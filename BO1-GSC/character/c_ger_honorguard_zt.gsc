 ...
 * Script: character\c_ger_honorguard_zt.gsc
*********************************************/

main() {
  codescripts\character::setModelFromArray(xmodelalias\c_ger_honorguard_zomb_bodyalias::main());
...
precache() {
  codescripts\character::precacheModelArray(xmodelalias\c_ger_honorguard_zomb_bodyalias::main());
