 ...
 * Script: character\c_zom_moon_tech_zombie_1_2.gsc
****************************************************/

main() {
  self setModel("c_zom_moon_tech_body_noshirtguts_2");
  self.headModel = codescripts\character::randomElement(xmodelalias\c_zom_moon_heads_alias::main());
  self attach(self.headModel, "", true);
  self.voice = "american";
  self.skeleton = "base";
  self.torsoDmg1 = "c_zom_moon_tech_body_n_g_upclean_2";
  self.torsoDmg2 = "c_zom_moon_tech_body_n_g_rarmoff_2";
  self.torsoDmg3 = "c_zom_moon_tech_body_n_g_larmoff_2";
...
precache() {
  precacheModel("c_zom_moon_tech_body_noshirtguts_2");
  codescripts\character::precacheModelArray(xmodelalias\c_zom_moon_heads_alias::main());
  precacheModel("c_zom_moon_tech_body_n_g_upclean_2");
  precacheModel("c_zom_moon_tech_body_n_g_rarmoff_2");
  precacheModel("c_zom_moon_tech_body_n_g_larmoff_2");
