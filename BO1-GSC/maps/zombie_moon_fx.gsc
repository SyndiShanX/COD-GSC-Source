 ...
 * Script: maps\zombie_moon_fx.gsc
**************************************/
...
main() {
  ...
  maps\createfx\zombie_moon_fx::main();
  maps\createart\zombie_moon_art::main();
...
precache_scripted_fx() {
  ...
  level._effect["lght_marker"] = loadfx("maps/zombie/fx_zombie_moon_marker");
  ...
  level._effect["elec_room_on"] = loadfx("misc/fx_zombie_light_elec_room_on");
