 ...
 * Script: maps\_zombietron_fate.gsc
**************************************/
...
choose_fate_round() {
  ...
  fate_triggers[2] = GetEnt("fate_trigger3", "targetname");
  fate_triggers[3] = GetEnt("fate_trigger4", "targetname");
  the_fates = randomize_array(fate_triggers);
