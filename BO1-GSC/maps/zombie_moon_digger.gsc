 ...
 * Script: maps\zombie_moon_digger.gsc
***************************************/
...
digger_init_flags() {
  ...
  if(isDefined(level.quantum_bomb_register_result_func)) {
    ...
    ]("remove_digger", ::quantum_bomb_remove_digger_result, 75, ::quantum_bomb_remove_digger_validation);
  }
}
  ...
  while(1) {
    ...
    if(flag(start_flag) && !flag(hacked_flag)) {
      ...
      switch (struct.digger_name) {
        case "hangar":
          level clientnotify("HCA");
          break;
        case "teleporter":
          level clientnotify("TCA");
          break;
        case "biodome":
          level clientnotify("BCA");
          break;
      }
    }
    ...
    if(flag(hacked_flag)) {
      ...
      switch (struct.digger_name) {
        case "hangar":
          level clientnotify("HCO");
          break;
        case "teleporter":
          level clientnotify("TCO");
          break;
        case "biodome":
          level clientnotify("BCO");
          break;
      }
    }
