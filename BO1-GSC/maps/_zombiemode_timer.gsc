...
start_timer(time, stop_notify) {
  ...
  if(!isDefined(self.stopwatch_elem)) {
    ...
    self.stopwatch_elem.alignX = "user_left";
    self.stopwatch_elem.alignY = "user_top";
    ...
    self.stopwatch_elem_glass.alignX = "user_left";
    self.stopwatch_elem_glass.alignY = "user_top";
