...
loadtreadfx(vehicle) {
  ...
  if(vehicle.vehicletype == "boat_pbr_player") {
    ...
    vehicle.wakefx[0] = loadfx("vehicle/water/fx_wake_pbr_churn_reverse");
    vehicle.wakefx[1] = loadfx("vehicle/water/fx_wake_pbr_churn_0");
    vehicle.wakefx[2] = loadfx("vehicle/water/fx_wake_pbr_churn_1");
    vehicle.wakefx[3] = loadfx("vehicle/water/fx_wake_pbr_churn_2");
    vehicle.wakefx[4] = loadfx("vehicle/water/fx_wake_pbr_churn_3");
  }
}