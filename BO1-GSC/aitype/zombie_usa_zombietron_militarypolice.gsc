 ...
 * Script: aitype\zombie_usa_zombietron_militarypolice.gsc
***********************************************************/
...
main() {
  ...
  character\c_usa_militarypolice_zombietron::main();
}
...
precache() {
  character\c_usa_militarypolice_zombietron::precache();
