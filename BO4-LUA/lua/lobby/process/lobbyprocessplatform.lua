...
Lobby.ProcessPlatform.PS4AcceptInvite = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5)
	...
	local f1_local0 = Engine[0x3E68E350BEFE50D](Enum[0x7CA2DE5266A94BF][0xC46B73E8E18BA2], Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	local f1_local1 = function()
		if not f1_local0 and Engine[0x9882F293C327557]() == LobbyData.GetLobbyMenuIDByName(LuaEnum.UI.MAIN) then
			...
			for f2_local1 = 0, LuaDefine.MAX_CONTROLLER_COUNT - 1, 1 do
				if Engine[0xF3A4EBD7B3AA744](f2_local1) then
					f2_local0 = f2_local0 + 1
				end
			end
			if f2_local0 == 0 or Engine[0xA5B9C0111291A8B]() ~= f1_arg0 then
				Engine[0x34F3B87969746BE](f1_arg0)
			end
		end
	end
	f1_arg0 = Engine[0xA5B9C0111291A8B]()
	...
	if Engine[0xA63E42B2FB6EC02]() == Enum[0xC84D3E505F1444][0xDB898B3478D2D71] then
		local f1_local6 = Enum[0xC84D3E505F1444][0xBAA8EC6F3E77255]
	end
	if LuaUtils.OnlineOnlyDemo() == true then
		local f1_local6 = Enum[0xC84D3E505F1444][0xE99F41098B71960]
	end
	if LuaUtils.OfflineOnlyDemo() == true then
		local f1_local6 = Enum[0xC84D3E505F1444][0xBAA8EC6F3E77255]
	end
	local f1_local7 = f1_local6 == Enum[0xC84D3E505F1444][0xBAA8EC6F3E77255]
	...
	if f1_local0 == true then
		f1_local10 = Engine[0x29B25E8DA873863](Enum[0x7CA2DE5266A94BF][0xC46B73E8E18BA2], Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	end
	local f1_local11 = LobbyData.GetLobbyMenuByName(LuaEnum.UI.DIRECTOR_ONLINE)
	if f1_local6 == Enum[0xC84D3E505F1444][0xBAA8EC6F3E77255] then
	...
	if Engine[0x9FB56855DFACDAD]() > 1 then
		...
		for f1_local46 = 1, LuaDefine.MAX_CONTROLLER_COUNT, 1 do
			...
			if Engine[0xF3A4EBD7B3AA744](f1_local49) then
	...
	local f1_local53 = Lobby.Actions.LobbyClientEnd(Enum[0xBF54BE1BB3D618B][0x92676CF5B6FCD43])
	local f1_local54 = Lobby.Actions.LobbyHostEnd(Enum[0xBF54BE1BB3D618B][0x92676CF5B6FCD43])
	local f1_local55 = Lobby.Actions.LobbyClientEnd(Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	local f1_local56 = Lobby.Actions.LobbyHostEnd(Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	local f1_local57 = Lobby.Actions.LobbyClientEnd(Enum[0xBF54BE1BB3D618B][0x92676CF5B6FCD43])
	local f1_local58 = Lobby.Actions.LobbyHostEnd(Enum[0xBF54BE1BB3D618B][0x92676CF5B6FCD43])
	local f1_local59 = Lobby.Actions.LobbyClientEnd(Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	local f1_local60 = Lobby.Actions.LobbyHostEnd(Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	local f1_local61 = Lobby.Actions.PlatformSessionGetReceivedInvitation(f1_arg0, f1_arg1, Enum[0xBF54BE1BB3D618B][0xA1647599284110], f1_arg2)
	local f1_local62 = Lobby.Actions.PlatformSessionGetSessionInfo(f1_arg0, f1_arg1, Enum[0xBF54BE1BB3D618B][0xA1647599284110], f1_arg3, f1_local61.info)
	...
	local f1_local71 = Lobby.Actions.LobbyJoinXUIDExt(f1_arg0, Enum[0xC018C5F55467EB1][0x9707B48B88781B9], f1_local64, Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	local f1_local72 = Lobby.Actions.ErrorPopup(f1_local71)
	local f1_local73 = Lobby.Actions.LobbyJoinXUIDExt(f1_arg0, Enum[0xC018C5F55467EB1][0x9707B48B88781B9], f1_local64, Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	local f1_local74 = Lobby.Actions.LobbyHostStart(f1_arg0, Enum[0x89C1455C5032969][0xD5FBB8D74AC6D62], Enum[0xBF54BE1BB3D618B][0xA1647599284110], Enum[0x8409AA0F01B5DBC][0x285F46E8227BB03], f1_local10, "", "")
	local f1_local75 = Lobby.Actions.LobbyHostAddPrimary(Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	local f1_local76 = Lobby.Actions.LobbyClientStart(Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	...
	local f1_local85 = function()
		if Engine[0x86E64DD1C270046](Enum[0x7CA2DE5266A94BF][0xC46B73E8E18BA2], Engine[0xC3DF042E7492B66](Enum[0x7CA2DE5266A94BF][0xC46B73E8E18BA2]), f1_arg1) then
	...
	if Engine[0x3E68E350BEFE50D](Enum[0x7CA2DE5266A94BF][0xC46B73E8E18BA2], Enum[0xBF54BE1BB3D618B][0xA1647599284110]) then
...
Lobby.ProcessPlatform.XboxJoin = function(f10_arg0, f10_arg1, f10_arg2, f10_arg3)
	Engine[0xB972AE22481F1]()
	local f10_local0 = Engine[0x3E68E350BEFE50D](Enum[0x7CA2DE5266A94BF][0xC46B73E8E18BA2], Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	if Engine[0xA63E42B2FB6EC02]() == Enum[0xC84D3E505F1444][0xDB898B3478D2D71] then
		local f10_local1 = Enum[0xC84D3E505F1444][0xBAA8EC6F3E77255]
	end
	if LuaUtils.OnlineOnlyDemo() == true then
		local f10_local1 = Enum[0xC84D3E505F1444][0xE99F41098B71960]
	end
	if LuaUtils.OfflineOnlyDemo() == true then
		local f10_local1 = Enum[0xC84D3E505F1444][0xBAA8EC6F3E77255]
	end
	local f10_local2 = f10_local1 == Enum[0xC84D3E505F1444][0xBAA8EC6F3E77255]
	...
	local f10_local4 = function()
		if not f10_local0 then
			...
			Engine[0xC28EAD1F7D00AD7](Engine[0x93B19E01B1FD1C7](f10_arg0))
		end
	end
	...
	if f10_local0 == true then
		f10_local10 = Engine[0x29B25E8DA873863](Enum[0x7CA2DE5266A94BF][0xC46B73E8E18BA2], Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	end
	local f10_local11 = LobbyData.GetLobbyMenuByName(LuaEnum.UI.DIRECTOR_ONLINE)
	if f10_local1 == Enum[0xC84D3E505F1444][0xBAA8EC6F3E77255] then
	...
	if Engine[0x9FB56855DFACDAD]() > 1 then
		...
		for f10_local36 = 1, LuaDefine.MAX_CONTROLLER_COUNT, 1 do
			...
			if Engine[0xF3A4EBD7B3AA744](f10_local39) and not Engine[0xE91B1452CB6FBE6](f10_local39) then
	...
	local f10_local40 = Lobby.Actions.ForceLobbyUIScreen(f10_arg0, f10_local11[0x8B72E07B55C3AC0])
	local f10_local39 = Lobby.Actions.LobbyClientEnd(Enum[0xBF54BE1BB3D618B][0x92676CF5B6FCD43])
	local f10_local41 = Lobby.Actions.LobbyHostEnd(Enum[0xBF54BE1BB3D618B][0x92676CF5B6FCD43])
	local f10_local42 = Lobby.Actions.LobbyClientEnd(Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	local f10_local43 = Lobby.Actions.LobbyHostEnd(Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	local f10_local44 = Lobby.Actions.LeaveWithParty(3000)
	local f10_local45 = Lobby.Actions.LobbyClientEnd(Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	local f10_local46 = Lobby.Actions.LobbyHostEnd(Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	local f10_local47 = Lobby.Actions.LobbyClientEnd(Enum[0xBF54BE1BB3D618B][0x92676CF5B6FCD43])
	local f10_local48 = Lobby.Actions.LobbyHostEnd(Enum[0xBF54BE1BB3D618B][0x92676CF5B6FCD43])
	...
	local f10_local51 = Lobby.Actions.LobbyJoinXUIDExt(f10_arg0, f10_arg2, f10_local49, Enum[0xBF54BE1BB3D618B][0x743687BBDF0B150])
	...
	local f10_local54 = Lobby.Actions.LobbyJoinXUIDExt(f10_arg0, Enum[0xC018C5F55467EB1][0x9707B48B88781B9], f10_local49, Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	f10_local54.name = f10_local54.name .. "(private)"
	local f10_local55 = Lobby.Actions.LobbyHostStart(f10_arg0, Enum[0x89C1455C5032969][0xD5FBB8D74AC6D62], Enum[0xBF54BE1BB3D618B][0xA1647599284110], Enum[0x8409AA0F01B5DBC][0x285F46E8227BB03], f10_local10, "", "")
	local f10_local56 = Lobby.Actions.LobbyHostAddPrimary(Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	local f10_local57 = Lobby.Actions.LobbyClientStart(Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	...
	local f10_local72 = Lobby.Actions.ExecuteScript(function()
		if Engine[0x86E64DD1C270046](Enum[0x7CA2DE5266A94BF][0xC46B73E8E18BA2], Engine[0xC3DF042E7492B66](Enum[0x7CA2DE5266A94BF][0xC46B73E8E18BA2]), f10_arg1) then
			Engine[0xF56FEF6357B5097](Enum[0xBF54BE1BB3D618B][0xA1647599284110], Enum[0x5A046D0646801][0x4787E42BE26EFCD])
			return false
		else
			return true
	...
	local f10_local77 = Engine[0x7B48C1ABFF0F764]()
	local f10_local78 = Engine[0x3E68E350BEFE50D](Enum[0x7CA2DE5266A94BF][0xC46B73E8E18BA2], Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	local f10_local79 = Engine[0x3E68E350BEFE50D](Enum[0x7CA2DE5266A94BF][0xC46B73E8E18BA2], Enum[0xBF54BE1BB3D618B][0x92676CF5B6FCD43])
	local f10_local80 = Engine[0xEA2BE00F49480D](Enum[0xBF54BE1BB3D618B][0xA1647599284110])
	local f10_local81 = Engine[0xEA2BE00F49480D](Enum[0xBF54BE1BB3D618B][0x92676CF5B6FCD43])
	local f10_local82 = Engine[0x44FC97037CE42ED](Enum[0x7CA2DE5266A94BF][0xC46B73E8E18BA2], Enum[0xBF54BE1BB3D618B][0xA1647599284110], Enum[0x575E471C039DBD6][0x92BC25E18D296F])
	local f10_local83 = Engine[0x44FC97037CE42ED](Enum[0x7CA2DE5266A94BF][0xC46B73E8E18BA2], Enum[0xBF54BE1BB3D618B][0x92676CF5B6FCD43], Enum[0x575E471C039DBD6][0x92BC25E18D296F])
...
Lobby.ProcessPlatform.PlayTogetherBeginPlay = function(f19_arg0, f19_arg1)
	...
	local f19_local6 = Lobby.Actions.SendPlatformInvite(f19_arg0, Enum[0xBF54BE1BB3D618B][0xA1647599284110], f19_arg1)
...
Lobby.ProcessPlatform.SendPlayTogetherInvites = function(f21_arg0, f21_arg1)
	...
	local f21_local5 = Lobby.Actions.SendPlatformInvite(f21_arg0, Enum[0xBF54BE1BB3D618B][0xA1647599284110], f21_arg1, f21_local0)
	local f21_local6 = {
		head = f21_local2,
		interrupt = Lobby.Interrupt.NONE,
		force = false,
