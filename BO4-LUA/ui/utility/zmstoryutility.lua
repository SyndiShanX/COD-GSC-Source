...
CoD.ZMStoryUtility.GetCurrentMapStory = function()
	...
	if InFrontend() then
		...
		if not f2_local1 or f2_local1 == 0x0 then
			...
			if not f2_local1 or f2_local1 == 0x0 then
				f2_local1 = Engine[@"converttoxhash"](Engine[@"lobbygetmap"]())
			end
		end
	else
		f2_local1 = Engine[@"converttoxhash"](Engine[@"lobbygetmap"]())
...
CoD.ZMStoryUtility.SetSelectedStoryOnLoad = function()
	local f5_local0 = CoD.BaseUtility.GetMapValue(Engine[@"getcurrentmap"](), @"hash_3A3627D705B66CDE")
	if f5_local0 then
		Engine[@"hash_337129162C820FB"](f5_local0)
	end
end
CoD.ZMStoryUtility.SetSelectedStoryToCurrentMapStory = function(f6_arg0)
	...
	Engine[@"hash_337129162C820FB"](f6_local0)
...
CoD.ZMStoryUtility.UpdateSelectedStory = function(f7_arg0, f7_arg1)
	...
	Engine[@"hash_337129162C820FB"](f7_local0)
...
CoD.ZMStoryUtility.UpdateSelectedCharacterStory = function(f8_arg0, f8_arg1)
	...
	if f8_local1 then
		Engine[@"hash_337129162C820FB"](f8_local1)
		...
		if f9_local9.session_mode == Enum[@"emodes"][@"mode_zombies"] and f9_local9[@"hash_3A3627D705B66CDE"] and f9_local9.zmCharacters then
			for f9_local6, f9_local7 in ipairs(f9_local9.zmCharacters) do
				if f9_local7.characterIndex then
					CoD.ZMStoryUtility.CharacterIndexToStory[f9_local7.characterIndex] = f9_local9[@"hash_3A3627D705B66CDE"]
				end
			end
		end
	end
