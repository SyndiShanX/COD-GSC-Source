...
CoD.ConsoleUtility.UpdateConsole = function(f1_arg0)
	...
	local f1_local1 = Engine[0x4DF5CFBC1771947](f1_arg0.controller)
	local f1_local2 = Engine[0x40E824FE270E174](f1_arg0.consoleModel, "currentIndex")
	local f1_local3 = Engine[0x614D394F6F9A18D](f1_local2)
	if f1_arg0.maxElementIndex < f1_local0 then
		f1_arg0.lines[f1_local3].element:forceHideConsoleEntry()
	end
	if Engine[0xDD333420C49E6D0](f1_arg0.controller, Enum[0x7F032C2EF103A1A][0xD3ABF9A2753CE40]) then
	else
		f1_arg0.lines[f1_local3].element:showConsoleEntry(f1_local3, f1_arg0.padding)
		f1_arg0.lines[f1_local3].active = true
	end
	Engine[0x83C9B5DE1D9371](f1_local2, (f1_local3 + 1) % (f1_arg0.maxElementIndex + 1))
	return true
end
...
CoD.ConsoleUtility.Init = function(f3_arg0, f3_arg1, f3_arg2, f3_arg3, f3_arg4)
	...
	local f3_local0 = Engine[0x40E824FE270E174](Engine[0x4DF5CFBC1771947](f3_arg1), "hudItems." .. f3_arg2)
	Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](f3_local0, "currentIndex"), 0)
...
CoD.ConsoleUtility.ShowConsoleEntry = function(f6_arg0, f6_arg1, f6_arg2)
	...
	f6_arg0.icon0Visible = f6_local5(Engine[0x614D394F6F9A18D](Engine[0x40E824FE270E174](f6_local6, "icon0")))
	f6_arg0.text0Visible = f6_local5(Engine[0x614D394F6F9A18D](Engine[0x40E824FE270E174](f6_local6, "text0")))
	f6_arg0.icon1Visible = f6_local5(Engine[0x614D394F6F9A18D](Engine[0x40E824FE270E174](f6_local6, "icon1")))
	f6_arg0.text1Visible = f6_local5(Engine[0x614D394F6F9A18D](Engine[0x40E824FE270E174](f6_local6, "text1")))
	f6_arg0.text2Visible = f6_local5(Engine[0x614D394F6F9A18D](Engine[0x40E824FE270E174](f6_local6, "text2")))
	if f6_arg0.icon0Visible then
		local f6_local7, f6_local8, f6_local9, f6_local10 = f6_arg0.ConsoleEntry.Icon0:getLocalRect()
		local f6_local11 = (f6_local10 - f6_local8) * Engine[0x614D394F6F9A18D](Engine[0x40E824FE270E174](f6_local6, "iconWidth"))
	...
	if f6_arg0.alignment == Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041] then
...
CoD.ConsoleUtility.ChooseEntryIconImage = function(f12_arg0)
	local f12_local0 = Engine[0x40E824FE270E174](f12_arg0.obitModel, "line" .. Engine[0x614D394F6F9A18D](f12_arg0.currentIndexModel))
	local f12_local1 = Engine[0x40E824FE270E174](f12_local0, "icon")
	local f12_local2 = Engine[0x614D394F6F9A18D](Engine[0x40E824FE270E174](f12_local0, "mod"))
	local f12_local3 = Engine[0x614D394F6F9A18D](Engine[0x40E824FE270E174](f12_local0, "weaponKillIcon"))
	...
	Engine[0x83C9B5DE1D9371](f12_local1, f12_local6)
end
CoD.ConsoleUtility.UpdateObituary = function(f13_arg0)
	...
	local f13_local1 = Engine[0x4DF5CFBC1771947](f13_arg0.controller)
	local f13_local2 = Engine[0x614D394F6F9A18D](f13_arg0.currentIndexModel)
	if f13_arg0.maxElementIndex < f13_local0 then
		f13_arg0.lines[f13_local2].element:forceHideObituaryEntry()
	end
	if Engine[0xDD333420C49E6D0](f13_arg0.controller, Enum[0x7F032C2EF103A1A][0xD3ABF9A2753CE40]) then
	else
		f13_arg0.lines[f13_local2].element:showObituaryEntry(f13_local2)
		f13_arg0.lines[f13_local2].active = true
	end
	Engine[0x83C9B5DE1D9371](f13_arg0.currentIndexModel, (f13_local2 + 1) % (f13_arg0.maxElementIndex + 1))
	return true
end
...
CoD.ConsoleUtility.InitObituary = function(f15_arg0, f15_arg1, f15_arg2, f15_arg3)
	...
	local f15_local0 = Engine[0x40E824FE270E174](Engine[0x4DF5CFBC1771947](f15_arg1), "hudItems." .. f15_arg2)
	local f15_local1 = Engine[0xA798E4552F5E872](f15_local0, "currentIndex")
	f15_arg0.maxElementIndex = f15_arg3 or 6
	f15_arg0.obitModel = f15_local0
	f15_arg0.currentIndexModel = f15_local1
	Engine[0x83C9B5DE1D9371](f15_local1, 0)
	f15_arg0.lines = {}
