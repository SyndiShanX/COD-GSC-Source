CoD.CoDAccountUtility = {
	...
	error_codes = {
		[Enum[@"hash_17DEA32672263479"][@"hash_4949EF8AE1EF744D"]] = 0xA1F937DB15A3B0,
		...
		[Enum[@"hash_17DEA32672263479"][@"hash_5B84C61C4FB6633E"]] = 0x48D6F4B4570581,
...
DataSources.CODAccountRegisterOptions = ListHelper_SetupDataSource("CODAccountRegisterOptions", function(f14_arg0, f14_arg1)
	...
	local f14_local7 = @"hash_734AB4709B1FA9DB"
	local f14_local8 = ""
	local f14_local9 = nil
	local f14_local10 = f14_local1
	local f14_local11 = nil
	local f14_local12 = Engine[@"hash_24A9D1DAC0556BB1"](f14_arg0)
	if f14_local12 then
	...
	f14_local7 = @"hash_213ADAB54C482D0"
	f14_local8 = ""
	f14_local9 = nil
...
DataSources.CODAccountSignInInfoBasic = ListHelper_SetupDataSource("CODAccountSignInInfoBasic", function(f18_arg0)
	...
	table.insert(f18_local0, CoD.CoDAccountUtility.packageOptionsButtonData(@"hash_61770F1CA89E2DE5", @"hash_13C9CB1D8A997FD1", "", f18_local1))
	table.insert(f18_local0, CoD.CoDAccountUtility.packageOptionsButtonData(@"hash_4A50C91C923FBBF6", @"hash_64D3F2D796BAF968", "", f18_local2))
	return f18_local0
end, true)
...
DataSources.CODAccountRegisterInfoDob = ListHelper_SetupDataSource("CODAccountRegisterInfoDob", function(f25_arg0)
	...
	local f25_local2 = function(f27_arg0, f27_arg1, f27_arg2, f27_arg3)
		...
		if f27_local1 < CoD.CoDAccountUtility.MINIMUM_DOB_YEAR then
			local f27_local2, f27_local3, f27_local4 = Engine[@"hash_3221B0C76B5975CB"]()
	...
	local f25_local3 = function(f28_arg0, f28_arg1, f28_arg2, f28_arg3)
		...
		local f28_local2, f28_local3, f28_local4 = Engine[@"hash_3221B0C76B5975CB"]()
	...
	local f25_local11 = @"hash_B47567E1BA0DB3C"
	local f25_local12 = @"hash_2BFD846433DF23C4"
	...
	f25_local11 = @"hash_1EDDA606BC3D1A85"
	f25_local12 = @"hash_6CF3C204406D094F"
	...
	f25_local9 = f25_local0
	f25_local10 = CoD.CoDAccountUtility.packageNumOptionsButtonData
	f25_local11 = @"hash_3D518580105F7DFD"
	f25_local12 = @"hash_5A98FA84F1693047"
	f25_local13 = DataSources.CODAccountRegistrationForm.getModel(f25_arg0)
...
DataSources.CODAccountRegisterInfoRegion = ListHelper_SetupDataSource("CODAccountRegisterInfoRegion", function(f33_arg0)
	...
	local f33_local1 = function(f34_arg0, f34_arg1, f34_arg2, f34_arg3)
		...
		f34_local2:set(Engine[@"hash_4F9F1239CFD921FE"](CoD.CoDAccountUtility.country_list[f34_local1].display_string))
	end
	local f33_local2 = function(f35_arg0, f35_arg1, f35_arg2, f35_arg3)
		...
		f35_local2:set(Engine[@"hash_4F9F1239CFD921FE"](CoD.CoDAccountUtility.country_list[f35_local1].display_string))
	end
	local f33_local3 = DataSources.CODAccountRegistrationForm.getModel(f33_arg0)
	f33_local3 = f33_local3.regionIndex:get()
	table.insert(f33_local0, CoD.CoDAccountUtility.packageNumOptionsButtonData(@"hash_15E47B2E277CE3DF", @"hash_1C3AF012770E8671", Engine[@"hash_4F9F1239CFD921FE"](CoD.CoDAccountUtility.country_list[f33_local3.regionIndex:get()].display_string), f33_local1, f33_local2))
	return f33_local0
end, true)
DataSources.CODAccountSignInInfoOptions = ListHelper_SetupDataSource("CODAccountSignInInfoOptions", function(f36_arg0)
	...
	local f36_local6 = @"hash_24386399918B25D7"
	local f36_local7 = @"hash_32C3697D1F18A5C9"
...
DataSources.CODAccountRegisterInfoOptions = ListHelper_SetupDataSource("CODAccountRegisterInfoOptions", function(f39_arg0)
	...
	local f39_local7 = @"hash_3D226F0316784E4D"
	local f39_local8 = @"hash_41E95EF81CEEDBC0"
	...
	f39_local7 = @"hash_24386399918B25D7"
	f39_local8 = @"hash_32C3697D1F18A5C9"
...
DataSources.CODAccountManagementOptions = ListHelper_SetupDataSource("CODAccountManagementOptions", function(f43_arg0)
	...
	local f43_local6 = @"hash_24386399918B25D7"
	local f43_local7 = @"hash_32C3697D1F18A5C9"
...
DataSources.CODAccountSignInConfirmation = ListHelper_SetupDataSource("CODAccountSignInConfirmation", function(f46_arg0)
	...
	table.insert(
		f46_local0,
		CoD.CoDAccountUtility.packageOptionsButtonData(@"hash_734AB4709B1FA9DB", @"hash_35FE2CB1957E1FCD", nil, function(f47_arg0, f47_arg1, f47_arg2, f47_arg3, f47_arg4)
...
DataSources.CODAccountRegisterConfirmation = ListHelper_SetupDataSource("CODAccountRegisterConfirmation", function(f48_arg0)
	...
	local f48_local1 = function(f49_arg0, f49_arg1, f49_arg2, f49_arg3)
		...
		local f49_local1, f49_local2, f49_local3 = Engine[@"hash_3221B0C76B5975CB"]()
	...
	table.insert(
		f48_local0,
		CoD.CoDAccountUtility.packageOptionsButtonData(@"hash_215C30E9D25C305", 0x8166430FAB32CF, nil, function(f50_arg0, f50_arg1, f50_arg2, f50_arg3, f50_arg4)
...
DataSources.CODAccountManagementConfirmation = ListHelper_SetupDataSource("CODAccountManagementConfirmation", function(f51_arg0)
	...
	table.insert(
		f51_local0,
		CoD.CoDAccountUtility.packageOptionsButtonData(@"hash_2510602E24EC68E6", @"hash_71E475AB21AD3B16", nil, function(f52_arg0, f52_arg1, f52_arg2, f52_arg3, f52_arg4)
			...
			Engine[@"hash_23FA7DA8B2FCE32E"](f52_arg2)
...
CoD.CoDAccountUtility.CodAccountOnTransactionResultUpdated = function(f59_arg0, f59_arg1, f59_arg2)
	...
	if f59_local2 ~= nil and f59_local1 == Enum[@"hash_1BD1E0D9720D416F"][@"hash_144F7EE04FC86C81"] and Engine[@"getmodelvalue"](Engine[@"createmodel"](Engine[@"getglobalmodel"](), "lobbyRoot.spinnerActive")) == true then
		if f59_local2 == Enum[@"hash_17DEA32672263479"][@"hash_19785994B830E5D0"] and f59_local4 then
			...
			local f59_local5 = @"hash_38A1166FB6473E4E"
			local f59_local6 = @"hash_BDDF5BDFAA382D4"
			if CoD.CoDAccountUtility.IsSignInActive then
				f59_local5 = @"hash_66144FDBA2ECB222"
	...
	elseif not CoD.isPC and CoD.BaseUtility.IsCurrentLanguageRussian() then
		...
		if not IsInGame() then
			if CoD.DirectorUtility.IsOfflineDemo() then
				f64_local0 = Engine[@"hash_5CB675CA7856DA25"]()
				if f64_local0 then
				else
					return f64_local0
				end
...
CoD.CoDAccountUtility.GetElementDescription = function(f65_arg0)
	...
	if f65_local0 then
		...
		local f65_local2 = Engine[@"hash_4F9F1239CFD921FE"](f65_local0.description:get())
	end
...
CoD.CoDAccountUtility.OnNewAccountItemFocusChangeWithHint = function(f67_arg0, f67_arg1)
	...
	f67_local0.hintText:set(Engine[@"hash_4F9F1239CFD921FE"](f67_arg1))
end
...
CoD.CoDAccountUtility.OnSignInItemFocusChangeWithHint = function(f69_arg0, f69_arg1)
	...
	f69_local0.hintText:set(Engine[@"hash_4F9F1239CFD921FE"](f69_arg1))
end
...
CoD.CoDAccountUtility.SetLegalPagesText = function(f77_arg0, f77_arg1, f77_arg2, f77_arg3)
	f77_arg0:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_6A205700391CF3AD", f77_arg2, f77_arg3))
end
