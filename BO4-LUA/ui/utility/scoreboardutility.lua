...
CoD.ScoreboardUtility.SetupGameStatusClientLists = function(f5_arg0, f5_arg1)
	...
	local f5_local2 = Engine[0x4DF5CFBC1771947](f5_arg1)
	...
	f5_local2 = Engine[0x4DF5CFBC1771947](f5_arg1)
...
CoD.ScoreboardUtility.SetClientModelOnElement = function(f8_arg0, f8_arg1)
	local f8_local0 = Engine[0xE4D2F32833CFA6C](Engine[0x761955642304848](f8_arg0))
	if f8_local0 then
...
CoD.ScoreboardUtility.UpdateScoreboardClientMuteButtonPrompt = function(f9_arg0, f9_arg1)
	...
	local f9_local2 = Engine[0xA798E4552F5E872](Engine[0x4DF5CFBC1771947](f9_arg1), "scoreboardInfo.muteButtonPromptVisible")
	local f9_local3 = Engine[0xA798E4552F5E872](Engine[0x4DF5CFBC1771947](f9_arg1), "scoreboardInfo.muteButtonPromptText")
	if f9_local1 and f9_local1 >= 0 and Engine[0x761955642304848](f9_arg1) ~= f9_local1 then
		...
		local f9_local6 = Engine[0x83C9B5DE1D9371]
		...
		if Engine[0xAC4DDADDA07242F](f9_arg1, Engine[0xC3DF042E7492B66](Enum[0x7CA2DE5266A94BF][0xC46B73E8E18BA2]), f9_local4) then
			Engine[0x83C9B5DE1D9371](f9_local3, 0x6BEF50FAD886D13)
		else
			Engine[0x83C9B5DE1D9371](f9_local3, 0x322978D8B62A956)
		end
	else
		Engine[0x83C9B5DE1D9371](f9_local2, false)
		Engine[0x83C9B5DE1D9371](f9_local3, 0x322978D8B62A956)
	end
end
CoD.ScoreboardUtility.ToggleClientMute = function(f10_arg0, f10_arg1)
	...
	if f10_local1 and f10_local1 >= 0 and Engine[0x761955642304848](f10_arg1) ~= f10_local1 then
		Engine[0xB55E6E9AFB2E809](f10_arg1, f10_local1, Engine[0xC3DF042E7492B66](Enum[0x7CA2DE5266A94BF][0xC46B73E8E18BA2]))
...
CoD.ScoreboardUtility.CreatedSortKey = function(f11_arg0, f11_arg1, f11_arg2)
	local f11_local0 = Engine[0x4DF5CFBC1771947](f11_arg0)
	if not f11_local0["scoreboardInfo.sortKey" .. f11_arg1] then
		local f11_local1 = Engine[0x8C7ADE01B406F5E](f11_arg0, "scoreboardSortKey" .. f11_arg1)
...
CoD.ScoreboardUtility.InitScoreboardSortKey = function(f12_arg0)
	local f12_local0 = Engine[0x170F4F2196F8FD0](f12_arg0, 0)
	local f12_local1 = Engine[0x170F4F2196F8FD0](f12_arg0, 1)
	local f12_local2 = Engine[0x170F4F2196F8FD0](f12_arg0, 2)
...
CoD.ScoreboardUtility.SetRowHeader = function(f13_arg0, f13_arg1, f13_arg2)
	local f13_local0 = Engine[0x4E9119DFEF0C60A](f13_arg0, f13_arg2)
...
CoD.ScoreboardUtility.SetCurrentFocusedClient = function(f14_arg0, f14_arg1)
	...
	if f14_local0 then
		local f14_local1 = Engine[0x4DF5CFBC1771947](f14_arg1)
...
CoD.ScoreboardUtility.SetCurrentFocusedClientToLocalPlayer = function(f15_arg0, f15_arg1)
	local f15_local0 = Engine[0x4DF5CFBC1771947](f15_arg1)
...
CoD.ScoreboardUtility.SetSavedActiveItemToLocalPlayer = function(f16_arg0, f16_arg1)
	local f16_local0 = Engine[0x4DF5CFBC1771947](f16_arg1)
...
CoD.ScoreboardUtility.SetupFooterSubscription = function(f17_arg0, f17_arg1)
	local f17_local0 = Engine[0x4DF5CFBC1771947](f17_arg1)
	if not f17_local0.currentFocusedClient then
		local f17_local1 = Engine[0xE4D2F32833CFA6C](Engine[0x761955642304848](f17_arg1))
...
CoD.ScoreboardUtility.SetupResetToLocalPlayerSubscription = function(f19_arg0, f19_arg1, f19_arg2)
	...
	local f19_local2 = Engine[0x4DF5CFBC1771947](f19_arg2)
	f19_local1(f19_local0, f19_local2["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0xF4EDA8B636F3F04]], function(f20_arg0)
...
CoD.ScoreboardUtility.SetupTeamLists = function(f22_arg0, f22_arg1, f22_arg2, f22_arg3, f22_arg4, f22_arg5)
	local f22_local0 = math.ceil(Engine[0x29B25E8DA873863](Enum[0x7CA2DE5266A94BF][0xC46B73E8E18BA2], Engine[0xC3DF042E7492B66](Enum[0x7CA2DE5266A94BF][0xC46B73E8E18BA2])) / 2)
...
CoD.ScoreboardUtility.CanShowScoreboard = function(f26_arg0)
	local f26_local0
	if not Engine[0xDD333420C49E6D0](f26_arg0, Enum[0x7F032C2EF103A1A][0xF4EDA8B636F3F04]) and not CoD.SpawnSelectionUtility.IsSpawnSelectActive(f26_arg0) then
...
CoD.ScoreboardUtility.CanHideScoreboard = function(f27_arg0)
	local f27_local0 = Engine[0xDD333420C49E6D0](f27_arg0, Enum[0x7F032C2EF103A1A][0xF4EDA8B636F3F04])
	if f27_local0 then
...
CoD.ScoreboardUtility.IsActiveRowClientNum = function(f30_arg0, f30_arg1)
	local f30_local0 = Engine[0x4DF5CFBC1771947](f30_arg0)
...
DataSources.TeamClients = {
	prepare = function(f33_arg0, f33_arg1, f33_arg2)
		local f33_local0 = Engine[0xE4D2F32833CFA6C](Engine[0x761955642304848](f33_arg0))
		f33_local0 = f33_local0:create("team")
		f33_local0 = f33_local0:get()
		if f33_local0 == Enum[0x13A4717E5AC547][0xE4DDAC9C5C45556] then
			if CoD.ShoutcasterProfileVarBool(f33_arg0, "shoutcaster_ds_flip_scorepane") then
				f33_local0 = Enum[0x13A4717E5AC547][0x3F83D7CE4BD7B68]
			else
				f33_local0 = Enum[0x13A4717E5AC547][0x2A34B055ADD98AB]
			end
		end
...
DataSources.EnemyClients = {
	prepare = function(f36_arg0, f36_arg1, f36_arg2)
		local f36_local0 = Engine[0xE4D2F32833CFA6C](Engine[0x761955642304848](f36_arg0))
		f36_local0 = f36_local0:create("team")
		f36_local0 = f36_local0:get()
		if f36_local0 == Enum[0x13A4717E5AC547][0xE4DDAC9C5C45556] then
			if CoD.ShoutcasterProfileVarBool(f36_arg0, "shoutcaster_ds_flip_scorepane") then
				f36_local0 = Enum[0x13A4717E5AC547][0x3F83D7CE4BD7B68]
			else
				f36_local0 = Enum[0x13A4717E5AC547][0x2A34B055ADD98AB]
			end
		end
...
DataSources.ScoreboardSortOptions = ListHelper_SetupDataSource("ScoreboardSortOptions", function(f39_arg0)
	local f39_local0 = {}
	local f39_local1 = Engine[0x4DF5CFBC1771947](f39_arg0)
...
CoD.ScoreboardUtility.SwitchTabbedScoreboardTabs = function(f40_arg0, f40_arg1, f40_arg2, f40_arg3, f40_arg4)
	...
	local f40_local1 = Engine[0x4DF5CFBC1771947](f40_arg2)
...
CoD.ScoreboardUtility.GetScoreboardTeamTable = function(f41_arg0, f41_arg1)
	local f41_local0 = Engine[0x2B1F9C28B0BC2C6](f41_arg0, Engine[0xA9423CFB94266E8]())
	if Engine[0xA9423CFB94266E8]() < 2 and f41_arg1 == 2 then
		return {}
	end
	local f41_local1 = f41_local0[f41_arg1].team
	local f41_local2 = 0
	local f41_local3 = 0
	if f41_local1 ~= Enum[0x13A4717E5AC547][0x97263B3C1ABADF7] then
		f41_local2 = Engine[0x1FB0DCE27DB91F6](Enum[0x13A4717E5AC547][0x2A34B055ADD98AB])
		f41_local3 = Engine[0x1FB0DCE27DB91F6](Enum[0x13A4717E5AC547][0x3F83D7CE4BD7B68])
	else
		f41_local2 = Engine[0x1FB0DCE27DB91F6](Enum[0x13A4717E5AC547][0x97263B3C1ABADF7])
	end
	...
	for f41_local6 = 1, f41_local4, 1 do
		...
		local f41_local10 = -1
		if Engine[0x1FB0DCE27DB91F6](f41_local1) < f41_local6 then
			f41_local9 = "team: " .. f41_local1 .. " client: -1"
		else
			f41_local10 = Engine[0xB255C69C8381094](f41_local6 - 1, f41_local1, Enum[0x44F374008DFA22A][0x3A1B2ED08B85E14])
		end
...
CoD.ScoreboardUtility.UpdateScoreboardTeamScores = function(f42_arg0)
	local f42_local0 = Engine[0xA9423CFB94266E8]()
	local f42_local1 = Engine[0xA798E4552F5E872](Engine[0x4DF5CFBC1771947](f42_arg0), "scoreboardInfo")
	local f42_local2 = Engine[0x2B1F9C28B0BC2C6](f42_arg0, f42_local0)
	local f42_local3 = {}
	for f42_local4 = 1, f42_local0, 1 do
		...
		if f42_local8 ~= Enum[0x13A4717E5AC547][0x97263B3C1ABADF7] then
	...
	for f42_local12, f42_local7 in ipairs(f42_local3) do
		for f42_local9, f42_local10 in pairs(f42_local7) do
			Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](f42_local1, "team" .. f42_local12 .. f42_local9), f42_local10)
		end
	end
end
...
CoD.ScoreboardUtility.SetNemesisInfoModels = function(f44_arg0, f44_arg1)
	...
	Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](f44_arg1, "nemesisXuid"), Engine[0x9073FBE2D48C156](f44_local1.nemesisXuid:get()))
	Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](f44_arg1, "nemesisKills"), f44_local2)
	Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](f44_arg1, "nemesisKilledBy"), f44_local3)
end
CoD.ScoreboardUtility.SetScoreboardUIModels = function(f45_arg0)
	local f45_local0 = Engine[0xA9423CFB94266E8]()
	local f45_local1 = Engine[0x4DF5CFBC1771947](f45_arg0)
	local f45_local2 = Engine[0xA798E4552F5E872](f45_local1, "scoreboardInfo")
	local f45_local3 = Engine[0xA798E4552F5E872](Engine[0x4DF5CFBC1771947](0), "scoreboardInfo")
	if not Engine[0x40E824FE270E174](f45_local1, "forceScoreboard") then
		Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](f45_local1, "forceScoreboard"), 0)
	end
	Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](Engine[0x4DF5CFBC1771947](f45_arg0), "updateClientDeadStatus"), 0)
	Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](f45_local2, "muteButtonPromptVisible"), false)
	Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](f45_local2, "muteButtonPromptText"), 0x0)
	local f45_local4 = MapNameToLocalizedMapName(Engine[0x84A6876C104DA7D]())
	Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](f45_local2, "mapName"), f45_local4)
	Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](f45_local3, "mapName"), f45_local4)
	if Engine[0x32ABAFDCA93FDF9]() then
		...
		local f45_local5 = Engine[0x2B1F9C28B0BC2C6](f45_arg0, f45_local0)
		local f45_local6 = {}
		for f45_local7 = 1, f45_local0, 1 do
			...
			if f45_local11 ~= Enum[0x13A4717E5AC547][0x97263B3C1ABADF7] then
		...
		for f45_local15, f45_local10 in ipairs(f45_local6) do
			for f45_local12, f45_local13 in pairs(f45_local10) do
				Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](f45_local2, "team" .. f45_local15 .. f45_local12), f45_local13)
			end
		end
		f45_local7 = Engine[0xEA74FA7EE46E195](Engine[0x6F8027A8BC75673]())
		f45_local8 = f45_local7.nameRefCaps
		Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](f45_local2, "gameType"), f45_local8)
		Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](f45_local3, "gameType"), f45_local8)
		if f45_local0 < 2 then
			f45_local9 = Engine[0x40E824FE270E174](f45_local1, "gameScore.playerScore")
			if f45_local9 then
				Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](f45_local2, "team1Score"), Engine[0x614D394F6F9A18D](f45_local9))
			else
				local f45_local5 = 5
				for f45_local6 = 1, f45_local5, 1 do
					Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](f45_local2, "column" .. f45_local6 .. "Header"), Engine[0x4E9119DFEF0C60A](f45_arg0, f45_local6 - 1))
				end
			end
		else
			local f45_local5 = 5
			...
			if f50_arg2 > 0 then
				...
				if not f50_local0 then
					...
					if f50_arg1 ~= 0x1C078C11093F212 and f50_arg1 ~= 0x80234A872BD64AC then
						f50_arg0:AddScoreFeed(Engine[0xED84C33EC5F01EA](f50_arg1), f50_local1, f50_local2)
					end
					if f50_local2 then
