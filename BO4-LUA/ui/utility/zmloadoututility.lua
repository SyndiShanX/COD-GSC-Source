	...
	if f1_local0 then
		for f1_local7, f1_local8 in ipairs(f1_local0) do
			for f1_local4, f1_local5 in pairs(CoD.CACUtility.GetUnlockableItemTable()) do
				if CoD.BitUtility.IsBitSet(f1_local5.modes, Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A]) and f1_local5.nameHash == f1_local8[0xB610205F2C6E01] and f1_local5[0x32A46624FFC3379] ~= 1 then
...
CoD.ZMLoadoutUtility.AnySecondaryWeaponIsRestricted = function()
	local f5_local0 = CoD.CACUtility.GetUnlockableItemsForLoadoutSlot(Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A], "secondary")
	local f5_local1 = {}
...
CoD.ZMLoadoutUtility.GetArmoryAttachmentStringForWeaponIndex = function(f6_arg0, f6_arg1, f6_arg2)
	...
	for f6_local5, f6_local6 in ipairs(f6_local0.attachmentList) do
		if f6_local6.itemIndex ~= CoD.CACUtility.EmptyItemIndex then
			f6_local1 = LUI.appendStringWithDelimiter(f6_local1, Engine[0x2E29FB421AD554B](f6_arg1, f6_local6.itemIndex, f6_arg2), "+")
		end
	end
		...
		if f7_local2 then
			for f7_local6, f7_local7 in ipairs(f7_arg0.armoryAttachmentTable) do
				if f7_local7.itemIndex ~= CoD.CACUtility.EmptyItemIndex then
					f7_local0 = LUI.appendStringWithDelimiter(f7_local0, Engine[0x2E29FB421AD554B](f7_local2, f7_local7.itemIndex, f7_arg2), "+")
				end
			end
...
CoD.ZMLoadoutUtility.GetLoadoutStorageBuffer = function(f8_arg0)
	local f8_local0 = Enum[0xBBD4F9E70101BA8][0xA621D7C69E5741A]
	if not IsLocal() then
		if IsCustomLobby() then
			f8_local0 = Enum[0xBBD4F9E70101BA8][0x3376D9E1C3C8130]
		else
			f8_local0 = Enum[0xBBD4F9E70101BA8][0x9E5D6DF436F1EE]
		end
	end
	return Engine[0x8BF970606552F4C](f8_arg0, f8_local0)
end
CoD.ZMLoadoutUtility.GetVariantSlot = function(f9_arg0, f9_arg1, f9_arg2)
	...
	if not f9_local1 and f9_arg2 then
		...
		f9_local1.paintjobSlot:set(Enum[0xCA3F54D92F45B45][0x60CAA8D66ED63A5])
	end
...
CoD.ZMLoadoutUtility.SetArmoryWeaponAccessoryAttachment = function(f12_arg0, f12_arg1, f12_arg2)
	...
	for f12_local3 = 0, #f12_local1.attachment - 1, 1 do
		...
		if f12_local6 ~= CoD.CACUtility.EmptyItemIndex and not Engine[0x628AD12A64D07F](f12_local0, f12_arg2, f12_local6, f12_local2) then
	...
	if f12_local3 then
		...
		local f12_local4 = Engine[0x4DF5CFBC1771947](f12_arg1)
...
CoD.ZMLoadoutUtility.UpdateArmoryAttachments = function(f23_arg0, f23_arg1)
	...
	if f23_arg0._weaponItemModel and f23_arg0._weaponItemModel.hasOpticEquipped and f23_arg0._weaponItemModel.attachmentsEquippedCount then
		...
		for f23_local7, f23_local8 in ipairs(f23_arg0._armoryAttachmentTable) do
			local f23_local9 = Engine[0x2E29FB421AD554B](f23_arg0._weaponItemIndex, f23_local8.itemIndex, f23_local0)
	...
	local f23_local0 = Engine[0x4DF5CFBC1771947](f23_arg1)
...
CoD.ZMLoadoutUtility.GetWeaponOptionsTableForIndex = function(f24_arg0, f24_arg1, f24_arg2)
	...
	if IsLive() and f24_local0 then
		...
		Engine[0xAF3C2D1A783917D](f24_arg0, f24_local6)
		if f24_local6 ~= Enum[0xCA3F54D92F45B45][0x60CAA8D66ED63A5] then
			f24_local3 = 1
		end
	else
...
CoD.ZMLoadoutUtility.SetWeaponOptionForVariant = function(f26_arg0, f26_arg1, f26_arg2, f26_arg3)
	...
	if f26_local0 and f26_local1 and f26_local2 then
		...
		if f26_local5 == Enum[0x3CBA8D054211104][0x6C9BD564F3BA48B] then
		...
		if not f26_local7 then
			return
		elseif f26_local5 == Enum[0x3CBA8D054211104][0x43A5BEA0FB2891E] then
			local f26_local8 = f26_arg1:getModel(f26_arg2, "paintjobSlot")
			f26_local7.paintjobSlot:set(f26_local8:get())
		elseif f26_local5 == Enum[0x3CBA8D054211104][0x6C9BD564F3BA48B] then
			f26_local7.reticleIndex:set(f26_local4)
		elseif f26_local5 == Enum[0x3CBA8D054211104][0x393666961B28A15] then
			local f26_local8 = f26_local7.weaponModelSlot:get()
			local f26_local9 = Engine[0x9F0BB7D52A7A978](CoD.CACUtility.GetUnlockableItemInfoField(f26_local6, Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A], "nameHash"))
...
CoD.ZMLoadoutUtility.ClearWeaponOptionForVariant = function(f27_arg0, f27_arg1, f27_arg2, f27_arg3)
	...
	if f27_local3 then
		...
		if not f27_local4 then
			...
			if f27_local4 == Enum[0x3CBA8D054211104][0x393666961B28A15] then
				f27_local2.camoIndex:set(CoD.CACUtility.EmptyItemIndex)
			elseif f27_local4 == Enum[0x3CBA8D054211104][0x6C9BD564F3BA48B] then
				f27_local2.reticleIndex:set(CoD.CACUtility.EmptyItemIndex)
			elseif f27_local4 == Enum[0x3CBA8D054211104][0x43A5BEA0FB2891E] then
				f27_local2.paintjobSlot:set(Enum[0xCA3F54D92F45B45][0x60CAA8D66ED63A5])
			end
			CoD.WeaponOptionsUtility.UpdateWeaponOptionLists(f27_arg1, f27_arg2)
		end
	end
	f27_local4 = Enum[0x3CBA8D054211104][0xFC7C36E20E72CE4]
end
	...
	if f31_local2 then
		...
		for f31_local6 = 0, #f31_local2 - 1, 1 do
			...
			if CoD.CACUtility.EmptyItemIndex < f31_local9 and f31_arg2 ~= f31_local9 then
				if not Engine[0x628AD12A64D07F](f31_arg1, f31_local9, f31_arg2, f31_arg3) and (not Engine[0x689E378B0101DCE](f31_arg1, f31_local9) or not Engine[0x689E378B0101DCE](f31_arg1, f31_arg2)) then
					table.insert(f31_local0, {
						ref = Engine[0x2E29FB421AD554B](f31_arg1, f31_local9, f31_arg3),
						attachmentIndex = f31_local9,
					})
				end
				if f31_local5 then
					local f31_local10 = Engine[0x2E29FB421AD554B](f31_arg1, f31_local9, f31_arg3)
					...
					if f31_local4 or f31_local11 then
						...
						if f31_local11 then
							...
							f31_local10 = Engine[0x2E29FB421AD554B](f31_arg1, f31_arg2, f31_arg3)
...
CoD.ZMLoadoutUtility.ClearAllAttachments = function(f34_arg0, f34_arg1, f34_arg2)
	local f34_local0 = {}
	local f34_local1 = Engine[0xF8ECCDE64F061E1](f34_arg1, f34_arg2)
...
CoD.ZMLoadoutUtility.UpdateEquippedWeaponAttachmentAttributes = function(f35_arg0, f35_arg1, f35_arg2)
	local f35_local0 = Enum[0x4894073C9168D02][0x5B7E5FC5552F23A]
	local f35_local1 = Enum[0x4894073C9168D02][0x115E22D013F28C1]
	local f35_local2 = Enum[0x4894073C9168D02][0x51BABA455D2DC80]
	local f35_local3 = Enum[0x4894073C9168D02][0x1A6E182D6FE3472]
	local f35_local4 = Enum[0x4894073C9168D02][0x5083C82F930E500]
	local f35_local5 = Enum[0x4894073C9168D02][0x295ABB48F2C6284]
	...
	for f35_local19, f35_local20 in ipairs(f35_arg0._armoryAttachmentTable) do
		if f35_local20.itemIndex > CoD.CACUtility.EmptyItemIndex then
			local f35_local12 = Engine[0x2E29FB421AD554B](f35_arg1, f35_local20.itemIndex, f35_arg2)
			table.insert(f35_local8, f35_local12)
			local f35_local13 = Engine[0x2DCF0973239E909](CoD.weaponAttributes, f35_local2, f35_local0, f35_local12, f35_local1, f35_local6)
			local f35_local14 = Engine[0x2DCF0973239E909](CoD.weaponAttributes, f35_local3, f35_local0, f35_local12, f35_local1, f35_local6)
			local f35_local15 = Engine[0x2DCF0973239E909](CoD.weaponAttributes, f35_local4, f35_local0, f35_local12, f35_local1, f35_local6)
			local f35_local16 = Engine[0x2DCF0973239E909](CoD.weaponAttributes, f35_local5, f35_local0, f35_local12, f35_local1, f35_local6)
...
CoD.ZMLoadoutUtility.GetArmoryWeaponAttachmentList = function(f36_arg0, f36_arg1, f36_arg2, f36_arg3, f36_arg4, f36_arg5)
	...
	local f36_local2 = Engine[0xF8ECCDE64F061E1](f36_arg2, f36_arg5)
	...
	for f36_local5 = 1, f36_local2 - 1, 1 do
		local f36_local8 = Engine[0x174D9B6F1E719ED](f36_arg2, f36_local5, f36_arg5)
		if f36_local8 > CoD.CACUtility.EmptyItemIndex then
			local f36_local9 = Engine[0x2E29FB421AD554B](f36_arg2, f36_local5, f36_arg5)
			if f36_local9 ~= "ir" then
				local f36_local10 = Engine[0xD0520F158FE13E9](f36_arg2, f36_local5, f36_arg5)
				local f36_local11 = Engine[0x8FD38AB8CA1FA21](f36_arg2, f36_local5, f36_arg5)
				local f36_local12 = Engine[0x55B3AC1DC0E0003](f36_arg2, f36_local5, f36_arg5)
...
CoD.ZMLoadoutUtility.AppendEquippedPrestigeAttachment = function(f38_arg0, f38_arg1, f38_arg2, f38_arg3)
	...
	if f38_local0 ~= CoD.CACUtility.EmptyItemIndex and f38_arg3 then
		f38_arg3 = LUI.appendStringWithDelimiter(f38_arg3, Engine[0x2E29FB421AD554B](f38_arg1, f38_local0, f38_arg2), "+")
	end
	return f38_arg3
end
CoD.ZMLoadoutUtility.GetEquippedArmoryAttachments = function(f39_arg0, f39_arg1, f39_arg2)
	...
	local f39_local1 = Engine[0xDADCBC194F892B7](f39_arg1, f39_arg2) > 1
		...
		if f39_local7 then
			for f39_local8 = 0, #f39_local7 - 1, 1 do
				...
				if f39_local11 ~= CoD.CACUtility.EmptyItemIndex then
					...
					local f39_local13 = Engine[0x2E29FB421AD554B](f39_arg1, f39_local11, f39_arg2)
...
CoD.ZMLoadoutUtility.AddArmoryAttachmentModelsAndProperties = function(f40_arg0, f40_arg1, f40_arg2, f40_arg3)
	...
	local f40_local3
	if f40_local1 then
		f40_local3 = Engine[0xED84C33EC5F01EA](0x2EA924A41028AEA)
...
DataSources.ZMSpecialWeapons = ListHelper_SetupDataSource("ZMSpecialWeapons", function(f41_arg0, f41_arg1)
	...
	if f41_arg1._zmStorySubscription == nil then
		f41_local4 = Engine[0x4DF5CFBC1771947](f41_arg0)
...
CoD.ZMLoadoutUtility.SetupBGBLoadout = function(f43_arg0, f43_arg1, f43_arg2, f43_arg3)
	...
	for f43_local6, f43_local7 in pairs(CoD.ZMLoadoutUtility.BGBSlotPositions) do
		local f43_local8 = Engine[0x2321ACE1C24455D](f43_arg1, f43_arg2, f43_local7.index)
		local f43_local9 = Engine[0xE8B1E317B9DD6FE](f43_local8, Enum[0x6EB546760F890D2][0x48CD0338EE0B3AE], Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A])
		local f43_local10 = CoD.CACUtility.GetUnlockableItemInfo(f43_local9, Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A])
...
DataSourceHelpers.PerControllerDataSourceSetup("BGBLoadout", "BGBLoadout", function(f44_arg0, f44_arg1)
	...
	CoD.ZMLoadoutUtility.SetupBGBLoadout(f44_arg0, f44_arg1, Engine[0x68C87A9FEAC28F6](f44_arg1), nil)
...
DataSources.BGBCategories = ListHelper_SetupDataSource("BGBCategories", function(f45_arg0)
	local f45_local0 = Engine[0x68C87A9FEAC28F6](f45_arg0)
	local f45_local1 = DataSources.BGBLoadout.getModel(f45_arg0)
	local f45_local2 = Engine[0x2321ACE1C24455D](f45_arg0, f45_local0, f45_local1.selectedIndex:get())
	local f45_local3 = Engine[0x87395843D470BE2](f45_local2, Enum[0x6EB546760F890D2][0x48CD0338EE0B3AE], Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A])
	local f45_local4 = Engine[0x86DC0510B2E2933](f45_local2, Enum[0x6EB546760F890D2][0x48CD0338EE0B3AE], Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A])
...
DataSources.ArmoryWeaponAttachments = ListHelper_SetupDataSource(
	"ArmoryWeaponAttachments",
...
CoD.ZMLoadoutUtility.SetEquippedBubbleGumPackToSelectedClass = function(f51_arg0, f51_arg1, f51_arg2)
	...
	if f51_local0 == nil and IsZombies() then
		f51_local0 = Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A]
	end
	if f51_local0 == Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A] then
		local f51_local1 = f51_arg0:getModel()
		Engine[0x9F152D616D0B8F9](f51_arg1, f51_local1.classNum:get())
...
CoD.ZMLoadoutUtility.PreviewBubbleGumPack = function(f52_arg0, f52_arg1, f52_arg2)
	...
	if f52_local0 == nil and IsZombies() then
		f52_local0 = Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A]
	end
	if f52_local0 == Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A] then
		local f52_local1 = f52_arg0:getModel()
		f52_local1 = f52_local1.classNum:get()
		local f52_local2 = Engine[0x4DF5CFBC1771947](f52_arg1)
...
CoD.ZMLoadoutUtility.UpdateBubbleGumPackForCurrentClass = function(f53_arg0, f53_arg1, f53_arg2)
	...
	local f53_local2 = Engine[0x4DF5CFBC1771947](f53_arg2)
...
CoD.ZMLoadoutUtility.SaveZMLoadoutBuffer = function(f55_arg0)
	local f55_local0 = Enum[0xBBD4F9E70101BA8][0xA621D7C69E5741A]
	if not IsLocal() then
		if IsCustomLobby() then
			f55_local0 = Enum[0xBBD4F9E70101BA8][0x3376D9E1C3C8130]
		else
			f55_local0 = Enum[0xBBD4F9E70101BA8][0x9E5D6DF436F1EE]
		end
	end
	Engine[0x28A466EF7723621](f55_arg0, f55_local0)
end
...
CoD.ZMLoadoutUtility.AddBGBSelectMenuControls = function(f57_arg0, f57_arg1, f57_arg2, f57_arg3)
	...
	if IsFreeCursorActive(f57_arg3) then
		f57_arg0:AddButtonCallbackFunction(f57_arg0, f57_arg3, Enum[0x3DD78803F918E9D][0x57783F8DA4AAEF], nil, function(element, menu, controller, model)
			if IsFreeCursorActive(controller) and IsDpadButton(model) and not f57_local0("left") then
				f57_local1("left")
			end
		end, AlwaysFalse, false)
		f57_arg0:AddButtonCallbackFunction(f57_arg0, f57_arg3, Enum[0x3DD78803F918E9D][0x571F08AD84807E0], nil, function(element, menu, controller, model)
			if IsFreeCursorActive(controller) and IsDpadButton(model) and not f57_local0("right") then
				f57_local1("right")
			end
		end, AlwaysFalse, false)
		f57_arg0:AddButtonCallbackFunction(f57_arg0, f57_arg3, Enum[0x3DD78803F918E9D][0x4B11D2B20C75A7F], nil, function(element, menu, controller, model)
			if IsFreeCursorActive(controller) and IsDpadButton(model) and not f57_local0("up") then
				f57_local1("up")
			end
		end, AlwaysFalse, false)
		f57_arg0:AddButtonCallbackFunction(f57_arg0, f57_arg3, Enum[0x3DD78803F918E9D][0xD4C15FE32148D3A], nil, function(element, menu, controller, model)
...
CoD.ZMLoadoutUtility.UpdateArmoryWeaponModel = function(f67_arg0, f67_arg1, f67_arg2)
	...
	if f67_local4 and CoD.CACUtility.EmptyItemIndex < f67_local4 then
		...
		if f67_local6 then
			...
			local f67_local8 = Engine[0x2DCF0973239E909](CoD.CACUtility.CamoOptionsTable, Enum[0x5DD5CC8AEA7314B][0xAA94CABDA68EB21], Enum[0x5DD5CC8AEA7314B][0xB79D07B3744EA1A], "camo", Enum[0x5DD5CC8AEA7314B][0xA6342D60A0D5AAE], f67_local7)
	...
	if f67_local1 and f67_local2 then
		local f67_local8 = Engine[0x6ABA4D7F0840A1E]
...
CoD.ZMLoadoutUtility.UpdateArmoryAttachmentModel = function(f68_arg0, f68_arg1, f68_arg2, f68_arg3)
	...
	if f68_arg3 then
		...
		if CoD.CACUtility.EmptyItemIndex < f68_local6 then
			f68_local3 = f68_local3 .. "+" .. Engine[0x2E29FB421AD554B](f68_local7, f68_local6, f68_local1)
		end
	end
	if not IsInGame() and f68_local8 ~= 0x0 and f68_local7 then
		Engine[0x6ABA4D7F0840A1E](f68_arg2, "CustomClass_update" .. CoD.GetLocalClientAdjustedNum(f68_arg2), {
...
CoD.ZMLoadoutUtility.SetShowcaseWeapon = function(f75_arg0, f75_arg1, f75_arg2)
	...
	if f75_local2 and f75_local2.itemIndex then
		...
		Engine[0xFCCE0C9C2A40C9A](f75_arg1, f75_local0, f75_local1, 0x56C9496D7E38137, f75_local3)
		local f75_local4 = CoD.ZMLoadoutUtility.GetVariantSlot(f75_arg1, f75_local3, false)
		if f75_local4 then
			Engine[0xFCCE0C9C2A40C9A](f75_arg1, f75_local0, f75_local1, 0xD7F884DAFFAA30F, f75_local4.camoIndex:get())
			Engine[0xFCCE0C9C2A40C9A](f75_arg1, f75_local0, f75_local1, 0xEE983B435CE4912, f75_local4.weaponModelSlot:get())
		end
	end
	if f75_arg0.armoryAttachmentTable then
		for f75_local6, f75_local7 in ipairs(f75_arg0.armoryAttachmentTable) do
			Engine[0xFCCE0C9C2A40C9A](f75_arg1, f75_local0, f75_local1, 0x73F89AC8D3F248, f75_local7.itemIndex, f75_local6 - 1)
		end
	end
...
CoD.ZMLoadoutUtility.ShowBubblegumBuffModel = function(f76_arg0, f76_arg1, f76_arg2, f76_arg3)
	...
	if f76_local0 then
		...
		local f76_local3 = Engine[0x86DC0510B2E2933](f76_local1, Enum[0x6EB546760F890D2][0x48CD0338EE0B3AE], Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A])
		...
		local f76_local7 = 1
		local f76_local8 = CoD.CACUtility.GetUnlockableItemInfo(f76_local2, Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A])
		if f76_local8 then
			f76_local6 = f76_local8[0xB6404450C6BAEEF] or 0x0
			f76_local7 = f76_local8[0xB49D7582CD08B0E] or 1
		end
		Engine[0x6ABA4D7F0840A1E](f76_arg3, "CustomClass_update" .. CoD.GetLocalClientAdjustedNum(f76_arg3), {
...
CoD.ZMLoadoutUtility.EquipBubblegumBuff = function(f78_arg0, f78_arg1, f78_arg2)
	local f78_local0 = Engine[0x68C87A9FEAC28F6](f78_arg2)
	...
	if f78_local1 and f78_local1.classNum then
		...
		local f78_local2 = Engine[0x4DF5CFBC1771947](f78_arg2)
	...
	for f78_local6 = 0, CoD.BGBUtility.NumBuffsPerPack - 1, 1 do
		if Engine[0x2321ACE1C24455D](f78_arg2, f78_local0, f78_local6) == f78_local3 then
			f78_local5 = f78_local6
			f78_local4 = Engine[0x2321ACE1C24455D](f78_arg2, f78_local0, f78_local2)
			break
		end
	end
	Engine[0xE0D984A534D93C9](f78_arg2, f78_local0, f78_local2, f78_local3)
	if f78_local5 then
		Engine[0xE0D984A534D93C9](f78_arg2, f78_local0, f78_local5, f78_local4)
	end
	...
	f81_arg0:appendEventHandler("lose_focus", function(f83_arg0, f83_arg1)
		if IsMouseOrKeyboard(f83_arg1.controller) then
			...
			if f83_local0 == nil or f83_local0:getParent() ~= f83_arg0:getParent() then
				local f83_local1 = Engine[0x4DF5CFBC1771947](f81_arg1)
...
CoD.ZMLoadoutUtility.AddPreviewBumperNavigationPC = function(f84_arg0, f84_arg1, f84_arg2, f84_arg3)
	CoD.GridAndListUtility.AddGenericNavigationInternal(f84_arg1, f84_arg2, f84_arg3, nil, nil, Enum[0x3DD78803F918E9D][0x493152B20AE4F58], Enum[0x3DD78803F918E9D][0x49A252B20B48936], "zmQuickEquip", true, function()
...
CoD.ZMLoadoutUtility.UpdateZMSpecialWeaponStageModel = function(f89_arg0, f89_arg1, f89_arg2)
	...
	if f89_local2 and f89_local2.itemRefHash then
		Engine[0x6ABA4D7F0840A1E](f89_arg2, "CustomClass_update" .. CoD.GetLocalClientAdjustedNum(f89_arg2), {
...
CoD.ZMLoadoutUtility.ResetAttachmentListModelForWeaponAttributes = function(f92_arg0, f92_arg1, f92_arg2)
	...
	local f92_local3 = Engine[0xA798E4552F5E872](Engine[0xA798E4552F5E872](Engine[0x4DF5CFBC1771947](f92_arg2), "ZMArmoryNoAttachmentAttributesModel"), "weaponAttributes")
	...
	local f92_local6 = function(f93_arg0)
		...
		local f93_local1 = Engine[0xA798E4552F5E872](f92_local3, f93_arg0)
	...
	local f92_local7 = function(f94_arg0)
		...
		if f94_local0 ~= 0 then
			local f94_local1 = Engine[0xA798E4552F5E872](f92_local3, f94_arg0)
	...
	f92_local7("magCount")
	f92_local7("magSize")
	local f92_local8 = Engine[0xA798E4552F5E872](f92_local3, "uberName")
	f92_local8:set(f92_local5.uberName)
	f92_local8 = Engine[0xA798E4552F5E872](f92_local3, "uberImage")
...
CoD.ZMLoadoutUtility.GetUnlockDescriptionForFeature = function(f96_arg0, f96_arg1, f96_arg2)
	local f96_local0 = Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A]
...
CoD.ZMLoadoutUtility.GetUnlockRankIconLargeForFeature = function(f97_arg0, f97_arg1)
	local f97_local0 = Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A]
	...
	if f97_local1 and f97_local0 and CoD.CACUtility.IsProgressionEnabled(f97_local0) then
		...
		if f97_local2 then
			return Engine[0xE1B786B1A765D9E](Engine[0x6A28AE1C9C05372](f97_local2, Enum[0x6EB546760F890D2][0x3057ABF96AF8289], f97_local0), f97_local0)
		end
	end
	return 0x0
end
CoD.ZMLoadoutUtility.GetArmoryAttachmentUnlockDescription = function(f98_arg0, f98_arg1, f98_arg2)
	...
	if CoD.CACUtility.IsProgressionEnabled(f98_local2) and f98_local3 and f98_local3 > CoD.CACUtility.EmptyItemIndex then
		local f98_local4 = Engine[0x2F222B10B26FCEF](f98_local3, f98_local1, f98_local2)
		if f98_local4 then
...
CoD.ZMLoadoutUtility.GetEquippedSignatureWeaponImage = function(f99_arg0, f99_arg1, f99_arg2)
	if f99_arg0.useVariantSlot and f99_arg0.useVariantSlot:get() > 0 then
		...
		if f99_local1 and f99_local1 > 0 then
			local f99_local2 = CoD.CACUtility.GetUnlockableItemInfo(f99_local0, Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A])
			local f99_local3 = f99_local2.zmPreviewImage
			local f99_local4 = Engine[0x9F0BB7D52A7A978](Engine[0xB98952F69D937F9](f99_local0, Enum[0x6EB546760F890D2].STATINDEXOFFSET_WEAPON, Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A]))
...
CoD.ZMLoadoutUtility.GetEquippedSignatureWeaponName = function(f100_arg0, f100_arg1, f100_arg2)
	if f100_arg0.useVariantSlot and f100_arg0.useVariantSlot:get() > 0 then
		...
		if f100_local1 and f100_local1 > 0 then
			local f100_local2 = Engine[0xF9F1239CFD921FE](Engine[0x6B7AC889104DED3](f100_local0, Enum[0x6EB546760F890D2].STATINDEXOFFSET_WEAPON, Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A]))
			local f100_local3 = Engine[0x9F0BB7D52A7A978](Engine[0xB98952F69D937F9](f100_local0, Enum[0x6EB546760F890D2].STATINDEXOFFSET_WEAPON, Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A]))
			...
			local f100_local2 = CoD.CACUtility.GetUnlockableItemInfo(f100_local0, Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A])
...
CoD.ZMLoadoutUtility.IsBubbleGumBuffEquippedInCurrentSlot = function(f101_arg0, f101_arg1, f101_arg2)
	...
	local f101_local1 = Engine[0x40E824FE270E174](f101_local0, "itemIndex")
	if not f101_local1 then
		return false
	end
	local f101_local2 = Engine[0x68C87A9FEAC28F6](f101_arg2)
	...
	if f101_local3 and f101_local3.classNum then
		...
		local f101_local4 = Engine[0x4DF5CFBC1771947](f101_arg2)
		CoD.ZMLoadoutUtility.SetupBGBLoadout(f101_local4:create("BGBLoadout"), f101_arg2, f101_local2, f101_local3)
	end
	local f101_local4 = Engine[0x614D394F6F9A18D](f101_local1)
	local f101_local5 = DataSources.BGBLoadout.getModel(f101_arg2)
	if Engine[0x2321ACE1C24455D](f101_arg2, f101_local2, f101_local5.selectedIndex:get()) == f101_local4 then
		return true
	end
	return false
end
CoD.ZMLoadoutUtility.IsBubbleGumBuffEquippedInAnySlot = function(f102_arg0, f102_arg1, f102_arg2)
	...
	local f102_local2 = Engine[0x68C87A9FEAC28F6](f102_arg2)
	...
	if f102_local3 and f102_local3.classNum then
		...
		local f102_local4 = Engine[0x4DF5CFBC1771947](f102_arg2)
		CoD.ZMLoadoutUtility.SetupBGBLoadout(f102_local4:create("BGBLoadout"), f102_arg2, f102_local2, f102_local3)
	end
	local f102_local4 = Engine[0x614D394F6F9A18D](f102_local1)
	for f102_local5 = 0, CoD.BGBUtility.NumBuffsPerPack - 1, 1 do
		if Engine[0x2321ACE1C24455D](f102_arg2, f102_local2, f102_local5) == f102_local4 then
			return true
		end
	end
	return false
	...
	for f106_local8, f106_local9 in ipairs(f106_arg2) do
		...
		if f106_local2 <= f106_local1 and (not f106_local3 or f106_local8 <= 4) then
			if CoD.CACUtility.IsProgressionEnabled(f106_arg1) then
				if not Engine[0xF94404F8A25006A](f106_arg0, f106_arg3, f106_local7, f106_arg1) then
					return true
				end
			end
			return true
...
CoD.ZMLoadoutUtility.IsCACItemBubbleGum = function(f108_arg0, f108_arg1, f108_arg2)
	...
	if f108_local1 and f108_local1.itemIndex then
		...
		if CoD.CACUtility.EmptyItemIndex < f108_local2 then
			local f108_local3 = Engine[0x86DC0510B2E2933](f108_local2, Enum[0x6EB546760F890D2][0x48CD0338EE0B3AE], f108_local0)
...
CoD.ZMLoadoutUtility.IsBGBItemLocked = function(f109_arg0, f109_arg1, f109_arg2)
	if not CoD.CACUtility.IsProgressionEnabled(CoD.BaseUtility.GetMenuSessionMode(f109_arg0)) then
		...
		if not f109_local0 or f109_local0 < Enum[0x15A59C8C59697E5][0xAE7A7ACDC9568EC] then
			return CoD.CACUtility.IsCACItemLocked(f109_arg0, f109_arg1, f109_arg2)
		else
			return not Engine[0xB521CB398C92692](f109_arg2, Engine[0xC53F8D38DF9042B]("dlc" .. f109_local0 - Enum[0x15A59C8C59697E5][0x1F3DD02BF22E47A]))
		end
	end
end
CoD.ZMLoadoutUtility.ShouldHideLoadoutPreviewSelectButton = function(f110_arg0, f110_arg1, f110_arg2, f110_arg3, f110_arg4)
	...
	if f110_local2 and f110_local2.classNum then
		f110_local1 = CoD.CACUtility.IsFeatureItemLocked(f110_arg2, CoD.CACUtility.GetClassesUnlockableItemUnlockInfo(f110_local2.classNum:get(), "featureItemIndex"), Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A])
	end
	return f110_local0 or f110_local1
end
CoD.ZMLoadoutUtility.IsCurrentPreviewClassLocked = function(f111_arg0, f111_arg1)
	local f111_local0 = Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A]
...
CoD.ZMLoadoutUtility.IsArmoryAttachmentItemLocked = function(f112_arg0, f112_arg1, f112_arg2)
	...
	if f112_local1 and f112_local2 and CoD.CACUtility.EmptyItemIndex < f112_local2 then
		...
		if CoD.CACUtility.EmptyItemIndex < f112_local3 then
			return Engine[0x758EBFCB1826DAD](f112_arg2, f112_local2, f112_local3, f112_local0)
		end
	end
	return false
end
...
CoD.ZMLoadoutUtility.IsAttachmentSlotLocked = function(f115_arg0, f115_arg1, f115_arg2, f115_arg3)
	...
	if not CoD.CACUtility.IsProgressionEnabled(f115_local0) or f115_local0 ~= Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A] then
		return false
	end
	...
	if f115_local1 and f115_local1.itemIndex then
		...
		if CoD.CACUtility.EmptyItemIndex < f115_local2 then
			return Engine[0xF94404F8A25006A](f115_arg2, f115_local2, f115_arg3, f115_local0)
		end
	end
	return false
end
CoD.ZMLoadoutUtility.IsAttachmentMutuallyExclusiveWithSelection = function(f116_arg0, f116_arg1, f116_arg2)
	local f116_local0 = Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A]
...
CoD.ZMLoadoutUtility.IsWeaponOptionEquipped = function(f117_arg0, f117_arg1, f117_arg2, f117_arg3)
	...
	if f117_local2 and f117_local1 and f117_local1[f117_arg3] then
		...
		if f117_local5 == Enum[0x3CBA8D054211104][0x6C9BD564F3BA48B] then
		...
		elseif f117_local5 == Enum[0x3CBA8D054211104][0x43A5BEA0FB2891E] and f117_local2.paintjobSlot then
			local f117_local6 = f117_local2.paintjobSlot:get()
			if f117_local6 ~= Enum[0xCA3F54D92F45B45][0x60CAA8D66ED63A5] then
...
CoD.ZMLoadoutUtility.UpdateZMSpecialWeaponActiveStageModel = function(f123_arg0, f123_arg1)
	...
	if f123_local0 then
		...
		if f123_local1 then
			local f123_local2 = Engine[0x4DF5CFBC1771947](f123_arg1)
			if f123_local2[f123_local1] then
				f123_local2 = Engine[0x4DF5CFBC1771947](f123_arg1)
				if f123_local2[f123_local1]["1"] then
					...
					local f123_local5 = Engine[0x4DF5CFBC1771947](f123_arg1)
