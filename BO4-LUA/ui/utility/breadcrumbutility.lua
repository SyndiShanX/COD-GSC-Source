...
CoD.BreadcrumbUtility.GetStorageClientBufferForPlayer = function ( f10_arg0, f10_arg1 )
	if not f10_arg1 then
		f10_arg1 = Engine[0x3EAC408F958FF05]()
	end
	if f10_arg1 == Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A] then
		return Engine[0x8BF970606552F4C]( f10_arg0, Enum[0xBBD4F9E70101BA8][0xEC77AD28A19F8E0] )
	elseif f10_arg1 == Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39] then
		return Engine[0x8BF970606552F4C]( f10_arg0, Enum[0xBBD4F9E70101BA8][0xD1A0F784B3C95A0] )
	else
		return Engine[0x8BF970606552F4C]( f10_arg0, Enum[0xBBD4F9E70101BA8][0xFDE358A242AFA2C] )
	end
end
CoD.BreadcrumbUtility.GetStorageLoadoutBufferForPlayer = function ( f11_arg0, f11_arg1 )
	if not f11_arg1 then
		f11_arg1 = Engine[0x3EAC408F958FF05]()
	end
	local f11_local0 = Enum[0xBBD4F9E70101BA8][0x6C886CEB6BF4BCA]
	if f11_arg1 == Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A] then
		f11_local0 = Enum[0xBBD4F9E70101BA8][0x9E5D6DF436F1EE]
	elseif f11_arg1 == Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39] then
		f11_local0 = Enum[0xBBD4F9E70101BA8][0xDF87425733853AE]
	end
	local f11_local1 = Engine[0x8BF970606552F4C]( f11_arg0, f11_local0 )
	if f11_local1 then
...
CoD.BreadcrumbUtility.IsStatSpecialistOutfitItemNew = function ( f24_arg0, f24_arg1, f24_arg2, f24_arg3, f24_arg4, f24_arg5 )
	...
	if f24_arg0._sessionMode == Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A] then
...
CoD.BreadcrumbUtility.ClearSpecialistOutfitItem = function ( f38_arg0, f38_arg1, f38_arg2, f38_arg3, f38_arg4, f38_arg5 )
	...
	if f38_arg0._sessionMode == Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A] then
...
CoD.BreadcrumbUtility.GetLootWeaponNewCountForCategory = function ( f45_arg0, f45_arg1, f45_arg2 )
	...
	for f45_local5, f45_local6 in ipairs( CoD.CACUtility.GetUnlockableItemsForItemGroup( f45_arg1, f45_local1, f45_arg2 ) ) do
		if not Engine[0x191C1637A229078]( f45_arg1, f45_local6.globalItemIndex, f45_local1 ) then
...
CoD.BreadcrumbUtility.GetEmblemNewCountFromOwned = function ( f48_arg0, f48_arg1, f48_arg2 )
	...
	if not IsUserContentRestricted( f48_arg1 ) then
		...
		if f48_local1 and f48_local1[0x873C248BAA41A06] and f48_local1[0x2799A890D40252F] then
			local f48_local2 = Engine[0xC1EF938E568714]( f48_arg1, 0, f48_arg2 )
			for f48_local3 = 0, f48_local2 - 1, 1 do
				local f48_local6 = Engine[0x8C223AA63A664D]( f48_arg1, 0, f48_arg2, f48_local3 )
...
CoD.BreadcrumbUtility.GetEmblemByCategoryNewCount = function ( f49_arg0, f49_arg1, f49_arg2 )
	...
	if not IsUserContentRestricted( f49_arg1 ) then
		local f49_local1 = Engine[0xC1EF938E568714]( f49_arg1, 0, f49_arg2 )
		for f49_local2 = 0, f49_local1 - 1, 1 do
			local f49_local5 = false
			local f49_local6 = Engine[0x8C223AA63A664D]( f49_arg1, 0, f49_arg2, f49_local2 )
...
CoD.BreadcrumbUtility.UpdateOwnedCallingCardsAndCount = function ( f51_arg0, f51_arg1, f51_arg2 )
	...
	if IsLive() and f51_arg2 == "loot" then
		...
		elseif f51_arg2 == "mp" then
			f51_local0 = CoD.ChallengesUtility.GetChallengeCardsForSessionMode( f51_arg1, Enum[0x9C0C2196D8313A0][0x83EBA96F36BC4E5], f51_arg2, false )
		elseif f51_arg2 == "zm" then
			f51_local0 = CoD.ChallengesUtility.GetChallengeCardsForSessionMode( f51_arg1, Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A], f51_arg2, false )
		elseif f51_arg2 == "wz" then
			f51_local0 = CoD.ChallengesUtility.GetChallengeCardsForSessionMode( f51_arg1, Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39], f51_arg2, false )
...
CoD.BreadcrumbUtility.UpdateSprayGestureNewCountTable = function ( f52_arg0, f52_arg1, f52_arg2 )
	...
	if not f52_arg0._sessionMode then
		local f52_local1 = Engine[0x3EAC408F958FF05]()
	end
	...
	if f55_arg0._itemRefHash and f55_arg0._attachmentRef then
		...
		if f55_local1 then
			for f55_local7, f55_local8 in ipairs( f55_local1 ) do
				...
				if (f55_local6.available or f55_local8.entitlement and Engine[0xB521CB398C92692]( f55_arg1, f55_local8.entitlement )) and CoD.BreadcrumbUtility.IsStatWeaponOpticNew( f55_arg0, f55_arg1, f55_arg0._itemRefHash, f55_local8.weaponOptionSubIndex ) then
...
CoD.BreadcrumbUtility.BuildWeaponCamoTable = function ( f56_arg0, f56_arg1, f56_arg2, f56_arg3 )
	...
	local f56_local1 = Engine[0x910CBCCD3C164C9]( CoD.attachmentTable, Enum[0xAAB93F26A00CE2][0xBE9816FAD8AD2D2], "lootbase" )
	if f56_local1 then
		for f56_local5, f56_local6 in ipairs( f56_local1 ) do
			local f56_local7 = Engine[0xC6F8EC444864600]( CoD.attachmentTable, f56_local6, Enum[0xAAB93F26A00CE2][0x419575E672F6FA2] )
			if f56_local7 then
	...
	if f56_arg3 then
		local f56_local2 = Engine[0x910CBCCD3C164C9]( CoD.attachmentTable, Enum[0xAAB93F26A00CE2][0xBE9816FAD8AD2D2], "active" )
		if f56_local2 then
			for f56_local6, f56_local7 in ipairs( f56_local2 ) do
				local f56_local8 = Engine[0xC6F8EC444864600]( CoD.attachmentTable, f56_local7, Enum[0xAAB93F26A00CE2][0x419575E672F6FA2] )
				if f56_local8 then
		...
		for f58_local9, f58_local10 in ipairs( f58_arg2 ) do
			...
			if f58_local10 and f58_local10.ref and f58_local10.ref:get() then
				...
				elseif f58_local4 then
					local f58_local5 = Engine[0x2DCF0973239E909]( CoD.CACUtility.CamoOptionsTable, Enum[0x5DD5CC8AEA7314B][0xA6342D60A0D5AAE], Enum[0x5DD5CC8AEA7314B][0xAA94CABDA68EB21], f58_local4 )
					local f58_local6 = Engine[0x2DCF0973239E909]( CoD.attachmentTable, Enum[0xAAB93F26A00CE2][0xCD7120E6EC7A6DF], Enum[0xAAB93F26A00CE2][0x419575E672F6FA2], f58_local4 )
					local f58_local7
					if f58_local4 then
...
CoD.BreadcrumbUtility.DecrementPrimarySecondaryBreadCrumbCount = function ( f59_arg0, f59_arg1, f59_arg2 )
	...
	if f59_local0 then
		if f59_local1 == Enum[0x9C0C2196D8313A0][0x83EBA96F36BC4E5] then
		...
		elseif f59_local1 == Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A] then
			f59_local0.breadcrumbCount:set( math.max( 0, f59_local0.breadcrumbCount:get() - 1 ) )
		elseif f59_local1 == Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39] then
			f59_local0.breadcrumbCount:set( math.max( 0, f59_local0.breadcrumbCount:get() - 1 ) )
		end
	end
end
...
CoD.BreadcrumbUtility.UploadBuffer = function ( f62_arg0, f62_arg1 )
	Engine[0x28A466EF7723621]( f62_arg0, f62_arg1 )
end
...
CoD.BreadcrumbUtility.SetLootWeaponAsOld = function ( f69_arg0, f69_arg1, f69_arg2 )
	...
	if f69_local1 then
		...
		local f69_local4 = Engine[0xDFCA8C2FD92A9DE]( f69_local1.itemIndex:get(), f69_local0 )
...
CoD.BreadcrumbUtility.SetSignatureWeaponAsOld = function ( f70_arg0, f70_arg1, f70_arg2 )
	...
	if f70_local1 then
		...
		if f70_local3 >= 1 then
			...
			local f70_local4 = Engine[0xDFCA8C2FD92A9DE]( f70_local1.itemIndex:get(), f70_local0 )
...
CoD.BreadcrumbUtility.SetSpecialistOutfitItemAsOld = function ( f75_arg0, f75_arg1, f75_arg2 )
	...
	if f75_local1 and f75_local0 and f75_local0.outfitIndex and CoD.ModelUtility.IsSelfModelValueNilOrTrue( f75_arg1, f75_arg2, "owned" ) then
		...
		local f75_local7 = Engine[0x3EAC408F958FF05]()
	...
	if f83_local0 then
		...
		if not f83_local1 then
			...
			if f83_local0 and f83_local1 == true and CoD.BreadcrumbUtility.IsWeaponCamoNew( f83_arg0, f83_arg1, f83_arg2 ) then
				...
				local f83_local3 = Engine[0x2DCF0973239E909]( CoD.CACUtility.CamoOptionsTable, Enum[0x5DD5CC8AEA7314B][0xA6342D60A0D5AAE], Enum[0x5DD5CC8AEA7314B][0xAA94CABDA68EB21], CoD.SafeGetModelValue( f83_local0, "ref" ) )
...
CoD.BreadcrumbUtility.UpdateStartMenuBreadcrumb = function ( f85_arg0 )
	...
	if not IsLobbyNetworkModeLAN() and Engine[0xA6C26EBACD7322D]( f85_arg0, CoD.STATS_LOCATION_NORMAL, Enum[0x9C0C2196D8313A0][0x83EBA96F36BC4E5] ) then
...
CoD.BreadcrumbUtility.IsWeaponCamoNew = function ( f90_arg0, f90_arg1, f90_arg2 )
	...
	local f90_local1 = Engine[0x2DCF0973239E909]( CoD.CACUtility.CamoOptionsTable, Enum[0x5DD5CC8AEA7314B][0xA6342D60A0D5AAE], Enum[0x5DD5CC8AEA7314B][0xAA94CABDA68EB21], f90_arg1 and CoD.SafeGetModelValue( f90_arg1:getModel(), "ref" ) )
...
CoD.BreadcrumbUtility.IsAnyOpticsNew = function ( f91_arg0, f91_arg1, f91_arg2 )
	...
	if not CoD.CACUtility.IsProgressionEnabled( f91_local0 ) then
		...
		if f91_local1 and f91_local1[f91_arg2] and f91_local1[f91_arg2].itemIndex then
			...
			return Engine[0x401C7B9C4F53D57]( f91_arg1, f91_local2, f91_local0 )
		else
			return false
		end
	end
...
CoD.BreadcrumbUtility.IsAnyAttachmentsNew = function ( f92_arg0, f92_arg1, f92_arg2 )
	...
	if not CoD.CACUtility.IsProgressionEnabled( f92_local0 ) then
		...
		if f92_local1 and f92_local1[f92_arg2] and f92_local1[f92_arg2].itemIndex then
			...
			return Engine[0x36A8CA278F6DF15]( f92_arg1, f92_local2, f92_local0 )
		else
			return false
		end
	end
...
CoD.BreadcrumbUtility.IsAnyLoadoutSlotNew = function ( f93_arg0, f93_arg1 )
	...
	elseif f93_local2 then
		return Engine[0xD9F199FB1C745F]( f93_arg1, f93_local2 )
	else
		return false
	end
end
...
CoD.BreadcrumbUtility.UpdateNewBreadcrumbPersonalizationString = function ( f111_arg0, f111_arg1, f111_arg2 )
	...
	if f111_local0 then
		...
		if f111_local2 and f111_local2 > 0 then
			local f111_local3 = Engine[0x3EAC408F958FF05]()
			local f111_local4 = {
...
DataSourceHelpers.PerControllerDataSourceSetup( "StartMenuBreadcrumbs", "Breadcrumbs.startMenu", function ( f112_arg0, f112_arg1 )
	...
	local f112_local0 = Engine[0x3EAC408F958FF05]()
...
DataSourceHelpers.PerControllerDataSourceSetup( "CharacterBreadcrumbs", "Breadcrumbs.characters", function ( f115_arg0, f115_arg1 )
	local f115_local0 = Engine[0x3EAC408F958FF05]()
	local f115_local1 = f115_arg0:create( "breadcrumbCount" )
	f115_local1:set( 0 )
	if f115_local0 ~= Enum[0x9C0C2196D8313A0][0xB22E0240605CFFE] and not IsInGame() and not IsLobbyNetworkModeLAN() then
		...
		local f115_local4 = {}
		for f115_local5 = 0, Enum[0x9C0C2196D8313A0][0x96642BDE9B5962E] - 1, 1 do
		...
		local f115_local5 = function ()
			return f115_local0 == Engine[0x3EAC408F958FF05]()
		end
			...
			for f115_local8, f115_local16 in ipairs( f115_local3 ) do
				if f115_local16 and f115_local16.bodyIndex then
					...
					if CoD.PlayerRoleUtility.IsRoleUnlocked( f115_arg1, f115_local0, f115_local11 ) then
						...
						if f115_local0 == Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39] then
...
DataSourceHelpers.PerControllerDataSourceSetup( "DepotBreadcrumbs", "Breadcrumbs.depot", function ( f120_arg0, f120_arg1 )
	...
	CoD.BreadcrumbUtility.AddChildCountLink( f120_arg1, f120_local0, f120_local2.breadcrumbCount, function ()
		return Engine[0x3EAC408F958FF05]() == Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39]
	end )
...
DataSourceHelpers.PerControllerDataSourceSetup( "SprayGestureBreadcrumbs", "Breadcrumbs.sprayGesture", function ( f122_arg0, f122_arg1 )
	...
	updateAllSprayGestureBreadcrumbs = function ( f123_arg0, f123_arg1, f123_arg2 )
		...
		if f123_arg1 == Enum[0x9C0C2196D8313A0][0x83EBA96F36BC4E5] or f123_arg1 == Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39] then
	...
	updateJumpkitBreadcrumbs = function ( f126_arg0, f126_arg1 )
		if Engine[0x3EAC408F958FF05]() == Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39] then
			CoD.BreadcrumbUtility.QueueBreadcrumbTask( f126_arg0, "updateJumpkitBreadcrumbs ", function ()
				...
				local f127_local1 = Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39]
				local f127_local3 = {
		...
		if f128_local0 and #f128_local0 > 0 then
			...
			for f128_local16, f128_local17 in ipairs( CoDLoadoutsShared.characterCustomizationRegions ) do
				if f128_local17.requiresBreadcrumb then
					...
					if f128_local17.type ~= Enum[0xFCC6A2D2EB0FDA7][0x7852FCB3BFCC8D1] then
						...
						if f128_local22[f128_local17.name] then
							...
							for f128_local24 = 1, #f128_local22[f128_local17.name], 1 do
								if f128_local21 ~= 1 or f128_local24 ~= 1 then
									...
									if not f128_local29 and f128_local17.type == Enum[0xFCC6A2D2EB0FDA7][0x8E3A65D78229DC1] and f128_local27.lootId ~= 0x0 then
...
DataSourceHelpers.PerControllerDataSourceSetup( "EmblemCallingCardBreadcrumbs", "Breadcrumbs", function ( f136_arg0, f136_arg1 )
	local f136_local0 = Enum[0x9C0C2196D8313A0][0x83EBA96F36BC4E5]
...
DataSourceHelpers.PerControllerDataSourceSetup( "LoadoutBreadcrumbs", "Breadcrumbs", function ( f144_arg0, f144_arg1 )
	local f144_local0 = Engine[0x3EAC408F958FF05]()
	local f144_local1 = Engine[0x4DF5CFBC1771947]( f144_arg1 )
	f144_local1 = f144_local1.isInPaintshop
	if f144_local1 and f144_local1:get() == true then
		f144_local0 = Enum[0x9C0C2196D8313A0][0x83EBA96F36BC4E5]
	end
	local f144_local2 = {
