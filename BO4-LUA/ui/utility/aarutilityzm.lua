	...
	if f4_local1 then
		...
		if not f4_local3 then
			...
			if f4_local0 then
				...
				for f4_local13, f4_local14 in ipairs(Engine[0xF53C0EFB693F362](f4_arg0)) do
					if f4_local14.type == Enum[0x30E44A363F3414C][0x398A3DF84F4A233] then
						local f4_local12 = tonumber(Engine[0xC6F8EC444864600](CoD.getStatsMilestoneTable(f4_local14.tableNumber + 1), f4_local14.row, Enum[0x5D8958B21A067C9][0xADDE5074A3A02E1]))
						if f4_local12 then
			...
			local f4_local15 = Engine[0xA798E4552F5E872](Engine[0x4DF5CFBC1771947](f4_arg0), "aarStats.performanceTabStats")
			for f4_local13, f4_local14 in pairs(f4_local8) do
				Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](f4_local15, f4_local13), f4_local14)
			end
			if CoD.isFrontend and f4_arg0 ~= 0 then
				f4_local9 = Engine[0xA798E4552F5E872](Engine[0x4DF5CFBC1771947](0), "aarStats.performanceTabStats")
				for f4_local14, f4_local16 in pairs(f4_local8) do
					Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](f4_local9, f4_local14), f4_local16)
				end
			end
...
CoD.AARUtilityZM.GetModelForRewardItemByIndex = function(f6_arg0, f6_arg1)
	return Engine[0x40E824FE270E174](Engine[0x4DF5CFBC1771947](f6_arg0), "aarRewards." .. f6_arg1)
end
...
CoD.AARUtilityZM.CreateQuestItemModels = function(f8_arg0)
	local f8_local0 = Engine[0xA798E4552F5E872](Engine[0x4DF5CFBC1771947](f8_arg0), "aarQuests")
end
