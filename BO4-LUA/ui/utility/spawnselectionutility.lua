	...
	if f1_local0 then
		...
		local f1_local10 = function ( f2_arg0, f2_arg1 )
			...
			if Engine[0x17B32C04C4BE462]( Engine[0xC3DF042E7492B66]( Enum[0x7CA2DE5266A94BF][0xC46B73E8E18BA2] ) ) == Enum[0x8409AA0F01B5DBC][0xB3A1BBF18C0B176] or IsSimulateCT() then
				Engine[0xC554A8C36EF7EFF]( f1_arg2, CoD.SpawnSelectionUtility.MenuResponseName, "SpawnRegionFocus", f1_arg0.selectedRegion.objId )
			end
		end
...
CoD.SpawnSelectionUtility.FindBeaconTargetedByCursor = function ( f7_arg0, f7_arg1, f7_arg2 )
	...
	for f7_local6, f7_local7 in pairs( f7_arg0.beacons ) do
		if Engine[0x879C9464C18718]( f7_arg1, f7_local7, f7_local1.name, f7_arg2.x, f7_arg2.y ) then
...
CoD.SpawnSelectionUtility.MoveSelectionToTargetedBeacon = function ( f9_arg0, f9_arg1, f9_arg2 )
	...
	if f9_local1 then
		...
		Engine[0xC4146BA76D0F982]( "uin_main_edit", f9_arg1 )
	end
end
...
CoD.SpawnSelectionUtility.PositionObjectiveMarker = function ( f11_arg0, f11_arg1, f11_arg2, f11_arg3 )
	local f11_local0, f11_local1, f11_local2 = Engine[0xC39E4C676019B6D]( f11_arg1, f11_arg3 )
...
CoD.SpawnSelectionUtility.IsObjectiveInActiveState = function ( f13_arg0 )
	local f13_local0
	if f13_arg0 ~= Enum[0xA2C16942D15B316][0x54563D60375E060] and f13_arg0 ~= Enum[0xA2C16942D15B316][0x59FDE7D12BCC045] then
		f13_local0 = false
	else
		f13_local0 = true
	end
...
CoD.SpawnSelectionUtility.IsObjectiveSpawnBeacon = function ( f14_arg0, f14_arg1 )
	return Engine[0xBE25B67EDE3D9F9]( f14_arg0, f14_arg1 ) == 0x8D1C6C697374044
end
CoD.SpawnSelectionUtility.IsObjectiveDeathMarker = function ( f15_arg0, f15_arg1 )
	return Engine[0xBE25B67EDE3D9F9]( f15_arg0, f15_arg1 ) == 0x18F4438220254D1
end
CoD.SpawnSelectionUtility.IsObjectiveSpawnGroup = function ( f16_arg0, f16_arg1 )
	if Engine[0xBE25B67EDE3D9F9]( f16_arg0, f16_arg1 ) then
		return false
	else
		return false
	end
...
CoD.SpawnSelectionUtility.IsObjectiveTeamOwned = function ( f17_arg0, f17_arg1 )
	return CoD.TeamUtility.GetTeamID( f17_arg0 ) == Engine[0x4C77EAF5F088DC3]( f17_arg0, f17_arg1 )
end
CoD.SpawnSelectionUtility.IsSpawnEMPDisabled = function ( f18_arg0, f18_arg1 )
	if f18_arg1 ~= f0_local0 then
		return Engine[0x12267460B50F00A]( f18_arg0, f18_arg1 ) == f0_local1
	else
		return false
	end
end
CoD.SpawnSelectionUtility.IsSpawnManualDisabled = function ( f19_arg0, f19_arg1 )
	if f19_arg1 ~= f0_local0 then
		return Engine[0x12267460B50F00A]( f19_arg0, f19_arg1 ) == f0_local2
	else
		return false
	end
end
...
CoD.SpawnSelectionUtility.GetObjectiveModel = function ( f21_arg0, f21_arg1 )
	return Engine[0x40E824FE270E174]( Engine[0x4DF5CFBC1771947]( f21_arg0 ), "objective" .. f21_arg1 )
end
...
CoD.SpawnSelectionUtility.SetupDeathMarker = function ( f27_arg0, f27_arg1, f27_arg2, f27_arg3 )
	...
	if f27_local0 and Engine[0x869E84B826141D2]( f27_arg1 ) == Engine[0xC43D7E71B1CA70B]( f27_arg1, f27_arg3 ) then
		...
		f27_local0:subscribeToModel( f27_local2, function ( model )
			if not CoD.SpawnSelectionUtility.IsObjectiveInActiveState( Engine[0x614D394F6F9A18D]( model ) ) then
...
CoD.SpawnSelectionUtility.SetupSpawnSelectControls = function ( f42_arg0, f42_arg1, f42_arg2, f42_arg3 )
	...
	local f42_local1 = function ( f46_arg0 )
		if CoD.SpawnSelectionUtility.IsSpawnSelectActive( f42_arg1 ) and f42_arg3._readyForInput and not f42_local0() and CoD.BitUtility.IsBitwiseAndNonZero( Engine[0x614D394F6F9A18D]( f46_arg0 ), Enum[0xE29E259801BC1A4][0x253A6F6CAAAE464] ) and not f42_arg2.m_disableAllButtonActions and not CoD.SpawnSelectionUtility.IsKillcamFullscreen( f42_arg0 ) and not CoD.SpawnSelectionUtility.IsKillcamAnimating( f42_arg0 ) then
			...
			if CoD.isPC and f46_local0 and f46_local0 ~= f42_arg3.selectedRegion then
				...
				Engine[0xC4146BA76D0F982]( "uin_main_edit", f42_arg1 )
			elseif f46_local0 and f46_local0 == f42_arg3.selectedRegion then
				if not CoD.SpawnSelectionUtility.IsSpawnEMPDisabled( f42_arg1, f46_local0.objId ) and not CoD.SpawnSelectionUtility.IsSpawnManualDisabled( f42_arg1, f46_local0.objId ) and CoD.SpawnSelectionUtility.IsSpawnBeaconActive( f42_arg1, f46_local0 ) then
					if IsGameTypeCombatTraining() and IsPC() and not IsGamepad( f42_arg1 ) then
						Engine[0xC554A8C36EF7EFF]( f42_arg1, CoD.SpawnSelectionUtility.MenuResponseName, "SpawnSelectKeyboard", f46_local0.objId )
					end
					Engine[0xC554A8C36EF7EFF]( f42_arg1, CoD.SpawnSelectionUtility.MenuResponseName, "SpawnRegion", f46_local0.objId )
	...
	f42_arg3:subscribeToModel( Engine[0x40E824FE270E174]( Engine[0x4DF5CFBC1771947]( f42_arg1 ), "ButtonBits." .. Enum[0x3DD78803F918E9D][0x755DA1E2E7C263F] ), f42_local1, false )
	f42_arg3:subscribeToModel( Engine[0x40E824FE270E174]( Engine[0x4DF5CFBC1771947]( f42_arg1 ), "ButtonBits." .. Enum[0x3DD78803F918E9D][0xC083113BC81F23F] ), f42_local1, false )
	if CoD.isPC then
		local f42_local2 = function ( f47_arg0, f47_arg1 )
			if CoD.SpawnSelectionUtility.IsSpawnSelectActive( f42_arg1 ) and f42_arg3._readyForInput then
				local f47_local0 = Engine[0x614D394F6F9A18D]( f47_arg0 )
				if not CoD.BitUtility.IsBitwiseAndNonZero( f47_local0, Enum[0xE29E259801BC1A4][0x3DC8FC0E6AB543F] ) and CoD.BitUtility.IsBitwiseAndNonZero( f47_local0, Enum[0xE29E259801BC1A4][0x253A6F6CAAAE464] ) then
		...
		f42_arg3:subscribeToModel( Engine[0x40E824FE270E174]( Engine[0x4DF5CFBC1771947]( f42_arg1 ), "KeyPressBits.ESCAPE" ), function ( model )
			local f48_local0 = Engine[0x614D394F6F9A18D]( model )
			local f48_local1 = CoD.BitUtility.IsBitwiseAndNonZero( f48_local0, Enum[0xE29E259801BC1A4][0x253A6F6CAAAE464] )
			local f48_local2 = CoD.BitUtility.IsBitwiseAndNonZero( f48_local0, Enum[0xE29E259801BC1A4][0x3DC8FC0E6AB543F] )
		...
		f42_arg3:subscribeToModel( Engine[0x40E824FE270E174]( Engine[0x4DF5CFBC1771947]( f42_arg1 ), "KeyPressBits.SPACE" ), f42_local1, false )
		f42_arg3:subscribeToModel( Engine[0x40E824FE270E174]( Engine[0x4DF5CFBC1771947]( f42_arg1 ), "KeyPressBits.MOUSE1" ), f42_local1, false )
		if CursorInputEnabledForBuild( f42_arg1 ) then
			...
			local f42_local6 = Engine[0x4DF5CFBC1771947]( f42_arg1 )
			f42_local5( f42_local4, f42_local6.LastInput, function ( f54_arg0 )
				if CoD.SpawnSelectionUtility.IsSpawnSelectActive( f42_arg1 ) and f42_arg3._readyForInput and not f42_arg0.SpawnSelectionMap.selectedRegion and not Engine[0x6C1F6DEE7AF457B]() then
...
CoD.SpawnSelectionUtility.SetupSpawnSelectionMap = function ( f55_arg0, f55_arg1, f55_arg2 )
	...
	if f55_local0 then
		local f55_local1 = Engine[0x8DF2E5447F384B9]()
	...
	if not f55_arg0.newObjSubscription then
		f55_arg0.newObjSubscription = f55_arg0:subscribeToModel( Engine[0xA798E4552F5E872]( Engine[0x4DF5CFBC1771947]( f55_arg1 ), "newObjective" ), function ( model )
			if not CoD.SpawnSelectionUtility.IsKillcamActive( f55_arg1 ) then
				local f56_local0 = Engine[0x614D394F6F9A18D]( model )
				if f56_local0 then
					...
					if CoD.SpawnSelectionUtility.IsObjectiveTeamOwned( f55_arg1, f56_local0 ) then
						if f56_local1 then
							...
							local f56_local5 = Engine[0x4DF5CFBC1771947]( f55_arg1 )
...
CoD.SpawnSelectionUtility.SendMenuResponseForRecommendedRegion = function ( f60_arg0, f60_arg1, f60_arg2, f60_arg3 )
	if f60_arg3 then
		...
		Engine[0xC554A8C36EF7EFF]( f60_arg1, CoD.SpawnSelectionUtility.MenuResponseName, "SpawnRegion", f60_local0 )
	end
end
...
CoD.SpawnSelectionUtility.InitTimeLimit = function ( f65_arg0, f65_arg1, f65_arg2 )
	...
	local f65_local2 = Engine[0x4DF5CFBC1771947]( f65_arg1 )
...
CoD.SpawnSelectionUtility.RestoreNormalViewport = function ( f66_arg0, f66_arg1, f66_arg2 )
	...
	Engine[0x41BB55A1633C931]( f66_arg1 )
end
...
CoD.SpawnSelectionUtility.ForceFullscreenViewportUntilClosed = function ( f68_arg0, f68_arg1 )
	...
	if CoD.perController[f68_arg1].modifiedViewport then
		Engine[0x41BB55A1633C931]( f68_arg1 )
	end
...
CoD.SpawnSelectionUtility.IsForwardSpawnTeamActive = function ( f79_arg0, f79_arg1 )
	...
	local f79_local1 = Engine[0x40E824FE270E174]( Engine[0x8DF2E5447F384B9](), "hudItems.war.forwardSpawnStatus" )
...
CoD.SpawnSelectionUtility.IsForwardSpawnEnemyActive = function ( f80_arg0, f80_arg1 )
	...
	local f80_local3 = Engine[0x40E824FE270E174]( Engine[0x8DF2E5447F384B9](), "hudItems.war.forwardSpawnStatus" )
