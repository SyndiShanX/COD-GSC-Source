...
CoD.AmmoWidgetUtility.InitTacticalEmptyPulse = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4)
	local f1_local0 = Engine[0x4DF5CFBC1771947](f1_arg2)
	f1_arg1.previousPulseValue = 0
	f1_arg1:subscribeToModel(Engine[0x40E824FE270E174](f1_local0, "hudItems.pulseNoTactical"), function(model)
		...
		if f1_arg1.previousPulseValue == f2_local0 then
			...
			if not PulseNoTactical(f1_arg2) then
				return
			elseif Engine[0x614D394F6F9A18D](Engine[0x40E824FE270E174](f1_local0, "currentSecondaryOffhand.secondaryOffhand")) == nil then
				return
			else
...
CoD.AmmoWidgetUtility.InitLethalEmptyPulse = function(f5_arg0, f5_arg1, f5_arg2, f5_arg3, f5_arg4)
	local f5_local0 = Engine[0x4DF5CFBC1771947](f5_arg2)
	f5_arg1.previousPulseValue = 0
	f5_arg1:subscribeToModel(Engine[0x40E824FE270E174](f5_local0, "hudItems.pulseNoLethal"), function(model)
		...
		f6_local2:subscribeToElementModel(f5_arg0, "image", function(f7_arg0)
			local f7_local0 = Engine[0x614D394F6F9A18D](f7_arg0)
			if f7_local0 then
...
CoD.AmmoWidgetUtility.IsAbilityRestricted = function(f9_arg0)
	...
	return Engine[0x23577A128ED85F3](Engine[0xD97229B24C685D5](Engine[0x6341D58561B3B7E](f9_local0.id:get())), false)
end
