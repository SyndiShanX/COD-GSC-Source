...
CoD.FileshareUtility.GetIsCommunityMode = function(f29_arg0)
	...
	CoD.FileshareUtility.SetShouldShowTabs(modelValue == Enum.FileshareMode[@"fileshare_mode_user"])
	return modelValue == Enum.FileshareMode[@"fileshare_mode_community"]
end
...
CoD.FileshareUtility.SetupFileShareSummary_MP = function(f69_arg0, f69_arg1, f69_arg2)
	...
	CoD.FileshareUtility.SetFileshareSummaryItem(f69_arg0, "column1Header", Engine[@"hash_4F9F1239CFD921FE"]("menu/kills_caps"))
	CoD.FileshareUtility.SetFileshareSummaryItem(f69_arg0, "column1Value", f69_local11)
	CoD.FileshareUtility.SetFileshareSummaryItem(f69_arg0, "column2Header", Engine[@"hash_4F9F1239CFD921FE"]("menu/deaths_caps"))
	...
	if f69_local7 == "tdm" or f69_local7 == "dm" then
		f69_local22 = Engine[@"hash_4F9F1239CFD921FE"]("mpui/ratio_caps")
		f69_local24 = CoD.GetKDRatio(f69_local23.kills:get(), f69_local23.deaths:get())
		f69_local25 = Engine[@"hash_4F9F1239CFD921FE"]("mpui/assists_caps")
		f69_local26 = f69_local23.assists:get()
	elseif f69_local7 == "dom" or f69_local7 == "hq" then
		f69_local22 = Engine[@"hash_4F9F1239CFD921FE"]("mpui/captures_caps")
		f69_local24 = f69_local21.captures
		f69_local25 = Engine[@"hash_4F9F1239CFD921FE"]("mpui/defends_caps")
	...
	elseif f69_local7 == "ctf" then
		f69_local22 = Engine[@"hash_4F9F1239CFD921FE"]("mpui/captures_caps")
		f69_local24 = f69_local21.captures
		f69_local25 = Engine[@"hash_4F9F1239CFD921FE"]("mpui/returns_caps")
		f69_local26 = f69_local21.returns
	elseif f69_local7 == "dem" or f69_local7 == @"sab" or f69_local7 == "sd" then
		f69_local22 = Engine[@"hash_4F9F1239CFD921FE"]("mpui/plants_caps")
		f69_local24 = f69_local21.plants
		f69_local25 = Engine[@"hash_4F9F1239CFD921FE"]("mpui/defuses_caps")
		f69_local26 = f69_local21.defuses
	elseif f69_local7 == "conf" then
		f69_local22 = Engine[@"hash_4F9F1239CFD921FE"]("mpui/kills_confirmed_caps")
		f69_local24 = f69_local21.captures
		f69_local25 = Engine[@"hash_4F9F1239CFD921FE"]("mpui/kills_denied_caps")
		f69_local26 = f69_local21.returns
