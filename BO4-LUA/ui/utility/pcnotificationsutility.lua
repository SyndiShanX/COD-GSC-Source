...
DataSources.CurrentNotification = {
	prepare = function(f1_arg0)
		local f1_local0 = Engine[0xA798E4552F5E872](Engine[0x4DF5CFBC1771947](f1_arg0), "PC.CurrentNotification")
		local f1_local1 = Engine[0xA798E4552F5E872](f1_local0, "notificationEvent")
		f1_local1:set("")
		f1_local1 = Engine[0xA798E4552F5E872](f1_local0, "inviteResponseEvent")
		f1_local1:set("")
		f1_local1 = Engine[0xA798E4552F5E872](f1_local0, "visibility")
		f1_local1:set(false)
		f1_local1 = Engine[0xA798E4552F5E872](f1_local0, "hideNotificationsTimestamp")
		f1_local1:set(Engine[0x9D33D652B9B0F3B]() - CoD.PCNotificationsUtility.NOTIFICATION_DURATION * 1000)
		f1_local1 = Engine[0xA798E4552F5E872](f1_local0, "chooseOffDurationStateVisible")
		f1_local1:set(false)
		f1_local1 = Engine[0xA798E4552F5E872](f1_local0, "type")
		f1_local1:set(0)
		f1_local1 = Engine[0xA798E4552F5E872](f1_local0, "senderXuid")
		f1_local1:set(nil)
		f1_local1 = Engine[0xA798E4552F5E872](f1_local0, "senderGamertag")
		f1_local1:set("")
		f1_local1 = Engine[0xA798E4552F5E872](f1_local0, "requestIndex")
		f1_local1:set(0)
		f1_local1 = Engine[0xA798E4552F5E872](f1_local0, "remainingTime")
		f1_local1:set(0)
		f1_local1 = Engine[0xA798E4552F5E872](f1_local0, "timestamp")
		f1_local1:set(0)
		return f1_local0
	end,
	getModel = function(f2_arg0)
		local f2_local0 = Engine[0x40E824FE270E174](Engine[0x4DF5CFBC1771947](f2_arg0), "PC.CurrentNotification")
...
local f0_local1 = function(f4_arg0, f4_arg1)
	if #CoD.PCNotificationsUtility.MockupData == 0 then
		local f4_local0 = Engine[0xF14B7D0A8CB7818](f4_arg0)
		if #f4_local0 > 0 then
			local f4_local1 = 0
			for f4_local5, f4_local6 in pairs(f4_local0) do
				local f4_local7 = Engine[0xDC3B811A6](f4_arg0, f4_local6.xuid)
...
local f0_local3 = function(f6_arg0, f6_arg1)
	if #CoD.PCNotificationsUtility.MockupDataFriends == 0 then
		local f6_local0 = Engine[0xF14B7D0A8CB7818](f6_arg0)
		if #f6_local0 > 0 then
			local f6_local1 = 0
			for f6_local5, f6_local6 in pairs(f6_local0) do
				local f6_local7 = Engine[0xDC3B811A6](f6_arg0, f6_local6.xuid)
...
local f0_local6 = function(f9_arg0, f9_arg1, f9_arg2)
	...
	local f9_local2 = {}
	if Engine[0xB72F603CAC75B3A](f9_arg1, 0x9E3758E63839B10) ~= 0 then
	...
	if #f9_local2 > 0 and f9_arg2 then
		...
		local f9_local7 = Engine[0xED84C33EC5F01EA]
		...
		local f9_local4 = {}
		if Engine[0xB72F603CAC75B3A](f9_arg1, 0x8F2B8315512CEA5) ~= 0 then
	...
	if #f10_local0 > 0 then
		...
		for f10_local11, f10_local12 in pairs(f10_local0) do
			if f10_local12.timestamp + CoD.PCNotificationsUtility.NOTIFICATION_DURATION * 1000 < f10_local1 and (f10_local3 ~= CoD.PCNotificationsUtility.NotificationType.PARTY.id or f10_local4 ~= f10_local12.xuid) then
				...
				local f10_local9 = Engine[0xED84C33EC5F01EA]
...
CoD.PCNotificationsUtility.UpdateNotifToSafeArea = function(f14_arg0, f14_arg1)
	local f14_local0, f14_local1, f14_local2, f14_local3 = Engine[0x26E31A9FDAA85EB](f14_arg1, true)
...
CoD.PCNotificationsUtility.AcceptCurrentInvite = function(f17_arg0, f17_arg1)
	...
	if f17_local1 == CoD.PCNotificationsUtility.NotificationType.PARTY.id then
		...
		if LobbyQuickJoinWithXuid(f17_arg0, f17_arg1, f17_local2) then
			...
			local f17_local4 = Engine[0xED84C33EC5F01EA]
...
CoD.PCNotificationsUtility.PrepareNotificationContainer = function(f20_arg0, f20_arg1, f20_arg2, f20_arg3)
	...
	CoD.Menu.AddButtonCallbackFunction(f20_arg2, f20_arg3.KeyPrompts.KeyPromptAccept, f20_arg1, Enum[0x3DD78803F918E9D][0x755DA1E2E7C263F], "ui_confirm", function(element, menu, controller, f23_arg3)
	...
	CoD.Menu.AddButtonCallbackFunction(f20_arg2, f20_arg3.KeyPrompts.KeyPromptDecline, f20_arg1, Enum[0x3DD78803F918E9D][0x755DA1E2E7C263F], "ui_confirm", function(element, menu, controller, f24_arg3)
		if CoD.PCNotificationsUtility.IsNotificationWidgetVisible(controller) then
