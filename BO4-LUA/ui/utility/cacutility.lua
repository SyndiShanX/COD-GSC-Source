...
CoD.OverlayUtility.AddSystemOverlay( "PrestigeWeapon", {
	...
	title = function ( f14_arg0, f14_arg1 )
		return Engine.ToUpper( Engine[@"hash_4F9F1239CFD921FE"]( "menu/enter_weapon_prestige_x", CoD.CACUtility.GetWeaponPLevel( f14_arg0, Engine.GetModelValue( f14_arg1 ) ) + 1 ) )
	end,
	...
	listDatasource = function ( f22_arg0, f22_arg1 )
		DataSources.PrestigeWeaponOptionsList = DataSourceHelpers.ListSetup( "PrestigeWeaponOptionsList", function ( f23_arg0 )
			...
			if f23_local5 == Enum.eModes.mode_zombies then
				table.insert( f23_local0, f23_local1( Engine[@"hash_4F9F1239CFD921FE"]( "menu/enter_weapon_prestige" ), f23_local3, false ) )
			elseif f23_local5 == Enum.eModes.mode_multiplayer then
				table.insert( f23_local0, f23_local1( Engine[@"hash_4F9F1239CFD921FE"]( "menu/enter_weapon_prestige" ), f23_local2, false ) )
			end
	...
	if not CoD.CACUtility.IsProgressionEnabled( f358_local1 ) then
		...
		if f358_local2 <= CoD.CACUtility.EmptyItemIndex then
			...
			if CoD.CACUtility.IsWeaponLevelMax( f358_local0, f358_local2, f358_local1 ) then
				return Engine[@"hash_4F9F1239CFD921FE"]( "mpui/max_caps" )
			else
...
CoD.CACUtility.GetAttachmentUnlockDescription = function ( f362_arg0, f362_arg1, f362_arg2 )
	...
	if CoD.CACUtility.IsProgressionEnabled( f362_local3 ) and f362_local2 and f362_local2[f362_local4] then
		...
		if f362_local5 and f362_local5 > CoD.CACUtility.EmptyItemIndex then
			...
			if f362_local6 then
				return Engine[@"hash_4F9F1239CFD921FE"]( "mpui/requires_weapon_level", f362_local6 + 2 )
			end
		end
	end
	return 0x0
...
CoD.CACUtility.AddGlobalRightStickSingleItemControlForSessionMode = function ( f382_arg0, f382_arg1, f382_arg2, f382_arg3, f382_arg4 )
	...
	if IsFreeCursorActive( f382_arg2 ) then
		f382_arg0:AddButtonCallbackFunction( f382_arg0, f382_arg2, Enum.LUIButton[@"lui_key_left"], nil, function ( f383_arg0, f383_arg1, f383_arg2, f383_arg3 )
		...
		f382_arg0:AddButtonCallbackFunction( f382_arg0, f382_arg2, Enum.LUIButton[@"lui_key_right"], nil, function ( f384_arg0, f384_arg1, f384_arg2, f384_arg3 )
		...
		f382_arg0:AddButtonCallbackFunction( f382_arg0, f382_arg2, Enum.LUIButton[@"lui_key_up"], nil, function ( f385_arg0, f385_arg1, f385_arg2, f385_arg3 )
		...
		f382_arg0:AddButtonCallbackFunction( f382_arg0, f382_arg2, Enum.LUIButton[@"lui_key_down"], nil, function ( f386_arg0, f386_arg1, f386_arg2, f386_arg3 )
