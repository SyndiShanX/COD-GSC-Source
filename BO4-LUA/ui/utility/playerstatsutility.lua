	...
	if CoD.PlayerStatsUtility.WZGameModeInfoTable == nil then
		CoD.PlayerStatsUtility.WZGameModeInfoTable = {
			[CoD.PlayerStatsUtility.WZGameModeDisplayType.ALL] = {
				...
				statPathName = CoD.GameTypeUtility.GetAllGameModes(Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39]),
			},
			...
			[CoD.PlayerStatsUtility.WZGameModeDisplayType.LTM] = {
				...
				statPathName = CoD.GameTypeUtility.GetLimitedTimeModes(Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39]),
			},
		}
	end
	...
	if Engine[0x3EAC408F958FF05]() == Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39] then
		...
		if not f9_local0 then
			...
			if not CoD.PlayerStatsUtility.MedalsListTable then
				...
				local f9_local1 = Engine[0x63FBABD1982143E](f9_local0)
...
CoD.PlayerStatsUtility.IsPrestigeMasterForMenu = function(f11_arg0, f11_arg1)
	return IsGameModeParagonCapable(f11_arg0) and Engine[0x1C875FDC0D5417E](f11_arg0) <= f11_local1
end
...
CoD.PlayerStatsUtility.SetCombatRecordXUID = function(f13_arg0)
	CoD.PlayerStatsUtility.CombatRecordXUID = Engine[0x93B19E01B1FD1C7]()
...
CoD.PlayerStatsUtility.SetCombatRecordXUIDForSelectedPlayer = function(f14_arg0)
	local f14_local0 = Engine[0x4DF5CFBC1771947](f14_arg0)
...
CoD.PlayerStatsUtility.GetStorageBufferForPlayer = function(f15_arg0)
	if CoD.PlayerStatsUtility.CombatRecordOtherPlayerStats then
		...
		local f15_local0 = Engine[0x3EAC408F958FF05]()
		if f15_local0 == Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A] then
			return Engine[0x8BF970606552F4C](f15_arg0, Enum[0xBBD4F9E70101BA8][0xA57D6164B91A8FC])
		elseif f15_local0 == Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39] then
			return Engine[0x8BF970606552F4C](f15_arg0, Enum[0xBBD4F9E70101BA8][0xAB0E693244221BC])
		else
			return Engine[0x8BF970606552F4C](f15_arg0, Enum[0xBBD4F9E70101BA8][0xD5A7695E03A7A90])
		end
	end
end
CoD.PlayerStatsUtility.GetStorageBufferEnumForPlayer = function(f16_arg0)
	if CoD.PlayerStatsUtility.CombatRecordOtherPlayerStats then
		...
		local f16_local0 = Engine[0x3EAC408F958FF05]()
		if f16_local0 == Enum[0x9C0C2196D8313A0][0x3723205FAE52C4A] then
			return Enum[0xBBD4F9E70101BA8][0xA57D6164B91A8FC]
		elseif f16_local0 == Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39] then
			return Enum[0xBBD4F9E70101BA8][0xAB0E693244221BC]
		else
			return Enum[0xBBD4F9E70101BA8][0xD5A7695E03A7A90]
		end
	end
end
...
CoD.PlayerStatsUtility.GetShowcaseMedal = function(f18_arg0, f18_arg1)
	...
	if not f18_local0 then
		f18_local0 = Engine[0x93B19E01B1FD1C7](f18_arg1)
	end
	if f18_local0 then
...
CoD.PlayerStatsUtility.SetNextPrestigeCallingCard = function(f19_arg0, f19_arg1, f19_arg2)
	...
	CoD.ChallengesUtility.SetCallingCardForWidget(f19_arg2, CoD.PrestigeUtility.GetBackgroundIdByPLevel(f19_arg1, math.min(f19_local1, CoD.PrestigeUtility.GetPrestigeCap()) + 1, Engine[0x3EAC408F958FF05]()), f19_arg0.id)
end
...
CoD.PlayerStatsUtility.GetRank = function(f37_arg0, f37_arg1)
	...
	local f37_local3 = Engine[0x3EAC408F958FF05]()
	if f37_local3 == Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39] then
	...
	elseif CoD.PlayerStatsUtility.IsPrestigeMasterForMenu(f37_local3, f37_arg0) then
		return Engine[0x801A572E417CC01](f37_local2, f37_local3)
	else
		return Engine[0xE1DE4A6CE92B4FD](f37_local0)
	end
end
CoD.PlayerStatsUtility.GetRankColor = function(f38_arg0, f38_arg1)
	...
	local f38_local2 = Engine[0x3EAC408F958FF05]()
	if f38_local2 == Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39] and IsGameModeParagonCapable(f38_local2) and Engine[0x1C875FDC0D5417E](f38_local2) <= f38_local1 then
...
CoD.PlayerStatsUtility.GetRankIcon = function(f39_arg0, f39_arg1)
	local f39_local0 = Engine[0x3EAC408F958FF05]()
	if f39_local0 == Enum[0x9C0C2196D8313A0][0xB22E0240605CFFE] then
...
CoD.PlayerStatsUtility.GetRankIconLarge = function(f40_arg0, f40_arg1, f40_arg2)
	...
	if f40_local0 == Enum[0x9C0C2196D8313A0][0xB22E0240605CFFE] then
		return 0x7615068F50B3D66
	else
...
CoD.PlayerStatsUtility.GetRankTitle = function(f41_arg0, f41_arg1)
	...
	if f41_local0 == Enum[0x9C0C2196D8313A0][0xB22E0240605CFFE] then
		return 0x0
	else
...
CoD.PlayerStatsUtility.GetLevelString = function(f42_arg0, f42_arg1)
	...
	local f42_local2 = Engine[0x3EAC408F958FF05]()
	if f42_local2 == Enum[0x9C0C2196D8313A0][0xB22E0240605CFFE] then
		return 0x0
	elseif IsGameModeParagonCapable(f42_local2) and Engine[0x1C875FDC0D5417E](f42_local2) <= f42_local1 then
		return Engine[0xF9F1239CFD921FE](
			0x21235EA457AB637,
			Engine[0x801A572E417CC01](
				CoD.PlayerStatsUtility.HashStorageLookupForMenu(f42_arg0, {
					0xD59E8BFAC78A33B,
					0x82D5F0A666E1010,
				}),
				f42_local2
	...
	elseif f42_local2 == Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39] then
...
CoD.PlayerStatsUtility.GetCurrentXPForRank = function(f43_arg0, f43_arg1)
	local f43_local0 = Engine[0x3EAC408F958FF05]()
	if f43_local0 == Enum[0x9C0C2196D8313A0][0xB22E0240605CFFE] then
		return 0
	else
...
CoD.PlayerStatsUtility.GetXPToNextRank = function(f44_arg0, f44_arg1)
	local f44_local0 = Engine[0x3EAC408F958FF05]()
	if f44_local0 == Enum[0x9C0C2196D8313A0][0xB22E0240605CFFE] then
		return 0
	else
...
CoD.PlayerStatsUtility.GetCurrentXPOverNextRankXP = function(f45_arg0, f45_arg1)
	local f45_local0 = Engine[0x3EAC408F958FF05]()
	if f45_local0 == Enum[0x9C0C2196D8313A0][0xB22E0240605CFFE] then
		return ""
	end
	...
	if f45_local3 then
		...
		f45_local2 = CoD.PlayerStatsUtility.GetPrestigeMasterAbsoluteXP(
			f45_local0,
			CoD.PlayerStatsUtility.HashStorageLookupForMenu(f45_arg0, {
				0xD59E8BFAC78A33B,
				0x460BE5A20FCF3D8,
			})
		)
...
CoD.PlayerStatsUtility.GetNextRank = function(f46_arg0, f46_arg1)
	...
	if f46_local0 == Enum[0x9C0C2196D8313A0][0xB22E0240605CFFE] then
		return 0
	else
...
CoD.PlayerStatsUtility.GetCurrentRankProgress = function(f47_arg0, f47_arg1, f47_arg2, f47_arg3, f47_arg4)
	local f47_local0 = Engine[0x3EAC408F958FF05]()
	if f47_local0 == Enum[0x9C0C2196D8313A0][0xB22E0240605CFFE] then
		return 0
	end
	...
	if f47_local3 then
		...
		f47_local2 = CoD.PlayerStatsUtility.GetPrestigeMasterAbsoluteXP(
			f47_local0,
			CoD.PlayerStatsUtility.HashStorageLookupForMenu(f47_arg0, {
				0xD59E8BFAC78A33B,
				0x460BE5A20FCF3D8,
			})
		)
...
CoD.PlayerStatsUtility.GetNextRankIcon = function(f48_arg0, f48_arg1)
	local f48_local0 = Engine[0x3EAC408F958FF05]()
	if f48_local0 == Enum[0x9C0C2196D8313A0][0xB22E0240605CFFE] then
		return 0x7615068F50B3D66
	end
	...
	return Engine[0x9C6922557618920](f48_local4, f48_local2, f48_local0) or 0x7615068F50B3D66
end
CoD.PlayerStatsUtility.GetNextPrestigeTitle = function(f49_arg0, f49_arg1)
	local f49_local0 = Engine[0x3EAC408F958FF05]()
	if f49_local0 == Enum[0x9C0C2196D8313A0][0xB22E0240605CFFE] then
		return 0x0
	else
...
CoD.PlayerStatsUtility.GetNextPrestigeIcon = function(f50_arg0, f50_arg1, f50_arg2)
	local f50_local0 = Engine[0x3EAC408F958FF05]()
	if f50_local0 == Enum[0x9C0C2196D8313A0][0xB22E0240605CFFE] then
		return 0x7615068F50B3D66
	else
...
CoD.PlayerStatsUtility.GetPrestigeProgressFractionString = function(f52_arg0, f52_arg1)
	...
	if f52_local2 == Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39] and not CoD.PlayerStatsUtility.IsPrestigeMasterForMenu(f52_local2, f52_arg0) then
...
CoD.PlayerStatsUtility.GetPrestigeRequirementString = function(f53_arg0, f53_arg1)
	...
	if f53_local0 == Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39] and not CoD.PlayerStatsUtility.IsPrestigeMasterForMenu(f53_local0, f53_arg0) then
...
DataSources.MedalsList = ListHelper_SetupDataSource("MedalsList", function(f67_arg0, f67_arg1)
	...
	if f67_local4 then
		...
		for f67_local11, f67_local12 in pairs(f67_local3) do
			...
			local f67_local9
			if (not f67_arg1.menu._category or f67_arg1.menu._category ~= f67_local12.medalCategory) and Engine[0x3EAC408F958FF05]() ~= Enum[0x9C0C2196D8313A0][0xBF1DCC8138A9D39] then
				f67_local9 = false
			else
				f67_local9 = true
			end
...
DataSources.FeaturedMedals = {
	...
	getHighestValueEarnedMedal = function(f68_arg0, f68_arg1, f68_arg2)
		for f68_local7, f68_local8 in ipairs(f68_arg2) do
			...
			local f68_local3 = Engine[0x910CBCCD3C164C9](DataSources.FeaturedMedals.MedalTable, CoD.ScoreInfoTable.ScriptRefCol, f68_local8)
	...
	createModelsFn = function(f70_arg0, f70_arg1, f70_arg2, f70_arg3)
		local f70_local0 = {}
		local f70_local1 = Engine[0x910CBCCD3C164C9](DataSources.FeaturedMedals.MedalTable, CoD.ScoreInfoTable.ScriptRefCol, f70_arg3)
		...
		local f70_local3 = Engine[0x4DF5CFBC1771947](f70_arg0)
	...
	getModel = function(f72_arg0)
		...
		local f72_local2 = Engine[0x4DF5CFBC1771947](f72_arg0)
...
DataSources.PlayerShowcase = {
	...
	updateShowcaseMedal = function(f76_arg0)
		...
		local f76_local7 = Engine[0x2DCF0973239E909](CoD.ScoreInfoTable.BaseMPTable, CoD.ScoreInfoTable.MedalAssetCol, CoD.ScoreInfoTable.MedalRefCol, f76_local6)
