...
CoD.CraftAuthorInfo.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	TimestampText:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	TimestampText:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	CreatedTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	CreatedTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	AuthorGamertag:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	AuthorGamertag:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	AuthorTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	AuthorTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	EmblemName:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	NameTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	NameTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
