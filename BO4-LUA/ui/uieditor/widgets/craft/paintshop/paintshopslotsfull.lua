...
CoD.PaintshopSlotsFull.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	count:subscribeToGlobalModel(f1_arg1, "PerController", "Paintshop.UpdateDataSource", function(model)
		CoD.CraftUtility.UpdateSlotCountText(self, count, f1_arg1, Enum[0xBBD4F9E70101BA8][0x743B8404C246F61])
	end)
	...
	VariantSlots:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	VariantSlots:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	slotFulltext:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	slotFulltext:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
...
CoD.PaintshopSlotsFull.__resetProperties = function(f3_arg0)
	...
	f3_arg0.slotFulltext:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
...
CoD.PaintshopSlotsFull.__clipsPerState = {
	...
	SlotsFull = {
		DefaultClip = function(f5_arg0, f5_arg1)
			...
			f5_arg0.slotFulltext:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
