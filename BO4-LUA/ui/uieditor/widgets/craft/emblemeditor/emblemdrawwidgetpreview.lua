	...
	DefaultState = {
		...
		EditMode = function(f10_arg0, f10_arg1)
			...
			local f10_local3 = function(f14_arg0)
				f10_arg0.FrontendFrameSelected:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f10_local5 = function(f17_arg0)
				f10_arg0.FrontendFocusPip:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_in"])
	...
	EditMode = {
		...
		DefaultState = function(f22_arg0, f22_arg1)
			...
			local f22_local3 = function(f26_arg0)
				f22_arg0.FrontendFrameSelected:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f22_local5 = function(f28_arg0)
				f22_arg0.FrontendFocusPip:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_out"])
