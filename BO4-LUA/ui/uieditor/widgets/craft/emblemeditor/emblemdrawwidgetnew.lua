	...
	DefaultState = {
		...
		EditMode = function(f11_arg0, f11_arg1)
			...
			local f11_local4 = function(f16_arg0)
				f11_arg0.FrontendFrameSelected:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f11_local6 = function(f19_arg0)
				f11_arg0.FrontendFocusPip:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_in"])
	...
	EditMode = {
		...
		DefaultState = function(f24_arg0, f24_arg1)
			...
			local f24_local3 = function(f28_arg0)
				f24_arg0.FrontendFrameSelected:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f24_local5 = function(f30_arg0)
				f24_arg0.FrontendFocusPip:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_out"])
