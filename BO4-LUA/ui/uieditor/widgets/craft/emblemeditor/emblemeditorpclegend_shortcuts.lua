...
CoD.EmblemEditorPCLegend_Shortcuts.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Shortcut.KeyPrompt.keybind:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_7179662091387B23"))
	Shortcut.Text.Text:setText(LocalizeToUpperString(@"hash_12C331BE453CDAEF"))
	...
	PCTheaterKeyboardShortcut.KeyPrompt.keybind:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_7179682091387E89"))
	...
	PCTheaterKeyboardShortcut2.KeyPrompt.keybind:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_7179672091387CD6"))
	PCTheaterKeyboardShortcut2.Text.Text:setText(LocalizeToUpperString(@"hash_673BFA7879AB1AFB"))
	...
	PCTheaterKeyboardShortcut3.Text.Text:setText(LocalizeToUpperString(@"hash_45464A3F4DF44C12"))
	...
	PCTheaterKeyboardShortcut6.Text.Text:setText(LocalizeToUpperString(@"hash_1E3B3C6130E3F5E6"))
	...
	PCTheaterKeyboardShortcut11.Text.Text:setText(LocalizeToUpperString(@"hash_CD67DEBE479D01"))
	...
	PCTheaterKeyboardShortcut14.Text.Text:setText(LocalizeToUpperString(@"hash_79EA9FBA1D9EE194"))
	...
	PCTheaterKeyboardShortcut17.Text.Text:setText(LocalizeToUpperString(@"hash_6E183CF1F7D46A06"))
	...
	PCTheaterKeyboardShortcut18.Text.Text:setText(LocalizeToUpperString(@"hash_6C94DB02C0AF2E2F"))
