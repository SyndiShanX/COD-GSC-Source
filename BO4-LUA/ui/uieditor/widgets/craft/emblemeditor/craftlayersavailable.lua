...
CoD.CraftLayersAvailable.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	temporary:setText(LocalizeStringWithDatasource("Emblem.EmblemProperties.layersAvailable", f1_arg1, @"hash_63C805518F0500BA"))
	temporary:setTTF("dinnext_regular")
	temporary:setLetterSpacing(1)
	temporary:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	temporary:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	notEnoughLayersText:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_2A5A029CEE54E27D"))
	notEnoughLayersText:setTTF("dinnext_regular")
	notEnoughLayersText:setLetterSpacing(1)
	notEnoughLayersText:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	notEnoughLayersText:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
