...
CoD.ObituaryKillerIdentity.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	KillerLabel:setText(LocalizeToUpperString(@"hash_698E1E885ED068B4"))
	KillerLabel:setTTF("ttmussels_regular")
	KillerLabel:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	KillerLabel:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	...
	ClanName:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	...
	BackingRank:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16CBE95C250C6D15"))
	...
	ArenaRank:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
