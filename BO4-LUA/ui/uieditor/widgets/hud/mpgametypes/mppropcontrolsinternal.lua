...
CoD.MPPropControlsInternal.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	ControlsBackingBlur:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_E2354BE557C4C7A"))
	...
	TextBoxLock:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_49C3DCE861008C68"))
	TextBoxLock:setTTF("ttmussels_demibold")
	TextBoxLock:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TextBoxLock:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TextBoxLookThrough:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_2A03387A61128CEE"))
	TextBoxLookThrough:setTTF("ttmussels_demibold")
	TextBoxLookThrough:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TextBoxLookThrough:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TextBoxRotate:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_4D6DF9FA110152CC"))
	TextBoxRotate:setTTF("ttmussels_demibold")
	TextBoxRotate:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TextBoxRotate:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	self:addElement(TextBoxRotate)
	self.TextBoxRotate = TextBoxRotate
	local TextBoxSlope = LUI.UIText.new(0, 0, 9, 117, 0, 0, 270, 287)
	TextBoxSlope:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_2A2AC356732E680E"))
	TextBoxSlope:setTTF("ttmussels_demibold")
	TextBoxSlope:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TextBoxSlope:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TextBoxConcuss:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TextBoxConcuss:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	TextBoxConcuss:subscribeToGlobalModel(f1_arg1, "HUDItems", "numPropConcusses", function(model)
		local f2_local0 = model:get()
		if f2_local0 ~= nil then
			TextBoxConcuss:setText(LocalizeStringWithParameter(@"hash_3DD6B71E2529F7D", f2_local0))
		end
	end)
	...
	TextBoxChange:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TextBoxChange:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	TextBoxChange:subscribeToGlobalModel(f1_arg1, "HUDItems", "numPropChanges", function(model)
		local f3_local0 = model:get()
		if f3_local0 ~= nil then
			TextBoxChange:setText(LocalizeStringWithParameter(@"hash_51559855588AC43D", f3_local0))
		end
	end)
	...
	TextBoxDecoy:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TextBoxDecoy:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	TextBoxDecoy:subscribeToGlobalModel(f1_arg1, "HUDItems", "numPropDecoys", function(model)
		local f4_local0 = model:get()
		if f4_local0 ~= nil then
			TextBoxDecoy:setText(LocalizeStringWithParameter(@"hash_75735A9AFD8468C7", f4_local0))
		end
	end)
	...
	TextBoxLockButton:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TextBoxLockButton:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TextBoxLookThroughButton:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TextBoxLookThroughButton:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TextBoxRotateButton:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TextBoxRotateButton:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TextBoxDecoyButton:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TextBoxDecoyButton:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TextBoxChangeButton:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TextBoxChangeButton:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TextBoxConcussButton:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TextBoxConcussButton:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TextBoxSlopeButton:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TextBoxSlopeButton:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
...
CoD.MPPropControlsInternal.__resetProperties = function(f8_arg0)
	...
	f8_arg0.TextBoxChangeButton:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	f8_arg0.TextBoxDecoyButton:setLeftRight(0, 0, 25.5, 102.5)
	f8_arg0.TextBoxDecoyButton:setTopBottom(0, 0, 460.5, 488.5)
	f8_arg0.TextBoxDecoyButton:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	f8_arg0.TextBoxConcussButton:setLeftRight(0, 0, 25.5, 102.5)
	f8_arg0.TextBoxConcussButton:setTopBottom(0, 0, 307.5, 335.5)
	f8_arg0.TextBoxConcussButton:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
...
CoD.MPPropControlsInternal.__clipsPerState = {
	...
	KBM = {
		DefaultClip = function(f10_arg0, f10_arg1)
			...
			f10_arg0.TextBoxLockButton:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
			...
			f10_arg0.TextBoxLookThroughButton:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
			...
			f10_arg0.TextBoxRotateButton:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
			...
			f10_arg0.TextBoxDecoyButton:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
			...
			f10_arg0.TextBoxChangeButton:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
			...
			f10_arg0.TextBoxConcussButton:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
			...
			f10_arg0.TextBoxSlopeButton:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
