...
CoD.AmmoWidgetWZ.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Frame:setImage(RegisterImage(@"hash_6192903FBEA50B36"))
	self:addElement(Frame)
	self.Frame = Frame
	local LEDgraph = LUI.UIImage.new(0, 0, 358.5, 586.5, 0, 0, 23, 87)
	LEDgraph:setRGB(0, 0, 0)
	LEDgraph:setAlpha(0.2)
	LEDgraph:setImage(RegisterImage(@"hash_7C841C84F3674732"))
	...
	GlowWeapon:setImage(RegisterImage(@"hash_4D9665F2DAD5E915"))
	...
	goldenBullet:setImage(RegisterImage(@"hash_26137E42475D0CF1"))
	...
	LEDarmor:setImage(RegisterImage(@"hash_7E543F2886150754"))
	self:addElement(LEDarmor)
	self.LEDarmor = LEDarmor
	local LED = LUI.UIImage.new(0, 0, 161.5, 229.5, 0, 0, 20, 88)
	LED:setRGB(0, 0, 0)
	LED:setAlpha(0.2)
	LED:setImage(RegisterImage(@"hash_5D9A4F6492B1AE8B"))
	self:addElement(LED)
	self.LED = LED
		...
		PulseEnding = function(f15_arg0, f15_arg1)
			...
			local f15_local0 = function(f16_arg0)
				local f16_local0 = function(f17_arg0)
					f17_arg0:beginAnimation(500, Enum[@"luitween"][@"luitween_ease_both"])
					f17_arg0:setAlpha(1)
					f17_arg0:registerEventHandler("transition_complete_keyframe", f15_arg0.clipFinished)
				end
				f15_arg0.goldenBullet:beginAnimation(500, Enum[@"luitween"][@"luitween_ease_both"])
