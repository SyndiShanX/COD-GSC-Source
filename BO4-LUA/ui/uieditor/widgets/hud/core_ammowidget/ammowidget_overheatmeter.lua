...
CoD.AmmoWidget_OverheatMeter.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	OverheatingPulse:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	OverheatingPulse:setAlignment(Enum[0x7A5123B654282D2][0xE821F0ECFF8D1C7])
	...
	Overheating:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	Overheating:setAlignment(Enum[0x7A5123B654282D2][0xE821F0ECFF8D1C7])
...
CoD.AmmoWidget_OverheatMeter.__resetProperties = function(f6_arg0)
	...
	f6_arg0.Backing:setMaterial(LUI.UIImage.GetCachedMaterial(0xE125638BF94665F))
...
CoD.AmmoWidget_OverheatMeter.__clipsPerState = {
	DefaultState = {
		DefaultClip = function(f7_arg0, f7_arg1)
			...
			f7_arg0.Backing:setMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
	...
	Overheating = {
		DefaultClip = function(f8_arg0, f8_arg1)
			...
			f8_arg0.Backing:setMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
	...
	OverheatingAsianLang = {
		DefaultClip = function(f11_arg0, f11_arg1)
			...
			f11_arg0.Backing:setMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
