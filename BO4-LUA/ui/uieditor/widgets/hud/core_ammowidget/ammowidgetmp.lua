...
CoD.AmmoWidgetMP.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Frame:setImage(RegisterImage(@"hash_4C2A880079B9F2B1"))
	self:addElement(Frame)
	self.Frame = Frame
	local FrameGolden = LUI.UIImage.new(0, 0, 264, 624, 0, 0, 25.5, 111.5)
	FrameGolden:setImage(RegisterImage(@"hash_DDA2B9CC83282F8"))
	...
	FrameGoldenGlow:setImage(RegisterImage(@"hash_25CDC829DEF0025C"))
	...
	LEDscreen:setImage(RegisterImage(@"hash_2B3750B856814A3A"))
	...
	GlowImage:setImage(RegisterImage(@"hash_1DA3FD465AC2534"))
	GlowImage:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	GlowImage2:setImage(RegisterImage(@"hash_1DA3FD465AC2534"))
	GlowImage2:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	GlowTop:setAlpha(0)
	GlowTop:setImage(RegisterImage(@"hash_3B0B47D37604C9FA"))
	...
	GlowBtm:setImage(RegisterImage(@"hash_3B0B47D37604C9FA"))
	GlowBtm:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
			...
			local f11_local2 = function(f17_arg0)
				local f17_local0 = function(f18_arg0)
					local f18_local0 = function(f19_arg0)
						f19_arg0:beginAnimation(349, Enum[@"luitween"][@"luitween_ease_both"])
						f19_arg0:setAlpha(1)
			...
			local f11_local5 = function(f24_arg0)
				local f24_local0 = function(f25_arg0)
					local f25_local0 = function(f26_arg0)
						f26_arg0:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_in"])
					...
					f25_arg0:beginAnimation(850, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f11_local6 = function(f27_arg0)
				local f27_local0 = function(f28_arg0)
					local f28_local0 = function(f29_arg0)
						f29_arg0:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_in"])
						f29_arg0:setLeftRight(0, 0, 466, 690)
						f29_arg0:setAlpha(0)
						f29_arg0:registerEventHandler("transition_complete_keyframe", f11_arg0.clipFinished)
					end
					f28_arg0:beginAnimation(850, Enum[@"luitween"][@"luitween_ease_out"])
