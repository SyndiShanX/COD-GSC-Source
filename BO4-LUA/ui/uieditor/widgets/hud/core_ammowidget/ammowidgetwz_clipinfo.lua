...
CoD.AmmoWidgetWZ_ClipInfo = InheritFrom(LUI.UIElement)
CoD.AmmoWidgetWZ_ClipInfo.__defaultWidth = 64
CoD.AmmoWidgetWZ_ClipInfo.__defaultHeight = 61
CoD.AmmoWidgetWZ_ClipInfo.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	local self = LUI.UIElement.new(f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	self:setClass(CoD.AmmoWidgetWZ_ClipInfo)
	self.id = "AmmoWidgetWZ_ClipInfo"
	self.soundSet = "default"
	self.anyChildUsesUpdateState = true
	f1_arg0:addElementToPendingUpdateStateList(self)
	local Clip = CoD.AmmoWidgetMP_ClipContainerNew.new(f1_arg0, f1_arg1, 0, 0, 0, 64, 0, 0, 4, 30)
	Clip:mergeStateConditions({
		{
			...
			condition = function(menu, element, event)
				...
				if not IsCampaign() then
					f2_local0 = not WeaponUsesAmmo(f1_arg1)
				else
					f2_local0 = false
				end
				return f2_local0
	...
	local TotalAmmoLabel = Engine[@"getglobalmodel"]()
	ClipDual(ClipHero, TotalAmmoLabel["lobbyRoot.lobbyNav"], function(f6_arg0)
	...
	ClipDual(ClipHero, TotalAmmoLabel.weapon, function(f7_arg0)
		f1_arg0:updateElementState(Clip, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	TotalAmmoLabel = LUI.UIText.new(0, 0, 0, 64, 0, 0, 32, 48)
	...
	TotalAmmoLabel:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	TotalAmmoLabel:setShaderVector(0, 1, 0, 0, 0)
	TotalAmmoLabel:setShaderVector(1, 0, 0, 0, 0)
	TotalAmmoLabel:setShaderVector(2, 0.8, 0.8, 0.8, 0.3)
	...
	self:mergeStateConditions({
		...
		},
		{
			...
			condition = function(menu, element, event)
				return WeaponUsesAmmo(f1_arg1) and IsWeaponClipGreaterThanOrEqualTo(f1_arg1, 100)
			end,
		},
	})
	f1_local6 = self
...
CoD.AmmoWidgetWZ_ClipInfo.__resetProperties = function(f39_arg0)
	...
	f39_arg0.Clip:setLeftRight(0, 0, 0, 64)
	f39_arg0.Clip:setTopBottom(0, 0, 4, 30)
	f39_arg0.Clip:setRGB(ColorSet.T8__OFF__WHITE.r, ColorSet.T8__OFF__WHITE.g, ColorSet.T8__OFF__WHITE.b)
	f39_arg0.Clip:setAlpha(1)
	f39_arg0.TotalAmmoLabel:setLeftRight(0, 0, 0, 64)
	f39_arg0.TotalAmmoLabel:setTopBottom(0, 0, 32, 48)
...
CoD.AmmoWidgetWZ_ClipInfo.__clipsPerState = {
	DefaultState = {
		DefaultClip = function(f40_arg0, f40_arg1)
			f40_arg0:__resetProperties()
			f40_arg0:setupElementClipCounter(2)
			f40_arg0.Clip:completeAnimation()
			f40_arg0.Clip:setLeftRight(0, 0, 0, 64)
			f40_arg0.Clip:setTopBottom(0, 0, 14.5, 40.5)
			f40_arg0.Clip:setRGB(ColorSet.T8__OFF__WHITE.r, ColorSet.T8__OFF__WHITE.g, ColorSet.T8__OFF__WHITE.b)
	...
	DisposableMags = {
		DefaultClip = function(f41_arg0, f41_arg1)
			...
			f41_arg0.Clip:setLeftRight(0, 0, 0, 64)
			f41_arg0.Clip:setTopBottom(0, 0, 14.5, 40.5)
			f41_arg0.Clip:setRGB(ColorSet.T8__OFF__WHITE.r, ColorSet.T8__OFF__WHITE.g, ColorSet.T8__OFF__WHITE.b)
	...
	WeaponDual = {
		DefaultClip = function(f44_arg0, f44_arg1)
			...
			f44_arg0.Clip:setTopBottom(0, 0, 4, 30)
			...
			f44_arg0.ClipDual:setTopBottom(0, 0, 4, 30)
			...
			f44_arg0.TotalAmmoLabel:completeAnimation()
			f44_arg0.TotalAmmoLabel:setAlpha(1)
			f44_arg0.clipFinished(f44_arg0.TotalAmmoLabel)
		end,
	...
	Weapon = {
		DefaultClip = function(f46_arg0, f46_arg1)
			...
			f46_arg0.Clip:setLeftRight(0, 0, 0, 64)
			...
			f46_arg0.TotalAmmoLabel:setLeftRight(0, 0, 0, 64)
			f46_arg0.TotalAmmoLabel:setTopBottom(0, 0, 32, 48)
			f46_arg0.TotalAmmoLabel:setRGB(ColorSet.T8__BEIGE__HEADER.r, ColorSet.T8__BEIGE__HEADER.g, ColorSet.T8__BEIGE__HEADER.b)
			f46_arg0.TotalAmmoLabel:setAlpha(1)
		...
		Weapon3Digits = function(f47_arg0, f47_arg1)
			...
			f47_arg0.clipFinished(f47_arg0.TotalAmmoLabel)
		end,
	},
	Weapon3Digits = {
		DefaultClip = function(f48_arg0, f48_arg1)
			...
			f48_arg0.Clip:setLeftRight(0, 0, 0, 64)
			...
			f48_arg0.TotalAmmoLabel:setAlpha(1)
...
CoD.AmmoWidgetWZ_ClipInfo.__onClose = function(f50_arg0)
	f50_arg0.Clip:close()
