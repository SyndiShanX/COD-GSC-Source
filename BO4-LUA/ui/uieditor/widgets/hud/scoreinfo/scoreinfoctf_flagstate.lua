...
CoD.ScoreInfoCTF_FlagState.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	awayText:setAlpha(0)
	awayText:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_2C95E6E315A859AB"))
	awayText:setTTF("ttmussels_regular")
	awayText:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	awayText:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	self:addElement(awayText)
	self.awayText = awayText
	local homeText = LUI.UIText.new(0, 0, 0, 170, 0.5, 0.5, -9, 9)
	homeText:setAlpha(0)
	homeText:setText(Engine[@"hash_4F9F1239CFD921FE"](0xF60F2FAE650F9E))
	homeText:setTTF("ttmussels_regular")
	homeText:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	homeText:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	...
	FlagStateText:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	FlagStateText:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
