...
CoD.GameEndScoreTitle.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Stripe:setAlpha(0)
	Stripe:setImage(RegisterImage(@"hash_1CB3E0A1AFAFFB92"))
	...
	MatchInfo:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_3F72C8CF61961FB2"))
	MatchInfo:setTTF("ttmussels_demibold")
	MatchInfo:setLetterSpacing(24)
	MatchInfo:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	MatchInfo:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	self:addElement(MatchInfo)
	self.MatchInfo = MatchInfo
	local GlowBot = LUI.UIImage.new(0, 0, 128, 828, 0, 0, 38, 90)
	GlowBot:setAlpha(0)
	GlowBot:setZRot(180)
	GlowBot:setImage(RegisterImage(@"hash_11ADC9BCAB2CE792"))
	GlowBot:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	GlowTop:setAlpha(0)
	GlowTop:setImage(RegisterImage(@"hash_11ADC9BCAB2CE792"))
	GlowTop:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	DefaultState = {
		...
		Win = function(f12_arg0, f12_arg1)
			...
			local f12_local0 = function(f13_arg0)
				f12_arg0.Frame:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f12_local1 = function(f14_arg0)
				local f14_local0 = function(f15_arg0)
					...
					f15_arg0:beginAnimation(599, Enum[@"luitween"][@"luitween_ease_in"])
					f15_arg0:setAlpha(1)
			...
			local f12_local2 = function(f18_arg0)
				local f18_local0 = function(f19_arg0)
					f19_arg0:beginAnimation(400, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_in"])
					f19_arg0:setAlpha(1)
			...
			local f12_local3 = function(f20_arg0)
				local f20_local0 = function(f21_arg0)
					local f21_local0 = function(f22_arg0)
						f22_arg0:beginAnimation(399, Enum[@"luitween"][@"luitween_ease_both"])
						f22_arg0:setAlpha(0)
						f22_arg0:setShaderVector(0, 1, 0, 0, 0)
						f22_arg0:registerEventHandler("transition_complete_keyframe", f12_arg0.clipFinished)
					end
					f21_arg0:beginAnimation(400, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f12_local4 = function(f23_arg0)
				local f23_local0 = function(f24_arg0)
					local f24_local0 = function(f25_arg0)
						f25_arg0:beginAnimation(399, Enum[@"luitween"][@"luitween_ease_both"])
						f25_arg0:setAlpha(0)
						f25_arg0:setShaderVector(0, 1, 0, 0, 0)
						f25_arg0:registerEventHandler("transition_complete_keyframe", f12_arg0.clipFinished)
					end
					f24_arg0:beginAnimation(400, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
		...
		Loss = function(f34_arg0, f34_arg1)
			...
			local f34_local0 = function(f35_arg0)
				f34_arg0.Frame:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f34_local2 = function(f40_arg0)
				local f40_local0 = function(f41_arg0)
					f41_arg0:beginAnimation(400, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_in"])
					f41_arg0:setAlpha(1)
			...
			local f34_local3 = function(f42_arg0)
				local f42_local0 = function(f43_arg0)
					local f43_local0 = function(f44_arg0)
						f44_arg0:beginAnimation(399, Enum[@"luitween"][@"luitween_ease_both"])
						f44_arg0:setAlpha(0)
						f44_arg0:setShaderVector(0, 1, 0, 0, 0)
						f44_arg0:registerEventHandler("transition_complete_keyframe", f34_arg0.clipFinished)
					end
					f43_arg0:beginAnimation(400, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f34_local4 = function(f45_arg0)
				local f45_local0 = function(f46_arg0)
					local f46_local0 = function(f47_arg0)
						f47_arg0:beginAnimation(399, Enum[@"luitween"][@"luitween_ease_both"])
						f47_arg0:setAlpha(0)
						f47_arg0:setShaderVector(0, 1, 0, 0, 0)
						f47_arg0:registerEventHandler("transition_complete_keyframe", f34_arg0.clipFinished)
					end
					f46_arg0:beginAnimation(400, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
		...
		Draw = function(f56_arg0, f56_arg1)
			...
			local f56_local0 = function(f57_arg0)
				f56_arg0.Frame:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f56_local2 = function(f62_arg0)
				local f62_local0 = function(f63_arg0)
					f63_arg0:beginAnimation(400, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_in"])
					f63_arg0:setAlpha(1)
			...
			local f56_local3 = function(f64_arg0)
				local f64_local0 = function(f65_arg0)
					local f65_local0 = function(f66_arg0)
						f66_arg0:beginAnimation(399, Enum[@"luitween"][@"luitween_ease_both"])
						f66_arg0:setAlpha(0)
						f66_arg0:setShaderVector(0, 1, 0, 0, 0)
						f66_arg0:registerEventHandler("transition_complete_keyframe", f56_arg0.clipFinished)
					end
					f65_arg0:beginAnimation(400, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f56_local4 = function(f67_arg0)
				local f67_local0 = function(f68_arg0)
					local f68_local0 = function(f69_arg0)
						f69_arg0:beginAnimation(399, Enum[@"luitween"][@"luitween_ease_both"])
						f69_arg0:setAlpha(0)
						f69_arg0:setShaderVector(0, 1, 0, 0, 0)
						f69_arg0:registerEventHandler("transition_complete_keyframe", f56_arg0.clipFinished)
					end
					f68_arg0:beginAnimation(400, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
	...
	Neutral = {
		DefaultClip = function(f81_arg0, f81_arg1)
			...
			local f81_local0 = function(f82_arg0)
				f81_arg0.Frame:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f81_local2 = function(f87_arg0)
				local f87_local0 = function(f88_arg0)
					f88_arg0:beginAnimation(400, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_in"])
					f88_arg0:setAlpha(1)
			...
			local f81_local3 = function(f89_arg0)
				local f89_local0 = function(f90_arg0)
					local f90_local0 = function(f91_arg0)
						f91_arg0:beginAnimation(399, Enum[@"luitween"][@"luitween_ease_both"])
						f91_arg0:setAlpha(0)
						f91_arg0:setShaderVector(0, 1, 0, 0, 0)
						f91_arg0:registerEventHandler("transition_complete_keyframe", f81_arg0.clipFinished)
					end
					f90_arg0:beginAnimation(400, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f81_local4 = function(f92_arg0)
				local f92_local0 = function(f93_arg0)
					local f93_local0 = function(f94_arg0)
						f94_arg0:beginAnimation(399, Enum[@"luitween"][@"luitween_ease_both"])
						f94_arg0:setAlpha(0)
						f94_arg0:setShaderVector(0, 1, 0, 0, 0)
						f94_arg0:registerEventHandler("transition_complete_keyframe", f81_arg0.clipFinished)
					end
					f93_arg0:beginAnimation(400, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
