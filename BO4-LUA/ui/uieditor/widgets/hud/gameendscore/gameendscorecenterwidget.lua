...
CoD.GameEndScoreCenterWidget.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Ring:setImage(RegisterImage(@"hash_4F6B907EC3E8812F"))
	...
	RingPC:setAlpha(0)
	RingPC:setImage(RegisterImage(@"hash_4F6B907EC3E8812F"))
	...
	Versus:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_34F347C78B3F5793"))
	Versus:setTTF("0arame_mono_stencil")
	Versus:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	Versus:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
		...
		DefaultClip = function(f6_arg0, f6_arg1)
			...
			local f6_local0 = function(f7_arg0)
				local f7_local0 = function(f8_arg0)
					f8_arg0:beginAnimation(230, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f6_local1 = function(f9_arg0)
				local f9_local0 = function(f10_arg0)
					f10_arg0:beginAnimation(230, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f6_local3 = function(f13_arg0)
				local f13_local0 = function(f14_arg0)
					local f14_local0 = function(f15_arg0)
						f15_arg0:beginAnimation(40, Enum[@"luitween"][@"luitween_ease_in"])
						f15_arg0:setAlpha(0.8)
						f15_arg0:registerEventHandler("transition_complete_keyframe", f6_arg0.clipFinished)
					end
					f14_arg0:beginAnimation(99, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f6_local5 = function(f19_arg0)
				...
				f19_arg0:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f6_local7 = function(f23_arg0)
				local f23_local0 = function(f24_arg0)
					f24_arg0:beginAnimation(120, Enum[@"luitween"][@"luitween_ease_in"])
					f24_arg0:setAlpha(1)
		...
		DefaultClip = function(f29_arg0, f29_arg1)
			...
			local f29_local0 = function(f30_arg0)
				local f30_local0 = function(f31_arg0)
					f31_arg0:beginAnimation(230, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f29_local1 = function(f32_arg0)
				local f32_local0 = function(f33_arg0)
					f33_arg0:beginAnimation(230, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_in"])
