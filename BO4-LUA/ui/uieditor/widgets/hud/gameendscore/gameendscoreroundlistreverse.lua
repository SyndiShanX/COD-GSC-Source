...
CoD.GameEndScoreRoundListReverse = InheritFrom(LUI.UIElement)
CoD.GameEndScoreRoundListReverse.__defaultWidth = 316
CoD.GameEndScoreRoundListReverse.__defaultHeight = 74
CoD.GameEndScoreRoundListReverse.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	local self = LUI.UIElement.new(f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	self:setClass(CoD.GameEndScoreRoundListReverse)
	self.id = "GameEndScoreRoundListReverse"
	...
	RoundPipList:setTopBottom(0.5, 0.5, -24, 24)
...
CoD.GameEndScoreRoundListReverse.__resetProperties = function(f16_arg0)
...
CoD.GameEndScoreRoundListReverse.__clipsPerState = {
	DefaultState = {
	...
	ShowNumber = {
		DefaultClip = function(f18_arg0, f18_arg1)
			...
			f18_arg0.Score:setAlpha(0)
			f18_local0(f18_arg0.Score)
		end,
	},
}
CoD.GameEndScoreRoundListReverse.__onClose = function(f20_arg0)
