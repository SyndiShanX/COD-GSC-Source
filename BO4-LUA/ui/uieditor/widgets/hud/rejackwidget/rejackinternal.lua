local f0_local0 = function(f1_arg0, f1_arg1, f1_arg2)
	...
	local f1_local2 = (f1_arg2 - Engine[0xB07E933C9E5CEB1]()) / (f1_local0 - f1_local1)
	f1_arg0:playClip("HeartBeat")
	Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](Engine[0x4DF5CFBC1771947](f1_arg1), "hudItems.rejack.countdownText"), f1_local0)
	...
	f1_arg0.countdownTimer = LUI.UITimer.newElementTimer(f1_local2, false, function()
		...
		if f1_local1 <= f1_arg0.countdownText then
			Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](Engine[0x4DF5CFBC1771947](f1_arg1), "hudItems.rejack.countdownText"), f1_arg0.countdownText)
		else
...
local f0_local1 = function(f3_arg0, f3_arg1)
	...
	Engine[0x83C9B5DE1D9371](Engine[0xA798E4552F5E872](Engine[0x4DF5CFBC1771947](f3_arg1), "hudItems.rejack.countdownText"), f3_arg0.startVal)
...
CoD.RejackInternal.new = function(f5_arg0, f5_arg1, f5_arg2, f5_arg3, f5_arg4, f5_arg5, f5_arg6, f5_arg7, f5_arg8, f5_arg9)
	...
	RejackTitle:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	RejackTitle:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	RejackingTitle2:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	RejackingTitle2:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	TimeRemaining:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	TimeRemaining:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	RejackingTitle20:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	RejackingTitle20:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
