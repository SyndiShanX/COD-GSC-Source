...
CoD.StoreFeaturedFrameGrid.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	DotlineV06:setImage(RegisterImage(@"hash_C49B0C8991A541F"))
	DotlineV06:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	DotlineV05:setImage(RegisterImage(@"hash_C49B0C8991A541F"))
	DotlineV05:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	DotlineV01:setImage(RegisterImage(@"hash_C49B0C8991A541F"))
	DotlineV01:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	DotlineH01:setImage(RegisterImage(@"hash_6F5E8F1B8586D9C5"))
	DotlineH01:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	DefaultState = {
		...
		Intro = function(f4_arg0, f4_arg1)
			...
			local f4_local0 = function(f5_arg0)
				f4_arg0.plus03:beginAnimation(250, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f4_local1 = function(f6_arg0)
				f4_arg0.plus02:beginAnimation(250, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f4_local2 = function(f7_arg0)
				f4_arg0.plus01:beginAnimation(250, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f4_local3 = function(f8_arg0)
				local f8_local0 = function(f9_arg0)
					f9_arg0:beginAnimation(350, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f4_local4 = function(f10_arg0)
				local f10_local0 = function(f11_arg0)
					f11_arg0:beginAnimation(350, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f4_local5 = function(f12_arg0)
				local f12_local0 = function(f13_arg0)
					f13_arg0:beginAnimation(350, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f4_local6 = function(f14_arg0)
				local f14_local0 = function(f15_arg0)
					f15_arg0:beginAnimation(350, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f4_local7 = function(f16_arg0)
				local f16_local0 = function(f17_arg0)
					f17_arg0:beginAnimation(350, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f4_local8 = function(f18_arg0)
				local f18_local0 = function(f19_arg0)
					f19_arg0:beginAnimation(350, Enum[@"luitween"][@"luitween_ease_both"])
