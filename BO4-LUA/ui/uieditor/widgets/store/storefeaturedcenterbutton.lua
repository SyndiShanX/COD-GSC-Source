	...
	DefaultState = {
		...
		GainChildFocus = function(f8_arg0, f8_arg1)
			...
			local f8_local0 = function(f9_arg0)
				f8_arg0.itemImage:beginAnimation(200, Enum[0xF50FFF429AB1890][0x53CEB9A0427197])
		...
		LoseChildFocus = function(f10_arg0, f10_arg1)
			...
			local f10_local0 = function(f11_arg0)
				f10_arg0.itemImage:beginAnimation(200, Enum[0xF50FFF429AB1890][0x53CEB9A0427197])
