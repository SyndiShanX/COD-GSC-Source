...
CoD.ZMGenericSummaryStatWidget.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	ValueGlow:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	ValueGlow:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	ValueGlow:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	ValueGlow2:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	ValueGlow2:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	ValueGlow2:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	Value:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_171E049B161CD00A"))
