...
CoD.ZMAARTrialTabRoundStat.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Num:setAlpha(0.5)
	Num:setTTF("skorzhen")
	Num:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	...
	TitleUnknown:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_7521943FA0D36D36"))
	TitleUnknown:setTTF("skorzhen")
	TitleUnknown:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
...
CoD.ZMAARTrialTabRoundStat.__resetProperties = function(f5_arg0)
	...
	f5_arg0.Title:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	f5_arg0.TitleUnknown:setLeftRight(0, 0, 67, 390)
	f5_arg0.TitleUnknown:setRGB(0.92, 0.92, 0.92)
	f5_arg0.TitleUnknown:setAlpha(1)
	f5_arg0.TitleUnknown:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
...
CoD.ZMAARTrialTabRoundStat.__clipsPerState = {
	...
	Incomplete = {
		DefaultClip = function(f10_arg0, f10_arg1)
			...
			f10_arg0.Title:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
			...
			f10_arg0.TitleUnknown:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
