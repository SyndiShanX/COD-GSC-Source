...
CoD.LeaderboardHeader.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Column0:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
	Column0:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	Column1:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
	Column1:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	Column2:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
	Column2:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	Column3:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
	Column3:setAlignment(Enum[0x7A5123B654282D2][0xE821F0ECFF8D1C7])
	...
	Column4:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
	Column4:setAlignment(Enum[0x7A5123B654282D2][0xE821F0ECFF8D1C7])
	...
	TopFrame:setImage(RegisterImage(0xC325BED3F226657))
	TopFrame:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
...
CoD.LeaderboardHeader.__resetProperties = function(f12_arg0)
	...
	f12_arg0.Rank:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
	f12_arg0.Name:setTopBottom(0.5, 0.5, -9, 9)
	f12_arg0.Name:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	f12_arg0.Position:setTopBottom(0.5, 0.5, -9, 9)
	f12_arg0.Position:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
...
CoD.LeaderboardHeader.__clipsPerState = {
	...
	DefaultStateArabic = {
		DefaultClip = function(f14_arg0, f14_arg1)
			...
			f14_arg0.Position:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
			f14_arg0.clipFinished(f14_arg0.Position)
			f14_arg0.Rank:completeAnimation()
			f14_arg0.Rank:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
			f14_arg0.clipFinished(f14_arg0.Rank)
			f14_arg0.Name:completeAnimation()
			f14_arg0.Name:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
