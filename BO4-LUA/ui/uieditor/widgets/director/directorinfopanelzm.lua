...
CoD.DirectorInfoPanelZM.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	TabDesc:setAlignment(Engine[@"hash_67F8853DC3581AA4"](Enum[@"luialignment"][@"lui_alignment_left"]))
	TabDesc:setAlignment(Engine[@"hash_67F8853DC3581AA4"](Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"]))
	TabDesc:linkToElementModel(self, "tabDesc", true, function(model)
		local f3_local0 = model:get()
		if f3_local0 ~= nil then
			TabDesc:setText(Engine[@"hash_4F9F1239CFD921FE"](f3_local0))
		end
	end)
	...
	StoryDesc:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	StoryDesc:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	StoryDesc:linkToElementModel(self, "storyDesc", true, function(model)
		local f5_local0 = model:get()
		if f5_local0 ~= nil then
			StoryDesc:setText(Engine[@"hash_4F9F1239CFD921FE"](f5_local0))
		end
	end)
	...
	TiledBacking3:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16CBE95C250C6D15"))
	...
	TiledBacking4:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16CBE95C250C6D15"))
	...
	IntStatHeader1:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	IntStatHeader1:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	IntStatHeader2:setText(LocalizeToUpperString(@"hash_8E2A982E7E6C57A"))
	IntStatHeader2:setTTF("skorzhen")
	IntStatHeader2:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	IntStatHeader2:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	IntStatHeader3:setText(LocalizeToUpperString(@"hash_7A02EA29F37FAD9E"))
	IntStatHeader3:setTTF("skorzhen")
	IntStatHeader3:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	IntStatHeader3:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	IntStatHeader4:setText(LocalizeToUpperString(@"hash_4D0DA41C5196284E"))
	IntStatHeader4:setTTF("skorzhen")
	IntStatHeader4:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	IntStatHeader4:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	IntStat1:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	IntStat1:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	IntStat2:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	IntStat2:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	IntStat3:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	IntStat3:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	IntStat4:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	IntStat4:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TimeStat1:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TimeStat1:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TimeStatHeader1:setText(LocalizeToUpperString(@"hash_414A0CBAA1B5F463"))
	TimeStatHeader1:setTTF("skorzhen")
	TimeStatHeader1:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TimeStatHeader1:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	TimeStatHeader2:setText(LocalizeToUpperString(@"hash_1579002A8837BFA5"))
	TimeStatHeader2:setTTF("skorzhen")
	TimeStatHeader2:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TimeStatHeader2:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	TimeStatSmall1:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TimeStatSmall1:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TimeStatSmall2:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TimeStatSmall2:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TimeStatSmall3:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TimeStatSmall3:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	MapName:setAlignment(Engine[@"hash_67F8853DC3581AA4"](Enum[@"luialignment"][@"lui_alignment_left"]))
	MapName:setAlignment(Engine[@"hash_67F8853DC3581AA4"](Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"]))
	...
	MapsString:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	MapsString:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	GametypesString:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	GametypesString:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
...
CoD.DirectorInfoPanelZM.__resetProperties = function(f34_arg0)
	...
	f34_arg0.Header1:setText(LocalizeToUpperString(@"hash_1388A4D4A933E2CB"))
	f34_arg0.Header2:setTopBottom(1, 1, -217, -193)
	f34_arg0.Header2:setRGB(0.92, 0.92, 0.92)
	f34_arg0.Header2:setAlpha(0)
	f34_arg0.Header2:setText(LocalizeToUpperString(@"hash_2D018E374661728B"))
	...
	f34_arg0.IntStatHeader3:setText(LocalizeToUpperString(@"hash_7A02EA29F37FAD9E"))
	...
	f34_arg0.IntStatHeader4:setText(LocalizeToUpperString(@"hash_4D0DA41C5196284E"))
	f34_arg0.IntStatHeader4:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	...
	f34_arg0.TimeStatHeader1:setText(LocalizeToUpperString(@"hash_414A0CBAA1B5F463"))
	f34_arg0.TimeStatHeader1:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
...
CoD.DirectorInfoPanelZM.__clipsPerState = {
	...
	ZombieRush = {
		DefaultClip = function(f39_arg0, f39_arg1)
			...
			f39_arg0.IntStatHeader3:setText(LocalizeToUpperString(@"hash_7D80ABF106EEC246"))
			...
			f39_arg0.IntStatHeader4:setText(LocalizeToUpperString(@"hash_A2A3178502E973A"))
	...
	Trials = {
		DefaultClip = function(f41_arg0, f41_arg1)
			...
			f41_arg0.Header2:setText(LocalizeToUpperString(@"hash_DD47718CCC82EA"))
			...
			f41_arg0.IntStatHeader4:setText(LocalizeToUpperString(@"hash_15800C2A883DF2B7"))
			f41_arg0.IntStatHeader4:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
			...
			f41_arg0.TimeStatHeader1:setText(LocalizeToUpperString(@"hash_1575FA2A88357F9C"))
			f41_arg0.TimeStatHeader1:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	...
	TrialsVariant1 = {
		DefaultClip = function(f42_arg0, f42_arg1)
			...
			f42_arg0.Header2:setText(LocalizeToUpperString(@"hash_DD47718CCC82EA"))
			...
			f42_arg0.IntStatHeader4:setText(LocalizeToUpperString(@"hash_15800C2A883DF2B7"))
			f42_arg0.IntStatHeader4:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
			...
			f42_arg0.TimeStatHeader1:setText(LocalizeToUpperString(@"hash_1575FA2A88357F9C"))
			f42_arg0.TimeStatHeader1:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
			...
			f42_arg0.TrialsSilverMedal.Medal:setImage(RegisterImage(@"hash_FD6B3DF8A0BA964"))
			...
			f42_arg0.TrialsGoldMedal.Medal:setImage(RegisterImage(@"hash_18F9261A2CAA7739"))
