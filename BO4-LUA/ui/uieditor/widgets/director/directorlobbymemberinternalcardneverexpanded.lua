...
CoD.DirectorLobbyMemberInternalCardNeverExpanded.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	FocusGlowSquare:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_6DAB59B2CAE01851"))
	...
	DefaultState = {
		...
		GainFocus = function(f8_arg0, f8_arg1)
			...
			local f8_local0 = function(f9_arg0)
				local f9_local0 = function(f10_arg0)
					f10_arg0:beginAnimation(50, Enum[@"luitween"][@"luitween_ease_out"])
		...
		LoseFocus = function(f13_arg0, f13_arg1)
			...
			local f13_local0 = function(f14_arg0)
				f13_arg0.FocusBrackets:beginAnimation(60, Enum[@"luitween"][@"luitween_ease_in"])
