...
CoD.TrialCountdownSmallWidget.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	TrialText:setText(LocalizeToUpperString(@"hash_3F16F4088C060F3A"))
	...
	TrialText:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	...
	TrialCountdownText:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	TrialCountdownText:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	TrialCountdownText:subscribeToGlobalModel(f1_arg1, "WarzoneTrialInfo", "countdown_timer", function(model)
		local f2_local0 = model:get()
		if f2_local0 ~= nil then
			TrialCountdownText:setText(LocalizeIntoStringIfNotEmpty(@"hash_1C0CE2452CF87DB1", f2_local0))
		end
	end)
