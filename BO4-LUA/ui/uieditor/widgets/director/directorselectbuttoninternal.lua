...
CoD.DirectorSelectButtonInternal.__clipsPerState = {
	...
	Locked = {
		...
		Focus = function(f25_arg0, f25_arg1)
			...
			f25_arg0.ImageNotFocus:setMaterial(LUI.UIImage.GetCachedMaterial(0x67D1E3A3D2D1BF))
		...
		GainFocus = function(f26_arg0, f26_arg1)
			...
			f26_arg0.ImageNotFocus:setMaterial(LUI.UIImage.GetCachedMaterial(0x67D1E3A3D2D1BF))
