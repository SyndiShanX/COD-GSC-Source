	...
	DefaultState = {
		...
		GainFocus = function(f20_arg0, f20_arg1)
			...
			local f20_local0 = function(f21_arg0)
				local f21_local0 = function(f22_arg0)
					f22_arg0:beginAnimation(50, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f20_local2 = function(f24_arg0)
				f20_arg0.SelectionOverlay:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
		...
		LoseFocus = function(f26_arg0, f26_arg1)
			...
			local f26_local1 = function(f28_arg0)
				f26_arg0.SelectionOverlay:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
