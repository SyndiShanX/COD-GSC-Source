	...
	DefaultState = {
		...
		LoseFocus = function(f26_arg0, f26_arg1)
			...
			local f26_local0 = function(f27_arg0)
				f26_arg0.FocusBrackets:beginAnimation(60, Enum[@"luitween"][@"luitween_ease_in"])
	...
	AlwaysExpand = {
		...
		GainFocus = function(f36_arg0, f36_arg1)
			...
			local f36_local0 = function(f37_arg0)
				local f37_local0 = function(f38_arg0)
					f38_arg0:beginAnimation(50, Enum[@"luitween"][@"luitween_ease_out"])
		...
		LoseFocus = function(f41_arg0, f41_arg1)
			...
			local f41_local0 = function(f42_arg0)
				f41_arg0.FocusBrackets:beginAnimation(60, Enum[@"luitween"][@"luitween_ease_in"])
