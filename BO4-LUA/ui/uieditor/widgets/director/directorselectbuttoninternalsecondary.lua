...
CoD.DirectorSelectButtonInternalSecondary.__clipsPerState = {
	...
	Locked = {
		DefaultClip = function(f22_arg0, f22_arg1)
			...
			f22_arg0.ImageNotFocus:setMaterial(LUI.UIImage.GetCachedMaterial(0x67D1E3A3D2D1BF))
		...
		Focus = function(f23_arg0, f23_arg1)
			...
			f23_arg0.ImageNotFocus:setMaterial(LUI.UIImage.GetCachedMaterial(0x67D1E3A3D2D1BF))
		...
		GainFocus = function(f24_arg0, f24_arg1)
			...
			f24_arg0.ImageNotFocus:setMaterial(LUI.UIImage.GetCachedMaterial(0x67D1E3A3D2D1BF))
