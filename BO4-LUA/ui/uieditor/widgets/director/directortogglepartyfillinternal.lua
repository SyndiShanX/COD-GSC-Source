...
CoD.DirectorTogglePartyFillInternal.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Status:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	...
	StatusFocus:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_2AE166D9BA8C6907"))
	...
	StatusFocus:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	StatusFocus:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	...
	MiddleText:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	...
	MiddleTextFocus:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	MiddleTextFocus:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	...
	Disabled = {
		...
		GainFocus = function(f35_arg0, f35_arg1)
			...
			local f35_local0 = function(f36_arg0)
				...
				f35_arg0.FocusBrackets:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_in"])
