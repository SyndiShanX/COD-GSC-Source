	...
	DefaultState = {
		...
		GainFocus = function(f8_arg0, f8_arg1)
			...
			local f8_local1 = function(f11_arg0)
				f8_arg0.FrontendFrameSelected:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f8_local2 = function(f12_arg0)
				f8_arg0.FocusGlow:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
		...
		LoseFocus = function(f19_arg0, f19_arg1)
			...
			local f19_local0 = function(f20_arg0)
				f19_arg0.FocusBrackets:beginAnimation(60, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f19_local1 = function(f21_arg0)
				f19_arg0.FrontendFrameSelected:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
	...
	Locked = {
		...
		GainFocus = function(f41_arg0, f41_arg1)
			...
			local f41_local0 = function(f42_arg0)
				local f42_local0 = function(f43_arg0)
					f43_arg0:beginAnimation(50, Enum[@"luitween"][@"luitween_ease_out"])
		...
		LoseFocus = function(f45_arg0, f45_arg1)
			...
			local f45_local0 = function(f46_arg0)
				f45_arg0.FocusBrackets:beginAnimation(60, Enum[@"luitween"][@"luitween_ease_in"])
