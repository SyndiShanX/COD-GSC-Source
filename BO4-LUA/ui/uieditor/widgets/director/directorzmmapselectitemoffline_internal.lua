...
CoD.DirectorZMMapSelectItemOffline_Internal.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	TeamName:setText(Engine[@"hash_4F9F1239CFD921FE"](@"menu/new"))
	TeamName:setTTF("skorzhen")
	TeamName:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	TeamName:setAlignment(Enum[@"luialignment"][@"lui_alignment_bottom"])
		...
		GainFocus = function(f19_arg0, f19_arg1)
			...
			local f19_local2 = function(f22_arg0)
				local f22_local0 = function(f23_arg0)
					f23_arg0:beginAnimation(50, Enum[@"luitween"][@"luitween_ease_out"])
