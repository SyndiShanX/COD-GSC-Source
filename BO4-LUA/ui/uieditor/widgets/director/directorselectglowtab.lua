...
CoD.DirectorSelectGlowTab.__resetProperties = function(f7_arg0)
	...
	f7_arg0.TabEndLeft:setMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
...
CoD.DirectorSelectGlowTab.__clipsPerState = {
	DefaultState = {
		...
		Active = function(f9_arg0, f9_arg1)
			...
			f9_arg0.TabEndLeft:setMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
		...
		GainActive = function(f12_arg0, f12_arg1)
			...
			f12_arg0.TabEndLeft:setMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
		...
		LoseActive = function(f28_arg0, f28_arg1)
			...
			f28_arg0.TabEndLeft:setMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
