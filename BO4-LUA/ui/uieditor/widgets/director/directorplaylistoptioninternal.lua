...
CoD.DirectorPlaylistOptionInternal.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	GameModeText:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	GameModeText:setAlignment(Enum[@"luialignment"][@"lui_alignment_bottom"])
			...
			condition = function(menu, element, event)
				...
				if f10_local0 then
					if not CoD.ModelUtility.IsSelfModelValueEqualToEnum(element, f1_arg1, "lockState", Enum[@"playlistlockstate"][@"pls_required_dlc_not_available"]) then
						f10_local0 = not CoD.ModelUtility.IsSelfModelValueEqualToEnum(element, f1_arg1, "lockState", Enum[@"playlistlockstate"][@"hash_4BDEB566326AC98"])
					else
						f10_local0 = false
					end
				end
