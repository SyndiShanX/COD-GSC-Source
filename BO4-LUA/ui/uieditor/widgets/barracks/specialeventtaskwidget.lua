...
CoD.SpecialEventTaskWidget.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	TaskName:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	TaskName:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	...
	TaskDescription:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	TaskDescription:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	TaskDescription:linkToElementModel(self, "taskDescription", true, function(model)
		local f4_local0 = model:get()
		if f4_local0 ~= nil then
			TaskDescription:setText(Engine[@"hash_4F9F1239CFD921FE"](f4_local0))
		end
	end)
	...
	TaskProgressString:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
