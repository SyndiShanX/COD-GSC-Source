CoD[@"hash_1C8E42E011D260E"] = InheritFrom(LUI.UIElement)
CoD[@"hash_1C8E42E011D260E"].__defaultWidth = 960
CoD[@"hash_1C8E42E011D260E"].__defaultHeight = 240
		...
		DefaultClip = function(f3_arg0, f3_arg1)
			...
			local f3_local0 = function(f4_arg0)
				local f4_local0 = function(f5_arg0)
					f5_arg0:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_in"])
					f5_arg0:setLeftRight(0, 0, 0, 312)
					f5_arg0:registerEventHandler("transition_complete_keyframe", f3_arg0.clipFinished)
				end
				f3_arg0.zombie1:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f3_local1 = function(f6_arg0)
				local f6_local0 = function(f7_arg0)
					f7_arg0:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_in"])
					f7_arg0:setLeftRight(0, 0, 213, 629)
					f7_arg0:registerEventHandler("transition_complete_keyframe", f3_arg0.clipFinished)
				end
				f3_arg0.man1:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f3_local2 = function(f8_arg0)
				local f8_local0 = function(f9_arg0)
					f9_arg0:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_in"])
					f9_arg0:setLeftRight(0, 0, 451, 787)
					f9_arg0:registerEventHandler("transition_complete_keyframe", f3_arg0.clipFinished)
				end
				f3_arg0.man2:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f3_local3 = function(f10_arg0)
				local f10_local0 = function(f11_arg0)
					f11_arg0:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_in"])
					f11_arg0:setLeftRight(0, 0, 624, 960)
					f11_arg0:registerEventHandler("transition_complete_keyframe", f3_arg0.clipFinished)
				end
				f3_arg0.headblood:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f3_local4 = function(f12_arg0)
				local f12_local0 = function(f13_arg0)
					f13_arg0:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_in"])
					f13_arg0:setLeftRight(0, 0, 811, 931)
					f13_arg0:registerEventHandler("transition_complete_keyframe", f3_arg0.clipFinished)
				end
				f3_arg0.head:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f3_local5 = function(f14_arg0)
				local f14_local0 = function(f15_arg0)
					f15_arg0:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_in"])
					f15_arg0:setLeftRight(0, 0, 563.5, 979.5)
					f15_arg0:registerEventHandler("transition_complete_keyframe", f3_arg0.clipFinished)
				end
				f3_arg0.armblood:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f3_local6 = function(f16_arg0)
				local f16_local0 = function(f17_arg0)
					f17_arg0:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_in"])
					f17_arg0:setLeftRight(0, 0, 718.5, 974.5)
					f17_arg0:registerEventHandler("transition_complete_keyframe", f3_arg0.clipFinished)
				end
				f3_arg0.zombiearm:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f3_local7 = function(f18_arg0)
				local f18_local0 = function(f19_arg0)
					f19_arg0:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_in"])
					f19_arg0:setLeftRight(0, 0, 0, 816)
					f19_arg0:registerEventHandler("transition_complete_keyframe", f3_arg0.clipFinished)
				end
				f3_arg0.smoke:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_in"])
