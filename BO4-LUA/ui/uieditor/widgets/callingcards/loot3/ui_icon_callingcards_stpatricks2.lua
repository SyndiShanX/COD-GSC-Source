		...
		DefaultClip = function(f3_arg0, f3_arg1)
			...
			local f3_local5 = function(f11_arg0)
				local f11_local0 = function(f12_arg0)
					f12_arg0:beginAnimation(2100, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f3_local6 = function(f14_arg0)
				local f14_local0 = function(f15_arg0)
					f15_arg0:beginAnimation(2100, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f3_local7 = function(f17_arg0)
				local f17_local0 = function(f18_arg0)
					f18_arg0:beginAnimation(2100, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f3_local8 = function(f20_arg0)
				local f20_local0 = function(f21_arg0)
					f21_arg0:beginAnimation(2100, Enum[@"luitween"][@"luitween_ease_out"])
