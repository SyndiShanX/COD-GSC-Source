...
CoD.MedalPreviewWidget.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	MedalCount:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	MedalCount:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	MedalCount:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	MedalName:setAlignment(Enum[@"luialignment"][@"lui_alignment_bottom"])
	...
	MedalDescription:setAlignment(Engine[@"hash_67F8853DC3581AA4"](Enum[@"luialignment"][@"lui_alignment_left"]))
	MedalDescription:setAlignment(Engine[@"hash_67F8853DC3581AA4"](Enum[@"luialignment"][@"lui_alignment_top"]))
	MedalDescription:linkToElementModel(self, "description", true, function(model)
		local f5_local0 = model:get()
		if f5_local0 ~= nil then
			MedalDescription:setText(Engine[@"hash_4F9F1239CFD921FE"](f5_local0))
		end
	end)
	...
	DotPip:setAlpha(0.5)
	DotPip:setImage(RegisterImage(@"hash_73854665C02218EF"))
	...
	DotPip2:setImage(RegisterImage(@"hash_73854665C02218EF"))
	...
	DotPip4:setImage(RegisterImage(@"hash_73854665C02218EF"))
	...
	DotPip3:setImage(RegisterImage(@"hash_73854665C02218EF"))
