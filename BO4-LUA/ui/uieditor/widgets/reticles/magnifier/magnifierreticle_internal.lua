	...
	DefaultState = {
		...
		Zoom = function(f6_arg0, f6_arg1)
			...
			local f6_local0 = function(f7_arg0)
				f6_arg0.OneXring:beginAnimation(250, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f6_local2 = function(f10_arg0)
				f6_arg0.OutterReticle:beginAnimation(250, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f6_local3 = function(f11_arg0)
				f6_arg0.ZoomBAr:beginAnimation(250, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f6_local4 = function(f12_arg0)
				f6_arg0.ThreeX:beginAnimation(250, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f6_local5 = function(f13_arg0)
				f6_arg0.ZoomInBar:beginAnimation(250, Enum[@"luitween"][@"luitween_ease_both"])
