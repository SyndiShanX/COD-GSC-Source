...
CoD.TempestReticleInternal.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	ReticleLineBottom:setMaterial(LUI.UIImage.GetCachedMaterial(0x4E6CE42E0799F57))
	...
	ReticleLineTop:setMaterial(LUI.UIImage.GetCachedMaterial(0x4E6CE42E0799F57))
	...
	ReticleLineRight:setMaterial(LUI.UIImage.GetCachedMaterial(0x4E6CE42E0799F57))
	...
	ReticleLineLeft:setMaterial(LUI.UIImage.GetCachedMaterial(0x4E6CE42E0799F57))
	...
	OuterLineAngleCenter:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	OuterLineRightTop:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	OuterLineAngleCenter0:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	OuterLineRightTopLeft2:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	OuterLineAngleCenter1:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	OuterLineRightTop1:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	OuterLineAngleCenterLL:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	OuterLineLeft2:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	Image0:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	Image1:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	Image2:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	Image3:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	self:mergeStateConditions({
		{
			...
			condition = function(menu, element, event)
				return CoD.ModelUtility.IsGlobalDataSourceModelValueEqualToEnum(f1_arg1, "CurrentWeapon", "weaponDelayFiring", Enum[0x9F4B605DFDC7FFF][0x53F33952DDBD5D0])
			end,
		},
	})
...
CoD.TempestReticleInternal.__resetProperties = function(f4_arg0)
	...
	f4_arg0.OuterLineAngleCenter0:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
...
CoD.TempestReticleInternal.__clipsPerState = {
	DefaultState = {
		...
		Fire = function(f6_arg0, f6_arg1)
			...
			f6_arg0.OuterLineAngleCenter0:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
