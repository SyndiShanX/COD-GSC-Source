require("x64:e28f49355328b81")
CoD.LauncherMultiReticle_UI3D = InheritFrom(LUI.UIElement)
CoD.LauncherMultiReticle_UI3D.__defaultWidth = 768
CoD.LauncherMultiReticle_UI3D.__defaultHeight = 768
CoD.LauncherMultiReticle_UI3D.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	local internal = CoD.LauncherMultiReticle_UI3D_Internal.new(f1_arg0, f1_arg1, 0, 0, 0, 768, 0, 0, 0, 768)
...
CoD.LauncherMultiReticle_UI3D.__resetProperties = function(f6_arg0)
	f6_arg0.internal:completeAnimation()
	f6_arg0.internal:setAlpha(1)
end
CoD.LauncherMultiReticle_UI3D.__clipsPerState = {
	DefaultState = {
...
CoD.LauncherMultiReticle_UI3D.__onClose = function(f9_arg0)
