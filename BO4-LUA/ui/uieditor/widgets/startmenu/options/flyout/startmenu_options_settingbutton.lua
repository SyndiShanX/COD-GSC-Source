...
CoD.StartMenu_Options_SettingButton.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	ButtonActionLabel:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	ButtonActionLabel:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	DefaultState = {
		...
		LoseChildFocus = function(f16_arg0, f16_arg1)
			...
			local f16_local5 = function(f22_arg0)
				f16_arg0.FocusBrackets:beginAnimation(60, Enum[@"luitween"][@"luitween_ease_in"])
