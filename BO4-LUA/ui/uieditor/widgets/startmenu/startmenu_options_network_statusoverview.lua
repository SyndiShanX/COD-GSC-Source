...
CoD.StartMenu_Options_Network_StatusOverview.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	FirstPartyStateLabel:setText(Engine[@"hash_4F9F1239CFD921FE"]("platform/options_network_signed_in"))
	FirstPartyStateLabel:setTTF("ttmussels_regular")
	FirstPartyStateLabel:setAlignment(Enum.LUIAlignment[@"lui_alignment_left"])
	FirstPartyStateLabel:setAlignment(Enum.LUIAlignment[@"lui_alignment_top"])
	...
	ServerStateLabel:setText(Engine[@"hash_4F9F1239CFD921FE"]("menu/options_network_cod_connected"))
	ServerStateLabel:setTTF("ttmussels_regular")
	ServerStateLabel:setAlignment(Enum.LUIAlignment[@"lui_alignment_left"])
	...
	InternetStateLabel:setText(Engine[@"hash_4F9F1239CFD921FE"]("menu/options_network_internet_not_connected"))
	InternetStateLabel:setTTF("ttmussels_regular")
	InternetStateLabel:setAlignment(Enum.LUIAlignment[@"lui_alignment_left"])
...
CoD.StartMenu_Options_Network_StatusOverview.__resetProperties = function(f6_arg0)
	...
	f6_arg0.ServerStateLabel:setText(Engine[@"hash_4F9F1239CFD921FE"]("menu/options_network_cod_connected"))
	...
	f6_arg0.FirstPartyStateLabel:setText(Engine[@"hash_4F9F1239CFD921FE"]("platform/options_network_signed_in"))
...
CoD.StartMenu_Options_Network_StatusOverview.__clipsPerState = {
	DefaultState = {
		...
		GainFocus = function(f9_arg0, f9_arg1)
			...
			local f9_local3 = function(f13_arg0)
				local f13_local0 = function(f14_arg0)
					f14_arg0:beginAnimation(50, Enum[@"luitween"][@"luitween_ease_out"])
		...
		LoseFocus = function(f15_arg0, f15_arg1)
			...
			local f15_local3 = function(f19_arg0)
				f15_arg0.FocusBrackets:beginAnimation(60, Enum[@"luitween"][@"luitween_ease_in"])
	...
	NoInternet = {
		...
		GainFocus = function(f22_arg0, f22_arg1)
			...
			local f22_local0 = function(f23_arg0)
				f22_arg0.FocusGlow:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
		...
		LoseFocus = function(f27_arg0, f27_arg1)
			...
			local f27_local2 = function(f30_arg0)
				f27_arg0.FocusBrackets:beginAnimation(60, Enum[@"luitween"][@"luitween_ease_in"])
	...
	NotSignedInToLive = {
		DefaultClip = function(f31_arg0, f31_arg1)
			...
			f31_arg0.FirstPartyStateLabel:setText(Engine[@"hash_4F9F1239CFD921FE"]("platform/options_network_not_signed_in"))
			f31_arg0.clipFinished(f31_arg0.FirstPartyStateLabel)
			f31_arg0.ServerStateLabel:completeAnimation()
			f31_arg0.ServerStateLabel:setText(Engine[@"hash_4F9F1239CFD921FE"]("menu/options_network_cod_not_connected"))
		...
		Focus = function(f32_arg0, f32_arg1)
			...
			f32_arg0.FirstPartyStateLabel:setText(Engine[@"hash_4F9F1239CFD921FE"]("platform/options_network_not_signed_in"))
			f32_arg0.clipFinished(f32_arg0.FirstPartyStateLabel)
			f32_arg0.ServerStateLabel:completeAnimation()
			f32_arg0.ServerStateLabel:setText(Engine[@"hash_4F9F1239CFD921FE"]("menu/options_network_cod_not_connected"))
		...
		GainFocus = function(f33_arg0, f33_arg1)
			...
			local f33_local0 = function(f34_arg0)
				f33_arg0.FocusGlow:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
			...
			f33_arg0.FirstPartyStateLabel:setText(Engine[@"hash_4F9F1239CFD921FE"]("platform/options_network_not_signed_in"))
			f33_arg0.clipFinished(f33_arg0.FirstPartyStateLabel)
			f33_arg0.ServerStateLabel:completeAnimation()
			f33_arg0.ServerStateLabel:setText(Engine[@"hash_4F9F1239CFD921FE"]("menu/options_network_cod_not_connected"))
			...
			local f33_local2 = function(f36_arg0)
				local f36_local0 = function(f37_arg0)
					f37_arg0:beginAnimation(50, Enum[@"luitween"][@"luitween_ease_out"])
		...
		LoseFocus = function(f38_arg0, f38_arg1)
			...
			f38_arg0.FirstPartyStateLabel:setText(Engine[@"hash_4F9F1239CFD921FE"]("platform/options_network_not_signed_in"))
			f38_arg0.clipFinished(f38_arg0.FirstPartyStateLabel)
			f38_arg0.ServerStateLabel:completeAnimation()
			f38_arg0.ServerStateLabel:setText(Engine[@"hash_4F9F1239CFD921FE"]("menu/options_network_cod_not_connected"))
			...
			local f38_local2 = function(f41_arg0)
				f38_arg0.FocusBrackets:beginAnimation(60, Enum[@"luitween"][@"luitween_ease_in"])
	...
	NotConnectedToCodServer = {
		DefaultClip = function(f42_arg0, f42_arg1)
			...
			f42_arg0.ServerStateLabel:setText(Engine[@"hash_4F9F1239CFD921FE"]("menu/options_network_cod_not_connected"))
		...
		Focus = function(f43_arg0, f43_arg1)
			...
			f43_arg0.ServerStateLabel:setText(Engine[@"hash_4F9F1239CFD921FE"]("menu/options_network_cod_not_connected"))
		...
		GainFocus = function(f44_arg0, f44_arg1)
			...
			local f44_local0 = function(f45_arg0)
				f44_arg0.FocusGlow:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
			...
			f44_arg0.ServerStateLabel:setText(Engine[@"hash_4F9F1239CFD921FE"]("menu/options_network_cod_not_connected"))
			...
			local f44_local2 = function(f47_arg0)
				local f47_local0 = function(f48_arg0)
					f48_arg0:beginAnimation(50, Enum[@"luitween"][@"luitween_ease_out"])
		...
		LoseFocus = function(f49_arg0, f49_arg1)
			...
			f49_arg0.ServerStateLabel:setText(Engine[@"hash_4F9F1239CFD921FE"]("menu/options_network_cod_not_connected"))
			...
			local f49_local2 = function(f52_arg0)
				f49_arg0.FocusBrackets:beginAnimation(60, Enum[@"luitween"][@"luitween_ease_in"])
