	...
	DefaultState = {
		...
		GainFocus = function(f12_arg0, f12_arg1)
			...
			local f12_local0 = function(f13_arg0)
				f12_arg0.FocusGlow:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
		...
		GainFocus = function(f30_arg0, f30_arg1)
			...
			local f30_local0 = function(f31_arg0)
				local f31_local0 = function(f32_arg0)
					f32_arg0:beginAnimation(50, Enum[@"luitween"][@"luitween_ease_out"])
	...
	ZombiesState = {
		...
		GainFocus = function(f43_arg0, f43_arg1)
			...
			local f43_local0 = function(f44_arg0)
				f43_arg0.FocusGlow:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
