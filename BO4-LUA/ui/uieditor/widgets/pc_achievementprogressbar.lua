...
CoD.PC_AchievementProgressBar.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	CompletedText:setText(LocalizeToUpperString(0xC249C368451D708))
	CompletedText:setTTF("ttmussels_demibold")
	CompletedText:setLetterSpacing(4)
	CompletedText:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
	CompletedText:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
