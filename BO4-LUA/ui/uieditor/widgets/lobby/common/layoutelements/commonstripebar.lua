...
CoD.CommonStripeBar.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	TopStripe:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
...
CoD.CommonStripeBar.__resetProperties = function(f2_arg0)
	...
	f2_arg0.TopStripe:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
...
CoD.CommonStripeBar.__clipsPerState = {
	DefaultState = {
		DefaultClip = function(f3_arg0, f3_arg1)
			...
			f3_arg0.TopStripe:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
		...
		Intro = function(f5_arg0, f5_arg1)
			...
			local f5_local0 = function(f6_arg0)
				...
				f5_arg0.TopStripe:beginAnimation(1000, Enum[@"luitween"][@"luitween_ease_both"])
			...
			f5_arg0.TopStripe:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
