...
CoD.CommonBgLayoutElement01.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	DotGridPattern01:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	DotGridPattern02:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	DotGridPattern03:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
...
CoD.CommonBgLayoutElement01.__resetProperties = function(f2_arg0)
	...
	f2_arg0.DotGridPattern01:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	f2_arg0.DotGridPattern01:setShaderVector(0, 1, 0, 0, 0)
	f2_arg0.DotGridPattern02:setAlpha(0)
	f2_arg0.DotGridPattern02:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	f2_arg0.DotGridPattern02:setShaderVector(0, 1, 0, 0, 0)
	f2_arg0.DotGridPattern03:setAlpha(0)
	f2_arg0.DotGridPattern03:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
...
CoD.CommonBgLayoutElement01.__clipsPerState = {
	DefaultState = {
		DefaultClip = function(f3_arg0, f3_arg1)
			...
			local f3_local1 = function(f9_arg0)
				local f9_local0 = function(f10_arg0)
					local f10_local0 = function(f11_arg0)
						...
						f11_arg0:beginAnimation(250, Enum[@"luitween"][@"luitween_ease_both"])
						f11_arg0:setAlpha(0)
						f11_arg0:setShaderVector(0, 1, 0, 0, 0)
						f11_arg0:registerEventHandler("transition_complete_keyframe", f11_local0)
					end
					f10_arg0:beginAnimation(250, Enum[@"luitween"][@"luitween_ease_both"])
			...
			f3_arg0.DotGridPattern01:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
				...
				local f15_local0 = function(f16_arg0)
					local f16_local0 = function(f17_arg0)
						local f17_local0 = function(f18_arg0)
							...
							f18_arg0:beginAnimation(250, Enum[@"luitween"][@"luitween_ease_both"])
							f18_arg0:setAlpha(0)
							f18_arg0:setShaderVector(0, 1, 0, 0, 0)
							f18_arg0:registerEventHandler("transition_complete_keyframe", f18_local0)
						end
						f17_arg0:beginAnimation(250, Enum[@"luitween"][@"luitween_ease_both"])
			...
			f3_arg0.DotGridPattern02:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
					...
					local f24_local0 = function(f25_arg0)
						local f25_local0 = function(f26_arg0)
							local f26_local0 = function(f27_arg0)
								...
								f27_arg0:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
								f27_arg0:setAlpha(0)
								f27_arg0:setShaderVector(0, 1, 0, 0, 0)
								f27_arg0:registerEventHandler("transition_complete_keyframe", f27_local0)
							end
							f26_arg0:beginAnimation(199, Enum[@"luitween"][@"luitween_ease_both"])
			...
			f3_arg0.DotGridPattern03:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
		...
		Intro = function(f31_arg0, f31_arg1)
			...
			local f31_local0 = function(f32_arg0)
				local f32_local0 = function(f33_arg0)
					f33_arg0:beginAnimation(400, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
					f33_arg0:setAlpha(1)
