...
CoD.CommonAnalysingIndicator.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	AnalysingFrame:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	AnalysingText:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	ConnectedTextDepth:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
...
CoD.CommonAnalysingIndicator.__resetProperties = function(f2_arg0)
	...
	f2_arg0.Arrow:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	f2_arg0.AnalysingText:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	DefaultState = {
		DefaultClip = function(f3_arg0, f3_arg1)
			...
			local f3_local0 = function(f4_arg0)
				...
				f3_arg0.ConnectedText:beginAnimation(300, Enum[@"luitween"][@"luitween_bounce"])
			...
			f3_arg0.Arrow:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
		...
		Intro = function(f15_arg0, f15_arg1)
			...
			f15_arg0.AnalysingText:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
