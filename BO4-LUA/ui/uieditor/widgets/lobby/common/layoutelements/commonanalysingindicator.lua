...
CoD.CommonAnalysingIndicator.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	AnalysingFrameWipe:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
	...
	AnalysingBackingProgress:setMaterial(LUI.UIImage.GetCachedMaterial(0x2EEB1ECF1F211F5))
...
CoD.CommonAnalysingIndicator.__resetProperties = function(f2_arg0)
	...
	f2_arg0.AnalysingFrameWipe:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
	...
	f2_arg0.AnalysingBackingProgress:setMaterial(LUI.UIImage.GetCachedMaterial(0x2EEB1ECF1F211F5))
...
CoD.CommonAnalysingIndicator.__clipsPerState = {
	DefaultState = {
		...
		Intro = function(f15_arg0, f15_arg1)
			...
			f15_arg0.AnalysingFrameWipe:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
			...
			f15_arg0.AnalysingBackingProgress:setMaterial(LUI.UIImage.GetCachedMaterial(0x2EEB1ECF1F211F5))
