...
CoD.CommonBgLayoutLinkLine.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	LinkHline:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	LinkConnector02:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	LinkConnector01:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
...
CoD.CommonBgLayoutLinkLine.__resetProperties = function(f2_arg0)
	...
	f2_arg0.LinkConnector01:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	f2_arg0.LinkHline:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
...
CoD.CommonBgLayoutLinkLine.__clipsPerState = {
	DefaultState = {
		DefaultClip = function(f3_arg0, f3_arg1)
						...
						local f6_local0 = function(f7_arg0)
							local f7_local0 = function(f8_arg0)
								local f8_local0 = function(f9_arg0)
									f9_arg0:beginAnimation(2000, Enum[@"luitween"][@"luitween_ease_both"])
									f9_arg0:setAlpha(0.85)
									f9_arg0:registerEventHandler("transition_complete_keyframe", f3_arg0.clipFinished)
								end
								f8_arg0:beginAnimation(2000, Enum[@"luitween"][@"luitween_ease_both"])
								f8_arg0:setAlpha(0.75)
								f8_arg0:registerEventHandler("transition_complete_keyframe", f8_local0)
							end
							f7_arg0:beginAnimation(2000, Enum[@"luitween"][@"luitween_ease_both"])
							f7_arg0:setAlpha(0.95)
							f7_arg0:registerEventHandler("transition_complete_keyframe", f7_local0)
						end
						f6_arg0:beginAnimation(2000, Enum[@"luitween"][@"luitween_ease_both"])
						f6_arg0:setAlpha(0.7)
						f6_arg0:registerEventHandler("transition_complete_keyframe", f6_local0)
					end
					f5_arg0:beginAnimation(2000, Enum[@"luitween"][@"luitween_ease_both"])
					f5_arg0:setAlpha(0.9)
					f5_arg0:registerEventHandler("transition_complete_keyframe", f5_local0)
				end
				f3_arg0.LinkHline:beginAnimation(2000, Enum[@"luitween"][@"luitween_ease_both"])
				...
				local f10_local0 = function(f11_arg0)
					local f11_local0 = function(f12_arg0)
						local f12_local0 = function(f13_arg0)
							f13_arg0:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_both"])
							f13_arg0:setAlpha(0)
							f13_arg0:setShaderVector(0, 1, 1, 0, 0)
							f13_arg0:registerEventHandler("transition_complete_keyframe", f3_arg0.clipFinished)
						end
						f12_arg0:beginAnimation(1500, Enum[@"luitween"][@"luitween_ease_both"])
							...
							local f22_local0 = function(f23_arg0)
								local f23_local0 = function(f24_arg0)
									local f24_local0 = function(f25_arg0)
											...
											local f26_local0 = function(f27_arg0)
												local f27_local0 = function(f28_arg0)
													local f28_local0 = function(f29_arg0)
														...
														f29_arg0:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
										...
										f25_arg0:beginAnimation(599, Enum[@"luitween"][@"luitween_ease_in"])
										f25_arg0:setAlpha(0)
			...
			f3_arg0.LinkConnector01:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
		...
		Intro = function(f30_arg0, f30_arg1)
			...
			f30_arg0.LinkHline:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
