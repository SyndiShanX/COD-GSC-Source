...
require("x64:46840c675b6e9ca")
require("x64:828993443a76418")
require("x64:7f9b72b8dc0d9f0")
...
CoD.InspectionSelectedPlayerInfo.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	IdentityTiledBg:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16CBE95C250C6D15"))
	...
	EmblemCornerBlurBL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	EmblemCornerBL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	EmblemCornerBlurTL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	EmblemCornerTL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	EmblemCornerBlurBR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	EmblemCornerBR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	EmblemCornerBlurTR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	EmblemCornerTR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	DefaultState = {
		...
		Intro = function(f18_arg0, f18_arg1)
			...
			local f18_local0 = function(f19_arg0)
				f18_arg0.InspectionEmblemWidget:beginAnimation(300, Enum[@"luitween"][@"luitween_bounce"])
			...
			local f18_local1 = function(f20_arg0)
				local f20_local0 = function(f21_arg0)
					f21_arg0:beginAnimation(310, Enum[@"luitween"][@"luitween_bounce"])
					f21_arg0:setAlpha(1)
		...
		Outro = function(f22_arg0, f22_arg1)
			...
			local f22_local0 = function(f23_arg0)
				f22_arg0.InspectionEmblemWidget:beginAnimation(300, Enum[@"luitween"][@"luitween_bounce"])
			...
			local f22_local1 = function(f24_arg0)
				local f24_local0 = function(f25_arg0)
					f25_arg0:beginAnimation(309, Enum[@"luitween"][@"luitween_bounce"])
					f25_arg0:setAlpha(0)
