...
CoD.LocalServerRow.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	GameType:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	ClientCount:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	ClientCount:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	HostName:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	HostName:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	self:addElement(HostName)
	self.HostName = HostName
	self.Status:linkToElementModel(self, "status", true, function(model)
		local f2_local0 = model:get()
		if f2_local0 ~= nil then
			Status:setText(Engine[0xF9F1239CFD921FE](LocalServerStatusToString(f2_local0)))
		end
	end)
