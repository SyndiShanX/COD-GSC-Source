...
CoD.TabbedScoreboardLayoutSideElements.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	MapLayoutSideBoxPattern:setImage(RegisterImage(@"hash_180F9AB2A72B6B3A"))
	...
	MapLayoutSideBoxPatternAdd:setImage(RegisterImage(@"hash_180F9AB2A72B6B3A"))
	...
	MapLayoutSideBoxEmpty:setImage(RegisterImage(@"hash_180F99B2A72B6987"))
	...
	MapLayoutSideBoxEmptyAdd:setImage(RegisterImage(@"hash_180F99B2A72B6987"))
	MapLayoutSideBoxEmptyAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	DefaultState = {
		DefaultClip = function(f3_arg0, f3_arg1)
			...
			local f3_local2 = function(f6_arg0)
				f6_arg0:beginAnimation(400, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f3_local3 = function(f7_arg0)
				f7_arg0:beginAnimation(400, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f3_local4 = function(f8_arg0)
				local f8_local0 = function(f9_arg0)
					f9_arg0:beginAnimation(500, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f3_local5 = function(f10_arg0)
				local f10_local0 = function(f11_arg0)
					f11_arg0:beginAnimation(500, Enum[@"luitween"][@"luitween_ease_in"])
