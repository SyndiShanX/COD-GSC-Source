...
CoD.ScoreboardGameStatusMapWZ.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	MinimapFogOfWar:setupCompassFog(Enum[@"compasstype"][@"compass_type_full"])
	...
	MinimapFogOfWarEnemyTearing:setupCompassEnemyTearingFog(Enum[@"compasstype"][@"compass_type_full"])
	...
	MinimapMap:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_1DC408FAFC6D5CD"))
	...
	MinimapDeathZoneMask:setupCompassDeathZoneMask(Enum[@"compasstype"][@"compass_type_full"])
	...
	MinimapMapLabels:setupCompassLabels(Enum[@"compasstype"][@"compass_type_full"])
	...
	CompassItems0.CompassMinimapItems:setupCompassItems(Enum[@"compasstype"][@"compass_type_full"])
	...
	CompassItems.CompassMinimapItems:setupCompassItems(Enum[@"compasstype"][@"compass_type_full"])
	...
	CompassOverlay.CompassMinimapOverlay:setupCompassOverlay(Enum[@"compasstype"][@"compass_type_full"])
