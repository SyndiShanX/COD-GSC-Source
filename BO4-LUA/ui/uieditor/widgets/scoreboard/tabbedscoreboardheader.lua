...
CoD.TabbedScoreboardHeader.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	GameTimer00:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_171E049B161CD00A"))
	...
	VS:setAlpha(0.8)
	VS:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_34F347C78B3F5793"))
	VS:setTTF("0arame_mono_stencil")
	VS:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	VS:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	self:addElement(VS)
	self.VS = VS
	local GameTypeText = LUI.UIText.new(0, 0, 17, 341, 0, 0, 33.5, 45.5)
	GameTypeText:setRGB(0.7, 0.7, 0.7)
	GameTypeText:setAlpha(0.3)
	GameTypeText:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_27F09D9C7D9A3FEE"))
	GameTypeText:setTTF("dinnext_regular")
	GameTypeText:setLetterSpacing(2)
	GameTypeText:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	GameTypeText:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	TimeText:setText(Engine[@"hash_4F9F1239CFD921FE"](@"mpui/objtime"))
	TimeText:setTTF("dinnext_regular")
	TimeText:setLetterSpacing(2)
	TimeText:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	TimeText:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	CodCasterTeam1Name:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	CodCasterTeam1Name:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	CodCasterTeam2Name:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	CodCasterTeam2Name:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
...
CoD.TabbedScoreboardHeader.__resetProperties = function(f14_arg0)
	...
	f14_arg0.CodCasterTeam2Name:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	f14_arg0.CodCasterTeam1Name:setLeftRight(0, 0, 129, 329)
	f14_arg0.CodCasterTeam1Name:setAlpha(0)
	f14_arg0.CodCasterTeam1Name:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
...
CoD.TabbedScoreboardHeader.__clipsPerState = {
	...
	Codcaster = {
		DefaultClip = function(f17_arg0, f17_arg1)
			...
			f17_arg0.CodCasterTeam1Name:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
			...
			f17_arg0.CodCasterTeam2Name:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
