	...
	DefaultState = {
		DefaultClip = function(f3_arg0, f3_arg1)
			...
			local f3_local1 = function(f8_arg0)
				...
				f3_arg0.Cursor:beginAnimation(300, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f3_local2 = function(f12_arg0)
				...
				f3_arg0.CursorGlow:beginAnimation(300, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
