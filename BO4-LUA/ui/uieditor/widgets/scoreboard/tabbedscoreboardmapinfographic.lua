...
require("x64:19f1805db291fd2")
require("x64:9f0c909fb4316e9")
require("x64:d63ba66c95f0762")
require("x64:b8558b5956d158")
require("x64:ebb213505127f40")
...
CoD.TabbedScoreboardMapInfographic.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	satelliteMap:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	satelliteMap:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	textInfoBot01:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	textInfoBot01:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	textInfoTop01:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	textInfoTop01:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	textInfoTop03:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	textInfoTop03:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	textInfoTop02:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	textInfoTop02:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	geoData:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	geoData:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	textInfoR01:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	textInfoR01:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	LeftFuiElementBlur:setImage(RegisterImage(@"hash_53570AE130F7102B"))
	...
	LeftFuiElement:setImage(RegisterImage(@"hash_53570AE130F7102B"))
	...
	LeftFuiElement2:setImage(RegisterImage(@"hash_53570AE130F7102B"))
	...
	SatelliteTextGlow:setImage(RegisterImage(@"hash_420A8A24C5B343CF"))
