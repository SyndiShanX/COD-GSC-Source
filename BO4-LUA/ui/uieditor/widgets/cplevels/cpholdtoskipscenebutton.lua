local PostLoadFunc = function(self, controller, menu)
	self:registerEventHandler("update_scene_skip_progress", function(element)
		self.progressMeter:setShaderVector(0, (Engine[0xB07E933C9E5CEB1]() - self._progressStartTime) / (self._progressEndTime - self._progressStartTime), 0, 0, 0)
	end)
	self:linkToElementModel(menu, "sceneSkipEndTime", true, function(model)
		...
		if f3_local0 == 0 then
			...
			self._progressStartTime = Engine[0xB07E933C9E5CEB1]()
...
CoD.CPHoldToSkipSceneButton.new = function(f4_arg0, f4_arg1, f4_arg2, f4_arg3, f4_arg4, f4_arg5, f4_arg6, f4_arg7, f4_arg8, f4_arg9)
	...
	local f4_local6 = Engine[0x4DF5CFBC1771947](f4_arg1)
