...
CoD.CodCaster_Keyboard.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	ArrowsFPS:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_6CC03F6E4651CC85"))
	ArrowsFPS:setTTF("default")
	ArrowsFPS:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	self:addElement(ArrowsFPS)
	self.ArrowsFPS = ArrowsFPS
	local Numbers = LUI.UIText.new(0, 0, 569.5, 1069.5, 0, 0, 253.5, 268.5)
	Numbers:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_4B9AD6ACC2FEA3DD"))
	...
	R:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_5082ECE165D3E0C"))
	R:setTTF("default")
	R:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	self:addElement(R)
	self.R = R
	local T = LUI.UIText.new(0, 0, 738, 1238, 0, 0, 300.5, 315.5)
	T:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_1EF1D244CD091910"))
	T:setTTF("default")
	T:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	self:addElement(T)
	self.T = T
	local Y = LUI.UIText.new(0, 0, 776, 1276, 0, 0, 314.5, 329.5)
	Y:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_1E9D5F20B19EC763"))
	Y:setTTF("default")
	Y:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	self:addElement(Y)
	self.Y = Y
	local ZoomOut = LUI.UIText.new(0, 0, 962.5, 1462.5, 0, 0, 370.5, 385.5)
	ZoomOut:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_582758552FB3DD94"))
	ZoomOut:setTTF("default")
	ZoomOut:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	self:addElement(ZoomOut)
	self.ZoomOut = ZoomOut
	local Shift = LUI.UIText.new(0, 0, 440.5, 698.5, 0, 0, 670, 686)
	Shift:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_32D4D1AF93A1C593"))
	Shift:setTTF("default")
	Shift:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	self:addElement(Shift)
	self.Shift = Shift
	local Enter = LUI.UIText.new(0, 0, 1084, 1584, 0, 0, 385.5, 400.5)
	Enter:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_E528282EC1246D5"))
	Enter:setTTF("default")
	Enter:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	self:addElement(Enter)
	self.Enter = Enter
	local C = LUI.UIText.new(0, 0, 413, 671, 0, 0, 778.5, 794.5)
	C:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_4F4695A8C0A844EF"))
	C:setTTF("default")
	C:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	self:addElement(C)
	self.C = C
	local F = LUI.UIText.new(0, 0, 431, 689, 0, 0, 796.5, 811.5)
	F:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_74780A983DA51A66"))
	F:setTTF("default")
	F:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	self:addElement(F)
	self.F = F
	local G = LUI.UIText.new(0, 0, 751.5, 1251.5, 0, 0, 796.5, 811.5)
	G:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_51FDC6938F3218D0"))
	G:setTTF("default")
	G:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	self:addElement(G)
	self.G = G
	local H = LUI.UIText.new(0, 0, 788.5, 1288.5, 0, 0, 778.5, 793.5)
	H:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_629C3F7E140F260A"))
	H:setTTF("default")
	H:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	self:addElement(H)
	self.H = H
	local J = LUI.UIText.new(0, 0, 826.5, 1326.5, 0, 0, 328.5, 343.5)
	J:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_6239BFD1BBD74729"))
	J:setTTF("default")
	J:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	self:addElement(J)
	self.J = J
	local M = LUI.UIText.new(0, 0, 844.5, 1344.5, 0, 0, 746.5, 761.5)
	M:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_6D9622B4FC02DFBA"))
	M:setTTF("default")
	M:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	self:addElement(M)
	self.M = M
	local K = LUI.UIText.new(0, 0, 862.5, 1362.5, 0, 0, 342.5, 357.5)
	K:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_2295108BDCD43FFC"))
	K:setTTF("default")
	K:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	self:addElement(K)
	self.K = K
	local Prev = LUI.UIText.new(0, 0, 883.5, 1383.5, 0, 0, 715.5, 730.5)
	Prev:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_644D944499B494E8"))
	Prev:setTTF("default")
	Prev:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	self:addElement(Prev)
	self.Prev = Prev
	local L = LUI.UIText.new(0, 0, 901.5, 1401.5, 0, 0, 356.5, 371.5)
	L:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_6DBD347CE6E79536"))
	L:setTTF("default")
	L:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	self:addElement(L)
	self.L = L
	local Next = LUI.UIText.new(0, 0, 918.5, 1418.5, 0, 0, 696.5, 711.5)
	Next:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_2A2F2B5E2765E548"))
	Next:setTTF("default")
	Next:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	self:addElement(Next)
	self.Next = Next
	local Semicolon = LUI.UIText.new(0, 0, 938.5, 1438.5, 0, 0, 680.5, 695.5)
	Semicolon:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_524B92E40440B5ED"))
	Semicolon:setTTF("default")
	Semicolon:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	self:addElement(Semicolon)
	self.Semicolon = Semicolon
	local Comma = LUI.UIText.new(0, 0, 975.5, 1475.5, 0, 0, 660.5, 675.5)
	Comma:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_72EB128302A523CF"))
	Comma:setTTF("default")
	Comma:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	self:addElement(Comma)
	self.Comma = Comma
	local UpDownArrows = LUI.UIText.new(0, 0, 1149.5, 1649.5, 0, 0, 711, 726)
	UpDownArrows:setText(Engine[@"hash_4F9F1239CFD921FE"](0x1C66D706E4682A))
	UpDownArrows:setTTF("default")
	UpDownArrows:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	...
	LeftRightArrows:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_311D93615BDAC5C3"))
	LeftRightArrows:setTTF("default")
	LeftRightArrows:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
