...
CoD.CodCasterTeamIdentityInformationPanel.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	CodCasterTeam1Information.TeamLogoTitle:setText(LocalizeToUpperString(@"hash_753D63E3F4E6CDC0"))
	CodCasterTeam1Information.TeamNameTitle:setText(LocalizeToUpperString(@"hash_1D1CDFD2190AC31C"))
	CodCasterTeam1Information.TeamColorTitle:setText(LocalizeToUpperString(@"hash_21BE11FFFC43DC2E"))
	...
	CodCasterTeam2Information.TeamLogoTitle:setText(LocalizeToUpperString(@"hash_47594C4235BAF38F"))
	CodCasterTeam2Information.TeamNameTitle:setText(LocalizeToUpperString(@"hash_750B8544C6063AB"))
	CodCasterTeam2Information.TeamColorTitle:setText(LocalizeToUpperString(@"hash_175FBF79F95C5DBF"))
