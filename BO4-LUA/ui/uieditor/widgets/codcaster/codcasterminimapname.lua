...
CoD.CodCasterMiniMapName.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	bg:setRGB(0, 0, 0)
	bg:setAlpha(0.85)
	bg:setImage(RegisterImage(0x650EEDEA9341CB9))
	bg:setMaterial(LUI.UIImage.GetCachedMaterial(0x5EBE8D6E802F0F5))
	...
	mapTitle:setMaterial(LUI.UIImage.GetCachedMaterial(0x90D57B1E92D39D7))
	mapTitle:setShaderVector(0, 0.3, 0, 0, 0)
	mapTitle:setShaderVector(1, 0.3, 0, 0, 0)
	mapTitle:setShaderVector(2, 0, 0, 0, 0.75)
	mapTitle:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	mapTitle:setAlignment(Enum[0x7A5123B654282D2][0x6ED4298C93DC5ED])
	mapTitle:subscribeToGlobalModel(f1_arg1, "MapInfo", "mapName", function(model)
		local f2_local0 = model:get()
		if f2_local0 ~= nil then
			mapTitle:setText(Engine[0xF9F1239CFD921FE](f2_local0))
		end
	end)
