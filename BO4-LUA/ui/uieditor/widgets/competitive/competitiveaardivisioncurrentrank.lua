...
CoD.CompetitiveAARDivisionCurrentRank.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	PlacementMessage2.PlacementMessage:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_4B173E5D02BB9455"))
	...
	LadderRank:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	LadderRank:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	LadderRank:subscribeToGlobalModel(f1_arg1, "LeaguePlay", "leaguePlayRank", function(model)
		local f3_local0 = model:get()
		if f3_local0 ~= nil then
			LadderRank:setText(ToUpper(LocalizeStringWithParameter(@"hash_447AC0462E4B2132", f3_local0)))
		end
	end)
