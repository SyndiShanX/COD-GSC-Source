	...
	DefaultState = {
		...
		GainChildFocus = function(f6_arg0, f6_arg1)
			...
			local f6_local0 = function(f7_arg0)
				f6_arg0.SpecialistCharacter:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_in"])
		...
		LoseChildFocus = function(f8_arg0, f8_arg1)
			...
			local f8_local0 = function(f9_arg0)
				f8_arg0.SpecialistCharacter:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_out"])
