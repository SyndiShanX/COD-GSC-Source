...
CoD.HubStatsButtonInternal.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	weaponHeader:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	weaponValue:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	weaponValue:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	...
	specialIssueHeader:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	specialIssueValue:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	...
	statsHeader:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
