...
CoD.HubGestureButtonBacking.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Bg04:setImage(RegisterImage(0x34839E8065B1E53))
	...
	Bg05:setImage(RegisterImage(0x34839E8065B1E53))
	...
	Bg02:setImage(RegisterImage(0x34839E8065B1E53))
	...
	Bg03:setImage(RegisterImage(0x34839E8065B1E53))
	...
	Bg01:setImage(RegisterImage(0x34839E8065B1E53))
	...
	border05:setImage(RegisterImage(0x185E11D74ECA3D7))
	border05:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	border04:setImage(RegisterImage(0x185E11D74ECA3D7))
	border04:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	border03:setImage(RegisterImage(0x185E11D74ECA3D7))
	border03:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	border02:setImage(RegisterImage(0x185E11D74ECA3D7))
	border02:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	border01:setImage(RegisterImage(0x185E11D74ECA3D7))
	border01:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
