...
CoD.HubWeaponVideoButton.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	BotBar:setAlpha(0.8)
	BotBar:setImage(RegisterImage(@"hash_4C325BED3F226657"))
	...
	DotLeft:setImage(RegisterImage(@"hash_73854665C02218EF"))
	...
	DotRight:setImage(RegisterImage(@"hash_73854665C02218EF"))
	...
	schema:setAlignment(Engine[@"hash_67F8853DC3581AA4"](Enum[@"luialignment"][@"lui_alignment_left"]))
	schema:setAlignment(Engine[@"hash_67F8853DC3581AA4"](Enum[@"luialignment"][@"lui_alignment_top"]))
	...
	schemaHeader:setText(LocalizeToUpperString(@"hash_6C0091D9DC3CC019"))
	schemaHeader:setTTF("ttmussels_regular")
	schemaHeader:setLetterSpacing(4)
	schemaHeader:setAlignment(Engine[@"hash_67F8853DC3581AA4"](Enum[@"luialignment"][@"lui_alignment_left"]))
	schemaHeader:setAlignment(Engine[@"hash_67F8853DC3581AA4"](Enum[@"luialignment"][@"lui_alignment_top"]))
	...
	itemName:setAlignment(Engine[@"hash_67F8853DC3581AA4"](Enum[@"luialignment"][@"lui_alignment_left"]))
	...
	mainHeader:setAlignment(Engine[@"hash_67F8853DC3581AA4"](Enum[@"luialignment"][@"lui_alignment_left"]))
	...
	VideoBotRuler:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	Connected:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	ConnectedAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	VoDPreviewCornerBR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	VoDPreviewCornerTR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	VoDPreviewCornerBL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	VoDPreviewCornerTL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	CommonTiledDotline:setImage(RegisterImage(@"hash_6F5E8F1B8586D9C5"))
	CommonTiledDotline:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
...
CoD.HubWeaponVideoButton.__resetProperties = function(f4_arg0)
	...
	f4_arg0.ConnectedAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	f4_arg0.TiledBackingAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
...
CoD.HubWeaponVideoButton.__clipsPerState = {
	DefaultState = {
		...
		ChildFocus = function(f6_arg0, f6_arg1)
			...
			f6_arg0.TiledBackingAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
			...
			local f6_local8 = function(f16_arg0)
				local f16_local0 = function(f17_arg0)
					f17_arg0:beginAnimation(100, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
					f17_arg0:setAlpha(1)
					f17_arg0:setZoom(0)
					f17_arg0:setShaderVector(0, 1.5, 0, 0, 0)
					f17_arg0:registerEventHandler("transition_complete_keyframe", f6_arg0.clipFinished)
				end
				f6_arg0.ConnectedAdd:beginAnimation(100, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
			...
			f6_arg0.ConnectedAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
			f6_arg0.ConnectedAdd:setShaderVector(0, 1, 0, 0, 0)
			f6_local8(f6_arg0.ConnectedAdd)
			local f6_local9 = function(f18_arg0)
				f6_arg0.VoDPreviewCornerBR:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f6_local10 = function(f19_arg0)
				f6_arg0.VoDPreviewCornerTR:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f6_local11 = function(f20_arg0)
				f6_arg0.VoDPreviewCornerBL:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f6_local12 = function(f21_arg0)
				f6_arg0.VoDPreviewCornerTL:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f6_local13 = function(f22_arg0)
				local f22_local0 = function(f23_arg0)
					f23_arg0:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_in"])
					f23_arg0:setAlpha(0)
					f23_arg0:registerEventHandler("transition_complete_keyframe", f6_arg0.clipFinished)
				end
				f6_arg0.GridVideoWindow:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_out"])
