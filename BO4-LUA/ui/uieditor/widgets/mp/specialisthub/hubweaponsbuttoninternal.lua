...
CoD.HubWeaponsButtonInternal.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	weaponHeader:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	...
	specialIssueHeader:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	...
	specialIssueName:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	specialIssueName:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	mainHeader:setText(LocalizeToUpperString(@"hash_729E45AE7FF6633E"))
	mainHeader:setTTF("ttmussels_demibold")
	mainHeader:setLetterSpacing(2)
	mainHeader:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
