...
CoD.HubSpecialist_characterNewItem.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	NewItemIndicatorGlowR:setMaterial(LUI.UIImage.GetCachedMaterial(0x2EEB1ECF1F211F5))
	...
	NewItemIndicatorGlowL:setMaterial(LUI.UIImage.GetCachedMaterial(0x2EEB1ECF1F211F5))
...
CoD.HubSpecialist_characterNewItem.__resetProperties = function(f2_arg0)
	...
	f2_arg0.NewItemIndicatorGlowR:setMaterial(LUI.UIImage.GetCachedMaterial(0x2EEB1ECF1F211F5))
	...
	f2_arg0.NewItemIndicatorGlowL:setMaterial(LUI.UIImage.GetCachedMaterial(0x2EEB1ECF1F211F5))
...
CoD.HubSpecialist_characterNewItem.__clipsPerState = {
	DefaultState = {
		...
		FocusPulse = function(f8_arg0, f8_arg1)
			...
			f8_arg0.NewItemIndicatorGlowR:setMaterial(LUI.UIImage.GetCachedMaterial(0x2EEB1ECF1F211F5))
			...
			f8_arg0.NewItemIndicatorGlowL:setMaterial(LUI.UIImage.GetCachedMaterial(0x2EEB1ECF1F211F5))
		...
		Intro = function(f21_arg0, f21_arg1)
			...
			f21_arg0.NewItemIndicatorGlowR:setMaterial(LUI.UIImage.GetCachedMaterial(0x2EEB1ECF1F211F5))
			...
			f21_arg0.NewItemIndicatorGlowL:setMaterial(LUI.UIImage.GetCachedMaterial(0x2EEB1ECF1F211F5))
