...
CoD.HubWeaponVideoButtonGrid.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	GridOutlineBot:setImage(RegisterImage(@"hash_484B43D5B04D263A"))
	GridOutlineBot:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	GridOutlineTop:setImage(RegisterImage(@"hash_484B43D5B04D263A"))
	GridOutlineTop:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	GridOutlineLeft:setImage(RegisterImage(@"hash_484B43D5B04D263A"))
	GridOutlineLeft:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	GridOutlineRight:setImage(RegisterImage(@"hash_484B43D5B04D263A"))
	GridOutlineRight:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	GridTiled:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
