...
CoD.CustomGames_MapModeInfo.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	GameTypeName:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	...
	PreviewInfoName:setText(Engine[@"hash_4F9F1239CFD921FE"](@"menu/new"))
	PreviewInfoName:setTTF("ttmussels_regular")
	PreviewInfoName:setLetterSpacing(6)
	PreviewInfoName:setAlignment(Engine[@"hash_67F8853DC3581AA4"](Enum[@"luialignment"][@"lui_alignment_left"]))
	PreviewInfoName:setAlignment(Engine[@"hash_67F8853DC3581AA4"](Enum[@"luialignment"][@"lui_alignment_top"]))
	...
	PreviewInfoDesc:setText(Engine[@"hash_4F9F1239CFD921FE"](@"menu/new"))
	PreviewInfoDesc:setTTF("ttmussels_regular")
	PreviewInfoDesc:setLetterSpacing(6)
	PreviewInfoDesc:setAlignment(Engine[@"hash_67F8853DC3581AA4"](Enum[@"luialignment"][@"lui_alignment_left"]))
	PreviewInfoDesc:setAlignment(Engine[@"hash_67F8853DC3581AA4"](Enum[@"luialignment"][@"lui_alignment_top"]))
