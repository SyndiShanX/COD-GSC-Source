...
CoD.vhud_HellstormCenterFrame.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	FrameBR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	FrameTL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	FrameTR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	FrameBL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	FrameTop:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	CenterCircleL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	CenterCircleR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	LockTR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	LockBL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	LockBR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	LockTL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	FuiArrowTop:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	FuiArrowRight:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	FuiArrowLeft:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	MediumAltitude = {
		...
		LowAltitude = function(f83_arg0, f83_arg1)
			...
			local f83_local5 = function(f89_arg0)
				f83_arg0.LockTR:beginAnimation(250, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f83_local6 = function(f90_arg0)
				f83_arg0.LockBL:beginAnimation(250, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f83_local7 = function(f91_arg0)
				f83_arg0.LockBR:beginAnimation(250, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f83_local8 = function(f92_arg0)
				f83_arg0.LockTL:beginAnimation(250, Enum[@"luitween"][@"luitween_ease_both"])
		...
		DefaultState = function(f96_arg0, f96_arg1)
			...
			local f96_local7 = function(f104_arg0)
				f96_arg0.LockTR:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f96_local8 = function(f105_arg0)
				f96_arg0.LockBL:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f96_local9 = function(f106_arg0)
				f96_arg0.LockBR:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f96_local10 = function(f107_arg0)
				f96_arg0.LockTL:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
	...
	HighAltitude = {
		...
		MediumAltitude = function(f124_arg0, f124_arg1)
			...
			local f124_local7 = function(f132_arg0)
				f124_arg0.LockTR:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f124_local8 = function(f133_arg0)
				f124_arg0.LockBL:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f124_local9 = function(f134_arg0)
				f124_arg0.LockBR:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f124_local10 = function(f135_arg0)
				f124_arg0.LockTL:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f124_local11 = function(f136_arg0)
				f124_arg0.FuiArrowTop:beginAnimation(70, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f124_local12 = function(f137_arg0)
				f124_arg0.FuiArrowRight:beginAnimation(70, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f124_local13 = function(f138_arg0)
				f124_arg0.FuiArrowLeft:beginAnimation(70, Enum[@"luitween"][@"luitween_ease_both"])
