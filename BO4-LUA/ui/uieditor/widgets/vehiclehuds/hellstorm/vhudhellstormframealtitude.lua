...
CoD.vhudHellstormFrameAltitude.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Top:setImage(RegisterImage(@"hash_3DD7AABB9320F4BD"))
	Top:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	Top:setShaderVector(0, 1, 0, 0, 0)
	self:addElement(Top)
	self.Top = Top
	local Mid = LUI.UIImage.new(0, 0, 0, 20, 0, 0.92, 20, 20)
	Mid:setImage(RegisterImage(@"hash_19A28B0832D46AA"))
	Mid:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	Mid:setShaderVector(0, 1.5, 0, 0, 0)
	self:addElement(Mid)
	self.Mid = Mid
	local Bot = LUI.UIImage.new(0, 0, 0, 20, 1, 0.96, 4, 4)
	Bot:setImage(RegisterImage(@"hash_3DD7AABB9320F4BD"))
	Bot:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
