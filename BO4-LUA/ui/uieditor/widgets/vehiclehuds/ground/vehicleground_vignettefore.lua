...
CoD.VehicleGround_VignetteFore.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Image0:setImage(RegisterImage(0x6CA21BC45DC5D28))
	self:addElement(Image0)
	self.Image0 = Image0
	local Image1 = LUI.UIImage.new(1, 1, -600, 0, 1, 1, -516, 0)
	Image1:setYRot(-180)
	Image1:setImage(RegisterImage(0x6CA21BC45DC5D28))
	self:addElement(Image1)
	self.Image1 = Image1
	local Image2 = LUI.UIImage.new(0, 0, 0, 600, 0, 0, 0, 516)
	Image2:setXRot(-180)
	Image2:setImage(RegisterImage(0x6CA21BC45DC5D28))
	self:addElement(Image2)
	self.Image2 = Image2
	local Image3 = LUI.UIImage.new(1, 1, -600, 0, 0, 0, 0, 516)
	Image3:setXRot(-180)
	Image3:setYRot(-180)
	Image3:setImage(RegisterImage(0x6CA21BC45DC5D28))
