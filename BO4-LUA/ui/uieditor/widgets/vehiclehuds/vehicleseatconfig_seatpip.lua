...
CoD.VehicleSeatConfig_SeatPip.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	OccupiedPip:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	OccupiedPipPulse:setImage(RegisterImage(@"hash_5B5C93CB5E222BAD"))
	OccupiedPipPulse:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	LedPattern:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	LedPatternAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	DefaultState = {
		...
		Empty = function(f18_arg0, f18_arg1)
			...
			local f18_local0 = function(f19_arg0)
				f18_arg0.OccupiedPip:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f18_local1 = function(f20_arg0)
				f18_arg0.FrontendFrame:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
	...
	Empty = {
		...
		DefaultState = function(f22_arg0, f22_arg1)
			...
			local f22_local0 = function(f23_arg0)
				f22_arg0.OccupiedPip:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f22_local1 = function(f24_arg0)
				f22_arg0.FrontendFrame:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
