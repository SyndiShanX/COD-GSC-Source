require("x64:bd1730eced61cd9")
require("x64:4578a00a56ef81b")
require("x64:5a9b8ffe81f1afd")
require("x64:8a35864b418ab6")
require("x64:bfec370b56e5be9")
...
CoD.vhud_dart_reticle.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	BlkCircleBot:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	BlkCircleTop:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	CircleFrameBot:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	CircleFrameTop:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	FuiLinkBR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	FuiLinkBL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	FuiLinkTL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	FuiLinkTR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	DefaultState = {
		DefaultClip = function(f9_arg0, f9_arg1)
			...
			local f9_local7 = function(f26_arg0)
				f26_arg0:beginAnimation(49, Enum[@"luitween"][@"luitween_bounce"])
				f26_arg0:setAlpha(1)
