	...
	DefaultState = {
		DefaultClip = function(f5_arg0, f5_arg1)
			...
			local f5_local0 = function(f6_arg0)
				...
				f5_arg0.ModDNI:beginAnimation(1210, Enum[@"luitween"][@"luitween_ease_both"])
					...
					local f9_local0 = function(f10_arg0)
						local f10_local0 = function(f11_arg0)
							local f11_local0 = function(f12_arg0)
								f12_arg0:beginAnimation(320, Enum[@"luitween"][@"luitween_back"] | Enum[@"luitween"][@"luitween_ease_in"])
						...
						f10_arg0:beginAnimation(360, Enum[@"luitween"][@"luitween_back"] | Enum[@"luitween"][@"luitween_ease_out"])
				...
				local f13_local0 = function(f14_arg0)
					local f14_local0 = function(f15_arg0)
						local f15_local0 = function(f16_arg0)
							f16_arg0:beginAnimation(320, Enum[@"luitween"][@"luitween_back"] | Enum[@"luitween"][@"luitween_ease_in"])
					...
					f14_arg0:beginAnimation(440, Enum[@"luitween"][@"luitween_back"] | Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f5_local3 = function(f17_arg0)
				local f17_local0 = function(f18_arg0)
					f18_arg0:beginAnimation(610, Enum[@"luitween"][@"luitween_ease_both"])
					f18_arg0:setAlpha(0)
