...
CoD.missileProximityAlert.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	GlowRed2:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	IncomingText:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_7C8D5872C7601994"))
	IncomingText:setTTF("0arame_mono_stencil")
	IncomingText:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_171E049B161CD00A"))
	...
	TiledLed2:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	TiledLed3:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	TiledLedAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	GlowStatic:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	TiledLed:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	FooterStripeScroll:setImage(RegisterImage(@"hash_2C7A051F5EFC70E5"))
	...
	HeaderStripeScroll:setImage(RegisterImage(@"hash_2C7A051F5EFC70E5"))
	...
	DefaultState = {
		...
		On = function(f7_arg0, f7_arg1)
			...
			local f7_local5 = function(f19_arg0)
				f7_arg0.AccentBotAdd:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f7_local7 = function(f21_arg0)
				f7_arg0.AccentTopAdd:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f7_local13 = function(f32_arg0)
				local f32_local0 = function(f33_arg0)
					f33_arg0:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_in"])
					f33_arg0:setAlpha(1)
	...
	On = {
		DefaultClip = function(f37_arg0, f37_arg1)
			...
			local f37_local4 = function(f46_arg0)
				local f46_local0 = function(f47_arg0)
					local f47_local0 = function(f48_arg0)
						f48_arg0:beginAnimation(500, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f37_local5 = function(f49_arg0)
				...
				f37_arg0.Glow:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_out"])
