require("x64:beeadce472fc348")
require("x64:4d0a8b93f3a16ee")
...
CoD.AARXpMeter.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	LevelMeterTickGlow:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	LevelMeterTick:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	ExpPointer:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	xpEarnedText:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	xpEarnedText:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	xpNeededText:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	xpNeededText:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	maxRankText:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	maxRankText:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
			...
			local f9_local0 = function(f10_arg0)
				local f10_local0 = function(f11_arg0)
					local f11_local0 = function(f12_arg0)
						...
						f12_arg0:beginAnimation(2500, Enum[@"luitween"][@"luitween_ease_both"])
				...
				f9_arg0.LevelMeterBar:beginAnimation(2500, Enum[@"luitween"][@"luitween_ease_both"])
