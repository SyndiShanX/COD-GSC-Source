...
CoD.AARLevelUpOverlay_LevelUpTextInternal.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Flash:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	ZMLeveledUpTextAdd:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_3C0BFBD2AC9E2C45"))
	ZMLeveledUpTextAdd:setTTF("skorzhen")
	ZMLeveledUpTextAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_3336C1AE82B1520A"))
	ZMLeveledUpTextAdd:setRFTMaterial(LUI.UIImage.GetCachedMaterial(@"hash_5B17513E9D94CE76"))
	...
	ZMLeveledUpTextAdd:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	ZMLeveledUpTextAdd:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	...
	ZMLeveledUpTextBase:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_3C0BFBD2AC9E2C45"))
	ZMLeveledUpTextBase:setTTF("skorzhen")
	ZMLeveledUpTextBase:setRFTMaterial(LUI.UIImage.GetCachedMaterial(@"hash_5B17513E9D94CE76"))
	...
	ZMLeveledUpTextBase:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	ZMLeveledUpTextBase:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	...
	LeveledUpTextBase:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_3C0BFBD2AC9E2C45"))
	...
	LeveledUpTextBase:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	LeveledUpTextAdd:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_3C0BFBD2AC9E2C45"))
	...
	LeveledUpTextAdd:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
...
CoD.AARLevelUpOverlay_LevelUpTextInternal.__resetProperties = function(f3_arg0)
	...
	f3_arg0.LeveledUpTextBase:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_3C0BFBD2AC9E2C45"))
	...
	f3_arg0.ZMLeveledUpTextBase:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_3C0BFBD2AC9E2C45"))
...
CoD.AARLevelUpOverlay_LevelUpTextInternal.__clipsPerState = {
	DefaultState = {
		DefaultClip = function(f4_arg0, f4_arg1)
			...
			f4_arg0.LeveledUpTextBase:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_3C0BFBD2AC9E2C45"))
		...
		Intro = function(f7_arg0, f7_arg1)
			...
			f7_arg0.LeveledUpTextBase:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_3C0BFBD2AC9E2C45"))
			f7_local0(f7_arg0.LeveledUpTextBase)
			local f7_local1 = function(f13_arg0)
				local f13_local0 = function(f14_arg0)
					local f14_local0 = function(f15_arg0)
						f15_arg0:beginAnimation(329, Enum[@"luitween"][@"luitween_ease_in"])
						f15_arg0:setAlpha(0)
						f15_arg0:registerEventHandler("transition_complete_keyframe", f7_arg0.clipFinished)
					end
					f14_arg0:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_out"])
					f14_arg0:setAlpha(1)
	...
	ZM = {
		...
		Intro = function(f49_arg0, f49_arg1)
			...
			f49_arg0.ZMLeveledUpTextBase:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_3C0BFBD2AC9E2C45"))
	...
	CurrentRank = {
		DefaultClip = function(f64_arg0, f64_arg1)
			...
			f64_arg0.LeveledUpTextBase:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_1E0ABFC5C51DD27C"))
