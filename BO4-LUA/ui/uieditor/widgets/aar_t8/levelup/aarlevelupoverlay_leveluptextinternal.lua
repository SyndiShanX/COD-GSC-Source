...
CoD.AARLevelUpOverlay_LevelUpTextInternal.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	ZMLeveledUpTextAdd:setRFTMaterial(LUI.UIImage.GetCachedMaterial(0xB17513E9D94CE76))
	...
	ZMLeveledUpTextAdd:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	ZMLeveledUpTextAdd:setAlignment(Enum[0x7A5123B654282D2][0xE821F0ECFF8D1C7])
	...
	ZMLeveledUpTextBase:setRFTMaterial(LUI.UIImage.GetCachedMaterial(0xB17513E9D94CE76))
	...
	ZMLeveledUpTextBase:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	ZMLeveledUpTextBase:setAlignment(Enum[0x7A5123B654282D2][0xE821F0ECFF8D1C7])
	...
	LeveledUpTextBase:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	LeveledUpTextAdd:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
...
CoD.AARLevelUpOverlay_LevelUpTextInternal.__clipsPerState = {
	...
	CurrentRank = {
		DefaultClip = function(f64_arg0, f64_arg1)
			...
			f64_arg0.LeveledUpTextBase:setText(Engine[0xF9F1239CFD921FE](0xE0ABFC5C51DD27C))
