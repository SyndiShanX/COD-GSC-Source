...
CoD.AARTabButton.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	TabBackingGlowRed:setImage(RegisterImage(0x4E64BF345836DCC))
	...
	TextFocus:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	TextFocus:setAlignment(Enum[0x7A5123B654282D2][0xE821F0ECFF8D1C7])
...
CoD.AARTabButton.__resetProperties = function(f11_arg0)
	...
	f11_arg0.TabEndLeft:setMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
...
CoD.AARTabButton.__clipsPerState = {
	DefaultState = {
		...
		GainActive = function(f13_arg0, f13_arg1)
			...
			f13_arg0.TabEndLeft:setMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
		...
		Active = function(f29_arg0, f29_arg1)
			...
			f29_arg0.TabEndLeft:setMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
		...
		LoseActive = function(f32_arg0, f32_arg1)
			...
			f32_arg0.TabEndLeft:setMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
	...
	Zombies = {
		...
		Active = function(f43_arg0, f43_arg1)
			...
			f43_arg0.TabEndLeft:setMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
		...
		LoseActive = function(f46_arg0, f46_arg1)
			...
			f46_arg0.TabEndLeft:setMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
		...
		GainActive = function(f55_arg0, f55_arg1)
			...
			f55_arg0.TabEndLeft:setMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
