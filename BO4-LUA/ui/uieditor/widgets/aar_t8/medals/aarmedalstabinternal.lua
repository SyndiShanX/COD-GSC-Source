...
CoD.AARMedalsTabInternal.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	MedalsTitleGlow:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_8F69F5BDD4F7C26"))
	MedalsTitleGlow:setTTF("ttmussels_demibold")
	MedalsTitleGlow:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	MedalsTitleGlow:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	MedalsTitleGlow:setAlignment(Enum[@"luialignment"][@"lui_alignment_bottom"])
	...
	MedalsTitle:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_8F69F5BDD4F7C26"))
	MedalsTitle:setTTF("ttmussels_demibold")
	MedalsTitle:setLetterSpacing(10)
	MedalsTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	MedalsTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_bottom"])
