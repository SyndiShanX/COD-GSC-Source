...
CoD.AARLadderPoints.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	PlusMinus:setText(Engine[@"hash_4F9F1239CFD921FE"](@"mp/plus"))
	PlusMinus:setTTF("0arame_mono_stencil")
	PlusMinus:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	PlusMinus:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	self:addElement(PlusMinus)
	self.PlusMinus = PlusMinus
	local PointsTxt = LUI.UIText.new(0.5, 0.5, -150, 150, 0, 0, 100, 118)
	PointsTxt:setRGB(0.92, 0.92, 0.92)
	PointsTxt:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_6436CFB031FD2F44"))
	PointsTxt:setTTF("ttmussels_demibold")
	PointsTxt:setLetterSpacing(4)
	PointsTxt:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	PointsTxt:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	Points:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	Points:setAlignment(Enum[@"luialignment"][@"lui_alignment_bottom"])
	...
	PointsAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_3336C1AE82B1520A"))
	PointsAdd:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	PointsAdd:setAlignment(Enum[@"luialignment"][@"lui_alignment_bottom"])
	...
	DefaultState = {
		DefaultClip = function(f3_arg0, f3_arg1)
			...
			local f3_local0 = function(f4_arg0)
				...
				f3_arg0.Corners:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f3_local1 = function(f7_arg0)
				local f7_local0 = function(f8_arg0)
					f8_arg0:beginAnimation(250, Enum[@"luitween"][@"luitween_ease_out"])
					f8_arg0:setAlpha(0)
			...
			local f3_local2 = function(f9_arg0)
				local f9_local0 = function(f10_arg0)
					...
					f10_arg0:beginAnimation(170, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f3_local4 = function(f14_arg0)
				local f14_local0 = function(f15_arg0)
					...
					f15_arg0:beginAnimation(170, Enum[@"luitween"][@"luitween_ease_out"])
