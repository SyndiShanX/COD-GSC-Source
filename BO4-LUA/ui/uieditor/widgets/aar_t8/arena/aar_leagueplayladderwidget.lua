...
CoD.AAR_LeaguePlayLadderWidget.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	PositionsList:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	...
	SpecialistRight:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_49C509B807FDA37"))
	SpecialistRight:setTTF("0arame_mono_stencil")
	SpecialistRight:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	SpecialistRight:setAlignment(Enum[@"luialignment"][@"lui_alignment_bottom"])
	...
	SpecialistRight2:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_21275B8C997A0D5E"))
	SpecialistRight2:setTTF("0arame_mono_stencil")
	SpecialistRight2:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	SpecialistRight2:setAlignment(Enum[@"luialignment"][@"lui_alignment_bottom"])
