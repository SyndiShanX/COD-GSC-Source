...
CoD.AARCompactHistoryMessage.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	AverageLabel:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_573D09C07F4B5680"))
	AverageLabel:setTTF("ttmussels_regular")
	AverageLabel:setLetterSpacing(4)
	AverageLabel:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	AverageLabel:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
