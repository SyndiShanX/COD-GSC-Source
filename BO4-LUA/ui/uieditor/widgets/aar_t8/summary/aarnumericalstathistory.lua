		...
		DefaultClip = function(f22_arg0, f22_arg1)
			...
			local f22_local0 = function(f23_arg0)
				local f23_local0 = function(f24_arg0)
					f24_arg0:beginAnimation(2000, Enum[@"luitween"][@"luitween_ease_both"])
					f24_arg0:setAlpha(0)
					f24_arg0:registerEventHandler("transition_complete_keyframe", f22_arg0.clipFinished)
				end
				f22_arg0.InValidAdd:beginAnimation(2000, Enum[@"luitween"][@"luitween_ease_both"])
