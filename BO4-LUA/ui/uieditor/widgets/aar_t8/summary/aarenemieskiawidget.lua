...
CoD.AAREnemiesKIAWidget.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Title:setAlpha(0.2)
	Title:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_69DB6D07C46E748"))
	...
	TimeGlow:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	TimeGlow:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	TimeGlow:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	Time:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	...
	StatDeath.RatioLabel:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_3AC9A72BC7A21122"))
...
CoD.AAREnemiesKIAWidget.__resetProperties = function(f11_arg0)
	...
	f11_arg0.Title:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_69DB6D07C46E748"))
...
CoD.AAREnemiesKIAWidget.__clipsPerState = {
	DefaultState = {
		DefaultClip = function(f12_arg0, f12_arg1)
			...
			local f12_local0 = function(f13_arg0)
				...
				f12_arg0.KillsGlow:beginAnimation(1000, Enum[@"luitween"][@"luitween_ease_both"])
	...
	PropHunt = {
		DefaultClip = function(f16_arg0, f16_arg1)
			...
			f16_arg0.Title:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_3AD795C41AE2FC56"))
