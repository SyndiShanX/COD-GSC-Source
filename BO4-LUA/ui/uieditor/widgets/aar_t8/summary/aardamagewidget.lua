...
CoD.AARDamageWidget.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	DamageGlow:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	DamageGlow:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	DamageGlow:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	DamageLabel:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_2C4B84A4968AAC62"))
	...
	Damage:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	ObjectiveScoreLargeGlow:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	ObjectiveScoreLargeGlow:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	ObjectiveScoreLargeGlow:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	ObjectiveScoreLarge:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	ObjectiveScoreLarge:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	ObjectiveTotalGlow:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	ObjectiveTotalGlow:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	ObjectiveTotalGlow:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	ObjectiveTotal:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	ObjectiveTotal:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	EscortDeliveries:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	EscortDeliveries:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	EscortDeliveries:linkToElementModel(self, "escortDeliveries", true, function(model)
		local f8_local0 = model:get()
		if f8_local0 ~= nil then
			EscortDeliveries:setText(LocalizeStringWithParameter(@"hash_47AEA6CA48B89901", f8_local0))
		end
	end)
	...
	CleanDeposits:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	CleanDeposits:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	EscortDisables:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	EscortDisables:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	EscortDisables:linkToElementModel(self, "escortDisables", true, function(model)
		local f10_local0 = model:get()
		if f10_local0 ~= nil then
			EscortDisables:setText(LocalizeStringWithParameter(@"hash_7D310F5466D82F18", f10_local0))
		end
	end)
	...
	CleanDenies:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	CleanDenies:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	ObjectiveEKIA.ScoreLabel:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_51C51D749B365E54"))
	...
	ObjectiveReturns.ScoreLabel:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_6813EDE9EBB8843E"))
...
CoD.AARDamageWidget.__resetProperties = function(f22_arg0)
	...
	f22_arg0.DamageLabel:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_2C4B84A4968AAC62"))
...
CoD.AARDamageWidget.__clipsPerState = {
	DefaultState = {
		DefaultClip = function(f23_arg0, f23_arg1)
			...
			local f23_local0 = function(f24_arg0)
				...
				f23_arg0.DamageGlow:beginAnimation(1000, Enum[@"luitween"][@"luitween_ease_both"])
	...
	Escort = {
		DefaultClip = function(f27_arg0, f27_arg1)
			...
			f27_arg0.DamageLabel:setText(Engine[@"hash_4F9F1239CFD921FE"](@"aar/objective"))
	...
	Clean = {
		DefaultClip = function(f31_arg0, f31_arg1)
			...
			f31_arg0.DamageLabel:setText(Engine[@"hash_4F9F1239CFD921FE"](@"aar/objective"))
	...
	PropHunt = {
		DefaultClip = function(f35_arg0, f35_arg1)
			...
			f35_arg0.DamageLabel:setText(Engine[@"hash_4F9F1239CFD921FE"](@"aar/objective"))
	...
	Ctf = {
		DefaultClip = function(f36_arg0, f36_arg1)
			...
			f36_arg0.DamageLabel:setText(Engine[@"hash_4F9F1239CFD921FE"](@"aar/objective"))
	...
	Objective = {
		DefaultClip = function(f37_arg0, f37_arg1)
			...
			f37_arg0.DamageLabel:setText(Engine[@"hash_4F9F1239CFD921FE"](@"aar/objective"))
			...
			local f37_local0 = function(f38_arg0)
				...
				f37_arg0.ObjectiveTotalGlow:beginAnimation(1000, Enum[@"luitween"][@"luitween_ease_both"])
