...
CoD.AARRewardContractDesc = InheritFrom(LUI.UIElement)
CoD.AARRewardContractDesc.__defaultWidth = 380
CoD.AARRewardContractDesc.__defaultHeight = 182
CoD.AARRewardContractDesc.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	local self = LUI.UIElement.new(f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	self:setClass(CoD.AARRewardContractDesc)
	self.id = "AARRewardContractDesc"
	self.soundSet = "none"
	...
	local Description = LUI.UIText.new(0.5, 0.5, -171, 89, 0, 0, 51, 69)
	...
	local Title = LUI.UIText.new(0.5, 0.5, -171, 89, 0, 0, 24.5, 45.5)
...
CoD.AARRewardContractDesc.__onClose = function(f2_arg0)
	f2_arg0.Frame:close()
