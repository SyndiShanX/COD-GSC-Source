	...
	DefaultState = {
		DefaultClip = function(f9_arg0, f9_arg1)
			...
			local f9_local0 = function(f10_arg0)
				f9_arg0.AARRewardHeaderZM:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f9_local1 = function(f11_arg0)
				local f11_local0 = function(f12_arg0)
					f12_arg0:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
					f12_arg0:setAlpha(1)
		...
		DefaultClip = function(f13_arg0, f13_arg1)
			...
			local f13_local1 = function(f15_arg0)
				local f15_local0 = function(f16_arg0)
					f16_arg0:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
					f16_arg0:setAlpha(1)
