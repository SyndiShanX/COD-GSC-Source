require("x64:46fa4015e14fa27")
require("x64:4e6143dbc749ffd")
require("x64:377569138f4cdb9")
...
CoD.AARClassRewardPreview.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Perks:setSpacing(20)
	Perks:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	...
	Linker3:setZRot(90)
	Linker3:setImage(RegisterImage(@"hash_C49B0C8991A541F"))
	Linker3:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
