...
CoD.PlayOfTheMatchWidget.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	FluffGradientRight:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_E2354BE557C4C7A"))
	...
	SpecialistName:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	SpecialistName.__String_Reference = function(f2_arg0)
		local f2_local0 = f2_arg0:get()
		if f2_local0 ~= nil then
			SpecialistName:setText(Engine[@"hash_4F9F1239CFD921FE"](GetCharacterDisplayNameByIndex(f2_local0)))
		end
	end
	...
	TextGamertag:setRFTMaterial(LUI.UIImage.GetCachedMaterial(@"hash_5B17513E9D94CE76"))
	...
	whiteflare:setImage(RegisterImage(@"hash_33F0C857755BA4B7"))
	...
	speedfare:setImage(RegisterImage(@"hash_43BEA16D33C8F870"))
	...
	spermflare:setImage(RegisterImage(@"hash_5FB683D5D1061C79"))
...
CoD.PlayOfTheMatchWidget.__resetProperties = function(f6_arg0)
	...
	f6_arg0.FluffGradientRight:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_E2354BE557C4C7A"))
	...
	f6_arg0.TextGamertag:setRFTMaterial(LUI.UIImage.GetCachedMaterial(@"hash_5B17513E9D94CE76"))
		...
		DefaultClip = function(f8_arg0, f8_arg1)
			...
			local f8_local0 = function(f9_arg0)
				local f9_local0 = function(f10_arg0)
					local f10_local0 = function(f11_arg0)
						f11_arg0:beginAnimation(199, Enum[@"luitween"][@"luitween_ease_in"])
						f11_arg0:setAlpha(1)
			...
			local f8_local1 = function(f12_arg0)
				local f12_local0 = function(f13_arg0)
					...
					f13_arg0:beginAnimation(269, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f8_local2 = function(f15_arg0)
				local f15_local0 = function(f16_arg0)
					local f16_local0 = function(f17_arg0)
						...
						f17_arg0:beginAnimation(190, Enum[@"luitween"][@"luitween_ease_in"])
			...
			f8_arg0.TextGamertag:setRFTMaterial(LUI.UIImage.GetCachedMaterial(@"hash_5B17513E9D94CE76"))
		...
		DefaultClip = function(f52_arg0, f52_arg1)
				...
				local f53_local0 = function(f54_arg0)
					local f54_local0 = function(f55_arg0)
						local f55_local0 = function(f56_arg0)
							f56_arg0:beginAnimation(199, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f52_local1 = function(f57_arg0)
				local f57_local0 = function(f58_arg0)
					...
					f58_arg0:beginAnimation(269, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f52_local2 = function(f60_arg0)
				local f60_local0 = function(f61_arg0)
					local f61_local0 = function(f62_arg0)
						...
						f62_arg0:beginAnimation(190, Enum[@"luitween"][@"luitween_ease_in"])
			...
			f52_arg0.TextGamertag:setRFTMaterial(LUI.UIImage.GetCachedMaterial(@"hash_5B17513E9D94CE76"))
