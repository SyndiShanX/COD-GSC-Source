...
CoD.LoadoutClassItemContainerZombie.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Colorize:setAlpha(0)
	Colorize:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16CBE95C250C6D15"))
	...
	BracketsBottom:setImage(RegisterImage(@"hash_630489D9CBA3FA2"))
	...
	BracketsTop:setImage(RegisterImage(@"hash_3BB497F7936F10E4"))
	...
	DotsTop:setImage(RegisterImage(@"hash_46A5B4F2DD473905"))
	...
	loadoutName:setText(LocalizeToUpperString(@"hash_463E51BFF17859F1"))
	loadoutName:setTTF("ttmussels_regular")
	loadoutName:setLetterSpacing(4)
	loadoutName:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
