	...
	DefaultState = {
		...
		GainChildFocus = function(f22_arg0, f22_arg1)
			...
			local f22_local0 = function(f23_arg0)
				f22_arg0.WeaponSelectGridItemInternal:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
		...
		LoseChildFocus = function(f24_arg0, f24_arg1)
			...
			local f24_local0 = function(f25_arg0)
				f24_arg0.WeaponSelectGridItemInternal:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
