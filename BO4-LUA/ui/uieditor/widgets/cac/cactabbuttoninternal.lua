require("ui/uieditor/widgets/cac/restricteditemwarningbar")
...
CoD.CACTabButtonInternal.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	TabBackingGlowRed:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	TabBackingRed:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	TextFocus:setAlignment(Enum.LUIAlignment[@"lui_alignment_center"])
	TextFocus:setAlignment(Enum.LUIAlignment[@"hash_E821F0ECFF8D1C7"])
	...
	TextFocus:setBackingMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	self.Text:linkToElementModel(self, "tabName", true, function(model)
		...
		if f5_local0 ~= nil then
			Text:setText(Engine[@"hash_4F9F1239CFD921FE"](f5_local0))
		end
	end)
	self.TextFocus:linkToElementModel(self, "tabName", true, function(model)
		local f6_local0 = model:get()
		if f6_local0 ~= nil then
			TextFocus:setText(Engine[@"hash_4F9F1239CFD921FE"](f6_local0))
		end
	end)
	...
	DefaultState = {
		...
		GainActive = function(f18_arg0, f18_arg1)
			...
			local f18_local5 = function(f26_arg0)
				...
				f18_arg0.TabEndLeft:beginAnimation(120, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f18_local6 = function(f28_arg0)
				...
				f18_arg0.TabEndRight:beginAnimation(120, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_out"])
	...
	Zombies = {
		...
		GainActive = function(f117_arg0, f117_arg1)
			...
			local f117_local5 = function(f125_arg0)
				...
				f117_arg0.TabEndLeft:beginAnimation(120, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f117_local6 = function(f127_arg0)
				...
				f117_arg0.TabEndRight:beginAnimation(120, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_out"])
	...
	Multilplayer = {
		...
		GainActive = function(f223_arg0, f223_arg1)
			...
			local f223_local5 = function(f231_arg0)
				...
				f223_arg0.TabEndLeft:beginAnimation(120, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f223_local6 = function(f233_arg0)
				...
				f223_arg0.TabEndRight:beginAnimation(120, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_out"])
