...
CoD.WeaponAttributeUberInfo.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	UberHeaderText:setText(LocalizeToUpperString(@"hash_6912DE50663D611C"))
	UberHeaderText:setTTF("ttmussels_regular")
	UberHeaderText:setLetterSpacing(4)
	UberHeaderText:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	...
	UberAttachmentName:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
