...
CoD.PCSocialMenu_GenericButton.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	self:setClass(CoD.PCSocialMenu_GenericButton)
	self.id = "PCSocialMenu_GenericButton"
	self.soundSet = "default"
	self.onlyChildrenFocusable = true
	f1_arg0:addElementToPendingUpdateStateList(self)
	local ButtonContainer = CoD.PCSocialMenu_GenericButton_Container.new(f1_arg0, f1_arg1, 0, 1, 0, 0, 0, 1, 0, 0)
