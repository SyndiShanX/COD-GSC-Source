...
CoD.EmblemRenameTextBox = InheritFrom(LUI.UIElement)
CoD.EmblemRenameTextBox.__defaultWidth = 412
CoD.EmblemRenameTextBox.__defaultHeight = 60
CoD.EmblemRenameTextBox.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	local self = LUI.UIElement.new(f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	CoD.BaseUtility.InitControllerModel(f1_arg1, "renameEmblemText")
	self:setClass(CoD.EmblemRenameTextBox)
	self.id = "EmblemRenameTextBox"
	...
	f1_local6 = self
	if IsPC() then
		CoD.PCUtility.SetEditBoxMaxChar(self, 15)
...
CoD.EmblemRenameTextBox.__resetProperties = function(f6_arg0)
...
CoD.EmblemRenameTextBox.__clipsPerState = {
	DefaultState = {
...
CoD.EmblemRenameTextBox.__onClose = function(f25_arg0)
