...
CoD.StartMenu_Options_PC_Graphics_Advanced = InheritFrom(LUI.UIElement)
CoD.StartMenu_Options_PC_Graphics_Advanced.__defaultWidth = 1650
CoD.StartMenu_Options_PC_Graphics_Advanced.__defaultHeight = 900
CoD.StartMenu_Options_PC_Graphics_Advanced.new = function(f3_arg0, f3_arg1, f3_arg2, f3_arg3, f3_arg4, f3_arg5, f3_arg6, f3_arg7, f3_arg8, f3_arg9)
	...
	self:setClass(CoD.StartMenu_Options_PC_Graphics_Advanced)
	self.id = "StartMenu_Options_PC_Graphics_Advanced"
	...
	graphicsList:setDataSource("OptionGraphicsAdvanced")
