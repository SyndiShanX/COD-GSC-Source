...
CoD.PC_StartMenu_Options_SafeAreaBorder_Vert.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	self:setClass(CoD.PC_StartMenu_Options_SafeAreaBorder_Vert)
	self.id = "PC_StartMenu_Options_SafeAreaBorder_Vert"
	self.soundSet = "default"
	self.onlyChildrenFocusable = true
	f1_arg0:addElementToPendingUpdateStateList(self)
	local HandleBG = LUI.UIImage.new(0.5, 0.5, -60, 60, 0, 0, 20, 45)
	HandleBG:setAlpha(0.15)
	self:addElement(HandleBG)
	self.HandleBG = HandleBG
	local HandleBG2 = LUI.UIImage.new(0.5, 0.5, -35.5, 35.5, 0, 0, 32, 33)
	HandleBG2:setRGB(0.29, 0.29, 0.29)
	HandleBG2:setAlpha(0.5)
	self:addElement(HandleBG2)
	self.HandleBG2 = HandleBG2
	local Border = LUI.UIImage.new(0, 1, 0, 0, 0, 0, 0, 1)
	Border:setAlpha(0.15)
	self:addElement(Border)
	self.Border = Border
	local emptyFocusableClic = CoD.emptyFocusable.new(f1_arg0, f1_arg1, 0, 1, 100, -100, 0, 1, 0, 0)
