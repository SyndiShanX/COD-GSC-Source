...
CoD.StartMenu_Options_PC_Accessibility_TabContent.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	self:setClass(CoD.StartMenu_Options_PC_Accessibility_TabContent)
	self.id = "StartMenu_Options_PC_Accessibility_TabContent"
	self.soundSet = "default"
	self.onlyChildrenFocusable = true
	self.anyChildUsesUpdateState = true
	f1_arg0:addElementToPendingUpdateStateList(self)
	local SubOptionsNavigation1 = CoD.StartMenu_Options_PC_AccessibilityOptions_SubOptionsNavigation.new(f1_arg0, f1_arg1, 0, 0, 422, 1885, 0, 0, 0, 716)
	...
	SubOptions = {
		DefaultClip = function(f12_arg0, f12_arg1)
			...
			local f12_local0 = function(f13_arg0)
				f12_arg0.SubOptionsNavigation1:beginAnimation(350, Enum[@"luitween"][@"luitween_ease_out"])
