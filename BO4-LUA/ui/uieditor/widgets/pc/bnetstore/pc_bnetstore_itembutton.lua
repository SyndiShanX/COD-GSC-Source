...
CoD.PC_BnetStore_ItemButton.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Purchased:setAlignment(Enum.LUIAlignment[@"lui_alignment_bottom"])
	self:addElement(Purchased)
	self.Purchased = Purchased
	local Owned = LUI.UIText.new(0, 1, 204, -92, 0.5, 0.5, 5, 33)
	Owned:setRGB(0.52, 0.52, 0.52)
	Owned:setAlpha(0)
	Owned:setText(Engine[@"hash_4F9F1239CFD921FE"]("store/owned"))
	Owned:setTTF("ttmussels_regular")
	Owned:setLetterSpacing(2)
	Owned:setAlignment(Enum.LUIAlignment[@"lui_alignment_left"])
	Owned:setAlignment(Enum.LUIAlignment[@"lui_alignment_bottom"])
	...
	PurchasedImage:setImage(RegisterImage(@"hash_1ACBDC051D85F4A8"))
	...
	f1_arg0:AddButtonCallbackFunction(self, f1_arg1, Enum.LUIButton[@"lui_key_xba_pscross"], nil, function(f14_arg0, f14_arg1, f14_arg2, f14_arg3)
		CoD.PCUtility.ActiveParentElementGrid(self, f14_arg1, f14_arg2)
		return true
	end, function(f15_arg0, f15_arg1, f15_arg2)
		CoD.Menu.SetButtonLabel(f15_arg1, Enum.LUIButton[@"lui_key_xba_pscross"], 0x0, nil, nil)
		return false
	end, false)
