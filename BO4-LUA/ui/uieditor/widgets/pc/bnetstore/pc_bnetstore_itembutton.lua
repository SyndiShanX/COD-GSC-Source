...
CoD.PC_BnetStore_ItemButton.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Purchased:setText(LocalizeToUpperString(0xD65F0B9783C3D00))
	...
	Purchased:setAlignment(Enum[0x7A5123B654282D2][0x70510683C22104B])
	...
	Owned:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	Owned:setAlignment(Enum[0x7A5123B654282D2][0x70510683C22104B])
...
CoD.PC_BnetStore_ItemButton.__resetProperties = function(f16_arg0)
	...
	f16_arg0.PurchasedImage:setMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
...
CoD.PC_BnetStore_ItemButton.__clipsPerState = {
	...
	Owned = {
		DefaultClip = function(f37_arg0, f37_arg1)
			...
			f37_arg0.PurchasedImage:setMaterial(LUI.UIImage.GetCachedMaterial(0x67D1E3A3D2D1BF))
		...
		Focus = function(f38_arg0, f38_arg1)
			...
			f38_arg0.PurchasedImage:setMaterial(LUI.UIImage.GetCachedMaterial(0x67D1E3A3D2D1BF))
		...
		Active = function(f39_arg0, f39_arg1)
			...
			f39_arg0.PurchasedImage:setMaterial(LUI.UIImage.GetCachedMaterial(0x67D1E3A3D2D1BF))
		...
		GainFocus = function(f40_arg0, f40_arg1)
			...
			f40_arg0.PurchasedImage:setMaterial(LUI.UIImage.GetCachedMaterial(0x67D1E3A3D2D1BF))
		...
		LoseFocus = function(f43_arg0, f43_arg1)
			...
			f43_arg0.PurchasedImage:setMaterial(LUI.UIImage.GetCachedMaterial(0x67D1E3A3D2D1BF))
		...
		ActiveAndFocus = function(f46_arg0, f46_arg1)
			...
			f46_arg0.PurchasedImage:setMaterial(LUI.UIImage.GetCachedMaterial(0x67D1E3A3D2D1BF))
