...
CoD.PC_BnetStore_GiftButton_Texts.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	ButtonTitle:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_6CAF60F095239BED"))
	...
	GiftSalePrice:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	GiftSalePrice:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	...
	GiftPrice:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
