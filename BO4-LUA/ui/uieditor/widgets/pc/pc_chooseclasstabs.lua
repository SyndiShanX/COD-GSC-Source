...
CoD.PC_ChooseClassTabs.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	TextBoxThin:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TextBoxThin:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TextBoxBold:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TextBoxBold:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	footerTooltip.label:setText(LocalizeToUpperString(@"hash_4BC5B5CEFBE730F7"))
