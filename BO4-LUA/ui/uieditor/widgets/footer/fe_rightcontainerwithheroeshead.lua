...
CoD.fe_RightContainerWithHeroesHead.__defaultWidth = 1305
CoD.fe_RightContainerWithHeroesHead.__defaultHeight = 48
CoD.fe_RightContainerWithHeroesHead.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	self.Image0 = Image0
	local FooterButtonDoublePrompts = CoD.FooterButtonDoublePrompts.new(f1_arg0, f1_arg1, 1, 1, -631, -358, 1, 1, -48, 0)
	...
	local Padbtn = CoD.FooterButtonPrompt.new(f1_arg0, f1_arg1, 1, 1, -872, -631, 1, 1, -48, 0)
	...
	self.Padbtn = Padbtn
	local RJoystickbtn = CoD.FooterButtonPrompt.new(f1_arg0, f1_arg1, 1, 1, -1008, -872, 1, 1, -48, 0)
...
CoD.fe_RightContainerWithHeroesHead.__onClose = function(f9_arg0)
	f9_arg0.FooterButtonDoublePrompts:close()
	f9_arg0.Padbtn:close()
	f9_arg0.RJoystickbtn:close()
end
