...
CoD.Loot_BonusToastStandard.__resetProperties = function(f2_arg0)
	...
	f2_arg0.ItemName:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	...
	f2_arg0.SetName:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	f2_arg0.Category:setLeftRight(0, 0, 131.5, 399.5)
	f2_arg0.Category:setTopBottom(0, 0, 38.5, 56.5)
	f2_arg0.Category:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
...
CoD.Loot_BonusToastStandard.__clipsPerState = {
	...
	LootBonusCallingCard = {
		DefaultClip = function(f5_arg0, f5_arg1)
			...
			f5_arg0.Category:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
			...
			f5_arg0.SetName:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
			...
			f5_arg0.ItemName:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
