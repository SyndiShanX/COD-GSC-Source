...
CoD.PlayerCardMenu.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	ClanTag(TeamColor, RankIcon["UIVisibilityBit." .. Enum[@"uivisibilitybit"][@"bit_game_ended"]], function(f5_arg0)
		f1_arg0:updateElementState(GamerTag, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	CalloutHeading:linkToElementModel(self, "heading", true, function(model)
		...
		if f15_local0 ~= nil then
			CalloutHeading:setText(Engine[@"hash_4F9F1239CFD921FE"](f15_local0))
		end
	end)
	...
	IdentitySeperatorTop:setImage(RegisterImage(@"hash_3CF8AB3892E52036"))
	...
	IdentitySeperatorBottom:setImage(RegisterImage(@"hash_3CF8AB3892E52036"))
