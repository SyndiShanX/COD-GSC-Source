	...
	DefaultState = {
				...
				local f19_local0 = function(f20_arg0)
					local f20_local0 = function(f21_arg0)
						local f21_local0 = function(f22_arg0)
							...
							f22_arg0:beginAnimation(90, Enum[@"luitween"][@"luitween_ease_out"])
		...
		TimeUp = function(f24_arg0, f24_arg1)
			...
			local f24_local0 = function(f25_arg0)
				f24_arg0.SubText:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f24_local1 = function(f26_arg0)
				f26_arg0:beginAnimation(199, Enum[@"luitween"][@"luitween_ease_out"])
				f26_arg0:setAlpha(0)
			...
			local f24_local2 = function(f27_arg0)
				f24_arg0.Title:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
		...
		Combined = function(f28_arg0, f28_arg1)
			...
			local f28_local0 = function(f29_arg0)
				...
				f28_arg0.SubText:beginAnimation(300, Enum[@"luitween"][@"luitween_ease_out"])
	...
	DoubleXP = {
				...
				local f46_local0 = function(f47_arg0)
					local f47_local0 = function(f48_arg0)
						local f48_local0 = function(f49_arg0)
							...
							f49_arg0:beginAnimation(90, Enum[@"luitween"][@"luitween_ease_out"])
		...
		TimeUp = function(f51_arg0, f51_arg1)
			...
			local f51_local0 = function(f52_arg0)
				f51_arg0.SubText:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f51_local1 = function(f53_arg0)
				f53_arg0:beginAnimation(199, Enum[@"luitween"][@"luitween_ease_out"])
				f53_arg0:setAlpha(0)
			...
			local f51_local3 = function(f56_arg0)
				f51_arg0.Title:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
		...
		Combined = function(f57_arg0, f57_arg1)
			...
			local f57_local0 = function(f58_arg0)
				local f58_local0 = function(f59_arg0)
					f59_arg0:beginAnimation(199, Enum[@"luitween"][@"luitween_ease_out"])
					f59_arg0:setScale(1, 1)
					f59_arg0:registerEventHandler("transition_complete_keyframe", f57_arg0.clipFinished)
				end
				f57_arg0.SubText:beginAnimation(300, Enum[@"luitween"][@"luitween_ease_out"])
