	...
	DefaultState = {
		...
		StartNotification = function(f6_arg0, f6_arg1)
			...
			local f6_local0 = function(f7_arg0)
				local f7_local0 = function(f8_arg0)
					f8_arg0:beginAnimation(500, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_in"])
					f8_arg0:setAlpha(1)
		...
		TimeUp = function(f9_arg0, f9_arg1)
			...
			local f9_local0 = function(f10_arg0)
				f9_arg0.NotificationText:beginAnimation(400, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_in"])
