...
CoD.LootContractCompleteNotification.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	DescriptionText:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	...
	DescriptionText:setBackingMaterial(LUI.UIImage.GetCachedMaterial(@"hash_E2354BE557C4C7A"))
	...
	DefaultState = {
		DefaultClip = function(f10_arg0, f10_arg1)
			...
			local f10_local1 = function(f14_arg0)
				local f14_local0 = function(f15_arg0)
					f15_arg0:beginAnimation(99, Enum[@"luitween"][@"luitween_ease_out"])
					f15_arg0:setScale(1, 1)
					f15_arg0:registerEventHandler("transition_complete_keyframe", f10_arg0.clipFinished)
				end
				f14_arg0:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
				f14_arg0:setAlpha(1)
			...
			local f10_local3 = function(f18_arg0)
				local f18_local0 = function(f19_arg0)
					f19_arg0:beginAnimation(69, Enum[@"luitween"][@"luitween_ease_out"])
				...
				f18_arg0:beginAnimation(90, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f10_local4 = function(f20_arg0)
				local f20_local0 = function(f21_arg0)
					f21_arg0:beginAnimation(89, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f10_local6 = function(f25_arg0)
				local f25_local0 = function(f26_arg0)
					local f26_local0 = function(f27_arg0)
						f27_arg0:beginAnimation(370, Enum[@"luitween"][@"luitween_ease_out"])
				...
				local f28_local0 = function(f29_arg0)
					local f29_local0 = function(f30_arg0)
						local f30_local0 = function(f31_arg0)
							f31_arg0:beginAnimation(60, Enum[@"luitween"][@"luitween_ease_out"])
					...
					f29_arg0:beginAnimation(69, Enum[@"luitween"][@"luitween_ease_out"])
					f29_arg0:setAlpha(1)
					f29_arg0:setScale(2.75, 2.75)
					f29_arg0:registerEventHandler("transition_complete_keyframe", f29_local0)
				end
				f10_arg0.Rank:beginAnimation(510, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f10_local8 = function(f32_arg0)
				...
				f32_arg0:beginAnimation(130, Enum[@"luitween"][@"luitween_ease_out"])
		...
		TimeUp = function(f34_arg0, f34_arg1)
			...
			local f34_local7 = function(f42_arg0)
				...
				f34_arg0.Rank:beginAnimation(50, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_out"])
