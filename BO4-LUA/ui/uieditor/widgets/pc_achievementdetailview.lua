...
CoD.PC_AchievementDetailView.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	CurrentProgressValue:setText(Engine[@"hash_4F9F1239CFD921FE"](@"menu/new"))
	CurrentProgressValue:setTTF("ttmussels_demibold")
	CurrentProgressValue:setLetterSpacing(2)
	CurrentProgressValue:setAlignment(Enum.LUIAlignment[@"lui_alignment_right"])
	CurrentProgressValue:setAlignment(Enum.LUIAlignment[@"lui_alignment_top"])
	...
	TotalProgressValue:setText(Engine[@"hash_4F9F1239CFD921FE"](@"menu/new"))
	...
	TotalProgressValue:setAlignment(Enum.LUIAlignment[@"lui_alignment_top"])
	...
	HeaderStripeBot:setImage(RegisterImage(@"hash_2C7A051F5EFC70E5"))
	HeaderStripeBot:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16CBE95C250C6D15"))
	...
	HeaderStripeTop:setImage(RegisterImage(@"hash_2C7A051F5EFC70E5"))
	HeaderStripeTop:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16CBE95C250C6D15"))
