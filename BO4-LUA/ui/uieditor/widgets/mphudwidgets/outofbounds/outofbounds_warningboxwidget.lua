...
CoD.outofbounds_warningboxwidget.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	CenterBoxGlow:setImage(RegisterImage(@"hash_1A6ABAF4E8653C11"))
	CenterBoxGlow:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	CenterBoxBotLine3:setImage(RegisterImage(@"hash_4B272A8F1652D0AD"))
	...
	CenterBoxBotLine2:setImage(RegisterImage(@"hash_4B272A8F1652D0AD"))
	...
	CenterBoxBotLine:setImage(RegisterImage(@"hash_4B272A8F1652D0AD"))
	...
	CenterBox3:setImage(RegisterImage(@"hash_1A7ACAAD400A469D"))
	...
	CenterBox2:setImage(RegisterImage(@"hash_1A7ACAAD400A469D"))
	...
	CenterBox:setImage(RegisterImage(@"hash_1A7ACAAD400A469D"))
	...
	TextBoxWarningBlur:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_3DBDEBD27773724A"))
	TextBoxWarningBlur:setTTF("0arame_mono_stencil")
	TextBoxWarningBlur:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_2AE166D9BA8C6907"))
	...
	TextBoxWarningBlur:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TextBoxWarningBlur:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TextBoxWarning:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_3DBDEBD27773724A"))
	TextBoxWarning:setTTF("0arame_mono_stencil")
	TextBoxWarning:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_2AE166D9BA8C6907"))
	...
	TextBoxWarning:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TextBoxWarning:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
...
CoD.outofbounds_warningboxwidget.__resetProperties = function(f2_arg0)
	...
	f2_arg0.CenterBoxGlow:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	DefaultState = {
		DefaultClip = function(f3_arg0, f3_arg1)
			...
			local f3_local0 = function(f4_arg0)
				...
				f3_arg0.CenterBoxGlow:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
			...
			f3_arg0.CenterBoxGlow:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
