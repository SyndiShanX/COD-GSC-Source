...
CoD.outofbounds_alert_icon.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	AlertIcon:setImage(RegisterImage(@"hash_49E47106ADFC5151"))
	AlertIcon:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	AlertIcon:setShaderVector(0, 1, 0, 0, 0)
	self:addElement(AlertIcon)
	self.AlertIcon = AlertIcon
	local AlertIconAdd = LUI.UIImage.new(0, 0, 0, 64, 0, 0, 0, 58)
	AlertIconAdd:setImage(RegisterImage(@"hash_49E47106ADFC5151"))
	AlertIconAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
...
CoD.outofbounds_alert_icon.__resetProperties = function(f2_arg0)
	...
	f2_arg0.AlertIcon:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	f2_arg0.AlertIcon:setShaderVector(0, 1, 0, 0, 0)
	f2_arg0.AlertIconAdd:setAlpha(1)
	f2_arg0.AlertIconAdd:setZoom(0)
	f2_arg0.AlertIconAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
...
CoD.outofbounds_alert_icon.__clipsPerState = {
	DefaultState = {
		DefaultClip = function(f3_arg0, f3_arg1)
			...
			f3_arg0.AlertIcon:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
			...
			local f3_local0 = function(f4_arg0)
				...
				f3_arg0.AlertIconAdd:beginAnimation(500, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
			...
			f3_arg0.AlertIconAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
