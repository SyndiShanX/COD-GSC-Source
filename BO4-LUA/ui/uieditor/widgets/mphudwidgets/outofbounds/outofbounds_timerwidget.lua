...
CoD.outofbounds_timerwidget.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Timer0:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TimerPulseSmall:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TimerPulseSmall:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TimerPulseLarge01:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TimerPulseLarge01:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TimerPulseLarge02:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TimerPulseLarge02:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	DefaultState = {
		DefaultClip = function(f7_arg0, f7_arg1)
			...
			local f7_local0 = function(f8_arg0)
				...
				f7_arg0.TimerPulseSmall:beginAnimation(700, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
				...
				local f10_local0 = function(f11_arg0)
					local f11_local0 = function(f12_arg0)
						local f12_local0 = function(f13_arg0)
							...
							f13_arg0:beginAnimation(99, Enum[@"luitween"][@"luitween_ease_in"])
							f13_arg0:setAlpha(0)
