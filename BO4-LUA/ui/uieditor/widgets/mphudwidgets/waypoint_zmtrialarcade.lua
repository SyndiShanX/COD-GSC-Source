...
CoD.Waypoint_ZmTrialArcade.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	self:mergeStateConditions({
		{
			...
			condition = function(menu, element, event)
				local f34_local0 = Engine[0xDD333420C49E6D0](f1_arg1, Enum[0x7F032C2EF103A1A][0x1CDCB451655ABCF])
				if not f34_local0 then
					f34_local0 = Engine[0xDD333420C49E6D0](f1_arg1, Enum[0x7F032C2EF103A1A][0x198075B069840DC])
					if not f34_local0 then
						f34_local0 = Engine[0xDD333420C49E6D0](f1_arg1, Enum[0x7F032C2EF103A1A][0x8A5E996D4528DA2])
						if not f34_local0 then
							f34_local0 = Engine[0xDD333420C49E6D0](f1_arg1, Enum[0x7F032C2EF103A1A][0xA77EB9347BE4DFF])
							if not f34_local0 then
								f34_local0 = Engine[0xDD333420C49E6D0](f1_arg1, Enum[0x7F032C2EF103A1A][0x24E603C16FCC38F])
								if not f34_local0 then
									f34_local0 = Engine[0xDD333420C49E6D0](f1_arg1, Enum[0x7F032C2EF103A1A][0x534C7B2375D2D47])
									if not f34_local0 then
										f34_local0 = Engine[0xDD333420C49E6D0](f1_arg1, Enum[0x7F032C2EF103A1A][0x4828BED794DA0A5])
										if not f34_local0 then
											f34_local0 = Engine[0xDD333420C49E6D0](f1_arg1, Enum[0x7F032C2EF103A1A][0x1E59914E91E423A])
										end
									end
								end
							end
	...
	f1_local19(f1_local18, f1_local20["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0x1CDCB451655ABCF]], function(f39_arg0)
	...
	f1_local20 = Engine[0x4DF5CFBC1771947](f1_arg1)
	f1_local19(f1_local18, f1_local20["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0x198075B069840DC]], function(f40_arg0)
		f1_arg0:updateElementState(self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel
	f1_local20 = Engine[0x4DF5CFBC1771947](f1_arg1)
	f1_local19(f1_local18, f1_local20["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0x8A5E996D4528DA2]], function(f41_arg0)
		f1_arg0:updateElementState(self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel
	f1_local20 = Engine[0x4DF5CFBC1771947](f1_arg1)
	f1_local19(f1_local18, f1_local20["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0xA77EB9347BE4DFF]], function(f42_arg0)
		f1_arg0:updateElementState(self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel
	f1_local20 = Engine[0x4DF5CFBC1771947](f1_arg1)
	f1_local19(f1_local18, f1_local20["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0x24E603C16FCC38F]], function(f43_arg0)
		f1_arg0:updateElementState(self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel
	f1_local20 = Engine[0x4DF5CFBC1771947](f1_arg1)
	f1_local19(f1_local18, f1_local20["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0x534C7B2375D2D47]], function(f44_arg0)
		f1_arg0:updateElementState(self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel
	f1_local20 = Engine[0x4DF5CFBC1771947](f1_arg1)
	f1_local19(f1_local18, f1_local20["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0x4828BED794DA0A5]], function(f45_arg0)
		f1_arg0:updateElementState(self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel
	f1_local20 = Engine[0x4DF5CFBC1771947](f1_arg1)
	f1_local19(f1_local18, f1_local20["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0x1E59914E91E423A]], function(f46_arg0)
		f1_arg0:updateElementState(self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel
	f1_local20 = Engine[0x4DF5CFBC1771947](f1_arg1)
	f1_local19(f1_local18, f1_local20["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0x6FFF566DCC09BBD]], function(f59_arg0)
		f1_arg0:updateElementState(self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel
	f1_local20 = Engine[0x4DF5CFBC1771947](f1_arg1)
	f1_local19(f1_local18, f1_local20["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0xADC477DDE486DD7]], function(f60_arg0)
		f1_arg0:updateElementState(self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel
	f1_local20 = Engine[0x4DF5CFBC1771947](f1_arg1)
	f1_local19(f1_local18, f1_local20["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0x59333FC97F7870]], function(f61_arg0)
		f1_arg0:updateElementState(self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel
	f1_local20 = Engine[0x4DF5CFBC1771947](f1_arg1)
	f1_local19(f1_local18, f1_local20["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0x1C630DB86D235A5]], function(f62_arg0)
		f1_arg0:updateElementState(self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
