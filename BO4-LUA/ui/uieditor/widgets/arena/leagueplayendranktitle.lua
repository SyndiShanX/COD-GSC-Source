...
CoD.leaguePlayEndRankTitle.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	LeveledUpTextBase:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_7C950E3B6C414F51"))
	...
	LeveledUpTextAdd:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_7C950E3B6C414F51"))
...
CoD.leaguePlayEndRankTitle.__resetProperties = function(f3_arg0)
	...
	f3_arg0.LeveledUpTextBase:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_7C950E3B6C414F51"))
...
CoD.leaguePlayEndRankTitle.__clipsPerState = {
				...
				local f14_local0 = function(f15_arg0)
					local f15_local0 = function(f16_arg0)
						local f16_local0 = function(f17_arg0)
							f17_arg0:beginAnimation(330, Enum[@"luitween"][@"luitween_ease_in"])
							f17_arg0:setAlpha(0)
							f17_arg0:registerEventHandler("transition_complete_keyframe", f7_arg0.clipFinished)
						end
						f16_arg0:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_out"])
						f16_arg0:setAlpha(1)
	...
	CurrentRank = {
		DefaultClip = function(f56_arg0, f56_arg1)
			...
			f56_arg0.LeveledUpTextBase:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_1E0ABFC5C51DD27C"))
