		...
		Intro = function(f24_arg0, f24_arg1)
			...
			local f24_local0 = function(f25_arg0)
				local f25_local0 = function(f26_arg0)
					f26_arg0:beginAnimation(299, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f24_local1 = function(f27_arg0)
				local f27_local0 = function(f28_arg0)
					f28_arg0:beginAnimation(299, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f24_local8 = function(f42_arg0)
				local f42_local0 = function(f43_arg0)
					local f43_local0 = function(f44_arg0)
						f44_arg0:beginAnimation(20, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f24_local9 = function(f45_arg0)
				local f45_local0 = function(f46_arg0)
					local f46_local0 = function(f47_arg0)
						f47_arg0:beginAnimation(20, Enum[@"luitween"][@"luitween_ease_in"])
