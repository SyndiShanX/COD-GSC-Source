...
CoD.LeaguePlayEndRankUpPlacementText.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	CurrentRank:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_6058CDEF9060214"))
	...
	NewRank:setAlpha(0)
	NewRank:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_6058CDEF9060214"))
	NewRank:setTTF("ttmussels_demibold")
	NewRank:setLetterSpacing(8)
	NewRank:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	...
	PlacementResult:linkToElementModel(self, "lastLadderRank", true, function(model)
		...
		if f2_local0 ~= nil then
			PlacementResult:setText(Engine[@"hash_4F9F1239CFD921FE"](CoD.ArenaUtility.GetLadderPositionRankUpResult(f2_local0)))
		end
	end)
		...
		Intro = function(f8_arg0, f8_arg1)
			...
			local f8_local0 = function(f9_arg0)
				local f9_local0 = function(f10_arg0)
					f10_arg0:beginAnimation(999, Enum[@"luitween"][@"luitween_ease_in"])
					f10_arg0:setAlpha(0)
			...
			local f8_local2 = function(f15_arg0)
				local f15_local0 = function(f16_arg0)
					local f16_local0 = function(f17_arg0)
						f17_arg0:beginAnimation(199, Enum[@"luitween"][@"luitween_ease_out"])
						f17_arg0:setAlpha(1)
		...
		Intro = function(f21_arg0, f21_arg1)
			...
			local f21_local0 = function(f22_arg0)
				local f22_local0 = function(f23_arg0)
					f23_arg0:beginAnimation(499, Enum[@"luitween"][@"luitween_ease_in"])
					f23_arg0:setAlpha(0)
