...
CoD.ArenaEventButtonInternal.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	MiddleTextFocus:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	MiddleTextFocus:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	LeaderActivityText:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	leagueOrdinalRank:subscribeToGlobalModel(f1_arg1, "LeaguePlayLadder", "entityLadderRank", function(model)
		...
		if f2_local0 ~= nil then
			leagueOrdinalRank:setText(Engine[@"hash_4F9F1239CFD921FE"](CoD.ArenaUtility.GetLadderPositionOrdinal(f2_local0)))
		end
	end)
	...
	leagueRank:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_171E049B161CD00A"))
	leagueRank:setLetterSpacing(2)
	leagueRank:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
...
CoD.ArenaEventButtonInternal.__resetProperties = function(f5_arg0)
	...
	f5_arg0.MiddleTextFocus:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	f5_arg0.LeaderActivityText:setLeftRight(0, 0, 15, 135)
	f5_arg0.LeaderActivityText:setTopBottom(0.5, 0.5, -10, 10)
	f5_arg0.LeaderActivityText:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	f5_arg0.MiddleText:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
...
CoD.ArenaEventButtonInternal.__clipsPerState = {
	DefaultState = {
		...
		GainFocus = function(f10_arg0, f10_arg1)
			...
			local f10_local1 = function(f13_arg0)
				f10_arg0.FrontendFrameSelected:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f10_local2 = function(f14_arg0)
				f10_arg0.FocusGlow:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
		...
		LoseFocus = function(f22_arg0, f22_arg1)
			...
			local f22_local0 = function(f23_arg0)
				f22_arg0.FocusBrackets:beginAnimation(60, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f22_local1 = function(f24_arg0)
				f22_arg0.FrontendFrameSelected:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
			...
			f22_arg0.MiddleTextFocus:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
			f22_local5(f22_arg0.MiddleTextFocus)
			f22_arg0.LeaderActivityText:completeAnimation()
			f22_arg0.LeaderActivityText:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
			...
			f22_arg0.MiddleText:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	Locked = {
		DefaultClip = function(f33_arg0, f33_arg1)
			...
			f33_arg0.MiddleText:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
		...
		LoseFocus = function(f39_arg0, f39_arg1)
			...
			local f39_local0 = function(f40_arg0)
				f39_arg0.FocusBrackets:beginAnimation(60, Enum[@"luitween"][@"luitween_ease_in"])
