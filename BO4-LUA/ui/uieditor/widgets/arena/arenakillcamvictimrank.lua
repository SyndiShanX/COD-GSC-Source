CoD.ArenaKillcamVictimRank = InheritFrom(LUI.UIElement)
CoD.ArenaKillcamVictimRank.__defaultWidth = 147
CoD.ArenaKillcamVictimRank.__defaultHeight = 40
CoD.ArenaKillcamVictimRank.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	self:setClass(CoD.ArenaKillcamVictimRank)
	self.id = "ArenaKillcamVictimRank"
	self.soundSet = "none"
	...
	Rank:subscribeToGlobalModel(f1_arg1, "Victim", "xuid", Rank.__String_Reference)
	Rank.__String_Reference_FullPath = function()
		local f3_local0 = DataSources.Victim.getModel(f1_arg1)
	...
	RankIcon:subscribeToGlobalModel(f1_arg1, "Victim", "xuid", RankIcon.__Image)
	RankIcon.__Image_FullPath = function()
		local f5_local0 = DataSources.Victim.getModel(f1_arg1)
