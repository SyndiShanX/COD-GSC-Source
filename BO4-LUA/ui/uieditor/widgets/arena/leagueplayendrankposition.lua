...
CoD.LeaguePlayEndRankPosition.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Position:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	...
	Position:subscribeToGlobalModel(f1_arg1, "LeaguePlay", "lastLadderRank", function(model)
		...
		if f2_local0 ~= nil then
			Position:setText(LocalizeStringWithParameter(0xE8DFC210924D670, f2_local0))
		end
	end)
	self:addElement(Position)
	self.Position = Position
	local YouPlacedText = LUI.UIText.new(0.5, 0.5, -302, 302, 0, 0, 37, 62)
	YouPlacedText:setText(Engine[0xF9F1239CFD921FE](0x3D5F1A3853D382D))
	YouPlacedText:setTTF("ttmussels_regular")
	YouPlacedText:setLetterSpacing(4)
	YouPlacedText:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	YouPlacedText:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	PlacementResult:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	PlacementResult:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	PlacementResult:subscribeToGlobalModel(f1_arg1, "LeaguePlay", "lastLadderRank", function(model)
		local f3_local0 = model:get()
		if f3_local0 ~= nil then
			PlacementResult:setText(Engine[0xF9F1239CFD921FE](CoD.ArenaUtility.GetLadderPositionResult(f3_local0)))
		end
	end)
