...
CoD.LeaguePlayEndrankupplacement.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Reward:setAlpha(0)
	Reward:setText(Engine[@"hash_4F9F1239CFD921FE"](0xAE84A67016185))
	...
	LadderPointRule:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_115BF1D94808E922"))
	LadderPointRule:setTTF("ttmussels_regular")
	LadderPointRule:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_171E049B161CD00A"))
	LadderPointRule:setLetterSpacing(1)
	LadderPointRule:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	LadderPointRule:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	DefaultState = {
		DefaultClip = function(f12_arg0, f12_arg1)
			...
			local f12_local0 = function(f13_arg0)
				f12_arg0.Backing:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f12_local3 = function(f20_arg0)
				...
				f12_arg0.infoBracketBot:beginAnimation(160, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f12_local4 = function(f23_arg0)
				...
				f12_arg0.infoBracketTop:beginAnimation(160, Enum[@"luitween"][@"luitween_ease_in"])
