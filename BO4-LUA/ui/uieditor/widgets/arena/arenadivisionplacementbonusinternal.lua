...
CoD.ArenaDivisionPlacementBonusInternal.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	ladderpoint:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_21275B8C997A0D5E"))
	ladderpoint:setTTF("ttmussels_regular")
	ladderpoint:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_171E049B161CD00A"))
	ladderpoint:setLetterSpacing(1)
	ladderpoint:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	ladderpoint:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	SubdivisionName:setText(Engine[@"hash_4F9F1239CFD921FE"](0x6CC918ABE57B73))
	SubdivisionName:setTTF("ttmussels_regular")
	SubdivisionName:setLetterSpacing(1)
	SubdivisionName:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	SubdivisionName:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	DivisionName:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	DivisionName:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
