CoD.ChatAutoCompleteAction = InheritFrom(LUI.UIElement)
CoD.ChatAutoCompleteAction.__defaultWidth = 233
CoD.ChatAutoCompleteAction.__defaultHeight = 29
CoD.ChatAutoCompleteAction.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	self:setClass(CoD.ChatAutoCompleteAction)
	self.id = "ChatAutoCompleteAction"
	self.soundSet = "none"
