	...
	DefaultState = {
		...
		GainChildFocus = function(f12_arg0, f12_arg1)
			...
			local f12_local0 = function(f13_arg0)
				f12_arg0.ButtonOptionInternal:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_in"])
		...
		LoseChildFocus = function(f14_arg0, f14_arg1)
			...
			local f14_local0 = function(f15_arg0)
				f14_arg0.ButtonOptionInternal:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_out"])
