...
CoD.SpecialistDecalEntry.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	noneText:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	UnderlineFocusGlow:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_6DAB59B2CAE01851"))
	...
	UnderlineFocus:setImage(RegisterImage(@"hash_33F29FF813507D9B"))
