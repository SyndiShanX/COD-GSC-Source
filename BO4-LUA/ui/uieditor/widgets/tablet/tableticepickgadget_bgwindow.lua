...
CoD.TabletIcePickGadget_BgWindow.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	BlurFrame:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	Box01:setAlpha(0.5)
	Box01:setImage(RegisterImage(0x185E11D74ECA3D7))
	Box01:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	Box02:setAlpha(0.5)
	Box02:setImage(RegisterImage(0x185E11D74ECA3D7))
	Box02:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
	...
	Box03:setAlpha(0.5)
	Box03:setImage(RegisterImage(0x185E11D74ECA3D7))
	Box03:setMaterial(LUI.UIImage.GetCachedMaterial(0xFD777557404A7B3))
