...
CoD.TabletIcePickHackDetectionBar.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	BG:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16CBE95C250C6D15"))
	BG:setShaderVector(0, 0, 0, 0, 0)
	BG:setupNineSliceShader(196, 88)
	self:addElement(BG)
	self.BG = BG
	local Glow = LUI.UIImage.new(0, 0, -114.5, 225.5, 0, 0, -60, 80)
	Glow:setImage(RegisterImage(@"hash_5F3052FD0F0098FB"))
	...
	Title:setText(LocalizeToUpperString(@"hash_759519CFCE1BB1DB"))
	...
	FillFrame:setImage(RegisterImage(@"hash_22AABF859E4BD498"))
	...
	FillFrame2:setImage(RegisterImage(@"hash_22AABF859E4BD498"))
	...
	Stripe:setImage(RegisterImage(@"hash_1A7E361974EC3A2E"))
	...
	EdgeRight:setImage(RegisterImage(@"hash_A8B500A007A9B7C"))
	EdgeRight:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	EdgeLeft:setImage(RegisterImage(@"hash_A8B500A007A9B7C"))
	EdgeLeft:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	Fill2:setAlpha(0.6)
	Fill2:setImage(RegisterImage(@"hash_583C3A03D42E5F7A"))
	...
	warning:setAlpha(0)
	warning:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_3DBDEBD27773724A"))
	warning:setTTF("0arame_mono_stencil")
	warning:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_3336C1AE82B1520A"))
	warning:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	warning:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
...
CoD.TabletIcePickHackDetectionBar.__resetProperties = function(f6_arg0)
	...
	f6_arg0.Title:setText(LocalizeToUpperString(@"hash_759519CFCE1BB1DB"))
...
CoD.TabletIcePickHackDetectionBar.__clipsPerState = {
	DefaultState = {
		...
		Detected = function(f14_arg0, f14_arg1)
			...
			local f14_local1 = function(f16_arg0)
				...
				f14_arg0.Title:setText(LocalizeToUpperString(@"hash_2BFBA1BAC637A9AD"))
			...
			f14_arg0.Title:setText(LocalizeToUpperString(@"hash_759519CFCE1BB1DB"))
	...
	Detected = {
		DefaultClip = function(f29_arg0, f29_arg1)
			...
			f29_arg0.Title:setText(LocalizeToUpperString(@"hash_2BFBA1BAC637A9AD"))
