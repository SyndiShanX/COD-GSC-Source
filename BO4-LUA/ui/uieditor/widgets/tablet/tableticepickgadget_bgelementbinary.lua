...
CoD.TabletIcePickGadget_BgElementBinary.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	binary05:setAlpha(0)
	binary05:setImage(RegisterImage(@"hash_2D5F0B06802219AA"))
	binary05:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	binary04:setAlpha(0)
	binary04:setImage(RegisterImage(@"hash_2D5F0C0680221B5D"))
	...
	binary03:setAlpha(0)
	binary03:setImage(RegisterImage(@"hash_2D5F050680220F78"))
	...
	binary02:setAlpha(0)
	binary02:setImage(RegisterImage(@"hash_2D5F06068022112B"))
	...
	binary01:setImage(RegisterImage(@"hash_2D5F080680221491"))
