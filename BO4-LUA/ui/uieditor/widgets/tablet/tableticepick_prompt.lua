...
CoD.TabletIcePick_Prompt.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Glow:setAlpha(0)
	Glow:setImage(RegisterImage(@"hash_5DD958EDC81E440B"))
	...
	selectText:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_28EA0BA3ED013CFD"))
	...
	selectText:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	...
	FillFrame:setImage(RegisterImage(@"hash_33F81A0BFADA5CDE"))
	...
	FillFrameAdd:setImage(RegisterImage(@"hash_33F81A0BFADA5CDE"))
	...
	GlowLarge:setImage(RegisterImage(@"hash_3C1B5BC57AE822F0"))
	GlowLarge:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	BotBar:setImage(RegisterImage(@"hash_71A39F2678E2F17"))
...
CoD.TabletIcePick_Prompt.__resetProperties = function(f10_arg0)
	...
	f10_arg0.selectText:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_28EA0BA3ED013CFD"))
	f10_arg0.selectText:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
...
CoD.TabletIcePick_Prompt.__clipsPerState = {
	...
	HackStarted = {
		DefaultClip = function(f88_arg0, f88_arg1)
			...
			f88_arg0.selectText:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_7B1B092FD4E6B362"))
			...
			local f88_local7 = function(f131_arg0)
				local f131_local0 = function(f132_arg0)
					...
					f132_arg0:beginAnimation(499, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f88_local8 = function(f135_arg0)
				local f135_local0 = function(f136_arg0)
					...
					f136_arg0:beginAnimation(499, Enum[@"luitween"][@"luitween_ease_out"])
	...
	HackStartedKBM = {
		DefaultClip = function(f140_arg0, f140_arg1)
			...
			f140_arg0.selectText:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_62A27E5351D6BEAD"))
			f140_arg0.selectText:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	...
	DefaultStateKBM = {
		DefaultClip = function(f145_arg0, f145_arg1)
			...
			f145_arg0.selectText:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_3ECC3695A4019BA6"))
			f145_arg0.selectText:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
