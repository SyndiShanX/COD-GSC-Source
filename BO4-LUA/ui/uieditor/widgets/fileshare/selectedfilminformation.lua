...
CoD.SelectedFilmInformation.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	AuthorName:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	AuthorName:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	CreateTime:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	CreateTime:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	MatchType:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	MatchType:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	SelectedFilmSummaryInformation:subscribeToGlobalModel(f1_arg1, "GlobalModel", "fileshareRoot.summaryDownloadTask.state", function(model)
		...
		if CoD.ModelUtility.IsGlobalModelValueEqualToEnum("fileshareRoot.summaryDownloadTask.state", Enum[0xE798E99E27D081E][0xFE5B3BE5B00EEEA]) and CoD.ModelUtility.IsGlobalModelValueTrue("fileshareRoot.summaryDownloadTask.success") then
	...
	GameModeTitle:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	GameModeTitle:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	DurationText:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
	DurationText:setAlignment(Enum[0x7A5123B654282D2][0x6ED4298C93DC5ED])
