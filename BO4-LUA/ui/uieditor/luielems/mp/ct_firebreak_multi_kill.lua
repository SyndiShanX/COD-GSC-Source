...
LUI.createMenu.ct_firebreak_multi_kill = function(f1_arg0, f1_arg1)
	...
	TextBox:setText(Engine[0xF9F1239CFD921FE](0x43A5A1C6EED9669))
...
CoD.ct_firebreak_multi_kill.__resetProperties = function(f2_arg0)
	...
	f2_arg0.TextBox:setText(Engine[0xF9F1239CFD921FE](0x43A5A1C6EED9669))
end
CoD.ct_firebreak_multi_kill.__clipsPerState = {
	DefaultState = {
		DefaultClip = function(f3_arg0, f3_arg1)
			...
			f3_arg0.TextBox:setText(Engine[0xF9F1239CFD921FE](0x43A5A1C6EED9669))
