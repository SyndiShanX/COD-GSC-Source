...
LUI.createMenu.ct_shared_ingame_hint = function(f1_arg0, f1_arg1)
	...
	InGameHint:setAlignment(Enum[0x7A5123B654282D2][0x6ED4298C93DC5ED])
	...
	fakePrompt:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	fakePrompt:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
