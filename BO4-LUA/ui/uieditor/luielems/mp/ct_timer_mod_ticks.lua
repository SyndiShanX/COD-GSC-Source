...
LUI.createMenu.ct_timer_mod_ticks = function(f1_arg0, f1_arg1)
	...
	modTimeBonus:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	modTimeBonus:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	modTimeBonus:linkToElementModel(self, "timeMod", true, function(model)
		local f2_local0 = model:get()
		if f2_local0 ~= nil then
			modTimeBonus:setText(Engine[@"hash_4F9F1239CFD921FE"](CoD.CTUtility.LocalizeTimeBonus(@"hash_69F904FB34DE1ADD", f2_local0)))
		end
	end)
	...
	TimeBonusDogKill:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	TimeBonusDogKill:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	TimeBonusDogKill:linkToElementModel(self, "timeMod", true, function(model)
		local f3_local0 = model:get()
		if f3_local0 ~= nil then
			TimeBonusDogKill:setText(Engine[@"hash_4F9F1239CFD921FE"](CoD.CTUtility.LocalizeTimeBonus(@"hash_792D3042676927B4", f3_local0)))
		end
	end)
	...
	TimeBonusDestroyedObj:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	TimeBonusDestroyedObj:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	TimeBonusDestroyedObj:linkToElementModel(self, "timeMod", true, function(model)
		local f4_local0 = model:get()
		if f4_local0 ~= nil then
			TimeBonusDestroyedObj:setText(Engine[@"hash_4F9F1239CFD921FE"](CoD.CTUtility.LocalizeTimeBonus(@"hash_799407BFA9F9AA1E", f4_local0)))
		end
	end)
	...
	TimeBonusKilledWarlord:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	TimeBonusKilledWarlord:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	TimeBonusKilledWarlord:linkToElementModel(self, "timeMod", true, function(model)
		local f5_local0 = model:get()
		if f5_local0 ~= nil then
			TimeBonusKilledWarlord:setText(Engine[@"hash_4F9F1239CFD921FE"](CoD.CTUtility.LocalizeTimeBonus(@"hash_279BCB8C86A7AA44", f5_local0)))
		end
	end)
	...
	TimeBonusMultiKill:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	TimeBonusMultiKill:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	TimeBonusMultiKill:linkToElementModel(self, "timeMod", true, function(model)
		local f6_local0 = model:get()
		if f6_local0 ~= nil then
			TimeBonusMultiKill:setText(Engine[@"hash_4F9F1239CFD921FE"](CoD.CTUtility.LocalizeTimeBonus(@"hash_6B5D76F3013A39BF", f6_local0)))
		end
	end)
	...
	modTimePenalty:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	modTimePenalty:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	modTimePenalty:linkToElementModel(self, "timeMod", true, function(model)
		local f7_local0 = model:get()
		if f7_local0 ~= nil then
			modTimePenalty:setText(Engine[@"hash_4F9F1239CFD921FE"](CoD.CTUtility.LocalizeTimeBonus(@"hash_2BB69798EC9E5475", f7_local0)))
		end
	end)
			...
			local f13_local0 = function(f14_arg0)
				local f14_local0 = function(f15_arg0)
					local f15_local0 = function(f16_arg0)
						f16_arg0:beginAnimation(500, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_out"])
