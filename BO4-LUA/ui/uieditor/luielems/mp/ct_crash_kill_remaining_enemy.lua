...
LUI.createMenu.ct_crash_kill_remaining_enemy = function(f1_arg0, f1_arg1)
	...
	TextBox:setText(Engine[0xF9F1239CFD921FE](0x7F341B796C609B))
...
CoD.ct_crash_kill_remaining_enemy.__resetProperties = function(f2_arg0)
	...
	f2_arg0.TextBox:setText(Engine[0xF9F1239CFD921FE](0x7F341B796C609B))
end
CoD.ct_crash_kill_remaining_enemy.__clipsPerState = {
	DefaultState = {
		DefaultClip = function(f3_arg0, f3_arg1)
			...
			f3_arg0.TextBox:setText(Engine[0xF9F1239CFD921FE](0x7F341B796C609B))
