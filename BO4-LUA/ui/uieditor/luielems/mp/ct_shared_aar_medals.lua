...
LUI.createMenu.ct_shared_aar_medals = function(f1_arg0, f1_arg1)
	...
	thresholdGold:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_2AE166D9BA8C6907"))
	...
	thresholdGold:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	thresholdGold:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	thresholdGold:linkToElementModel(self, "medalGoldThreshold", true, function(model)
		local f2_local0 = model:get()
		if f2_local0 ~= nil then
			thresholdGold:setText(Engine[@"hash_4F9F1239CFD921FE"](f2_local0))
		end
	end)
	...
	thresholdSilver:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_2AE166D9BA8C6907"))
	...
	thresholdSilver:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	thresholdSilver:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	thresholdSilver:linkToElementModel(self, "medalSilverThreshold", true, function(model)
		local f3_local0 = model:get()
		if f3_local0 ~= nil then
			thresholdSilver:setText(Engine[@"hash_4F9F1239CFD921FE"](f3_local0))
		end
	end)
	...
	thresholdBronze:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_2AE166D9BA8C6907"))
	...
	thresholdBronze:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	thresholdBronze:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	thresholdBronze:linkToElementModel(self, "medalBronzeThreshold", true, function(model)
		local f4_local0 = model:get()
		if f4_local0 ~= nil then
			thresholdBronze:setText(Engine[@"hash_4F9F1239CFD921FE"](f4_local0))
		end
	end)
...
CoD.ct_shared_aar_medals.__resetProperties = function(f5_arg0)
	...
	f5_arg0.thresholdGold:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_2AE166D9BA8C6907"))
	...
	f5_arg0.thresholdGold:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	...
	f5_arg0.thresholdSilver:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_2AE166D9BA8C6907"))
	...
	f5_arg0.thresholdBronze:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_2AE166D9BA8C6907"))
...
CoD.ct_shared_aar_medals.__clipsPerState = {
	DefaultState = {
		DefaultClip = function(f6_arg0, f6_arg1)
			...
			f6_arg0.thresholdGold:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
		...
		DefaultClip = function(f7_arg0, f7_arg1)
			...
			local f7_local0 = function(f8_arg0)
				local f8_local0 = function(f9_arg0)
					f9_arg0:beginAnimation(500, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
					f9_arg0:setAlpha(1)
			...
			f7_arg0.thresholdGold:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_2AE166D9BA8C6907"))
			...
			f7_arg0.thresholdBronze:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_2AE166D9BA8C6907"))
	...
	medal_silver = {
		DefaultClip = function(f12_arg0, f12_arg1)
			...
			local f12_local1 = function(f14_arg0)
				...
				f12_arg0.thresholdSilver:beginAnimation(500, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
			...
			f12_arg0.thresholdSilver:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_2AE166D9BA8C6907"))
	...
	medal_none = {
		DefaultClip = function(f21_arg0, f21_arg1)
			...
			f21_arg0.thresholdBronze:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_2AE166D9BA8C6907"))
