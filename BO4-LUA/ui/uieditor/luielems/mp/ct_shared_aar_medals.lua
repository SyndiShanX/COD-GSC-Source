...
LUI.createMenu.ct_shared_aar_medals = function(f1_arg0, f1_arg1)
	...
	thresholdGold:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
	thresholdGold:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	thresholdSilver:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
	thresholdSilver:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	thresholdBronze:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
	thresholdBronze:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
...
CoD.ct_shared_aar_medals.__resetProperties = function(f5_arg0)
	...
	f5_arg0.thresholdGold:setRFTMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
	f5_arg0.thresholdGold:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
	f5_arg0.thresholdGold:setBackingMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
	f5_arg0.thresholdGold:setBackingMaterial(LUI.UIImage.GetCachedMaterial(0x44484DDFAF5C093))
	...
	f5_arg0.thresholdSilver:setRFTMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
	f5_arg0.thresholdSilver:setBackingMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
	f5_arg0.thresholdSilver:setBackingMaterial(LUI.UIImage.GetCachedMaterial(0x44484DDFAF5C093))
	...
	f5_arg0.thresholdBronze:setRFTMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
	f5_arg0.thresholdBronze:setBackingMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
	f5_arg0.thresholdBronze:setBackingMaterial(LUI.UIImage.GetCachedMaterial(0x44484DDFAF5C093))
end
CoD.ct_shared_aar_medals.__clipsPerState = {
	DefaultState = {
		DefaultClip = function(f6_arg0, f6_arg1)
			...
			f6_arg0.thresholdGold:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
	...
	medal_gold = {
		DefaultClip = function(f7_arg0, f7_arg1)
			...
			f7_arg0.thresholdGold:setRFTMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
			f7_arg0.thresholdGold:setBackingMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
			f7_arg0.thresholdGold:setBackingMaterial(LUI.UIImage.GetCachedMaterial(0x44484DDFAF5C093))
			...
			f7_arg0.thresholdBronze:setRFTMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
			f7_arg0.thresholdBronze:setBackingMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
			f7_arg0.thresholdBronze:setBackingMaterial(LUI.UIImage.GetCachedMaterial(0x44484DDFAF5C093))
	...
	medal_silver = {
		DefaultClip = function(f12_arg0, f12_arg1)
			...
			f12_arg0.thresholdSilver:setRFTMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
			f12_arg0.thresholdSilver:setBackingMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
			f12_arg0.thresholdSilver:setBackingMaterial(LUI.UIImage.GetCachedMaterial(0x44484DDFAF5C093))
	...
	medal_none = {
		DefaultClip = function(f21_arg0, f21_arg1)
			...
			f21_arg0.thresholdBronze:setRFTMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
			f21_arg0.thresholdBronze:setBackingMaterial(LUI.UIImage.GetCachedMaterial(0x6B34AA3F39208EF))
			f21_arg0.thresholdBronze:setBackingMaterial(LUI.UIImage.GetCachedMaterial(0x44484DDFAF5C093))
