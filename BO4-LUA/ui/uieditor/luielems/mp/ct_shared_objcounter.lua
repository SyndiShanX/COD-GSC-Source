...
LUI.createMenu.ct_shared_objcounter = function(f1_arg0, f1_arg1)
	...
	separator:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_5A1DD8EB81BD3558"))
	separator:setTTF("ttmussels_regular")
	separator:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	separator:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	label:linkToElementModel(self, "objectiveLabel", true, function(model)
		...
		if f4_local0 ~= nil then
			label:setText(Engine[@"hash_4F9F1239CFD921FE"](f4_local0))
		end
	end)
...
CoD.ct_shared_objcounter.__resetProperties = function(f5_arg0)
	...
	f5_arg0.separator:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_5A1DD8EB81BD3558"))
...
CoD.ct_shared_objcounter.__clipsPerState = {
	...
	nototal = {
		DefaultClip = function(f7_arg0, f7_arg1)
			...
			f7_arg0.separator:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_64E027043D62D489"))
	...
	nototal_update = {
		DefaultClip = function(f8_arg0, f8_arg1)
			...
			f8_arg0.separator:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_64E027043D62D489"))
	...
	nototal_init = {
		DefaultClip = function(f15_arg0, f15_arg1)
			...
			f15_arg0.separator:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_64E027043D62D489"))
