...
LUI.createMenu.prototype_hud = function(f1_arg0, f1_arg1)
	...
	ObjectiveString:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	ObjectiveString:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	DefenseResourceCount:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	DefenseResourceCount:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	UpgradeResourceCount:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	UpgradeResourceCount:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	FanfareText:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	FanfareText:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	FanfareText2:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	FanfareText2:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	local f1_local30 = Engine[0x4DF5CFBC1771947](f1_arg0)
	...
	f1_local30 = Engine[0x4DF5CFBC1771947](f1_arg0)
	f1_local29(f1_local28, f1_local30["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0xF4EDA8B636F3F04]], function(f47_arg0)
		f1_local1:updateElementState(self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
