...
LUI.createMenu.insertion_passenger_count = function(f1_arg0, f1_arg1)
	...
	ExitPrompt:setText(Engine[@"hash_4F9F1239CFD921FE"](@"wz/infiltration_drop"))
	ExitPrompt:setTTF("ttmussels_regular")
	ExitPrompt:setLetterSpacing(3)
	ExitPrompt:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	ExitPrompt:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	ExitPrompt:setBackingMaterial(LUI.UIImage.GetCachedMaterial(@"hash_E2354BE557C4C7A"))
