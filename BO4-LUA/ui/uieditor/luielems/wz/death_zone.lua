...
LUI.createMenu.death_zone = function(f1_arg0, f1_arg1)
	...
	shutdownwarningshadow:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_1110B2D72E1F5652"))
	shutdownwarningshadow:setTTF("default")
	shutdownwarningshadow:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	shutdownwarningshadow:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	shutdownwarning:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_1110B2D72E1F5652"))
	shutdownwarning:setTTF("default")
	shutdownwarning:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	shutdownwarning:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	offlineshadow:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_D40CA530BF6A6E9"))
	offlineshadow:setTTF("default")
	offlineshadow:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	offlineshadow:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	self:addElement(offlineshadow)
	self.offlineshadow = offlineshadow
	local offline = LUI.UIText.new(0, 0, 651, 1269, 0, 0, 290.5, 370.5)
	offline:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_D40CA530BF6A6E9"))
	offline:setTTF("default")
	offline:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	offline:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
...
CoD.death_zone.__onClose = function(f7_arg0) end
