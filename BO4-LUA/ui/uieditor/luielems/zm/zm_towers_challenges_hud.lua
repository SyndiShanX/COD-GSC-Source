...
LUI.createMenu.zm_towers_challenges_hud = function(f1_arg0, f1_arg1)
	...
	ChallengeText:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_171E049B161CD00A"))
	ChallengeText:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	ChallengeText:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	ChallengeText:linkToElementModel(self, "challenge_text", true, function(model)
		local f2_local0 = model:get()
		if f2_local0 ~= nil then
			ChallengeText:setText(Engine[@"hash_4F9F1239CFD921FE"](f2_local0))
		end
	end)
	...
	ChallengeProgress:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_171E049B161CD00A"))
	ChallengeProgress:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	ChallengeProgress:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TextOf:setAlpha(0)
	TextOf:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_61FEEEE687293F9F"))
	TextOf:setTTF("skorzhen")
	TextOf:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_171E049B161CD00A"))
	TextOf:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	TextOf:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	RequiredProgress:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	RequiredProgress:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
