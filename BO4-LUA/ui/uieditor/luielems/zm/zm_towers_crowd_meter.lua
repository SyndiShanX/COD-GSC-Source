require("x64:eb06740528bdc87")
require("x64:857f6c026e9ea99")
...
LUI.createMenu.zm_towers_crowd_meter = function(f1_arg0, f1_arg1)
	...
	smokewidget:setRFTMaterial(LUI.UIImage.GetCachedMaterial(0x4E6CE42E0799F57))
	...
	smokewidget2:setRFTMaterial(LUI.UIImage.GetCachedMaterial(0x4E6CE42E0799F57))
	...
	Image00:setMaterial(LUI.UIImage.GetCachedMaterial(0x9227A50BA2B8D21))
	...
	ZmAmmoParticleFX3right:setRFTMaterial(LUI.UIImage.GetCachedMaterial(0x4E6CE42E0799F57))
	...
	CrowdItem:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	CrowdItem:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	CrowdTitle:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	CrowdTitle:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	self:subscribeToGlobalModel(f1_arg0, "GlobalModel", nil, function(model)
		...
		CoD.ZMInventoryUtility.SetupHideIfVisBit(self, f1_arg0, Enum[0x7F032C2EF103A1A][0xF4EDA8B636F3F04])
	end)
