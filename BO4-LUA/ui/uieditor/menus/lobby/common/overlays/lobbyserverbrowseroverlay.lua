...
LUI.createMenu.LobbyServerBrowserOverlay = function(f1_arg0, f1_arg1)
	...
	HostNameText:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	HostNameText:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	PlayerCountText:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	PlayerCountText:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	GameMode:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	GameMode:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	StatusTextBox:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	StatusTextBox:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	DetailsTextBox:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	DetailsTextBox:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	f1_local1:AddButtonCallbackFunction(self, f1_arg0, Enum[0x3DD78803F918E9D][0xE6DB407A2AF8B09], nil, function(element, menu, controller, model)
		...
		CoD.Menu.SetButtonLabel(menu, Enum[0x3DD78803F918E9D][0xE6DB407A2AF8B09], 0x864802EE42E1E92, nil, nil)
		return true
	end, false)
