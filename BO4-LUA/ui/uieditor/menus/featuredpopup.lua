...
LUI.createMenu.FeaturedPopup = function(f1_arg0, f1_arg1)
	...
	DividerSolidTop:setImage(RegisterImage(@"hash_484B43D5B04D263A"))
	DividerSolidTop:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16CBE95C250C6D15"))
	...
	MOTDFeaturedButtonContainerPC.backButtonPC.featureOverlayButtonContainer.Title:setText(LocalizeToUpperString(@"hash_778D439E1B360368"))
	...
	f1_local1:AddButtonCallbackFunction(self, f1_arg0, Enum[@"luibutton"][@"lui_key_xbx_pssquare"], nil, function(element, menu, controller, model)
		...
		if not CoD.ModelUtility.IsSelfModelPathNil(element, controller, "popupActionString") and not CoD.ModelUtility.IsSelfModelValueNil(element, controller, "popupActionString") then
			CoD.Menu.SetButtonLabel(menu, Enum[@"luibutton"][@"lui_key_xbx_pssquare"], @"menu/select", nil, nil)
			return true
		else
			return false
		end
