...
LUI.createMenu.CodCasterQuickSettingsSideBar = function(f2_arg0, f2_arg1)
	...
	f2_local1:AddButtonCallbackFunction(ButtonList, f2_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"], nil, function(element, menu, controller, model)
	...
	Title:setText(LocalizeToUpperString(@"hash_24EA93CFFE505B27"))
	...
	backButton.ButtonContainer.Title:setText(Engine[@"hash_4F9F1239CFD921FE"](@"menu/back"))
	...
	f2_local1:AddButtonCallbackFunction(backButton, f2_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"], "MOUSE1", function(element, menu, controller, model)
	...
	f2_local1:AddButtonCallbackFunction(resetButton, f2_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"], "MOUSE1", function(element, menu, controller, model)
	...
	self:mergeStateConditions({
		{
			...
			condition = function(menu, element, event)
				return Engine[@"isvisibilitybitset"](f2_arg0, Enum[@"uivisibilitybit"][@"bit_game_ended"])
			end,
		},
		{
			stateName = "PCGamepad",
	...
	f2_local17(f2_local16, f2_local18["UIVisibilityBit." .. Enum[@"uivisibilitybit"][@"bit_game_ended"]], function(f15_arg0)
	...
	self:appendEventHandler("input_source_changed", function(f18_arg0, f18_arg1)
		...
		CoD.Menu.UpdateButtonShownState(f18_arg0, f2_local1, f2_arg0, Enum[@"luibutton"][@"lui_key_xbx_pssquare"])
	end)
	f2_local16 = self
	f2_local17 = self.subscribeToModel
	f2_local18 = Engine[@"getmodelforcontroller"](f2_arg0)
	f2_local17(f2_local16, f2_local18.LastInput, function(f19_arg0, f19_arg1)
		CoD.Menu.UpdateButtonShownState(f19_arg1, f2_local1, f2_arg0, Enum[@"luibutton"][@"lui_key_xbx_pssquare"])
	end, false)
	f2_local1:AddButtonCallbackFunction(self, f2_arg0, Enum[@"luibutton"][@"lui_key_ltrig"], "R", function(element, menu, controller, model)
		...
		if not IsRepeatButtonPress(nil) then
			CoD.Menu.SetButtonLabel(menu, Enum[@"luibutton"][@"lui_key_ltrig"], @"menu/back", nil, "R")
			return true
		else
			return false
		end
	end, false)
	f2_local1:AddButtonCallbackFunction(self, f2_arg0, Enum[@"luibutton"][@"lui_key_xbx_pssquare"], "ui_contextual_2", function(element, menu, controller, model)
...
CoD.CodCasterQuickSettingsSideBar.__resetProperties = function(f25_arg0)
	...
	f25_arg0.backButton.ButtonContainer.Title:setText(Engine[@"hash_4F9F1239CFD921FE"](@"menu/back"))
	f25_arg0.resetButton:setAlpha(1)
	f25_arg0.resetButton.ButtonContainer.Title:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_5FA987631536BD44"))
...
CoD.CodCasterQuickSettingsSideBar.__clipsPerState = {
	DefaultState = {
		DefaultClip = function(f26_arg0, f26_arg1)
			...
			f26_arg0.backButton.ButtonContainer.Title:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_5FA987631536BD44"))
	...
	PC = {
		DefaultClip = function(f29_arg0, f29_arg1)
			...
			f29_arg0.backButton.ButtonContainer.Title:setText(Engine[@"hash_4F9F1239CFD921FE"](@"menu/back"))
			...
			f29_arg0.resetButton.ButtonContainer.Title:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_5FA987631536BD44"))
