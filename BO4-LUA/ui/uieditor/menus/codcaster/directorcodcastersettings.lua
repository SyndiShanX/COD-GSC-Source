...
LUI.createMenu.DirectorCodCasterSettings = function(f1_arg0, f1_arg1)
	...
	MenuFrame:subscribeToGlobalModel(f1_arg0, "LobbyRoot", "lobbyTitle", function(model)
		...
		if f3_local0 ~= nil then
			MenuFrame.CommonHeader.subtitle.subtitle:setText(Engine[@"hash_4F9F1239CFD921FE"](f3_local0))
		end
	end)
	...
	self:appendEventHandler("input_source_changed", function(f6_arg0, f6_arg1)
		...
		CoD.Menu.UpdateButtonShownState(f6_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rtrig"])
	end)
	...
	f1_local9(f1_local8, f1_local10.LastInput, function(f7_arg0, f7_arg1)
		...
		CoD.Menu.UpdateButtonShownState(f7_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rtrig"])
	end, false)
	...
	f1_local1:AddButtonCallbackFunction(self, f1_arg0, Enum[@"luibutton"][@"lui_key_xby_pstriangle"], "Z", function(element, menu, controller, model)
		...
		if CoD.CodCasterUtility.CodcasterTeamIdentityShowingTeamSetting(controller, self.CatgeoryTabs) and CoD.CodCasterUtility.UseCustomTeamIdentity(controller) then
			CoD.Menu.SetButtonLabel(menu, Enum[@"luibutton"][@"lui_key_xby_pstriangle"], @"hash_7DD938AAB1C2D899", Enum[@"luibuttonpromptflags"][@"hash_72919C98A7A845F0"] | 400 << Enum[@"luibuttonpromptflags"][@"hash_176ADD225D738C93"], "Z")
			return true
		else
			return false
		end
