...
LUI.createMenu.DeleteFileshareFile = function(f1_arg0, f1_arg1)
	...
	GenericMenuFrame0.CommonHeader.subtitle.StageTitle:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_38242B5D10AB6D48"))
	GenericMenuFrame0:subscribeToGlobalModel(f1_arg0, "LobbyRoot", "lobbyTitle", function(model)
		local f3_local0 = model:get()
		if f3_local0 ~= nil then
			GenericMenuFrame0.CommonHeader.subtitle.subtitle:setText(Engine[@"hash_4F9F1239CFD921FE"](f3_local0))
		end
	end)
