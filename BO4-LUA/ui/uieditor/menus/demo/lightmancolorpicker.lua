...
LUI.createMenu.LightmanColorPicker = function(f2_arg0, f2_arg1)
	...
	BGTint:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	InnerFrameTL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	InnerFrameTR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	InnerFrameBR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	InnerFrameBR2:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	OutterFrameTL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	OutterFrameTL2:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	OutterFrameTL3:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	OutterFrameTR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	ColorPicker:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	...
	ColorPicker:registerEventHandler("gain_focus", function(element, event)
		...
		CoD.Menu.UpdateButtonShownState(element, f2_local1, f2_arg0, Enum[@"luibutton"][@"lui_key_start"])
		return f4_local0
	end)
	f2_local1:AddButtonCallbackFunction(ColorPicker, f2_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"], nil, function(element, menu, controller, model)
	...
	f2_local1:AddButtonCallbackFunction(ColorPicker, f2_arg0, Enum[@"luibutton"][@"lui_key_start"], nil, function(element, menu, controller, model)
		CoD.DemoUtility.SelectLightmanColor(self, element, controller, menu)
		GoBack(self, controller)
		SetGlobalModelValueFalse("demo.showLightmanColorPicker")
		return true
