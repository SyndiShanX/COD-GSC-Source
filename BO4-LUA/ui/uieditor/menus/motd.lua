...
LUI.createMenu.MOTD = function(f1_arg0, f1_arg1)
	...
	TiledBacking2:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	ButtonsList:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	...
	DividerSolid:setImage(RegisterImage(@"hash_484B43D5B04D263A"))
	DividerSolid:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16CBE95C250C6D15"))
