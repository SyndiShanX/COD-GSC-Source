...
LUI.createMenu.WZPurchaseCamo = function(f1_arg0, f1_arg1)
	...
	FullscreenPopupTemplate.Subtitle:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_447FEC1C323B4F6B"))
	FullscreenPopupTemplate.ErrorSubtitle:setText("")
	FullscreenPopupTemplate.WorkingTitle:setText("")
	FullscreenPopupTemplate.Title:setText(LocalizeToUpperString(@"hash_1C6D71184390ADDC"))
	...
	if IsPC() then
		CoD.PCUtility.LinkPCSmallCloseButtonToInput(f1_local1, f1_arg0, f1_local19, Enum[@"luibutton"][@"lui_key_xbb_pscircle"])
	end
	return self
end
