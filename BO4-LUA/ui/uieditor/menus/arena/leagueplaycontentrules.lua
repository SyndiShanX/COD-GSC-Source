...
LUI.createMenu.LeaguePlayContentRules = function(f1_arg0, f1_arg1)
	...
	ModificationsRules:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	ModificationsRules:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	ModificationsDescription:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	ModificationsDescription:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	Modifications:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	Modifications:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	RestrictionsDescription:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	RestrictionsDescription:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	RestrictionRules:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	RestrictionRules:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	Restrictions:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	Restrictions:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	ScreenSubTitle:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	ScreenSubTitle:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	ScreenTitle:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	ScreenTitle:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	f1_local1:AddButtonCallbackFunction(self, f1_arg0, Enum[0x3DD78803F918E9D][0x805EFA15E9E7E5A], "ESCAPE", function(element, menu, controller, model)
		...
		if IsPC() then
			...
			CoD.Menu.SetButtonLabel(menu, Enum[0x3DD78803F918E9D][0x805EFA15E9E7E5A], 0x3996BAAC73C3F6D, nil, "ESCAPE")
			return true
		end
	end, false)
