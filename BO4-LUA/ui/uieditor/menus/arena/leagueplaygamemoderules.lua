...
LUI.createMenu.LeaguePlayGameModeRules = function(f1_arg0, f1_arg1)
	...
	ControlRules:setText(Engine[@"hash_4F9F1239CFD921FE"](0x823B0CB3D9ABF2))
	ControlRules:setTTF("dinnext_regular")
	ControlRules:setLetterSpacing(1)
	ControlRules:setLineSpacing(2)
	ControlRules:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	ControlRules:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	ControlTitle:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_EC3279692A4D03E"))
	ControlTitle:setTTF("default")
	ControlTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	ControlTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	HardpointRules:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_2C70A8C6C93F10AE"))
	HardpointRules:setTTF("dinnext_regular")
	HardpointRules:setLetterSpacing(1)
	HardpointRules:setLineSpacing(2)
	HardpointRules:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	HardpointRules:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	HardpointTitle:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_674D6D89F097A672"))
	HardpointTitle:setTTF("default")
	HardpointTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	HardpointTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	SearchAndDestroyRules:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_79AAA52DB0FC4E90"))
	...
	SearchAndDestroyRules:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	SearchAndDestroyRules:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	SearchAndDestroyTitle:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_21F403C48EF7B8B4"))
	SearchAndDestroyTitle:setTTF("default")
	SearchAndDestroyTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	SearchAndDestroyTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	ScreenSubTitle:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_7DCA39A7569B2F75"))
	...
	ScreenTitle:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_586B7DE6FDD7CEB8"))
	...
	DividerLine2:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	DividerLine1:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
