...
local PostLoadFunc = function(self, controller, menu)
	...
	if CoD.isDurango then
		self.XboxGamerTag:setText(Engine[@"hash_4F9F1239CFD921FE"]("xboxlive/signedinas", Engine.GetGamertagForController(0)))
	else
...
LUI.createMenu.FirstTimeBrightnessSetting = function(f3_arg0, f3_arg1)
	...
	DescText:setZoom(40)
	DescText:setText(Engine[@"hash_4F9F1239CFD921FE"]("menu/adjust_brightness_firsttime"))
	...
	f3_local1:AddButtonCallbackFunction(self, f3_arg0, Enum.LUIButton[@"lui_key_xbb_pscircle"], nil, function(f8_arg0, f8_arg1, f8_arg2, f8_arg3)
		GoBack(self, f8_arg2)
		ClearMenuSavedState(f8_arg1)
		return true
	end, function(f9_arg0, f9_arg1, f9_arg2)
		CoD.Menu.SetButtonLabel(f9_arg1, Enum.LUIButton[@"lui_key_xbb_pscircle"], 0x0, nil, nil)
		return false
	end, false)
	f3_local1:AddButtonCallbackFunction(self, f3_arg0, Enum.LUIButton[@"lui_key_xbx_pssquare"], nil, function(f10_arg0, f10_arg1, f10_arg2, f10_arg3)
		CoD.OptionsUtility.ResetPlayerSettingToDefault(self.Button, f10_arg2)
		return true
	end, function(f11_arg0, f11_arg1, f11_arg2)
		CoD.Menu.SetButtonLabel(f11_arg1, Enum.LUIButton[@"lui_key_xbx_pssquare"], "menu/default", nil, nil)
		return true
	end, false)
	f3_local1:AddButtonCallbackFunction(self, f3_arg0, Enum.LUIButton[@"lui_key_xba_pscross"], nil, function(f12_arg0, f12_arg1, f12_arg2, f12_arg3)
		ClearMenuSavedState(f12_arg1)
		CoD.LobbyUtility.CompleteFirstTimeBrightness(f12_arg1, f12_arg2)
		return true
	end, function(f13_arg0, f13_arg1, f13_arg2)
		CoD.Menu.SetButtonLabel(f13_arg1, Enum.LUIButton[@"lui_key_xba_pscross"], @"menu/confirm", nil, nil)
		return true
	end, false)
