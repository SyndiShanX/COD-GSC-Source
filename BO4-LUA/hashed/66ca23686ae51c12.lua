...
CoD.ButtonFrame_MaxLevelNotify.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	MaxLevel:setText(Engine[0xF9F1239CFD921FE](0x3266CB6BCE7419E))
	MaxLevel:setTTF("ttmussels_demibold")
	MaxLevel:setMaterial(LUI.UIImage.GetCachedMaterial(0x90D57B1E92D39D7))
	...
	MaxLevel:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	...
	PrestigeAvailable:setText(Engine[0xF9F1239CFD921FE](0xAAAEEE2695C5F4))
	PrestigeAvailable:setTTF("ttmussels_demibold")
	PrestigeAvailable:setMaterial(LUI.UIImage.GetCachedMaterial(0x90D57B1E92D39D7))
	...
	PrestigeAvailable:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
