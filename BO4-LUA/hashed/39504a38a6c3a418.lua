...
CoD.ItemShopGlowRaysAnim.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	GlowRaysAnim1:setImage(RegisterImage(@"hash_111109A79AAD3403"))
	GlowRaysAnim1:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	GlowRaysAnim2:setImage(RegisterImage(@"hash_11110AA79AAD35B6"))
	GlowRaysAnim2:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	GlowRaysAnim3:setImage(RegisterImage(@"hash_11110BA79AAD3769"))
	GlowRaysAnim3:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	GlowRaysAnim4:setImage(RegisterImage(@"hash_111109A79AAD3403"))
	GlowRaysAnim4:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
