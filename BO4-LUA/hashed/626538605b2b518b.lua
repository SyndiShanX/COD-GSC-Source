...
CoD.zm_hud_gameover_smokebackground.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	SmokeStandard2:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	SmokeHorizontalLG:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	SmokeHorizontalSM:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
