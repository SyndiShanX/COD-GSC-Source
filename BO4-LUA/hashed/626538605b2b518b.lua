...
CoD.zm_hud_gameover_smokebackground.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	SmokeRotate:setImage(RegisterImage(0x5471A9F31D0980B))
	SmokeRotate:setMaterial(LUI.UIImage.GetCachedMaterial(0x98A2728B4675FB5))
	...
	SmokeTwist:setImage(RegisterImage(0x5471A9F31D0980B))
	SmokeTwist:setMaterial(LUI.UIImage.GetCachedMaterial(0x8088DD962BCED66))
	...
	SmokeStandard:setImage(RegisterImage(0x5471A9F31D0980B))
	SmokeStandard:setMaterial(LUI.UIImage.GetCachedMaterial(0x98A2728B4675FB5))
	...
	SmokeStandard2:setImage(RegisterImage(0x5471A9F31D0980B))
	...
	SmokeHorizontalLG:setImage(RegisterImage(0xF034C487614E57C))
	...
	SmokeHorizontalSM:setImage(RegisterImage(0xF034C487614E57C))
