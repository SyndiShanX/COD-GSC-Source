...
CoD.Footer_IGRPerksList.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	IGRPerk4.PerkText:setText(Engine[0xF9F1239CFD921FE](0x7610559D290D868))
	...
	IGRPerk.PerkLogo:setImage(RegisterImage(0xC1460CF69AB482B))
	IGRPerk.PerkText:setText(CoD.PCKoreaUtility.InjectBonusCredits(0x327C56902BCB8A5))
	self:addElement(IGRPerk)
	self.IGRPerk = IGRPerk
	local IGRPerk3 = CoD.IGRPerkElement.new(f1_arg0, f1_arg1, 0, 0, 0, 350, 0, 0, 124, 188)
	IGRPerk3.PerkLogo:setImage(RegisterImage(0xCFD527F0E4A01CE))
	IGRPerk3.PerkText:setText(CoD.PCKoreaUtility.InjectBonusXP(0xD38DFFC56710A2B))
	...
	IGRPerk2.PerkLogo:setImage(RegisterImage(0x8FBBCE5058992F3))
	IGRPerk2.PerkText:setText(CoD.PCKoreaUtility.InjectBonusGunXP(0x936FCC81C9EE8D0))
	...
	IGRPerk6.PerkLogo:setImage(RegisterImage(0x3C39A58A11F906E))
	IGRPerk6.PerkText:setText(CoD.PCKoreaUtility.InjectBonusMerits(0x3B9E184FC8CDACD))
	...
	IGRPerk5.PerkLogo:setImage(RegisterImage(0xF762F7D1E478A24))
	IGRPerk5.PerkText:setText(Engine[0xF9F1239CFD921FE](0x2998B6D9C673F0E))
