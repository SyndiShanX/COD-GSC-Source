	...
	NotAvailable = {
		...
		GainChildFocus = function(f38_arg0, f38_arg1)
			...
			local f38_local0 = function(f39_arg0)
				f38_arg0.internal:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_in"])
		...
		LoseChildFocus = function(f40_arg0, f40_arg1)
			...
			local f40_local0 = function(f41_arg0)
				f40_arg0.internal:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_in"])
