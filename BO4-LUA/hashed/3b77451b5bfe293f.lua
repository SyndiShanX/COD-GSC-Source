...
CoD.Tcm_Rule_Entry.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	RuleTextShadow:setMaterial(LUI.UIImage.GetCachedMaterial(0xAE166D9BA8C6907))
	...
	RuleTextShadow:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	RuleTextShadow:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	RuleTextShadow:linkToElementModel(self, "text", true, function(model)
		local f2_local0 = model:get()
		if f2_local0 ~= nil then
			RuleTextShadow:setText(Engine[0xF9F1239CFD921FE](f2_local0))
		end
	end)
	...
	RuleText:setMaterial(LUI.UIImage.GetCachedMaterial(0xAE166D9BA8C6907))
	RuleText:setShaderVector(0, 0, 0, 0, 0)
	RuleText:setShaderVector(1, 0, 0, 0, 0)
	RuleText:setShaderVector(2, 1, 0, 0, 0)
	RuleText:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	RuleText:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	RuleText:linkToElementModel(self, "text", true, function(model)
		local f3_local0 = model:get()
		if f3_local0 ~= nil then
			RuleText:setText(Engine[0xF9F1239CFD921FE](f3_local0))
		end
	end)
