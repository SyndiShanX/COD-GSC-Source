...
CoD.ItemShopRarityBackgroundStream_Rare.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	RadialGlow:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_1A02C44161370F6D"))
	...
	BottomGradient:setImage(RegisterImage(@"hash_58F71B593239CEE7"))
	...
	BGPatternThin:setImage(RegisterImage(@"hash_1785018A3DD922D8"))
	...
	BGPatternThin2:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_C221B51E4063E3D"))
