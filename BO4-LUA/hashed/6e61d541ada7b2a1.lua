		...
		Trigger = function(f7_arg0, f7_arg1)
			...
			local f7_local0 = function(f8_arg0)
				local f8_local0 = function(f9_arg0)
					f9_arg0:beginAnimation(280, Enum[@"luitween"][@"luitween_ease_out"])
					f9_arg0:setAlpha(0)
					f9_arg0:setScale(6, 4)
					f9_arg0:registerEventHandler("transition_complete_keyframe", f7_arg0.clipFinished)
				end
				f7_arg0.FocusHighlight:beginAnimation(120, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f7_local1 = function(f10_arg0)
				local f10_local0 = function(f11_arg0)
					f11_arg0:beginAnimation(280, Enum[@"luitween"][@"luitween_ease_out"])
					f11_arg0:setAlpha(0)
					f11_arg0:setScale(2.75, 2.75)
					f11_arg0:registerEventHandler("transition_complete_keyframe", f7_arg0.clipFinished)
				end
				f7_arg0.FocusHighlight2:beginAnimation(120, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f7_local2 = function(f12_arg0)
				local f12_local0 = function(f13_arg0)
					f13_arg0:beginAnimation(280, Enum[@"luitween"][@"luitween_ease_out"])
					f13_arg0:setAlpha(0)
					f13_arg0:setScale(1.8, 1.25)
					f13_arg0:registerEventHandler("transition_complete_keyframe", f7_arg0.clipFinished)
				end
				f7_arg0.FocusGlow:beginAnimation(120, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f7_local3 = function(f14_arg0)
				local f14_local0 = function(f15_arg0)
					local f15_local0 = function(f16_arg0)
						f16_arg0:beginAnimation(80, Enum[@"luitween"][@"luitween_ease_out"])
						f16_arg0:setAlpha(0)
						f16_arg0:registerEventHandler("transition_complete_keyframe", f7_arg0.clipFinished)
					end
					f15_arg0:beginAnimation(80, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f7_local4 = function(f17_arg0)
				local f17_local0 = function(f18_arg0)
					local f18_local0 = function(f19_arg0)
						f19_arg0:beginAnimation(160, Enum[@"luitween"][@"luitween_ease_out"])
						f19_arg0:setAlpha(0)
						f19_arg0:setScale(2, 2)
						f19_arg0:registerEventHandler("transition_complete_keyframe", f7_arg0.clipFinished)
					end
					f18_arg0:beginAnimation(80, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f7_local5 = function(f20_arg0)
				local f20_local0 = function(f21_arg0)
					f21_arg0:beginAnimation(160, Enum[@"luitween"][@"luitween_ease_out"])
					f21_arg0:setAlpha(0)
					f21_arg0:setScale(2, 2)
					f21_arg0:registerEventHandler("transition_complete_keyframe", f7_arg0.clipFinished)
				end
				f20_arg0:beginAnimation(80, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f7_local7 = function(f24_arg0)
				local f24_local0 = function(f25_arg0)
					local f25_local0 = function(f26_arg0)
						f26_arg0:beginAnimation(560, Enum[@"luitween"][@"luitween_ease_out"])
						f26_arg0:setAlpha(0)
						f26_arg0:setScale(2, 2)
						f26_arg0:registerEventHandler("transition_complete_keyframe", f7_arg0.clipFinished)
					end
					f25_arg0:beginAnimation(79, Enum[@"luitween"][@"luitween_ease_out"])
