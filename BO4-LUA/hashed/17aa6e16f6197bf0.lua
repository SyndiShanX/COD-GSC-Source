...
CoD.ContractItemCostMultiCurrency.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	CostCP:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	CostCP:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	CostCP:linkToElementModel(self, "price", true, function(model)
		local f2_local0 = model:get()
		if f2_local0 ~= nil then
			CostCP:setText(LocalizeIntoString(@"hash_56A3CC7BE3008989", f2_local0))
		end
	end)
	...
	CostCase:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	CostCase:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	CostCase:linkToElementModel(self, "casePrice", true, function(model)
		local f3_local0 = model:get()
		if f3_local0 ~= nil then
			CostCase:setText(LocalizeIntoString(@"hash_79CBD79D3C8A2BED", f3_local0))
		end
	end)
