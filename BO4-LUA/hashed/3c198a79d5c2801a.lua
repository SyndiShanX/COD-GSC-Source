...
require("x64:21fbf1151650ae2")
require("x64:1b76bc3f9278e54")
require("x64:22d8b3b3820d242")
require("x64:5eeaa6da9f4609")
require("x64:439f8f3f2b50e4b")
...
CoD.PurchaseableItem.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	itemPrice:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_393F12745A24670F"))
	itemPrice:setTTF("ttmussels_demibold")
	itemPrice:setLetterSpacing(1.5)
	itemPrice:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	itemPrice:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	ItemName:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	Promo:linkToElementModel(self, "percentOff", true, function(model)
		...
		if f16_local0 ~= nil then
			Promo.Promo:setText(ToUpper(LocalizeIntoString(@"hash_44211D07B481977D", f16_local0)))
		end
	end)
		...
		Animation = function(f51_arg0, f51_arg1)
			...
			local f51_local1 = function(f53_arg0)
				local f53_local0 = function(f54_arg0)
					f54_arg0:beginAnimation(350, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
					f54_arg0:setAlpha(1)
		...
		Animation = function(f87_arg0, f87_arg1)
			...
			local f87_local1 = function(f89_arg0)
				local f89_local0 = function(f90_arg0)
					f90_arg0:beginAnimation(360, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
					f90_arg0:setAlpha(1)
