require("x64:6cfb14ab0b137a5")
require("x64:43e711b632bac8d")
require("x64:9bf4161fe672a21")
require("x64:b757afc5f54b586")
...
CoD.WZAAR_Challenge.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	ProgressCount:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	ProgressCount:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	...
	Completed:setText(Engine[@"hash_4F9F1239CFD921FE"](@"menu/completed"))
	Completed:setTTF("ttmussels_regular")
	Completed:setLetterSpacing(2)
	Completed:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	Completed:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	...
	Description:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	XpEarned:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	XpEarned:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	XpEarned:linkToElementModel(self, "xp", true, function(model)
		local f4_local0 = model:get()
		if f4_local0 ~= nil then
			XpEarned:setText(LocalizeIntoString(@"hash_5B30C9471AAF95D", f4_local0))
		end
	end)
