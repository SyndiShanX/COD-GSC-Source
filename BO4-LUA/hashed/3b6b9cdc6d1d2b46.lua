...
CoD.ContractItemCost.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Free:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	Free:setShaderVector(0, 1, 0, 0, 0)
	Free:setShaderVector(1, 0, 0, 0, 0)
	Free:setShaderVector(2, 0, 0.1, 1, 0)
	Free:setLetterSpacing(2)
	Free:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	Free:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	ContractCost:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	ContractCost:setShaderVector(0, 1, 0, 0, 0)
	ContractCost:setShaderVector(1, 0, 0, 0, 0)
	ContractCost:setShaderVector(2, 1, 0, 0, 0.3)
	ContractCost:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	ContractCost:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	ContractCost:linkToElementModel(self, "price", true, function(model)
		local f2_local0 = model:get()
		if f2_local0 ~= nil then
			ContractCost:setText(LocalizeIntoString(@"hash_56A3CC7BE3008989", f2_local0))
		end
	end)
	...
	DiscountCost:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	DiscountCost:setShaderVector(0, 1, 0, 0, 0)
	DiscountCost:setShaderVector(1, 0, 0, 0, 0)
	DiscountCost:setShaderVector(2, 1, 0, 0, 0.3)
	DiscountCost:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	DiscountCost:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	DiscountCost:linkToElementModel(self, "price", true, function(model)
		local f3_local0 = model:get()
		if f3_local0 ~= nil then
			DiscountCost:setText(LocalizeIntoString(@"hash_56A3CC7BE3008989", f3_local0))
		end
	end)
