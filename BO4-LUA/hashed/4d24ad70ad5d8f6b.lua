...
CoD.vhud_tank_robot_framesquare.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	BoxT:setAlpha(0.4)
	BoxT:setImage(RegisterImage(@"hash_4D7C8DB42E3B4493"))
	...
	BoxR:setAlpha(0.4)
	BoxR:setImage(RegisterImage(@"hash_4D7C8DB42E3B4493"))
	...
	BoxB:setAlpha(0.4)
	BoxB:setImage(RegisterImage(@"hash_4D7C8DB42E3B4493"))
	...
	BoxL:setAlpha(0.4)
	BoxL:setImage(RegisterImage(@"hash_4D7C8DB42E3B4493"))
	...
	DotlineH:setZRot(90)
	DotlineH:setImage(RegisterImage(@"hash_C49B0C8991A541F"))
	DotlineH:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	DotLineV:setImage(RegisterImage(@"hash_C49B0C8991A541F"))
	DotLineV:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	ringTR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	ringBL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	ringBR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	ringTL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
			...
			local f3_local5 = function(f13_arg0)
				local f13_local0 = function(f14_arg0)
					local f14_local0 = function(f15_arg0)
						f15_arg0:beginAnimation(19, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f3_local6 = function(f16_arg0)
				local f16_local0 = function(f17_arg0)
					local f17_local0 = function(f18_arg0)
						f18_arg0:beginAnimation(19, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f3_local7 = function(f19_arg0)
				local f19_local0 = function(f20_arg0)
					local f20_local0 = function(f21_arg0)
						f21_arg0:beginAnimation(19, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f3_local8 = function(f22_arg0)
				local f22_local0 = function(f23_arg0)
					local f23_local0 = function(f24_arg0)
						f24_arg0:beginAnimation(19, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f3_local9 = function(f25_arg0)
				local f25_local0 = function(f26_arg0)
					local f26_local0 = function(f27_arg0)
						f27_arg0:beginAnimation(30, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f3_local10 = function(f28_arg0)
				local f28_local0 = function(f29_arg0)
					local f29_local0 = function(f30_arg0)
						f30_arg0:beginAnimation(30, Enum[@"luitween"][@"luitween_ease_both"])
