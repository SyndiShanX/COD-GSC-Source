...
Lobby.JSON.BuildMapPackFlagsTable = function(f1_arg0, f1_arg1, f1_arg2)
	if f1_arg1 & Enum[@"contentflagbits"][@"content_originalmaps"] > 0 then
		table.insert(f1_arg0, "MP_ORIGINAL_MAPS")
		Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "MP_ORIGINAL_MAPS \n")
	end
	if f1_arg1 & Enum[@"contentflagbits"][@"content_dlc0zm"] > 0 then
		table.insert(f1_arg0, "DLC_1")
		Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "DLC_1 \n")
	end
	if f1_arg1 & Enum[@"contentflagbits"][@"content_dlc2mp"] > 0 or f1_arg2 then
		table.insert(f1_arg0, "DLC_2")
		Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "DLC_2 \n")
	end
	if f1_arg1 & Enum[@"contentflagbits"][@"content_dlc1zm"] > 0 then
		table.insert(f1_arg0, "DLC_3")
		Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "DLC_3 \n")
	end
	if f1_arg1 & Enum[@"contentflagbits"][@"content_dlc3mp"] > 0 or f1_arg2 then
		table.insert(f1_arg0, "DLC_4")
		Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "DLC_4 \n")
	end
	if f1_arg1 & Enum[@"contentflagbits"][@"content_dlc2zm"] > 0 then
		table.insert(f1_arg0, "DLC_5")
		Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "DLC_5 \n")
	end
	if f1_arg1 & Enum[@"contentflagbits"][@"content_dlc4mp"] > 0 or f1_arg2 then
		table.insert(f1_arg0, "DLC_6")
		Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "DLC_6 \n")
	end
	if f1_arg1 & Enum[@"contentflagbits"][@"content_dlc3zm"] > 0 then
		table.insert(f1_arg0, "DLC_7")
		Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "DLC_7 \n")
	end
	if f1_arg1 & Enum[@"contentflagbits"][@"content_dlc5mp"] > 0 or f1_arg2 then
		table.insert(f1_arg0, "DLC_8")
		Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "DLC_8 \n")
	end
	if f1_arg1 & Enum[@"contentflagbits"][@"content_dlc4zm"] > 0 then
		table.insert(f1_arg0, "DLC_9")
		Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "DLC_9 \n")
	end
	if f1_arg1 & Enum[@"contentflagbits"][@"content_dlc6mp"] > 0 or f1_arg2 then
		table.insert(f1_arg0, "DLC_10")
		Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "DLC_10 \n")
	end
	if f1_arg1 & Enum[@"contentflagbits"][@"content_dlc5zm"] > 0 then
		table.insert(f1_arg0, "DLC_11")
		Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "DLC_11 \n")
	end
	return f1_arg0
end
Lobby.JSON.GetMappackBitsForName = function(f2_arg0)
	...
	if f2_arg0 == "MP_ORIGINAL_MAPS" then
		f2_local0 = Enum[@"contentflagbits"][@"content_originalmaps"]
	elseif f2_arg0 == "DLC_1" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc0zm"]
	elseif f2_arg0 == "DLC_2" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc2mp"]
	elseif f2_arg0 == "DLC_3" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc1zm"]
	elseif f2_arg0 == "DLC_4" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc3mp"]
	elseif f2_arg0 == "DLC_5" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc2zm"]
	elseif f2_arg0 == "DLC_6" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc4mp"]
	elseif f2_arg0 == "DLC_7" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc3zm"]
	elseif f2_arg0 == "DLC_8" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc5mp"]
	elseif f2_arg0 == "DLC_9" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc4zm"]
	elseif f2_arg0 == "DLC_10" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc6mp"]
	elseif f2_arg0 == "DLC_11" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc5zm"]
	end
	return f2_local0
end
Lobby.JSON.ErrorWrite = function(f3_arg0, f3_arg1, f3_arg2)
	Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], f3_arg1 .. ": " .. f3_arg2 .. "\n")
	if f3_arg0 ~= nil then
		f3_arg0:endWrite()
	end
	return nil
...
Lobby.JSON.ErrorParsing = function(f4_arg0, f4_arg1, f4_arg2)
	Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], f4_arg1 .. ": " .. f4_arg2 .. "\n")
	if f4_arg0 ~= nil then
		f4_arg0:endParse()
	end
	return nil
...
Lobby.JSON.CreateFieldAndAddToLocation = function(f5_arg0, f5_arg1, f5_arg2)
	...
	if f5_local0 == nil then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "failed to set '" .. f5_arg2 .. "' field.\n")
		return nil
	else
		return f5_local0
	end
...
Lobby.JSON.CreateArrayAndAddToLocation = function(f6_arg0, f6_arg1, f6_arg2)
	...
	if f6_local0 == nil then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "failed to set '" .. f6_arg2 .. "' array field.\n")
		return nil
	else
		return f6_local0
	end
...
Lobby.JSON.ParseLobbyHostDoc = function(f7_arg0, f7_arg1)
	...
	local f7_local1 = Engine[@"hash_1A4245AC303B4CD5"]()
	...
	if f7_local9 ~= nil then
		...
		if f7_local12 == nil then
			Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.ParseLobbyHostDoc: Missing current_player_state\n")
		else
			for f7_local17, f7_local18 in ipairs(f7_local12:getAllKeys()) do
				...
				if f7_local16 == nil then
					Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.ParseLobbyHostDoc: current_player_state[" .. f7_local18 .. "] failed to get connection state\n")
		...
		if f7_arg1 == nil then
			Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], f7_local0 .. "\n lobbyHostDoc: " .. f7_arg0 .. "\n lobbyHostXuid: " .. Engine[@"uint64tostring"](f7_local25.listen_server.host_player_id) .. "\n hostAddressBase64Encoded: " .. f7_local25.listen_server.host_address .. ".\n")
		end
		return f7_local25
	end
...
Lobby.JSON.CreateWritableDocFromString = function(f8_arg0)
	local f8_local0 = Engine[@"hash_61FCAFA688299BE3"](f8_arg0 .. " ")
	if f8_local0 == nil then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.CreateWritableDocFromString: couldn't create json object\n")
		return nil
	else
		local f8_local1 = f8_local0:getRoot()
		if f8_local1 == nil then
			Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.CreateWritableDocFromString: failed to get root of lobbyHostDoc JSON\n")
			f8_local0:endWrite()
			return nil
		else
...
Lobby.JSON.CreateConvertJsonToStringAndCloseHandle = function(f9_arg0, f9_arg1)
	...
	if f9_local0 == nil then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.MatchmakingAsync.CreateConvertJsonToStringAndClose: failed (getRepresentation) to get JSON.\n")
	else
...
Lobby.JSON.setUpdateID = function(f10_arg0, f10_arg1, f10_arg2, f10_arg3)
	if f10_arg1:setUInt64("update_id", f10_arg3) == false then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.setUpdateID: failed setting the 'update_id' in the lobbyhostdoc.\n")
	end
...
Lobby.JSON.setUpdateTime = function(f11_arg0, f11_arg1, f11_arg2, f11_arg3)
	if f11_arg1:setUInt64("update_time", f11_arg3) == false then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.setUpdateTime: failed setting the 'update_time' in the lobbyhostdoc.\n")
	end
...
Lobby.JSON.setCanSplitTeam = function(f12_arg0, f12_arg1, f12_arg2, f12_arg3)
	...
	if f12_local0 ~= nil and f12_local0:setBool("can_change_teams", f12_arg3) == false then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.setCanSplitTeam: failed setting the 'game_is_in_progress' in the lobbyhostdoc.\n")
	end
...
Lobby.JSON.setLobbyOpen = function(f13_arg0, f13_arg1, f13_arg2, f13_arg3)
	if f13_arg1:getFieldByKey("lobby_open") ~= nil and f13_arg1:setBool("lobby_open", f13_arg3) == false then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.setLobbyOpen: failed setting the 'lobby_open' in the lobbyhostdoc.\n")
	end
	f13_arg2.lobby_open = f13_arg3
	f13_arg2.needs_update = true
	Engine[@"hash_1CD447775E2BE007"](f13_arg3)
	Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.setLobbyOpen: Lobby.MMAsync.AdvertStatus was " .. tostring(Lobby.MMAsync.AdvertStatus) .. " now it's " .. tostring(f13_arg3) .. "\n")
...
Lobby.JSON.setAllowPresenseJoin = function(f14_arg0, f14_arg1, f14_arg2, f14_arg3)
	if f14_arg1:getFieldByKey("lobby_open_for_pres_join") ~= nil and f14_arg1:setBool("lobby_open_for_pres_join", f14_arg3) == false then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.setLobbyOpen: failed setting the 'lobby_open_for_pres_join' in the lobbyhostdoc.\n")
	end
...
Lobby.JSON.setGameID = function(f15_arg0, f15_arg1, f15_arg2, f15_arg3)
	if f15_arg1:setUInt64("game_id", f15_arg3) == false then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.setUpdateID: failed setting the 'game_id' in the lobbyhostdoc.\n")
	end
...
Lobby.JSON.AddExpectedPlayersToLobbyHostDoc = function(f16_arg0, f16_arg1, f16_arg2, f16_arg3, f16_arg4)
	...
	if f16_local0 == nil then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.AddExpectedPlayersToLobbyHostDoc: failed to read 'current_player_state' field.\n")
		return nil
	end
	for f16_local4, f16_local5 in ipairs(f16_arg3.expectedPlayers) do
		if f16_arg4[f16_local5.xuidstrnum] == nil then
			if f16_local0:getFieldByKey(f16_local5.xuidstrnum) == nil then
				Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.AddExpectedPlayersToLobbyHostDoc: Player not found adding \n")
				...
				if f16_local0:setUInt64(f16_local5.xuidstrnum, Engine[@"numbertouint64"](LuaEnum.LobbyMemberStatus.MEMBER_STATUS_MAY_CONNECT)) == false then
					Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.AddExpectedPlayersToLobbyHostDoc: failed to write xuid(" .. f16_local5.xuidstrnum .. ") to 'current_player_state' Expecting player may connect.\n")
				end
			end
			Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.AddExpectedPlayersToLobbyHostDoc: Player found \n")
			if f16_arg2.current_player_state[f16_local5.xuidstrnum] == nil or f16_arg2.current_player_state[f16_local5.xuidstrnum] < LuaEnum.LobbyMemberStatus.MEMBER_STATUS_MAY_CONNECT then
				Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.AddExpectedPlayersToLobbyHostDoc: Player found Updating \n")
				f16_arg2.current_player_state[f16_local5.xuidstrnum] = LuaEnum.LobbyMemberStatus.MEMBER_STATUS_MAY_CONNECT
				f16_arg2.needs_update = true
				if f16_local0:setUInt64(f16_local5.xuidstrnum, Engine[@"numbertouint64"](LuaEnum.LobbyMemberStatus.MEMBER_STATUS_MAY_CONNECT)) == false then
					Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.AddExpectedPlayersToLobbyHostDoc: failed to write xuid(" .. f16_local5.xuidstrnum .. ") to 'current_player_state' Expecting player may connect.\n")
...
Lobby.JSON.migrateHostData = function(f17_arg0, f17_arg1, f17_arg2, f17_arg3)
	...
	if f17_local0 then
		if f17_local0:setUInt64("host_player_id", f17_arg3.hostXuid) == false then
			Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.migrateHostData: failed to write 'lobby_host'.\n")
		end
		if f17_local0:setString("host_address", f17_arg3.hostAddress) == false then
			Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.migrateHostData: failed to write 'lobby_host_address'.\n")
		end
	end
	f17_arg2.listen_server.host_player_id = f17_arg3.hostXuid
	f17_arg2.listen_server.host_address = f17_arg3.hostAddress
	f17_arg2.listen_server.hostAddress = Engine[@"hash_DF4C7BBB34DA21C"](f17_arg3.hostAddress)
	local f17_local1 = f17_arg1:getFieldByKey("attachment")
	if f17_local1 == nil then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.migrateHostData: failed to get 'attachment' field from hostdoc.\n")
	else
		if f17_local1:setString("host_name", f17_arg3.gamertag) == false then
			Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.migrateHostData: failed to write 'host_name' in the attachment.\n")
		end
	...
	if f17_local2 == nil then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.migrateHostData: failed to read 'current_player_state' field.\n")
	end
	for f17_local10, f17_local11 in ipairs(f17_local2:getAllKeys()) do
		...
		if f17_local6 == false then
			Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.migrateHostData: Migration Data setting XUID [" .. f17_local11 .. "] to MEMBER_STATUS_WONT_CONNECT\n")
...
Lobby.JSON.RemoveClientsFromHostData = function(f18_arg0, f18_arg1, f18_arg2, f18_arg3)
	...
	if f18_local0 == nil then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.RemoveClientsFromHostData: failed to read 'current_player_state' field.\n")
		return nil
	end
	for f18_local4, f18_local5 in ipairs(f18_arg3.removeList) do
		if f18_local0:deleteField(f18_local5.xuidstrnum) then
			...
			Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Removed client xuid:" .. f18_local5.xuidstrnum .. "/" .. tostring(f18_local5.xuid) .. ".\n")
		end
	end
	return f18_arg2
end
Lobby.JSON.AddClientsToHostData = function(f19_arg0, f19_arg1, f19_arg2, f19_arg3)
	...
	if f19_local0 == nil then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.AddClientsToHostData: failed to read 'current_player_state' field.\n")
		return nil
	end
	for f19_local4, f19_local5 in ipairs(f19_arg3.sessionClients) do
		...
		if f19_local0:setUInt64(f19_local5.xuidstrnum, Engine[@"numbertouint64"](LuaEnum.LobbyMemberStatus.MEMBER_STATUS_CONNECTED)) == false then
			Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.AddClientsToHostData: failed to write xuid(" .. f19_local5.xuidstrnum .. ") to 'current_player_state' .\n")
		end
...
Lobby.JSON.UpdateMergeRules = function(f20_arg0, f20_arg1, f20_arg2, f20_arg3)
	...
	if f20_local0 then
		if f20_local0:setBool("is_merge_src", f20_arg3.src) == false then
			Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.UpdateMergeRules: failed to write 'is_merge_src'\n")
		end
		if f20_local0:setBool("is_merge_dst", f20_arg3.dst) == false then
			Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.UpdateMergeRules: failed to write 'is_merge_dst'\n")
		end
	end
...
Lobby.JSON.AddHostAttachmentInfo = function(f21_arg0, f21_arg1, f21_arg2, f21_arg3)
	...
	if f21_local0 == nil then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.AddHostData: failed to add 'attachment' Array field to hostdoc.\n")
		return nil
	elseif f21_local0:setString("host_name", f21_arg3.hostName) == false then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.AddHostData: failed to write 'host_name' in the attachment.\n")
		return nil
	elseif f21_local0:setUInt("host_menuID", f21_arg3.menuID) == false then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.AddHostData: failed to write 'host_menuID' in the attachment.\n")
		return nil
	else
		f21_arg2.attachment = {
...
Lobby.JSON.markDedicatedToShutdown = function(f22_arg0, f22_arg1, f22_arg2)
	...
	if f22_local0 ~= nil and f22_local0:setBool("shutting_down", true) == false then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.markDedicatedToShutdown: failed setting the 'dedicated_server.shutting_down' in the lobbyhostdoc.\n")
	end
...
Lobby.JSON.ParseLobbyBackendDoc = function(f23_arg0)
	...
	while f23_local0 == nil and f23_local2 < 3 do
		...
		if f23_local0 == nil then
			...
			Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.ParseLobbyBackendDoc: Failed to parse lobbyBackendDoc try# [" .. tostring(f23_local2) .. "] is missing entry " .. tostring(f23_local3) .. "\n")
	...
	if f23_local0 == nil then
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.ParseLobbyBackendDoc: Failed to parse lobbyBackendDoc 3 times throwing com error \n")
		Engine[@"comerror"](Enum[@"errorcode"][@"error_softrestart"], "Lobby.JSON.ParseLobbyBackendDoc has failed, please email your logs to codcoreonline@treyarch.com")
	end
	return f23_local0
end
Lobby.JSON.ParseLobbyBackendDocInternal = function(f24_arg0)
	local f24_local0 = "Lobby.JSON.ParseLobbyBackendDocInternal"
	local f24_local1 = Engine[@"hash_1A4245AC303B4CD5"]()
		...
		if f24_local10 then
			...
			if f24_local24 then
				...
				if f24_local25 then
					...
					f24_local1:endParse()
					local f24_local29 = Engine[@"hash_6E46D712FE84AF13"](f24_local7, f24_local8)
					local f24_local30 = {
						lobbyDoc = f24_arg0,
						lobbyID = f24_local3,
					...
					Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.MatchmakingAsync.ParseLobbyBackendDoc:" .. "\n lobbyBackendDoc: " .. f24_local30.lobbyDoc .. "\n lobbyID: " .. Engine[@"uint64tostring"](f24_local30.lobbyID) .. "\n updateID: " .. Engine[@"uint64tostring"](f24_local30.update_id) .. "\n secIdBase64Encoded: " .. f24_local30.secIdBase64Encoded .. "\n secKeyBase64Encoded: " .. f24_local30.secKeyBase64Encoded .. "\n playlistID: " .. tostring(f24_local30.playlist_id) .. "\n")
...
Lobby.JSON.ParseDCQoSInfo = function(f25_arg0)
	local f25_local0 = function(f26_arg0, f26_arg1)
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.ParseDCQoSInfo: " .. f26_arg1)
		if f26_arg0 ~= nil then
			f26_arg0:endParse()
		end
		return nil
	end
	local f25_local1 = Engine[@"hash_1A4245AC303B4CD5"]()
	...
	for f25_local8 = 1, f25_local6, 1 do
		...
		if f25_local11:checkIfFieldHasData("datacenter") then
			...
			if f25_local15 == nil then
				Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "No datacenter in json, skipping\n")
			end
		end
		local f25_local16 = Engine[@"hash_6E46D712FE84AF13"](f25_local12, f25_local13)
		local f25_local17 = Engine[@"hash_DF4C7BBB34DA21C"](f25_local14)
		f25_local3 = tonumber(Engine[@"uint64tostring"](f25_local3))
	...
	Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.ParseDCQoSInfo:" .. "\n dcQoSInfo: " .. f25_local8.dcQoSInfo .. "\n numProbes: " .. tostring(f25_local8.numProbes) .. "\n transactionID: " .. Engine[@"uint64tostring"](f25_local8.transactionID) .. "\n hosts: cannot display info" .. "\n")
	return f25_local8
end
Lobby.JSON.CreatePlayerInfoDoc = function(f27_arg0)
	local f27_local0 = function(f28_arg0, f28_arg1)
		Engine[@"printerror"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.CreatePlayerInfoDoc: " .. f28_arg1)
	...
	if Dvar[@"hash_76C1A042EF5D6CEC"]:exists() then
		local f27_local7 = tonumber(Dvar[@"hash_76C1A042EF5D6CEC"]:get())
		if f27_local7 < 4 then
			f27_local6 = f27_local7
			Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.CreatePlayerInfoDoc: forcing nat type to " .. f27_local6 .. "\n")
		end
	end
	local f27_local7 = Engine[@"getconnectiontype"]() == Enum[@"connectiontype_e"][@"connection_type_wireless"]
	local f27_local8 = ""
	local f27_local9 = ""
	local f27_local10 = {}
	...
	Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Getting Table of owned mappacks:\n")
	Lobby.JSON.BuildMapPackFlagsTable(f27_local10, Engine[@"getdlcbits"](), Engine[@"ownseasonpass"](Engine[@"getprimarycontroller"]()))
	Engine[@"hash_2A8F0FED295F69CD"](f27_arg0.secIdKey.secId, f27_arg0.secIdKey.secKey)
	Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Enable QoS listener for client: " .. f27_arg0.gamertag .. ", with Sec Id: " .. tostring(f27_arg0.secIdKey.secIdInt64) .. ".\n")
	Engine[@"qosprobelistenerenable"](true, f27_arg0.secIdKey.secIdInt64)
	local f27_local14 = Engine[@"hash_1A4245AC303B4CD5"]()
...
Lobby.JSON.CreateStartSearchParamDoc = function(f29_arg0)
	...
	local f29_local3 = Engine[@"hash_25E804BED092329B"]()
	local f29_local4 = Engine[@"getplaylistversionnumber"]()
	local f29_local5 = Engine[@"getplaylistid"]()
	local f29_local6 = Dvar[@"lobbymultiplaylistsearchenabled"]:exists()
	if f29_local6 then
		f29_local6 = Dvar[@"lobbymultiplaylistsearchenabled"]:get()
	end
	local f29_local7 = {}
	...
	if f29_local6 then
		...
		if f29_local10 then
			...
			for f29_local12 = 1, f29_local11, 1 do
				table.insert(f29_local7, Engine[@"getplaylistinfobyid"](f29_local10[f29_local12]:get()))
			end
	...
	local f29_local11 = Engine[@"getplaylistinfobyid"](f29_local5)
	...
	local f29_local19 = Engine[@"hash_4F75734A98C53D1B"](f29_local5)
	...
	if Dvar[@"hash_4E0FB96935DF872D"]:exists() and Dvar[@"hash_4E0FB96935DF872D"]:get() > 0 then
		f29_local16 = Dvar[@"hash_4E0FB96935DF872D"]:get()
	end
	if Dvar[@"hash_6B0353CA54760727"]:exists() and Dvar[@"hash_6B0353CA54760727"]:get() > 0 and Dvar[@"hash_6B0353CA54760727"]:get() <= #LuaEnum.NeedForDedicatedServerString then
		f29_local9 = Dvar[@"hash_6B0353CA54760727"]:get()
	end
	local f29_local20 = LobbyData.GetCurrentMenuTarget()
	local f29_local21 = Engine[@"hash_2786FFC9E621CAB7"]()
	Lobby.MatchmakingAsync.MatchmakingSearchSummaryLog[@"hash_522C2D85063EC515"] = f29_local21
	Lobby.MatchmakingAsync.PartyToMatchSummary[@"hash_522C2D85063EC515"] = f29_local21
	if f29_arg0 == nil and f29_local11.mainMode ~= f29_local20[@"mainmode"] then
		...
		return nil
	elseif f29_local20[@"mainmode"] == Enum[@"lobbymainmode"][@"lobby_mainmode_zm"] or f29_local20[@"mainmode"] == Enum[@"lobbymainmode"][@"lobby_mainmode_cp"] then
		f29_local8 = 1
	elseif f29_local20[@"mainmode"] == Enum[@"lobbymainmode"][@"lobby_mainmode_wz"] then
		f29_local8 = 1
		...
		local f29_local22 = Engine[@"hash_E00882E35AF63D2"](Enum[@"lobbymodule"][@"lobby_module_host"], Enum[@"lobbytype"][@"lobby_type_private"])
		if f29_local22 ~= nil then
			f29_local15 = f29_local22.fillParty
		end
	end
	if LuaDefine.isPCClient and f29_local20[@"mainmode"] == Enum[@"lobbymainmode"][@"lobby_mainmode_mp"] and Dvar[0x3617F20591CC64]:exists() and Dvar[0x3617F20591CC64]:get() then
		f29_local9 = LuaEnum.NeedForDedicatedServer.REQUIRED
	end
	if f29_local20[@"lobbymode"] == Enum[@"lobbymode"][@"lobby_mode_arena"] then
		if Dvar[@"hash_7AAD4C8A3747B359"]:exists() and Dvar[@"hash_7AAD4C8A3747B359"]:get() then
			f29_local9 = LuaEnum.NeedForDedicatedServer.NOT_NEEDED
		end
		if Dvar[@"hash_2781206C11C8B523"]:exists() then
			f29_local17 = f29_local17 + Dvar[@"hash_2781206C11C8B523"]:get()
		end
	end
	...
	if Dvar[@"hash_E4D6FF240788F81"]:exists() and Dvar[@"hash_E4D6FF240788F81"]:get() then
		...
		if f29_local20[@"mainmode"] == Enum[@"lobbymainmode"][@"lobby_mainmode_wz"] then
			f29_local14 = f29_local14 .. "-wz"
			if Dvar[@"hash_1AFE8B91B7B953C3"]:exists() then
				suffix = "100"
				f29_local14 = f29_local14 .. "-" .. suffix
			end
		elseif f29_local20[@"mainmode"] == Enum[@"lobbymainmode"][@"lobby_mainmode_mp"] then
			f29_local14 = f29_local14 .. "-mp"
		end
	end
	Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], f29_local0 .. "\n buildNameContext: " .. f29_local14 .. "\n")
	local f29_local25 = ""
	...
	local f29_local28 = Engine[@"getlobbyuiscreen"]()
	local f29_local29 = Engine[@"hash_1A4245AC303B4CD5"]()
	...
	local f29_local33 = Engine[@"lobbygetsessionclients"](Enum[@"lobbymodule"][@"lobby_module_host"], Enum[@"lobbytype"][@"lobby_type_private"])
	local f29_local34 = {}
	...
	if f29_arg0 ~= nil then
		...
		elseif Dvar[@"hash_24BAF85486280784"]:get() == true or Dvar[@"hash_717148A4FB179B6C"]:get() == true then
			Dvar[@"hash_24BAF85486280784"]:set(false)
			if Dvar[@"hash_717148A4FB179B6C"]:get() == false then
				Dvar[@"hash_2A546240BBE08638"]:set(false)
			end
		...
		if f29_local10 then
			...
			if not f29_local45 then
				...
				Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Getting Table of mappacks in the Playlist:\n")
				f29_local42 = {}
					...
					if f29_local48.name == @"hash_6E535D66F4F89AE5" then
						if #f29_local48.value > 0 then
							...
							elseif f29_local50:addString(f29_local49) == false then
								...
								Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "asyncMatchmakingStartDoc: forcing datacenter to  " .. f29_local49 .. "\n")
								break
							end
				...
				for f29_local48, f29_local49 in ipairs(f29_local33.sessionClients) do
					local f29_local54 = Lobby.JSON.CreateFieldAndAddToLocation(f29_local29, f29_local43, Engine[@"uint64tostring"](f29_local49.xuid))
					f29_local54:setBool("mic", f29_local49.VOIPStatus == Enum[@"evoipstatus"][@"voip_nottalking"])
					...
					if f29_local48 == 1 then
						...
						if f29_local20[@"mainmode"] == Enum[@"lobbymainmode"][@"lobby_mainmode_zm"] then
							f29_local52 = Engine[@"storagegetbuffer"](f29_local51, Enum[@"storagefiletype"][@"storage_zm_stats_online"])
						elseif f29_local20[@"mainmode"] == Enum[@"lobbymainmode"][@"lobby_mainmode_mp"] then
							f29_local52 = Engine[@"storagegetbuffer"](f29_local51, Enum[@"storagefiletype"][@"storage_mp_stats_online"])
						end
						if f29_local52 then
...
Lobby.JSON.ParseAsyncMatchmakingStartDoc = function(f30_arg0)
	...
	local f30_local1 = Engine[@"hash_1A4245AC303B4CD5"]()
			...
			if f30_local3 == nil then
				...
				if f30_local4 == nil then
					...
					local f30_local5 = {
						...
						estimatedWaitTime = tonumber(Engine[@"uint64tostring"](f30_local3)),
						mm_id = f30_local4,
					}
					Engine[@"printinfo"](Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.ParseAsyncMatchmakingStartDoc:" .. "\n asyncMatchmakingStartDoc: " .. f30_local5.asyncMatchmakingStartDoc .. "\n estimatedWaitTime: " .. tostring(f30_local5.estimatedWaitTime) .. "\n MatchmakindID: " .. Engine[@"uint64tostring"](f30_local4) .. "\n")
					return f30_local5
				end
			end
		end
