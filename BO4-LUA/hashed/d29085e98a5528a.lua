	...
	self:mergeStateConditions({
		...
		},
		{
			...
			condition = function(menu, element, event)
				...
				if not CoD.ModelUtility.IsSelfModelValueTrue(element, f1_arg1, "unlocked") then
					f11_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum(element, f1_arg1, "rarity", Enum[@"lootraritytype"][@"loot_rarity_type_common"])
				else
					f11_local0 = false
				end
				return f11_local0
		...
		},
		{
			...
			condition = function(menu, element, event)
				...
				if f12_local0 then
					f12_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum(element, f1_arg1, "rarity", Enum[@"lootraritytype"][@"loot_rarity_type_common"])
					if f12_local0 then
		...
		},
		{
			...
			condition = function(menu, element, event)
				...
				if f13_local0 then
					f13_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum(element, f1_arg1, "rarity", Enum[@"lootraritytype"][@"loot_rarity_type_common"])
					if f13_local0 then
		...
		},
		{
			...
			condition = function(menu, element, event)
				...
				if f14_local0 then
					f14_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum(element, f1_arg1, "rarity", Enum[@"lootraritytype"][@"loot_rarity_type_common"])
					if f14_local0 then
