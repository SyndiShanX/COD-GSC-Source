...
CoD.WZObituaryCalloutContainerFinish = InheritFrom(LUI.UIElement)
CoD.WZObituaryCalloutContainerFinish.__defaultWidth = 550
CoD.WZObituaryCalloutContainerFinish.__defaultHeight = 26
CoD.WZObituaryCalloutContainerFinish.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	local self = LUI.UIHorizontalList.new(f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9, 28, false)
	self:setAlignment(LUI.Alignment.Center)
	self:setClass(CoD.WZObituaryCalloutContainerFinish)
	self.id = "WZObituaryCalloutContainerFinish"
...
CoD.WZObituaryCalloutContainerFinish.__onClose = function(f3_arg0)
