	...
	DefaultState = {
		...
		GainChildFocus = function(f6_arg0, f6_arg1)
			...
			local f6_local0 = function(f7_arg0)
				f6_arg0.DirectorSelectButtonLines:beginAnimation(200, Enum[0xF50FFF429AB1890][0x53CEB9A0427197])
		...
		LoseChildFocus = function(f8_arg0, f8_arg1)
			...
			local f8_local0 = function(f9_arg0)
				f8_arg0.DirectorSelectButtonLines:beginAnimation(200, Enum[0xF50FFF429AB1890][0x6F6186B702830BC])
