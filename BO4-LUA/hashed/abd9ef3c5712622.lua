...
CoD.TabletTak5_LinkAll.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	ModuleLink01Add:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	ModuleLink02Add:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	ModuleLink03Add:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	ModuleLink04Add:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	Connector01:setImage(RegisterImage(@"hash_7FA1D08EA1C385B0"))
	Connector01:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	Connector02:setImage(RegisterImage(@"hash_7FA1D38EA1C38AC9"))
	Connector02:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	Connector03:setImage(RegisterImage(@"hash_7FA1D38EA1C38AC9"))
	Connector03:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	Connector04:setImage(RegisterImage(@"hash_7FA1D38EA1C38AC9"))
	Connector04:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
