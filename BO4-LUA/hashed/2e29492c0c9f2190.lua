...
CoD.ClanInboxRow.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	MessageSent:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	MessageSent:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	MessageDescription:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	MessageDescription:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
...
CoD.ClanInboxRow.__resetProperties = function(f15_arg0)
	...
	f15_arg0.btnDisplayTextStroke:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	f15_arg0.btnDisplayText:setAlpha(0)
	f15_arg0.btnDisplayText:setZoom(10)
	f15_arg0.btnDisplayText:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
...
CoD.ClanInboxRow.__clipsPerState = {
	...
	DefaultStateArabic = {
		DefaultClip = function(f55_arg0, f55_arg1)
			...
			f55_arg0.btnDisplayText:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
			...
			f55_arg0.btnDisplayTextStroke:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
	...
	DisabledArabic = {
		DefaultClip = function(f75_arg0, f75_arg1)
			...
			f75_arg0.btnDisplayText:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
			...
			f75_arg0.btnDisplayTextStroke:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
