	...
	DefaultState = {
		DefaultClip = function(f7_arg0, f7_arg1)
			...
			local f7_local4 = function(f18_arg0)
				...
				f7_arg0.infoBracketBot:beginAnimation(170, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f7_local5 = function(f20_arg0)
				...
				f7_arg0.infoBracketTop:beginAnimation(170, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f7_local7 = function(f24_arg0)
				local f24_local0 = function(f25_arg0)
					f25_arg0:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_both"])
		...
		Intro = function(f26_arg0, f26_arg1)
			...
			local f26_local3 = function(f32_arg0)
				local f32_local0 = function(f33_arg0)
					...
					f33_arg0:beginAnimation(159, Enum[@"luitween"][@"luitween_ease_in"])
