CoD.HealthBarWidgetPulsePortraitList = InheritFrom(LUI.UIElement)
CoD.HealthBarWidgetPulsePortraitList.__defaultWidth = 156
CoD.HealthBarWidgetPulsePortraitList.__defaultHeight = 20
CoD.HealthBarWidgetPulsePortraitList.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	local self = LUI.UIElement.new(f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	self:setClass(CoD.HealthBarWidgetPulsePortraitList)
	self.id = "HealthBarWidgetPulsePortraitList"
	self.soundSet = "none"
...
CoD.HealthBarWidgetPulsePortraitList.__resetProperties = function(f2_arg0)
...
CoD.HealthBarWidgetPulsePortraitList.__clipsPerState = {
	DefaultState = {
		DefaultClip = function(f3_arg0, f3_arg1)
			...
			local f3_local0 = function(f4_arg0)
				...
				f3_arg0.PulseBar:setTopBottom(0.63, 0.63, -200, 200)
