...
CoD.SwipeTak5_ConfirmButton.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	BgStripe:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	BgStripeColor:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	ConfirmText:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_5349737B0BDAA763"))
	ConfirmText:setTTF("0arame_mono_stencil")
	ConfirmText:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_171E049B161CD00A"))
	ConfirmText:setLetterSpacing(4)
	ConfirmText:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	ConfirmText:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	ConfirmTextColor:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_5349737B0BDAA763"))
	ConfirmTextColor:setTTF("0arame_mono_stencil")
	ConfirmTextColor:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_171E049B161CD00A"))
	ConfirmTextColor:setLetterSpacing(4)
	ConfirmTextColor:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	ConfirmTextColor:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	ConfirmTextAdd:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_5349737B0BDAA763"))
	ConfirmTextAdd:setTTF("0arame_mono_stencil")
	ConfirmTextAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_3336C1AE82B1520A"))
	ConfirmTextAdd:setLetterSpacing(4)
	ConfirmTextAdd:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	ConfirmTextAdd:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	ButtonBarR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	ButtonBarRColor:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	ButtonBarL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	ButtonBarLColor:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
...
CoD.SwipeTak5_ConfirmButton.__resetProperties = function(f3_arg0)
	...
	f3_arg0.ConfirmTextAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_3336C1AE82B1520A"))
...
CoD.SwipeTak5_ConfirmButton.__clipsPerState = {
	DefaultState = {
		DefaultClip = function(f4_arg0, f4_arg1)
			...
			local f4_local0 = function(f5_arg0)
				local f5_local0 = function(f6_arg0)
					local f6_local0 = function(f7_arg0)
						f7_arg0:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_both"])
						f7_arg0:setAlpha(0)
						f7_arg0:registerEventHandler("transition_complete_keyframe", f4_arg0.clipFinished)
					end
					f6_arg0:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_both"])
			...
			f4_arg0.ConfirmTextAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_3336C1AE82B1520A"))
			...
			local f4_local1 = function(f8_arg0)
				f4_arg0.ButtonBarR:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f4_local2 = function(f9_arg0)
				f4_arg0.ButtonBarL:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_out"])
		...
		ButtonPress = function(f10_arg0, f10_arg1)
			...
			local f10_local1 = function(f13_arg0)
				local f13_local0 = function(f14_arg0)
					local f14_local0 = function(f15_arg0)
						f15_arg0:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_out"])
						f15_arg0:setAlpha(1)
			...
			local f10_local3 = function(f19_arg0)
				local f19_local0 = function(f20_arg0)
					f20_arg0:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_both"])
					f20_arg0:setScale(1, 1)
					f20_arg0:registerEventHandler("transition_complete_keyframe", f10_arg0.clipFinished)
				end
				f10_arg0.ConfirmText:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f10_local5 = function(f24_arg0)
				local f24_local0 = function(f25_arg0)
					local f25_local0 = function(f26_arg0)
						f26_arg0:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_out"])
						f26_arg0:setAlpha(1)
