	...
	self:mergeStateConditions({
		...
		},
		{
			...
			condition = function(menu, element, event)
				...
				if not CoD.ModelUtility.IsSelfModelValueTrue(element, f1_arg1, "unlocked") then
					f12_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum(element, f1_arg1, "rarity", Enum[@"lootraritytype"][@"hash_63006FE890A202D9"])
				else
					f12_local0 = false
				end
				return f12_local0
		...
		},
		{
			...
			condition = function(menu, element, event)
				...
				if f13_local0 then
					f13_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum(element, f1_arg1, "rarity", Enum[@"lootraritytype"][@"hash_63006FE890A202D9"])
					if f13_local0 then
		...
		},
		{
			...
			condition = function(menu, element, event)
				...
				if f14_local0 then
					f14_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum(element, f1_arg1, "rarity", Enum[@"lootraritytype"][@"hash_63006FE890A202D9"])
					if f14_local0 then
		...
		},
		{
			...
			condition = function(menu, element, event)
				...
				if f15_local0 then
					f15_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum(element, f1_arg1, "rarity", Enum[@"lootraritytype"][@"hash_63006FE890A202D9"])
					if f15_local0 then
