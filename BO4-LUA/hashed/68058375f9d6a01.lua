...
CoD.PositionDraft_ViewTeams_CodCaster_Client = InheritFrom(LUI.UIElement)
CoD.PositionDraft_ViewTeams_CodCaster_Client.__defaultWidth = 189
CoD.PositionDraft_ViewTeams_CodCaster_Client.__defaultHeight = 216
CoD.PositionDraft_ViewTeams_CodCaster_Client.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	self:setClass(CoD.PositionDraft_ViewTeams_CodCaster_Client)
	self.id = "PositionDraft_ViewTeams_CodCaster_Client"
	...
	EnemyBackground:subscribeToGlobalModel(f1_arg1, "Factions", "axisFactionColor", function(model)
		...
		if f2_local0 ~= nil then
			EnemyBackground:setRGB(f2_local0)
		end
	end)
	...
	FriendlyBackground:subscribeToGlobalModel(f1_arg1, "Factions", "alliesFactionColor", function(model)
		...
		if f3_local0 ~= nil then
			FriendlyBackground:setRGB(f3_local0)
		end
	end)
	...
	TopBarFriendly:subscribeToGlobalModel(f1_arg1, "Factions", "alliesFactionColor", function(model)
		...
		if f5_local0 ~= nil then
			TopBarFriendly:setRGB(f5_local0)
		end
	end)
		...
		},
		{
			...
			condition = function(menu, element, event)
				...
				if not CoD.ModelUtility.IsSelfModelValueNilOrZero(element, f1_arg1, "characterIndex") then
					f10_local0 = IsGametypeSettingsValue("draftHideEnemyTeam", 1)
				else
					f10_local0 = false
				end
				return f10_local0
	...
	PositionDraftCharacterEnemy:linkToElementModel(self, "characterIndex", true, function(model)
		...
		if f19_local0 ~= nil then
			PositionDraftCharacterEnemy.Name:setText(LocalizeToUpperString(GetCharacterDisplayNameByIndex(f19_local0)))
		end
	end)
	...
	PositionDraftCharacter:linkToElementModel(self, "characterIndex", true, function(model)
		...
		if f32_local0 ~= nil then
			PositionDraftCharacter.Name:setText(LocalizeToUpperString(GetCharacterDisplayNameByIndex(f32_local0)))
		end
	end)
	...
	self.PositionDraftCharacterEnemy:linkToElementModel(self, "characterIndex", true, function(model)
		...
		if f39_local0 ~= nil then
			PositionDraftCharacterEnemy.Portrait:setImage(RegisterImage(GetPositionDraftIconByIndex(f39_local0)))
		end
	end)
	self.PositionDraftCharacter:linkToElementModel(self, "characterIndex", true, function(model)
		...
		if f40_local0 ~= nil then
			PositionDraftCharacter.Portrait:setImage(RegisterImage(GetPositionDraftIconByIndex(f40_local0)))
		end
	end)
...
CoD.PositionDraft_ViewTeams_CodCaster_Client.__resetProperties = function(f51_arg0)
	...
	f51_arg0.TopBarEnemy:completeAnimation()
	f51_arg0.BG:setAlpha(0.9)
	f51_arg0.ClientClanTag:setLeftRight(1, 1, -179, -9)
	f51_arg0.ClientClanTag:setAlpha(1)
	f51_arg0.TopBarFriendly:setAlpha(0)
	f51_arg0.FriendlyBackground:setAlpha(1)
	f51_arg0.EnemyBackground:setAlpha(1)
	f51_arg0.ClientGamertag:setLeftRight(1, 1, -179, -9)
	f51_arg0.ClientGamertag:setAlpha(1)
	f51_arg0.Rank:setAlpha(0)
	f51_arg0.PositionDraftCharacterEnemy:setAlpha(1)
	f51_arg0.PositionDraftCharacter:setAlpha(1)
	f51_arg0.TopBarEnemy:setAlpha(0)
end
CoD.PositionDraft_ViewTeams_CodCaster_Client.__clipsPerState = {
	...
	Friendly_CharacterSelected_Rank = {
		DefaultClip = function(f53_arg0, f53_arg1)
			...
			f53_arg0.Rank:completeAnimation()
			f53_arg0.Rank:setAlpha(1)
			f53_arg0.clipFinished(f53_arg0.Rank)
			f53_arg0.ClientClanTag:completeAnimation()
			f53_arg0.ClientClanTag:setLeftRight(1, 1, -149, -9)
			f53_arg0.ClientClanTag:setAlpha(1)
			f53_arg0.clipFinished(f53_arg0.ClientClanTag)
			f53_arg0.ClientGamertag:completeAnimation()
			f53_arg0.ClientGamertag:setLeftRight(1, 1, -149, -9)
			f53_arg0.clipFinished(f53_arg0.ClientGamertag)
		end,
	},
	...
	Friendly_ValidClient = {
		DefaultClip = function(f55_arg0, f55_arg1)
			...
			f55_arg0.PositionDraftCharacter:setAlpha(1)
			...
			f55_arg0.ClientClanTag:setAlpha(1)
	...
	Friendly_Searching = {
		DefaultClip = function(f56_arg0, f56_arg1)
			...
			f56_arg0.ClientGamertag:setAlpha(0)
	...
	Enemy_CharacterSelected_Rank = {
		DefaultClip = function(f57_arg0, f57_arg1)
			...
			f57_arg0.EnemyBackground:setAlpha(0.3)
			...
			f57_arg0.TopBarEnemy:setAlpha(0.6)
			f57_arg0.clipFinished(f57_arg0.TopBarEnemy)
			f57_arg0.PositionDraftCharacter:completeAnimation()
			f57_arg0.PositionDraftCharacter:setAlpha(1)
			f57_arg0.clipFinished(f57_arg0.PositionDraftCharacter)
			f57_arg0.Rank:completeAnimation()
			f57_arg0.Rank:setAlpha(1)
			f57_arg0.clipFinished(f57_arg0.Rank)
			f57_arg0.ClientClanTag:completeAnimation()
			f57_arg0.ClientClanTag:setLeftRight(1, 1, -149, -9)
			f57_arg0.ClientClanTag:setAlpha(1)
			f57_arg0.clipFinished(f57_arg0.ClientClanTag)
			f57_arg0.ClientGamertag:completeAnimation()
			f57_arg0.ClientGamertag:setLeftRight(1, 1, -149, -9)
			f57_arg0.clipFinished(f57_arg0.ClientGamertag)
		end,
	},
	Enemy_CharacterSelected = {
		DefaultClip = function(f58_arg0, f58_arg1)
			...
			f58_arg0.EnemyBackground:setAlpha(0.3)
	...
	Enemy_ValidClient = {
		DefaultClip = function(f59_arg0, f59_arg1)
			...
			f59_arg0.EnemyBackground:setAlpha(0.3)
			...
			f59_arg0.ClientClanTag:setAlpha(1)
	...
	Enemy_Searching = {
		DefaultClip = function(f60_arg0, f60_arg1)
			...
			f60_arg0.EnemyBackground:setAlpha(0.3)
			...
			f60_arg0.TopBarEnemy:setAlpha(0.6)
...
CoD.PositionDraft_ViewTeams_CodCaster_Client.__onClose = function(f61_arg0)
	f61_arg0.EnemyBackground:close()
	f61_arg0.FriendlyBackground:close()
	f61_arg0.TopBarEnemy:close()
