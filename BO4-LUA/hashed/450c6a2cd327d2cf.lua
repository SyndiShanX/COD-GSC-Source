...
CoD.MeritOverlayBoard.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	TiledPlusGridL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	TiledPlusGridR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	ItemTop:linkToElementModel(self, "topLabel", true, function(model)
		...
		if f8_local0 ~= nil then
			ItemTop.ItemLabel:setText(LocalizeStringWithParameter(@"hash_56076E20CE50E4CB", f8_local0))
		end
	end)
	...
	TotalMerit:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TotalMerit:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	TotalMeritsLabel:setText(LocalizeToUpperString(@"hash_32FD7986ED047F25"))
	TotalMeritsLabel:setTTF("default")
	TotalMeritsLabel:setLetterSpacing(2)
	TotalMeritsLabel:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TotalMeritsLabel:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	MeritsLabel:setText(LocalizeToUpperString(@"hash_41A6986D07D40B76"))
	MeritsLabel:setTTF("default")
	MeritsLabel:setLetterSpacing(2)
	MeritsLabel:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	MeritsLabel:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	...
	Arrow:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	DotVline01:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	DotHline02:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	DotHline:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	DotHline01:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	DefaultState = {
		DefaultClip = function(f13_arg0, f13_arg1)
			...
			local f13_local0 = function(f14_arg0)
				local f14_local0 = function(f15_arg0)
					local f15_local0 = function(f16_arg0)
						...
						f16_arg0:beginAnimation(2000, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f13_local1 = function(f18_arg0)
				...
				f13_arg0.SideBarRight:beginAnimation(1000, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f13_local2 = function(f20_arg0)
				...
				f13_arg0.SideBarLeft:beginAnimation(1000, Enum[@"luitween"][@"luitween_ease_both"])
