...
CoD.WZAAR_MeritBreakdown.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Box2:setAlpha(0)
	Box2:setImage(RegisterImage(0x60863710610A64E))
	...
	Merits:setAlpha(0)
	Merits:setText(Engine[0xF9F1239CFD921FE](0x93E719493E9E18F))
	...
	Merits:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
	Merits:setAlignment(Enum[0x7A5123B654282D2][0xE821F0ECFF8D1C7])
	...
	MeritsTitle:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	MeritsTitle:setAlignment(Enum[0x7A5123B654282D2][0x6ED4298C93DC5ED])
	...
	Rule3:setAlpha(0.6)
	Rule3:setImage(RegisterImage(0xB20AD7A31239369))
	...
	Rule4:setAlpha(0)
	Rule4:setImage(RegisterImage(0xB20AD7A31239369))
	...
	Rule5:setAlpha(0)
	Rule5:setImage(RegisterImage(0xB20AD7A31239369))
	...
	Rule2:setAlpha(0.6)
	Rule2:setImage(RegisterImage(0xB20AD7A31239369))
	...
	Rule1:setAlpha(0.6)
	Rule1:setImage(RegisterImage(0xB20AD7A31239369))
