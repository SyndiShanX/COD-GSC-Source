...
CoD.DeployableNotifications_SensorDart.__resetProperties = function(f9_arg0)
	...
	f9_arg0.bottombar:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
...
CoD.DeployableNotifications_SensorDart.__clipsPerState = {
	DefaultState = {
		...
		OneDart = function(f11_arg0, f11_arg1)
			...
			f11_arg0.bottombar:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
	...
	OneDart = {
		DefaultClip = function(f17_arg0, f17_arg1)
			...
			f17_arg0.bottombar:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
		...
		DefaultState = function(f18_arg0, f18_arg1)
			...
			f18_arg0.bottombar:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
		...
		TwoDarts = function(f25_arg0, f25_arg1)
			...
			f25_arg0.bottombar:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
	...
	TwoDarts = {
		DefaultClip = function(f28_arg0, f28_arg1)
			...
			f28_arg0.bottombar:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
		...
		OneDart = function(f29_arg0, f29_arg1)
			...
			f29_arg0.bottombar:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
		...
		ThreeDarts = function(f32_arg0, f32_arg1)
			...
			f32_arg0.bottombar:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
	...
	ThreeDarts = {
		DefaultClip = function(f36_arg0, f36_arg1)
			...
			f36_arg0.bottombar:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
		...
		FourDarts = function(f41_arg0, f41_arg1)
			...
			f41_arg0.bottombar:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
