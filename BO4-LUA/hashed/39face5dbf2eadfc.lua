...
CoD.AARTierRewardColumnHeader.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	CommonOuterGlowThinVert:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_6DAB59B2CAE01851"))
	...
	CommonOuterGlow01:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_6DAB59B2CAE01851"))
	...
	StripesBtm:setImage(RegisterImage(@"hash_2C7A051F5EFC70E5"))
	StripesBtm:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16CBE95C250C6D15"))
	...
	StripesTop:setImage(RegisterImage(@"hash_2C7A051F5EFC70E5"))
	StripesTop:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16CBE95C250C6D15"))
	...
	Tier:setText(Engine[@"hash_4F9F1239CFD921FE"](@"menu/new"))
	Tier:setTTF("ttmussels_demibold")
	Tier:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	Tier:setShaderVector(0, 1, 0, 0, 0)
	Tier:setShaderVector(1, 0, 0, 0, 0)
	Tier:setShaderVector(2, 1, 0.32, 0, 0)
	Tier:setLetterSpacing(3)
	Tier:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	Tier:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
