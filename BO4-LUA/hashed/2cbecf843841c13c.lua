...
CoD.ButtonFrame_ArenaBarracksStats_Firstplace.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	StatsValue:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	StatsValue:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
	...
	FirstPlaceTitle:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_44916FF71F124343"))
	FirstPlaceTitle:setTTF("ttmussels_regular")
	FirstPlaceTitle:setLetterSpacing(1)
	FirstPlaceTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	FirstPlaceTitle:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
