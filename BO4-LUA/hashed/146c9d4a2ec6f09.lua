...
CoD.Prestige_Fanfare.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	GridBg:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	PrestigeTitle:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_2157400D2DF93470"))
	PrestigeTitle:setTTF("dinnext_regular")
	PrestigeTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	PrestigeTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	PrestigeTitle2:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_25C5D3FB80D2A515"))
	PrestigeTitle2:setTTF("ttmussels_regular")
	PrestigeTitle2:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
		...
		ShowPrestige = function(f4_arg0, f4_arg1)
					...
					local f26_local0 = function(f27_arg0)
						local f27_local0 = function(f28_arg0)
							local f28_local0 = function(f29_arg0)
								f29_arg0:beginAnimation(1000, Enum[@"luitween"][@"luitween_ease_both"])
								f29_arg0:setAlpha(0)
			...
			local f4_local7 = function(f30_arg0)
				local f30_local0 = function(f31_arg0)
					local f31_local0 = function(f32_arg0)
						f32_arg0:beginAnimation(1000, Enum[@"luitween"][@"luitween_ease_out"])
						f32_arg0:setAlpha(0)
				...
				f4_arg0.PrestigeTitle:beginAnimation(500, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f4_local8 = function(f33_arg0)
				local f33_local0 = function(f34_arg0)
					local f34_local0 = function(f35_arg0)
						f35_arg0:beginAnimation(1000, Enum[@"luitween"][@"luitween_ease_out"])
						f35_arg0:setAlpha(0)
				...
				f4_arg0.PrestigeTitle2:beginAnimation(500, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f4_local9 = function(f36_arg0)
				local f36_local0 = function(f37_arg0)
					...
					f37_arg0:beginAnimation(229, Enum[@"luitween"][@"luitween_ease_in"])
