...
CoD.IGRPerksDirectorButton.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	ActiveText:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_444C98BBF9AFAD5"))
	ActiveText:setTTF("ttmussels_regular")
	ActiveText:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	ActiveText:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
