...
CoD.PositionDraft_StatusBanner.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	ArrowBL:setZRot(90)
	ArrowBL:setImage(RegisterImage(0x1226A0CC6137EEE))
	...
	ArrowTR:setZRot(-90)
	ArrowTR:setImage(RegisterImage(0x1226A0CC6137EEE))
	...
	ArrowBR:setZRot(90)
	ArrowBR:setImage(RegisterImage(0x1226A0CC6137EEE))
	...
	BotBarAdd:setImage(RegisterImage(0xB66E349310D9B93))
	...
	TopBar:setAlpha(0.5)
	TopBar:setImage(RegisterImage(0xAC381499DAAF90D))
	...
	TopBarAdd:setImage(RegisterImage(0xAC381499DAAF90D))
