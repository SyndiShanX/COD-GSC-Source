...
require("x64:7935bd4c2250126")
require("x64:3e58edf544a2163")
...
CoD.SupplyChainStreamInternal.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	NineSliceShaderImage:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_3E7BDCB879A5176D"))
	...
	EventTimeRemaining:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	EventTimeRemaining:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	EventTimeRemaining:subscribeToGlobalModel(f1_arg1, "AutoEvents", "loot_event_stream_timer", function(model)
		local f3_local0 = model:get()
		if f3_local0 ~= nil then
			EventTimeRemaining:setText(LocalizeIntoStringIfNotEmpty(@"hash_1C0CE2452CF87DB1", f3_local0))
		end
	end)
	...
	SeasonTimeRemaining:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	SeasonTimeRemaining:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	ContractTimeRemaining:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	ContractTimeRemaining:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	ContractTimeRemaining:subscribeToGlobalModel(f1_arg1, "ItemshopRotation", "loot_itemshop_slot3_timer", function(model)
		local f6_local0 = model:get()
		if f6_local0 ~= nil then
			ContractTimeRemaining:setText(LocalizeIntoStringIfNotEmpty(@"hash_890CD07DDE9B131", f6_local0))
		end
	end)
	...
	NextContractTimeRemaining:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	NextContractTimeRemaining:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	NextContractTimeRemaining:subscribeToGlobalModel(f1_arg1, "ItemshopRotation", "loot_itemshop_slot3_timer", function(model)
		...
		if f7_local0 ~= nil then
			NextContractTimeRemaining:setText(LocalizeIntoStringIfNotEmpty(@"hash_5AAA70C5480C51D2", f7_local0))
		end
	end)
	...
	StreamSubtitle:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	StreamSubtitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	StreamSubtitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	StreamName:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	StreamName:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	StreamName:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	FeatureTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	FeatureTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
