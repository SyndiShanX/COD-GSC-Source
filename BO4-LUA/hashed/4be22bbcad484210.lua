...
CoD.PC_IGR_AAR_BonusXP.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	IGRPerkElement2.PerkLogo:setImage(RegisterImage(0x8FBBCE5058992F3))
	IGRPerkElement2.PerkText:setText(CoD.PCKoreaUtility.InjectBonusGunXP(0x936FCC81C9EE8D0))
	...
	IGRPerkElement3.PerkLogo:setImage(RegisterImage(0xC1460CF69AB482B))
	IGRPerkElement3.PerkText:setText(CoD.PCKoreaUtility.InjectBonusCredits(0x327C56902BCB8A5))
	...
	IGRPerkElement1.PerkLogo:setImage(RegisterImage(0xCFD527F0E4A01CE))
	IGRPerkElement1.PerkText:setText(CoD.PCKoreaUtility.InjectBonusXP(0xD38DFFC56710A2B))
