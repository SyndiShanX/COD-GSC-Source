...
LUI.createMenu.PositionDraft_Teams = function(f1_arg0, f1_arg1)
	...
	VS2:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	VS2:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	self:addElement(VS2)
	self.VS2 = VS2
	...
	EnemyTeam:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	...
	EnemyTeamCodCaster:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	...
	FriendlyTeam:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	...
	FriendlyTeamCodCaster:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	...
	local f1_local29 = Engine[0x4DF5CFBC1771947](f1_arg0)
	...
	f1_local1:AddButtonCallbackFunction(self, f1_arg0, Enum[0x3DD78803F918E9D][0x805EFA15E9E7E5A], nil, function(element, menu, controller, model)
		...
		CoD.Menu.SetButtonLabel(menu, Enum[0x3DD78803F918E9D][0x805EFA15E9E7E5A], 0x972E7D1EB1EF77F, nil, nil)
		return true
	end, false)
	f1_local1:AddButtonCallbackFunction(self, f1_arg0, Enum[0x3DD78803F918E9D][0x93AB4C84F113EE1], "TAB", function(element, menu, controller, model)
		GoBack(self, controller)
		return true
	end, function(element, menu, controller)
		CoD.Menu.SetButtonLabel(menu, Enum[0x3DD78803F918E9D][0x93AB4C84F113EE1], 0x0, nil, "TAB")
		return false
	end, false)
