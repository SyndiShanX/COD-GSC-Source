...
CoD.GameEndScore_WeaponIdentity.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	TickMarkLeft:setImage(RegisterImage(@"hash_2E9EFAE37B6F52A6"))
	...
	TickMarkRight:setImage(RegisterImage(@"hash_2E9EFAE37B6F52A6"))
	...
	HeaderTextBoxShadow:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_2AE166D9BA8C6907"))
	...
	HeaderTextBoxShadow:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	...
	WeaponName:linkToElementModel(self, "weaponName", true, function(model)
		...
		if f3_local0 ~= nil then
			WeaponName:setText(Engine[@"hash_4F9F1239CFD921FE"](f3_local0))
		end
	end)
