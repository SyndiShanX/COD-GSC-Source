...
LUI.createMenu.SpecialDealConfirmation = function(f1_arg0, f1_arg1)
	...
	Tiers:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	Tiers:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	local f1_local22 = Engine[0x4DF5CFBC1771947](f1_arg0)
	...
	if IsPC() then
		CoD.PCUtility.LinkPCSmallCloseButtonToInput(f1_local1, f1_arg0, f1_local22, Enum[0x3DD78803F918E9D][0x805EFA15E9E7E5A])
	end
	return self
end
