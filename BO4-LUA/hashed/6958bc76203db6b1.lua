...
CoD.ZMInvChallengeProgress.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	CurrentProgress:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	CurrentProgress:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	CurrentProgressTime:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	CurrentProgressTime:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	Divider:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	Divider:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	NumNeeded:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	NumNeeded:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
