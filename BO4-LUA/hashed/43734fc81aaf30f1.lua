...
CoD.DupeMarker.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	RerollLabel:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	RerollLabel:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	DupeLabel:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	DupeLabel:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	ReserveLabel:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	ReserveLabel:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	ReserveIcon:setImage(RegisterImage(@"hash_73AFA9E5CE99FEDF"))
