...
CoD.SwipeTak5_CharacterPortrait.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	PlayerBgGrid:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	ClanAndGamerName:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_2AE166D9BA8C6907"))
	...
	ClanAndGamerName:setAlignment(Engine[@"hash_67F8853DC3581AA4"](Enum[@"luialignment"][@"lui_alignment_center"]))
	...
	PlayerImage:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_1A02C44161370F6D"))
	...
	DeadStipe:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	DeadStipeAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	FrameTop:setImage(RegisterImage(@"hash_47722C79022535EA"))
	...
	OperatorIndicator:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	RepeatLine:setImage(RegisterImage(@"hash_484B43D5B04D263A"))
	RepeatLine:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	RepeatDotline:setImage(RegisterImage(@"hash_6F5E8F1B8586D9C5"))
	RepeatDotline:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	CornerPips:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
...
CoD.SwipeTak5_CharacterPortrait.__resetProperties = function(f13_arg0)
	...
	f13_arg0.TiledBackingAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
...
CoD.SwipeTak5_CharacterPortrait.__clipsPerState = {
	DefaultState = {
		DefaultClip = function(f14_arg0, f14_arg1)
			...
			local f14_local0 = function(f15_arg0)
				...
				f14_arg0.ScorePip:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f14_local1 = function(f18_arg0)
				...
				f14_arg0.CornerPips:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
	...
	InvalidClient = {
		DefaultClip = function(f21_arg0, f21_arg1)
			...
			f21_arg0.TiledBackingAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	Dead = {
		DefaultClip = function(f22_arg0, f22_arg1)
			...
			local f22_local0 = function(f23_arg0)
				local f23_local0 = function(f24_arg0)
					local f24_local0 = function(f25_arg0)
						f25_arg0:beginAnimation(750, Enum[@"luitween"][@"luitween_ease_both"])
				...
				f22_arg0.DeadStipeAdd:beginAnimation(750, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f22_local1 = function(f26_arg0)
				...
				f22_arg0.skull:beginAnimation(750, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_out"])
	...
	Self = {
		DefaultClip = function(f29_arg0, f29_arg1)
			...
			local f29_local1 = function(f33_arg0)
				...
				f29_arg0.OperatorIndicator:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f29_local2 = function(f36_arg0)
				...
				f29_arg0.CornerPips:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_both"])
