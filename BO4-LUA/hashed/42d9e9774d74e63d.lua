...
CoD.GameEndScore_Placement.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	TextElimination:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	TextElimination:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	...
	TextMatchOutcome:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	TextMatchOutcome:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	...
	HeaderTextTeamRank:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	HeaderTextTeamRank:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
