...
CoD.SupplyChainItemReveal.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	ThinGlowMid:setImage(RegisterImage(0x223AD1B40A93955))
	...
	ThinGlowRight:setImage(RegisterImage(0x223AD1B40A93955))
	...
	ThinGlowLeft:setImage(RegisterImage(0x223AD1B40A93955))
