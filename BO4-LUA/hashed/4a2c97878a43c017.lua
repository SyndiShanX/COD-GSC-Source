...
LUI.createMenu.PurchaseTiersConfirmation = function(f1_arg0, f1_arg1)
	...
	FullscreenPopupTemplate.Subtitle:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_473FB71DD306C936"))
	FullscreenPopupTemplate.ErrorSubtitle:setText(LocalizeToUpperString(@"hash_3A3298EE0A8F4603"))
	FullscreenPopupTemplate.WorkingTitle:setText(LocalizeToUpperString(@"menu/purchase_processing"))
	FullscreenPopupTemplate.Title:setText(LocalizeToUpperString(@"hash_68CCB8B7EF76929B"))
	...
	TextBGBox:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16CBE95C250C6D15"))
	...
	Tiers:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_593F361CC41C94AF"))
	...
	Tiers:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	Tiers:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	ImagePrompt.ImagePromptInternal.warningTextPrompt:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_2AB9A04058E8DADC"))
	...
	if IsPC() then
		CoD.PCUtility.LinkPCSmallCloseButtonToInput(f1_local1, f1_arg0, f1_local21, Enum[@"luibutton"][@"lui_key_xbb_pscircle"])
	end
	return self
end
