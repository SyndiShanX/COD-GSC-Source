require("x64:45111f049e24a81")
require("x64:ec94048bad1fbac")
require("x64:eb274d1dc908cc6")
require("x64:dd2fb2034a0f264")
...
CoD.BountyHunterPackagePreview.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Type:setText("")
	Type:setTTF("default")
	Type:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	Type:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	self:addElement(Type)
	self.Type = Type
	local Cost = LUI.UIText.new(0, 0, 4.5, 373.5, 1, 1, -62, -45)
	Cost:setRGB(0.54, 0.55, 0.58)
	Cost:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_3E14C0D42B565C03"))
	...
	SingleItemName:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	...
	SingleItemDescription:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	SingleItemDescription:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	SingleItemDescription:linkToElementModel(self, "item1.description", true, function(model)
		local f3_local0 = model:get()
		if f3_local0 ~= nil then
			SingleItemDescription:setText(Engine[@"hash_4F9F1239CFD921FE"](f3_local0))
		end
	end)
	...
	VerticalAccentBL:setImage(RegisterImage(@"hash_2FE30A9AF719A400"))
	...
	VerticalAccentBR:setImage(RegisterImage(@"hash_2FE30A9AF719A400"))
	...
	VerticalAccentBL2:setImage(RegisterImage(@"hash_2FE30A9AF719A400"))
	...
	VerticalAccentBR2:setImage(RegisterImage(@"hash_2FE30A9AF719A400"))
...
CoD.BountyHunterPackagePreview.__clipsPerState = {
	...
	Weapon = {
		DefaultClip = function(f22_arg0, f22_arg1)
			...
			f22_arg0.SingleItemName:setAlignment(Enum[@"luialignment"][@"lui_alignment_bottom"])
