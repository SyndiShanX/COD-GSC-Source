...
CoD.ZMSpecialWeapon_StageInfo.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Stage:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	Stage:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	Stage:linkToElementModel(self, "displayName", true, function(model)
		local f2_local0 = model:get()
		if f2_local0 ~= nil then
			Stage:setText(Engine[@"hash_4F9F1239CFD921FE"](f2_local0))
		end
	end)
...
CoD.ZMSpecialWeapon_StageInfo.__resetProperties = function(f4_arg0)
	...
	f4_arg0.Name:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
...
CoD.ZMSpecialWeapon_StageInfo.__clipsPerState = {
	DefaultState = {
		...
		Focus = function(f6_arg0, f6_arg1)
			...
			f6_arg0.Name:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
