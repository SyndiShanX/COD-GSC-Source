...
CoD.WarzoneGameStatusIndicatorListItem.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	mainText:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	mainTextX:setText(Engine[@"hash_4F9F1239CFD921FE"](@"wz/x"))
	mainTextX:setTTF("0arame_mono_stencil")
	mainTextX:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	mainTextX:setShaderVector(0, 0.8, 0, 0, 0)
	mainTextX:setShaderVector(1, 0, 0, 0, 0)
	mainTextX:setShaderVector(2, 1, 1, 1, 0.35)
	mainTextX:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	...
	secondText:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	secondText:setShaderVector(0, 0.8, 0, 0, 0)
	secondText:setShaderVector(1, 0, 0, 0, 0)
	secondText:setShaderVector(2, 1, 1, 1, 0.35)
	secondText:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	...
	spectatorsAddText:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	spectatorsAddText:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	...
	spectatorsAddTextX:setText(Engine[@"hash_4F9F1239CFD921FE"](@"wz/x"))
	spectatorsAddTextX:setTTF("0arame_mono_stencil")
	spectatorsAddTextX:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	spectatorsAddTextX:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
...
CoD.WarzoneGameStatusIndicatorListItem.__clipsPerState = {
	...
	PlayersAlivePandemicInfected = {
		DefaultClip = function(f18_arg0, f18_arg1)
			...
			f18_arg0.mainText:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
			...
			f18_arg0.secondText:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
			...
			f18_arg0.iconPandemic:setImage(RegisterImage(@"hash_7EAC82FFC1BA9E1"))
	...
	PlayersAlivePandemic = {
		DefaultClip = function(f19_arg0, f19_arg1)
			...
			f19_arg0.mainText:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
			...
			f19_arg0.secondText:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
			...
			f19_arg0.iconPandemicEnemy:setImage(RegisterImage(@"hash_7EAC82FFC1BA9E1"))
	...
	PlayersAliveBigTeam = {
		DefaultClip = function(f20_arg0, f20_arg1)
			...
			f20_arg0.mainText:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
			...
			f20_arg0.secondText:setAlignment(Enum[@"luialignment"][@"hash_E821F0ECFF8D1C7"])
		...
		ValueUpdate = function(f37_arg0, f37_arg1)
			...
			local f37_local2 = function(f43_arg0)
				local f43_local0 = function(f44_arg0)
					...
					f44_arg0:beginAnimation(229, Enum[@"luitween"][@"luitween_bounce"])
