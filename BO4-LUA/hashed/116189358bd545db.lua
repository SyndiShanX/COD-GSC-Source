...
CoD.ZM_Tutorial_Certificate.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Certificate:setImage(RegisterImage(@"hash_13BB7FBDE140EE1"))
	self:addElement(Certificate)
	self.Certificate = Certificate
	local Blood = LUI.UIImage.new(0.5, 0.5, -960, 960, 0.5, 0.5, -540, 540)
	Blood:setImage(RegisterImage(@"hash_3A7AA4C2313C3FF2"))
	...
	Line1:setRGB(0, 0, 0)
	Line1:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_A3986D664860FEA"))
	Line1:setTTF("default")
	Line1:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	...
	Line2:setRGB(0, 0, 0)
	Line2:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_A3985D664860E37"))
	Line2:setTTF("default")
	Line2:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	...
	Line3:setRGB(0, 0, 0)
	Line3:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_A3984D664860C84"))
	Line3:setTTF("default")
	Line3:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	...
	Line3Shadow:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_A3984D664860C84"))
	Line3Shadow:setTTF("default")
	Line3Shadow:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	self:addElement(Line3Shadow)
	self.Line3Shadow = Line3Shadow
	local Line4 = LUI.UIText.new(0, 0, 719.5, 1200.5, 0, 0, 466, 496)
	Line4:setRGB(0, 0, 0)
	Line4:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_A3983D664860AD1"))
	Line4:setTTF("default")
	Line4:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	...
	Line5:setRGB(0, 0, 0)
	Line5:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_A3982D66486091E"))
	Line5:setTTF("default")
	Line5:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	...
	Line6:setRGB(0, 0, 0)
	Line6:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_A3981D66486076B"))
	Line6:setTTF("default")
	Line6:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
