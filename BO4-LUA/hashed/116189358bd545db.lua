...
CoD.ZM_Tutorial_Certificate.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Line1:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	Line1:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	Line2:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	Line2:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	Line3:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	...
	Line3Shadow:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	...
	Line4:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	Line4:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	Line5:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	Line5:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	Line6:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	self:addElement(Line6)
	self.Line6 = Line6
	self:subscribeToGlobalModel(f1_arg1, "PerController", "scriptNotify", function(model)
		local f4_local0 = self
		if CoD.ModelUtility.IsParamModelEqualToHashString(model, 0x4FAFC5DE45F047) and CoD.HUDUtility.IsAnyGameType(f1_arg1, "ztutorial") then
