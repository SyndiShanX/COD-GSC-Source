...
CoD.WarzoneInventoryPickupNotification.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	PickedUpText:setText(Engine[@"hash_4F9F1239CFD921FE"](@"menu/new"))
	PickedUpText:setTTF("ttmussels_regular")
	PickedUpText:setLetterSpacing(1)
	PickedUpText:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	PickedUpText:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
			...
			local f4_local0 = function(f5_arg0)
				local f5_local0 = function(f6_arg0)
					local f6_local0 = function(f7_arg0)
						f7_arg0:beginAnimation(200, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
						f7_arg0:setAlpha(0)
				...
				f4_arg0.PickedUpText:beginAnimation(300, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_both"])
