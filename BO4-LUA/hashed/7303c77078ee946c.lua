...
CoD.remoteMissileTargetLockonInternal.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	BaseLine:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_F755127C95CF5B6"))
	...
	BaseAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	ReticleAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	HawkLockOnTertiaryAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	LockonHawk = {
		...
		DefaultState = function(f31_arg0, f31_arg1)
			...
			local f31_local0 = function(f32_arg0)
					...
					local f33_local0 = function(f34_arg0)
						local f34_local0 = function(f35_arg0)
							local f35_local0 = function(f36_arg0)
								f36_arg0:beginAnimation(109, Enum[@"luitween"][@"luitween_ease_in"])
				...
				f31_arg0.HawkLockOnTertiary:beginAnimation(80, Enum[@"luitween"][@"luitween_ease_out"])
		...
		Killed = function(f44_arg0, f44_arg1)
			...
			local f44_local2 = function(f47_arg0)
				...
				f44_arg0.HawkEKIA:beginAnimation(180, Enum[@"luitween"][@"luitween_ease_out"])
		...
		DefaultClip = function(f57_arg0, f57_arg1)
			...
			local f57_local3 = function(f88_arg0)
				local f88_local0 = function(f89_arg0)
					f89_arg0:beginAnimation(300, Enum[@"luitween"][@"luitween_ease_in"])
			...
			local f57_local4 = function(f90_arg0)
				local f90_local0 = function(f91_arg0)
					...
					f91_arg0:beginAnimation(300, Enum[@"luitween"][@"luitween_ease_in"])
					f91_arg0:setAlpha(1)
					f91_arg0:setZRot(45)
