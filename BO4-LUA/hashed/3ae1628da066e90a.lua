...
CoD.TabletTak5_PlayerInfo.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	PlayerInfoGrid:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	YouString:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_51F9844545CB4FF6"))
	YouString:setTTF("dinnext_regular")
	YouString:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	...
	InfoHeartAdd:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	SearchingString:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_2660F4D87BFCE63"))
	SearchingString:setTTF("dinnext_regular")
	SearchingString:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	SearchingString:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	NoTargetText:setText(LocalizeToUpperString(@"hash_441C813D62359384"))
	NoTargetText:setTTF("dinnext_regular")
	NoTargetText:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_171E049B161CD00A"))
	NoTargetText:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	NoTargetText:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	MaxedOutString:setText(LocalizeToUpperString(@"hash_DF37DF17685ED6D"))
	MaxedOutString:setTTF("dinnext_regular")
	MaxedOutString:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_171E049B161CD00A"))
	MaxedOutString:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	MaxedOutString:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	HealIndicator:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
...
CoD.TabletTak5_PlayerInfo.__resetProperties = function(f10_arg0)
	...
	f10_arg0.PlayerInfoGrid:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	f10_arg0.MaxedOutString:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_171E049B161CD00A"))
...
CoD.TabletTak5_PlayerInfo.__clipsPerState = {
	DefaultState = {
		DefaultClip = function(f11_arg0, f11_arg1)
			...
			f11_arg0.PlayerInfoGrid:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	Self = {
		DefaultClip = function(f16_arg0, f16_arg1)
			...
			f16_arg0.PlayerInfoGrid:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	MaxedOut = {
		DefaultClip = function(f21_arg0, f21_arg1)
			...
			f21_arg0.PlayerInfoGrid:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
			...
			f21_arg0.MaxedOutString:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_171E049B161CD00A"))
	...
	NoTarget = {
		DefaultClip = function(f32_arg0, f32_arg1)
			...
			f32_arg0.PlayerInfoGrid:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
				...
				local f35_local0 = function(f36_arg0)
					local f36_local0 = function(f37_arg0)
						local f37_local0 = function(f38_arg0)
							f38_arg0:beginAnimation(299, Enum[@"luitween"][@"luitween_ease_both"])
					...
					f36_arg0:beginAnimation(450, Enum[@"luitween"][@"luitween_ease_both"])
