...
CoD.GameEndScore_KillerIdentity.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Rank.__String_Reference = function(f9_arg0)
		...
		if f9_local0 ~= nil then
			Rank:setText(CoD.PrestigeUtility.LocalizeIfMaxRank(@"hash_54008CE61FE52DCD", SetValueIfEmptyString("1", f9_local0)))
		end
	end
	...
	TextBoxShadow:setText(LocalizeToUpperString(@"hash_5384588C2F4949A5"))
	TextBoxShadow:setTTF("ttmussels_demibold")
	TextBoxShadow:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_2AE166D9BA8C6907"))
	...
	TextBoxShadow:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	...
	TextBox:setAlpha(0)
	TextBox:setText(LocalizeToUpperString(@"hash_5384588C2F4949A5"))
