...
LUI.createMenu.zm_laststand_client = function(f1_arg0, f1_arg1)
							...
							if not f6_local0 then
								if Engine[0xDD333420C49E6D0](f1_arg0, Enum[0x7F032C2EF103A1A][0xADC477DDE486DD7]) then
									...
									if not f6_local0 then
										...
										if not f6_local0 then
											f6_local0 = Engine[0xDD333420C49E6D0](f1_arg0, Enum[0x7F032C2EF103A1A][0xA77EB9347BE4DFF])
											if not f6_local0 then
												...
												if not f6_local0 then
													...
													if not f6_local0 then
														f6_local0 = Engine[0xDD333420C49E6D0](f1_arg0, Enum[0x7F032C2EF103A1A][0xF4EDA8B636F3F04])
														if not f6_local0 then
															f6_local0 = Engine[0xDD333420C49E6D0](f1_arg0, Enum[0x7F032C2EF103A1A][0x1E59914E91E423A])
															if not f6_local0 then
																f6_local0 = Engine[0xDD333420C49E6D0](f1_arg0, Enum[0x7F032C2EF103A1A][0xA69E34E231CE8B6])
																if not f6_local0 then
																	f6_local0 = not Engine[0xDD333420C49E6D0](f1_arg0, Enum[0x7F032C2EF103A1A][0xBB045E46E88E762])
																end
															end
														end
													end
	...
	f1_local13 = Engine[0x4DF5CFBC1771947](f1_arg0)
	f1_local12(f1_local11, f1_local13["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0xB8E9B69F4B87954]], function(f10_arg0)
		f1_local1:updateElementState(self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	f1_local12 = self.subscribeToModel
	f1_local13 = Engine[0x4DF5CFBC1771947](f1_arg0)
	f1_local12(f1_local11, f1_local13["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0xD3ABF9A2753CE40]], function(f11_arg0)
		f1_local1:updateElementState(self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	f1_local12 = self.subscribeToModel
	f1_local13 = Engine[0x4DF5CFBC1771947](f1_arg0)
	f1_local12(f1_local11, f1_local13["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0x1CDCB451655ABCF]], function(f12_arg0)
		f1_local1:updateElementState(self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	f1_local12 = self.subscribeToModel
	f1_local13 = Engine[0x4DF5CFBC1771947](f1_arg0)
	f1_local12(f1_local11, f1_local13["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0x198075B069840DC]], function(f13_arg0)
		f1_local1:updateElementState(self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	f1_local12 = self.subscribeToModel
	f1_local13 = Engine[0x4DF5CFBC1771947](f1_arg0)
	f1_local12(f1_local11, f1_local13["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0xADC477DDE486DD7]], function(f14_arg0)
		f1_local1:updateElementState(self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	f1_local12 = self.subscribeToModel
	f1_local13 = Engine[0x4DF5CFBC1771947](f1_arg0)
	f1_local12(f1_local11, f1_local13["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0x23CD9BAB9B9F4C8]], function(f15_arg0)
		f1_local1:updateElementState(self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	f1_local12 = self.subscribeToModel
	f1_local13 = Engine[0x4DF5CFBC1771947](f1_arg0)
	f1_local12(f1_local11, f1_local13["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0x8A5E996D4528DA2]], function(f16_arg0)
		f1_local1:updateElementState(self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	f1_local12 = self.subscribeToModel
	f1_local13 = Engine[0x4DF5CFBC1771947](f1_arg0)
	f1_local12(f1_local11, f1_local13["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0xA77EB9347BE4DFF]], function(f17_arg0)
		f1_local1:updateElementState(self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	f1_local12 = self.subscribeToModel
	f1_local13 = Engine[0x4DF5CFBC1771947](f1_arg0)
	f1_local12(f1_local11, f1_local13["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0x24E603C16FCC38F]], function(f18_arg0)
		f1_local1:updateElementState(self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	f1_local12 = self.subscribeToModel
	f1_local13 = Engine[0x4DF5CFBC1771947](f1_arg0)
	f1_local12(f1_local11, f1_local13["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0x4828BED794DA0A5]], function(f19_arg0)
		f1_local1:updateElementState(self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	f1_local12 = self.subscribeToModel
	f1_local13 = Engine[0x4DF5CFBC1771947](f1_arg0)
	f1_local12(f1_local11, f1_local13["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0xF4EDA8B636F3F04]], function(f20_arg0)
		f1_local1:updateElementState(self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	f1_local12 = self.subscribeToModel
	f1_local13 = Engine[0x4DF5CFBC1771947](f1_arg0)
	f1_local12(f1_local11, f1_local13["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0x1E59914E91E423A]], function(f21_arg0)
		f1_local1:updateElementState(self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	f1_local12 = self.subscribeToModel
	f1_local13 = Engine[0x4DF5CFBC1771947](f1_arg0)
	f1_local12(f1_local11, f1_local13["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0xA69E34E231CE8B6]], function(f22_arg0)
		f1_local1:updateElementState(self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	f1_local12 = self.subscribeToModel
	f1_local13 = Engine[0x4DF5CFBC1771947](f1_arg0)
	f1_local12(f1_local11, f1_local13["UIVisibilityBit." .. Enum[0x7F032C2EF103A1A][0xBB045E46E88E762]], function(f23_arg0)
		f1_local1:updateElementState(self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
