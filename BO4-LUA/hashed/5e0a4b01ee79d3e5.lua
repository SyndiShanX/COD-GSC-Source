...
CoD.DeployableNotifications_MedicCleanse.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	arcWide:setXRot(180)
	arcWide:setYRot(180)
	arcWide:setImage(RegisterImage(@"hash_749747A311563706"))
	...
	arc:setXRot(180)
	arc:setYRot(180)
	arc:setImage(RegisterImage(@"hash_535ED854EF45231A"))
	...
	iconBacker:setImage(RegisterImage(@"hash_23196FD58747E81E"))
	...
	icon:setAlpha(0)
	icon:setImage(RegisterImage(@"hash_6FD4A5102910318B"))
	...
	CurrentCounter:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	CurrentCounter:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	PreviousCounter:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	PreviousCounter:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
