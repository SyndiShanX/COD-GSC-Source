...
CoD.DeployableNotifications_MedicCleanse.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	arcWide:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
	...
	arc:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
	...
	CurrentCounter:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	CurrentCounter:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	PreviousCounter:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	PreviousCounter:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
...
CoD.DeployableNotifications_MedicCleanse.__resetProperties = function(f8_arg0)
	...
	f8_arg0.arc:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
	...
	f8_arg0.arcWide:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
...
CoD.DeployableNotifications_MedicCleanse.__clipsPerState = {
	DefaultState = {
		...
		Active = function(f10_arg0, f10_arg1)
			...
			f10_arg0.arc:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
	...
	Active = {
		DefaultClip = function(f18_arg0, f18_arg1)
			...
			f18_arg0.arc:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
		...
		DefaultState = function(f19_arg0, f19_arg1)
			...
			f19_arg0.arc:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
	...
	Cleanse = {
		...
		DefaultState = function(f28_arg0, f28_arg1)
			...
			f28_arg0.arcWide:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
			...
			f28_arg0.arc:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
