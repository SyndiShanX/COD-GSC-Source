...
CoD.CustomizeIconDetails.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	LevelRequirementText:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	LevelRequirementText:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	LockedVictoryCoinText:setText(LocalizeToUpperString(@"hash_51E811E8A111D6A0"))
	LockedVictoryCoinText:setTTF("ttmussels_regular")
	LockedVictoryCoinText:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	LockedVictoryCoinText:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
