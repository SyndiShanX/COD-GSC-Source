...
CoD.SpecialDeal.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	DescBacking:setMaterial(LUI.UIImage.GetCachedMaterial(0x44484DDFAF5C093))
	...
	DescText:setAlignment(Enum[0x7A5123B654282D2][0x6ED4298C93DC5ED])
	...
	TimerText:setBackingMaterial(LUI.UIImage.GetCachedMaterial(0x44484DDFAF5C093))
