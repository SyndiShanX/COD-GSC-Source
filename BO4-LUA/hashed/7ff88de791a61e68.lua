...
CoD.HealthBar.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Backer:setAlpha(0.7)
	Backer:setYRot(180)
	Backer:setImage(RegisterImage(@"hash_33F02AF56D3B7437"))
	Backer:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_631E7B3C72564429"))
	...
	HealthFill:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_17E89392B94A41DE"))
	...
	LowHealthFill:setImage(RegisterImage(@"hash_5700B275CC09FEF2"))
	LowHealthFill:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_17E89392B94A41DE"))
	...
	WoundBar:setImage(RegisterImage(@"hash_1C31716385F5211C"))
