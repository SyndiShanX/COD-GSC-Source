...
CoD.WeaponBribeItemInternal.__resetProperties = function(f7_arg0)
	...
	f7_arg0.WeaponBribeOwnedStamp.PurchasedTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
end
CoD.WeaponBribeItemInternal.__clipsPerState = {
	DefaultState = {
		...
		LoseFocus = function(f18_arg0, f18_arg1)
			...
			local f18_local2 = function(f21_arg0)
				f18_arg0.FocusBrackets:beginAnimation(60, Enum[@"luitween"][@"luitween_ease_in"])
	...
	Purchased = {
		DefaultClip = function(f25_arg0, f25_arg1)
			...
			f25_arg0.WeaponBribeOwnedStamp.PurchasedTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_right"])
		...
		GainFocus = function(f27_arg0, f27_arg1)
			...
			local f27_local2 = function(f30_arg0)
				local f30_local0 = function(f31_arg0)
					f31_arg0:beginAnimation(50, Enum[@"luitween"][@"luitween_ease_out"])
