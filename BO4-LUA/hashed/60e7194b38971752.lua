...
CoD.WeaponBribeItemInternal.__resetProperties = function(f7_arg0)
	...
	f7_arg0.WeaponBribeOwnedStamp.PurchasedTitle:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
end
CoD.WeaponBribeItemInternal.__clipsPerState = {
	...
	Purchased = {
		DefaultClip = function(f25_arg0, f25_arg1)
			...
			f25_arg0.WeaponBribeOwnedStamp.PurchasedTitle:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
