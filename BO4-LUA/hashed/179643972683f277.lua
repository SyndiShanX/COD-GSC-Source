...
CoD.zm_red_location_text.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	LocationTextDark:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	LocationTextDark:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	LocationText:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	NotInLocation = {
		DefaultClip = function(f6_arg0, f6_arg1)
			...
			local f6_local0 = function(f7_arg0)
				...
				f6_arg0.LocationText:beginAnimation(500, Enum[@"luitween"][@"luitween_ease_in"])
