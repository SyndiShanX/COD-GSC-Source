...
CoD.ArenaGauntletProgressBar.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	ProgressBacking:setImage(RegisterImage(0x75CDE8BCCBD6F24))
	ProgressBacking:setMaterial(LUI.UIImage.GetCachedMaterial(0x31E7B3C72564429))
	...
	ProgressFill:setImage(RegisterImage(0x75CDE8BCCBD6F24))
	ProgressFill:setMaterial(LUI.UIImage.GetCachedMaterial(0x31E7B3C72564429))
