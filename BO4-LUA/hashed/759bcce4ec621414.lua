...
CoD.SwipeTak5_LayoutElements.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	LayoutElementRB:setImage(RegisterImage(@"hash_462FB654884B9D1B"))
	...
	LayoutElementLB:setImage(RegisterImage(@"hash_462FBC54884BA74D"))
	...
	upArrowL:setImage(RegisterImage(@"hash_4FCFCDE5B5BEF0"))
	upArrowL:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	upArrowR:setImage(RegisterImage(@"hash_4FCFCDE5B5BEF0"))
	upArrowR:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	Tak5VersionInfo:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	DefaultState = {
		DefaultClip = function(f3_arg0, f3_arg1)
			...
			local f3_local4 = function(f12_arg0)
				local f12_local0 = function(f13_arg0)
					f13_arg0:beginAnimation(500, Enum[@"luitween"][@"luitween_ease_both"])
					f13_arg0:setAlpha(0.4)
					f13_arg0:registerEventHandler("transition_complete_keyframe", f3_arg0.clipFinished)
				end
				f3_arg0.Tak5VersionInfo:beginAnimation(500, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f3_local5 = function(f14_arg0)
				...
				f3_arg0.ConnectedAdd:beginAnimation(500, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f3_local6 = function(f16_arg0)
				...
				f3_arg0.SectionAGAdd:beginAnimation(500, Enum[@"luitween"][@"luitween_ease_both"])
		...
		Intro = function(f18_arg0, f18_arg1)
			...
			local f18_local0 = function(f19_arg0)
				f19_arg0:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f18_local1 = function(f20_arg0)
				f20_arg0:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f18_local2 = function(f21_arg0)
				local f21_local0 = function(f22_arg0)
					f22_arg0:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
					f22_arg0:registerEventHandler("transition_complete_keyframe", f18_arg0.clipFinished)
				end
				f18_arg0.LayoutLineTR:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f18_local3 = function(f23_arg0)
				local f23_local0 = function(f24_arg0)
					f24_arg0:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
					f24_arg0:registerEventHandler("transition_complete_keyframe", f18_arg0.clipFinished)
				end
				f18_arg0.LayoutLineTL:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f18_local4 = function(f25_arg0)
				local f25_local0 = function(f26_arg0)
					f26_arg0:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
					f26_arg0:registerEventHandler("transition_complete_keyframe", f18_arg0.clipFinished)
				end
				f18_arg0.LayoutLineBL:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f18_local5 = function(f27_arg0)
				local f27_local0 = function(f28_arg0)
					f28_arg0:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
					f28_arg0:registerEventHandler("transition_complete_keyframe", f18_arg0.clipFinished)
				end
				f18_arg0.LayoutLineBR:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f18_local6 = function(f29_arg0)
				f29_arg0:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f18_local7 = function(f30_arg0)
				f30_arg0:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f18_local8 = function(f31_arg0)
				f31_arg0:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f18_local9 = function(f32_arg0)
				f32_arg0:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f18_local10 = function(f33_arg0)
				f33_arg0:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f18_local11 = function(f34_arg0)
				f34_arg0:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f18_local12 = function(f35_arg0)
				f35_arg0:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
			...
			local f18_local13 = function(f36_arg0)
				f36_arg0:beginAnimation(150, Enum[@"luitween"][@"luitween_ease_both"])
