...
CoD.SpecialistDossierInternalBioText.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Header1:setText(LocalizeToUpperString(@"hash_7DF851E1720F9418"))
	Header1:setTTF("ttmussels_regular")
	Header1:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	...
	Header2:setText(LocalizeToUpperString(@"hash_432D390E3FF28B53"))
	Header2:setTTF("ttmussels_regular")
	Header2:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	...
	Header3:setText(LocalizeToUpperString(@"hash_6260D937C768747"))
	Header3:setTTF("ttmussels_regular")
	Header3:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	...
	Header4:setText(LocalizeToUpperString(@"hash_664518911D9EFCCA"))
	Header4:setTTF("ttmussels_regular")
	Header4:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	...
	DOB:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	DOB:subscribeToGlobalModel(f1_arg1, "SpecialistDossier", "DOB", function(model)
		local f3_local0 = model:get()
		if f3_local0 ~= nil then
			DOB:setText(Engine[@"hash_4F9F1239CFD921FE"](f3_local0))
		end
	end)
	self:addElement(DOB)
	self.DOB = DOB
	...
	Nationality:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	Nationality:subscribeToGlobalModel(f1_arg1, "SpecialistDossier", "nationality", function(model)
		local f4_local0 = model:get()
		if f4_local0 ~= nil then
			Nationality:setText(Engine[@"hash_4F9F1239CFD921FE"](f4_local0))
		end
	end)
	...
	Designation:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	Designation:subscribeToGlobalModel(f1_arg1, "SpecialistDossier", "designation", function(model)
		local f5_local0 = model:get()
		if f5_local0 ~= nil then
			Designation:setText(Engine[@"hash_4F9F1239CFD921FE"](f5_local0))
		end
	end)
