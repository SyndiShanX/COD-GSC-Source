...
CoD.BountyHunterPreviewDollars.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Purchased:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_4162FE5AE72BC9F7"))
	Purchased:setTTF("ttmussels_regular")
	Purchased:setLetterSpacing(4)
	Purchased:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	Purchased:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	CostSign:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	CostSign:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
