...
CoD.DiscountTiersWidget.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	TierPurchaseBacking:setImage(RegisterImage(@"hash_9C5333D12FF47"))
	...
	TitlePromo:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	TitlePromo:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	DiscountTextNew:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_5C8629D9F852A2DF"))
	DiscountTextNew:setTTF("ttmussels_demibold")
	DiscountTextNew:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	...
	ReservesItemPurchaseTitle:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	ReservesItemPurchaseTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	ReservesItemPurchaseTitle:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	ReservesItemName:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	ReservesItemName:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	ReservesItemName:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	ReservesItemName:linkToElementModel(self, "name", true, function(model)
		local f12_local0 = model:get()
		if f12_local0 ~= nil then
			ReservesItemName:setText(Engine[@"hash_4F9F1239CFD921FE"](f12_local0))
		end
	end)
	...
	PromoTitle:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	ItemShopDiscountBanner:linkToElementModel(self, "percentOff", true, function(model)
		...
		if f16_local0 ~= nil then
			ItemShopDiscountBanner.Promo:setText(ToUpper(LocalizeIntoString(@"hash_44211D07B481977D", f16_local0)))
		end
	end)
