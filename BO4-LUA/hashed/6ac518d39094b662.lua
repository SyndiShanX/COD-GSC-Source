...
CoD.WZObituaryCalloutContainerKillConfirm = InheritFrom(LUI.UIElement)
CoD.WZObituaryCalloutContainerKillConfirm.__defaultWidth = 550
CoD.WZObituaryCalloutContainerKillConfirm.__defaultHeight = 26
CoD.WZObituaryCalloutContainerKillConfirm.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	local self = LUI.UIHorizontalList.new(f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9, 28, false)
	self:setAlignment(LUI.Alignment.Center)
	self:setClass(CoD.WZObituaryCalloutContainerKillConfirm)
	self.id = "WZObituaryCalloutContainerKillConfirm"
	...
	PlayerName:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	ContribText2:setText(LocalizeToUpperString(@"hash_4656DD61A70ABD85"))
	ContribText2:setTTF("ttmussels_regular")
	ContribText2:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	ContribText2:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
...
CoD.WZObituaryCalloutContainerKillConfirm.__onClose = function(f3_arg0)
