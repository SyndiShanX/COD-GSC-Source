...
CoD.RadiationBlastMeter.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	IconBG:setRGB(0, 0, 0)
	IconBG:setAlpha(0)
	IconBG:setImage(RegisterImage(@"hash_130221F3EBDE187C"))
	...
	MessageText:setText(Engine[@"hash_4F9F1239CFD921FE"](0xF81F0725C61935))
	MessageText:setTTF("ttmussels_regular")
	MessageText:setLetterSpacing(1)
	MessageText:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	MessageText:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	MeltdownText:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_B326F825EA10C28"))
	MeltdownText:setTTF("ttmussels_regular")
	MeltdownText:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	MeltdownText:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	MaximumDamageText:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_310E0C314A2638E9"))
	MaximumDamageText:setTTF("ttmussels_regular")
	MaximumDamageText:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	MaximumDamageText:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
