require("x64:a43ce2da2f8157d")
require("x64:5bf4b6f49c15a4c")
	...
	DefaultState = {
		...
		GainChildFocus = function(f14_arg0, f14_arg1)
			...
			local f14_local0 = function(f15_arg0)
				f14_arg0.Button:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_in"])
		...
		LoseChildFocus = function(f16_arg0, f16_arg1)
			...
			local f16_local0 = function(f17_arg0)
				f16_arg0.Button:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_in"])
	...
	NotAvailable = {
		...
		GainChildFocus = function(f21_arg0, f21_arg1)
			...
			local f21_local0 = function(f22_arg0)
				f21_arg0.Button:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_in"])
		...
		LoseChildFocus = function(f23_arg0, f23_arg1)
			...
			local f23_local0 = function(f24_arg0)
				f23_arg0.Button:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_in"])
	...
	FocusTarget = {
		...
		GainChildFocus = function(f27_arg0, f27_arg1)
			...
			local f27_local0 = function(f28_arg0)
				f27_arg0.Button:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_in"])
		...
		LoseChildFocus = function(f29_arg0, f29_arg1)
			...
			local f29_local0 = function(f30_arg0)
				f29_arg0.Button:beginAnimation(200, Enum[@"luitween"][@"luitween_ease_in"])
