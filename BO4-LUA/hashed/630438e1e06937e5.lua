...
CoD.DeployableNotifications_SpawnBeacon.__resetProperties = function(f7_arg0)
	...
	f7_arg0.arc:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
	...
	f7_arg0.arcWide:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
...
CoD.DeployableNotifications_SpawnBeacon.__clipsPerState = {
	DefaultState = {
		...
		Active = function(f9_arg0, f9_arg1)
			...
			f9_arg0.arc:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
	...
	Active = {
		DefaultClip = function(f16_arg0, f16_arg1)
			...
			f16_arg0.arc:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
		...
		DefaultState = function(f17_arg0, f17_arg1)
			...
			f17_arg0.arc:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
		...
		PlayerSpawned = function(f26_arg0, f26_arg1)
			...
			f26_arg0.arcWide:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
			...
			f26_arg0.arc:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
	...
	Destroyed = {
		DefaultClip = function(f52_arg0, f52_arg1)
			...
			f52_arg0.arc:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
	...
	Replacing = {
		DefaultClip = function(f65_arg0, f65_arg1)
			...
			f65_arg0.arc:setMaterial(LUI.UIImage.GetCachedMaterial(0xE992BD5A540E2D))
