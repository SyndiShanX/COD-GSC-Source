...
CoD.SubtitleEntry.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	glow:setRGB(0, 0, 0)
	glow:setTTF("default")
	glow:setMaterial(LUI.UIImage.GetCachedMaterial(0xAE166D9BA8C6907))
	glow:setShaderVector(0, 0.4, 0, 0, 0)
	glow:setShaderVector(1, -0.7, 0, 0, 0)
	glow:setShaderVector(2, 1, 0, 0, 0)
	glow:setAlignment(Enum[0x7A5123B654282D2][0xFEEB12BCB0D7041])
	glow:setAlignment(Enum[0x7A5123B654282D2][0xF41D595A2B0EDF3])
	...
	DefaultState = {
		...
		FadeOut = function(f7_arg0, f7_arg1)
			...
			local f7_local0 = function(f8_arg0)
				f7_arg0.glow:beginAnimation(280, Enum[0xF50FFF429AB1890][0x5D2D9CF90AB1735])
			...
			local f7_local1 = function(f9_arg0)
				f7_arg0.TextBox:beginAnimation(280, Enum[0xF50FFF429AB1890][0x5D2D9CF90AB1735])
		...
		FadeIn = function(f10_arg0, f10_arg1)
			...
			local f10_local0 = function(f11_arg0)
				f10_arg0.glow:beginAnimation(200, Enum[0xF50FFF429AB1890][0x5D2D9CF90AB1735] | Enum[0xF50FFF429AB1890][0x5193EA7825DC097])
			...
			local f10_local1 = function(f12_arg0)
				f10_arg0.TextBox:beginAnimation(200, Enum[0xF50FFF429AB1890][0x5D2D9CF90AB1735] | Enum[0xF50FFF429AB1890][0x5193EA7825DC097])
