...
CoD.StartMenu_Options_PC_Sound_Sound = InheritFrom(LUI.UIElement)
CoD.StartMenu_Options_PC_Sound_Sound.__defaultWidth = 1650
CoD.StartMenu_Options_PC_Sound_Sound.__defaultHeight = 900
CoD.StartMenu_Options_PC_Sound_Sound.new = function(f3_arg0, f3_arg1, f3_arg2, f3_arg3, f3_arg4, f3_arg5, f3_arg6, f3_arg7, f3_arg8, f3_arg9)
	local self = LUI.UIElement.new(f3_arg2, f3_arg3, f3_arg4, f3_arg5, f3_arg6, f3_arg7, f3_arg8, f3_arg9)
	self:setClass(CoD.StartMenu_Options_PC_Sound_Sound)
	self.id = "StartMenu_Options_PC_Sound_Sound"
...
CoD.StartMenu_Options_PC_Sound_Sound.__onClose = function(f6_arg0)
