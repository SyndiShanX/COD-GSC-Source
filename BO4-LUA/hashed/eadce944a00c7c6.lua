...
CoD.ContractItemInternal.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	TileDots:setAlpha(0)
	TileDots:setImage(RegisterImage(@"hash_3C8D2DBD72EBF38"))
	TileDots:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16CBE95C250C6D15"))
	...
	SpecialistName:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_3336C1AE82B1520A"))
	...
	ThemeName:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	ThemeName:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	ThemeName:setAlignment(Enum[@"luialignment"][@"lui_alignment_bottom"])
	...
	OutfitName:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_90D57B1E92D39D7"))
	...
	OutfitName:setAlignment(Enum[@"luialignment"][@"lui_alignment_left"])
	OutfitName:setAlignment(Enum[@"luialignment"][@"lui_alignment_bottom"])
