...
CoD.PositionDraft_StatusBannerFrame.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	TextBackingLeftBlur:setImage(RegisterImage(@"hash_1D78C39F28AB8E39"))
	TextBackingLeftBlur:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_E2354BE557C4C7A"))
	...
	TextBackingRightBlur:setImage(RegisterImage(@"hash_1D78C39F28AB8E39"))
	TextBackingRightBlur:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_E2354BE557C4C7A"))
	...
	TextBackingPC:setImage(RegisterImage(@"hash_43E4122CBBE4A3"))
