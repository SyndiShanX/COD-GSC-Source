...
LUI.createMenu.SpecialistBio = function(f1_arg0, f1_arg1)
	...
	DescBackingTopBar:setImage(RegisterImage(0xC49B0C8991A541F))
	...
	DescBackingBottomBar:setImage(RegisterImage(0xC49B0C8991A541F))
	...
	f1_local1:AddButtonCallbackFunction(self, f1_arg0, Enum[0x3DD78803F918E9D][0x805EFA15E9E7E5A], "ESCAPE", function(element, menu, controller, model)
		...
		CoD.Menu.SetButtonLabel(menu, Enum[0x3DD78803F918E9D][0x805EFA15E9E7E5A], 0xA4032FB2AAB69F2, nil, "ESCAPE")
		return true
	end, false)
