...
CoD.AARTierRewardItemGlowAnimationRare.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	DotPattern:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
	...
	DotPattern2:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_67C9C02F608D0A75"))
		...
		Trigger = function(f10_arg0, f10_arg1)
			...
			local f10_local0 = function(f11_arg0)
				local f11_local0 = function(f12_arg0)
					f12_arg0:beginAnimation(280, Enum[@"luitween"][@"luitween_ease_out"])
					f12_arg0:setAlpha(0)
					f12_arg0:setScale(6, 4)
					f12_arg0:registerEventHandler("transition_complete_keyframe", f10_arg0.clipFinished)
				end
				f10_arg0.FocusHighlight:beginAnimation(120, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f10_local1 = function(f13_arg0)
				local f13_local0 = function(f14_arg0)
					f14_arg0:beginAnimation(280, Enum[@"luitween"][@"luitween_ease_out"])
					f14_arg0:setAlpha(0)
					f14_arg0:setScale(2.75, 2.75)
					f14_arg0:registerEventHandler("transition_complete_keyframe", f10_arg0.clipFinished)
				end
				f10_arg0.FocusHighlight2:beginAnimation(120, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f10_local2 = function(f15_arg0)
				local f15_local0 = function(f16_arg0)
					f16_arg0:beginAnimation(280, Enum[@"luitween"][@"luitween_ease_out"])
					f16_arg0:setAlpha(0)
					f16_arg0:setScale(1.8, 1.25)
					f16_arg0:registerEventHandler("transition_complete_keyframe", f10_arg0.clipFinished)
				end
				f10_arg0.FocusGlow:beginAnimation(120, Enum[@"luitween"][@"luitween_ease_out"])
			...
			local f10_local3 = function(f17_arg0)
				local f17_local0 = function(f18_arg0)
					local f18_local0 = function(f19_arg0)
						f19_arg0:beginAnimation(80, Enum[@"luitween"][@"luitween_ease_out"])
						f19_arg0:setAlpha(0)
			...
			local f10_local4 = function(f20_arg0)
				local f20_local0 = function(f21_arg0)
					local f21_local0 = function(f22_arg0)
						f22_arg0:beginAnimation(120, Enum[@"luitween"][@"luitween_ease_out"])
						f22_arg0:setAlpha(0)
						f22_arg0:setScale(3, 3)
						f22_arg0:registerEventHandler("transition_complete_keyframe", f10_arg0.clipFinished)
					end
					f21_arg0:beginAnimation(40, Enum[@"luitween"][@"luitween_ease_out"])
					f21_arg0:setAlpha(1)
			...
			local f10_local5 = function(f23_arg0)
				local f23_local0 = function(f24_arg0)
					f24_arg0:beginAnimation(400, Enum[@"luitween"][@"luitween_ease_out"])
					f24_arg0:setAlpha(0)
					f24_arg0:setScale(3, 3)
					f24_arg0:registerEventHandler("transition_complete_keyframe", f10_arg0.clipFinished)
				end
				f23_arg0:beginAnimation(280, Enum[@"luitween"][@"luitween_ease_out"])
				f23_arg0:setAlpha(1)
