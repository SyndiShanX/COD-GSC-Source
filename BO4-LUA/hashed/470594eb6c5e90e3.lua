...
CoD.StartMenu_Inventory_SwitchWeaponTab.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	HeaderWeapon:setText(Engine[@"hash_4F9F1239CFD921FE"](@"warzone/weapon_1"))
	...
	HeaderWeapon:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
	...
	HeaderWeaponAsian:setText(Engine[@"hash_4F9F1239CFD921FE"](@"warzone/weapon_1"))
	HeaderWeaponAsian:setTTF("ttmussels_regular")
	HeaderWeaponAsian:setLetterSpacing(4)
	HeaderWeaponAsian:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	HeaderWeaponAsian:setAlignment(Enum[@"luialignment"][@"lui_alignment_top"])
