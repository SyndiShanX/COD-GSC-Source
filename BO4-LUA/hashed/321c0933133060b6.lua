...
CoD.WarzoneInventoryCalloutGestureHintText.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	QuickLabel2:setText(LocalizeToUpperString(0x141F3EAEF2341BB))
	QuickLabel2:setTTF("ttmussels_regular")
	QuickLabel2:setMaterial(LUI.UIImage.GetCachedMaterial(0x90D57B1E92D39D7))
	...
	QuickLabel2:setAlignment(Enum[0x7A5123B654282D2][0x830CFD395E6AA0A])
	QuickLabel2:setAlignment(Enum[0x7A5123B654282D2][0x6ED4298C93DC5ED])
	self:addElement(QuickLabel2)
	self.QuickLabel2 = QuickLabel2
	local QuickLabel3 = LUI.UIText.new(0, 0, 275, 526, 0, 0, 0, 18)
	QuickLabel3:setText(LocalizeToUpperString(0x4A2541E3E7EACED))
	QuickLabel3:setTTF("ttmussels_regular")
	QuickLabel3:setMaterial(LUI.UIImage.GetCachedMaterial(0x90D57B1E92D39D7))
	...
	QuickLabel3:setAlignment(Enum[0x7A5123B654282D2][0x58C8A85F2048829])
	QuickLabel3:setAlignment(Enum[0x7A5123B654282D2][0x6ED4298C93DC5ED])
