...
CoD.PC_Korea_Event_Month_Reward.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	MonthRewardBG:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16CBE95C250C6D15"))
	...
	Reward:setImage(RegisterImage(@"hash_DAE99C512361BE4"))
	...
	ExplanationText:setText(Engine[@"hash_4F9F1239CFD921FE"](@"hash_51925D88309CE266"))
	ExplanationText:setTTF("dinnext_regular")
	ExplanationText:setAlignment(Enum[@"luialignment"][@"lui_alignment_center"])
	ExplanationText:setAlignment(Enum[@"luialignment"][@"lui_alignment_bottom"])
