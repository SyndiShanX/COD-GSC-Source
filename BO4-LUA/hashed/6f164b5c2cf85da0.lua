...
CoD.Tak5ReticleBracketBoxes.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	ReticleBox03Add:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	ReticleBox02Add:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
	...
	ReticleBox01Add:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_31CC85D0A86303B0"))
		...
		DefaultClip = function(f3_arg0, f3_arg1)
			...
			local f3_local0 = function(f4_arg0)
				local f4_local0 = function(f5_arg0)
					local f5_local0 = function(f6_arg0)
						f6_arg0:beginAnimation(99, Enum[@"luitween"][@"luitween_ease_both"])
						f6_arg0:setAlpha(0)
						f6_arg0:registerEventHandler("transition_complete_keyframe", f3_arg0.clipFinished)
					end
					f5_arg0:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_both"])
					f5_arg0:setAlpha(1)
			...
			local f3_local1 = function(f7_arg0)
				local f7_local0 = function(f8_arg0)
					local f8_local0 = function(f9_arg0)
						f9_arg0:beginAnimation(100, Enum[@"luitween"][@"luitween_ease_both"])
						f9_arg0:setAlpha(0)
						f9_arg0:registerEventHandler("transition_complete_keyframe", f3_arg0.clipFinished)
					end
					f8_arg0:beginAnimation(99, Enum[@"luitween"][@"luitween_ease_both"])
					f8_arg0:setAlpha(1)
			...
			local f3_local2 = function(f10_arg0)
				local f10_local0 = function(f11_arg0)
					...
					f11_arg0:beginAnimation(99, Enum[@"luitween"][@"luitween_ease_both"])
					f11_arg0:setAlpha(1)
