...
CoD.AARTierRewardDupeIndicator.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	Icon:setImage(RegisterImage(@"hash_F395928C19E9B99"))
...
CoD.AARTierRewardDupeIndicator.__resetProperties = function(f2_arg0)
	...
	f2_arg0.Icon:setImage(RegisterImage(@"hash_F395928C19E9B99"))
...
CoD.AARTierRewardDupeIndicator.__clipsPerState = {
	DefaultState = {
		...
		Dupe = function(f4_arg0, f4_arg1)
			...
			f4_arg0.Icon:setImage(RegisterImage(@"hash_F395928C19E9B99"))
		...
		ReRolling = function(f7_arg0, f7_arg1)
			...
			f7_arg0.Icon:setImage(RegisterImage(@"hash_7B259D817A83EFDB"))
		...
		ReRolled = function(f10_arg0, f10_arg1)
			...
			f10_arg0.Icon:setImage(RegisterImage(@"hash_7B259D817A83EFDB"))
			...
			f10_arg0.Message:setText(LocalizeToUpperString(@"hash_63F6CF92B504C237"))
	...
	ReRolled = {
		DefaultClip = function(f13_arg0, f13_arg1)
			...
			f13_arg0.Icon:setImage(RegisterImage(@"hash_7B259D817A83EFDB"))
			f13_arg0.clipFinished(f13_arg0.Icon)
			f13_arg0.Message:completeAnimation()
			f13_arg0.Message:setText(LocalizeToUpperString(@"hash_63F6CF92B504C237"))
		...
		ReRolling = function(f14_arg0, f14_arg1)
			...
			f14_arg0.Icon:setImage(RegisterImage(@"hash_7B259D817A83EFDB"))
		...
		ReRolled = function(f17_arg0, f17_arg1)
			...
			f17_arg0.Icon:setImage(RegisterImage(@"hash_7B259D817A83EFDB"))
			...
			f17_arg0.Message:setText(LocalizeToUpperString(@"hash_63F6CF92B504C237"))
