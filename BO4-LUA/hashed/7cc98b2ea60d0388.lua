...
CoD.ZMTalismanChannelPathBG.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	PathHoriz01:setImage(RegisterImage(@"hash_475C7D4D54D3AA9E"))
	PathHoriz01:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16A7171D365F4648"))
	...
	PathHoriz02:setImage(RegisterImage(@"hash_475C7D4D54D3AA9E"))
	PathHoriz02:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16A7171D365F4648"))
	...
	PathHoriz03:setImage(RegisterImage(@"hash_475C7D4D54D3AA9E"))
	PathHoriz03:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16A7171D365F4648"))
	...
	PathHoriz04:setImage(RegisterImage(@"hash_475C7D4D54D3AA9E"))
	PathHoriz04:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16A7171D365F4648"))
	...
	PathHoriz:setImage(RegisterImage(@"hash_21B9FA81FAE6DBC7"))
	PathHoriz:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16A7171D365F4648"))
	...
	PathVert01:setImage(RegisterImage(@"hash_38EA32A456C33D15"))
	PathVert01:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16A7171D365F4648"))
	...
	PathVert:setImage(RegisterImage(@"hash_38EA32A456C33D15"))
	PathVert:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16A7171D365F4648"))
	...
	PathVert2:setImage(RegisterImage(@"hash_38EA32A456C33D15"))
	PathVert2:setMaterial(LUI.UIImage.GetCachedMaterial(@"hash_16A7171D365F4648"))
	...
	PathBranch01:setImage(RegisterImage(@"hash_EC38C5180782DFF"))
	...
	PathBranch02:setImage(RegisterImage(@"hash_EC38C5180782DFF"))
	...
	PathBranch03:setImage(RegisterImage(@"hash_EC38C5180782DFF"))
	...
	PathBranch:setImage(RegisterImage(@"hash_EC38C5180782DFF"))
	...
	PathBranch3:setImage(RegisterImage(@"hash_781D0E9FE511363A"))
	...
	PathBranch5:setImage(RegisterImage(@"hash_781D0E9FE511363A"))
	...
	PathBranch4:setImage(RegisterImage(@"hash_4EBB92789038ACBD"))
