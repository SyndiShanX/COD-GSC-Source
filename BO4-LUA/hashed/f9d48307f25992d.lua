...
CoD.VHUDHawkReticle.new = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9)
	...
	HUDVehiclePrompt4.label:setText(LocalizeToUpperString(@"hash_2577B757C1CA9678"))
	HUDVehiclePrompt4.HUDVehiclePromptContainer.KBMText:setText(CoD.BaseUtility.AlreadyLocalized("[{+vehiclemoveup}]"))
	HUDVehiclePrompt4.HUDVehiclePromptContainer.KBMText:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
	...
	HUDVehiclePrompt5.label:setText(LocalizeToUpperString(@"hash_29F6A908F9B269AD"))
	HUDVehiclePrompt5.HUDVehiclePromptContainer.KBMText:setText(CoD.BaseUtility.AlreadyLocalized("[{+vehiclemovedown}]"))
	HUDVehiclePrompt5.HUDVehiclePromptContainer.KBMText:setAlignment(Enum[@"luialignment"][@"lui_alignment_middle"])
