...
Lobby.BlackMarket.GetPlayerLootStreamState = function(f8_arg0)
	...
	Engine[0x8C5711DAACC99F4](Enum[0x7A63DCD561B0FA8][0x8DC984EB9B80F9], "Payload: " .. f8_local1 .. "\n")
...
Lobby.BlackMarket.GetPlayerPagedSeasonStream = function(f10_arg0)
	...
	Engine[0x8C5711DAACC99F4](Enum[0x7A63DCD561B0FA8][0x8DC984EB9B80F9], "Payload: " .. f10_local3 .. "\n")
	...
	for f14_local1 = 1, #f14_local0, 1 do
		...
		for f14_local8 = 1, #f14_local7, 1 do
			...
			for f14_local17 = 1, #f14_local16, 1 do
				...
				if f14_local15 then
					local f14_local21 = Engine[0x4DF5CFBC1771947](f14_arg0)
...
Lobby.BlackMarket.OpenSupplyChainLootDrop = function(f16_arg0)
	...
	if f16_local4 and f16_local4 > 0 then
		local f16_local5 = Engine[0x4DF5CFBC1771947](f16_local0)
	...
	if f16_local3 ~= nil and f16_local3 ~= 0x0 and f16_local3 ~= f16_local5 then
		Engine[0x5DF86CF48135674](Enum[0x7A63DCD561B0FA8][0x8DC984EB9B80F9], "Overriding season.\n")
	...
	Engine[0x8C5711DAACC99F4](Enum[0x7A63DCD561B0FA8][0x8DC984EB9B80F9], "Payload: " .. f16_local10 .. "\n")
	...
	for f22_local1 = 1, #f22_local0, 1 do
		...
		if f22_local5 < 0 then
			...
			if f22_local6 > 0 then
				...
				Engine[0x6484C28135868CE](f22_arg0, f22_local4, f22_local5)
			end
			Engine[0x5DF86CF48135674](Enum[0x7A63DCD561B0FA8][0x8DC984EB9B80F9], "Tier quantity modified during loot operation.\n")
		end
	end
end
...
Lobby.BlackMarket.FinalizeRNGResultModel = function(f27_arg0)
	local f27_local0 = Engine[0x4DF5CFBC1771947](f27_arg0)
...
Lobby.BlackMarket.ParseRNGDropDetail = function(f28_arg0, f28_arg1)
	...
	for f28_local6 = 1, #f28_local4, 1 do
		...
		elseif string.find(f28_local2, "rng_dupe") then
			...
			local f28_local15 = Engine[0x4DF5CFBC1771947](f28_arg0)
...
Lobby.BlackMarket.ParseStreamDropDetail = function(f29_arg0, f29_arg1)
	...
	for f29_local8 = 1, #f29_local7, 1 do
		...
		if string.find(f29_local5, "rng_dupe") then
			if f29_local3:getInt() == Lobby.BlackMarket.MaxDupeCount then
				local f29_local12 = Engine[0x4DF5CFBC1771947](f29_arg0)
	...
	local f29_local9 = Engine[0x4DF5CFBC1771947](f29_arg0)
...
Lobby.BlackMarket.ParseCrateTrackingInfo = function(f33_arg0, f33_arg1)
	...
	local f33_local0 = Engine[0x4DF5CFBC1771947](f33_arg0)
...
Lobby.BlackMarket.ZombiesHandleLootDropResponse = function(f34_arg0, f34_arg1)
	...
	for f34_local6 = 1, f34_local3, 1 do
		...
		if f34_local9 then
			...
			local f34_local13 = Engine[0x2DCF0973239E909](Lobby.BlackMarket.lootTableName, 1, 0, f34_local12)
			local f34_local14 = Engine[0x2DCF0973239E909](Lobby.BlackMarket.lootTableName, 2, 0, f34_local12)
...
Lobby.BlackMarket.GetLabModel = function(f36_arg0)
	local f36_local0 = Engine[0x4DF5CFBC1771947](f36_arg0)
