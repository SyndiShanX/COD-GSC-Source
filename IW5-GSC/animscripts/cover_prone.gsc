...
setup_cover_prone() {
  ...
  var_0["single"] = animscripts\utility::array(%prone_fire_1);
  ...
  var_0["look"] = animscripts\utility::array(%prone_twitch_look, %prone_twitch_lookfast, %prone_twitch_lookup);
  var_0["grenade_safe"] = animscripts\utility::array(%prone_grenade_a, %prone_grenade_a);
  var_0["grenade_exposed"] = animscripts\utility::array(%prone_grenade_a, %prone_grenade_a);
  var_0["exposed_idle"] = animscripts\utility::array(%prone_idle);
