...
playdeathanim(var_0) {
  ...
  if(isDefined(self.skipdeathanim)) {
    ...
    thread waitforragdoll(getanimlength(var_0) * 0.35);
  }
  if(!isDefined(self.skipdeathanim)) {
    thread playdeathfx();
  }
...
specialdeath() {
  ...
  switch (self.a.special) {
    ...
    case "saw":
      if(self.a.pose == "stand") {
        dodeathfromarray(animscripts\utility::array(%saw_gunner_death));
      } else if(self.a.pose == "crouch") {
        dodeathfromarray(animscripts\utility::array(%saw_gunner_lowwall_death));
      } else {
        dodeathfromarray(animscripts\utility::array(%saw_gunner_prone_death));
      }
      return 1;
    case "dying_crawl":
      if(isDefined(self.a.onback) && self.a.pose == "crouch") {
        var_0 = animscripts\utility::array(%dying_back_death_v2, %dying_back_death_v3, %dying_back_death_v4);
        dodeathfromarray(var_0);
      } else {
        var_0 = animscripts\utility::array(%dying_crawl_death_v1, %dying_crawl_death_v2);
        dodeathfromarray(var_0);
      }
...
getstrongbulletdamagedeathanim() {
  ...
  if(var_0 > 150) {
    if(animscripts\utility::damagelocationisany("left_leg_upper", "left_leg_lower", "right_leg_upper", "right_leg_lower", "left_foot", "right_foot")) {
      var_1 = animscripts\utility::array(%death_shotgun_legs, %death_stand_sniper_leg);
    } else {
      var_1 = [];
    ...
    var_1 = animscripts\utility::array(%death_shotgun_spinl, %death_stand_sniper_spin1, %death_stand_sniper_chest1, %death_stand_sniper_chest2);
  } else {
    var_1 = animscripts\utility::array(%death_shotgun_spinr, %death_stand_sniper_spin2, %death_stand_sniper_chest1, %death_stand_sniper_chest2);
  }
...
getrunningforwarddeathanim() {
  var_0 = [];
  var_0[var_0.size] = tryadddeathanim(%run_death_facedown);
  var_0[var_0.size] = tryadddeathanim(%run_death_roll);
  var_0[var_0.size] = tryadddeathanim(%run_death_fallonback);
  var_0[var_0.size] = tryadddeathanim(%run_death_flop);
  var_0 = animscripts\pain::removeblockedanims(var_0);
...
getstanddeathanim() {
  ...
  if(animscripts\utility::usingsidearm()) {
    ...
    if(animscripts\utility::damagelocationisany("torso_lower", "left_leg_upper", "left_leg_lower", "right_leg_lower", "right_leg_lower")) {
      var_0[var_0.size] = tryadddeathanim(%exposed_death_groin);
      var_0[var_0.size] = tryadddeathanim(%stand_death_leg);
      var_1[var_1.size] = tryadddeathanim(%stand_death_crotch);
      var_1[var_1.size] = tryadddeathanim(%stand_death_guts);
    }

    if(animscripts\utility::damagelocationisany("head", "helmet")) {
      var_0[var_0.size] = tryadddeathanim(%exposed_death_headshot);
      var_0[var_0.size] = tryadddeathanim(%exposed_death_flop);
    }

    if(animscripts\utility::damagelocationisany("neck")) {
      var_0[var_0.size] = tryadddeathanim(%exposed_death_neckgrab);
    }
    if(animscripts\utility::damagelocationisany("torso_upper", "left_arm_upper")) {
      var_0[var_0.size] = tryadddeathanim(%exposed_death_twist);
      var_0[var_0.size] = tryadddeathanim(%stand_death_shoulder_spin);
      var_0[var_0.size] = tryadddeathanim(%stand_death_shoulderback);
    }

    if(animscripts\utility::damagelocationisany("torso_upper")) {
      var_0[var_0.size] = tryadddeathanim(%stand_death_tumbleforward);
      var_0[var_0.size] = tryadddeathanim(%stand_death_stumbleforward);
      var_1[var_1.size] = tryadddeathanim(%stand_death_fallside);
    }

    if(self.damageyaw > 135 || self.damageyaw <= -135) {
      if(animscripts\utility::damagelocationisany("neck", "head", "helmet")) {
        var_0[var_0.size] = tryadddeathanim(%stand_death_face);
        var_0[var_0.size] = tryadddeathanim(%stand_death_headshot_slowfall);
        var_1[var_1.size] = tryadddeathanim(%stand_death_head_straight_back);
      }

      if(animscripts\utility::damagelocationisany("torso_upper")) {
        var_0[var_0.size] = tryadddeathanim(%stand_death_tumbleback);
        var_1[var_1.size] = tryadddeathanim(%stand_death_chest_stunned);
      }
    } else if(self.damageyaw > -45 && self.damageyaw <= 45) {
      var_0[var_0.size] = tryadddeathanim(%exposed_death_falltoknees);
      var_0[var_0.size] = tryadddeathanim(%exposed_death_falltoknees_02);
    }

    var_2 = var_0.size > 0;

    if(!var_2 || randomint(100) < 15) {
      var_0[var_0.size] = tryadddeathanim(%exposed_death_02);
      var_0[var_0.size] = tryadddeathanim(%exposed_death_nerve);
    }

    if(randomint(100) < 10 && firingdeathallowed()) {
      var_0[var_0.size] = tryaddfiringdeathanim(%exposed_death_firing_02);
      var_0[var_0.size] = tryaddfiringdeathanim(%exposed_death_firing);
...
getcrouchdeathanim() {
  ...
  if(animscripts\utility::damagelocationisany("head", "neck")) {
    var_0[var_0.size] = tryadddeathanim(%exposed_crouch_death_fetal);
  }
  if(animscripts\utility::damagelocationisany("torso_upper", "torso_lower", "left_arm_upper", "right_arm_upper", "neck")) {
    var_0[var_0.size] = tryadddeathanim(%exposed_crouch_death_flip);
  }
  if(var_0.size < 2) {
    var_0[var_0.size] = tryadddeathanim(%exposed_crouch_death_twist);
  }
  if(var_0.size < 2) {
    var_0[var_0.size] = tryadddeathanim(%exposed_crouch_death_flip);
  }
