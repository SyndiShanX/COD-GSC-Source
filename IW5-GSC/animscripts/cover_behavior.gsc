...
main(var_0) {
  ...
  for(;;) {
    ...
    self safeteleport(self.covernode.origin, var_4);
    ...
    if(isalive(self.enemy)) {
      var_6 = isenemyvisiblefromexposed();
      var_7 = animscripts\utility::cansuppressenemyfromexposed();
    }
