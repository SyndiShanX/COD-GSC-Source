 ...
 * Script: scripts\23556.gsc
**************************************/

main() {
  var_0 = maps\_utility::create_vision_set_fog("so_assassin_payback");
  var_0.startdist = 849.906;
  var_0.halfwaydist = 4017.16;
  var_0.red = 0.87126;
  var_0.green = 0.850411;
  var_0.blue = 0.793104;
