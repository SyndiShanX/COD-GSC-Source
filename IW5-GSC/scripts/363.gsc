...
heli_circling_think(var_0, var_1) {
  ...
  for(;;) {
    ...
    var_6 = maps\_utility::getclosest(var_5, var_2);
...
heli_goal_think(var_0) {
  ...
  var_2 = self;
  var_3 = maps\_utility::getclosest(var_2.origin, var_1);
  var_4 = var_3;
  var_2 endon("death");
  ...
  for(;;) {
    ...
    if(var_3 == var_4 && var_2.istakingdamage) {
      ...
      var_3 = maps\_utility::getclosest(var_7, var_8);
    }
    ...
    var_4 = var_3;
    var_9 = maps\_utility::getclosest(var_7, var_1);
    var_10 = maps\_utility::getclosest(var_7, var_8);
    ...
    var_14 = maps\_utility::getclosest(var_7, var_8);
    ...
    if(var_8.size < 2) {
      ...
      var_15 = [];
      var_15[0] = var_14;
      var_8 = maps\_utility::get_array_of_closest(var_7, var_8, var_15, 2);
...
heli_spotlight_think() {
  ...
  self.left_ent = spawn("script_origin", var_0.origin);
  self.left_ent.origin = var_0.origin;
  self.left_ent.angles = var_0.angles;
  self.left_ent.targetname = "left_ent";
  self.right_ent = spawn("script_origin", var_0.origin);
  self.right_ent.origin = var_0.origin;
  self.right_ent.angles = var_0.angles;
  self.right_ent.targetname = "right_ent";
  var_1 = spawnStruct();
  var_1.entity = self.left_ent;
  var_1.right = 250;
  var_1 maps\_utility::flashbanggettimeleftsec();
  self.left_ent linkTo(self);
  var_2 = spawnStruct();
  var_2.entity = self.right_ent;
  var_2.right = -250;
  var_2 maps\_utility::flashbanggettimeleftsec();
  self.right_ent linkTo(self);
  var_3 = [];
  var_3[0] = var_0;
  var_3[1] = self.left_ent;
  var_3[2] = self.right_ent;
  self.spottarget = var_0;
  common_scripts\utility::array_thread(var_3, ::heli_spotlight_aim_ents_cleanup, self);
  ...
  for(;;) {
    ...
    self.targetdefault = var_3[var_4];
...
littlebird_turrets_think(var_0) {
  var_1 = self;
  var_1 maps\_vehicle::turret_set_default_on_mode("manual");
