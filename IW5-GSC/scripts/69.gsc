...
display_screen_effect(var_0, var_1, var_2, var_3, var_4) {
  ...
  switch (var_1) {
    case "bottom":
      ...
      if(var_0 == "dirt") {
        var_8 = maps\_hud_util::create_client_overlay_custom_size(var_2, 1, var_6, var_7);
        var_8 thread screen_effect_on_open_bottom(var_0, var_4, 1);
        var_8 screen_detailed_alpha();
      } else {
        var_8 = maps\_hud_util::create_client_overlay_custom_size(var_2, 0, var_6, var_7);
        var_8 screen_effect_on_open_bottom(var_0, var_4);
      }

      if(isDefined(var_3)) {
        var_9 = maps\_hud_util::create_client_overlay_custom_size(var_3, 0, var_6, var_7);
...
auto_adjust_enemy_death_detection(var_0, var_1, var_2, var_3, var_4, var_5, var_5) {
  if(!isalive(self) || self.delayeddeath) {
    auto_adjust_enemy_died(var_0, var_1, var_4, var_3);
    return;
  }
  ...
  aa_player_attacks_enemy_with_ads(var_0, var_4, var_3);
}
