...
killing_will_down(var_0) {
  if(laststand_enabled()) {
    return var_0 maps\_laststand::laststand_downing_will_fail() == 0;
  }
  return 0;
}
...
set_custom_eog_summary(var_0, var_1, var_2) {
  var_3 = int(var_0);
  var_4 = int(var_1);
  var_5 = "";
...
add_custom_eog_summary_line(var_0, var_1, var_2, var_3, var_4) {
  ...
  set_custom_eog_summary(var_5, 1, var_0);
  var_6 = [];
  ...
  for(var_7 = 0; var_7 < var_6.size; var_7++) {
    set_custom_eog_summary(var_5, 4 - var_7, var_6[var_7]);
  }
}
...
isdefined_test(var_0, var_1, var_2) {
  if(!isDefined(var_0)) {
    return 0;
  }
  if(!isDefined(var_1)) {
...
flag_trigger_init(var_0, var_1, var_2) {
  ...
  var_1 thread _flag_wait_trigger(var_0, var_2);
  return var_1;
}
...
flag_triggers_init(var_0, var_1, var_2) {
  ...
  for(var_3 = 0; var_3 < var_1.size; var_3++) {
    var_1[var_3] thread _flag_wait_trigger(var_0, 0);
  }
  return var_1;
}
...
autosave_by_name_thread(var_0, var_1, var_2, var_3) {
  ...
  var_5 = level maps\_autosave::tryautosave(level.curautosave, "autosave", var_4, var_1, var_2, var_3);
...
chain_off(var_0) {
  ...
  for(var_2 = 0; var_2 < var_1.size; var_2++) {
    if(isDefined(var_1[var_2].script_chain) && var_1[var_2].script_chain == var_0) {
      if(isDefined(var_1[var_2].oldorigin)) {
        var_1[var_2].origin = var_1[var_2].oldorigin;
      } else {
        var_1[var_2].oldorigin = var_1[var_2].origin;
      }
      var_1[var_2].origin = var_1[var_2].origin + (0, 0, -5000);
    }
  }
}
...
get_closest_player(var_0) {
  ...
  var_1 = getclosest(var_0, level.players);
  return var_1;
}
...
set_ambient(var_0, var_1) {
  maps\_audio_zone_manager::azm_start_zone(var_0, var_1);
}
...
get_friendly_chain_node(var_0) {
  var_1 = undefined;
  var_2 = getEntArray("trigger_friendlychain", "classname");

  for(var_3 = 0; var_3 < var_2.size; var_3++) {
    if(isDefined(var_2[var_3].script_chain) && var_2[var_3].script_chain == var_0) {
      var_1 = var_2[var_3];
      break;
    }
  }
...
play_loop_sound_on_tag(var_0, var_1, var_2) {
...
spawn_anim_model(var_0, var_1) {
  if(!isDefined(var_1)) {
    var_1 = (0, 0, 0);
  }
  var_2 = spawn("script_model", var_1);
  var_2.animname = var_0;
  var_2 assign_animtree();
  var_2 assign_model();
  return var_2;
}
...
get_living_aispecies(var_0, var_1, var_2) {
  var_3 = get_living_ai_array(var_0, var_1, var_2);
...
set_environment(var_0) {
  animscripts\utility::setenv(var_0);
}
...
battlechatter_off(var_0) {
  ...
  for(var_4 = 0; var_4 < var_1.size; var_4++) {
    ...
    var_5 maps\_utility_code::wait_until_done_speaking();
  }
...
set_team_bcvoice(var_0, var_1) {
  ...
  var_3 = array_contains(var_2, var_1);
...
set_ai_bcvoice(var_0) {
  ...
  var_2 = array_contains(var_1, var_0);
...
set_friendly_chain_wrapper(var_0) {
...
obj_set_chain_and_enemies() {
  ...
  flood_and_secure_scripted(var_1);
  level notify("new_friendly_trigger");
  level.player set_friendly_chain_wrapper(var_0);
}
...
flood_and_secure_scripted(var_0, var_1) {
  if(!isDefined(var_1)) {
    var_1 = 0;
  }
  ...
  common_scripts\utility::array_thread(var_0, maps\_spawner::flood_and_secure_spawner, var_1);

  for(var_2 = 0; var_2 < var_0.size; var_2++) {
    var_0[var_2].playertriggered = 1;
...
set_ambient_alias(var_0, var_1) {
  var_2 = var_0;
  maps\_audio_zone_manager::azm_set_zone_streamed_ambience(var_2, var_1);
}
...
custom_battlechatter(var_0) {
  return animscripts\battlechatter_ai::custom_battlechatter_internal(var_0);
}
...
set_force_color(var_0) {
  ...
  self.old_forcecolor = undefined;
  var_2 = maps\_colors::get_team();

  if(isDefined(self.script_forcecolor)) {
    level.arrays_of_colorforced_ai[var_2][self.script_forcecolor] = common_scripts\utility::array_remove(level.arrays_of_colorforced_ai[var_2][self.script_forcecolor], self);
  }
  self.script_forcecolor = var_1;
  level.arrays_of_colorforced_ai[var_2][var_1] = array_removedead(level.arrays_of_colorforced_ai[var_2][var_1]);
  level.arrays_of_colorforced_ai[var_2][self.script_forcecolor] = array_add(level.arrays_of_colorforced_ai[var_2][self.script_forcecolor], self);
...
vehicle_land(var_0) {
  maps\_vehicle::vehicle_landvehicle(var_0);
}

vehicle_liftoff(var_0) {
  maps\_vehicle::vehicle_liftoffvehicle(var_0);
}
...
getvehiclespawnerarray(var_0) {
  return maps\_vehicle::_getvehiclespawnerarray(var_0);
}

describe_start(var_0, var_1, var_2, var_3) {
  add_start_assert();

  if(!isDefined(level.start_description)) {
    level.start_description = [];
  }
  level.start_description[var_0] = add_start_construct(var_0, var_1, var_2, var_3);
}

add_start(var_0, var_1, var_2, var_3) {
  add_start_assert();
  var_0 = tolower(var_0);

  if(isDefined(level.start_description) && isDefined(level.start_description[var_0])) {
    var_5 = level.start_description[var_0];
  } else {
    var_5 = add_start_construct(var_0, var_1, var_2, var_3);
  }
  if(!isDefined(var_1)) {
    if(!isDefined(level.start_description)) {} else if(!issubstr(var_0, "no_game")) {
  ...
  level.start_functions[level.start_functions.size] = var_5;
  level.start_arrays[var_0] = var_5;
}
...
add_start_construct(var_0, var_1, var_2, var_3) {
  var_4 = [];
  var_4["name"] = var_0;
...
spawn_reinforcement(var_0, var_1) {
  maps\_colors::colornode_spawn_reinforcement(var_0, var_1);
}
...
wait_for_flag_or_timeout(var_0, var_1) {
  ...
  var_2 = spawnStruct();
  var_2 thread maps\_utility_code::ent_waits_for_level_notify(var_0);
  var_2 thread maps\_utility_code::ent_times_out(var_1);
  var_2 waittill("done");
}

wait_for_notify_or_timeout(var_0, var_1) {
  var_2 = spawnStruct();
  var_2 thread maps\_utility_code::ent_waits_for_notify(self, var_0);
  var_2 thread maps\_utility_code::ent_times_out(var_1);
  var_2 waittill("done");
}
...
wait_for_trigger_or_timeout(var_0) {
  var_1 = spawnStruct();
  var_1 thread maps\_utility_code::ent_waits_for_trigger(self);
  var_1 thread maps\_utility_code::ent_times_out(var_0);
  var_1 waittill("done");
}
...
makerealai(var_0) {
  return maps\_spawner::spawner_makerealai(var_0);
}
...
set_move_animset(var_0, var_1, var_2) {
  var_3 = anim.animsets.move[var_0];
...
lerp_player_view_to_tag(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
...
display_hint(var_0, var_1, var_2, var_3) {
  var_4 = get_player_from_self();

  if(isDefined(level.trigger_hint_func[var_0])) {
    if(var_4[[level.trigger_hint_func[var_0]]]()) {
      return;
    }
    var_4 thread maps\_utility_code::hintprint(level.trigger_hint_string[var_0], level.trigger_hint_func[var_0], var_1, var_2, var_3, 30);
  } else {
    var_4 thread maps\_utility_code::hintprint(level.trigger_hint_string[var_0], undefined, undefined, undefined, undefined, 30);
  }
}

display_hint_timeout(var_0, var_1, var_2, var_3, var_4) {
  var_5 = get_player_from_self();

  if(var_5[[level.trigger_hint_func[var_0]]]()) {
    return;
  }
  var_5 thread maps\_utility_code::hintprint(level.trigger_hint_string[var_0], level.trigger_hint_func[var_0], var_2, var_3, var_4, var_1);
}
...
set_goal_ent(var_0) {
  playlocalsoundwrapper(var_0.origin);
...
enable_auto_adjust_threatbias() {
  ...
  var_0 = level.auto_adjust_difficulty_frac * 0.01;
  level.player.threatbias = int(maps\_gameskill::get_blended_difficulty("threatbias", var_0));
}
...
players_looking_at(var_0, var_1, var_2, var_3) {
...
arcademode_damage(var_0, var_1, var_2) {
  ...
  thread maps\_arcademode::arcademode_add_points(var_0, 0, var_1, var_2);
}
...
arcademode_checkpoint(var_0, var_1) {
  ...
  var_2 = maps\_arcademode::arcademode_checkpoint_getid(var_1);

  if(!isDefined(var_2)) {
    var_2 = level.arcademode_checkpoint_dvars.size;
    level.arcademode_checkpoint_dvars[level.arcademode_checkpoint_dvars.size] = var_1;
  }
  ...
  thread maps\_arcademode::draw_checkpoint(var_5, var_6, 1);
  thread maps\_arcademode::draw_checkpoint(var_5, var_6, -1);
}
...
get_ent_closest_to_flag_trig(var_0, var_1) {
  if(var_1.size == 1) {
    return var_1[0];
  }
  var_2 = undefined;
  ...
  for(var_5 = 0; var_5 < var_4.size; var_5++) {
    if(isDefined(var_4[var_5].script_flag) && var_4[var_5].script_flag == var_0) {
      var_2 = var_4[var_5];
      break;
    }
  }

  var_3 = getclosest(var_2.origin, var_1);
  return var_3;
}
...
setmodelfunc(var_0, var_1) {
  if(!isDefined(var_1)) {
    var_1 = 0;
  }
  thread maps\_loadout::updatemodel(var_0);
}
...
givexp(var_0, var_1) {
  maps\_rank::updateplayerscore(var_0, var_1);
}
...
is_other_player_downed(var_0) {
  var_1 = get_other_player(var_0);
  return is_player_down(var_1);
}
...
follow_path(var_0, var_1, var_2) {
  ...
  var_4 = self.script_forcegoal;
  self.script_forcegoal = 1;
  maps\_spawner::go_to_node(var_0, var_3, var_2, var_1);
  self.script_forcegoal = var_4;
}
...
getentwithflag(var_0) {
  var_1 = maps\_load::get_load_trigger_classes();
  var_2 = [];
  ...
  var_7 = maps\_load::get_load_trigger_funcs();
...
get_rumble_ent(var_0) {
  ...
  var_2.intensity = 1;
  var_2 thread maps\_utility_code::update_rumble_intensity(var_1, var_0);
  return var_2;
}
...
kill_deathflag(var_0, var_1) {
  ...
  foreach(var_3 in level.deathflags[var_0]) {
    foreach(var_5 in var_3) {
      if(isalive(var_5)) {
        var_5 thread maps\_utility_code::kill_deathflag_proc(var_1);
        continue;
      }
...
blend_dof(var_0, var_1, var_2) {
  var_3 = level create_blend(maps\_utility_code::blend_default_dof, var_0, var_1);
  var_3.time = var_2;
}
...
set_moveplaybackrate(var_0, var_1) {
  ...
  if(isDefined(var_1)) {
    var_2 = var_0 - self.moveplaybackrate;
    var_3 = 0.05;
    var_4 = var_1 / var_3;
    var_5 = var_2 / var_4;

    while(abs(var_0 - self.moveplaybackrate) > abs(var_5 * 1.1)) {
      self.moveplaybackrate = self.moveplaybackrate + var_5;
      wait(var_3);
    }
  }
...
create_vision_set_fog(var_0) {
  ...
  var_1 = spawnStruct();
  var_1.name = var_0;
  level.vision_set_fog[var_0] = var_1;
  return var_1;
}
...
fog_set_changes(var_0, var_1) {
  ...
  var_2 = level.fog_set[var_0];

  if(!isDefined(var_2)) {
    var_2 = level.vision_set_fog[var_0];
  }
  if(!isDefined(var_1)) {
  ...
  if(!isPlayer(self)) {
    if(level.fog_transition_ent.fogset == var_0 && level.fog_transition_ent.time == var_1) {
      return;
    }
    ...
    if(self.fog_transition_ent.fogset == var_0 && self.fog_transition_ent.time == var_1) {
      return;
    }
    set_fog_to_ent_values(var_2, var_1);
...
set_fog_to_ent_values(var_0, var_1) {
  if(isDefined(var_0.sunfogenabled) && var_0.sunfogenabled) {
    if(!isPlayer(self)) {
      setexpfog(var_0.startdist, var_0.halfwaydist, var_0.red, var_0.green, var_0.blue, var_0.maxopacity, var_1, var_0.sunred, var_0.sungreen, var_0.sunblue, var_0.sundir, var_0.sunbeginfadeangle, var_0.sunendfadeangle, var_0.normalfogscale);
    } else {
      self playersetexpfog(var_0.startdist, var_0.halfwaydist, var_0.red, var_0.green, var_0.blue, var_0.maxopacity, var_1, var_0.sunred, var_0.sungreen, var_0.sunblue, var_0.sundir, var_0.sunbeginfadeangle, var_0.sunendfadeangle, var_0.normalfogscale);
    }
...
vision_set_fog_changes(var_0, var_1) {
  ...
  if(var_2 && isDefined(get_vision_set_fog(var_0))) {
    fog_set_changes(var_0, var_1);
  }
}
...
vision_set_changes(var_0, var_1) {
  if(!isPlayer(self)) {
    ...
    if(level.vision_set_transition_ent.vision_set == var_0 && level.vision_set_transition_ent.time == var_1) {
      return 0;
    }
    ...
    if(self.vision_set_transition_ent.vision_set == var_0 && self.vision_set_transition_ent.time == var_1) {
      return 0;
    }
...
mask_interactives_in_volumes(var_0) {
  ...
  foreach(var_6 in var_1) {
    foreach(var_3 in var_0) {
      ...
      var_3 maps\_utility_code::put_interactive_in_volume(var_6);
      break;
    }
  }
}
...
activate_interactives_in_volume() {
  ...
  foreach(var_1 in self.interactives) {
    ...
    var_2 thread maps\_interactive_objects::tv_logic();
  }
...
activate_exploders_in_volume() {
  ...
  foreach(var_2 in level.createfxent) {
    ...
    maps\_load::setup_individual_exploder(var_6);
    var_2.model = var_6;
  }
...
delete_interactives_in_volumes(var_0, var_1) {
...
get_color_volume_from_trigger() {
  var_0 = maps\_utility_code::get_color_info_from_trigger();
  var_1 = var_0["team"];
...
musicloop(var_0, var_1) {
  if(!isDefined(var_1)) {
    var_1 = 0;
  }
  var_2 = musiclength(var_0);
  level notify("stop_music");
  level endon("stop_music");

  for(;;) {
    musicplaywrapper(var_0);
    wait(var_2);
    wait(var_1);
  }
}
...
define_introscreen(var_0) {
  level.introscreen_levelname = var_0;
}
