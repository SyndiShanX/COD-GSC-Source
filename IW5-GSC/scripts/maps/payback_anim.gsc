 ...
 * Script: scripts\maps\payback_anim.gsc
*****************************************/
...
anims() {
  ...
  maps\_anim::addnotetrack_customfunction("soap", "gun_2_right", maps\payback_1_script_a::soap_gun_right);
  maps\_anim::addnotetrack_customfunction("soap", "gun_2_left", maps\payback_1_script_a::soap_gun_left);
  ...
  maps\_anim::addnotetrack_customfunction("price", "unhide_mask_1", maps\payback_1_script_e::unhide_mask_1, "waraabe_interrogation");
  maps\_anim::addnotetrack_customfunction("price", "unhide_mask_3", maps\payback_1_script_e::unhide_mask_3, "waraabe_interrogation");
  maps\_anim::addnotetrack_customfunction("price", "activate_gas_can", maps\payback_1_script_e::_id_6683, "waraabe_interrogation");
  maps\_anim::addnotetrack_customfunction("price", "hide_mask_1", maps\payback_1_script_e::hide_mask_1, "waraabe_interrogation");
  maps\_anim::addnotetrack_customfunction("price", "price_holster_mg", maps\payback_1_script_e::price_holster_mg, "waraabe_interrogation");
  maps\_anim::addnotetrack_customfunction("price", "price_unholster_pistol", maps\payback_1_script_e::price_unholster_pistol, "waraabe_interrogation");
  maps\_anim::addnotetrack_customfunction("price", "price_shoot_pistol", maps\payback_1_script_e::price_shoot_pistol, "waraabe_interrogation");
  maps\_anim::addnotetrack_customfunction("price", "price_holster_pistol", maps\payback_1_script_e::price_holster_pistol, "waraabe_interrogation");
  maps\_anim::addnotetrack_customfunction("price", "price_unholster_mg", maps\payback_1_script_e::price_unholster_mg, "waraabe_interrogation");
  maps\_anim::addnotetrack_customfunction("price", "swap_model", maps\payback_1_script_e::swap_model, "waraabe_interrogation");
  level.scr_anim["kruger"]["waraabe_breach"] = % payback_breach_warrabe;
  maps\_anim::addnotetrack_customfunction("kruger", "shot_in_leg", maps\payback_1_script_e::waraabe_shot_in_leg, "waraabe_breach");
  ...
  maps\_anim::addnotetrack_customfunction("kruger", "wound_stomp", maps\payback_1_script_e::waraabe_leg_stomp, "payback_interrogation_warrabe");
  ...
  maps\_anim::addnotetrack_customfunction("soap", "unhide_mask_2", maps\payback_1_script_e::unhide_mask_2, "waraabe_interrogation");
  maps\_anim::addnotetrack_customfunction("soap", "unhide_gas_can", maps\payback_1_script_e::unhide_gas_can, "waraabe_interrogation");
  maps\_anim::addnotetrack_customfunction("soap", "hide_mask_2", maps\payback_1_script_e::hide_mask_2, "waraabe_interrogation");
  maps\_anim::addnotetrack_customfunction("soap", "open_door_2", maps\payback_1_script_e::open_exit_door, "waraabe_interrogation");
  ...
  maps\_anim::addnotetrack_customfunction("soap", "fire", maps\payback_streets_const::post_rappel_gate_open, "const_rappel_soap");
  level.scr_anim["price"]["const_rappel_price"] = % payback_const_rappel_price;
  maps\_anim::addnotetrack_customfunction("price", "gun_2_hand", maps\payback_streets_const::soap_put_guns_back_in_hands, "const_rappel_price");
  ...
  maps\_anim::addnotetrack_customfunction("price", "slide_fx_on", maps\payback_rescue::slide_fx_on, "exfil_slide_price");
  maps\_anim::addnotetrack_customfunction("price", "slide_fx_off", maps\payback_rescue::slide_fx_off, "exfil_slide_price");
  level.scr_anim["price"]["price_enter_jeep"] = % rubicon_mount_backr;
  level.scr_anim["soap"]["exfil_slide_soap"] = % payback_exfil_slide_soap;
  maps\_anim::addnotetrack_customfunction("soap", "slide_fx_on", maps\payback_rescue::slide_fx_on, "exfil_slide_soap");
  maps\_anim::addnotetrack_customfunction("soap", "slide_fx_off", maps\payback_rescue::slide_fx_off, "exfil_slide_soap");
  ...
  maps\_anim::addnotetrack_customfunction("rescue_echo_2", "slide_fx_on", maps\payback_rescue::slide_fx_on, "exfil_slide_echo_2");
  maps\_anim::addnotetrack_customfunction("rescue_echo_2", "slide_fx_off", maps\payback_rescue::slide_fx_off, "exfil_slide_echo_2");
  level.scr_anim["nikolai_jeep_escape"]["exfil_slide_nikolai"] = % payback_exfil_slide_nikolai;
  maps\_anim::addnotetrack_customfunction("nikolai_jeep_escape", "slide_fx_on", maps\payback_rescue::slide_fx_on, "exfil_slide_nikolai");
  maps\_anim::addnotetrack_customfunction("nikolai_jeep_escape", "slide_fx_off", maps\payback_rescue::slide_fx_off, "exfil_slide_nikolai");
  ...
  maps\_anim::addnotetrack_customfunction("price", "slide_fx_on", maps\payback_rescue::slide_fx_on, "jeep_slide_escape");
  maps\_anim::addnotetrack_customfunction("price", "slide_fx_off", maps\payback_rescue::slide_fx_off, "jeep_slide_escape");
  ...
  maps\_anim::addnotetrack_customfunction("nikolai_jeep_escape", "slide_fx_on", maps\payback_rescue::slide_fx_on, "jeep_slide_escape");
  maps\_anim::addnotetrack_customfunction("nikolai_jeep_escape", "slide_fx_off", maps\payback_rescue::slide_fx_off, "jeep_slide_escape");
  ...
  maps\_anim::addnotetrack_customfunction("soap", "slide_fx_on", maps\payback_rescue::slide_fx_on, "jeep_slide_escape");
  maps\_anim::addnotetrack_customfunction("soap", "slide_fx_off", maps\payback_rescue::slide_fx_off, "jeep_slide_escape");
  ...
  maps\_anim::addnotetrack_customfunction("rescue_echo_1", "slide_fx_on", maps\payback_rescue::slide_fx_on, "rescue_echo_1_slide");
  maps\_anim::addnotetrack_customfunction("rescue_echo_1", "slide_fx_off", maps\payback_rescue::slide_fx_off, "rescue_echo_1_slide");
  level.scr_anim["rescue_echo_2"]["rescue_echo_2_slide"] = % payback_end_slide_bravo_2;
  maps\_anim::addnotetrack_customfunction("rescue_echo_2", "slide_fx_on", maps\payback_rescue::slide_fx_on, "rescue_echo_2_slide");
  maps\_anim::addnotetrack_customfunction("rescue_echo_2", "slide_fx_off", maps\payback_rescue::slide_fx_off, "rescue_echo_2_slide");
...
animated_prop_setup() {
  ...
  maps\_anim::addnotetrack_flag("city_rollcar", "explosion", "city_rollcar_switchmodel", "payback_city_rollcar");
  ...
  maps\_anim::addnotetrack_flag("const_wall_wall", "screen_shake", "const_wallfall_screen_shake", "fall");
  ...
  maps\_anim::addnotetrack_customfunction("dummy_prop_7", "fx_big_spew", maps\payback_1_script_e::_id_6687, "waraabe_interrogation");
  maps\_anim::addnotetrack_customfunction("dummy_prop_7", "fx_sparks", maps\payback_1_script_e::fx_sparks, "waraabe_interrogation");
  maps\_anim::addnotetrack_customfunction("dummy_prop_7", "fx_initial_spew", maps\payback_1_script_e::fx_initial_spew, "waraabe_interrogation");
  maps\_anim::addnotetrack_customfunction("dummy_prop_7", "fx_big_spew", maps\payback_1_script_e::fx_big_spew, "waraabe_interrogation");
...
_id_683B() {
  ...
  maps\_vehicle::build_aianims(::turretdoshootanims, vehicle_scripts/_jeep_rubicon_payback::set_vehicle_anims);
}

#using_animtree("generic_human");

turretdoshootanims() {
  var_0 = vehicle_scripts/_jeep_rubicon_payback::setanims();
...
player_animations() {
  ...
  maps\_anim::addnotetrack_customfunction("player_slide_legs", "slide_fx_on", maps\payback_rescue::slide_fx_on, "jeep_slide_escape");
  maps\_anim::addnotetrack_customfunction("player_slide_legs", "slide_fx_off", maps\payback_rescue::slide_fx_off, "jeep_slide_escape");
