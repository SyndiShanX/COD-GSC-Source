 ...
 * Script: scripts\maps\hijack_anim.gsc
****************************************/
...
generic_human() {
  ...
  maps\_anim::addnotetrack_customfunction("president", "notify_conf_room", maps\hijack_airplane::intro_conf_room, "intro_scene");
  ...
  maps\_anim::addnotetrack_customfunction("assistant", "open_door2", maps\hijack_airplane::intro_asst_door, "intro_scene");
  ...
  maps\_anim::addnotetrack_customfunction("generic", "open_door3", maps\hijack_airplane::debate_open_first_door_intro, "intro_cine_agent");
  ...
  maps\_anim::addnotetrack_customfunction("generic", "close_door3", maps\hijack_airplane::debate_close_first_door, "intro_cine_agent_close_door");
  ...
  maps\_anim::addnotetrack_customfunction("generic", "open_door3", maps\hijack_airplane::debate_open_first_door, "debate_cine_agent_rescue");
  ...
  maps\_anim::addnotetrack_customfunction("generic", "fire", maps\hijack_crash_fx::custom_fire_fx, "planecrash_enemy1");
  maps\_anim::addnotetrack_customfunction("generic", "fire", maps\hijack_crash_fx::custom_fire_fx, "planecrash_enemy2");
  maps\_anim::addnotetrack_customfunction("generic", "fire", maps\hijack_crash_fx::custom_fire_fx, "planecrash_enemy3");
  maps\_anim::addnotetrack_customfunction("generic", "fire", maps\hijack_crash_fx::custom_fire_fx, "planecrash_enemy4");
  maps\_anim::addnotetrack_customfunction("generic", "fire", maps\hijack_crash_fx::custom_fire_fx, "planecrash_enemy5");
  maps\_anim::addnotetrack_customfunction("generic", "fire", maps\hijack_crash_fx::custom_fire_fx, "planecrash_enemy6");
...
zero_g_body() {
  ...
  maps\_anim::addnotetrack_customfunction("test_body", "people_lurch_left", maps\hijack_airplane::zerog_firsthit, "zero_g_player");
  maps\_anim::addnotetrack_customfunction("test_body", "plane_dive_down", maps\hijack_airplane::zerog_planedive, "zero_g_player");
  maps\_anim::addnotetrack_customfunction("test_body", "people_fly_up", maps\hijack_airplane::zerog_flyup, "zero_g_player");
  maps\_anim::addnotetrack_customfunction("test_body", "screen_shake_1", maps\hijack_airplane::zerog_secondhit, "zero_g_player");
  maps\_anim::addnotetrack_customfunction("test_body", "plane_roll_right", maps\hijack_airplane::zerog_planerollright, "zero_g_player");
  maps\_anim::addnotetrack_customfunction("test_body", "screen_shake_2", maps\hijack_airplane::zerog_bigshake, "zero_g_player");
  maps\_anim::addnotetrack_customfunction("test_body", "plane_roll_left", maps\hijack_airplane::zerog_planerollleft, "zero_g_player");
  maps\_anim::addnotetrack_customfunction("test_body", "screen_shake_3", maps\hijack_airplane::zerog_thirdhit, "zero_g_player");
  maps\_anim::addnotetrack_customfunction("test_body", "plane_level_out", maps\hijack_airplane::zerog_planelevelout, "zero_g_player");
}
...
president_moveset() {
  ...
  level.scr_anim["president"]["run_weights"] = var_2;
...
president_setup_turn_anims_override(var_0) {
  var_1 = undefined;

  if(var_0 < -22.5 && var_0 >= -70) {
    var_1 = level.scr_anim[self.animname]["turn_left_45"];
  }
  if(var_0 < -70 && var_0 > -120) {
    var_1 = level.scr_anim[self.animname]["turn_left_90"];
  }
  if(var_0 > 22.5 && var_0 <= 70) {
    var_1 = level.scr_anim[self.animname]["turn_right_45"];
  }
  if(var_0 > 70 && var_0 < 120) {
