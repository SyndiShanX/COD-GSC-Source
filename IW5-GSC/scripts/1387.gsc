...
droppedline(var_0, var_1, var_2, var_3, var_4, var_5) {
  var_0 = maps\_utility::drop_to_ground(var_0);
  var_1 = maps\_utility::drop_to_ground(var_1);
...
droppedlinez(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  ...
  var_2 = maps\_utility::drop_to_ground(var_2);
...
add_collision_to_path(var_0) {
  ...
  foreach(var_16 in var_14) {
    var_17 = maps\_utility::get_array_of_closest(var_16.origin, var_0, undefined, 2);
...
add_collision_offsets_to_path_ent(var_0, var_1, var_2) {
  ...
  var_4 = var_1._id_3F42 - level.dodge_distance;
  var_5 = undefined;
  var_6 = undefined;
  var_7 = undefined;
  var_8 = undefined;
...
modulate_speed_based_on_progress() {
  ...
  for(;;) {
    ...
    var_7 = progress_dif(self.targ, self._id_3F42, var_5, var_6);
...
track_player_progress(var_0) {
  ...
  self.targ = maps\_vehicle::get_my_spline_node(var_0);
  self._id_3F42 = 0;
