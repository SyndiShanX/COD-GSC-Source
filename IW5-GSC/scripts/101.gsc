...
ai_picks_destination(var_0) {
  if(isDefined(self.script_forcecolor)) {
    ...
    level.arrays_of_colorforced_ai[get_team()][var_1] = maps\_utility::array_add(level.arrays_of_colorforced_ai[get_team()][var_1], self);
...
prioritize_colorcoded_nodes(var_0, var_1, var_2) {
  ...
  var_4.cover_nodes_first = maps\_utility::array_randomize(var_4.cover_nodes_first);
  var_8 = [];
  var_3 = [];
...
issue_color_order_to_ai(var_0, var_1, var_2, var_3) {
  ...
  for(var_9 = 0; var_9 < var_5.size; var_9++) {
    ...
    var_11 = maps\_utility::getclosest(var_10.origin, var_3);
...
add_node_to_global_arrays(var_0, var_1) {
  ...
  foreach(var_4 in var_2) {
    if(isDefined(level.arrays_of_colorcoded_nodes[var_1]) && isDefined(level.arrays_of_colorcoded_nodes[var_1][var_4])) {
      level.arrays_of_colorcoded_nodes[var_1][var_4] = maps\_utility::array_add(level.arrays_of_colorcoded_nodes[var_1][var_4], self);
      continue;
    }
...
colornode_replace_on_death() {
  ...
  for(;;) {
    ...
    var_5 = maps\_utility::getclosest(level.player.origin, var_4);
    waittillframeend;
