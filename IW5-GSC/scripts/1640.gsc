...
main(var_0, var_1, var_2, var_3) {
  ...
  var_7 = maps\_vehicle::get_light_model(var_0, var_2);
  maps\_vehicle::build_light(var_7, "cockpit_blue_cargo01", "tag_light_cargo01", "misc/aircraft_light_cockpit_red", "interior", 0.0);
  maps\_vehicle::build_light(var_7, "cockpit_blue_cockpit01", "tag_light_cockpit01", "misc/aircraft_light_cockpit_blue", "interior", 0.1);
  maps\_vehicle::build_light(var_7, "white_blink", "tag_light_belly", "misc/aircraft_light_white_blink", "running", var_6);
  maps\_vehicle::build_light(var_7, "white_blink_tail", "tag_light_tail", "misc/aircraft_light_red_blink", "running", var_6);
  maps\_vehicle::build_light(var_7, "wingtip_green", "tag_light_L_wing", "misc/aircraft_light_wingtip_green", "running", var_6);
  maps\_vehicle::build_light(var_7, "wingtip_red", "tag_light_R_wing", "misc/aircraft_light_wingtip_red", "running", var_6);
  maps\_vehicle::build_light(var_7, "spot", "tag_passenger", "misc/aircraft_light_hindspot", "spot", 0.0);
