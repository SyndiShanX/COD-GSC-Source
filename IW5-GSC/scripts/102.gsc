...
run_spawn_functions() {
  ...
  if(isDefined(self.team)) {
    for(var_0 = 0; var_0 < level.spawn_funcs[self.team].size; var_0++) {
      var_1 = level.spawn_funcs[self.team][var_0];
...
spawn_think_action(var_0) {
  ...
  level thread maps\_friendlyfire::postpainfunc(self);
  self.walkdist = 16;
  init_reset_ai();
  spawn_think_game_skill_related();
  spawn_think_script_inits();
...
go_to_node(var_0, var_1, var_2, var_3) {
  if(isDefined(self.used_an_mg42)) {
    return;
  }
  var_4 = get_node_funcs_based_on_target(var_0, var_1);
  ...
  if(!isDefined(var_2)) {
    var_2 = ::empty_arrived_func;
  }
  go_to_node_using_funcs(var_4["destination"], var_4["get_target_func"], var_4["set_goal_func_quits"], var_2, var_3);
}

empty_arrived_func(var_0) {}
...
go_to_node_using_funcs(var_0, var_1, var_2, var_3, var_4) {
  ...
  for(;;) {
    ...
    if(isDefined(var_0.script_requires_player)) {
      if(var_0.script_requires_player > 1) {
        var_5 = var_0.script_requires_player;
      }
    ...
    while(isDefined(var_0.script_requires_player)) {
      ...
      if(go_to_node_wait_for_player(var_0, var_1, var_5)) {
...
setnewplayerchain(var_0, var_1) {
  level.player maps\_utility::set_friendly_chain_wrapper(var_0);
...
camper_trigger_think(var_0) {
  ...
  var_0 waittill("trigger");
  var_3 = maps\_utility::array_randomize(var_3);
...
flood_spawner_think(var_0) {
  ...
  while(self.count > 0) {
    ...
    if(isDefined(self.script_combatbehavior)) {
      if(self.script_combatbehavior == "heat") {
        var_3 maps\_utility::enable_heat_behavior();
      }
      if(self.script_combatbehavior == "cqb") {
    ...
    var_3 thread reincrement_count_if_deleted(self);
    var_3 thread expand_goalradius(var_0);
    var_3 waittill("death", var_4);

    if(!player_saw_kill(var_3, var_4)) {
      self.count++;
    } else if(isDefined(level.ac130_flood_respawn)) {
      if(isDefined(level.ac130gunner) && var_4 == level.ac130gunner) {
        if(randomint(2) == 0) {
          self.count++;
        }
      }
...
death_achievements() {
  ...
  thread achieve_strike(var_0, var_1, var_2);
  thread achieve_jack_the_ripper(var_0, var_1, var_2);
  thread achieve_serrated_edge(var_0, var_1, var_2);
...
achieve_strike(var_0, var_1, var_2) {
  if(var_1 != "MOD_GRENADE_SPLASH") {
    var_0.achieve_strike = undefined;
    return;
  }
  ...
  if(!isDefined(var_0.achieve_strike)) {
    var_0.achieve_strike = 1;
  } else {
    var_0.achieve_strike++;
  }
  if(var_0.achieve_strike == 5) {
    var_0 maps\_utility::player_giveachievement_wrapper("STRIKE");
  }
  waittillframeend;
  var_0.achieve_strike = undefined;
}

achieve_jack_the_ripper(var_0, var_1, var_2) {
  if(var_1 == "MOD_MELEE") {
    if(!isDefined(var_0.achieve_jack_the_ripper)) {
      var_0.achieve_jack_the_ripper = 1;
    } else {
      var_0.achieve_jack_the_ripper++;
    }
    if(var_0.achieve_jack_the_ripper == 5) {
      var_0 maps\_utility::player_giveachievement_wrapper("JACK_THE_RIPPER");
    }
  } else {
    var_0.achieve_jack_the_ripper = undefined;
  }
}

achieve_serrated_edge(var_0, var_1, var_2) {
  if(isDefined(self.juggernaut) && self.juggernaut && var_1 == "MOD_MELEE" && (!isDefined(var_2) || !issubstr(var_2, "riotshield") && !issubstr(var_2, "riot_shield"))) {
    var_0 maps\_utility::player_giveachievement_wrapper("SERRATED_EDGE");
  }
}
