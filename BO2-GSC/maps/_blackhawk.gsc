...
set_vehicle_anims(positions) {
  positions[2].vehicle_idle = % v_crew_blackhawk_hover_idle;
  positions[2].vehicle_getout = % v_crew_blackhawk_unload;
  positions[2].vehicle_getoutanim_clear = 0;
  return positions;
}

set_vehicle_rappel_anims(positions) {
  positions[2].vehicle_getout = % v_crew_blackhawk_hover_idle;
  positions[2].vehicle_getoutanim_clear = 0;
  return positions;
}

init_fastrope() {
  self.fastropeoffset = 908;
}
...
setanims() {
  ...
  positions[0].idle[2] = % ai_crew_blackhawk_pilot1_idle_twitch_lookback;
  positions[0].idle[3] = % ai_crew_blackhawk_pilot1_idle_twitch_lookoutside;
  ...
  positions[1].idle[0] = % ai_crew_blackhawk_pilot2_idle;
  positions[1].idle[1] = % ai_crew_blackhawk_pilot2_idle_twitch_clickpanel;
  positions[1].idle[2] = % ai_crew_blackhawk_pilot2_idle_twitch_lookoutside;
  positions[1].idle[3] = % ai_crew_blackhawk_pilot2_idle_twitch_radio;
  ...
  positions[2].idle = % ai_crew_blackhawk_fl_unload_idle;
  positions[3].idle = % ai_crew_blackhawk_fr_unload_idle;
  positions[4].idle = % ai_crew_blackhawk_rl_unload_idle;
  positions[5].idle = % ai_crew_blackhawk_rr_unload_idle;
  positions[2].getout = % ai_crew_blackhawk_fl_unload;
  positions[3].getout = % ai_crew_blackhawk_fr_unload;
  positions[4].getout = % ai_crew_blackhawk_rl_unload;
  positions[5].getout = % ai_crew_blackhawk_rr_unload;
...
setrappelanims() {
  ...
  positions[2].idle = % ai_crew_blackhawk_1_idle;
  positions[3].idle = % ai_crew_blackhawk_2_idle;
  positions[4].idle = % ai_crew_blackhawk_3_idle;
  positions[5].idle = % ai_crew_blackhawk_4_idle;
  positions[6].idle = % ai_crew_blackhawk_5_idle;
  positions[7].idle = % ai_crew_blackhawk_6_idle;
  positions[8].idle = % ai_crew_blackhawk_7_idle;
  positions[9].idle = % ai_crew_blackhawk_8_idle;
  positions[2].getout = % ai_crew_blackhawk_1_drop;
  positions[3].getout = % ai_crew_blackhawk_2_drop;
  positions[4].getout = % ai_crew_blackhawk_3_drop;
  positions[5].getout = % ai_crew_blackhawk_4_drop;
  positions[6].getout = % ai_crew_blackhawk_5_drop;
  positions[7].getout = % ai_crew_blackhawk_6_drop;
  positions[8].getout = % ai_crew_blackhawk_7_drop;
  positions[9].getout = % ai_crew_blackhawk_8_drop;
  positions[2].getoutstance = "crouch";
  positions[3].getoutstance = "crouch";
  positions[4].getoutstance = "crouch";
  positions[5].getoutstance = "crouch";
