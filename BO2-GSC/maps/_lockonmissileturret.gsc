 ...
 * Script: maps\_lockonmissileturret.gsc
*****************************************/
...
setnoclearance() {
  ...
  color_failed = (1, 0, 0);
  checks = [];
  checks[0] = vectorscale((0, 0, 1), 80.0);
  checks[1] = (-40, 0, 120);
  checks[2] = (40, 0, 120);
  checks[3] = vectorscale((-1, 0, 1), 40.0);
...
looplocaltrackingsound(alias, drone) {
  ...
  for(olde = undefined; isDefined(missile) && isDefined(drone); olde = e) {
