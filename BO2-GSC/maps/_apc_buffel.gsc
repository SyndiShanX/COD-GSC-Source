...
set_vehicle_anims(positions) {
  ...
  positions[6].vehicle_getoutanim_clear = 0;
  positions[7].vehicle_getoutanim_clear = 0;
  positions[8].vehicle_getoutanim_clear = 0;
  ...
  positions[9].vehicle_aimdown = % v_crew_buffel_gun_aim_down;
  positions[9].vehicle_aimup = % v_crew_buffel_gun_aim_up;
  positions[9].vehicle_fire = % v_crew_buffel_fire;
  positions[9].vehicle_firedown = % v_crew_buffel_fire_down;
  positions[9].vehicle_fireup = % v_crew_buffel_fire_up;
  return positions;
}
...
setanims() {
  ...
  positions[9].aimdown = % ai_crew_buffel_gunner_aim_down;
  positions[9].aimup = % ai_crew_buffel_gunner_aim_up;
  positions[9].fire = % ai_crew_buffel_gunner_fire;
  positions[9].firedown = % ai_crew_buffel_gunner_fire_down;
  positions[9].fireup = % ai_crew_buffel_gunner_fire_up;
  return positions;
}
