...
init_ambient_boats() {
  ...
  for(i = 0; i < 20; i++) {
    ...
    a_boats[n_index] thread play_fx("ambient_boat_wake", a_boats[n_index].origin + vectorscale((0, 0, 1), 96.0), a_boats[n_index].angles + vectorscale((0, -1, 0), 90.0), undefined, 1, undefined, 1);
