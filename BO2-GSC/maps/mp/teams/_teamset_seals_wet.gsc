 ...
 * Script: maps\mp\teams\_teamset_seals_wet.gsc
************************************************/

#include maps\mp\teams\_teamset;
#include mpbody\class_assault_usa_seals_wet;
#include mpbody\class_lmg_usa_seals_wet;
#include mpbody\class_shotgun_usa_seals_wet;
#include mpbody\class_smg_usa_seals_wet;
#include mpbody\class_sniper_usa_seals_wet;
...
precache() {
  ...
  mpbody\class_lmg_usa_seals_wet::precache();
  mpbody\class_shotgun_usa_seals_wet::precache();
  mpbody\class_smg_usa_seals_wet::precache();
  mpbody\class_sniper_usa_seals_wet::precache();
}