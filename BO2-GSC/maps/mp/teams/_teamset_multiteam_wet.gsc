 ...
 * Script: maps\mp\teams\_teamset_multiteam_wet.gsc
****************************************************/

#include maps\mp\teams\_teamset;
#include mpbody\class_assault_usa_seals_wet;
#include mpbody\class_assault_usa_fbi_wet;
#include mpbody\class_assault_rus_pmc_wet;
#include mpbody\class_assault_chn_pla_wet;
#include mpbody\class_assault_isa_wet;
#include mpbody\class_assault_cd_wet;
