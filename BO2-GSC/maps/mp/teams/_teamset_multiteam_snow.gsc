 ...
 * Script: maps\mp\teams\_teamset_multiteam_snow.gsc
*****************************************************/

#include maps\mp\teams\_teamset;
#include mpbody\class_assault_usa_seals_snow;
#include mpbody\class_assault_usa_fbi_snow;
#include mpbody\class_assault_rus_pmc_snow;
#include mpbody\class_assault_chn_pla_snow;
#include mpbody\class_assault_isa_snow;
#include mpbody\class_assault_cd_snow;
