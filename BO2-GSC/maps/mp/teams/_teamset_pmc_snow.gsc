 ...
 * Script: maps\mp\teams\_teamset_pmc_snow.gsc
***********************************************/

#include maps\mp\teams\_teamset;
#include mpbody\class_assault_rus_pmc_snow;
#include mpbody\class_lmg_rus_pmc_snow;
#include mpbody\class_shotgun_rus_pmc_snow;
#include mpbody\class_smg_rus_pmc_snow;
#include mpbody\class_sniper_rus_pmc_snow;
...
precache() {
  ...
  mpbody\class_lmg_rus_pmc_snow::precache();
  mpbody\class_shotgun_rus_pmc_snow::precache();
  mpbody\class_smg_rus_pmc_snow::precache();
  mpbody\class_sniper_rus_pmc_snow::precache();
}