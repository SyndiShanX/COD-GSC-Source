 ...
 * Script: maps\mp\teams\_teamset_multiteam_sand.gsc
*****************************************************/

#include maps\mp\teams\_teamset;
#include mpbody\class_assault_usa_seals_sand;
#include mpbody\class_assault_usa_fbi_sand;
#include mpbody\class_assault_rus_pmc_sand;
#include mpbody\class_assault_chn_pla_sand;
#include mpbody\class_assault_isa_sand;
