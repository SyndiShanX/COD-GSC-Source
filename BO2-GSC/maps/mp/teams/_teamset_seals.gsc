 ...
 * Script: maps\mp\teams\_teamset_seals.gsc
********************************************/

#include maps\mp\teams\_teamset;
#include mpbody\class_assault_usa_seals;
#include mpbody\class_lmg_usa_seals;
#include mpbody\class_shotgun_usa_seals;
#include mpbody\class_smg_usa_seals;
#include mpbody\class_sniper_usa_seals;
