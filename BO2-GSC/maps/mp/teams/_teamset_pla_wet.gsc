 ...
 * Script: maps\mp\teams\_teamset_pla_wet.gsc
**********************************************/

#include maps\mp\teams\_teamset;
#include mpbody\class_assault_chn_pla_wet;
#include mpbody\class_lmg_chn_pla_wet;
#include mpbody\class_shotgun_chn_pla_wet;
#include mpbody\class_smg_chn_pla_wet;
#include mpbody\class_sniper_chn_pla_wet;
...
precache() {
  ...
  mpbody\class_lmg_chn_pla_wet::precache();
  mpbody\class_shotgun_chn_pla_wet::precache();
  mpbody\class_smg_chn_pla_wet::precache();
  mpbody\class_sniper_chn_pla_wet::precache();
}