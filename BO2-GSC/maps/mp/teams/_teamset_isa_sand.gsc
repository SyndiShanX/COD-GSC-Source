 ...
 * Script: maps\mp\teams\_teamset_isa_sand.gsc
***********************************************/

#include maps\mp\teams\_teamset;
#include mpbody\class_assault_isa_sand;
#include mpbody\class_lmg_isa_sand;
#include mpbody\class_shotgun_isa_sand;
#include mpbody\class_smg_isa_sand;
#include mpbody\class_sniper_isa_sand;
