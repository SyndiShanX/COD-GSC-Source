...
scene_afghanistan_models() {
  ...
  base.origin = e_surface.origin - vectorscale((0, 0, 1), 5.0);
  ...
  level thread holo_table_feature_prop("p6_hologram_vtol_combined", "asd_down", 1, undefined, vectorscale((0, 0, -1), 26.0), "vtol", 0);
