...
exploder_earthquake() {
  ...
  assert(isDefined(level.earthquake) && isDefined(level.earthquake[earthquake_name]), "No earthquake '" + earthquake_name + "' defined for exploder - call add_earthquake() in your level script.");
  self exploder_delay();
