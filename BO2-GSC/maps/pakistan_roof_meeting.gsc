 ...
 * Script: maps\pakistan_roof_meeting.gsc
******************************************/
...
id_defalco() {
  ...
  level thread id_think(level.defalco, 60.0, 2.5, 0);
...
millibar_fov() {
  level.player thread lerp_fov_overtime(2.0, 30.0, 1);
  ...
  level.player thread lerp_fov_overtime(2.0, 10.0, 1);
