...
load_story_stats() {
  ...
  level.is_defalco_alive = !level.player get_story_stat("DEFALCO_DEAD_IN_KARMA") && !level.player get_story_stat("DEFALCO_DEAD_IN_COMMAND_CENTER");
