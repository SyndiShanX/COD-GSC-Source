 ...
 * Script: maps\pakistan_escape_intro.gsc
******************************************/
...
main() {
  ...
  level.health_regen_damage_multiplier = 4.0;
...
drone_intro_entries() {
  ...
  magicbullet("usrpg_sp", nd_start.origin + vectorscale((0, 0, 1), 64.0), v_end_pos);
