 ...
 * Script: clientscripts\mp\zm_tomb_craftables.csc
***************************************************/
...
init_craftables() {
  ...
  clientscripts\mp\zombies\_zm_craftables::add_zombie_craftable("equip_dieseldrone_zm");
  clientscripts\mp\zombies\_zm_craftables::add_zombie_craftable("tomb_shield_zm");
  clientscripts\mp\zombies\_zm_craftables::add_zombie_craftable("shovel");
  clientscripts\mp\zombies\_zm_craftables::add_zombie_craftable("elemental_staff_fire");
  clientscripts\mp\zombies\_zm_craftables::add_zombie_craftable("elemental_staff_air");
  clientscripts\mp\zombies\_zm_craftables::add_zombie_craftable("elemental_staff_water");
  clientscripts\mp\zombies\_zm_craftables::add_zombie_craftable("elemental_staff_lightning");
...
#include_craftables() {
  ...
  clientscripts\mp\zombies\_zm_craftables::include_zombie_craftable("elemental_staff_fire");
  clientscripts\mp\zombies\_zm_craftables::include_zombie_craftable("elemental_staff_air");
  clientscripts\mp\zombies\_zm_craftables::include_zombie_craftable("elemental_staff_water");
  clientscripts\mp\zombies\_zm_craftables::include_zombie_craftable("elemental_staff_lightning");
}
