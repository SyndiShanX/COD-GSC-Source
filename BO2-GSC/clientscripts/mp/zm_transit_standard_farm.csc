 ...
 * Script: clientscripts\mp\zm_transit_standard_farm.csc
*************************************************************/
...
main() {
  ...
  clientscripts\mp\zombies\_zm_game_mode_objects::gamemode_common_setup("standard", "farm", "zm_transit_farm_ext", 1);
