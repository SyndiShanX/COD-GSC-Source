 ...
 * Script: clientscripts\panama_2.csc
**************************************/

#include clientscripts\_utility;
#include clientscripts\panama_2_fx;
#include clientscripts\_load;
#include clientscripts\_audio;
#include clientscripts\panama_2_amb;

main() {
  clientscripts\panama_2_fx::main();
  clientscripts\_load::main();
  thread clientscripts\_audio::audio_init(0);
  thread clientscripts\panama_2_amb::main();
  register_clientflag_callback("scriptmover", 1, ::toggle_extra_cam);
  register_clientflag_callback("scriptmover", 13, ::blood_pool);
  waitforclient(0);

  println("*** Client : panama_2 running...");
}
