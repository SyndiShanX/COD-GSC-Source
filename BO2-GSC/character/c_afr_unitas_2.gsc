 ...
 * Script: character\c_afr_unitas_2.gsc
****************************************/

#include codescripts\character;
#include xmodelalias\c_afr_unitas_head_als;
#include xmodelalias\c_afr_unitas_hat_als;
#include xmodelalias\c_afr_unitas_gear_als;
