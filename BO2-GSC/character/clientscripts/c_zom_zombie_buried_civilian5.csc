 ...
 * Script: character\clientscripts\c_zom_zombie_buried_civilian5.csc
*************************************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_zombie_buried_civilian_body5"];
}
...
register_gibs() {
  ...
  gib_spawn.gibspawn5 = "c_zom_zombie_buried_civilian_hats2";
  gib_spawn.gibspawntag5 = "J_Head";
  level._gibbing_actor_models["c_zom_zombie_buried_civilian_body5"] = gib_spawn;
}