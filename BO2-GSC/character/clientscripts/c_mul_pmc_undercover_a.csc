 ...
 * Script: character\clientscripts\c_mul_pmc_undercover_a.csc
***********************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_mul_pmc_undercover_body1"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_mul_pmc_undercover_body1"] = gib_spawn;
}