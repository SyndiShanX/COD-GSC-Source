 ...
 * Script: character\clientscripts\c_mul_cartel1_2_char.csc
*******************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_mul_cartel_body1_2_char"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_mul_cartel_body1_2_char"] = gib_spawn;
}