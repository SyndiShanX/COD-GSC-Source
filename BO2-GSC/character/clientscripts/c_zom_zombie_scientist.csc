 ...
 * Script: character\clientscripts\c_zom_zombie_scientist.csc
***********************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_zombie_scientist_body"];
}
...
register_gibs() {
  ...
  gib_spawn.gibspawn2 = "c_zom_zombie_scientist_g_larmspawn";
  gib_spawn.gibspawntag2 = "J_Elbow_LE";
  gib_spawn.gibspawn3 = "c_zom_zombie_scientist_g_rlegspawn";
  gib_spawn.gibspawntag3 = "J_Knee_RI";
  gib_spawn.gibspawn4 = "c_zom_zombie_scientist_g_llegspawn";
  gib_spawn.gibspawntag4 = "J_Knee_LE";
  level._gibbing_actor_models["c_zom_zombie_scientist_body"] = gib_spawn;
}