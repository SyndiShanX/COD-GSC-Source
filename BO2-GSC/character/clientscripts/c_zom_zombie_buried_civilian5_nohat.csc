 ...
 * Script: character\clientscripts\c_zom_zombie_buried_civilian5_nohat.csc
*************************************************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_zombie_buried_civilian_body5_nohat"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_zom_zombie_buried_civilian_body5_nohat"] = gib_spawn;
}