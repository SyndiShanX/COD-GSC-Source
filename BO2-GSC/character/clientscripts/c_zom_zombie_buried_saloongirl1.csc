 ...
 * Script: character\clientscripts\c_zom_zombie_buried_saloongirl1.csc
*****************************************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_zombie_buried_sgirl_body1"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_zom_zombie_buried_sgirl_body1"] = gib_spawn;
}