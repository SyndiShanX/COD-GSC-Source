 ...
 * Script: character\clientscripts\c_zom_zombie3_04.csc
***********************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_zombie3_body04"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_zom_zombie3_body04"] = gib_spawn;
}