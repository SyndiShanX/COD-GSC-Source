 ...
 * Script: character\clientscripts\c_zom_zombie_buried_civilian2.csc
*************************************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_zombie_buried_civilian_body2"];
}
...
register_gibs() {
  ...
  gib_spawn.gibspawn5 = "c_zom_zombie_buried_civilian_hats3";
  gib_spawn.gibspawntag5 = "J_Head";
  level._gibbing_actor_models["c_zom_zombie_buried_civilian_body2"] = gib_spawn;
}