 ...
 * Script: character\clientscripts\c_zom_zombie8_03.csc
***********************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_zombie8_body03"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_zom_zombie8_body03"] = gib_spawn;
}