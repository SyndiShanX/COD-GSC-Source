 ...
 * Script: character\clientscripts\c_zom_tomb_crusader_2b_nohat.csc
***********************************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_tomb_crusader_body_2b_nohat"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_zom_tomb_crusader_body_2b_nohat"] = gib_spawn;
}