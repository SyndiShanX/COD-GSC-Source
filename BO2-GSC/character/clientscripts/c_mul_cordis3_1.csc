 ...
 * Script: character\clientscripts\c_mul_cordis3_1.csc
*********************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_mul_cordis_body3_1"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_mul_cordis_body3_1"] = gib_spawn;
}