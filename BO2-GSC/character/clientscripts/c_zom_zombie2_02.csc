 ...
 * Script: character\clientscripts\c_zom_zombie2_02.csc
***********************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_zombie2_body02"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_zom_zombie2_body02"] = gib_spawn;
}