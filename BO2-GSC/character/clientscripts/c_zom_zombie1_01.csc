 ...
 * Script: character\clientscripts\c_zom_zombie1_01.csc
***********************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_zombie1_body01"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_zom_zombie1_body01"] = gib_spawn;
}