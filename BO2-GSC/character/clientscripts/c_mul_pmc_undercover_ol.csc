 ...
 * Script: character\clientscripts\c_mul_pmc_undercover_ol.csc
*************************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_mul_pmc_undercover_body1_ol"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_mul_pmc_undercover_body1_ol"] = gib_spawn;
}