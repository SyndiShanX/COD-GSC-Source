 ...
 * Script: character\clientscripts\c_zom_dlc0_zombie_soldier_1_beyes.csc
*********************************************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_dlc0_zom_sol_body1"];
}
...
register_gibs() {
  ...
  gib_spawn.gibspawn2 = "c_zom_dlc0_zom_sol_body1_g_larmspawn";
  ...
  gib_spawn.gibspawn4 = "c_zom_dlc0_zom_sol_body1_g_llegspawn";
  gib_spawn.gibspawntag4 = "J_Knee_LE";
  level._gibbing_actor_models["c_zom_dlc0_zom_sol_body1"] = gib_spawn;
}