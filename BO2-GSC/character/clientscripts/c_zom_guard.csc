 ...
 * Script: character\clientscripts\c_zom_guard.csc
***************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_guard_body"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_zom_guard_body"] = gib_spawn;
}