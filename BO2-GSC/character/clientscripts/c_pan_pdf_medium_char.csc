 ...
 * Script: character\clientscripts\c_pan_pdf_medium_char.csc
*********************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_pan_pdf_body1_char"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_pan_pdf_body1_char"] = gib_spawn;
}