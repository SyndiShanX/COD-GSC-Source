 ...
 * Script: character\clientscripts\c_zom_tomb_crusader_1c.csc
***********************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_tomb_crusader_body_1c"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_zom_tomb_crusader_body_1c"] = gib_spawn;
}