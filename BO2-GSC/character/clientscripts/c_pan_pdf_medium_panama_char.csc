 ...
 * Script: character\clientscripts\c_pan_pdf_medium_panama_char.csc
***********************************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_pan_pdf_body1_panama_char"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_pan_pdf_body1_panama_char"] = gib_spawn;
}