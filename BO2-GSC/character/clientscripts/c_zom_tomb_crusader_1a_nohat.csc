 ...
 * Script: character\clientscripts\c_zom_tomb_crusader_1a_nohat.csc
***********************************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_tomb_crusader_body_1a_nohat"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_zom_tomb_crusader_body_1a_nohat"] = gib_spawn;
}