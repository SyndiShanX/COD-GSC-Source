 ...
 * Script: character\clientscripts\c_zom_zombie_buried_civilian4_nohat.csc
*************************************************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_zombie_buried_civilian_body4_nohat"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_zom_zombie_buried_civilian_body4_nohat"] = gib_spawn;
}