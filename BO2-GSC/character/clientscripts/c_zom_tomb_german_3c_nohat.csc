 ...
 * Script: character\clientscripts\c_zom_tomb_german_3c_nohat.csc
*******************************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_tomb_german_body_3c_nohat"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_zom_tomb_german_body_3c_nohat"] = gib_spawn;
}