 ...
 * Script: character\clientscripts\c_mul_cordis2_2.csc
*********************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_mul_cordis_body2_2"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_mul_cordis_body2_2"] = gib_spawn;
}