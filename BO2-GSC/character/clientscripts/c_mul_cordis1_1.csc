 ...
 * Script: character\clientscripts\c_mul_cordis1_1.csc
*********************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_mul_cordis_body1_1"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_mul_cordis_body1_1"] = gib_spawn;
}