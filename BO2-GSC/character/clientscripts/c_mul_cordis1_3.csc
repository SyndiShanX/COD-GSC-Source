 ...
 * Script: character\clientscripts\c_mul_cordis1_3.csc
*********************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_mul_cordis_body1_3"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_mul_cordis_body1_3"] = gib_spawn;
}