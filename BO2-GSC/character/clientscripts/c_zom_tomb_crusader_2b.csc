 ...
 * Script: character\clientscripts\c_zom_tomb_crusader_2b.csc
***********************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_tomb_crusader_body_2b"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_zom_tomb_crusader_body_2b"] = gib_spawn;
}