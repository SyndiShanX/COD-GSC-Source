 ...
 * Script: character\clientscripts\c_pan_pdf_intro_leader.csc
***********************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_pan_pdf_body1"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_pan_pdf_body1"] = gib_spawn;
}