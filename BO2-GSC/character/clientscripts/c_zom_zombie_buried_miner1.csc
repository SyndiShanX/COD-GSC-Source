 ...
 * Script: character\clientscripts\c_zom_zombie_buried_miner1.csc
*******************************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_zombie_buried_miner_body1"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_zom_zombie_buried_miner_body1"] = gib_spawn;
}