 ...
 * Script: character\clientscripts\c_mul_pmc_cloak_wt.csc
***************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_mul_pmc_body_1_1_cl_wt"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_mul_pmc_body_1_1_cl_wt"] = gib_spawn;
}