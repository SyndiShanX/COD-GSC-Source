 ...
 * Script: character\clientscripts\c_zom_zombie9_01.csc
***********************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_zombie9_body01"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_zom_zombie9_body01"] = gib_spawn;
}