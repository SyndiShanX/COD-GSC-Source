 ...
 * Script: character\clientscripts\c_pan_dingbats_2.csc
***********************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_pan_dingbats_body_2"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_pan_dingbats_body_2"] = gib_spawn;
}