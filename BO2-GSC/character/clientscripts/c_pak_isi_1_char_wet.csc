 ...
 * Script: character\clientscripts\c_pak_isi_1_char_wet.csc
*******************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_pak_isi_body_char_wet"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_pak_isi_body_char_wet"] = gib_spawn;
}