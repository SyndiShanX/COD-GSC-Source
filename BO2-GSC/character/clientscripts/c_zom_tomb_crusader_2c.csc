 ...
 * Script: character\clientscripts\c_zom_tomb_crusader_2c.csc
***********************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_tomb_crusader_body_2c"];
}
...
register_gibs() {
  ...
  gib_spawn.gibspawn5 = "c_zom_tomb_crusader_hat_1";
  gib_spawn.gibspawntag5 = "J_Head";
  level._gibbing_actor_models["c_zom_tomb_crusader_body_2c"] = gib_spawn;
}