 ...
 * Script: character\clientscripts\c_zom_tomb_german_3c.csc
*******************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_tomb_german_body_3c"];
}
...
register_gibs() {
  ...
  gib_spawn.gibspawn5 = "c_zom_tomb_german_hat_3";
  gib_spawn.gibspawntag5 = "J_Head";
  level._gibbing_actor_models["c_zom_tomb_german_body_3c"] = gib_spawn;
}