 ...
 * Script: character\clientscripts\c_zom_tomb_german_bare.csc
***********************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_tomb_german_body_1a"];
}
...
register_gibs() {
  ...
  gib_spawn.gibspawn5 = "c_zom_tomb_german_hat_1";
  gib_spawn.gibspawntag5 = "J_Head";
  level._gibbing_actor_models["c_zom_tomb_german_body_1a"] = gib_spawn;
}