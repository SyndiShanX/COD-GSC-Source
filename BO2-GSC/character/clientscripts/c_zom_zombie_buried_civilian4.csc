 ...
 * Script: character\clientscripts\c_zom_zombie_buried_civilian4.csc
*************************************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_zombie_buried_civilian_body4"];
}
...
register_gibs() {
  ...
  gib_spawn.gibspawn5 = "c_zom_zombie_buried_civilian_hats4";
  gib_spawn.gibspawntag5 = "J_Head";
  level._gibbing_actor_models["c_zom_zombie_buried_civilian_body4"] = gib_spawn;
}