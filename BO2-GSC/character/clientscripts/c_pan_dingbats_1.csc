 ...
 * Script: character\clientscripts\c_pan_dingbats_1.csc
***********************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_pan_dingbats_body_1"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_pan_dingbats_body_1"] = gib_spawn;
}