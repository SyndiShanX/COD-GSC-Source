 ...
 * Script: character\clientscripts\c_zom_tomb_crusader_zc.csc
***********************************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_zom_tomb_crusader_body_zc"];
}
...
register_gibs() {
  ...
  gib_spawn.gibspawn5 = "c_zom_tomb_crusader_hat_3";
  gib_spawn.gibspawntag5 = "J_Head";
  level._gibbing_actor_models["c_zom_tomb_crusader_body_zc"] = gib_spawn;
}