 ...
 * Script: character\clientscripts\c_afr_mpla_2.csc
****************************************************/

main() {
  self._gib_def = level._gibbing_actor_models["c_afr_mpla_body2"];
}
...
register_gibs() {
  ...
  level._gibbing_actor_models["c_afr_mpla_body2"] = gib_spawn;
}