 ...
 * Script: character\c_mul_cordis1_1.gsc
*****************************************/
...
main() {
  self setModel("c_mul_cordis_body1_1");
  self.headmodel = codescripts\character::randomelement(xmodelalias\c_mul_cordis_head_als::main());
  self attach(self.headmodel, "", 1);
  self.voice = "terrorist";
  self.skeleton = "base";
  self.torsodmg1 = "c_mul_cordis_body1_1_g_upclean";
  self.torsodmg2 = "c_mul_cordis_body1_1_g_rarmoff";
  self.torsodmg3 = "c_mul_cordis_body1_1_g_larmoff";
  self.torsodmg5 = "c_mul_cordis_body1_1_g_behead";
...
precache() {
  precachemodel("c_mul_cordis_body1_1");
  codescripts\character::precachemodelarray(xmodelalias\c_mul_cordis_head_als::main());
  precachemodel("c_mul_cordis_body1_1_g_upclean");
  precachemodel("c_mul_cordis_body1_1_g_rarmoff");
  precachemodel("c_mul_cordis_body1_1_g_larmoff");
  precachemodel("c_mul_cordis_body1_1_g_behead");
