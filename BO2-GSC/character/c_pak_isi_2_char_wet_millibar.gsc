 ...
 * Script: character\c_pak_isi_2_char_wet_millibar.gsc
*********************************************************/

#include codescripts\character;
#include xmodelalias\c_pak_isi_head_char_wet_m_als;

main() {
  self setModel("c_pak_isi_body_char_wet_m");
  self.headmodel = codescripts\character::randomelement(xmodelalias\c_pak_isi_head_char_wet_m_als::main());
  self attach(self.headmodel, "", 1);
  self.gearmodel = "c_pak_isi_gear2_char_wet_m";
...
precache() {
  precachemodel("c_pak_isi_body_char_wet_m");
  codescripts\character::precachemodelarray(xmodelalias\c_pak_isi_head_char_wet_m_als::main());
  precachemodel("c_pak_isi_gear2_char_wet_m");
