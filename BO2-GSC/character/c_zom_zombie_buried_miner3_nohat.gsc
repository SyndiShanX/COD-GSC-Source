 ...
 * Script: character\c_zom_zombie_buried_miner3_nohat.gsc
***************************************************************/
...
main() {
  self setModel("c_zom_zombie_buried_miner_body3_nohat");
...
precache() {
  precachemodel("c_zom_zombie_buried_miner_body3_nohat");
