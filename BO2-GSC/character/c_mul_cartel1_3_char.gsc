 ...
 * Script: character\c_mul_cartel1_3_char.gsc
**********************************************/

#include codescripts\character;
#include xmodelalias\c_mul_cartel_head_char_als;
#include xmodelalias\c_mul_cartel_gear_char_als;

main() {
  self setModel("c_mul_cartel_body1_3_char");
  ...
  self.voice = "digbat";
  self.skeleton = "base";
  self.torsodmg1 = "c_mul_cartel_body1_3_ch_g_upclean";
  self.torsodmg2 = "c_mul_cartel_body1_3_ch_g_rarmoff";
  self.torsodmg3 = "c_mul_cartel_body1_3_ch_g_larmoff";
  self.torsodmg5 = "c_mul_cartel_body1_3_ch_g_behead";
...
precache() {
  precachemodel("c_mul_cartel_body1_3_char");
  ...
  precachemodel("c_mul_cartel_body1_3_ch_g_upclean");
  precachemodel("c_mul_cartel_body1_3_ch_g_rarmoff");
  precachemodel("c_mul_cartel_body1_3_ch_g_larmoff");
  precachemodel("c_mul_cartel_body1_3_ch_g_behead");
