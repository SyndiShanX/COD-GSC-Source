 ...
 * Script: character\c_mul_cordis3_1.gsc
*****************************************/
...
main() {
  ...
  self.torsodmg2 = "c_mul_cordis_body3_1_g_rarmoff";
  self.torsodmg3 = "c_mul_cordis_body3_1_g_larmoff";
  self.torsodmg5 = "c_mul_cordis_body3_1_g_behead";
...
precache() {
  precachemodel("c_mul_cordis_body3_1");
  precachemodel("c_mul_cordis_body3_1_g_upclean");
  precachemodel("c_mul_cordis_body3_1_g_rarmoff");
  precachemodel("c_mul_cordis_body3_1_g_larmoff");
  precachemodel("c_mul_cordis_body3_1_g_behead");
