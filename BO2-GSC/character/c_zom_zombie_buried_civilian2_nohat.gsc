 ...
 * Script: character\c_zom_zombie_buried_civilian2_nohat.gsc
*********************************************************************/

#include codescripts\character;
#include xmodelalias\c_zom_zombie_buried_male_heads_als;
#include xmodelalias\c_zom_zombie_buried_civilian_hat2_als;

main() {
  self setModel("c_zom_zombie_buried_civilian_body2_nohat");
  self.headmodel = codescripts\character::randomelement(xmodelalias\c_zom_zombie_buried_male_heads_als::main());
  self attach(self.headmodel, "", 1);
  self.hatmodel = codescripts\character::randomelement(xmodelalias\c_zom_zombie_buried_civilian_hat2_als::main());
...
precache() {
  precachemodel("c_zom_zombie_buried_civilian_body2_nohat");
  codescripts\character::precachemodelarray(xmodelalias\c_zom_zombie_buried_male_heads_als::main());
  codescripts\character::precachemodelarray(xmodelalias\c_zom_zombie_buried_civilian_hat2_als::main());
