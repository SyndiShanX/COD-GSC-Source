 ...
 * Script: character\c_mul_cordis2_2.gsc
*****************************************/
...
main() {
  self setModel("c_mul_cordis_body2_2");
  ...
  self.skeleton = "base";
  self.torsodmg1 = "c_mul_cordis_body2_2_g_upclean";
  self.torsodmg2 = "c_mul_cordis_body2_2_g_rarmoff";
  self.torsodmg3 = "c_mul_cordis_body2_2_g_larmoff";
  self.torsodmg5 = "c_mul_cordis_body2_2_g_behead";
...
precache() {
  precachemodel("c_mul_cordis_body2_2");
  codescripts\character::precachemodelarray(xmodelalias\c_mul_cordis_head_als::main());
  precachemodel("c_mul_cordis_body2_gear1");
  precachemodel("c_mul_cordis_body2_2_g_upclean");
  precachemodel("c_mul_cordis_body2_2_g_rarmoff");
  precachemodel("c_mul_cordis_body2_2_g_larmoff");
  precachemodel("c_mul_cordis_body2_2_g_behead");
