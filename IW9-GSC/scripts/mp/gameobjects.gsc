  ...
  for(;;) {
    ...
    if(self.claimteam != "none") {
      if(self.usetime) {
        ...
        } else if(scripts\mp\utility\game::getgametype() == "bigctf" && istrue(self.stalemate)) {} else {
      ...
      if(!self.usetime) {
        ...
        if(!self.numtouching[self.claimteam]) {
          ...
          if(isDefined(self.lastprogressteam) && self.lastprogressteam == self.claimteam && self.teamprogress[self.claimteam] == 0)
            ...
            stompenemyteamprogress(self.claimteam);
        } else if(isDefined(self._id_F0A9A5C4D6084AE7) && isDefined(self._id_F0A9A5C4D6084AE7._id_04756733ECC825A2) && self.claimteam == self._id_F0A9A5C4D6084AE7._id_04756733ECC825A2) {} else if(self.ownerteam != self.claimteam) {
          self.setblocking = 0;
          self.setdefending = 0;
          self.lastprogressteam = self.claimteam;
          applycaptureprogressanduseupdate();
