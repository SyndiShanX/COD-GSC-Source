 ...
 * Script: scripts\mp\gametypes\br_deployable_kiosk.gsc
********************************************************/

main() {
  if(!getdvarint("scr_br_deployable_kiosk_enabled", 0)) {
    return;
  }
...
_id_CE60E2DA53459A87() {
  ...
  level._id_ED2DCA1658DA90B2._id_53385B6BE5F6C52F = getdvarint("scr_br_deployable_kiosk_health", 200);
  ...
  level._id_ED2DCA1658DA90B2._id_0338B4F24FC6601C = getdvarint("scr_br_deployable_kiosk_max_speed", 52);
  ...
  level._id_ED2DCA1658DA90B2._id_35BBF066F50AC582 = getdvarint("scr_br_deployable_kiosk_explosion_radius", 512);
  ...
  level._id_ED2DCA1658DA90B2._id_E90F0FE1F275A8B6 = getdvarfloat("scr_br_deployable_kiosk_distance_threshold_gas", 0.0);
  level._id_ED2DCA1658DA90B2._id_AEEB98B4D36B65A6 = getdvarfloat("scr_br_deployable_kiosk_distance_threshold_gas_multi_circle", 0.0);
...
checklinktotraininternal(ent) {
  ...
  while(self.traintracefails < 20) {
    ...
    if(_id_1F0571D36D0DF95B.size > 0 && isDefined(_id_1F0571D36D0DF95B["entity"]) && scripts\cp_mp\utility\train_utility::is_train_ent(_id_1F0571D36D0DF95B["entity"])) {
      ...
      if(!isDefined(self.traintracerelpos)) {} else if(distancesquared(traintracerelpos, self.traintracerelpos) > _id_1375DD9DF5EBF6CD) {
