 ...
 * Script: scripts\cp\interaction.gsc
***********************************************/
...
init() {
  ...
  if(!isDefined(level._id_EF5A3D5534030ADD))
    level._id_EF5A3D5534030ADD = 0;
...
assign_trigger_on_player_spawned() {
  ...
  for(;;) {
    ...
    player.interaction_trigger _meth_DFB78B3E724AD620(0);
    player thread _id_00BAB793FB0C5C8E();
...
registerinteraction(script_noteworthy, hint_func, activation_func, init_func, _id_AD96AC0EC299E386, suseduration, _id_5A9D289A0E9AC2D8) {
  ...
  _id_DF071553D0996FF9 = spawnStruct();
  _id_DF071553D0996FF9.script_noteworthy = script_noteworthy;
  _id_DF071553D0996FF9.hint_func = hint_func;
  _id_DF071553D0996FF9.spend_type = spend_type;
  _id_DF071553D0996FF9.tutorial = tutorial;
  _id_DF071553D0996FF9.activation_func = activation_func;
  _id_DF071553D0996FF9.enabled = 1;
  _id_DF071553D0996FF9.disabledguidedinteractions = 1;
  _id_DF071553D0996FF9.cost = 0;
  _id_DF071553D0996FF9.requires_power = requires_power;
  _id_DF071553D0996FF9.init_func = init_func;
  _id_DF071553D0996FF9.can_use_override_func = undefined;
  _id_DF071553D0996FF9.noactivation = _id_AD96AC0EC299E386;
  _id_DF071553D0996FF9.useduration = suseduration;
  _id_DF071553D0996FF9.is_p_ent = _id_5A9D289A0E9AC2D8;
  level.interactions[script_noteworthy] = _id_DF071553D0996FF9;
  _id_70DAB3207FB65169 = scripts\engine\utility::getStructArray(script_noteworthy, "script_noteworthy");

  for(_id_AC0E594AC96AA3A8 = 0; _id_AC0E594AC96AA3A8 < _id_70DAB3207FB65169.size; _id_AC0E594AC96AA3A8++) {
    _id_70DAB3207FB65169[_id_AC0E594AC96AA3A8]._id_EF5A3D5534030ADD = level._id_EF5A3D5534030ADD;
    level.current_interaction_structs[level._id_EF5A3D5534030ADD] = _id_70DAB3207FB65169[_id_AC0E594AC96AA3A8];
    level._id_EF5A3D5534030ADD++;
  }

  if(isDefined(init_func)) {
    if(scripts\engine\utility::flag("interactions_initialized")) {
      level thread[[init_func]](_id_70DAB3207FB65169);

      if(istrue(_id_5A9D289A0E9AC2D8)) {
        foreach(_id_DF071553D0996FF9 in _id_70DAB3207FB65169)
        scripts\cp\coop_personal_ents::addtopersonalinteractionlist(_id_DF071553D0996FF9);
      }
    }
  }
...
add_interaction_structs_to_interaction_arrays(_id_70DAB3207FB65169) {
  foreach(_id_DF071553D0996FF9 in _id_70DAB3207FB65169)
  level.current_interaction_structs[_id_DF071553D0996FF9._id_EF5A3D5534030ADD] = _id_DF071553D0996FF9;
}
...
register_interaction(script_noteworthy, spend_type, tutorial, hint_func, activation_func, _id_CA8CDB622A3BCECB, requires_power, init_func, can_use_override_func, _id_AD96AC0EC299E386, suseduration) {
  registerinteraction(script_noteworthy, hint_func, activation_func, init_func, _id_AD96AC0EC299E386, suseduration);
}
...
_id_00BAB793FB0C5C8E() {
  ...
  if(isDefined(level.player_interaction_monitor))
    ...
    thread _id_061244C780CC5FD7();
}

_id_061244C780CC5FD7() {
  ...
  for(;;) {
    ...
    if(!isDefined(_id_AC3DC6CF8564E576) || !scripts\engine\utility::array_contains(level.current_interaction_structs, _id_AC3DC6CF8564E576) || !can_use_interaction(_id_AC3DC6CF8564E576)) {
      reset_interaction();
      continue;
    }

    if(!no_previous_interaction_point() || !interaction_point_has_changed(_id_AC3DC6CF8564E576) && interaction_is_button_mash(_id_AC3DC6CF8564E576) || interaction_point_has_changed(_id_AC3DC6CF8564E576))
      set_interaction_point(_id_AC3DC6CF8564E576);
...
reset_interaction() {
  ...
  wait 0.2;
  self.interaction_trigger _meth_DFB78B3E724AD620(0);
  self.last_interaction_point = undefined;
}
...
set_interaction_point(_id_AC3DC6CF8564E576, _id_9883D93111FD5AB9) {
  ...
  if(istrue(_id_AC3DC6CF8564E576._id_9D53C266D664E00A))
    _id_C2F4EC03C9EC610E = _id_AC3DC6CF8564E576.origin;
  ...
  if(_id_FB316FEAB9934117(_id_AC3DC6CF8564E576))
    self.interaction_trigger.origin = _id_AC3DC6CF8564E576.origin;
  ...
  self.interaction_trigger _meth_DFB78B3E724AD620(1);
}
...
can_purchase_ammo(_id_D4DF17A1168AC8E2) {
  ...
  if(isDefined(_id_C53C17F2D86BCA58)) {
    ...
    _id_8529009219E1AD48 = scripts\cp\utility::_id_ED18A118C6FA5C4F(_id_C53C17F2D86BCA58);
    ...
    if(_id_0DE8A9EAD75A0581 < _id_DB6891EE5A14D7AA)
      return 1;
    else if(_id_8529009219E1AD48 == weaponclipsize(_id_C53C17F2D86BCA58) && self getweaponammoclip(_id_C53C17F2D86BCA58) < weaponclipsize(_id_C53C17F2D86BCA58))
      return 1;
    else
      return 0;
  }
...
remove_from_current_interaction_list(_id_DF071553D0996FF9) {
  ...
  if(isDefined(level.current_interaction_structs[_id_DF071553D0996FF9._id_EF5A3D5534030ADD]))
    level.current_interaction_structs[_id_DF071553D0996FF9._id_EF5A3D5534030ADD] = undefined;
...
remove_from_current_interaction_list_for_player(_id_DF071553D0996FF9, player) {
  ...
  player.disabled_interactions[_id_DF071553D0996FF9._id_EF5A3D5534030ADD] = _id_DF071553D0996FF9;
...
add_to_current_interaction_list_for_player(_id_DF071553D0996FF9, player) {
  ...
  player.disabled_interactions[_id_DF071553D0996FF9._id_EF5A3D5534030ADD] = undefined;
  scripts\cp\coop_personal_ents::update_special_mode_for_player(player);
}
...
can_purchase_interaction(_id_DF071553D0996FF9, amount, spend_type, weapon) {
  ...
  if(_id_3BCAA2CBAF54ABDD::player_has_enough_currency(cost, spend_type))
    return 1;
...
take_player_money(cost, _id_E42F7EB456B932F2) {
  _id_3BCAA2CBAF54ABDD::take_player_currency(cost, 1, _id_E42F7EB456B932F2);
}
...
getammopurchasestring(_id_DF071553D0996FF9, player) {
  ...
  _id_8529009219E1AD48 = scripts\cp\utility::_id_ED18A118C6FA5C4F(currentweapon);
  ...
  foreach(weapon in weapons) {
    ...
    if(_id_9211CDAADB7BCA55 == scripts\cp\utility::getrawbaseweaponname(_id_DF071553D0996FF9.script_noteworthy)) {
      ...
      _id_8529009219E1AD48 = scripts\cp\utility::_id_ED18A118C6FA5C4F(_id_3626CCBDF1758532);
      _id_DB6891EE5A14D7AA = int(_id_629F6083F99F1D29 * _id_8529009219E1AD48);
    }
  }
...
interaction_is_valid(_id_DF071553D0996FF9, player) {
  ...
  if(!isDefined(_id_DF071553D0996FF9._id_EF5A3D5534030ADD))
    return 0;

  return 1;
}

_id_FB316FEAB9934117(_id_DF071553D0996FF9) {
  return _id_DF071553D0996FF9.script_noteworthy == "hardpoint_airdrop";
}
...
interaction_is_weapon_buy(_id_DF071553D0996FF9) {
  if(isDefined(_id_DF071553D0996FF9.weapon))
    return 1;
...
spawninteractionmodel(_id_DF071553D0996FF9, _id_E0D9D2880C046704) {
  ...
  if(isDefined(_id_DF071553D0996FF9.script_modelname)) {
    ...
    if(isDefined(_id_DF071553D0996FF9._id_C83A47C596B260BC))
      model[[_id_DF071553D0996FF9._id_C83A47C596B260BC]](_id_DF071553D0996FF9);
  }
}
...
move_to_closest_interaction(player) {
  ...
  for(;;) {
    if(istrue(player.inlaststand) || istrue(player.siege_activated) || istrue(player.flung)) {
      ...
      _id_D5B8724607C37B52 = sortbydistancecullbyradius(level.current_interaction_structs, player.origin, 750);

      foreach(item in _id_D5B8724607C37B52) {
        if(!isDefined(player.disabled_interactions[item._id_EF5A3D5534030ADD]) && is_permitted_guided_interaction(player, item, _id_43E0B9317508501B))
...
_id_9A2E153E21F32208(_id_DF071553D0996FF9, player, cost) {
  if(!isDefined(cost))
    cost = _id_DF071553D0996FF9 interaction_get_cost();
  ...
  player thread take_player_money(cost, _id_E42F7EB456B932F2);
  interaction_post_activate_update(_id_DF071553D0996FF9);
}

_id_550809E2AB1F8EBC(interaction_name, _id_2BA45A0BBBC19F0C) {
  level.interaction_hintstrings[interaction_name] = _id_2BA45A0BBBC19F0C;
}