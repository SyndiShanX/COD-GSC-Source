...
watchentitiesinradius(_id_40EA85AA56FCCDC4, _id_4063CDC9B79E33F2, _id_ECEA6CDA97E5F7AE, _id_26E2CA9B2AD77B37, _id_9DC460B17444614F) {
  ...
  for(;;) {
    ...
    if(_id_9DC460B17444614F)
      _id_A018E61307A26F1A = scripts\cp\utility\player::getplayersinradius(self.origin, _id_40EA85AA56FCCDC4);
    else
...
isbossheli(ent) {
  ...
  _id_8AB8EB8DEF8AC7AC = ent.vehicletype == "apache" || ent.vehicletype == "veh_apache_cp";
  return _id_8AB8EB8DEF8AC7AC;
}
