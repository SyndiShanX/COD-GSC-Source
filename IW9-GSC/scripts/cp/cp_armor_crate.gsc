...
armor_crate_init() {
  ...
  _id_86280FEFB94B6B28.lifespan = 300;
...
armorbox_onusedeployable(_id_FBBAB18B5A41C7CB) {
  ...
  scripts\cp\challenges_cp::_id_3D55D46E36D8430B();
  self playlocalsound("weap_ammo_pickup");
  _id_FBBAB18B5A41C7CB scripts\cp\cp_deployablebox::box_disableplayeruse(self);
  return 1;
}
