 ...
 * Script: scripts\cp\equipment\cp_decoy_grenade.gsc
*****************************************************/
...
decoy_debuffenemiesinrange() {
  _id_EF269077A28646EB = scripts\common\utility::playersincylinder(self.origin, 800);
  ...
  foreach(ai in _id_01D4621C77C9108F) {
    ...
    if(ai _id_18A73A64992DD07D::is_specified_unittype("suicidebomber")) {
