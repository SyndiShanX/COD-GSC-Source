 ...
 * Script: scripts\cp\damagefeedback.gsc
***********************************************/
...
_id_04E514DCD8E549D1(einflictor, eattacker, victim, idamage, smeansofdeath, objweapon, shitloc, idflags, _id_1DA1A66B5C6A06A7, _id_986B2E0350629522, _id_0708152DEDBC0117) {
...
process_damage_feedback(einflictor, eattacker, idamage, idflags, smeansofdeath, sweapon, vpoint, vdir, shitloc, timeoffset, victim) {
  ...
  if(isDefined(_id_91EBB035A259E76A) && _id_91EBB035A259E76A != victim && (!isDefined(shitloc) || shitloc != "shield")) {
    ...
    if(istrue(victim _id_18A73A64992DD07D::is_specified_unittype("juggernaut")))
      ...
      if(isDefined(self._id_B5218CF00DAD94EF) && self._id_B5218CF00DAD94EF > 0)
        ...
        _id_91EBB035A259E76A playsoundtoplayer("hit_marker_3d_armor_break", _id_91EBB035A259E76A);
      }
    ...
    if(istrue(self._id_61BFAFE53CF69323))
      _id_14B8F2EEBA6A3E78 = 0;
...
updatedamagefeedback(_id_B98146816886D3C4, _id_D7198CEB7D51DB5B, damage, headshot, _id_B2883531AFA6B83D, agent, inflictor, attacker, _id_62CF84636D4CEF2C) {
  ...
  if(getdvarint("dvar_553350CE7343FF76", 0) == 1)
    _id_62CF84636D4CEF2C = 1;
  ...
  if(getdvarint("scr_nohitmarker", 1) != 0 && _id_B98146816886D3C4 != "hittrophysystem" && _id_B98146816886D3C4 != "hitveharmor" && _id_B98146816886D3C4 != "hitvehstandard" && _id_B98146816886D3C4 != "hitveharmorbreak" && _id_B98146816886D3C4 != "hitarmorheavy" && _id_B98146816886D3C4 != "hitarmorheavybreak" && _id_B98146816886D3C4 != "hitarmorlightbreak" && _id_B98146816886D3C4 != "hithelmetlightbreak" && _id_B98146816886D3C4 != "hithelmetheavybreak" && _id_B98146816886D3C4 != "hitvehcritical" && _id_B98146816886D3C4 != "hitnobulletdamage" && _id_B98146816886D3C4 != "hitlaststand_stimpistol" && _id_B98146816886D3C4 != "hitjuggernaut") {
    return;
  }
