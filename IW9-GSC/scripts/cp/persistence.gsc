 ...
 * Script: scripts\cp\persistence.gsc
***********************************************/
...
_id_5D7C28C83D8DA818(_id_6B05369A767E9DBC) {
  _id_8334742FE1363A27 = get_player_currency();
  _id_98AFD1CE36F4905A = int(max(0, _id_8334742FE1363A27 + _id_6B05369A767E9DBC));
  set_player_currency(_id_98AFD1CE36F4905A);
}

set_player_currency(amount, _id_8E67A20D8E88DB4D) {
  self.plundercount = amount;

  if(!istrue(_id_8E67A20D8E88DB4D))
...
give_player_currency(amount, _id_F0778934C2C7E788, shitloc, _id_04A46DC3F73A35CB, _id_7F71FF0C9FD703C5, _id_1E921A3666F3D7EC) {
  ...
  if(!isDefined(_id_B4187EC006E2D1E2))
    _id_B4187EC006E2D1E2 = 0;
  ...
  if(scripts\cp\utility::_id_F993F83A21FC44B2() && getdvarint("dvar_D4ED36D1F90CA352", 0) && (!isDefined(_id_7F71FF0C9FD703C5) || _id_7F71FF0C9FD703C5 == "debug")) {
    set_player_currency(_id_98AFD1CE36F4905A);
    thread _id_187A04151C40FB72::scorepointspopup(amount, 1);
  } else if(scripts\cp\utility::_id_F993F83A21FC44B2() && getdvarint("dvar_D4ED36D1F90CA352", 0) && (isDefined(_id_7F71FF0C9FD703C5) && _id_7F71FF0C9FD703C5 == "bounty")) {
    set_player_currency(_id_98AFD1CE36F4905A);
    thread _id_41AE4F5CA24216CB::_id_0366980B6A8796AE("stat_532C064CAF1E3CA6", undefined, amount);
  } else if(scripts\cp\utility::is_wave_gametype() || isDefined(_id_7F71FF0C9FD703C5) && _id_7F71FF0C9FD703C5 == "cash_pickup") {
...
reset_eog_stats(clientnum) {
  for(_id_AC0E594AC96AA3A8 = 0; _id_AC0E594AC96AA3A8 < level.eogtracking.size; _id_AC0E594AC96AA3A8++) {
    ...
    if(isDefined(self.pers["counting_stats"]) && isDefined(self.pers["counting_stats"][level.eogtracking[_id_AC0E594AC96AA3A8]]))
      value = self.pers["counting_stats"][level.eogtracking[_id_AC0E594AC96AA3A8]];

    self setplayerdata("cp", "EoGPlayer", clientnum, level.eogtracking[_id_AC0E594AC96AA3A8], value);
  }
}
...
_id_00C0480DC3A45EF6(_id_6BD45B7708CE4099) {
  _id_1DAB4A6BAD01C509 = self getentitynumber();
  _id_748A5B6E1EB008F5 = self getplayerdata("cp", "EoGPlayer", _id_1DAB4A6BAD01C509, _id_6BD45B7708CE4099);
...
update_weaponstats(_id_415D8240D8C76BEC, _id_8D74294401BB1C97, _id_D0F001B1761FBF53, value) {
  ...
  _id_7E2C53B0BCF117D9.weaponname = base_weapon;
  _id_7E2C53B0BCF117D9._id_629757F5C9E770D8 = _id_D0F001B1761FBF53;
  _id_7E2C53B0BCF117D9._id_A1D4E7D5EF9DA660 = value;
  _id_7E2C53B0BCF117D9.variantid = getweaponvariantindex(_id_8D74294401BB1C97);
...
increment_player_career_shots_fired(player) {
