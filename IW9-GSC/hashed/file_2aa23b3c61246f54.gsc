 ...
 * Script: hashed\file_2aa23b3c61246f54.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(3, _id_687325E5C597E4FB, characters, "actor_enemy_mp_smg_tier1_ru")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_smg_tier1_ru";
