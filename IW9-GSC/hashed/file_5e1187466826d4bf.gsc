 ...
 * Script: hashed\file_5e1187466826d4bf.gsc
***********************************************/
...
main() {
  ...
  _id_FEA750D6814B803D = "iw9_dm_pgolf1_mp, [ none, none, none, none, none, none ], none, none";
...
setup_model(agent_type) {
  _id_5C431EE36C371999::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_cp_sniper_tier1_aq";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_5C431EE36C371999::_id_8168FBF6282D398B();
  }
...
_id_E8CF870298E36BDC() {
  ...
  if(!isDefined(level._id_67B54180A55F70E1[_id_FEA750D6814B803D]))
    level._id_67B54180A55F70E1[_id_FEA750D6814B803D] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_dm_pgolf1_mp", ["none", "none", "none", "none", "none", "none"], "none", "none");
