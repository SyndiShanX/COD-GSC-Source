 ...
 * Script: hashed\file_5a64299cad91a4fb.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  characters = ["character_cp_usmc_basic_ar_1", "character_cp_usmc_basic_ar_2", "character_cp_usmc_basic_ar_3", "character_cp_usmc_basic_ar_4", "character_cp_usmc_basic_lmg"];

  switch (scripts\code\character::get_random_character(5, _id_687325E5C597E4FB, characters, "actor_ally_cp_usmc_ar")) {
    case 0:
      character\character_cp_usmc_basic_ar_1::_id_8EE09B8CB8661567();
      break;
    case 1:
      character\character_cp_usmc_basic_ar_2::_id_8EE09B8CB8661567();
      break;
    case 2:
      character\character_cp_usmc_basic_ar_3::_id_8EE09B8CB8661567();
      break;
    case 3:
      character\character_cp_usmc_basic_ar_4::_id_8EE09B8CB8661567();
      break;
    case 4:
      character\character_cp_usmc_basic_lmg::_id_8EE09B8CB8661567();
      break;
  }
}

precache() {
  agent_type = "actor_ally_cp_usmc_ar";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    character\character_cp_usmc_basic_ar_1::_id_8168FBF6282D398B();
    character\character_cp_usmc_basic_ar_2::_id_8168FBF6282D398B();
    character\character_cp_usmc_basic_ar_3::_id_8168FBF6282D398B();
    character\character_cp_usmc_basic_ar_4::_id_8168FBF6282D398B();
    character\character_cp_usmc_basic_lmg::_id_8168FBF6282D398B();
  }
