 ...
 * Script: hashed\file_34d9fdab8e05405a.gsc
***********************************************/
...
main() {
  ...
  switch (scripts\code\character::get_random_weapon(2)) {
    case 0:
      _id_FEA750D6814B803D = "iw9_sm_apapa, [ lasercyl_hip02, iw9_minireddot01_tall, mag_sm_large_p03 ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
    case 1:
      _id_FEA750D6814B803D = "iw9_sm_alpha57, [ laserbox_hip02, reflex01_tall, stock_ar_tactical_p01_alpha57 ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
  }
...
precache() {
  agent_type = "actor_enemy_mp_smg_tier3_biolab";
...
_id_E8CF870298E36BDC() {
  ...
  _id_5576D3BE590A9A64 = "iw9_sm_apapa, [ lasercyl_hip02, iw9_minireddot01_tall, mag_sm_large_p03 ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D3BE590A9A64]))
    level._id_67B54180A55F70E1[_id_5576D3BE590A9A64] = scripts\mp\class::_id_E83615F8A92E4378("iw9_sm_apapa", ["lasercyl_hip02", "iw9_minireddot01_tall", "mag_sm_large_p03"], "none", "none");

  _id_5576D6BE590AA0FD = "iw9_sm_alpha57, [ laserbox_hip02, reflex01_tall, stock_ar_tactical_p01_alpha57 ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD]))
    level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD] = scripts\mp\class::_id_E83615F8A92E4378("iw9_sm_alpha57", ["laserbox_hip02", "reflex01_tall", "stock_ar_tactical_p01_alpha57"], "none", "none");
