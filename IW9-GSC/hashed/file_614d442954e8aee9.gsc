 ...
 * Script: hashed\file_614d442954e8aee9.gsc
***********************************************/
...
setup_model(agent_type) {
  _id_643E8B467B75ED76::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_cp_riotshield_tier1_nvg_aq";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_643E8B467B75ED76::_id_8168FBF6282D398B();
  }
