 ...
 * Script: hashed\file_1ab3687ff5c05f23.gsc
***********************************************/

main(_id_97282C14346A7FCF, _id_CDDA4278F5259F6D) {
  if(scripts\engine\utility::flag_exist("mp_saba_hydro_vehicledrive_cs")) {
    return;
  }
  if(!isDefined(_id_CDDA4278F5259F6D))
    _id_CDDA4278F5259F6D = scripts\common\create_script_utility::_id_B055D49370405173();

  scripts\engine\utility::flag_init("mp_saba_hydro_vehicledrive_cs");
  s = spawnStruct();
  level thread cs_return_and_wait_for_flag(_id_CDDA4278F5259F6D, s, "mp_saba_hydro_vehicledrive_cs");
...
cs_return_and_wait_for_flag(_id_CDDA4278F5259F6D, s, _id_CE173D78F5680530) {
  ...
  s scripts\common\create_script_utility::cs_setup_arrays(_id_CDDA4278F5259F6D, "mp_saba_hydro_vehicledrive_cs");
  ...
  level thread scripts\common\create_script_utility::wait_for_flags(s, "mp_saba_hydro_vehicledrive_cs");
}
...
createstructs(_id_CE2D3C78F5803630, _id_CDDA4278F5259F6D, _id_CE173D78F5680530) {
  ...
  _id_CE2D3C78F5803630[[f]](s, _id_CDDA4278F5259F6D, _id_CE173D78F5680530, (-5935, 15115, 355.42), (0, 225, 0), "vehicledrive_guard");
  s = scripts\common\create_script_utility::s();
  s._id_B205D90302DA2F07 = "saba_hydro";
  _id_CE2D3C78F5803630[[f]](s, _id_CDDA4278F5259F6D, _id_CE173D78F5680530, (-6865.5, 15822.5, 466), (0, 225, 0), "dmz_vehicledrive_end", undefined, undefined, undefined, undefined, undefined, undefined, 200);
