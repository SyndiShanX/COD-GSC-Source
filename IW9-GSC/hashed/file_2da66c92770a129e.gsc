 ...
 * Script: hashed\file_2da66c92770a129e.gsc
***********************************************/
...
main() {
  ...
  switch (scripts\code\character::get_random_weapon(3)) {
    ...
    case 1:
      ...
      break;
    case 2:
      _id_FEA750D6814B803D = "iw9_sm_mpapa7, [ none, none, none, none, none, none ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
  }
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(3, _id_687325E5C597E4FB, characters, "actor_enemy_mp_smg_tier3_ru")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_smg_tier3_ru";
...
_id_E8CF870298E36BDC() {
  ...
  _id_5576D6BE590AA0FD = "iw9_sm_aviktor, [ none, none, none, none, none, none ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD]))
    level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD] = scripts\mp\class::_id_E83615F8A92E4378("iw9_sm_aviktor", ["none", "none", "none", "none", "none", "none"], "none", "none");

  _id_5576D5BE590A9ECA = "iw9_sm_mpapa7, [ none, none, none, none, none, none ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D5BE590A9ECA]))
    level._id_67B54180A55F70E1[_id_5576D5BE590A9ECA] = scripts\mp\class::_id_E83615F8A92E4378("iw9_sm_mpapa7", ["none", "none", "none", "none", "none", "none"], "none", "none");
