 ...
 * Script: hashed\file_147448f3f080c636.gsc
***********************************************/
...
_id_6145AB8334E20D85(source, _id_BC807AA760828D81) {
  ...
  foreach(_id_A5638903B40C5A21 in level.civs["ending_cap"]) {
    ...
    if(dist <= 500) {
      if(_id_A5638903B40C5A21._id_7AFD86C1AF40885B == "cower") {} else if(_id_A5638903B40C5A21._id_7AFD86C1AF40885B != "panicked" && _id_A5638903B40C5A21._id_7AFD86C1AF40885B != "scared") {
        _id_469BB23C3EF9A2F8 = randomint(10);
    ...
    if(dist <= 1000) {
      if(_id_A5638903B40C5A21._id_7AFD86C1AF40885B == "cower") {} else if(_id_A5638903B40C5A21._id_7AFD86C1AF40885B == "panicked") {
