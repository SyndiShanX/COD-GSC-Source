 ...
 * Script: hashed\file_26312d39e065281c.gsc
***********************************************/
...
main() {
  ...
  switch (scripts\code\character::get_random_weapon(3)) {
    case 0:
      _id_FEA750D6814B803D = "iw9_sm_mpapa7_mp, [ mag_sm_small_p09 ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
    case 1:
      _id_FEA750D6814B803D = "iw9_sm_mpapa7_mp, [ stock_sm_tactical_p09, reflex03_tall, bar_sm_hvyshort_p09 ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
    case 2:
      _id_FEA750D6814B803D = "iw9_sm_mpapa7_mp, [ grip_vert02, iw9_minireddot02_tall, comp_sm_02 ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
  }
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_cp_smg_tier1_cartel")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_cp_smg_tier1_cartel";
...
_id_E8CF870298E36BDC() {
  ...
  _id_5576D3BE590A9A64 = "iw9_sm_mpapa7_mp, [ mag_sm_small_p09 ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D3BE590A9A64]))
    level._id_67B54180A55F70E1[_id_5576D3BE590A9A64] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_sm_mpapa7_mp", ["mag_sm_small_p09"], "none", "none");

  _id_5576D6BE590AA0FD = "iw9_sm_mpapa7_mp, [ stock_sm_tactical_p09, reflex03_tall, bar_sm_hvyshort_p09 ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD]))
    level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_sm_mpapa7_mp", ["stock_sm_tactical_p09", "reflex03_tall", "bar_sm_hvyshort_p09"], "none", "none");

  _id_5576D5BE590A9ECA = "iw9_sm_mpapa7_mp, [ grip_vert02, iw9_minireddot02_tall, comp_sm_02 ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D5BE590A9ECA]))
    level._id_67B54180A55F70E1[_id_5576D5BE590A9ECA] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_sm_mpapa7_mp", ["grip_vert02", "iw9_minireddot02_tall", "comp_sm_02"], "none", "none");
