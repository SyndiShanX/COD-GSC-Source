 ...
 * Script: hashed\file_737f801e6beb18c7.gsc
***********************************************/

_id_69E63E3462F94600() {
  ...
  _id_584994FAB4A8712B.callbacks["equip_binoculars"]["onGive"] = ::binoculars_ongive;
  _id_584994FAB4A8712B.callbacks["equip_binoculars"]["onTake"] = ::binoculars_ontake;
}
...
_id_67DA6F8A8E37737B(targetent) {
  ...
  if(isPlayer(targetent)) {
    _id_295719F06C03407F = targetent scripts\cp_mp\utility\player_utility::getstancetop();
    _id_FC60036BA7BF253A = targetent scripts\cp_mp\utility\player_utility::getstancecenter();
...
binoculars_hascoldblooded(targetent) {
  return isPlayer(targetent) && targetent scripts\cp\utility::_hasperk("specialty_noscopeoutline");
}
...
binoculars_setexpirationtimer(targetent) {
  targetdata = self.binocularsstruct.targetdata[targetent getentitynumber()];
  expiretime = getdvarint("dvar_B9E9EE1040E95FE3", 15000);
...
binoculars_addmarkpoints(targetent) {
  ...
  if(!isDefined(self.markedentitieslifeindices[_id_8B1683C8EAD7B9BE]) || self.markedentitieslifeindices[_id_8B1683C8EAD7B9BE] > _id_59A52BFE186A64C9) {
    ...
    thread _id_293BC33BD79CABD1::killeventtextpopup("stat_DAF5C8199CB809AE", 0);

    if(scripts\cp_mp\utility\script_utility::issharedfuncdefined("player", "doScoreEvent"))
      self thread[[scripts\cp_mp\utility\script_utility::getsharedfunc("player", "doScoreEvent")]]("binoculars_marked");
  }
}
...
binoculars_giveassistpoints(attacker, victim) {
  ...
  if(scripts\cp_mp\utility\script_utility::issharedfuncdefined("game", "getTeamData"))
    _id_6D5ED003AF1F9612 = [[scripts\cp_mp\utility\script_utility::getsharedfunc("game", "getTeamData")]](attacker.team, "players");
  ...
  foreach(_id_F0EA4030349A33D5 in _id_6D5ED003AF1F9612) {
    ...
    if(_id_F0EA4030349A33D5 binoculars_targetismarked(victim)) {
      if(scripts\cp_mp\utility\script_utility::issharedfuncdefined("player", "doScoreEvent"))
        _id_F0EA4030349A33D5 thread[[scripts\cp_mp\utility\script_utility::getsharedfunc("player", "doScoreEvent")]]("binoculars_assist");
    }
  }
}
