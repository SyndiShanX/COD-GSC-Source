 ...
 * Script: hashed\file_796573ce3cdc1e3.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  characters = ["character_iw9_enemy_pmc_tier1_1_1", "character_iw9_enemy_pmc_tier1_2_1", "character_iw9_enemy_pmc_tier1_3_1", "character_iw9_enemy_pmc_tier1_4_1", "character_iw9_enemy_aq_ar_5"];

  switch (scripts\code\character::get_random_character(5, _id_687325E5C597E4FB, characters, "actor_enemy_mp_ar_tier1_pmc")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_ar_tier1_pmc";
...
_id_E8CF870298E36BDC() {
  ...
  if(!isDefined(level._id_67B54180A55F70E1[_id_FEA750D6814B803D]))
    level._id_67B54180A55F70E1[_id_FEA750D6814B803D] = scripts\mp\class::_id_E83615F8A92E4378("iw9_ar_mike4", ["none", "none", "none", "none", "none", "none"], "none", "none");
