 ...
 * Script: hashed\file_475b8f2a2b661976.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_mp_rpg_tier1_merc")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_rpg_tier1_merc";
