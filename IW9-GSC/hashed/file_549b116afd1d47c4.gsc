 ...
 * Script: hashed\file_549b116afd1d47c4.gsc
***********************************************/
...
main() {
  ...
  switch (scripts\code\character::get_random_weapon(5)) {
    case 0:
      _id_FEA750D6814B803D = "iw9_ar_akilo105_mp, [ mag_ar_lgtxlarge_p04, ub_gl_akilo ], none, none";
    ...
    case 1:
      ...
      break;
    case 2:
      _id_FEA750D6814B803D = "iw9_ar_akilo105_mp, [ holo01, mag_ar_lgtlarge_p04_akilo105, grip_vert01 ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
    case 3:
...
precache() {
  agent_type = "actor_enemy_cp_ar_tier3_cartel";
...
_id_E8CF870298E36BDC() {
  ...
  _id_5576D3BE590A9A64 = "iw9_ar_akilo105_mp, [ mag_ar_lgtxlarge_p04, ub_gl_akilo ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D3BE590A9A64]))
    level._id_67B54180A55F70E1[_id_5576D3BE590A9A64] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_ar_akilo105_mp", ["mag_ar_lgtxlarge_p04", "ub_gl_akilo"], "none", "none");
  ...
  _id_5576D5BE590A9ECA = "iw9_ar_akilo105_mp, [ holo01, mag_ar_lgtlarge_p04_akilo105, grip_vert01 ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D5BE590A9ECA]))
    level._id_67B54180A55F70E1[_id_5576D5BE590A9ECA] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_ar_akilo105_mp", ["holo01", "mag_ar_lgtlarge_p04_akilo105", "grip_vert01"], "none", "none");
