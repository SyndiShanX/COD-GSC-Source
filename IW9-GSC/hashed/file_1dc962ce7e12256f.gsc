 ...
 * Script: hashed\file_1dc962ce7e12256f.gsc
***********************************************/
...
setup_model(agent_type) {
  _id_37A1F321C29D5908::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_cp_riotshield_tier3_nvg_aq";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_37A1F321C29D5908::_id_8168FBF6282D398B();
  }
