 ...
 * Script: hashed\file_7ddfb3ce873eed2e.gsc
***********************************************/
...
setup_model(agent_type) {
  _id_5B6B2CCFFF137E75::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_cp_riotshield_tier2_nvg_aq";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_5B6B2CCFFF137E75::_id_8168FBF6282D398B();
  }
