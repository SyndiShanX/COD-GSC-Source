 ...
 * Script: hashed\file_202bd16030099022.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  characters = ["character_iw9_wz_rusher_pmc_tier3_1_1", "character_iw9_wz_rusher_pmc_tier3_2_1", "character_iw9_wz_rusher_pmc_tier3_3_1"];

  switch (scripts\code\character::get_random_character(3, _id_687325E5C597E4FB, characters, "actor_enemy_mp_rusher_tier3_merc")) {
    case 0:
      _id_15138D613C1DD8F9::_id_8EE09B8CB8661567();
      break;
    case 1:
      _id_47AC1FFD1505FC7C::_id_8EE09B8CB8661567();
      break;
    case 2:
      _id_116F39414F68474B::_id_8EE09B8CB8661567();
      break;
  }
}

precache() {
  agent_type = "actor_enemy_mp_rusher_tier3_merc";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_15138D613C1DD8F9::_id_8168FBF6282D398B();
    _id_47AC1FFD1505FC7C::_id_8168FBF6282D398B();
    _id_116F39414F68474B::_id_8168FBF6282D398B();
  }
