 ...
 * Script: hashed\file_4218c6de2b3477d2.gsc
***********************************************/
...
setup_model(agent_type) {
  _id_168E0C2D1646F357::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_mp_riotshield_tier2_aq";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_168E0C2D1646F357::_id_8168FBF6282D398B();
  }
