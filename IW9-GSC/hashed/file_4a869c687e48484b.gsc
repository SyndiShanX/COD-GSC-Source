 ...
 * Script: hashed\file_4a869c687e48484b.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_mp_sniper_tier1_pmc")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_sniper_tier1_pmc";
