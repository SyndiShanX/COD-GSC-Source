 ...
 * Script: hashed\file_6c6ccd8c6079310d.gsc
***********************************************/
...
setup_model(agent_type) {
  _id_3BEAB04E93C4181E::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_cp_ar_tier3_aq";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_3BEAB04E93C4181E::_id_8168FBF6282D398B();
  }
