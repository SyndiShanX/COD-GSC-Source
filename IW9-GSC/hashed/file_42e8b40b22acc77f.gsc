 ...
 * Script: hashed\file_42e8b40b22acc77f.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  characters = ["character_iw9_aq_smg_1_white_nvg", "character_iw9_enemy_aq_ar_2_white_nvg"];

  switch (scripts\code\character::get_random_character(2, _id_687325E5C597E4FB, characters, "actor_enemy_cp_smg_tier1_nvg_aq")) {
    case 0:
      _id_4732456CA74D9FC7::_id_8EE09B8CB8661567();
      break;
    case 1:
...
precache() {
  agent_type = "actor_enemy_cp_smg_tier1_nvg_aq";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_4732456CA74D9FC7::_id_8168FBF6282D398B();
