 ...
 * Script: hashed\file_24325c1321481788.gsc
***********************************************/
...
setup_model(agent_type) {
  _id_39BEC940D408DBAB::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_mp_riotshield_tier3_ru";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_39BEC940D408DBAB::_id_8168FBF6282D398B();
  }
