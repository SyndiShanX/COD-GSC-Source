 ...
 * Script: hashed\file_75db5f41104948e8.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_mp_smg_tier1_merc")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_smg_tier1_merc";
