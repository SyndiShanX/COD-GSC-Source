 ...
 * Script: hashed\file_518fddf1cea846c7.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(5, _id_687325E5C597E4FB, characters, "actor_enemy_mp_ar_tier1_aq_gwtdm")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_ar_tier1_aq_gwtdm";
