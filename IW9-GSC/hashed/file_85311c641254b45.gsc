 ...
 * Script: hashed\file_85311c641254b45.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_cp_shotgun_tier1_cartel")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_cp_shotgun_tier1_cartel";
