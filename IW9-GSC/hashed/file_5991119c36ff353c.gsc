 ...
 * Script: hashed\file_5991119c36ff353c.gsc
***********************************************/
...
main() {
  ...
  _id_FEA750D6814B803D = "iw9_dm_la700_mp, [ dmscope01 ], none, none";
...
precache() {
  agent_type = "actor_enemy_cp_sniper_tier3_cartel";
...
_id_E8CF870298E36BDC() {
  ...
  if(!isDefined(level._id_67B54180A55F70E1[_id_FEA750D6814B803D]))
    level._id_67B54180A55F70E1[_id_FEA750D6814B803D] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_dm_la700_mp", ["dmscope01"], "none", "none");
