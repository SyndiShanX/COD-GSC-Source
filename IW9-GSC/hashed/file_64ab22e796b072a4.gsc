 ...
 * Script: hashed\file_64ab22e796b072a4.gsc
***********************************************/
...
setup_model(agent_type) {
  _id_744BCB054874A005::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_mp_riotshield_tier3_biolab";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_744BCB054874A005::_id_8168FBF6282D398B();
  }
