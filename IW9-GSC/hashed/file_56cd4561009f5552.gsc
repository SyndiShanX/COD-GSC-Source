 ...
 * Script: hashed\file_56cd4561009f5552.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  characters = ["character_iw9_enemy_pmc_tier2_2_1", "character_iw9_enemy_pmc_tier2_2_1", "character_iw9_enemy_pmc_tier2_3_1", "character_iw9_enemy_pmc_tier2_4_1"];

  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_mp_pistol_tier2_pmc")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_pistol_tier2_pmc";
