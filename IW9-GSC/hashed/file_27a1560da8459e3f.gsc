 ...
 * Script: hashed\file_27a1560da8459e3f.gsc
***********************************************/
...
main() {
  ...
  _id_FEA750D6814B803D = "iw9_sm_aviktor, [ flashlight_box02 ], none, none";
...
setup_model(agent_type) {
  _id_45457F1953C82EC5::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_mp_strikeunit_tier1_biolab";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_45457F1953C82EC5::_id_8168FBF6282D398B();
  }
...
_id_E8CF870298E36BDC() {
  ...
  if(!isDefined(level._id_67B54180A55F70E1[_id_FEA750D6814B803D]))
    level._id_67B54180A55F70E1[_id_FEA750D6814B803D] = scripts\mp\class::_id_E83615F8A92E4378("iw9_sm_aviktor", ["flashlight_box02"], "none", "none");
