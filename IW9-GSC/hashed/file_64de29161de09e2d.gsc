 ...
 * Script: hashed\file_64de29161de09e2d.gsc
***********************************************/
...
setup_model(agent_type) {
  _id_30E31AB3430E63AA::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_mp_riotshield_tier2_ru";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_30E31AB3430E63AA::_id_8168FBF6282D398B();
  }
