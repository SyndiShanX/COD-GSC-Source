 ...
 * Script: hashed\file_210160a8393ef112.gsc
***********************************************/
...
setup_model(agent_type) {
  character\character_al_qatala_desert_ar::_id_8EE09B8CB8661567();
}
...
precache() {
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    character\character_al_qatala_desert_ar::_id_8168FBF6282D398B();
  }
...
_id_E8CF870298E36BDC() {
  ...
  if(!isDefined(level._id_67B54180A55F70E1[_id_FEA750D6814B803D]))
    level._id_67B54180A55F70E1[_id_FEA750D6814B803D] = scripts\mp\class::_id_E83615F8A92E4378("iw9_ar_akilo", ["none", "none", "none", "none", "none", "none"], "none", "none");
