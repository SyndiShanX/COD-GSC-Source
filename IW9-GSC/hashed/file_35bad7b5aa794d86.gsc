 ...
 * Script: hashed\file_35bad7b5aa794d86.gsc
***********************************************/
...
setup_model(agent_type) {
  _id_0AAA17AAC3649EEB::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_mp_jugg_merc";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_0AAA17AAC3649EEB::_id_8168FBF6282D398B();
  }
