 ...
 * Script: hashed\file_403797145fb02eac.gsc
***********************************************/
...
main() {
  ...
  _id_FEA750D6814B803D = "iw9_lm_rkilo_mp, [ mag_ar_p04_rkilo, stock_ar_light_p04_rkilo ], none, none";
...
setup_model(agent_type) {
  ...
  characters = ["character_iw9_aq_lmg_1_white_nvg", "character_iw9_enemy_aq_ar_2_white_nvg"];

  switch (scripts\code\character::get_random_character(2, _id_687325E5C597E4FB, characters, "actor_enemy_cp_lmg_tier1_nvg_aq")) {
    case 0:
      _id_58DF89C558C99386::_id_8EE09B8CB8661567();
      break;
    case 1:
      _id_156059D415B2FFA5::_id_8EE09B8CB8661567();
      break;
  }
}

precache() {
  agent_type = "actor_enemy_cp_lmg_tier1_nvg_aq";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_58DF89C558C99386::_id_8168FBF6282D398B();
    _id_156059D415B2FFA5::_id_8168FBF6282D398B();
  }
...
_id_E8CF870298E36BDC() {
  ...
  if(!isDefined(level._id_67B54180A55F70E1[_id_FEA750D6814B803D]))
    level._id_67B54180A55F70E1[_id_FEA750D6814B803D] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_lm_rkilo_mp", ["mag_ar_p04_rkilo", "stock_ar_light_p04_rkilo"], "none", "none");
