 ...
 * Script: hashed\file_4704c0212ea4f9f7.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_mp_lmg_tier1_merc")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_lmg_tier1_merc";
...
_id_E8CF870298E36BDC() {
  ...
  _id_5576D3BE590A9A64 = "iw9_lm_foxtrot, [ none, none, none, none, none, none ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D3BE590A9A64]))
    level._id_67B54180A55F70E1[_id_5576D3BE590A9A64] = scripts\mp\class::_id_E83615F8A92E4378("iw9_lm_foxtrot", ["none", "none", "none", "none", "none", "none"], "none", "none");
