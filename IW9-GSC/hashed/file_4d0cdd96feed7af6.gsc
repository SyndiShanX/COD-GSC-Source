 ...
 * Script: hashed\file_4d0cdd96feed7af6.gsc
***********************************************/
...
setup_model(agent_type) {
  _id_5CFBF14959FE3F1A::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_mp_riotshield_tier3_cartel";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_5CFBF14959FE3F1A::_id_8168FBF6282D398B();
  }
