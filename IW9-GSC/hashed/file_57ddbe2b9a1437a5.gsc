 ...
 * Script: hashed\file_57ddbe2b9a1437a5.gsc
***********************************************/
...
setup_model(agent_type) {
  _id_54ECD09E82DFF254::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_mp_boss_pyro";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_54ECD09E82DFF254::_id_8168FBF6282D398B();
  }
