 ...
 * Script: hashed\file_4c433ed59c58e6b9.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_mp_smg_tier1_pmc")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_smg_tier1_pmc";
