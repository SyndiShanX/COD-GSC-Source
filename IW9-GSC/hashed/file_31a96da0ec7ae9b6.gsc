 ...
 * Script: hashed\file_31a96da0ec7ae9b6.gsc
***********************************************/
...
setup_model(agent_type) {
  _id_370BE001440E8091::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_cp_ar_tier2_nvg_aq";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_370BE001440E8091::_id_8168FBF6282D398B();
  }
