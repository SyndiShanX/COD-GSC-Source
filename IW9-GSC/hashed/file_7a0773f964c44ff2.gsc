 ...
 * Script: hashed\file_7a0773f964c44ff2.gsc
***********************************************/
...
main() {
  ...
  self.enemyselector = "enemyselector_juggernaut";
  self _meth_E99626ADD202FE1A(0, "entity");
  self setengagementmindist(128.0, 0.0);
  self setengagementmaxdist(1200.0, 1600.0);
  self _meth_9215CE6FC83759B9(0.0);
  _id_FEA750D6814B803D = "iw9_lm_dblmg2_cp, [ none, none, none, none, none, none ], none, none";
...
setup_model(agent_type) {
  _id_67B6BAF8CE2E26C0::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_cp_jugg_cartel";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_67B6BAF8CE2E26C0::_id_8168FBF6282D398B();
  }
...
_id_E8CF870298E36BDC() {
  ...
  if(!isDefined(level._id_67B54180A55F70E1[_id_FEA750D6814B803D]))
    level._id_67B54180A55F70E1[_id_FEA750D6814B803D] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_lm_dblmg2_cp", ["none", "none", "none", "none", "none", "none"], "none", "none");
