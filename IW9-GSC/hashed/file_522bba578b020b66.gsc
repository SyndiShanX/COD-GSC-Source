 ...
 * Script: hashed\file_522bba578b020b66.gsc
***********************************************/
...
setup_model(agent_type) {
  _id_3C6815650225084A::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_mp_jugg_ru";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_3C6815650225084A::_id_8168FBF6282D398B();
  }
