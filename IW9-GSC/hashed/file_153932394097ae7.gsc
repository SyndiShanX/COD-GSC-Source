 ...
 * Script: hashed\file_153932394097ae7.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_cp_lmg_tier1_cartel")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_cp_lmg_tier1_cartel";
