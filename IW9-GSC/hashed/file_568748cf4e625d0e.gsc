 ...
 * Script: hashed\file_568748cf4e625d0e.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_cp_riotshield_tier1_cartel_pistol")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_cp_riotshield_tier1_cartel_pistol";
