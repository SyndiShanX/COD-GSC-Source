 ...
 * Script: hashed\file_4687a3d1b3f6590a.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(3, _id_687325E5C597E4FB, characters, "actor_enemy_mp_pistol_tier1_ru")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_pistol_tier1_ru";
