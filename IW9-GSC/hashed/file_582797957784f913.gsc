 ...
 * Script: hashed\file_582797957784f913.gsc
***********************************************/

main() {
  self.animationarchetype = "rusher";
  self.voice = "shadowcompany";
  self setModel("body_wz_opforce_shadow_company_armored_dmr_1_1_rusher");
...
_id_430419022A9C3FFE() {
  precache();
  precachemodel("body_wz_opforce_shadow_company_armored_dmr_1_1_rusher");
