 ...
 * Script: hashed\file_a8217caf57e40dc.gsc
***********************************************/
...
main() {
  ...
  switch (scripts\code\character::get_random_weapon(2)) {
    case 0:
      _id_FEA750D6814B803D = "iw9_sn_alpha50, [ lasercyl_hip02, stock_sn_heavy_p23, bipod01 ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
    case 1:
      _id_FEA750D6814B803D = "iw9_sn_limax, [ laserbox_hip02, stock_sn_tactical_p22, comp_sn_03 ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
  }
...
precache() {
  agent_type = "actor_enemy_mp_sniper_tier3_biolab";
...
_id_E8CF870298E36BDC() {
  ...
  _id_5576D3BE590A9A64 = "iw9_sn_alpha50, [ lasercyl_hip02, stock_sn_heavy_p23, bipod01 ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D3BE590A9A64]))
    level._id_67B54180A55F70E1[_id_5576D3BE590A9A64] = scripts\mp\class::_id_E83615F8A92E4378("iw9_sn_alpha50", ["lasercyl_hip02", "stock_sn_heavy_p23", "bipod01"], "none", "none");

  _id_5576D6BE590AA0FD = "iw9_sn_limax, [ laserbox_hip02, stock_sn_tactical_p22, comp_sn_03 ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD]))
    level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD] = scripts\mp\class::_id_E83615F8A92E4378("iw9_sn_limax", ["laserbox_hip02", "stock_sn_tactical_p22", "comp_sn_03"], "none", "none");
