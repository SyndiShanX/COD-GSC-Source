 ...
 * Script: hashed\file_413d5d04d1ccf3f2.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_mp_pistol_tier1_merc")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_pistol_tier1_merc";
