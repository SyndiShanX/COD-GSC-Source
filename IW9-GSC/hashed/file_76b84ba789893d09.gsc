 ...
 * Script: hashed\file_76b84ba789893d09.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_mp_lmg_tier1_cartel")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_lmg_tier1_cartel";
