 ...
 * Script: hashed\file_5abe51e1e3396b16.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_mp_rpg_tier2_pmc")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_rpg_tier2_pmc";
