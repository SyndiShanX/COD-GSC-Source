 ...
 * Script: hashed\file_67429a758c13f756.gsc
***********************************************/
...
main() {
  ...
  switch (scripts\code\character::get_random_weapon(4)) {
    case 0:
      _id_FEA750D6814B803D = "iw9_ar_mike16, [ grip_vert02 ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
    case 1:
      _id_FEA750D6814B803D = "iw9_ar_mike4, [ grip_vert02 ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
    case 2:
      _id_FEA750D6814B803D = "iw9_ar_akilo105, [ grip_vert02 ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
    case 3:
      _id_FEA750D6814B803D = "iw9_ar_akilo105, [ ub_gl_akilo ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
  }
...
precache() {
  agent_type = "actor_enemy_mp_ar_tier3_cartel";
...
_id_E8CF870298E36BDC() {
  ...
  _id_5576D3BE590A9A64 = "iw9_ar_mike16, [ grip_vert02 ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D3BE590A9A64]))
    level._id_67B54180A55F70E1[_id_5576D3BE590A9A64] = scripts\mp\class::_id_E83615F8A92E4378("iw9_ar_mike16", ["grip_vert02"], "none", "none");

  _id_5576D6BE590AA0FD = "iw9_ar_mike4, [ grip_vert02 ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD]))
    level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD] = scripts\mp\class::_id_E83615F8A92E4378("iw9_ar_mike4", ["grip_vert02"], "none", "none");

  _id_5576D5BE590A9ECA = "iw9_ar_akilo105, [ grip_vert02 ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D5BE590A9ECA]))
    level._id_67B54180A55F70E1[_id_5576D5BE590A9ECA] = scripts\mp\class::_id_E83615F8A92E4378("iw9_ar_akilo105", ["grip_vert02"], "none", "none");

  _id_5576D0BE590A93CB = "iw9_ar_akilo105, [ ub_gl_akilo ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D0BE590A93CB]))
    level._id_67B54180A55F70E1[_id_5576D0BE590A93CB] = scripts\mp\class::_id_E83615F8A92E4378("iw9_ar_akilo105", ["ub_gl_akilo"], "none", "none");
