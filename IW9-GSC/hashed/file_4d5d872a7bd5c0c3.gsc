 ...
 * Script: hashed\file_4d5d872a7bd5c0c3.gsc
***********************************************/
...
_id_DC08EFAC4AA8BC95(owner) {
  ...
  for(;;) {
    ...
    if(isDefined(player)) {
      ...
      player _id_24A2E2FA6ADC7F55();

      if(isDefined(owner))
        owner thread _id_A51CB31233EACF9E();
...
_id_80143A61B671BDD3() {
  ...
  childthread _id_4B87F2871B6B025C::_id_8C3428AEB7C8B1F4(10, ::_id_10A2B3E20F49AC40);
  ...
  childthread _id_D321BEF8910E7427();
...
_id_2C9C3BC278844056() {
  if(_id_4B87F2871B6B025C::_id_EA8199F09C110522()) {
    if(soundexists("cp_oxygen_mask_use_large"))
      self playlocalsound("cp_oxygen_mask_use_large");
  } else if(soundexists("cp_oxygen_mask_use_small"))
    self playlocalsound("cp_oxygen_mask_use_small");

  self playsoundonmovingent("eqp_cp_raid1_o2_tank_air_release");
}
...
_id_EAE1981AB021806B() {
  ...
  _id_8B61DAC63B58C6CE("Activating");
...
_id_95812DCC553470BD() {
  ...
  level endon("game_ended");
  self endon("give_oxygenmask");
  _id_4B87F2871B6B025C::_id_8C3428AEB7C8B1F4(99, ::_id_BC75520A8C4707BA);
}
