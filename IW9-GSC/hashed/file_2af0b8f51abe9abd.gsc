 ...
 * Script: hashed\file_2af0b8f51abe9abd.gsc
***********************************************/
...
setup_model(agent_type) {
  _id_65BD56F0C8BBE91C::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_mp_riotshield_tier2_biolab";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_65BD56F0C8BBE91C::_id_8168FBF6282D398B();
  }
...
_id_E8CF870298E36BDC() {
  ...
  if(!isDefined(level._id_67B54180A55F70E1[_id_FEA750D6814B803D]))
    level._id_67B54180A55F70E1[_id_FEA750D6814B803D] = scripts\mp\class::_id_E83615F8A92E4378("iw9_sm_mpapa7", ["flashlight_cyl01", "mag_sm_large_p09"], "none", "none");
