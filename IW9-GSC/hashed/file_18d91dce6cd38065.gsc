 ...
 * Script: hashed\file_18d91dce6cd38065.gsc
***********************************************/
...
main() {
  ...
  self.health = 300;
  self.maxhealth = 300;
  self.behaviortreeasset = "jailer_baton";
  self.asmasset = "rusher";
  self.defaultcoverselector = "cover_default";
  self.enemyselector = "enemyselector_baton_jailer";
...
setup_model(agent_type) {
  _id_05E9CC305CFDBD46::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_mp_baton_base";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_05E9CC305CFDBD46::_id_8168FBF6282D398B();
  }

  scripts\aitypes\bt_util::init();
  _id_699B0BF58F54F2EA::registerbehaviortree();
