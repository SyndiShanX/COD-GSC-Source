 ...
 * Script: hashed\file_5b9d30af634e407c.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(2, _id_687325E5C597E4FB, characters, "actor_enemy_mp_shotgun_tier2_cartel")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_shotgun_tier2_cartel";
