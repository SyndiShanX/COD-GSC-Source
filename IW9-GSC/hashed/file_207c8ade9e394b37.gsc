 ...
 * Script: hashed\file_207c8ade9e394b37.gsc
***********************************************/
...
main() {
  ...
  switch (scripts\code\character::get_random_weapon(3)) {
    case 0:
      _id_FEA750D6814B803D = "iw9_ar_akilo_mp, [ none, none, none, none, none, none ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
    case 1:
      _id_FEA750D6814B803D = "iw9_ar_akilo74_mp, [ none, none, none, none, none, none ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
    case 2:
...
setup_model(agent_type) {
  _id_26EC98AC13C52A18::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_cp_ar_tier3_nvg_aq";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_26EC98AC13C52A18::_id_8168FBF6282D398B();
  }
...
_id_E8CF870298E36BDC() {
  ...
  _id_5576D3BE590A9A64 = "iw9_ar_akilo_mp, [ none, none, none, none, none, none ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D3BE590A9A64]))
    level._id_67B54180A55F70E1[_id_5576D3BE590A9A64] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_ar_akilo_mp", ["none", "none", "none", "none", "none", "none"], "none", "none");

  _id_5576D6BE590AA0FD = "iw9_ar_akilo74_mp, [ none, none, none, none, none, none ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD]))
    level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_ar_akilo74_mp", ["none", "none", "none", "none", "none", "none"], "none", "none");

  _id_5576D5BE590A9ECA = "iw9_ar_akilo105_mp, [ none, none, none, none, none, none ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D5BE590A9ECA]))
    level._id_67B54180A55F70E1[_id_5576D5BE590A9ECA] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_ar_akilo105_mp", ["none", "none", "none", "none", "none", "none"], "none", "none");
