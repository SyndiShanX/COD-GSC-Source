 ...
 * Script: hashed\file_2e54bc4b1946a95f.gsc
***********************************************/
...
main() {
  ...
  _id_FEA750D6814B803D = "iw9_la_rpapa7, [ none, none, none, none, none, none ], none, none";
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_mp_rpg_tier1_pmc")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_rpg_tier1_pmc";
...
_id_E8CF870298E36BDC() {
  ...
  if(!isDefined(level._id_67B54180A55F70E1[_id_FEA750D6814B803D]))
    level._id_67B54180A55F70E1[_id_FEA750D6814B803D] = scripts\mp\class::_id_E83615F8A92E4378("iw9_la_rpapa7", ["none", "none", "none", "none", "none", "none"], "none", "none");
