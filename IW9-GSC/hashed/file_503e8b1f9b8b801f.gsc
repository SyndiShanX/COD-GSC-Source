 ...
 * Script: hashed\file_503e8b1f9b8b801f.gsc
***********************************************/
...
main() {
  ...
  switch (scripts\code\character::get_random_weapon(2)) {
    case 0:
      ...
      break;
    case 1:
      _id_FEA750D6814B803D = "iw9_ar_scharlie_mp, [ none, none, none, none, none, none ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
  }
...
setup_model(agent_type) {
  ...
  characters = ["character_iw9_ally_mex_sf_1", "character_iw9_ally_mex_sf_2", "character_iw9_ally_mex_sf_3", "character_iw9_ally_mex_sf_4"];

  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_iw9_ally_mex_sf_ar_cp")) {
    case 0:
      _id_76C85360E87D97DA::_id_8EE09B8CB8661567();
      break;
    case 1:
      _id_70C3D3537047B1C7::_id_8EE09B8CB8661567();
      break;
    case 2:
      _id_0A235845EC2D1DB0::_id_8EE09B8CB8661567();
      break;
    case 3:
      _id_1C57C8786132552D::_id_8EE09B8CB8661567();
      break;
  }
}

precache() {
  agent_type = "actor_iw9_ally_mex_sf_ar_cp";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_76C85360E87D97DA::_id_8168FBF6282D398B();
    _id_70C3D3537047B1C7::_id_8168FBF6282D398B();
    _id_0A235845EC2D1DB0::_id_8168FBF6282D398B();
    _id_1C57C8786132552D::_id_8168FBF6282D398B();
  }
...
_id_E8CF870298E36BDC() {
  ...
  _id_5576D3BE590A9A64 = "iw9_ar_mike4_mp, [ none, none, none, none, none, none ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D3BE590A9A64]))
    level._id_67B54180A55F70E1[_id_5576D3BE590A9A64] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_ar_mike4_mp", ["none", "none", "none", "none", "none", "none"], "none", "none");

  _id_5576D6BE590AA0FD = "iw9_ar_scharlie_mp, [ none, none, none, none, none, none ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD]))
    level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_ar_scharlie_mp", ["none", "none", "none", "none", "none", "none"], "none", "none");
