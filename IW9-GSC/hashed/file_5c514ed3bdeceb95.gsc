 ...
 * Script: hashed\file_5c514ed3bdeceb95.gsc
***********************************************/
...
main() {
  ...
  switch (scripts\code\character::get_random_weapon(3)) {
    case 0:
      ...
      break;
    case 1:
      _id_FEA750D6814B803D = "iw9_ar_akilo74, [ none, none, none, none, none, none ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
    case 2:
...
precache() {
  agent_type = "actor_enemy_mp_ar_tier3_pmc";
...
_id_E8CF870298E36BDC() {
  ...
  _id_5576D6BE590AA0FD = "iw9_ar_akilo74, [ none, none, none, none, none, none ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD]))
    level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD] = scripts\mp\class::_id_E83615F8A92E4378("iw9_ar_akilo74", ["none", "none", "none", "none", "none", "none"], "none", "none");
