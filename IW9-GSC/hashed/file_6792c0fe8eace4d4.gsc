 ...
 * Script: hashed\file_6792c0fe8eace4d4.gsc
***********************************************/
...
main(model, type, classname) {
  ...
  _id_12A4C0B2EEB1DB9D = "veh9_civ_lnd_van_cargo_vehphys_hsk_sp";
  scripts\common\vehicle_build::_id_98128821320ABA35(model, _id_12A4C0B2EEB1DB9D, "veh9_civ_lnd_van_cargo_physics_sp");
}
