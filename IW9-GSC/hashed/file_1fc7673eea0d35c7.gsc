 ...
 * Script: hashed\file_1fc7673eea0d35c7.gsc
***********************************************/
...
main() {
  ...
  switch (scripts\code\character::get_random_weapon(2)) {
    case 0:
      _id_FEA750D6814B803D = "iw9_sh_mike1014, [ lasercyl_hip02 ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
    case 1:
      _id_FEA750D6814B803D = "iw9_sh_mviktor, [ lasercyl_hip02 ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
  }
...
precache() {
  agent_type = "actor_enemy_mp_shotgun_tier3_merc";
...
_id_E8CF870298E36BDC() {
  ...
  _id_5576D3BE590A9A64 = "iw9_sh_mike1014, [ lasercyl_hip02 ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D3BE590A9A64]))
    level._id_67B54180A55F70E1[_id_5576D3BE590A9A64] = scripts\mp\class::_id_E83615F8A92E4378("iw9_sh_mike1014", ["lasercyl_hip02"], "none", "none");

  _id_5576D6BE590AA0FD = "iw9_sh_mviktor, [ lasercyl_hip02 ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD]))
    level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD] = scripts\mp\class::_id_E83615F8A92E4378("iw9_sh_mviktor", ["lasercyl_hip02"], "none", "none");
