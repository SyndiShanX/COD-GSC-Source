 ...
 * Script: hashed\file_cb8137203401a93.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(2, _id_687325E5C597E4FB, characters, "actor_enemy_cp_smg_tier2_cartel")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_cp_smg_tier2_cartel";
