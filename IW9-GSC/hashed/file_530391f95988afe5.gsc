 ...
 * Script: hashed\file_530391f95988afe5.gsc
***********************************************/

main() {
  self.animationarchetype = "rusher";
  self.voice = "shadowcompany";
  self setModel("body_sp_opforce_shadow_company_armored_smg_1_1_rusher");
...
_id_430419022A9C3FFE() {
  precache();
  precachemodel("body_sp_opforce_shadow_company_armored_smg_1_1_rusher");
