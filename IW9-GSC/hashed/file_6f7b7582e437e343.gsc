 ...
 * Script: hashed\file_6f7b7582e437e343.gsc
***********************************************/
...
main() {
  ...
  _id_FEA750D6814B803D = "iw9_sm_mpapa7_mp, [ none, none, none, none, none, none ], none, none";
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_iw9_ally_mex_sf_smg_cp")) {
    case 0:
...
precache() {
  agent_type = "actor_iw9_ally_mex_sf_smg_cp";
...
_id_E8CF870298E36BDC() {
  ...
  if(!isDefined(level._id_67B54180A55F70E1[_id_FEA750D6814B803D]))
    level._id_67B54180A55F70E1[_id_FEA750D6814B803D] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_sm_mpapa7_mp", ["none", "none", "none", "none", "none", "none"], "none", "none");
