 ...
 * Script: hashed\file_3a1d8db6d92d73f8.gsc
***********************************************/
...
_id_2BBAFD88C0646D49(heli) {
  ...
  heli._id_116AD1E054E41093 = (0, 0, 850);
  ...
  for(;;) {
    ...
    _id_FECE2C56170697AD = vehicle.origin + vehicle._id_8C7951652AC9E489;
    _id_CE0F3178F55FFF1E = (0, 0, 850);
...
_id_2D3A0D35632F1495() {
  ...
  for(;;) {
    ...
    if(!isDefined(driver)) {
      self._id_F052A2BF872947B0 = undefined;
      return;
    }
...
_id_6EFE8AD8F8527B46(_id_8FDFAD46F0546243) {
  ...
  chopper_height = _id_8FDFAD46F0546243 scripts\cp\helicopter\cp_helicopter::_id_68C2534A5EA3CD2B();
...
_id_A742F2D93265DBE7(spawnpos) {
  ...
  spawn_point.origin = (-16522, -8180, 2865.27);
...
_id_ACDEBFCCE1906051(spawner) {
  ...
  heli._id_F6A794B2D3DC63E7 = ::_id_E05C59AAD0D3EA4A;
...
_id_A48BAD21C6C1E0A9(struct) {
  ...
  if(isDefined(heli)) {
    ...
    foreach(index, rider in heli.riders) {
      ...
      rider thread _id_7EA61A73C7EE5FEC::_id_505AD627A91D8597();
    }
  }
...
_id_6C8E45C9F0D2ED69() {
  level.exfil_heli = _id_9C5F65BACCB9CCEC();

  while(istrue(level._id_364D5EFBFB7D1FAC) || istrue(level._id_BDB99233B8F43C69))
    wait 0.1;

  _id_4B51EFC61B1C7ECF::_id_775CD164C569E279("dx_cp_cpes_gexf_niko_motherofwhores");
  wait 1.25;
  _id_4B51EFC61B1C7ECF::_id_775CD164C569E279("dx_cp_cpes_gexf_niko_breaker1thesebastard");
  wait 1.5;
  _id_4B51EFC61B1C7ECF::_id_775CD164C569E279("dx_cp_cpes_gexf_lasw_breakersdispatchthat");
}
...
_id_8AB55654A453F80C() {
  ...
  level._id_664E187FD885C2D5._id_F6A794B2D3DC63E7 = ::_id_E05C59AAD0D3EA4A;
  level notify("heli_inbound");
...
heli_crash(attacker) {
  ...
  if(istrue(self._id_A446C274174C1268) || getdvarint("dvar_BA8282E1A78AC163", 1) > 0) {
    ...
    corpse.clip = getEnt("heli_corpse_main", "targetname");
    corpse._id_2E1259FB590696E9 = getEnt("heli_corpse_main_dmg", "targetname");
    corpse._id_B917E6F71A39183F.clip = getEnt("heli_corpse_tail", "targetname");
    corpse._id_B917E6F71A39183F._id_2E1259FB590696E9 = getEnt("heli_corpse_tail_dmg", "targetname");
    ...
    waitframe();
    self delete();
    corpse.clip.origin = corpse.origin + (0, 0, 60) + anglestoleft(corpse.angles) * 10;
    corpse.clip.angles = corpse.angles;
    corpse._id_B917E6F71A39183F.clip.origin = corpse._id_B917E6F71A39183F.origin + (0, 0, 60);
    corpse._id_B917E6F71A39183F.clip.angles = corpse._id_B917E6F71A39183F.angles;
    corpse._id_2E1259FB590696E9.origin = corpse.clip.origin;
    corpse._id_2E1259FB590696E9.angles = corpse.clip.angles;
    corpse._id_B917E6F71A39183F._id_2E1259FB590696E9.origin = corpse._id_B917E6F71A39183F.clip.origin;
    corpse._id_B917E6F71A39183F._id_2E1259FB590696E9.angles = corpse._id_B917E6F71A39183F.clip.angles;
    corpse thread _id_F5711AD28016CCBA();
    corpse._id_B917E6F71A39183F._id_2E1259FB590696E9 thread _id_E0359466C85F064B();
    corpse._id_2E1259FB590696E9 thread _id_E0359466C85F064B();
