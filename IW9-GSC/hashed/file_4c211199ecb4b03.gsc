 ...
 * Script: hashed\file_4c211199ecb4b03.gsc
***********************************************/
...
main() {
  ...
  self.defaultcoverselector = "cover_aggressive";
  self.enemyselector = "enemyselector_default";
  self _meth_E99626ADD202FE1A(0, "entity");
  self setengagementmindist(500.0, 240.0);
  self setengagementmaxdist(4000.0, 4000.0);
  self _meth_9215CE6FC83759B9(4000.0);
  _id_FEA750D6814B803D = "iw9_la_mike32biolab_mp, [ none, none, none, none, none, none ], none, none";
...
setup_model(agent_type) {
  _id_7DF2CA72197142AA::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_cp_boss_velikan_raid_ep3";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_7DF2CA72197142AA::_id_8168FBF6282D398B();
  }
...
_id_E8CF870298E36BDC() {
  ...
  if(!isDefined(level._id_67B54180A55F70E1[_id_FEA750D6814B803D]))
    level._id_67B54180A55F70E1[_id_FEA750D6814B803D] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_la_mike32biolab_mp", ["none", "none", "none", "none", "none", "none"], "none", "none");
