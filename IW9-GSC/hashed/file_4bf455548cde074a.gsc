 ...
 * Script: hashed\file_4bf455548cde074a.gsc
***********************************************/

main() {
  self.animationarchetype = "rusher";
  self.voice = "shadowcompany";
  self setModel("body_sp_opforce_shadow_company_armored_ar_1_1_rusher");
...
_id_430419022A9C3FFE() {
  precache();
  precachemodel("body_sp_opforce_shadow_company_armored_ar_1_1_rusher");
