 ...
 * Script: hashed\file_5ad6824f8f5cfe2a.gsc
***********************************************/
...
setup_model(agent_type) {
  _id_214E2D0F86EC0731::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_mp_boss_butcher";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_214E2D0F86EC0731::_id_8168FBF6282D398B();
  }

  scripts\aitypes\bt_util::init();
  _id_10FB43BD7474C909::registerbehaviortree();
