 ...
 * Script: hashed\file_3615e9060032a4a0.gsc
***********************************************/
...
main() {
  ...
  self.defaultcoverselector = "cover_lmg_cp";
  self.enemyselector = "enemyselector_default";
  self _meth_E99626ADD202FE1A(0, "entity");
  self setengagementmindist(400.0, 200.0);
  self setengagementmaxdist(1500.0, 1750.0);
  self _meth_9215CE6FC83759B9(3096.0);

  switch (scripts\code\character::get_random_weapon(3)) {
    case 0:
      _id_FEA750D6814B803D = "iw9_lm_kilo21_mp, [ holo02 ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
    case 1:
      _id_FEA750D6814B803D = "iw9_lm_kilo21_mp, [ hybrid03, belt_lm_large_p02, bar_lm_long_p02_kilo21 ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
    case 2:
      _id_FEA750D6814B803D = "iw9_lm_kilo21_mp, [ grip_angled01, bar_lm_short_p02_kilo21 ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
  }
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(2, _id_687325E5C597E4FB, characters, "actor_enemy_cp_lmg_tier2_cartel")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_cp_lmg_tier2_cartel";
...
_id_E8CF870298E36BDC() {
  ...
  _id_5576D3BE590A9A64 = "iw9_lm_kilo21_mp, [ holo02 ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D3BE590A9A64]))
    level._id_67B54180A55F70E1[_id_5576D3BE590A9A64] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_lm_kilo21_mp", ["holo02"], "none", "none");

  _id_5576D6BE590AA0FD = "iw9_lm_kilo21_mp, [ hybrid03, belt_lm_large_p02, bar_lm_long_p02_kilo21 ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD]))
    level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_lm_kilo21_mp", ["hybrid03", "belt_lm_large_p02", "bar_lm_long_p02_kilo21"], "none", "none");

  _id_5576D5BE590A9ECA = "iw9_lm_kilo21_mp, [ grip_angled01, bar_lm_short_p02_kilo21 ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D5BE590A9ECA]))
    level._id_67B54180A55F70E1[_id_5576D5BE590A9ECA] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_lm_kilo21_mp", ["grip_angled01", "bar_lm_short_p02_kilo21"], "none", "none");
