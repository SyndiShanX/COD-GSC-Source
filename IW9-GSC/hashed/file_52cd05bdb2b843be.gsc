 ...
 * Script: hashed\file_52cd05bdb2b843be.gsc
***********************************************/
...
main() {
  ...
  _id_FEA750D6814B803D = "iw9_lm_foxtrot, [ bipod01 ], none, none";
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(2, _id_687325E5C597E4FB, characters, "actor_enemy_mp_lmg_tier2_cartel")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_lmg_tier2_cartel";
...
_id_E8CF870298E36BDC() {
  ...
  if(!isDefined(level._id_67B54180A55F70E1[_id_FEA750D6814B803D]))
    level._id_67B54180A55F70E1[_id_FEA750D6814B803D] = scripts\mp\class::_id_E83615F8A92E4378("iw9_lm_foxtrot", ["bipod01"], "none", "none");
