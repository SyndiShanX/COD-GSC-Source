 ...
 * Script: hashed\file_3fe3e0b1d061d3db.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_mp_pistol_tier1_pmc")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_pistol_tier1_pmc";
