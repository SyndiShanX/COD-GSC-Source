 ...
 * Script: hashed\file_3eafdec77ccc53ea.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  characters = ["character_iw9_wz_riotshield_pmc_tier1_1_1", "character_iw9_wz_riotshield_pmc_tier1_2_1", "character_iw9_wz_riotshield_pmc_tier1_3_1", "character_iw9_wz_riotshield_pmc_tier1_4_1"];

  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_mp_riotshield_tier1_merc")) {
    case 0:
      _id_24E84A65E86FBB35::_id_8EE09B8CB8661567();
      break;
    case 1:
      _id_2FEC9BF5C26F0838::_id_8EE09B8CB8661567();
      break;
    case 2:
      _id_00347E142C781A17::_id_8EE09B8CB8661567();
      break;
    case 3:
      _id_569CE78C30FEA45A::_id_8EE09B8CB8661567();
      break;
  }
}

precache() {
  agent_type = "actor_enemy_mp_riotshield_tier1_merc";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_24E84A65E86FBB35::_id_8168FBF6282D398B();
    _id_2FEC9BF5C26F0838::_id_8168FBF6282D398B();
    _id_00347E142C781A17::_id_8168FBF6282D398B();
    _id_569CE78C30FEA45A::_id_8168FBF6282D398B();
  }
