 ...
 * Script: hashed\file_4db9aec2c9d0f4da.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_mp_ar_tier2_pmc")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_ar_tier2_pmc";
