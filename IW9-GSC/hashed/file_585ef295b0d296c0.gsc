 ...
 * Script: hashed\file_585ef295b0d296c0.gsc
***********************************************/
...
main() {
  ...
  switch (scripts\code\character::get_random_weapon(2)) {
    case 0:
      ...
      break;
    case 1:
      _id_FEA750D6814B803D = "iw9_sm_beta, [ laserbox_hip01 ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
  }
...
precache() {
  agent_type = "actor_enemy_mp_smg_tier3_cartel";
...
_id_E8CF870298E36BDC() {
  ...
  _id_5576D6BE590AA0FD = "iw9_sm_beta, [ laserbox_hip01 ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD]))
    level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD] = scripts\mp\class::_id_E83615F8A92E4378("iw9_sm_beta", ["laserbox_hip01"], "none", "none");
