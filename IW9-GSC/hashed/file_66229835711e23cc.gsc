 ...
 * Script: hashed\file_66229835711e23cc.gsc
***********************************************/

main(_id_97282C14346A7FCF, _id_CDDA4278F5259F6D) {
  if(scripts\engine\utility::flag_exist("mp_caves_gw_gametype_cs")) {
    return;
  }
  if(!isDefined(_id_CDDA4278F5259F6D))
    _id_CDDA4278F5259F6D = scripts\common\create_script_utility::_id_B055D49370405173();

  scripts\engine\utility::flag_init("mp_caves_gw_gametype_cs");
  s = spawnStruct();
  level thread cs_return_and_wait_for_flag(_id_CDDA4278F5259F6D, s, "mp_caves_gw_gametype_cs");
...
cs_return_and_wait_for_flag(_id_CDDA4278F5259F6D, s, _id_CE173D78F5680530) {
  ...
  s scripts\common\create_script_utility::cs_setup_arrays(_id_CDDA4278F5259F6D, "mp_caves_gw_gametype_cs");
  ...
  level thread scripts\common\create_script_utility::wait_for_flags(s, "mp_caves_gw_gametype_cs");
}
...
createstructs(_id_CE2D3C78F5803630, _id_CDDA4278F5259F6D, _id_CE173D78F5680530) {
  ...
  s.height = 144;
  _id_CE2D3C78F5803630[[f]](s, _id_CDDA4278F5259F6D, _id_CE173D78F5680530, (-33185.8, 1344.27, 1991.17), undefined, "ctf_flag_allies_CS", undefined, "ctf_flag_allies_CS", undefined, undefined, undefined, undefined, 64);
  s = scripts\common\create_script_utility::s();
  s.height = 144;
  _id_CE2D3C78F5803630[[f]](s, _id_CDDA4278F5259F6D, _id_CE173D78F5680530, (-24489.1, -2911.01, 1808.64), undefined, "ctf_flag_axis_CS", undefined, "ctf_flag_axis_CS", undefined, undefined, undefined, undefined, 64);
