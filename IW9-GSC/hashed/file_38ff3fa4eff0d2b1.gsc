 ...
 * Script: hashed\file_38ff3fa4eff0d2b1.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  characters = ["character_iw9_wz_riotshield_pmc_tier2_1_1", "character_iw9_wz_riotshield_pmc_tier2_2_1", "character_iw9_wz_riotshield_pmc_tier2_3_1", "character_iw9_wz_riotshield_pmc_tier2_4_1"];

  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_mp_riotshield_tier2_merc")) {
    case 0:
      _id_6159DED28959AB6C::_id_8EE09B8CB8661567();
      break;
    case 1:
      _id_00768E4EB06E0069::_id_8EE09B8CB8661567();
      break;
    case 2:
      _id_6D00D50FAE6EF172::_id_8EE09B8CB8661567();
      break;
    case 3:
      _id_437C3FCA502D918F::_id_8EE09B8CB8661567();
      break;
  }
}

precache() {
  agent_type = "actor_enemy_mp_riotshield_tier2_merc";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_6159DED28959AB6C::_id_8168FBF6282D398B();
    _id_00768E4EB06E0069::_id_8168FBF6282D398B();
    _id_6D00D50FAE6EF172::_id_8168FBF6282D398B();
    _id_437C3FCA502D918F::_id_8168FBF6282D398B();
  }
