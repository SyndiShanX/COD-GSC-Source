 ...
 * Script: hashed\file_78e04d3550f82bf7.gsc
***********************************************/

main() {
  self.animationarchetype = "rusher";
  self.voice = "shadowcompany";
  self setModel("body_sp_opforce_shadow_company_tier_1_1_1_rusher");
...
_id_430419022A9C3FFE() {
  precache();
  precachemodel("body_sp_opforce_shadow_company_tier_1_1_1_rusher");
