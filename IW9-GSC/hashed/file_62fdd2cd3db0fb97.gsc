 ...
 * Script: hashed\file_62fdd2cd3db0fb97.gsc
***********************************************/
...
main() {
  ...
  switch (scripts\code\character::get_random_weapon(2)) {
    case 0:
      _id_FEA750D6814B803D = "iw9_pi_decho_mp, [ none, none, none, none, none, none ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
    case 1:
      _id_FEA750D6814B803D = "iw9_pi_papa220_mp, [ none, none, none, none, none, none ], none, none";
      self.weapon = level._id_67B54180A55F70E1[_id_FEA750D6814B803D];
      break;
  }
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(2, _id_687325E5C597E4FB, characters, "actor_enemy_cp_riotshield_tier2_cartel_pistol")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_cp_riotshield_tier2_cartel_pistol";
...
_id_E8CF870298E36BDC() {
  ...
  _id_5576D3BE590A9A64 = "iw9_pi_decho_mp, [ none, none, none, none, none, none ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D3BE590A9A64]))
    level._id_67B54180A55F70E1[_id_5576D3BE590A9A64] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_pi_decho_mp", ["none", "none", "none", "none", "none", "none"], "none", "none");

  _id_5576D6BE590AA0FD = "iw9_pi_papa220_mp, [ none, none, none, none, none, none ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD]))
    level._id_67B54180A55F70E1[_id_5576D6BE590AA0FD] = scripts\cp\cp_weapon::_id_E83615F8A92E4378("iw9_pi_papa220_mp", ["none", "none", "none", "none", "none", "none"], "none", "none");
