 ...
 * Script: hashed\file_547ae018065cdd12.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  characters = ["character_iw9_enemy_ru_tier1_1", "character_iw9_enemy_ru_tier1_2", "character_iw9_enemy_ru_tier1_3"];

  switch (scripts\code\character::get_random_character(3, _id_687325E5C597E4FB, characters, "actor_enemy_mp_ar_tier1_ru")) {
    case 0:
      _id_4CFC2DFE808C7037::_id_8EE09B8CB8661567();
      break;
    case 1:
      _id_50696E0FA54EE88A::_id_8EE09B8CB8661567();
      break;
    case 2:
      _id_1316B4ED28FBC6F9::_id_8EE09B8CB8661567();
      break;
  }
}

precache() {
  agent_type = "actor_enemy_mp_ar_tier1_ru";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_4CFC2DFE808C7037::_id_8168FBF6282D398B();
    _id_50696E0FA54EE88A::_id_8168FBF6282D398B();
    _id_1316B4ED28FBC6F9::_id_8168FBF6282D398B();
  }
...
_id_E8CF870298E36BDC() {
  ...
  _id_5576D3BE590A9A64 = "iw9_ar_akilo, [ none, none, none, none, none, none ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D3BE590A9A64]))
    level._id_67B54180A55F70E1[_id_5576D3BE590A9A64] = scripts\mp\class::_id_E83615F8A92E4378("iw9_ar_akilo", ["none", "none", "none", "none", "none", "none"], "none", "none");
  ...
  _id_5576D5BE590A9ECA = "iw9_ar_acharlie300, [ none, none, none, none, none, none ], none, none";

  if(!isDefined(level._id_67B54180A55F70E1[_id_5576D5BE590A9ECA]))
    level._id_67B54180A55F70E1[_id_5576D5BE590A9ECA] = scripts\mp\class::_id_E83615F8A92E4378("iw9_ar_acharlie300", ["none", "none", "none", "none", "none", "none"], "none", "none");
