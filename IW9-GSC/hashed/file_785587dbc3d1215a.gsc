 ...
 * Script: hashed\file_785587dbc3d1215a.gsc
***********************************************/

main() {
  self.animationarchetype = "soldier";
  self.voice = "shadowcompany";
  self setModel("body_wz_opforce_shadow_company_armored_dmr_1_1");
...
_id_430419022A9C3FFE() {
  precache();
  precachemodel("body_wz_opforce_shadow_company_armored_dmr_1_1");
