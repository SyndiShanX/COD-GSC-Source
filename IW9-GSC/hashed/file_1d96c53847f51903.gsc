 ...
 * Script: hashed\file_1d96c53847f51903.gsc
***********************************************/
...
setup_model(agent_type) {
  ...
  switch (scripts\code\character::get_random_character(4, _id_687325E5C597E4FB, characters, "actor_enemy_mp_riotshield_tier1_pmc")) {
    case 0:
...
precache() {
  agent_type = "actor_enemy_mp_riotshield_tier1_pmc";
