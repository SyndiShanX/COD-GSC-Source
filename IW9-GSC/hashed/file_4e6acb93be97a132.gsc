 ...
 * Script: hashed\file_4e6acb93be97a132.gsc
***********************************************/
...
setup_model(agent_type) {
  _id_7E8DB33127BE6361::_id_8EE09B8CB8661567();
}

precache() {
  agent_type = "actor_enemy_mp_riotshield_tier1_ru";
  ...
  if(!isDefined(level.agent_definition[agent_type])) {
    ...
    _id_7E8DB33127BE6361::_id_8168FBF6282D398B();
  }
