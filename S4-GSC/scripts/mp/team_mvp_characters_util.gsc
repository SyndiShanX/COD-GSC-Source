...
file_print_generate_animation_data_function() {
    ...
    scripts\engine\utility::_id_5A31("");
    scripts\engine\utility::_id_5A31("\t\tundefined
      scripts\engine\utility::_id_5A31("\t];"); scripts\engine\utility::_id_5A31("}"); var_1 = "raw"; var_2 = "mp"; scripts\engine\utility::_id_5A32(var_0, 1);
    }
    ...
    print_data_from_csv_table(var_0, var_1, var_2, var_3) {
        ...
        for(var_6 = 0; var_6 < var_4; var_6++) {
          ...
          if(var_9) {
            scripts\engine\utility::_id_5A31("\t\tundefined, continue;
            }
