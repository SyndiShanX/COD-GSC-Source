...
func_7119() {
  ...
  while(common_scripts\utility::func_562E(self.var_7A8D.var_8BE)) {
    common_scripts\utility::waittill_any("weapon_given", "weapon_taken", "zombie_player_spawn_finished", "melee_weapon_change", "weapon_switch_started");
    wait 0.05;
...
func_9AB9() {
  ...
  while(gettime() < var_01 + 6000) {
    ...
    foreach(var_04 in function_01AC(var_02, self.origin, 100)) {
      var_05 = var_04.health;
      ...
      var_04 dodamage(var_05, self.origin, self, self, "MOD_MELEE", "raven_sword_tod_aoe_zm", "none");
      wait 0.05;
    }
...
func_9ABA() {
  common_scripts\utility::waittill_any("death", "disconnect", "touch_of_death_aoe_complete");
...
func_2416() {
  ...
  if(self.var_7A8D.var_8BE && !self.var_7A8D.var_9AC4) {
    ...
    playFX(var_04, self.origin + (0, 0, 40));
