...
func_AB9F(param_00, param_01, param_02) {
  ...
  foreach(var_04 in ["j_headb"]) {
    ...
    var_05.maxhealth = 0.3 * self.maxhealth;
...
func_AB99(param_00, param_01, param_02, param_03, param_04, param_05, param_06, param_07, param_08, param_09, param_0A) {
  ...
  if(!common_scripts\utility::func_562E(self.exploder_godmode) && !self.var_4B34) {
    ...
    if(isDefined(var_0C) && var_0C.health > 0) {
...
func_AB90() {
  ...
  self.var_349C.health = self.var_3937.var_3935;
...
func_3940() {
  ...
  if(isDefined(self.owner) && common_scripts\utility::func_562E(self.owner.var_392C)) {
    self.owner func_AB9D();
    return;
  }
...
func_0893(param_00, param_01) {
  ...
  if(isDefined(self.owner) && common_scripts\utility::func_562E(self.owner.var_392C)) {
    self.owner thread zombie_exploder_ensure_die_from_attached_explosion(var_04);
  }
...
zombie_exploder_ensure_die_from_attached_explosion(param_00) {
  ...
  var_01 endon("death");
  wait 0.05;
  if(isDefined(param_00) && !isPlayer(param_00.owner)) {
    param_00 = undefined;
  }

  if(isalive(var_01)) {
    var_01 dodamage(var_01.maxhealth + 666, var_01.origin, param_00, undefined, "MOD_EXPLOSIVE", "drag_explosive_zombie_zm");
  }
}
...
func_AB9E(param_00) {
  ...
  foreach(var_02 in level.players) {
    if(distance(param_00, var_02.origin) <= 92) {
...
func_AB97() {
  ...
  if(isDefined(var_02) && var_02.health <= 0) {
    var_01 = 1;
...
func_3942() {
  ...
  if(isDefined(var_01)) {
    var_02 = 1 - distance(var_01.origin, var_00.origin) / func_AB92();
    if(var_02 > 0.2) {
      var_03 = 2.3 * var_02;
      wait(var_03);
    }
...
func_630A(param_00) {
  ...
  for(;;) {
    ...
    var_03 = var_02[0];
    var_04 = distance(var_01.origin, var_03.origin);
    if(var_04 > func_AB93()) {
      break;
    }
  }
...
func_6309(param_00, param_01) {
  ...
  var_02 = param_00 common_scripts\utility::waittill_any_return("stun_burst", "player_dist_reset", "dropped_explosive", "zombie_stunned");
...
func_0BBF(param_00, param_01, param_02, param_03) {
  ...
  var_08 = transformmove(var_06, var_07, var_04, var_05, param_00.origin, param_00.angles);
  param_00.origin = var_08["origin"];
  param_00.angles = var_08["angles"];
}
...
func_AB9B(param_00, param_01, param_02, param_03, param_04, param_05, param_06, param_07, param_08, param_09, param_0A) {
  ...
  if(isDefined(self.on_took_damage_func)) {
    self thread[[self.on_took_damage_func]](anglesToForward(self.angles), param_08, param_05, param_04, param_02, param_00, param_01);
  }
