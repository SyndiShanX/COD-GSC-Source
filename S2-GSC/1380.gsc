...
func_ABA7() {
  ...
  if(isDefined(var_01) && var_01.size > 0) {
    var_02 = distancesquared(var_01[0].origin, self.origin);
  }
...
func_3C0F(param_00) {
  ...
  if(!maps / mp / agents / humanoid / _humanoid_util::func_56DD(self.var_28D2)) {
    if(!maps / mp / agents / humanoid / _humanoid::func_5859(self.var_28D2.origin)) {
      return 0;
    }
...
func_AA4F() {
  return distancesquared(self.origin, self.var_28D2.origin) <= squared(250);
}

func_AA53() {
  return distancesquared(self.origin, self.var_28D2.origin) <= squared(self.var_60F0);
}

func_56EE() {
  var_00 = self.origin + (0, 0, self.var_60E1);
  var_01 = self.var_28D2.origin + (0, 0, self.var_60E1);
...
func_3BF1() {
  ...
  if(var_00.var_A266 && self.var_3CF9) {
    var_03 = maps / mp / agents / humanoid / _humanoid_util::func_1F51(self.origin, var_00.origin);
    if(var_03) {
      var_01 = 1;
      var_02 = var_00.origin;
    } else {
      var_04 = bullettracepassed(self.origin + (0, 0, 32), self.var_28D2.origin + (0, 0, 32), 0, undefined);
      if(var_04) {
        var_01 = 1;
        var_02 = self.origin;
      }
...
func_3BFD() {
  ...
  func_3C02(self.var_28D2, var_00.origin);
}
...
func_3D2A() {
  ...
  while(gettime() - var_00 < 2000) {
    var_01 = common_scripts\utility::func_F73(lib_0547::func_408F(), level.players);
...
func_5625(param_00) {
  ...
  if(distance2dsquared(self.origin, param_00.origin) > var_02) {
    return 0;
  }

  var_09 = param_00.origin - var_04 * (1, 1, 0);
...
func_21CD(param_00) {
  ...
  if(isDefined(param_00) && isDefined(param_00.var_56ED) && param_00.var_56ED) {
    func_21CE(param_00, var_01, var_02, var_03, param_00.maxhealth / 2);
  }
}
...
func_A112() {
  ...
  for(;;) {
    ...
    var_02 = length(var_01.origin - self.var_5B9B);
    if(var_02 < 100) {
      continue;
    }
...
func_3889(param_00) {
  if(!param_00 method_83B8() && distance2dsquared(self.origin, param_00.origin) < 250000) {
    return -1;
  }
...
func_388B(param_00) {
  ...
  if(self.var_28D2 == param_00 && lengthsquared(param_00.origin - self.origin) < squared(250)) {
    return -1;
  }
...
func_9E17(param_00, param_01, param_02, param_03) {
  if(gettime() - param_00.var_9A18 >= 50) {
    param_00.origin = maps / mp / agents / humanoid / _humanoid_util::func_60F4(param_01, param_00.var_686A, param_02);
    param_00.origin = maps / mp / agents / humanoid / _humanoid_util::func_34AB(param_00.origin, 15, 55);
...
func_ABA9(param_00, param_01, param_02, param_03, param_04, param_05, param_06, param_07, param_08) {
  ...
  if(isDefined(param_01)) {
    var_09 = common_scripts\utility::func_98E7(isPlayer(param_01), param_01.name, "") + " killed fireman";
...
func_3C11(param_00, param_01, param_02) {
  ...
  var_03 = 0;
  if(lib_0547::func_5565(param_01.script_noteworthy, "zombie_sky_spawner") || lib_0547::func_5565(param_01.var_8109, "scripted_fire_spawn_drop")) {
    var_03 = 1;
  }
  ...
  if(var_03) {
    var_05 thread func_3C0D(param_01.origin);
  }

  var_05.health = func_3C04(var_05.health);
  if(var_05.health < var_05.maxhealth) {
...
func_3C0D(param_00) {
  ...
  foreach(var_07 in var_05) {
    ...
    var_08 = distancesquared(var_07.origin, param_00);
    if(var_08 <= var_02) {
  ...
  foreach(var_0B in level.players) {
    var_08 = distancesquared(var_0B.origin, param_00);
    if(var_08 <= var_01) {
...
func_3FEF(param_00, param_01, param_02, param_03, param_04, param_05, param_06, param_07, param_08, param_09, param_0A) {
  waittillframeend;
  if(isalive(self)) {
    lib_0380::func_2889("zmb_fireman_gas_tank_destroyed", undefined, self.origin);
    self.var_3FEE = 1;
    thread func_3FF0(param_06);
    self setonfire(0.01 * self.maxhealth, 1.5, 20, "none", 1, self, param_05);
    self dodamage(self.var_3FF2, self.origin, param_01, param_00, "MOD_EXPLOSIVE", param_05);
