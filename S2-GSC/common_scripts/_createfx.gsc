...
convertoneshotfx() {
  ...
  for(var_1 = 0; var_1 < level._createfx.selected_fx_ents.size; var_1++) {
    ...
    if(var_2.v["type"] == "exploder") {
      setfxkillondelete(var_2.looper, 1);
      waitframe();
      var_2.v["type"] = "oneshotfx";
      var_2 remove_option("exploder");
      var_2.v["delay"] = -15;
      var_2 remove_option("exploder_type");
    }
  }
...
init_level_variables() {
  ...
  level._createfx._id_8C29 = 0;
  level._createfx._id_8BF0 = 0;
...
createfxlogic() {
  ...
  for(;;) {
    ...
    var_14 = button_is_clicked("mouse1", "BUTTON_A");
    var_15 = button_is_held("mouse1", "BUTTON_A");
    var_16 = button_is_held("shift");
    ...
    if(button_is_clicked("r") && var_16) {
      _id_7A4E();
    }

    modify_player_speed();

    if(!var_13 && button_is_clicked("g")) {
    ...
    for(var_18 = 0; var_18 < level.createfxent.size; var_18++) {
      ...
      var_19 = level.player getvieworigin();
      var_20 = vectorNormalize(var_3.v["origin"] - var_19);
      var_21 = vectordot(var_8, var_20);
    ...
    manipulate_createfx_ents(var_12, var_14, var_15, var_13, var_7);
...
draw_origin(var_0, var_1) {
  ...
  if(var_5 > 0) {
    ...
    if(var_16) {
      ...
      var_22 = 0.333;
      var_23 = var_4 * (var_22, var_22, var_22) + (1, 0, 0);
      var_24 = var_4 * (var_22, var_22, var_22) + (0, 1, 0);
      var_25 = var_4 * (var_22, var_22, var_22) + (0, 0, 1);
    }
  }
}
...
_id_8C29() {
  if(level._createfx._id_8C29) {} else {}

  level._createfx._id_8C29 = !level._createfx._id_8C29;
}

_id_8BF0() {
  if(level.mp_createfx) {
    level._createfx._id_8BF0 = !level._createfx._id_8BF0;
  }
}
...
handle_selected_ents(var_0) {
  if(level._createfx.selected_fx_ents.size > 0 && level.createfx_help_active == 0) {
    ...
    set_tool_hudelem("Selection:", _id_7E32());
    ...
    if(level._createfx.axismode && level._createfx.selected_fx_ents.size > 0) {
      ...
      for(var_7 = 0; var_7 < level._createfx.selected_fx_ents.size; var_7++) {
        ...
        if(level.mp_createfx && _id_55E9(var_9.v["origin"] + var_8) != 1) {
...
_id_7E32() {
  ...
  if(level._createfx.selected_fx_ents.size == 1) {
    ...
    var_1 = level._createfx.selected_fx_ents[0].v[var_0];
    var_2 = [];

    foreach(var_5, var_4 in level.createfxent) {
      if(isDefined(var_4.v[var_0]) && issubstr(var_4.v[var_0], var_1)) {
        if(var_0 == "soundalias") {
          if(var_4.v["type"] == "soundfx_interval" || var_4.v["type"] == "soundfx") {
    ...
    if(var_2.size > 1) {
      for(var_5 = 0; var_5 < var_2.size; var_5++) {
        if(level.createfxent[var_2[var_5]] == level._createfx.selected_fx_ents[0]) {
          var_6 = var_5;
        }
      }
    }

    return var_6 + 1 + " of " + var_2.size + " placed";
  } else
...
aim_axis_of_selected_ents() {
  ...
  if(level._createfx.selected_fx_ents.size == 1 && !level.mp_createfx) {
    var_1 = level._createfx.selected_fx_ents[0];
    var_2 = vectortoangles(-1 * [[level._id_3F0F]]());
    var_1.v["angles"] = var_2;
    var_1 set_forward_and_up_vectors();
  } else {
    for(var_3 = 0; var_3 < level._createfx.selected_fx_ents.size - 1; var_3++) {
      var_1 = level._createfx.selected_fx_ents[var_3];
      var_2 = vectortoangles(var_0.v["origin"] - var_1.v["origin"]);
      var_1.v["angles"] = var_2;
      var_1 set_forward_and_up_vectors();
    }
  }
...
move_selection_to_cursor() {
  ...
  if(level.mp_createfx && _id_55E9(var_0) != 1) {
...
_id_838C(var_0) {
  ...
  foreach(var_3 in level._createfx.selected_fx_ents) {
    if(!isDefined(var_3.v[var_0]) || var_3.v["type"] != "oneshotfx") {
      continue;
    }
    var_4 = var_3.v[var_0];
    var_1[var_4] = 1;
...
reset_fx_hud_colors() {
  for(var_0 = 0; var_0 < level._createfx.hudelem_count; var_0++) {
    level._createfx.hudelems[var_0].color = (1, 1, 1);
  }
}
...
write_log(var_0, var_1, var_2, var_3, var_4) {
    ...
    cfxprintln("cfxprintln("#include common_scripts\\utility;"); cfxprintln("#include common_scripts\\_createfx;\n"); cfxprintln(""); cfxprintln("main()"); cfxprintln("{"); var_6 = var_0.size;
      ...
      cfxprintln(var_5 + "foreach(var_12 in var_0) {
        if(level.createfx_loopcounter > 16) {
          level.createfx_loopcounter = 0;
          wait 0.1;
        }

        level.createfx_loopcounter++; write_entity(var_12, var_2);
      }
      ...
      if(isDefined(var_4)) {
        foreach(var_9 in var_4) {
          ...
          if(!isDefined(var_9["radiant"])) {
            ...
            var_12 = spawnStruct();
            var_12.v = var_9;
            write_entity(var_12, var_2);
          }
        }
      }

      cfxprintln("}"); cfxprintln(" "); cfxprintlnend(var_2, var_3, var_1);
    }
    ...
    cfxprintln(var_0) {
      common_scripts\utility:: fileprint_launcher_start_file( var_0 );
    }
    ...
    init_huds() {
      ...
      for(var_0 = 0; var_0 < level._createfx.hudelem_count; var_0++) {
        ...
        var_1.alpha = 1;
        var_1.y = 60 + var_0 * 15;
        level._createfx.hudelems[var_0] = var_1;
      }
      ...
      var_1.x = 320;
      var_1.y = 240;
      level.createfx_centerprint = var_1;
    }
    ...
    _id_5984(var_0) {
      ...
      var_2 = level._createfx.selected_fx_ents[0].v[var_1];
      var_3 = [];

      foreach(var_6, var_5 in level.createfxent) {
        if(isDefined(var_5.v[var_1]) && issubstr(var_5.v[var_1], var_2)) {
          if(var_1 == "soundalias") {
            if(var_5.v["type"] == "soundfx_interval" || var_5.v["type"] == "soundfx") {
      ...
      if(var_3.size > 1) {
        for(var_6 = 0; var_6 < var_3.size; var_6++) {
          if(level.createfxent[var_3[var_6]] == level._createfx.selected_fx_ents[0]) {
            var_7 = var_6;
          }
        }

        if(var_7 >= var_3.size - 1 && var_0 == "next") {
          var_8 = var_3[0];
        } else if(var_7 == 0 && var_0 == "prev") {
          var_8 = var_3[var_3.size - 1];
        } else if(var_0 == "next") {
          var_8 = var_3[var_7 + 1];
        } else {
          var_8 = var_3[var_7 - 1];
        ...
        deselect_all_ents();
        select_entity(var_8, level.createfxent[var_8]);
        frame_selected();
      }
    }
    ...
    _id_44C7(var_0) {
      for(var_1 = 0; var_1 < level.createfxent.size; var_1++) {
        if(var_0 == level.createfxent[var_1]) {
          return var_1;
        }
      }
    }
    ...
    _id_55E9(var_0) {
      var_1 = level._id_5FEB - (32768, 32768, 32768);
      var_2 = level._id_5FEB + (32768, 32768, 32768);
      var_3 = var_0[0] > var_1[0] && var_0[0] < var_2[0];
      var_4 = var_0[1] > var_1[1] && var_0[1] < var_2[1];
      var_5 = var_0[2] > var_1[2] && var_0[2] < var_2[2];
