...
func_854A(param_00, param_01) {
  ...
  var_05.origin = (var_05.origin[0], var_05.origin[1], var_04[2]);
  ...
  var_06 = level.var_6DDD.origin;
  var_07 = level.var_6DDD.angles;
...
func_7D78(param_00, param_01) {
  ...
  level.var_6DDD.origin = param_00;
  level.var_6DDD.angles = param_01;
}
...
func_801B(param_00, param_01) {
  ...
  if(isDefined(param_00.var_A6EA)) {
    ...
    param_00.var_586E = spawn("weapon_" + param_01, param_00.var_6DDD.origin);
