...
func_3B9D(param_00) {
  var_01 = self;
  playFX(common_scripts\utility::func_44F5("tesla_blood_explosion"), var_01.origin + (0, 0, 24));
  var_02 = maps / mp / gametypes / zombies::func_1E59() * 2;
  lib_0580::func_98E9(var_01.origin, func_4184(), param_00.player, undefined, "teslagun_zm_blood", (0.5803922, 0.1921569, 0.3372549), var_02);
...
func_7788(param_00, param_01) {
  ...
  if(isDefined(var_02.var_A4B)) {
    ...
    if(isDefined(var_03) && common_scripts\utility::func_562E(var_03.shockbyteslablood)) {
      var_04 = lib_0580::func_8317(param_00, param_01.player, ::func_3B9D);
      var_02 thread lib_0547::func_7D1A("tesla_shock", [var_04], 4);
      return;
    }
  }

  var_03 thread lib_0580::func_98EE(param_01, var_02.player, "MOD_ENERGY", "teslagun_zm_blood", 1);
}
