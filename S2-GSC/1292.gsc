...
func_1437(param_00, param_01) {
  foreach(var_03 in level.var_1FFD) {
    ...
    if(distancesquared(param_01.origin, var_03.origin) < 2500) {
      return 0;
    }
  }
...
func_1443(param_00, param_01) {
  foreach(var_03 in level.var_486C) {
    ...
    if(distancesquared(param_01.origin, var_03.origin) < 65536) {
      return 0;
    }
  }
...
func_1447(param_00, param_01) {
  ...
  foreach(var_04 in var_02) {
    ...
    if(distancesquared(param_01.origin, var_04.origin) < 65536) {
      return 0;
    }
  }
...
func_56E4(param_00) {
  if(!level.teambased || level.friendlyfire || isDefined(param_00) && !isDefined(param_00.team)) {
    return 1;
  }
  ...
  if(isDefined(param_00) && param_00 == self.owner) {
    return 1;
  }
...
func_144D(param_00, param_01) {
  ...
  var_02 = lib_0526::func_4675(param_01.origin);
  if(var_02 > 0.25) {
    return 0;
  }
  ...
  if(!isDefined(level.var_9034)) {
    ...
    foreach(var_07 in var_03) {
      ...
      foreach(var_0A in var_04) {
        var_0B = distance(var_07.origin, var_0A.origin);
        if(var_0B < var_08) {
          var_08 = var_0B;
        }
      }

      if(isDefined(var_07.script_noteworthy) && var_07.script_noteworthy == "axis_override") {
        var_07.var_2BD3 = "axis";
        continue;
      }

      if(isDefined(var_07.script_noteworthy) && var_07.script_noteworthy == "allies_override") {
      ...
      foreach(var_0E in var_05) {
        var_0F = distance(var_07.origin, var_0E.origin);
        if(var_0F < var_08 / 2) {
          var_07.var_2BD3 = "axis";
          break;
...
func_10DE(param_00, param_01) {
  if(func_2936() && isDefined(param_01.var_3EF5) && level.var_3EF3.var_565F[self.team] && param_01.var_3EF5 != self.team) {
    return 0;
  }
...
func_1451(param_00, param_01) {
  if(positionwouldtelefrag(param_01.origin)) {
...
func_143E(param_00, param_01) {
  if(isDefined(param_01.var_5BE1) && !level.teambased || param_01.var_5BE1 != param_00) {
...
func_3B92(param_00, param_01, param_02) {
  ...
  foreach(var_08 in level.var_7AD4[var_03]) {
    ...
    var_0A = distancesquared(param_01.origin, var_08["position"]);
    if((param_02 && var_0A > level.var_9037["enemySpawnAreaDistance"]) || !level.teambased && var_08["player"] == self.guid) {
      continue;
    }
...
func_1450(param_00, param_01, param_02) {
  ...
  var_03 = distancesquared(param_01.origin, param_02["position"]);
...
func_1446(param_00, param_01) {
  ...
  var_02 = distancesquared(param_01.origin, self.var_5B90);
  if(var_02 > 4000000) {
    return 100;
  }
...
func_3B91(param_00, param_01, param_02) {
  ...
  foreach(var_07 in level.var_7AD1[param_00]) {
    ...
    var_09 = distancesquared(param_01.origin, var_07["position"]);
    if((param_02 && var_09 > level.var_9037["allyDeathDistance"]) || !level.teambased && var_07["player"] != self.guid) {
      continue;
    }
...
func_1445(param_00, param_01) {
  ...
  var_02 = distancesquared(param_01.origin, self.lastattacker.origin);
  if(var_02 > 4000000) {
    return 100;
  }
...
func_765D(param_00, param_01) {
  var_02 = getspawnpointtotalplayers(param_01.index, param_00);
  if(var_02 == 0) {
    return 0;
  }

  var_03 = getspawnpointdistsum(param_01.index, param_00);
  if(!isDefined(var_03)) {
    return 0;
  }
...
func_7660(param_00, param_01) {
  if(getspawnpointtotalplayers(param_01.index, param_00) == 0) {
    return 0;
  }

  var_02 = getspawnpointmindist(param_01.index, param_00);
  if(!isDefined(var_02)) {
    return 0;
  }
...
func_AAFF(param_00, param_01) {
  var_02 = maps\mp\gametypes\_gameobjects::func_44B9(param_00);
  if(getspawnpointtotalplayers(param_01.index, var_02) == 0) {
    return 100;
  }

  var_03 = getspawnpointmindist(param_01.index, var_02);
  if(!isDefined(var_03)) {
    return 0;
  }
...
func_143C(param_00, param_01) {
  ...
  if(isDefined(param_00)) {
    foreach(var_06 in level.players) {
      if(!isDefined(var_06) || !isDefined(var_06.team) || var_06 == self || function_02D5(var_06) == "spectator") {
        continue;
      } else {
...
func_143D(param_00, param_01) {
  ...
  var_03 = distancesquared(param_01.origin, maps / mp / gametypes / dom::func_44E1(param_01.var_766F));
...
func_7667(param_00, param_01) {
  ...
  var_03 = distancesquared(var_02.origin, param_01.origin);
...
avoidveryclosetorelic(param_00, param_01) {
  ...
  var_03 = distancesquared(var_02, param_01.origin);
  if(var_03 <= level.var_9037["HPZoneTooCloseDistance"]) {
    return 0;
  }
...
func_AB32(param_00, param_01) {
  ...
  if(isDefined(level.zombies_active_spawn_event)) {
    ...
    if(isDefined(param_01.targetname) && param_01.targetname == var_02) {
      return 100;
    }
  }

  if(isDefined(level.var_1F1D) && ![[level.var_1F1D]](param_01.script_noteworthy)) {
    return 0;
  }

  if(isDefined(level.var_AC88) && [[level.var_AC88]](param_01.script_noteworthy)) {
    return 0;
  }
...
func_AB3F(param_00, param_01) {
  ...
  var_03 = [[level.var_43F2]](var_02, param_01.script_noteworthy);
  if(var_03 < 0) {
    return 0;
  }
...
func_AB40(param_00, param_01) {
  ...
  var_03 = [[level.var_43F4]](var_02, param_01.script_noteworthy);
  if(var_03 < 0) {
    return 0;
  }
...
func_AB41(param_00, param_01) {
  ...
  var_02 = distance(param_01.origin, self.var_5B90);
...
func_A11B() {
  ...
  var_03 = var_02 - var_00.lastupdatetime / 1000;
  var_00.lastupdatetime = var_02;
  ...
  foreach(var_1B in var_19) {
    var_1C = undefined;
    var_1D = var_00.var_6162 - var_1B.origin;
