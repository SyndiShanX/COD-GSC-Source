...
run_post_launch_optional_spawner_params_override() {
  ...
  foreach(var_04 in var_00) {
    var_05 = common_scripts\utility::func_4461(var_04.origin, var_01);
  ...
  for(;;) {
    ...
    for(;;) {
      ...
      if(isDefined(var_0D) && getdvarint("spv_zm_difficulty_enabled") == 1) {
        var_0E = int(var_0D.maxhealth * level.zm_shotgun_health_mod);
        var_0D.maxhealth = var_0E;
