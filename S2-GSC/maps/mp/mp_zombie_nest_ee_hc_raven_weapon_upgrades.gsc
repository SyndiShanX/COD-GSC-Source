 ...
 * Script: maps\mp\mp_zombie_nest_ee_hc_raven_weapon_upgrades.gsc
******************************************************************/
...
func_7B96(param_00, param_01, param_02, param_03, param_04, param_05, param_06, param_07, param_08, param_09) {
  ...
  var_0D = common_scripts\utility::func_44BE(var_0C.target, "targetname");
  ...
  var_11 = common_scripts\utility::func_46B5(var_0C.target + "_trap_reciever", "targetname");
  ...
  foreach(var_13 in var_0D) {
    ...
    switch (var_13.script_noteworthy) {
      case "cover_model":
        var_10[var_13.script_noteworthy] = var_13;
        break;
      ...
      case "fuse_pickup":
        var_10[var_13.script_noteworthy] = var_13;
        var_10[var_13.script_noteworthy] hide();
        break;
      ...
      case "raven_uber_trap_deposit":
        var_10[var_13.script_noteworthy] = var_13;
        var_10[var_13.script_noteworthy].var_3E3C = common_scripts\utility::func_46B5(var_10[var_13.script_noteworthy].targetname + "_forge", "targetname");
        var_10[var_13.script_noteworthy].var_65D5 = param_00;
        break;
  ...
  var_16 = getEnt(var_10["raven_uber_trap_deposit"].var_3E3C.target, "targetname");
  var_17 = getEnt(var_10["raven_uber_trap_deposit"].var_3E3C.target, "targetname");
  var_18 = getEnt(param_05, "targetname");
  var_19 = getEnt(var_17.target, "targetname");
  var_19 hide();
  ...
  var_0C.var_9C92.var_9FE5 hide();
  var_1D = lib_0585::func_8F7E(var_0C.var_9C92.var_9FE5.origin, func_4703(param_00), func_4702(param_00), var_10["raven_trap_pickup_trig_offset"].origin, param_00);
  var_10["raven_uber_trap_deposit_trig"] common_scripts\utility::func_9D9F();
  var_17 setHintString(&"ZOMBIE_NEST_PLACE_UBER");
  var_17 usetouchtriggerrequirefacingposition(1, var_10["raven_uber_trap_deposit"].var_3E3C.origin);
  var_0C.var_9C92.var_9FE5.var_65E3 delete();
  var_0C.var_9C92.var_9FE5.origin = var_10["raven_uber_trap_deposit"].var_3E3C.origin;
  var_0B = undefined;
  while(!isDefined(var_0B) || !var_0B lib_0585::func_9E12(param_00)) {
    var_17 waittill("trigger", var_0B);
  }

  var_0C.var_9C92.var_9FE5 show();
  var_17 setHintString(&"ZOMBIE_NEST_UBER_TRANSFER");
  var_10["main_trigger"] = var_17;
  var_1E["battleID"] = 3;
  var_1E["event_origin"] = var_10["main_trigger"].origin;
  ...
  var_10["attack_positions"] = getEnt(var_19.target, "targetname");
  var_1F = spawnStruct();
  ...
  maps / mp / mp_zombie_nest_special_event_creator::func_3135(::func_A6A4, var_10["main_trigger"], [var_10["attack_positions"]], var_1E["battleID"], var_1E["notifications"], var_10["activation_triggers"], var_10["main_trigger"].script_noteworthy, var_1E["event_origin"], ::func_6A77, ::func_6A76, ::func_6A78, var_1F, ::func_6A7D, var_21);
  var_17 delete();
  ...
  var_23 = [0, undefined];
  while(!var_23[0]) {
    var_23 = maps / mp / mp_zombie_nest_ee_util::func_745D(level.var_AACA[param_04].var_48F2.origin, 250, 128);
    wait(1);
  }
  ...
  while(!issubstr(var_24, "teslagun_zm")) {
    ...
    if(!issubstr(var_24, "teslagun_zm")) {
      var_0B iprintlnbold(&"ZOMBIE_NEST_ASSEMBLE_WW_REQUIRES");
    }
  }
...
func_8F6E(param_00, param_01, param_02, param_03, param_04) {
  ...
  var_07 = param_01.origin - param_00.origin;
  var_08 = sqrt(abs(var_07[2] * 2 / 800));
  var_09 = 1 / var_08;
  var_0A = var_07 * (var_09, var_09, 0);
  var_06 gravitymove(var_0A, var_08);
  var_06 rotateTo(param_01.angles, var_08);
  wait(var_08);
  var_06.origin = param_01.origin;
}
...
func_9870(param_00, param_01, param_02) {
  ...
  for(;;) {
    ...
    for(var_0B = 0; var_0B < var_09.size; var_0B++) {
      if(distance(self.origin, var_09[var_0B].origin) < 256 && isDefined(var_09[var_0B].var_A4B) && var_09[var_0B].var_A4B == param_01) {
...
func_440B() {
  ...
  foreach(var_03 in var_00) {
    if(var_03.agentteam == level.var_746E) {
      continue;
    }
...
func_902C(param_00, param_01) {
  ...
  var_02.targetname = param_01 + "_uber_receiver";
...
func_9FE9(param_00, param_01, param_02, param_03, param_04) {
  ...
  var_06 = spawn("script_model", param_01.origin);
...
func_7A8A(param_00) {
  if(!0) {
    if(0) {
      while(!isDefined(level.players) || distance(level.players[0].origin, param_00["tesla_fuse_box"].origin) > 256) {
        wait(0.1);
      }
    ...
    while(!var_01) {
      ...
      var_04 = getEnt(param_00["fuse_pickup"].target, "targetname");
      if(distance(var_04.origin, var_02) <= 150) {
        var_01 = 1;
      }
    }
  }
  ...
  var_05 = getEnt(param_00["fuse_pickup"].target, "targetname");
...
func_7A87(param_00) {
  if(0) {
    while(!isDefined(level.players) || distance(level.players[0].origin, param_00["cover_model"].origin) > 256) {
      wait(0.1);
    }
  ...
  param_00["cover_model"] thread func_1806();
  var_01 = getEnt(param_00["fuse_pickup"].target, "targetname");
...
func_1806() {
  ...
  self gravitymove(-200 * vectorNormalize(common_scripts\utility::func_3D5C(anglesToForward(self.angles))) + (0, 0, 50), 1);
...
func_7A8B(param_00) {
  ...
  var_01 = common_scripts\utility::func_46B5(param_00["fuse_pickup"].target, "targetname");
  var_02 = param_00["fuse_pickup"];
  var_03 = var_01;
  var_02 hide();
...
func_7A89(param_00) {
  ...
  while(var_02.var_775E < var_04.size) {
    var_02.origin = var_04[var_02.var_775E].origin;
    var_02 thread func_39EA(6);
    var_02 waittill("trigger");
    if(var_02.var_775E >= 0) {
      lib_0378::func_8D74("tesla_hc_energy_lamp_destruct", var_02.origin);
    }
  ...
  lib_0378::func_8D74("tesla_hc_energy_lamp_loop_off", var_02.origin);
  stopFXOnTag(common_scripts\utility::func_44F5("temp_hc_challenge_indicator_lights"), var_03, "tag_origin");
  var_06 = getEnt(param_00["fuse_pickup"].target, "targetname");
  var_02.origin = var_06.origin;
  var_07 = getEnt(param_00["fuse_pickup"].target, "targetname");
...
func_6FEE(param_00) {
  if(!common_scripts\utility::func_562E(param_00.var_2EE3)) {
    param_00.var_2EE3 = 1;
    self notify("zombie trap killed", param_00.var_A4B, param_00.origin);
    wait 0.05;
  }
}
...
func_A6A2(param_00) {
  ...
  while(!var_01) {
    ...
    if(distance(param_00.origin, var_02) < var_03) {
      var_01 = 1;
    }
  }
}
...
func_A6B9(param_00, param_01, param_02, param_03) {
  ...
  while((!isDefined(param_03) && var_04 == "") || isDefined(param_03) && var_04 != param_03) {
    ...
    if(isDefined(param_03) && var_04 != param_03) {
      var_05 iprintln("need wonder weap to skip");
    }
  }
