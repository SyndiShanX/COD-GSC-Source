 ...
 * Script: maps\mp\mp_tank_graveyard_2.gsc
*********************************************/

func_00F9() {
  maps\mp\mp_tank_graveyard_2_precache::main();
  maps\createart\mp_tank_graveyard_2_art::main();
  maps\mp\mp_tank_graveyard_2_fx::main();
  maps\mp\_load::main();
  maps\mp\mp_tank_graveyard_2_lighting::main();
  maps\mp\mp_tank_graveyard_2_aud::main();
