 ...
 * Script: maps\mp\mp_zombie_nest_ee_hc_true_voice.gsc
*******************************************************/
...
func_6A7B() {
  self["god_gem"] show();
  level notify("end hilt grabbed", self["god_gem"].var_5AFC.origin);
...
func_52EF() {
  ...
  var_00["god_gem"] = spawn("script_model", var_03.origin);
  var_00["god_gem"] setModel("zmb_hilt_sword_gem_01");
  var_00["god_gem"] hide();
  var_00["god_gem"].var_5AFC = common_scripts\utility::func_46B5(var_03.target, "targetname");
  return var_00;
}