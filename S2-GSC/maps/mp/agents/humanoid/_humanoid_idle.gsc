 ...
 * Script: maps\mp\agents\humanoid\_humanoid_idle.gsc
******************************************************/
...
func_A0DE() {
  var_00 = undefined;
  if(isDefined(self.var_9831) && distancesquared(self.var_9831.origin, self.origin) < 262144) {
    var_00 = self.var_9831;
  } else if(isDefined(self.var_3043) && distancesquared(self.var_3043.var_4883, self.origin) < 16384) {
