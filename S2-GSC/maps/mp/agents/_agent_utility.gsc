...
func_5334(param_00) {
  if(!param_00) {
    ...
    self.var_1444 = 5;
    self.guid = maps\mp\_utility::func_4704();
    self.name = self.guid;
...
func_470C(param_00, param_01) {
  ...
  if(isDefined(level.var_A966) && isDefined(level.var_9DC7)) {
    ...
    foreach(var_05 in var_03) {
      if(var_05.origin[2] > level.var_A966 || !ispointinvolume(var_05.origin, level.var_9DC7)) {
...
func_5A39() {
  self[[func_0A59("on_damaged")]](level, undefined, self.health + 1, 0, "MOD_CRUSH", "none", (0, 0, 0), (0, 0, 0), "none", 0, "");
}
