 ...
 * Script: maps\mp\agents\_agents_gametype_raid.gsc
****************************************************/
...
func_9079(param_00, param_01, param_02, param_03, param_04, param_05, param_06) {
  ...
  maps / mp / agents / _agent_utility::func_83FE(self.team);
  self.agentname = &"RAIDS_SQUADMATE";
...
func_0C6D() {
  ...
  for(;;) {
    ...
    if(float(self.owner.health) / self.owner.maxhealth < 0.5 && gettime() > var_01) {
      ...
      var_03 = maps / mp / bots / _bots_util::func_19CE(self.owner.origin, 350, 1);
      if(isDefined(var_03)) {
    ...
    if(!maps / mp / bots / _bots_util::func_1A30(self.owner)) {
      var_04["override_goal_type"] = "critical";
      var_04["min_goal_time"] = 20;
      var_04["max_goal_time"] = 30;
      maps / mp / bots / _bots_strategy::func_1A0C(self.owner, 350, var_04);
    }
...
func_17C8(param_00, param_01, param_02, param_03, param_04) {
  ...
  if(level.var_791B.size > 6) {
    level.var_791B[0] dodamage(level.var_791B[0].health + 100, level.var_791B[0].origin);
  }
...
func_0A5F() {
  ...
  func_0A5E();
  thread func_0A60();
  maps / mp / bots / _bots_strategy::func_1A8D(self.origin, 512, []);
  wait(15);
...
func_0A5E() {
  ...
  foreach(var_04 in var_00) {
    ...
    self setweaponammoclip(var_04, var_05);
  }
