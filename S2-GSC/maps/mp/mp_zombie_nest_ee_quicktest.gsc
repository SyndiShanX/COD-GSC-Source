 ...
 * Script: maps\mp\mp_zombie_nest_ee_quicktest.gsc
***************************************************/
...
func_0CAE(param_00, param_01, param_02, param_03) {
  ...
  foreach(var_05 in level.var_AC1D) {
    var_05 notify("open", level.players[0]);
  }
  ...
  for(;;) {
    if(isDefined(level.players)) {
      for(var_08 = 0; var_08 < level.players.size; var_08++) {
        if(!isDefined(level.players[var_08].var_57D9)) {
          level.players[var_08].var_57D9 = 1;
          if(isDefined(var_07)) {
            level.players[var_08] setOrigin(var_07[var_08].origin);
            level.players[var_08] setplayerangles(var_07[var_08].angles);
          }

          level.players[var_08] func_8706(param_00, param_01);
          if(0) {
            level.players[var_08].var_AC5B = 1;
          }

          level.players[var_08] maps / mp / gametypes / zombies::func_4798(param_02 - 500);
          level.players[var_08] lib_056A::func_47B5();
          level.players[var_08] lib_056A::func_47B8();
          level.players[var_08] lib_056A::func_47B1();
        }
      }
    }
