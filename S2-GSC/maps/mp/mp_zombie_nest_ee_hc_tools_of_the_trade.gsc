...
func_52EC() {
  ...
  foreach(var_05 in var_03) {
    var_06 = common_scripts\utility::func_44BE(var_05.target, "targetname");
    var_07 = function_021F(var_05.target, "targetname");
...
func_760C() {
  ...
  playFX(common_scripts\utility::func_44F5("zmb_ee_switch_sparks"), self["power_box"].origin, anglesToForward(self["power_box"].angles), anglestoup(self["power_box"].angles));
...
func_80D6() {
  ...
  wait(0.15);
  for(var_01 = 0; var_01 < var_00.size; var_01++) {
    self.var_2E71[var_01] = self.var_3B9C[var_01].origin;
    self.var_3B9C[var_01].var_65DB = spawn("script_model", self.var_2E71[var_01]);
    self.var_3B9C[var_01].var_65DB.angles = self.var_3B9C[var_01].angles;
  ...
  for(var_01 = 0; var_01 < var_00.size; var_01++) {
    ...
    var_05 = self.var_3B9C[var_01].var_65DB.origin;
...
func_3B8A(param_00, param_01, param_02) {
  ...
  for(var_05 = 0; var_05 < param_01.size; var_05++) {
    ...
    var_08 = param_01[var_05] - param_00.origin;
    var_07 = var_07 * (1, 1, 0);
    var_08 = var_08 * (1, 1, 0);
