...
on_player_connect() {
  ...
  var_00.var_7545 = [];
  var_00.hasradar = 0;
  var_00.radarshowenemydirection = 0;
  var_00.var_5F7C = 0;
  var_00.var_9CFF = 0;
...
spawnzombiesforteam(param_00, param_01, param_02) {
  for(var_03 = 0; var_03 < param_01; var_03++) {
    ...
    if(isDefined(var_04)) {
      playFX(common_scripts\utility::func_44F5("zombieSpawn"), var_04.origin);
      ...
      if(level.gametype == "undead") {
        var_04 handlezombieaggro(level.players, ::quicksort_hardpoint_dist_compare);
      }
    }
...
quicksort_hardpoint_dist_compare(param_00, param_01) {
  return distance2dsquared(param_00.origin, level.var_AC7C.origin) < distance2dsquared(param_01.origin, level.var_AC7C.origin);
}
...
killallzombies() {
  ...
  foreach(var_01 in level.zombiearray) {
    playFX(common_scripts\utility::func_44F5("zombieSpawn"), var_01.origin);
    lib_0378::func_8D74("aud_zombie_spawn", var_01.origin);
    var_01 suicide();
  }
}
...
changezombieallegiance(param_00) {
  ...
  if(level.zombiearray[0].team == param_00) {
    return;
  }

  for(var_01 = 0; var_01 < level.zombiearray.size; var_01++) {
    level.zombiearray[var_01] hudoutlinedisableforclients(level.players);
    level.zombiearray[var_01].team = param_00;
...
func_6BD1(param_00, param_01, param_02, param_03, param_04, param_05, param_06, param_07, param_08, param_09, param_0A) {
  ...
  if(isDefined(param_05) && maps\mp\_utility::getweaponclass(param_05) == "weapon_other" && !issubstr(param_05, "riotshield_mp")) {
    param_02 = 666;
  }
...
func_6BD4(param_00, param_01, param_02, param_03, param_04, param_05, param_06, param_07, param_08) {
  ...
  if(isPlayer(param_01)) {
    if(!isDefined(param_01.pers["zombieKills"])) {
      param_01.pers["zombieKills"] = 0;
    }

    param_01.pers["zombieKills"]++;
    if(level.gametype == "undead") {
      ...
      param_01 maps\mp\_utility::func_867C(param_01.pers["zombieKills"]);
    }
