 ...
 * Script: maps\mp\gametypes\demo.gsc
*********************************************/
...
func_6BA7() {
  ...
  if(isPlayer(self)) {
    if(level.var_6510 && self.pers["team"] == game["attackers"] || game["status"] == "overtime") {
...
func_A121() {
  ...
  level.var_3992 = maps\mp\_utility::dvarintvalue("extraTime", 2, 0, 10);
}

func_5782(param_00) {
  if(isDefined(level.var_1913)) {
    foreach(var_02 in level.var_1913) {
      if(distancesquared(self.origin, var_02.var_9D65.origin) < 4096) {
        return 0;
      }
    }
  }
...
onnormaldeath(param_00, param_01, param_02) {
  if(game["state"] == "postgame" && param_00.team == game["defenders"] || !level.var_18F9) {
  ...
  for(var_01 = 0; var_01 < var_00.size; var_01++) {
    ...
    if(isDefined(level.demolition_site_mod) && isDefined(level.demolition_site_mod[var_01])) {
      ...
      foreach(var_07 in var_04) {
        if(distance(var_07.origin, var_02.origin) <= 200 && isDefined(var_07.var_81BE) && ((game["status"] != "overtime" && var_07.var_81BE == "demo_bombzone") || game["status"] == "overtime" && var_07.var_81BE == "demo_bombzone_ot") && isDefined(var_07.var_81E8) && var_07.var_81E8 == level.demolition_site_mod[var_01]) {
          var_05 = var_07;
        }
      }
    }
    ...
    if(isDefined(level.demolition_site_origins) && isDefined(level.demolition_site_origins[var_01]) && isDefined(var_05)) {
      var_02.origin = level.demolition_site_origins[var_01];
      var_03[0].origin = level.demolition_site_origins[var_01];
      var_05.origin = (0, 0, 26) + level.demolition_site_origins[var_01];
    }

    if(isDefined(level.demolition_site_angles) && isDefined(level.demolition_site_angles[var_01]) && isDefined(var_05)) {
      var_02.angles = level.demolition_site_angles[var_01];
      var_03[0].angles = (0, 270, 0) + level.demolition_site_angles[var_01];
      var_05.angles = level.demolition_site_angles[var_01];
    }
    ...
    var_0B.var_18D5 = getEnt(var_03[0].target, "targetname");
    var_0B.var_18D5.origin = var_0B.var_18D5.origin + (0, 0, -10000);
    var_0B.var_18D5.label = var_0C;
...
func_6BC8(param_00) {
  if(!maps\mp\gametypes\_gameobjects::func_56FB(param_00.pers["team"]) || game["status"] == "overtime") {
...
func_7156(param_00) {
  var_01 = common_scripts\utility::func_F93(level.players, param_00);
  if(var_01.size) {
...
func_6ABF(param_00) {
  ...
  if(maps\mp\gametypes\_gameobjects::func_56FB(param_00.pers["team"])) {
    if(!level.var_8C56 && !param_00 maps\mp\_utility::_hasperk("specialty_improvedobjectives")) {
...
func_18D3() {
  ...
  foreach(var_01 in level.players) {
    var_01 setclientomnvar("ui_demo_bomb" + self.label + "_state", 0);
  }

  setomnvar("ui_bomb" + self.label + "_timer_endtime", 0);
  setomnvar("ui_broadcaster_game_mode_status_1", 0);
