...
func_154D() {
  self.var_50CB = 0;
  var_00 = self.var_A582[0];
  playsoundatpos(var_00.origin, "grid_ball_out_of_bounds");
...
func_154E(param_00) {
  ...
  var_03 = 1.2;
  var_04 = 1;
  playsoundatpos(param_00.origin, "grid_goal_scored");
...
func_1509() {
  var_00 = undefined;
  var_01 = common_scripts\utility::array_randomize(level.var_1554);
