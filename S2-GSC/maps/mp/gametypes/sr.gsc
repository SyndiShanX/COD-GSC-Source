...
func_903E(param_00, param_01) {
  ...
  if(isDefined(level.var_31F9[param_00.guid])) {
    playFX(level.var_257E["vanish"], level.var_31F9[param_00.guid].var_28D4);
    level.var_31F9[param_00.guid] notify("reset");
  } else {
    ...
    level.var_31F9[param_00.guid] maps\mp\gametypes\_gameobjects::func_8A5A(0);
    level.var_31F9[param_00.guid].var_6BBF = ::func_6BBF;
    level.var_31F9[param_00.guid].victim = param_00;
    level.var_31F9[param_00.guid].var_A496 = param_00.team;
    level thread func_2404(param_00);
    param_00 thread func_95BD(level.var_31F9[param_00.guid]);
  }

  level.var_31F9[param_00.guid].var_28D4 = var_02;
  level.var_31F9[param_00.guid].var_9D65.origin = var_02;
  level.var_31F9[param_00.guid].var_A582[0].origin = var_02;
  ...
  if(param_00.team == "axis") {
    function_01D1(level.var_31F9[param_00.guid].var_698B, "waypoint_dogtags_friendlys");
    objective_team(level.var_31F9[param_00.guid].var_698B, "axis");
    function_01D1(level.var_31F9[param_00.guid].var_698A, "waypoint_dogtags");
    objective_team(level.var_31F9[param_00.guid].var_698A, "allies");
  } else {
    function_01D1(level.var_31F9[param_00.guid].var_698A, "waypoint_dogtags_friendlys");
    objective_team(level.var_31F9[param_00.guid].var_698A, "allies");
    function_01D1(level.var_31F9[param_00.guid].var_698B, "waypoint_dogtags");
    objective_team(level.var_31F9[param_00.guid].var_698B, "axis");
  }

  objective_position(level.var_31F9[param_00.guid].var_698A, var_02);
  objective_position(level.var_31F9[param_00.guid].var_698B, var_02);
  objective_state(level.var_31F9[param_00.guid].var_698A, "active");
  objective_state(level.var_31F9[param_00.guid].var_698B, "active");
  playsoundatpos(var_02, "mp_killconfirm_tags_drop");
  level notify("sr_player_killed", param_00);
  param_00.var_95B4 = 1;
  param_00.objective = 3;
  level.var_31F9[param_00.guid].var_A582[0] scriptmodelplayanim("mp_dogtag_spin");
  level.var_31F9[param_00.guid].var_A582[1] scriptmodelplayanim("mp_dogtag_spin");
}
...
func_6BBF(param_00) {
  ...
  if(param_00.pers["team"] == self.var_A496) {
    self.var_9D65 playSound("mp_snd_ally_revive");
    ...
    param_00.var_7D26[self.victim.guid] = 1;
    if(param_00.var_7D26.size == 4) {
      param_00 maps\mp\gametypes\_missions::processchallenge("ch_helpme");
    }
  } else {
    self.var_9D65 playSound("mp_killconfirm_tags_pickup");
    param_00 thread maps\mp\_events::func_35D3();
    if(isDefined(self.victim)) {
      if(!level.gameended) {
        self.victim maps\mp\_utility::func_86C3("spawn_info", game["strings"]["spawn_next_round"]);
        self.victim thread maps\mp\gametypes\_playerlogic::func_7CFA(3);
      }
...
func_7D6F() {
  ...
  self.var_9D65.origin = (0, 0, 1000);
  self.var_A582[0].origin = (0, 0, 1000);
  self.var_A582[1].origin = (0, 0, 1000);
...
func_95BD(param_00) {
  ...
  for(;;) {
    ...
    param_00.var_A496 = self.pers["team"];
    param_00 func_7D6F();
  }
}
