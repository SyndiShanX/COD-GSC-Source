 ...
 * Script: maps\mp\bots\_bots_gametype_undead.gsc
**************************************************/
    ...
    if(isDefined(level.var_ACAF) && !isDefined(var_00) && level.var_7A62 == 0 && level.var_1A19) {
      ...
      if(var_02 > 0 && var_02 < 10000) {
        ...
        if(!var_03) {
          ...
          var_06 = maps / mp / bots / _bots_util::func_19F9(self.team);
...
func_1969(param_00) {
  ...
  maps / mp / bots / _bots_strategy::func_196B(param_00.origin, param_00.var_671A, param_00.var_9D5E, var_01);
}
