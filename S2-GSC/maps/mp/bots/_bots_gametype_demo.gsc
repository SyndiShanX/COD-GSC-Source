 ...
 * Script: maps\mp\bots\_bots_gametype_demo.gsc
************************************************/
  ...
  for(;;) {
    ...
    if(var_00) {
      ...
      if(self.var_7ECA == "sweep_zone") {
        ...
        if(!function_0279(level.var_2D65[self.var_28EE.label]) && !maps / mp / bots / _bots_util::func_1A2E(level.var_2D65[self.var_28EE.label].origin)) {
          var_01["score_flags"] = "strongly_avoid_center";
          maps / mp / bots / _bots_strategy::func_1AA6(level.var_2D65[self.var_28EE.label].origin, level.var_7790, var_01);
        }
...
func_2C92() {
  ...
  var_00 = maps / mp / bots / _bots_gametype_common::func_40DE(self.var_28EE).origin;
...
func_4297(param_00) {
  var_01 = func_42B2(param_00, self.team);
...
func_42B2(param_00, param_01) {
  ...
  foreach(var_05 in var_03) {
    ...
    if(distancesquared(var_05.origin, param_00.var_28D4) < level.var_7790 * level.var_7790) {
      var_02 = common_scripts\utility::func_F6F(var_02, var_05);
    }
  }
...
func_1B08() {
  ...
  if(isDefined(var_00)) {
    var_01 = distance(self.origin, self.var_28EE.var_28D4);
    var_02 = distance(self.origin, var_00.var_28D4);
...
func_1970() {
  ...
  if(func_553C(self.var_28EE)) {
    ...
    if(!isDefined(var_01) || var_01 == self) {
      ...
      var_02 = distance(self.origin, self.var_28EE.var_28D4);
      var_03 = distance(var_01.origin, self.var_28EE.var_28D4);
