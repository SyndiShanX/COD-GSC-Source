...
func_197D() {
  ...
  for(;;) {
    ...
    if(var_00 && self method_8367()) {
      ...
      } else if(maps / mp / bots / _bots_strategy::func_1A14("kill_tag") && self.var_95A8 maps\mp\gametypes\_gameobjects::func_1F53(self.team)) {
...
func_197C(param_00, param_01) {
  ...
  foreach(var_04 in param_00) {
    ...
    foreach(var_07 in param_01) {
      if(var_04.var_95A6 == var_07.var_95A6 && maps / mp / bots / _bots_util::func_1B1C(var_04.origin, var_07.origin)) {
        var_05 = 1;
        break;
      }
    }
...
func_19D1(param_00, param_01, param_02) {
  ...
  if(isDefined(var_03)) {
    foreach(var_07 in level.var_31F9) {
      if(var_07 maps\mp\gametypes\_gameobjects::func_1F53(self.team)) {
        var_08 = 0;
        if(!param_00 || var_07.attacker == self) {
          if(!isDefined(var_07.var_1E5A)) {
            ...
            var_08 = distancesquared(self.origin, var_07.var_487B) < 1000000 && var_07.var_6AA9;
          }
  ...
  if(param_00.size > 0) {
    ...
    foreach(var_05 in param_00) {
      ...
      if(!param_01 || var_06 < 2) {
        var_07 = distancesquared(var_05.var_95A6.var_487B, self.origin);
        if(var_07 < var_03) {
...
func_1AB5(param_00) {
  ...
  foreach(var_03 in param_00) {
    if(var_03.var_95A6 maps\mp\gametypes\_gameobjects::func_1F53(self.team) && maps / mp / bots / _bots_util::func_1B1C(var_03.var_95A6.var_28D4, var_03.origin)) {
...
func_424F(param_00) {
  ...
  foreach(var_03 in level.var_6E97) {
    ...
    if(var_03.team == self.team && var_03 != self) {
      ...
      if(distancesquared(var_03.origin, param_00.var_28D4) < 160000) {
        var_01++;
      }
    }
  }
