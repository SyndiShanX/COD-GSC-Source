 ...
 * Script: maps\mp\zombies\shotgun\_zombies_shotgun_drop_pod.gsc
*****************************************************************/
...
drop_pod_spawn_drop() {
  ...
  var_04 = (0, 0, -800);
  var_05 = 1;
  var_06 = var_01 - var_00.pod_model.origin;
...
drop_pod_set_drop_point_active() {
  ...
  var_04 = common_scripts\utility::func_F73(level.players, lib_0547::func_408F());
  foreach(var_06 in var_04) {
    if(var_06 istouching(self.clip_shell)) {
      if(isPlayer(var_06)) {
        var_07 = self.spawned_model.origin;
        if(canspawn(var_07)) {
        ...
        var_06 dodamage(var_06.health + 666, self.spawned_model.origin, undefined, undefined, "MOD_CRUSH");
        continue;
      }

      var_06 dodamage(var_06.health + 666, self.spawned_model.origin, undefined, undefined, "MOD_EXPLOSIVE");
    }
  }
  ...
  for(;;) {
    foreach(var_01 in level.players) {
      ...
      if(isDefined(var_02) && var_02 == self.clip_shell) {
        var_03 = self.spawned_model.origin;
        if(canspawn(var_03)) {
        ...
        var_01 dodamage(var_01.health + 666, self.spawned_model.origin, undefined, undefined, "MOD_CRUSH");
      }
    }
