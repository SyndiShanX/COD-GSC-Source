 ...
 * Script: maps\mp\zombies\shotgun\_zombies_shotgun_gamemode.gsc
*****************************************************************/
...
spawn_weapon_pickup_on_zombies(param_00, param_01, param_02, param_03, param_04, param_05, param_06, param_07, param_08) {
  ...
  if(lib_0547::func_5565(self.agentteam, level.var_746E)) {
    return;
  }

  var_09 = maps / mp / gametypes / zombies::func_3B9B(self.origin);
  if(!isDefined(var_09)) {
    return;
  }
...
spawn_client_hc_opt_in(param_00) {
  ...
  if(maps\mp\_utility::func_4571() == "mp_zombie_dig_02") {
    var_02.origin = var_02.origin + (0, 0, 6);
  }
  ...
  var_04 = 25;
  for(;;) {
    if(var_04 < 0 || !common_scripts\utility::func_562E(var_01.optedintohc) && var_01 useButtonPressed() && distance(var_01.origin, var_02.origin) < 64) {
      if(var_04 >= 0) {
...
sg_pickup_drop_schedule() {
  ...
  var_00 = level.players.size * 2000;
  var_01 = level.players.size * 3000;
...
run_intro_cinematic() {
  ...
  var_00.var_6772.sort = 999;
  var_00.var_6772.horzalign = "fullscreen";
  var_00.var_6772.vertalign = "fullscreen";
  var_00.var_6772.foreground = 0;
  var_00 endon("disconnect");
  ...
  foreach(var_05, var_04 in var_01) {
    var_04.dest = common_scripts\utility::func_4461(var_04.origin, var_02);
...
run_outro_cinematic() {
  ...
  var_01.dest = common_scripts\utility::func_46B5(var_01.target, "targetname");
...
initialize_weapons_in_play() {
  ...
  foreach(var_05 in level.var_A7DE) {
    var_00 = common_scripts\utility::func_F6F(var_00, var_05.script_noteworthy);
  }
...
sg_run_obj_round(param_00) {
  if(isDefined(param_00.event_func)) {
    var_01 = sg_obj_splash_get_type_name_friendly(param_00.type);
    foreach(var_03 in level.players) {
      var_04 = undefined;
      if(param_00.type == "type_boss") {
        ...
        if(param_00.type != "type_escape_common") {
          var_03 thread maps\mp\gametypes\_hud_message::func_9102(param_00.type);
        }

        var_04 = tablelookup("mp/zombiesShotgunObjectiveData.csv", 0, param_00.type, 1);
      }
    ...
    if(isDefined(param_00.var_9A07) && param_00.var_9A07 != 0) {
      var_06 = maps / mp / zombies / shotgun / _zombies_shotgun_gamemode_utility::get_difficulty_setting(param_00.type + "_timer");
      if(!isDefined(var_06)) {
...
sg_obj_set_wave_endless(param_00) {
  ...
  if(common_scripts\utility::func_562E(param_00)) {
    level.var_3774[level.players.size][level.var_A980]["zombie_generic"] = 10;
    level.var_3774[level.players.size][level.var_A980]["zombie_berserker"] = 5;
    level.var_3774[level.players.size][level.var_A980]["zombie_exploder"] = 2;
    level.var_3774[level.players.size][level.var_A980]["zombie_heavy"] = 0;
    return;
  }
...
sg_obj_splash_title(param_00, param_01, param_02, param_03) {
  ...
  var_04.splashtitle = var_04 maps\mp\gametypes\_hud_util::createfontstring("bigfixed", 1);
  var_04.splashtitle maps\mp\gametypes\_hud_util::setpoint("CENTER", "CENTER", 0, -10);
  var_04.splashtitle.label = sg_obj_splash_get_type_name_friendly(param_00);
  var_04.splashtitle.alpha = 0;
  var_04.splashtitle.color = (1, 0, 0.07);
  ...
  var_04.splashtitle.horzalign = "left_adjustable";
  var_04.splashtitle.vertalign = "top_adjustable";
  var_04.splashtitle.aligny = "top";
  var_04.splashtitle.alignx = "left";
  var_04.splashtitle.x = var_05.width * 0.042;
  var_04.splashtitle.y = var_05.height * 0.031;
  var_06 = 0.05;
  var_07 = 0.5;
  for(var_08 = 0; var_08 < var_07; var_08 = var_08 + var_06) {
    var_04.splashtitle.fontscale = var_04.splashtitle.fontscale - 0.03;
    wait(var_06);
  }
...
sg_obj_splash_desc(param_00, param_01, param_02, param_03) {
  ...
  var_04.splashdesc = var_04 maps\mp\gametypes\_hud_util::createfontstring("default", 1);
  var_04.splashdesc maps\mp\gametypes\_hud_util::setpoint("CENTER", "CENTER", 0, 10);
  var_04.splashdesc.label = sg_obj_splash_get_type_desc_friendly(param_00);
  var_04.splashdesc.alpha = 0;
  if(!isDefined(param_02)) {
    param_02 = 0;
  }
...
sg_obj_splash_fade_in() {
  ...
  for(var_02 = 0; var_02 < var_01; var_02 = var_02 + var_00) {
    self.alpha = clamp(var_02 / var_01 - 0.25, 0, 0.75);
    wait(var_00 / 2);
    self.alpha = var_02 / var_01;
    wait(var_00 / 2);
  }
}
...
sg_obj_splash_fade_out() {
  ...
  for(var_02 = var_01; var_02 > 0; var_02 = var_02 - var_00) {
    ...
    self.alpha = clamp(var_02 / var_01 + 0.25, 0.25, 1);
    wait(var_00 / 2);
    self.alpha = var_02 / var_01;
    wait(var_00 / 2);
  }
...
sg_obj_splash_clear_title() {
  ...
  if(isDefined(var_00.splashtitle)) {
    var_00.splashtitle maps\mp\gametypes\_hud_util::destroyelem();
  }
}
...
sg_obj_splash_clear_desc() {
  ...
  if(isDefined(var_00.splashdesc)) {
    var_00.splashdesc maps\mp\gametypes\_hud_util::destroyelem();
  }
}
...
sg_obj_timer_countdown() {
  ...
  for(;;) {
    ...
    if(level.sg_obj_timer < 30) {
      foreach(var_02 in level.players) {
        if(isDefined(var_02.objtimerhud) && var_02.objtimerhud.color != (1, 0, 0)) {
          var_02.objtimerhud.color = (1, 0, 0);
        }
      }
    }
...
sg_obj_timer_ui(param_00) {
  ...
  var_01.objtimerhud = var_01 maps\mp\gametypes\_hud_util::createfontstring("default", 1);
  var_01.objtimerhud maps\mp\gametypes\_hud_util::setpoint("LEFT", undefined, 20, 50);
  var_01.objtimerhud.label = &"Time Remaining: ";
  var_01.objtimerhud settenthstimer(level.sg_obj_timer);
  for(;;) {
    var_02 = level common_scripts\utility::waittill_any_return("sg_obj_end", "sg_obj_timeout", "sg_obj_remove_timer", "sg_obj_update_timer");
...
sg_obj_timer_ui_clear() {
  ...
  if(isDefined(var_00.objtimerhud)) {
    var_00.objtimerhud maps\mp\gametypes\_hud_util::destroyelem();
  }
}
...
shotgun_classic_listen_for_jolts() {
  ...
  for(;;) {
    ...
    foreach(var_02 in level.var_8AD2) {
      if(!self method_858B(var_02.origin)) {
        continue;
      }
