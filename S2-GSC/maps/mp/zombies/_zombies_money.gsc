...
func_8ADC(param_00) {
  ...
  lib_0378::func_8D74("zmb_points_pickup", var_01.origin);
...
func_8ADF(param_00, param_01, param_02) {
  ...
  if(func_A235()) {
    ...
    var_04.alpha = 0.9;
    var_04.color = (0.654902, 0.6352941, 0.5647059);
    var_04.x = param_00[0];
    var_04.y = param_00[1];
    var_04.z = param_00[2] + func_4515();
    var_05 = 1;
    var_06 = 1;
    var_07 = 0;
    var_08 = 0;
...
func_A90B() {
  ...
  for(;;) {
    ...
    lib_0378::func_8D74("zmb_points_share", var_00.origin);
    if(!isDefined(var_05)) {
...
func_4681(param_00) {
  ...
  var_02 = param_00.origin + var_01 * func_467E() + (0, 0, 30);
