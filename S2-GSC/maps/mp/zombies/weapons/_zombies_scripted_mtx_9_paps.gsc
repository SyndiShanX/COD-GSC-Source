 ...
 * Script: maps\mp\zombies\weapons\_zombies_scripted_mtx_9_paps.gsc
********************************************************************/
...
scripted_mtx9_on_death(param_00, param_01, param_02, param_03, param_04, param_05, param_06, param_07, param_08) {
  ...
  if(issubstr(param_04, "charlton") && issubstr(param_04, "_pap_zm")) {
    ...
    thread try_charlton_blackhole(self.origin, param_04);
  }
}
...
bubble_sheild_ready() {
  ...
  if(!isDefined(var_00.bubblestruct)) {
    ...
    var_00.bubblestruct.origin = (0, 0, 0);
  }
  ...
  var_00 thread maps / mp / zombies / consumables / inv_giest_shield::spawn_a_giest_bubble_shield(var_00.origin, 5);
}
...
run_reload_bombs(param_00) {
  ...
  var_01 spawn_bubble_bomb("tag_weapon_right", self.origin + (160, 0, 0), param_00);
  wait(0.4);
  var_01 spawn_bubble_bomb("tag_weapon_right", self.origin + (0, 160, 0), param_00);
  wait(0.4);
  var_01 spawn_bubble_bomb("tag_weapon_right", self.origin + (-80, -80, 0), param_00);
}
...
spawn_bubble_bomb(param_00, param_01, param_02) {
  ...
  var_06 = magicartillery(var_04, var_03.origin, param_01, 1, var_05[2] + 42, var_03);
...
geist_bombs_static_think(param_00, param_01, param_02) {
  ...
  if(param_02) {
    ...
    foreach(var_0F in var_0D) {
      if(distance2d(var_0F.origin, param_00) <= 160) {
...
try_charlton_blackhole(param_00, param_01) {
  ...
  level.charlton_blackhole.origin = var_02 + (0, 0, 4);
...
spawn_blackhole() {
  ...
  while(isDefined(self)) {
    foreach(var_02 in lib_0547::func_408F()) {
      ...
      if(distance(var_02.origin, var_00.origin) > 256) {
        continue;
      }
...
pulse_drag_in_victim(param_00) {
  ...
  var_02 = var_01 / 256;
  var_03 = 400 * var_02;
  var_04 = self.origin - param_00.origin;
...
dp28_death_bolt(param_00, param_01) {
  ...
  var_04 = var_02 common_scripts\utility::waittill_any_return("missile_stuck", "death", "entitydeleted");
...
missile_do_flight_damage(param_00, param_01) {
  ...
  if(isDefined(param_00.var_A4B)) {
    ...
    param_00 dodamage(level.dp38missiledamage, param_01, self.owner, self.owner, "MOD_EXPLOSIVE", "dp28_pap_zm");
  }
}
...
dp28_noisy_cricket(param_00) {
  ...
  foreach(var_06 in var_04) {
    ...
    if(distance2d(var_06.origin, var_02) <= 128) {
      if(common_scripts\utility::func_562E(var_03)) {
        var_06 dodamage(1800, param_00.origin, param_00, param_00, "MOD_EXPLOSIVE", "dp28_pap_zm");
      } else {
        var_06 dodamage(level.dp38cricetdamage, param_00.origin, param_00, param_00, "MOD_EXPLOSIVE", "dp28_pap_zm");
      }

      var_07 = 1;
    } else if(distance2d(var_06.origin, var_02) <= 192) {
      if(common_scripts\utility::func_562E(var_03)) {
        var_06 dodamage(1200, param_00.origin, param_00, param_00, "MOD_EXPLOSIVE", "dp28_pap_zm");
      } else {
        var_06 dodamage(level.dp38cricetdamage * 0.66, param_00.origin, param_00, param_00, "MOD_EXPLOSIVE", "dp28_pap_zm");
      }
      ...
      var_07 = 1;
    } else if(distance2d(var_06.origin, var_02) <= 256) {
      if(common_scripts\utility::func_562E(var_03)) {
        var_06 dodamage(600, param_00.origin, param_00, param_00, "MOD_EXPLOSIVE", "dp28_pap_zm");
      } else {
        var_06 dodamage(level.dp38cricetdamage * 0.33, param_00.origin, param_00, param_00, "MOD_EXPLOSIVE", "dp28_pap_zm");
      }
    ...
    if(isDefined(var_06.myshield) && var_07) {
      var_06.myshield dodamage(level.dp38cricetdamage * 0.33, param_00.origin, param_00, param_00, "MOD_EXPLOSIVE", "dp28_pap_zm");
    }
  }
}
...
play_noisy_cricket_vfx(param_00) {
  ...
  playFX(common_scripts\utility::func_44F5("zmb_dp28_green_impact"), param_00.origin);
