 ...
 * Script: maps\mp\mp_zombie_nest_ee_shard.gsc
***********************************************/
...
func_202E() {
  self method_8495("s2_zom_shroud_lift_active", self.var_BBE.origin, self.var_BBE.angles);
  wait(0.2);
...
func_2029() {
  ...
  self method_8495("s2_zom_shroud_lift_2", self.var_BBE.origin, self.var_BBE.angles);
  wait(var_00);
}
...
func_2028() {
  ...
  for(;;) {
    ...
    level.var_3576 method_8495("s2_zom_shroud_lift_stuck_idle", level.var_3576.var_BBE.origin, level.var_3576.var_BBE.angles);
    level.var_3572 scriptmodelclearanim();
    level.var_3572 method_8495("s2_zom_shroud_cover_lift_stuck_idle", level.var_3572.var_BBE.origin, level.var_3572.var_BBE.angles, lib_0547::func_A286());
  }
}
...
func_202B() {
  ...
  var_01 method_8495("s2_zom_shroud_lift_rise_active", var_01.var_BBE.origin, var_01.var_BBE.angles);
  lib_0378::func_8D74("aud_claw_move_start", level.var_3571, 0);
  wait(var_00);
  lib_0378::func_8D74("aud_claw_move_stop", level.var_3571);
}
...
func_2717() {
  ...
  lib_0378::func_8D74("comm_room_claw_trapdoor_closing", self.origin);
}
...
func_2022(param_00) {
  switch (param_00) {
    ...
    case "first_panel_closed":
      lib_0378::func_8D74("comm_room_claw_trapdoor_closed", self.origin);
      break;
    ...
    case "nudge_start_open":
      lib_0378::func_8D74("comm_room_claw_trapdoor_stall", self.origin);
      break;

    case "actually_start_open":
      lib_0378::func_8D74("comm_room_claw_trapdoor_start_open", self.origin);
      level.var_3572.var_8F1 = 1;
      break;

    case "post_open_vibrate":
      lib_0378::func_8D74("comm_room_claw_trapdoor_end_open", self.origin);
      level.var_3595.var_137B = 1;
      break;

    case "slide_begin":
      lib_0378::func_8D74("comm_room_claw_trapdoor_slider", self.origin);
      break;
  }
}
