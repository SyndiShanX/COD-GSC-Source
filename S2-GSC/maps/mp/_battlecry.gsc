  ...
  for(;;) {
    ...
    if(!isDefined(var_00.var_1643)) {
      ...
      if(!isbot(var_00)) {
        ...
        var_00.var_1645.x = 0;
        var_00.var_1645.y = 0;
        var_00.var_1645.alignx = "left";
        var_00.var_1645.aligny = "top";
        var_00.var_1645.horzalign = "fullscreen";
        var_00.var_1645.vertalign = "fullscreen";
        var_00.var_1645 setshader("combathigh_overlay", 640, 480);
        var_00.var_1645.alpha = 0;
        var_00.var_1645.color = (1, 1, 1);
        var_00.var_1645.sort = -3;
...
func_A88F() {
  ...
  for(;;) {
    ...
    if(self.var_1647) {
      ...
      self.var_1644 = maps\mp\_entityheadicons::func_869E(self.team, "waypoint_escort", (0, 0, 90), 14, 14, 0, 0.05, 0, 1, 0, 0, "tag_origin");
      if(isDefined(self.var_1645)) {
        self.var_1645.alpha = 1;
      }

      foreach(var_01 in level.players) {
        if(!isbot(var_01) && var_01.team == self.team) {
          var_01 iprintlnbold(&"MP_BATTLECRY_ACTIVE");
          var_01 playlocalsound("battlecry_use");
        }
      }
    }
  }
...
func_A735() {
  level endon("game_ended");
  for(;;) {
    common_scripts\utility::waittill_any("disconnect", "death", "faux_spawn");
    if(isDefined(self)) {
      func_3673();
    }
  }
...
func_6511() {
  ...
  for(;;) {
    ...
    wait 0.05;
    if(self.recentkillcount > 1 && self.var_1642 == 0 && self.var_1647 == 0) {
      func_1647();
    }
  }
}
...
func_6633() {
  ...
  self endon("disconnect");
  for(;;) {
    common_scripts\utility::waittill_any("neardeath_battlecry");
...
func_7B43() {
  ...
  self endon("disconnect");
  for(;;) {
    common_scripts\utility::waittill_any("recovery_battlecry");
    if(self.var_1642 == 0 && self.var_1647 == 0) {
      func_1647();
    }
  }
