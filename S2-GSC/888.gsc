...
func_1BBF() {
  ...
  self endon("death");
  for(;;) {
    level common_scripts\utility::waittill_any("game_ended", "round_end_finished");
    thread func_93E2();
  }
}
...
func_8D86() {
  if(!isDefined(level.var_71D.guid)) {
    level.var_71D.guid = 0;
  }

  if(maps\mp\_utility::func_585F()) {
    if(level.var_71D.guid > 10000) {
      level.var_71D.guid = 0;
    }
  }

  level.var_71D.guid++;
  return level.var_71D.guid;
}
...
func_8DEE(param_00) {
  ...
  if(isDefined(level.var_71D.var_5D87[param_00])) {
    callclientscript(level.players, "snd_stop_line_emitter", param_00);
...
func_8D9E(param_00, param_01, param_02, param_03, param_04) {
  callclientscript(level.players, "snd_play_dist_conditional_at", param_00, param_01, param_02, param_03, param_04);
}
...
func_307C(param_00, param_01, param_02) {
  var_03 = spawnStruct();
  var_03.var_77EF = func_8E5E(::func_3082);
...
func_8E60() {
  var_00 = undefined;
  if(!func_8E63()) {
    var_00 = self.var_2A35[self.var_B9];
    self.var_B9 = self.var_B9 + 1 % self.var_6062;
    self.var_28CC--;
    self notify("size_changed");
  } else {
...
func_8E63() {
  return self.var_B9 == self.var_95BE;
}

func_8E64() {
  return self.var_B9 == self.var_95BE + 1 % self.var_6062;
}
