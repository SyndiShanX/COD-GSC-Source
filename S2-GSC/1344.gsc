...
func_ABA4(param_00, param_01, param_02, param_03, param_04, param_05) {
  ...
  var_2A = anglestoaxis(self.angles);
  playFX(common_scripts\utility::func_44F5("ground_impact"), self.origin, var_2A["forward"], var_2A["up"]);
  ...
  lib_0547::func_84CB();
  if(abs(param_00[2] - self.origin[2]) > 32) {
    lib_056D::func_5A86();
  }
}
...
func_17EE(param_00) {
  self.var_3A1B = 1;
  param_00 common_scripts\utility::waittill_any("death", "zombie_fall_impact");
