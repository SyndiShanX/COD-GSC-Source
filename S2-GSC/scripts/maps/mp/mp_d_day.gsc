...
_id_0FF4(var_0) {
  var_1 = 0.4;
  wait 2;
  _earthquake(var_1, 1.0, var_0, 600);
}
...
_id_3AAD() {
  ...
  for(var_1 = 0; var_1 < var_0; var_1++) {
    var_2 = _randomfloatrange(0.05, 0.25);
    var_3 = _randomfloatrange(9.0, 12.0);
    var_4 = 1;
    var_5 = 1800;
    var_6 = _randomintrange(-2000, 2000);
    var_7 = 1;
...
_id_7025() {
  ...
  var_1 = 5;
  var_2 = -8;
  var_3 = _randomfloatrange(1.0, 2.0);
  var_4 = 1;
