...
_id_9CB8(var_0) {
  var_0._id_9CB9 = _func_18E("electric_trap_origin", "targetname");
...
_id_8B0D() {
  ...
  var_1 = _func_14B(level._effect["zmb_med_spike_trap_on"], var_0.origin, anglesToForward(var_0.angles));
  _func_14C(var_1);
...
_id_2FF4() {
  ...
  for(;;) {
    for(var_0 = 0; var_0 < 2; var_0++) {
      ...
      self._id_16F7 _meth_82B1(self._id_16F2.origin, 1);
      wait 1;
      var_1 delete();
    }
  }
...
_id_30E4(var_0) {
  while(self._id_9CB9._id_565F) {
    ...
    foreach(var_3 in var_1) {
      if(_func_0E1(var_3.origin, var_0.origin) < 135 && var_3.origin[2] < self._id_9CB9.origin[2]) {
        ...
        if(isalive(var_3) && var_3._id_0BA4 != "traverse") {
          if(!isDefined(var_3._id_A874) || isDefined(var_3._id_A874) && var_4 > var_3._id_A874 + 1000) {
            if(var_3 _id_0547::_id_580A())
              var_3 _meth_8059(var_3.health * 0.1, self._id_9CB9.origin, level._id_9CB8, level._id_9CB8, "MOD_EXPLOSIVE", "trap_zm_mp");
            else {
              maps\mp\mp_zombie_nest_ee_hc_raven_weapon_upgrades::_id_6FEE(var_3);
              var_3 _meth_8059(var_3.health + 666, self._id_9CB9.origin, level._id_9CB8, level._id_9CB8, "MOD_EXPLOSIVE", "trap_zm_mp");
    ...
    foreach(var_3 in var_1) {
      ...
      if(_func_0E1(var_3.origin, var_0.origin) < 135 && var_3.origin[2] < self._id_9CB9.origin[2]) {
        ...
        if(isalive(var_3) && var_4 > var_3._id_A874 + 500 && !_id_0547::_id_577E(var_3)) {
          var_3 _meth_8059(5, self._id_9CB9.origin, undefined, undefined, "MOD_CRUSH");
          var_3._id_A874 = gettime();
          waitframe();
        }
      }
