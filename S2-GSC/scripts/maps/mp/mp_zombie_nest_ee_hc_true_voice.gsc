...
_id_6A7B() {
  ...
  self["god_gem"] _meth_82B1(self["god_gem"]._id_5AFC.origin, 5, 1, 1);
  _func_147(level._effect["nest_ee_hc_gem_fx"], self["god_gem"], "tag_origin");
...
_id_A6DB() {
  ...
  level._id_357F _meth_80CE(&"ZOMBIE_NEST_AMP_CONFIRM_CODE");
...
_id_52EF() {
  ...
  var_0["chandelier_trig"] = _func_18E("nest_hc_mural_chandelier", "script_noteworthy");
