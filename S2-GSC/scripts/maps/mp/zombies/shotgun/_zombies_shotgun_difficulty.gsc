 ...
 * Script: scripts\maps\mp\zombies\shotgun\_zombies_shotgun_difficulty.gsc
***************************************************************************/
...
init() {
  ...
  maps\mp\zombies\shotgun\_zombies_shotgun_gamemode_utility::add_difficulty_setting("Defense Objective Time", "type_defense_common_timer", [90.0, 120], 1, 1, undefined, undefined);
  ...
  maps\mp\zombies\shotgun\_zombies_shotgun_gamemode_utility::add_difficulty_setting("Extermination Time", "type_extermination_common_timer", [150.0, 180], 1, 1, undefined, undefined);
  ...
  maps\mp\zombies\shotgun\_zombies_shotgun_gamemode_utility::add_difficulty_setting("Assassin Objective time", "type_meuchler_common_timer", [150.0, 180], 1, 1, undefined, undefined);
  ...
  maps\mp\zombies\shotgun\_zombies_shotgun_gamemode_utility::add_difficulty_setting("Assassinate Zombie Time", "type_assassinate_common_timer", [180, 150.0], 1, 1, undefined, undefined);
  maps\mp\zombies\shotgun\_zombies_shotgun_gamemode_utility::add_difficulty_setting("Assassinate Zombie Health", "type_assassinate_common_health", 19000, 81400.0, 1, 5.9);
  ...
  maps\mp\zombies\shotgun\_zombies_shotgun_gamemode_utility::add_difficulty_setting("Boss Base Health", "type_boss_health", 210000, 798000.0);
  ...
  maps\mp\zombies\shotgun\_zombies_shotgun_gamemode_utility::add_difficulty_setting("Boss Red Skull Assassin Health", "type_boss_health_assassin_red_skull", 60000, 228000.0);
  ...
  maps\mp\zombies\shotgun\_zombies_shotgun_gamemode_utility::add_difficulty_setting("Visions Time", "visions_timer", [150.0, 180], 1, 1, undefined, undefined);
  ...
  level thread maps\mp\_utility::_id_6F74(::adjust_zombie_health_on_connected);
...
boost_special_enemy_waves() {
  ...
  foreach(var_15, var_1 in level._id_3774) {
    foreach(var_14, var_3 in level._id_3774[var_15]) {
      foreach(var_13, var_5 in level._id_3774[var_15][var_14]) {
        var_6 = maps\mp\zombies\shotgun\_zombies_shotgun_gamemode_utility::get_current_team_level();
        ...
        if(isDefined(level.dynamic_special_enemy_add[var_13])) {
          var_10 = level.dynamic_special_enemy_add[var_13][var_8][0];
          var_11 = level.dynamic_special_enemy_add[var_13][var_8][1];
          var_12 = int(var_15 * _func_2CA(var_10, var_11, var_9));
          level._id_3774[var_15][var_14][var_13] = level._id_3774[var_15][var_14][var_13] + var_12;
        }
      }
    }
  }
...
initialize_care_package_rewards() {
  ...
  var_0 = level.zombies_shotgun_weapons_in_play["weapon_pistol"];
  var_1 = common_scripts\utility::_id_0F73(level.zombies_shotgun_weapons_in_play["weapon_smg"], ["dp28_zm"]);
  var_1 = common_scripts\utility::_id_0F73(var_1, ["winchester1897_zm", "walther_zm"]);
  var_2 = common_scripts\utility::_id_0F73(level.zombies_shotgun_weapons_in_play["weapon_assault"], level.zombies_shotgun_weapons_in_play["weapon_heavy"]);
  var_2 = common_scripts\utility::_id_0F73(var_2, ["ptrs41_zm", "delisle_zm", "leveraction_zm", "arisaka_zm"]);
  ...
  var_3 = maps\mp\zombies\shotgun\_zombies_shotgun_gamemode_utility::get_berlin_melee_weapons();
  var_4 = [];
  var_5 = ["fliegerfaust_zm", "razergun_zm", "teslagun_zm"];
  ...
  maps\mp\zombies\shotgun\_zombies_shotgun_gamemode_utility::register_care_package_reward(2, var_1, var_5);
  maps\mp\zombies\shotgun\_zombies_shotgun_gamemode_utility::register_care_package_reward(3, var_2, var_6, undefined, var_7);
}