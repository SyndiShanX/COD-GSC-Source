...
_id_9276() {
  ...
  for(;;) {
    ...
    self._id_400F = _float(self._id_AC2C) / _float(self._id_AC2D);
  ...
  for(;;) {
    for(var_1 = 0; var_1 < self._id_A602.size; var_1++) {
      for(var_2 = 0; var_2 < self._id_A602[var_1] + 1; var_2++) {
        ...
        var_0 setscriptablepartstate("tech_light", "green_on");
        wait 0.2;
        var_0 setscriptablepartstate("tech_light", "off");
        wait 0.2;
      }
    ...
    var_0 setscriptablepartstate("tech_light", "red_on");
    wait 0.75;
    var_0 setscriptablepartstate("tech_light", "off");
    wait 0.75;
  }
...
_id_52E6() {
  ...
  var_1 = _getscriptablearray("zmb_phonograph_model", "targetname");
  var_0["record_player"] = var_1[0];
  var_2 = _getscriptablearray("hc_phonograph_tech_piece", "targetname");
  var_0["record_player_tech"] = var_2[0];
  var_0["record_player"] thread _id_86F6("off");
  var_0["record_player"] setscriptablepartstate("record", "off");
  return var_0;
}
