...
players_in_zone_internal() {
  var_00 = self;
  var_01 = [];
  foreach(var_03 in var_00.players) {
    if(isDefined(var_03) && isPlayer(var_03) && var_03.sessionstate != "spectator") {
      var_01[var_01.size] = var_03;
    }
  }

  var_00.players = var_01;
  return var_01;
}
...
updatecurrentzones() {
  ...
  if(isDefined(var_00.lastzoneupdateorigin)) {
    if(var_00.origin == var_00.lastzoneupdateorigin) {
      return;
    }
  }

  var_00.lastzoneupdateorigin = var_00.origin;
  var_01 = var_00.currentzones;
  var_00.currentzones = [];
  var_02 = isPlayer(var_00) && var_00.sessionstate == "spectator";
...
onentityleftzone(param_00) {
  ...
  if(isPlayer(var_01)) {
    var_02.players[var_03] = undefined;
  }
...
func_530A(param_00, param_01, param_02) {
  ...
  foreach(var_06 in var_04) {
    if(var_06.classname == "info_volume") {
...
func_4694(param_00) {
  ...
  foreach(var_0A in level.var_AC80.var_ACB3[param_00].var_A615) {
    if(isDefined(var_0A.target)) {
      var_0B = common_scripts\utility::func_46B7(var_0A.target, "targetname");
    ...
    foreach(var_05 in var_01) {
      if(ispointinvolume(var_05.origin, var_0A) && !common_scripts\utility::func_F79(var_08, var_05)) {
...
func_583C(param_00) {
  ...
  if(isDefined(level.players)) {
    foreach(var_03 in level.players) {
      var_04 = function_038E(param_00, var_03.origin);
      if(var_04 < 2000) {
        var_01 = 1;
        break;
      }
...
func_1E55(param_00, param_01, param_02, param_03) {
  ...
  foreach(var_08 in var_05) {
    if((var_08 func_905D() || isDefined(param_03)) && var_08 func_905C(param_00, param_01) && isDefined(param_03) || (param_02 || func_583C(var_08.origin)) && var_08 func_582C()) {
      var_04 = var_08;
      break;
    }
  }
...
func_1E4E(param_00, param_01, param_02, param_03) {
  ...
  foreach(var_15 in level.players) {
    ...
    foreach(var_18 in var_13) {
      if(isDefined(var_18.enemy) && var_18.enemy == var_15) {
        var_16++;
      }
    }
  ...
  foreach(var_25 in var_09) {
    ...
    var_28 = function_038E(var_27, var_11.origin);
    var_26 = var_26 + var_28 / var_1E;
    var_26 = var_26 / common_scripts\utility::func_5D93(vectordot(vectorNormalize(var_11 getvelocity()), vectorNormalize(var_27 - var_11.origin)), 0, 1, 1, 1 + var_1D);
...
func_ACA1() {
  ...
  if(isDefined(var_00)) {
    var_01 = getclosestpointonnavmesh(var_00.origin);
    self.var_74DC = var_01;
    return;
  }

  foreach(var_04, var_03 in lib_050D::func_44F9("allies")) {
    if(lib_0547::func_5565(var_03.script_noteworthy, self.var_AC8A)) {
      var_01 = getclosestpointonnavmesh(var_03.origin);
...
zonehudupdateplayerthread() {
  ...
  for(;;) {
    ...
    if(!isDefined(var_03)) {} else {
      ...
      if(lib_0547::func_5565(var_00.var_5BB6, var_03)) {} else {
        var_05 = "unknown";
