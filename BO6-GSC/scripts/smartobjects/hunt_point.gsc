 ...
 * Script: scripts\smartobjects\hunt_point.gsc
***********************************************/
...
function main() {
  utility::add_smartobject_type("\xae,p\r,\xdd\x90\xd5\xed\xa6", &getinfo, &canuse);
}
...
function onuse(object) {
  var_5577343375ce9026 = self._blackboard.var_fbcdc3ec5079a36a;
  pod = undefined;
  ...
  if(self == job.leader) {
    ...
    self.var_ec73914830381278 = 1;
    self.var_f825f09f8146eb41 = exit_wait;
    gesture::ai_request_gesture("\x13\ft_\x02t\x83\xf5\xcb\xd3\f\xe4\x9f\xc3", var_5577343375ce9026, 1000, "\xe7\xa9BqTXlmfH^\akc4\xf5\xf2%");
    ...
    if(!isDefined(var_dae9df780a8ea40b)) {
      ...
      otherguy utility::delaycall(0.5, &glanceatpos, var_dae9df780a8ea40b, 300);
    ...
    gesture::ai_request_gesture("\xfa\x9b\x1c", undefined, 1000, "\x18\x06p?\x87\xd3k:\x12\x8e\\\xdf");
  }

  thread waitforgesture("\x18\x06p?\x87\xd3k:\x12\x8e\\\xdf");
  battlechatter::set_cooldown("\xdf\xd6\xa9-\xc2X\xa1\xa0\x9c\xa4", 20);
}
