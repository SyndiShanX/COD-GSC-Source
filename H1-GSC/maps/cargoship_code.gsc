 ...
 * Script: maps\cargoship_code.gsc
********************************/
...
txt_voice(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  ...
  if(isPlayer(self)) {
    while(var_10) {
      ...
      var_13 = level.player.origin + var_12 + (0, 0, 64);
      var_8 = 0.25;
      var_7 = (1, 1, 0);

      for(var_14 = 0; var_14 < var_9.size; var_14++)
        var_13 = var_13 + (0, 0, 10 * var_8);
...
heli_flypath(var_0) {
  ...
  while(isDefined(var_0)) {
    ...
    level.heli.vehicle setvehgoalpos(var_0.origin + (0, 0, 150), var_1);
  ...
  while(!common_scripts\utility::flag("deck_windows")) {
    ...
    for(var_6 = 0; var_6 < var_4.size; var_6++) {
      ...
      if(var_9 > var_3 && var_4[var_6].moveplaybackrate < var_0) {
        var_4[var_6].moveplaybackrate = var_4[var_6].moveplaybackrate + 0.05;
        continue;
      }
...
hallways_heroes_solo(var_0, var_1, var_2, var_3) {
  ...
  while(isDefined(var_4)) {
    ...
    if(isDefined(var_3)) {
      ...
      if(var_3 == "stand2run180")
        var_7.angles = var_7.angles + (0, 32, 0);
...
escape_heroes2() {
  ...
  switch (self.script_noteworthy) {
    ...
    case "grigsby":
      wait 0.5;
      var_0.origin = var_0.origin + (0, -35, 0);
...
escape_fx_setup() {
  ...
  maps\_utility::delaythread(1, common_scripts\utility::play_sound_in_space, "elm_wave_crash_ext", (-2304, -864, -128));
  ...
  maps\_utility::delaythread(0.5, common_scripts\utility::play_sound_in_space, "elm_wave_crash_ext", (-2304, -864, -128));
  maps\_utility::delaythread(0.5, common_scripts\_exploder::exploder, 126);
  maps\_utility::delaythread(1.25, common_scripts\utility::play_sound_in_space, "elm_wave_crash_ext", (-2848, -800, -64));
  maps\_utility::delaythread(1.25, common_scripts\_exploder::exploder, 300);
  maps\_utility::delaythread(4, common_scripts\utility::play_sound_in_space, "elm_wave_crash_ext", (-3808, -368, -64));
...
escape_explosion() {
  ...
  thread common_scripts\utility::play_sound_in_space("scn_cargo_explosion", (8, -360, -216));
