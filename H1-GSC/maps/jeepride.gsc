...
bodysense_bridgeexplosion() {
  ...
  var_0.origin = var_1;
  var_0.angles = var_2;
  var_0 linktoplayerview(level.player, "tag_origin", (0, 0, -50), (0, 0, 0), 1);
...
checkmantle() {
  ...
  var_0 linktoplayerview(level.player, "tag_origin", (0, 0, var_1), (0, 0, 0), 0);
...
bridge_zakhaev() {
  ...
  maps\_utility::delaythread(8.15, maps\jeepride_code::shot_in_the_head_point_blank, var_13, (3, -4, 6), (105, -80, 0));
  maps\_utility::delaythread(13.1, maps\jeepride_code::shot_in_the_head_point_blank, var_9, (-5, 2, 2), (42, -8, 0));
  maps\_utility::delaythread(8.65, maps\jeepride_code::shot_in_the_head_point_blank, var_10, (-2, 3, 4), (100, 42, 0));
...
offset_ent() {
  self.origin = self.origin + level.rescue_scene_offset;
}
...
bx_warmup_vfx_end() {
  ...
  maps\jeepride_fx::heli_tread_fx_swap("fx\treadfx\heli_dust_jeepride3");
}
