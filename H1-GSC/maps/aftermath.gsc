...
radio_chatter() {
  thread common_scripts\utility::play_sound_in_space("snc_intro_stinger", (0, 0, 0));
...
body_sense_wakeup_start() {
  ...
  level.ground_ref_ent.angles = level.ground_ref_ent.angles + (0, 0, -5.27285);
