...
quarters_dialogue() {
  ...
  maps\_vehicle::switch_vehicle_fx("script_vehicle_blackhawk", "fx\treadfx\heli_dust_cargoship");
}
...
quarters_heli() {
  ...
  while(isDefined(var_0)) {
    ...
    level.heli.vehicle setvehgoalpos(var_0.origin + (0, 0, 150), var_2);
...
deck_heli() {
  ...
  level.heli.vehicle setvehgoalpos(var_0.origin + (0, 0, 146), 1);
  ...
  level.heli.model.spotlight_default_target linkto(level.heli.model, "tag_turret", (0, 0, -256), (0, 0, 0));
  ...
  level.heli.vehicle setlookatent(level.heroes5["price"]);
  common_scripts\utility::flag_wait("moveup_deck1a");
  maps\_vehicle::switch_vehicle_fx("script_vehicle_blackhawk", "fx\treadfx\heli_dust_cargoship_shooting");
  ...
  var_4 linkto(level.heli.model.minigun["left"], "tag_flash", (-30, 0, 0), (0, 0, 0));
...
cargohold2_enemies_common() {
  ...
  self.baseaccuracy = self.baseaccuracy * 0.8;
  self.a.disablelongdeath = 1;
...
end_anim_thread() {
  ...
  thread common_scripts\utility::play_sound_in_space("elm_wave_crash_ext", (-3392, 656, -64));
...
end_dialogue() {
  ...
  thread common_scripts\utility::play_sound_in_space("scn_heli_jump_final_thunder_lr", (0, 0, 0));
...
objective_main() {
  ...
  if(level.jumpto != "start") {
    objective_add(var_0, "active", level.strings["obj_package"], (3052, 15, 407));
...
movewindbox(var_0) {
  self endon("BoxesInTheWindStop");
  var_0 physicslaunchclient(var_0.origin, (0, 0, 0));
  var_1 = -2400;
  ...
  for(;;) {
    ...
    var_1 = var_1 + randomintrange(36, 120);
...
start_physical_dof() {
  ...
  for(var_11 = 28; var_5 < var_6; var_5 = var_5 + 0.1) {
