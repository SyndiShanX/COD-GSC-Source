 ...
 * Script: maps\sniperescape_anim.gsc
********************************/
...
player_rappel() {
  ...
  level.scr_model["player_grab_barret"] = "viewhands_player_marines";
  level.scr_anim["player_rappel"]["rappel"] = % sniper_escape_player_rappel;
  level.scr_animtree["player_rappel"] = #animtree;
  level.scr_model["player_rappel"] = "worldbody_h1_sas_woodland_ghillie";
  ...
  if(getdvarint("use_old_crash_pickup") == 1) {
    ...
    level.scr_model["player_carry"] = "worldbody_h1_sas_woodland_ghillie";
