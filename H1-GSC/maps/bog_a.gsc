...
apartment_second_floor() {
  ...
  wait 1;
  var_2 = maps\_utility::get_closest_colored_friendly("p", (10327.1, -386.339, 236));
...
javelin_guy_runs_in() {
  ...
  wait 2.0;
  thread common_scripts\utility::play_sound_in_space("bog_a_gm1_westisdown", (9153.57, 64.5412, 80), 1);
