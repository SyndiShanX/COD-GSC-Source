...
ambush_setup() {
  ...
  level.player setplayerangles(var_1.angles + (13, 0, 0));
...
apartment_helicopter_turret(var_0, var_1, var_2) {
  ...
  thread common_scripts\utility::play_sound_in_space("scn_minigun_shell_tl", (-4802.8, -8288.6, 38));
  level waittill("remove_old_turret");
  var_3 delete();
}
...
apartment_mg_nest() {
  ...
  var_0 hide();
  wait 0.9;
  var_5 physicslaunchclient(var_5.origin + (0, -50, 0), (0, 600, 0));
  common_scripts\utility::flag_wait("apartment_inside");
...
apartment_mg_nest_sandbag() {
  ...
  self physicslaunchclient(self.origin + (0, -10, 0), (0, 1500, 200));
}
