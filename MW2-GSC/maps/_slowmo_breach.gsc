 ...
 * Script: maps\_slowmo_breach.gsc
********************************************************/
...
dump_missing_anims() {
    ...
    PrintLn("adds = []; adds[adds.size] = "_survives "; adds[adds.size] = "_death "; adds[adds.size] = "_death2 "; adds[adds.size] = "_idle "; adds[adds.size] = "_manhandled_guarded "; adds[adds.size] = "_manhandled "; adds[adds.size] = "_manhandled_guarded_idle "; adds[adds.size] = "_manhandled_idle "; adds[adds.size] = "_manhandled_guarded_prepare_idle "; adds[adds.size] = "_manhandled_prepare_idle "; adds[adds.size] = "_manhandled_guarded_prepare "; adds[adds.size] = "_manhandled_prepare ";

      add_suffix = []; foreach(parm, _ in level.missing_animation_parameters) {
        foreach(add in adds) {
      ...
      level.missing_animation_parameters = undefined; level.missing_animations = undefined;
    }
