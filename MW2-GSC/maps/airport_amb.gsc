...
main() {
  ...
  ambientDelay("airport_terminal0", 5.0, 10.0);
  ...
  ambientDelay("airport_ext0", 7.0, 15.0);
  ambientEvent("airport_ext0", "null", 1.0);

  ambientDelay("airport_int0", 7.0, 15.0);
  ambientEvent("airport_int0", "null", 1.0);

  ambientDelay("airport_basement0", 7.0, 15.0);
