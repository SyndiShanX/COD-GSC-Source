...
so_player_get_bodyfunc(num) {
  switch (level.so_campaign) {
    ...
    default:
      assertex(false, "Special Ops requires level.campaign to be set to a valid value in order to setup the character body.");
  }
  return;
}
