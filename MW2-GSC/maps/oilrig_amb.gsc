...
main() {
  ...
  ambientDelay("amb_underwater_test1v1", 15.0, 25.0);
  ambientEvent("amb_underwater_test1v1", "null", 1.0);

  ambientDelay("ambient_oilrig_test_ext1", 5.0, 10.0);
  ...
  ambientDelay("ambient_oilrig_int1", 5.0, 10.0);
