 ...
 * Script: aitype\enemy_merc_rpg.gsc
********************************************************/

/*QUAKED actor_enemy_merc_RPG (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE PERFECTENEMYINFO DONTSHAREENEMYINFO
defaultmdl="body_airborne_lmg""count" -- max AI to ever spawn from this spawner
