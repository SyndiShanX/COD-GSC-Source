 ...
 * Script: aitype\enemy_desert_elite_lmg_rpd.gsc
********************************************************/

/*QUAKED actor_enemy_desert_elite_LMG_RPD (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE PERFECTENEMYINFO DONTSHAREENEMYINFO
defaultmdl="body_us_army_assault_a""count" -- max AI to ever spawn from this spawner
