 ...
 * Script: maps\mp\gametypes\oneflag.gsc
*****************************************/
...
oneflag_ctf() {
  ...
  level.iconCapture3D = "waypoint_capture_flag";
  level.iconTarget3D = "waypoint_captureneutral";
  level.iconDefend3D = "waypoint_defend_flag";
  level.iconCapture2D = "waypoint_capture_flag";
  level.iconTarget2D = "waypoint_captureneutral";
