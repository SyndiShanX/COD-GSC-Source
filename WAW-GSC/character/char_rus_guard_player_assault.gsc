 ...
 * Script: character\char_rus_guard_player_assault.gsc
*******************************************************/

main() {
  self setModel("char_rus_guard_player_body_assault");
  self.headModel = "char_rus_guard_player_head_assault";
...
precache() {
  precacheModel("char_rus_guard_player_body_assault");
  precacheModel("char_rus_guard_player_head_assault");
