 ...
 * Script: character\char_ger_hnrgd_player_rifle.gsc
*****************************************************/

main() {
  self setModel("char_ger_hnrgd_player_body_rifle");
  self.headModel = "char_ger_hnrgd_player_head_rifle";
...
precache() {
  precacheModel("char_ger_hnrgd_player_body_rifle");
  precacheModel("char_ger_hnrgd_player_head_rifle");
