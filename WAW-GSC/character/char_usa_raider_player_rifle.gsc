 ...
 * Script: character\char_usa_raider_player_rifle.gsc
******************************************************/

main() {
  self setModel("char_usa_raider_player_body_rifle");
  self.headModel = "char_usa_raider_player_head_rifle";
...
precache() {
  precacheModel("char_usa_raider_player_body_rifle");
  precacheModel("char_usa_raider_player_head_rifle");
