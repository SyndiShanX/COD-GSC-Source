 ...
 * Script: character\char_ger_honorguard2_flamethrower.gsc
***********************************************************/

main() {
  codescripts\character::setModelFromArray(xmodelalias\char_ger_honorgd2_bodyalias::main());
  self.headModel = codescripts\character::randomElement(xmodelalias\char_ger_honorgd_headalias::main());
...
precache() {
  ...
  codescripts\character::precacheModelArray(xmodelalias\char_ger_honorgd_headalias::main());
