 ...
 * Script: character\char_usa_marine_r_flame.gsc
*************************************************/
...
main() {
  ...
  self.hatModel = codescripts\character::randomElement(xmodelalias\char_usa_raider_helmalias::main());
...
precache() {
  ...
  codescripts\character::precacheModelArray(xmodelalias\char_usa_raider_helmalias::main());
