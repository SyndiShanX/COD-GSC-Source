 ...
 * Script: character\char_rus_guard_player_lmg.gsc
*****************************************************/

main() {
  self setModel("char_rus_guard_player_body_lmg");
  self.headModel = "char_rus_guard_player_head_lmg";
...
precache() {
  precacheModel("char_rus_guard_player_body_lmg");
  precacheModel("char_rus_guard_player_head_lmg");
