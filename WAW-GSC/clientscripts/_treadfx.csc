...
main(vehicletype) {
  ...
  switch (vehicletype) {
    ...
    case "buffalo":
      setallvehiclefx(vehicletype, "vehicle/treadfx/fx_treadfx_dust");
      setvehiclefx(vehicletype, "water", "vehicle/water/fx_wake_lvt_churn");
      setvehiclefx(vehicletype, "default", "vehicle/water/fx_wake_lvt_churn");
      setvehiclefx(vehicletype, "none", "vehicle/water/fx_wake_lvt_churn");
      break;
    case "amtank":
      setallvehiclefx(vehicletype, "vehicle/treadfx/fx_treadfx_dust");
      setvehiclefx(vehicletype, "water", "vehicle/water/fx_wake_lvt_churn");
