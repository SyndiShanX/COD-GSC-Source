 ...
 * Script: maps\createart\mak_art.gsc
*****************************************************/

main() {
  level.tweakfile = true;
  setdvar("scr_fog_exp_halfplane", "2600");
  setdvar("scr_fog_exp_halfheight", "2649");
  setdvar("scr_fog_nearplane", "2166");
  setdvar("scr_fog_red", "0.043");
  setdvar("scr_fog_green", "0.043");
  setdvar("scr_fog_blue", "0.043");
  setdvar("scr_fog_baseheight", "1320");
  ...
  level thread maps\_utility::set_all_players_visionset("mak", 0.1);
}
