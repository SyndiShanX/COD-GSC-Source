...
arcadeMode_checkpoint_restore() {
  ...
  for (i = 0; i < players.size; i++) {
    ...
    current_restorable_points = players[i] pGetIntDvar("current_restorable_points");
    previous_restorable_points = players[i] pGetIntDvar("previous_restorable_points");
