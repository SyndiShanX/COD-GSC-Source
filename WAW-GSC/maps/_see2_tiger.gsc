...
main(model, type, no_mantle) {
  build_template("see2_tiger", model, type);
  build_localinit(::init_local);
  build_deathmodel("vehicle_ger_tracked_king_tiger", "vehicle_ger_tracked_king_tiger_d_base");
  ...
  build_deathfx("vehicle/vfire/fx_vfire_ger_kingtiger", "tag_origin", undefined);
  build_deathfx("vehicle/vfire/fx_vsmoke_tiger_smolder", "tag_origin", undefined);
