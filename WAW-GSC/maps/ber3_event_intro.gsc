 ...
 * Script: maps\ber3_event_intro.gsc
*****************************************************/
...
event_intro_action() {
  ...
  thread e1_intro_friendlies_move();
  ...
  wait(5);
  level.comm anim_single_solo(level.comm, "intro_comm_1");
  wait(2);
  level.comm anim_single_solo(level.comm, "intro_comm_2");
  wait(1);
  level.comm anim_single_solo(level.comm, "intro_comm_3");
  wait(2);
  level.comm anim_single_solo(level.comm, "intro_comm_4");
...
e1_intro_friendlies_move() {
  ...
  level.sarge anim_single_solo(level.sarge, "intro_rez_09");
  level.sarge thread anim_single_solo(level.sarge, "intro_rez_10");
  if(!level.hit_first_move_trig) {
    getent("e1_friendlies_move1", "targetname") notify("trigger");
  }
  wait(5);
  level.sarge anim_single_solo(level.sarge, "intro_rez_07");
  level.sarge anim_single_solo(level.sarge, "intro_rez_08");
}
...
play_intro_on_player(anime, node, index, lerp_node) {
  ...
  self PlayerLinkTo(viewhands, "tag_player", 1, 20, 20, 20, 0);
...
e1_move_vehicles() {
  ...
  thread loop_fire_katyusha();
  if(!NumRemoteClients()) {
    thread overhead_planes();
  }
...
e1_alley() {
  ...
  thread amb_alley();
  thread e1_library_knock_bookshelf_over();
...
e1_entering_house_vo() {
  ...
  level.sarge anim_single_solo(level.sarge, "e1_rez_03");
  level.sarge anim_single_solo(level.sarge, "e1_rez_04");
}
...
rus_shreck_fired() {
  ...
  level.sargeanim_single_solo(level.sarge, "intro_rez_12");
  wait(1);
  level.sarge anim_single_solo(level.sarge, "e1_rez_01");
  wait(1);
  level.sarge anim_single_solo(level.sarge, "e1_rez_02");
}
...
e1_exiting_library_vo() {
  ...
  level.sarge anim_single_solo(level.sarge, "e1_rez_window");
  wait(1);
  level.sarge anim_single_solo(level.sarge, "e1_rez_06");
  level.sarge anim_single_solo(level.sarge, "e1_rez_07");
}
...
e1_library_knock_bookshelf_over() {
  ...
  level.sarge anim_single_solo(level.sarge, "e1_rez_05");
