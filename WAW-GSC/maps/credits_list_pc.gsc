 ...
 * Script: maps\credits_list_pc.gsc
**************************************/
...
init_treyarch_credits_pc() {
  ...
  add_space();
  add_heading(&"CREDITS_PROJECT_LEAD_PC");
  ...
  add_heading(&"CREDITS_KEN_SATO");
  add_space();
  add_heading(&"CREDITS_PRODUCTION_INTERN");
  add_heading(&"CREDITS_JAMES_CHIEN_CHEN");
  ...
  add_space();
  add_heading(&"CREDITS_LEAD_ENGINEER_PC");
  ...
  add_space();
  add_heading(&"CREDITS_ENGINEERS_PC_TEAM");
  ...
  add_heading(&"CREDITS_MICHAEL_BEACH");
  ...
  add_heading(&"CREDITS_NATHAN_FILLHARDT");
  ...
  add_space();
  add_heading(&"CREDITS_QA_PC_MOD_TOOLS");
  add_heading(&"CREDITS_TONY_KRAMER");
  add_heading(&"CREDITS_GAVIN_NIEBEL");
  add_heading(&"CREDITS_ALEX_ROMO");
