...
assign_random_run_anim() {
  ...
  index = randomint(100);
  if(index < 30) {
    self.drone_run_cycle = % unarmed_run_russian;
  } else if(index < 60) {
    self.drone_run_cycle = % run_n_gun_B;
  } else if(index < 70) {
    self.drone_run_cycle = % run_lowready_L;
  } else if(index < 80) {
    self.drone_run_cycle = % run_lowready_R;
  } else if(index < 90) {
    self.drone_run_cycle = % run_lowready_B;
  } else {
    self.drone_run_cycle = % unarmed_run_russian;
  }
}
