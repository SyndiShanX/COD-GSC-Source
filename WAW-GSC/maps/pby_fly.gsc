...
my_level_init() {
  ...
  level.player thread move_to_required_seat();
...
fake_blister_gunners() {
  ...
  self.gunner_right animscripts\shared::placeWeaponOn(self.gunner_right.weapon, "none");
  ...
  self.gunner_left animscripts\shared::placeWeaponOn(self.gunner_left.weapon, "none");
...
event4(jumpto) {
  ...
  for(i = 0; i < level.survivors_group_1.size; i++) {
    level.survivors_group_1[i] notify("swimming_notify");
  ...
  for(i = 0; i < level.survivors_group_2.size; i++) {
    level.survivors_group_2[i] notify("swimming_notify");
...
pby_crew_init(plane_name) {
  ...
  if(plane_name == "player_plane_a") {
    ...
    self.engineer animscripts\shared::placeWeaponOn(self.engineer.weapon, "none");
...
build_player_planes(type) {
  ...
  if(type == "pby_blackcat") {
    ...
    maps\_vehicle::build_deathfx(death_fx, "tag_engineer", death_sound, undefined, undefined, undefined, undefined);
  ...
  if(type == "fletcher_destroyer") {
    ...
    maps\_vehicle::build_localinit(func);
    maps\_vehicle::build_deathmodel(model, death_model);
    maps\_vehicle::build_deathfx(death_fx, "tag_origin", death_sound, undefined, undefined, undefined, undefined);
    maps\_vehicle::build_life(health, min_health, max_health);
    maps\_vehicle::build_treadfx(type);
    maps\_vehicle::build_team(team);
    load_fletcher_ship_names();
...
build_enemy_vehicles(type) {
  ...
  if(type != "jap_ptboat" && type != "jap_shinyo") {
    ...
    maps\_vehicle::build_deathfx(death_fx, "tag_engine_left", death_sound, undefined, undefined, undefined, undefined);
...
zero_get_damage_point() {
  ...
  ref_point[2] = self.origin + (AnglesToRight(self.angles) * -5);
...
event2_destruction_dialogue() {
  destruction_yay = [];
  destruction_yay[0] = "PBY1_IGD_003A_LAUG";
  destruction_yay[1] = "PBY1_IGD_004A_LAUG";
...
play_land_pby() {
  ...
  if(self == level.plane_a) {
    ...
    self thread pby_veh_idle("float_ai", 1.0);
  }
}
...
swap_model_for_fletcher(_targetname) {
