...
main(model, type) {
  build_template("panther", model, type);
  build_localinit(::init_local);
  build_deathmodel("vehicle_ger_tracked_panther", "vehicle_ger_tracked_panther_d");
  build_deathmodel("vehicle_ger_tracked_panther_winter", "vehicle_ger_tracked_panther_d");
  build_shoot_shock("tankblast");
  build_shoot_rumble("tank_fire");
  build_exhaust("vehicle/exhaust/fx_exhaust_panther");
  build_deathfx("vehicle/vexplosion/fx_vexplode_ger_panther", "tag_origin", "explo_metal_rand");
