...
setup_human_anims() {
  ...
  level.scr_anim["introIGC_victim"]["intro_igc"] = % ch_berlin2_intro_guy1;
  level.scr_anim["introIGC_guy2"]["intro_igc"] = % ch_berlin2_intro_guy2;
  level.scr_anim["introIGC_guy3"]["intro_igc"] = % ch_berlin2_intro_guy3;
  level.scr_anim["introIGC_guy4"]["intro_igc"] = % ch_berlin2_intro_guy4;
  ...
  addNotetrack_sound("introIGC_guy3", "fire", "intro_igc", "weap_tt33_fire");
  ...
  addNotetrack_sound("knees_execution_executioner", "shoot", "execute", "weap_kar98k_fire");
  addNotetrack_customFunction("knees_execution_executioner", "shoot", maps\ber2_event1::event1_knees_execution_gunshotFX, "execute");
  addNotetrack_sound("knees_execution_executioner", "shot_in_the_head", "execute", "bullet_large_flesh");
  addNotetrack_customFunction("knees_execution_executioner", "shot_in_the_head", maps\ber2_event1::event1_knees_execution_headshotFX, "execute");
  ...
  addNotetrack_customFunction("wounded_execution1_executioner", "fire", maps\ber2_event1::street_execution_gunshotFX, "execution_shot");
  addNotetrack_sound("wounded_execution1_executioner", "fire", "execution_shot", "weap_kar98k_fire");
  addNotetrack_sound("wounded_execution1_executioner", "head_shot", "execution_shot", "bullet_large_flesh");
  ...
  addNotetrack_customFunction("wounded_execution2_executioner", "fire", maps\ber2_event1::street_execution_gunshotFX, "execution_shot");
  addNotetrack_sound("wounded_execution2_executioner", "fire", "execution_shot", "weap_kar98k_fire");
  addNotetrack_sound("wounded_execution2_executioner", "head_shot", "execution_shot", "bullet_large_flesh");
  ...
  addNotetrack_customFunction("wounded_execution3_executioner", "fire", maps\ber2_event1::street_execution_gunshotFX, "execution_shot");
  addNotetrack_sound("wounded_execution3_executioner", "fire", "execution_shot", "weap_kar98k_fire");
  addNotetrack_sound("wounded_execution3_executioner", "head_shot", "execution_shot", "bullet_large_flesh");
