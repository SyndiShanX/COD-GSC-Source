...
init_treyarch_credits_ps3() {
  ...
  add_space();
  add_heading(&"CREDITS_LEAD_ENGINEER");
  ...
  add_heading(&"CREDITS_NATY_HOFFMAN");
...
init_activision_credits_ps3() {
  ...
  add_heading(&"CREDITS_KYLE_CAREY");
  add_heading(&"CREDITS_JASON_HARRIS");
  add_space();
  add_heading(&"CREDITS_TRG_PLATFORM_LEADS");
  add_heading(&"CREDITS_BRIAN_BENSI");
  add_heading(&"CREDITS_PAUL_CARRION");
  add_heading(&"CREDITS_TOMO_SHIKAMI");
  add_space();
  add_heading(&"CREDITS_TRG_TESTERS");
  add_heading(&"CREDITS_VIDAL_CANTU");
  add_heading(&"CREDITS_BRIAN_BAKER");
  add_heading(&"CREDITS_KEITH_KODAMA");
  add_heading(&"CREDITS_COLIN_KAWAKAMI");
  add_heading(&"CREDITS_SCOTT_BORAKOVE");
  add_heading(&"CREDITS_SCOTT_WINSLOW");
  add_heading(&"CREDITS_JOHN_MCCURRY");
  add_heading(&"CREDITS_KIRT_SANCHEZ");
  add_heading(&"CREDITS_MELVIN_ALLEN");
  add_heading(&"CREDITS_STEFAN_GOODREAU");
  add_heading(&"CREDITS_TAKUMA_KOKUBO");
  add_heading(&"CREDITS_ELIZABETH_HICKEY_MCCOY");
  add_heading(&"CREDITS_JENNIFER_GOODMAN");
