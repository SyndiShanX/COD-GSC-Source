...
plant_bomb_buttons() {
  ...
  if(level.xenon) {
    ...
    add_universal_button("plantbomb", "dpad_left");
    add_universal_button("plantbomb", "dpad_right");
    add_universal_button("plantbomb", "button_b");
    add_universal_button("plantbomb", "button_x");
    add_universal_button("plantbomb", "button_y");
  ...
  add_universal_button("plantbomb", "=");
  add_universal_button("plantbomb", "pgup");
  add_universal_button("plantbomb", "pgdn");
