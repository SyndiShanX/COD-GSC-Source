...
collision_test_point_in_sphere(
  point, sphere_origin, sphere_radius) {
...
collision_test_points_in_sphere(
  point_list_s, sphere_origin, sphere_radius) {
  assertex((sphere_radius > 0.001), "invalid sphere radius");
...
collision_test_point_in_cylinder(
  point, cylinder_base, cylinder_radius, cylinder_height, cylinder_height_unit_vector) {
...
collision_test_points_in_cylinder(
  point_list_s, cylinder_base, cylinder_radius, cylinder_height, cylinder_height_unit_vector) {
  assertex((cylinder_radius > 0.001) && (cylinder_height > 0.001), "invalid cylinder geometry");
  assertex(vector3d_is_normalized(cylinder_height_unit_vector), "cylinder height vector must be unit vector");

  collision_results_s = spawnStruct();
  collision_results_s.a = CollisionTestPointsInCylinder(
    point_list_s.a, cylinder_base, 0.0 + cylinder_radius, 0.0 + cylinder_height, cylinder_height_unit_vector);

  return collision_results_s;
}
collision_test_point_in_pill(
  point, cylinder_base, cylinder_radius, cylinder_height, cylinder_height_unit_vector, cylinder_radial_vector) {
...
collision_test_points_in_pill(
  point_list_s, cylinder_base, cylinder_radius, cylinder_height, cylinder_height_unit_vector, cylinder_radial_vector) {
...
collision_test_point_in_cone(
  point, cone_base, cone_base_radius, cone_height, cone_height_unit_vector, cone_radial_unit_vector) {
...
collision_test_points_in_cone(
  point_list_s, cone_base, cone_base_radius, cone_height, cone_height_unit_vector, cone_radial_unit_vector) {
  assertex((cone_base_radius > 0.001) && (cone_height > 0.001), "invalid cone geometry");
  assertex(vector3d_is_normalized(cone_height_unit_vector), "cone height vector must be unit vector");
  assertex(vector3d_is_normalized(cone_radial_unit_vector), "cone radial vector must be unit vector");
...
collision_test_point_in_box(
  point, box_origin, box_width, box_height, box_depth, forward, up) {
...
collision_test_points_in_box(
  point_list_s, box_origin, box_width, box_height, box_depth, forward, up) {
  assertex((box_width > 0.001) && (box_height > 0.001) && (box_depth > 0.001), "invalid box geometry");
...
draw_sphere(
  sphere_origin, sphere_radius, forward, up, rgb_color) {
...
draw_cylinder(
  cylinder_base, cylinder_radius, cylinder_height, forward, up, rgb_color) {
...
draw_box(
  centroid, dimensions, forward, up, rgb_color) {
...
draw_pill(
  pill_base, pill_radius, pill_height, forward, up, rgb_color) {
...
draw_cone(
  cone_base, cone_radius, cone_height, forward, up, rgb_color) {
...
generate_sphere_points_list(
  sphere_origin, radius, forward, up) {
  points = [];
...
generate_cylinder_points_list(
  cylinder_base, cylinder_radius, cylinder_height, forward, up) {
  points = [];
...
generate_pill_points_lists(
  pill_base, pill_radius, pill_height, forward, up) {
  points = [];
...
generate_cone_points_lists(
  cone_base, cone_radius, cone_height, forward, up) {
  points = [];
...
generate_box_points_lists(
  centroid, dimensions, forward, up) {
  points = [];
