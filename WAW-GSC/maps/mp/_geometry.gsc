...
collision_test_point_in_cylinder(
  point, cylinder_base, // base point of cylinder
  cylinder_radius, cylinder_height, cylinder_height_unit_vector) // direction &height of cylinder from cylinder_base
{
...
collision_test_points_in_cylinder(
  point_list_s, cylinder_base, // base point of cylinder
  cylinder_radius, cylinder_height, cylinder_height_unit_vector) // direction &height of cylinder from cylinder_base
{
...
collision_test_point_in_pill(
  point, cylinder_base, // base point of cylinder
  cylinder_radius, cylinder_height, cylinder_height_unit_vector, // direction of cylinder from cylinder_base
...
collision_test_point_in_cone(
  point, cone_base, // base point of cone
  cone_base_radius, cone_height, cone_height_unit_vector, // direction &height of cone from cone_base to the tip
...
collision_test_points_in_cone(
  point_list_s, cone_base, // base point of cone
  cone_base_radius, cone_height, cone_height_unit_vector, // direction &height of cone from cone_base to the tip
  cone_radial_unit_vector) // a radial vector (any unit vector orthogonal to the height vector - passed in for convenience, since scripting always has available)
{
...
collision_test_points_in_box(
  point_list_s, box_origin, // box centroid
  box_width, // x-dimension
  box_height, // y-dimension
  box_depth, // z-dimension
  forward, up) {
