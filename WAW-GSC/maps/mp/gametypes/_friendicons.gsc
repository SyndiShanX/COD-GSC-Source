...
init() {
  ...
  switch (game["allies"]) {
    case "marines":
      game["headicon_allies"] = "faction_128_american";
      break;
    case "russian":
      game["headicon_allies"] = "faction_128_soviet";
      break;
    default:
      game["headicon_allies"] = "faction_128_american";
      break;
  ...
  switch (game["axis"]) {
    case "japanese":
      game["headicon_axis"] = "faction_128_japan";
      break;
    case "german":
      game["headicon_axis"] = "faction_128_german";
      break;
    default:
      game["headicon_axis"] = "faction_128_japan";
      break;
