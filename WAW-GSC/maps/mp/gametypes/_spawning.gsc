...
_create_influencer(
  type, shape, forward, up, origin, score, score_curve
) {
  influencer = [];
...
_create_radiusaxis_influencer(
  type, shape, forward, up, origin, score, score_curve, radius, axis_length
) {
...
create_sphere_influencer(
  type, forward, up, origin, score, score_curve, radius
) {
...
create_cylinder_influencer(
  type, forward, up, origin, score, score_curve, radius, axis_length
) {
