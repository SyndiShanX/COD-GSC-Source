...
// calls a callback every time a player starts playing (spawns), // and another callback every time they stop (die / switch teams / disconnect).
// handles the annoying logic of players joining and leaving the game, // so that other scripts don't have to.
