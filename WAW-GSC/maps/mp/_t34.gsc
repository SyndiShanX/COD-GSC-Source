...
build_damage_states() {
  ...
  vehicle_name = "t34_mp";
  {
    ...
    level.vehicles_damage_treadfx[vehicle_name] = [];
    {
      ...
      level.vehicles_damage_states[vehicle_name][k_mild_damage_index].effect_array[0].damage_effect = loadFX("vehicle/vfire/fx_vdamage_rus_t34_mp01");
      ...
      level.vehicles_damage_states[vehicle_name][k_moderate_damage_index].effect_array[0].damage_effect = loadFX("vehicle/vfire/fx_vdamage_rus_t34_mp02");
      ...
      level.vehicles_damage_states[vehicle_name][k_severe_damage_index].effect_array[0].damage_effect = loadFX("vehicle/vfire/fx_vdamage_rus_t34_mp03");
