                ...
                fprintln(file, tab + "
                  fprintln(file, tab + "
                    ...
                    fprintln(file, ""); target = level.cam_shots[shot_names[i]].cam_target; fprintln(file, tab + "
                      ...
                      fprintln(file, tab + build_shot + "\"" + shot_names[i] + "\", " + "\"" + level.cam_shots[shot_names[i]].cam_track.type + "\", " + "\"" + level.cam_shots[shot_names[i]].cam_target.type + "\", track_array, target_array );"); fprintln(file, "");
                    }
                    fprintln(file, "}");
                  }
                  save_scenes(file) {
