...
anim_loader() {
  ...
  addNotetrack_customFunction("reznov", "fire", maps\see1_opening::opening_zeitzev_gunshotFX, "intro");
  addNotetrack_customFunction("reznov", "explosion", maps\see1_opening::opening_zeitzev_explosion, "intro");
  ...
  level.scr_anim["german"]["melee_combat_1"] = % ch_berlin1_E3vignette3_german;
  ...
  level.scr_anim["german"]["melee_combat_2"] = % ch_berlin1_E3vignette3_german;
  ...
  level.scr_anim["german"]["running_on_fire_1"] = % ch_peleliu1_outbunker_guy1;
  level.scr_anim["german"]["running_on_fire_2"] = % ch_peleliu1_outbunker_guy2;
  level.scr_anim["german"]["dazed_fire_run_1"] = % ch_dazed_b;
  level.scr_anim["german"]["dazed_fire_run_2"] = % ch_dazed_c;
  ...
  level.scr_sound["reznov"]["instinct"] = "See1_IGD_012A_REZN";
  level.scr_sound["reznov"]["left_or_right"] = "See1_IGD_013A_REZN";
