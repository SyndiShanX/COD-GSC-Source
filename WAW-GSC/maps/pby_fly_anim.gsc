...
anim_loader() {
  ...
  level.scr_anim["survivor"]["swim_far"][0] = % ch_pby_swim_freestyle_hi;
  level.scr_anim["survivor"]["swim_far"][1] = % ch_pby_swim_freestyle_hi;
  level.scr_anim["survivor"]["swim_far"][2] = % ch_pby_swim_freestyle_hi;
  level.scr_anim["survivor"]["swim_far"][3] = % ch_pby_swim_freestyle_hi;
  ...
  addNotetrack_dialogue("copilot", "co_pilot", "intro_vig", "Pby1_INT_103A_PLT1");
  addNotetrack_customFunction("copilot", "second_pilot", maps\pby_fly::second_pilot_reply_intro, "intro_vig");
  addNotetrack_dialogue("copilot", "co_pilot", "intro_vig", "Pby1_INT_005A_PLT1");

  level.scr_anim["radio_op"]["intro_vig"] = % ch_pby_intro_radio;
  addNotetrack_dialogue("radio_op", "radio_op", "intro_vig", "Pby1_INT_100A_RADO");
  addNotetrack_dialogue("radio_op", "radio_op", "intro_vig", "Pby1_INT_101A_RADO");
  addNotetrack_dialogue("radio_op", "radio_op", "intro_vig", "Pby1_INT_102A_RADO");
  addNoteTrack_customFunction("radio_op", "second_gunner", maps\pby_fly::second_gunner_reply_intro, "intro_vig");
  addNoteTrack_dialogue("radio_op", "radio_op", "intro_vig", "Pby1_INT_003A_RADO");
  addNoteTrack_dialogue("radio_op", "radio_op", "intro_vig", "Pby1_INT_004A_RADO");
...
dialogue_loader() {
  ...
  level.scr_sound["radio_op"]["landry_confirmed_harrington"] = "PBY1_IGD_062B_LAND";
  level.scr_sound["radio_op"]["landry_oh_hell"] = "PBY1_IGD_064A_LAND";
  level.scr_sound["radio_op"]["landry_captain_harrington_distress_call"] = "PBY1_IGD_065B_LAND";
  level.scr_sound["radio_op"]["landry_theyve_called_for_air_support"] = "PBY1_IGD_066A_LAND";
  level.scr_sound["radio_op"]["landry_atleast_one_infantry"] = "PBY1_IGD_406A_LAND";
  ...
  level.scr_sound["radio_op"]["landry_this_is_blackcat"] = "PBY1_IGD_132D_LAND";
