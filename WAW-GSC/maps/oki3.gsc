...
update_mortar_objectives() {
  ...
  if(isDefined(guys) && guys.size > 0) {
    ...
    switch (guys.size) {
      case 1:
        level.sarge do_dialogue("take_last");
        level.sarge thread last_mortar_nag();
        break;
      case 2:
        level.polonsky do_dialogue("second");
        level.polonsky do_dialogue("two_more");
        break;
      case 3:
        level.sarge do_dialogue("one_down");
        break;
      case 4:
        level.polonsky do_dialogue("first");
        level.sarge do_dialogue("clear_em");
        break;
    }
  } else {
    wait(randomfloat(1.5));
