 ...
 * Script: maps\mp\zombies\killstreaks\_zombie_sentry.gsc
**********************************************************/
...
init() {
  ...
  level.turretsettings["mg_turret"].timeout = 90.0;
...
tryusedisruptorturret(var_0, var_1) {
  if(maps\mp\zombies\_util::arekillstreaksdisabled()) {
    return 0;
  }

  return tryuseremotemgsentryturret(var_0, ["sentry_disruptor"]);
}
...
tryuseremoteturret(var_0, var_1, var_2, var_3) {
  ...
  if(var_3.size == 0) {
    var_3 = ["sentry_guardian", "sentry_rippable"];
  }
  ...
  if(isDefined(var_4)) {
    ...
    if(common_scripts\utility::array_contains(var_3, "sentry_disruptor")) {
      var_5 = "ss_use_disruptor";
    }

    thread maps\mp\zombies\_zombies_audio::playerkillstreakcratevo(var_5);
    level.turretsdeployed++;
    level.turretsinworld[var_4 getentitynumber()] = var_4;
    return 1;
  } else {
    return 0;
  }
...
setcarryingturret(var_0, var_1) {
  ...
  var_2 = maps\mp\_utility::getkillstreakweapon("zm_sentry");
  ...
  for(;;) {
    self waittill("translated_turret_input", var_4);
...
playergiveturrethead(var_0, var_1) {
  maps\mp\killstreaks\_killstreaks::givekillstreak("zm_ripped_turret", 0, 0, self, [var_0], var_1);

  if(!isDefined(self.pers["rippableSentry"])) {
    self.pers["rippableSentry"] = spawnStruct();
  }

  var_2 = maps\mp\killstreaks\_rippedturret::getammoforturretweapontype(var_0);
  maps\mp\killstreaks\_rippedturret::playerrecordrippableammo(var_2);

  if(!common_scripts\utility::is_player_gamepad_enabled()) {
    var_3 = var_1 + 1;
    var_4 = "streakUsed" + var_3;
    self notify(var_4);
    waittillframeend;
  }
...
setripoffturrethead(var_0, var_1) {
  self endon("death");
  self endon("disconnect");
  ...
  if(var_0.energyturret) {
    thread playergiveturrethead("turretheadenergy_mp", var_1);
  } else if(var_0.rocketturret) {
    thread playergiveturrethead("turretheadrocket_mp", var_1);
  } else if(var_0.disruptorturret) {
    thread maps\mp\killstreaks\_rippedturret::playergiveturrethead("turretheaddisruptor_mp");
  } else {
    thread playergiveturrethead("turretheadmg_mp", var_1);
  }
...
updateturretplacement(var_0) {
  ...
  for(;;) {
    var_2 = self canplayerplacesentry(1);
    var_0.origin = var_2["origin"];
    var_0.angles = var_2["angles"];
    var_3 = var_2["entity"];
    var_0.canbeplaced = self isonground() && var_2["result"] && (abs(var_0.origin[2] - self.origin[2]) < 10 && !var_0 istouchingwater());

    if(isDefined(var_3)) {
      if(maps\mp\zombies\_util::is_true(var_3.noturretplacement)) {
        var_0.canbeplaced = 0;
        var_0.placementlinkentity = undefined;
      } else {
        var_0.placementlinkentity = var_3;
      }
    } else {
      var_0.placementlinkentity = undefined;
    }
...
createturretforplayer(var_0, var_1, var_2, var_3) {
  ...
  var_5.canremotecontrol = 0;
  var_5.linegunignore = 1;
  ...
  if(var_5.rocketturret || var_5.energyturret || var_5.disruptorturret) {
    var_5 turretsetbarrelspinenabled(0);
  }

  var_5 setturretmodechangewait(1);
  var_5 turret_setinactive();
  var_5 setsentryowner(var_1);
  var_5 setturretminimapvisible(1, var_0);

  if(var_5.disruptorturret) {
    var_5 setleftarc(0);
    var_5 setrightarc(0);
  } else if(var_5.is360) {
    var_5 setleftarc(180);
    var_5 setrightarc(180);
  } else {
    var_5 setleftarc(80);
    var_5 setrightarc(80);
  }

  var_5 settoparc(50);
  var_5 setbottomarc(30);
  var_5 setdefaultdroppitch(-89.0);
...
turret_setactive() {
  ...
  if(!isDefined(self.aiclip) && isDefined(level.sentry_ai_clip)) {
    ...
    self.aiclip linktosynchronizedparent(self, "tag_origin", (0, 0, 0), (0, 0, 0));
  ...
  if(level.teambased) {
    ...
    var_1 = game["entity_headicon_allies"];
    ...
    game["entity_headicon_allies"] = var_1;
  } else {
...
turret_modifydamage(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(var_1) && (var_1 == "remote_energy_turret_mp" || var_1 == "sentry_minigun_mp" || var_1 == "killstreakmahem_mp")) {
    var_4 = -1;
  }
...
startusingremoteturret(var_0, var_1, var_2, var_3, var_4) {
  ...
  if(!var_4) {
    ...
    var_5 disableoffhandsecondaryweapons();
    ...
    if(var_6 != level.turretsettings[self.turrettype].laptopinfo) {
      ...
      var_5 enableoffhandsecondaryweapons();
      var_5 unlink();
      return 0;
    }
  }
  ...
  var_5 playerlinkweaponviewtodelta(self, "tag_player", 0, var_0, var_1, var_2, var_3, 0);
  var_5 playerlinkedsetviewznear(0);
  var_5 playerlinkedsetusebaseangleforviewclamp(1);
  var_5 remotecontrolturret(self);
...
stopusingremoteturret(var_0) {
  ...
  var_1 enableoffhandsecondaryweapons();
  thread sentry_attacktargets();
  ...
  if(var_1 maps\mp\_utility::isusingremote()) {
    ...
    var_1 remotecontrolturretoff(self);
...
player_shoulddisableremoteenter(var_0) {
  ...
  return var_0 turret_isstunned() || player_isusingkillstreak(var_0) || isDefined(self.underwater) && self.underwater || self.using_remote_turret || var_1 == "none" || self istouching(var_0.ownertrigger) || self islinked() && !self.using_remote_turret || isDefined(self.empgrenaded) && self.empgrenaded;
}
...
playercanuseturret(var_0) {
  ...
  if(isDefined(var_0.ownertrigger) && self istouching(var_0.ownertrigger)) {
    return 0;
  }
...
player_shouldclearturretpickuphints(var_0) {
  var_1 = self getcurrentweapon();
  return var_0 turret_isstunned() || player_isusingkillstreak(var_0) || isDefined(self.underwater) && self.underwater || self.using_remote_turret || var_1 == "none" || !self istouching(var_0.ownertrigger) || !maps\mp\_utility::isreallyalive(self) || !self isonground() || isDefined(var_0.carriedby);
}
  ...
  for(;;) {
    ...
    if(maps\mp\_utility::isreallyalive(self) && self istouching(var_0.ownertrigger) && !isDefined(var_0.carriedby) && self isonground()) {
      if(self useButtonPressed()) {
        ...
        var_2 = maps\mp\zombies\killstreaks\_zombie_killstreaks::getslotnumber(self);
        ...
        var_0 setmode(level.turretsettings[var_0.turrettype].sentrymodeoff);
        var_0 sentry_stopattackingtargets();
        thread setripoffturrethead(var_0, var_2);
        var_0 turret_clearpickuphints();
        var_0.pickupent delete();
        var_0.ownertrigger delete();
        return;
...
turret_timeout() {
  ...
  thread turret_blinkheadiconbeforedeath(var_0);
...
playerownsanotherturret() {
  foreach(var_1 in level.turretsinworld) {
...
turret_handledeath() {
  ...
  turret_deathsounds(var_0, var_2);
  ...
  if(isDefined(var_3)) {
    stopusingremoteturret();
    var_3.using_remote_turret = 0;
    var_3.turret = undefined;

    if(!var_3 playerownsanotherturret()) {
      var_3 playerremovenotifycommands();
    }

    if(var_3 getcurrentweapon() == "none") {
      var_4 = var_3 common_scripts\utility::getlastweapon();

      if(isDefined(var_3.underwater) && var_3.underwater) {
        var_4 = var_3 maps\mp\_utility::get_water_weapon();
      }
  ...
  if(!isDefined(self.quick_death) || !self.quick_death) {
    ...
    for(var_5 = 8; var_5 > 0; var_5 = var_5 - 0.4) {
...
turret_firerocket(var_0) {
  ...
  if(isDefined(level.ishorde) && level.ishorde) {
    ...
    var_6 = isDefined(var_5) && issentient(var_5) && !isalliedsentient(self.owner, var_5);
  }
  ...
  if(!var_0) {
    ...
    foreach(var_10 in level.players) {
      if(var_10 != self.owner) {
        playfxontagforclients(common_scripts\utility::getfx("sentry_rocket_muzzleflash_wv"), self, "tag_flash", var_10);
      }
    }
  } else {
...
turret_hordeshootdronesandturrets() {
  ...
  for(;;) {
    ...
    if(isDefined(var_7)) {
      self settargetentity(var_7, var_0);
...
turret_blinkheadiconbeforedeath(var_0) {
  var_1 = 8;
  var_2 = var_0 - var_1;
...
translateturretinput(var_0) {
  self endon("end_translate_turret_input");

  for(;;) {
    self waittill(var_0);
    self notify("translated_turret_input", var_0);
  }
}
...
sentry_disruptor() {
  ...
  for(;;) {
    ...
    foreach(var_4 in var_2) {
      ...
      if(!turretdisruptorcanhurtzombie(var_4, var_0, var_1)) {
        continue;
      }
      if(common_scripts\utility::array_contains(self.radiationlist, var_4)) {
        continue;
      }
      self.radiationlist = common_scripts\utility::array_add(self.radiationlist, var_4);
      thread turretdisruptorhurtzombie(var_4);
    }
...
turretdisruptorcanhurtzombie(var_0, var_1, var_2) {
...
turretdisruptorhurtzombie(var_0) {
  self endon("death");
  var_1 = 0.2;
  var_2 = 16;
  var_3 = gettime();
  ...
  while(var_5) {
    ...
    var_7 = anglesToForward(self gettagangles("tag_flash"));
    ...
    if(self.stunned) {
      ...
      var_5 = turretdisruptorcanhurtzombie(var_0, var_6, var_7);
      continue;
    }

    if(gettime() >= var_3) {
      var_3 = gettime() + var_1 * 1000;
      var_0 maps\mp\zombies\_zombies::addbuff("disruptorBuff", var_0 getdisruptorbuff(self.owner));
    }

    var_8 = var_0 common_scripts\utility::waittill_notify_or_timeout_return("death", 0.05);
...
getdisruptorbuff(var_0) {
  var_1 = maps\mp\zombies\_zombies::getbuff("disruptorBuff");

  if(!isDefined(var_1)) {
    var_1 = spawndisruptorbuff();
  }
...
spawndisruptorbuff() {
  ...
  var_1 = 0.4;
  var_2 = spawnStruct();
  var_2.buffupdate = ::updatedisruptorbuff;
  var_2.buffremove = ::removedisruptorbuff;
  var_2.lifespan = 0.2;
  var_2.damageperstep = var_0 * maps\mp\zombies\_zombies::getbufftimestep();
  var_2.speedmultiplier = var_1;
  self notify("speed_debuffs_changed");
  return var_2;
}

updatedisruptorbuff(var_0) {
  var_1 = var_0.player;
  ...
  self dodamage(var_0.damageperstep, self.origin, var_1, undefined, "MOD_TRIGGER_HURT", "remote_energy_turret_mp", "none");
