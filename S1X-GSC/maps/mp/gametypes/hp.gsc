...
getspawnpoint() {
  ...
  if(level.usestartspawns && level.ingraceperiod) {
    var_1 = maps\mp\gametypes\_spawnlogic::getspawnpointarray("mp_hp_spawn_" + var_0 + "_start");
    ...
    var_2 = maps\mp\gametypes\_spawnscoring::getspawnpoint_hardpoint(var_1);
  }
  ...
  if(isDefined(self.lastcaptureteam) && self.lastcaptureteam != var_1) {
    for(var_7 = 0; var_7 < level.players.size; var_7++) {
      ...
      if(var_0.pers["team"] == var_1) {
        if(var_0.lastkilltime + 500 > gettime()) {
