 ...
 * Script: wz\wz_open_skyscrapers.gsc
***********************************************/
...
#include scripts\wz\wz_open_skyscrapers_ai_zones;
#include scripts\wz\wz_open_skyscrapers_death_circle;
...
#include scripts\wz_common\wz_blast_doors;
#include scripts\wz_common\wz_buoy_stash;
#include scripts\wz_common\wz_dynents;
...
function_5ef515a6(item_spawn_groups) {
  n_total = 0;
...
function_317da0a9(item_spawn_groups, group, point, var_9b62e326, var_cc2e4f94, n_z, n_dist) {
  b_failed = 0;
  b_close = 0;
  v_color = (0, 1, 0);
  var_7cb887a8 = [];
...
private event_handler[event_9673dc9a] function_f9b68fd7(eventstruct) {
...
function_2e72f24d(tracepoint, weapon) {
...
function_c21a7f52(tracepoint, weapon, color, mp) {
  if(!isDefined(mp)) {
    mp = 1;
  }
