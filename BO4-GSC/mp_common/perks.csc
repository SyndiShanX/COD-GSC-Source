...
on_gameplay_started(local_client_num) {
...
function_92725cf9(local_client_num) {
...
watch_perks_change(local_client_num) {
...
monitor_tracker_perk(local_client_num) {
...
killtrackerfx_track(local_client_num, handle) {
...
killtrackerfx_on_death(local_client_num) {
  self endon(#"disconnect");
...
gettrackerfxposition(local_client_num) {
...
function_3edf2cf8(dist_sq, var_73491815, var_47435b6f) {
...
monitor_detectnearbyenemies(local_client_num) {
  self endon(#"death");
...
function_c90f8547(var_8bced359, var_832d6681, delay_time) {
  self endon(#"death");
...
function_c2b5b27c(local_client_num) {
  self endon(#"death");
  self.var_7122b2ff = 1;
