 ...
 * Script: mp_common\gametypes\ct_ruin_tutorial.gsc
****************************************************/
...
function_53ef16ed(var_b6acc0c9, var_5563d1e7, var_8b1294a8, var_20d50849, var_4dc9e63c, var_6ff1bf88, str_objective) {
  level endon(#"combattraining_logic_finished");
...
function_22720795(var_3ee0e184) {
  level.var_7b46025 = struct::get_array(var_3ee0e184, "targetname");
  level.var_47cd3e56 = 0;
  level thread ct_bots::activate_bots(level.var_7b46025.size, #"axis");
}

function_e43f2419(var_3ee0e184) {
  level.var_7b46025 = struct::get_array(var_3ee0e184, "targetname");
  level.var_47cd3e56 = 0;
  level thread ct_bots::activate_bots(level.var_7b46025.size, #"axis");
}
...
function_4150d677(n_goal_radius, b_ignoreall, b_keyline, var_4d39247d) {
