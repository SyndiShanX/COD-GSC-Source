 ...
 * Script: mp_common\gametypes\ct_prophet_tutorial.gsc
*******************************************************/
...
#include scripts\killstreaks\mp\dart;
...
#include scripts\weapons\mp\seeker_mine;
...
function_a5ead78e(_hash) {
  level.var_8fce01d = 0;
}

function_8b563364(var_8f2a3132 = 0) {
  level endon(#"combattraining_logic_finished");
...
function_50999af5(n_timeout = 30) {
  level endon(#"combattraining_logic_finished");
...
function_5b350d94(var_43d50d89 = 1, var_463b195d = 1) {
  level notify(#"hash_358a76ad1437866d");
  waitframe(1);
...
function_cc50d201(var_14a220fc = 4, var_e01def33 = 1) {
...
function_e5964493(e_seeker_mine) {
  level endon(#"combattraining_logic_finished");
...
function_2ff5e6da(e_target, var_847fac28 = 2) {
  level endon(#"combattraining_logic_finished");
...
function_17786807(n_spread = 256) {
  return (randomfloatrange(n_spread * -1, n_spread), randomfloatrange(n_spread * -1, n_spread), randomfloatrange(n_spread * -1, n_spread));
}

function_b274b737(einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, vdamageorigin, psoffsettime, damagefromunderneath, modelindex, partname, vsurfacenormal) {
  e_player = ct_utils::get_player();
...
function_2c254de9(var_6e9e34cc = 2) {
  wait var_6e9e34cc;
...
function_25bdd976(var_ccd0840c = 1, var_a4339f5b = 1, str_nag, var_23cfda = 0) {
