 ...
 * Script: mp_common\gametypes\ct_battery_tutorial.gsc
*******************************************************/
...
#include scripts\core_common\vehicles\amws;
...
init() {
  ...
  level.var_ae120f18 = array(#"vox_tvoi_tutor_batt_slide_2_0", #"vox_tvoi_tutor_batt_slide_2_1");
}
...
function_eef19056() {
  ...
  level thread ct_vo::function_14b08e49(array(#"vox_tvoi_tutor_batt_slide_2_nag"), "stop_goto_nag");
...
function_c8eefe3b(var_c361acde) {
  level endon(#"combattraining_logic_finished");
...
function_2aab1550(einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, vdamageorigin, psoffsettime, damagefromunderneath, modelindex, partname, vsurfacenormal) {
...
grenade_room_watcher(vol_room, waypoint) {
...
function_45f567b0(s_loc, waypoint) {
  self endon(#"death");
  level endon(#"boat_enemies_dead");
...
function_76f5d2dc(str_s_target) {
