 ...
 * Script: mp_common\gametypes\ct_ai.gsc
***********************************************/
...
spawn_zombie(v_spawn_pos, b_keyline, var_8ac47d78) {
...
spawn_blight_father(v_spawn_pos, b_keyline, var_8ac47d78, var_158efaf3) {
...
function_1495c8c(v_origin, v_angles, anim_name) {
  self endon(#"death");
...
function_f02d23b2(var_f6a3e268) {
...
function_45a6adc0(einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime, boneindex, modelindex) {
...
spawn_warlord(v_spawn_pos, v_spawn_angles) {
...
function_9ca5c5fc(v_loc, str_team, n_radius) {
  var_4ed86107 = [];
...
function_9313dd47(s_loc, n_radius) {
  self endon(#"death");
...
function_8e0db9e6(s_loc, var_feefa8d9, var_ecf349de, var_3fc5d539) {
  self endon(#"death");
