 ...
 * Script: mp_common\gametypes\ct_battery.gsc
***********************************************/
...
#include scripts\mp_common\gametypes\ct_battery_tutorial;
...
spawn_attack_wave(n_count, var_2c6e8cfe = 0, a_parms, var_1b783b8b = 0) {
  var_d3dc6155 = [];
  var_c580022d = [];
...
function_5d585945(hardpointtype) {
  self notify(#"evasive");
  self.evasive = 1;
...
function_430510ec(str_path_start, key = "targetname") {
...
function_40c7d949(n_range = 2000) {
...
function_6b4ab31d(_hash) {
  helicopter::heli_reset();
  self notify(#"stop hover");
}

function_64dd0b39(var_fec7078b) {
  e_player = ct_utils::get_player();
...
private function_4e049216(einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, vdamageorigin, psoffsettime, damagefromunderneath, modelindex, partname, vsurfacenormal) {
...
function_4293d37b(einflictor, eattacker, idamage, smeansofdeath, weapon, vdir, shitloc, psoffsettime) {
...
function_4c8f915a(str_targetname, str_team) {
...
private function_1f04fda(einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, vdamageorigin, psoffsettime, damagefromunderneath, modelindex, partname, vsurfacenormal) {
  if(isDefined(einflictor) && einflictor == self) {
    return 0;
  }
...
function_52d196f2(n_difficulty = 2) {
  e_player = self;
