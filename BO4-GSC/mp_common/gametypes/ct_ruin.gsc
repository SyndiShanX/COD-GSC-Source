 ...
 * Script: mp_common\gametypes\ct_ruin.gsc
***********************************************/
...
function_73c1ecd4(predictedspawn) {
  if(level.ctdifficulty == 0) {
...
function_39002b98(einflictor, attacker, idamage, smeansofdeath, weapon, vdir, shitloc, psoffsettime, deathanimduration) {
  if(level.ctdifficulty == 0) {
...
function_7d779cf7(gamedifficulty) {
...
function_d999dbe2(var_8e2567b1) {
