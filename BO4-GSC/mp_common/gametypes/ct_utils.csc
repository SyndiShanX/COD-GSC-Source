 ...
 * Script: mp_common\gametypes\ct_utils.csc
***********************************************/
...
vision_pulse(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  self endon(#"death");
...
screen_blur(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  self endon(#"death");
...
area_arrows(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
...
function_3827fca4(localclientnum) {
...
collisionbox_render(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  if(newval == oldval) {
    return;
  }
...
highlight_sphere(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
...
highlight_sphere_normal(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  if(newval) {
...
highlight_ring(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  e_player = function_5c10bd79(localclientnum);
...
postfx_hitzone(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  e_player = function_5c10bd79(localclientnum);
