 ...
 * Script: mp_common\gametypes\ct_bots.gsc
***********************************************/
...
function_fa0d912f(var_7b4ae7d1) {
...
function_aa870283(n_delay, var_4406a529 = 0, var_8c5f03d7 = 1, var_dd200d99 = 1) {
  if(n_delay) {
    wait n_delay;
  } else {
    waitframe(1);
...
function_26d45f32(var_4406a529 = 0, var_8c5f03d7 = 1, var_dd200d99 = 1) {
  if(!var_4406a529) {
...
function_35e77034(weapon, var_dd200d99) {
...
activate_bot(str_team, str_targetname, var_216e25ba = 0, var_29b433bd) {
...
function_cc9c6a13(current_state) {
...
function_b8eff92a(desired_state) {
  if(isai(self)) {
    self.ignoreall = 0;
  }
...
function_911f9e8f(var_dfb36d05, n_threat = 0.5) {
...
function_a64b7003(var_bf0bb02d = 0, var_61e27031) {
...
function_c2cfffdd(nd_guard, var_2fd67dea = 0, var_1d1ab17 = 0) {
...
function_82569431(einflictor, attacker, idamage, smeansofdeath, weapon, vdir, shitloc, psoffsettime, deathanimduration) {
  if(isDefined(self.nd_guard)) {
    self.nd_guard.e_occupant = undefined;
    self.nd_guard = undefined;
    self.var_9a79d89d = undefined;
...
function_7e8fcca2(nd_spawn, n_state = 4) {
  entities = function_66ced330();
  var_e8d6f89 = 0;
...
function_59458966(nd_spawn, n_state) {
  self endon(#"death");
