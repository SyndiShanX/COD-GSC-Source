 ...
 * Script: mp_common\gametypes\ct_utils.gsc
***********************************************/
...
#include scripts\autogenerated\luielems\mp\ct_progressbar_status;
#include scripts\autogenerated\luielems\mp\ct_shared_button_prompt;
#include scripts\autogenerated\luielems\mp\ct_shared_desc;
#include scripts\autogenerated\luielems\mp\ct_shared_ingame_hint;
#include scripts\autogenerated\luielems\mp\ct_shared_ingame_objective;
#include scripts\autogenerated\luielems\mp\ct_shared_objcounter;
#include scripts\autogenerated\luielems\mp\ct_shared_warning;
#include scripts\autogenerated\luielems\mp\ct_timer_mod_ticks;
...
_objective_zapper_tall(statename) {
  level.ct_shared_desc ct_shared_desc::set_state(self, statename);
}

function_281d799(b_persistent = 1) {
...
function_853efded(var_5b811c5d) {
  level.ct_shared_ingame_objective ct_shared_ingame_objective::open(self, 1);
...
hud_message(var_4909a70, str_message, n_x_pos, n_y_pos, n_time, n_size = 1) {
...
function_78469779(ispredictedspawn) {
...
function_ee4639dd(var_bbda5e06, var_bbe3381f = 1, var_6158669b) {
  self endon(#"death");
...
function_d471f8fa(var_75998dae, var_96829af4 = undefined, var_bbe3381f = 0, var_6158669b) {
  if(isDefined(level.var_5a623458) && level.var_5a623458) {
    return;
  }
...
timer_mod_ticks(var_75998dae, var_35214535 = 1, var_6158669b) {
  if(var_75998dae > 0) {
...
function_c9ba88ba(str_state, var_dd646e5, n_count = 1) {
  for(i = 0; i < n_count; i++) {
    self function_b0b54bd5(str_state, var_dd646e5);
  }
}

function_b0b54bd5(var_92c8bf38, var_2cb0d724) {
  level endon(#"show_aar");
  self function_a6ee046();
  s_data = {
    #str_state: var_92c8bf38, #var_dd646e5: var_2cb0d724
  };
...
function_2914a896(str_state, var_dd646e5, var_e8ee1cd1 = 0) {
...
function_bfa522d1(b_looping, n_cycles = 3) {
...
function_4adf5b5a(var_58d4bf93) {
  for(i = 0; i < 10; i++) {
...
function_c94d8a8a(var_58d4bf93) {
...
function_bd3fa3f4(str_team, str_objective) {
...
function_7b70bd74(lui_elem, n_xpos, n_ypos, n_width, n_height) {
...
function_5ccd53d5(var_9e2a4c29) {
  self endon(#"death");
...
function_1ca79c02(str_volume, var_7a037bc3, n_max_value, var_c088c2dd) {
...
function_b42ce622(var_4b3a6521) {
...
function_7b72086e(hash_state, var_61cb4be0, n_period) {
...
create_waypoint(var_1ce6b997, v_origin, v_normal, str_team, var_e9633e99 = game.defenders, var_9c8d914, var_9c57bbcf) {
...
update_glow(var_c386a7d2, var_a97eacb3, var_9c8d914) {
  self endon(#"death");
...
function_289b4b9f(str_message, var_520123e0, var_8e90b9b5, var_f031f5a, var_95690319) {
...
function_77111f4b(target, settings) {
  self endon(#"death");
...
function_7a21ac57(n_type = 0, var_61ca8276, var_9d99d28, n_silver, n_gold, var_c7165970) {
  ...
  if(!isDefined(level.var_b613db22[str_map][str_character][var_d0c7d280])) {
    level.var_b613db22[str_map][str_character][var_d0c7d280] = {
      #var_d2b50dd9: var_61ca8276, #var_d775ff6a: n_type
    };
  }
...
function_d7db338d(n_score, n_type) {}

function_661bb2ee(n_time) {
  str_map = function_f0149e2f();
  str_character = level.var_820c5561;
  var_d0c7d280 = level.var_d0c7d280;
...
function_9d4708dc(var_52487c6d, str_map = function_f0149e2f(), str_character = level.var_820c5561, var_d0c7d280 = level.var_d0c7d280) {
  ...
  switch (var_d775ff6a) {
    case 0:
      if(var_3bb92d22 > var_52487c6d) {
        ...
        return {
          #var_4a4d7e27: 1, #var_d2b50dd9: var_52487c6d
        };
      } else {
        return {
          #var_4a4d7e27: 0, #var_d2b50dd9: var_52487c6d
        };
      }
...
function_329f9ba6(str_hint, n_duration, str_color = "grey", n_priority = 0, var_f1840b4a = 0, var_64ef1697, var_2ee3d6f5) {
  level endon(#"combattraining_logic_finished");
...
function_415cd308(n_duration, str_color, n_priority = 0, var_f1840b4a = 0, var_64ef1697 = "BUTTON_A", var_2ee3d6f5) {
  level endon(#"combattraining_logic_finished");
...
function_80540e80(var_64ef1697 = "BUTTON_A", var_2ee3d6f5 = 0.5) {
  level endon(#"combattraining_logic_finished");
...
function_61c3d59c(str_text, a_str_vo, var_5b811c5d, var_23301438 = 0) {
  level endon(#"combattraining_logic_finished");
...
magic_explosion(v_loc, str_weapontype = # "frag_grenade") {
...
is_within(v_origin, var_22068a81) {
  v_check = self.origin;
...
function_6d7f4ec6(var_cfc2603c) {
...
tutorial_goto(loc, str_waypoint = # "hash_1f1deaa6bff12db8", var_a0b3876d = 64, var_55ce88ff, var_3b37a003 = "tutorial_goto_done", var_8fe28ab0 = 0) {
...
function_2cc00dba(var_14fe1698) {
...
function_b733ae0d(b_on = 1, var_b5d05353 = 0, var_967db01d = 0) {
...
function_5b59f3b7(var_9a79d89d, var_5ab7c19c, var_bab91f2, var_4c7240f1 = 1, var_b1fd680c = 0, var_b4bf5d7d = 1) {
  self.var_ef59b90 = 4;
...
function_b05a86bc(str_team, n_radius, var_b1fd680c) {
  a_bots = ct_bots::function_fbe3dcbb();
...
function_32e977f(e_target, n_range) {
  self endon(#"death");
...
function_b5e31ad(e_target, n_min, n_max) {
  self endon(#"death");
  e_target endon(#"death");
...
function_e768df25(v_target, var_368c41b6) {
  e_player = self;
...
function_d25bd3c9(v_target, var_368c41b6, var_7f71c337) {
...
function_84181d75(b_freeze, v_loc, var_b5023654) {
...
function_88c18aba(_hash) {
  self unlink();
}

function_93c86846(a_str_vo, var_8a30c2bf, var_aa62f5bf, arena_defend_wasp_vignette_path_teleport_, var_cf0cbd73, var_9c8d914) {
  if(isDefined(a_str_vo)) {
...
function_e0d36a2c(str_vo, var_8a30c2bf, var_aa62f5bf, arena_defend_wasp_vignette_path_teleport_, var_cf0cbd73, var_9c8d914) {
  e_player = get_player();
...
get_trace(old_position, new_position) {
  size = 10;
  height = size * 2;
...
function_b7f367ed(old_position, new_position) {
...
function_7a739ee3(var_c82bc161, str_spawns = "mp_t8_spawn_point") {
  e_player = get_player();
...
function_61d750d4(loc, v_angles) {
  if(isstring(loc)) {
    s_loc = struct::get(loc, "targetname");
    v_origin = s_loc.origin;
...
function_96dda082(n_time_min = 2, n_time_max = 4) {
  self endon(#"death");
...
function_df8f80c4(e_target, n_wait_min = 0.1, n_wait_max = 0.5) {
...
function_49e0c5bc(var_a9a68bf = 0, b_corpses, b_play_fx = 1) {
...
player_collisionbox(var_96065dae, var_8d3fbac4 = undefined, n_size = 0) {
...
function_2daf1983(str_weapon, b_immediate = 1, n_delay) {
  wait n_delay;
  give_weapon(str_weapon, b_immediate);
}

give_weapon(the_weapon, b_immediate = 1, var_738b1542 = 0) {
...
function_e9ab1003(var_5bdda9b3) {
  e_player = get_player();
...
function_79957328(var_46fa8f90, var_5bdda9b3) {
...
function_8f04870f(var_6988e659 = undefined) {
  e_player = get_player();
...
function_15e01238(s_loc, n_max_dist, var_9c8d914, var_c9af632d, var_4df4f851) {
...
function_71a30a6e(var_e3ab9b64, backstabsidlestart = 1) {
  e_player = get_player();
...
highlight_sphere_on(v_origin, v_normal, var_9c8d914) {
...
highlight_ring(b_on = 1, v_origin, v_normal) {
  if(b_on) {
...
function_eeb4cff6(var_9d4f2d1, var_f11dba7e, var_260aad25, a_str_vo) {
...
function_401b3a93(var_260aad25, var_264ee2f5) {
  level.var_7b46025 = struct::get_array(var_260aad25, "targetname");
  level.var_47cd3e56 = 0;
...
surround_spawn(n_spawn_count, n_dist_min = 800, n_dist_max = 1600, var_65c9209b = 1, var_e01def33 = 4, var_5e5dc085, str_targetname = "bot_surround_spawn") {
...
function_c655d719(n_dist_min = 800, n_dist_max = 1600, var_5e5dc085) {
...
function_b061b486(str_id, str_key = "targetname", b_enable = 1) {
...
function_51d33352(str_id, str_key = "targetname") {
  function_b061b486(str_id, str_key, 0);
}

function_d00e0eeb(n_left = 0) {
...
kill_bots(str_team, var_4e15a2e9) {
...
function_c008bffa(var_f58e81b8) {
  self endon(#"death");
  wait 1;
...
function_d3bbbf8a(var_996160bc, zmb_vessel_pickup_skull_, var_9c8d914, var_c9269d20, var_6e135d55) {
...
function_9ab507a9(var_76b15be0, var_8e92afbd, var_da2d40e, var_e380ff6c, var_40347291 = 1, b_disconnectpaths = 0) {
  ...
  level.a_s_colbounds[var_76b15be0] = {
    #targetname: var_76b15be0, #a_effects: [], #var_5d90b13a: var_8e92afbd, #var_a90a2d1: var_da2d40e, #var_e380ff6c: var_e380ff6c, #var_40347291: var_40347291, #b_disconnectpaths: b_disconnectpaths
  };
...
colbounds_off(str_id, var_c57d5cfe = 0) {
...
function_6432dd9(nd_current, n_speed, n_accel) {
  self endon(#"death");
...
function_31a67d65(e_target, var_6ae0852b) {
  self endon(#"death");
  e_target endon(#"death");
...
function_be7bc7b2(var_eb8df0c3, var_a8d88c43, var_2d222ffc, var_d69032e9) {
  b_success = 0;
  n_start_time = gettime() / 1000;
...
function_6434a9f(n_start_scale = 0.01, var_a8de9b22 = 1, n_time = 1, n_steps = 5) {
...
kill_all_bots(n_delay, var_b1a0d102 = 0, b_play_fx = 1) {
  if(isDefined(n_delay)) {
    wait n_delay;
  }
...
function_e44c5b8e(str_killstreak, var_88d2d0b2 = 10, var_baf3556b = 0) {
...
function_5149c890(b_on = 1, n_wait = 0.1) {
  self endon(#"death");
...
function_9a283f84(s_loc, str_model_name) {
...
function_f3b02850(s_loc, var_9806a7cc) {
...
function_9a4e412e(s_loc, str_notify) {
...
function_c444a920(s_loc, var_9c8d914) {
...
function_9d1fc273(e_obj, onusefunc, str_objective, var_484df237) {
...
function_51c89e00(var_2f3964e3, str_team) {
  a_bots = ct_bots::function_fbe3dcbb();
