 ...
 * Script: mp_common\gametypes\ct_torque_tutorial.gsc
******************************************************/
...
function_222141a5(var_58d9f1c6 = 1) {
  level endon(#"combattraining_logic_finished");
...
function_74d4f033(var_f3aa6dfe) {
  self endon(#"death");
  var_7dd5b77 = [];
...
function_f22f1511(var_f3aa6dfe) {
  level endon(#"combattraining_logic_finished");
  var_304623ae = [];
...
function_b2e3d55a(str_notify, var_6202642d = #"axis", var_64179396 = 1) {
...
function_fde0ed2f(a_n_counts, spawnpts, n_rest = 0.25, b_randomize = 0, var_e9cd12e3 = 0) {
...
function_3dd59a93(str_targetname) {
  level endon(#"combattraining_logic_finished");
...
_enemy_setup(var_1640cf17, b_ignoreall = 1, var_bab91f2 = 32, var_cde63359 = 0) {
  level endon(#"combattraining_logic_finished");
...
function_331992ca(e_enemy, s_loc) {
  level endon(#"combattraining_logic_finished");
  e_enemy waittill(#"death");
  s_loc.e_occupant = undefined;
}

function_a20738a(var_fd986e47 = 0) {
  level endon(#"combattraining_logic_finished");
...
_enemy_razorwire_flounder(e_inflictor) {
...
function_e1e35c8b(var_f3aa6dfe, a_s_loc, n_range = 32) {
  level endon(#"combattraining_logic_finished");
  var_b43f496 = 0;
  var_45006933 = [];
...
function_44776cd(var_f3aa6dfe, s_loc, n_range = 24) {
  level endon(#"combattraining_logic_finished");
...
function_9326b2b2(var_f3aa6dfe, s_loc, n_range = 20) {
  n_range_sq = n_range * n_range;
  v_pos = s_loc.origin;
  v_fwd = anglesToForward(s_loc.angles);
  var_6c267b3 = vectornormalize((v_fwd[0], v_fwd[1], 0));
...
function_1689d4b(einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime, iboneindex, imodelindex) {
...
function_1df46b8d(n_percentage = 0.25) {
  self endon(#"death");
...
function_60d7db7f(var_de22a8df, var_f3aa6dfe) {
...
function_6e4b6ccc(var_f3aa6dfe) {
  if(isDefined(self.var_bb1b065f)) {
...
function_907568bb(str_volume = "trig_torque_tut_finale_area") {
  level notify(#"hash_1496d0fbb526a24a");
  waitframe(1);
...
function_a9832377(_hash) {
  level clientfield::set("area_arrows", 0);
}

overridedamage_player(e_inflictor, e_attacker, n_damage, n_dflags, str_means_of_death, weapon, v_point, v_dir, str_hit_loc, n_psoffsettime, var_8b69d5cf) {
  return int(n_damage / 5);
}

function_24e6adf3(e_inflictor, e_attacker, n_damage, n_dflags, str_means_of_death, weapon, v_point, v_dir, str_hit_loc, n_psoffsettime, var_8b69d5cf) {
