...
sd_getteamkillpenalty(einflictor, attacker, smeansofdeath, weapon) {
...
sd_getteamkillscore(einflictor, attacker, smeansofdeath, weapon) {
...
function_941367ab(team, player, result) {
  waypoint = self.waypoint;
...
function_46031620(team, player, result) {
  waypoint = self.waypoint;
  objective_clearallusing(waypoint.objectiveid);
...
bombdefused(defusedobject, player) {
...
figureoutgametypefriendlyfire(victim) {
