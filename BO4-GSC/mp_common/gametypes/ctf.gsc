 ...
 * Script: mp_common\gametypes\ctf.gsc
***********************************************/
...
function_18d7960(flagteam, player) {
...
ctf_getteamkillpenalty(einflictor, attacker, smeansofdeath, weapon) {
...
ctf_getteamkillscore(einflictor, attacker, smeansofdeath, weapon) {
