 ...
 * Script: mp_common\gametypes\ct_firebreak_tutorial.gsc
*********************************************************/
...
function_95da118b(str_weapon = # "ar_accurate_t8") {
  level endon(#"combattraining_logic_finished");
  self endon(#"death");
  waitframe(1);
...
function_3b6be7bd(_hash) {
  self.var_7ca576f0 = 0;
}

function_b3977527(n_count, b_keyline = 1, var_3aad7172 = 0, var_2960f558 = 1, str_targetname, var_216e25ba = 0) {
  level endon(#"combattraining_logic_finished");
...
function_1ba28169(str_objective, a_str_vo, var_f54b52b3, var_8eb9348c = 5) {
...
function_9f1d8637(var_f54b52b3) {
...
function_2969ccb4(var_43d50d89 = 1, var_463b195d = 1) {
  level notify(#"hash_6822294416b67f95");
  waitframe(1);
...
function_7d10f455(a_str_vo, var_c782ff9c) {
  e_player = ct_utils::get_player();
...
function_5a0f5bcb(str_tut, var_6bf7e923) {
