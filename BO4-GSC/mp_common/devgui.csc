...
create_mp_contracts_devgui(localclientnum) {
...
add_blackjack_contract_set_count(localclientnum, root, contract_count) {
...
add_contract_scheduler_daily_duration(localclientnum, root, label, daily_duration) {
  next_cmd = "<dev string:x81>";
