...
select_character(characterindex, forceselection, var_8a239568) {
...
function_9f408cf7(oldval, newval) {
  player = self;
...
function_c5394b83(starttime, seconds) {
