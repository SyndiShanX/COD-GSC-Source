...
function_127fb8f3(supplypod, attackingplayer) {
...
function_bff5c062(supplypod, attackingplayer) {
...
function_29de6f1f(weapon, meansofdeath = undefined) {
...
supplypod_spawned(watcher, owner) {
  self endon(#"death");
...
playcommanderaudio(soundbank, team) {
...
private function_5761966a(supplypod) {
  player = self;
...
private function_3c4843e3(supplypod, timetoadd) {
...
function_8d362deb(einflictor, attacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime, iboneindex, imodelindex) {
...
private function_8c8fb7b5(player) {}

private function_a143899c(player, waittime) {}

private function_a1434496(team, player, result) {
...
function_1f8cd247(origin, angles, player) {
...
function_452147b1(weapon, weaponindex) {
  player = self;
  level endon(#"game_ended");
