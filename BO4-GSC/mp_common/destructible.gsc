 ...
 * Script: mp_common\destructible.gsc
***********************************************/
...
event_callback(destructible_event, attacker, weapon, piece_index, point, dir, mod) {
  explosion_radius = 0;
...
car_explosion(attacker, physics_explosion) {
...
car_fire_think(attacker) {
  self endon(#"death");
  wait randomintrange(7, 10);
  self thread car_explosion(attacker);
}

event_handler[destructible] codecallback_destructibleevent(eventstruct) {
