 ...
 * Script: mp_common\scoreevents.gsc
***********************************************/
...
function_4013aee1(status_effect, var_3bc85d80) {
...
get_equipped_hero_ability(ability_name) {
...
killedheavyweaponenemy(attacker, victim, weapon, victim_weapon, victim_gadget_power) {
...
function_8fe4629e(killcount, weapon) {
...
is_weapon_valid(meansofdeath, weapon, weaponclass, killstreak) {
  valid_weapon = 0;
...
updatemultikills(weapon, weaponclass, killstreak, victim) {
...
specialiststatabilityusage(usagesinglegame, multitrackperlife) {
  self endon(#"disconnect");
...
function_c01cb128(entity, sensor_darts) {
...
function_c28e2c05(entity_origin, sensor_darts, var_e13a103a) {
  if(!var_e13a103a) {
...
function_3932ffa2(sensor_darts) {
  foreach(sensor in sensor_darts) {
    if(!isDefined(sensor)) {
      continue;
    }
...
function_43ee1b3d(attacker, victim, attackerweapon) {
