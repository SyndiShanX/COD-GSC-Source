...
function_37175e73(var_fee74908) {
...
function_48b8fc19(localclientnum) {
...
function_c17fe536(localclientnum, clientdata, networkid) {
...
function_839d4c20(localclientnum, clientdata, networkid) {
...
function_61f5d33a(localclientnum, clientdata, networkid) {
  model = function_839d4c20(localclientnum, clientdata, networkid);
...
function_237888bb(localclientnum) {
...
function_3bd99d2f(localclientnum, clientdata, vehicle, clear = 0) {
...
_draw(localclientnum, draworigin) {
  self endon(#"shutdown");
...
function_78a9fd5f(point) {
  ...
  if(!isstruct(point) && isDefined(point.type == #"scriptmover") && isDefined(point.itementry.dropmodel) && point getentitynumber() < 1024) {
    if(isDefined(point.itementry.weapon) && point.itementry.weapon.name == #"waterballoon") {
      var_af7d7388 = array(#"wpn_t8_wz_water_balloon_red_world", #"wpn_t8_wz_water_balloon_blue_world", #"wpn_t8_wz_water_balloon_green_world", #"wpn_t8_wz_water_balloon_yellow_world", #"wpn_t8_wz_water_balloon_orange_world", #"wpn_t8_wz_water_balloon_purple_world");
...
function_8cf40a8c(localclientnum) {
  return getcamposbylocalclientnum(localclientnum);
}

function_9e4552fe(var_fee74908) {
  level thread function_37175e73(var_fee74908);
}

function_9160538(localclientnum, eventtype, eventdata, var_c5a66313, var_567004a8) {
  waitframe(1);
...
function_60386766(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  level flagsys::wait_till(#"item_world_initialized");
...
function_4e9220ab(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  if(newval) {
    waitframe(1);
...
function_e2e7ee77(localclientnum) {
...
_on_localclient_connect(localclientnum) {
  function_952d97dc(localclientnum);
...
_set_weapon(localclientnum, item) {
...
function_e082e650(localclientnum, item, newmodel, scale) {
...
function_96fa1c6d(localclientnum) {
  clientdata = function_a7e98a1a(localclientnum);
...
function_c7e5c26(localclientnum) {
  clientdata = function_a7e98a1a(localclientnum);
...
function_34418003(localclientnum, eyepos, angles) {
  clientdata = function_a7e98a1a(localclientnum);
...
function_5cbe24ea(&dest, &source, &order) {
  items = [];
...
function_b21002cb(localclientnum, objid, obj, objstate) {
...
function_c3f5f99b(localclientnum, objid, obj) {
...
function_b0af857f(localclientnum) {
  self endon(#"death");
  clientdata = function_a7e98a1a(localclientnum);
...
function_83e328e1(var_78ddf4e2, newitems) {
