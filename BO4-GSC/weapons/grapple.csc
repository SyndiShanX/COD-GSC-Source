...
function_664d0a50(localclientnum) {
...
grapple_light_watch_end(localclientnum, handle, name) {
  player = self;
...
function_2297363d(localclientnum) {
...
function_bbd7fc60(var_428d0be2) {
