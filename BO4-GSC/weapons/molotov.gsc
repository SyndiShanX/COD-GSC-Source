...
function_31f342a2(origin, var_9c7e3678) {
  if(!isDefined(level.var_a88ac760)) {
    return false;
  }
...
function_42b9fdbe(weapon, loc, normal, duration, team) {
  fxnormal = normal;
...
function_9464e4ad(owner, position, killcament, normal, weapon, customsettings, radius_multiplier, var_e76400c0, wallnormal, var_cbaaea69, damageendtime) {
  level endon(#"game_ended");
  radius = customsettings.var_6193a41b * radius_multiplier;
  height = customsettings.var_cbd86f3e;
  trigger_radius_position = position - (0, 0, height);
