 ...
 * Script: weapons\proximity_grenade.gsc
***********************************************/
...
creategadgetproximitygrenadewatcher(watcher) {
  watcher.watchforfire = 1;
  watcher.hackable = 1;
  watcher.hackertoolradius = level.equipmenthackertoolradius;
  watcher.hackertooltimems = level.equipmenthackertooltimems;
...
proximitygrenadedamageplayer(eattacker, einflictor, killcament, weapon, meansofdeath, damage, proximitychain) {
...
chainplayer(eattacker, killcament, weapon, meansofdeath, damage, proximitychain, player, distancesq) {
  waittime = 0.25;
...
tesla_play_arc_fx(target, waittime) {
