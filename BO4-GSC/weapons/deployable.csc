...
register_deployable(weapon, var_7ec218c6) {
  if(weapon.name == "#none") {
    return;
  }
...
function_c1ee2dce(player, localclientnum, weapon) {
...
function_35d1c69f(localclientnum, player, weapon) {
...
group_mega_round_end_abcd_talking(localclientnum = 0) {
