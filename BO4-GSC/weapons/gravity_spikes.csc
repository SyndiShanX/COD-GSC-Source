 ...
 * Script: weapons\gravity_spikes.csc
***********************************************/
...
getideallocationforfx(startpos, fxindex, fxcount, defaultdistance, rotation) {
...
randomizelocation(startpos, max_x_offset, max_y_offset) {
...
do_gravity_spike_fx_circle(localclientnum, owner, center, radius, count) {
  segment = 360 / count;
  up = (0, 0, 1);
  randomization = 40;
  sphere_size = 5;
