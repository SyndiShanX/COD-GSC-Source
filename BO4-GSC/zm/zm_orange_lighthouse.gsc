 ...
 * Script: zm\zm_orange_lighthouse.gsc
***********************************************/
...
trigger_trap_explosion(v_pos, e_activator) {
...
function_576ecbe6(v_pos) {
  e_tag = util::spawn_model("tag_origin", v_pos, (0, 0, 0));
  wait 5;
  e_tag delete();
}

function_27304b98(var_a5a067c5, var_a75e9b3b) {
