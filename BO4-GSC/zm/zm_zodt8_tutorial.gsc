...
private function_86ff864(e_player, player_has_weapon) {
  return false;
}
...
private function_40bfbff0(entity) {
  entity setgoal(entity.origin);
}

private show_hint_text(text, show_for_time = 3.2, font_scale = 1.25, ypos = 220) {
