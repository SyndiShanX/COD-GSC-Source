 ...
 * Script: zm\zm_mansion_storage.csc
***********************************************/
...
start_billiards(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  if(newval) {
    billiards_setup();
  }
}
...
function_954a27a2(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  if(newval) {
