...
function_24d3ec02(str_script_noteworthy, var_a61b5e1 = 0) {
  self endon(#"death");
...
function_7273c33d(s_loc, var_2c30f72f = 1) {
  self endon(#"death");
...
function_d89227a0(ent_name, message) {
...
function_37aed203(var_f1404f73, b_use_spawn_fx = 1) {
