...
function_5d904e7d(var_dcc985c4, var_a6c68ee8 = 1, var_cc91eb05 = 0) {
  n_item = randomint(3);
  level.var_dcc985c4 = var_dcc985c4;
...
private function_1bf68b9d(v_position, v_angles) {
  if(!isDefined(v_position)) {
    return;
  }
...
private function_5bc6515c(s_brutus_spawn) {
...
private function_1d0df68c(var_b631c17a) {
...
private function_a7c869fb(n_wait) {
  self endon(#"death");
...
private function_68a43add(str_zone, var_c34665fc) {
...
private function_65c7c787(e_brutus) {
...
private function_dbe333cb(n_time) {
  self endon(#"death");
...
private function_a98a79b(e_activator) {
...
private registers_helm_of_the_king_support(a_ents) {
  e_brutus = a_ents[# "brutus"];
...
private function_30bab0b0(b_taken = 1) {
