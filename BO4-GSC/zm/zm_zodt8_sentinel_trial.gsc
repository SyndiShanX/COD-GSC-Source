 ...
 * Script: zm\zm_zodt8_sentinel_trial.gsc
***********************************************/
...
function_e3163424(var_5ea5c94d) {
...
function_c4bd3743(var_5ea5c94d, ended_early) {
...
function_fbba6b79(var_5ea5c94d) {
...
function_eb027eca(var_5ea5c94d, ended_early) {
...
function_558b4527(var_5ea5c94d) {
...
function_34f97128(var_5ea5c94d, ended_early) {
  if(!var_5ea5c94d) {
    hidemiscmodels("bridge_controls");
...
function_bdf27083(str_script_noteworthy) {
...
function_23153807(s_telegraph, var_3d89d732 = undefined, var_d0b3106f = undefined) {
...
private function_6361c85(str_script_noteworthy) {
...
function_39b9ecb(s_telegraph, var_397be8a2) {
...
function_73a32bb4(var_5ea5c94d) {
...
function_ba182aaa(var_5ea5c94d, ended_early) {
...
function_b6db8da0(s_struct, ai_killed) {
...
function_6ae57d29(s_struct, ai_killed) {
  level thread function_3965c201(s_struct);
}

function_3965c201(s_struct) {
...
function_4d356dc0(s_struct, s_portal) {
...
function_65880cbe(a_s_valid_respawn_points) {
  return level.var_bbef5923;
}

function_8a0679e4(s_struct, s_portal) {
...
function_36df874b(s_struct, ai_killed) {
...
function_800855df(s_struct, ai_killed) {}

function_a5946754(a_spawnpoints, n_spawns, n_max_active = 24, var_4309d73b, var_e7c7eaab, n_spawn_delay = 0.1, var_70f72ba4 = 0.1) {
  var_cbdd8fe5 = 0;
...
function_71d1696b(var_6d630352, var_c0958d26) {
...
function_8046369(a_spawnpoints) {
...
function_9c6147b1(n_max) {
  while(getaiteamarray(level.zombie_team).size > int(n_max)) {
    wait 0.1;
  }
}

function_1b44fb7f(var_5ea5c94d) {
...
function_92cd9426(var_5ea5c94d, ended_early) {
  if(!var_5ea5c94d) {
...
function_443b1ad2(var_5ea5c94d) {
...
function_542127b2(var_5ea5c94d, ended_early) {
  if(!var_5ea5c94d) {
...
function_7711ae4b(a_glyphs, mdl_light) {
...
function_f016aaf8(a_glyphs, mdl_light) {
  level endon(#"hash_77f76266b597a1f7");
...
function_50b3a576(str_planet_name, n_number) {
...
function_13fa48c4(s_stoker_spawn, n_delay) {
  wait n_delay;
  ai = zm_ai_stoker::spawn_single(1, s_stoker_spawn);
...
function_ce045bbf(a_spawnpoints, str_type) {
  var_fded0f90 = [];
...
function_89b95aa1(a_zones, str_planet_name) {
  wait 10;
...
function_996d1a4c(a_glyphs, mdl_light) {
...
function_370a9e5(mdl_planet, v_start, v_end, v_forward) {
...
function_647da52c(str_planet_name) {
...
function_8ec70b18(var_5ea5c94d) {
...
function_71a8bce1(var_5ea5c94d, ended_early) {
  if(ended_early) {
...
function_a68ae7b5(s_blocker, n_health) {
...
get_spawnpoints(var_78837396 = 1, var_7d9a5da1) {
  a_s_spawnpoints = [];
...
function_204d58b0(s_spawn_point, n_round_number) {
...
function_5b7a1511(var_5ea5c94d) {
...
function_98cdd988(var_5ea5c94d, ended_early) {
...
function_50128c10(var_79727c11, a_icebergs, var_c53a4cdc) {
  wait 5;
...
function_2f2651ce(s_setup, s_pushback, player) {
...
function_f4b715c1(var_5ea5c94d) {
...
function_594ebc75(var_5ea5c94d) {
  level flag::clear("spawn_zombies");
  level flag::set(#"pause_round_timeout");
...
warzonecompassnorth(var_5ea5c94d, ended_early) {}
...
function_6099877a(n_radius = 96, str_endon) {
...
function_43a16eb7(var_e6d63e1c, s_loc) {
  zm_audio::sndvoxoverride(1);
...
function_77a859a8(var_82ea43f2 = 0, var_a8d0b313 = 1, b_hide_body = 1) {
  foreach(ai in getaiteamarray(level.zombie_team)) {
...
function_63a0f09e(b_success = 1, var_d1a2823e = 1) {
  a_players = util::get_active_players();
...
function_d4b31d36(v_origin, var_39acfdda, str_category = #"m_quest") {
...
function_53802e89(str_vox, v_loc, var_c30ae85a, var_3d981e0b) {
