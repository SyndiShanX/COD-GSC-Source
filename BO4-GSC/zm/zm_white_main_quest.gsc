 ...
 * Script: zm\zm_white_main_quest.gsc
***********************************************/
...
#include scripts\zm\zm_white_timecard_clocks;
...
function_d7662e16(var_ee7af3b, var_6f927674) {
  self.is_rotating = 1;
...
setclock(n_hour, n_minute, is_fast) {
  var_97ee4db9 = 0;
  var_f797d4af = 0;
...
zm_white_main_quest_step1_setup(var_5ea5c94d) {
  if(!var_5ea5c94d) {
...
zm_white_main_quest_step1_cleanup(var_5ea5c94d, ended_early) {
...
zm_white_main_quest_step2_setup(var_5ea5c94d) {
  if(!var_5ea5c94d) {
    level function_cae70bde();
    level flag::wait_till(#"mq_computer_activated");
    level zm_hms_util::pause_zombies(1, 0);
...
zm_white_main_quest_step2_cleanup(var_5ea5c94d, ended_early) {
  if(var_5ea5c94d || ended_early) {
...
zm_white_main_quest_step3_setup(var_5ea5c94d) {
  if(!var_5ea5c94d) {
    level function_cae70bde();
    level flag::wait_till(#"mq_computer_activated");
    level zm_hms_util::pause_zombies(1, 0);
...
zm_white_main_quest_step3_cleanup(var_5ea5c94d, ended_early) {
  if(var_5ea5c94d || ended_early) {
...
zm_white_main_quest_step4_setup(var_5ea5c94d) {
  if(!var_5ea5c94d) {
    level function_cae70bde();
    level flag::wait_till(#"mq_computer_activated");
    level zm_hms_util::pause_zombies(1, 0);
...
zm_white_main_quest_step4_cleanup(var_5ea5c94d, ended_early) {
  if(var_5ea5c94d || ended_early) {
...
zm_white_main_quest_step5_setup(var_5ea5c94d) {
  if(!var_5ea5c94d) {
    level function_cae70bde();
    level flag::wait_till(#"mq_computer_activated");
    level zm_hms_util::pause_zombies(1, 0);
...
zm_white_main_quest_step5_cleanup(var_5ea5c94d, ended_early) {
  if(var_5ea5c94d || ended_early) {
...
zm_white_main_quest_step6_setup(var_5ea5c94d) {
  if(!var_5ea5c94d) {
    level function_cae70bde();
    level flag::wait_till(#"mq_computer_activated");
    level zm_hms_util::pause_zombies(1, 0);
...
zm_white_main_quest_step6_cleanup(var_5ea5c94d, ended_early) {
  if(var_5ea5c94d || ended_early) {
...
zm_white_main_quest_step7_setup(var_5ea5c94d) {
  if(!var_5ea5c94d) {
    level function_cae70bde();
    level flag::wait_till(#"mq_computer_activated");
    level zm_hms_util::function_3c173d37();
...
zm_white_main_quest_step7_cleanup(var_5ea5c94d, ended_early) {
  if(var_5ea5c94d || ended_early) {
...
zm_white_main_quest_step8_setup(var_5ea5c94d) {
  if(!var_5ea5c94d) {
...
zm_white_main_quest_step8_cleanup(var_5ea5c94d, ended_early) {
  if(var_5ea5c94d || ended_early) {
...
zm_white_main_quest_step9_setup(var_5ea5c94d) {
  if(!var_5ea5c94d) {
...
zm_white_main_quest_step9_cleanup(var_5ea5c94d, ended_early) {
  if(var_5ea5c94d || ended_early) {
...
zm_white_mq_crawler_setup(var_5ea5c94d) {
  if(!var_5ea5c94d) {
...
zm_white_mq_crawler_cleanup(var_5ea5c94d, ended_early) {
  if(var_5ea5c94d || ended_early) {
    level flag::set(#"crawler_step_complete");
  }
...
function_a0351130(var_e3d37a1d) {
...
function_8ef535c2(str_zone_name) {
...
zm_white_mq_canister_setup(var_5ea5c94d) {
  if(!var_5ea5c94d) {
...
zm_white_mq_canister_cleanup(var_5ea5c94d, ended_early) {
  if(var_5ea5c94d || ended_early) {
    level flag::set(#"hash_6a79293e26344b0f");
  }
}
...
zm_white_mq_circuit_setup(var_5ea5c94d) {
  if(!var_5ea5c94d) {
...
_that_peek(var_5ea5c94d, ended_early) {
  if(var_5ea5c94d || ended_early) {
    level flag::set(#"circuit_step_complete");
  }
...
function_c03c3007(e_player) {
  self sethintstring(#"zombie/need_power");
  return true;
}

function_713b8131(e_player) {
  while(true) {
    waitframe(1);
  }
}
...
zm_white_mq_server_setup(var_5ea5c94d) {
  if(!var_5ea5c94d) {
...
zm_white_mq_server_cleanup(var_5ea5c94d, ended_early) {
  if(var_5ea5c94d || ended_early) {
    level flag::set(#"hash_2f57ff102a73c0b5");
  }
}
...
zm_white_mq_mannequin_setup(var_5ea5c94d) {
  if(!var_5ea5c94d) {
...
zm_white_mq_mannequin_cleanup(var_5ea5c94d, ended_early) {
  e_mccain = getent("atlas_ct", "targetname");
...
function_ea6f0b51(event, mod, hit_location, zombie_team, damage_weapon) {
  return false;
}

function_3ee2b1c3(event, mod, hit_location, zombie_team, damage_weapon) {
  return 10;
}
...
function_c23eba78(n_difficulty) {
  level.var_2b5d31d8 = 0;
...
function_57dda4d1(str_identifier) {
...
function_9840ec4a(str_type, e_who) {
  if(str_type == #"left") {
    level zm_hms_util::function_3c173d37();
...
function_553ec923(var_5ea5c94d) {
  if(!var_5ea5c94d) {
    level zm_hms_util::function_3c173d37();
...
function_3ce3c949() {
  level endon(#"orb_path_completed", #"hash_3972ecbdd044ba98", #"orb_reached_destination");
  var_7b286c7b = 0;
  n_speed = 6;
...
function_b7fa863b(var_5ea5c94d, ended_early) {
  if(var_5ea5c94d || ended_early) {
...
function_63e4838b(should_hide = 1) {
  level.mq_computer.var_60b0e76f = should_hide;
}

function_bf3779ea(e_player) {
...
function_5f6e4e8f(var_cb672d5f, var_8208d890) {
  var_64460018 = self.scene_ents[#"whi_server"];
