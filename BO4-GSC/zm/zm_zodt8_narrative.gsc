 ...
 * Script: zm\zm_zodt8_narrative.gsc
***********************************************/
...
function_aba430c2(s_unitrigger) {
  while(isDefined(self)) {
...
function_63c3fd24(var_314c1b5a) {
  while(true) {
    s_result = self waittill(#"trigger_activated");
    e_player = s_result.e_who;
...
function_7c9ab1ea(t_flag, var_f96aafd8) {
  while(true) {
...
function_e1a452f5(e_homunculus, var_21bb918c, var_c8279d50) {
...
function_c867ac0a(e_homunculus, var_21bb918c, var_c8279d50) {
...
function_dc92e2d4(a_angles, var_21bb918c, var_c8279d50, str_letter) {
  var_21bb918c unlink();
  var_c8279d50 unlink();
...
function_f64a749c(var_6fc696ed, var_8940de41, str_letter) {
