...
function_841236e4(w_weapon, var_b6bc44ed) {
  ...
  if(w_weapon.name === #"ww_hand_h_uncharged" || w_weapon.name === #"ww_hand_h" || w_weapon.name === #"ww_hand_h_upgraded") {
    self notify(#"light_energy_dropped", {
      #b_success: 0
    });
    var_caa76b60 = #"light";
...
function_10139c6(e_player) {
  ...
  if(!(isDefined(e_player.var_10c283af) && e_player.var_10c283af)) {
    ...
    e_player thread zm_vo::vo_say(#"vox_acheron_drink_orac_0", 0, 1, 9999, 1, 1);
  }
...
function_ab234072(var_cd1844a3) {
...
function_2eeb736b(var_c34665fc) {
  zm_unitrigger::unregister_unitrigger(self.s_unitrigger);
}

function_8f228be7(var_cd1844a3) {
  self.var_11dc678a = 0;
...
_shit_bhb_invalid_area(e_player, player_has_weapon) {
...
light_energy_carry(e_player) {
  ...
  while(true) {
    if(e_player ismeleeing() && distance(e_player.origin, self.var_a1327d58.origin) < 150 && e_player getcurrentweapon() === self.w_uncharged_hand) {
      e_player notify(#"light_energy_dropped", {
        #b_success: 1
      });
