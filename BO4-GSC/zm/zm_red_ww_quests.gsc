 ...
 * Script: zm\zm_red_ww_quests.gsc
***********************************************/

#include script_8dca41f2d7c91bc;
#include scripts\core_common\ai\archetype_catalyst;
...
#include scripts\zm\perk\zm_perk_mod_quick_revive;
...
function_fa621ff5(e_destructible) {
  self endon(#"disconnect");
...
function_aaaf780e(var_87658653, t_damage) {
  self endon(#"disconnect");
...
on_player_disconnect() {
  self notify(#"hash_7fe6ca08732b8a1d", {
    #b_success: 0
  });
  self notify(#"hash_4d89e2bb8e3d1eb3", {
    #b_success: 0
  });
  self notify(#"hash_2026d806e71dfad5", {
    #b_success: 0
  });
...
function_841236e4(w_weapon, var_b6bc44ed) {
...
function_887b7e4b(str_hand, var_b6bc44ed) {
...
on_player_damage(einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime) {
...
function_7bd1fb22(str_hand, e_player) {
  s_quest = level.var_d225ea18[str_hand];
  var_a1327d58 = s_quest.var_a1327d58;
...
private function_f7cee57d(s_quest) {
  self endon(#"disconnect");
...
private function_2db4d0dc(e_player) {
...
function_6b3c32b6(str_hand, e_player) {
  level endon(#"end_game");
...
private function_6d15a744(e_player) {
...
function_a975461d(var_d4a055df = 0) {
...
private function_ab234072(var_cd1844a3) {
...
private function_2eeb736b(var_c34665fc) {
  zm_unitrigger::unregister_unitrigger(self.s_unitrigger);
}

private function_8f228be7(var_cd1844a3) {
  self.var_11dc678a = 0;
...
function_e6e126b4(e_target, w_weapon) {
  s_quest = level.var_d225ea18[#"death"];
...
function_cdbadaff(var_a06d0f4f, var_2d8a1db5, n_time) {
  starttime = gettime();
...
function_5d783702(n_stop) {
  n_base = pow(2, n_stop);
  var_2fcfdce8 = n_base * 1600;
  return var_2fcfdce8;
}

function_adc2d252(e_player) {
  var_b37a7d1e = e_player function_996fee51();
  s_quest = level.var_d225ea18[#"death"];
...
private function_af78c3b3(b_disable = 1) {
  if(b_disable) {
...
private _shit_bhb_invalid_area(e_player, player_has_weapon) {
...
function_b962a4a6(var_542837e6) {
  level endon(#"game_ended");
  ...
  while(true) {
    ...
    level notify(#"mirror_hit", {
      #t_damage: self.script_noteworthy
    });
  }
}

function_4771e682(var_542837e6) {
  level endon(#"game_ended");
  var_542837e6 endon(#"hash_2b524e51784167cc");
  mdl_mirror = getent(var_542837e6.target, "targetname");
...
function_2a290bb7(var_542837e6, v_position, e_player) {
  do {
...
function_79a8a785(var_542837e6, e_player) {
...
light_energy_carry(e_player) {
  ...
  while(true) {
    if(e_player ismeleeing() && distance(e_player.origin, self.var_a1327d58.origin) < 150 && e_player getcurrentweapon() === self.w_uncharged_hand) {
      e_player notify(#"hash_3f0faacb0cc98a9", {
        #b_success: 1
      });
...
function_fbcb1210(s_params) {
  self notify(#"hash_3f0faacb0cc98a9", {
    #b_success: 0
  });
}

function_9aa74e4(var_542837e6, e_player, str_clientfield) {
  e_player endon(#"disconnect");
...
function_35d91981(e_player) {
  self.var_29aa427b.origin = (self.var_29aa427b.origin[0], self.var_29aa427b.origin[1], self.var_29aa427b.origin[2] - 3000);
  e_player waittill(#"hash_4d89e2bb8e3d1eb3", #"disconnect");
  self.var_29aa427b.origin = (self.var_29aa427b.origin[0], self.var_29aa427b.origin[1], self.var_29aa427b.origin[2] + 3000);
}

function_419874c2(e_player) {}
...
function_d5dcd2b0(e_player) {
  level.var_3804f7bd = &function_42afccbf;
  level.var_21343c57 = 1;
}

function_42afccbf(e_target, weapon = level.weaponnone, n_damage) {
...
function_479cad97(e_target, registerzmb_pod_play_preferred) {
...
function_6d466962(var_8290a028, s_original, mdl_feather, e_player = undefined) {
...
function_381519d9(var_8290a028, mdl_feather, n_max_height, s_original) {
...
function_759736f(var_8290a028, mdl_feather) {
...
private function_bbee7f7b() {
  level flag::wait_till("all_players_spawned");
  self clientfield::set("" + #"hash_3c85334429a971b4", 1);
}

function_ca04e287(e_player) {}

function_68080923(var_52666e80, mdl_tree) {
  level endon(#"end_game");
  level flag::wait_till("all_players_spawned");
...
function_88edd220(e_player, w_charged) {
...
function_8ad28be8(e_player) {
  ...
  e_player notify(#"hash_4d89e2bb8e3d1eb3", {
    #b_success: b_success
  });
}

function_cb939976(s_params) {
...
private function_4aea06b0(b_disable = 1) {
  if(b_disable) {
...
function_4de98257(var_7e847524) {
  a_ai_zombies = getaiteamarray(level.zombie_team);
...
function_530d7ea0(var_bcf66490, e_player) {
...
function_2d281542(var_bcf66490) {
...
is_soul_capture(var_88206a50, e_zombie) {
...
function_f53f86f8(e_player, s_pap_interact) {
...
function_b2a3182b(e_player) {
  ...
  e_player notify(#"hash_2026d806e71dfad5", {
    #b_success: 1
  });
}

private function_cee9fb17() {
  a_ai_zombies = getaiteamarray(level.zombie_team);
...
function_f2081007(e_player, s_pap_interact) {
  e_player endon(#"disconnect");
...
private function_43a6c665(w_cur) {
...
function_51a8e408(str_hand) {
  ...
  var_a1327d58 = s_quest.var_a1327d58;
  a_players = util::get_active_players();
  var_a1327d58 notify(#"trigger_activated", {
    #e_who: a_players[0]
  });
  wait 1;
...
function_e3a8b066(str_hand) {
  ...
  wait 2.5;
  level.var_f9a57be7[level.var_65569374] notify(#"trigger_activated", {
    #e_who: a_players[0]
  });
  level.var_65569374++;
...
function_34c06bf9() {
  a_players = util::get_active_players();
  a_players[0] notify(#"hash_4d89e2bb8e3d1eb3", {
    #b_success: 1
  });
}
...
function_f241b684() {
  ...
  s_quest.var_a1327d58 notify(#"trigger_activated", {
    #e_who: a_players[0]
  });
...
function_6bf10cf9() {
  ...
  var_83f3addf notify(#"trigger_activated", {
    #e_who: a_players[0]
  });
  wait 1;
  s_quest = level.var_d225ea18[#"death"];
  ...
  if(isDefined(s_quest.var_18fd25ab[0])) {
    s_quest.var_18fd25ab[0] notify(#"trigger_activated", {
      #e_who: a_players[0]
    });
  }
...
function_11a0f6f8() {
  ...
  if(isDefined(s_quest.var_18fd25ab)) {
    s_quest.var_18fd25ab[1] notify(#"trigger_activated", {
      #e_who: a_players[0]
    });
    s_quest.var_18fd25ab[2] notify(#"trigger_activated", {
      #e_who: a_players[0]
    });
  }
}
...
function_681ce100() {
  ...
  wait 4.5;
  var_1d89b97b = struct::get_array("<dev string:xcd>", "<dev string:x9b>");
  var_1d89b97b[0] notify(#"trigger_activated", {
    #e_who: a_players[0]
  });
  s_teleport = s_quest.var_ed424981;
...
function_d963daa9() {
  level.players[0] notify(#"hash_2026d806e71dfad5", {
    #b_success: 1
  });
}
