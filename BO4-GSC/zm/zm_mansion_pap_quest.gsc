 ...
 * Script: zm\zm_mansion_pap_quest.gsc
***********************************************/
...
function_39549562(var_7b192260, var_f8561a50) {
  level flag::wait_till("all_players_spawned");
  ...
  level notify(#"hash_483503537a553500", {
...
function_bbceb70a(var_88206a50, ent) {
...
function_9ce2b677(var_f0e6c7a2, ent) {
...
function_2ec958b6(var_88206a50, ent) {
...
function_2c902b77(var_f0e6c7a2, ent) {
  if(getPlayers().size > 2) {
    n_souls_required = level.var_71561996;
  } else if(getPlayers().size > 1) {
    n_souls_required = level.var_d4fada4a;
...
function_995220a5(var_88206a50, ent) {
...
function_da937c94(var_f0e6c7a2, ent) {
  if(getPlayers().size > 2) {
    n_souls_required = level.var_71561996;
  } else if(getPlayers().size > 1) {
    n_souls_required = level.var_d4fada4a;
...
function_93e11617(a_ents, e_player) {
...
function_9e7129d2(e_player, s_stone, var_6cf4ded4, str_hint) {
  ...
  if(isPlayer(e_player)) {
    level notify(#"hash_43aa2c21cf191318", {
      #e_player: e_player
    });
  }
}
...
function_617b9c13(n_index, e_player, str_type) {
...
function_16ce67dd(vol_transform) {
  while(true) {
...
function_16288b92(str_type, s_loc, mdl_key, vol_transform) {
  v_offset = (0, 0, 16);
  s_stub = self.stub;
...
function_2f2d292b(s_loc, mdl_key, a_str_shots, var_8a9c5e4f) {
...
function_22b22d52(mdl_key, str_scene, str_shot) {
...
function_ff4485b6(a_ents, mdl_key, mdl_crystal) {
...
function_342e0887(a_ents, mdl_key, mdl_crystal) {
  self function_ff4485b6(a_ents, mdl_key, mdl_crystal);
}

function_11886796(a_ents) {
...
show_trail(nd_start, mdl_painting) {
...
function_1ae44836(var_c176969a) {
...
function_900b7dca(var_878f0f0a, var_5a365909 = 0, e_player, var_a797e723 = 0) {
  self endon(#"death");
...
function_e8355769(vol_defend, str_flag) {
  level endon(#"end_game");
  wait 3;
  jup_emblem_b5012_5 = mansion_util::function_91dfc9d4(vol_defend);

  while(!level flag::get(str_flag)) {
    a_players_touching = mansion_util::function_91dfc9d4(vol_defend);

    foreach(var_b930e62d in array::remove_undefined(jup_emblem_b5012_5)) {
  ...
  foreach(e_starting in array::remove_undefined(jup_emblem_b5012_5)) {
...
function_51573c45(var_39cddd2a, var_854f3b02) {
...
function_1a82ca71(str_flag, b_delete = 1) {
  if(!isDefined(self)) {
    return;
  }
...
function_d48fb847(var_ffba68db, str_flag, e_volume, e_player) {
...
check_player_proximity(vol_defend, var_39cddd2a, var_854f3b02) {
...
function_4387bfae(vol_defend, var_39cddd2a) {
...
clock_zombie_spawn(s_pos, str_flag, e_volume) {
  if(!isDefined(s_pos)) {
    return;
  }
...
function_418873a4(var_eb6e62b5) {
    ...
    switch (self.stub.var_db9b80c9) {
      case #"main_hall":
        if(isDefined(level.var_eab529d7)) {
          ...
          playSoundAtPosition(#"zmb_pap_key_pickup", level.var_eab529d7.origin);
      ...
      case #"library":
        if(isDefined(level.var_192555d1)) {
          ...
          playSoundAtPosition(#"zmb_pap_key_pickup", level.var_192555d1.origin);
      ...
      case #"greenhouse":
        if(isDefined(level.var_a46e88e5)) {
          ...
          playSoundAtPosition(#"zmb_pap_key_pickup", level.var_a46e88e5.origin);
...
function_5e48b125(thing, var_f068172b, str_ender, v_color) {
...
function_75e87a52(nd_start, v_color) {
