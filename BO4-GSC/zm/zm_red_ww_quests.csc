...
init() {
  ...
  zm_sq_modules::function_d8383812(#"ww_sc_light", 16000, #"ww_sc_h", 100, level._effect[#"pap_projectile_y"], level._effect[#"hash_2c33b0af2f93389e"], undefined, undefined, 1);
