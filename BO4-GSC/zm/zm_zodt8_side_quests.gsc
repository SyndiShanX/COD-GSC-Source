 ...
 * Script: zm\zm_zodt8_side_quests.gsc
***********************************************/
...
#include scripts\zm\powerup\zm_powerup_fire_sale;
...
ships_engineer_1_setup(var_a276c861) {
...
ships_engineer_1_cleanup(var_a276c861, var_19e802fa) {
...
ships_engineer_2_setup(var_a276c861) {
  if(!var_a276c861) {
...
ships_engineer_2_cleanup(var_a276c861, var_19e802fa) {
  if(var_a276c861 || var_19e802fa) {
    level flag::set(#"hash_f244999377a9081");
  }
}
...
ships_engineer_3_setup(var_a276c861) {
  if(!var_a276c861) {
    level flag::wait_till(#"hash_598d4e6af1cf4c39");
  }
}

ships_engineer_3_cleanup(var_a276c861, var_19e802fa) {
  level flag::set(#"hash_f244999377a9081");
  level flag::set(#"hash_598d4e6af1cf4c39");
}

function_a0f5819b(b_on = 1) {
...
portal_pass_step_1_setup(var_5ea5c94d) {
  if(!var_5ea5c94d) {
...
portal_pass_step_1_cleanup(var_5ea5c94d, ended_early) {
...
portal_pass_step_2_setup(var_5ea5c94d) {
  if(!var_5ea5c94d) {
    level waittill(#"hash_3fe51713857b3c4");
  }
}

portal_pass_step_2_cleanup(var_5ea5c94d, ended_early) {
  if(ended_early) {
    function_cbee939b();
  }
...
function_cbee939b(var_a9e11cb7) {
...
fishy_offering_step_1_cleanup(var_5ea5c94d, ended_early) {
  e_fish = getent("dead_offering", "targetname");
...
fishy_offering_step_2_setup(var_5ea5c94d) {
...
fishy_offering_step_2_cleanup(var_5ea5c94d, ended_early) {}
...
sea_walkers_setup(var_5ea5c94d) {
  level.var_f02a5fea = [];
...
sea_walkers_cleanup(var_5ea5c94d, ended_early) {}
...
function_86a8ce54(var_a276c861, var_19e802fa) {
  if(var_19e802fa) {
...
function_c0174de(var_f02fb354, gadget_lgt_exp_train_canals_debug) {
  self endon(#"death");
...
function_b941922b(var_a276c861) {
  if(!var_a276c861) {
...
function_2eabbbf5(var_a276c861, var_19e802fa) {
  foreach(s_safe in level.a_s_safes) {
...
function_e9104d6d(var_a276c861) {
...
function_2ff57042(var_a276c861, var_19e802fa) {}
...
function_1a1d203a(var_a276c861) {
  if(!var_a276c861) {
    function_23c7360a();
...
function_127efb37(var_a276c861, var_19e802fa) {
...
function_a5214a8d(w_frost_shield) {
  self endon(#"disconnect");
...
function_e01b477f(var_2cb1cbce, var_46a3f206) {
	level endon(#"end_game");
	self endon(#"death");
...
function_a65045b6(s_result) {
  if(isDefined(self) && isDefined(self.trigger)) {
    self.trigger delete();
  }
}

function_9fa09d36(mdl_flare) {
...
vomit_blade_setup(var_a276c861) {
...
vomit_blade_cleanup(var_a276c861, var_19e802fa) {
  if(getdvarint(#"zm_debug_ee", 0)) {
...
function_b87c71d7(var_a276c861) {
...
function_8c94faeb() {
  ...
  while(true) {
    ...
    self.stub.related_parent notify(#"hash_3c52547927852e33", {
      #e_who: e_player
    });
    e_player zm_audio::create_and_play_dialog(#"component_pickup", #"generic");
  }
...
function_1f7f2030(var_2c2d042a) {
  switch (var_2c2d042a) {
    case 0:
...
function_6d5cf6b2(str_text, str_endon) {
...
function_46a445cd(var_a276c861, var_19e802fa) {
  a_s_pianos = struct::get_array(#"ivory_number");
...
function_9a209775(var_a276c861) {
...
function_281b6803(zbarrier_magicbox) {
...
function_3fa7aef2(var_8352fb8a, e_player) {
...
function_2ae7b2a6(var_a276c861, var_19e802fa) {}