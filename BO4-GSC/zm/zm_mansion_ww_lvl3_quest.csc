 ...
 * Script: zm\zm_mansion_ww_lvl3_quest.csc
***********************************************/
...
function_41ad73f5(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
...
function_3ab850d6(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  if(isDefined(self.var_30b1857a)) {
    stopfx(localclientnum, self.var_30b1857a);
    self.var_30b1857a = undefined;
  }
...
function_d19e8c30(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
...
function_6bc1e300(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  if(newval) {
...
function_fdbcb111(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
...
function_d96d1ec8(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
...
ww_lvl3_crafting_table_fx(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
