...
#include scripts\zm\zm_mansion_achievements;
#include scripts\zm\zm_mansion_boss_ww;
#include scripts\zm\zm_mansion_gamemodes;
...
#include scripts\zm\zm_mansion_trap_buy_buttons;
#include scripts\zm\zm_mansion_trap_werewolfer;
#include scripts\zm\zm_mansion_traps_firegates;
#include scripts\zm\zm_mansion_triad;
#include scripts\zm\zm_mansion_trials;
#include scripts\zm\zm_mansion_util;
#include scripts\zm\zm_mansion_ww_lvl1_quest;
#include scripts\zm\zm_mansion_ww_lvl2_quest;
#include scripts\zm\zm_mansion_ww_lvl3_quest;
#include scripts\zm\zm_mansion_zones;
...
function_745370d2(w_weapon, e_player) {
...
function_d9848d71(a_zombie_doors) {
  level endon(#"end_game");
...
function_94cf8d37(var_62406c, var_62c4256, n_acceleration, n_speed) {
...
function_89244213(var_8f129c8e) {
  level endon(#"hash_48ee29312bd2ad06");
