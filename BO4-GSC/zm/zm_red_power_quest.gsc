 ...
 * Script: zm\zm_red_power_quest.gsc
***********************************************/
...
private function_d1435bda(player, var_feed7374) {
...
function_a5b8e88f(var_ddab7294 = 0) {
...
function_75162692(a_ai_zombies, n_limit) {
...
function_4fe65f31(n_zombies, n_timeout) {
  level endon(#"end_game");
...
function_72d7e85b(var_1c6bf395, var_29826eea, n_timeout) {
  level endon(#"end_game");
...
function_b8848794(n_section, n_delay = 0.5) {
...
reinforcements_think(str_spawns, var_f153be86 = 0, var_a294702 = 0) {
...
function_2a80a9cc(b_run = 0, b_sprint = 0) {
  self endon(#"death");
  waitframe(1);
