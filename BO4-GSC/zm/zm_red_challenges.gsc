 ...
 * Script: zm\zm_red_challenges.gsc
***********************************************/
...
actor_damage_callback(inflictor, attacker, damage, flags, meansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime, boneindex, surfacetype) {
...
create_challenge(n_challenge, n_zone, var_6346e7b, var_12af4e08 = &function_2dcc7ade, var_893baaf = undefined) {
...
function_49e4f4ca(var_ecffa2a8) {
...
function_2dcc7ade(var_893baaf = undefined) {
  return true;
}

function_40ccb2dc(var_893baaf = undefined) {
...
function_69a721d(var_893baaf = undefined) {
...
function_a987b682(var_893baaf = undefined) {
...
function_572ece72(var_893baaf = undefined) {
...
function_c0539e40(var_893baaf = undefined) {
  if(!function_863d38d3(self.n_zone)) {
    return 0;
  }
...
function_7fcc1087(var_893baaf = undefined) {
...
function_2d371444(var_893baaf = undefined) {
...
is_challenge_active(var_ecffa2a8) {
...
function_94bdb104(s_struct, ai_killed) {
...
soul_capture(s_struct, ai_killed) {
...
function_bf582bc8(var_ecffa2a8, n_damage) {
...
function_5e882c6f(e_player, var_2b625b6e) {
...
player_zone_watcher(var_ecffa2a8, var_2c5f83d, vol_override = undefined) {
