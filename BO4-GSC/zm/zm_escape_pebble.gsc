...
init_quests() {
  ...
  zm_sq::register(#"narrative_room", #"1", #"narrative_room_hidden", &function_6f55d670, &function_13c87ace);
...
function_13ee3d14(n_index, s_power_up) {
...
function_ac75d5bf(e_player, s_next_location) {
  self endon(#"death");
  self waittill(#"goal");
