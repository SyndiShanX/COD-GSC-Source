...
function_583cad13(var_2753f06a) {
  wait 1;
  b_played = 0;
...
function_8123b826(str_category, var_39acfdda) {
...
function_e43bea18(var_11975e15) {
...
function_cda40569(n_delay, str_alias, n_variant, str_endon) {
...
function_fe8ee9f0(var_b36eb2ad, var_7f70dbec = 1) {
...
is_wonder_weapon(w_weapon) {
  return isinarray(level.a_w_wonder, w_weapon);
}

function_5cd05b9(w_weapon_1, w_weapon_2) {
...
start_zombies_collision_manager(w_pickup, func_cleanup) {
...
custom_magic_box_selection_logic(w_weapon, e_player) {
