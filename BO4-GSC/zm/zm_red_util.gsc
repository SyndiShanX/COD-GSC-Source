...
function_6f5a2cb2(text, n_display_time = 0, str_waittill = undefined, var_3de28ed8 = 1) {
...
function_9ab191d3(var_447e014a = 1) {
  self function_207cca50();
...
show_text(text, n_display_time = 0, str_waittill = undefined, var_3de28ed8 = 1) {
  self endon(#"death");
...
function_b952264e(var_3de28ed8 = 1) {
  if(var_3de28ed8) {
...
function_797ac3b0(vol_area) {
  a_zombies = getaiteamarray(level.zombie_team);
  var_2a4957b4 = function_f17015c8(a_zombies, vol_area);
  return var_2a4957b4;
}

function_f17015c8(a_ents, vol_area) {
  var_2a4957b4 = 0;
...
private function_ee58ddd4(is_scroll = 0) {
  n_radius = 64;
...
function_d24a0f09(str_vo_line, var_e688ce8f = 0) {
