...
#include scripts\zm_common\trials\zm_trial_crawlers_only;
...
#include scripts\zm_common\trials\zm_trial_friendly_fire;
#include scripts\zm_common\trials\zm_trial_no_ads;
#include scripts\zm_common\trials\zm_trial_no_player_damage;
#include scripts\zm_common\trials\zm_trial_no_powerups;
#include scripts\zm_common\trials\zm_trial_open_all_doors;
#include scripts\zm_common\trials\zm_trial_random_teleport;
#include scripts\zm_common\trials\zm_trial_sprinters_only;
#include scripts\zm_common\trials\zm_trial_super_sprinters_only;
#include scripts\zm_common\trials\zm_trial_timeout;
#include scripts\zm_common\trials\zm_trial_use_magicbox;
#include scripts\zm_common\zm_round_spawning;
#include scripts\zm_common\zm_trial;
#namespace zm_zodt8_trials;

private autoexec function_88c28903() {
  zm_round_spawning::function_54fee373(&function_6bf7d04f);
}

private function_6bf7d04f(var_c766fbe6) {
