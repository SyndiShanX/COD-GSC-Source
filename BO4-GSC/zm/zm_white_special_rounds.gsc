 ...
 * Script: zm\zm_white_special_rounds.gsc
***********************************************/
...
#include scripts\zm\ai\zm_ai_white_nova_crawler;
...
function_fb32496a(str_identifier) {
...
function_1d0bb4d1(str_identifier) {
  foreach(var_efb22590 in level.var_d372355e) {
...
function_10671c7e(var_22a056cf) {
  var_18a839cc = [];
...
function_7b706d1d(str_identifier) {
...
function_3be5a506(str_identifier) {
...
function_53ffbb2e(var_cf2bbe1e) {
  a_s_result = [];
...
function_778aec95() {
  ...
  while(self.var_a1edb69e < 10) {
    ...
    while(b_using && (!level flag::get(#"hash_1478cafcd626c361") || level flag::get(#"circuit_step_complete"))) {
      ...
      n_percent_complete = floor(self.var_a1edb69e / 10 * 100);
      str_house = level function_b822e13(self.script_string);
      iprintlnbold(str_house + "<dev string:xf6>" + n_percent_complete + "<dev string:x101>");
...
function_8a3b2065(var_f1c779a7) {
...
function_27a8604b(str_identifier) {
  foreach(var_ab611263 in level.var_d4a0b9f4) {
...
function_2dfe81a1(var_f1c779a7) {
...
function_9c35a6e7(var_f1c779a7) {
...
function_71753169(a_s_valid_respawn_points) {
...
function_75cb64de(event, mod, hit_location, zombie_team, damage_weapon) {
  return false;
}

function_dba114b7(event, mod, hit_location, zombie_team, damage_weapon) {
  return 10;
}
...
function_6acd363d(is_completed) {
  if(!is_completed) {
...
function_c70d673e(var_4aad2831) {
  foreach(var_677ba5c4 in var_4aad2831) {
...
function_ec9a1827(var_4aad2831) {
