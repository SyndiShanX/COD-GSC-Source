 ...
 * Script: zm\zm_red_boss_battle.gsc
***********************************************/
...
#include scripts\zm_common\bgbs\zm_bgb_shields_up;
...
private function_9e8c41f4(e_target) {
...
function_2858e671(var_c34665fc, e_boss) {
...
function_12f4c281(s_waitresult, w_weapon, e_boss) {
...
function_9d06f858(var_fb8c33cc) {
...
function_84fac8d5(var_956f2977, n_delay, v_origin) {
...
private function_ca661e4b(var_956f2977, _town_pap_quest_complete) {
  switch (var_956f2977) {
    case 0:
...
private function_732c74f7(n_max_time) {
...
private function_3c2238ed(str_zone) {
  n_island = 0;
...
private function_b4723f8e(v_origin, e_pegasus) {
...
private function_325b6d95(v_origin) {
  level endon(#"hash_7646638df88a3656");
  n_radius = 1000;
  n_iterations = int(20);
...
private function_123b6625(e_player) {
...
function_d899c62c(base_health, round_number) {
...
private function_4d844f2() {
  level flag::clear(#"hash_59553ef93adcfe51");
}

function_79611ef0(n_island) {
  level endon(#"hash_7646638df88a3656");
  e_perseus = level.s_boss_battle.mdl_perseus;
...
private function_2003ebc9(n_island) {
...
private function_75f1dc3a(n_island) {
  foreach(var_225a75b4 in level.var_4775015b) {
    switch (n_island) {
      case 1:
        if(var_225a75b4.script_string === "park_to_column" || var_225a75b4.script_string === "park_to_fountain") {
...
function_b2420fe0(n_island) {
  switch (n_island) {
    case 2:
      ...
      break;
    case 3:
      if(level flag::get(#"hash_75d9474065de2230") && level flag::get(#"hash_75d94a4065de2749")) {} else if(level flag::get(#"hash_75d9474065de2230")) {
...
private function_c7a3202c(str_target_zone) {
...
private function_39dc3a09(e_target) {
  v_angles = undefined;
...
function_766fb0b1(var_fd1c353a) {
...
perseus_teleport_fx(v_destination) {
...
private function_4c17036d(e_attacker, b_hero_weapon = 0) {
...
function_60d4faca(a_s_valid_respawn_points) {
  var_e124a4eb = [];
