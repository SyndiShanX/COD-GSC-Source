...
#include scripts\zm\zm_zodt8_achievements;
#include scripts\zm\zm_zodt8_devgui;
...
#include scripts\zm\zm_zodt8_trials;
...
function_389e7c22(var_404e4288, var_8dd554ee) {
...
private function_4aaab486(b_show) {
  if(b_show) {
...
private function_34d1e89a(var_424eb3ee) {
...
function_2c0f0869(b_open, e_door, var_a34c7e62) {
...
pap_projectile_fx(var_da44938b, var_62c4256, n_acceleration, n_speed) {
...
private function_b0a7ca7(var_32be30af, var_4c2f2156, var_eb6a4856, var_bbaf1a87, n_time, var_65feb6ff, var_c6653d4, var_ff884319, var_90c00a3d, var_4cdff787) {
...
change_water_height_fore(b_drain) {
  if(b_drain) {
...
change_water_height_aft(b_drain) {
  if(b_drain) {
...
private function_b40f577b(var_eb6a4856, var_bbaf1a87, n_time, var_65feb6ff, var_c6653d4, var_ff884319, var_90c00a3d, b_drain) {
...
private function_8faf37bb(n_time, var_65feb6ff, var_c6653d4) {
...
function_94040dcd(b_on, var_eb6a4856, str_clientfield, var_ff4a7150) {
  if(b_on) {
...
function_18f12f69(str_zone_name) {
