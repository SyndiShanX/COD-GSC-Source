 ...
 * Script: zm\zm_mansion_boss_ww.gsc
***********************************************/
...
function_9eb08be3(var_5ea5c94d, ended_early) {
  if(!var_5ea5c94d) {
    boss_outro(1);
  }
}

function_df7c8713(var_5ea5c94d) {
  if(!var_5ea5c94d) {
    level thread function_482a7a01();
    boss_intro(2);
...
function_1e450b1a(var_5ea5c94d, ended_early) {
  if(!var_5ea5c94d) {
    boss_outro(2);
  }
}

function_f242ac9f(var_5ea5c94d) {
  if(!var_5ea5c94d) {
    level thread function_482a7a01();
    boss_intro(3);
...
boss_teleport_players(var_a88dacea) {
  level endon(#"end_game", #"intermission");
...
function_bb612e31(n_stage, var_c962047c) {
...
function_8b4d2b91(v_impact_origin) {
...
function_f25a51e4(b_captured, v_origin) {
  if(b_captured) {
...
function_1a240284(n_stage, var_2100633b) {
...
function_8d29523e(str_waittill, b_slow = 0) {
...
function_a3a00f3a(b_on) {
  for(i = 1; i <= 3; i++) {
    level.var_b5fff38b[i].unitrigger_stub.b_can_use = b_on;
  }
}

function_d2367771(var_82b2ec02 = 0) {
  if(var_82b2ec02) {
...
function_1025059f(var_2175ea54, n_statue, var_2d102ea7, var_b7daddf4 = 0) {
...
function_a70e02d3(var_b66cd272) {
  level endon(#"end_game", #"intermission");
...
function_e9cc6379(var_4642da4d, var_732926d1 = 0) {
  level endon(#"hash_38f29f9cb03586ea", #"spawn_zombies", #"end_game", #"intermission");
  n_round = level.var_d6f059f7;
