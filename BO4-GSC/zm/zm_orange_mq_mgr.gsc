 ...
 * Script: zm\zm_orange_mq_mgr.gsc
***********************************************/
...
#include scripts\zm\zm_orange_mq_vessel;
...
function_cb512dd4(var_5ea5c94d) {
  if(!var_5ea5c94d) {
    wait 10;
  }
}
...
function_d4147875(var_5ea5c94d) {
...
function_895265b1(var_5ea5c94d, ended_early) {
