 ...
 * Script: zm\zm_red_fasttravel.gsc
***********************************************/
...
function_91fabcb(mdl_item, b_clean_up = 0) {
  self endon(#"death");
...
function_c52e8ba(e_player, var_8d5d092c) {
  b_result = 0;
...
function_28deccf1(var_de3a312c, var_d53c9600 = 1) {
  self endon(#"death");
