 ...
 * Script: zm\zm_mansion_ww_lvl3_quest.gsc
***********************************************/
...
function_e92f09d0(einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, vdamageorigin, psoffsettime, damagefromunderneath, modelindex, partname, vsurfacenormal) {
...
function_e217ba73(v_pos, v_velocity) {
...
function_6730d7f4(var_74f1c6f6, var_1fc5672) {
...
function_afb9c21c(var_74f1c6f6) {
  ...
  while(true) {
    ...
    if(isDefined(s_waitresult.attacker) && (!isDefined(level.var_12469d5) || level.var_12469d5 == s_waitresult.attacker) && (s_waitresult.mod === "MOD_PROJECTILE" || s_waitresult.mod === "MOD_PROJECTILE_SPLASH") && (s_waitresult.weapon === level.var_6fe89212 || s_waitresult.weapon === level.var_74cf08b1)) {
      ...
      self notify(#"hash_5806ee636b7dafda", {
        #index: var_74f1c6f6.script_index
      });
      break;
    }
