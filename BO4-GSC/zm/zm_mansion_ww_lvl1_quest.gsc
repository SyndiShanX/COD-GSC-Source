 ...
 * Script: zm\zm_mansion_ww_lvl1_quest.gsc
***********************************************/
...
function_8b4cc6ae(origin, arc_angle_degrees = 90, do_trace, e_ignore) {
...
function_175e4696(var_1e30344b) {
  level endon(#"ww_case_completed");
  self.n_rotation = 0;
