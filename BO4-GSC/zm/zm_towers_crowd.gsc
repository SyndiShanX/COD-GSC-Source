...
function_10ef0925(e_homunculus) {
...
function_51ea46f3(b_enable = 1, b_close = 0) {
...
function_fd02425d(var_2bd26cff) {
  if(var_2bd26cff >= 40) {
    return true;
  }
...
function_e94dbaa9(var_2bd26cff) {
  if(var_2bd26cff <= -40) {
    return true;
  }
...
function_acab98ce(var_82c32aa7, var_9c93ba8f, var_ac39950d = 0, str_event) {
  str_name = self.name;
  var_65b29bff = "";
  var_aee1a869 = 0;
  var_31571f8a = 0;
...
function_1d9a9b89(str_category, b_announcer, var_ac39950d) {
...
function_dbe08c92(var_82c32aa7, var_bec704d1) {
  if(zm_utility::is_standard()) {
    return;
  }
