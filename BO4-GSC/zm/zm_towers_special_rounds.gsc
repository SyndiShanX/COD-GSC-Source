 ...
 * Script: zm\zm_towers_special_rounds.gsc
***********************************************/
...
#include scripts\zm\zm_towers_side_quests;
...
function_23873006(str_prefix, n_count) {
  for(i = 1; i <= n_count; i++) {
...
function_9a74f284(var_d25bbdd5) {
  if(var_d25bbdd5) {
    level.var_3f8640e8++;
...
function_93b3cc13(var_d25bbdd5) {
  if(var_d25bbdd5) {
    level.var_f8ae1232++;
...
registerpathing_units_() {
  return 12;
}

function_93eab559(var_b45e3d90 = 0) {
...
function_417990b9(var_b45e3d90 = 0) {
  if(!level flag::get(#"hash_1baa9fb772fb9175")) {
    return;
  }
...
private function_3cba3938(var_c34665fc) {
...
function_71c7c70b(var_c1ff0b19) {
