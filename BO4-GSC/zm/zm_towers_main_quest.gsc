...
init() {
  ...
  zm_sq::register(#"main_quest", #"wait_for_pap_quest", #"wait_for_pap_quest", &function_a3cd497c, &function_ff02b202);
...
function_4c6f5906(v_pos, v_dir, e_player) {
  s_line = spawnStruct();
  s_line.v_from = v_pos;
...
function_fa986cd(v_start, v_end, v_heading) {
  a_v_points = array();
  a_s_lines = array();
...
function_e5778b63(v_dir, e_rune) {
