 ...
 * Script: zm\zm_white_ww_quest_weapon.gsc
***********************************************/
...
init() {
  ...
  level.var_cb94d41d.a_s_slots[0] = {
    #n_state: 1, #var_2153c223: level.a_w_ray_guns[4]
  };
  level.var_cb94d41d.a_s_slots[1] = {
    #n_state: 1, #var_2153c223: level.a_w_ray_guns[6]
  };
  level.var_cb94d41d.a_s_slots[2] = {
    #n_state: 1, #var_2153c223: level.a_w_ray_guns[8]
  };
  level.var_cb94d41d.a_s_slots[3] = {
    #n_state: 1, #var_2153c223: level.a_w_ray_guns[10]
  };
...
function_537cf9cc(w_ray_gun, n_ammo_clip, n_ammo_stock, var_f702cf26) {
  function_b308d26b(w_ray_gun, n_ammo_clip, n_ammo_stock, var_f702cf26);
