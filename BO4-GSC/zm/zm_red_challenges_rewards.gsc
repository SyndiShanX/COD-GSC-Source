 ...
 * Script: zm\zm_red_challenges_rewards.gsc
***********************************************/
...
#include scripts\zm_common\bgbs\zm_bgb_bullet_boost;
#include scripts\zm_common\trials\zm_trial_red_tribute;
...
function_ab6fd86c(e_player, s_bowl) {
...
function_3165516b(var_1e2067f4, n_phase) {
  self endon(#"death");
  n_color = 1;
...
function_29e6dc49(var_be164210 = 1, var_6c9485fc = 15) {
  self endon(#"death");
...
function_d36fb590(var_aa4f9213, var_6c9485fc = 15, n_fx_type = 1) {
  self endon(#"death");
  ...
  mdl_reward = util::spawn_model(var_24a867e4, v_spawn_loc, v_spawn_angles);
...
function_ed4a5d52(var_f0de9b92) {
...
function_f152b354(str_bgb, var_6c9485fc = 15) {
  self endon(#"death");
  ...
  v_spawn_loc = self.s_tribute_bowl.var_1a34d8e + (0, 0, -6);
  v_spawn_angles = self.s_tribute_bowl.var_7b63dcba;
  mdl_reward = util::spawn_model(#"wpn_t8_zm_elixir_bottle_world", v_spawn_loc, v_spawn_angles);
...
give_weapon_reward(var_7ed75e97, var_6c9485fc = 15, b_upgraded = 0, var_5876e0e2 = undefined) {
  self endon(#"death");
...
function_e2a25377(str_weapon_name) {
...
function_53a333a8(var_ecffa2a8, var_41f9c5ff = undefined, var_893baaf = undefined) {
  if(isbot(self)) {
    return;
  }
  ...
  if(var_1f5eb74c != self.var_9e09931e) {
    ...
    self notify(#"hash_24326081081c2468", {
      #var_9e09931e: self.var_9e09931e
    });
    self thread function_b858f95a();
  }
}

function_73fda38e(n_amount) {
  if(!n_amount) {
    return 0;
  }
...
function_955b59b2(var_5436555f, var_893baaf) {
  n_amount = 0;
...
function_566c19d5(var_3d01acc1, n_index) {
...
give_perk_reward(var_16c042b8, var_6c9485fc = 15) {
  self endon(#"death");
  ...
  v_spawn_loc = self.s_tribute_bowl.var_9d32404.origin + (0, 0, 35);
  v_spawn_angles = self.s_tribute_bowl.var_9d32404.angles;
  v_forward = anglesToForward(v_spawn_angles);
  v_spawn_loc += v_forward * 7 + (0, 0, -9);
  mdl_perk = zm_perks::get_perk_weapon_model(var_16c042b8);
  mdl_reward = util::spawn_model(mdl_perk, v_spawn_loc, v_spawn_angles);
...
function_8665509b(var_6c9485fc = 15) {
...
function_7dc3dfdb(var_6c9485fc = 0) {
  self endon(#"death");
  ...
  v_spawn_angles = self.s_tribute_bowl.var_7b63dcba;
  v_forward = anglesToForward(v_spawn_angles);
  v_spawn_loc += v_forward * 7;
  mdl_reward = util::spawn_model("p8_zm_powerup_aat", v_spawn_loc, v_spawn_angles);
  b_taken = self function_dcda5d87(mdl_reward, 1, 1, 1);
...
function_dcda5d87(mdl_reward, b_rotate = 1, var_b9b24 = 1, n_fx_type = 1) {
  self endon(#"death");
...
function_57b8a4e9(e_pickup) {
  e_pickup waittill(#"death");
  self delete();
}

function_f7cdf2f7(n_fx_type = 1) {
  self endon(#"death");
...
pickup_timeout(e_player, var_cbfbd48a, var_22b0e42b = 15) {
  self endon(#"death");
...
function_6c62f074(var_9e09931e) {
  switch (var_9e09931e) {
    case 2:
...
function_abd417dc(var_7ed75e97, var_5876e0e2 = undefined, b_upgraded = 1) {
  self endon(#"death");
...
function_e08e4c9c(str_bgb, v_spawn_loc) {
  ...
  n_power = length(mdl_reward.origin - v_spawn_loc);
  var_cef149e8 = mdl_reward zm_utility::fake_physicslaunch(v_spawn_loc, n_power);
  wait var_cef149e8;
...
function_445c5623(var_aa4f9213, v_spawn_loc, n_fx_type = 1) {
  ...
  level.var_d1c9bbc4[level.var_d1c9bbc4.size] = mdl_reward;
  n_power = length(mdl_reward.origin - v_spawn_loc);
  var_cef149e8 = mdl_reward zm_utility::fake_physicslaunch(v_spawn_loc + (0, 0, 50), n_power);
  wait var_cef149e8;
...
function_c45635c7(mdl_reward, b_rotate, var_b9b24, n_fx_type = 1) {
...
function_cdb9fba6(mdl_reward, b_rotate, var_b9b24, n_fx_type = 1) {
  self endon(#"death");
...
function_529e8585(var_fd6264f6) {
...
function_50ce2afd() {
  if(zm_red_challenges::is_challenge_active(8)) {
    level notify(#"kill_with_god_hand", {
      #e_player: self
    });
  }
}

function_bec5bf67(type) {
