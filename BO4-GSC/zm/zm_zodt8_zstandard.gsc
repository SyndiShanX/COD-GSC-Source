 ...
 * Script: zm\zm_zodt8_zstandard.gsc
***********************************************/
...
function_dbf2f421(n_max) {
  return n_max;
}

function_30cd3df(n_max) {
  return 3;
}

function_c3b9a076(n_max) {
...
function_cb0be2c5(n_round_number) {
  zm_ai_stoker::spawn_single(1);
}

intro_blight_father(n_round_number) {
  zm_transform::function_bdd8aba6(#"blight_father");
}

function_52498131(var_edb0b1c5 = 5) {
...
function_e361bbf7(n_round_number) {
...
function_dcf7377c(n_round_number) {
