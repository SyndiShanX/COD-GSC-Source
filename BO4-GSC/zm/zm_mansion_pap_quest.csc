 ...
 * Script: zm\zm_mansion_pap_quest.csc
***********************************************/
...
function_9e5522ac(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwasdemojump) {
...
function_731e7fcf(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwasdemojump) {
  switch (newval) {
    case 0:
...
function_828749d4(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwasdemojump) {
  if(newval) {
...
function_9d797e21(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwasdemojump) {
  if(newval) {
...
ghost_trail_fx(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwasdemojump) {
  if(newval) {
...
function_924f922d(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwasdemojump) {
  switch (newval) {
    case 1:
...
function_3e31854(e_player, v_color) {
...
function_5fc23aa1(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwasdemojump) {
  if(newval) {
...
ghost_impact_fx(localclientnum) {
  self endon(#"death");
  v_contact = (0, 0, 0);
...
function_c0257c1d(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
...
function_466c2fa3(str_fx, newval) {
