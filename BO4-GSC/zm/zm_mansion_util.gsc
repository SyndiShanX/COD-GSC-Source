...
create_unitrigger(s_loc, func_think, hint_string, b_lookat, n_cost, var_ddbd86e1) {
...
function_ebad0e52(var_88f1eaa8) {
  self endon(#"disconnect");
...
function_f1c106b(str_blocker, b_solid) {
...
_print_player_out(n_range_sq = 9000000) {
  ...
  if(zm_utility::is_player_valid(e_player)) {
    return {
      #e_player: e_player, #n_index: e_player zm_characters::function_d35e4c92()
    };
  }
...
get_closest_valid_player(n_range_sq = 9000000) {
...
draw_arrow(org, ang, opcolor, str) {
