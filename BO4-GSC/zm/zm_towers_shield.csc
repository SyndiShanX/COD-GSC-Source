 ...
 * Script: zm\zm_towers_shield.csc
***********************************************/
...
function_311767a6(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  if(isDefined(self.fx_firestorm)) {
    killfx(localclientnum, self.fx_firestorm);
  }
}

function_467afa20(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  var_515e20e6 = 0;
...
function_8a2b203b(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
...
function_b975154f(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
...
function_e8244a0c(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  if(newval) {
    self flag::set(#"hash_4752663d0689d2c2");
  }
}

function_3864f492(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  if(newval) {
    self flag::set(#"hash_4d84827b8da5223d");
  }
}

function_200650fb(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  self function_34260ecf();
...
function_781821bc(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  if(newval) {
    self flag::set(#"hash_3c5ef4492a237f89");
  }
}

function_f6ec8d80(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  if(newval) {
    self flag::set(#"hash_748199dab24b7972");
  }
}

function_bee087e9(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  self function_34260ecf();
...
function_7faf18dd(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  if(newval) {
    self flag::set(#"hash_5be88bdaaf36eedf");
  }
}

function_f2c5818e(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  if(newval) {
...
function_103be84b(localclientnum, str_piece, s_start) {
  self endon(#"disconnect");
