...
#include scripts\zm\zm_white_devgui;
#include scripts\zm\zm_white_doomsday_clock;
#include scripts\zm\zm_white_door_powerup;
#include scripts\zm\zm_white_fx;
#include scripts\zm\zm_white_gamemodes;
#include scripts\zm\zm_white_insanity_mode;
#include scripts\zm\zm_white_lighting;
#include scripts\zm\zm_white_mee;
#include scripts\zm\zm_white_perk_pap;
#include scripts\zm\zm_white_population_count;
#include scripts\zm\zm_white_portals;
#include scripts\zm\zm_white_special_rounds;
#include scripts\zm\zm_white_toast;
#include scripts\zm\zm_white_trials;
#include scripts\zm\zm_white_trophies;
#include scripts\zm\zm_white_util;
#include scripts\zm\zm_white_ww_quest_modkit;
...
function_cc45705b(a_s_respawn_points) {
