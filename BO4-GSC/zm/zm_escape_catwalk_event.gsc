 ...
 * Script: zm\zm_escape_catwalk_event.gsc
***********************************************/
...
function_1646f141(var_e8ba54a2 = 0) {
  if(var_e8ba54a2) {
    level thread function_17ccf041();
    level thread function_da824de8();
  }
...
function_7b6777c5(t_spawner) {
  ...
  foreach(var_adad907f in var_d72fffcc) {
    ...
    if(isDefined(level.var_2b94ce72) && level.var_2b94ce72) {
      ...
      level notify(#"hash_744c6105bcd18f3a", {
        #ai_dog: e_enemy
      });
...
function_82a43802(a_s_valid_respawn_points) {
  var_e9b059c7 = [];
