...
#include scripts\zm\zm_office_fx;
...
#include scripts\zm\zm_office_traps;
#include scripts\zm\zm_office_trials;
#include scripts\zm\zm_office_trophies;
#include scripts\zm\zm_office_ww_quest;
#include scripts\zm\zm_office_zones;
...
main_quest_step1_setup(var_5ea5c94d) {
  if(!var_5ea5c94d) {
...
main_quest_step1_cleanup(var_5ea5c94d, ended_early) {
...
registerquest_key_pickup_explode(e_player) {
...
function_eeb98313(a_s_respawn_points) {
  var_5f7e6059 = [];
