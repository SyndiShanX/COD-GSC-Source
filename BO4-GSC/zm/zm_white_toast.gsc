...
function_641f4ec(var_ae5725a9, lockdown_trigger_func, unlock_cost, client_fx) {
...
function_8c2bda65(n_rate, b_drain) {
  e_goop = getent(self.soul_goo, "script_noteworthy");
...
function_12a92019(str_position) {
