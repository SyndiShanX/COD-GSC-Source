 ...
 * Script: zm\zm_mansion_storage.gsc
***********************************************/
...
function_63ceee4b(var_a276c861) {
  level.var_969e8ac2 = spawnStruct();
...
function_ff726bbb(var_2afee46 = 1) {
  ...
  while(true) {
    ...
    if(isplayer(s_waitresult.activator)) {
      ...
      level.var_969e8ac2 notify(#"hash_59cef06ae393749f", {
        #var_f9ba056c: e_book.var_a0639b8c,
        #array_index: e_book.var_60f4d369,
        #var_537e3893: e_book.script_noteworthy,
...
function_34f6d80a() {
  ...
  if(!b_failed) {
    level.var_969e8ac2 notify(#"hash_35caca73b82a6707", {
      #var_537e3893: s_waitresult.var_537e3893
    });
    return;
  }
...
function_21e10c11(var_a276c861, ended_early) {}
...
function_6c1be65c(var_a276c861) {
  level.a_s_barrels = [];
  level.a_s_spigots = [];
...
function_e4b6830d(var_a276c861, ended_early) {
  if(var_a276c861 || ended_early) {
...
function_c63076b4(var_2afee46 = 1) {
...
function_28995f54(var_a276c861) {
...
function_f5692472(var_a276c861, ended_early) {}
...
function_ffc4a06a(var_a276c861) {
...
function_a4daedbe(var_a276c861, ended_early) {
  if(var_a276c861 || ended_early) {
...
function_784a41d1(s_notify) {
  level clientfield::set("" + # "hash_75594bca6b54706e", 0);
}

function_cf048af(oldval, newval) {
...
function_2ff803fa(var_a276c861, ended_early) {
  if(var_a276c861 || ended_early) {}
}
...
function_63c873d9(var_dc2ad9ce) {
