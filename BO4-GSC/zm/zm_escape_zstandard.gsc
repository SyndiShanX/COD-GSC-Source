 ...
 * Script: zm\zm_escape_zstandard.gsc
***********************************************/
...
enable_gondola_at_docks(b_enable) {
...
function_c3ad6d4a(b_wait_for_player = 0) {
  level endon(#"end_game");
