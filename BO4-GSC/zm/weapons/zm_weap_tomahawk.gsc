...
tomahawk_ricochet_attack(var_65f2e452, e_grenade, var_bc201c9e, e_ignore) {
  self endon(#"disconnect");
...
function_d81951f5(mdl_tomahawk, var_65f2e452) {
  var_f500f73e = [];
  a_ai_zombies = util::get_array_of_closest(self.origin, getaiteamarray(level.zombie_team), undefined, undefined, 900);
...
function_e865484a(mdl_tomahawk, a_ai_zombie, var_65f2e452) {
  self endon(#"disconnect");
...
function_c7ddedb2(mdl_tomahawk, ai_zombie, var_bfed4a7 = 0.25) {
  self endon(#"disconnect");
...
function_e2c00ed6(mdl_tomahawk, n_move_speed, n_total_time) {
...
function_723cb8bd(mdl_tomahawk) {
  self endon(#"disconnect");
  mdl_tomahawk endon(#"death");
...
calculate_tomahawk_damage(ai_target_zombie, n_tomahawk_power, tomahawk) {
