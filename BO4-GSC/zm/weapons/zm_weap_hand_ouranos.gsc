 ...
 * Script: zm\weapons\zm_weap_hand_ouranos.gsc
***********************************************/
...
function_1fc2378f(e_projectile, ai_zombie, n_damage) {
...
function_dced5aef(e_target, weapon = level.weaponnone, n_damage, v_to_target, b_charged) {
  self endon(#"disconnect");
...
ouranos_feather_hit(oldval, newval) {
