 ...
 * Script: zm\weapons\zm_weap_scepter.gsc
***********************************************/
...
private function_304a3c9b(var_c34665fc) {
...
private function_4521ac7e(w_curr, n_lvl) {
...
private function_4493c71b(weapon, n_lvl = 1) {
...
private function_eae0296b(str_level, b_postfx = 0) {
  if(b_postfx) {
...
private function_89fc5431() {
  self.var_5762241e = undefined;
  self.var_a0a1475c = undefined;
}

private function_e874c3e1(weapon) {
...
private blood_death_fx(var_14ef0a6c) {
  if(self.archetype == "zombie") {}
}

function_fe3f086c(e_target, weapon = level.weaponnone) {
  if(isactor(e_target)) {
...
melee_zombies(weapon = level.weaponnone) {
...
function_be8ae52f(w_curr) {
  ...
  while(true) {
    ...
    level notify(#"hash_3e0895cd0cc16d2d", {
      #player: self
    });
...
private function_b67b2aff(e_target, n_damage, v_target_pos, w_hero, b_launched = 0, var_9a119ceb = 0) {
  e_target endon(#"death");
  self endon(#"disconnect");
...
function_d14a3750(var_c34665fc) {
...
function_f67f53a7(var_4eaa1f4c) {
...
function_15c2525e(var_a7e57ef9, n_loop_time) {
  self endon(#"disconnect");
...
function_3a00c0a6(perk) {
  self thread zm_perks::function_b2dfd295(perk, &function_cd010531);
  return false;
}

function_cd010531(e_reviver, var_84280a99) {
...
function_1728db6f(var_6554d141) {
