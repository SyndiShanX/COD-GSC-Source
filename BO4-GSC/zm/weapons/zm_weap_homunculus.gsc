 ...
 * Script: zm\weapons\zm_weap_homunculus.gsc
***********************************************/
...
function_2c022ba8(e_player, e_grenade) {
...
function_9ef23dc0(ai_zombie, n_time, e_player, e_grenade) {
...
grenade_stolen_by_sam(e_grenade) {
...
function_4d71ac38(str_alias, var_f2aa64f7 = 0) {
  if(var_f2aa64f7) {
