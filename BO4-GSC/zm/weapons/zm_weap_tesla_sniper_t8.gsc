 ...
 * Script: zm\weapons\zm_weap_tesla_sniper_t8.gsc
**************************************************/
...
function_e0525d4e(var_6a3758f2, e_source, meansofdeath, weapon, shitloc) {
...
function_4764da22(e_source, meansofdeath, weapon, shitloc) {
  if(isDefined(self)) {
...
function_487ae8a7(e_source, meansofdeath, weapon, shitloc) {
  self endon(#"death");
  level endon(#"end_game");
...
function_bd5b7309(player, var_fb0999c0) {
  if(!isalive(self)) {
    return;
  }
