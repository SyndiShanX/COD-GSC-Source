 ...
 * Script: zm\weapons\zm_weap_katana.gsc
***********************************************/
...
function_4e81317c(einflictor, eattacker, idamage, flags, meansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime, boneindex, surfacetype) {
...
private function_bbe55589(e_player, w_katana, str_hitloc) {
  self endon(#"death");
  n_base_damage = 50;
...
function_8520d1c9(var_f1149aba, str_hitloc, w_katana) {
...
function_c43691a9(var_2e56d8e5) {
