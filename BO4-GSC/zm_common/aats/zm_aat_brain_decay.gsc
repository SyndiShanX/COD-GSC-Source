 ...
 * Script: zm_common\aats\zm_aat_brain_decay.gsc
*************************************************/
...
function_8e97a3a4(attacker, weapon) {
...
private function_fef86dd4(var_c5ad44f1, n_damage, e_attacker, weapon) {
...
zombie_death_explosion(var_58928a4b, e_attacker, weapon) {
...
zombie_kill_tracker(e_attacker) {
  self endon(#"death");
  var_a57adbdc = 1;
...
zombie_death_gib(e_attacker, weapon) {
