...
function_aaf2d8(player, weapon, b_weapon_supports_aat, var_a86430cb) {
...
private can_pack_weapon(weapon, pap_machine) {
...
private player_use_can_pack_now(pap_machine) {
...
repack_weapon(weapon, n_repacks) {
