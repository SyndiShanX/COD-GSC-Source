 ...
 * Script: zm_common\zm_contracts.gsc
***********************************************/
...
function_8968a076(einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime) {
  if(idamage > 0) {
    self.shlocalh = 0;
  }
}
...
increment_zm_contract(var_38280f2f, delta = 1, var_86024473) {
...
registerpower_grid_displaycontrolrobotmelee(slot) {
...
function_1729afac(var_c34665fc) {
  self endon(#"disconnect");
...
function_1395d508(var_c34665fc) {
  self endon(#"disconnect");
...
function_295a8005(var_1d89ece6) {
