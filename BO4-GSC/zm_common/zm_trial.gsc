...
function_e80e07db(v_prev_origin) {
...
register_challenge(name, var_3b7ba215, var_6993ecb4) {
  if(!isDefined(level.var_75e93a54)) {
    level.var_75e93a54 = [];
  }
...
function_48736df9(var_38f795c7) {
...
function_cd75b690(var_cfb434d8) {
...
function_44200d07(var_cfb434d8) {
...
function_cdcce681(var_cfb434d8) {
  clientfield::set_world_uimodel("ZMHudGlobal.trials.disableGun", var_cfb434d8);
  clientfield::set_world_uimodel("ZMHudGlobal.trials.disableEquip", var_cfb434d8);
...
function_2b3a3307(var_cfb434d8) {
...
function_19a1098f(var_cfb434d8) {
...
function_63bdc1da(var_cfb434d8) {
...
fail(reason = undefined, var_eeb30248 = undefined) {
...
function_5769f26a(var_c00ecbf1) {
  for(i = 0; i <= 5000; i++) {
