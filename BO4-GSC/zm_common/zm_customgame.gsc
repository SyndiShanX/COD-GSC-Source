...
function_16020b98(var_c9db62d5) {
...
function_9be9c072(var_c9db62d5) {
...
function_928be07c(var_6a59aecf) {
...
function_928e94b9(a_str_archetypes) {
...
private function_e57809dd(einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime, boneindex) {
  if(idamage > 0) {
...
private function_4225c3b7(einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime, boneindex) {
  if(idamage > 0) {
    idamage = max(int(idamage * 0.25), 1);
  }
...
private function_6607cdee(einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime, boneindex) {
  if(idamage > 0) {
