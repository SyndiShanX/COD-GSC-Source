 ...
 * Script: zm_common\zm_utility_zstandard.gsc
***********************************************/
...
open_door(a_str_door_names, var_47eb646a = 0, var_91ccb2d7, b_play_audio = 0) {
...
function_26a5066b(n_round_number, var_232e4ebc = 1) {
...
function_31e9c9c6(n_round_number) {
  if(!isDefined(level.var_26a5066b)) {
    level.var_26a5066b = [];
  }
...
function_e12de7f5(n_round_number) {
...
function_22e48b1b(var_9b0e82f2) {
...
function_72c90d95(var_232e4ebc) {
...
function_6df718d(var_d147b93a, var_5cd8902e = 0, var_70516a9d = &function_9dc9326c) {
  level thread function_9ac7ed7d(var_d147b93a, var_5cd8902e, var_70516a9d);
}

function_9ac7ed7d(var_d147b93a, var_5cd8902e, var_70516a9d) {
...
function_511ee23e(var_35200797 = 1) {
  level thread function_27b4c2be(var_35200797);
}

function_27b4c2be(var_35200797 = 1) {
...
function_214563e(var_35200797 = 1, stop_time_travel_on_) {
  self endon(#"death");
...
drop_key(v_start_pos, var_b545186e = 0) {
...
function_742f2c18(n_round, archetype, n_count_total, var_4f886dd2, var_37dc6df8, var_d58fab26, var_8857c54d) {
...
function_c492c4d6(str_index, var_ed1db1a7, a_str_zones, a_str_next_defend, var_16a34df0, var_39c44288, var_c13f5c4b, var_9fc5eea1) {
...
function_40ef77ab(var_573c22c3, b_random = 1) {
...
function_428cfaae(var_679cd7a8, var_6cc77d4e, hide_notify, n_obj_id, var_e1feb2f6) {
...
function_9704c82e(s_defend, var_e1feb2f6) {
  level endon(#"end_game");
...
function_33798535(var_31721422, a_str_zones, var_ed1db1a7, var_6cc77d4e = # "hash_683cf7d37afcc3ae", var_de0f1997 = 45, var_f7c3c527 = 60, var_232e4ebc = 0, var_b96be97f = undefined) {
  ...
  level notify(#"creating_zone_defend_area", {
    #n_obj_id: level.var_35da2d77
  });
...
function_3b09971f(var_ed1db1a7, var_de0f1997, a_str_zones) {
...
function_1f9d70f7(var_57465a1b) {
...
function_766eff6(var_31721422, a_str_zones, var_de0f1997, var_f7c3c527) {
  self endon(#"disconnect");
...
player_left_zone(a_str_zones, var_8e2567b1, var_9faecc20) {
  self endon(#"disconnect");
...
function_1aaa4f63(var_3534ec82 = 1, var_f24b3f7a = 0) {
  level.var_e0b78e03 = undefined;
...
function_9757d4d2(var_35105434 = 0) {
...
function_2959a3cb(str_archetype, var_99dc2928) {
...
function_9b7bc715(str_archetype, var_f6e469ad = 1) {
...
function_6cb904e2(v_start_pos, var_487ba56d, n_radius = 512, b_randomize = 1, var_79ced64 = 0.2) {
  function_4a25b584(v_start_pos, var_487ba56d, n_radius, b_randomize, var_79ced64);
}

function_92162963(var_b9fefaba, b_permanent = 0) {
...
function_72725f77(b_permanent = 0) {
...
enable_power_switch(b_enable = 0, var_909e9d3d = 0, str_value, str_key, var_34451c07) {
