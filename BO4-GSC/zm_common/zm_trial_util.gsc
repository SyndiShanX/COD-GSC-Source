...
#include scripts\autogenerated\luielems\zm\zm_game_timer;
...
function_2976fa44(var_71fbbf01) {
...
function_dace284(var_96936cca, b_mute = 0) {
...
function_7d32b7d0(var_acc46b81) {
...
function_c2cd0cba(var_71fbbf01) {
  assert(var_71fbbf01 >= 0 && var_71fbbf01 <= 1000);
...
function_58292c4a(reason, var_eeb30248 = undefined) {
...
function_3f8a4145(var_26f4f16d) {
...
function_85d088ed(player) {
  bitarray = 0;
  bitarray |= 1 << player getentitynumber();
  return bitarray;
}

function_7dbb1712(forceupdate) {
...
function_79518194(eventstruct) {
  function_7dbb1712(0);
}

function_dc9ab223(b_locked = 1, var_1d9fd2ff = 0) {
  if(b_locked) {
...
function_d0348c2c(var_69cbd99d = 0) {
...
function_b142d49f(weapon, var_ef2d79a9 = 1) {
  self endon(#"disconnect");
...
function_bf710271(var_ef2d79a9 = 1, var_88ebd569 = 1, var_fdb73f9e = 1, var_af33418e = 1, var_3bd29f5e = 1) {
  self endon(#"disconnect");
...
function_dc0859e(var_b5434dd5 = 1) {
  foreach(weapon in self getweaponslist(1)) {
    self unlockweapon(weapon);
