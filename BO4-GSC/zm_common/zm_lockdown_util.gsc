...
function_b913ec1b(targetname, category) {
...
function_9f952db3(stub, entity, maxheight) {
...
function_9c7d5271(entity, &registerlotus_right, range) {
...
function_fea6f0c0(entity, stub, current_zone) {
  if(isDefined(current_zone) && isDefined(stub.in_zone) && stub.in_zone != current_zone) {
    function_78eae22a(entity, stub, 2);
...
function_db989a2a(entity, &registerlotus_right, range) {
  current_zone = entity zm_utility::get_current_zone();
...
function_ea677a9a(entity, stub, current_zone) {
  if(isDefined(current_zone) && isDefined(stub.in_zone) && stub.in_zone != current_zone) {
    function_78eae22a(entity, stub, 2);
...
function_d0e1d38c(entity, &registerlotus_right, range) {
  current_zone = entity zm_utility::get_current_zone();
...
function_e6761711(entity, &registerlotus_right, range) {
...
function_790e3eb0(entity, trigger) {
...
function_165e2bd6(entity, &registerlotus_right, range) {
...
function_809ae5cb(entity, blocker) {
...
function_8850974b(entity, &registerlotus_right, range) {
...
function_387fd27e(entity, trap_trig) {
...
function_d2ce5ac1(entity, &registerlotus_right, range) {
