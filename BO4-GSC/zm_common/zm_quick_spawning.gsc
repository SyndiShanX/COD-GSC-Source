 ...
 * Script: zm_common\zm_quick_spawning.gsc
***********************************************/
...
function_765cb1de(var_f4d3512f, player) {
  self endon(#"death");
...
function_1dbfb733(type, name, condition, text_func) {
...
function_bc774350(debug_info) {
  return debug_info.name + "<dev string:x4e>" + level.var_d4a79133;
}

function_766c006e(debug_info) {
