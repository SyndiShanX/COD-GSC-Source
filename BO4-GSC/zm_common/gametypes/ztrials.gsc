...
#include scripts\zm_common\trials\zm_trial_acquire_perks;
...
#include scripts\zm_common\trials\zm_trial_double_damage;
#include scripts\zm_common\trials\zm_trial_give_reward;
#include scripts\zm_common\trials\zm_trial_headshots_only;
#include scripts\zm_common\trials\zm_trial_reset_loadout;
#include scripts\zm_common\trials\zm_trial_restrict_controls;
...
#include scripts\zm_common\trials\zm_trial_turn_on_power;
...
event_handler[level_init] levelinit(eventstruct) {
  var_189d26ca = "";
...
set_door_hint_string(e_door, n_cost) {
  level flag::wait_till("start_zombie_round_logic");
