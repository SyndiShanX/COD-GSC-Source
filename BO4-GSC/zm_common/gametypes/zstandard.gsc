...
function_c3a8f243(_gen_zipline_traversal) {
  switch (level.players.size) {
    case 1:
...
function_261d5f79(params, ai_killed) {
...
function_3450100a(str_event, ai_killed, params) {
...
function_2a5d7e30(n_multiplier) {
...
function_4e9a2af4(var_273349fe) {
  switch (var_273349fe) {
    case 1:
...
function_b8b6bc95(str_event, ai_killed, params) {
...
function_a79dd957(var_f2c28d86, str_event, ai_killed) {
  if(str_event === "zm_arcade_kill") {} else if(str_event === "bonus_points_player_grabbed" || str_event === "player_grabbed_key") {
...
function_dead22f(player) {
  function_51e47b48(player, "pap", 30000);
}

function_10e451d7(player) {
...
function_5a2c9b1c(n_round_number) {
...
function_77ee3cd2(n_round_number) {
...
private function_17f8d14c(str_name, n_value) {
...
function_2b580cd4(var_e5fb46a8, str_name) {
...
function_7a916f72(e_player) {
  function_51e47b48(e_player, self.clientfieldname, 0);
}

function_51e47b48(var_e5fb46a8, str_name, n_time_ms) {
  if(!isDefined(var_e5fb46a8.var_bde53893)) {
...
function_3e1c5dad(var_e5fb46a8, str_name) {
...
function_6a326935(str_door_name) {
...
function_31094dd(var_a8903530 = 0) {
...
function_ec53cb2c() {
  ...
  function function_21669ebc(restart = 0) {
    ...
    while(true) {
      ...
      zombie_utility::set_zombie_var("zombie_spawn_delay", [
        [level.func_get_zombie_spawn_delay]
      ](zm_round_logic::get_round_number()));
      matchutctime = getutc();
...
function_cab8ebff(var_5707265b = 120) {
...
function_f26f8251(str_archetype, n_player_count) {
  level endon(#"end_game");
