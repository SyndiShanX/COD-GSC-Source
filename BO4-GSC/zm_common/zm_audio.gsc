...
function_bf1b121a(timeout, n_range, var_618a04) {
  __timeout__ = timeout;
...
function_a3932430(str_category, var_39acfdda) {
  if(isDefined(self.var_c13233ee)) {
    if(isDefined(self.var_c13233ee[str_category])) {
      if(isDefined(self.var_c13233ee[str_category][var_39acfdda])) {
...
function_3442c81a(str_location, str_music_state, b_repeat = 0, var_57b726a7 = 1, var_22324b12 = 2) {
