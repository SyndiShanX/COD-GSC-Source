 ...
 * Script: zm_common\zm_unitrigger.gsc
***********************************************/
...
function_fac87205(var_9d80e6ef, var_e0bc0661, var_98f0ce74 = 0, var_85b3bba3 = 0) {
...
unregister_unitrigger_internal(unitrigger_stub, var_a68f8009 = 0) {
...
register_dyn_unitrigger(unitrigger_stub, trigger_func, recalculate_zone) {
  if(level.zones.size == 0) {
    unitrigger_stub.trigger_func = trigger_func;
    level._unitriggers._deferredinitlist[level._unitriggers._deferredinitlist.size] = unitrigger_stub;
    return;
...
reregister_unitrigger(unitrigger_stub) {
...
function_a7620bfb(n_radius = 64, var_4478092b = 1) {
  if(var_4478092b) {
...
function_9267812e(n_width = 64, n_length = 64, n_height = 64, var_4478092b = 1) {
  if(var_4478092b) {
...
function_47625e58(s_stub, origin, v_angles) {
...
function_c9e3607c(s_stub, str_icon, w_weapon) {
...
unitrigger_set_hint_string(s_stub, str_hint, param1, param2) {
...
function_413f9fcf(s_stub, ent, default_ref, cost) {
  ref = default_ref;
...
unitrigger_force_per_player_triggers(s_stub, opt_on_off = 1) {
  s_stub.trigger_per_player = opt_on_off;
  s_stub.var_8d306e51 = 0;
  reregister_unitrigger(s_stub);
}

function_c4a5fdf5(s_stub, opt_on_off = 1) {
  s_stub.trigger_per_player = opt_on_off;
  s_stub.var_8d306e51 = 0;
  reregister_unitrigger(s_stub);
}

function_f1794fbf(s_stub, player) {
...
function_91a18523(s_stub, var_a6b7a40d) {
  ...
  if(self.current_trigger !== trigger) {
    if(isDefined(self.current_trigger)) {
      if(isDefined(self.current_trigger.stub)) {
        self.current_trigger.stub notify(#"unitrigger_deactivated", {
          #player: self
        });
      }
    }
    ...
    if(isDefined(self.current_trigger)) {
      if(isDefined(self.current_trigger.stub)) {
        self.current_trigger.stub notify(#"unitrigger_activated", {
          #player: self
        });
      }
    }
...
function_68f2282d(var_e7d50e88) {
