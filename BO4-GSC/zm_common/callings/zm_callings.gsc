...
function_c3be3572(var_9c939fff, var_27426b47, target, xp, var_b68d50cb = 1, var_7b2027fe = 1) {
  ...
  if(isDefined(var_1eb89301.callingtask)) {
    ...
    if(isDefined(var_341c004b)) {
      ...
      var_d1017f27 = {
        #var_e226ec4f: target, #var_ad971622: var_1eb89301.callingtask, #n_xp: xp, #var_de86e878: var_341c004b, #var_30c47a21: var_27426b47, #var_4a01cb77: self.var_96d6f6d1.size, #var_52ac6e9c: var_b68d50cb, #var_949f9254: var_7b2027fe
      };
...
function_10a1ac3c(var_d1017f27, var_e06cb519, var_bf6f8ec3) {
...
function_66714869(var_d1017f27, var_e06cb519, var_bf6f8ec3, n_inc) {
  if(isDefined(var_d1017f27.var_949f9254) && var_d1017f27.var_949f9254) {
    if(isDefined(var_d1017f27.var_52ac6e9c) && var_d1017f27.var_52ac6e9c) {
...
function_a6a40735(var_d1017f27, var_e06cb519, var_bf6f8ec3, n_value, var_32a60884 = 0) {
  if(!(isDefined(var_d1017f27.var_949f9254) && var_d1017f27.var_949f9254)) {
...
function_7b01d125(var_a0639b8c, var_f65a9845) {
