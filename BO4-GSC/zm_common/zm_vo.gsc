...
function_7922807c(var_a33019a0, var_3e24b5d5, a_players, b_force = 1) {
  _play_banter(var_3e24b5d5, var_a33019a0, a_players, b_force);
}

play_banter(var_3e24b5d5, var_a33019a0, a_players, b_force = 1) {
  _play_banter(var_3e24b5d5, var_a33019a0, a_players, b_force);
}

private _play_banter(var_3e24b5d5, var_a33019a0, a_players, b_force = 0) {
...
function_577efa88(var_a33019a0, var_3e24b5d5 = isDefined(level.var_3e24b5d5) ? level.var_3e24b5d5 : "banter") {
...
function_2fd1af0(var_a33019a0, var_c6a4663f = 1, var_3e24b5d5 = isDefined(level.var_3e24b5d5) ? level.var_3e24b5d5 : "banter") {
  if(!isDefined(level.var_5388c8f9[var_3e24b5d5])) {
    level.var_5388c8f9[var_3e24b5d5] = [];
  }
...
function_c6311709(var_a33019a0, var_3e24b5d5 = isDefined(level.var_3e24b5d5) ? level.var_3e24b5d5 : "banter") {
  if(isDefined(level.var_5388c8f9[var_3e24b5d5])) {
...
private function_bd8c7ec(var_ac829b0, var_3e24b5d5) {
...
function_e27cd027(var_ac829b0, var_3e24b5d5 = isDefined(level.var_3e24b5d5) ? level.var_3e24b5d5 : "banter") {
...
function_cf6c9597(var_ac829b0, var_3e24b5d5 = isDefined(level.var_3e24b5d5) ? level.var_3e24b5d5 : "banter", n_index) {
  if(!isDefined(level.var_98eae67a[var_ac829b0])) {
    level.var_98eae67a[var_ac829b0] = [];
  }
...
function_769aa73b(var_3e24b5d5, character1, character2) {
...
private function_3f8824e6(var_ac829b0, var_3e24b5d5) {
  n_index = int(min(function_e27cd027(var_ac829b0, var_3e24b5d5) + 1, 21));
  function_cf6c9597(var_ac829b0, var_3e24b5d5, n_index);
  return n_index;
}

private function_2b7b1675(var_3e24b5d5 = isDefined(level.var_3e24b5d5) ? level.var_3e24b5d5 : "banter", var_a33019a0, var_2e6c012e, e_player_2) {
...
private function_d74752d8(var_2753f06a) {
...
function_8d0f6d6c(str_notify) {
  level thread function_396064c0(0);
}

function_396064c0(var_e29db913 = 1) {
...
function_ee847f80(str_line1, str_line2) {
...
private function_172de553(var_ec88b612 = 1, a_players = array::randomize(function_347f7d34())) {
  var_f5f6332 = [];
...
function_18d309e5(n_timeout, var_ec88b612, a_players) {
...
function_5c82f986(var_97beaf8b, var_ccac9966) {
...
private function_95b99c5b(n_max, var_50bb7db7) {
...
private function_542dfad7(e1, e2, b_lowest_first = 1) {
  if(b_lowest_first) {
...
function_2ee2ece4(var_79dbc69 = 1) {
  while(true) {
...
vo_say(str_vo_alias, n_delay = 0, b_wait_if_busy = 0, n_priority = 0, var_34e7887 = 0, var_d7714e4e = 0, var_9c64da7c = 0, var_67fee570 = 0) {
  if(!isDefined(self)) {
    return 0;
  }
...
private function_597484c3(n_delay, var_56f97c91, var_d7714e4e) {
  if(!isDefined(self)) {
    return;
  }
...
function_cf1e151c(a_str_vo, var_604e94aa = [], b_wait_if_busy = 0, n_priority = 0, var_34e7887 = 0) {
  b_played = 0;
...
function_7e4562d7(var_3505e2ee, var_604e94aa = [], b_wait_if_busy = 0, n_priority = 0, var_34e7887 = 0, var_39ed8245 = 1, var_dcc9a85f = 2147483647) {
  b_played = 0;
  var_cd5bda0c = [];
...
function_3c173d37(v_pos, n_range = 1000) {
