...
#include scripts\zm_common\talisman\zm_talisman_box_guarantee_box_only;
#include scripts\zm_common\talisman\zm_talisman_box_guarantee_lmg;
#include scripts\zm_common\talisman\zm_talisman_coagulant;
#include scripts\zm_common\talisman\zm_talisman_extra_claymore;
#include scripts\zm_common\talisman\zm_talisman_extra_frag;
#include scripts\zm_common\talisman\zm_talisman_extra_miniturret;
#include scripts\zm_common\talisman\zm_talisman_extra_molotov;
#include scripts\zm_common\talisman\zm_talisman_extra_semtex;
#include scripts\zm_common\talisman\zm_talisman_impatient;
#include scripts\zm_common\talisman\zm_talisman_perk_mod_single;
#include scripts\zm_common\talisman\zm_talisman_perk_permanent_1;
#include scripts\zm_common\talisman\zm_talisman_perk_permanent_2;
#include scripts\zm_common\talisman\zm_talisman_perk_permanent_3;
#include scripts\zm_common\talisman\zm_talisman_perk_permanent_4;
#include scripts\zm_common\talisman\zm_talisman_perk_reducecost_1;
#include scripts\zm_common\talisman\zm_talisman_perk_reducecost_2;
#include scripts\zm_common\talisman\zm_talisman_perk_reducecost_3;
#include scripts\zm_common\talisman\zm_talisman_perk_reducecost_4;
#include scripts\zm_common\talisman\zm_talisman_perk_start_1;
#include scripts\zm_common\talisman\zm_talisman_perk_start_2;
#include scripts\zm_common\talisman\zm_talisman_perk_start_3;
#include scripts\zm_common\talisman\zm_talisman_perk_start_4;
#include scripts\zm_common\talisman\zm_talisman_shield_durability_legendary;
#include scripts\zm_common\talisman\zm_talisman_shield_durability_rare;
#include scripts\zm_common\talisman\zm_talisman_shield_price;
#include scripts\zm_common\talisman\zm_talisman_special_startlv2;
#include scripts\zm_common\talisman\zm_talisman_special_startlv3;
#include scripts\zm_common\talisman\zm_talisman_special_xp_rate;
#include scripts\zm_common\talisman\zm_talisman_start_weapon_ar;
#include scripts\zm_common\talisman\zm_talisman_start_weapon_lmg;
#include scripts\zm_common\talisman\zm_talisman_start_weapon_smg;
#include scripts\zm_common\talisman\zm_talisman_weapon_reducepapcost;
#include scripts\zm_common\trials\zm_trial_headshots_only;
#include scripts\zm_common\util;
#include scripts\zm_common\zm_armor;
#include scripts\zm_common\zm_attachments;
...
#include scripts\zm_common\zm_playerzombie;
...
fade_out_intro_screen_zm(hold_black_time = 0.2) {
  players = getplayers();
...
function_d797f41f(n_waittime = 1) {
  wait n_waittime;
...
function_9c2111a0(initial_black) {
  self endon(#"disconnect");
...
register_vehicle_damage_callback(func) {
...
private function_7bdb1f9f(attacker, damage, meansofdeath, weapon, shitloc) {
...
check_actor_damage_callbacks(inflictor, attacker, damage, flags, meansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime, boneindex, surfacetype) {
...
function_84d343d(str_weapon, func) {
  if(!isDefined(level.var_aed5d327)) {
    level.var_aed5d327 = [];
  }
...
register_actor_damage_callback(func, var_61bac8c = 0) {
  if(!isDefined(level.actor_damage_callbacks)) {
...
actor_damage_override_wrapper(inflictor, attacker, damage, flags, meansofdeath, weapon, vpoint, vdir, shitloc, vdamageorigin, psoffsettime, boneindex, modelindex, surfacetype, vsurfacenormal) {
  if(!isDefined(self)) {
    return damage;
  }
...
register_zombie_damage_override_callback(func) {
  if(!isDefined(level.zombie_damage_override_callbacks)) {
...
actor_killed_override(einflictor, attacker, idamage, smeansofdeath, weapon, vdir, shitloc, psoffsettime) {
