...
increment_global_stat(stat_name) {
  if(isDefined(level.zm_disable_recording_stats) && level.zm_disable_recording_stats) {
    return;
  }
...
highwater_global_stat(stat_name, value) {
  if(value > get_global_stat(stat_name)) {
    set_global_stat(stat_name, value);
  }
}

get_client_stat(stat_name) {
  return self stats::get_stat(#"playerstatslist", stat_name, #"statvalue");
}
...
highwater_map_stat(stat_name, value) {
...
function_ab006044(stat_name, value) {
  if(!level.onlinegame || isDefined(level.zm_disable_recording_stats) && level.zm_disable_recording_stats) {
    return;
  }
...
function_d4e0d242(stat_name, value) {
  if(value > function_56ec2437(stat_name)) {
    function_4d4e2a78(stat_name, value);
  }
}

function_b1520544(stat_name) {
  if(!level.onlinegame || isDefined(level.zm_disable_recording_stats) && level.zm_disable_recording_stats) {
    return 0;
  }
...
function_a6efb963(stat_name, value) {
  if(!level.onlinegame || isDefined(level.zm_disable_recording_stats) && level.zm_disable_recording_stats) {
    return;
  }
...
function_1b763e4(stat_name, value) {
  if(!isDefined(value)) {
    return;
  }
...
function_366b6fb9(stat_name, value, var_48038375 = 0) {
...
function_31931250(stat_name, n_value, var_48038375 = 0) {
...
increment_challenge_stat(stat_name, amount = 1, var_b68b08b1 = 0) {
...
add_match_stat(stat_name, value) {
  if(isDefined(level.zm_disable_recording_stats) && level.zm_disable_recording_stats) {
    return;
  }
...
increment_match_stat(stat_name) {
  if(isDefined(level.zm_disable_recording_stats) && level.zm_disable_recording_stats) {
    return;
  }
...
function_57febe39(stat_name, value) {
  if(value > get_match_stat(stat_name)) {
    set_match_stat(stat_name, value);
  }
}

function_529e1302(stat_name) {
  if(isDefined(level.zm_disable_recording_stats) && level.zm_disable_recording_stats) {
    return 0;
  }
...
function_ae547e45(stat_name, value) {
...
function_301c4be2(stat_name, value) {
  if(isDefined(level.zm_disable_recording_stats) && level.zm_disable_recording_stats && !issubstr(stat_name, "boas_")) {
    return;
  }
...
function_5d0e6000(stat_name, value) {
...
function_7741345e(player, w_current, n_shots_fired, n_hits) {
...
function_ea5b4947(b_end_game = 0) {
...
function_94335f4a(var_1aa5a6d6) {
  ...
  for(n_row = 0; true; n_row++) {
    ...
    if(n_event == var_1aa5a6d6) {
      ...
      level.var_ad5d54b[n_tier] = {
        #var_e226ec4f: var_e226ec4f, #var_ad971622: var_ad971622, #n_xp: n_xp, #var_1f2bdb95: var_1f2bdb95
      };
    }
  }
}

function_c0c6ab19(var_ad971622, n_value = 1, var_b68b08b1 = 0) {
...
function_7f377150(s_event_calling_task, n_value = 1) {
...
function_e8c496dd(var_d479261a) {
  ...
  if(isDefined(callingsbundle.dailyschedule) && isDefined(callingsbundle.dailyschedule[var_d479261a])) {
    ...
    if(isDefined(taskinfo.callingtask)) {
      ...
      if(isDefined(var_341c004b)) {
        level.s_daily_calling_task = {
          #var_e226ec4f: taskinfo.dailytarget, #var_ad971622: taskinfo.callingtask, #n_xp: task.xp, #var_de86e878: var_341c004b
        };
      }
    }
  }
