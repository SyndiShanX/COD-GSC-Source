 ...
 * Script: hashed\script_2ba3951675c7ee1c.gsc
***********************************************/
...
private function_cbe7f871() {
  ...
  while(true) {
    ...
    if(level flag::get(#"hash_3fb7d58b07b04333") && level flag::get(#"hash_1d5f5fbf80476490")) {
      self.stub notify(#"hash_38a4480847fe9677", {
        #activator: e_player
      });
    }
  }
...
function_fcf0a319(e_player, var_a29167c5) {
...
function_599013ad(e_player, var_98fbd60e) {
...
private function_11efbb03(e_player) {
  ...
  while(true) {
    ...
    if(s_result.activator == e_player) {
      if(zm_utility::can_use(e_player, 1) && e_player.currentweapon.name != "none") {
        ...
        level notify(#"hash_575b654fc5c59146", {
          #e_player: e_player
        });
...
private wait_for_timeout(e_player, var_9bce3ebf) {
...
function_9689b55c(var_88f24b00) {
  self endon(#"death");
  var_88f24b00 endon(#"death");
  var_39662a63 = int(5);
...
function_dd30dc9a(var_146228fb) {
  self endon(#"death");
...
function_ce0bd88a(var_146228fb) {
  self endon(#"death");
  self movez(36, 3);
  wait 3;
...
function_e672cf9(e_player, var_fc074136) {
  self endon(#"magma_taken");
...
private function_a6a91f7a(var_f2528cbc) {
  if(isDefined(self.var_607f49de)) {
    self.var_607f49de delete();
  }
