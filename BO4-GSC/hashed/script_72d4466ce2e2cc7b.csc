 ...
 * Script: hashed\script_72d4466ce2e2cc7b.csc
***********************************************/
...
function_9b08184(localclientnum) {
...
function_9ac87769(localclientnum) {
...
function_1183b860(localclientnum) {
  self endon(#"death");
  level endon(#"game_ended");
  player = function_5c10bd79(localclientnum);
...
function_cfd06f57(localclientnum) {
  self endon(#"death");
...
function_1edfdbc1(localclientnum) {
  self endon(#"death");
...
function_161106e1(localclientnum) {
  self endon(#"death");
...
function_a78bbf22(localclientnum) {
  self endon(#"death");
...
function_ba24f324(localclientnum) {
  level endon(#"game_ended");
...
function_218c905c(localclientnum, winningteam) {
  self endon(#"death");
  player = function_5c10bd79(localclientnum);
...
function_1d13e2db(localclientnum) {
  level endon(#"game_ended");
...
function_f5866497(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  player = function_5c10bd79(localclientnum);
...
function_815076cb(keylist, color) {
  foreach(key in keylist) {
    function_b4c6383f(key, 1, color);
  }
}

function_ed8d6d5e(keylist, startcolor, endcolor, fadetime) {
  foreach(key in keylist) {
    function_b4c6383f(key, 2, startcolor, endcolor, fadetime);
  }
}

function_119b3b6b(keylist, color, var_276aa694, fadetime, var_109ec056, offset) {
  foreach(key in keylist) {
    function_b4c6383f(key, 4, color, var_276aa694, fadetime, var_109ec056, offset);
  }
}

function_6f501c4(keylist) {
  foreach(key in keylist) {
