...
function_915f2843(localclientnum) {
  self notify(#"hash_593064545176ab53");
}

function_e2730196(localclientnum) {
...
function_36e09e98(localclientnum) {
  self show();
...
function_77fbeefa(localclientnum) {
  self hide();
...
morse_code_sfx(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
...
function_44181c14(localclientnum, n_val) {
...
generator_spark_fx(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwasdemojump) {
