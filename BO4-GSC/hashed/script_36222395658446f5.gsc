 ...
 * Script: hashed\script_36222395658446f5.gsc
***********************************************/
...
private function_831aa56d(e_player, var_69970c6) {
...
private function_6c5fdbbf(e_player) {
  e_player endoncallback(&function_905f55bb, # "disconnect");
...
private function_f23ddf20(e_player) {
  e_player endoncallback(&function_905f55bb, # "disconnect");
...
private function_455ede41(e_player) {
...
function_a93fd607(e_grenade, n_grenade_charge_power) {
...
function_986bf0d5(mdl_tomahawk, mdl_rock) {
  self endon(#"disconnect");
...
function_1d02544f(e_grenade, n_grenade_charge_power) {
...
function_f02db707(mdl_tomahawk, mdl_rock) {
  self endon(#"disconnect");
  mdl_tomahawk waittill(#"death");
  mdl_rock delete();
...
function_b74fca4c(e_grenade, n_grenade_charge_power) {
...
function_7694f3cb(mdl_tomahawk, mdl_rock) {
  self endon(#"disconnect");
  mdl_tomahawk waittill(#"death");
  mdl_rock delete();
