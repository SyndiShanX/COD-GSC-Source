...
burn(str_type, e_attacker, weapon, var_477abb8f) {
...
function_865a83f8(zombie, target, predictedpos, var_95342913) {
...
register_slowdown(str_type, n_rate, n_duration = -1) {
  if(!isDefined(level.var_981dd9cf)) {
    level.var_981dd9cf = [];
  } else if(!isarray(level.var_981dd9cf)) {
    level.var_981dd9cf = array(level.var_981dd9cf);
