 ...
 * Script: hashed\script_4bae07eadc57bb51.gsc
***********************************************/
...
function_da973002(var_c34665fc) {
  hold_round_end(0);
}

function_2cfc0c77(e_holder, w_item) {
  self thread dog_ambush();
}

hold_round_end(var_430ae23) {
  if(var_430ae23) {
