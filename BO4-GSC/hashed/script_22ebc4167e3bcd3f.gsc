 ...
 * Script: hashed\script_22ebc4167e3bcd3f.gsc
***********************************************/
...
function_6ff33a91(var_217fca51) {
...
function_6098c5c(var_fdc7d6b5, v_origin, var_965869c9) {
...
function_2084efc3(str_notify) {
  callback::remove_on_connect(&function_5753ae89);
}

function_48e7a1d7(e_grenade, n_grenade_charge_power) {
  self endon(#"disconnect");
...
function_be995f48(mdl_tomahawk, mdl_powerup) {
  self endon(#"disconnect");
