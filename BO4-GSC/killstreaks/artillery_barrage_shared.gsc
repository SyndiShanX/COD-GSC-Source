 ...
 * Script: killstreaks\artillery_barrage_shared.gsc
****************************************************/
...
function_d7cf7d18(location, killstreak_id) {
  team = self.team;
...
function_a9ef6d5d(plane, var_675219e7, var_aff95821, var_d1769adf) {
  owner = self;
...
function_5a0d2864(startpoint, endpoint, targetpoint, angles, team, killstreak_id) {
  ...
  shell notify(#"hackertool_update_ent", {
    #entity: bomb
  });
...
function_cc147a03(attacker, weapon) {
  plane = self;
  plane.destroyed = 1;
