...
function_ec2c9808(response, intpayload) {
...
function_8076d591(event, params) {
  if(isDefined(params)) {
...
function_6ee52dd0(damage, damageinterval) {
  level flagsys::wait_till(#"insertion_teleport_completed");
  var_366959 = 0;
