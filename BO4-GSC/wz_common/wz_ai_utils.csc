 ...
 * Script: wz_common\wz_ai_utils.csc
***********************************************/
...
function_5c69ac3b(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  if(newval > 0) {
...
function_7e5339f3(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  if(newval > 0) {
    if(newval == 1) {
...
function_88a28ed1(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
  if(newval > 0) {
