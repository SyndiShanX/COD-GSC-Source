 ...
 * Script: abilities\ability_util.csc
***********************************************/
...
get_aoe_fx_info(aoe_name) {
  return level.aoe_fx_info[aoe_name];
}

init_applied_aoe_fx_info(aoe_name) {
...
update_applied_aoe_fx(local_client_num, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
...
set_aoe_fx(local_client_num, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
...
stop_aoe_fx(local_client_num, clientfield_name, aoe_fx_info) {
...
private aoe_fx(local_client_num, clientfield_name, aoe_fx_info) {
  self endon(#"death");
...
private do_aoe_fx(local_client_num, center, yaw_count, pitch, clientfield_name, aoe_fx_info) {
