 ...
 * Script: mp\mp_cosmodrome_scripted.gsc
***********************************************/
...
function_971b8aa2(var_ae2faaca) {
...
kill_equipment(rocket_kill_trig) {
  self endon(#"death");
...
function_cd7664d5(loc, alias, color) {
  if(!isDefined(color)) {
    color = (0, 1, 0);
  }
