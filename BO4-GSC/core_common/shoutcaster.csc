...
private shoutcaster_monitor_xray_change(local_client_num) {
...
private function_4c4946d4(local_client_num, localplayerteam, var_52fe6881, var_faa7a3fb) {
  var_f2a410c9 = [];
...
private function_7ed4edd3(playername) {
...
private function_2b07633f(playername) {
  if(!isDefined(playername)) {
    return false;
  }
...
private function_8e1e7736(localclientnum, player) {
...
private function_35248a94(localclientnum, playername) {
  if(isDefined(level.shoutcasterpucks[playername])) {
...
private function_69b179ea(localclientnum) {
  if(isDefined(level.var_fea1a13)) {
...
private shoutcaster_monitor_player_pucks(localclientnum) {
