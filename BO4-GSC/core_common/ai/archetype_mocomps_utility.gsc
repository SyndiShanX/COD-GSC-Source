 ...
 * Script: core_common\ai\archetype_mocomps_utility.gsc
********************************************************/
...
calculatepivotoriginfromedge(entity, mantlenode, traversalstart) {
...
function_5f0e6de2(entity, mocompanim, mocompanimblendouttime, mocompanimflag, mocompduration) {
  mocomptraversalproceduralinit(entity, mocompanim, mocompanimblendouttime, mocompanimflag, mocompduration, 0);
}

mocomptraversalproceduralinit(entity, mocompanim, mocompanimblendouttime, mocompanimflag, mocompduration, timescale = 1) {
...
function_41323d2(entity, mocompanim, mocompanimblendouttime, mocompanimflag, mocompduration) {
  mocomptraversalproceduralpivotinit(entity, mocompanim, mocompanimblendouttime, mocompanimflag, mocompduration, 0);
}

mocomptraversalproceduralpivotinit(entity, mocompanim, mocompanimblendouttime, mocompanimflag, mocompduration, timescale = 1) {
  traversal = spawnStruct();
  traversal.startnode = entity.traversestartnode;
  traversal.endnode = entity.traverseendnode;
...
mocomptraversalproceduralpivotterminate(entity, mocompanim, mocompanimblendouttime, mocompanimflag, mocompduration) {
  traversal = entity.traversal;
...
autoexec initadjusttocoverparams() {
...
function_7ea5e21f(entity, mocompanim, mocompanimblendouttime, mocompanimflag, mocompduration) {
...
function_8def77d1(entity, mocompanim, mocompanimblendouttime, mocompanimflag, mocompduration) {
...
function_59fe75e2(entity, mocompanim, mocompanimblendouttime, mocompanimflag, mocompduration) {
  entity.blockingpain = 1;
  entity orientmode("face angle", entity.angles[1]);
  entity animmode("zonly_physics", 1);
}

function_8559a6cd(entity, mocompanim, mocompanimblendouttime, mocompanimflag, mocompduration) {
  entity.blockingpain = 1;
  entity orientmode("face angle", entity.angles[1]);
  entity animmode("zonly_physics", 1);
}

function_4b95cde(entity, mocompanim, mocompanimblendouttime, mocompanimflag, mocompduration) {
  entity.blockingpain = 0;
