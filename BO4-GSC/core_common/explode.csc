...
watchforplayerfalldamage(localclientnum) {
  self endon(#"death");
  seed = 0;
  xdir = 0;
  ydir = 270;
...
watchforplayerslide(localclientnum) {
  self endon(#"death");
  seed = 0;
...
dothedirty(localclientnum, right, up, distance, dirtduration, dirtfadetime) {
  self endon(#"death");
...
do_the_dirty_lerp_helper(currenttime, elapsedtime, localclientnum, dirtduration, right, up, distance, dirtfadetime) {
...
watchforexplosion(localclientnum) {
  self endon(#"death");
