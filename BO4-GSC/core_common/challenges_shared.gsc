...
last_man_defeat_3_enemies(team) {
...
function_90185171(totaltimeplayed, credits, casexp) {
...
function_659f7dc(var_1ef5a3ba, var_3e853b2e, var_25ad32e1) {
...
function_24db0c33(weapon, destroyedobject) {
  weaponclass = util::getweaponclass(weapon);
  weaponpickedup = 0;
...
capturedobjective(capturetime, objective) {
...
playerkilled(einflictor, attacker, idamage, smeansofdeath, weapon, shitloc, attackerstance, bledout) {
