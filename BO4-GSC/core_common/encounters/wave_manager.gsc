...
function_710cbc75(e_player, var_1ad9db60, b_branch) {
  start_internal(self);
}
...
function_e43e16d2(var_dcd6c23, n_wave) {
  if(isDefined(n_wave)) {
...
function_aa6a8e4a(var_dcd6c23, n_wave) {
  if(isDefined(n_wave)) {
...
function_a2115dc4(var_dcd6c23, n_wave) {
  if(isDefined(n_wave)) {
...
function_55525f13(var_dcd6c23, n_wave, var_b8b3e39d) {
  if(isDefined(n_wave)) {
...
stop_internal(var_dcd6c23, var_4bb2faf8) {
...
start_internal(s_wave_manager_struct, str_team, b_looping, str_wavemanager, str_spawner_targets, var_e8332bc1) {
...
function_7909260f(var_dcd6c23, n_wave, var_bced2a83) {
  n_spawns = 0;
...
function_9e2b33f4(var_c21b798e) {
...
function_d081cf72(var_a2b4b991) {
...
function_ed819a97(var_a2b4b991) {
  var_c165240a = [];
...
function_d8cca6d5(var_c165240a) {
  var_db4208eb = [];
...
function_63e08195(kvp, b_assert = 1) {
  a_s_wave_managers = [];
...
function_5b3b889f(var_ac1d69cd) {
  return isinarray(level.a_s_wave_managers, var_ac1d69cd);
}

function_bf55c711(n_wave, var_bced2a83) {
...
function_be3a34f(var_b6ee6116, str_team, b_looping = 0, str_spawner_targets, var_964c77e1, ...) {
  var_e8332bc1 = new class_8e39177();
  var_e8332bc1.var_964c77e1 = var_964c77e1;
  var_e8332bc1.a_params = vararg;
...
function_1c556906(kvp, str_spawner_targetname) {
...
function_a3469200(kvp, n_spawn_set) {
  a_ai = [];
  var_fed53aae = self wave_manager_sys::function_32b947df(kvp);

  if(isDefined(n_spawn_set)) {
    n_spawn_set--;
  }

  foreach(var_dcd6c23 in var_fed53aae) {
    if(isDefined(var_dcd6c23.var_376c2c29)) {
      if(isDefined(n_spawn_set) && n_spawn_set > 0) {
        if(isDefined(var_dcd6c23.var_376c2c29[n_spawn_set])) {
          a_ai = var_dcd6c23.var_376c2c29[n_spawn_set].m_a_ai;
        }
      } else {
        foreach(var_c21b798e in var_dcd6c23.var_376c2c29) {
          foreach(ai in var_c21b798e.m_a_ai) {
