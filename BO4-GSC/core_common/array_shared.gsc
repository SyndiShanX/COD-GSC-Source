 ...
 * Script: core_common\array_shared.gsc
***********************************************/
...
pop_front(&array, b_keep_keys = 1) {
  index = getfirstarraykey(array);
  return pop(array, index, b_keep_keys);
}

push(&array, val, index = array.size + 1) {
...
get_all_farthest(org, &array, a_exclude, n_max = array.size, n_maxdist) {
...
get_all_closest(org, &array, a_exclude, n_max = array.size, n_maxdist) {
  a_ret = exclude(array, a_exclude);
...
function_460f3c24(array1, array2) {
