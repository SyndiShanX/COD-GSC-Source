...
generic_human_anims() {
  ...
  if(getDvar("intro_mask") == "0") {
    ...
    level.scr_anim["rorke"]["cornered_intro_rorke_2_start"] = % cornered_level_intro_merrick_start;
    level.scr_anim["rorke"]["cornered_intro_rorke_2_end"] = % cornered_level_intro_merrick_end;
    level.scr_anim["rorke"]["cornered_level_intro_merrick_loop"][0] = % cornered_level_intro_merrick_loop;
    level.scr_anim["rorke"]["cornered_level_intro_merrick_start_mask"] = % cornered_level_intro_merrick_start_mask;
  }
  ...
  maps\_anim::addnotetrack_notify("generic", "keegan_vo_line", "notify_vo_line");
  ...
  level.scr_anim["rorke"]["cornered_office_baker_enter"] = % cornered_office_baker_enter;
  ...
  level.scr_anim["baker"]["cornered_office_enter"] = % cornered_office_rorke_enter;
  ...
  level.scr_anim["vargas"]["cornered_office_vargas_enter"] = % cornered_office_vargas_enter;
  level.scr_anim["rorke"]["cornered_stairs"] = % cnd_stair_escape_ally1;
  level.scr_anim["baker"]["cornered_stairs"] = % cnd_stair_escape_ally2;
  ...
  maps\_anim::addnotetrack_flag("rorke", "shake", "lobby_stairwell_shake", "enter_lobby");
  maps\_anim::addnotetrack_flag("rorke", "door_open", "open_lobby_door", "enter_lobby");
  ...
  maps\_anim::addnotetrack_flag("rorke", "show_chute", "show_ally_chute", "cornered_exfil_ally1");
...
player_anims() {
  ...
  level.scr_model["cornered_player_arms"] = "viewhands_player_gs_stealth";
  level.scr_animtree["cornered_player_legs"] = #animtree;
  level.scr_model["cornered_player_legs"] = "viewlegs_gs_stealth_tapered";
  ...
  level.scr_anim["cornered_player_arms"]["pounce_stand"] = % cornered_inv_tkdn_stand;
  level.scr_animtree["player_rappel_arms"] = #animtree;
  level.scr_model["player_rappel_arms"] = "viewhands_player_gs_stealth";
  level.scr_animtree["player_rappel_legs"] = #animtree;
  level.scr_model["player_rappel_legs"] = "viewlegs_gs_stealth_tapered";
  level.scr_animtree["cornered_player_arms"] = #animtree;
  level.scr_model["cornered_player_arms"] = "viewhands_player_gs_stealth";
  ...
  level.scr_model["player_office"] = "viewhands_player_gs_stealth";
  level.scr_anim["player_office"]["cornered_office_player"] = % cornered_office_player;
  level.scr_animtree["player_bldg_fall"] = #animtree;
  level.scr_model["player_bldg_fall"] = "viewhands_player_gs_stealth";
  level.scr_anim["player_bldg_fall"]["lobby_react_player"] = % cornered_building_fall_lobby_react_player;
  maps\_anim::addnotetrack_flag("player_bldg_fall", "enemy_a", "fall_enemy_a", "lobby_react_player");
  maps\_anim::addnotetrack_flag("player_bldg_fall", "enemy_b", "fall_enemy_b", "lobby_react_player");
  maps\_anim::addnotetrack_flag("player_bldg_fall", "enemy_c", "fall_enemy_c", "lobby_react_player");
  maps\_anim::addnotetrack_flag("player_bldg_fall", "enemy_d", "fall_enemy_d", "lobby_react_player");
  maps\_anim::addnotetrack_flag("player_bldg_fall", "enemy_e", "fall_enemy_e", "lobby_react_player");
  ...
  maps\_anim::addnotetrack_flag("player_bldg_fall", "enemy_f", "fall_enemy_f", "cornered_building_fall_slide_player");
  ...
  maps\_anim::addnotetrack_flag("player_bldg_fall", "show_chute", "show_player_chute", "cornered_exfil_player");
  maps\_anim::addnotetrack_flag("player_bldg_fall", "start_building", "go_exfil_bldg", "cornered_exfil_player");
  level.scr_anim["player_bldg_fall"]["cornered_exfil_fail_player"] = % cornered_exfil_fail_player;
  level.scr_animtree["player_bldg_fall_legs"] = #animtree;
  level.scr_model["player_bldg_fall_legs"] = "viewlegs_gs_stealth_tapered";
...
prop_anims() {
  ...
  level.scr_anim["zipline_launcher"]["zipline_launcher_setup_baker"] = % cornered_intro_launcher1_setup;
  level.scr_anim["zipline_launcher"]["zipline_launcher_setup_player"] = % cornered_intro_launcher2_setup;
  level.scr_anim["zipline_launcher"]["zipline_launcher_setup_rorke"] = % cornered_intro_launcher3_setup;
  ...
  level.scr_anim["cnd_rappel_tele_rope"]["cornered_inv_tkdn_pounce_baker"] = % cornered_inv_tkdn_pounce_baker_rope;
  level.scr_anim["cnd_rappel_tele_rope"]["cornered_inv_tkdn_baker_rope_loop"][0] = % cornered_inv_tkdn_baker_rope_loop;
  ...
  level.scr_animtree["festival_balloon"] = #animtree;
  level.scr_model["festival_balloon"] = "generic_prop_raven";
  level.scr_anim["festival_balloon"]["cornered_balloon_wiggle"][0] = % cornered_balloon_wiggle;
  ...
  level.scr_anim["lobby_objects"]["cornered_building_fall_debris_office_a"] = % cornered_building_fall_debris_office_a;
  ...
  maps\_anim::addnotetrack_flag("bldg_shake_rubble", "rubble_start", "start_falling_debris", "cornered_building_fall_lobby_celling_debris");
  ...
  level.scr_anim["exfil_bldg"]["cornered_building_fall_lobby_door"] = % cornered_building_fall_lobby_door;
  level.scr_animtree["exfil_sign"] = #animtree;
  level.scr_anim["exfil_sign"]["cornered_exfil_sign"] = % cornered_exfil_sign;
...
addnotetrack_cornered(var_0, var_1, var_2, var_3) {
  var_1 = tolower(var_1);
