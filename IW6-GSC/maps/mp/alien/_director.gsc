 ...
 * Script: maps\mp\alien\_director.gsc
***************************************/
...
alien_cloak() {
  ...
  while(1) {
    ...
    self cloak_fx();
    self setModel(original_model + "_cloak");

    waittill_any_timeout(1, "jump_finished", "damage");
