...
main(var_0) {
  ...
  switch (var_0) {
    ...
    case "script_vehicle_m1a1_abrams_minigun":
      setallvehiclefx(var_0, "fx/treadfx/tread_dust_hamburg_cheap");
    ...
    case "script_vehicle_ny_blackhawk":
      setallvehiclefx(var_0, "fx/treadfx/heli_dust_default");
...
setvehiclefx(var_0, var_1, var_2) {
  maps\_vehicle::set_vehicle_effect(var_0, var_1, var_2);
}
