 ...
 * Script: zm_common\gametypes\zsurvival_collapse.gsc
******************************************************/
...
function function_549c8ed1(v_location, n_radius, n_height, n_time) {
  ...
  var_c3ad43e6 = {
    #trigger: var_8bfc79f8, #n_time: n_time
  };
...
function function_3ff09157(var_36b79a75, n_current_time, b_inside) {
  ...
  if(getdvarint(#"hash_efbcdc90002337", 0)) {
    ...
    if(isDefined(var_9d01657b) && isDefined(var_5c77052c) && isDefined(n_radius)) {
      if(b_inside) {
        debug2dtext((300, 600, 0), "<dev string:x8e>" + (isDefined(n_current_time) ? n_current_time : 0) + "<dev string:xac>" + n_max_time, (1, 0, 0));
        print3d(var_5c77052c + (0, 0, 40), "<dev string:xb1>" + (isDefined(n_current_time) ? n_current_time : 0) + "<dev string:xac>" + n_max_time, (1, 0, 0), undefined, 0.1, 1, 1);
        cylinder(var_5c77052c, var_9d01657b, n_radius, (1, 0, 0), undefined, 1);
        return;
      }

      print3d(var_5c77052c + (0, 0, 40), "<dev string:xb1>" + (isDefined(n_current_time) ? n_current_time : 0) + "<dev string:xac>" + n_max_time, (0, 1, 0), undefined, 0.25, 1, 1);
