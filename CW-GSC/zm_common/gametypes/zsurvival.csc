 ...
 * Script: zm_common\gametypes\zsurvival.csc
***********************************************/
...
function event_handler[gametype_init] main(eventstruct) {
  ...
  clientfield::register_clientuimodel("hudItems.playerLivesRemaining", #"hud_items", #"playerlivesremaining", 1, 3, "int", undefined, 0, 0);
  clientfield::register_clientuimodel("hudItems.playerCanRedeploy", #"hud_items", #"playercanredeploy", 1, 1, "int", undefined, 0, 0);
  clientfield::register_clientuimodel("hudItems.zombiesSurvivalRespawn", #"hud_items", #"zombiessurvivalrespawn", 1, 1, "int", undefined, 0, 0);
  clientfield::function_5b7d846d("hudItems.warzone.collapse", #"warzone_global", #"collapse", 1, 21, "int", undefined, 0, 0);
  clientfield::function_5b7d846d("hudItems.warzone.waveRespawnTimer", #"warzone_global", #"waverespawntimer", 1, 21, "int", undefined, 0, 0);
