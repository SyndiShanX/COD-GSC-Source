...
function lose_perk(perk) {
  ...
  if(slot != -1 && isDefined(self.var_7864a0f6) && is_true(self.var_7864a0f6.a_b_vapors[slot]) && !self zm_perks::function_e56d8ef4(perk)) {
...
function function_776fbeaf(s_params) {
  if(is_true(self.var_fbc66a96) && isDefined(self.var_7864a0f6) && isarray(self.var_7864a0f6.a_b_vapors) && isarray(self.var_7864a0f6.var_6fdc9c9c)) {
