...
function private on_begin(var_e097dc07, var_f5300808) {
  ...
  switch (var_e097dc07) {
    ...
    case # "hash_7416cabf26f52c5f":
      ...
      allowed_weapons = arraycombine(allowed_weapons, array(#"ww_random_ray_gun1", #"ww_random_ray_gun2", #"ww_random_ray_gun2_charged", #"ww_random_ray_gun3", #"ww_random_ray_gun3_charged"), 0, 0);
      var_fda63ae3 = function_f1dd7bf8(array("pistol_standard_t8", "pistol_burst_t8", "pistol_revolver_t8"));
      level zm_trial::function_25ee130(1);
      break;
...
function is_active(var_1eb3fec6 = 0) {
  if(var_1eb3fec6 && is_true(level.b_special_weapons)) {
    return false;
  }
