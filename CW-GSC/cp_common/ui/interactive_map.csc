 ...
 * Script: cp_common\ui\interactive_map.csc
***********************************************/
  ...
  while(true) {
    ...
    if(!is_true(function_125940c8())) {
      if(var_52665581) {
        ...
        cursor_delta *= (isDefined(function_2ff81eb2("state")) ? function_2ff81eb2("state") : 0) < 0 ? 1 : 0.66;
        cursor_pos += cursor_delta;
      } else {
        cursor_delta = function_6593be12(localclientnum);
        cursor_pos += cursor_delta;
