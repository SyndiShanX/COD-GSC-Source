 ...
 * Script: zm\zm_tungsten_end_fight.gsc
***********************************************/
...
function init() {
  ...
  foreach(struct in struct::get_array(level.var_75a7d6.target)) {
    ...
    if(struct.var_fdd68e6f === #"cannon_le" || struct.var_fdd68e6f === #"cannon_ri") {
...
function function_f11e26f9() {
  ...
  level thread boss_spawn(level.var_75a7d6.s_boss);
...
function function_79868b3b(b_skipped) {
  ...
  level.var_75a7d6.var_815eeaa4[#"disciple"] = [];
  ...
  foreach(struct in struct::get_array(level.var_75a7d6.target)) {
    if(isDefined(struct.var_fdd68e6f)) {
      switch (struct.var_fdd68e6f) {
        ...
        case #"spawn_portal":
        case #"spawn":
          var_9893d55e = [#"zombie", #"tormentor", #"tempest", #"disciple", #"raz", #"mimic", #"mechz", #"abom"];
        ...
        case #"cannon_le":
          ...
          if(isvehicle(var_1280faf3)) {
            zm_sq::objective_set(#"hash_380134b80e0ab939", var_1280faf3, 0, undefined, #"cannon", undefined, &function_ab16ea40);
          }

          foreach(child_struct in struct::get_array(struct.target)) {
            if(child_struct.var_fdd68e6f === #"mount") {
              s_unitrigger = child_struct zm_unitrigger::create(&function_401c03c5, 96);
              zm_unitrigger::function_89380dda(s_unitrigger, 0);
              s_unitrigger.var_98bf27a1 = struct;
              child_struct.var_98bf27a1 = struct;
              level thread function_38e2dcaa(child_struct);
              break;
            }
          }
  ...
  level.var_75a7d6 flag::set(#"mechz_disabled");
  ...
  boss_spawn(level.var_75a7d6.s_boss);
...
function function_ec198408(b_skipped, var_19e802fa) {
  ...
  level.check_end_game_override = &check_end_game_override;
...
function check_end_game_override(e_player) {
  return true;
}
...
function play_intro_vo() {
  ...
  wait 1;
  level.var_75a7d6 flag::set(#"intro_vo_done");
}
...
function function_e324aad2() {
  ...
  foreach(struct in struct::get_array(level.var_75a7d6.target)) {
    if(struct.var_fdd68e6f === #"capture") {
      level.var_75a7d6.var_a17b2556 = util::spawn_model(#"p9_zm_tungsten_capture_cage", struct.origin, struct.angles);
      level.var_75a7d6.var_b9f89aa6 = util::spawn_model(#"p9_fxanim_zm_tungsten_capture_cage_mod", struct.origin, struct.angles);
...
function function_7ed3f4dd(var_a07ea3db) {
  ...
  while(true) {
    var_ce34262e = spawncollision(#"collision_bullet_256x256x256", "roots_shoot", level.var_75a7d6.mdl_body gettagorigin(str_tag), (0, 0, 0));
    ...
    if(isPlayer(e_attacker) || var_9b676843) {
      ...
      if(var_9b676843) {
        if(var_a8c53cf5) {
          ...
          var_982513ee = 1;
          level thread function_f83c329c(#"cannon_blocked", 0, 0.5, {
            #str_id: #"cannon_blocked", #n_time: 60
          }, 0);
        }
      ...
      if(!var_982513ee) {
        if(!var_a8c53cf5) {
          ...
          if(var_fd8ded06.health <= 0) {
            ...
            level thread weakpoint_regen(var_fd8ded06);
          }
        }
      }
...
function weakpoint_regen(var_fd8ded06) {
...
function function_6074ced6() {
  ...
  level function_f83c329c(#"cannon_failed", 0, 0, {
    #str_id: #"cannon_failed", #n_time: 5
  }, 0);
  wait 0.5;
  level function_f83c329c(#"weakpoint_regen", 1, 0, {
    #str_id: #"weakpoint_regen", #n_time: 60
  });
...
function weakpoint_destroyed(var_a07ea3db) {
  ...
  switch (var_a07ea3db) {
    case #"left":
      ...
      level.var_75a7d6 flag::clear(#"tempest_disabled");
  ...
  if(level.var_75a7d6 flag::get_all([#"hash_12678fff6a404d29", #"hash_48bc8345fad29b74"])) {
    level.var_75a7d6 flag::set(#"arms_destroyed");
  }
  ...
  if(level.var_75a7d6 flag::get(#"arms_destroyed")) {
  ...
  if(!level.var_75a7d6 flag::get(#"head_destroyed")) {
    if(level.var_75a7d6 flag::get(#"stomach_destroyed")) {
...
function function_4a0ebe24(var_a07ea3db) {
  ...
  if(var_a07ea3db == #"stomach") {
    ...
    while(true) {
      ...
      v_move += v_right * var_d7015271;
      v_move += v_up * var_5b6e1d07;
...
function function_768e1bba() {
  ...
  wait 2;
  level function_f83c329c(#"cannon_success", 0, 0, undefined, 0, 1);
  wait 2;
  level function_fee3db9("bf_fsnrtv75_fskn_0", 1);
  level.var_75a7d6 flag::decrement(#"priority_vo");
  level.var_75a7d6 flag::wait_till(#"stomach_destroyed");
  level.var_75a7d6 flag::increment(#"priority_vo");
  wait 2;
  level function_f83c329c(#"cannon_success", 0, 0, undefined, 0, 1);
  wait 2;
...
function function_60c68651() {
  ...
  foreach(str_id in [#"ground", #"frost", #"mine", #"eyes", #"cannon_charged", #"cannon_blocked", #"cannon_failed", #"cannon_success", #"weakpoint_regen", #"maxis_move", #"maxis_100", #"maxis_75", #"maxis_50", #"maxis_25"]) {
    switch (str_id) {
      case #"ground":
...
function function_f83c329c(str_id, var_2adc0309 = 0, n_delay = 0.5, var_591caa3e, var_127a2393 = 1, var_a78cf3d4 = 0) {
  ...
  if(!level.var_75a7d6 flag::get(#"intro_vo_done")) {
    return;
  }
...
function function_fee3db9(str_shot, var_a78cf3d4 = 0) {
  ...
  if(!var_a78cf3d4 && level.var_75a7d6 flag::get_any([#"priority_vo", #"boss_talking"])) {
    return;
  }

  level endon(#"end_game");
  level.var_75a7d6 flag::increment(#"boss_talking");
  a_ents[#"head"] = level.var_75a7d6.mdl_head;
  level.var_75a7d6.mdl_anchor scene::play(#"hash_4dae4f482421b3ed", str_shot, a_ents);
  level.var_75a7d6.mdl_anchor thread scene::play(#"hash_4dae4f482421b3ed", "idle", a_ents);
  waitframe(1);
  level.var_75a7d6 flag::decrement(#"boss_talking");
}
...
function function_3d5eabf(str_shot) {
  ...
  wait 2;
  level thread function_f83c329c(#"cannon_success", 0, 0, undefined, 0);
  wait 3;
  ...
  var_abe648f0 = {
    #origin: level.var_75a7d6.s_boss.origin, #radius: 9999, #n_start: 0, #var_efc4d374: 0.4, #n_duration: 4
  };
  ...
  level.var_75a7d6 flag::clear(#"mechz_disabled");
...
function function_4346157c(var_9161d39c = #"", b_play_vo = 1) {
  ...
  if(var_9161d39c != #"") {
    if(!isDefined(level.var_75a7d6.var_9d7dfc4c) && !level.var_75a7d6 flag::get(#"arms_destroyed")) {
    ...
    if(level.var_75a7d6 flag::get(#"stomach_destroyed")) {
      var_190b1087 = 7;
    } else if(level.var_75a7d6 flag::get(#"arms_destroyed")) {
      var_190b1087 = 10;
    }
  ...
  if(level.var_75a7d6.var_9d7dfc4c === #"hash_4a50cd145965b8cd" || level.var_75a7d6 flag::get(#"arms_destroyed") && (var_9161d39c != #"eyes" || level.var_75a7d6.var_1ec89ecd[#"eyes"] + 1 <= 1)) {
  ...
  if(isDefined(level.var_75a7d6.var_9d7dfc4c)) {
    switch (level.var_75a7d6.var_9d7dfc4c) {
      case #"hash_35eefe12894036fd":
        if(isinarray(var_acd1a5c4, #"ground_le") || isinarray(var_acd1a5c4, #"ground_ri")) {
  ...
  if(isDefined(var_b5714783)) {
    switch (var_b5714783) {
      ...
      case #"ground_le":
        ...
        arrayremovevalue(var_acd1a5c4, #"ground_le");
        arrayremovevalue(var_acd1a5c4, #"ground_ri");
        var_b5714783 = #"ground";
        break;
      case #"mine":
...
function function_eadf62a1() {
  ...
  if(!level.var_75a7d6 flag::get(#"hash_12678fff6a404d29")) {
    ...
    var_2cb97f5a[var_2cb97f5a.size] = #"ground_le";
  }
  ...
  if(!level.var_75a7d6 flag::get(#"hash_48bc8345fad29b74")) {
    ...
    var_2cb97f5a[var_2cb97f5a.size] = #"ground_ri";
  }
  ...
  return {
    #var_2cb97f5a: var_2cb97f5a, #var_abef106b: var_abef106b
  };
}
...
function function_360256d0(str_side, b_play_vo = 1) {
  ...
  if(b_play_vo) {
    level thread function_f83c329c(#"ground", 1, 0.5, {
      #str_id: #"boss_attack", #n_time: 30
    });
  }

  level waittilltimeout(10, #"roots_smash");
...
function function_5db5dfb(var_7434cb7d) {
  ...
  for(i = 0; i < 7; i++) {
    for(j = 0; j < 5; j++) {
      ...
      if(isvec(v_navmesh)) {
        var_943c7562 = {
          #origin: v_navmesh, #a_v_points: [v_navmesh]
        };
...
function function_9df1d3c8(s_spawn) {
  ...
  var_4e1bd1ba flag::clear(#"postfx_enabled");
  var_4e1bd1ba flag::clear(#"slow_enabled");
  wait 1;
...
function function_775a15ec() {
  ...
  while(true) {
    ...
    foreach(var_4e1bd1ba in level.var_75a7d6.var_1aa34baf) {
      if(isDefined(var_4e1bd1ba) && var_4e1bd1ba flag::get_any([#"postfx_enabled", #"slow_enabled"])) {
        n_dist = distancesquared(self.origin, var_4e1bd1ba.origin);

        if(var_4e1bd1ba flag::get(#"postfx_enabled") && !var_17f4a48e && n_dist <= sqr(250)) {
          var_17f4a48e = 1;
        }

        if(var_4e1bd1ba flag::get(#"slow_enabled") && !var_67c43623 && n_dist <= sqr(250)) {
          var_67c43623 = 1;
        }
...
function function_2dc91d9f() {
  ...
  if(!level.var_75a7d6.var_c20e460e flag::get(#"charging_cannon")) {
    var_135e3159 = level.var_75a7d6.var_c20e460e.var_529d63dd[3];

    if(isstruct(var_135e3159)) {
      maxis_move(var_135e3159.origin, var_135e3159.angles, var_135e3159);
...
function function_cdc05f45(var_973c5c71 = 0, var_bad95e69 = 1) {
  ...
  while(true) {
    if(var_973c5c71) {
      ...
      if(!level.var_75a7d6 flag::get(#"intermission")) {
        level thread function_f83c329c(#"maxis_move", 0, 0.5, {
          #str_id: #"maxis_generic", #n_time: 5
        });
      }
    }
    ...
    maxis_move(var_135e3159.origin, var_135e3159.angles, var_135e3159, undefined, undefined, var_bad95e69);
    var_bad95e69 = 1;
  }
}
...
function function_7c6aaab3(var_bad95e69 = 1, var_58a45754 = 0) {
  ...
  if(isstruct(s_safe)) {
    maxis_move(s_safe.origin, s_safe.angles, undefined, undefined, 400, var_bad95e69, var_58a45754);
  }
}
...
function maxis_move(v_dest, v_angles, var_135e3159, var_2dba142c = 0, n_speed = 300, var_bad95e69 = 1, var_58a45754 = 1) {
...
function function_1f80b24d() {
  ...
  while(true) {
    ...
    if(level.var_75a7d6.var_c20e460e flag::get(#"radius_on") && isDefined(var_2644aca3) && distance2dsquared(self.origin, var_2644aca3.origin) <= sqr(256)) {
      self flag::clear(#"hash_21fe92f29511661c");
...
function function_1c6d2370() {
  ...
  if(level.var_75a7d6 flag::get(#"defeated") || level.var_75a7d6.var_c20e460e flag::get(#"charging_cannon") || level.var_75a7d6.var_c20e460e.var_8a337eba < level.var_75a7d6.var_c20e460e.var_3887bcb7) {
    return;
  }
  ...
  level.var_75a7d6.var_c20e460e flag::set(#"charging_cannon");
  ...
  maxis_move(mdl_charge.origin, mdl_charge.angles, undefined, 1, n_speed, var_bad95e69);
  ...
  level.var_75a7d6.var_c20e460e.var_8a337eba = 0;
  function_4ba59ffe();
  level thread function_f83c329c(#"cannon_charged", 0, 0, {
    #str_id: #"cannon_charged", #n_time: 30
  });
  level.var_75a7d6.var_c20e460e.mdl_anchor scene::play(#"hash_5b405bfccbbf2def", "cannon_out", a_ents);
  level.var_75a7d6.var_c20e460e flag::clear(#"charging_cannon");
  function_9965670d();
...
function function_35058c30() {
  ...
  if(!level.var_75a7d6 flag::get(#"intro_vo_done") || level.var_75a7d6 flag::get_any([#"defeated", #"intermission"]) || level.var_75a7d6.var_c20e460e flag::get(#"hash_58ea62b85fb9afed")) {
    return;
  }

  wait 1;

  if(!level.var_75a7d6.var_c20e460e flag::get(#"hash_58ea62b85fb9afed") && level.var_75a7d6.var_c20e460e flag::get(#"charging_cannon") && !function_ef8d1319()) {
...
function function_9965670d() {
  level.var_75a7d6.var_c20e460e flag::set(#"radius_on");
...
function function_9a39a4c() {
  level.var_75a7d6.var_c20e460e flag::clear(#"radius_on");
...
function function_733c1a3f(s_params) {
  ...
  if(!level.var_75a7d6 flag::get_any([#"defeated", #"intermission", #"boss_talking"])) {
    str_vo = #"maxis_100";
    ...
    level thread function_f83c329c(str_vo, 0, 0.5, {
      #str_id: #"maxis_generic", #n_time: 10
    }, 0);
  }
}
...
function function_bc6c4c25(s_params) {
  ...
  if(isPlayer(e_player)) {
    e_player val::reset_all(#"laser_cannon");
    e_player.var_f22c83f5 = undefined;
  }
}
...
function function_57858b58(var_98bf27a1) {
  ...
  if(isPlayer(var_3ef4b5cf)) {
    var_3ef4b5cf val::set(#"laser_cannon", "ignoreme", 1);
    var_3ef4b5cf val::set(#"laser_cannon", "takedamage", 0);
    var_3ef4b5cf val::set(#"laser_cannon", "allowdeath", 0);
  }
  ...
  var_abe648f0 = {
    #origin: var_1280faf3.origin, #radius: 1024, #n_start: 0, #var_efc4d374: 0.3, #n_duration: 2
  };
  level thread function_a7978694(var_abe648f0);
  ...
  var_abe648f0 = {
    #origin: var_1280faf3.origin, #radius: 1024, #n_start: 0.4
  };
  level thread function_a7978694(var_abe648f0);
  ...
  var_abe648f0 = {
    #origin: var_1280faf3.origin, #radius: 1024, #n_start: 0.4, #var_efc4d374: 0, #n_duration: 1, #var_2d65be8d: 1
  };
  level thread function_a7978694(var_abe648f0);
  level thread function_2bc1ab1(var_1280faf3.origin);
  wait 1;
...
function function_866fc84d(var_98bf27a1) {
  ...
  level thread function_f83c329c(#"cannon_failed", 0, 0.5, {
    #str_id: #"cannon_failed", #n_time: 30
  }, 0);
}
...
function function_a831c582(str_ai) {
  ...
  switch (str_ai) {
    case #"abom":
      ...
      return {
        #str_flag: #"hash_15ced8000939a79b", #n_time: n_time
      };
    case #"mechz":
      switch (n_players) {
        case 1:
    ...
    case #"tormentor":
      ...
      return {
        #str_flag: #"hash_3cd746b1b8037a98", #n_time: n_time
      };
    case #"raz":
      switch (n_players) {
        case 1:
    ...
    case #"mimic":
      ...
      return {
        #str_flag: #"hash_51c765cb33419613", #n_time: n_time
      };
  }
}
    ...
    if(math::cointoss(5)) {
      ...
      if(!isDefined(str_flag) || !level.var_75a7d6 flag::get(str_flag)) {
        ...
        if(isDefined(var_1010e70f) && getaiarchetypearray(#"soa").size < var_1010e70f) {
          s_spawn = get_spawn(#"disciple", var_41ca011b);
    ...
    if(math::cointoss(5)) {
      ...
      if(!isDefined(str_flag) || !level.var_75a7d6 flag::get(str_flag)) {
        ...
        if(isDefined(var_60625635) && getaiarchetypearray(#"tormentor").size < var_60625635) {
          ...
          if(isstruct(s_spawn)) {
            return {
              #str_ai: #"tormentor", #s_spawn: s_spawn
            };
          }
        }
      }
...
function boss_outro() {
  ...
  if(level.var_75a7d6.var_c20e460e.var_135e3159 !== var_1bb57bae) {
    level thread maxis_move(var_1bb57bae.origin, var_1bb57bae.angles);
  }
...
function function_96a74deb() {
  level endon(#"end_game");
  wait 4;
  gestures::function_ba4529d4(#"ges_t9_blind_reaction");
...
function function_c69bc55b(e_player) {
  ...
  if(e_player isgestureplaying(#"ges_t9_blind_reaction")) {
...
function function_26a3bcef(var_d2ee34ea) {
  ...
  while(true) {
    ...
    mdl_crystal = util::spawn_model(#"p9_sur_holdout_crystal_01", var_d2ee34ea.origin + (0, 0, 4096), var_d2ee34ea.angles);
...
function devgui_setup() {
  ...
  util::add_debug_command("<dev string:x9b>");
  util::add_debug_command("<dev string:x102>");
  util::add_debug_command("<dev string:x163>");
  util::add_debug_command("<dev string:x1c4>");
  util::add_debug_command("<dev string:x221>");
