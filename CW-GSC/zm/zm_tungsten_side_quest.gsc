 ...
 * Script: zm\zm_tungsten_side_quest.gsc
***********************************************/
...
function init() {
  ...
  clientfield::register("scriptmover", "" + # "dome_shader", 28000, 1, "int");
...
function function_64969e00() {
  var_638ed7d7 = {
    #nodes: [], #start: struct::get("grand_prix_racetrack_start")
  };
  var_15a51335 = var_638ed7d7.start;

  var_e542c08f = undefined;
  var_e6336354 = "<dev string:x38>";
  ...
  if(!isDefined(var_15a51335)) {
    str_msg = "<dev string:x56>" + (isDefined(var_e6336354) ? var_e6336354 : "<dev string:x7f>") + "<dev string:x8c>" + (isDefined(var_e542c08f) ? var_e542c08f : "<dev string:x7f>");
    assertmsg(str_msg);
  }

  assert(var_15a51335 === var_638ed7d7.start, "<dev string:x99>");
  assert(var_638ed7d7.checkpoints.size > 1, "<dev string:xb7>");
...
function function_c6fdb204(var_15a51335) {
  ...
  var_15a51335.axis = {
    #right: anglestoright(var_15a51335.angles)
  };
  ...
  while(!var_57850891) {
    ...
    for(i = 0; i < n_total; i++) {
      ...
      if(isDefined(var_55935bba)) {
        ...
        var_38811eba = e_vehicle.var_5b345137 + "<dev string:xee>" + 3;
        var_9ac6b2ac = "<dev string:xf3>" + n_player + "<dev string:xfe>" + i + 1 + "<dev string:xee>" + n_total + "<dev string:x10b>" + var_38811eba;
        var_f5eb67b0 = sqrt(var_55935bba.dist_to_next);
        var_ba0b397c = "<dev string:x114>" + var_55935bba.node.index + "<dev string:x123>" + var_f5eb67b0;
        str_checkpoint = "<dev string:x133>" + e_vehicle.next_checkpoint;
        debug2dtext((900, 600 + i * 30, 0), var_9ac6b2ac + var_ba0b397c + str_checkpoint, v_color);
      }
    }
  }
...
function function_e951ccfe(var_15a51335, n_time) {
  ...
  str_node = var_15a51335.targetname;

  if(!isDefined(self.var_2ab8445c[str_node])) {
    self.var_2ab8445c[str_node] = {
      #node: var_15a51335
    };
  }
  ...
  if(var_ce9da91e.node === var_638ed7d7.checkpoints[self.next_checkpoint] && var_ce9da91e.var_1a4cb070 < 1600) {
    if(self.next_checkpoint == 0) {
      if(self.var_5b345137 < 3) {
        ...
        self.var_4290ff97 = {
          #time: var_ce9da91e.last_update, #dist: var_ce9da91e.var_1a4cb070
        };
        ...
        level notify(#"hash_51adedadaedb6ebd", {
          #vehicle: self, #record: self.var_4290ff97
        });
        return;
      }
    }

    level notify(#"hash_4847149e99d2b54", {
      #vehicle: self, #checkpoint: self.next_checkpoint, #lap: self.var_5b345137
    });
...
function function_9afd667d() {
  ...
  while(true) {
    ...
    if(n_dot < 0.5 && abs(self getspeed()) < 0.2) {
      ...
      iprintlnbold("<dev string:x141>" + self getentnum() + "<dev string:x158>" + var_59af9d7a);
...
function function_ec243299() {
  ...
  for(var_ca3231c5 = 0; var_ca3231c5 < 3; var_ca3231c5++) {
    wait 1;
    level.var_579617db[var_ca3231c5] setModel(#"p9_zm_tungsten_screen_red");
  ...
  array::run_all(level.var_579617db, &setmodel, #"p9_zm_tungsten_screen_green");
  arrayremovevalue(level.var_3ab17de8, undefined);
...
function function_371733c() {
  ...
  assert(var_4347cdf6.size >= a_players.size, "<dev string:x169>");
...
function function_39a8cd0f() {
  self clientfield::increment("" + # "gp_explode");
...
function function_1fe4ebed(var_a276c861, var_19e802fa) {
  ...
  foreach(player in a_players) {
    if(isDefined(player)) {
      ...
      player thread zm_fasttravel::function_66d020b0(undefined, undefined, undefined, undefined, {
        #origin: player.origin, #angles: player.angles
      }, undefined, "grand_prix_teleport");
    }
  }
...
function function_42c605b5() {
  ...
  if(!isDefined(level.var_a266b15d)) {
    ...
    level.var_a266b15d = util::spawn_model(#"p9_zm_tungsten_dark_aether_crystal_plane", var_89e55ea4.origin, var_89e55ea4.angles);
  }
        ...
        switch (var_e15e9f2a) {
          case 1:
            level scoreevents::doscoreeventcallback("scoreEventZM", {
              #attacker: self.owner, #scoreevent: "essence_pickup_small"});
            break;
          case 2:
    ...
    if(isPlayer(player) && waitresult.mod === "MOD_EXPLOSIVE" && player namespace_e86ffa8::function_582d36be(5) && isDefined(damage) && damage >= 35) {
      ...
      if(isDefined(var_ca57b8dd)) {
        ...
        if(isvec(var_2077a964) && isDefined(mdl_reward)) {
          ...
          drop_time = mdl_reward zm_utility::fake_physicslaunch(var_2077a964, n_power);
...
function function_8f75cb6a(var_a276c861) {
  ...
  var_bb9fd562.var_af44ab5f = util::spawn_model(#"p9_zm_platinum_magic_box_bunny", var_bb9fd562.origin, var_bb9fd562.angles);
...
function function_ef77607f() {
  ...
  var_d0426a23.var_97d37415 clientfield::set("" + # "dome_shader", 1);
...
function function_7b92ffd7(entity) {
  namespace_85745671::cleanup_attackable(entity);
  ...
  if(isDefined(entity.var_97d37415)) {
    entity.var_97d37415 clientfield::set("" + # "dome_shader", 0);
...
function function_7d36e498() {
  ...
  while(true) {
    ...
    if(isPlayer(waitresult.attacker)) {
      level notify(#"hash_452cf48337ae8aff", {
        #entity: self
      });
      wait 1;
    }
...
function function_4d5c7397(var_a276c861) {
  ...
  var_55c78eeb.mdl = util::spawn_model(#"p9_zm_tungsten_screen_green", var_55c78eeb.origin, var_55c78eeb.angles);
  ...
  var_55c78eeb.mdl setModel(#"p9_zm_tungsten_screen_red");
  ...
  while(true) {
    ...
    if(isDefined(spawn_loc)) {
      ...
      if(is_true(zm_zonemgr::zone_is_enabled(zone)) && is_true(level.zones[zone].is_active) && zm_utility::check_point_in_playable_area(spawn_loc)) {
        iprintlnbold(spawn_loc[0] + "<dev string:x28f>" + spawn_loc[1] + "<dev string:x28f>" + spawn_loc[2]);
...
function function_37597f29() {
  util::add_debug_command("<dev string:x294>");
  util::add_debug_command("<dev string:x2ea>");
  util::add_debug_command("<dev string:x33a>");
  util::add_debug_command("<dev string:x38d>");
  util::add_debug_command("<dev string:x3ea>");
  util::add_debug_command("<dev string:x456>");
...
function cmd(cmd) {
  switch (cmd) {
    ...
    case # "hash_3a4ae233094bafaf":
      ...
      function_212b0926(1, 1);
      var_b510e160 = struct::get_array("<dev string:x4cf>", "<dev string:x4e0>");
      level.var_6627533b = [];
