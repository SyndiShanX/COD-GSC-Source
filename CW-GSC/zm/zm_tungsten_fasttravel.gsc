 ...
 * Script: zm\zm_tungsten_fasttravel.gsc
***********************************************/
...
function private function_ee59489c(var_331b7cc3, origin, instance) {
  ...
  level thread function_a70fa155(level.var_fdcaf3a6.var_e55c8b4e, #"hash_53c181b5f1f2760f", array(level.var_117d5f10), level.var_dc2ca204, #"exfil_complete");
}