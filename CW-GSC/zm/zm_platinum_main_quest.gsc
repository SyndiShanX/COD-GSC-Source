 ...
 * Script: zm\zm_platinum_main_quest.gsc
***********************************************/
...
function init() {
  ...
  clientfield::register("actor", "" + # "zombie_soul", 24000, 1, "int");
  ...
  zm_utility_zsurvival::function_6e9bb6b5(undefined, undefined, "vol_portal_restrict");

  level thread function_cd7a3de4();
}

function function_e983f15a() {
  level zm_sq::register(#"platinum_main_quest", #"hash_587e74fe327f43fb", #"hash_342e10211feb6e85", &function_336abb75, &function_4cd9b9c);
  level zm_sq::register(#"platinum_main_quest", #"hash_428542f9f5e07c8e", #"hash_342e0d211feb696c", &function_775253af, &function_f795ca1);
  level zm_sq::register(#"platinum_main_quest", #"hash_2eee1c712127c1ca", #"hash_342e0e211feb6b1f", &function_2ca830c2, &function_6dbba0a7);
  level zm_sq::register(#"platinum_main_quest", #"hash_4b1700b8df69481b", #"hash_342e0b211feb6606", &function_78368ca1, &function_3d1b0280);
  level zm_sq::register(#"platinum_main_quest", #"hash_63dee3cf914e5e20", #"hash_342e0c211feb67b9", &function_9704287a, &function_ca3d5cd0);
  level zm_sq::register(#"platinum_main_quest", #"hash_19376fa43a7e085c", #"hash_342e09211feb62a0", &function_4e719111, &function_a7935e0c);
  level zm_sq::register(#"platinum_main_quest", #"hash_58a40205ad8ede62", #"hash_342e0a211feb6453", &namespace_4e8d47b1::function_79868b3b, &namespace_4e8d47b1::function_ec198408);
  level zm_sq::register(#"platinum_main_quest", #"hash_284338cc7c9db648", #"hash_342e17211feb7a6a", &function_70647a4f, &function_24b3acaf, 1);
...
function function_e9c07a3d() {
  level zm_sq::start(#"platinum_main_quest");
}
...
function function_d7f67c90() {
  ...
  assert(var_973936fc.size >= 3, "<dev string:x38>");
...
function function_933074b6() {
  ...
  var_2d3dceb6 = util::spawn_model(#"p9_fxanim_zm_platinum_tempest_machine_lure_mod", (-2951, 14217, -556), (0, 90, 0));
  level flag::wait_till(#"hash_64e189de9593e575");
  var_1440b452 clientfield::set("" + # "hash_41ba39a474a3503f", 0);
...
function function_3fead2ea() {
  ...
  self.mdl_screen = util::spawn_model(#"hash_18ea421c8e112587", self.origin, self.angles);
  self.mdl_screen playSound(#"hash_35a6dba8d4956d39");
  self.mdl_screen playLoopSound(#"zmb_mq_stp5_screen_lp_alarm");
}
...
function function_f8702828() {
  ...
  while(true) {
    ...
    if(isPlayer(waitresult.attacker) && weapon === var_c33e9969 && waitresult.mod !== "MOD_MELEE") {
      level notify(#"hash_3cb4d977beb558f0", {
...
function function_da3ee2e3(var_c5d57dcc) {
  level endon(#"end_game");
  var_5940806d = util::spawn_model(#"p9_zm_platinum_harvest_canister", self.origin, self.angles);
  ...
  if(isPlayer(attacker) || attacker === level.klaus) {
    if(self.archetype === # "avogadro") {
      ...
      if(isDefined(var_ddba2f7e) && is_true(var_ddba2f7e.var_a53d0b46) && !is_true(var_ddba2f7e.var_43456ea9)) {
        ...
        var_ddba2f7e notify(#"tempest_killed");
      }
    }
  }
}
...
function function_65fd08d7(player, index) {
  ...
  iprintlnbold("<dev string:xbb>" + index);
}
...
function function_475abfc5() {
  ...
  self.var_4bbcfae9 = util::spawn_model(#"p9_zm_platinum_harvest_units_machine", self.origin, self.angles);
  self.var_4bbcfae9 disconnectpaths();
  level flag::wait_till("power_on");
  self.light_mdl = util::spawn_model(#"p9_zm_platinum_harvest_units_machine_green_flash", self.origin, self.angles);
...
function function_c080f1c1(s_device) {
  ...
  if(isDefined(var_2a86179)) {
    s_device.var_a3e9fe06 = util::spawn_model(#"p9_zm_platinum_harvest_canister", var_2a86179.origin, var_2a86179.angles);
    ...
    s_device.light_mdl setModel(#"p9_zm_platinum_harvest_units_machine_green");
...
function function_1144f1aa(s_device, player) {
  ...
  s_device.light_mdl setModel(#"p9_zm_platinum_harvest_units_machine_red");
  waitframe(5);
  ...
  level notify(#"hash_7344fe1e5a50e191", {
    #player: player
  });
}
...
function function_ce39a77b() {
  ...
  if(!var_e4dd1a2e) {
    ...
    teleport_loc = function_945bc567(closest_player);

    if(isDefined(teleport_loc) && isDefined(self)) {
      if(self.archetype === # "raz") {
        self zm_ai_utility::function_a8dc3363(teleport_loc);
        self thread zm_ai_raz::function_1f9940b8();
      } else if(self.archetype === # "tormentor") {
        self thread namespace_abfee9ba::function_55413772(teleport_loc);
        wait 1;
        self zm_ai_utility::function_a8dc3363(teleport_loc);
...
function disable_sprint(bool) {
  if(bool) {
    ...
    self val::set(#"carry_canister", "allow_sprint", 0);
    self val::set(#"carry_canister", "allow_jump", 0);
    self val::set(#"carry_canister", "allow_prone", 0);
    return;
  }

  self val::reset(#"carry_canister", "allow_sprint");
  self val::reset(#"carry_canister", "allow_jump");
  self val::reset(#"carry_canister", "allow_prone");
}
...
function function_6012c55c() {
  ...
  while(true) {
    waitresult = self waittill(#"tempest_killed");
    var_d9321608++;

    if(var_d9321608 >= self.var_bcce0aa9) {
      wait 2;
      self.var_a3e9fe06 clientfield::set("" + # "hash_6f292901e2fcaeb3", 1);
      self.var_a3e9fe06 setModel(#"p9_zm_platinum_harvest_canister_off");
...
function function_927a0091(var_16cee4c4 = 0) {
  assert(!isDefined(self.canister), "<dev string:x11f>");

  if(isentity(var_16cee4c4)) {
    canister = var_16cee4c4;
  } else {
    canister = util::spawn_model(#"p9_zm_platinum_harvest_canister_off", (0, 0, 0));
    canister notsolid();
...
function function_3357e2a9(var_6661fde5 = 0) {
  assert(isDefined(self.canister), "<dev string:x158>");
...
function function_75fd7e0() {
  ...
  if(self.canister.var_a1f3366 >= 6) {
    namespace_1b527536::function_7281de4d(#"field_upgrade_canister_item_sr", &function_daec8c25, #"hash_60cb3fd3716d711e", #"ui_icon_zm_field_upgrade_canister", 1, 6, 1);
    return;
  }

  namespace_1b527536::function_7281de4d(#"field_upgrade_canister_item_sr", &function_daec8c25, #"hash_60cb3fd3716d711e", #"ui_icon_zm_field_upgrade_canister", 1, 6, 0);
  ...
  for(i = 0; i < a_zombies.size; i++) {
    ...
    if(isalive(actor) && actor.team === level.zombie_team) {
      if(distance2dsquared(self.origin, actor.origin) <= 250000) {
        if(actor.zm_ai_category === # "normal") {
      ...
      } else if(actor.zm_ai_category === # "normal") {
...
function function_2b855510() {
  self endon(#"death", #"canister_drop");
...
function function_2a651d2(var_180f7698, var_905df4de, var_205b8171) {
  ...
  level.var_48d07d1f.var_ec0d861e[#"rico_card"] = var_fd260ca3;
...
function function_bb082beb(var_e7b30689 = 0, var_cfea0f34 = 0) {
  ...
  while(true) {
    ...
    if(isarray(self.spawned_zombies)) {
      function_1eaaceab(self.spawned_zombies);
    }
    ...
    if(var_3bca7dbd.size != 0) {
      foreach(zombie in var_3bca7dbd) {
        ...
        if(var_e7b30689) {
          if(isDefined(self.spawned_zombies) && self.spawned_zombies.size != 0) {
            if(!isinarray(self.spawned_zombies, zombie)) {
...
function function_ebd5e2eb() {
  if(isDefined(self.spawned_zombies)) {
    foreach(zombie in self.spawned_zombies) {
      zombie unlink();
...
function function_d8d8efb() {
  ...
  for(i = 0; i < 5; i++) {
    ...
    if(isDefined(spawn_ai)) {
      ...
      if(!isDefined(self.spawned_zombies)) {
        self.spawned_zombies = [];
      } else if(!isarray(self.spawned_zombies)) {
        self.spawned_zombies = array(self.spawned_zombies);
      }

      if(!isinarray(self.spawned_zombies, spawn_ai)) {
        self.spawned_zombies[self.spawned_zombies.size] = spawn_ai;
      }
    }
  }
}
...
function function_f255115() {
  if(!level flag::get(#"hash_40ce269b267d7a50")) {
    spawn_origin = level.var_48d07d1f.var_ec0d861e[#"rico_card"].origin;
    spawn_angles = level.var_48d07d1f.var_ec0d861e[#"rico_card"].angles;
...
function function_16053431() {
  ...
  e_computer.mdl_screen setModel(#"hash_18ea3f1c8e11206e");
  e_computer.mdl_screen playSound(#"zmb_mq_stp5_selection_right");
  e_computer.mdl_screen playLoopSound(#"zmb_mq_stp5_screen_lp");
...
function private function_3caf2b94(var_7bbb033f, str_model, str_sound, var_395f162a, var_a04e2369) {
  ...
  self.mdl_screen setModel(str_model);
  self.mdl_screen playSound(str_sound);
  self.mdl_screen playLoopSound(var_395f162a);
...
function function_6bf79248() {
  ...
  foreach(screen in var_e5635857) {
    util::spawn_model(#"p9_zm_ndu_computer_screen_medical_password", screen.origin, screen.angles);
  ...
  while(true) {
    ...
    foreach(player in a_players) {
      if(distance(var_96a2b4c6.origin, player.origin) < 500 && player.cached_zone_name === "zone_rooftops_start") {
        level notify(#"hash_2f350a6796478d3a", {
          #e_activator: player
        });
        break;
      }
  ...
  while(true) {
    ...
    foreach(player in a_players) {
      if(distance(var_4c0d74cf.origin, player.origin) < 500 && player.cached_zone_name === "zone_ghost_station") {
        level notify(#"hash_1b22030e8582373", {
          #e_activator: player
        });
        break;
      }
  ...
  while(true) {
    ...
    foreach(player in a_players) {
      if(distance(var_cf37d6c7.origin, player.origin) < 500 && player.cached_zone_name === "zone_electronics_store") {
        level notify(#"hash_710553010563fce0", {
          #e_activator: player
        });
        break;
      }
...
function function_4e719111(b_skipped) {
  ...
  while(var_fa3ce073 < var_a7ae334) {
  ...
  iprintlnbold("<dev string:x26c>");
}

function private function_cbdf8397() {
  if(self.subarchetype === # "hash_12fa854f3a7721b9" || self.subarchetype === # "hash_3498fb1fbfcd0cf") {
...
function function_a0128e84(var_b8713e0c) {
  ...
  var_a8bde821.box = util::spawn_model(#"p9_zm_platinum_uranium_corrupted_box", struct::get(var_540b503.target).origin, struct::get(var_540b503.target).angles);
  var_a8bde821.rock = util::spawn_model(#"p9_zm_platinum_uranium_corrupted", struct::get(var_540b503.var_e8ed2abf).origin, struct::get(var_540b503.var_e8ed2abf).angles);
...
function function_f0af1f03(v_start_pos, v_end_pos) {
  var_e0b595fe = util::spawn_model(#"p9_zm_platinum_uranium_cleansed", v_start_pos);
...
function function_12034670() {
  iprintlnbold("<dev string:x29b>");

  self flag::set(#"hash_4af94dbfdea74dfd");
  self.var_e22b6325 = util::spawn_model(#"p9_zm_platinum_uranium_cleansed", self gettagorigin("tag_stowed_back"), self gettagangles("tag_stowed_back"));
...
function function_85112dd6(var_1377a1e8) {
  ...
  var_48ac9424.box = util::spawn_model(#"p9_zm_platinum_uranium_corrupted_box", var_f82db2b.origin, var_f82db2b.angles);
  var_48ac9424.rock = util::spawn_model(#"p9_zm_platinum_uranium_corrupted", var_ed508b9c.origin, var_ed508b9c.angles);
...
function function_ac348e30(v_pos) {
  ...
  var_48ac9424.box = util::spawn_model(#"p9_zm_platinum_uranium_corrupted_box", v_pos + (-1.5, 0, -10));
  var_48ac9424.rock = util::spawn_model(#"p9_zm_platinum_uranium_corrupted", v_pos + (-1.5, 0, -10));
...
function function_d78c944b() {
  if(!isDefined(self.mdl_screen)) {
    self.mdl_screen = util::spawn_model(#"hash_18ea3e1c8e111ebb", self.origin, self.angles);
  } else {
    self.mdl_screen setModel(#"hash_18ea3e1c8e111ebb");
    self.mdl_screen playSound(#"zmb_mq_stp5_selection_wrong");
    self.mdl_screen playLoopSound(#"zmb_mq_stp5_screen_lp_alarm");
  }

  self zm_unitrigger::function_fac87205(#"hash_58ebb0f6cc10122e");
  self.mdl_screen setModel(#"hash_18ea3d1c8e111d08");
  self.mdl_screen playSound(#"zmb_mq_stp5_selection_right");
  self.mdl_screen playLoopSound(#"zmb_mq_stp5_screen_lp");
  level notify(#"hash_32cdc77246645d55");
}

function function_1be639cd() {
  if(!isDefined(self.mdl_screen)) {
    self.mdl_screen = util::spawn_model(#"hash_18ea3d1c8e111d08", self.origin, self.angles);
  } else {
    self.mdl_screen setModel(#"hash_18ea3d1c8e111d08");
  }
...
function function_bb459ba0(params) {
  if(self.subarchetype === # "hash_12fa854f3a7721b9" || self.subarchetype === # "hash_3498fb1fbfcd0cf") {
    level notify(#"hash_3fccc5577b1a9589", {
...
function function_18610fa3(player, enemy) {
  if(self.zm_ai_category === # "elite") {
    level scoreevents::doscoreeventcallback("scoreEventZM", {
      #scoreevent: "retrieve_cannister_elite_kill_zm", #attacker: player, #enemy: enemy
    });
    return;
  }
  ...
  if(self.zm_ai_category === # "special") {
    level scoreevents::doscoreeventcallback("scoreEventZM", {
      #scoreevent: "retrieve_cannister_special_kill_zm", #attacker: player, #enemy: enemy
    });
    return;
  }

  level scoreevents::doscoreeventcallback("scoreEventZM", {
    #scoreevent: "retrieve_cannister_kill_zm", #attacker: player, #enemy: enemy
  });
}
...
function function_a8d60a9c() {
  zm_sq::objective_set(#"hash_6c971ede43d84b27", self.origin);
...
function function_dcaecf14(v_pos) {
  var_41a4d1a0 = util::spawn_model(#"p9_zm_platinum_uranium_corrupted", v_pos + (0, 0, 40));
...
function function_f3b08671() {
  ...
  self.var_7fe8417d = util::spawn_model(#"p9_zm_platinum_uranium_corrupted", self gettagorigin("tag_stowed_back"), self gettagangles("tag_stowed_back"));
...
function event_handler[gadget_on] gadget_on_callback(eventstruct) {
  ...
  if(isPlayer(player) && eventstruct.weapon.name === # "eq_stimshot") {
...
function function_70be7cd6() {
  ...
  level.var_34380a98.box = util::spawn_model(#"p9_zm_platinum_uranium_corrupted_box", struct::get(var_6f9e4297.target).origin, struct::get(var_6f9e4297.target).angles);
  level.var_34380a98.rock = util::spawn_model(#"p9_zm_platinum_uranium_corrupted", struct::get(var_6f9e4297.var_e8ed2abf).origin, struct::get(var_6f9e4297.var_e8ed2abf).angles);
...
function function_70647a4f(b_skipped) {
  ...
  level thread gestures::function_ba4529d4(#"ges_t9_blind_reaction");
  ...
  zm_sq::objective_set(#"hash_4ab92bb68f4c78c9", level.klaus, 1, #"hash_3258f0b2a8184c64");
...
function function_24b3acaf(b_skipped, var_19e802fa) {
  ...
  mdl_portal setModel(#"p9_zm_platinum_portal_ring_off");
...
function function_ccba157(e_player) {
  ...
  e_player stopgestureviewmodel(#"ges_t9_blind_reaction");
...
function function_344ba078() {
  ...
  if(isDefined(v_center)) {
    ...
    while(true) {
      ...
      if(self isfiring() || self isreloading() || !self gestures::function_8cc27b6d(#"ges_t9_blind_reaction")) {
        ...
        if(!self isgestureplaying(#"ges_t9_blind_reaction")) {
          self playgestureviewmodel(#"ges_t9_blind_reaction");
        }
      }

      if(!var_35f9203c && self isgestureplaying(#"ges_t9_blind_reaction")) {
        self stopgestureviewmodel(#"ges_t9_blind_reaction");
      }
...
function function_cd7a3de4() {
  util::add_debug_command("<dev string:x2fa>");
  util::add_debug_command("<dev string:x34b>");
  util::add_debug_command("<dev string:x3a6>");
  util::add_debug_command("<dev string:x407>");
  util::add_debug_command("<dev string:x472>");
  util::add_debug_command("<dev string:x4b9>");
  util::add_debug_command("<dev string:x517>");
  util::add_debug_command("<dev string:x571>");
  ...
  switch (cmd) {
    case # "hash_738c5e6d53b6b2c5":
      if(!isDefined(level.var_48d07d1f.var_ec0d861e[#"train"])) {
        ...
        scene::add_scene_func(#"hash_73a873b0f9cd0894", &function_41ae49d5, "<dev string:x5d5>");
    ...
    case # "hash_20bb7f03866471ed":
      ...
      if(isDefined(var_8841c4a7)) {
        var_8841c4a7 thread scene::play("<dev string:x608>", "<dev string:x637>", var_8841c4a7);
      }
    ...
    case # "hash_7f88d25958b36eb5":
      ...
      foreach(player in getplayers()) {
        zm_items::player_pick_up(player, zm_crafting::get_component("<dev string:x66e>"));
      }
    ...
    case # "collect_board":
      ...
      foreach(player in getplayers()) {
        zm_items::player_pick_up(player, zm_crafting::get_component("<dev string:x695>"));
      }
    ...
    case # "hash_744b2d417a70e285":
      ...
      foreach(player in getplayers()) {
        zm_items::player_pick_up(player, zm_crafting::get_component("<dev string:x6bc>"));
      }
