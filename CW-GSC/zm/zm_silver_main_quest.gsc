 ...
 * Script: zm\zm_silver_main_quest.gsc
***********************************************/
...
function init() {
  ...
  clientfield::register("world", "" + # "falling_concrete", 1, 1, "int");
...
function init_steps() {
  ...
  level zm_sq::register(#"main_quest", #"init_purifier", #"init_purifier", &function_f8065ad8, &function_bdfb3840);
  level zm_sq::register(#"main_quest", #"hash_61ed135b2872c893", #"hash_61ed135b2872c893", &function_6e538fed, &function_2bc04c1);
  level zm_sq::register(#"main_quest", #"recover_container", #"recover_container", &function_7d5e3785, &function_3520ea1b);
  ...
  level zm_sq::register(#"main_quest", #"defend", #"defend", &defend_setup, &function_d7ef969f);
...
function function_58e278a1(t_override = undefined) {
  if(!isDefined(self.mdl_gameobject)) {
    ...
    self.mdl_gameobject gameobjects::allow_use(#"group_all");
...
function function_97000481() {
  ...
  while(isDefined(self)) {
    ...
    if(isPlayer(e_player)) {
      e_player clientfield::increment_to_player("" + # "interact_rumble_small");
    }
...
function init_purifier() {
  ...
  level.var_7c6e836b = util::spawn_model(#"p9_zm_ndu_computer_screen_medical_a", level.var_b2371398.origin, level.var_b2371398.angles);
  ...
  level.var_fc67035a = util::spawn_model(#"p9_zm_ndu_computer_screen_medical_h", level.var_b2371398.origin, level.var_b2371398.angles);
  ...
  level.var_729c7023 = util::spawn_model(#"p9_zm_ndu_computer_screen_medical_v", level.var_b2371398.origin, level.var_b2371398.angles);
...
function function_dd3b6aa2() {
  ...
  level.var_59b6e9a5 setModel(#"p9_zm_ndu_computer_screen_medical_charge");
...
function function_f5edeec7(player, time) {
  if(time >= 2000) {
    self notify(#"hash_323bacd5b189fc1e", {
      #player: player
    });
  }
}
...
function recover_container() {
  ...
  level.var_59b6e9a5 setModel(#"p9_zm_ndu_computer_screen_medical_insert");
  level.var_59b6e9a5 playSound(#"hash_691b9c2488253fde");
  ...
  level notify(#"gold_container_receptacle_off");
...
function defend_setup(b_skipped) {
  if(b_skipped) {
    function_8f85d169();
...
function function_8b8ae486() {
  ...
  if(isDefined(self.stub) && isDefined(self.stub.related_parent)) {
    ...
    level notify(#"gold_container_receptacle_on");

    iprintlnbold("<dev string:x174>");
...
function function_85e60c0a() {
  ...
  level endon(#"end_game", #"container_pickedup");
  wait 60;
  level notify(#"container_reset");
...
function function_7acfbb3a(e_player) {
  e_player endon(#"container_dropped", #"disconnect");
  e_player playSound(#"hash_7de2e7ddb5eb901b");
  e_player val::set(#"carry_container", "disable_weapon_cycling", 1);
  ...
  e_player notify(#"container_dropped", {
    #str_result: "recovered"});
}

function function_f4b436d5() {
  self endon(#"disconnect");
  self.is_drinking = 1;
  self val::set(#"carry_container", "disable_weapon_fire", 1);
  self val::set(#"carry_container", "allow_melee", 0);
  self val::set(#"carry_container", "allow_mantle", 0);
  self val::set(#"carry_container", "allow_sprint", 0);
  self val::set(#"carry_container", "allow_jump", 0);
  self val::set(#"carry_container", "allow_crouch", 0);
  self val::set(#"carry_container", "allow_prone", 0);
  self waittill(#"container_dropped");
  self.is_drinking = 0;
  self val::reset(#"carry_container", "disable_weapon_fire");
  self val::reset(#"carry_container", "allow_melee");
  self val::reset(#"carry_container", "allow_mantle");
  self val::reset(#"carry_container", "allow_sprint");
  self val::reset(#"carry_container", "allow_jump");
  self val::reset(#"carry_container", "allow_crouch");
  self val::reset(#"carry_container", "allow_prone");
}

function function_114098ba(e_player) {
  e_player endon(#"disconnect");
  s_result = e_player waittill(#"container_dropped", #"fake_death");
  callback::remove_on_weapon_change(&function_e9df7768);
  callback::function_824d206(&function_7904960c);
...
function function_50d04ccb() {
  self endon(#"disconnect", #"container_dropped", #"fake_death");
...
function function_2a8262fa() {
  ...
  level.var_59b6e9a5 setModel(#"p9_zm_ndu_computer_screen_medical_secure");
  level.var_59b6e9a5 playSound(#"hash_691b9c2488253fde");
...
function function_41e8018f() {
  ...
  function_8f85d169();
  level.var_59b6e9a5 setModel(#"p9_zm_ndu_computer_screen_medical_commence");
  ...
  level flag::set(#"decontamination_start");
...
function function_8c5dae74() {
  ...
  level.var_59b6e9a5 setModel(#"p9_zm_ndu_computer_screen_medical_blank");
  var_924f0bf0 = struct::get("fml_pht_sploc", "script_noteworthy");
  var_9bb7cfb8 = struct::get("pht_ter", "script_noteworthy");
  var_ccd37052 = struct::get("steiner_phtloc", "script_noteworthy");
  var_bc233708 = struct::get_array("mq_br_dr_fx_loc", "targetname");
  level thread function_34a1157d("aib_t9_zm_silver_secretecho_4_orlovandmedved", "scn_orlovandmedved", "zone_proto_exterior_rear2", #"photo_placed", "done_echo_scene_orlovandmedved");
  level thread function_34a1157d("aib_t9_zm_silver_secretecho_5_valentinaandpeck", "scn_valentinaandpeck", "zone_power_room", #"photo_placed", "done_echo_scene_valentinaandpeck");
...
function function_3b4a24e2() {
  ...
  objective_manager::function_9751c453(script.var_331b7cc3, instance.contentgroups[#"exfil_loc"][0].origin, instance);
  ...
  var_3ec7083c = instance.contentgroups[#"exfil_loc"][0];
...
function function_8fcb0a(var_3aeede0b) {
  level endon(#"objective_ended", #"hash_158779eefe4893d1", #"exfil_complete", #"end_game");
...
function function_c504b2d1() {
  level endon(#"objective_ended", #"exfil_complete");
...
function function_31125f54(var_8bb7479c) {
  ...
  waitresult = level waittill(#"exfil_complete");
  ...
  level callback::callback(#"objective_ended", {
    #instance: level.var_fdcaf3a6, #completed: b_success
  });
...
function function_6a06cd37() {
  self endon(#"death");
  level endon(#"hash_59b1c24ec69056a4", #"photo_placed");
...
function function_be97976d(var_8286522a, current_wave) {
  ...
  level notify(#"hash_2af49a26c2d2b8", {
    #progress: n_progress
  });
  lasttime = gettime();
...
function function_cc7a52ed() {
  level endon(#"end_game", #"exfil_complete");
...
function function_bdd8e757() {
  level clientfield::set("" + # "falling_concrete", 1);
  wait 4;
  level clientfield::set("" + # "falling_concrete", 0);
}
...
function function_479a6396() {
  ...
  while(true) {
    ...
    foreach(player in a_players) {
      player thread clientfield::increment_to_player("" + # "interact_rumble_small", 1);
    }
