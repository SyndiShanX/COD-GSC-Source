...
function set_team_objective(var_3c9f56bd, var_cc966c56, n_obj_id, n_widget, var_48d81699, b_pvp) {
  ...
  if(isDefined(s_main_objective) && isDefined(s_objective.n_widget)) {
    if(s_main_objective == s_radiant) {
      ...
      s_main_objective flag::set(#"hud_pause_tracking_" + str_team);
    }
  }
...
function private function_323820d9(var_fd92dd8f, var_776f69c5) {
  ...
  if(!is_true(s_radiant.var_7ed82df7)) {
    var_24955a61 = var_776f69c5.a_s_main_objectives.size && (!isinarray(var_776f69c5.a_s_main_objectives, s_radiant) || is_true(s_radiant.var_4b2ab62));
...
function function_69ae81e(var_776f69c5, var_67af9061, s_radiant, var_cc966c56) {
  ...
  if(is_true(s_main_objective.var_a3417ee3)) {
    return;
  }
  ...
  if(is_true(s_main_objective.var_4b2ab62)) {
...
function private function_da72e57e(var_776f69c5, var_67af9061, var_cc966c56) {
  ...
  if(clientfield::get_world_uimodel(var_67af9061 + ".activeObjective.objId") != s_main_objective.var_f84d27e3) {
    ...
    if(is_true(s_main_objective.var_4df20a3b)) {
      var_776f69c5.var_d201303e = 1;
    }

    if(is_true(s_main_objective.var_3093fd62) || s_main_objective.script_team === #"any") {
...
function function_e5ae6379(var_ea5acf75 = #"none", var_f30c60cd = 1) {
  ...
  if(b_clear) {
    if(is_true(s_main_objective.var_852d1dbb)) {
...
function private function_11a980cd(var_cc966c56, var_776f69c5) {
  ...
  if(isDefined(self.s_main_objective)) {
    return (self.s_main_objective == var_776f69c5.a_s_main_objectives[0] && isDefined(self.s_main_objective.a_b_set) && is_true(self.s_main_objective.a_b_set[var_cc966c56]));
  } else if(isDefined(self.s_radiant)) {
    s_radiant = self.s_radiant;
    return (s_radiant.s_main_objective == var_776f69c5.a_s_main_objectives[0] && isDefined(s_radiant.s_main_objective.a_b_set) && is_true(s_radiant.s_main_objective.a_b_set[var_cc966c56]));
  }
...
function function_e2f8b883(str_team, str_objective, s_main_objective, e_player, var_2f3a056c, var_b1f5cba2 = 0) {
  if(!isDefined(level.var_6371e281)) {
    level function_6cf4a466();
  }
  ...
  objective_add(n_obj_id, "invisible", undefined, s_main_objective);
  objective_setteam(n_obj_id, var_cc966c56);
  var_869753ec = {
    #n_obj_id: n_obj_id, #var_428fe2c1: 1, #str_objective: s_main_objective, #var_b1f5cba2: var_b1f5cba2
  };

  if(isDefined(e_player)) {
    var_869753ec.s_main_objective = e_player;
  }
