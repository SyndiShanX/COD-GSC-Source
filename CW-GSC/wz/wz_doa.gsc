...
function function_725dd341() {
  var_3177c2d3 = array({
    #name: "island", #activation: &function_863ffeba, #shutdown: &function_ffeaed15
  }, {
    #name: "jungle", #activation: &function_529acb04, #shutdown: &function_f1ec9045
  }, {
    #name: "cartel", #activation: &function_15692944, #shutdown: &function_8025b684
  }, {
    #name: "mausoleum", #activation: &function_7773730f, #shutdown: &function_682069ef
  }, {
    #name: "graveyard", #activation: &function_d723726a, #shutdown: &function_6d60789
  }, {
    #name: "temple", #activation: &function_f7295a2d, #shutdown: &function_6800d147
  }, {
    #name: "watertemple", #activation: &function_eb41fd02, #shutdown: &function_507356f3
  }, {
    #name: "geothermal", #activation: &function_79604b5e, #shutdown: &function_e68b172f
  }, {
    #name: "wintercave", #activation: &function_8ff5e09, #shutdown: &function_d9967798
  }, {
    #name: "icecave", #activation: &function_4eaa5cb4, #shutdown: &function_ef053c43
  }, {
    #name: "bloodlake", #activation: &function_db874c99, #shutdown: &function_cd588c9f
  }, {
    #name: "witchwood", #activation: &function_b5abde0c, #shutdown: &function_d70d8d1
  }, {
    #name: "alpine", #activation: &function_a077af19, #shutdown: &function_e584ce9d
  }, {
    #name: "frontyard", #activation: &function_a80babc3, #shutdown: &function_f66db708
  }, {
    #name: "greatroom", #activation: &function_c32a6622, #shutdown: &function_a9f65217
  }, {
    #name: "boss", #activation: &function_e26b3847, #shutdown: &function_7519f916
  });
...
function function_89315f8a(section) {
  ...
  if(section.id == 3) {
    ...
    throne = getent("giant_skeleton_throne", "targetname");
    level thread function_4ab4dc9f(var_d8e073bd, throne);
  }
}
...
function function_4ab4dc9f(var_d8e073bd, throne) {
  level endon(#"game_over", #"hash_77e4bcc14697c018");

  if(isDefined(var_d8e073bd) && isDefined(throne)) {
    ...
    tagorigin = throne gettagorigin("tag_throne_animate");
    tagangles = throne gettagangles("tag_throne_animate");
    tagorigin = throne.origin;
    tagangles = throne.angles;
...
function function_bd65dc78(highestround) {
  arenaid = int(highestround / 4);
...
function function_9dbdc114() {
  ...
  level doa_banner::function_7a0e5387(57);
  ...
  while(true) {
    ...
    if(level.doa.roundnumber == 1) {
      if(getplayers().size == 1 && getdvarint(#"hash_29afb60660d7bc06", 0)) {
        ...
        level.doa.nostats = 1;
        player = getplayers()[0];
        var_b0fa9a8d = player stats::get_stat(#"doaglobalstats", #"hash_5a6bd78423046ffb");
        var_76fa0c6b = player stats::get_stat(#"hash_7eb2e5e9d5a52fbe", 0, #"highest_round");
...
function function_d723726a() {
  ...
  level waittill(#"arena_initialized");
  ...
  if(!is_true(level.var_e5d89122)) {
    if(var_72bee225) {
      level waittill(#"hash_62332fcf2ebc16d1", #"arena_initialized");
...
function function_821f3d71() {
  ...
  foreach(fxloc in var_3a602ebe) {
    fxloc.fakemodel = namespace_ec06fe4a::spawnmodel(fxloc.origin, undefined, undefined, "geothermal fxlocModel");

    if(isDefined(fxloc.fakemodel)) {
      fxloc.fakemodel.script_noteworthy = fxloc.script_noteworthy;
      fxloc.fakemodel thread function_a2bf31a9();
    }
  }
  ...
  while(true) {
    ...
    foreach(fxloc in var_83a77edd) {
      fxloc.fakemodel notify(#"stop_fx");
    }
    ...
    foreach(fxloc in var_3a602ebe) {
      fxloc.fakemodel thread function_231e7cd8("water_geyser_sm", "warn", 2, 4);
    }
    ...
    foreach(fxloc in var_83a77edd) {
      fxloc.fakemodel thread function_231e7cd8("water_geyser", "active", 0.4, 1.4, 0, 0);
    }
...
function function_4eaa5cb4() {
  ...
  level.doa.var_4e7fa15 = {
    #var_68196321: var_736dd93a, #var_64e8274c: var_b2f4c996, #var_751c4256: var_2e3fc95e
  };
...
function function_b5abde0c() {
  [[level.doa.var_39e3fa99]] - > function_6d5262dc(32 + (getplayers().size - 1) * getdvarint(#"hash_f59b123b8f7c868", 4) + level.doa.var_6c58d51 * 8);
  assert(level.doa.var_65a70dc != doa_enemy::function_d7c5adee("<dev string:x62>"), "<dev string:x71>");
  level.doa.var_65a70dc = doa_enemy::function_d7c5adee("basic_zombie");
}
...
function function_a80babc3() {
  ...
  foreach(var_30f23074 in var_36a503f5) {
    assert(!isDefined(var_30f23074.var_92595434), "<dev string:xa2>");
...
function function_e26b3847() {
  ...
  level doa_banner::function_7a0e5387(61);
  ...
  level doa_banner::function_7a0e5387(62);
...
function function_99072b0f(var_ae0093c9) {
  ...
  level doa_banner::function_7a0e5387(60);
...
function function_762b14b0(var_acbf7fe7, hintmask = 0) {
  level.doa.var_1e31cd70 |= hintmask;
...
function function_9e356c78(name) {
  level doa_banner::function_7a0e5387(49);
...
function function_ae378de8() {
  ...
  if(isDefined(silverback)) {
    level.doa.active_attractors[level.doa.active_attractors.size] = silverback;
    silverback thread namespace_6e90e490::function_47e11416(11, 3, 1);
    silverback.var_ba88972 = 1;
    silverback waittilltimeout(2, #"taunt_end", #"death");
    wait 3.1;
...
function function_2a6cdb09() {
  ...
  foreach(player in players) {
    ...
    player.doa.hintmask = player stats::get_stat(#"doaglobalstats", #"hintmask");
    hasplayed = player stats::get_stat(#"doaglobalstats", #"careergames");
