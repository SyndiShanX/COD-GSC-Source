...
function function_cc147a03(attacker, weapon) {
  ...
  if(plane.isleaving !== 1) {
    plane killstreak_dialog::play_pilot_dialog_on_owner("destroyed", "artillery_barrage");
    plane killstreak_dialog::play_destroyed_dialog_on_owner("artillery_barrage", self.killstreakid);
  }
}
