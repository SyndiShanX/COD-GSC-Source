 ...
 * Script: killstreaks\mp\killstreakrules.gsc
***********************************************/
...
function init() {
  ...
  addkillstreaktorule("nuke", "nuke", 1, 1);
  addkillstreaktorule("spy_wanted_order", "spy_wanted_order", 1, 1);
  addkillstreaktorule("spy_med_pack", "spy_med_pack", 1, 1);
}
...
function private function_8152c650() {
  ...
  createrule("nuke", 1, 1, 0);
  createrule("spy_wanted_order", 1, 5, 0, 0, 0);
  createrule("spy_med_pack", 10, 10, 0);
}
...
function private function_94d7a65f() {
  ...
  createrule("nuke", 1, 1);
  createrule("spy_wanted_order", 1, 5);
  createrule("spy_med_pack", 10, 10);
}
