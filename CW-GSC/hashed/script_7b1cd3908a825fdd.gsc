 ...
 * Script: hashed\script_7b1cd3908a825fdd.gsc
***********************************************/
...
function function_7c255771() {
  ...
  level.var_fdcaf3a6.gameobject gameobjects::set_visible(#"group_none");
...
function exfil_complete(b_success = 0) {
...
function function_839b3d5a(s_exfil) {
  ...
  n_time = function_385ab693(s_exfil.origin);
  ...
  s_exfil.var_4cdbc624 = spawn("trigger_radius", s_exfil.origin - (0, 0, s_exfil.height), 0, s_exfil.radius, s_exfil.height * 2);
  ...
  if(zm_utility::is_classic()) {
    ...
    s_exfil.var_4cdbc624 waittill(#"trigger");
    var_69c8822d = s_exfil.parent.contentgroups[# "hash_5819d8571ea7c838"][0];
  ...
  foreach(player in getplayers()) {
    player thread function_bf33dd82(s_exfil.var_4cdbc624);
  }
}
...
function function_8fcb0a(var_3aeede0b) {
  level endon(#"objective_ended", #"hash_158779eefe4893d1", #"exfil_complete", #"end_game", #"exfil_cleared");
...
function function_64df57fc(v_spawn, var_ca838126) {
  ...
  while(var_2eb61c8a.size && n_ai_count < var_ca838126) {
    ...
    if(var_4bf95f4c.aitype_name == # "spawner_bo5_avogadro_sr" && getaiarchetypearray(#"avogadro").size > getplayers().size) {
      var_4bf95f4c.aitype_name = # "hash_7cba8a05511ceedf";
    }

    ai = namespace_85745671::function_9d3ad056(var_4bf95f4c.aitype_name, var_2eb61c8a[i].origin, (0, v_angles[1], 0), "exfil_ai");
...
function function_4b115eba(struct) {
  ...
  a_v_points = array::randomize(namespace_85745671::function_e4791424(struct.origin, var_a77909d4, struct.spawn_height, struct.spawn_radius));
  ...
  while(n_ai_count < var_a77909d4 && a_v_points.size) {
    ...
    ai = namespace_85745671::function_9d3ad056(var_4bf95f4c.aitype_name, a_v_points[i].origin, (0, v_angles[1], 0), "exfil_ai");
...
function function_9feae843(var_fda8dff8) {
  var_3ec7083c = level.var_fdcaf3a6.contentgroups[# "exfil_loc"][0];
  var_5789be51 = 850;
    ...
    if(!isDefined(params.eattacker) && !is_true(self.var_8576e0be) || isPlayer(params.eattacker) && params.eattacker.v_train_inbound_igc !== 1 && params.weapon !== getweapon(#"hash_1734871fef9c0549")) {
      ...
      do {
        ...
        if(getaiarray().size < level.zombie_ai_limit) {
          ...
          ai = namespace_85745671::function_9d3ad056(aitype_name, var_d2e2380c, (0, randomint(360), 0), "exfil_ai", 0);
        }
      }
      while(!isDefined(ai));
...
function function_5dd89100() {
  ...
  if(!isDefined(var_10ed23ba)) {
    var_10ed23ba = level.var_fdcaf3a6.contentgroups[# "exfil_loc"][0];
  }
...
function private function_39eec401(instance) {
  ...
  if(!getdvarint(#"hash_33b0be96bf3cd69a", 0)) {
    s_result = level waittill(#"portal_activated", #"hash_3e765c26047c9f54");
  }
  ...
  if(s_result._notify === # "hash_3e765c26047c9f54" || getdvarint(#"hash_33b0be96bf3cd69a", 0)) {
    ...
    if(isDefined(level.var_b2fde059)) {
      [[level.var_b2fde059]](script.var_331b7cc3, instance.contentgroups[# "exfil_loc"][0].origin, instance);
    } else {
...
function function_5a22584f() {
  ...
  while(true) {
    ...
    var_f354b9b2 gameobjects::set_visible(#"group_all");
    var_f354b9b2 gameobjects::allow_use(#"group_all");
