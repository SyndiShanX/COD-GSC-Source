 ...
 * Script: hashed\script_6fc1886ffe877d6.gsc
***********************************************/
...
function event_handler[level_init] main(eventstruct) {
  ...
  clientfield::register("allplayers", "" + # "turnoff_scrambler", 1, 1, "counter");
  clientfield::register("toplayer", "" + # "hash_bd79b6ca5ca6bc0", 1, 2, "int");
  clientfield::register("toplayer", "" + # "dark_aether", 1, 1, "int");
  clientfield::register("toplayer", "" + # "teleport_blur", 1, 1, "int");
  ...
  clientfield::register("scriptmover", "" + # "aether_beam", 1, 1, "int");
...
function function_208f2fc1() {
  self endon(#"objective_ended", #"teleport_go");
...
function function_521d95ab() {
  ...
  s_loot = content_manager::function_31e8da78(self.location.destination, "loot_pods");
  self thread function_b8df700f(s_loot);
  ...
  if(isDefined(s_loot.a_models)) {
    foreach(model in s_loot.a_models) {
      if(isDefined(model)) {
...
function loot_pod(instance) {
  ...
  if(!isDefined(self.b_destroyed)) {
    self fx::play(#"hash_6583defa5c93e609", self.origin, self.angles, #"pod_destroyed", 1);
  }
}
...
function function_90725ab1() {
  ...
  self.var_5c6a2bf5 = content_manager::function_cfa4f1a0(self.var_fc1420f, #"p9_fxanim_zm_ndu_essence_bomb_body_mod", 0);
  ...
  foreach(player in getplayers()) {
    player clientfield::set_to_player("" + # "teleport_blur", 1);
  }
...
function function_354e27f9() {
  ...
  self waittilltimeout(180, #"end_game", #"players_dead", #"objective_ended", #"hash_36719991d2a7edc6", #"switch_map");
...
function function_b746ae20(door) {
  setdynentstate(door, 3);
  door.destroyed = 1;
  self waittill(#"objective_ended");

  if(isDefined(door)) {
    setdynentstate(door, 0);
...
function function_44fe71e3() {
  ...
  self flag::wait_till(#"barriers_off");
...
function player_teleport(s_pos, b_state) {
  ...
  self clientfield::set_to_player("" + # "teleport_blur", 0);
  self flag::wait_till(#"fasttravel_done");
...
function function_26a50e5e() {
  ...
  foreach(var_936c52b5 in self.var_603d86e5) {
    ...
    if(isDefined(var_936c52b5.e_fx)) {
      var_936c52b5.e_fx clientfield::set("" + # "barrier_fx", 1);
      var_936c52b5.var_3b6eef70 = 1;
    }
  ...
  foreach(var_936c52b5 in self.var_603d86e5) {
    if(isDefined(var_936c52b5.e_fx)) {
      var_936c52b5.e_fx clientfield::set("" + # "barrier_fx", 0);
    }
  }
...
function function_34ac205(n_active, n_wave) {
  ...
  while(true) {
    ...
    if(self.n_active < n_active) {
      str_aitype = get_aitype(self, level.var_b48509f9);
      ...
      ai_spawned = namespace_85745671::function_9d3ad056(str_aitype, s_loc.origin, s_loc.angles, "holdout_zombie");
      wait 0.1;
...
function get_aitype(instance, var_661691aa) {
  var_908ce45b = 0;
...
function function_4f7c9f11(player_index = 0) {
  ...
  return {
    #origin: struct.origin, #angles: struct.angles
  };
}
...
function function_f04763d9() {
  ...
  if(self.success && !is_true(self.player_downed)) {
    level scoreevents::doscoreeventcallback("scoreEventSR", {
      #scoreevent: "holdout_perfect_defense_zm", #allplayers: 1
    });
  }
  ...
  foreach(player in getplayers()) {
    ...
    player clientfield::increment("" + # "turnoff_scrambler");
  }
}
...
function function_5f3c406e() {
  ...
  var_f2afb269 = content_manager::function_cfa4f1a0(self.var_48e204a7, #"p9_fxanim_zm_silver_jellyfish_small_01_mod", 0);
  ...
  foreach(var_1cde429c in var_f2afb269) {
    if(isDefined(var_1cde429c)) {
      ...
      if(isDefined(var_1cde429c.var_b30a9f82)) {
        ...
        var_1cde429c clientfield::increment("" + # "jellyfish_trail");
