 ...
 * Script: hashed\script_6fc2be37feeb317b.gsc
***********************************************/
...
function function_80287c83(weapon, str_ammo_mod) {
  var_5503dd3 = {
    #var_c08f8ddc: gettime(), #var_671a4a8f: zm_utility::function_e3025ca5(), #var_19b950db: zm_utility::get_round_number(), #weapon: weapon.name, #ammo_mod: str_ammo_mod
  };
