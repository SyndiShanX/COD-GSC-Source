 ...
 * Script: hashed\script_4ce5d94e8c797350.gsc
***********************************************/
...
function function_1296cf27(instance) {
  ...
  if(!isarray(var_d690f2be) || var_d690f2be.size < 4) {
    assertmsg("<dev string:x7e>" + 4 + "<dev string:x8b>" + instance.targetname);
    return;
  }
...
function function_66d92f6(n_sequence = 1, n_delay) {
  ...
  if(n_sequence == 2) {
    ...
    if(level.var_107cca82 isattached(#"p9_sur_machine_computer_side_screen_on_seq_01", "tag_origin")) {
      level.var_107cca82 detach(#"p9_sur_machine_computer_side_screen_on_seq_01", "tag_origin");
    }
    ...
    if(!level.var_107cca82 isattached(#"p9_sur_machine_computer_side_screen_on_seq_02", "tag_origin")) {
      level.var_107cca82 attach(#"p9_sur_machine_computer_side_screen_on_seq_02", "tag_origin");
    }
  ...
  if(level.var_107cca82 isattached(#"p9_sur_machine_computer_side_screen_on_seq_02", "tag_origin")) {
    level.var_107cca82 detach(#"p9_sur_machine_computer_side_screen_on_seq_02", "tag_origin");
  }
  ...
  if(!level.var_107cca82 isattached(#"p9_sur_machine_computer_side_screen_on_seq_01", "tag_origin")) {
    level.var_107cca82 attach(#"p9_sur_machine_computer_side_screen_on_seq_01", "tag_origin");
  }
...
function function_662458e() {
  ...
  if(!isDefined(var_3cbf62f9)) {
    println("<dev string:xd4>" + n_index + "<dev string:xee>");
    var_3cbf62f9 = level.var_f654fb0f[3];

    if(!isDefined(var_3cbf62f9)) {
      assertmsg("<dev string:x100>" + n_index + "<dev string:x128>" + level.script + "<dev string:x136>" + 4 + "<dev string:x15f>");
      return;
    }
  }
  ...
  var_3cbf62f9 function_e1dd6a53(#"no_reward");
...
function private function_284f537c() {
  ...
  while(true) {
    ...
    waitframe(1);
    var_4944ff9 += float(function_60d95f53()) / 1000;
  }
}
...
function create_challenge(var_38f795c7, var_6346e7b, zonenames, weaponname, var_e09af826, var_3df4e085, var_205fe3e6, func_end) {
  ...
  s_challenge = {
    #str_name: var_38f795c7, #var_4427ebb1: zonenames, #var_6346e7b: var_6346e7b, #n_count: isDefined(n_count) ? n_count : 0, #var_4365b81b: var_e09af826, #var_8edbca81: weaponname, #var_3df4e085: var_3df4e085, #var_c376bcd5: var_205fe3e6, #var_3e17832: func_end
  };
...
function function_8f0594cb(s_challenge) {
  ...
  if(level.var_2dffd020 == 2) {
    ...
    iprintlnbold("<dev string:x1d2>" + level.var_d2bdec66 + "<dev string:x1e3>");
  } else {
...
function game_over() {
  level waittill(#"end_game", #"exfil_complete", #"hash_29edd9425510b40d");
...
function function_37597f29() {
  util::add_debug_command("<dev string:x278>");
  util::add_debug_command("<dev string:x2d5>");
  util::add_debug_command("<dev string:x338>");
  util::add_debug_command("<dev string:x3a3>");
  util::add_debug_command("<dev string:x402>");
  util::add_debug_command("<dev string:x46f>");
  util::add_debug_command("<dev string:x4dc>");
  zm_devgui::add_custom_devgui_callback(&cmd);
  util::init_dvar(#"hash_5b92db1162c53bb5", "<dev string:x556>", &function_e6f97362);
}

function private function_e6f97362(params) {
  if(params.value === "<dev string:x556>") {
    return;
  }
  ...
  switch (cmd) {
    ...
    case # "hash_625423e17a0da5e2":
      if(getdvarint(#"hash_1ca7459bb8b222dd", 0)) {
        ...
        iprintlnbold("<dev string:x55a>");
      } else {
        setDvar(#"hash_1ca7459bb8b222dd", 1);

        iprintlnbold("<dev string:x574>");
      }
    ...
    case # "hash_5e917a17463426aa":
      if(isDefined(level.var_107cca82)) {
        ...
        iprintlnbold("<dev string:x58d>" + level.var_107cca82.n_sequence);
...
function function_5a327610() {
  level notify(#"hash_1b63b0a9d74c5852");
  level endon(#"hash_1b63b0a9d74c5852", #"end_game", #"portal_activated");
      ...
      foreach(var_1b7cb15f in level.var_5de83c5b) {
        if(var_1b7cb15f === level.var_28daae89) {
          ...
          foreach(var_543e34e3 in var_ad7704f) {
            if(var_543e34e3.script_noteworthy === "<dev string:x5ea>") {
              circle(var_543e34e3.origin, 10, (0, 1, 0));
              print3d(var_543e34e3.origin, "<dev string:x5fb>", (0, 1, 0), undefined, 0.25);
            }
          }
        ...
        foreach(var_543e34e3 in var_ad7704f) {
          ...
          if(var_543e34e3.script_noteworthy === "<dev string:x5ea>") {
            ...
            print3d(var_543e34e3.origin, "<dev string:x671>", (1, 0, 0), undefined, 0.25);
          }
        }
      }
    }
