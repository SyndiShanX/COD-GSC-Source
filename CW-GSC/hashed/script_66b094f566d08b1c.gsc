 ...
 * Script: hashed\script_66b094f566d08b1c.gsc
***********************************************/
...
function preinit() {
  ...
  if(util::get_map_name() === "wz_forest") {
    ...
    zm_utility_zsurvival::function_6e9bb6b5(undefined, undefined, "vol_sr_ee_hulk_restrict");
    zm_utility_zsurvival::function_c1ced485(#"hash_82ac1fec5a17ea9");
  }
...
function function_a91c56fa(a_ents) {
  ...
  level lui::screen_fade_out(0.5, (1, 1, 1), #"outro_fade");
  wait 2;
  level lui::screen_fade_in(0.5, (1, 1, 1), #"outro_fade");
}
...
function function_abb99222(s_instance) {
  level endon(#"end_game");
  var_db9e2dd = isDefined(s_instance.contentgroups[#"wild_thing"]) ? s_instance.contentgroups[#"wild_thing"] : [];
  ...
  foreach(var_e24a3dff in var_db9e2dd) {
    ...
    var_77cb4212 val::set(#"wild_thing", "takedamage", 1);
    var_77cb4212 val::set(#"wild_thing", "allowdeath", 0);
  ...
  if(level flag::get(#"hash_3b46a8a050e7823e")) {
    ...
    foreach(var_4684f38d in var_2cc0d452) {
      ...
      var_255f195e = var_4684f38d.contentgroups[#"signage"][0];
...
function function_33a937d1() {
  ...
  s_spawn = {
    #origin: self.origin, #angles: self.angles, #var_738dfc81: 1, #scriptmodel: self
  };
...
function function_90b2fdc5(s_instance) {
  ...
  if(!level flag::get(#"hash_5d9bfa8fc70231e4") && level flag::get(#"hash_3b46a8a050e7823e") && !level flag::get(#"hash_24ee328d248f88de")) {
    ...
    if(isDefined(var_6ced8323)) {
      var_7bbc6dd2 = content_manager::spawn_script_model(var_6ced8323, #"p8_col_screen_projector_open", 0, 0);
...
function function_547ad6c7() {
  ...
  self endon(#"death");
  self val::reset(#"observe_ignore", "ignoreme");
  ...
  while(isDefined(s_rotate)) {
    if(distancesquared(self.origin, s_rotate.origin) <= sqr(256)) {
      if(!var_b7153b99) {
        self val::set(#"observe_ignore", "ignoreme", 1);
        var_b7153b99 = 1;
      }
...
function function_3e5ee10c(s_instance, var_7aad4d7d) {
  ...
  if(!s_instance flag::get(#"first_target")) {
    s_instance flag::set(#"first_target");
  ...
  if(var_838a2bd4 === 2 && !s_instance flag::get(#"first_shake")) {
    s_instance flag::set(#"first_shake");
...
function function_5720dd7() {
  ...
  foreach(e_player in getplayers()) {
    e_player val::reset(#"observe_ignore", "ignoreme");
  }
}
...
function function_7c583c30(s_instance) {
  ...
  if(getdvarint(#"hash_4fdce3a28f1397f2", 0)) {
    ...
    var_cc88afe6 = var_a8795e51.contentgroups[#"perk_machine_choice"][0];
    namespace_82b4c2d1::function_744f2a2(var_cc88afe6, #"perk_machine_choice", #"hash_6e47d6576612543c", #"hash_4af85251966549b8", #"hash_3eac5ec7a888ddfb", 0, &namespace_82b4c2d1::function_472f16d8);
    s_pap = var_a8795e51.contentgroups[#"weapon_machine"][0];
    namespace_4b9fccd8::function_e0069640(s_pap);
    var_93696db0 = var_a8795e51.contentgroups[#"armor_machine"][0];
    ...
    foreach(s_chest in isDefined(var_a8795e51.contentgroups[#"chest"]) ? var_a8795e51.contentgroups[#"chest"] : []) {
      s_chest.scriptmodel = content_manager::spawn_script_model(s_chest, #"p9_fxanim_zm_gp_chest_01_lrg_gold_xmodel", 1);
      s_chest.var_422ae63e = #"p9_fxanim_zm_gp_chest_01_lrg_bundle";
      s_chest.scriptmodel clientfield::set("<dev string:x38>", 1);
    ...
    if(getdvarint(#"hash_4fdce3a28f1397f2", 0) >= 2) {
      ...
      playFXOnTag(#"hash_7b7ba0ac0755a064", var_6bc2752.mdl_fx, "<dev string:x53>");
  ...
  if(isarray(var_ad04192d)) {
    foreach(ent in var_ad04192d) {
      if(ent.objectid === #"elevator_floor") {
        var_234f6dad = ent;
        break;
      }
    }
    ...
    if(isDefined(var_234f6dad)) {
      ...
      foreach(ent in var_ad04192d) {
        ...
        if(ent.objectid === #"elevator_switch") {
  ...
  var_8424facf = s_instance.contentgroups[#"elevator_button"][0];
...
function function_a0930644(s_instance) {
  level endon(#"end_game", #"objective_started");
  s_instance.var_4272a188 triggerenable(0);
  s_instance.var_4272a188.origin -= (0, 0, 2048);
  var_8424facf = s_instance.contentgroups[#"elevator_button"][0];
...
function function_4afbaee8() {
  ...
  self val::reset(#"elevator_ignore", "ignoreme");
  ...
  while(true) {
    if(self istouching(var_ca4ed51d)) {
      if(!var_b7153b99) {
        self val::set(#"elevator_ignore", "ignoreme", 1);
        var_b7153b99 = 1;
      }
    } else if(var_b7153b99) {
      self val::reset(#"elevator_ignore", "ignoreme");
...
function function_b6b9b6e6(s_instance, e_player) {
  ...
  if(getdvarint(#"hash_4fdce3a28f1397f2", 0)) {
    var_f3527953 = getent("<dev string:x61>", "<dev string:x7a>");
    ...
    mdl_pap = getent("<dev string:x8f>", "<dev string:x7a>");
    ...
    var_185c6200 = getent("<dev string:xaa>", "<dev string:x7a>");
    ...
    if(isDefined(var_185c6200)) {
      ...
      var_185c6200 clientfield::set("<dev string:xc4>" + #"hash_7dfc37315a4eff0", 0);
    ...
    var_44aa636e = getent("<dev string:xc8>", "<dev string:x7a>");
    ...
    foreach(s_chest in isDefined(var_a8795e51.contentgroups[#"chest"]) ? var_a8795e51.contentgroups[#"chest"] : []) {
      if(isDefined(s_chest.scriptmodel)) {
        ...
        s_chest.scriptmodel clientfield::set("<dev string:xe2>", 0);
  ...
  zm_utility_zsurvival::function_6e9bb6b5(undefined, undefined, "vol_sr_ee_hulk_restrict_meet");
  level flag::set(#"in_dark_side");
  level thread function_a988ea3e(s_instance);
  zm_sq::objective_set(#"hash_299e2967fc164ebf", undefined, 0, #"hash_1ab762d585960cc3", #"search");
  s_lock = s_instance.contentgroups[#"lock"][0];
  zm_sq::objective_set(#"hash_66884519b9716488", s_lock, undefined, undefined, #"lock", undefined, &function_35cf6e0b);
  ...
  foreach(e_player in getplayers()) {
    ...
    e_player val::reset(#"elevator_ignore", "ignoreme");
  }
  ...
  s_instance flag::wait_till(#"lockdown_ended");
  ...
  var_e6bc63a1 = isDefined(s_instance.contentgroups[#"post_inform"]) ? s_instance.contentgroups[#"post_inform"] : [];
  ...
  s_instance flag::set(#"keys_start");
  ...
  zm_utility_zsurvival::function_78d9625d("vol_sr_ee_hulk_restrict_meet");
  s_instance flag::wait_till(#"keys_inserted");
  ...
  s_exit = s_instance.contentgroups[#"exit"][0];
  zm_sq::objective_set(#"hash_3d896d54ea2917cf", s_exit, 0, #"hash_7c5523463d63e94f", #"exit");
  ...
  s_instance flag::wait_till(#"beast_start");
  function_282ec8be();
...
function function_6b1df768() {
  ...
  zm_utility_zsurvival::function_6e9bb6b5(undefined, undefined, "vol_sr_ee_hulk_restrict_during");
  zm_utility_zsurvival::function_c1ced485(#"hash_732ee24081b8622b");
  zm_utility_zsurvival::function_78d9625d("vol_sr_ee_hulk_restrict");
  zm_utility_zsurvival::function_118215e2(#"hash_82ac1fec5a17ea9");
}
...
function function_282ec8be() {
  ...
  zm_utility_zsurvival::function_6e9bb6b5(undefined, undefined, "vol_sr_ee_hulk_restrict");
  zm_utility_zsurvival::function_c1ced485(#"hash_82ac1fec5a17ea9");
  zm_utility_zsurvival::function_78d9625d("vol_sr_ee_hulk_restrict_during");
  zm_utility_zsurvival::function_118215e2(#"hash_732ee24081b8622b");
}
...
function function_dcb31940(s_instance, var_72aa02d6) {
  ...
  foreach(i, s_spawn in a_s_spawns) {
    if(isstring(s_spawn.script_noteworthy) || ishash(s_spawn.script_noteworthy)) {
      ...
      if(!isDefined(s_spawn.spawn_height)) {
        s_spawn.spawn_height = 16;
      }

      s_spawn.spawn_height = float(s_spawn.spawn_height);
      ...
      while(true) {
        a_s_points = namespace_85745671::function_e4791424(s_spawn.origin, s_spawn.num_points, s_spawn.spawn_height, s_spawn.radius, s_spawn.inner_radius);
  ...
  if(!s_instance flag::get(#"lockdown_ended")) {
    level thread function_c2a64e82(var_72aa02d6, #"a_elevator", 5, undefined, 0, #"golden_first");
    level thread function_c2a64e82(var_72aa02d6, #"hash_75cea46e1972beee", 10, undefined, 0, #"golden_first");
    level thread function_c2a64e82(var_72aa02d6, #"hash_50b3cc006552fe1e", 10, undefined, 0, #"golden_first");
    level thread function_c2a64e82(var_72aa02d6, #"central", 6, #"golden_half", 0, undefined, #"golden_first");
    level thread function_c2a64e82(var_72aa02d6, #"hash_62e616024da4239d", 10, #"golden_half", 0, undefined, #"golden_first");
    level thread function_c2a64e82(var_72aa02d6, #"hash_5b85b545c3e8a293", 10, #"golden_half", 0, undefined, #"golden_first");
  }
}
...
function function_2699787c(var_72aa02d6, var_d168712b) {
  var_72aa02d6 endon(#"clear_spawns");
  ...
  for(i = 0; i < n_to_spawn; i++) {
    ...
    if(isvec(s_point.origin)) {
      ...
      if(isvec(v_point)) {
        ...
        str_aitype = var_6017f33e.aitype_name;
        ...
        if(isDefined(str_aitype)) {
          ...
          while(true) {
            ai_zombie = namespace_85745671::function_9d3ad056(str_aitype, v_point, (0, randomfloat(360), 0), undefined, 0);
          ...
          if(b_respawn) {
            ai_zombie.var_43b32a98 = {
              #var_72aa02d6: var_72aa02d6, #str_script_noteworthy: str_script_noteworthy, #a_str_vol: a_str_vol
            };
...
function clear_spawns(var_72aa02d6) {
  var_72aa02d6 notify(#"clear_spawns");
  level thread zm_utility::function_9ad5aeb1(0, 0, 1, 0);
}
      ...
      if(var_72aa02d6.a_ai_spawned[#"all"].size + 1 < var_72aa02d6.var_de4a9f7a) {
        ...
        if(a_s_spawns.size > 0) {
          ...
          if(function_a1ef346b(undefined, s_point.origin, 512).size <= 0) {
            ...
            if(isDefined(str_aitype)) {
              ai_zombie = namespace_85745671::function_9d3ad056(str_aitype, s_point.origin, (0, randomfloat(360), 0), undefined, 0);
...
function function_a998b7a0(s_params) {
  ...
  if(isDefined(s_instance) && isDefined(mdl_lock)) {
    ...
    s_instance flag::set(#"lockdown_ended");
  }
}
...
function function_35f83dc7(s_instance) {
  ...
  var_cc88afe6 = s_instance.contentgroups[#"perk_machine_choice"][0];
  namespace_82b4c2d1::function_744f2a2(var_cc88afe6, #"perk_machine_choice", #"hash_6e47d6576612543c", #"hash_4af85251966549b8", #"hash_3eac5ec7a888ddfb", 0, &namespace_82b4c2d1::function_472f16d8);
  ...
  s_pap = s_instance.contentgroups[#"weapon_machine"][0];
  namespace_4b9fccd8::function_e0069640(s_pap);
  ...
  var_93696db0 = s_instance.contentgroups[#"armor_machine"][0];
  namespace_dd7e54e3::function_93a99046(var_93696db0);
              ...
              if(isalive(e_player) && isvec(s_point.origin)) {
                ...
                if(isDefined(str_aitype)) {
                  ...
                  if(!b_skip) {
                    ...
                    if(isvec(v_spawn)) {
                      ai_zombie = namespace_85745671::function_9d3ad056(str_aitype, v_spawn, (0, randomfloat(360), 0), undefined, 0);
...
function function_a988ea3e(s_instance) {
  ...
  level thread key_monkey(s_instance);
  ...
  s_instance flag::wait_till(#"keys_start");
  zm_sq::objective_set(#"hash_b418b036831ea2a", undefined, 0, #"hash_3e23b85b1db9f461", #"launch");
  var_c194c71 = 0;
  ...
  if(!var_c194c71) {
    s_instance flag::wait_till(#"keys_collected");
  }

  wait 1;
  zm_sq::objective_complete(#"launch");
  zm_sq::objective_set(#"hash_b418b036831ea2a", undefined, 0, #"hash_395f08b8fee17ae2", #"launch_time");

  while(!s_instance flag::get(#"keys_inserted")) {
    s_instance flag::clear(#"hash_3948726af18b5993");
    s_instance flag::clear(#"keys_timeout");
    s_instance flag::clear(#"keys_failed");
    ...
    s_instance flag::wait_till_any([#"keys_timeout", #"keys_failed", #"keys_inserted"]);

    if(s_instance flag::get(#"keys_inserted")) {
      break;
    }

    if(s_instance flag::get(#"keys_timeout")) {
    ...
    s_instance flag::set(#"keys_failed");
...
function function_aff6ff39(s_params) {
  ...
  if(isDefined(str_key) && isDefined(s_instance)) {
    ...
    if(isDefined(var_72aa02d6)) {
      ...
      var_72aa02d6 flag::set(#"key_collected");
      ...
      if(isDefined(str_desc)) {
        ...
        level zm_sq::objective_set(#"hash_b418b036831ea2a", undefined, 0, str_desc, #"launch");
      }

      if(s_instance.var_d674188d >= 3) {
        s_instance flag::set(#"keys_collected");
      }
    }
  }
}
...
function key_monkey(s_instance) {
  var_72aa02d6 = s_instance.contentgroups[#"key_monkey"][0];
  ...
  if(isDefined(var_6ae3683f)) {
    var_72aa02d6.var_6ae3683f = util::spawn_model(#"p9_fxanim_zm_gold_essence_trap_mod", var_6ae3683f.origin, var_6ae3683f.angles);
    var_6ae3683f delete();
    var_6ae3683f = var_72aa02d6.var_6ae3683f;
    ...
    while(true) {
      item_key = item_drop::drop_item(0, undefined, 1, 0, point.id, v_spawn, var_6ae3683f.angles, 0);

      if(isDefined(item_key)) {
        break;
      }
    ...
    item_key playLoopSound(#"hash_6979a0759dfa9cb3");
    item_key.var_a84740ef = #"key_monkey";
    item_key moveto(item_key.origin + anglestoup(item_key.angles) * 8, 3);
    level thread function_93c5804e(var_72aa02d6, var_6ae3683f, item_key);
    var_72aa02d6 flag::wait_till(#"key_collected");
...
function function_93c5804e(var_72aa02d6, var_6ae3683f, item_key) {
  ...
  level thread function_1b3d1df9(var_72aa02d6, var_6ae3683f, item_key);
}

function function_1b3d1df9(var_72aa02d6, var_6ae3683f, item_key) {
  ...
  if(isDefined(s_target) && isDefined(item_key) && !ispointonnavmesh(var_6ae3683f.origin)) {
    v_target = s_target.origin;
    var_fd6264f6 = item_key zm_utility::fake_physicslaunch(v_target, 300);

    if(var_fd6264f6 > 0) {
      item_key rotateto((0, 0, 0), var_fd6264f6);
      wait var_fd6264f6;
    }

    if(isDefined(item_key)) {
      item_key.origin = v_target;
      item_key.angles = (0, 0, 0);
    }
  }
}
...
function function_bc7dee45(s_instance, var_72aa02d6) {
  level endon(#"end_game");
  s_entry = {
    #weapon_name: #"hash_2f22ef3b917ab0ac", #item_name: #"sr_hulk_interest_goal"};
  ...
  e_player = var_72aa02d6 waittill(#"interest_taken");
  ...
  if(s_instance flag::get(#"keys_start")) {
...
function function_d65012f6(s_params) {
  ...
  if(isDefined(var_72aa02d6) && zm_utility::is_player_valid(e_player)) {
    self triggerenable(0);
    var_72aa02d6 notify(#"interest_taken", e_player);
  }
}
...
function function_5394c6a7(s_watcher, e_player) {
  ...
  if(isDefined(var_72aa02d6)) {
    ...
    if(!var_72aa02d6 flag::get(#"first_interest")) {
      var_72aa02d6 flag::set(#"first_interest");
...
function function_89e9be54(var_72aa02d6) {
  ...
  var_72aa02d6.var_be3a4990 = util::spawn_model(#"c_t9_zmb_cottontop_monkey_echo_fb1", (0, 0, -2048));
  var_be3a4990 = var_72aa02d6.var_be3a4990;
  var_be3a4990 hide();
  ...
  while(true) {
    ...
    if(var_72aa02d6 flag::get(#"shot")) {
      if(!var_72aa02d6 flag::get(#"first_shot")) {
        ...
        level util::delay(1, "end_game", &namespace_7589cf5c::play_vo, #"ee_hulk_business_shoot");
      }
    } else {
      var_35e1a444++;
...
function function_52cca084(var_72aa02d6, var_2c8c8f6d, var_f1a01024 = 1) {
  ...
  var_dd7192a0 val::set(#"business_shoot", "allowdeath", 0);
  var_dd7192a0 val::set(#"business_shoot", "takedamage", 1);
...
function function_2c3c8a35(s_params) {
  ...
  if(isDefined(var_72aa02d6) && zm_utility::is_player_valid(e_player)) {
    self triggerenable(0);
    var_72aa02d6 notify(#"interest_collected", e_player);
  }
}
...
function function_4004453a(s_instance) {
  ...
  var_dcdd09f2 ghost();
  var_18fd369a = util::spawn_model(#"p9_sur_console_launch_key_01", var_9fe8c6e9.origin, var_9fe8c6e9.angles);
...
function function_e1e48820(var_72aa02d6) {
  ...
  a_props = [[#"p8_wmd_chair_folding_clean", 0], [#"p8_wz_skt_potted_plant_palm_square", 0], [#"p9_rus_fire_extinguisher_police", 0], [#"p8_jpn_ashtray_tall", 13], [#"p9_sr_water_cooler_01", 0], [#"p9_sur_terminal_computer_safehouse_keyboard", 44]];
...
function function_f9d3c90b(var_72aa02d6, mdl_prop) {
  ...
  while(!b_spawn) {
    b_spawn = mdl_prop flag::get(#"shot");
...
function function_cf0fb035(var_72aa02d6, ai_mimic, var_9fe8c6e9, e_player) {
  ...
  while(true) {
    item_key = item_drop::drop_item(0, undefined, 1, 0, point.id, v_origin, (0, 0, 0), 2);
  ...
  item_key playLoopSound(#"hash_6979a0759dfa9cb3");
  item_key.var_a84740ef = #"hash_1b764530c070424a";
  wait 1;
...
function function_f23a642e(s_instance) {
  ...
  var_72aa02d6.mdl_canister = util::spawn_model(#"p9_sur_console_control_01_canister_red", var_b3fb5814 gettagorigin("p9_sur_console_control_01_canister_jnt"), var_b3fb5814 gettagangles("p9_sur_console_control_01_canister_jnt"));
  mdl_canister = var_72aa02d6.mdl_canister;
  mdl_canister linkto(var_b3fb5814, "p9_sur_console_control_01_canister_jnt");
  mdl_canister.targetname = "retrieval_component";
  s_instance flag::wait_till(#"keys_start");
  ...
  foreach(var_86cb7d9d in isDefined(var_72aa02d6.contentgroups[#"floating_body"]) ? var_72aa02d6.contentgroups[#"floating_body"] : []) {
    switch (var_86cb7d9d.model) {
      case #"hash_1bf172051b6041bf":
        str_body = #"hash_1bf172051b6041bf";
        break;
      case #"hash_61caa108089b6ef7":
        str_body = #"hash_61caa108089b6ef7";
        break;
      case #"hash_2464edbb120f53a0":
        str_body = #"hash_2464edbb120f53a0";
        break;
      case #"hash_3ade095afc6e4835":
        str_body = #"hash_3ade095afc6e4835";
        break;
    }

    if(isDefined(str_body)) {
      mdl_body = util::spawn_model(str_body, var_86cb7d9d.origin, var_86cb7d9d.angles);
  ...
  foreach(var_8b24e6f6 in isDefined(var_72aa02d6.contentgroups[#"floating_gib"]) ? var_72aa02d6.contentgroups[#"floating_gib"] : []) {
    switch (var_8b24e6f6.model) {
      case #"c_t9_zmb_zombie_arm_rt_s":
        var_f43fac08 = #"c_t9_zmb_zombie_arm_rt_s";
        break;
      case #"c_t9_zmb_ndu_zombie_male1_s_lleg":
        var_f43fac08 = #"c_t9_zmb_ndu_zombie_male1_s_lleg";
        break;
      case #"c_t9_zmb_ndu_zombie_male1_s_larm":
        var_f43fac08 = #"c_t9_zmb_ndu_zombie_male1_s_larm";
        break;
      case #"c_t9_zmb_zombie_arm_lt_s":
        var_f43fac08 = #"c_t9_zmb_zombie_arm_lt_s";
        break;
      case #"c_t9_zmb_ndu_zombie_male1_s_rleg":
        var_f43fac08 = #"c_t9_zmb_ndu_zombie_male1_s_rleg";
        break;
    }
  ...
  var_72aa02d6.var_8cd815ff[var_72aa02d6.var_8cd815ff.size] = var_72aa02d6.contentgroups[#"first_attack"][0];
  var_72aa02d6.var_6ac71323 = arraycopy(var_72aa02d6.var_8cd815ff);
  var_72aa02d6.var_2e66fa35 = 10;

  while(!var_72aa02d6 flag::get(#"key_collected")) {
    var_72aa02d6 flag::clear(#"hash_43b54fe5263c99c3");
    var_72aa02d6 flag::clear(#"canister_depleted");
    var_72aa02d6.var_1edd9ca5 = 0;
    var_72aa02d6.var_7f8115b4 = 3;
    var_72aa02d6.var_13c74181 = [];
    level thread function_6f1cb9c7(var_72aa02d6, mdl_canister, var_b3fb5814);
    ...
    wait 0.5;
    mdl_canister unlink();
    level thread function_b9462694(0, var_72aa02d6, mdl_canister, var_b3fb5814);
    wait 2;
    ...
    function_42cf5b78();
    wait 3;
    mdl_canister playLoopSound(#"hash_3432d05cab6568b1");
    mdl_canister setModel(#"hash_7705d4f7da40daeb");
    mdl_canister fx::play(#"sr/fx9_obj_retrieval_container_glow", mdl_canister.origin, mdl_canister.angles, #"hash_ffb63905e695382", 1, "tag_origin");
    function_b9462694(1, var_72aa02d6, mdl_canister, var_b3fb5814);
    var_a168912c = content_manager::spawn_interact(var_758436f2, &function_e424e2c2, #"hash_c90fb1f338973f7", undefined, 96);
    e_player = var_72aa02d6 waittill(#"canister_taken");
    ...
    var_72aa02d6 flag::wait_till_any([#"key_collected", #"canister_depleted"]);

    if(!var_72aa02d6 flag::get(#"key_collected")) {
      canister_drop(var_72aa02d6.var_f9bc175a, 0, 0);
      waitframe(1);
      mdl_canister notify(#"hash_ffb63905e695382");
      mdl_canister stoploopsound();
      mdl_canister setModel(#"p9_sur_console_control_01_canister_red");
      mdl_canister.origin = var_b3fb5814 gettagorigin("p9_sur_console_control_01_canister_jnt");
      mdl_canister.angles = var_b3fb5814 gettagangles("p9_sur_console_control_01_canister_jnt");
      mdl_canister linkto(var_b3fb5814);
    }
  }

  wait 0.5;
  level thread function_6f582582(var_72aa02d6, mdl_canister);
  wait 0.5;
...
function function_bd97d87e(var_72aa02d6, var_eef0aa31) {
  ...
  while(!var_72aa02d6 flag::get(#"key_collected")) {
    ...
    var_83ad943a fx::play(#"hash_6583defa5c93e609", var_83ad943a.origin, var_83ad943a.angles, #"chunk_pop", 1, undefined, 1);
    ...
    if(!var_56f340c4 || var_72aa02d6 flag::get(#"key_collected")) {
      var_cc1fb2d0 = namespace_58949729::function_fd5e77fa(#"pod");
      var_e8b254f5 = {
        #origin: v_origin, #angles: v_angles, #var_738dfc81: 1
      };

      while(true) {
        a_items = var_e8b254f5 item_spawn_groups_util::function_fd87c780(var_cc1fb2d0, 1, var_98d110e6);
    ...
    if(var_56f340c4) {
      while(!var_72aa02d6 flag::get(#"key_collected") && isDefined(var_f3c7bdd)) {
        wait 1;
      }
    } else {
    ...
    var_72aa02d6 flag::wait_till_timeout(60, #"key_collected");
...
function function_855284ee(var_72aa02d6, mdl_body, s_key) {
  ...
  while(true) {
    item_key = item_drop::drop_item(0, undefined, 1, 0, point.id, s_key.origin, s_key.angles, 0);
  ...
  item_key.var_a84740ef = #"hash_645bdb2b2ae769ef";
  item_key.origin = s_key.origin;
  item_key.angles = s_key.angles;
  item_key linkto(mdl_body);
  item_key playLoopSound(#"hash_6979a0759dfa9cb3");
  var_72aa02d6.item_key = item_key;
  callback::on_spawned(&function_dbf42caa);

  foreach(e_player in function_a1ef346b()) {
    if(!isDefined(item_key.var_699c6bfb)) {
      item_key.var_699c6bfb = [];
    } else if(!isarray(item_key.var_699c6bfb)) {
      item_key.var_699c6bfb = array(item_key.var_699c6bfb);
    }

    if(!isinarray(item_key.var_699c6bfb, e_player)) {
      item_key.var_699c6bfb[item_key.var_699c6bfb.size] = e_player;
    }
  }
}
...
function function_409e7991(var_72aa02d6, e_player, t_trigger) {
  ...
  while(zm_utility::is_player_valid(e_player) && isDefined(t_trigger) && e_player istouching(t_trigger) && e_player util::use_button_held()) {
    if((gettime() - n_start_time) / 1000 >= 1) {
      ...
      if(!var_72aa02d6 flag::get(#"first_deposit")) {
        var_72aa02d6 flag::set(#"first_deposit");
      }
...
function function_6f1cb9c7(var_72aa02d6, mdl_canister, var_b3fb5814) {
  if(!(isDefined(mdl_canister) && isDefined(var_b3fb5814))) {
    return;
  }

  var_72aa02d6 endon(#"hash_43b54fe5263c99c3", #"chunks_deleted");
  mdl_canister endon(#"death");
  ...
  for(var_5d3eb138 = 0; var_5d3eb138 < 5; var_5d3eb138++) {
    for(n_row = 0; n_row < 4; n_row++) {
      ...
      var_2e69c597[var_2e69c597.size] = {
        #origin: var_56527466
      };
    }
  }
  ...
  for(var_290cd1dd = 0; var_2e69c597.size > 0; var_290cd1dd = 1) {
    ...
    if(!var_290cd1dd) {
      mdl_canister fx::play(#"hash_76e6cbdd75a0ae46", mdl_canister.origin, mdl_canister.angles, #"hash_47432af7f1c60dd3", 1);
    }
  }
}

function function_72e54417(var_72aa02d6, var_eef0aa31, b_up) {
  var_72aa02d6 endon(#"chunks_deleted");
  mdl_crystal = util::spawn_model(#"p9_sur_crystal_small_01_b", var_eef0aa31.origin);
...
function function_56644615(var_72aa02d6) {
  ...
  if(isDefined(s_spawn)) {
    ...
    if(isDefined(var_397a719)) {
      ...
      var_72aa02d6 flag::set(#"first_attack");
...
function function_b9462694(var_949add22 = 1, var_72aa02d6, mdl_canister, var_b3fb5814) {
  if(!(isDefined(mdl_canister) && isDefined(var_b3fb5814))) {
    return;
  }
  ...
  if(!var_949add22 && isDefined(var_13c74181)) {
    foreach(var_83ad943a in var_13c74181) {
      if(isDefined(var_83ad943a)) {
        var_83ad943a linkto(mdl_canister);
      }
    }
  }

  mdl_canister rotateyaw(90, 1, 0.25);
  mdl_canister waittilltimeout(1, #"rotatedone");
  mdl_canister rotateyaw(90 * -1, 3, 0.5);
  n_move_dist = 16;
  ...
  mdl_canister movez(n_move_dist, 3, 0.5);
  mdl_canister waittilltimeout(3, #"movedone");

  if(!var_949add22) {
    mdl_canister notify(#"chunks_deleted");
    mdl_canister notify(#"hash_47432af7f1c60dd3");
...
function function_e424e2c2(s_params) {
  ...
  if(isDefined(var_72aa02d6) && zm_utility::is_player_valid(e_player)) {
    self triggerenable(0);
    var_72aa02d6 notify(#"canister_taken", e_player);
  }
}
...
function function_57d4f7c0(e_player) {
  ...
  if(!(isDefined(var_72aa02d6) && isDefined(mdl_canister)) || !isalive(e_player)) {
    return;
  }

  var_72aa02d6 endon(#"canister_dropped");
  ...
  playsoundatposition(#"hash_1105191492bc5a15", mdl_canister.origin + (0, 0, 25));
  e_player playrumbleonentity(#"damage_heavy");
  ...
  if(isDefined(str_tag)) {
    mdl_canister linkto(e_player, str_tag, (8, 5, -4), (270, 0, 0));
  } else {
    mdl_canister linkto(e_player, "tag_origin", (-12, 0, 45), (-5, 0, 0));
  }
...
function function_5ccdeb5c(e_player) {
  ...
  var_72aa02d6 endon(#"canister_dropped", #"hash_42c3607cc510f24d");
  e_player endon(#"death", #"player_downed");
  ...
  while(true) {
    ...
    if(!var_1806c69c && e_player buttonbitstate("BUTTON_BIT_ANY_DOWN") || var_1806c69c && e_player actionslottwobuttonPressed()) {
      level thread canister_drop(e_player);
      break;
    }
...
function function_110e10e1(s_params) {
  ...
  level thread canister_drop(self);
  var_72aa02d6 = level.var_76978879;
...
function canister_drop(e_player, var_6661fde5 = 1, var_378e4c08 = 1) {
  var_72aa02d6 = level.var_76978879;
  mdl_canister = var_72aa02d6.mdl_canister;
  ...
  if(isDefined(var_72aa02d6)) {
    var_72aa02d6 notify(#"canister_dropped");
  }

  if(!isDefined(mdl_canister)) {
    return;
  }
  ...
  mdl_canister unlink();
  mdl_canister.origin = v_ground;
  mdl_canister.angles = v_angles;
  playsoundatposition(#"hash_3047775b10faeffc", mdl_canister.origin + (0, 0, 25));

  if(var_378e4c08) {
    wait 1;
    s_canister = {
      #origin: v_ground, #angles: v_angles
    };
...
function function_e0619d7a(e_player) {
  ...
  e_player namespace_1b527536::function_7281de4d(#"field_upgrade_canister_item_stacked_sr", &field_upgrade_fired, #"hash_60cb3fd3716d711e", #"ui_icon_zm_field_upgrade_canister", 3, 1, 0);
...
function field_upgrade_fired(s_params) {
  ...
  if(!(isDefined(var_72aa02d6) && isDefined(var_72aa02d6.var_7f8115b4)) || var_72aa02d6 flag::get(#"key_collected")) {
    return;
  }
  ...
  if(!var_46c5b60c && zm_utility::is_player_valid(self) && !var_72aa02d6 flag::get(#"key_collected")) {
  ...
  if(isDefined(var_72aa02d6.mdl_canister)) {
    var_72aa02d6.mdl_canister clientfield::increment("" + #"canister_shockwave");
  }
  ...
  if(var_72aa02d6.var_7f8115b4 <= 0 && !var_46c5b60c) {
    ...
    var_72aa02d6 util::delay(2, undefined, &flag::set, #"canister_depleted");
  }
}
...
function function_dbf42caa() {
  ...
  if(isDefined(var_72aa02d6) && !var_72aa02d6 flag::get(#"key_collected")) {
    var_72aa02d6 endon(#"key_collected");
    item_key = var_72aa02d6.item_key;

    while(!isDefined(item_key)) {
      item_key = var_72aa02d6.item_key;
      waitframe(1);
    }
    ...
    if(!isinarray(item_key.var_699c6bfb, self)) {
      item_key.var_699c6bfb[item_key.var_699c6bfb.size] = self;
    }

    arrayremovevalue(item_key.var_699c6bfb, undefined);
  }
}
...
function function_a4be54e3(var_72aa02d6, e_player) {
  ...
  if(isDefined(item_key)) {
    arrayremovevalue(item_key.var_699c6bfb, e_player);
    arrayremovevalue(item_key.var_699c6bfb, undefined);
    level thread function_6317c931(item_key, e_player);
  }
  ...
  while(isDefined(var_f4ba4ba2.targetname)) {
    ...
    if(var_f4ba4ba2.content_key === #"float_end") {
      var_852f8a9f = 2;
    }
  ...
  if(isDefined(e_player.var_67aa3392) && !var_72aa02d6 flag::get(#"key_collected")) {
    var_72aa02d6 notify(#"hash_42c3607cc510f24d");
    level thread function_5ccdeb5c(e_player);
  }
...
function function_6317c931(item_key, e_player) {
  if(!isDefined(item_key) || !isalive(e_player)) {
    return;
  }
  ...
  while(isDefined(item_key)) {
    ...
    if(isDefined(var_3aee78d5) && var_3aee78d5.itemstruct === item_key && var_3aee78d5 istriggerenabled() && e_player useButtonPressed()) {
      var_3aee78d5 callback::callback(#"on_trigger", {
        #activator: e_player
      });
    }
...
function function_ed97869c(var_72aa02d6, e_player) {
  if(isDefined(e_player)) {
    ...
    if(isDefined(e_player)) {
      ...
      if(!var_72aa02d6 flag::get(#"key_collected") && isarray(var_72aa02d6.var_410f8136) && var_72aa02d6.var_410f8136.size > 0) {
  ...
  if(isDefined(var_72aa02d6) && var_72aa02d6.var_7f8115b4 <= 0 && !var_72aa02d6 flag::get(#"key_collected")) {
    var_72aa02d6 flag::set(#"canister_depleted");
  }
}

function function_6f582582(var_72aa02d6, mdl_canister) {
  if(!isDefined(mdl_canister)) {
    return;
  }
  ...
  waitframe(1);
  mdl_canister stoploopsound();
  var_20aa2309 = var_72aa02d6.contentgroups[#"reward_end"][0];
  var_7482f041 = var_20aa2309.origin;
  n_time = distance(mdl_canister.origin, var_7482f041) / 20;
  mdl_canister rotatevelocity((randomfloatrange(5, 10), randomfloatrange(5, 10), randomfloatrange(5, 10)), 100000);

  if(n_time > 0) {
    mdl_canister moveto(var_7482f041, n_time);
    mdl_canister waittilltimeout(n_time, #"movedone");
  }

  mdl_canister.origin = var_7482f041;
  wait 2;
  mdl_canister bobbing((0, 0, 1), 10, 10);
}
...
function function_155d8fca(s_params) {
  ...
  if(isDefined(var_870db21a) && zm_utility::is_player_valid(e_player)) {
    self triggerenable(0);
    var_870db21a notify(#"key_inserted", {
      #e_player: e_player
    });
    self deletedelay();
  }
...
function function_ac90ef3b(s_instance, var_870db21a, var_26830295) {
  s_instance endon(#"keys_timeout", #"keys_failed");
  var_870db21a endon(#"keys_failed");
  ...
  s_waitresult = var_870db21a waittill(#"key_inserted");
  var_2abe2638 = 0;
  b_failed = 0;
  ...
  if(var_26830295 == s_instance.var_26830295) {
    ...
    foreach(var_df017ae3 in var_5fa08c4c) {
      var_df017ae3 notify(#"keys_failed");
  ...
  if(var_2abe2638) {
    s_instance flag::set(#"keys_inserted");
    return;
  }
...
function function_4ba8981f(s_instance) {
  ...
  wait 45;
  s_instance flag::set(#"keys_timeout");
}
...
function function_31aa1903(s_instance) {
  ...
  a_s_lines = [{
    #var_7ddb4474: 30, #var_33e81c58: #"hash_609b191b5e728016"}, {
    #var_7ddb4474: 10, #var_33e81c58: #"hash_c15ace851c6b900"}, {
    #var_7ddb4474: 9, #var_33e81c58: #"hash_c15ade851c6bab3"}, {
    #var_7ddb4474: 8, #var_33e81c58: #"hash_c15aee851c6bc66"}, {
    #var_7ddb4474: 7, #var_33e81c58: #"hash_c15afe851c6be19"}, {
    #var_7ddb4474: 6, #var_33e81c58: #"hash_c15b0e851c6bfcc"}, {
    #var_7ddb4474: 5, #var_33e81c58: #"hash_c15b1e851c6c17f"}, {
    #var_7ddb4474: 4, #var_33e81c58: #"hash_c15b2e851c6c332"}, {
...
function function_eb16f54b(s_instance, s_exit) {
  level endon(#"end_game");
  s_instance endon(#"failed", #"beast_start");
...
function function_a2c5fa4f(s_params) {
  ...
  if(isDefined(s_instance) && s_instance flag::get(#"hash_3db12b263b5c8868")) {
    self triggerenable(0);
    s_instance flag::set(#"beast_start");
    self deletedelay();
  }
}
...
function function_861f39db(s_instance, b_debug = 0) {
  ...
  mdl_wall = util::spawn_model(#"p9_sur_fow_path_capsule_forest_battery", s_wall.origin, s_wall.angles);
...
function function_86fbcb7e(s_instance, b_debug = 0) {
  ...
  if(b_debug) {
    ...
    foreach(e_player in function_a1ef346b()) {
      if(!b_triggered && zm_utility::is_player_valid(e_player)) {
        b_triggered = 1;
        s_instance.var_4272a188 callback::callback(#"on_trigger", {
          #activator: e_player
        });
      }
    }
  ...
  zm_utility_zsurvival::function_6e9bb6b5(undefined, undefined, "vol_sr_ee_hulk_restrict_beast");
  ...
  var_b4488d57 flag::set(#"damage_disabled");
  ...
  wait 5;
  zm_sq::objective_set(#"hash_b418b036831ea2a", undefined, 0, #"hash_d62f5e8f2b581a4", #"beast");

  if(b_debug) {
    level thread function_a735633b(s_instance, var_b4488d57);
  }

  var_b4488d57 flag::clear(#"damage_disabled");
...
function function_a735633b(s_instance, var_b4488d57) {
  ...
  level thread beast_failed(s_instance, var_b4488d57);
}
...
function function_c5021764(var_b4488d57, n_total_time) {
  ...
  a_s_lines = [{
    #var_7ddb4474: 300, #var_33e81c58: #"hash_554487f97b3b2e5d", #var_587381ce: #"hash_73d406cdb079e626"}, {
    #var_7ddb4474: 240, #var_33e81c58: #"hash_5c43ce1da5774d76"}, {
    #var_7ddb4474: 180, #var_33e81c58: #"hash_3ddd66fa47ae9d9b", #var_587381ce: #"hash_797df0dbff72babc"}, {
    #var_7ddb4474: 120, #var_33e81c58: #"hash_48e838216e6ae9bc"}, {
    #var_7ddb4474: 60, #var_33e81c58: #"hash_6805f41751646fb1", #var_587381ce: #"hash_46a88c20ad7807f5"}, {
    #var_7ddb4474: 30, #var_33e81c58: #"hash_67028e2fe1c8128c"}, {
    #var_7ddb4474: 10, #var_33e81c58: #"hash_c15ace851c6b900"}, {
    #var_7ddb4474: 9, #var_33e81c58: #"hash_c15ade851c6bab3"}, {
    #var_7ddb4474: 8, #var_33e81c58: #"hash_c15aee851c6bc66"}, {
    #var_7ddb4474: 7, #var_33e81c58: #"hash_c15afe851c6be19"}, {
...
function beast_failed(s_instance, var_b4488d57) {
  ...
  wait 1;
  var_a6d869eb = s_instance.contentgroups[#"spawns"][0];
  var_a6d869eb notify(#"clear_spawns");
  ...
  wait 3;
  level.var_2e73af9b = #"beast_failed";
...
function function_51bcd8c6(var_b4488d57, var_5beedbc3, var_51a975ee = #"") {
  ...
  if(isDefined(var_9d7dfc4c)) {
    switch (var_9d7dfc4c) {
      ...
      case #"force_stun":
        ...
        return;
      case #"force_death":
        level thread beast_defeated(var_b4488d57, var_5beedbc3);
        return;
    }
  }
  ...
  if(var_b4488d57.var_9d7dfc4c === #"force_idle") {
...
function function_725374c3(var_b4488d57, var_51a975ee = #"") {
  if(var_b4488d57.var_9d7dfc4c === #"force_idle" || var_b4488d57.var_9d7dfc4c === #"force_bolt") {
    return 0;
  }
  ...
  if(var_b4488d57.var_9d7dfc4c === #"force_storm") {
    var_b3f30d75 = 4;
    var_ed9c3e17 = -1;
...
function function_d7753961(var_b4488d57, var_5beedbc3) {
  if(var_b4488d57.var_9d7dfc4c === #"force_idle" || var_b4488d57.var_9d7dfc4c === #"force_storm") {
    return 0;
  }
  ...
  if(var_b4488d57.var_9d7dfc4c === #"force_bolt") {
    var_890ec4bd = -1;
    var_ed9c3e17 = -1;
  }
...
function function_90ed61b8(var_b4488d57) {
  var_b4488d57 flag::set(#"stun_disabled");
...
function function_aa6c9b40(var_b4488d57) {
  ...
  var_b4488d57 flag::clear(#"stun_disabled");
}
...
function function_9b762c44(var_b4488d57, var_5beedbc3) {
  ...
  var_b4488d57 endon(#"failed", #"defeated");
  var_5beedbc3 endon(#"death");
  var_5beedbc3 val::set(#"beast_hit", "takedamage", 1);
  var_5beedbc3 val::set(#"beast_hit", "allowdeath", 0);
    ...
    while(true) {
      ...
      if(isPlayer(e_player)) {
        ...
        if(var_982513ee) {
          ...
          if(!var_b4488d57 flag::get(#"damage_disabled")) {
            n_min = 0;

            if(var_b4488d57 flag::get(#"stun_disabled")) {
              n_min = 5000;
            }
...
function function_4c15e02a(var_b4488d57, var_5beedbc3) {
  ...
  var_b4488d57 endon(#"failed", #"defeated");
  var_5beedbc3 endon(#"death");
  var_b4488d57 flag::clear(#"orb_destroyed");
  var_b4488d57 flag::clear(#"orbs_deployed");
  var_b4488d57 flag::clear(#"orbs_return");
  var_b4488d57 flag::set(#"hash_1e2734204ab845a2");
  var_37fce2a8 = var_5beedbc3 gettagorigin("tag_heart");

  if(!var_b4488d57 flag::get(#"first_stun")) {
    var_b4488d57 flag::set(#"first_stun");
  ...
  var_b4488d57 flag::set(#"orbs_deployed");
  ...
  var_b4488d57 flag::wait_till_timeout(10, #"orb_destroyed");
  var_e9eb81d7 = var_b4488d57 flag::get(#"orb_destroyed");
  ...
  var_b4488d57 flag::set(#"orbs_return");
...
function function_5a369a74(var_b4488d57) {
  ...
  wait 0.5;
  var_b4488d57 flag::wait_till(#"orbs_deployed");
...
function beast_defeated(var_b4488d57, var_5beedbc3) {
  ...
  level thread function_d4c750c2(var_b4488d57);
  wait 1;
  level thread namespace_7589cf5c::play_vo(#"beast_defeated");
  ...
  level notify(#"hash_718440039bd6eb39", {
    #b_success: 1
  });
...
function function_43d248c7(var_b4488d57) {
  ...
  foreach(var_6b610739 in var_b4488d57.var_841919e8) {
    ...
    var_6b610739 flag::clear(#"effects_enabled");
...
function function_56529f40(var_b4488d57, var_5beedbc3, var_7fd775e2, var_37fce2a8) {
  ...
  var_b4488d57 flag::wait_till(#"orbs_return");
...
function function_64b681ba(var_b4488d57, mdl_orb, var_7fd775e2) {
  ...
  mdl_orb val::set(#"beast_orb", "takedamage", 1);
  mdl_orb val::set(#"beast_orb", "allowdeath", 0);
  mdl_orb.health = 1;
  ...
  var_b4488d57 flag::set(#"orb_destroyed");
}
...
function function_9c96a95e(var_b4488d57, var_6b610739) {
  ...
  var_6b610739 flag::set(#"effects_enabled");
...
function function_59c58c97(var_6b610739) {
  ...
  while(var_6b610739 flag::get(#"effects_enabled")) {
    foreach(e_player in getplayers()) {
      if(isDefined(e_player.var_749332e7)) {
...
function function_8dba2029(var_b4488d57) {
  ...
  foreach(var_36a27d79 in isDefined(var_b4488d57.contentgroups[#"adds"]) ? var_b4488d57.contentgroups[#"adds"] : []) {
    ...
    if(!isDefined(var_36a27d79.spawn_height)) {
      var_36a27d79.spawn_height = 128;
    }

    var_36a27d79.spawn_height = float(var_36a27d79.spawn_height);
    ...
    while(true) {
      a_s_points = namespace_85745671::function_e4791424(var_36a27d79.origin, var_36a27d79.num_points, var_36a27d79.spawn_height, var_36a27d79.radius, 0);
  ...
  while(true) {
    ...
    if(!var_b4488d57 flag::get(#"hash_1e2734204ab845a2") && var_5cdb48ca.size < 25) {
      ...
      if(isDefined(str_aitype)) {
        b_skip = 0;
        var_f8b1c5ab = isinarray(var_e8ed4d48, str_aitype);
          ...
          if(!b_skip) {
            switch (str_aitype) {
              ...
              case #"spawner_bo5_mechz_sr":
                ...
                b_skip = var_6782fa22.size >= var_a706eda6 || var_b4488d57 flag::get(#"mechz_cooldown");
                break;
            }
          }
        }
        ...
        if(!b_skip) {
          ...
          if(!var_b4488d57 flag::get(#"hash_1e2734204ab845a2") && isvec(s_spawn.origin)) {
            ...
            if(isvec(v_spawn)) {
              var_fff91355 = namespace_85745671::function_9d3ad056(str_aitype, s_spawn.origin, (0, randomfloat(360), 0), undefined, 0);
...
function function_e0e5c765(var_b4488d57, var_5beedbc3, var_dbbe30cd) {
  ...
  if(isDefined(v_center)) {
    ...
    v_angles = (270, 0, 0);
    var_dbbe30cd fx::play(#"hash_3ccd156dce20e5c9", v_offset, v_angles, #"stop_tell");
...
function devgui_setup() {
  util::add_debug_command("<dev string:xf5>");
  util::add_debug_command("<dev string:x15f>");
  util::add_debug_command("<dev string:x1b9>");
  util::add_debug_command("<dev string:x21b>");
  util::add_debug_command("<dev string:x27d>");
  util::add_debug_command("<dev string:x2de>");
  util::add_debug_command("<dev string:x338>");
