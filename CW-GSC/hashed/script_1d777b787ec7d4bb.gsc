 ...
 * Script: hashed\script_1d777b787ec7d4bb.gsc
***********************************************/
...
function function_b7c45db1(control_point, e_player) {
  ...
  control_point.var_93623c13 = control_point util::spawn_model(#"p9_fxanim_zm_gold_control_point_crystal_02_mod", control_point.origin, control_point.angles);
  control_point.var_93623c13 thread function_6ed4e713();
  control_point.var_4e953b00 = 1;
  level flag::set(#"insert_crystal" + control_point.script_int);
  level.var_2912d8c5++;
...
function function_7df47abd() {
  ...
  var_37c20fcf = 5;
  var_4340bf8a = var_b90dca7b - n_count_min;
  var_3b3dba11 = var_4340bf8a / var_37c20fcf;
  n_count = int(n_count_min + var_3b3dba11 * (n_round - var_37c20fcf));

  if(n_count < n_count_min) {
    n_count = n_count_min;
...
function function_752dbea1(str_intensity = #"low") {
...
function function_ca558ad5() {
  ...
  while(n_killed < var_10ff40e4) {
    ...
    if(isDefined(killed_ai) && isDefined(self.var_547f9dd5)) {
      var_c2b976ac = zm_gold_main_quest::function_db7e1556(killed_ai, self.var_547f9dd5);
...
function function_559a9ad3(params) {
  ...
  if((isPlayer(e_attacker) || is_true(self.nuked)) && self.team === level.zombie_team) {
    level notify(#"hash_7de17e8051b0d8d2", {
      #entity: self, #attacker: e_attacker
    });
  }
}
...
function function_30f8cfb4(satellite, zone_index, var_14a22ccd = 0) {
  ...
  zm_sq::objective_set(#"hash_1598ff25b76743dd", e_objective, undefined, undefined, #"hash_8602209567f541c", undefined, &zm_gold_util::function_13ebb331, "vol_player_in_firebase");
  zm_sq::function_3029d343(#"hash_8602209567f541c", e_objective);
  zm_sq::objective_set(#"hash_68f4e9062d28524d", e_objective, undefined, var_9bb2940e, #"hash_3e7926c5aefe4406", undefined, &zm_gold_util::function_13ebb331, "vol_player_in_firebase");

  while(true) {
    result = self waittill(#"damage");

    if(!isPlayer(result.attacker)) {
      level notify("damage" + zone_index, {
        #amount: result.amount, #var_e3276b1e: satellite.mdl
      });
...
function function_49401276(e_objective) {
  ...
  if(self flag::get(#"objective_flashing")) {
    return;
  }

  self flag::set(#"objective_flashing");
  ...
  self flag::clear(#"objective_flashing");
}
...
function function_bc369205(var_14a22ccd = 0, var_17f8efd5 = 0, var_d219813c = 0) {
  level endon(#"end_game", "captured_control_point" + self.script_int, "failed_control_point" + self.script_int, #"charging_failed", #"charging_succeed", #"hash_3e765c26047c9f54");
  self endon(#"defend_succeed");
...
function function_21a9e71b(success, var_14a22ccd, var_d219813c = 0) {
  ...
  foreach(cleanup in a_cleanup) {
    ...
    if(isDefined(attackable)) {
      ...
      attackable thread namespace_85745671::cleanup_attackable(attackable);
      attackable notify(#"hash_3ff994bb36bd6fa0");
      attackable flag::clear(#"objective_flashing");
    }
  }
...
function function_bdb2b85b(origin, angles, radius, num_spots, zone_name, max_height = 512) {
  ...
  record3dtext("<dev string:x8a>", origin, (0, 0, 1));
...
function function_37597f29() {
  util::add_debug_command("<dev string:x9a>");
  util::add_debug_command("<dev string:x107>");
  util::add_debug_command("<dev string:x166>");
  util::add_debug_command("<dev string:x1cb>");
