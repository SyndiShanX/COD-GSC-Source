 ...
 * Script: hashed\script_6418a6112420d977.gsc
***********************************************/
...
function function_4f8b33df(instance) {
  ...
  s_loot = content_manager::function_31e8da78(instance.location.destination, "loot_pods");
  instance thread function_c97fdd1d(s_loot);
...
function function_dd9b1007(instance, v_spawnpt, v_ang) {
  ...
  ai_spawned = namespace_85745671::function_9d3ad056(str_aitype, v_spawnpt, v_ang, "rover_zombie");
  wait 0.1;
...
function function_24735dd6(instance) {
  ...
  while(true) {
    ...
    for(i = 0; i < var_90a50598.size; i++) {
      var_a989d2f6 = content_manager::spawn_script_model(var_90a50598[i], #"p9_fxanim_zm_silver_jellyfish_large_xmodel", 0);
...
function function_4e0f32cf(instance) {
  ...
  foreach(var_b6e76b65 in var_90a50598) {
    var_dafcbf83 = content_manager::spawn_script_model(var_b6e76b65, #"p9_fxanim_zm_silver_jellyfish_large_xmodel", 0);
    util::wait_network_frame();
...
function function_753752c6(instance) {
  ...
  instance endon(#"objective_ended");
  level.var_c39a4b8f waittill(#"phase_exit");
...
function function_c97fdd1d(s_loot) {
  if(isDefined(s_loot)) {
    self.var_55b8433b = [];
    var_5504b0b = s_loot.contentgroups[#"hash_130282cd5152e410"];
...
function spawn_orb() {
  ...
  mdl_orb = util::spawn_model(#"p7_zm_ctl_deathray_sphere", level.var_c39a4b8f gettagorigin("tag_cage_attach"));
  mdl_orb ghost();
