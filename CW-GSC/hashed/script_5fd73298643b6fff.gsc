 ...
 * Script: hashed\script_5fd73298643b6fff.gsc
***********************************************/
...
function init() {
  ...
  clientfield::register("world", "" + # "starting_alarms", 16000, 3, "int");
  clientfield::register("scriptmover", "" + # "orda_dissolve", 16000, 1, "int");
...
function function_ba9d5cad(mdl_support_machine, var_32f76af8) {
  ...
  mdl_support_machine.mdl_screen = util::spawn_model(#"tag_origin", mdl_support_machine.origin, mdl_support_machine.angles);
...
function function_8ca02d60(e_player) {
  ...
  if(mdl_support_machine flag::get(#"power_on")) {
    if(mdl_support_machine flag::get(#"destroyed")) {
      ...
      if(mdl_support_machine flag::get(#"first_buy")) {
...
function function_ab5e8b7e() {
  ...
  while(true) {
    ...
    if(zm_utility::is_player_valid(e_player)) {
      ...
      if(mdl_support_machine flag::get(#"enabled") && (!mdl_support_machine flag::get(#"first_buy") || e_player zm_score::can_player_purchase(n_cost)) && !e_player killstreaks::has_killstreak(var_d9726d35)) {
        if(mdl_support_machine flag::get(#"first_buy")) {
          e_player thread zm_score::minus_to_player_score(n_cost);
        }

        e_player thread namespace_1cc7b406::give_item(var_d9726d35);
        e_player notify(#"hash_360ecb13f668ae0f", {
          #killstreak: var_d9726d35
        });
        str_sound = "purchase";
        e_player playrumbleonentity(#"zm_interact_rumble");
        mdl_support_machine flag::set(#"first_buy");
      }
...
function function_947330e6(var_32f76af8, str_state = # "power_off") {
  ...
  if(!isDefined(mdl_support_machine) || !isDefined(mdl_support_machine.mdl_screen)) {
    return;
  }
  ...
  if(str_state == # "power_off") {
    mdl_support_machine.mdl_screen setModel(#"tag_origin");
    mdl_support_machine.mdl_screen stoploopsound();
    return;
  }
  ...
  if(str_state == # "enabled") {
    ...
    mdl_support_machine.mdl_screen playLoopSound(#"hash_2abb8dfe1cd5f02e");
  }

  mdl_support_machine.mdl_screen setModel(var_5fa67dc9);
...
function function_83285a17(var_32f76af8, var_f070c3ca = 1) {
  ...
  if(var_f070c3ca) {
    ...
    if(!is_true(mdl_support_machine.is_active)) {
      ...
      if(isDefined(slots) && slots.size > 0) {
        ...
        mdl_support_machine.var_b79a8ac7 = {
          #var_f019ea1a: 1024, #slots: slots
        };
  ...
  if(is_true(mdl_support_machine.is_active)) {
    ...
    mdl_support_machine flag::clear(#"objective_flashing");
    ...
    namespace_85745671::cleanup_attackable(mdl_support_machine);
...
function function_7942f4b8(var_32f76af8, mdl_support_machine) {
  ...
  zm_sq::objective_set(#"hash_13c74190a9e88f6e", mdl_support_machine, undefined, undefined, #"hash_8602209567f541c", undefined, &zm_gold_util::function_13ebb331, "vol_player_in_firebase");
  zm_sq::function_3029d343(#"hash_8602209567f541c", mdl_support_machine);
  zm_sq::objective_set(#"hash_35ca48ad08bd82a2", mdl_support_machine, undefined, undefined, #"hash_3e7926c5aefe4406", undefined, &zm_gold_util::function_13ebb331, "vol_player_in_firebase");
...
function function_29701d79() {
  ...
  self val::set(#"assault_round_turret", "takedamage", 0);
  self val::set(#"assault_round_turret", "allowdeath", 0);
  self.controlled = 0;
...
function function_a1728f1d(var_f57c3dea) {
  ...
  if(var_f57c3dea.var_58d1b08a.size > 0) {
    var_f57c3dea flag::set(#"spawns_generated");
  }

  if(getdvarint(#"hash_90aec9f47685abc", 0) >= 2) {
    if(!var_f57c3dea flag::get(#"spawns_generated")) {
...
function function_8903caa4(s_goal) {
  ...
  s_goal flag::set(#"goals_generated");
...
function function_c1976ea5() {
  ...
  if(n_current_round < 20) {
    ...
    if(var_586ab1ac > n_current_round) {
      ...
      iprintlnbold("<dev string:x38>" + var_586ab1ac);
      println("<dev string:x38>" + var_586ab1ac);
    }
  }
...
function function_b9e3761a() {
  ...
  if(level.var_98232a38 < 2) {
    iprintlnbold("<dev string:x51>" + level.var_9614e521);
    println("<dev string:x51>" + level.var_9614e521);
    return;
  }

  iprintlnbold("<dev string:x6b>" + level.var_df4c24cd);
  println("<dev string:x6b>" + level.var_df4c24cd);
}
...
function function_d08cba34(var_32f76af8) {
  ...
  level clientfield::set("" + # "starting_alarms", var_32f76af8.script_int);
  ...
  foreach(var_3e7e5948 in struct::get_array(#"fasttravel_trigger")) {
    if(isDefined(var_3e7e5948) && var_3e7e5948.script_string === # "firebase") {
      zm_sq::objective_set(#"hash_68f0c1062d24257e", var_3e7e5948, undefined, undefined, #"hash_86f91ca1e18f21f", undefined, &zm_gold_util::function_13ebb331, "vol_player_in_village");
      break;
    }
  }
  ...
  wait 6;
  level clientfield::set("" + # "starting_alarms", 0);
  ...
  while(!var_d58c8115) {
    ...
    if(var_faa6c24 < var_a77c8ab2 && (var_2a69785e || level.var_98232a38 >= 1 || n_round >= 20)) {
      if(math::cointoss(75) || var_57d164d9 >= 2) {
        ...
        if(var_8e58e88c == # "mimic") {
          var_1a6bb917 = # "mangler";
          var_8e58e88c = # "mangler";
        } else {
          var_1a6bb917 = # "mimic";
          var_8e58e88c = # "mimic";
        }
    ...
    foreach(i, var_f57c3dea in var_7464cd64) {
      ...
      if(n_total > 0 && level.var_8c8c8ffd + n_total <= level.zombie_ai_limit) {
        ...
        var_f57c3dea flag::set(#"spawn_mimics");
...
function function_9ce67fef(var_f57c3dea) {
  if(!var_f57c3dea flag::get_any([# "spawn_zombies", #"hash_3bf1a72ac4665e68", #"spawn_mimics"])) {
...
function function_58b27842(var_f57c3dea, n_spawns) {
  ...
  var_f57c3dea flag::clear(#"spawn_mimics");
  function_9ce67fef(var_f57c3dea);
}
...
function function_a7d1da85(var_f57c3dea, n_round, var_d1d2d9e2 = 0) {
  ...
  s_spawn = {
    #origin: v_spawn, #angles: var_f57c3dea.angles
  };
...
function function_892960f5(var_f57c3dea, var_d1d2d9e2 = 0) {
  ...
  self val::set(#"assault_rounds", "ignoreall", 1);
  ...
  while(true) {
    if(!s_goal flag::get(#"goals_generated")) {
  ...
  self val::reset(#"assault_rounds", "ignoreall");
...
function function_44361a8f(control_point, var_e1c95338, var_ab56660c) {
  ...
  a_spawn_pos = arraycopy(control_point.var_94cc32a1);
  var_67fee1f1 = [];
  var_5fa4c84a = [];
  var_a77909d4 = 0;
  var_4ebe6ac0 = 0;
  ...
  for(i = 0; i < (getplayers().size < a_spawn_pos.size ? getplayers().size : a_spawn_pos.size); i++) {
...
function function_f239fa6c(a_ents) {
  ...
  level.orda clientfield::set("" + # "orda_dissolve", 1);
...
function private function_2b49cac1() {
  level endon(#"end_game");
  level waittill(#"set_dissolve", #"hash_a88cb65d3952bc4");
...
function function_6da6ae01(var_ce68958a) {
  ...
  while(true) {
    ...
    if(waitresult.amount > 0 && isPlayer(waitresult.attacker) && waitresult.mod !== "MOD_AAT") {
      ...
      self.var_77dcb00d[attacker getentitynumber()] = struct_params;
...
function private function_4a5c7c33() {
  ...
  level waittill(#"set_dissolve");

  if(isDefined(level.orda)) {
    level.orda clientfield::set("" + # "orda_dissolve", 0);
  }
}
...
function function_cd7a3de4() {
  util::add_debug_command("<dev string:x83>");
  util::add_debug_command("<dev string:xfc>");
  util::add_debug_command("<dev string:x175>");
  util::add_debug_command("<dev string:x1ee>");
  util::add_debug_command("<dev string:x26d>");
  util::add_debug_command("<dev string:x2ee>");
...
function function_eed94aa6(index) {
  ...
  if(!level flag::get("<dev string:x36d>" + index)) {
...
function function_999d2162() {
  ...
  a_str_shots = ["<dev string:x379>", "<dev string:x387>", "<dev string:x395>", "<dev string:x3a3>", "<dev string:x3b1>", "<dev string:x3c0>", "<dev string:x3cf>", "<dev string:x3de>", "<dev string:x3f4>", "<dev string:x40a>", "<dev string:x419>", "<dev string:x428>", "<dev string:x439>", "<dev string:x447>", "<dev string:x45d>", "<dev string:x473>", "<dev string:x489>", "<dev string:x49f>"];
  ...
  a_str_shots = ["<dev string:x447>", "<dev string:x45d>", "<dev string:x473>", "<dev string:x489>", "<dev string:x49f>"];
