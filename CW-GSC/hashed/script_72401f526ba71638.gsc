 ...
 * Script: hashed\script_72401f526ba71638.gsc
***********************************************/
...
function function_5f81a103(weapon, b_killed = 0) {
  if(isPlayer(self)) {
    var_49058ab = {
      #var_4b738e64: function_f8d53445(), #var_8335e8a8: zm_utility::function_e3025ca5(), #var_d8fb195f: zm_utility::get_round_number(), #field_upgrade: weapon.name, #var_c9995ddd: b_killed
    };
...
function function_f793af68() {
  ...
  util::add_debug_command("<dev string:x9a>" + hashtostring(#"field_upgrade_frost_blast_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:xf4>" + hashtostring(#"field_upgrade_frost_blast_1_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x149>" + hashtostring(#"field_upgrade_frost_blast_2_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x19c>" + hashtostring(#"field_upgrade_frost_blast_3_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x1ef>" + hashtostring(#"field_upgrade_frost_blast_4_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x242>" + hashtostring(#"field_upgrade_frost_blast_5_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x295>" + hashtostring(#"field_upgrade_heal_aoe_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x2eb>" + hashtostring(#"field_upgrade_heal_aoe_1_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x341>" + hashtostring(#"field_upgrade_heal_aoe_2_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x395>" + hashtostring(#"field_upgrade_heal_aoe_3_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x3e9>" + hashtostring(#"field_upgrade_heal_aoe_4_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x43d>" + hashtostring(#"field_upgrade_heal_aoe_5_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x491>" + hashtostring("<dev string:x4e6>") + "<dev string:xef>");
  util::add_debug_command("<dev string:x50b>" + hashtostring("<dev string:x560>") + "<dev string:xef>");
  util::add_debug_command("<dev string:x587>" + hashtostring("<dev string:x5da>") + "<dev string:xef>");
  util::add_debug_command("<dev string:x601>" + hashtostring("<dev string:x654>") + "<dev string:xef>");
  util::add_debug_command("<dev string:x67b>" + hashtostring("<dev string:x6ce>") + "<dev string:xef>");
  util::add_debug_command("<dev string:x6f5>" + hashtostring("<dev string:x748>") + "<dev string:xef>");
  util::add_debug_command("<dev string:x76f>" + hashtostring("<dev string:x7c6>") + "<dev string:xef>");
  util::add_debug_command("<dev string:x7ed>" + hashtostring("<dev string:x844>") + "<dev string:xef>");
  util::add_debug_command("<dev string:x86d>" + hashtostring("<dev string:x8c2>") + "<dev string:xef>");
  util::add_debug_command("<dev string:x8eb>" + hashtostring("<dev string:x940>") + "<dev string:xef>");
  util::add_debug_command("<dev string:x969>" + hashtostring("<dev string:x9be>") + "<dev string:xef>");
  util::add_debug_command("<dev string:x9e7>" + hashtostring("<dev string:xa3c>") + "<dev string:xef>");
  util::add_debug_command("<dev string:xa65>" + hashtostring("<dev string:xabb>") + "<dev string:xef>");
  util::add_debug_command("<dev string:xae1>" + hashtostring("<dev string:xb37>") + "<dev string:xef>");
  util::add_debug_command("<dev string:xb5f>" + hashtostring("<dev string:xbb3>") + "<dev string:xef>");
  util::add_debug_command("<dev string:xbdb>" + hashtostring("<dev string:xc2f>") + "<dev string:xef>");
  util::add_debug_command("<dev string:xc57>" + hashtostring("<dev string:xcab>") + "<dev string:xef>");
  util::add_debug_command("<dev string:xcd3>" + hashtostring("<dev string:xd27>") + "<dev string:xef>");
  util::add_debug_command("<dev string:xd4f>" + hashtostring(#"field_upgrade_frenzied_guard_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:xda7>" + hashtostring(#"field_upgrade_frenzied_guard_1_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:xdff>" + hashtostring(#"field_upgrade_frenzied_guard_2_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:xe55>" + hashtostring(#"field_upgrade_frenzied_guard_3_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:xeab>" + hashtostring(#"field_upgrade_frenzied_guard_4_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:xf01>" + hashtostring(#"field_upgrade_frenzied_guard_5_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:xf57>" + hashtostring(#"field_upgrade_toxic_growth_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:xfad>" + hashtostring(#"field_upgrade_toxic_growth_1_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x1003>" + hashtostring(#"field_upgrade_toxic_growth_2_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x1057>" + hashtostring(#"field_upgrade_toxic_growth_3_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x10ab>" + hashtostring(#"field_upgrade_toxic_growth_4_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x10ff>" + hashtostring(#"field_upgrade_toxic_growth_5_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x1153>" + hashtostring(#"field_upgrade_lightning_links_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x11ac>" + hashtostring(#"field_upgrade_lightning_links_1_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x1205>" + hashtostring(#"field_upgrade_lightning_links_2_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x125c>" + hashtostring(#"field_upgrade_lightning_links_3_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x12b3>" + hashtostring(#"field_upgrade_lightning_links_4_item_sr") + "<dev string:xef>");
  util::add_debug_command("<dev string:x130a>" + hashtostring(#"field_upgrade_lightning_links_5_item_sr") + "<dev string:xef>");
