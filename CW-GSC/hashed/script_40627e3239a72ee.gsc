 ...
 * Script: hashed\script_40627e3239a72ee.gsc
***********************************************/
...
function function_8dc68d9c() {
  ...
  foreach(pos in a_s_pos) {
    ...
    if(pos.script_noteworthy === "hit_location") {
      ...
      slots = [];
      slots[slots.size] = {
        #origin: pos.origin, #on_navmesh: 0
      };
      self.is_active = 1;
      self.var_b79a8ac7 = {
        #var_f019ea1a: 1200, #slots: slots
      };
      continue;
    }
...
function function_d825b521() {
  level zm_sq::register(#"upgrade_quest", #"step_1", #"hash_5e3bafbf90c3a595", &function_b546cde6, &function_fd853e02);
  level zm_sq::register(#"upgrade_quest", #"step_2", #"hash_5e3bacbf90c3a07c", &function_a38008d1, &function_54e9a43b);
  level flag::wait_till(#"start_zombie_round_logic");
  level zm_sq::start(#"upgrade_quest", 1);
}
...
function function_4675ef4e() {
  ...
  foreach(var_2551a4be in var_9039575a.var_2409a5e6) {
    if(isDefined(var_2551a4be.mdl)) {
      var_2551a4be.mdl setModel(#"p9_zm_platinum_armor_station_abandoned_screen_02");
      var_2551a4be.mdl playSound(#"hash_5e793e8deaf716a6");
      var_2551a4be.mdl playLoopSound(#"hash_648ae65d9a233cf9");
    }
  }
  ...
  foreach(var_2551a4be in var_9039575a.var_2409a5e6) {
    if(isDefined(var_2551a4be.mdl)) {
      var_2551a4be.mdl setModel(#"p9_zm_platinum_armor_station_abandoned_screen_03");
    ...
    if(isDefined(var_2551a4be.var_429cef67)) {
      var_2551a4be.var_429cef67 setModel(#"p9_zm_platinum_armor_station_abandoned_screen_04");
      var_2551a4be.mdl playSound(#"hash_18d052827c85e15");
      var_2551a4be.mdl playLoopSound(#"hash_19b4044ad55db503");
    }
  }
...
function function_c490ff56(params) {
  ...
  iprintlnbold("<dev string:x6a>" + attacker.var_e941964e);
...
function function_f26e6dd8() {
  ...
  zm_sq::objective_set(#"hash_7a3926f32c4410eb", level.klaus, 1, #"hash_3258f0b2a8184c64");
...
function function_b20e6cff() {
  ...
  wait 0.5;
  level thread zm_platinum_main_quest::function_e8799ac6(self, 512);
  self scene::stop(#"hash_a4fed5bd30bd26b");
...
function private function_4a57e36(aitype, origin, angles, scene, shot, hidden = 1) {
  while(true) {
    ...
    if(isDefined(var_55033b92)) {
      var_55033b92 val::set(#"upgraded_idle", "ignoreall", 1);
...
function private function_a7642f50(scene, shot) {
  ...
  self val::reset(#"upgraded_idle", "ignoreall");
  self pathmode("move allowed");
}

function function_12f0e19b() {
  level endon(#"end_game", #"hash_30bd3fb769cba5e7");
  self endon(#"defend_succeed", #"defend_failed");
...
function private function_1bf091a7() {
  level endon(#"end_game");
  util::waittill_any_ents(level, #"hash_30bd3fb769cba5e7", self, #"defend_succeed", self, #"defend_failed");
...
function function_cd7a3de4() {
  ...
  util::add_debug_command("<dev string:x1d7>");
  util::add_debug_command("<dev string:x23f>");
  util::add_debug_command("<dev string:x2ba>");
  util::add_debug_command("<dev string:x31c>");
  util::add_debug_command("<dev string:x37e>");
  util::add_debug_command("<dev string:x3e0>");
  util::add_debug_command("<dev string:x446>");
