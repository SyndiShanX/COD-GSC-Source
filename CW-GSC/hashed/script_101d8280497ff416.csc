 ...
 * Script: hashed\script_101d8280497ff416.csc
***********************************************/
...
function setup_groups() {
  ...
  println("<dev string:x1e3>" + (isDefined(level.var_ac56bfa4) ? level.var_ac56bfa4 : "<dev string:x215>"));

  if(level.var_ac56bfa4 === var_282e0a11) {
    println("<dev string:x222>");
    return;
  }

  println("<dev string:x257>");
}
