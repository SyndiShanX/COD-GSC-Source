 ...
 * Script: hashed\script_654423edfcdca394.gsc
***********************************************/
...
function function_36718adf(instance) {
  ...
  instance.var_5ea363c = content_manager::spawn_script_model(instance.var_3bb47a83, #"veh_t9_sv_truck_hemtt_payload_rocket");
...
function function_d63c4af(instance) {
  instance endon(#"objective_ended", #"transport_go");
  self endon(#"death");
  wait 3;
    ...
    if(level.var_50cb7dc9 > 1) {
      ...
      if(isDefined(level.var_74d92ff6) && level.var_74d92ff6 <= 90) {
        level scoreevents::doscoreeventcallback("scoreEventSR", {
          #scoreevent: "transport_rapid_delivery_zm", #allplayers: 1
        });
      }
      ...
      if(isDefined(self.var_ff72be84.health) && isDefined(self.var_ff72be84.max_health) && self.var_ff72be84.health / self.var_ff72be84.max_health >= 0.8) {
        level scoreevents::doscoreeventcallback("scoreEventSR", {
          #scoreevent: "transport_pristine_zm", #allplayers: 1
        });
      }
...
function function_81b42164() {
  ...
  wait 3;
  self.var_7a1183ab clientfield::set("" + # "rocket_thruster", 1);
  ...
  wait 1;
  self.var_7a1183ab clientfield::set("" + # "rocket_thruster", 0);
  ...
  if(isDefined(self.var_da3c0f01)) {
    foreach(var_b3fb5814 in self.var_da3c0f01) {
      if(isDefined(var_b3fb5814)) {
        if(!is_true(var_b3fb5814.mdl_canister.b_pickedup) && isDefined(var_b3fb5814.mdl_canister)) {
          var_b3fb5814.mdl_canister delete();
        }
...
function function_fbaf0bd(a_s_pts) {
  self endon(#"objective_ended", #"harvest_done");
  ...
  while(true) {
    ...
    if(isDefined(s_spawnpt) && self.n_active < self.n_max) {
      ...
      ai_spawned = namespace_85745671::function_9d3ad056(str_aitype, s_spawnpt.origin, s_spawnpt.angles, "transport_zombie");
      wait 0.1;
...
function function_6e3b7f88(instance) {
  self endon(#"death", #"truck_approach");
  instance endon(#"objective_ended");
...
function function_57812547(s_pt) {
  ...
  if(isDefined(s_pt) && self.n_active < n_max) {
    ...
    if(self flag::get(#"tempest_spawn")) {
      if(self.var_9d0832d6 < self.var_6720064d) {
        str_aitype = # "spawner_bo5_avogadro_sr";
      }
    }

    ai_spawned = namespace_85745671::function_9d3ad056(str_aitype, s_pt.origin, v_ang, "transport_zombie");
    wait 0.1;
    ...
    if(isDefined(ai_spawned)) {
      ...
      if(self flag::get(#"tempest_spawn") && str_aitype === # "spawner_bo5_avogadro_sr") {
        self.var_9d0832d6++;
      }
    }
  }
...
function function_14cb5911(instance) {
  self endon(#"death");
  instance endon(#"objective_ended");
  instance flag::wait_till(#"truck_emp");
...
function function_f2659c3a(instance) {
  ...
  self.var_ff72be84 thread truck_approach(self, self.var_6135d9ba, 4000);
  ...
  self flag::wait_till(#"harvest_done");
  wait 0.5;
  self.var_ff72be84 notify(#"transport_enable");
  self.var_ff72be84 thread function_6e3b7f88(self);
  self.var_6135d9ba clientfield::set("" + # "hash_7434dc21c6d7b515", 0);
  self.var_6135d9ba.var_776aca17 clientfield::increment("" + # "canister_shockwave");
  ...
  self.var_ff72be84 thread truck_approach(self, self.var_a8e6692e, 6000);
  wait 0.1;
  self thread function_5671b2f0("vortex_2");
  self.var_ff72be84 flag::wait_till(#"truck_approach");
  ...
  self.var_a8e6692e.var_776aca17 clientfield::increment("" + # "canister_shockwave");
...
function function_7864688c(n_index) {
  ...
  self flag::set(#"vortex_gone");
  wait 0.5;
  self flag::clear(#"vortex_gone");
}
...
function function_5671b2f0(var_1d9bbfbb) {
  self endon(#"objective_ended", #"truck_emp");
...
function function_913f0e5a() {
  ...
  self.var_ff72be84 flag::clear(#"truck_approach");
...
function function_6abe3eb2(v_org) {
  ...
  if(isDefined(self) && self.zm_ai_category === # "normal") {
...
function truck_approach(instance, var_d8f8912, var_e7201bd1) {
  instance endon(#"objective_ended");
  self endon(#"truck_approach");
  n_dist = sqr(var_e7201bd1);

  while(true) {
    if(distance2dsquared(var_d8f8912.origin, self.origin) <= n_dist) {
      self flag::set(#"truck_approach");
      break;
    }
...
function function_6828193b() {
  ...
  foreach(var_b3fb5814 in self.var_da3c0f01) {
    ...
    if(!is_true(var_b3fb5814.mdl_canister.b_pickedup)) {
...
function function_b588231f() {
  self endon(#"objective_ended", #"players_dead", #"launcher_approach");
  self flag::wait_till(#"tempest_spawn");
...
function function_c8bfd10b(str_team, e_player, b_result) {
  ...
  if(b_result) {
    ...
    if(isDefined(e_player.mdl_canister)) {
      e_player.mdl_canister delete();
    } else {
      e_player detach(#"p9_sur_console_control_01_canister_full", "tag_stowed_back");
    }
    ...
    foreach(mdl_canister in var_53ba65b) {
      if(isDefined(var_67aa3392) && mdl_canister != var_67aa3392 && isDefined(mdl_canister.n_objective_id) && !is_true(mdl_canister.var_2e5efdc7)) {
        objective_setvisibletoplayer(mdl_canister.n_objective_id, e_player);
      }
    }
...
function function_f692b63a(instance, n_index) {
  instance endon(#"objective_ended", #"harvest_done");

  if(isDefined(instance.var_ff72be84)) {
    instance.var_ff72be84 endon(#"death");
  }

  instance flag::wait_till(#"harvest_start");
...
function restore_health(instance, n_damage) {
  ...
  if(n_damage > 0) {
    ...
    util::wait_network_frame();
    self setdestructibledef("destructible_veh_t9_mil_ru_truck_transport_player_wz");
    util::wait_network_frame();
...
function function_9458dd64() {
  ...
  self flag::wait_till(#"harvest_start");
  ...
  self flag::set(#"harvest_done");
}

function function_6a62464c(v_goal, n_dist, n_time) {
  self endon(#"death");
  self clientfield::set("" + # "zombie_marked", 1);
  n_inc = 200;
  ...
  self clientfield::set("" + # "zombie_marked", 0);
  wait 0.1;
...
function function_990585f(params) {
  ...
  self waittill(#"transport_enable");
  self.is_staircase_up = undefined;
  self flag::clear(#"truck_emp");
  self transport_enable();
}
...
function function_c36cb7b1(params) {
  ...
  if(is_true(params.eattacker.var_28107825)) {
    if(self.zm_ai_category === # "elite") {
      level scoreevents::doscoreeventcallback("scoreEventSR", {
        #scoreevent: "retrieve_cannister_elite_kill_zm", #attacker: params.eattacker, #enemy: self
      });
      return;
    }
    ...
    if(self.zm_ai_category === # "special") {
      level scoreevents::doscoreeventcallback("scoreEventSR", {
        #scoreevent: "retrieve_cannister_special_kill_zm", #attacker: params.eattacker, #enemy: self
      });
    }
  }
}
...
function function_31fe5df1(instance) {
  ...
  while(true) {
    ...
    wait 0.1;
    instance flag::clear(#"harvest_start");
    instance flag::wait_till(#"harvest_done");
    wait 0.1;
    self stoprumble("sr_machinery_rumble");
    self clientfield::set("" + # "hash_2833af7211f19903", 0);
    instance flag::clear(#"harvest_done");
  }
}
...
function function_13a328f(instance) {
  ...
  self.mdl_canister = util::spawn_model(#"p9_sur_console_control_01_canister_full", self gettagorigin("canister_jnt"), self.angles);
  waitframe(1);
  instance.var_53ba65b[instance.var_53ba65b.size] = self.mdl_canister;
  self.mdl_canister.targetname = "transport_canister";
  self.mdl_canister ghost();
  self.mdl_canister notsolid();
  self.mdl_canister linkto(self, "canister_jnt");
  instance flag::wait_till_any(array(#"final_fight", #"hash_6850d08488f52f5e"));
...
function function_f7616c2b(instance) {
  ...
  if(isDefined(self.mdl_canister)) {
    self.mdl_canister.n_id = self.n_id;
    self.mdl_canister clientfield::set("" + # "canister_glow", 1);
    self clientfield::set("" + # "canister_glow", 0);
    self.mdl_canister show();
    self.mdl_canister solid();
    self.mdl_canister.v_start = self.mdl_canister.origin;
    wait 0.1;
...
function function_7d00b085() {
  if(is_true(self.var_28107825) && !self util::is_spectating()) {
    ...
    if(isDefined(self.mdl_canister)) {
      self.mdl_canister delete();
    } else {
      self detach(#"p9_sur_console_control_01_canister_full", "tag_stowed_back");
    }

    self notify(#"drop_comp");
...
function function_4be8796(instance) {
  ...
  if(!is_true(self.var_67aa3392.var_a325551c)) {
    ...
    namespace_1b527536::function_7281de4d(#"field_upgrade_canister_item_sr", &function_94e78240, #"hash_60cb3fd3716d711e", #"ui_icon_zm_field_upgrade_canister", 1, 6, 1);
    return;
  }
  ...
  namespace_1b527536::function_7281de4d(#"field_upgrade_canister_item_sr", &function_94e78240, #"hash_60cb3fd3716d711e", #"ui_icon_zm_field_upgrade_canister", 1, 6, 0);
...
function function_d52adbbc(instance) {
  instance endon(#"objective_ended");
  self endon(#"disconnect", #"player_downed", #"drop_comp", #"sudden_death");
...
function function_e1c4e1c2(ai_zombie) {
  if(isDefined(ai_zombie)) {
    ...
    if(ai_zombie.zm_ai_category === # "special" || ai_zombie.zm_ai_category === # "elite") {
      ai_zombie ai::stun(2);
    }
  }
}
...
function function_912eedf3(zombie) {
  ...
  if(isalive(zombie)) {
    ...
    level scoreevents::doscoreeventcallback("scoreEventSR", {
      #scoreevent: "retrieve_cannister_kill_zm", #attacker: self, #enemy: zombie
    });
...
function function_61ee3ab0(instance, mdl_canister) {
  instance endon(#"objective_ended");
  mdl_canister endon(#"installed");
  self waittill(#"drop_comp");
  ...
  mdl_canister thread canister_drop();
}

function canister_drop() {
  if(isDefined(self.e_owner)) {
...
function monitor_timer() {
  ...
  while(true) {
    ...
    foreach(mdl_canister in self.var_53ba65b) {
      if(is_true(mdl_canister.b_pickedup) || is_true(mdl_canister.var_2e5efdc7)) {
        var_dc9a9acc++;
      }
    }
...
function function_9181f7b3(instance) {
  ...
  self endon(#"disconnect", #"drop_comp");
  instance endon(#"objective_ended");
  s_result = self waittill(#"enter_vehicle");
...
function function_7bde6917() {
  ...
  if(isDefined(self.var_ff72be84)) {
    ...
    while(true) {
      if(self flag::get(#"truck_stopped") || self.var_ff72be84 getspeedmph() < 1) {
...
function vehicle_emp(params) {
  ...
  if(isDefined(level.contentmanager.activeobjective)) {
    level.contentmanager.activeobjective flag::wait_till(#"vortex_gone");
  }
