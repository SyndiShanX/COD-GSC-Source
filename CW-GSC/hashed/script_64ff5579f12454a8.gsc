 ...
 * Script: hashed\script_64ff5579f12454a8.gsc
***********************************************/
...
function preinit() {
  ...
  if(getdvarint(#"hash_c0b5b313ff35979", 0)) {
    setDvar(#"hash_4c7a7b0813c6765d", "<dev string:x38>");
...
function private function_6b9a56f7(var_2b357ce9, var_edf7d1ed, b_timeout = 1, n_radius = 160) {
  ...
  if(b_timeout) {
    ...
    if(s_result._notify === "timeout") {
      var_2b357ce9 notify(#"rift_close");
      return;
    }
  }

  var_2b357ce9 waittill(#"player_exiting");
}
...
function private function_6c8a368(eventstruct) {
  if(isPlayer(self) && eventstruct.item.itementry.name === # "item_survival_mq4_beacon_device") {
    ...
    if(!level flag::get(#"hash_537da116d92d952f")) {
      ...
      function_f73a5c91();
      level thread function_9026620d();
      level zm_vo::function_7622cb70(#"mq4_beacon_device", 0.5);
    }
  }
}
...
function function_9026620d() {
  ...
  level waittill(#"portal_activated", #"hash_3e765c26047c9f54");
...
function function_ba2ed0f6(instance) {
  ...
  instance.var_a9ef21d = content_manager::spawn_script_model(instance.var_1c61fe4b, #"p9_zm_ndu_reel_to_reel_audio_recorder_01");
...
function function_830b8b01(instance) {
  ...
  level thread unstable_orb(instance);
...
function private function_f5f14ffe(instance) {
  ...
  wait 0.2;
  instance.var_af44ab5f = content_manager::spawn_script_model(level.var_2c678640, #"p9_zm_platinum_magic_box_bunny");
...
function private function_6fcaf33e(var_af44ab5f) {
  self notify("<dev string:x61>");
  self endon("<dev string:x61>");

  while(isDefined(var_af44ab5f.trigger)) {
    var_2b4ca868 = var_af44ab5f gettagorigin("<dev string:x75>");
...
function private unstable_orb(instance) {
  ...
  while(!level flag::get(#"hash_4b060b9820d4141d")) {
    ...
    v_average = var_d297efab / max(var_6ba3d26a.size, 1);
    v_average = (0, absangleclamp360(v_average[1]), 0);
    var_853a6020 = 0;
    ...
    while(var_5848577a.size) {
      v_dest = mdl_orb.origin + anglesToForward(v_average) * (1500 + var_853a6020);
      ...
      var_b45fc900 = math::angle_dif(int(absangleclamp360(var_af6fb377[1])), int(v_average[1]));
...
function function_9ad91439(instance) {
  ...
  var_1c4dd56d = instance.contentgroups[#"phase_rover"][0];
  ...
  instance.var_fb224b3b = content_manager::spawn_script_model(var_b8c8ab67, #"p9_zm_ndu_reel_to_reel_audio_recorder_01");
  waitframe(1);
...
function private function_1554ed60(eventstruct) {
  ...
  if(!level flag::get(#"hash_68879aa426e6559a")) {
    ...
    var_8485244b = self.instance.contentgroups[#"start_interact"][0];
