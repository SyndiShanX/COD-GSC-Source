 ...
 * Script: hashed\script_7492032440d4d998.gsc
***********************************************/
...
function private function_626826e8(v_center, var_50721d66) {
  ...
  foreach(v_offset in var_9e6970bc[n_index]) {
    var_9da78756 = {
      #origin: v_center + v_offset, #type: 2
    };
  ...
  foreach(v_offset in var_a08fa5bf[n_index]) {
    var_9da78756 = {
      #origin: v_center + v_offset, #type: 1
    };
  ...
  var_9da78756 = {
    #origin: v_center + var_19c1ffe7[n_index], #type: 3
  };
