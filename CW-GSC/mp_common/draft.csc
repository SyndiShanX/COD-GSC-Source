...
function function_1cf2437c(localclientnum, draftcharacter, oldcharacterindex, newcharacterindex) {
  if(!isDefined([[newcharacterindex]] - > function_82e05d64().player)) {
    return;
  }

  if([[newcharacterindex]] - > function_82e05d64().localclientnum === oldcharacterindex && isDefined([[newcharacterindex]] - > function_82e05d64().selectedcharacterdata) && player_role::is_valid([[newcharacterindex]] - > function_82e05d64().selectedcharacterdata.charactertype)) {
    [[newcharacterindex]] - > function_82e05d64().player battlechatter::play_dialog("characterSelect", oldcharacterindex);
  }
}
    ...
    if(isDefined(positiondraftclientsmodel)) {
      ...
      if(clientnum >= 0) {
        ...
        if(is_true([[draftcharacter]] - > function_82e05d64().islocalclient) || codcaster::function_b8fe9b52(localclientnum)) {
          ...
          if(isDefined([[draftcharacter]] - > function_82e05d64().selectedcharacterdata) && player_role::is_valid([[draftcharacter]] - > function_82e05d64().selectedcharacterdata.charactertype) || codcaster::function_b8fe9b52(localclientnum)) {
