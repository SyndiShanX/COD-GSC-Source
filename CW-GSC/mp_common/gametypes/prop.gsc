...
function function_63d4897() {
  ...
  while(true) {
    ...
    if(height != -1 && height != var_309e583f.propheight) {
      ...
      clientfield::set_to_player("<dev string:x4a>", int(self.thirdpersonheightoffset / 10));
    }
    ...
    if(range != -1 && range != var_309e583f.proprange) {
      ...
      clientfield::set_to_player("<dev string:x5f>", int(self.thirdpersonrange / 10));
    }
...
function function_32041818() {
  path = "<dev string:x73>";
  adddebugcommand("<dev string:x8d>" + "<dev string:x9c>" + "<dev string:xac>");
  adddebugcommand("<dev string:x8d>" + "<dev string:xbb>" + "<dev string:xac>");
  adddebugcommand("<dev string:x8d>" + "<dev string:xcb>" + "<dev string:xac>");
  adddebugcommand("<dev string:x8d>" + "<dev string:xdb>" + "<dev string:xeb>");
  adddebugcommand("<dev string:x8d>" + "<dev string:xfa>" + "<dev string:xeb>");
  adddebugcommand("<dev string:x8d>" + "<dev string:x10a>" + "<dev string:xeb>");
  adddebugcommand("<dev string:x11a>" + "<dev string:x127>" + "<dev string:x136>");
  adddebugcommand("<dev string:x11a>" + "<dev string:x143>" + "<dev string:x151>");
  adddebugcommand("<dev string:x8d>" + "<dev string:x160>" + "<dev string:x16e>");
  adddebugcommand("<dev string:x179>" + path + "<dev string:x9c>" + "<dev string:x189>" + "<dev string:x9c>");
  adddebugcommand("<dev string:x179>" + path + "<dev string:xbb>" + "<dev string:x191>" + "<dev string:xbb>");
  adddebugcommand("<dev string:x179>" + path + "<dev string:xcb>" + "<dev string:x199>" + "<dev string:xcb>");
  adddebugcommand("<dev string:x179>" + path + "<dev string:xdb>" + "<dev string:x1a1>" + "<dev string:xdb>");
  adddebugcommand("<dev string:x179>" + path + "<dev string:xfa>" + "<dev string:x1a9>" + "<dev string:xfa>");
  adddebugcommand("<dev string:x179>" + path + "<dev string:x10a>" + "<dev string:x1b1>" + "<dev string:x10a>");
  adddebugcommand("<dev string:x179>" + path + "<dev string:x127>" + "<dev string:x1b9>" + "<dev string:x127>");
  adddebugcommand("<dev string:x179>" + path + "<dev string:x143>" + "<dev string:x1c1>" + "<dev string:x143>");
  adddebugcommand("<dev string:x179>" + path + "<dev string:x160>" + "<dev string:x1c9>" + "<dev string:x160>");
}
...
function getpropsize(propsizetext) {
  if(propsizetext == "<dev string:x1d1>") {
    return 0;
  }
  ...
  switch (propsizetext) {
    ...
    default:
      mapname = getmapname();
      var_a01224f2 = "gamedata/tables/mp/" + mapname + "_ph.csv";
      assertmsg("<dev string:x1db>" + propsizetext + "<dev string:x1f2>" + var_a01224f2 + "<dev string:x207>");
      propsize = 75;
      break;
  }
...
function stillalivexp() {
  ...
  while(true) {
    ...
    if(getgametypesetting("<dev string:x20d>") == 0) {
      continue;
    }
...
function function_bfc79664(var_167fb943, remainingtime) {
  ...
  if(remainingtime > 8) {
    ...
    self val::function_5276aede(#"props_hide", 1);
    result = self function_1ee6f124(var_ed3bdaed);
    self val::function_5276aede(#"props_hide", 0);
    fadeintime = 1;
  }
...
function onplayerkilled(einflictor, attacker, idamage, smeansofdeath, weapon, vdir, shitloc, psoffsettime, deathanimduration, lifeid) {
  ...
  if(victim.team == game.attackers && victim.var_4e6d7877 !== 1) {
    self thread respawnplayer();
  } else if(!level flag::get("props_hide_over") && victim.var_4e6d7877 !== 1) {
    self thread respawnplayer();
    return;
  } else {
    level.prop_controls mp_prop_controls::close(self);
...
function waittillcanspawnclient() {
  ...
  for(;;) {
    ...
    if(self.var_4e6d7877 === 1 || self.team !== var_e74281a8) {
      self.var_4e6d7877 = 1;
      return;
    }
  ...
  if(weapon.rootweapon === level.phsettings.var_86fda1fd) {
    ...
    if(meansofdeath != "MOD_IMPACT") {
      if(self hasperk("specialty_stunprotection")) {
        time *= 0.1;
      } else if(self util::mayapplyscreeneffect() && !is_true(self.lock)) {
