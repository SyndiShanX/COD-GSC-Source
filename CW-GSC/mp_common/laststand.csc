...
function private preinit() {
  ...
  clientfield::register_clientuimodel("hudItems.laststand.cowardsWayBleedOut", #"last_stand", #"cowardswaybleedout", 1, 1, "int", undefined, 0, 0);
  ...
  clientfield::register_clientuimodel("hud_items.selfReviveAvailable", #"hud_items", #"selfreviveavailable", 1, 1, "int", undefined, 0, 0);
