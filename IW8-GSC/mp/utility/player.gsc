...
_freezecontrols(var_0, var_1, var_2) {
  ...
  if(isDefined(var_2)) {
    if(var_0) {
      ...
      self.pers["_encstr_8463164B90E8F382C770CA52687D7A4F6182D5E43D31BF8F"] = [];
    else if(!isDefined(self.pers["_encstr_8463164B90E8F382C770CA52687D7A4F6182D5E43D31BF8F"][var_2]) || self.pers["_encstr_8463164B90E8F382C770CA52687D7A4F6182D5E43D31BF8F"][var_2] == 0) {} else {
      self.pers["_encstr_8463164B90E8F382C770CA52687D7A4F6182D5E43D31BF8F"][var_2]--;
