 ...
 * Script: character\character_iw8_russian_army_1_safehouse_finale.gsc
***********************************************************************/

#using_animtree("generic_human");

function main() {
  scripts\code\character::setmodelfromarray(xmodelalias\russian_army_bodies_1_light::main());
...
function precache() {
  scripts\code\character::precachemodelarray(xmodelalias\russian_army_bodies_1_light::main());
