 ...
 * Script: character\character_al_qatala_urban_ar_variant.gsc
**************************************************************/

#using_animtree("generic_human");

function main() {
  scripts\code\character::setmodelfromarray(xmodelalias\bodies_al_qatala_urban_ar_variant::main());
...
function precache() {
  scripts\code\character::precachemodelarray(xmodelalias\bodies_al_qatala_urban_ar_variant::main());
