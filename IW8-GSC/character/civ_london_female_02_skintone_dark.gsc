 ...
 * Script: character\civ_london_female_02_skintone_dark.gsc
************************************************************/

#using_animtree("generic_human");

function main() {
  scripts\code\character::setmodelfromarray(xmodelalias\civilian_london_female_body_02_skintone_dark::main());
...
function precache() {
  scripts\code\character::precachemodelarray(xmodelalias\civilian_london_female_body_02_skintone_dark::main());
