 ...
 * Script: character\character_civilian_me_male_cinderblock_c.gsc
******************************************************************/
...
function main() {
  ...
  self.animationarchetype = "civilian_cinderblockc";
  self.voice = "fsa";
...
function precache_mp(var_0) {
  level.agent_definition[var_0]["animclass"] = "civilian_cinderblockc";
}