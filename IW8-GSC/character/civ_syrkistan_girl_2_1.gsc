 ...
 * Script: character\civ_syrkistan_girl_2_1.gsc
************************************************/

#using_animtree("generic_human");

function main() {
  self setModel("body_civ_syrkistan_girl_2_1");
  self attach("head_sc_f_chivikina_child", "", 1);
  self.headmodel = "head_sc_f_chivikina_child";
