 ...
 * Script: character\civ_london_female_skintone_light_anim_safe.gsc
********************************************************************/

#using_animtree("generic_human");

function main() {
  scripts\code\character::setmodelfromarray(xmodelalias\civilian_london_female_body_skintone_01_anim_safe::main());
...
function precache() {
  scripts\code\character::precachemodelarray(xmodelalias\civilian_london_female_body_skintone_01_anim_safe::main());
