 ...
 * Script: character\civ_embassy_office_worker_female_1_1.gsc
**************************************************************/

#using_animtree("generic_human");

function main() {
  self setModel("body_civ_embassy_office_worker_female_1_1");
...
function precache() {
  precachemodel("body_civ_embassy_office_worker_female_1_1");
