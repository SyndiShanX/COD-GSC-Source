 ...
 * Script: character\character_civ_male_rus_clerical_1.gsc
***********************************************************/
...
function main() {
  ...
  self attach("head_sc_m_orlovszki_civ", "", 1);
  self.headmodel = "head_sc_m_orlovszki_civ";
...
function precache() {
  ...
  precachemodel("head_sc_m_orlovszki_civ");
}
