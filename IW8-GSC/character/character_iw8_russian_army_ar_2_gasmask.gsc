 ...
 * Script: character\character_iw8_russian_army_ar_2_gasmask.gsc
*****************************************************************/
...
function main() {
  ...
  scripts\code\character::attachhat("russian_army_ar_2_hats_gasmask", xmodelalias\russian_army_ar_2_hats_gasmask::main());
...
function precache() {
  ...
  scripts\code\character::precachemodelarray(xmodelalias\russian_army_ar_2_hats_gasmask::main());
}
