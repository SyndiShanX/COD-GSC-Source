 ...
 * Script: character\character_civilian_me_female_veil.gsc
***********************************************************/

#using_animtree("generic_human");

function main() {
  scripts\code\character::setmodelfromarray(xmodelalias\civilian_me_female_veil_bodies::main());
...
function precache() {
  scripts\code\character::precachemodelarray(xmodelalias\civilian_me_female_veil_bodies::main());
