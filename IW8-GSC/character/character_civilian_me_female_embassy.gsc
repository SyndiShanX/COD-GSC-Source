 ...
 * Script: character\character_civilian_me_female_embassy.gsc
**************************************************************/

#using_animtree("generic_human");

function main() {
  scripts\code\character::setmodelfromarray(xmodelalias\civilian_me_female_embassy_bodies::main());
...
function precache() {
  scripts\code\character::precachemodelarray(xmodelalias\civilian_me_female_embassy_bodies::main());
