 ...
 * Script: character\character_civilian_me_male_dist.gsc
*********************************************************/

#using_animtree("generic_human");

function main() {
  scripts\code\character::setmodelfromarray(xmodelalias\civilian_syrkistan_male_body_dist::main());
...
function precache() {
  scripts\code\character::precachemodelarray(xmodelalias\civilian_syrkistan_male_body_dist::main());
