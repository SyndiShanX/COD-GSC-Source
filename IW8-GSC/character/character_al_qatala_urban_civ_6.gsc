 ...
 * Script: character\character_al_qatala_urban_civ_6.gsc
*********************************************************/

#using_animtree("generic_human");

function main() {
  self setModel("body_al_qatala_urban_civ_6_1");
  self attach("head_sc_m_tabassomi_civ", "", 1);
  self.headmodel = "head_sc_m_tabassomi_civ";
  self.hatmodel = "hat_sc_m_tabassomi_civ_bandana";
...
function precache() {
  ...
  precachemodel("hat_sc_m_tabassomi_civ_bandana");
}
