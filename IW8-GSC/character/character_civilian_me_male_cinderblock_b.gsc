 ...
 * Script: character\character_civilian_me_male_cinderblock_b.gsc
******************************************************************/
...
function main() {
  ...
  self.animationarchetype = "civilian_cinderblockb";
  self.voice = "fsa";
...
function precache_mp(var_0) {
  level.agent_definition[var_0]["animclass"] = "civilian_cinderblockb";
}