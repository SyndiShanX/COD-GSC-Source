...
main(var_0, var_1, var_2) {
  ...
  scripts\common\vehicle_build::build_deathmodel(var_0, "veh8_civ_lnd_ralfa_static_dst");
...
setanims() {
  ...
  var_0[0].idle = % reb_vh_ralfa_driver_idle_search01;
  var_0[1].idle = % reb_vh_ralfa_passenger_idle_search01;
