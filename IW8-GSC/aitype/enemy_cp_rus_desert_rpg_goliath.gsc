 ...
 * Script: aitype\enemy_cp_rus_desert_rpg_goliath.gsc
******************************************************/
...
function precache() {
  var0 = "actor_enemy_cp_rus_desert_rpg_goliath";
  ...
  if(!isDefined(level.agent_definition[var0])) {
    ...
    level.agent_definition[var0]["reward"] = 110;
    ...
    character\character_russian_boss_hometown_cp::precache_mp(var0);
  }
