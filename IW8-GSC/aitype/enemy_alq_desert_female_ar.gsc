 ...
 * Script: aitype\enemy_alq_desert_female_ar.gsc
*************************************************/
...
function main() {
  ...
  var_0 = undefined;
  var_1 = ["alq_syrkistan_female_scarf_red"];

  switch (scripts\code\character::get_random_character(1, var_0, var_1)) {
    case 0:
      character\alq_syrkistan_female_scarf_red::main();
      break;
  }
}
...
function precache(var_0) {
  character\alq_syrkistan_female_scarf_red::precache();
