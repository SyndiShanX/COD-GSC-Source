 ...
 * Script: aitype\enemy_cp_rus_desert_rpg_gasmask.gsc
******************************************************/
...
function setup_model(var_0) {
  var_1 = undefined;
  var_2 = ["character_spetsnaz_gasmask_lmg_cp", "character_spetsnaz_gasmask_nohelmet_lmg_cp"];

  switch (scripts\code\character::get_random_character(2, var_1, var_2, "actor_enemy_cp_rus_desert_rpg_gasmask")) {
    case 0:
...
function precache() {
  var_0 = "actor_enemy_cp_rus_desert_rpg_gasmask";
  ...
  if(!isDefined(level.agent_definition[var_0])) {
    ...
    scripts\cp\cp_enemy_sentry_turret::precache_mp(var_0);
  }
