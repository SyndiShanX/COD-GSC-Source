 ...
 * Script: aitype\enemy_cp_rus_desert_lmg_nvg.gsc
**************************************************/
...
function setup_model(var_0) {
  scripts\cp\cp_enemy_tank::main_mp();
}

function precache() {
  var_0 = "actor_enemy_cp_rus_desert_lmg_nvg";
  ...
  if(!isDefined(level.agent_definition[var_0])) {
    ...
    scripts\cp\cp_enemy_tank::precache_mp(var_0);
  }
