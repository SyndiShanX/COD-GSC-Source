 ...
 * Script: aitype\civilian_me_female_embassy_mom.gsc
*****************************************************/
...
function main() {
  ...
  character\character_civilian_me_female_embassy_mom::main();
}
...
function precache(var0) {
  character\character_civilian_me_female_embassy_mom::precache();
