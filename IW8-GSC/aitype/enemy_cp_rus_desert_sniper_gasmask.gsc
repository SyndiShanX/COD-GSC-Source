 ...
 * Script: aitype\enemy_cp_rus_desert_sniper_gasmask.gsc
*********************************************************/
...
function setup_model(var0) {
  var1 = undefined;
  var2 = ["character_spetsnaz_gasmask_cqc_cp", "character_spetsnaz_gasmask_ar_cp", "character_spetsnaz_gasmask_lmg_cp"];

  switch (scripts\code\character::get_random_character(3, var1, var2, "actor_enemy_cp_rus_desert_sniper_gasmask")) {
    case 0:
...
function precache() {
  var0 = "actor_enemy_cp_rus_desert_sniper_gasmask";
