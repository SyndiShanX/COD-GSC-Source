 ...
 * Script: aitype\enemy_cp_alq_desert_dmr.gsc
***********************************************/
...
function setup_model(var0) {
  ...
  switch (scripts\code\character::get_random_character(6, var1, var2, "actor_enemy_cp_alq_desert_dmr")) {
    case 0:
...
function precache() {
  var0 = "actor_enemy_cp_alq_desert_dmr";
