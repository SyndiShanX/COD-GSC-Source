 ...
 * Script: aitype\enemy_alq_urban_civ_female_whitetop_ar.gsc
*************************************************************/
...
function main() {
  ...
  var_0 = undefined;
  var_1 = ["civ_al_qatala_urban_civ_female_whitetop"];

  switch (scripts\code\character::get_random_character(1, var_0, var_1)) {
    case 0:
      character\civ_al_qatala_urban_civ_female_whitetop::main();
      break;
  }
}
...
function precache(var_0) {
  character\civ_al_qatala_urban_civ_female_whitetop::precache();
