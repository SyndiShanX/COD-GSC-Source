 ...
 * Script: aitype\enemy_cp_rus_desert_rpg_nvg.gsc
**************************************************/
...
function setup_model(var_0) {
  character\character_spetsnaz_riotshield_cp::main_mp();
}

function precache() {
  var_0 = "actor_enemy_cp_rus_desert_rpg_nvg";
  ...
  if(!isDefined(level.agent_definition[var_0])) {
    ...
    character\character_spetsnaz_riotshield_cp::precache_mp(var_0);
  }
