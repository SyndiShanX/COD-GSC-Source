...
function setup_model(var0) {
  var1 = undefined;
  var2 = ["character_cp_al_qatala_desert_ar"];

  switch (scripts\code\character::get_random_character(1, var1, var2, "actor_enemy_cp_alq_desert_ar_hvt")) {
    case 0:
...
function precache() {
  var0 = "actor_enemy_cp_alq_desert_ar_hvt";
