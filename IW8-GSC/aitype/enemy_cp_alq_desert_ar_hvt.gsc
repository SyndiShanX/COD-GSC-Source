 ...
 * Script: aitype\enemy_cp_alq_desert_ar_hvt.gsc
*************************************************/
...
function setup_model(var_0) {
  var_1 = undefined;
  var_2 = ["character_cp_al_qatala_desert_ar"];

  switch (scripts\code\character::get_random_character(1, var_1, var_2, "actor_enemy_cp_alq_desert_ar_hvt")) {
    case 0:
...
function precache() {
  var_0 = "actor_enemy_cp_alq_desert_ar_hvt";
