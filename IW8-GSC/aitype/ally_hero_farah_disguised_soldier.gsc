 ...
 * Script: aitype\ally_hero_farah_disguised_soldier.gsc
********************************************************/
...
function main() {
  ...
  character\character_hero_farah_disguised_soldier::main();
}
...
function precache(var0) {
  character\character_hero_farah_disguised_soldier::precache();
