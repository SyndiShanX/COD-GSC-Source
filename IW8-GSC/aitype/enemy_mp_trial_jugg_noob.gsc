 ...
 * Script: aitype\enemy_mp_trial_jugg_noob.gsc
***********************************************/
...
function main() {
  ...
  self setengagementmindist(64, 0);
  self setengagementmaxdist(128, 768);
  self.accuracy = 0.01;
...
function setup_model(var0) {
  character\character_spetsnaz_gasmask_ar_trial::main_mp();
}

function precache() {
  var0 = "actor_enemy_mp_trial_jugg_noob";
  ...
  if(!isDefined(level.agent_definition[var0])) {
    ...
    level.agent_definition[var0]["health"] = 100;
    ...
    character\character_spetsnaz_gasmask_ar_trial::precache_mp(var0);
  }
