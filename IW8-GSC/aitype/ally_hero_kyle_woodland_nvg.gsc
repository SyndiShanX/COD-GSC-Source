 ...
 * Script: aitype\ally_hero_kyle_woodland_nvg.gsc
**************************************************/
...
function main() {
  ...
  self.weapon = scripts\code\ai::create_weapon_in_script(["iw8_ar_mcharlie"]);
  character\character_hero_kyle_woodland_nvg::main();
}
