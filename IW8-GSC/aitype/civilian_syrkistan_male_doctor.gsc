 ...
 * Script: aitype\civilian_syrkistan_male_doctor.gsc
*****************************************************/
...
function main() {
  ...
  var_0 = undefined;
  var_1 = ["civ_syrkistan_male_doctor_mask", "civ_syrkistan_male_doctor_nomask"];

  switch (scripts\code\character::get_random_character(2, var_0, var_1)) {
    case 0:
      character\civ_syrkistan_male_doctor_mask::main();
      break;
    case 1:
      character\civ_syrkistan_male_doctor_nomask::main();
      break;
  }
}
...
function precache(var_0) {
  character\civ_syrkistan_male_doctor_mask::precache();
  character\civ_syrkistan_male_doctor_nomask::precache();
