 ...
 * Script: aitype\civilian_me_female_embassy.gsc
*************************************************/
...
function main() {
  ...
  character\character_civilian_me_female_embassy::main();
}
...
function precache(var0) {
  character\character_civilian_me_female_embassy::precache();
