 ...
 * Script: aitype\civilian_me_male_embassy_dad.gsc
***************************************************/
...
function main() {
  ...
  character\character_civilian_me_male_embassy_dad::main();
}
...
function precache(var0) {
  character\character_civilian_me_male_embassy_dad::precache();
