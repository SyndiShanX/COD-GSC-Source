 ...
 * Script: aitype\enemy_alq_urban_bomber.gsc
***********************************************/
...
function main() {
  ...
  var_0 = undefined;
  var_1 = ["character_iw8_al_qatala_urban_bombvest"];

  switch (scripts\code\character::get_random_character(1, var_0, var_1)) {
    case 0:
      character\character_iw8_al_qatala_urban_bombvest::main();
      break;
  }
}
...
function precache(var_0) {
  character\character_iw8_al_qatala_urban_bombvest::precache();
