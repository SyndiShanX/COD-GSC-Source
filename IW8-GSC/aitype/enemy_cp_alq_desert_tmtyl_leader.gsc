 ...
 * Script: aitype\enemy_cp_alq_desert_tmtyl_leader.gsc
*******************************************************/
...
function setup_model(var_0) {
  character\character_iw8_russian_army_1_trial::main_mp();
}

function precache() {
  var_0 = "actor_enemy_cp_alq_desert_tmtyl_leader";
  ...
  if(!isDefined(level.agent_definition[var_0])) {
    ...
    character\character_iw8_russian_army_1_trial::precache_mp(var_0);
  }
