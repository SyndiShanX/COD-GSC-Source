...
function precache() {
  var_0 = "actor_civilian_cp_tugofwar";
  ...
  if(!isDefined(level.agent_definition[var_0])) {
    ...
    level.agent_definition[var_0]["traversal_unit_type"] = "civilian";
    level.agent_definition[var_0]["health"] = 30;
    level.agent_definition[var_0]["xp"] = 50;
    level.agent_definition[var_0]["reward"] = 50;
    level.agent_definition[var_0]["asm"] = "civilian_cp";
    level.agent_definition[var_0]["radius"] = 15;
    level.agent_definition[var_0]["height"] = 70;
    level.agent_definition[var_0]["behaviorTree"] = "civilian_agent";
