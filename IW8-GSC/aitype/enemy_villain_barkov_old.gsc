 ...
 * Script: aitype\enemy_villain_barkov_old.gsc
***********************************************/
...
function main() {
  ...
  self.weapon = scripts\code\ai::create_weapon_in_script(["iw8_pi_cpapa"]);
  character\character_villain_barkov_old::main();
}
...
function precache(var0) {
  character\character_villain_barkov_old::precache();
