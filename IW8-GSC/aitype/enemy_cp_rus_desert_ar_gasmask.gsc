...
function setup_model(var_0) {
  var_1 = undefined;
  var_2 = ["character_spetsnaz_gasmask_ar_cp", "character_spetsnaz_gasmask_nohelmet_ar_cp"];

  switch (scripts\code\character::get_random_character(2, var_1, var_2, "actor_enemy_cp_rus_desert_ar_gasmask")) {
    case 0:
...
function precache() {
  var_0 = "actor_enemy_cp_rus_desert_ar_gasmask";
