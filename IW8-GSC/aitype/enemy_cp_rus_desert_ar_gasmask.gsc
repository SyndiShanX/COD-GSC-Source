 ...
 * Script: aitype\enemy_cp_rus_desert_ar_gasmask.gsc
*****************************************************/
...
function setup_model(var0) {
  var1 = undefined;
  var2 = ["character_spetsnaz_gasmask_ar_cp", "character_spetsnaz_gasmask_nohelmet_ar_cp"];

  switch (scripts\code\character::get_random_character(2, var1, var2, "actor_enemy_cp_rus_desert_ar_gasmask")) {
    case 0:
...
function precache() {
  var0 = "actor_enemy_cp_rus_desert_ar_gasmask";
