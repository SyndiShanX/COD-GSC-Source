 ...
 * Script: aitype\civilian_me_cinderblock_b.gsc
************************************************/
...
function main() {
  ...
  character\character_civilian_me_male_cinderblock_b::main();
}
...
function precache(var0) {
  character\character_civilian_me_male_cinderblock_b::precache();
