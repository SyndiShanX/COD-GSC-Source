 ...
 * Script: aitype\enemy_cp_rus_desert_smg_gasmask.gsc
******************************************************/
...
function setup_model(var0) {
  var1 = undefined;
  var2 = ["character_spetsnaz_gasmask_cqc_cp", "character_spetsnaz_gasmask_ar_cp", "character_spetsnaz_gasmask_nohelmet_ar_cp", "character_spetsnaz_gasmask_nohelmet_cqc_cp"];

  switch (scripts\code\character::get_random_character(4, var1, var2, "actor_enemy_cp_rus_desert_smg_gasmask")) {
    case 0:
    ...
    case 1:
      ...
      break;
    case 2:
      scripts\cp\cp_circuit_breaker::main_mp();
      break;
    case 3:
      scripts\cp\cp_enemy_drone_turret::main_mp();
      break;
  }
}

function precache() {
  var0 = "actor_enemy_cp_rus_desert_smg_gasmask";
  ...
  if(!isDefined(level.agent_definition[var0])) {
    ...
    scripts\cp\compass::precache_mp(var0);
    scripts\cp\cp_circuit_breaker::precache_mp(var0);
