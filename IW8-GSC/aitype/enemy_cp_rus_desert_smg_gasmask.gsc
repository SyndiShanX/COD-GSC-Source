...
function setup_model(var_0) {
  var_1 = undefined;
  var_2 = ["character_spetsnaz_gasmask_cqc_cp", "character_spetsnaz_gasmask_ar_cp", "character_spetsnaz_gasmask_nohelmet_ar_cp", "character_spetsnaz_gasmask_nohelmet_cqc_cp"];

  switch (scripts\code\character::get_random_character(4, var_1, var_2, "actor_enemy_cp_rus_desert_smg_gasmask")) {
    case 0:
...
function precache() {
  var_0 = "actor_enemy_cp_rus_desert_smg_gasmask";
  ...
  if(!isDefined(level.agent_definition[var_0])) {
    ...
    scripts\cp\cp_circuit_breaker::precache_mp(var_0);
