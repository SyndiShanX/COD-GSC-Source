 ...
 * Script: aitype\civilian_uk_male_embassy_ambassador.gsc
**********************************************************/
...
function main() {
  ...
  character\civ_london_male_embassy_ambassador::main();
}
...
function precache(var_0) {
  character\civ_london_male_embassy_ambassador::precache();
