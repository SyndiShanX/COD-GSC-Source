 ...
 * Script: aitype\civilian_cp_pilot_hvt.gsc
***********************************************/
...
function setup_model(var_0) {
  character\character_sas_pilot_helicopter_cp::main_mp();
}

function precache() {
  var_0 = "actor_civilian_cp_pilot_hvt";
  ...
  if(!isDefined(level.agent_definition[var_0])) {
    ...
    character\character_sas_pilot_helicopter_cp::precache_mp(var_0);
  }
