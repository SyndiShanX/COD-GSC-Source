 ...
 * Script: aitype\enemy_mp_trial_jugg_elite.gsc
************************************************/
...
function setup_model(var0) {
  var1 = undefined;
  var2 = ["character_spetsnaz_gasmask_ar_trial", "character_spetsnaz_gasmask_lmg_trial", "character_spetsnaz_gasmask_cqc_trial"];

  switch (scripts\code\character::get_random_character(3, var1, var2, "actor_enemy_mp_trial_jugg_elite")) {
    case 0:
...
function precache() {
  var0 = "actor_enemy_mp_trial_jugg_elite";
  ...
  if(!isDefined(level.agent_definition[var0])) {
    ...
    level.agent_definition[var0]["health"] = 500;
    ...
    scripts\cp\coop_escape::precache_mp(var0);
    scripts\cp\cp_checkpoint::precache_mp(var0);
    scripts\cp\cp_awards::precache_mp(var0);
  }
