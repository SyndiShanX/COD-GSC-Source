 ...
 * Script: aitype\civilian_me_cinderblock_c.gsc
************************************************/
...
function main() {
  ...
  character\character_civilian_me_male_cinderblock_c::main();
}
...
function precache(var0) {
  character\character_civilian_me_male_cinderblock_c::precache();
