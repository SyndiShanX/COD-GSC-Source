 ...
 * Script: aitype\civilian_me_cinderblock_d.gsc
************************************************/
...
function main() {
  ...
  character\character_civilian_me_male_cinderblock_d::main();
}
...
function precache(var0) {
  character\character_civilian_me_male_cinderblock_d::precache();
