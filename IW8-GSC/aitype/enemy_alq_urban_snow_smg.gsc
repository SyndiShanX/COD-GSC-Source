 ...
 * Script: aitype\enemy_alq_urban_snow_smg.gsc
***********************************************/
...
function main() {
  ...
  var_0 = undefined;
  var_1 = ["character_al_qatala_urban_ar_variant"];

  switch (scripts\code\character::get_random_character(1, var_0, var_1)) {
    case 0:
      character\character_al_qatala_urban_ar_variant::main();
      break;
  }
}
...
function precache(var_0) {
  character\character_al_qatala_urban_ar_variant::precache();
