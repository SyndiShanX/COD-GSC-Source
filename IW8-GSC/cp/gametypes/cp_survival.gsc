 ...
 * Script: cp\gametypes\cp_survival.gsc
***********************************************/
...
initdefaultsettings() {
  ...
  if(getdvarint("_encstr_AB1C179B2F78394FC171F13A1BB0B36E20893F1443F8FE277D", 0) <= 0) {
    setDvar("_encstr_8EB10B48F101F2EBF4BEDDDCD6", 560);
    setDvar("_encstr_B8610BC5BCB99F08E167979F37", 561);
    setDvar("_encstr_B6A30B7A9AC413984596A2D429", 560);
    setDvar("_encstr_91210B8D31359451D7313824D9", 561);
  }
...
onstartgametype() {
  ...
  if(level.gametype == "_encstr_839E0CBFD1801B5DB0D34C932998") {
    for(var_0 = 0; var_0 < level.players.size; var_0++)
      level.players[var_0] setclientomnvar("_encstr_8BCB112DF3390A3B3A66FB3F820F10911F73FD", "_encstr_AF8C0A1B6A1D6045925B4F7D");
  }
}
...
kick_for_inactivity(var_0) {
  ...
  var_1 = 0;
  var_2 = gettime();
  var_3 = level.onlinegame && !getdvarint("_encstr_93390B136AA2628AA8A93529D4");
...
enable_dogtag_revive(var_0) {
  ...
  level notify("_encstr_A198197CBF63DBDAE9F012AA1911155F3B17FFD7CE6BD7E3F538BA", var_1);
}
...
revivetriggerthink(var_0) {
  ...
  var_0 endon("_encstr_B17A0FC04B036BCA6803AE5662C31BDBD9");
  var_1 = 8000;
...
_id_124B9() {
  return istrue(game["_encstr_ACA91CC94BC077653B5798DDF7611C177A79D6417A4D40D7E8C94988AACD"]);
}
...
delay_init_infil() {
  ...
  var_0 = 4;
  wait(var_0);
  level thread scripts\cp\infilexfil\lbravo_infil_cp::lbravo_init("_encstr_BDBB0616C6C186C2");
  level waittill("_encstr_A32B1CC3D94F6B9D6083318318A8AFA295531B07A56EB25DE128754F90C0");
  game["_encstr_ACA91CC94BC077653B5798DDF7611C177A79D6417A4D40D7E8C94988AACD"] = 1;
}
...
lbravo_infil_spawn_blackscreen_func(var_0) {
  ...
  if(!scripts\cp\utility::gameflag("_encstr_8C0D0E8410E8B112602F133F559DCAF4")) {
    var_0.introscreen_overlay destroy();
    level notify("_encstr_859815B3BB4B5F6538B764779F78EDE778B6FA9A412B03", var_0);
  } else {
    var_0 notify("_encstr_93E5126FC75143212990F29AA823A3CF0825E60D");
    var_0.introscreen_overlay fadeovertime(2);
    var_0.introscreen_overlay.alpha = 0.5;
