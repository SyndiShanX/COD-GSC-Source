 ...
 * Script: cp\maps\cp_so_finale\cp_so_finale_create_script.gsc
***************************************************************/

main(var_0, var_1) {
  level endon("_encstr_9B1D0BC7932875276230426AA1");
  var_2 = spawnStruct();
  scripts\engine\utility::flag_init("_encstr_9A041B9883516F60EFFE2B90D10B696F06CBD00B5B77FF3BE7F22397BC");
  level thread cs_return_and_wait_for_flag(var_0, var_1, var_2, "_encstr_9A041B9883516F60EFFE2B90D10B696F06CBD00B5B77FF3BE7F22397BC");
...
cs_return_and_wait_for_flag(var_0, var_1, var_2, var_3) {
  ...
  if(istrue(var_0))
    level thread scripts\cp\cp_create_script_utility::wait_for_flags(var_2, "_encstr_9A041B9883516F60EFFE2B90D10B696F06CBD00B5B77FF3BE7F22397BC");
  else
    scripts\cp\cp_create_script_utility::wait_for_flags(var_2, "_encstr_9A041B9883516F60EFFE2B90D10B696F06CBD00B5B77FF3BE7F22397BC");
}
