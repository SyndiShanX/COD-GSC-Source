 ...
 * Script: cp\maps\cp_so_safehouse\cp_so_safehouse_create_script.gsc
*********************************************************************/

main(var_0, var_1) {
  level endon("_encstr_9B1D0BC7932875276230426AA1");
  var_2 = spawnStruct();
  scripts\engine\utility::flag_init("_encstr_97341E2383EF73C7EF3B8103A1A3BA4DBF58BFE663E5C7A0C526DB91D382B335");
  level thread cs_return_and_wait_for_flag(var_0, var_1, var_2, "_encstr_97341E2383EF73C7EF3B8103A1A3BA4DBF58BFE663E5C7A0C526DB91D382B335");
...
cs_return_and_wait_for_flag(var_0, var_1, var_2, var_3) {
  ...
  if(istrue(var_0))
    level thread scripts\cp\cp_create_script_utility::wait_for_flags(var_2, "_encstr_97341E2383EF73C7EF3B8103A1A3BA4DBF58BFE663E5C7A0C526DB91D382B335");
  else
    scripts\cp\cp_create_script_utility::wait_for_flags(var_2, "_encstr_97341E2383EF73C7EF3B8103A1A3BA4DBF58BFE663E5C7A0C526DB91D382B335");
}
