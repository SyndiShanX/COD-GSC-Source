 ...
 * Script: cp\maps\cp_smuggler\cp_smuggler_create_script.gsc
*************************************************************/

main(var_0, var_1) {
  level endon("_encstr_9B1D0BC7932875276230426AA1");
  var_2 = spawnStruct();
  scripts\engine\utility::flag_init("_encstr_8A371A77781673D2E3BCCF0595D5C92B1B48F753B84ECBFA0543123B");
  level thread cs_return_and_wait_for_flag(var_0, var_1, var_2, "_encstr_8A371A77781673D2E3BCCF0595D5C92B1B48F753B84ECBFA0543123B");
...
cs_return_and_wait_for_flag(var_0, var_1, var_2, var_3) {
  ...
  if(istrue(var_0))
    level thread scripts\cp\cp_create_script_utility::wait_for_flags(var_2, "_encstr_8A371A77781673D2E3BCCF0595D5C92B1B48F753B84ECBFA0543123B");
  else
    scripts\cp\cp_create_script_utility::wait_for_flags(var_2, "_encstr_8A371A77781673D2E3BCCF0595D5C92B1B48F753B84ECBFA0543123B");
}
