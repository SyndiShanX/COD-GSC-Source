 ...
 * Script: cp\maps\cp_so_embassy\cp_so_embassy_create_script.gsc
*****************************************************************/

main(var_0, var_1) {
  level endon("_encstr_9B1D0BC7932875276230426AA1");
  var_2 = spawnStruct();
  scripts\engine\utility::flag_init("_encstr_B1121CD8E07D37BDEB566B98B09B9B5EAF1B93CAC21D56D7CD8D4E2D1C8E");
  level thread cs_return_and_wait_for_flag(var_0, var_1, var_2, "_encstr_B1121CD8E07D37BDEB566B98B09B9B5EAF1B93CAC21D56D7CD8D4E2D1C8E");
...
cs_return_and_wait_for_flag(var_0, var_1, var_2, var_3) {
  ...
  if(istrue(var_0))
    level thread scripts\cp\cp_create_script_utility::wait_for_flags(var_2, "_encstr_B1121CD8E07D37BDEB566B98B09B9B5EAF1B93CAC21D56D7CD8D4E2D1C8E");
  else
    scripts\cp\cp_create_script_utility::wait_for_flags(var_2, "_encstr_B1121CD8E07D37BDEB566B98B09B9B5EAF1B93CAC21D56D7CD8D4E2D1C8E");
}
