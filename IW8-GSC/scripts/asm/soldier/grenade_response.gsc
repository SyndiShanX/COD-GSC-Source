...
function playgrenadereturnthrowanim(var_0, var_1, var_2) {
...
function terminategrenadereturnthrowanim(var_0, var_1, var_2) {
...
function choosegrenadereturnthrowanim(var_0, var_1, var_2) {
  var_3 = undefined;
  var_4 = 1000;
...
function playgrenadeavoidanim(var_0, var_1, var_2) {
  self.asm.bshouldattemptdive = randomint(100) > 50;
}

function shouldgrenadedive(var_0, var_1, var_2, var_3) {
...
function grenadeavoid_terminate(var_0, var_1, var_2) {
