...
function asm_animhasfacialoverride(var_0) {
  if(!animisleaf(var_0)) {
    return 0;
  }
...
function asm_playfacialanim_sp(var_0, var_1, var_2) {
...
function asm_playfacialaniminternal(var_0, var_1) {
...
function asm_playfacialanimfromnotetrack(var_0) {
  var_1 = "";
...
function asm_playfacialanimsingleframedeath(var_0) {
  if(isai(self)) {
...
function asm_ikfingeranim(var_0) {
  var_1 = scripts\anim\utility::getaicurrentweapon();
...
function asm_playikfingeranim(var_0) {
  var_1 = scripts\anim\utility::getaicurrentweapon();
  ...
  self setanim(var_11, 1, 0.3, 1);
  self setanim(var_10, 1, 0.3, 1);
}

function asm_clearikfingeranim(var_0) {
  var_1 = "ik_fingers_l";
...
function asm_playvisorraise(var_0) {
  if(isDefined(var_0)) {
    var_1 = 1;
  } else {
    var_1 = 0;
  ...
  asm_trynvgmodelswap();
  asm_clearvisoranim();
  var_2 = scripts\asm\asm::asm_getxanim("visor", scripts\asm\asm::asm_lookupanimfromalias("visor", "helmet_visor_up" + var_1));
  ...
  var_3 = scripts\asm\asm::asm_getxanim("visor", scripts\asm\asm::asm_lookupanimfromalias("visor", "helmet_visor_down" + var_1));
...
function asm_hasstatesp(var_0, var_1) {
...
function asm_playadditiveanimloopstate_sp(var_0, var_1, var_2) {
  ...
  for(;;) {
    ...
    if(var_3 != var_6) {
      if(var_4) {
        self setflaggedanimknoblimitedrestart(var_1, var_6, 1, var_5, 1);
      } else {
        self setflaggedanimknobrestart(var_1, var_6, 1, var_5, 1);
      }
...
function asm_playadditiveanimloopstate_helper(var_0, var_1, var_2) {
  ...
  while(isDefined(var_1)) {
    ...
    if(var_2) {
      self setflaggedanimlimited(var_0, var_1, 1, 0, 1);
      continue;
    }

    self setflaggedanim(var_0, var_1, 1, 0, 1);
  }
}

function asm_setaimlimits(var_0) {
...
function asm_getaimlimitset(var_0, var_1) {
...
function asm_setstateaimlimits(var_0, var_1) {
...
function asm_setupaim_sp(var_0, var_1, var_2, var_3) {
...
function asm_setupgesture(var_0, var_1) {
...
function asm_cleanupaimknobswithdelay(var_0, var_1) {
  self endon("death");
...
function asm_cleanupaimknobsonterminate(var_0) {
  self endon("death");
  self endon("StopCleanupAimKnobs");
...
function asm_animScripted(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  var_7 = self.asmname;
...
function asm_animcustom(var_0, var_1) {
...
function open_door(var_0, var_1) {
...
function door_needs_to_close(var_0) {
