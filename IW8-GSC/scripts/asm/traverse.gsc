...
function playtraversearrivalanim(var_0, var_1, var_2) {
  self endon("dealth");
...
function playtraverseanim_scaled(var_0, var_1, var_2) {
  self endon("death");
  self endon("terminate_ai_threads");
  checktraverse(var_1);
  var_3 = scripts\asm\asm::asm_getanim(var_0, var_1);
  ...
  if(var_6.size > 0) {
    thread scripts\asm\shared\utility::waitforcoverapproach(var_1, var_2);
    thread scripts\asm\shared\utility::waitforsharpturn(var_1, var_2);
  }
  ...
  if(var_8) {
    ...
    if(!animhasnotetrack(var_6, "traverse_align")) {
      scripts\asm\soldier\traverse::handletraversealignment();
    }
  }

  scripts\asm\asm::asm_playfacialanim(var_2, var_3, var_6);
  self.traversexanim = var_6;
  self.traverseanimroot = scripts\asm\asm::asm_getbodyknob();

  if(var_3 == "traverse_external") {
    self aisetanim(var_3, 0);
    self clearanim(scripts\asm\asm::asm_getinnerrootknob(), 0.2);
    self setflaggedanim(var_3, self.traversexanim);
  } else {
    self aisetanim(var_3, var_5);
  }

  if(var_10 && !isagent(self) && (!isDefined(self.traversearrival) || isDefined(self.traversearrival.doarrival) && !self.traversearrival.doarrival)) {
    var_11 = getnotetracktimes(var_6, "warp_arrival_end")[0];
    self setanimtime(var_6, var_11);
  }

  self.traversedeathindex = 0;
  self.traversedeathanim = undefined;
  self.useanimgoalweight = 1;
  var_12 = scripts\asm\asm::asm_donotetracks(var_2, var_3, var_10);
  ...
  if(var_12 == "code_move") {
    ...
    if(!scripts\asm\asm::asm_eventfired(var_2, "finish") && !scripts\asm\asm::asm_eventfired(var_2, "end")) {
      scripts\asm\asm::asm_donotetracks(var_2, var_3, var_10);
    }
  }
  ...
  if(self.delayeddeath) {
    scripts\asm\soldier\traverse::terminatetraverse(var_2, var_3);
    return;
  }
...
function shouldusewarpnotetracks(var_0) {
...
function shouldusewarparrival(var_0) {
...
function setuptraversaltransitioncheck(var_0, var_1, var_2) {
...
function shoulddotraversalarrival(var_0, var_1, var_2, var_3) {
...
function shouldconsidertraversearrival(var_0, var_1, var_2, var_3) {
...
function shouldstarttraverse(var_0, var_1, var_2, var_3) {
  if(self.traversearrival.traversetype != var_3) {
    return false;
  }
...
function shoulddotraditionaltraverse(var_0, var_1, var_2, var_3) {
  if(self.traversearrival.traversetype != var_3) {
    return false;
  }
...
function traverse_cleanup(var_0, var_1, var_2) {
  self motionwarpcancel();
  self finishtraverse();
  self.traversearrival = undefined;
}

function calctraversetype(var_0, var_1, var_2) {
...
function traversechooseanim(var_0, var_1, var_2) {
  var_3 = undefined;
...
function supportstraversearrival(var_0) {
  switch (var_0) {
...
function handletraversearrivalwarpnotetracks(var_0) {
  if(var_0 == "warp_arrival_start") {
    return handlewarparrivalnotetrack();
  }
}

function handletraversewarpnotetracks(var_0) {
  ...
  if(var_0 == "warp_across_start") {
    return handlewarpacrossnotetrack();
  }

  if(var_0 == "warp_down_start") {
    return handlewarpdownstartnotetrack();
  }

  if(var_0 == "warp_down_end") {
...
function handlewarpdownstartnotetrack() {
  ...
  if(isDefined(var_8)) {
    ...
    var_11 = clamp(angleclamp180(var_10 - self.angles[1]), -30, 30);
