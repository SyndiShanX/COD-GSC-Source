...
function choosebcdirectionanim(var_0, var_1, var_2) {
  ...
  jumpiffalse(isDefined(var_2)) LOC_0000005a;
  var_4 = var_2;
  goto LOC_0000008c;
}
...
function ai_gesture_stop(var_0) {
  ...
  while(gettime() / 1000 - var_2 < var_1) {
    var_13 = (gettime() / 1000 - var_2) / var_1;
...
function ai_gesture_torso_stop(var_0) {
  ...
  self clearanim(%torso_tracking_anims, var_1);
...
function ai_gesture_lookat(var_0, var_1, var_2) {
  ...
  if(isDefined(var_2)) {
    self.gesture_catchup_speed = clamp(var_2, 0.25, 4);
  } else {
...
function ai_gesture_eyes_lookat(var_0, var_1, var_2) {
  ...
  if(isDefined(var_1)) {
    self.eye_catchup_speed = clamp(var_1, 0.25, 4);
  } else {
...
function ai_gesture_lookat_natural(var_0, var_1, var_2, var_3) {
  ...
  for(;;) {
    ...
    if(distance2d(self.origin, var_0.origin) <= var_3) {
      ...
      thread ai_gesture_eyes_lookat(var_0, 1, 0.2);
    }
  }
}
...
function ai_gesture_head_leftright() {
  ...
  self setanimlimited(var_4, 1, self.blend_in_time);
...
function ai_gesture_head_updown() {
  ...
  for(;;) {
    ...
    var_9 = float_remap(var_8, 1, -1, 0, 1);
    var_0 += (var_9 - var_0) * self.gesture_catchup_speed * 0.3;
...
function ai_gesture_eyes_leftright() {
  ...
  for(;;) {
    ...
    var_10 = float_remap(var_9, 1, -1, 0, 1);
...
function ai_gesture_eyes_updown() {
  ...
  for(;;) {
    ...
    var_8 = float_remap(var_7, 1, -1, 0.3, 0.7);
    var_9 = clamp(var_8, 0, 1);
    var_0 += (var_9 - var_0) * self.eye_catchup_speed * 0.3;
...
function ai_gesture_point(var_0) {
  ...
  var_13 = var_12 * -1;
  var_14 = clamp(float_remap(var_12, 0.2, 1, 0, 1), 0, 1);
...
function ai_gesture_simple(var_0) {
  ...
  if(self.is_partial) {
    ...
    self setanimlimited(var_7, 1, 0.5, 0.75);
  }
...
function blend_partial_in(var_0, var_1, var_2, var_3) {
  var_4 = var_2 * 0.5;
  self setanimlimited(var_0, 1, var_4);
  self setanimlimited(var_1, 1, var_4, 0.75);
  wait var_2 * 0.5;
  self setanimlimited(var_1, 10, var_4, 0.75);
  self setanimlimited(var_0, 10, var_4);
}

function blend_partial_out(var_0, var_1, var_2) {
  var_3 = var_2 * 0.5;
  self setanimlimited(var_0, 1, var_3);
  self setanimlimited(var_1, 1, var_3);
  wait var_3;
...
function ai_gesture_directional_custom(var_0, var_1, var_2) {
  ...
  var_22 = var_21 * -1;
  var_23 = clamp(float_remap(var_21, 0.2, 1, 0, 1), 0, 1);
  ...
  if(!self.no_point_defined) {
    if(isDefined(var_6)) {
      self setanimlimited(var_12, 10, 0.25);
    } else {
      self setanimlimited(var_12, 1, 0.25);
    }

    if(var_31 < 0.3) {
      self setanimlimited(var_8, 0, 0, 1);
    } else {
      self setanimlimited(var_8, var_31, 0.25, 1);
    }

    if(isDefined(var_11)) {
      self setanimlimited(var_11, var_32, 0.25, 1);
    }

    if(isDefined(var_12)) {
      self setanimlimited(var_12, var_33, 0.25, 1);
    }

    self setanimlimited(var_9, var_24, 0.25, 1);
    self setanimlimited(var_10, var_23, 0.25, 1);
  } else {
    if(isDefined(var_6)) {
      self setanimlimited(var_12, 0.001, 0.1);
    }

    self setanimlimited(var_12, 1, 0.25);
    self setanimlimited(var_8, 1, 0.25);
  }

  var_34 = getanimlength(var_8);
  wait var_34;
  self clearanim(var_12, 0.25);
  self setanimlimited(var_12, 1, 0.25);
}
...
function ai_custom_gesture(var_0, var_1) {
  ...
  if(var_3) {
    ...
    self setanimlimited(var_0, 1, 0.1);
  }
...
function ai_gesture_head_leftright_c6() {
  ...
  for(;;) {
    ...
    var_18 = float_remap(var_17, -1, 1, 0, 1);
    var_18 = clamp(var_18, 0, 1);
    var_7 += (var_18 - var_7) * self.gesture_catchup_speed;
...
function ai_gesture_head_updown_c6() {
  ...
  for(;;) {
    ...
    var_8 = float_remap(var_7, 1, -1, 0, 1);
    var_0 += (var_8 - var_0) * self.gesture_catchup_speed * 0.3;
    var_0 = clamp(var_0, 0.1, 0.65);
    set_time_via_rate(self.look_updown_anim, var_0);
    waitframe();
  }
...
function ai_gesture_stop_c6(var_0) {
  ...
  self setanimlimited(%lookat_left_right, 1, var_1 * 0.15);
  self setanimlimited(%lookat_up_down, 1, var_1 * 0.15);
  self setanimlimited(%lookat_head_base_partial, 1, var_1 * 0.15);
  self setanimlimited(%head_gesture_look_partial, 1, var_1 * 0.15);
  wait var_1 * 0.15;
...
function blended_loop_anim() {
  ...
  var_0 setanimknoball(var_0.fwd_anim, %root, 1, 0.2);

  if(isDefined(var_0.right_anim)) {
    var_0 setanimlimited(var_0.right_anim, 0, 0.2);
  }

  if(isDefined(var_0.left_anim)) {
    var_0 setanimlimited(var_0.left_anim, 0, 0.2);
  }

  if(isDefined(var_0.leftback_anim)) {
    var_0 setanimlimited(var_0.leftback_anim, 0, 0.2);
  }

  if(isDefined(var_0.rightback_anim)) {
    var_0 setanimlimited(var_0.rightback_anim, 0, 0.2);
  }
