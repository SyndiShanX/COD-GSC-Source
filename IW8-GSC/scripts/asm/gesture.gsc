...
function ai_request_gesture(var_0, var_1, var_2, var_3) {
  if(!isDefined(var_2)) {
    var_2 = 1000;
  }
...
function handlegesturenotetrack(var_0) {
...
function gesturedonotetracks(var_0) {
...
function gesturenotetracktimeoutthread(var_0) {
  self endon("gesture_finished");
  wait var_0;
  self notify("gesture_timeout");
}

function gesture(var_0) {
...
function gesture_should_disable_lookat(var_0) {
...
function ai_request_gesture_internal(var_0, var_1, var_2, var_3) {
  if(isDefined(self._blackboard.gesturerequest)) {
    ai_cancel_gesture();
  }
...
function get_gesture_alias(var_0, var_1) {
...
function cleargestureanim(var_0, var_1, var_2) {
  if(isDefined(self._blackboard.activegesturenotify)) {
...
function gesture_finishearly(var_0, var_1, var_2, var_3) {
