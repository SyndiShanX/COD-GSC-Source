...
function dog_init(var_0, var_1, var_2) {
...
function needtoturnforexit(var_0, var_1, var_2, var_3) {
...
function playanim_arrival_cleanup(var_0, var_1, var_2) {
...
function playanim_idle(var_0, var_1, var_2) {
...
function playanim_headtrack(var_0, var_1) {
  self endon(var_1 + "_finished");
...
function playanim_growltrack(var_0, var_1) {
  self endon(var_1 + "_finished");
...
function handledogfootstepnotetracks(var_0) {
  switch (var_0) {
    case "fs_fr_l_sm":
    case "fs_fr_r_sm":
    case "fs_bk_r_sm":
...
function handleorientnotetracks(var_0, var_1) {
  switch (var_0) {
    case "orient_start":
...
function dog_notehandler(var_0, var_1) {
