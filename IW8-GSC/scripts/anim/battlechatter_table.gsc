...
function bctable_setfiles(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  anim.bctable[var_0] = [];
...
function bctable_addfile(var_0, var_1) {
  for(var_2 = 0;; var_2++) {
...
function bctable_pickaliasset(var_0, var_1, var_2) {
...
function bctable_exists(var_0, var_1, var_2) {
...
function bctable_categorykey(var_0, var_1) {
  if(!isDefined(var_0)) {
    var_0 = "all";
  }
