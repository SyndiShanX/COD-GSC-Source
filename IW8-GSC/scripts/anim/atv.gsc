...
function atv_handle_events(var_0) {
  self endon("death");
  self endon("killanimscript");
...
function atv_waitfor_start_aim(var_0) {
  if(var_0 == "start_aim") {
    return 1;
  }
}

function atv_waitfor_end(var_0) {
  if(var_0 == "end") {
    return 1;
  }
}

function atv_waitfor_start_lean(var_0) {
  if(var_0 == "start_lean") {
    return 1;
  }
}
...
function atv_get_death_anim(var_0, var_1, var_2) {
  var_3 = undefined;
  var_4 = undefined;
  var_5 = 0;
...
function atv_setanim_common(var_0) {
  ...
  self.a.array["single"] = scripts\anim\utility::array(level.scr_anim["atv"][var_0]["single"]);
...
function atv_setanim_driver(var_0) {
  self.a.array = [];
