...
function monitor_callbutton() {
  for(;;) {
    ...
    foreach(var_8 in var_2) {
      var_9 = elevator_floor_update(var_8);

      if(!level.elevator_aggressive_call && !var_9) {
        if(get_curfloor(var_8) == var_1) {
          var_6 = 1;
          var_2 = [];
          break;
        }
...
function elevator_interrupt(var_0) {
...
function elevator_floor_update() {
  ...
  foreach(var_4 in get_outer_doorsets()) {
...
function position_elevators() {
  foreach(var_1 in level.elevators) {
    var_1.moveto_floor = get_curfloor(var_1);

    foreach(var_4, var_3 in get_outer_doorsets(var_1)) {
      if(get_curfloor(var_1) != var_4) {
        thread close_outer_doors(var_1);
      }
    }
  }
}

function elevator_move(var_0) {
...
function close_outer_doors(var_0) {
...
function open_outer_doors(var_0) {
...
function build_elevators() {
  ...
  foreach(var_4 in var_0) {
    ...
    var_6 = [];
    var_6 = min(var_4.origin[0], var_5.origin[0]);
    var_6 = max(var_4.origin[0], var_5.origin[0]);
    var_6 = min(var_4.origin[1], var_5.origin[1]);
    var_6 = max(var_4.origin[1], var_5.origin[1]);
    var_7 = spawnStruct();
    ...
    foreach(var_24, var_33 in var_7.e["outer_doorset"]) {
      var_34 = get_housing_mainframe(var_7);
  ...
  foreach(var_39 in level.elevators) {
    var_40 = get_housing_primarylight(var_39);
...
function build_call_buttons() {
  ...
  foreach(var_1 in level.elevator_callbuttons) {
    ...
    foreach(var_6 in level.elevators) {
      foreach(var_11, var_8 in get_outer_doorsets(var_6)) {
...
function setup_hints() {
  foreach(var_1 in level.elevators) {
    var_2 = get_housing_inside_trigger(var_1);
    var_3 = get_outer_doorsets(var_1);
    var_4 = var_3.size;
...
function discrete_waittill(var_0) {
  enable_trigger();
...
function get_outer_doorset(var_0) {
...
function waittill_finish_moving(var_0, var_1, var_2, var_3) {
  jumpiffalse(!isDefined(var_2) && !isDefined(var_3)) LOC_00000017;
  var_2 = var_0;
  var_3 = var_1;
...
function isinboundingspere(var_0) {
  var_1 = self.origin[0];
  var_2 = self.origin[1];
  var_3 = var_0[0];
  var_4 = var_0[1];
...
function elevator_get_dvar_int(var_0, var_1) {
  return int(elevator_get_dvar(var_0, var_1));
}

function elevator_get_dvar(var_0, var_1) {
  if(getDvar(var_0) != "") {
