 ...
 * Script: scripts\opaque\58326.gsc
***********************************************/
...
function xpteamsatmatchstart() {
  var0 = scripts\cp_mp\vehicles\vehicle_mines::vehicle_mines_getleveldataforvehicle("little_bird_mg", 1);
...
function xyvelscale_low(var0, var1) {
  ...
  if(isDefined(var2) && scripts\cp_mp\vehicles\vehicle_spawn::vehicle_spawn_gamemodesupportsrespawn()) {
    var2.ondeathrespawn = &xyvelscale_high;
  }
...
function xyvelscale_maxheight() {
  ...
  var2 = spawnStruct();
  var3 = scripts\cp_mp\vehicles\vehicle_spawn::ref_1421c("little_bird_mg", var1, var2);
...
function xpperplayerpershare(var0, var1, var2, var3, var4) {
  if(istrue(level.ref_13375)) {
