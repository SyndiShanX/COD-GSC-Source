 ...
 * Script: scripts\smartobjects\stealth_look_over.gsc
******************************************************/

function main() {
  scripts\smartobjects\utility::add_smartobject_type("stealth_look_over", &getinfo, &canusecondition);
}
...
function getinfo() {
  ...
  var_0.animstatename = "smartobject_look_over";
