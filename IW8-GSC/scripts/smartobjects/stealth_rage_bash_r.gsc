 ...
 * Script: scripts\smartobjects\stealth_rage_bash_r.gsc
********************************************************/

function main() {
  scripts\smartobjects\utility::add_smartobject_type("stealth_rage_bash_r", &getinfo, &canusecondition);
}
...
function getinfo() {
  ...
  var_0.animstatename = "smartobject_rage_bash_r";
