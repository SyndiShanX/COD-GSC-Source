 ...
 * Script: scripts\smartobjects\stealth_rage_punch.gsc
*******************************************************/

function main() {
  scripts\smartobjects\utility::add_smartobject_type("stealth_rage_punch", &getinfo, &canusecondition);
}
...
function getinfo() {
  ...
  var_0.animstatename = "smartobject_rage_punch";
