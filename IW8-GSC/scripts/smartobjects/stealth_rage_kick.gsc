 ...
 * Script: scripts\smartobjects\stealth_rage_kick.gsc
******************************************************/

function main() {
  scripts\smartobjects\utility::add_smartobject_type("stealth_rage_kick", &getinfo, &canusecondition);
}
...
function getinfo() {
  ...
  var_0.animstatename = "smartobject_rage_kick";
