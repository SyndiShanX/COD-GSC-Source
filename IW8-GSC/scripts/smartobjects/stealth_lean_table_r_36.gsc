 ...
 * Script: scripts\smartobjects\stealth_lean_table_r_36.gsc
************************************************************/

function main() {
  scripts\smartobjects\utility::add_smartobject_type("stealth_lean_table_r_36", &getinfo, &canusecondition);
}
...
function getinfo() {
  ...
  var_0.animstatename = "smartobject_lean_table_r_36";
