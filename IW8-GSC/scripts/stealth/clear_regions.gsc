...
function findnextpointofinterest(var_0, var_1, var_2, var_3) {
  if(!isDefined(var_3)) {
    var_3 = 1;
  }
  ...
  for(var_8 = 84 * (1 + var_6); var_3 && var_4 < var_1.route_points.size || !var_3 && var_4 >= 0; var_8--) {
    ...
    var_14 = distance2d(var_9, var_12);
    var_15 = max(var_15 - var_14, 0);
    var_11 = max(var_11 - var_14, 0);
    var_9 = var_12;
...
function findcurposonroute(var_0, var_1) {
  var_2 = var_1.size;
  var_3 = 0;
  var_4 = -1;
...
function getregionforpos(var_0) {
  var_1 = 1000000000;
  var_2 = undefined;
...
function gethuntstealthgroups(var_0) {
  var_1 = [];
...
function gethuntstealthgroupvolumelists(var_0, var_1) {
  var_2 = [];
...
function buildhuntstealthgrouptransitiondata() {
  foreach(var_1 in level.hunt_region_load.hunt_stealth_group_region_sets) {
...
function cleanuphuntbuilddata(var_0) {
  foreach(var_2 in var_0) {
    var_2.containing_regions = undefined;
    var_2.transitions = undefined;
  }

  foreach(var_5 in level.hunt_region_load.hunt_stealth_group_region_sets) {
...
function inithuntregiondata() {
  ...
  foreach(var_36, var_6 in var_4) {
    ...
    level.hunt_region_load.hunt_stealth_group_region_sets[var_36].target_score = 0;
    ...
    foreach(var_9 in level.hunt_region_load.hunt_stealth_group_region_sets[var_36].hunt_regions) {
      ...
      var_29 = [];
      var_30 = var_21;
      var_29 = var_9.route_points[var_30];
      ...
      for(var_22 = 1; var_22 < var_9.route_points.size; var_22++) {
        ...
        while(var_32 < var_9.route_points.size) {
...
function huntcomputeaiindependentregionscores(var_0, var_1) {
  ...
  for(var_3 = 0; var_3 < var_2; var_3++) {
    var_4 = var_1.hunt_regions[var_3];
    var_4.bfs_score /= var_18;
    var_4.bfs_visited = undefined;
  }
}

function huntassigntoregion(var_0) {
...
function huntunassignfromregion(var_0) {
...
function huntincaiassignment(var_0) {
  var_0.shared_data.bfs_assigned += 1;
  hunttrytoenterregionvolume(var_0);
}

function huntdecaiassignment(var_0) {
  var_0.shared_data.bfs_assigned -= 1;
...
function hunttrytoexitregionvolume(var_0) {
