...
function death_cleanup() {
  if(isDefined(self)) {
    ...
    foreach(var_1 in level.players) {
      ...
      foreach(var_3 in var_1.stealth.threat_sighted) {
        if(!isDefined(var_3)) {
...
function add_active_sense_function(var_0) {
...
function proximity_check() {
  ...
  foreach(var_8 in level.players) {
    ...
    var_11 = distancesquared(var_2, var_8.origin + var_3);
...
function set_blind(var_0, var_1) {
...
function set_sight_state(var_0) {
  switch (var_0) {
    case "blind":
...
function alertlevel_normal(var_0) {
...
function set_alert_level(var_0) {
...
function monitor_damage_thread(var_0, var_1) {
  var_2 = undefined;
  var_3 = self.team;
...
function check_kill_damage(var_0, var_1, var_2) {
...
function shotisreasonablysafe(var_0) {
...
function headtrack_player_toggle(var_0) {
  if(var_0) {
...
function lock_player_headtracking_off(var_0) {
  self endon("death");
...
function event_handler_should_ignore(var_0) {
...
function should_ignore_sprint_footstep(var_0) {
  var_1 = (0, 0, 18);
...
function event_override_disguise(var_0) {
  if(issentient(var_0.entity)) {
    switch (var_0.typeorig) {
      ...
      case "proximity":
        thread scripts\stealth\threat_sight::threat_sight_force_visible(var_0.entity, 1);
        return true;
    }
  }
...
function event_override_controlling_robot(var_0) {
  if(issentient(var_0.entity)) {
    switch (var_0.typeorig) {
      case "proximity":
        return true;
...
function event_anyone_within_radius(var_0, var_1) {
  var_2 = var_1 * var_1;
...
function event_handler_translate_severity(var_0) {
...
function trigger_cover_blown(var_0, var_1) {
  if(!isDefined(self.stealth)) {
    return;
  }
...
function react_announce_specific(var_0) {
  self endon("death");
...
function go_to_node_wait_investigate(var_0, var_1, var_2) {
  self endon("death");
...
function go_to_node_wait(var_0, var_1) {
  self endon("death");
  self._blackboard.idlenode = undefined;
  go_to_node_wait_investigate(var_0, var_1);
}

function go_to_node_post_wait(var_0, var_1) {
  self endon("death");
...
function go_to_node_arrived(var_0, var_1) {
...
function bt_set_stealth_state(var_0, var_1) {
  self[[self.fnsetstealthstate]](var_0, var_1);
}

function bt_event_handler_severity(var_0) {
  var_1 = undefined;
...
function bt_event_investigate(var_0) {
  set_alert_level("warning1");
  bt_set_stealth_state("investigate", var_0);
}

function bt_event_cover_blown(var_0) {
...
function bt_event_combat(var_0) {
