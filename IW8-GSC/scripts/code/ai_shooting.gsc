...
function decidenumshotsformg() {
  ...
  if(var_2 && isDefined(var_1.script_burst_max)) {
    var_3 = var_1.script_burst_max - var_2;
  } else {
    var_3 = 1.5;
  }

  var_4 = var_3 + randomfloat(var_3);
  return int(var_4 * 10);
}
...
function decidenumshotsforburst(var_0) {
  var_1 = 5;
  ...
  if(var_2) {
    ...
    var_3 = reduceshotcountbydistance(var_2, var_1);
...
function reduceshotcountbydistance(var_0, var_1) {
  var_2 = 62500;
  var_3 = 810000;
  var_4 = 1562500;
  var_5 = 2560000;
