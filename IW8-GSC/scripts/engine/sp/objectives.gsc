...
function objective_add(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8) {
...
function objective_update(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8) {
  _objective_validatename(var_0);
...
function objective_remove(var_0) {
...
function objective_exists(var_0) {
  _objective_validatename(var_0);
...
function objective_set_state(var_0, var_1) {
  _objective_validatename(var_0);
...
function objective_set_position(var_0, var_1) {
  _objective_validatename(var_0);
  var_2 = _objective_getindexforname(var_0);
...
function objective_set_description(var_0, var_1) {
  _objective_validatename(var_0);
  var_2 = _objective_getindexforname(var_0);
...
function objective_set_label(var_0, var_1) {
  _objective_validatename(var_0);
  var_2 = _objective_getindexforname(var_0);
...
function objective_set_icon(var_0, var_1) {
  _objective_validatename(var_0);
  var_2 = _objective_getindexforname(var_0);
...
function objective_set_z_offset(var_0, var_1) {
  _objective_validatename(var_0);
  var_2 = _objective_getindexforname(var_0);
...
function objective_set_show_distance(var_0, var_1) {
  _objective_validatename(var_0);
  var_2 = _objective_getindexforname(var_0);
...
function objective_set_show_progress(var_0, var_1) {
  _objective_validatename(var_0);
  var_2 = _objective_getindexforname(var_0);
...
function objective_set_on_entity(var_0, var_1, var_2) {
  _objective_validatename(var_0);
...
function objective_add_location_entity(var_0, var_1, var_2) {
  _objective_addlocation(var_0, var_1, var_2);
}

function objective_add_location_position(var_0, var_1, var_2) {
  _objective_addlocation(var_0, var_1, var_2);
}

function objective_remove_location(var_0, var_1) {
  var_2 = -1;
  var_3 = _objective_getindexforname(var_0);
...
function objective_remove_all_locations(var_0) {
  var_1 = _objective_getindexforname(var_0);
...
function _objective_addlocation(var_0, var_1, var_2) {
  var_3 = _objective_getindexforname(var_0);
...
function _objective_validatename(var_0) {}

function _objective_initindexforname(var_0) {
  _objective_getindexforname(var_0, 1);
}

function _objective_getindexforname(var_0, var_1) {
  if(!isDefined(level.objective_array)) {
...
function _objective_getnextfreelocationindex(var_0) {
