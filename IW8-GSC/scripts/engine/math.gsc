...
function anglebetweenvectors(var_0, var_1) {
  return acos(vectordot(var_0, var_1) / length(var_0) * length(var_1));
}

function anglebetweenvectorsunit(var_0, var_1) {
  return acos(vectordot(var_0, var_1));
}

function anglebetweenvectorssigned(var_0, var_1, var_2) {
...
function vector_project_onto_plane(var_0, var_1) {
  return vectorNormalize(var_0 - vectordot(var_1, var_0) * var_1);
}

function vector_project_endpoint(var_0, var_1, var_2) {
...
function round_millisec_on_sec(var_0, var_1, var_2) {
  var_3 = var_0 / 1000;
...
function remap(var_0, var_1, var_2, var_3, var_4) {
  return var_3 + (var_0 - var_1) * (var_4 - var_3) / (var_2 - var_1);
}

function normalize_value(var_0, var_1, var_2) {
  if(var_0 > var_1) {
    var_3 = var_0;
    var_0 = var_1;
    var_1 = var_3;
...
function normalized_to_growth_clamps(var_0, var_1, var_2) {
  return (var_1 - var_0) * squared(var_2) + var_0;
}

function normalized_to_decay_clamps(var_0, var_1, var_2) {
  return normalized_to_growth_clamps(var_0, var_1, 1 - var_2);
}

function normalized_parabola(var_0) {
  return -1 * squared(2 * var_0 - 1) + 1;
}

function normalized_sin_wave(var_0) {
  var_1 = var_0 * 2 * 3.14159 - 1.5708;
  var_1 = (sin(radians_to_degrees(var_1)) + 1) * 0.5;
  return var_1;
}

function normalized_cos_wave(var_0) {
  var_1 = var_0 * 2 * 3.14159;
  var_1 = (cos(radians_to_degrees(var_1)) + 1) * 0.5;
  return var_1;
}

function radians_to_degrees(var_0) {
  return var_0 * 57.2958;
}

function keypad_increase_failnum(var_0) {
  return var_0 * 0.0174533;
}

function factor_value(var_0, var_1, var_2) {
  return var_1 * var_2 + var_0 * (1 - var_2);
}

function normalized_float_smoth_in_out(var_0) {
  if(var_0 < 0.5) {
    var_0 *= 2;
...
function normalized_float_smooth_in(var_0) {
  return var_0 * var_0;
}

function normalized_float_smooth_out(var_0) {
  var_0 = 1 - var_0;
  var_0 *= var_0;
  var_0 = 1 - var_0;
  return var_0;
...
function line_to_plane_intersection(var_0, var_1, var_2, var_3) {
...
function ray_to_plane_intersection_distance(var_0, var_1, var_2, var_3) {
  return vectordot(var_2 - var_0, var_3) / vectordot(var_1, var_3);
}

function segmentvssphere(var_0, var_1, var_2, var_3) {
  if(var_0 == var_1) {
    return false;
  }
...
function pointvscone(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  var_8 = var_0 - var_1;
...
function pointvscylinder(var_0, var_1, var_2, var_3, var_4) {
  var_5 = var_0 - var_3;
...
function point_side_of_line2d(var_0, var_1, var_2) {
...
function wrap(var_0, var_1, var_2) {
  var_3 = var_1 - var_0 + 1;

  if(var_2 < var_0) {
    var_2 += var_3 * int((var_0 - var_2) / var_3 + 1);
  }

  return var_0 + (var_2 - var_0) % var_3;
}

function point_in_fov(var_0, var_1, var_2) {
  if(!isDefined(var_0)) {
    return;
  }
...
function within_fov_2d(var_0, var_1, var_2, var_3) {
...
function is_point_in_front(var_0) {
  var_1 = 0;
  ...
  if(isent(self) && isPlayer(self)) {
    ...
    var_2 -= self.origin;
    var_3 = anglesToForward(self.angles);
    var_3 = vectordot(var_2, var_3);
  }

  return var_3 > 0;
}

function is_point_on_right(var_0) {
  var_1 = 0;
...
function set_matrix_from_up(var_0) {
...
function set_matrix_from_up_and_angles(var_0, var_1) {
  if(!isDefined(var_1)) {
    var_1 = self.angles;
  }
...
function build_matrix_from_up_and_angles(var_0, var_1) {
...
function critically_damped_move_to(var_0, var_1, var_2) {
  thread critically_damped_move_to_thread(var_0, var_1, var_2);
}

function critically_damped_move_to_thread(var_0, var_1, var_2) {
  self endon("death");
...
function critically_damped_move_and_rotate_to(var_0, var_1, var_2) {
  thread critically_damped_move_and_rotate_to_thread(var_0, var_1, var_2);
}

function critically_damped_move_and_rotate_to_thread(var_0, var_1, var_2) {
  self endon("death");
  self endon("stop_spring");
...
function over_damped_move_to(var_0, var_1, var_2, var_3) {
  thread over_damped_move_to_thread(var_0, var_1, var_2, var_3);
}

function over_damped_move_to_thread(var_0, var_1, var_2, var_3) {
  self endon("death");
  self endon("stop_spring");
...
function under_damped_move_to(var_0, var_1, var_2, var_3) {
  thread under_damped_move_to_thread(var_0, var_1, var_2, var_3);
}

function under_damped_move_to_thread(var_0, var_1, var_2, var_3) {
  self endon("death");
  self endon("stop_spring");
...
function spring_make_critically_damped(var_0, var_1, var_2) {
...
function spring_make_over_damped(var_0, var_1, var_2, var_3) {
...
function spring_make_under_damped(var_0, var_1, var_2, var_3) {
  var_4 = spring_add(var_2, var_3);
  var_5 = -0.5 * var_1;
  var_6 = var_0;
...
function spring_update(var_0, var_1, var_2, var_3) {
  if(isDefined(var_2)) {
...
function spring_delete(var_0) {
  level.springs[var_0] = undefined;
}

function spring_get_pos(var_0) {
  return level.springs[var_0].pos;
}

function spring_get_vel(var_0) {
...
function spring_add(var_0, var_1) {
  spring_init();
...
function spring_set_pos(var_0, var_1) {
  level.springs[var_0].pos = var_1;
}

function spring_set_vel(var_0, var_1) {
