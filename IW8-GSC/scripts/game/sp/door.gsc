...
function _init_door_internal(var_0) {
  ...
  if(isDefined(var_1) || isDefined(var_2)) {
    ...
    if(var_8.size > 0) {
      ...
      foreach(var_10 in var_8) {
        self.c4_struct.origin += var_10.origin * 1 / var_8.size;
        self.c4_struct.radius += var_10.radius * 1 / var_8.size;
      }
...
function set_snake_cam_ignore_ents(var_0) {
  if(!isarray(var_0)) {
    var_0 = [var_0];
  }
...
function set_snake_cam_vision(var_0) {
  if(!isDefined(var_0)) {
    var_0 = "snake_cam";
  }
...
function snake_cam_control(var_0) {
  ...
  for(;;) {
    ...
    var_16 = scripts\engine\math::lerp(var_16[0], var_22[0], var_25);
    var_16 = scripts\engine\math::lerp(var_16[1], var_22[1], var_25);
    ...
    var_38 = scripts\engine\math::factor_value(0, 0.105, var_37);
    var_39 = scripts\engine\math::factor_value(0, 0.08, var_37);
    var_40 = scripts\engine\math::factor_value(0, 0.2, var_37);
...
function put_player_on_cam(var_0) {
...
function cam_enemy_caret_follow_target_til_cleanup(var_0) {
  self endon("death");
