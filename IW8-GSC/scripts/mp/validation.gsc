...
function validationerror(var_0, var_1, var_2) {
  var_3 = var_0;
...
function isweaponvariantconditionallylocked(var_0, var_1) {
...
function validateweapon(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
...
function validateattachments(var_0, var_1, var_2, var_3, var_4) {
...
function validatepower(var_0, var_1, var_2, var_3) {
...
function validateperks(var_0, var_1, var_2) {
  var_3 = [];
  GscBinSkip0(0x2e, 1, 0);
}

function validatestreaks(var_0, var_1, var_2, var_3) {
...
function validatearchetype(var_0, var_1) {
...
function validatesuper(var_0, var_1, var_2) {
  if(!isDefined(var_1) || var_1 == "none") {
    return;
  }
...
function validatewildcards(var_0) {}

function fixloadout(var_0) {
...
function fixweapon(var_0, var_1) {
  if(var_1 == "primary") {
  ...
  var_1.loadoutsecondarylootitemid = 0;
  var_1.loadoutsecondaryvariantid = -1;

  for(var_2 = 0; var_2 < scripts\mp\class::getmaxsecondaryattachments(); var_2++) {
    var_1.loadoutsecondaryattachments[var_2] = "none";
  }
}

function fixattachment(var_0, var_1, var_2) {
  if(var_1 == "primary") {
    var_0.loadoutprimaryattachments[var_2] = "none";
    return;
  }
...
function fixsuper(var_0) {
  var_0.loadoutsuper = "none";
}

function fixinvaliditems(var_0, var_1) {
  ...
  if(isDefined(var_1[1])) {
    ...
    jumpiffalse(isDefined(var_1[3])) LOC_0000005a;
  ...
  if(isDefined(var_2[4])) {
    fixweapon(var_1, "secondary");
  } else {
    jumpiffalse(isDefined(var_2[6])) LOC_000000d4;

    for(var_2 = 0; var_2 < scripts\mp\class::getmaxsecondaryattachments(); var_2++) {
      fixattachment(var_1, "secondary", var_2);
    }

    goto LOC_00000107;
  }

  if(isDefined(var_2[7])) {
    fixpower(var_2, "primary");
  }

  if(isDefined(var_2[8])) {
    fixpower(var_2, "secondary");
  }

  foreach(var_8 in var_2[9]) {
    fixperk(var_2, var_8);
  }

  if(isDefined(var_2[10])) {
    fixarchetype(var_2);
  } else if(isDefined(var_2[11])) {
    fixarchetype(var_2);
  }

  if(isDefined(var_2[12])) {
    fixkillstreaks(var_2);
  }

  return var_2;
}

function lookuppowerslot(var_0) {
...
function weaponunlocksvialoot(var_0) {
  return false;
}
...
function turretparent(var_0, var_1, var_2, var_3) {
  if(scripts\mp\utility\game::isanymlgmatch()) {
    return true;
  }
    ...
    if(var_5 || var_10 == var_7) {
      if(!level.weaponlootmapdata[var_10].update_focus_fire_objective) {
        if(isDefined(level.weaponlootmapdata[var_10].attachcustomtoidmap)) {
          foreach(var_12 in level.weaponlootmapdata[var_10].attachcustomtoidmap) {
