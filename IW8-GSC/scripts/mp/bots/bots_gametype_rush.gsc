 ...
 * Script: scripts\mp\bots\bots_gametype_rush.gsc
**************************************************/
  ...
  for(;;) {
    ...
    if(self.role == "attacker") {
      ...
      if(!isDefined(var0)) {
        ...
        if(var0 != level.currentobjective.trigger) {
          var2 = 1;
        }
      }

      if(var2) {
        var3 = getclosestpointonnavmesh(level.currentobjective.trigger.origin, self);
    ...
    if(self.role == "defender") {
      ...
      if(!isDefined(var2)) {
        ...
        if(var2 != level.currentobjective.trigger) {
          var5 = 1;
        }
      }

      if(var5) {
        var6 = getnodesintrigger(level.currentobjective.trigger);
  ...
  if(isDefined(level.currentobjective.trigger)) {
    foreach(var3 in level.players) {
      if(!isai(var3) && isDefined(var3.team) && var3.team == var0) {
        if(!var3 istouching(level.currentobjective.trigger)) {
...
function is_b_better_defender(var0, var1) {
  var2 = var0 istouching(level.currentobjective.trigger);
  var3 = var1 istouching(level.currentobjective.trigger);
  ...
  var4 = distance2dsquared(var0.origin, level.currentobjective.trigger.origin);
  var5 = distance2dsquared(var1.origin, level.currentobjective.trigger.origin);
