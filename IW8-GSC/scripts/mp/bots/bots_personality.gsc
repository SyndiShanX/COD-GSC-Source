...
function setup_personalities() {
  ...
  foreach(var_1 in level.bot_personality) {
...
function bot_balance_personality() {
  ...
  foreach(var_15 in var_1) {
    var_13 = int(var_3[var_15] / level.bot_personality_types_desired[var_15]);
  }
  ...
  if(!isDefined(var_17)) {
    ...
    foreach(var_15 in var_1) {
      var_23 = level.bot_personality_types_desired[var_15] - var_3[var_15] % level.bot_personality_types_desired[var_15];
    }
...
function bot_try_trap_follower(var_0, var_1) {}

function clear_script_goal_on(var_0, var_1, var_2, var_3, var_4) {
...
function bot_add_ambush_time_delayed(var_0, var_1) {
...
function bot_watch_entrances_delayed(var_0, var_1, var_2, var_3) {
...
function bot_find_ambush_entrances(var_0, var_1) {
...
function bot_filter_ambush_inuse(var_0) {
  var_1 = [];
  var_2 = gettime();
  var_3 = var_0.size;
...
function bot_filter_ambush_vicinity(var_0, var_1, var_2) {
  var_3 = [];
  var_4 = [];
  var_5 = var_2 * var_2;
  ...
  if(level.teambased) {
    foreach(var_7 in level.participants) {
      ...
      if(var_7.team == var_1.team && var_7 != var_1 && isDefined(var_7.node_ambushing_from)) {
        var_4 = var_7.node_ambushing_from.origin;
      }
    }
  }
...
function find_ambush_node(var_0, var_1) {
  clear_camper_data();
