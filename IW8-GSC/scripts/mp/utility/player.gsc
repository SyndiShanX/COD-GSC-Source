...
function round_smoke_logic(var_0) {
...
function unset_relic_trex(var_0) {
...
function updatesessionstate(var_0, var_1) {
  ...
  ref_12898("player::updateSessionState() " + var_0);
}
...
function _freezecontrols(var_0, var_1, var_2) {
  ...
  if(isDefined(var_2)) {
    if(var_0) {
      ...
      self.pers["controllerFreezeDebug"] = [];
    } else if(!isDefined(self.pers["controllerFreezeDebug"][var_2]) || self.pers["controllerFreezeDebug"][var_2] == 0) {} else {
      self.pers["controllerFreezeDebug"][var_2]--;
...
function ai_offhandfiremanager() {
  ...
  if(isDefined(self.pers["controllerFreezeDebug"])) {
    foreach(var_3 in self.pers["controllerFreezeDebug"]) {
      var_1 += var_4 + "=" + var_3 + " | ";
    }
  }
