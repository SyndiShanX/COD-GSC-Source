 ...
 * Script: scripts\mp\utility\entity.gsc
***********************************************/
...
function watchentitiesinradius(var0, var1, var2, var3, var4) {
  ...
  for(;;) {
    ...
    if(var4) {
      var5 = scripts\mp\utility\player::getplayersinradius(self.origin, var0);
    } else {
...
function isuav(var0) {
  ...
  if(var0.streakinfo.streakname == "uav" || var0.streakinfo.streakname == "counter_uav" || var0.streakinfo.streakname == "directional_uav" || var0.streakinfo.streakname == "harp") {
    return true;
  }
...
function turret_op(var0) {
  ...
  var1 = var0.streakinfo.streakname == "assault_drone";
  return var1;
}
