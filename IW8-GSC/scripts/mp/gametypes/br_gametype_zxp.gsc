...
function init()
{
    ...
    level.disable_super_in_turret.Ωs¶Pêcí∫y∆∑
XÌ$5£–ú = getdvarint( "scr_br_zxp_human_nb_syringe_drop_on_death", 2 );
    ...
    level.disable_super_in_turret.ö‹°ˆw»Ì≥:Œπ{C∫÷õ7 = getdvarint( "scr_br_zxp_show_tags_to_humans", 1 );
    level.disable_super_in_turret.ref_12cb0 = [];
    level.disable_super_in_turret.ref_12cb1 = [];
    level.disable_super_in_turret.respawnitems = [];
    level.disable_super_in_turret.©o∫-ïËKRè√—Î⁄X8†◊ = getdvarint( "scr_br_zxp_zombieai_killed_loot_chance", 20 );
...
{
    if ( !level.disable_super_in_turret.∫}rïöçh%Û∞„y„›}e˚Ôí{Û )
    {
        return false;
    }
    ...
    if ( !level.disable_super_in_turret.Ç X_µæpÕ•Àˇ!w◊∞@Ê§bF|(î!Ä—pÿäÁÕ„H && istrue( var0.victim.inlaststand ) )
    {
        return false;
    }
...
function ref_13302( var0, var1 )
{
    ...
    {
        if ( !level.disable_super_in_turret.Ç X_µæpÕ•Àˇ!w◊∞@Ê§bF|(î!Ä—pÿäÁÕ„H && !istrue( self.inlaststand ) )
        {
            return false;
        }
    }
...
function ref_13662( var0, var1 )
{
    ...
    for ( var5 = 0; var5 < level.disable_super_in_turret.Ωs¶Pêcí∫y∆∑
XÌ$5£–ú ; var5++ )
    {
        var8 = var5.origin;
...
{
    var2 = level.disable_super_in_turret.Ωs¶Pêcí∫y∆∑
XÌ$5£–ú;
...
function ref_12cb2( var0 )
{
    if ( isent( self ) )
    {
        if ( istrue( level.disable_super_in_turret.ö‹°ˆw»Ì≥:Œπ{C∫÷õ7 ) || var0 scripts\mp\gametypes\br_public::ref_125f3() )
        {
...
function playerupdatetagobjectives()
{
    ...
    if ( !istrue( level.disable_super_in_turret.ö‹°ˆw»Ì≥:Œπ{C∫÷õ7 ) && !scripts\mp\gametypes\br_public::ref_125f3() )
    {
        return;
    }
...
function initzombieais()
{
    ...
    level.∂pOﬁ≠ƒ•¨,—:Ö6≠n4€∫Ü•Gl∆çÿ∂ = &zai_zombieattackshouldhitcallback;
...
{
    if ( randomint( 100 ) <= level.disable_super_in_turret.©o∫-ïËKRè√—Î⁄X8†◊ )
    {
        ref_12702();
        return;
    }
