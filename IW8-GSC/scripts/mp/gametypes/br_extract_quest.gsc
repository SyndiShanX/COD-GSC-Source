...
function init() {
  var0 = scripts\mp\gametypes\br_quest_util::registerquestcategory("blueprintextract", 1);
  ...
  var1 = getDvar("scr_br_gametype", "") == "dmz" || getDvar("scr_br_gametype", "") == "rat_race" || getDvar("scr_br_gametype", "") == "risk" || getDvar("scr_br_gametype", "") == "gold_war";
...
function originalloc(var0, var1, var2) {
  ...
  if(var2 > 0 && istrue(level.br_plunder_enabled) && (getDvar("scr_br_gametype", "") == "dmz" || getDvar("scr_br_gametype", "") == "rat_race" || getDvar("scr_br_gametype", "") == "risk" || getDvar("scr_br_gametype", "") == "gold_war")) {
...
function overtimebuiltintomatchtimer() {
  ...
  var1 = scripts\mp\gametypes\br_quest_util::play_train_speaker_vo("blueprintextract", var0);
...
function outofboundstimebr(var0) {
  ...
  var1 = scripts\mp\gametypes\br_quest_util::createlocaleinstance("blueprintextract_locale", "blueprintextract", "ExtractPoint:" + scripts\mp\gametypes\br_quest_util::getquestdata("blueprintextract_locale").nextid);
  ...
  scripts\mp\gametypes\br_quest_util::addquestinstance("blueprintextract_locale", var1);
  return var1;
}
...
function outofboundstriggersplanetrace(var0) {
  var1 = spawnStruct();
  var1.origin = var0;
  var2 = rocket_missile(var1);
  var3 = scripts\mp\gametypes\br_quest_util::play_train_speaker_vo("blueprintextract", var2);
...
function outline_grenade_box(var0, var1) {
  ...
  if(var3 > var1) {
    foreach(var5 in self.subscribedinstances) {
      scripts\mp\gametypes\br_quest_util::displayteamsplash(var5.team, "br_blueprint_extract_quest_circle_failure");
...
function takequestitem(var0) {
  ...
  var5 = scripts\mp\gametypes\br_quest_util::createquestinstance("blueprintextract", self.team, var0.index, var0);
  var5.team = self.team;
  var5.tablet = var0;
  ...
  var6 = getdvarint("scr_br_blueprintextract_questTime", 240);
  var5 scripts\mp\gametypes\br_quest_util::ref_1297d(var6, 4);
  var7 = rocket_missile(var0);
  var8 = var5 scripts\mp\gametypes\br_quest_util::requestquestlocale("blueprintextract_locale", var7, 1);
  ...
  scripts\mp\gametypes\br_quest_util::addquestinstance("blueprintextract", var5);
  ...
  var12.ref_127d5 = scripts\mp\gametypes\br_quest_util::rewardmodifier("blueprintextract", scripts\mp\gametypes\br_quest_util::ringing(self.team));
  scripts\mp\gametypes\br_quest_util::displayteamsplash(self.team, "br_blueprint_extract_quest_start_team", var12);
  scripts\mp\gametypes\br_quest_util::displayplayersplash(self, "br_blueprint_extract_quest_start_tablet_finder", var12);
  scripts\mp\gametypes\br_quest_util::lookforvehicles(var5.team, self, 6, scripts\mp\gametypes\br_quest_util::getquestindex("blueprintextract"));
...
function ref_14508(var0) {
  ...
  for(;;) {
    ...
    if(isDefined(var0) && !var0 hasweapon(self.weapon)) {
      ...
      scripts\mp\gametypes\br_quest_util::displayteamsplash(var0.team, "br_blueprint_extract_quest_failure");
      ref_13f71(var0);
      self.result = "fail";
...
function ref_14507(var0) {
  ...
  scripts\mp\gametypes\br_quest_util::displayteamsplash(var1, "br_blueprint_extract_quest_failure");
...
function ref_144b6(var0) {
  ...
  for(;;) {
    ...
    if(var0.warningbits == self.ref_1393b.soldier_agent_lwfn8.index) {
      ...
      var6 = scripts\mp\gametypes\br_quest_util::getquestindex("blueprintextract");
...
function logtrophysuccesful(var0) {
  ...
  var4 = scripts\mp\gametypes\br_quest_util::getquestindex("blueprintextract");
  var5 = scripts\mp\gametypes\br_quest_util::rewardtovalue(scripts\mp\gametypes\br_quest_util::rewardtotype("blueprintextract"));
  ...
  waitframe();
  scripts\mp\gametypes\br_quest_util::displayteamsplash(var1, "br_blueprint_extract_quest_complete", var2);
}
...
function rocket_missile(var0) {
  ...
  var1.ref_12fa6 = level.overrideviewkickscalek98;
  var1.ref_12fa7 = 0;
  ...
  if(getdvarint("scr_br_alt_mode_bblitz", 0)) {
    var1.ref_12fa1 = 0;
    var1.ref_12fa6 = 200000;
    var1.ref_13d09 = scripts\mp\gametypes\br_alt_mode_bblitz::clear_and_give_killstreak_loadout_support();
    var1.mintime = scripts\mp\gametypes\br_alt_mode_bblitz::clear_and_give_killstreak_loadout_recon();
  }
