...
function regive_killstreak_after_use(var_0, var_1) {
  ...
  if(!isDefined(var_2) && level.players.size > 1 && !istrue(level.gameended) && !istrue(level.‚kò·° F© ÝÇ - wá3Åû¸ "N|¸”%CÁPÙŠÅ ) ) {
      var_5 = 0;
  ...
  function spawnspectator(var_0, var_1, var_2) {
    ...
    if(isDefined(var_5) || !istrue(level.‚kò·° F© ÝÇ - wá3Åû¸ "N|¸”%CÁPÙŠÅ ) ) {
    ...
    function ref_11be2(var_0, var_1, var_2) {
      ...
      if(isDefined(var_3) || !istrue(level.‚kò·° F© ÝÇ - wá3Åû¸ "N|¸”%CÁPÙŠÅ ) ) {
