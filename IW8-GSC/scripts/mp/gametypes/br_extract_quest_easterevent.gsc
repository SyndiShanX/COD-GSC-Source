...
function overtimebuiltintomatchtimer() {
  ...
  var_1 = scripts\mp\gametypes\br_quest_util::play_train_speaker_vo("blueprintextract_easterevent", var_0);
...
function outofboundstriggersplanetrace(var_0) {
  var_1 = spawnStruct();
  var_1.origin = var_0;
  var_2 = scripts\mp\gametypes\br_extract_quest::rocket_missile(var_1);
  var_3 = scripts\mp\gametypes\br_quest_util::play_train_speaker_vo("blueprintextract_easterevent", var_2);
