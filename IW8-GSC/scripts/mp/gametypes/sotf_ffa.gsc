...
function onstartgametype() {
  ...
  var0 = &"OBJECTIVES/DM";
  var1 = &"OBJECTIVES/DM_SCORE";
  var2 = &"OBJECTIVES/DM_HINT";

  foreach(var4 in level.teamnamelist) {
    scripts\mp\utility\game::setobjectivetext(var4, var0);

    if(level.splitscreen) {
      scripts\mp\utility\game::setobjectivescoretext(var4, var0);
    } else {
      scripts\mp\utility\game::setobjectivescoretext(var4, var1);
    }

    scripts\mp\utility\game::setobjectivehinttext(var4, var2);
  }
...
function getspawnpoint() {
  var0 = scripts\mp\spawnlogic::getteamspawnpoints(self.team);

  if(level.ingraceperiod) {
    var1 = scripts\mp\spawnlogic::getspawnpoint_random(var0);
  } else {
    var1 = undefined;
  }
...
function onplayerscore(var0, var1) {
  var1.assists = var1 scripts\mp\utility\stats::getpersstat("longestStreak");
...
function startspawnchest() {
  level endon("game_ended");
  self endon("disconnect");
  var0 = getdvarint("scr_sotf_ffa_crateamount", 3);
  var1 = getdvarint("scr_sotf_ffa_cratetimer", 30);
...
function getrandomattachments(var0) {
  ...
  if(var5.size > 0) {
    ...
    if(var10 == "weapon_dmr" || var10 == "weapon_sniper" || var4 == "iw6_dlcweap02") {
      var11 = 0;
