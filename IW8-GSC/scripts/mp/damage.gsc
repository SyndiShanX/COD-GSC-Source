...
function heavyarmorvest_washit(var_0) {
  return isDefined(var_0.‡î è + ÀúsŒàžö‚ 3× û) && gettime() == var_0.‡î è + ÀúsŒàžö‚ 3× û;
}

function heavyarmorvest_sethit(var_0) {
  var_0.‡î è + ÀúsŒàžö‚ 3× û = gettime();
}

function heavyarmorvest_clearhit(var_0) {
  var_0.‡î è + ÀúsŒàžö‚ 3× û = undefined;
}

function heavyarmorvest_wasbroke(var_0) {
  return isDefined(var_0.¬Ù &É½ mVC + Xg— 'köœÎ+ÜŽ ) && gettime() == var_0.¬Ù&É½mVC+Xg—'
    köœÎ + ÜŽ;
  }

  function heavyarmorvest_setbroke(var_0) {
    var_0.¬Ù &É½ mVC + Xg— 'köœÎ+ÜŽ = gettime();
  }

  function heavyarmorvest_clearbroke(var_0) {
    var_0.¬Ù &É½ mVC + Xg— 'köœÎ+ÜŽ = undefined;
  }
