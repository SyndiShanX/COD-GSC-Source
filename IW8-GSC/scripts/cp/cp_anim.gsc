...
function do_animation(var0, var1, var2, var3, var4, var5) {
  ...
  if(self.code_classname == "misc_turret" && !isDefined(var5)) {
    ...
    var9 = scripts\engine\utility::ter_op(isDefined(var1), var1, (0, 0, 0));
    self animScripted(var4, var0, var9, var6, undefined, var8, var7);
  }
...
function mp_anim_handle_notetrack(var0, var1, var2, var3) {
  ...
  if(isDefined(var0["sound"])) {
    ...
    thread play_snd_on_tag(var1, var0["sound"]);
    return;
  }
}
...
function play_snd_on_tag(var0, var1) {
  if(isDefined(var1)) {
