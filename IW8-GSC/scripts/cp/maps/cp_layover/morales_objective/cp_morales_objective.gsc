...
function watchformoralesnearstruct(var_0, var_1) {
  level endon("game_ended");
  ...
  level notify("morales_near_" + var_0);
}

function watchformoralesnearpointarray(var_0, var_1) {
  level endon("game_ended");
...
function initmoraleshvtmodel(var_0) {
  ...
  level.moraleshostage = scripts\cp\cp_pickup_hostage::initdefaulthvtmodel(var_0, "morales_hostage_fullbody", undefined, &"CP_BR_SYRK_OBJECTIVES/PICK_MORALES", "drop_morales_hostage", undefined, "hostage_morales", 1);
...
function monitormoraleswaypoint() {
  ...
  for(;;) {
    self waittill("player_picked_up_hostage", var_0);
    wait 0.5;
...
function initmoraleslaptop() {
  ...
  var_1 setHintString(&"CP_OBJECTIVES/HACK");
...
function activationmoraleslaptop(var_0, var_1) {
  ...
  var_2 = scripts\cp\cp_objectives::getobjectivestructfromref("morales_2");
...
function initobjspawners() {
  ...
  [[var_0]]("morales_hack_laptop_2", 12, 20, 200, [ &waitbetweenspawnwaveswithtimeout, 0.1, 15], undefined, "morales_obj2", &watchforstopwaves, undefined, undefined);
  [[var_0]]("morales_rescue_hvt_3_A", 4, 4, 6, 0.05, undefined, "morales_obj3_A", undefined, undefined, undefined);
  [[var_0]]("morales_rescue_hvt_3_B", 4, 4, 6, 0.05, undefined, "morales_obj3_B", undefined, undefined, undefined);
  [[var_0]]("morales_rescue_hvt_3_C", 4, 4, 6, 0.05, undefined, "morales_obj3_C", undefined, undefined, undefined);
  [[var_0]]("morales_rescue_hvt_3_D", 4, 4, 6, 0.05, undefined, "morales_obj3_D", undefined, undefined, undefined);
  [[var_0]]("morales_signal_heli_4", 9, 9, 9, 0.05, undefined, "morales_obj4", undefined, undefined, undefined);
  [[var_0]]("morales_walk_ar_back", 3, 3, 3, 0.05, undefined, "morales_walk_ar_back", undefined, undefined, undefined);
  [[var_0]]("morales_walk_ar_front", 4, 4, 4, 0.05, undefined, "morales_walk_ar_front", undefined, undefined, undefined);
  [[var_0]]("morales_walk_sniper_back", 4, 4, 4, 0.05, undefined, "morales_walk_sniper_back", undefined, undefined, undefined);
  [[var_0]]("morales_walk_sniper_front", 4, 4, 4, 0.05, undefined, "morales_walk_sniper_front", undefined, undefined, undefined);
  [[var_0]]("morales_holdout_5", 0, 20, 200, 0.1, undefined, "morales_obj5", &watchforstopwaves, undefined, undefined);
  [[var_0]]("morales_holdout_5_NW", 0, 6, 6, 0.1, undefined, "morales_obj5_NW", &watchforstopwaves, &getnextholdoutspawnmodule, undefined);
  [[var_0]]("morales_holdout_5_SW", 0, 6, 6, 0.1, undefined, "morales_obj5_SW", &watchforstopwaves, &getnextholdoutspawnmodule, undefined);
  [[var_0]]("morales_holdout_5_SE", 0, 6, 6, 0.1, undefined, "morales_obj5_SE", &watchforstopwaves, &getnextholdoutspawnmodule, undefined);
  [[var_0]]("morales_holdout_5_OS", 0, 6, 6, 0.1, undefined, "morales_obj5_overseers", &watchforstopwaves, &getnextholdoutspawnmodule, undefined);
  ...
  [[var_0]]("morales_slow_load_hvt_6", 5, 15, 15, [ &waitbetweenspawnwaves, 0.1, 0.1], undefined, "morales_slow_exfil", &watchforstopwaves, undefined, undefined);
  [[var_0]]("morales_fast_load_hvt_6", 5, 15, 15, [ &waitbetweenspawnwaves, 0.1, 0.1], undefined, "morales_obj6_fast", &watchforstopwaves, undefined, undefined);
  [[var_0]]("morales_heli_1", 0, 6, 6, 0.1, 0, "morales_heli_1", undefined, &reset_recharge_after_respawn, undefined);
  [[var_0]]("morales_heli_2", 0, 6, 6, 0.1, 0, "morales_heli_2", undefined, &reset_recharge_after_respawn, undefined);
  [[var_0]]("morales_heli_approach", 0, 6, 6, 0.1, 0, "morales_heli_approach", undefined, &reset_recharge_after_respawn, undefined);
  [[var_0]]("morales_veh_1", 6, 6, 6, 0.1, undefined, "morales_veh_1", undefined, undefined, undefined);
  [[var_0]]("morales_1_patrols", 0, 24, undefined, 0.1, &unset_pre_wave_spawning, "morales_patrol_structs", &init_pre_wave_spawning, undefined);
...
function waitbetweenbomberwaves(var_0) {
  level endon("game_ended");
  var_1 = scripts\cp\cp_objectives::getobjectivestructfromref("morales_5");
...
function spawn_loot_pickups(var_0) {
  self endon("death");
...
function watchforstep5rushplayertimer(var_0) {
  level endon("game_ended");
  self endon("death");
  var_1 = 0;
...
function watchforstep4chaseplayerstopool(var_0) {
  level endon("game_ended");
  self endon("death");
...
function getnextholdoutspawnmodule(var_0) {
  ...
  for(var_2 = getaiarray("axis").size; var_2 > 20; var_2 = getaiarray("axis").size) {
    wait 1;
  }
  ...
  switch (var_0.group_name) {
    case "morales_holdout_5_NW":
      var_3 = "morales_holdout_5_SW";
      break;
    case "morales_holdout_5_SW":
      var_3 = "morales_holdout_5_SE";
      break;
    case "morales_holdout_5_SE":
      var_3 = "morales_holdout_5_OS";
      break;
    case "morales_holdout_5_OS":
      var_3 = "morales_holdout_5_NW";
      break;
    default:
      var_3 = undefined;
      break;
...
function reset_recharge_after_respawn(var_0) {
  if(!istrue(level.inmoralesholdout)) {
    return undefined;
  }
  ...
  switch (var_0.group_name) {
    case "morales_heli_approach":
      var_1 = "morales_heli_1";
      break;
    case "morales_heli_1":
      var_1 = "morales_heli_2";
      break;
    case "morales_heli_2":
      var_1 = "morales_heli_approach";
      break;
  }
...
function initmorales_1(var_0, var_1) {
...
function startmorales_1(var_0, var_1) {
  level endon("stop_morales_hvt_objectives");
  var_2 = scripts\engine\utility::getStruct("obj1_HVT_first_loc", "script_noteworthy");
...
function completemorales_1(var_0) {
  scripts\cp\cp_objectives::overridenextstep(var_0, "morales_2");
}

function initmorales_2(var_0, var_1) {
  if(!istrue(scripts\engine\utility::flag("cp_morales_cs"))) {
    scripts\engine\utility::flag_set("cp_morales_cs");
  }
...
function completemorales_2(var_0) {
  scripts\cp\cp_objectives::overridenextstep(var_0, "morales_3");
}
...
function initmorales_3(var_0, var_1) {
  if(!istrue(scripts\engine\utility::flag("cp_morales_cs"))) {
    scripts\engine\utility::flag_set("cp_morales_cs");
  }
...
function completemorales_3(var_0) {
  scripts\cp\cp_objectives::overridenextstep(var_0, "morales_4");
}

function initmorales_4(var_0, var_1) {
  if(!istrue(scripts\engine\utility::flag("cp_morales_cs"))) {
    scripts\engine\utility::flag_set("cp_morales_cs");
  }
  ...
  level.initlethalmaxoffsetmap = "morales_1";
  scripts\cp\utility::skydivestreamhintdvars("morales");
  var_2 = scripts\engine\utility::getStruct("morales_debug_hvt_slow_spawn", "script_noteworthy");
  ...
  var_3 = scripts\engine\utility::getStruct("morales_move_to_ambush", "script_noteworthy");
  ...
  objective_setdescription(var_0.customwaypointid, &"CP_BR_SYRK_OBJECTIVES/MOVE_LZ");
...
function startmorales_4(var_0, var_1) {
  ...
  wait level scripts\cp\cp_player_battlechatter::trysaylocalsound(var_2, "obj_holding");
...
function completemorales_4(var_0) {
  scripts\cp\cp_objectives::overridenextstep(var_0, "morales_5");
}

function initmorales_5(var_0, var_1) {
  if(!istrue(scripts\engine\utility::flag("cp_morales_cs"))) {
    scripts\engine\utility::flag_set("cp_morales_cs");
  }
...
function completemorales_5(var_0) {
  ...
  scripts\cp\cp_objectives::overridenextstep(var_0, "morales_6");
}

function initmorales_6(var_0, var_1) {
  if(!istrue(scripts\engine\utility::flag("cp_morales_cs"))) {
    scripts\engine\utility::flag_set("cp_morales_cs");
  }
...
function completemorales_6(var_0) {
  if(isDefined(level.moraleswid)) {
...
function mark_as_bomb_vest_controller_holder(var_0) {
  level endon("game_ended");
  wait var_0;
  var_1 = scripts\engine\utility::getStruct("morales_ai_mass_escape", "targetname");
...
function togglewavespawning(var_0) {}

function morales_guard_post_func(var_0) {
  waitframe();
...
function dorandomguardanim(var_0) {
  level endon("game_ended");
  var_0 endon("death");
  level endon("morales_guards_went_hot");
  var_1 = "cp_guard_standing_idle_01";
  var_0 scripts\asm\shared\mp\utility::bunkerinteriorkeypads(var_1);
}

function watchforguardclosetoplayers(var_0, var_1) {
  level endon("game_ended");
  var_0 endon("death");
  level endon("morales_guards_went_hot");
  var_2 = 2250000;
...
function waitformoralesguardgoinghot(var_0) {
  level endon("game_ended");
  var_0 endon("death");
...
function domoralestiedanim(var_0) {
  level endon("game_ended");
  var_0 endon("death");
  var_0.body scriptmodelplayanim("cp_morales_tied_down");
  level waittill("morales_guards_went_hot");
  var_0.body scriptmodelplayanim("sdr_cp_hostage_dropoff_ground_idle_pilot");
}
