...
function main() {
  ...
  var_0 = getDvar("cp_sv_petrograd_start_obj", "");
...
function player_fired_gun_monitor() {
  ...
  var_1 = spawn("script_model", (1315, -2034, 216));
  var_1.angles = (0, 0, 90);
  var_1 clonebrushmodeltoscriptmodel(var_0);
  var_0 = getEnt("clip128x128x8", "targetname");
  var_1 = spawn("script_model", (1315, -1955, 216));
  var_1.angles = (0, 0, 90);
  var_1 clonebrushmodeltoscriptmodel(var_0);
  var_0 = getEnt("clip64x64x256", "targetname");
  var_1 = spawn("script_model", (1347, -1999, 42));
  var_1.angles = (0, 0, 0);
  var_1 clonebrushmodeltoscriptmodel(var_0);
  var_0 = getEnt("nosight128x128x8", "targetname");
  var_1 = spawn("script_model", (-525, -1488, 216));
  var_1.angles = (270, 270, 15);
  var_1 clonebrushmodeltoscriptmodel(var_0);
  var_0 = getEnt("nosight128x128x8", "targetname");
  var_1 = spawn("script_model", (-426, -1461.5, 216));
  var_1.angles = (270, 270, 15);
  var_1 clonebrushmodeltoscriptmodel(var_0);
