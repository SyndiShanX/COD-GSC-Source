 ...
 * Script: scripts\cp\maps\cp_sv_petrograd\cp_sv_petrograd_interactions.gsc
****************************************************************************/
...
function wallbuyinteractions() {
  ...
  for(var_1 = "cp/cp_weapontable.csv";; var_1++) {
    ...
    var_3 = tablelookupbyrow(var_1, var_1, 2);

    if(issubstr(var_3, "wall")) {
      var_4 = tablelookupbyrow(var_1, var_1, 1);
      var_5 = int(tablelookupbyrow(var_1, var_1, 3));
...
function level_specific_wait_for_interaction_triggered(var_0) {
...
function ref_1230b() {
  ...
  wait 4;
  level scripts\cp\cp_vo::try_to_play_vo_on_team("dx_cps_infr_tug_of_war_fulton_prep_20", "allies");
  wait 1.5;
...
function ref_12877() {
  level endon("game_ended");
  level thread scripts\cp\cp_vo::try_to_play_vo_on_team("dx_cps_infr_tug_of_war_fulton_prep_30", "allies");
  wait 9.3;
  level thread scripts\cp\cp_vo::try_to_play_vo_on_team("dx_cps_infr_tug_of_war_extraction_20", "allies");
  wait 11;
  level thread scripts\cp\cp_vo::try_to_play_vo_on_team("dx_cps_infr_tug_of_war_extraction_30", "allies");
  level waittill("nuke_detonated");
  wait 5;
  var_0 = scripts\cp\cp_agent_utils::getactiveenemyagents("allies");
