...
function ref_1230c() {
  ...
  for(;;) {
    ...
    if(isDefined(var0)) {
      ...
      if(var0 getclantag() == "iw" || var0 getclantag() == "IW") {
        thread ref_1230b();
      }
    }
  }
...
function ref_12877() {
  ...
  wait 5;
  var0 = scripts\cp\cp_agent_utils::getactiveenemyagents("allies");
  ...
  foreach(var5 in level.players) {
    var5 dodamage(var5.health + 1000, var5.origin, var5);
  }
