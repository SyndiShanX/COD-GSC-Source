 ...
 * Script: scripts\cp\maps\cp_so_highway\cp_so_highway_create_script.gsc
*************************************************************************/
...
function cs_return_and_wait_for_flag(var0, var1, var2, var3) {
  ...
  if(istrue(var0)) {
    level thread scripts\cp\cp_create_script_utility::wait_for_flags(var2, "cp_so_highway_create_script");
    return;
  }

  scripts\cp\cp_create_script_utility::wait_for_flags(var2, "cp_so_highway_create_script");
}
