...
function player_exfil_struct() {
  var_0 = getEntArray("clip256x256x256", "targetname")[0];
  var_1 = spawn("script_model", (16790, 21198.5, 293));
  var_1.angles = (0, 330, 90);
  var_1 clonebrushmodeltoscriptmodel(var_0);
}

function ref_13528() {
  var_0 = spawn("script_model", (2165.46, 29700.2, 184));
  var_0.angles = (0, 62.6779, 0);
  var_0 setModel("debris_override_deadbody_safehouse_male_04_cn");
}