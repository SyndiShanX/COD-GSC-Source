...
function main() {
  ...
  if(isDefined(var0) && var0 != "") {
    ...
    var1 = getDvar("cp_smuggler_start_obj", "convoy4_securearea");

    if(var1 == "") {
      var1 = "convoy4_securearea";
    }
...
function tank_westturret(var0) {
  var1 = spawnStruct();
  var1.origin = var0;
  var1.angles = (0, 90, 0);
  var1.targetname = level.default_player_spawns;
  scripts\cp\cp_create_script_utility::initbunkeranims("targetname", var1.targetname, var1);
  return var1;
}