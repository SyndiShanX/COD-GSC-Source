...
function startrangeroverobjective(var0, var1) {
  waitforvehicleorplayernearpoint(var0.iconpos[0], 800);
  level notify("stop_ied_nag");
}

function startglexfilobjective(var0, var1) {
...
function initobjective2(var0, var1) {
  iprintlnbold("objective 2 init");
}

function startobjective2(var0, var1) {
  iprintlnbold("objective 2 Start");

  while(distance(level.players[0].origin, var0.iconpos) > 100) {
    wait 1;
  }
}

function completeobjective2(var0) {
  iprintlnbold("objective 2 finished");
}

function initobjective3(var0, var1) {
  iprintlnbold("objective 3 init");
}

function startobjective3(var0, var1) {
...
function completeobjective3(var0) {
  iprintlnbold("objective 3 finished");
}

function debugbeatobjective3(var0) {
