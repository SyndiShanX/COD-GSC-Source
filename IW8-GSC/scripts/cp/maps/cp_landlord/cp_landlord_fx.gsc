 ...
 * Script: scripts\cp\maps\cp_landlord\cp_landlord_fx.gsc
**********************************************************/
...
function main() {
  ...
  level._effect["vfx_ow_mortar_smoke"] = loadfx("vfx/iw8_cp/vfx_cp_smoke_gren_loop.vfx");
  ...
  scripts\cp\maps\cp_donetsk\cp_donetsk_obj_airfield::precache_fx();
