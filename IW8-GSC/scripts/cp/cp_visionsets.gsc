...
function create_visionset_stack(var_0) {
...
function add_visionset_to_stack(var_0, var_1, var_2) {
...
function remove_visionset_from_stack(var_0, var_1) {
  if(var_0.visionset_pointer <= 0) {} else {
    var_0.old_visionset = var_0.visionset_stack[var_0.visionset_pointer];
...
function remove_visionset_specific_from_stack(var_0, var_1, var_2) {
