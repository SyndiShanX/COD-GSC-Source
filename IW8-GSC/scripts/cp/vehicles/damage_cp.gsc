...
function callback_vehicledamage_internal(var_0) {
  ...
  scripts\cp_mp\vehicles\vehicle_damage::ref_14180(var_0, 1);
...
function emp_damage_callback(var_0) {
  var_1 = var_0.victim;
  var_1 endon("death");
  var_0.empdamageenabled = 1;
  thread callback_vehicledamage_internal(var_1);
  var_2 = get_emp_damage_callback(var_1.vehiclename);

  if(isDefined(var_2)) {
    GscBinSkip1(0x74, var_2, var_0, var_0);
  }
}

function get_emp_damage_callback(var_0) {
...
function set_emp_damage_callback(var_0, var_1) {
  if(!isDefined(level.vehicles)) {
    return undefined;
  } else if(!isDefined(level.vehicles.empdamage)) {
    return undefined;
...
function maxspreadshotsperframe(var_0, var_1, var_2) {
  var_3 = 0;
...
function packdamagedata(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11) {
  var_12 = spawnStruct();
