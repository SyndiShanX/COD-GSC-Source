...
function showchallengesplash(var_0, var_1) {
  var_2 = undefined;
...
function showsplash(var_0, var_1, var_2) {
...
function showsplashinternal(var_0, var_1, var_2) {
  if(!isPlayer(self)) {
    return;
  }
...
function queuesplash(var_0, var_1, var_2) {
  var_3 = spawnStruct();
  var_3.ref = var_0;
...
function tutorial_lookup_func(var_0) {
  ...
  if(get_has_seen_tutorial(var_1, var_0)) {
    return;
  }
  ...
  if(var_0 != "null" && !istrue(level.tutorial_activated)) {
    ...
    set_has_seen_tutorial(var_1, var_0, 1);
    level.tutorial_activated = undefined;
    return;
  }
}

function set_has_seen_tutorial(var_0, var_1) {
  self setplayerdata("cp", "tutorial", var_0, "saw_message", var_1);
}

function set_has_seen_perm_tutorial(var_0, var_1) {
  self setplayerdata("cp", "tutorialPerm", var_0, "saw_message", var_1);
}

function get_has_seen_tutorial(var_0) {
...
function shouldshowtutorial(var_0) {
...
function wait_and_play_tutorial_message(var_0, var_1) {
  level endon("game_ended");
  self endon("disconnect");
  self endon("death");
