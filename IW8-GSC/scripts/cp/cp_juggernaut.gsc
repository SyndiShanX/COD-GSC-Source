...
function vehicle_handleflarerecharge(var_0, var_1) {
...
function jugg_needtochangestance(var_0) {
  var_1 = 0;
...
function jugg_canresolvestance(var_0) {
  return true;
}

function jugg_handlestancechange(var_0) {
