...
function gas_watchexplode(var_0) {
  ...
  var_1 = undefined;
  jumpiffalse(isDefined(var_0.owner)) LOC_00000031;
  var_1 = var_0.owner;
...
function gas_createtrigger(var_0, var_1, var_2, var_3) {
  ...
  thread plunder_addanchoredwidgettorepositoryinstance(var_4, var_2);
  wait var_2;
...
function plunder_addanchoredwidgettorepositoryinstance(var_0, var_1) {
  if(!isDefined(self)) {
    return;
  }
...
function race_monitor_oob(var_0) {
  var_1 = var_0.basename;

  foreach(var_3 in level.powers) {
