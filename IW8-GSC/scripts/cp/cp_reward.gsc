...
function give_attacker_kill_rewards(var_0, var_1) {
  if(self.team == "allies") {
    return;
  }
  ...
  if(isDefined(self.attacker_damage) || isDefined(self.marked_by_hybrid)) {
    if(isDefined(self.marked_by_hybrid)) {
      foreach(var_4 in level.players) {
        if(isDefined(self.player_who_tagged) && self.player_who_tagged == var_4 && var_4 != var_4) {
          var_7 = getassistbonusamount();

          if(isDefined(level.cash_scalar)) {
            var_7 *= level.cash_scalar;
          }
  ...
  if(isDefined(var_5) && var_5 == "soft" && !var_14) {
    var_2 = int(var_2 * 1.5);
  }

  givekillreward(var_4, var_2, "large", var_5);
}
