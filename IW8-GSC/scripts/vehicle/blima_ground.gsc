...
function setanims() {
  ...
  var0[2].idle = % sdr_mp_veh_blima_ground_l1_idle;
  var0[3].idle = % sdr_mp_veh_blima_ground_l2_idle;
  var0[4].idle = % sdr_mp_veh_blima_ground_l3_idle;
  var0[5].idle = % sdr_mp_veh_blima_ground_r1_idle;
  var0[6].idle = % sdr_mp_veh_blima_ground_r2_idle;
  var0[7].idle = % sdr_mp_veh_blima_ground_r3_idle;
  var0[0].sittag = "tag_pilot1";
  var0[1].sittag = "tag_pilot2";
  var0[2].sittag = "tag_guy0";
  var0[3].sittag = "tag_guy1";
  var0[4].sittag = "tag_guy2";
  var0[5].sittag = "tag_guy3";
  var0[6].sittag = "tag_guy4";
  var0[7].sittag = "tag_guy6";
  var0[2].getout = % sdr_mp_veh_blima_ground_l1_exit;
  var0[3].getout = % sdr_mp_veh_blima_ground_l2_exit;
  var0[4].getout = % sdr_mp_veh_blima_ground_l3_exit;
  var0[5].getout = % sdr_mp_veh_blima_ground_r1_exit;
  var0[6].getout = % sdr_mp_veh_blima_ground_r2_exit;
  var0[7].getout = % sdr_mp_veh_blima_ground_r3_exit;
  return var0;
}
