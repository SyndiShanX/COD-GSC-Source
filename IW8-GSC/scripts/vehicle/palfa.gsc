 ...
 * Script: scripts\vehicle\palfa.gsc
***********************************************/
...
function main(var0, var1, var2) {
  ...
  scripts\common\vehicle_build::build_deathmodel(var0, "veh8_civ_lnd_palfa_static_dst");
...
function setanims() {
  ...
  var0[0].idle = % reb_vh_palfa_driver_idle_search01;
  var0[1].idle = $reb_vh_palfa_pass_idle_search01;
