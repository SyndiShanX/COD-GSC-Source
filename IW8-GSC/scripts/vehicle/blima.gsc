...
function main(var_0, var_1, var_2) {
  ...
  scripts\common\vehicle_build::build_light(var_2, "cockpit_red_cargo01", "tag_light_cargo01", "vfx/misc/aircraft_light_cockpit_red", "interior", 0);
  scripts\common\vehicle_build::build_light(var_2, "cockpit_red_cargo02", "tag_light_cargo02", "vfx/misc/aircraft_light_cockpit_red", "interior", 0);
  ...
  scripts\common\vehicle_build::build_light(var_2, "spot", "tag_passenger", "vfx/misc/aircraft_light_hindspot", "spot", 0);
