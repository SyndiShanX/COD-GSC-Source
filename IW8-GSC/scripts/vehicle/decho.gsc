...
function set_vehicle_anims_civ(var_0) {
...
function set_vehicle_anims_police(var_0) {
  set_vehicle_anims(var_0);
...
function set_vehicle_anims_rebel(var_0) {
  set_vehicle_anims(var_0);
...
function unload_groups_rebel() {
  var_0 = unload_groups();
  GscBinSkip0(0x2e, "all", scripts\engine\utility::array_combine(var_0["all"], [4, 5, 6]));
}