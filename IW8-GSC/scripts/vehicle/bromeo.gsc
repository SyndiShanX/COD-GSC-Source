...
function main(var_0, var_1, var_2) {
  ...
  scripts\common\vehicle_build::build_light(var_2, "headlight_L", "tag_headlights_left", "vfx/iw8/core/bradley/vfx_tank_headlight_l", "running", 0);
  scripts\common\vehicle_build::build_light(var_2, "headlight_R", "tag_headlights_right", "vfx/iw8/core/bradley/vfx_tank_headlight_r", "running", 0);
  scripts\common\vehicle_build::build_light(var_2, "brakelight_L", "tag_brakelight_left", "vfx/iw8/core/bradley/vfx_tank_brakelight", "running", 0);
  scripts\common\vehicle_build::build_light(var_2, "brakelight_R", "tag_brakelight_right", "vfx/iw8/core/bradley/vfx_tank_brakelight", "running", 0);
  scripts\common\vehicle_build::build_light(var_2, "gunlight", "tag_gunner_turret", "vfx/iw8/core/bradley/vfx_tank_headlight_green", "running", 0);
  scripts\common\vehicle_build::build_light(var_2, "headlight_L", "tag_headlights_left", "vfx/iw8/core/bradley/vfx_tank_headlight_l", "headlights", 0);
  scripts\common\vehicle_build::build_light(var_2, "headlight_R", "tag_headlights_right", "vfx/iw8/core/bradley/vfx_tank_headlight_r", "headlights", 0);
  scripts\common\vehicle_build::build_light(var_2, "brakelight_L", "tag_brakelight_left", "vfx/iw8/core/bradley/vfx_tank_brakelight", "headlights", 0);
  scripts\common\vehicle_build::build_light(var_2, "brakelight_R", "tag_brakelight_right", "vfx/iw8/core/bradley/vfx_tank_brakelight", "headlights", 0);
  scripts\common\vehicle_build::build_light(var_2, "gunlight", "tag_gunner_turret", "vfx/iw8/core/bradley/vfx_tank_headlight_green", "headlights", 0);
}
...
function bradley_turretdustkickup(var_0) {
  ...
  GscBinSkip0(0x2e, var_2.size, self);
}

function bradley_onfireshocknearplayers(var_0) {
  foreach(var_2 in level.players) {
    if(player_drivingtank(var_2)) {
      continue;
    }
