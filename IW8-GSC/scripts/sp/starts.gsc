...
function get_start_dvars() {
  ...
  for(var_1 = 0; var_1 < level.start_functions.size; var_1++) {
    var_0 = level.start_functions[var_1]["name"];
  }
...
function display_starts() {
  ...
  GscBinSkip0(0x2e, var_0.size, "default");
}
...
function start_list_settext(var_0, var_1, var_2) {
...
function start_display_cleanup(var_0, var_1) {
  var_1 destroy();
...
function handle_starts() {
  ...
  if(level.start_point == "default") {
    ...
    var_10 = level.start_arrays[level.start_point];
    GscBinSkip1(0x74, var_10["start_func"]);
  }
  ...
  for(var_3 = var_2; var_3 < level.start_functions.size; var_3++) {
    ...
    GscBinSkip0(0x2e, var_12.size, var_10["logic_func"]);
  }
}

function already_ran_function(var_0, var_1) {
...
function get_string_for_starts(var_0) {
...
function create_start(var_0, var_1) {
  var_2 = 1;
  var_3 = (0.9, 0.9, 0.9);
...
function create_feedback_starts(var_0) {
  if(!getdvarint("feedback")) {
    return;
  }
...
function create_feedback_context(var_0, var_1) {
  if(!getdvarint("feedback")) {
    return;
  }
...
function create_feedback_endfunc(var_0, var_1, var_2) {
  if(!getdvarint("feedback")) {
    return;
  }
...
function display_feedback_context(var_0) {
  if(!isDefined(level.feedback_context)) {
    return;
  }
...
function create_feedback_endfunc_thread(var_0, var_1, var_2) {
...
function feedback_check_start(var_0, var_1) {
...
function feedback_check_endfunc(var_0, var_1) {
...
function feedback_check_end(var_0, var_1) {
...
function check_feedback_starts_existance(var_0) {
  level waittill("load_finished");
  var_1 = [];
...
function add_start_construct(var_0, var_1, var_2, var_3, var_4, var_5) {
  var_6 = [];
  GscBinSkip0(0x2e, "name", var_0);
}
