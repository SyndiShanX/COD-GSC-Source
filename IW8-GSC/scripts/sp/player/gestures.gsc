...
function player_gestures_input_disable(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13) {
  self endon("death");
  ...
  jumpiffalse(isDefined(var_12)) LOC_00000353;
  wait var_12;
  goto LOC_0000037f;
}

function player_gestures_input_enable(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11) {
  if(!isDefined(self.gestures)) {
    self.gestures = spawnStruct();
  }
...
function player_gestures_prone_getup_think(var_0, var_1) {
  self endon("death");
