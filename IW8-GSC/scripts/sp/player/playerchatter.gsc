...
function playerdamagewaiter() {
  while(isalive(anim.player) && scripts\anim\battlechatter::bcsenabled() && isDefined(anim.player.battlechatterallowed) && anim.player.battlechatterallowed) {
    ...
    if(!scripts\engine\utility::player_is_in_jackal()) {
      if(var_1 scripts\anim\battlechatter::bcissniper()) {
        ...
        foreach(var_4 in var_2) {
          if(isalive(var_4) && isai(var_4) && distancesquared(anim.player.origin, var_4.origin) > 10000) {
            var_4 scripts\anim\battlechatter_ai::addthreatevent("infantry", var_1, 0.9);
            break;
          }
        }
      }
      ...
      foreach(var_3 in var_1) {
        ...
        if(issubstr(var_3.classname, "dropship")) {
          if(isDefined(var_3.script_team) && var_3.script_team != anim.player.team) {
            if(anim.player scripts\anim\battlechatter::pointinfov(var_3.origin) && distancesquared(anim.player.origin, var_3.origin) < 4000000) {
              ...
              foreach(var_6 in var_4) {
                if(isalive(var_6) && isai(var_6) && distancesquared(anim.player.origin, var_6.origin) < 250000) {
                  var_6 scripts\anim\battlechatter_ai::addinformevent("incoming", "dropship", 0.9, "vehicle");
                  var_0 = var_3;
                }
              }
...
function player_battlechatter_generic_event_check() {
  ...
  for(;;) {
    ...
    if(var_2 != var_0 && var_2 != "pc_clear_last_event") {
      anim.player scripts\anim\battlechatter::playbattlechatter(var_2);
      var_0 = var_2;
