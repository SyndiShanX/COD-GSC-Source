...
function semtexfiremain(var_0, var_1) {
  if(!isDefined(var_0)) {
    return;
  }
  ...
  var_0 makeunusable();
  thread semtex_watch_beacon(var_0, self);
  thread semtex_watch_stuck();
  thread semtex_watch_fuse();
}

function semtex_watch_beacon(var_0, var_1) {
...
function semtexstucktoenemy(var_0, var_1, var_2) {
