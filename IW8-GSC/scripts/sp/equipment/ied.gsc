...
function iedfiremain(var_0) {
  ...
  thread ieddetonationlogic(var_0, self, 25);
}

function ieddetonationlogic(var_0, var_1, var_2) {
...
function ieddetonate(var_0, var_1) {
...
function iedcreatecursor(var_0, var_1) {
