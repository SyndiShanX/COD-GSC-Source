...
function anim_generic_gravity(var_0, var_1, var_2) {
...
function anim_generic_reach(var_0, var_1, var_2) {
  var_3 = [];
  GscBinSkip0(0x2e, 0, var_0);
}

function anim_generic_reach_and_arrive(var_0, var_1, var_2, var_3) {
  reach_and_arrive_internal(var_0, var_1, var_2, var_3, "generic");
}

function anim_reach_and_arrive(var_0, var_1, var_2, var_3) {
  reach_and_arrive_internal(var_0, var_1, var_2, var_3, var_0.animname);
}

function reach_and_arrive_internal(var_0, var_1, var_2, var_3, var_4) {
...
function anim_custom_animmode(var_0, var_1, var_2, var_3) {
  ...
  wait_until_anim_finishes(var_7, var_2);
  self notify(var_2);
}

function anim_custom_animmode_loop(var_0, var_1, var_2, var_3) {
  var_4 = scripts\common\anim::get_anim_position(var_3);
  var_5 = var_4["origin"];
  var_6 = var_4["angles"];
  ...
  wait_until_anim_finishes(var_0[0], var_2);
  self notify(var_2);
}

function wait_until_anim_finishes(var_0) {
  self endon("finished_custom_animmode" + var_0);
  self waittill("death");
}

function anim_generic_custom_animmode(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  wait_until_anim_finishes(var_0, var_2);
  self notify(var_2);
}

function anim_generic_custom_animmode_loop(var_0, var_1, var_2, var_3, var_4, var_5) {
  var_6 = scripts\common\anim::get_anim_position(var_3);
  var_7 = var_6["origin"];
  var_8 = var_6["angles"];
...
function anim_custom_animmode_solo(var_0, var_1, var_2, var_3) {
  var_4 = [];
  GscBinSkip0(0x2e, 0, var_0);
}

function anim_custom_animmode_loop_solo(var_0, var_1, var_2, var_3) {
  var_4 = [];
  GscBinSkip0(0x2e, 0, var_0);
}

function anim_custom_animmode_on_guy(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8) {
...
function anim_single_gravity(var_0, var_1, var_2) {
...
function anim_single_run(var_0, var_1, var_2, var_3) {
  scripts\common\anim::anim_single_internal(var_0, var_1, var_2, 0.25, var_3);
}

function anim_reach_and_idle(var_0, var_1, var_2, var_3, var_4) {
...
function idle_on_reach(var_0, var_1, var_2, var_3, var_4) {
  wait_for_guy_to_die_or_get_in_position(var_0);
  var_4.reachers--;
...
function anim_reach_together(var_0, var_1, var_2, var_3) {
...
function modify_moveplaybackrate_together(var_0) {
  var_1 = 0.3;
  waittillframeend();
...
function anim_reach_failsafe(var_0, var_1) {
  if(isarray(var_0)) {
...
function anim_reach(var_0, var_1, var_2, var_3) {
...
function anim_reach_with_funcs(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  ...
  foreach(var_14 in var_0) {
    ...
    var_12++;
    thread begin_anim_reach(var_14, var_10, var_16, var_17, var_4);
  }
...
function anim_reach_cleanup_solo(var_0) {
  if(!isalive(var_0)) {
    return;
  }
...
function anim_spawner_teleport(var_0, var_1, var_2) {
...
function reach_death_notify(var_0) {
...
function begin_anim_reach(var_0, var_1, var_2, var_3, var_4) {
  self endon("death");
...
function reach_to_interact_begin(var_0, var_1) {
...
function reach_with_standard_adjustments_begin(var_0, var_1) {
  self.oldgoalradius = self.goalradius;
  self.oldpathenemyfightdist = self.pathenemyfightdist;
  self.oldpathenemylookahead = self.pathenemylookahead;
  self.pathenemyfightdist = 128;
...
function anim_changes_pushplayer(var_0) {
...
function reach_with_arrivals_begin(var_0, var_1) {
  var_0 = reach_with_standard_adjustments_begin(var_0, var_1);
  self.disablearrivals = 0;
  return var_0;
}

function reach_with_planting(var_0, var_1) {
...
function reach_with_planting_and_arrivals(var_0, var_1) {
  var_2 = self getdroptofloorposition(var_0);
  var_0 = var_2;
  var_0 = reach_with_standard_adjustments_begin(var_0, var_1);
  self.disablearrivals = 0;
...
function anim_reach_and_idle_solo(var_0, var_1, var_2, var_3, var_4) {
  self endon("death");
  GscBinSkip1(0x45, 0, var_0);
}

function anim_reach_solo(var_0, var_1, var_2) {
  self endon("death");
  GscBinSkip1(0x45, 0, var_0);
}

function anim_reach_and_approach_solo(var_0, var_1, var_2, var_3) {
  self endon("death");
  GscBinSkip1(0x45, 0, var_0);
}

function anim_reach_and_approach_node_solo(var_0, var_1, var_2, var_3, var_4) {
  self endon("death");
  GscBinSkip1(0x45, 0, var_0);
}

function anim_reach_and_approach(var_0, var_1, var_2, var_3) {
  self endon("death");
...
function add_animation(var_0, var_1) {
...
function anim_single_queue(var_0, var_1, var_2, var_3) {
  if(!isDefined(var_3)) {
    var_3 = 0;
  }
...
function anim_generic_queue(var_0, var_1, var_2, var_3, var_4) {
  var_0 endon("death");
...
function anim_dontpushplayer(var_0) {
  foreach(var_2 in var_0) {
    var_2 pushplayer(0);
  }
}

function anim_pushplayer(var_0) {
  foreach(var_2 in var_0) {
    var_2 pushplayer(1);
  }
}

function anim_facialanim(var_0, var_1, var_2) {
  var_0 endon("death");
  self endon(var_1);
  var_3 = 0.05;
...
function facial_notetrack_handler(var_0, var_1, var_2) {
  self endon(var_2);
  var_0 endon("death");
...
function anim_facialfiller(var_0, var_1) {
  self endon("death");
...
function set_talker_until_msg(var_0) {
  self waittill(var_0);
}

function talk_for_time(var_0) {
  self endon("death");
...
function anim_reach_idle(var_0, var_1, var_2) {
  var_3 = spawnStruct();
...
function reachidle(var_0, var_1, var_2, var_3) {
...
function clearfaceanimonanimdone(var_0, var_1, var_2) {
  var_0 endon("death");
...
function anim_set_rate_single(var_0, var_1, var_2) {
  thread anim_set_rate_internal(var_0, var_1);
}

function anim_set_rate(var_0, var_1, var_2) {
  scripts\engine\utility::array_thread(var_0, &anim_set_rate_internal, var_1, var_2);
}

function anim_set_rate_internal(var_0, var_1, var_2) {
  var_3 = undefined;
...
function create_anim_scene(var_0, var_1, var_2, var_3, var_4) {
  if(!isDefined(var_3)) {
    var_3 = "generic";
  } else {
...
function blended_loop_solo(var_0, var_1, var_2, var_3) {
...
function blended_anim_solo(var_0, var_1, var_2) {
...
function anim_block_in_single(var_0, var_1, var_2) {
  foreach(var_4 in var_0) {
    thread anim_block_in_internal(var_4, var_1, var_2);
  }
}

function anim_block_in_solo(var_0, var_1, var_2) {
  thread anim_block_in_internal(var_0, var_1, var_2);
}

function anim_block_in_internal(var_0, var_1, var_2) {
  var_0 endon("death");
  ...
  thread anim_block_in_cleanup_internal(var_0, var_5, var_6);
...
function anim_block_in_cleanup_internal(var_0, var_1, var_2) {
...
function bcs_scripted_dialog_clear(var_0, var_1) {
  self endon("death");
...
function do_facial_anim(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  if(var_0 && !var_6) {
    if(var_1) {
      thread scripts\anim\face::sayspecificdialogue(var_5);
    }
    ...
    if(var_2) {
      scripts\anim\face::sayspecificdialogue(var_5);
    } else {
      if(!var_6) {
        thread anim_facialfiller("single dialogue");
      }

      scripts\anim\face::sayspecificdialogue(var_5, "single dialogue");
    }
  } else {
...
function do_animation(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  if(self.code_classname == "misc_turret" && !isDefined(var_5)) {
    ...
    self animScripted(var_4, var_0, var_1, var_6, undefined, var_8, var_7, 1, var_9[0], var_9[1], var_9[2], var_9[3], var_10);
  }
...
function animscriptdonotetracksthread(var_0, var_1, var_2) {
...
function anim_react(var_0, var_1, var_2, var_3) {
...
function anim_react_data(var_0) {
  ...
  foreach(var_3 in var_0.guys) {
    ...
    thread anim_react_death(level, var_0.node, var_3);
  }

  var_9 = var_1 + "_intro";

  if(isDefined(level.scr_anim[var_0.guys[0].animname][var_9])) {
    anim_single_with_props(var_0.node, var_0.guys, var_9);
  }
  ...
  foreach(var_3 in var_0.guys) {
    ...
    if(isDefined(level.scr_anim[var_3.animname][var_10])) {
      thread anim_loop_with_props(var_0.node, var_3, var_10);
      continue;
    }

    if(isDefined(level.scr_anim[var_3.animname][var_11])) {
      thread anim_single_with_props(var_0.node, var_3);
...
function anim_react_thread(var_0) {
  self endon("death");
    ...
    if(var_1 == "pain") {
      ...
      if(isDefined(level.scr_anim[self.animname][var_6])) {
        ...
        if(!isDefined(self.animreactrelative)) {
          anim_single_with_props(var_0.node, self, var_6);
        } else {
      ...
      if(isDefined(level.scr_anim[self.animname][var_7])) {
        if(!isDefined(self.animreactrelative)) {
          anim_loop_with_props(var_0.node, self, var_7);
        } else {
...
function anim_react_waittill(var_0) {
...
function anim_react_alertgroup_msg(var_0, var_1) {
...
function anim_react_add_to_alertgroup(var_0) {
...
function add_animents(var_0, var_1) {
  var_2 = var_0;
...
function anim_single_with_props(var_0, var_1, var_2, var_3, var_4) {
  if(!isarray(var_0)) {
    var_0 = [var_0];
  }
...
function anim_loop_with_props(var_0, var_1, var_2, var_3, var_4, var_5) {
  if(!isarray(var_0)) {
    var_0 = [var_0];
  }
...
function anim_react_death(var_0, var_1, var_2) {
...
function detach_linkedaniments(var_0) {
  if(!isDefined(var_0.linkedaniments)) {
    return;
  }

  foreach(var_2 in var_0.linkedaniments) {
    thread detach_linkedaniment(var_2);
  }

  var_0.linkedaniments = undefined;
}

function detach_linkedaniment(var_0) {
  ...
  if(!isDefined(var_0)) {
    ...
    var_2 = var_1 gettagorigin(self.parenttag);
  }

  var_3 = vectorNormalize(var_2 - var_2);
...
function primaryweapon_leave_behind(var_0, var_1) {
  var_2 = self gettagorigin(var_0);
  var_3 = self gettagangles(var_0);
  primaryweapon_leave_behind_internal(var_2, var_3, var_1);
}

function primaryweapon_leave_behind_internal(var_0, var_1, var_2) {
