...
function gibbing_shouldgibai(var_0) {
...
function gibbing_gibai(var_0, var_1, var_2) {
  if(!isDefined(var_0)) {
    return;
  }
  ...
  var_0 scripts\anim\shared::dropaiweapon();
...
function gibbing_scriptversion(var_0, var_1, var_2) {
  ...
  if(var_18 == var_16) {
    ...
    jumpiffalse(isDefined(var_0.headmodel)) LOC_000002a8;
    var_0 detach(var_0.headmodel);
    ...
    var_19 = "J_SpineLower";
    playFX(level.g_effect["vfx_gib_explode"], var_2 gettagorigin(var_19), vectorNormalize(var_15));

    foreach(var_21 in var_8.tags) {
      if(scripts\engine\utility::hastag(var_2.model, var_21)) {
        var_2 hidepart(var_21);
      }
    }

    gibbing_buildskeletonlower(var_2);
  }

  var_2 scripts\sp\utility::do_damage(var_2.health + 9999, var_3, self, undefined, var_4, "iw8_sh_oscar12");
}

function gibbing_buildskeletonupper(var_0) {
  var_1 = "J_SpineLower";
  var_2 = (6, 0, 0);
  var_3 = (0, 270, -90);
  ...
  var_14 notsolid();
  gibbing_skeltonbuildpart(var_5, "gib_arm_upper", (-0.2, -9.5, 4), (354.959, 19.7917, 152.819), "space_suit_chunks_03", (1.5, -15.5, -3.5), (38.0104, 130.724, 95.635));
  var_15 = [var_5, var_8, var_11, var_14];
  thread gibbing_cleanupgibmodels(var_15);
}

function gibbing_buildskeletonlower(var_0) {
  var_1 = "J_SpineLower";
  ...
  var_8 linkTo(var_5, "tag_origin", var_6, var_7);
  var_8 notsolid();
  gibbing_skeltonbuildpart(var_5, "gib_leg_upper", (-6, -5, -19.5), (39.9994, 0, -12.3017), "space_suit_chunks_03", (1, -1.5, -8), (329.052, 229.202, -104.932));
  gibbing_skeltonbuildpart(var_5, "gib_leg_upper", (-2, 4.5, -20.5), (338.2, 180, -12.3017), "space_suit_chunks_04", (-0.5, 2, -14.5), (359.768, 279.452, 148.512));
  thread gibbing_cleanupgibmodels([var_5, var_8]);
}

function gibbing_skeltonbuildpart(var_0, var_1, var_2, var_3, var_4, var_5) {
...
function gibbing_cleanupgibmodels(var_0) {
  wait 30;
