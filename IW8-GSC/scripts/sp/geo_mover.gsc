...
function moveto_volume_think(var_0) {
  var_1 = [];
  ...
  if(var_15 scripts\common\vehicle::isvehicle()) {
    moveto_volume_vehiclespline(var_7, var_15, var_0);
  ...
  for(var_15 = undefined; isDefined(var_15); var_15 = undefined) {
    if(isDefined(var_21)) {
    ...
    moveto_rotateTo(var_7, var_15, var_18, var_19, var_20);
...
function moveto_volume_vehiclespline(var_0, var_1) {
  var_2 = self;
...
function moveto_rotateto_speed(var_0, var_1, var_2, var_3) {
  var_4 = var_0.origin;
  var_5 = self.origin;
