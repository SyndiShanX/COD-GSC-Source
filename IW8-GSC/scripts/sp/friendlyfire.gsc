...
function apply_friendly_fire_damage_modifier(var_0) {
  level.friendlyfire_damage_modifier = var_0;
}

function remove_friendly_fire_damage_modifier(var_0) {
  level.friendlyfire_damage_modifier = undefined;
}

function friendly_fire_think(var_0) {
  if(!isDefined(var_0)) {
    return;
  }
  ...
  for(;;) {
    ...
    if(var_11) {
      ...
      if(var_15 && !enemy_is_visible(var_2)) {
        ...
        waittillframeend();
        var_17 = get_adjusted_friendly_kill_points(var_2, level.friendlyfire["friend_kill_points"], var_5);
        level.player.participation += var_17;
      }
    } else {
...
function get_adjusted_friendly_kill_points(var_0, var_1) {
...
function friendly_fire_checkpoints(var_0) {
...
function check_grenade(var_0, var_1) {
  if(!isDefined(var_0)) {
    return 0;
  }
...
function notifydamagenotdone(var_0) {
...
function detectfriendlyfireonentity(var_0) {}
...
function enemy_is_visible() {
  ...
  foreach(var_4 in getaiarray("axis")) {
    ...
    var_5 &= var_4 seerecently(level.player, 2);
