...
function helmet_meters_on(var_0, var_1) {
  if(var_0 == "suit") {
...
function helmet_meters_off(var_0) {
...
function helmet_meters_normal_suit(var_0, var_1) {
  var_2 = randomfloatrange(93.83, 93.87);
  var_3 = randomintrange(18, 22);
  var_4 = randomfloatrange(8.2, 8.4);
  level.helmet_meters["oxygen"] = var_2;
...
function helmet_meters_normal_ship(var_0, var_1) {
  var_2 = randomfloatrange(20.93, 20.97);
  var_3 = randomintrange(18, 22);
  var_4 = randomfloatrange(14.5, 14.9);
  level.helmet_meters["oxygen"] = var_2;
...
function helmet_meters_set_oxygen(var_0, var_1, var_2) {
...
function helmet_meters_set_temperature(var_0, var_1, var_2) {
  if(isDefined(var_2) && var_2) {
...
function helmet_meters_set_pressure(var_0, var_1, var_2) {
  if(isDefined(var_2) && var_2) {
...
function helmet_meters_airlock_in(var_0) {
...
function helmet_meters_airlock_out(var_0) {
...
function helmet_meters_forced_decompress(var_0, var_1) {
  if(var_0 == "interior") {
    var_2 = randomfloatrange(20.93, 20.97);
    var_3 = randomintrange(18, 22);
    var_4 = randomfloatrange(14.5, 14.9);
  ...
  thread helmet_meters_ramp_and_stabilize("oxygen", var_4, var_2);

  if(!isDefined(var_4)) {
    var_4 = randomfloatrange(2, 3);
  }

  thread helmet_meters_ramp_and_stabilize("temperature", var_4, var_3);

  if(!isDefined(var_4)) {
    var_4 = randomfloatrange(2, 3);
  }

  thread helmet_meters_ramp_and_stabilize("pressure", var_4, var_4);
}

function helmet_meters_ramp(var_0, var_1, var_2) {
  var_3 = 0;
  var_4 = 0;
  var_5 = 0;
  ...
  while(var_11 < var_1) {
    if(var_10) {
      level.helmet_meters[var_0] += var_6;
    } else {
      level.helmet_meters[var_0] -= var_6;
    }
...
function helmet_meters_stabilize(var_0) {
  var_1 = 0;
...
function helmet_meters_ramp_and_stabilize(var_0, var_1, var_2) {
  helmet_meters_ramp(var_0, var_1, var_2);
  helmet_meters_stabilize(var_0);
}

function helmet_meters_rounding(var_0, var_1) {
  var_2 = int(var_1);
  return var_2;
}