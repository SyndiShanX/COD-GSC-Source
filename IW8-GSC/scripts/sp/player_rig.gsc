...
function init_player_rig(var_0, var_1, var_2) {
  if(isDefined(var_0)) {
    precachemodel(var_0);
  }
...
function init_player_rig_no_precache(var_0, var_1, var_2) {
  if(isDefined(var_0)) {
    level.scr_animtree["player_rig"] = #animtree;
    level.scr_model["player_rig"] = var_0;
  }
...
function link_player_to_arms(var_0, var_1, var_2, var_3) {
  if(!isDefined(var_0)) {
    var_0 = 30;
  }
...
function blend_player_to_arms(var_0) {
  if(!isDefined(var_0)) {
    var_0 = 0.7;
  }
...
function set_player_rig_allows(var_0) {
  if(!isDefined(var_0)) {
...
function link_player_to_rig(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11) {
...
function unlink_player_from_rig(var_0, var_1, var_2, var_3) {
...
function anim_lerp_from_player_pos(var_0, var_1, var_2) {
...
function player_rig_allow_weapon(var_0) {
  player_rig_allow_internal(var_0, "weapon");
}

function player_rig_allow_internal(var_0, var_1) {
