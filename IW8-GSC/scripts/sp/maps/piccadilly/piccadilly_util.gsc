...
function check_player_psycho(var_0) {
  self endon("entitydeleted");
...
function in_screen_center(var_0, var_1) {
...
function sighttrace_from_player(var_0) {
...
function colornode_arrived_func(var_0) {
  self endon("death");
...
function notify_nearby_casual_killers(var_0, var_1) {
...
function clear_favorite_enemy(var_0) {
  wait var_0;
...
function waittill_within_fov_from_dist(var_0, var_1, var_2) {
  self endon("death");
  var_3 = 0;
...
function lerp_fov_over_dist(var_0, var_1, var_2) {
...
function bomber_set_detonation_dist_squared(var_0) {
  self.bomberexplodedistance = var_0;
}

function bomber_set_target(var_0) {
  self.bombertarget = var_0;
  self getenemyinfo(var_0);
}

function initanimteddoor(var_0, var_1, var_2, var_3) {
...
function waittill_player_looks_or_timeout(var_0, var_1) {
...
function get_longest_animating_ent(var_0, var_1) {
  var_2 = var_0[0];
...
function breadcrumb_objective(var_0, var_1) {
...
function crowd_screams(var_0, var_1, var_2) {
...
function piccadilly_weapons() {
  ...
  foreach(var_4, var_3 in var_0) {
    if(var_3 == "iw8_pi_papa320") {
      var_1 = scripts\sp\utility::make_weapon_special("papa320_black_rain");
    } else {
      var_1 = scripts\sp\utility::make_weapon(var_3);
    }
...
function raindrop_fx_trigger_think(var_0, var_1) {
  for(;;) {
...
function picc_spawn_ai(var_0, var_1) {
  make_room_for_ai();
...
function make_room_for_ai(var_0, var_1, var_2) {
  if(!isDefined(var_0)) {
    var_0 = 30;
  }
...
function find_ai_to_kill(var_0) {
  ...
  foreach(var_3 in var_1) {
    if(!scripts\anim\utility_common::player_can_see_ai(level.player, var_3)) {
      return var_3;
    }
  }
...
function block_while_alive(var_0) {
  foreach(var_2 in var_0) {
...
function block_while_enemy_count(var_0) {
...
function set_goal_volume_for_substr(var_0, var_1, var_2) {
...
function set_goal_volume_for_all(var_0, var_1) {
...
function turn_off_flood_spawner(var_0) {
...
function ai_turret_shoot(var_0, var_1) {
  self endon("death");
  var_0 endon("death");
...
function veh_magic_bullet_array(var_0) {
  foreach(var_2 in var_0) {
...
function start_player_anim(var_0) {
...
function debug_print3d(var_0, var_1, var_2, var_3, var_4, var_5) {}

function delete_targetname(var_0) {
...
function delete_trigger_with_targetname(var_0) {
  var_1 = getEnt(var_0, "targetname");
  var_1 delete();
}

function delete_trigger_with_noteworthy(var_0) {
  var_1 = getEnt(var_0, "script_noteworthy");
  var_1 delete();
}
...
function pain_vo(var_0) {
  ...
  if(var_1 == "male") {
    ...
    var_3 = "woman_pain_friendly_" + var_3;
  }

  say(var_3);
}

function death_vo(var_0) {
  var_1 = get_gender();
  var_2 = randomintrange(1, 8);
  ...
  if(var_1 == "male") {
    ...
    var_3 = "woman_death_friendly_" + var_3;
  }
...
function add_to_chatter(var_0, var_1, var_2, var_3) {
  var_4 = undefined;
  ...
  if(isDefined(var_2)) {
    thread remove_on_notify(level.vo_chatter, var_0, var_2);
  }

  level.vo_chatter notify("item_added");
}

function add_say_on_closest_ally_to_chatter(var_0, var_1, var_2, var_3) {
...
function remove_on_notify(var_0, var_1, var_2) {
  ...
  foreach(var_4 in level.vo_chatter.queue) {
...
function chatter_loop_internal() {
  ...
  for(;;) {
    ...
    if(isarray(var_1)) {
      do_as_chatter(level, &say_sequence, [var_1], 1);
      continue;
    }

    do_as_chatter(level, &say_vo_item, [var_1], 1);
  }
}
...
function say_as_chatter(var_0, var_1, var_2, var_3) {
  return do_as_chatter(&say, [var_0, var_1], undefined, var_1, var_2, var_3);
}

function say_sequence_as_chatter(var_0, var_1, var_2, var_3) {
  return do_as_chatter(&say_sequence, [var_0], undefined, var_1, var_2, var_3);
}

function say_line_as_chatter_on_closest_ally(var_0, var_1, var_2, var_3) {
  return do_as_chatter(&say_line_on_closest_ally, [var_0], undefined, var_1, var_2, var_3);
}

function wait_for_break_in_chatter(var_0, var_1, var_2) {
  var_3 = spawnStruct();
  var_4 = 0.5;
  var_5 = 0;
...
function do_as_chatter(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  if(!isDefined(level.vo_chatter)) {
    thread init_chatter();
  }
...
function do_as_chatter_internal(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  level.vo_chatter endon("terminate_chatter");
  var_8 = 0.5;
  var_9 = gettime();
  ...
  if(!level.vo_chatter.speaking || !var_10 || istrue(var_4)) {
    if(!istrue(var_3)) {
      pause_chatter();
    }
    ...
    if(isDefined(var_5)) {
      var_5 -= gettime() - var_10;
    } else {
      var_5 = var_9 * 4;
    }

    if(var_5 > 0 && istrue(var_9)) {
      wait_combat_cooldown(var_9, var_5);
    }

    var_11 = call_with_params(var_1, var_2);
    level.vo_chatter.speaking--;
...
function say_line_on_closest_ally(var_0, var_1) {
  ...
  if(var_3 == level.sas[0]) {
    say(level.sas[0], var_0[0]);
  } else if(var_3 == level.sas[1]) {
    say(level.sas[1], var_0[1]);
  } else if(isDefined(var_3.vo_index)) {
    say(var_3, var_0[var_3.vo_index]);
  } else {
...
function forward_notify(var_0, var_1, var_2) {
  self endon("death");
...
function create_nag(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8) {
  var_9 = spawnStruct();
...
function set_if_undefined(var_0, var_1) {
  if(!isDefined(var_0)) {
    return var_1;
  }
...
function deck_nag(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10) {
  var_11 = create_nag(var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_10);
  deck_nag_internal(var_11, var_0, var_9);
  return var_11;
}

function deck_nag_internal(var_0, var_1, var_2) {
  if(isDefined(var_2)) {
    level endon(var_2);
    self endon(var_2);
  }
...
function is_in_combat(var_0, var_1) {
  ...
  if(istrue(var_1)) {
    ...
    foreach(var_7 in var_5) {
      if(!scripts\engine\utility::time_has_passed(ai_last_weapon_fire_time(var_7), var_0)) {
        return true;
      }
    }
  }
...
function osa_distance(var_0, var_1) {
  var_2 = var_0.size;
  var_3 = var_1.size;
  var_4 = [];
  ...
  for(var_5 = 1; var_5 <= var_2; var_5++) {
    for(var_6 = 1; var_6 <= var_3; var_6++) {
      ...
      var_4[var_6] = min(min(var_4[var_5][var_6 - 1] + 1, var_4[var_5 - 1][var_6] + 1), var_4[var_5 - 1][var_6 - 1] + var_7);

      if(var_5 > 1 && var_6 > 1 && var_0[var_5 - 1] == var_1[var_6 - 2] && var_0[var_5 - 2] == var_1[var_6 - 1]) {
        var_4[var_6] = min(var_4[var_5][var_6], var_4[var_5 - 2][var_6 - 2] + var_7);
      }
    }
  }
...
function osa_percentile(var_0, var_1) {
...
function display_all_ent_names(var_0) {
  for(;;) {
    if(isDefined(var_0)) {
    ...
    foreach(var_3 in var_1) {
      ...
      if(isDefined(var_6)) {
        var_6 = get_value_with_index(var_3, var_6, "script_noteworthy");
        var_4 += var_5;
      }
      ...
      if(isDefined(var_6)) {
        var_6 = get_value_with_index(var_3, var_6, "targetname");
        var_4 += var_5;
      }
...
function get_value_with_index(var_0, var_1) {
...
function display_all_last_anims(var_0) {
  for(;;) {
    var_1 = getEntArray();
...
function print_last_anim_info(var_0) {
