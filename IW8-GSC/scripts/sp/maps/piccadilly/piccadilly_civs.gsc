...
function start_civ_struct_spawner(var_0, var_1) {
  ...
  thread scripts\sp\maps\piccadilly\piccadilly_util::crowd_screams(var_3);
  ...
  foreach(var_5 in var_3) {
    thread civ_struct_spawner_internal(var_5, var_2);
  }
}

function civ_struct_spawner_internal(var_0, var_1) {
  ...
  for(var_2 = 0; var_2 < var_0; var_2++) {
    ...
    var_3 scripts\engine\utility::set_movement_speed(scripts\sp\maps\piccadilly\piccadilly_util::get_random_civilian_speed());
    thread civ_struct_ai_go(var_3);
...
function civ_struct_ai_go(var_0) {
  self endon("death");
...
function spawn_civ(var_0, var_1, var_2) {
  if(!istrue(var_2)) {
  ...
  var_4 thread scripts\sp\maps\piccadilly\piccadilly::global_civ_spawn_func();
  var_4.animname = self.animname;
  return var_4;
}

function get_picc_civ_spawner(var_0) {
...
function get_safe_spawners(var_0) {
  for(;;) {
