...
function right_corner_civs() {
  ...
  thread scripts\sp\maps\piccadilly\piccadilly_util::crowd_screams(var_5);
  var_6 = [];

  for(var_7 = 0; var_7 < 6; var_7++) {
    foreach(var_9 in var_1) {
      var_10 = var_9 scripts\sp\maps\piccadilly\piccadilly_civs::spawn_civ("random");
      var_10.team = "allies";
      var_10 setthreatbiasgroup("civilians");
      var_10.attackeraccuracy = 5;
      var_10.health = 50;
      var_6 = var_10;
      var_10 thread scripts\sp\maps\piccadilly\piccadilly_civs::civ_struct_ai_go(var_9.target);
      var_10.ignoreme = 1;
...
function right_kill_squad_dmg_func(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9) {
...
function lilly_entrance_draw() {
  ...
  if(isalive(var_0)) {
    ...
    scripts\sp\maps\piccadilly\piccadilly_anim::squib_head(var_0);
...
function lotus_bomber_logic() {
  ...
  thread scripts\sp\maps\piccadilly\piccadilly_util::say_line_as_chatter_on_closest_ally(var_1, 1, 0.5);
  ...
  var_2 = scripts\sp\maps\piccadilly\piccadilly_util::say_line_as_chatter_on_closest_ally(var_1, 1, 0.65);
  wait 0.3;
  ...
  if(isalive(var_2)) {
    if(var_2 == level.sas[0]) {
      level.sas[0] scripts\sp\maps\piccadilly\piccadilly_util::say(var_3[0]);
      return;
    }

    if(var_2 == level.sas[1]) {
      level.sas[1] scripts\sp\maps\piccadilly\piccadilly_util::say(var_3[1]);
      return;
    }

    if(isDefined(var_2.vo_index)) {
      var_2 scripts\sp\maps\piccadilly\piccadilly_util::say(var_3[var_2.vo_index]);
      return;
    }
  ...
  scripts\sp\maps\piccadilly\piccadilly_util::say_line_on_closest_ally(var_3);
}
...
function car_stream(var_0, var_1) {
  waitframe();
...
function car_drive_control(var_0) {
  self endon("death");
  wait 2;
...
function car_jumper() {
  ...
  var_0 scripts\anim\shared::forceuseweapon(scripts\sp\utility::make_weapon("iw8_ar_falpha", ["rec_falpha|1", "front_falpha|1", "mag_falpha|1", "toprail_falpha|1", "triggrip_falpha|1"]), "primary");
  var_1 = [];
  ...
  var_4 = var_2 scripts\sp\maps\piccadilly\piccadilly_civs::spawn_civ("male", 1);
  ...
  var_5 = var_2 scripts\sp\maps\piccadilly\piccadilly_civs::spawn_civ("male", 1);
  var_5.ignoreme = 1;
  ...
  thread car_jumper_car_delete_civs(var_2);
  thread jumper_dmg_detect();
  var_6 = car_jumper_logic(var_0, var_3, var_1, var_2);

  if(!isDefined(var_6)) {
    scriptable_clearanim(var_2);
    var_0 scripts\engine\utility::delaythread(1.6, &scripts\anim\shared::dropallaiweapons);
...
function car_jumper_car_delete_civs(var_0) {
  level endon("spec_price_intro_start");
...
function car_jumper_logic(var_0, var_1, var_2) {
  self.car = var_2;
  ...
  var_1 childthread scripts\common\anim::anim_loop_solo(self, "car_jump_loop_shoot");
  level scripts\engine\utility::delaythread(0.1, &car_civs_die, var_1, var_2, var_3);
  car_jumper_shooting(var_5, var_2);
  var_1 notify("stop_loop");
  ...
  var_1 scripts\common\anim::anim_single_solo(self, "car_jump_exit_back");
  scripts\common\ai::stop_magic_bullet_shield();
...
function car_civs_die(var_0, var_1, var_2) {
...
function car_jumper_shooting(var_0, var_1) {
  var_2 = gettime();
...
function set_accuracy_at_dist(var_0, var_1) {
...
function vo_combat_start() {
  ...
  if(!level.sas[0] iswaitingonsound() && !level.sas[1] iswaitingonsound() && !scripts\sp\maps\piccadilly\piccadilly_util::is_dead_or_dying(var_4)) {
  ...
  wait 3;
  scripts\sp\maps\piccadilly\piccadilly_util::add_to_chatter("dx_vom_gfc_combat_tube_10", var_0, ["tflag_left_underground", "going_right_side"]);
  var_5 = ["dx_vom_s151_combat_tube_20", "dx_vom_s152_combat_tube_30", "dx_vom_uk53_combat_tube_40", "dx_vom_uk54_combat_tube_50"];
  scripts\sp\maps\piccadilly\piccadilly_util::add_say_on_closest_ally_to_chatter(var_5, var_0, ["tflag_left_underground", "going_right_side"]);
  scripts\sp\maps\piccadilly\piccadilly_util::add_to_chatter("dx_vom_uk52_sting_entrance_90", var_3, ["snipers_engaged", "gap_approach", "gap_nag_started", "going_right_side"]);
  scripts\sp\maps\piccadilly\piccadilly_util::add_to_chatter("dx_vom_uk51_sting_entrance_100", var_3, ["snipers_engaged", "gap_approach", "gap_nag_started", "going_right_side"]);
  scripts\sp\maps\piccadilly\piccadilly_util::add_to_chatter("dx_vom_gfc_sting_entrance_110", var_3, ["snipers_engaged", "gap_approach", "gap_nag_started", "going_right_side"]);
  ...
  scripts\sp\maps\piccadilly\piccadilly_util::add_say_on_closest_ally_to_chatter(var_5, var_3, ["sting_building_rescue_start", "gap_approach", "gap_nag_started", "going_right_side"]);
  scripts\sp\maps\piccadilly\piccadilly_util::add_to_chatter("dx_vom_gfc_sting_entrance_10", [var_2, var_3], ["going_right_side", "sting_building_rescue_start", "gap_nag_started"]);
  ...
  scripts\sp\maps\piccadilly\piccadilly_util::add_say_on_closest_ally_to_chatter(var_5, [var_2, var_3], ["going_right_side", "sting_building_rescue_start", "gap_nag_started"]);
  ...
  var_6 = spawnStruct();
  vo_go_left_right_nags(level, var_6);
...
function vo_go_left_right_nags(var_0) {
  ...
  for(;;) {
    ...
    scripts\sp\maps\piccadilly\piccadilly_util::say_line_as_chatter_on_closest_ally(var_3 scripts\engine\sp\utility::deck_draw());
    var_0.times_nagged++;
...
function gap_nag() {
  ...
  for(;;) {
    ...
    level scripts\sp\maps\piccadilly\piccadilly_util::say_line_as_chatter_on_closest_ally(var_1);
    wait_tanto_nag(var_0);
...
function setup_allies() {
  ...
  foreach(var_2 in level.sas) {
    var_2.ignoreall = 0;
    var_2.ignoreme = 0;
    thread replace_sas_with_police();
    var_2.colornode_func = &scripts\sp\maps\piccadilly\piccadilly_util::colornode_arrived_func;
  }
}
...
function replace_sas_with_police() {
  ...
  var_0.colornode_func = &scripts\sp\maps\piccadilly\piccadilly_util::colornode_arrived_func;
  thread replace_sas_with_police();
}
...
function vo_stairs_balcony_guy() {
  ...
  scripts\sp\maps\piccadilly\piccadilly_util::say_line_as_chatter_on_closest_ally(var_1, 1, 1);
...
function can_move_to_next_node(var_0) {
  self endon("death");
...
function rpg_guy_scripted() {
  ...
  for(;;) {
    ...
    if(scripts\engine\utility::is_equal(var_4, level.player)) {
      ...
      thread scripts\sp\maps\piccadilly\piccadilly_util::say_line_as_chatter_on_closest_ally(var_14, 1, 0.3);
    }
...
function rpg_guy_damage_func(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9) {
  if(scripts\engine\utility::is_equal(var_1, level.player)) {
...
function waittill_player_sees_me_or_timeout(var_0) {
  self endon("death");
  self endon("timeout");
...
function get_rpg_guy_target() {
  ...
  foreach(var_4 in var_0) {
    if(isDefined(var_4.model) && issubstr(var_4.model, "veh") && var_4.health > -250 && !scriptable_should_be_ignored(var_4)) {
      var_1 = var_4;
    }
  }
...
function police_vignette() {
  ...
  var_2 = scripts\sp\maps\piccadilly\piccadilly_util::picc_spawn_ai("bobby_dr", 0);
  var_2.animname = "police01";
  var_0 = var_2;
  var_2 = scripts\sp\maps\piccadilly\piccadilly_util::picc_spawn_ai("bobby_pass", 0);
  var_2.animname = "police02";
  var_0 = var_2;
  var_3 = getscriptablearray("police_arrive_scriptable_car", "targetname")[0];
  thread police_arrive_car_firstframe(var_3);
  var_1 thread scripts\common\anim::anim_single(var_0, "police_arrive");
  waitframe();
  police_car_set_animtime(var_3, 0.1);
  police_car_set_animrate(var_3, 0);
  ...
  police_car_set_animrate(var_3, 1);
...
function police_corpse_manager() {
  ...
  var_0 = (123, -292, 111.5);
  var_1 = (245.5, 252, 140);
  GscBinSkip4(0x35, var_0, 350);
}

function delete_corpses_around_pos(var_0, var_1, var_2) {
  if(!isDefined(var_2)) {
    var_3 = 55;
  } else {
    var_3 = var_3;
  ...
  for(;;) {
    ...
    while(scripts\engine\utility::within_fov(level.player.origin, level.player getplayerangles(), var_1, var_4)) {
      wait 0.25;
    }

    var_5 = getcorpsearrayinradius(var_1, var_2);
...
function bus_animated_civs() {
  ...
  for(var_2 = 1; var_2 < 6; var_2++) {
    var_3 = var_1 scripts\sp\maps\piccadilly\piccadilly_civs::spawn_civ("random");
    var_3.animname = "bus_death_civ0" + var_2;
    var_3.dontmelee = 1;
    var_3.team = "allies";
    var_3.ignoreme = 1;
    var_3 thread scripts\sp\maps\piccadilly\piccadilly_civs::ignoreme_til_player_sees();
    var_3 setthreatbiasgroup("civilians");
    var_3.attackeraccuracy = 10;

    if(var_2 == 5) {
      var_3 thread scripts\sp\maps\piccadilly\piccadilly_util::ragdoll_death_after_anim();
    }
  ...
  thread scripts\sp\maps\piccadilly\piccadilly_util::crowd_screams(var_0[0].origin);
}

function civ_think_vignette(var_0, var_1, var_2) {
  self endon("death");
  ...
  if(!isai(self)) {
    var_3 = self.animname;
    scripts\sp\maps\piccadilly\piccadilly_util::make_room_for_ai();
    var_4 = scripts\sp\maps\piccadilly\piccadilly_civs::spawner_makerealai(self);
  ...
  var_4 thread scripts\sp\maps\piccadilly\piccadilly_civs::civ_think_run(var_4);
}

function fake_civ_stream(var_0, var_1, var_2, var_3) {
  level endon(var_1);
  ...
  for(;;) {
    foreach(var_6 in var_4) {
      ...
      if(istrue(var_3)) {
        var_7 thread scripts\sp\maps\piccadilly\piccadilly_util::check_player_psycho();
      }
...
function fake_actor_think(var_0) {
  self endon("death");
  self.ignoreme = 1;
...
function magicbullets_at_window(var_0, var_1) {
  var_2 = var_0;
...
function vo_player_sniping() {
  ...
  level thread scripts\sp\maps\piccadilly\piccadilly_util::say_sequence_as_chatter(["dx_vom_uk51_sting_snipers_70", [ &scripts\sp\maps\piccadilly\piccadilly_util::say_line_on_closest_ally, [var_0]]], 0, 5);
}
...
function sniper_bus_rescue() {
  ...
  foreach(var_4 in var_1) {
    var_5 = var_0 scripts\sp\maps\piccadilly\piccadilly_civs::spawn_civ("random", 1);
    var_5.animname = var_4;
    var_0 scripts\common\anim::anim_first_frame_solo(var_5, "bus_rescue_start");
    var_5 childthread scripts\sp\maps\piccadilly\piccadilly_ambient::vignette_drone_give_soul();
  ...
  GscBinSkip4(0x6e, var_8, var_0);
}

function sniper_recue_abort(var_0) {
...
function sniper_bus_civ1_down(var_0) {
...
function sniper_bus_civ_enter(var_0) {
  self endon("death");
...
function sniper_bus_civ_outcome(var_0) {
  self endon("death");
...
function bus_terry_killing_logic(var_0) {
  self endon("death");
  ...
  thread scripts\sp\maps\piccadilly\piccadilly_util::say_line_as_chatter_on_closest_ally(var_1);
...
function waittill_player_aims_at_bus_scene(var_0) {
  self endon("death");
  var_1 = gettime();
...
function nag_look_at_bus_scene() {
  ...
  scripts\sp\maps\piccadilly\piccadilly_util::say_line_as_chatter_on_closest_ally(var_0);
...
function vo_sniper_bus_scene(var_0) {
  var_0 endon("terry_shot");
  var_0 endon("bus_rescue_complete");
  level endon("bus_scene_kill_civs");
  scripts\sp\maps\piccadilly\piccadilly_util::pause_chatter();
  var_0 thread scripts\engine\utility::thread_on_notify("bus_rescue_complete", &scripts\sp\maps\piccadilly\piccadilly_util::resume_chatter);
  wait 1;
...
function sniper_bus_terry_logic(var_0) {
  var_0 endon("bus_rescue_complete");
    ...
    if(isDefined(var_2)) {
      if(isPlayer(var_2) || isai(var_2)) {
        ...
        if(!scripts\engine\utility::flag("bus_scene_kill_civs")) {
          ...
          level scripts\engine\utility::delaythread(1.1, &scripts\sp\maps\piccadilly\piccadilly_util::say_line_as_chatter_on_closest_ally, var_3);
        }
...
function player_is_sniping(var_0) {
  ...
  for(;;) {
    ...
    if(isDefined(var_3)) {
      ...
      if(scripts\engine\utility::flag("player_upstairs_left")) {
        ...
        if(isDefined(var_7)) {
          var_16 = vectorNormalize(var_8 - var_9);
          var_17 = distance(var_9, var_8);
          self.sniper_target.origin = var_9 + var_16 * min(var_17 - 400, 500);
          waitframe();
          self setentitytarget(self.sniper_target);
          self.lastenemysightpos = var_7.origin;
          scripts\engine\utility::flag_wait_or_timeout("player_in_center", 5);
          self clearentitytarget();
        }
      }
...
function sniper_shoot_target_internal(var_0) {
  if(scripts\engine\utility::flag("player_in_center")) {
    return;
  }
  ...
  foreach(var_2 in var_0) {
    if(isalive(var_2)) {
      if(!isDefined(var_2.lastattacker)) {
        thread sniper_breakout_behavior(var_2);
        var_4 = 0;
        continue;
      }
...
function sniper_breakout_behavior(var_0) {
  self endon("death");
  self clearentitytarget();
  self.fixednode = 0;
  self.attackeraccuracy = 10;
...
function sniper_damage_func(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9) {
  if(scripts\engine\utility::is_equal(var_1, level.player)) {
    self notify("player_attacked_me");
...
function vo_player_in_center_nags() {
  ...
  for(;;) {
    ...
    scripts\sp\maps\piccadilly\piccadilly_util::say_line_on_closest_ally(var_0);
...
function nag_get_downstairs(var_0) {
  if(!scripts\engine\utility::flag("player_upstairs_left")) {
    return;
  }
  ...
  for(;;) {
    ...
    if(var_0 scripts\engine\sp\utility::deck_is_empty()) {
      var_0 scripts\sp\maps\piccadilly\piccadilly_util::array_deck_shuffle();
    }

    var_1 = var_0 scripts\engine\sp\utility::deck_draw();
    scripts\sp\maps\piccadilly\piccadilly_util::say_line_as_chatter_on_closest_ally(var_1);
  }
}
...
function center_guys_to_volume(var_0, var_1) {
...
function vo_right_bomber_reaction(var_0) {
  wait 1;
...
function spawn_cop_from_behind_player(var_0) {
...
function fake_actor_think_kill(var_0) {
  self endon("death");
...
function gap_bomber_logic() {
  ...
  if(var_0.size) {
    ...
    if(distance2d(var_1.origin, self.origin) < 70 && isalive(var_1) && !scripts\anim\utility_common::player_can_see_ai(level.player, var_1)) {
...
function gap_bomber_detoantes() {
  ...
  if(isalive(self) && !istrue(self.hasexploded)) {
    scripts\sp\maps\piccadilly\piccadilly_util::bomber_set_target(var_0);
...
function stop_bulletshield_wrapper(var_0) {
...
function gap_bomber_dmg(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9) {
...
function flag_waitopen_either(var_0, var_1) {
  for(;;) {
...
function shot_in_back(var_0, var_1) {
  self endon("death");
...
function magicbullet_burst(var_0, var_1, var_2, var_3) {
  if(isDefined(var_2)) {
  ...
  for(var_6 = 0; var_6 < var_4; var_6++) {
    ...
    var_1 += scripts\engine\utility::randomvector(5);
...
function police_arrive_car_firstframe(var_0) {
...
function scriptable_clearanim(var_0) {
  if(isDefined(var_0)) {
