 ...
 * Script: scripts\sp\maps\piccadilly\piccadilly_anim.gsc
**********************************************************/
...
function generic_human() {
  ...
  scripts\common\anim::addnotetrack_customfunction("civ04", "pain", &scripts\sp\maps\piccadilly\piccadilly_util::pain_vo, "dying_idle");
  ...
  scripts\common\anim::addnotetrack_customfunction("civ05", "pain", &scripts\sp\maps\piccadilly\piccadilly_util::pain_vo, "injured_death");
