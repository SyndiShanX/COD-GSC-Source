 ...
 * Script: scripts\sp\maps\hometown\hometown.gsc
*************************************************/
...
function main() {
  ...
  scripts\engine\sp\utility::add_start("buried_start", &buried_start, "", &scripts\sp\maps\hometown\hometown_attack::buried_main, "buried_only", &buried_catchup);
  scripts\engine\sp\utility::add_start("carried_start", &carried_start, "", &scripts\sp\maps\hometown\hometown_attack::carried_main, "main_town_buried_carried", &carried_catchup);
  scripts\engine\sp\utility::add_start("alley_start", &alley_start, "", &scripts\sp\maps\hometown\hometown_attack::alley_main, "main_town_boss", &alley_catchup);
  scripts\engine\sp\utility::add_start("gas_attack_start", &gas_attack_start, "", &scripts\sp\maps\hometown\hometown_attack::gas_attack_main, "main_town_boss", &gas_attack_catchup);
  scripts\engine\sp\utility::add_start("house_enter_start", &house_enter_start, "", &scripts\sp\maps\hometown\hometown_house::house_enter_main, "main_town_boss", &house_enter_catchup);

  if(!scripts\sp\maps\hometown\hometown_util::skipchildrenkillingscene()) {
    scripts\engine\sp\utility::add_start("house_boss_start", &house_boss_start, "", &scripts\sp\maps\hometown\hometown_house::house_boss_main, "main_town_boss", &house_boss_catchup);
  }

  scripts\engine\sp\utility::add_start("house_exit_start", &house_exit_start, "", &scripts\sp\maps\hometown\hometown_house::house_exit_main, "main_town_boss", &house_exit_catchup);
  scripts\engine\sp\utility::add_start("gas_start", &gas_start, "", &scripts\sp\maps\hometown\hometown_escape::gas_main, "main_town_boss", &gas_catchup);
  scripts\engine\sp\utility::add_start("gas_mid_start", &gas_mid_start, "", &scripts\sp\maps\hometown\hometown_escape::gas_mid_main, "main_town_poppies", &gas_mid_catchup);
  scripts\engine\sp\utility::add_start("gas_exit_start", &gas_exit_start, "", &scripts\sp\maps\hometown\hometown_escape::gas_exit_main, "main_town_poppies", &gas_exit_catchup);
  scripts\engine\sp\utility::add_start("poppies_start", &poppies_start, "", &scripts\sp\maps\hometown\hometown_escape::poppies_main, "main_town_poppies", &poppies_catchup);
  scripts\engine\sp\utility::add_start("pistol_start", &pistol_start, "", &scripts\sp\maps\hometown\hometown_escape::pistol_main, "main_town_poppies", &pistol_catchup);
  scripts\engine\sp\utility::add_start("drive_start", &drive_start, "", &scripts\sp\maps\hometown\hometown_escape::drive_main, "poppies_bunker", &drive_catchup);
  scripts\engine\sp\utility::add_start("bunker_start", &bunker_start, "", &scripts\sp\maps\hometown\hometown_escape::bunker_main, "bunker_only", &bunker_catchup);
  scripts\sp\maps\hometown\hometown_anim::main();
  scripts\sp\maps\hometown\gen\hometown_art::main();
  scripts\sp\maps\hometown\hometown_fx::main();
  scripts\sp\maps\hometown\hometown_precache::main();
  scripts\sp\maps\hometown\hometown_vo::main();
  scripts\sp\maps\hometown\hometown_lighting::main();
  preload();
  ...
  scripts\sp\utility::nvidiaansel_overridecollisionradius(5);
}
...
function helicopters_controller() {
...
function helo_alley_wait() {
  scripts\engine\utility::flag_wait("helo_move_alley");
}

function helo_poppies_wait() {
  scripts\engine\utility::flag_wait("helo_move_01");
}

function helo_controller_spawn_func_alley_close() {
...
function helo_controller_spawn_func_alley_far() {
  self vehicle_turnengineoff();
  self stopsounds();
  scripts\engine\utility::flag_wait("helo_move_alley");
...
function helo_controller_spawn_func_poppies_close() {
  self vehicle_turnengineoff();
  self stopsounds();
  scripts\engine\utility::flag_wait("helo_move_01");
...
function helo_controller_spawn_func_poppies_far() {
  self vehicle_turnengineoff();
  self stopsounds();
  scripts\engine\utility::flag_wait("helo_move_01");
...
function trucks_controller_spawn_func_poppies_hill_umike() {
  self vehicle_turnengineoff();
  self stopsounds();
}

function trucks_controller_spawn_func_poppies_hill_pickup() {
  self vehicle_turnengineoff();
  self stopsounds();
...
function trucks_controller_spawn_func_poppies_shed_umike() {
  self vehicle_turnengineoff();
  self stopsounds();
...
function gas_attack_start() {
  ...
  thread scripts\sp\maps\hometown\hometown_attack::post_alley_scene();
}

function gas_attack_catchup() {
  level notify("rail_started");
  scripts\engine\utility::flag_set("objective_attract_help");
  scripts\engine\utility::stop_exploder("burried_sun");
}

function house_enter_start() {
...
function house_boss_start() {
  ...
  level.player scripts\engine\sp\utility::allow_nvg(0, "hometown", 1);
  thread melee_setup();
  thread scripts\sp\maps\hometown\hometown_house::goliath_stab_model_swap_monitor();
  scripts\engine\sp\utility::set_start_location("house_boss_start", [level.player]);
  visionsetnaked("hometown_house_int_postfire", 0);
  level.gas_attack_anim_node = getEnt("gas_attack_street_node", "script_noteworthy");
  scripts\sp\maps\hometown\hometown_attack::spawn_door_model();
  scripts\sp\maps\hometown\hometown_util::spawn_goliath_boss();
  scripts\sp\maps\hometown\hometown_util::goliath_bloody_footsteps();
  ...
  thread scripts\sp\maps\hometown\hometown_house::hadir_procedural_bones();
  ...
  level.player thread scripts\sp\maps\hometown\hometown_house::goliath_player_death_monitor();
  level thread scripts\sp\maps\hometown\hometown_house::goliath_round_monitor();
  level thread scripts\sp\maps\hometown\hometown_house::goliath_knife_monitor();
  ...
  thread scripts\sp\maps\hometown\hometown_vo::farah_idle_hide_hints();
}

function house_boss_catchup() {
  level notify("house_entered");
  scripts\engine\utility::stop_exploder("burried_sun");
}

function house_exit_start() {
  level.house_intro_deadbolt_model = getEnt("boss_house_deadbolt", "script_noteworthy");
  level.house_intro_deadbolt_model.animname = "house_intro_deadbolt";
  level.house_intro_deadbolt_model scripts\engine\sp\utility::assign_animtree("house_intro_deadbolt");
  level.door_clip_boss_enter = getEnt("house_door_clip_boss_enter", "script_noteworthy");
...
function gas_mid_start() {
  ...
  visionsetnaked("hometown_gas_close_mid", 0);
  thread scripts\sp\maps\hometown\hometown_house::player_putgasmaskon();
  level.hadir_ai attach("hat_child_hadir_gas_mask");
...
function gas_mid_catchup() {
  scripts\engine\utility::stop_exploder("burried_sun");
  thread scripts\engine\utility::exploder("gasgrenadeplayground");
  thread scripts\engine\utility::exploder("gas_cam_01");
}

function gas_exit_start() {
  thread scripts\sp\maps\hometown\hometown_util::gas_cover_blown_monitor();
  ...
  visionsetnaked("hometown_gas_close_less", 0);
  thread scripts\sp\maps\hometown\hometown_house::player_putgasmaskon();
  level.hadir_ai attach("hat_child_hadir_gas_mask");
  scripts\sp\maps\hometown\hometown_escape::gas_main_setup(1);
...
function gas_exit_catchup() {
  scripts\engine\utility::stop_exploder("burried_sun");
  thread scripts\engine\utility::exploder("gasgrenadeplayground");
  scripts\engine\utility::stop_exploder("gas_cam_01");
}

function poppies_start() {
  level.player scripts\engine\sp\utility::allow_nvg(0, "hometown", 1);
  thread melee_setup();
  ...
  thread scripts\sp\maps\hometown\hometown_escape::hadir_move_speed_gas_exit(1);
  thread scripts\sp\maps\hometown\hometown_escape::hadir_beckon_loop();
  ...
  thread scripts\sp\maps\hometown\hometown_escape::delete_window_blocker();
}

function poppies_catchup() {
  scripts\engine\utility::stop_exploder("burried_sun");
  scripts\engine\utility::stop_exploder("gas_cam_01");
}

function pistol_start() {
  level.player scripts\engine\sp\utility::allow_nvg(0, "hometown", 1);
  thread melee_setup();
...
function pistol_catchup() {
  level notify("poppies_start");
  scripts\engine\utility::stop_exploder("burried_sun");
  scripts\engine\utility::stop_exploder("gas_cam_01");
}

function drive_start() {
  thread melee_setup();
...
function bunker_start() {
  ...
  level.bunker_gas_mask_overlay = scripts\sp\hud_util::create_client_overlay("gasmask_overlay_russian", 1);
...
function preload() {
  ...
  scripts\engine\sp\utility::add_hint_string("hint_hold_fire", &"HOMETOWN/FIRE_PISTOL", &scripts\sp\maps\hometown\hometown_escape::hintfirepistolcheck);
