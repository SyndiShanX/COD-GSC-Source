...
function wait_lookat(var_0, var_1, var_2, var_3, var_4) {
  var_3 *= 1000;
  var_5 = undefined;
...
function make_script_model_civ(var_0, var_1, var_2, var_3) {
...
function make_script_model_civ_wh(var_0, var_1, var_2, var_3) {
  var_4 = scripts\engine\sp\utility::spawn_anim_model(var_0, var_1.origin, var_1.angles);
...
function make_script_model_civ_female(var_0, var_1, var_2, var_3) {
  var_4 = scripts\engine\sp\utility::spawn_anim_model(var_0, var_1.origin, var_1.angles);
...
function make_script_model_civ_child(var_0, var_1, var_2) {
...
function make_script_model_civ_child_female(var_0, var_1, var_2) {
  var_3 = scripts\engine\sp\utility::spawn_anim_model(var_0, var_1.origin, var_1.angles);
...
function make_script_model_russian(var_0, var_1, var_2, var_3) {
  var_4 = scripts\engine\sp\utility::spawn_anim_model(var_0, var_1.origin, var_1.angles);
...
function shoot_gun_from_notetrack_player(var_0) {
...
function shoot_gas_grenade_from_notetrack(var_0) {
  var_1 = self.gun_model gettagorigin("tag_flash");
...
function goliath_stealth_filter(var_0) {
...
function goliath_smartobject_notetrack_handler(var_0) {
  ...
  switch (var_0) {
    ...
    case "spawn_entity":
      ...
      while(level.goliath_melee_weapon_spawn_count == var_7 && var_6 < 30) {
        var_7 = scripts\engine\utility::random(var_5);
        var_6++;
      }
      ...
      if(var_8 == "iw8_knife_kid") {
        var_8 setModel("weapon_wm_me_kitchen_knife");
      } else if(var_8 == "iw8_knife_kid_screwdriver") {
        var_8 setModel("weapon_wm_me_screwdriver");
      } else if(var_8 == "iw8_knife_kid_scissors") {
        var_8 setModel("weapon_wm_me_scissors");
      } else {
        var_8 setModel("weapon_wm_me_kitchen_knife");
      }
      ...
      var_11 = 10;
      var_12 = 10;
      var_8 physicslaunchserver(var_8.origin, (var_10, var_11, var_12));
      thread goliath_melee_weapon_spawn_interact(var_8, var_8);
      break;
    case "kick":
...
function goliath_bloody_footsteps(var_0) {
  var_1 = "soldier";
  var_2 = scripts\engine\utility::getfx("bloody_footprint");
  scripts\anim\utility::setfootprinteffect(var_1, "snow", var_2);
  scripts\anim\utility::setfootprinteffect(var_1, "ice", var_2);
  scripts\anim\utility::setfootprinteffect(var_1, "asphalt_dry", var_2);
  scripts\anim\utility::setfootprinteffect(var_1, "dirt", var_2);
  scripts\anim\utility::setfootprinteffect(var_1, "foliage", var_2);
  scripts\anim\utility::setfootprinteffect(var_1, "grass", var_2);
  scripts\anim\utility::setfootprinteffect(var_1, "gravel", var_2);
  scripts\anim\utility::setfootprinteffect(var_1, "mud", var_2);
  scripts\anim\utility::setfootprinteffect(var_1, "rock", var_2);
  scripts\anim\utility::setfootprinteffect(var_1, "sand", var_2);
  scripts\anim\utility::setfootprinteffect(var_1, "water", var_2);
  scripts\anim\utility::setfootprinteffect(var_1, "default", var_2);
  scripts\anim\utility::setfootprinteffect(var_1, "wood_floor", var_2);
}
...
function goliath_melee_weapon_spawn_interact(var_0, var_1) {
  wait 1;
  thread goliath_melee_weapon_interact(var_0);
}

function kill_quietly(var_0) {
...
function kill_and_delete_quietly(var_0) {
  self.skipdeathanim = 1;
  self.noragdoll = 1;
  self pushplayer(0);
  self.allowdeath = 1;
...
function russian_patroller_stealth_filter(var_0) {
...
function poppies_enemy_stealth_filter(var_0) {
...
function goliath_melee_weapon_interact(var_0) {
  if(var_0 == "iw8_knife_kid") {
    var_1 = &"HOMETOWN/KNIFE";
  } else if(var_1 == "iw8_knife_kid_rebar") {
    var_1 = &"HOMETOWN/BRICK";
  } else if(var_1 == "iw8_knife_kid_scissors") {
    var_1 = &"HOMETOWN/SCISSORS";
  } else if(var_1 == "iw8_knife_kid_screwdriver") {
...
function goliath_melee_weapon_swap() {
  ...
  if(scripts\engine\sp\utility::player_has_weapon("iw8_knife_kid_scissors")) {
    ...
    var_3 setModel("weapon_wm_me_screwdriver");
  } else if(scripts\engine\sp\utility::player_has_weapon("iw8_knife_kid")) {
    var_3 = "iw8_knife_kid";
    var_3 setModel("weapon_wm_me_kitchen_knife");
  } else {
    var_3 = "iw8_knife_kid";
    var_3 setModel("weapon_wm_me_kitchen_knife");
  }
  ...
  thread goliath_melee_weapon_spawn_interact(var_3, var_3);
}
...
function play_anim_and_delete(var_0, var_1) {
  scripts\common\anim::anim_single_solo(var_0, var_1);
  var_0 delete();
}

function play_anim_and_then_loop(var_0, var_1, var_2) {
...
function play_anim_and_then_loop_with_nags(var_0, var_1, var_2) {
  self endon("stop_play_anim_and_then_loop");
  self notify("stop_loop");
  scripts\common\anim::anim_single_solo(var_0, var_1);
...
function play_anim_and_then_last_frame(var_0, var_1) {
  self endon("stop_play_anim_and_then_loop");
  self notify("stop_loop");
  scripts\common\anim::anim_single_solo(var_0, var_1);
...
function spawn_dude_play_anim_and_delete(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9) {
  if(!isDefined(var_7)) {
    if(var_2 == "male") {
      var_10 = make_script_model_civ(var_0, self);
    } else if(var_3 == "russian_male") {
      var_10 = make_script_model_russian(var_1, self);
    } else if(var_4 == "child_male") {
      var_10 = make_script_model_civ_child(var_2, self);
    } else if(var_5 == "child_female") {
      var_10 = make_script_model_civ_child_female(var_3, self);
    } else if(var_6 == "female") {
      var_10 = make_script_model_civ_female(var_4, self);
    } else if(var_7 == "white_helmet") {
      var_10 = make_script_model_civ_wh(var_5, self);
    } else {
      var_10 = scripts\engine\sp\utility::spawn_anim_model(var_6, self.origin, self.angles);
      var_10.fakeactor_face_anim = 1;
      var_10.animationarchetype = "soldier";
    }
  } else {
    var_10 = scripts\engine\sp\utility::spawn_anim_model(var_7, self.origin, self.angles);
    var_10.fakeactor_face_anim = 1;
    var_10.animationarchetype = "soldier";
  }
  ...
  var_10 scripts\engine\utility::delaythread(1, &hometown_print3d_on_me);
  thread spawn_dude_play_anim_and_delete_animate(var_10, var_8, var_10, var_10);
  return var_10;
}

function spawn_dude_play_anim_and_delete_animate(var_0, var_1, var_2, var_3) {
  if(isDefined(var_2)) {
...
function spawn_dude_loop_anim(var_0, var_1, var_2, var_3) {
  if(var_2 == "male") {
    var_4 = make_script_model_civ(var_0, self);
  } else if(var_3 == "russian_male") {
    var_4 = make_script_model_russian(var_1, self);
  } else if(var_4 == "child_male") {
    var_4 = make_script_model_civ_child(var_2, self);
  } else {
    var_4 = scripts\engine\sp\utility::spawn_anim_model(var_3, self.origin, self.angles);
    var_4.fakeactor_face_anim = 1;
    var_4.animationarchetype = "soldier";
  }

  level.civ_cleanup_array[level.civ_cleanup_array.size] = var_4;
  thread scripts\common\anim::anim_loop_solo(var_4, var_4, var_4);
  return var_4;
}

function spawn_dude_play_anim(var_0, var_1, var_2) {
  if(var_2 == "male") {
    var_3 = make_script_model_civ(var_0, self);
  } else if(var_3 == "russian_male") {
    var_3 = make_script_model_russian(var_1, self);
  } else {
    var_3 = scripts\engine\sp\utility::spawn_anim_model(var_2, self.origin, self.angles);
    var_3.fakeactor_face_anim = 1;
    var_3.animationarchetype = "soldier";
  }

  scripts\common\anim::anim_loop_solo(var_3, var_3);
  return var_3;
}

function spawn_thing_play_anim_and_delete(var_0, var_1, var_2, var_3) {
  ...
  var_4 scripts\engine\utility::delaythread(1, &hometown_print3d_on_me);
...
function spawn_thing_play_anim_and_last_frame(var_0, var_1, var_2, var_3) {
  var_4 = scripts\engine\sp\utility::spawn_anim_model(var_0, self.origin, self.angles);
...
function autosavethreatcheck_hometown(var_0, var_1) {
  ...
  foreach(var_4 in var_2) {
    ...
    if(var_4.a.lastshoottime > gettime() - 500) {
      var_6 = getcanshootandsee_hometown(var_4);
