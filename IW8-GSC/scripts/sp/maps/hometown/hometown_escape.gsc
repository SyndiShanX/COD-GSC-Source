...
function hadir_beckon_loop() {
  ...
  var_2 = [];
  GscBinSkip0(0x2e, var_2.size, "dx_vom_had_poppies_start_cough_10");
}

function gesture_on_start_cough(var_0) {
...
function gas_main_setup(var_0) {
  ...
  var_1 scripts\engine\sp\utility::add_spawn_function(&scripts\sp\maps\hometown\hometown_util::russian_patroller_spawn_func);
...
function hadir_move_speed_gas_start(var_0) {
  wait 0.5;
...
function hadir_move_speed_gas_exit(var_0) {
...
function mass_execution_a() {
  ...
  var_3 scripts\engine\sp\utility::add_spawn_function(&scripts\sp\maps\hometown\hometown_util::russian_patroller_spawn_func);
  var_4 = var_3 scripts\engine\sp\utility::spawn_ai(1);
  var_4.animname = "gas_mass_execution_01_enemy02";
  var_5 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("gas_mass_execution_01_civ01", var_0, 1, 1);
  var_6 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("gas_mass_execution_01_civ02", var_0, 1, 1);
  var_7 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("gas_mass_execution_01_civ03", var_0, 1, 1);
  var_8 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("gas_mass_execution_01_civ04", var_0, 1, 1);
  var_9 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("gas_mass_execution_01_civ05", var_0, 1, 1);
  var_10 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("gas_mass_execution_01_civ06", var_0, 1, 1);
...
function mass_execution_b() {
  ...
  var_2 scripts\engine\sp\utility::add_spawn_function(&scripts\sp\maps\hometown\hometown_util::russian_patroller_spawn_func);
  ...
  var_4 scripts\engine\sp\utility::add_spawn_function(&scripts\sp\maps\hometown\hometown_util::russian_patroller_spawn_func);
  var_5 = var_4 scripts\engine\sp\utility::spawn_ai(1);
  var_5.animname = "gas_mass_execution_02_enemy02";
  var_6 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("gas_mass_execution_02_civ01", var_0, 1, 1);
  var_7 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("gas_mass_execution_02_civ02", var_0, 1, 1);
  var_8 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("gas_mass_execution_02_civ03", var_0, 1, 1);
  var_9 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("gas_mass_execution_02_civ04", var_0, 1, 1);
  var_10 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("gas_mass_execution_02_civ05", var_0, 1, 1);
  var_11 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("gas_mass_execution_02_civ06", var_0, 1, 1);
  var_6 scriptmoverdistancefade();
  var_7 scriptmoverdistancefade();
  var_8 scriptmoverdistancefade();
  var_9 scriptmoverdistancefade();
...
function single_execution_a() {
  ...
  var_0 scripts\engine\sp\utility::add_spawn_function(&scripts\sp\maps\hometown\hometown_util::russian_patroller_spawn_func);
...
function gas_start_execution() {
  ...
  var_2 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("gas_start_dead_body", var_1);
  var_2 scriptmoverdistancefade();
...
function square_search_dead_bodies() {
  ...
  var_8 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("square_dead_body_a", var_1);
  var_9 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("square_dead_body_b", var_2);
  var_10 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("square_dead_body_c", var_3);
  var_11 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("square_dead_body_d", var_1);
  var_12 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("square_dead_body_e", var_2);
  var_13 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("gas_single_execution03_civ", var_3);
  var_14 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("gas_single_execution04_civ", var_1);
  var_8 scriptmoverdistancefade();
  var_9 scriptmoverdistancefade();
  var_10 scriptmoverdistancefade();
  var_11 scriptmoverdistancefade();
  ...
  var_15 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("gas_single_execution01_civ", var_0, 1, 1);
...
function single_execution_b() {
  ...
  var_3 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("gas_single_execution02_civ", var_0, 1, 1);
...
function gas_victim_spawn_and_loop(var_0, var_1, var_2, var_3, var_4) {
  var_5 = scripts\engine\utility::getStruct(var_1, "script_noteworthy");

  if(var_2 == "male") {
    var_6 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ(var_0, var_5);
    var_6 playLoopSound("dx_vom_male_gasp");
  } else if(var_3 == "female") {
    var_6 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ_female(var_1, var_6);
    var_6 playLoopSound("dx_vom_female_gasp");
  } else if(var_4 == "child_male") {
    var_6 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ_child(var_2, var_6);
  } else if(var_5 == "child_female") {
    var_6 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ_child_female(var_3, var_6);
  } else if(var_6 == "none") {
    var_6 = scripts\engine\sp\utility::spawn_anim_model(var_4, var_6.origin, var_6.angles);
  } else {
    var_6 = scripts\engine\sp\utility::spawn_anim_model(var_5, var_6.origin, var_6.angles);
  }
  ...
  var_6 scriptmoverdistancefade();
  var_6 thread scripts\common\anim::anim_loop_solo(var_6, "gas_death_idle");
}
...
function trafficked_scene_solo(var_0) {
...
function trafficked_scene_kill(var_0) {
  scripts\engine\utility::flag_wait("truckmove02");
...
function hadir_scramble_monitor() {
  ...
  var_1 = scripts\engine\utility::getStruct("hadir_scramble_start_node", "script_noteworthy");
  var_1 scripts\sp\anim::anim_reach_and_approach_solo(level.hadir_ai, "Execution_end");
  wait 0.1;
  level.hadir_ai scripts\engine\sp\utility::enable_ai_color();
}
...
function pistol_skip_fight() {
  ...
  for(var_6 = 0; var_6 < level.pistol_enemies.size; var_6++) {
    level.pistol_enemies[var_6] scripts\sp\maps\hometown\hometown_util::kill_and_delete_quietly(level.player);
  }
...
function player_pistol_damage_func(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9) {
  if(isai(var_1)) {
...
function loading_kids_into_trucks_scene() {
  var_0 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ_child("pistol_loading_boy03", level.pistol_intro_anim_node);
...
function audio_hometown_truck_kid_loaded_idle(var_0) {
...
function audio_hometown_truck_kid_loaded_leaving(var_0) {
...
function cellphone_react(var_0) {
  ...
  level.hadir_ai.ignoreme = 0;
  waitframe();
  self aieventlistenerevent("cover_blown", level.hadir_ai, var_1);
  waitframe();
  level.hadir_ai.ignoreme = 1;
}
...
function give_pistol_ammo(var_0) {
  level endon("pistol_enemies_dead");
...
function drive_main() {
  ...
  level.end_barkov_model = scripts\sp\maps\hometown\hometown_util::make_script_model_russian("barkov", var_0);
  level.end_russian_01_model = scripts\sp\maps\hometown\hometown_util::make_script_model_russian("end_russian_01", var_0);
  level.end_russian_02_model = scripts\sp\maps\hometown\hometown_util::make_script_model_russian("end_russian_02", var_0);
  level.end_russian_03_model = scripts\sp\maps\hometown\hometown_util::make_script_model_russian("end_russian_03", var_0);
  level.end_captive_01_model = scripts\sp\maps\hometown\hometown_util::make_script_model_civ_female("end_captive_01", var_0);
  level.end_captive_02_model = scripts\sp\maps\hometown\hometown_util::make_script_model_civ_female("end_captive_02", var_0);
  level.end_captive_03_model = scripts\sp\maps\hometown\hometown_util::make_script_model_civ_female("end_captive_03", var_0);
  level.end_captive_04_model = scripts\sp\maps\hometown\hometown_util::make_script_model_civ_female("end_captive_04", var_0);
...
function empty_vo_func(var_0, var_1, var_2) {}
...
function farah_gasmask_swap(var_0) {
  wait 6;
  var_0 show();
  level.farah_ai detach("hat_hero_farah_sas_gasmask");
}

function player_cinematic_swap(var_0, var_1) {
...
function soldier_finds_pistol() {
  ...
  var_2 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("dead_body_c", var_0);
  var_3 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("dead_body_d", var_1);
  var_2 scriptmoverdistancefade();
  var_3 scriptmoverdistancefade();
  ...
  var_6 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("soldier_finds_pistol_body", var_4, 1);
  var_6 scriptmoverdistancefade();
...
function soldier_finds_pistol_react(var_0) {
...
function dead_body_search_patrol() {
  ...
  var_3 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("dead_body_a", var_0);
  var_4 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("dead_body_b", var_1);
  var_5 = scripts\sp\maps\hometown\hometown_util::make_script_model_civ("dead_body_e", var_2);
  var_3 scriptmoverdistancefade();
