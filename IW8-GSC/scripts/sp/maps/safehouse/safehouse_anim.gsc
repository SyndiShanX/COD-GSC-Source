 ...
 * Script: scripts\sp\maps\safehouse\safehouse_anim.gsc
********************************************************/
...
function init_anim_script_model() {
  ...
  level.scr_animtree["level_barkovWeapon"] = $;
...
function escape_getcinderblockanimations() {
...
function init_anim_generic_human() {
...
function carnage_getenemyanimations() {
...
function carnage_getcorpseanimations() {
...
function init_anim_generic_human_level() {
...
function init_anim_generic_human_level_civilian_worker() {
...
function init_anim_generic_human_level_civilian_react() {
...
function init_anim_generic_human_level_execution() {
  ...
  scripts\common\anim::addnotetrack_customfunction("level_executionCivilian1", "kill", &scripts\sp\maps\safehouse\safehouse_guard::level_guardremovecivilian);
  level.scr_anim["level_executionCivilian2"]["level_executionSceneC"] = % sh_050_execution_scenec_civ02;
  scripts\common\anim::addnotetrack_customfunction("level_executionCivilian2", "kill", &scripts\sp\maps\safehouse\safehouse_guard::level_guardremovecivilian);
  level.scr_anim["level_executionCivilian3"]["level_executionSceneC"] = % sh_050_execution_scenec_civ03;
  scripts\common\anim::addnotetrack_customfunction("level_executionCivilian3", "kill", &scripts\sp\maps\safehouse\safehouse_guard::level_guardremovecivilian);
  level.scr_anim["level_executionCivilian4"]["level_executionSceneC"] = % sh_050_execution_scenec_civ04;
  scripts\common\anim::addnotetrack_customfunction("level_executionCivilian4", "kill", &scripts\sp\maps\safehouse\safehouse_guard::level_guardremovecivilian);
