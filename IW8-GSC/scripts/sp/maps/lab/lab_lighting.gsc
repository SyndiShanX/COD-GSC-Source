...
function ambush1_lights_off() {
  ...
  foreach(var_2 in var_0) {
    thread claxon_lights_off(level, var_2);
  }
}
...
function toggle_cockpit_lights(var_0) {
  foreach(var_2 in var_0) {
    var_2 setlightintensity(0);
  }
...
function toggle_farah_lights(var_0) {
  foreach(var_2 in var_0) {
    var_2 setlightintensity(0);
  }
...
function disable_back_light(var_0) {
  level waittill("disable_light_6");
  var_0 setlightintensity(0);
}

function disable_heli_lights(var_0) {
  scripts\engine\utility::flag_wait("barkov_dead");
...
function get_light_and_linkTo(var_0, var_1, var_2, var_3, var_4, var_5) {
