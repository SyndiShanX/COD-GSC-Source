...
function place_finale_trees(var_0) {
...
function finale_trees_delete(var_0) {
...
function bomb_plant_scene() {
  var_0 = scripts\sp\maps\lab\lab_lighting::pipes_hero_light_rig_setup();
...
function move_barkov_closer(var_0) {
...
function play_single_anim_last_frame(var_0, var_1) {
...
function finale_cam_anim(var_0, var_1) {
  ...
  link_player_to_set_rig(var_0, level.alt_rig, var_1 + "_cam", "prone", 0, undefined, 1);
...
function change_yaw_angle(var_0) {
...
function finale_cam_finish(var_0, var_1) {
...
function finale_cam_finish_kickoff(var_0, var_1) {
  level.player showviewmodel();
...
function setup_bodies_for_streaming(var_0) {
...
function spawn_in_streaming_bodies(var_0, var_1) {
  if(var_1 == "head_villain_barkov_stab_5_blendshape") {
    ...
    var_2 linkTo(var_1, "tag_origin", (166.5, -0.5, -110), (0, 0, 0));
    var_2 setModel(var_2);
    var_2 notsolid();
  }
...
function finale_cam_player_anims(var_0, var_1) {
  ...
  level.alt_rig dontinterpolate();
  level.player dontinterpolate();
  link_player_to_set_rig(var_0, level.alt_rig, var_1 + "_end", "prone", 0, undefined, 1);
}
...
function finale_cam_other_anims(var_0, var_1) {
  showmayhem("mayh_lab_heli_tarp");
  thread audio_finale_heli_start();
  thread finale_cam_farah_anims(level.farah, var_0);
  thread finale_cam_barkov_anims(level.barkov, var_0);
...
function finale_cam_farah_anims(var_0, var_1) {
  self show();
...
function finale_cam_barkov_anims(var_0, var_1) {
  self show();
  self linkTo(var_0);
  self dontinterpolate();
...
function finale_knockdown_scene_setup_rig(var_0) {
  level.alt_rig hide();
  level.alt_rig linkTo(var_0);
  var_0 scripts\common\anim::anim_first_frame_solo(level.alt_rig, "finale_knock_down");
}

function finale_kick_scene_setup_rig(var_0) {
  level.alt_rig hide();
  level.alt_rig linkTo(var_0);
...
function link_player_to_set_rig(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11) {
...
function set_player_set_rig_allows(var_0, var_1) {
  if(!isDefined(var_1)) {
...
function unlink_player_from_set_rig(var_0, var_1, var_2, var_3, var_4) {
...
function finale_heli_start() {
  ...
  level.alt_rig setModel("viewhands_farah_55inch_wind");
  level.alt_rig dontcastshadows();
  link_player_to_set_rig(var_1, level.alt_rig, var_0 + "_cam_end", "prone", 0, undefined, 1);
...
function fake_ally_setup(var_0) {
...
function fake_ally_death_watcher(var_0) {
  self waittill("death");
  wait 1;
  thread fake_ally_setup(var_0);
}

function fake_enemy_setup(var_0) {
  level endon("stop_spawning_finale_combat");
...
function fake_enemy_death_watcher(var_0) {
  self waittill("death");
  wait 1;
  thread fake_enemy_setup(var_0);
}

function setup_player_last_frame(var_0, var_1) {
  level.player dontinterpolate();
...
function barkov_kick_out_scene(var_0, var_1) {
...
function barkov_damage_ending(var_0) {
  level.player modifybasefov(55, 4);
  level.alt_rig linkTo(var_0);
  link_player_to_set_rig(var_0, level.alt_rig, self.kickoffstart, "stand", 0, undefined, 0, 25, 25, 25, 25, 1);
...
function finale_skippable_section(var_0) {
...
function cleanup_finale_combat_guys(var_0) {
  wait var_0;
  level notify("stop_spawning_finale_combat");

  foreach(var_2 in level.finale_combat_ai) {
    if(var_3 < 5) {
      thread cleanup_ai();
      continue;
    }
...
function barkov_kickoff_anim(var_0) {
...
function barkov_check_for_melee_range(var_0) {
...
function custom_context_range(var_0) {
  level endon("player_spotted_finale");
  var_1 = squared(60);
  var_2 = gettime();
  var_3 = var_0 * 1000;
...
function turn_off_prompt(var_0) {
  var_1 = 1;
...
function melee_distance_check(var_0) {
...
function barkov_damage_notifies(var_0) {
  for(;;) {
...
function barkov_lookback_scene_start(var_0) {
  level endon("player_spotted_finale");
...
function change_animshot_dir(var_0) {
...
function barkov_struggle_setup(var_0) {
...
function barkov_shooting_path(var_0) {
...
function barkov_within_melee_range(var_0) {
...
function barkov_firing_loop(var_0) {
  self endon("barkov_stop_shooting");
...
function barkov_gun_path(var_0, var_1, var_2) {
...
function barkov_melee_path(var_0, var_1, var_2) {
  if(var_1 == "_front") {
...
function barkov_choke_takedown_anims(var_0, var_1) {
...
function barkov_choke_scene(var_0, var_1) {
...
function barkov_stab_post_melee(var_0, var_1) {
  var_2 = undefined;
  scripts\engine\utility::flag_set("start_choking_scene");
...
function barkov_shot_loop(var_0) {
  var_0 notify("finale_idle");
  self notify("longdeath_ender");
  level notify("end_longdeath_lines");
...
function barkov_stab_loop(var_0, var_1) {
...
function barkov_crawl_anim(var_0) {
...
function barkov_crawl_anim_shot(var_0) {
  level endon("stop_crawling_notify");
  var_0 scripts\common\anim::anim_single_solo(self, "finale_stab02b");
  var_0 scripts\common\anim::anim_last_frame_solo(self, "finale_stab02b");
  self notify("barkov_crawl_finished");
...
function barkov_crawl_scene(var_0) {
  level notify("stop_choking", 1);
  scripts\engine\utility::delaythread(0.2, &scripts\engine\sp\utility::autosave_now);
...
function player_rig_end_scene_setup(var_0) {
  level.player_rig hide();
  level.player_rig linkTo(var_0);
...
function dialogue_wheel_check(var_0, var_1, var_2, var_3) {
  var_4 = 1;
...
function dialogue_wheel_player_state(var_0) {
...
function halt_heli_end_movement(var_0) {
...
function barkov_shot_dialog(var_0) {
  level endon("end_longdeath_lines");
  barkov_shot_dialog_internal(var_0);
}

function barkov_shot_dialog_internal(var_0) {
...
function long_death_barkov(var_0) {
...
function finale_stab(var_0, var_1) {
...
function anim_aim_and_reload(var_0, var_1, var_2) {
...
function anim_aim_shoot(var_0) {
  ...
  var_3 = undefined;
  jumpiffalse(var_2) LOC_00000050;
