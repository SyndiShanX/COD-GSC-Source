 ...
 * Script: scripts\sp\maps\lab\lab_anim.gsc
***********************************************/
...
function finale_player_dialogue(var_0) {
  ...
  if(!istrue(level.barkov.iscompletelydead)) {
    level.barkov scripts\engine\utility::delaythread(1.2, &scripts\sp\maps\lab\lab_vo_util::simple_dialogue, "dx_vom_bkv_finale_heli_kill_knife_90");
    wait 1;
  }
...
function big_boom(var_0) {
  ...
  thread scripts\sp\maps\lab\lab_finale::finale_trees_delete("finale_scene_trees_firstshot");
  roof_collapse_init();
}
...
function script_models() {
  ...
  level.scr_goaltime["player_mask"]["player_mask_on"] = 0;
