 ...
 * Script: scripts\sp\maps\lab\lab_offices.gsc
***********************************************/
...
function offices_start() {
  ...
  level.rebel_1 scripts\sp\maps\lab\lab_util::magic_bullet_safe();
...
function offices_preload() {
  ...
  GscBinSkip1(0x45, "farah_gesture1", &farah_gesture1);
}

function offices_postload() {
...
function offices_main() {
  scripts\engine\sp\utility::remove_global_spawn_function("axis", &scripts\sp\maps\lab\lab_util::laser_discipline);
  scripts\engine\sp\utility::remove_global_spawn_function("allies", &scripts\sp\maps\lab\lab_util::laser_discipline);
  ...
  scripts\sp\maps\lab\lab_lighting::detonator_hero_lighting_setup();
  scripts\sp\player::player_movement_state("cqb");
  thread offices_movement_farah();
  thread offices_movement_rebel_1();
  thread offices_movement_rebel_2();
...
function set_office_speeds() {}

function offices_movement_farah() {
...
function offices_movement_rebel_1() {
  level endon("stop_offices_movement");
...
function offices_movement_rebel_2() {
  level endon("stop_offices_movement");
...
function offices_dialog() {
  wait 1.8;
  level.player scripts\sp\maps\lab\lab_vo_util::say_as_chatter("dx_vom_alx_juggernaut_outro_50", 1, 0.5);
  level.farah scripts\sp\maps\lab\lab_vo_util::say_as_chatter("dx_vom_far_juggernaut_outro_52");
  level scripts\sp\maps\lab\lab_vo_util::say_as_chatter("dx_vom_pri_juggernaut_outro_60");
  level.player scripts\sp\maps\lab\lab_vo_util::say_as_chatter("dx_vom_alx_juggernaut_outro_70");
  level scripts\sp\maps\lab\lab_vo_util::say_as_chatter("dx_vom_pri_juggernaut_outro_80");
  level scripts\sp\maps\lab\lab_vo_util::say_as_chatter("dx_vom_alx_juggernaut_outro_90");
  level scripts\sp\maps\lab\lab_vo_util::say_as_chatter("dx_vom_pri_juggernaut_outro_100");
  ...
  level.player scripts\sp\maps\lab\lab_vo_util::say_as_chatter("dx_vom_alx_juggernaut_outro_110");
  wait 0.3;
  level.player scripts\sp\maps\lab\lab_vo_util::say_as_chatter("dx_vom_alx_juggernaut_outro_120");
  wait 5;
...
function offices_goal_dialog() {
  ...
  level.farah scripts\sp\maps\lab\lab_vo_util::say_as_chatter("dx_vom_far_offices_outro_50");
...
function reset_gasmask() {
  ...
  if(isDefined(self.gas_mask) && !self.gas_mask) {
    scripts\sp\maps\lab\lab_util::gasmask_on_belt("TAG_STOWED_BACK2", 0);
    return;
  }
}
...
function delete_allies() {
  ...
  level.farah scripts\sp\maps\lab\lab_util::disable_magic_bullet_delete();
...
function pov_switch_bink() {
  level notify("office_bink");
  hidecinematicletterboxing(0, 0);
  scripts\engine\utility::delaythread(0.2, &scripts\sp\maps\lab\lab_pipes::setup_post_cinematic);
