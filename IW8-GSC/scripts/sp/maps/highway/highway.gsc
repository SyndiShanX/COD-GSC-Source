...
function init_level() {
  ...
  var_11 scripts\anim\shared::setscriptammo("weapon_iw8_sm_beta", var_10, undefined);
  var_10 delete();
...
function ride_main() {
  ...
  thread scripts\sp\maps\highway\highway_lighting::ride_lighting(var_3);
  thread scripts\sp\maps\highway\highway_lighting::ride_dof(var_4);
  var_5 = ride_spawnanimateddriverally();
  var_6 = ride_spawnanimatedalexally();
  var_7 = ride_spawnanimatedgateallies();
  var_8 = scripts\sp\maps\highway\highway_anim::ride_getgatetypes();
  var_9 = [];
  ...
  scripts\sp\maps\highway\highway_utility::ai_setname(var_5, "");
  scripts\sp\maps\highway\highway_utility::ai_setname(var_4, "");
  ...
  scripts\sp\maps\highway\highway_utility::player_rigenterabsolute(var_2);
  var_2 hide();
  ...
  scripts\sp\maps\highway\highway_utility::player_rigexit(var_2, 1);
  scripts\sp\maps\highway\highway_utility::player_rigenter(var_2, 0, 0, 0, 0, 0);
  var_14 = 0.5;
  ...
  scripts\sp\maps\highway\highway_utility::player_rigexit(var_2);
  thread scripts\sp\maps\highway\highway_lighting::ride_end();
}

function ride_screenshakelogic(var_0) {
...
function ride_farahmodellogic(var_0, var_1) {
  var_2 = var_1.model;
  var_1 setModel("body_hero_farah_nobraids");
  scripts\sp\maps\highway\highway_utility::animation_waittillnotetrack(var_0, "swap_farah_model");
...
function ride_spawnanimatedgateallies() {
  ...
  foreach(var_3 in var_1) {
    ...
    scripts\sp\maps\highway\highway_utility::ai_setname(var_3, "");
  }
...
function intro_start() {
  ...
  var_9 = scripts\sp\maps\highway\highway_utility::ai_getanimationfinalorigin(var_3, "ride", var_1);
  var_10 = scripts\sp\maps\highway\highway_utility::ai_getanimationfinalangles(var_3, "ride", var_1);
  var_3 delete();
...
function intro_main() {
  ...
  scripts\sp\maps\highway\highway_utility::level_objectivecreatefollowai(var_0, undefined, &"HIGHWAY/OBJECTIVE_FOLLOW_FARAH");
  ...
  var_4 = [var_2, var_3];
  scripts\sp\maps\highway\highway_utility::animation_loop(var_1, var_4, "intro_phoneIdleA");
  var_5 = intro_spawnanimatedcinderblockallies();
  var_6 = scripts\sp\maps\highway\highway_anim::intro_getcinderblockanimations();
  var_7 = [];

  for(var_8 = 0; var_8 < var_6.size; var_8++) {
    var_7 = scripts\engine\sp\utility::spawn_anim_model("intro_animatedCinderblock" + var_8);
  ...
  scripts\sp\maps\highway\highway_utility::animation_loop(var_1, var_5, "intro_cinderblockIdleA");
  scripts\sp\maps\highway\highway_utility::animation_loop(var_1, var_9, "intro_cinderblockIdleA");
  var_10 = intro_spawnanimatedstairsally();
  var_11 = scripts\sp\maps\highway\highway_anim::intro_getstairscrateanimations();
  var_12 = [];
  var_8 = 0;

  if(var_8 < var_11.size) {
    GscBinSkip0(0x2e, var_8, scripts\engine\sp\utility::spawn_anim_model("intro_animatedStairsCrate" + var_8));
  }
...
function intro_scenealogic(var_0, var_1, var_2, var_3) {
  ...
  scripts\sp\maps\highway\highway_utility::animation_waittillend(var_1);
  scripts\engine\utility::exploder("release_birds_1");
  scripts\sp\maps\highway\highway_utility::animation_single(var_0, var_1, "intro_farahSceneA");
  var_5 = ["dx_vom_far_intro_village_65", "dx_vom_far_intro_village_80"];
  var_1 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_5, 10, level, "player_nearAI", 9);
  var_6 = scripts\sp\maps\highway\highway_utility::ai_getanimationfinalorigin(var_1, "intro_farahSceneB", var_0);
  scripts\sp\maps\highway\highway_utility::player_waittillnearai(var_1, 200, var_6, undefined, undefined, 10, undefined, undefined);
  level notify(var_4);
}

function intro_sceneblogic(var_0, var_1) {
  thread intro_dialoguejokesectionblogic(var_1);
  var_2 = var_1.anglelerprate;
  var_1.anglelerprate = 20;
  scripts\sp\maps\highway\highway_utility::animation_reachtosingleintoloop(var_0, var_1, "intro_farahSceneB", "intro_farahSceneBIdle");
  var_1.anglelerprate = var_2;
  var_3 = ["dx_vom_far_intro_village_220", "dx_vom_far_intro_village_230", "dx_vom_far_intro_rooftop_110"];
  var_1 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_3, 8, level, "player_nearAI", 8, undefined, undefined, "intro_farahSceneBNag", "intro_farahSceneBIdle", var_0);
  var_4 = scripts\sp\maps\highway\highway_utility::ai_getanimationfinalorigin(var_1, "intro_farahSceneC", var_0);
  scripts\sp\maps\highway\highway_utility::player_waittillnearai(var_1, 250, var_4, undefined, undefined, 10, undefined, undefined, 128);
}

function intro_sceneclogic(var_0, var_1, var_2, var_3, var_4, var_5) {
  scripts\engine\utility::exploder("release_birds_2");
  scripts\sp\maps\highway\highway_utility::animation_stoploop(var_2);
  thread scripts\sp\maps\highway\highway_utility::animation_singleintoloop(var_0, var_2, "intro_phoneEnter", "intro_phoneIdleB");
  scripts\sp\maps\highway\highway_utility::animation_stoploop(var_3);
  scripts\sp\maps\highway\highway_utility::animation_stoploop(var_5);
  thread scripts\sp\maps\highway\highway_utility::animation_singleintolastframe(var_0, var_4, "intro_cinderblockEnter");
  thread scripts\sp\maps\highway\highway_utility::animation_singleintolastframe(var_0, var_5, "intro_cinderblockEnter");
  thread scripts\sp\maps\highway\highway_utility::animation_singleintoloop(var_0, var_3, "intro_cinderblockEnter", "intro_cinderblockIdleB");
  scripts\sp\maps\highway\highway_utility::animation_stoploop(var_1);
  scripts\sp\maps\highway\highway_utility::animation_singleintoloop(var_0, var_1, "intro_farahSceneC", "intro_farahSceneCIdle");
  var_6 = ["dx_vom_far_intro_rooftop_100"];
  var_1 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_6, 5, level, "player_nearAI", 3, undefined, undefined, "intro_farahSceneCNag", "intro_farahSceneCIdle", var_0);
  var_7 = scripts\sp\maps\highway\highway_utility::ai_getanimationfinalorigin(var_1, "roof_sceneAEnter", var_0);
  scripts\sp\maps\highway\highway_utility::player_waittillnearai(var_1, 300, var_7, undefined, undefined, 10, undefined, undefined, 128);
}

function intro_hadirscenelogic(var_0) {
  ...
  scripts\sp\maps\highway\highway_utility::animation_loop(var_0, [var_1, var_2], "intro_hadirIdle");
}
...
function intro_setupanimatedfarahscope(var_0) {
...
function intro_plankanimationscenelogic() {
  ...
  thread scripts\sp\maps\highway\highway_utility::animation_single(var_7, var_6, "intro_plankEnter");
...
function intro_plankanimationscenecratelogic(var_0) {
  level.player endon("death");
  var_0 endon("entitydeleted");
  scripts\sp\maps\highway\highway_utility::animation_waittillend(var_0);
...
function intro_stairsanimationscenelogic(var_0, var_1, var_2, var_3) {
  intro_stairsanimationwaittillscene(var_1, var_3);
  thread scripts\sp\maps\highway\highway_utility::animation_singleintoloop(var_0, var_1, "intro_stairsEnter", "intro_stairsIdle");
  thread scripts\sp\maps\highway\highway_utility::animation_singleintolastframe(var_0, var_2, "intro_stairsEnter");
}

function intro_stairsanimationwaittillscene(var_0, var_1) {
  level endon(var_1);
...
function intro_dialoguejokesectionalogic(var_0) {
  level.player endon("death");
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_intro_joke_10", 1);
  level.player scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_alx_intro_joke_20", 0.25);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_intro_joke_30", 0.4);
  level.player scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_alx_intro_joke_40", 0.25);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_intro_joke_50");
}

function intro_dialoguejokesectionblogic(var_0) {
  level.player endon("death");
  level.player scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_alx_intro_joke_60");
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_intro_joke_70");
  level.player scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_alx_intro_joke_80");
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_intro_joke_90");
}

function intro_animatedpropscleanuplogic(var_0) {
...
function roof_start() {
  ...
  scripts\sp\maps\highway\highway_utility::ai_setname(var_2, "");
  player_givesecondaryweapon();
  thread intro_playerspeedscalinglogic();
...
function roof_main() {
  ...
  var_0 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_intro_village_104", 2);
  var_0 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_intro_village_105", 4);
  scripts\sp\maps\highway\highway_utility::animation_stoploop(var_0);
  scripts\sp\maps\highway\highway_utility::animation_single(var_3, var_0, "roof_farahEnter");
...
function roof_scenealogic(var_0, var_1, var_2, var_3) {
  scripts\sp\maps\highway\highway_utility::animation_stoploop(var_2);
  var_4 = roof_gethadirclip();
  var_4 delete();
  thread scripts\sp\maps\highway\highway_utility::animation_singleintoloop(var_0, var_3, "roof_sceneAEnter", "roof_sceneAIdle");
  thread scripts\sp\maps\highway\highway_utility::animation_singleintoloop(var_0, var_1, "roof_sceneAEnter", "roof_sceneAIdle");
  scripts\sp\maps\highway\highway_utility::animation_singleintoloop(var_0, var_2, "roof_sceneAEnter", "roof_sceneAIdle");
  thread roof_sceneanaglogic(var_0, var_2, var_3);
  scripts\sp\maps\highway\highway_utility::level_deletepreviousobjective();
  var_5 = scripts\sp\maps\highway\highway_utility::level_objectivegetindex();
  scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_MEET_HADIR", var_2.origin);
  objective_onentity(var_5, var_2);
  objective_setzoffset(var_5, 72);
  scripts\sp\maps\highway\highway_utility::player_waittillnearai(var_2, 150, undefined, undefined, undefined, 10);
  objective_delete(var_5);
}

function roof_sceneanaglogic(var_0, var_1, var_2) {
  level endon("player_nearAI");

  for(;;) {
    scripts\sp\maps\highway\highway_utility::animation_stoploop([var_1, var_2]);
    childthread scripts\sp\maps\highway\highway_utility::animation_singleintoloop(var_0, var_2, "roof_sceneANag", "roof_sceneAIdle");
    var_0 scripts\common\anim::anim_single_solo(var_1, "roof_sceneANag");
    scripts\sp\maps\highway\highway_utility::animation_loop(var_0, var_1, "roof_sceneAIdle");
...
function roof_sceneblogic(var_0, var_1, var_2, var_3) {
  scripts\sp\maps\highway\highway_utility::animation_stoploop([var_1, var_2, var_3]);
  thread scripts\sp\maps\highway\highway_utility::animation_singleintoloop(var_0, var_1, "roof_sceneBEnter", "roof_sceneBIdle");
  thread scripts\sp\maps\highway\highway_utility::animation_singleintoloop(var_0, var_2, "roof_sceneBEnter", "roof_sceneBIdle");
  var_0 scripts\common\anim::anim_single_solo(var_3, "roof_sceneBEnter");
}

function roof_scenesniperlogic(var_0, var_1, var_2, var_3) {
  ...
  var_2 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_5, 10, var_4, "trigger", 10, undefined, undefined, "roof_sceneBNag", "roof_sceneBIdle", var_0);
  var_6 = ["dx_vom_far_intro_gun_90"];
  var_1 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_6, 10, var_4, "trigger", 17);
  var_7 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_GRAB_SNIPER", var_4.origin + (0, 0, 12));
...
function roof_sceneclogic(var_0, var_1, var_2) {
  var_3 = 2;
  wait var_3;
  scripts\sp\maps\highway\highway_utility::animation_stoploop(var_2);
  scripts\sp\maps\highway\highway_utility::animation_singleintoloop(var_0, var_2, "roof_sceneCEnter", "roof_sceneCIdle");
  var_2 pushplayer(1);
...
function roof_scenefarahspotlogic(var_0, var_1, var_2) {
  var_3 = 1.8;
  wait var_3;
  thread roof_scenefarahanimationlogic(var_0, var_1, var_2);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_intro_gun_70");

  if(!player_isprone()) {
    var_2 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_intro_gun_120", 0.75, level, "tutorial_goProneComplete");
    return;
  }
}

function roof_scenefarahanimationlogic(var_0, var_1, var_2) {
  setmusicstate("");
  scripts\sp\maps\highway\highway_utility::animation_stoploop(var_1);
  var_3 = intro_getanimatedfarahscope();
  thread scripts\sp\maps\highway\highway_utility::animation_singleintoloop(var_0, var_3, "roof_sceneCEnter", "roof_sceneCIdle");
  scripts\sp\maps\highway\highway_utility::animation_singleintoloop(var_0, var_1, "roof_sceneCEnter", "roof_sceneCIdle");
  var_4 = roof_getfarahclip();
  var_4 delete();
}

function roof_spawnsniperweapon(var_0, var_1) {
...
function roof_setuptutorialallies() {
  ...
  scripts\sp\maps\highway\highway_utility::ai_takecoveratnodes(var_2, var_3);
}
...
function tutorial_start() {
  ...
  var_1 = level_gettownanimationstruct();
  intro_setupanimatedfarahscope(var_1);
  scripts\sp\maps\highway\highway_utility::animation_loop(var_1, var_0, "intro_farahSceneCIdle");
...
function tutorial_main() {
  ...
  scripts\sp\maps\highway\highway_utility::ai_setname(var_0, "Farah");
  scripts\sp\maps\highway\highway_utility::ai_setname(var_1, "Hadir");
...
function tutorial_allieslogic() {
  ...
  foreach(var_2 in var_4) {
    ...
    if(isDefined(var_2.script_friendname)) {
      scripts\sp\maps\highway\highway_utility::ai_setname(var_2, var_2.script_friendname);
    }
  }
...
function tutorial_goprone(var_0) {
  var_1 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_GO_PRONE", (-547, -1740, 1204));
  var_0 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_intro_prone_10", 5, level, "tutorial_goProneComplete");
  var_2 = ["dx_vom_far_intro_prone_20", "dx_vom_far_intro_prone_30"];
  var_0 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_2, 8, level, "tutorial_goProneComplete", 15);
...
function tutorial_ads(var_0) {
  var_1 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_AIM_DOWN_SIGHTS");
  ...
  var_0 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_2, 4, level.player, "ads_pressed", 1);
  ...
  for(;;) {
    ...
    var_0 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_2, 4, level.player, "ads_pressed", 1.5);
  }
...
function tutorial_signalallylogic(var_0, var_1) {
  var_2 = tutorial_getsignalally();
  var_2 endon("death");
  var_2 attach("com_flashlight_on_xforward", "tag_accessory_left");
  scripts\sp\maps\highway\highway_utility::animation_loop(var_2, var_2, "tutorial_idle");
  GscBinSkip4(0x35, var_2);
}

function tutorial_allysignaleffectslogic(var_0) {
...
function tutorial_zoomin(var_0) {
  var_1 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_ZOOM_IN");
  var_2 = 1;
  var_0 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_zoom_10", var_2, level.player, "player_variableZoomedIn");
  ...
  var_6 = 4;
  var_6 += var_2 + var_4 * 0.001;
  var_7 = ["dx_vom_far_tutorial_zoom_40", "dx_vom_far_tutorial_zoom_30", "dx_vom_far_tutorial_zoom_50"];
  var_0 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_7, 8, level.player, "player_variableZoomedIn", var_6);
  ...
  scripts\sp\maps\highway\highway_utility::waittill_nodialogueplaying();
  scripts\sp\maps\highway\highway_utility::waittill_time(var_5);
  level.player scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_alx_tutorial_zoom_20", 1);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_zoom_21", 0.5);
  objective_delete(var_1);
}

function tutorial_alliessearch(var_0) {
  ...
  var_0 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_zoom_110");
  var_3 = tutorial_getallies();
  var_4 = tutorial_getsignalally();
  var_5 = scripts\engine\utility::array_remove(var_3, var_4);
  var_4 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_fsa1_tutorial_zoom_120", 1.5);
  var_6 = (0, 0, 0);
  ...
  var_6 += (0, 0, 300);
  var_6 /= var_5.size;
  var_10 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_FIND_ALLIES", var_6);
  var_4 notify("tutorial_allyStopSignal");
  var_0 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_fsa_10", 3.5, level.player, "tutorial_playerFoundAllies");
  scripts\sp\maps\highway\highway_utility::animation_stoploop(var_4);
  scripts\sp\maps\highway\highway_utility::animation_single(var_4, var_4, "tutorial_enter");
  ...
  var_4 scripts\sp\maps\highway\highway_utility::ai_resetstances();
  ...
  var_0 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_12, 10, level.player, "tutorial_playerFoundAllies", 20, var_13, &player_sniperzoomedin);
  ...
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_fsa_70", 0.5);
  var_17 = level.player getEye();
  var_18 = anglesToForward(level.player getplayerangles());
  var_19 = -2147483647;
  var_18 = anglesToForward(level.player getgunangles());
...
function tutorial_placetargetlogic(var_0, var_1, var_2) {
  var_3 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_KEEP_SIGHTS", var_2.origin);
...
function tutorial_placetargetdialoguelogic(var_0) {
  var_1 = level_getfarah();
  var_2 = tutorial_getfarahcommandallylines();
  var_1 scripts\sp\maps\highway\highway_utility::dialogue(var_2[var_0.script_index], 1);
  var_3 = tutorial_getallyreplylines();
  var_0 notify("tutorial_chosenAllyPlaceTarget");
  var_0 scripts\sp\maps\highway\highway_utility::dialogue(var_3[var_0.script_index], undefined, undefined, undefined, 1);
  var_1 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_target_140", 0.75);
  var_1 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_30", 5);
  var_0 waittill("goal");
  wait 4.25;
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_" + var_0.aliasname + "_tutorial_target_190", undefined, undefined, undefined, 1);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_target_210");
}
...
function tutorial_primarytargetlogic() {
  ...
  var_2 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_SHOOT_JUG", var_1, &"HIGHWAY/LABEL_SHOOT");
...
function tutorial_primarytargetaim(var_0) {
  level endon("ballistics_impact");
  tutorial_primarytargetaimgravity(var_0);
  tutorial_primarytargetaimwind(var_0);
}

function tutorial_primarytargetaimgravity(var_0) {
  var_1 = level_getfarah();
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_40", 0.5, level, "ballistics_impact");
  ...
  var_1 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_2, 7, level.player, "aimed_for_gravity_primary", 6, var_3, &player_sniperzoomedin);
  var_4 = 300;
  var_5 = 0;
...
function tutorial_primarytargetaimwind(var_0) {
  var_1 = level_getfarah();
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_target_160");
  ...
  var_2 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_2, 8, level.player, "aimed_for_wind_primary", 2.5);
  var_3 = 300;
  var_4 = 0;

  for(;;) {
    var_5 = scripts\sp\player\ballistics::ballistics_doesbullettrajectoryhitentity(level.player getEye(), level.player getplayerangles(), var_1, 1);
  ...
  var_2 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_210", 0.5, level, "ballistics_impact");
  var_6 = ["dx_vom_far_tutorial_adjust_211", "dx_vom_far_tutorial_adjust_212", "dx_vom_far_tutorial_adjust_213"];
  var_2 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_6, 7, level, "ballistics_impact", 6);
}

function tutorial_primarytargetmiss(var_0) {
  var_0 endon("ballistics_bulletDamage");
  var_1 = level_getfarah();
  var_2 = level_gethadir();
  level waittill("ballistics_impact", var_3);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_10", 0.5);
  var_2 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_tutorial_adjust_20", 1.5);
  ...
  var_2 scripts\sp\maps\highway\highway_utility::dialogue(var_4, 3.5);
}
...
function tutorial_secondaryaim(var_0) {
  ...
  var_1 = var_0.origin + (0, 0, 50);
  var_2 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_SHOOT_WATERMELON", var_1, &"HIGHWAY/LABEL_SHOOT");
  var_0 thread scripts\sp\maps\highway\highway_utility::call_on_notify_no_self("ballistics_bulletDamage", &objective_delete, var_2);
  thread tutorial_secondarytargetlookat(var_0);
}

function tutorial_secondarytargetlookat(var_0) {
  var_0 endon("ballistics_bulletDamage");
  var_1 = level_getfarah();
  var_2 = level_gethadir();
  var_1 scripts\sp\maps\highway\highway_utility::dialogue_stop();
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_350", 0.5);
  var_2 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_tutorial_jug_100", 1);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_230", 0.5);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_melon_10", 1);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_melon_20", 1);
  tutorial_secondarylookatbuilding(var_0);
  scripts\sp\maps\highway\highway_utility::waittill_nodialogueplaying();
  level.player scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_alx_tutorial_melon_60", 0.5, var_0, "ballistics_bulletDamage");
  ...
  if(!player_sniperzoomedin()) {
    ...
    var_1 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_5, var_4, level.player, "sprint_pressed", var_3);
    ...
    for(;;) {
      ...
      var_1 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_5, 3, level.player, "sprint_pressed", 0.25);
    }
  }

  scripts\sp\maps\highway\highway_utility::waittill_nodialogueplaying();
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_melon_70", 0.5, var_0, "ballistics_bulletDamage");
  var_1 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_melon_90", 1, level, "ballistics_impact");
  var_1 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_melon_91", 11, level, "ballistics_impact");
  var_1 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_melon_92", 17, level, "ballistics_impact");
  var_1 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_melon_93", 24, level, "ballistics_impact");
  GscBinSkip4(0x35, var_0);
}

function tutorial_secondarylookatbuilding(var_0) {
  var_1 = level_getfarah();
  ...
  var_1 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_3, 8, level, "tutorial_secondaryTargetLookedAt", 6);
...
function tutorial_secondarytargetmisslogic(var_0) {
  var_1 = level_getfarah();
  ...
  for(;;) {
    ...
    if(var_14) {
      if(var_13) {
        if(var_16) {
          var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_250", 1);
        } else {
          var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_260", 1);
        }
      } else {
        var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_310", 1);
      }
    ...
    if(var_15) {
      if(var_13) {
        if(var_16) {
          var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_280", 1);
        } else {
          var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_290", 1);
        }
      } else {
        var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_320", 1);
      }
    ...
    if(var_16) {
      var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_330", 1);
      continue;
    }

    if(var_17) {
      var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_340", 1);
    }
  }
}
...
function tutorial_setalliesnames() {
  ...
  var_0 = scripts\sp\maps\highway\highway_utility::array_sortbyscriptindex(var_0);
...
function scouting_main() {
  var_0 = level_getfarah();
  var_1 = level_gethadir();
  var_0 scripts\sp\maps\highway\highway_utility::dialogue_stop();
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_220", 0.5);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_tutorial_melon_100", 1);
  level.player scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_alx_tutorial_melon_110", 0.5);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_melon_150", 0.5);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_dogs_10");
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_dogs_12", 0.5);
  level.player scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_alx_tutorial_dogs_14", 0.5);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_dogs_16", 0.5);
...
function dogs_dialoguelogic(var_0) {
  level endon("ballistics_impact");
  level endon("dogs_forceRun");
  ...
  if(scripts\engine\utility::is_equal(var_7, "dogs_playerSpottedDogs")) {
    ...
    if(scripts\engine\utility::is_equal(var_7, "dogs_playerSpottedDogs")) {
      ...
      var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_dogs_60");
    }
  } else {
    var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_dogs_40");
  ...
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_dogs_20", 3.5);
}

function dogs_playerspotteddogslogic(var_0, var_1) {
  level endon("ballistics_impact");
...
function dogs_dialoguedeathlogic(var_0) {
  foreach(var_2 in var_0) {
  ...
  var_4 scripts\sp\maps\highway\highway_utility::dialogue_stop();
  var_4 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_dogs_80", 1);
  var_4 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_dogs_20", 2);
}

function dogs_dialogueplayermisslogic(var_0) {
  foreach(var_2 in var_0) {
    var_2 endon("entitydeleted");
  }
  ...
  var_4 scripts\sp\maps\highway\highway_utility::dialogue_stop();
  var_4 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_dogs_90", 1);
  var_4 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_dogs_20", 2);
}
...
function assassinate_main() {
  ...
  var_2 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_scout_combat_90", 1);
}
...
function assassinate_dialoguetruck(var_0) {
  wait 4;
  var_1 = level_getfarah();
  var_2 = tutorial_getsignalally();
  var_2 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_fsa1_scout_reveal_10", undefined, undefined, undefined, 1);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_scout_reveal_30", 0.5);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_scout_reveal_50", 0.5);
  var_3 = gettime() + 6000;
  var_4 = 0;
  ...
  if(var_4) {
    ...
    var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_scout_reveal_70", 1);
  }

  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_scout_reveal_80", 0.5);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_scout_reveal_90");
}

function assassinate_sfxlogic(var_0) {
  var_0 playSound("scn_highway_truck_incoming_dist_01");
  wait 4;
  setmusicstate("mx_highway_singlecar");
}

function assassinate_dialoguelogic(var_0, var_1, var_2) {
  level endon("assassinate_enemiesAlerted");
  GscBinSkip4(0x35, var_0);
}

function assassinate_dialogueinstructionslogic(var_0) {
  level endon("ballistics_impact");
  level.player endon("weapon_fired");
  thread assassinate_dialoguemisslogic(var_0);
  level waittill("assassinate_enemiesClimbing");
  var_1 = level_getfarah();
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_scout_watch_80", 8);
  ...
  var_1 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_3, 8, level, var_2, 6);
  var_4 = 250;
  var_5 = 0;
  ...
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_scout_watch_82", 2);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_melon_90", 2);
  var_12 = ["dx_vom_far_convoy_watch_60", "dx_vom_far_scout_watch_83", "dx_vom_far_scout_watch_100"];
  var_1 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_12, 8, level.player, "weapon_fired", 6);
}

function assassinate_dialoguemisslogic(var_0) {
  foreach(var_2 in var_0) {
    var_2 endon("death");
  }
  ...
  for(var_6 = 1;; var_6 = 0) {
    ...
    if(var_26) {
      if(var_25) {
        if(var_28) {
          var_5 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_250", 1.5);
        } else {
          var_5 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_260", 1.5);
        }
      } else {
        var_5 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_310", 1.5);
      }
    } else if(var_27) {
      if(var_25) {
        if(var_28) {
          var_5 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_280", 1.5);
        } else {
          var_5 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_290", 1.5);
        }
      } else {
        var_5 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_320", 1.5);
      }
    } else if(var_28 || var_29) {
      var_5 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_60", 1.5);
    }

    if(var_6) {
      var_4 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_convoy_bc_160", 0.5);
    }
  }
}
...
function assassinate_dialogueenemydeathslogic() {
  ...
  for(;;) {
    ...
    var_5 = scripts\sp\maps\highway\highway_utility::array_removedeaddyingorundefined(var_5);

    if(var_5.size && var_5.size < var_1.size) {
      var_6 = var_5.size == 1;

      if(var_6) {
        var_0 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_scout_combat_50", 1, level, "ballistics_impact");
      } else {
        var_0 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_backup_110", 1, level, "ballistics_impact");
      }
    } else if(!var_5.size) {
      break;
    }
...
function assassinate_enemieslogic(var_0, var_1) {
  level endon("assassinate_enemiesDead");
  scripts\sp\maps\highway\highway_utility::level_deletepreviousobjective();
  var_2 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_SCOUT_ENEMY_VEHICLE");
  objective_onentity(var_2, var_0);
  objective_setzoffset(var_2, 72);
  level thread scripts\sp\maps\highway\highway_utility::call_on_notify_no_self("assassinate_enemiesAlerted", &objective_delete, var_2);
  ...
  objective_delete(var_2);
  var_2 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_SHOOT_ENEMIES");
  objective_setzoffset(var_2, 72);
  var_1 = scripts\sp\maps\highway\highway_utility::array_removedeaddyingorundefined(var_1);
  var_7 = assassinate_getcrawlcovernodes();
  var_8 = assassinate_getanimationstruct();

  foreach(var_5 in var_1) {
    objective_setlocation(var_2, var_11, var_5);
    var_5 thread scripts\sp\maps\highway\highway_utility::call_on_notify_no_self("death", &objective_unsetlocation, var_2, var_11);
    var_8 scripts\common\anim::anim_first_frame_solo(var_5, "assassinate_enter");
    var_5 allowedstances("prone");
    scripts\sp\maps\highway\highway_utility::ai_instantlyremovefromvehicle(var_5);
    var_5 attach("equipment_binoculars_01", "tag_accessory_left", 1);
    thread assassinate_enemybinocularslogic(var_5);
    thread scripts\sp\maps\highway\highway_utility::animation_singleintoloop(var_8, var_5, "assassinate_enter", "assassinate_idle");
...
function assassinate_enemybinocularslogic(var_0) {
...
function assassinate_driverdeathlogic(var_0, var_1) {
  var_2 = undefined;
...
function assassinate_enemyreactlogic(var_0, var_1) {
  var_0 endon("death");
  var_2 = assassinate_getanimationstruct();
  var_3 = "assassinate_entered";
  thread scripts\sp\maps\highway\highway_utility::animation_notifyonnotetrack(var_0, var_3);
...
function assassinate_enemiesdeathlogic(var_0) {
  var_1 = var_0.size;

  for(var_2 = 0; var_2 < var_1; var_2++) {
    scripts\engine\utility::array_any_wait(var_0, "death");
    var_0 = scripts\sp\maps\highway\highway_utility::array_removedeaddyingorundefined(var_0);
...
function assassinate_playeralertsenemies(var_0, var_1) {
  ...
  if(var_1.size) {
    ...
    var_8 scripts\sp\maps\highway\highway_utility::dialogue_stop();
    var_8 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_scout_alert_10", 0.2);
    var_8 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_alert_10", 1.5);
  }
  ...
  scripts\sp\maps\highway\highway_utility::ai_takecoveratnodes(var_10, var_9);
...
function assassinate_spawnenemiesinvehicle(var_0) {
...
function trap_main() {
  ...
  scripts\sp\maps\highway\highway_utility::level_deletepreviousobjective();
  var_9 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_COVER_ALLIES");
  ...
  foreach(var_11 in var_5) {
    scripts\sp\maps\highway\highway_utility::ai_instantlyremovefromvehicle(var_11);
  }

  var_12 scripts\common\anim::anim_single(var_5, "trap_placeIED");
  var_16 = tutorial_getallynodes();
  scripts\sp\maps\highway\highway_utility::ai_takecoveratnodes(var_4, var_16);
  var_17 = trap_getallyexplosivesreadylines();
  objective_delete(var_9);
  var_9 = level_addmissionnarrativeobjective();
  var_0 scripts\sp\maps\highway\highway_utility::dialogue(var_17[var_0.script_index]);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_trap_set_10", 1);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_trap_set_20", 1);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_trap_set_30");
  var_13 delete();
...
function trap_converationdialoguelogic(var_0, var_1) {
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_trap_prep_ali_10", 1.5);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_trap_prep_10", 2.5);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_trap_prep_11", 1);
  level.player scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_alx_scout_convo_10", 2.5);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_scout_convo_20", 1);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_scout_convo_30");
...
function convoy_start() {
  ...
  player_givefullloadout();
  var_3 = assassinate_spawnVehicle();
  var_4 = var_3 scripts\sp\maps\highway\highway_utility::get_lastentinspline(var_3.currentnode, &getvehiclenode);
...
function convoy_main() {
  ...
  scripts\sp\maps\highway\highway_utility::level_deletepreviousobjective();
  var_6 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_SCOUT_ENEMY_CONVOY");
...
function convoy_dialoguelogic() {
  ...
  var_1 = tutorial_getsignalally();
  var_2 = level_gethadir();
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_fsa1_convoy_reveal_10");
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_reveal_20");
  level.player endon("weapon_fired");
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_reveal_30");
  var_2 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_convoy_reveal_40", 0.15);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_reveal_50", 0.25);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_" + var_1.aliasname + "_convoy_watch_10", 1);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_watch_10", 0.5);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_watch_21", 4.5);
}
...
function convoy_spawnenemiesinvehicles(var_0) {
  var_1 = [];
...
function convoy_vehicleslogic(var_0) {
  foreach(var_2 in var_0) {
...
function convoy_vehiclesunloadlogic(var_0) {
  level endon("ballistics_impact");
  ...
  var_9 = scripts\sp\maps\highway\highway_utility::array_sortbyscriptindex(var_9);
...
function convoy_unloadanimatedenemylogic(var_0) {
  level endon("ballistics_impact");
  level endon("level_iedDetonated");
  ...
  if(var_0.script_index == 0) {
    scripts\sp\maps\highway\highway_utility::animation_reachtosingle(var_1, var_0, "convoy_enter");
    ambush_triggeried();
    return;
  }
  ...
  if(var_0.script_index == 1) {
    ...
    scripts\sp\maps\highway\highway_utility::animation_singleintoloop(var_1, var_0, "convoy_enter", "convoy_idle");
    scripts\engine\utility::flag_wait("convoy_enemyCommanderReached");
    scripts\sp\maps\highway\highway_utility::animation_stoploop(var_0);
    scripts\sp\maps\highway\highway_utility::animation_singleintolastframe(var_1, var_0, "convoy_exit");
    return;
  }

  var_1 scripts\sp\anim::anim_reach_solo(var_0, "convoy_enter");
  scripts\engine\utility::flag_set("convoy_enemyCommanderReached");
  scripts\sp\maps\highway\highway_utility::animation_singleintolastframe(var_1, var_0, "convoy_enter");
}

function convoy_unloadenemylogic(var_0, var_1) {
  level endon("ballistics_impact");
  level endon("level_iedDetonated");
...
function convoy_vehiclepathlogic(var_0) {
...
function convoy_vehiclealertedspeeduplogic(var_0) {
...
function convoy_vehicledriverdeathlogic(var_0) {
  var_0 endon("reached_wait_speed");
...
function convoy_sfxlogic(var_0) {
...
function ambush_start() {
  ...
  foreach(var_6 in var_4) {
    var_7 = var_6 scripts\sp\maps\highway\highway_utility::get_lastentinspline(var_6.currentnode, &getvehiclenode);
  ...
  var_16 = scripts\sp\maps\highway\highway_utility::array_sortbyscriptindex(var_16);
...
function ambush_iedlogic() {
  ...
  scripts\sp\maps\highway\highway_utility::level_deletepreviousobjective();
  var_1 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_AMBUSH_ENEMY_CONVOY", var_0.origin);
  var_2 = var_0.origin;
...
function ambush_dialoguelogic() {
  ...
  foreach(var_4 in var_1) {
    var_2 += var_4 vehicle_getspeed();
  }

  var_6 = level_getfarah();

  if(var_0 == "level_iedDetonated") {
    var_6 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_alert_10", 1.5);
    var_6 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_attack_10", 0.5);
  } else {
    if(var_2) {
      var_6 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_scout_alert_10", 1);
      var_6 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_scout_alert_20", 1.5);
    }
...
function ambush_instructionsdialoguelogic() {
  ...
  var_0 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_watch_30", 5, level, "convoy_enemiesAtTruck");
  var_0 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_watch_31", 8, level, "convoy_enemiesAtTruck");
  var_1 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_convoy_watch_32", 9, level, "convoy_enemiesAtTruck");
  var_0 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_watch_40", 11);
  level waittill("convoy_enemiesAtTruck");
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_watch_70", 4);
  var_2 = ambush_getied();
  var_0 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_watch_50", 0.75, var_2, "detonated");
  var_3 = 0.5;
  var_4 = lookupsoundlength("dx_vom_far_convoy_watch_50") * 0.001;
  var_5 = var_3 + var_4 + 5;
  var_6 = ["dx_vom_far_convoy_watch_60", "dx_vom_far_convoy_watch_80"];
  var_0 thread scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_6, 6, var_2, "detonated", var_5);
}
...
function ambush_locationcalloutlogic() {
  ...
  for(;;) {
    ...
    var_3 = scripts\sp\maps\highway\highway_utility::ai_getaliveaiarray("axis");
      ...
      if(var_7.size) {
        foreach(var_9 in var_3) {
          ...
          if(var_9 istouching(var_5)) {
            ...
            var_0 scripts\sp\maps\highway\highway_utility::dialogue(var_10);
...
function ambush_enemyballistickillcalloutlogic() {
  ...
  for(;;) {
    var_6 = scripts\sp\maps\highway\highway_utility::ai_getaliveaiarray("axis");
    var_7 = scripts\sp\maps\highway\highway_utility::array_waittill_ballisticdeath(var_6);
    ...
    var_9 = var_3[var_8];
    var_10 = var_4[var_8];
    var_10 scripts\sp\maps\highway\highway_utility::dialogue(var_9, 0.5);
...
function ambush_enemybarrelkillcalloutlogic() {
  ...
  for(var_3 = 0;; var_3 = scripts\engine\math::wrap(0, var_1.size - 1, var_3 + 1)) {
    ...
    var_6 = var_1[var_3];
    var_7 = var_2[var_3];
    var_7 thread scripts\sp\maps\highway\highway_utility::dialogue(var_1[var_3], 2);
  }
}

function ambush_getvolumelines(var_0) {
...
function ambush_allieslogic() {
  ...
  scripts\sp\maps\highway\highway_utility::ai_takecoveratnodes(var_0, var_4);
}
...
function ambush_enemieslogic() {
  ...
  var_0 = scripts\sp\maps\highway\highway_utility::ai_getaliveaiarray("axis");
  ...
  foreach(var_3 in var_0) {
    ...
    var_6 = scripts\sp\maps\highway\highway_utility::math_getchance(85) && !isDefined(var_3.ridingvehicle);
...
function ambush_enemylogic(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(var_3)) {
    ...
    var_0 scripts\sp\maps\highway\highway_utility::ai_waittillinstance(var_3);
  }
...
function fallback_start() {
  ...
  foreach(var_5 in var_3) {
    var_6 = var_5 scripts\sp\maps\highway\highway_utility::get_lastentinspline(var_5.currentnode, &getvehiclenode);
...
function fallback_enemieslogic() {
  ...
  foreach(var_3 in var_0) {
    ...
    if(!scripts\sp\maps\highway\highway_utility::ai_isalive(var_3)) {
      continue;
    }

    var_3 scripts\sp\maps\highway\highway_utility::ai_resetstances();
...
function reinforcements_start() {
  ...
  foreach(var_12 in var_10) {
    var_8 = var_12 scripts\sp\maps\highway\highway_utility::get_lastentinspline(var_12.currentnode, &getvehiclenode);
...
function reinforcements_main() {
  ...
  var_4 = scripts\sp\maps\highway\highway_utility::ai_getaliveaiarray("axis");
...
function reinforcements_dialoguelogic(var_0) {
  thread reinforcements_vehiclesdisableddialoguelogic();
  thread reinforcements_vehiclesunloadedlogic(var_0);
  var_1 = level_getfarah();
  var_2 = level_gethadir();
  var_1 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_backup_21", 3);
  scripts\engine\utility::array_wait(var_0, "stopped_path");
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_backup_23", 3);
  var_3 = tutorial_getsignalally();
  var_2 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_convoy_backup_24");
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_backup_25");
  var_2 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_convoy_backup_ali_10", 2);
  level endon("vehicle_techoDisable");
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_backup_90", 2);
  var_2 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_convoy_backup_70", 2);
}
...
function reinforcements_vehiclesdisableddialoguelogic() {
  ...
  for(var_2 = 0;; var_2 = scripts\engine\math::wrap(0, var_1.size - 1, var_2 + 1)) {
    level waittill("vehicle_techoDisable");
    var_0 thread scripts\sp\maps\highway\highway_utility::dialogue(var_1[var_2], 1);
  }
}

function reinforcements_vehiclesunloadedlogic(var_0) {
  scripts\engine\utility::array_wait(var_0, "unloading");
  var_1 = level_gethadir();
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_convoy_backup_140", 3);
}

function reinforcements_allieslogic(var_0) {
  ...
  scripts\sp\maps\highway\highway_utility::animation_stoploop(var_7);
...
function reinforcements_vehicleslogic(var_0, var_1) {
  scripts\engine\utility::array_wait(var_0, "spawnedRiders");
  scripts\sp\maps\highway\highway_utility::level_deletepreviousobjective();
  var_2 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_DISABLE_VEHICLES");
  objective_setzoffset(var_2, 100);
  var_3 = [];

  foreach(var_5 in var_0) {
    objective_setlocation(var_2, var_6, var_5);
    var_5 thread scripts\sp\maps\highway\highway_utility::call_on_notify_no_self("vehicle_disabled", &objective_unsetlocation, var_2, var_6);
  ...
  foreach(var_5 in var_0) {
    if(var_1) {
      ...
      var_12 = var_5 scripts\sp\maps\highway\highway_utility::get_lastentinspline(var_5.currentnode, &getvehiclenode);
  ...
  if(!var_1) {
    ...
    var_14 = scripts\sp\maps\highway\highway_utility::ai_getaliveaiarray("axis");
...
function reinforcements_vehiclessfxlogic(var_0) {
...
function reinforcements_vehicledoorsfxlogic(var_0) {
  var_0 waittill("reached_wait_speed");
  var_0 playSound("scn_highway_truck_doors_open");
}

function reinforcements_driverdeathlogic(var_0, var_1) {
  ...
  var_3 = level_getfarah();
  var_3 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_convoy_backup_64", 1);
}

function reinforcements_vehiclesstoppedautosave(var_0) {
  var_1 = [];
...
function reinforcements_cleanupenemieslogic(var_0) {
  ...
  foreach(var_5 in var_3) {
    ...
    var_6 = scripts\sp\maps\highway\highway_utility::ai_getaliveaiarray("allies");
...
function assault_enemymagicmolotovgrenadelogic() {
  ...
  var_2 = scripts\engine\utility::random(scripts\sp\maps\highway\highway_utility::ai_getaliveaiarray("axis"));
  ...
  var_3 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_cbc_had_inform_incoming_molotov");
  var_3 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_cbc_had_order_move_combat", 0.5);
  wait var_1;
...
function mortars_main() {
  ...
  scripts\sp\maps\highway\highway_utility::level_deletepreviousobjective();
  var_0 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_ELIMINATE_MORTARS");
...
function mortars_farahdialoguehints() {
  ...
  var_0 = level_getfarah();
  var_1 = level_gethadir();
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_mortar_reveal_10", 2);
  ...
  if(!level.player hasweapon(var_2)) {
    ...
    var_5 = 2;
    var_6 = 4;
    var_7 = scripts\sp\maps\highway\highway_utility::level_objectivegetindex();
    var_8 = player_getdroppedsniper();
    scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_GRAB_SNIPER", var_8.origin, &"HIGHWAY/LABEL_GRAB_SNIPER");
    objective_onentity(var_7, var_8);
    objective_setzoffset(var_7, 10);
    wait var_5;

    while(!level.player hasweapon(var_2)) {
      var_0 scripts\sp\maps\highway\highway_utility::dialogue(var_3[var_4]);
  ...
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_mortar_reveal_41", 0.5);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_mortar_reveal_90", 2);
...
function mortars_dialoguewarningslogic() {
  ...
  for(;;) {
    ...
    var_6 = var_3[var_5];
    var_7 = var_4[var_5];
    var_7 scripts\sp\maps\highway\highway_utility::dialogue(var_6);
  }
}
  ...
  for(var_9 = 0; var_9 < 3; var_9++) {
    ...
    if(!var_7) {
      if(var_10) {
        ...
        var_0 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_tutorial_adjust_342", 12, level, "mortars_crewSpotted");
        var_11 = ["dx_vom_far_mortar_team3_40", "dx_vom_far_mortar_team3_50", "dx_vom_far_mortar_team3_60"];
        var_0 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_11, 8, level, "mortars_crewSpotted", 13);
      }
    ...
    var_7 = 0;
    level.player thread scripts\sp\maps\highway\highway_utility::dialogue(var_4[var_8], 1);
    var_11 = ["dx_vom_far_mortar_team2_80", "dx_vom_far_mortar_team2_90", "dx_vom_far_mortar_team2_100"];
    var_0 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_11, 8, level, "mortars_crewDisabled", 6);
    level waittill("mortars_crewDisabled");
    var_12 = var_3[var_8];
    var_13 = var_2[var_8];
    var_12 thread scripts\sp\maps\highway\highway_utility::dialogue(var_13, 1.5);
    ...
    var_15 = var_6[var_8];
    var_16 = var_5[var_8];
    var_15 thread scripts\sp\maps\highway\highway_utility::dialogue(var_16, 2);
    var_8 = scripts\engine\math::wrap(0, var_2.size - 1, var_8 + 1);
  }
}

function mortars_modellogic(var_0, var_1, var_2) {
...
function mortars_playerspottedlogic(var_0) {
  for(;;) {
...
function mortars_enemieslogic(var_0, var_1, var_2) {
  ...
  foreach(var_6 in var_4) {
    scripts\sp\maps\highway\highway_utility::animation_stoploop(var_6);
...
function mortars_enemyreactlogic(var_0, var_1) {
  scripts\sp\maps\highway\highway_utility::animation_stoploop(var_1);
...
function mortars_enemiesanimationlogic(var_0, var_1, var_2, var_3) {
  var_0 endon("mortars_stop");
  var_4 = scripts\engine\utility::array_combine(var_1, [var_2], [var_0]);
  childthread scripts\sp\maps\highway\highway_utility::animation_loop(var_0, var_4, "mortars_idle");
  ...
  for(;;) {
    ...
    foreach(var_8 in var_1) {
      level.scr_goaltime["mortar_ai" + var_8.script_index]["mortars_idle"] = 0;
    }

    childthread scripts\sp\maps\highway\highway_utility::animation_singleintoloop(var_0, var_4, "mortars_fire", "mortars_idle");
...
function mortars_enemieswaittillalerted(var_0, var_1) {
  var_0 endon("mortars_stop");
...
function mortars_firemortarprojectile(var_0, var_1) {
  ...
  var_4 += scripts\engine\utility::randomvector(300);
  var_4 += (0, 0, 512);
...
function mortars_explodemortarprojectile(var_0, var_1, var_2) {
  var_3 = var_0.origin;
  var_0 delete();
  ...
  if(var_1) {
    ...
    physicsexplosionsphere(var_4, 512, 256, 150);
    earthquake(var_4, 1.25, var_4, 50000);
    playrumbleonposition("damage_heavy", var_4);
    thread mortars_explodemortarsfx(var_4);
  }

  playFX(level._effect["vfx_mortar_impact"], var_4);
  scripts\engine\utility::exploder("vfx_dust_interior");
  var_3 notify("mortars_impact", var_4);
  level notify("mortars_impact", var_4);
}

function mortars_mortarinairflaglogic(var_0) {
  level endon("mortars_fire");
...
function mortars_explodemortarsfx(var_0) {
...
function suicide_main() {
  ...
  scripts\sp\maps\highway\highway_utility::level_deletepreviousobjective();
  var_1 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_STOP_SUICIDE_TRUCK");
  ...
  var_2 = scripts\sp\maps\highway\highway_utility::ai_getaliveaiarray("allies");
  ...
  var_8 = level_getfarah();
  var_8 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_svbied_truck_120", 2);
...
function suicide_playersawvehiclelogic(var_0) {
  level.player endon("death");
  var_1 = gettime() + 5000;
...
function suicide_dialoguelogic(var_0) {
  level.player endon("death");
  ...
  var_1 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_svbied_truck_10", 1, var_0, "vehicle_disabled");
  var_1 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_svbied_truck_30", 7, var_0, "vehicle_disabled");
  var_1 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_svbied_truck_40", 12, var_0, "vehicle_disabled");
  var_1 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_svbied_truck_90", 18, var_0, "vehicle_disabled");
  var_2 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_svbied_truck_60", 22, var_0, "vehicle_disabled");
  var_2 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_svbied_truck_100", 27, var_0, "vehicle_disabled");
}

function suicide_dialoguehintslogic(var_0) {
  var_0 endon("vehicle_disabled");
  var_1 = level_getfarah();
  level waittill("vehicle_suicideTruckArmorBreak");
  var_1 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_svbied_truck_70", 0.5);
}
...
function restock_start() {
  ...
  level_openbunkerouterdoor();
  level_spawnredshirts();
  var_0 = scripts\sp\maps\highway\highway_utility::ai_getaliveaiarray("allies");
...
function restock_dialoguelogic() {
  ...
  var_0 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_2, 10, level, "restock_playerAtBunker", 30);
  ...
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_resupply_ieds_10");
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_resupply_ieds_20");
}

function restock_dialoguesectionalogic(var_0, var_1) {
  level endon("restock_playerLeftBunker");
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_mines_setup_10");
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_mines_setup_20", 0.5);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_mines_setup_30", 0.5);
}
...
function restock_allieslogic() {
  ...
  thread restock_plantingallylogic(var_1, var_2, var_3, 7, "restock_hadirIED");
  var_0 = 3;
  wait var_0;
  var_4 = level_getfarah();
  ...
  thread restock_plantingallylogic(var_4, var_5, var_6, 0, "restock_farahIED");
}

function restock_plantingallylogic(var_0, var_1, var_2, var_3, var_4) {
  ...
  if(istrue(var_3)) {
    scripts\sp\maps\highway\highway_utility::animation_stoploop(var_0);
    scripts\sp\maps\highway\highway_utility::animation_loop(var_1, var_0, "restock_idle");
    wait var_3;
  }
...
function restock_allyplace(var_0, var_1, var_2) {
  var_0 endon("death");
  var_0 endon("entitydeleted");
  level endon("restock_playerLeftBunker");
  thread scripts\sp\maps\highway\highway_utility::animation_reach(var_1, var_0, "restock_enter");
  ...
  scripts\sp\maps\highway\highway_utility::animation_single(var_1, [var_0, var_4], "restock_enter");
...
function restock_playerlogic() {
  var_0 = scripts\sp\maps\highway\highway_utility::level_objectivegetindex();
  ...
  if(!level.player hasweapon(var_2)) {
    ...
    var_4 = level_getfarah();
    var_4 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_3, 8, level, "restock_playerLeftBunker", 2);
    var_0 = scripts\sp\maps\highway\highway_utility::level_objectivegetindex();
    var_5 = player_getdroppedsniper();
    scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_GRAB_SNIPER", var_5.origin, &"HIGHWAY/LABEL_GRAB_SNIPER");
...
function restock_preplaceied(var_0, var_1) {
...
function restock_replacediedlogic(var_0, var_1, var_2, var_3) {
  var_4 = var_0.origin;
  var_0 waittill("detonated");
...
function restock_setupradioally() {
  ...
  var_1 = level_gettownanimationstruct();
  thread scripts\sp\maps\highway\highway_utility::animation_reachtoidle(var_1, var_0, "radio_allyEnterIdle");
}
...
function radio_main() {
  ...
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_sniper_radio_10");
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_sniper_radio_20");
  ...
  var_1 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_3, 13, level, "radio_playerNearAI", 13);
  ...
  var_6 = scripts\sp\maps\highway\highway_utility::level_objectivegetindex();
  scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_CONTACT_CAPTAIN_PRICE", var_5, &"HIGHWAY/LABEL_RADIO");
  ...
  scripts\sp\maps\highway\highway_utility::animation_stoploop(var_2);
  thread scripts\sp\maps\highway\highway_utility::animation_singleintoloop(var_7, var_2, "radio_allyEnter", "radio_allyIdle");
  var_2 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_fsa1_sniper_radio_55");
  ...
  var_9 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_pri_sniper_radio_70", 0.2);
  level.player thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_alx_sniper_combat_15", 6);
  var_9 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_pri_sniper_combat_20", 8.5);
  ...
  var_14 = scripts\sp\maps\highway\highway_utility::ai_getaliveaiarray("allies");
  ...
  scripts\sp\maps\highway\highway_utility::ai_takecoveratnodes(var_14, var_18);
  wait 0.15;
  level.player scripts\engine\sp\utility::set_player_demeanor("normal");
...
function radio_radioallysurvivedlogic(var_0) {
  var_0 endon("death");
  var_0 scripts\engine\sp\utility::set_goalRadius(4);
  var_1 = radio_getradioallynode();
  var_0 setgoalnode(var_1);
  var_0 waittill("goal");
  var_0 scripts\sp\maps\highway\highway_utility::ai_resetstances();
}
...
function radio_spawnradioally() {
  ...
  scripts\sp\maps\highway\highway_utility::ai_attachhead(var_1, "head_sc_m_ahmadzai_civ");
...
function radio_waittillplayernearradio(var_0, var_1, var_2) {
  var_3 = var_1 * var_1;
...
function sniper_main() {
  ...
  var_0 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_ELIMINATE_ENEMY_SNIPER");
...
function sniper_postdeathlogic(var_0) {
  setmusicstate("");
  level.player scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_alx_sniper_relocate_60", 1);
  var_1 = level_getfarah();
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_sniper_kill_10", 1);
  objective_delete(var_0);
}
...
function sniper_windshiftlogic(var_0) {
  if(istrue(var_0)) {
    wait var_0;
  }
...
function sniper_dialoguelogic(var_0) {
  var_0 endon("death");
  level.player endon("death");
  var_1 = level_getfarah();
  var_2 = level_gethadir();
...
function sniper_dialoguesightedlogic(var_0) {
  var_1 = 0;
  var_2 = 500;
...
function sniper_dialogueintrologic() {
  var_0 = level_getfarah();
  var_1 = level_gethadir();
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_sniper_combat_10", 1.5);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_sniper_combat_40", 0.75);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_sniper_combat_42", 1);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_sniper_combat_50", 4);
}
...
function sniper_dialoguerelocatelogic() {
  ...
  var_0 = level_getfarah();
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_sniper_wind_40", 1);

  if(level.ballistics.winddirectionaimstring == "left") {
    var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_sniper_wind_80");
  } else {
    var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_sniper_wind_60");
  }
...
function sniper_enemylogic(var_0) {
...
function sniper_enemyglinton(var_0) {
...
function sniper_combatlogic(var_0, var_1) {
  var_0 endon("death");
  level.player endon("death");
  GscBinSkip4(0x35, var_0);
}

function sniper_playerscreenbloodeffectlogic(var_0) {
  var_1 = 130;
  ...
  level.player thread scripts\sp\player::damagebloodoverlaydirectional(var_0, "MOD_RIFLE_BULLET", 8);
}

function sniper_playerlookingatenemy(var_0) {
  var_1 = anglesToForward(level.player getplayerangles());
...
function sniper_enemyrelocate(var_0, var_1, var_2) {
  var_3 = var_2.origin - var_1.origin;
  scripts\engine\utility::flag_set("sniper_enemyRelocating", var_3);
  var_0 allowedstances("prone");
  var_0 scripts\sp\maps\highway\highway_utility::ai_waittillinstance("prone");
  var_0 scripts\engine\sp\utility::set_goalRadius(4);
  scripts\sp\maps\highway\highway_utility::ai_movealongpath(var_0, var_2);
  var_4 = 0.5;
  wait var_4;
...
function sniper_enemyspottedlogic(var_0) {
  var_1 = 2000;
  var_2 = squared(var_1);
...
function sniper_enemytargetentitylogic(var_0) {
...
function sniper_killplayerlogic(var_0) {
  var_1 = 20;
  var_2 = 28;
  var_3 = -9;
  var_4 = -13;
...
function sniper_fireshot(var_0, var_1) {
  if(isai(var_0)) {
  ...
  playFX(level._effect["vfx_sniper_dust_kickup"], var_2.origin);
  ...
  while(var_6 < 1) {
    var_8 = var_4.origin;
    var_4.origin = scripts\engine\math::get_point_on_parabola(var_2, var_3, 50, var_6);
  ...
  var_4.origin = var_3;
  scripts\engine\utility::delaythread(0.25, &scripts\engine\utility::play_sound_in_space, "sniper_impact_crack_highway", var_3);
  level notify("sniper_bulletImpact");
  physicsexplosionsphere(var_3, 90, 90, 150);
  earthquake(0.15, 0.7, level.player.origin, 9999);
  playrumbleonposition("damage_heavy", level.player.origin);
  var_9 = distance(var_2, var_3);
  var_10 = var_9 / 1.5;
  var_11 = var_3 + var_7 * var_10 * 2;
  var_4 moveTo(var_11, 2);
  var_4 scripts\engine\utility::delaycall(2, &delete);
}
...
function squad_allieslogic() {
  ...
  foreach(var_2 in var_0) {
    var_2 scripts\sp\maps\highway\highway_utility::ai_resetstances();
  }
}
...
function squad_dialoguelogic() {
  ...
  var_0 = level_getfarah();
  var_1 = level_gethadir();
  var_1 childthread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_russian_jets_10", 4, level, "mortars_impact");
  var_0 childthread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_russian_jets_30", 7);
  level waittill("mortars_impact");
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_mortar_team3_20", 4);
}
...
function jets_sfxlogic(var_0, var_1, var_2) {
  if(!isDefined(var_1)) {
    return;
  }
...
function jets_dialoguelogic() {
  ...
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_russian_jets_40", 5);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_russian_jets_41");
  level.player scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_alx_russian_jets_45", 1);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_russian_jets_50", 6.5);
}
...
function jets_spawnVehicle(var_0) {
  var_1 = var_0 scripts\common\utility::spawn_vehicle();
  var_1 scripts\common\vehicle::godon();
  return var_1;
}

function jets_vehiclelogic(var_0) {
  thread scripts\common\vehicle_paths::gopath(var_0);
...
function armor_main() {
  ...
  var_5 = level_getfarah();
  var_5 scripts\sp\maps\highway\highway_utility::ai_resetstances();
...
function armor_objectivelogic(var_0) {
  var_1 = [level];
  ...
  var_3 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_STOP_RUSSIAN_ASSAULT");

  foreach(var_5 in var_0) {
    objective_setlocation(var_3, var_6, var_5);
    objective_setzoffset(var_3, 125);
    var_5 thread scripts\sp\maps\highway\highway_utility::call_on_notify_no_self("vehicle_tireBreak", &objective_unsetlocation, var_3, var_6);
  }
}

function armor_vehiclesstoppedautosave(var_0) {
  scripts\engine\utility::array_wait(var_0, "reached_wait_speed");
  scripts\engine\sp\utility::autosave_by_name_silent("armor_vehiclesStopped");
}

function armor_vehicleenemieslogic(var_0) {
  scripts\engine\utility::array_wait(var_0, "reached_wait_speed");
  var_1 = [];
...
function armor_audiologic(var_0) {
  wait 8;
...
function armor_vehicletireaudiologic(var_0) {
...
function armor_vehiclelogic(var_0, var_1) {
  if(var_1) {
    var_2 = var_0 scripts\sp\maps\highway\highway_utility::get_lastentinspline(var_0.currentnode, &getvehiclenode);
...
function armor_vehiclespottedlogic(var_0) {
...
function armor_vehiclespottedspeedlogic(var_0) {
  var_0 endon("reached_end_node");
  var_0 endon("vehicle_disabled");
...
function armor_clearvehiclessmokegrenades(var_0) {
...
function armor_dialoguelogic(var_0) {
  level endon("vehicle_tireBreak");
  level endon("vehicle_vindiaReachedEndNode");
  var_1 = level_getfarah();
  var_2 = level_gethadir();
  thread armor_dialogicfeedbacklogic();
  var_2 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_russian_apcs_90", 10, level, "armor_playerSpottedVehicle");
  var_1 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_russian_apcs_10", 21, level, "armor_playerSpottedVehicle");
  var_1 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_russian_apcs_45", 33, level, "armor_playerSpottedVehicle");
  level waittill("armor_playerSpottedVehicle");
  var_2 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_russian_apcs_22", 1, level, "ballistics_impact");
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_russian_apcs_50", 10);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_russian_apcs_70", 4);
}
...
function armor_dialogicfeedbacklogic() {
  ...
  for(;;) {
    ...
    if(var_17 == "vehicle_vindiaBodyShot" && !var_15) {
      var_3[var_5] thread scripts\sp\maps\highway\highway_utility::dialogue(var_2[var_5], var_4);
    ...
    if(var_17 == "vehicle_tireBreak") {
      ...
      if(var_11 == var_18) {
        var_7[var_9] thread scripts\sp\maps\highway\highway_utility::dialogue(var_6[var_9], var_8);
    ...
    if(var_17 == "vehicle_vindiaSmokeGrenade" && var_12.size) {
      var_19 = var_12[0];
      var_1 thread scripts\sp\maps\highway\highway_utility::dialogue(var_19, 4);
      var_12 = scripts\engine\utility::array_remove(var_12, var_19);
    }
  }
}

function armor_notifylevelonvehicleendpath(var_0) {
...
function russians_enemyinfinitespawninglogic(var_0) {
...
function russians_setenemygoalcount(var_0) {
...
function russians_infiniteenemylogic(var_0, var_1) {
  var_0 endon("death");
...
function russians_playerkillcounterlogic() {
  level.player endon("death");
  var_0 = 0;
  var_1 = scripts\sp\maps\highway\highway_utility::ai_getaliveaiarray("axis");
  var_2 = 0;
...
function russians_playerkillcounterworthy(var_0) {
...
function cover_main() {
  ...
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_russian_combat_10");
  level.player scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_alx_russian_combat_20", 0.5);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_cbc_had_inform_incoming_flashbang", 0.5);
  scripts\sp\maps\highway\highway_utility::player_waittillmaxhealth();
  ...
  var_2 = scripts\sp\maps\highway\highway_utility::ai_getaliveaiarray("axis");
  ...
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_russian_combat_41", 1, undefined, undefined, 0);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_gas_truck_20", 0.5);
  var_0 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_gas_truck_140", 0.25);
  var_0 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_gas_truck_150", 0.2);
  wait 2;
  ...
  scripts\sp\maps\highway\highway_utility::level_deletepreviousobjective();
  var_8 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_HELP_HADIR", var_7.origin + (0, 0, 5), &"HIGHWAY/LABEL_HELP");
  ...
  var_0 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_10, 10, level, "russians_stopSpawning", 9);
  var_11 = 40000;
  ...
  var_0 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_gas_tailgate_10", 1.5, var_7, "trigger");
  var_0 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_gas_tailgate_20", 5.5, var_7, "trigger");
  var_10 = ["dx_vom_had_gas_tailgate_30", "dx_vom_had_gas_tailgate_40", "dx_vom_had_gas_tailgate_50"];
  var_0 scripts\sp\maps\highway\highway_utility::dialogue_naglogic(var_10, 10, var_7, "trigger", 9);
  thread scripts\sp\player::focus_display_hint(2, undefined, var_7, "trigger");
...
function crash_dialoguelogic() {
  ...
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_gas_tailgate_80");
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_gas_tailgate_100", 0.5);
}

function crash_playeranimationlogic(var_0) {
...
function crash_hadiranimationlogic(var_0) {
  var_1 = level_gethadir();
...
function gas_dyingailogic(var_0) {
  ...
  thread scripts\sp\maps\highway\highway_utility::animation_singleintolastframe(var_9, var_10, "gas_dying");
...
function gas_dyingaidamagelogic(var_0) {
...
function gas_explosionsfxlogic(var_0) {
  var_1 = spawn("script_origin", var_0 + (0, 0, 1));
  var_1 playexplosionsound("scn_highway_gas_truck_exp", "exp");
  scripts\engine\utility::delaythread(2, &scripts\engine\utility::play_sound_in_space, "scn_highway_gas_truck_gas_leak", var_0);
  wait 10;
  var_1 delete();
}
...
function gas_killai() {
  ...
  foreach(var_4 in var_2) {
    ...
    if(isDefined(var_4.weapon) && !scripts\sp\maps\highway\highway_utility::weapon_empty(var_4.weapon)) {
...
function gas_playerexposedlogic() {
  ...
  for(;;) {
    ...
    if(var_26 >= var_25) {
      ...
      var_15 = scripts\engine\utility::array_remove(var_15, var_29);
      var_23 = scripts\engine\math::factor_value(var_18, var_20, var_22);
      var_24 = scripts\engine\math::factor_value(var_19, var_21, var_22);
      var_25 = randomfloatrange(var_23, var_24);
      var_30 = lookupsoundlength(var_29);
      var_25 += max(var_28, var_30);
      var_26 = gettime() + var_25;
    }
...
function gas_playerexposedblackoverlaylogic(var_0, var_1) {
  level.player endon("death");
  level endon("gas_playerPassedOutEnd");
  var_2 = gettime();
  var_3 = var_2 + 22000;
...
function gas_dialoguelogic() {
  var_0 = level_getfarah();
  var_1 = level_gethadir();
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_gas_truck_60", 6.5);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_gas_truck_65", 0.5);
  var_0 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_gas_truck_70", 0.5);
  var_1 scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_had_gas_truck_72", 0.5);
}
...
function drag_main() {
  ...
  thread scripts\sp\maps\highway\highway_utility::player_rigenter(var_6, 0, 0, 0, 0, 0);
  ...
  setblur(0, 0);
  scripts\sp\maps\highway\highway_utility::player_rigexit(var_6);
  var_7 scripts\engine\sp\utility::anim_stopanimScripted();
  var_7 linktoplayerview(level.player, "tag_camera", (0, 0, 0), (0, 0, 0), 1);
}

function drag_playergasmaskoverlaylogic(var_0) {
  scripts\sp\maps\highway\highway_utility::animation_waittillnotetrack(var_0, "drag_overlay");
...
function drag_playerblackoverlaylogic(var_0) {
  level endon("drag_end");
  var_1 = 2;
  wait var_1;
  var_2 = 0.5;
...
function bunker_outrologic() {
  ...
  scripts\sp\maps\highway\highway_utility::ai_attachhead(var_0, "head_hero_farah_gasmask");
  ...
  thread scripts\sp\maps\highway\highway_utility::player_rigenter(var_2, 0, 0, 0, 0, 0);
  var_4 = 2;
  ...
  var_0 scripts\engine\sp\utility::anim_stopanimScripted();
  scripts\sp\maps\highway\highway_utility::animation_stoploop(var_0);
  thread scripts\sp\maps\highway\highway_utility::animation_singleintolastframe(var_3, var_2, "bunker_sceneBEnter");
  thread scripts\sp\maps\highway\highway_utility::animation_singleintolastframe(var_3, var_0, "bunker_sceneBEnter");
  thread scripts\sp\maps\highway\highway_utility::animation_singleintolastframe(var_3, var_1, "bunker_sceneBEnter");
...
function player_ontownrooftop(var_0) {
  var_1 = player_gettouchingtownrooftoptrigger(var_0);
  return isDefined(var_1);
}

function player_gettouchingtownrooftoptrigger(var_0) {
...
function player_putgasmaskon(var_0) {
...
function player_getflag(var_0) {
  return level.player.flags &var_0;
}

function player_setflag(var_0, var_1) {
  if(var_1) {
    level.player.flags |= var_0;
    return;
  }
...
function player_dropballisticsweaponinteractlogic(var_0, var_1) {
  var_0 endon("entitydeleted");
  ...
  if(scripts\sp\maps\highway\highway_utility::weapon_empty(var_4)) {
...
function vehicle_spawnsuicidetruck(var_0, var_1) {
...
function vehicle_suicidetrucklogic(var_0) {
  var_0 endon("vehicle_disabled");
...
function vehicle_suicidetruckcrashlogic(var_0) {
  var_0 endon("reached_end_node");
...
function vehicle_suicidetruckexplodeoncrashpathend(var_0) {
  var_0 waittill("reached_end_node");
  vehicle_suicidetruckexplode(var_0, 0);
}

function vehicle_suicidetruckengineblocklogic(var_0) {
  ...
  var_4 += anglesToForward(var_0.angles) * var_2;
  var_4 += anglestoup(var_0.angles) * var_3;
...
function vehicle_suicidetruckarmorlogic(var_0, var_1) {
  var_1 endon("reached_end_node");
  var_0 endon("death");
...
function vehicle_suicidetrucklaunchmesh(var_0, var_1) {
  var_1 unlink();
...
function vehicle_suicidetruckriderslogic(var_0) {
  var_0 endon("reached_end_node");
  ...
  var_6 += anglesToForward(var_7) * var_4;
  var_6 += anglestoup(var_7) * var_5;
  ...
  thread scripts\sp\maps\highway\highway_utility::animation_loop(var_8, var_2, "suicide_driverIdle");
  ...
  var_11 += anglesToForward(var_12) * var_9;
  var_11 += anglestoup(var_12) * var_10;
  ...
  thread scripts\sp\maps\highway\highway_utility::animation_singleintolastframe(var_8, var_2, "suicide_driverDeath");
  scripts\sp\utility::giveachievement_wrapper("driversed");
}

function vehicle_suicidetruckdriverandanimationcleanup(var_0, var_1, var_2) {
...
function vehicle_suicidetruckrunoverlogic(var_0) {
  var_0 endon("reached_end_node");
  var_0 endon("vehicle_disabled");
...
function vehicle_suicidetruckexplode(var_0, var_1) {
  var_2 = var_0.origin;
  ...
  var_16 = scripts\engine\math::factor_value(3, 4, var_13);
  ...
  if(var_1) {
    ...
    var_17 thread scripts\sp\maps\highway\highway_utility::dialogue("dx_vom_far_svbied_truck_110");
    level.player kill();
    wait 1;
...
function vehicle_suicidetrucksfxlogic(var_0) {
...
function vehicle_vindiameshanimdrivecleanuplogic(var_0) {
  var_0 waittill("reached_wait_speed");
  var_1 = level.vehicle.templates.driveidle[var_0.model];
  var_0.mesh clearanim(var_1, 0);
}

function vehicle_vindiameshanimunloadlogic(var_0) {
...
function vehicle_vindiatirelogic(var_0, var_1) {
  ...
  var_5 linkTo(var_2, var_4, var_4, var_5);
  var_3 solid();
  var_3 waittill("ballistics_bulletDamage", var_6);
  var_5 setModel("veh8_mil_lnd_vindia_wheel_01_dst");
  playFX(level._effect["vfx_vindia_tire_break"], var_3.origin, anglesToForward(var_3.angles));
  thread scripts\engine\utility::play_sound_in_space("scn_highway_apc_tires_expl", var_3.origin);
  var_2.mesh clearanim(%hod_vehicle_hit_l_apc, 0);
  var_2.mesh clearanim(%hod_vehicle_hit_r_apc, 0);

  if(var_2 scripts\engine\math::is_point_on_right(var_6)) {
    var_2.mesh setanim(%hod_vehicle_hit_l_apc);
  } else {
    var_2.mesh setanim(%hod_vehicle_hit_r_apc);
  }

  playFXOnTag(level._effect["vfx_vindia_tire_sparks"], var_2.mesh, var_4);
  var_7 = 1.33333;
  var_8 = 1.33333;
  var_9 = 2;
  ...
  for(var_10 = 0; var_10 < 3; var_10++) {
    var_2.mesh unlink();
    var_11 = anglestoup(var_2.mesh.angles);
    var_2.mesh.origin -= var_11 * var_7;
    var_12 = anglesToForward(var_2.mesh.angles);
    var_13 = anglestoright(var_2.mesh.angles);
    var_14 = vectorNormalize(var_3.origin - var_2.origin);
    ...
    var_19 = var_17 * var_8;
    var_20 = var_18 * var_9;
    var_2.mesh.angles += (var_19, 0, var_20);
    var_2.mesh linkTo(var_2);
    waitframe();
  }

  var_2 notify("vehicle_tireBreak", var_6);
  level notify("vehicle_tireBreak", var_2);
  var_3 delete();
  var_2 scripts\engine\utility::waittill_any("vehicle_disabled", "reached_end_node");
  stopFXOnTag(level._effect["vfx_vindia_tire_sparks"], var_2.mesh, var_4);
}

function vehicle_vindiadamagelogic(var_0) {
  var_0 endon("reached_wait_speed");
  var_1 = level_getfarah();
...
function vehicle_vindiaspeeduplogic(var_0) {
  var_0 endon("reached_wait_speed");
  GscBinSkip4(0x35, var_0);
}

function vehicle_vindiaspeeduptimeoutlogic(var_0) {
  wait 80;
  var_0 vehicle_setspeed(35, 30);
}

function vehicle_vindiaunloadlogic(var_0) {
  var_0 waittill("reached_wait_speed");
...
function vehicle_vindiasmokegrenadelogic(var_0, var_1) {
  if(var_1) {
    var_0 waittill("reached_wait_speed");
...
function vehicle_vindialaunchsmokegrenades(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  var_7 = var_6 - var_5;
  var_8 = var_7 / 6;
  wait 1;
...
function vehicle_vindiasmokelaunchsfxlogic(var_0) {
  if(!isDefined(var_0)) {
...
function vehicle_vindiaspawnsmokegrenade(var_0, var_1) {
  var_2 = spawn("script_model", var_0);
...
function vehicle_vindiabodydamagelogic(var_0) {
  var_0 endon("reached_end_node");
  var_0 endon("vehicle_disabled");
...
function vehicle_spawntechos(var_0, var_1) {
  var_2 = scripts\common\utility::getvehiclespawnerarray(var_0, "targetname");
  var_3 = [];
...
function vehicle_techodisablelogic(var_0) {
  var_0.engineblock waittill("ballistics_bulletDamage", var_1);
  var_2 = 15;
  var_3 = -15;
  var_4 = var_0 gettagorigin("TAG_HOOD");
...
function vehicle_findnextcrashpath(var_0, var_1) {
  var_2 = undefined;
...
function vehicle_nodegetcrashpaths(var_0) {
...
function vehicle_suniform25effects(var_0) {
...
function vehicle_suniform25dropbomb(var_0) {
  var_1 = var_0.origin;
  var_2 = var_0.angles;
  ...
  var_15 = scripts\sp\maps\highway\highway_utility::ai_getaliveaiarray("axis");
...
function vehicle_waittillarraymoving(var_0) {
  for(;;) {
    var_1 = 0;
...
function level_setredshirtgoalamount(var_0) {
  level.redshirtgoalamount = var_0;
}

function level_spawnredshirtfromspawner(var_0, var_1) {
...
function level_redshirtmagicbulletshieldlogic(var_0) {
  var_0 endon("death");
  ...
  for(;;) {
    ...
    if(var_6) {
      for(var_7 = 0; var_7 < var_6; var_7++) {
        ...
        thread level_spawnredshirtfromspawner(var_9, 5);
      }
    }
...
function level_redshirtshouldmove(var_0) {
...
function level_redshirtcloseronscreen(var_0, var_1) {
...
function level_setupoilpump() {
  ...
  thread scripts\sp\maps\highway\highway_utility::animation_loop(var_0, var_0, "level_oilPumpIdle");
}
...
function level_ballisticsniperammointeractlogic(var_0) {
  var_0 endon("trigger");
...
function level_ballisticsniperammowaypointlogic(var_0) {
  ...
  for(;;) {
    ...
    if(!isDefined(var_2) && var_3) {
      ...
      var_2 = scripts\sp\maps\highway\highway_utility::level_objectiveadd(&"HIGHWAY/OBJECTIVE_GET_SNIPER_AMMO", var_0.origin + (0, 0, 10), &"HIGHWAY/LABEL_AMMO", 1);
    }
...
function level_enemyassaulttownlogic(var_0, var_1) {
  var_0 endon("death");
  level.player endon("death");
  level endon("level_enemyAssaultPlayerSeek");
...
function level_enemyassaulttownmolotovhintlogic() {
  level.player endon("death");
  var_0 = scripts\sp\maps\highway\highway_utility::level_getflag(16);
  ...
  if(!var_0 && var_2 && !var_3) {
    ...
    for(;;) {
      ...
      var_15 scripts\sp\maps\highway\highway_utility::dialogue(var_14);
...
function level_gettownrooftoptriggers(var_0) {
...
function level_notifylevelonenemycount(var_0, var_1) {
  scripts\sp\maps\highway\highway_utility::waittill_remainingenemycount(var_0);
  level notify(var_1);
}

function level_notifylevelonenemydeathcount(var_0, var_1) {
  var_2 = scripts\sp\maps\highway\highway_utility::ai_getaliveaiarray("axis");
  var_3 = var_2.size - var_0;

  while(scripts\sp\maps\highway\highway_utility::ai_getaliveaiarray("axis").size > var_3) {
    waitframe();
  }
...
function level_notifylevelonplayershotcount(var_0, var_1) {
...
function level_redbarreldeathlogic(var_0) {
  var_0 waittill("ballistics_bulletDamage");
  var_1 = var_0.origin;
  var_0 delete();
  ...
  var_3 = 225;
  var_4 = 0.15;
  var_5 = scripts\sp\maps\highway\highway_utility::ai_getaliveaiarray("axis");
  var_6 = 0;
  ...
  var_10 = 150;
  var_11 = scripts\sp\maps\highway\highway_utility::ai_getaliveaiarray("allies");
  ...
  physicsexplosionsphere(var_1, 700, 0, 2);
...
function wind_setdirection(var_0, var_1, var_2) {
  ...
  if(var_2) {
    ...
    var_5 = level.ballistics.winddirections[var_2];
    var_6 = 1;
  }
  ...
  var_7 = scripts\common\basic_wind::init_wind(var_6, var_6, 0);
  ...
  if(var_3) {
    ...
    var_10 = gettime();
    var_11 = var_10 + var_3;
    var_12 = var_3 * 0.001 * 20;
    var_13 = 1 / var_12;

    while(gettime() < var_11) {
      var_14 = var_8;
      var_15 = vectorcross(var_14, var_5);
      var_16 = axistoangles(var_14, var_15, var_5);
      var_17 = var_5;
      var_18 = vectorcross(var_17, var_5);
      var_19 = axistoangles(var_17, var_18, var_5);
