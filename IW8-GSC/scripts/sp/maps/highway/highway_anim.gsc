 ...
 * Script: scripts\sp\maps\highway\highway_anim.gsc
****************************************************/
...
function level_anims_vehicles() {
  level.scr_anim["trap_vehicle"]["trap_placeIED"] = % hod_trap_car_bomb_car;
  level.scr_animtree["level_hadirTruck"] = $;
...
function level_anims_generic_human() {
  level.scr_animtree["farah"] = #animtree;
  level.scr_animtree["hadir"] = $;
