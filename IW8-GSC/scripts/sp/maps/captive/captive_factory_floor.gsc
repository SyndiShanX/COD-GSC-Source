...
function factory_floor_catchup() {
  ...
  var_0 = scripts\sp\maps\captive\captive_util::get_prefab_base_ent("factory_floor_door", "script_noteworthy");
...
function door_kick_scene(var_0) {
  var_1 = scripts\sp\maps\captive\captive_util::get_prefab_base_ent("factory_floor_door", "script_noteworthy");
  ...
  var_2.ignoreme = 1;
  thread door_opener_check_for_damage(level, var_0, var_2);
  thread check_interrupt_threshold();
  thread play_dooropener_kill(level, var_0, var_2);
  level notify("vo_stop_guard_walla");
}

function play_dooropener_kill(var_0, var_1, var_2) {
  level endon("stop_nadia_kill");
  var_0 notify("end_door_kick_idle");
  var_3 = [level.nadia, var_1, var_2];
  var_1 scripts\engine\utility::delaythread(3.5, &scripts\anim\shared::dropallaiweapons);
...
function door_opener_check_for_damage(var_0, var_1, var_2) {
  ...
  if(!scripts\engine\utility::flag("door_opener_past_threshold")) {
    ...
    var_5 = [level.nadia];
    var_1 thread scripts\anim\shared::dropallaiweapons();
