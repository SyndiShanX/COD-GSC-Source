 ...
 * Script: scripts\sp\maps\stpetersburg\stpetersburg_anim.gsc
**************************************************************/
...
function humans() {
  ...
  scripts\common\anim::addnotetrack_customfunction("enforcer", "enable_breath_fx", &scripts\sp\maps\stpetersburg\stpetersburg_utility::enable_breath_fx, "intro_scene");
  scripts\common\anim::addnotetrack_customfunction("aq1", "enable_breath_fx", &scripts\sp\maps\stpetersburg\stpetersburg_utility::enable_breath_fx, "intro_scene");
  scripts\common\anim::addnotetrack_customfunction("aq2", "enable_breath_fx", &scripts\sp\maps\stpetersburg\stpetersburg_utility::enable_breath_fx, "intro_scene");
  ...
  level.scr_goaltime["price"]["stakeout_descend_stairs"] = 0;
...
function interrogation() {
  ...
  level.scr_goaltime["price"]["scene_press_02"] = 1;
...
function pc_force_fov(var_0) {
  if(level.player ispcplayer()) {
    ...
    level.player modifybasefov(55, 0.35);
    return;
  }
}
