...
function canal_civs_onlookers_handler() {
  ...
  thread canal_civs_onlookers_behavior(var_0, var_3);
  thread canal_civs_onlookers_behavior(var_1, var_3);
...
function canal_civs_onlookers_behavior(var_0, var_1) {
  self endon("death");
...
function spawn_car_and_link_driver(var_0) {
...
function fakeactor_cross_canal_runners() {
  ...
  foreach(var_2 in var_0) {
    ...
    var_3 thread scripts\sp\maps\stpetersburg\stpetersburg_utility::delete_on_flag("flag_acquire_complete");
  }
}
...
function snd_doppler_tick(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  var_7 = (0, 0, 0);
  var_8 = 39.3701;
...
function _snd_doppler_main(var_0, var_1, var_2) {
  ...
  while(isent(self)) {
    ...
    var_9 = _snd_get_velocity(var_3);
    var_10 = var_2;

    if(isDefined(var_9) == 0 || var_2 == 0) {
      var_9 = (0, 0, 0);
    }

    [var_12] = snd_doppler_tick(var_5, var_6, var_7, var_8, var_9, var_10);

    if(isDefined(var_1) == 1) {
      var_12 *= var_1;
    }

    var_12 = clamp(var_12, 0.01, 2);
    self scalepitch(var_12, var_4);
    wait var_4;
  }
}

function snd_doppler(var_0, var_1, var_2, var_3) {
  if(isent(var_0) == 0) {
    return;
  }
  ...
  thread _snd_doppler_main(var_0, var_1, var_2);
}

function snd_doppler_stop(var_0) {
