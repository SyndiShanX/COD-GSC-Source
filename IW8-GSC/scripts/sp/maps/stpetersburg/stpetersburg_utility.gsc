...
function setup_named_ai(var_0, var_1, var_2, var_3, var_4, var_5) {
...
function spawn_enforcer(var_0) {
  ...
  level.enforcer scripts\anim\shared::forceuseweapon(var_2, "primary");
...
function pursuit_timer(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  jumpiffalse(var_1 < 10) LOC_000001a5;
  var_10 = -10;
  var_11 = -10;
...
function pursuit_death_flag_save(var_0, var_1) {
...
function pursuit_autosave(var_0, var_1) {
  level endon("disable_autosaves");
  scripts\engine\utility::flag_wait(var_0);
  level notify("pursuit_timer_reset");
  level.player clearhudtutorialmessage();
...
function enforcer_monitor_health_handler(var_0) {
  ...
  while(isalive(level.enforcer) && level.enforcer.fake_health > 0) {
    ...
    level.enforcer.fake_health -= var_2;
...
function objective_enforcer_los(var_0, var_1, var_2, var_3) {
  level.enforcer endon("death");
  level.player endon("death");
  ...
  var_4 = "";
  jumpiffalse(isDefined(var_3) && var_3 == 1) LOC_0000005c;
...
function objective_trigger_handler(var_0, var_1) {
  scripts\engine\sp\utility::trigger_wait_targetname(var_1);
  level notify("objective_enforcer_los_end");
  scripts\engine\sp\objectives::objective_remove_all_locations(var_0);
}

function enforcer_blindfire(var_0, var_1, var_2, var_3) {
  level.enforcer endon("death");
...
function price_adjust_accuracy_over_time(var_0) {
...
function display_ai_count() {
  ...
  for(;;) {
    ...
    if(isDefined(var_0)) {
      if(var_0 != "all") {
        var_5 = [];
        var_5 = getaiarray(var_0).size;
      } else {
        var_5 = getaiarray("axis").size;
        var_5 = getaiarray("allies").size;
        var_5 = getaiarray("team3").size;
        var_5 = getaiarray("neutral").size;
      }
    } else {
      var_5 = [];
      wait 0.5;
...
function scared_civs_player_looking(var_0) {
  self endon("death");
  var_1 = cos(35);
...
function scared_civs_trigger_grenade(var_0) {
  self endon("death");
...
function scared_civs_cower(var_0) {
  self endon("death");
...
function set_walking_speed(var_0) {
  if(!isDefined(var_0)) {
    var_0 = 20;
  }
...
function populate_civs_looping(var_0, var_1) {
  ...
  foreach(var_6 in var_3) {
    ...
    wait 0.5;
    thread addloopinganimation(var_7);
...
function put_player_into_cam_rig(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  if(istrue(var_6)) {
    var_0 setModel("viewhands_base_fullbody_iw8");
  } else {
    level.player hidelegsandshadow();
...
function interrogation_room_door_close(var_0, var_1) {
  ...
  thread warehouse_garage_door_open_audio(var_2);
  var_2 moveTo(var_3.origin, var_1);
}

function warehouse_garage_door_open_audio(var_0) {
  wait 1;
...
function interrogation_room_door_open(var_0, var_1) {
  var_1 = scripts\engine\utility::ter_op(isDefined(var_1), var_1, 3);
  var_2 = getEnt(var_0, "targetname");
...
function price_clean_up_last_enemy(var_0, var_1) {
  waitframe();
...
function price_get_los_enemy(var_0) {
...
function trigger_safe_function(var_0, var_1, var_2) {
...
function player_wander_fail_handler(var_0) {
...
function delay_reset_player_wander_nag(var_0) {
...
function set_wander_fail_volume(var_0) {
...
function transient_unload_load(var_0, var_1) {
  waitframe();
...
function transient_waittill(var_0, var_1, var_2) {
  scripts\engine\utility::flag_wait(var_0);
  thread transient_unload_load(var_1, var_2);
}

function waittill_array_alive_count_or_timeout(var_0, var_1, var_2) {
  var_3 = spawnStruct();
  GscBinSkip4(0x6e, var_3, var_0, var_1);
}

function waittill_alive_count(var_0, var_1) {
...
function price_advance_trigger(var_0, var_1, var_2, var_3) {
  if(!isDefined(var_2)) {
    var_2 = 0;
  }
...
function getpriceenemytarget(var_0) {
  foreach(var_2 in var_0) {
...
function setup_dead_bodies(var_0, var_1) {
  var_2 = getspawnerarray(var_0);

  foreach(var_4 in var_2) {
    thread dead_body_create(var_4);
  }
}

function dead_body_create(var_0) {
...
function periph_vehicle_loop_new(var_0, var_1, var_2, var_3) {
  jumpiffalse(scripts\engine\utility::flag(var_0)) LOC_00000010;
  return;
}

function periph_vehicle_driver(var_0) {
...
function periph_vehicle_driver_delete_handler(var_0) {
  self endon("death");
  self endon("entitydeleted");
...
function vehicle_loop(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  waitframe();
...
function spawn_cluster(var_0, var_1, var_2, var_3, var_4, var_5) {
  if(!isDefined(var_1)) {
    var_1 = 1;
  }
  ...
  if(var_1 == var_2) {
    ...
    var_6 = randomintrange(var_2, var_3);
  }
  ...
  for(var_8 = 0; var_8 < var_7; var_8++) {
    ...
    if(isDefined(var_6)) {
      if(isDefined(var_6[var_9].size)) {
        var_11 setModel(var_6[var_9][randomintrange(0, var_6[var_9].size)]);
      } else {
        var_11 setModel(var_6[randomintrange(0, var_6.size)]);
      }
    }
...
function spawn_driver() {
  ...
  var_1.count = 1;
  self.driver = var_2;
  link_driver(var_2, self);
}

function link_driver(var_0) {
...
function manage_oscillation(var_0) {
  ...
  while(isDefined(self)) {
    var_2 = gettime() - var_1;
    var_3 = var_0;
    var_3 += sin(var_2 * 2.5 / (var_0 + 5)) * var_0 * 0.15;
...
function wait_player_not_looking(var_0, var_1, var_2) {
  var_3 = cos(50);
  var_4 = gettime();
...
function animation_stoploop(var_0, var_1) {
...
function animation_idle(var_0, var_1, var_2) {
...
function create_dialog_struct(var_0, var_1) {
  var_2 = spawnStruct();
  var_2.name = var_0;
  var_2.team = var_1;
  return var_2;
...
function add_dialogue_line_kyle(var_0, var_1, var_2, var_3, var_4, var_5) {
  if(isDefined(level.player)) {
    level.player.name = "Kyle";
    level.player.team = "allies";
    dialogue(level.player, var_0, var_1, var_2, var_3, var_4, var_5);
    return;
  }

  dialogue(level.kyle_dialog_struct, var_0, undefined, var_2, var_3, var_4, var_5);
}

function add_dialogue_line_price(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  if(!istrue(var_6)) {
  ...
  if(isDefined(level.price)) {
    ...
    dialogue(level.price, var_0, var_1, var_2, var_3, var_4, var_5);
    return;
  }

  dialogue(level.price_dialog_struct, var_0, undefined, var_2, var_3, var_4, var_5);
}

function add_dialogue_line_nikolai(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  if(!istrue(var_6)) {
  ...
  if(isDefined(level.nikolai)) {
    ...
    dialogue(level.nikolai, var_0, var_1, var_2, var_3, var_4, var_5);
    return;
  }

  dialogue(level.nikolai_dialog_struct, var_0, undefined, var_2, var_3, var_4, var_5);
}

function add_dialogue_line_civilian(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  dialogue(level.civilian_dialog_struct, var_0, undefined, var_2, var_3, var_4, var_5);
}

function add_dialogue_line_police(var_0, var_1, var_2, var_3, var_4, var_5) {
  if(isDefined(self) && isalive(self) && isai(self)) {
    self.name = "Police";
    scripts\engine\sp\utility::name_hide();
    self.team = "team3";
  ...
  dialogue(level.police_dialog_struct, var_0, undefined, var_2, var_3, var_4, var_5);
}

function add_dialogue_line_aq_soldier(var_0, var_1, var_2, var_3, var_4, var_5) {
  if(isDefined(self) && isalive(self) && isai(self)) {
    self.name = "Al Qatala";
    scripts\engine\sp\utility::name_hide();
    self.team = "axis";
  ...
  dialogue(level.aq_soldier_dialog_struct, var_0, undefined, var_2, var_3, var_4, var_5);
}

function add_dialogue_line_butcher(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  if(!istrue(var_6)) {
  ...
  if(isDefined(level.enforcer) && !scripts\engine\utility::flag("enforcer_dead")) {
    ...
    dialogue(level.enforcer, var_0, var_1, var_2, var_3, var_4, var_5);
    return;
  }
  ...
  if(isDefined(level.escorttargetdrone)) {
    ...
    dialogue(level.escorttargetdrone, var_0, var_1, var_2, var_3, var_4, var_5);
    return;
  }

  dialogue(level.butcher_dialog_struct, var_0, undefined, var_2, var_3, var_4, var_5);
}

function add_dialogue_line_butcher_wife(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  if(!istrue(var_6)) {
  ...
  if(isDefined(level.enforcerwife) || isDefined(level.escortdrones[0])) {
    if(isDefined(level.enforcerwife)) {
      ...
      dialogue(level.enforcerwife, var_0, var_1, var_2, var_3, var_4, var_5);
      return;
    }

    if(isDefined(level.escortdrones[0])) {
      dialogue(level.escortdrones[0], var_0, var_1, var_2, var_3, var_4, var_5);
      return;
    }
  ...
  dialogue(level.butcher_wife_dialog_struct, var_0, undefined, var_2, var_3, var_4, var_5);
}

function add_dialogue_line_butcher_son(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  if(!istrue(var_6)) {
    scripts\engine\utility::flag_waitopen("pause_family_vo");
  }
  ...
  if(isDefined(level.enforcerson) || isDefined(level.escortdrones[1])) {
    ...
    dialogue(var_7, var_0, var_1, var_2, var_3, var_4, var_5);
    return;
  }

  dialogue(level.butcher_son_dialog_struct, var_0, undefined, var_2, var_3, var_4, var_5);
}

function add_dialogue_line_yegor(var_0, var_1, var_2, var_3, var_4, var_5) {
  if(isDefined(level.yegor)) {
    level.yegor.name = "Yegor";
    level.yegor.team = "allies";
    dialogue(level.yegor, var_0, var_1, var_2, var_3, var_4, var_5);
    return;
  }

  dialogue(level.yegor_dialog_struct, var_0, undefined, var_2, var_3, var_4, var_5);
}

function dialogue(var_0, var_1, var_2, var_3, var_4, var_5) {
  self endon("death");
  ...
  if(!isDefined(var_1) || getdvarint("scr_show_temp_dialogue")) {
    ...
    if(istrue(var_12)) {
      var_14 = var_13 + var_13 + " (Over Radio)" + ": " + "^7" + var_3;
    } else {
      var_14 = var_13 + var_14 + ": " + "^7" + var_4;
    }

    thread dialogue_proc(var_14, var_12);
    return;
  }
}
...
function dialogue_naglogic(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10) {
  self endon("death");
  self endon("entitydeleted");
  var_11 = spawnStruct();
  var_11 endon("dialogue_endNag");
  thread dialogue_nagendonlogic(var_11, var_3, var_4);
  GscBinSkip4(0x35, var_11, var_5, var_0, var_1, var_2, var_6, var_7, var_8, var_9, var_10);
}

function dialogue_naglogic_proc(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9) {
  if(istrue(var_1)) {
    wait var_1;
  }
  ...
  for(;;) {
    if(isDefined(var_7) && isDefined(var_8) && isDefined(var_9)) {
      GscBinSkip4(0x35, var_7, var_8, var_9);
    }
...
function dialogue_nagflaglogic(var_0, var_1) {
  level_setflag(256, 1);
...
function dialogue_naganimationlogic(var_0, var_1, var_2) {
...
function level_getflag(var_0) {
  return level.flags &var_0;
}

function level_setflag(var_0, var_1) {
  if(var_1) {
    level.flags |= var_0;
    return;
  }
...
function dialogue_glanceatentity(var_0, var_1, var_2) {
  self endon("death");
...
function swap_vehicle_for_scriptable(var_0) {
  if(!isDefined(self)) {
...
function get_closest_living_ai(var_0, var_1, var_2) {
  if(isDefined(var_1)) {
...
function enable_breath_fx(var_0) {
  if(isDefined(var_0)) {
...
function disable_breath_fx(var_0) {
  if(isDefined(var_0)) {
...
function debug_display_rule_of_thirds() {
  ...
  var_1 = [];
  GscBinSkip0(0x2e, 0, create_debug_hud_line(213, 0, 1, 480, var_0));
}

function create_debug_hud_line(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
...
function background_fakeciv_setup(var_0, var_1, var_2) {
...
function background_fakeciv_idle(var_0) {
...
function background_fakeciv_loop(var_0) {
  self endon("death");
  self endon("entitydeleted");
...
function background_fakeciv_scatter(var_0) {
  self endon("death");
  self endon("entitydeleted");
...
function cointoss_variable(var_0) {
  return randomint(100) >= var_0;
}

function set_attackeraccuracy_handler(var_0, var_1, var_2, var_3) {
  self endon("death");
  self endon("entitydeleted");
