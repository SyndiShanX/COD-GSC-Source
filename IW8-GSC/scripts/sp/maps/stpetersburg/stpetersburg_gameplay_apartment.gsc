...
function apartment_price_handler() {
  ...
  level.price scripts\sp\maps\stpetersburg\stpetersburg_utility::color_node_arrive(var_0);
...
function entrance_blindfire_vignette() {
  ...
  if(var_2 == "blindfire_entrance_vignette_start") {
    wait 1;
    thread scripts\sp\maps\stpetersburg\stpetersburg_utility::enforcer_blindfire(var_0.origin, var_1.origin, "blindfire_entrance_vignette_end");
    return;
  }

  thread scripts\sp\maps\stpetersburg\stpetersburg_utility::enforcer_blindfire(var_0.origin, var_1.origin, "blindfire_entrance_vignette_start");
}

function stairs_blindfire_vignette(var_0) {
  ...
  thread scripts\sp\maps\stpetersburg\stpetersburg_utility::enforcer_blindfire(var_1.origin, var_2.origin, "flag_apartment_enforcer_blindfire_end", 5);
  wait 1.5;
...
function apartment_player_grenade_effects(var_0) {
  level.player endon("death");
  var_1 = getEnt("grenade_shellshock_area", "targetname");
...
function apartment_destruction_grenade_effects(var_0) {
...
function apartment_enforcer_grenade_throw() {
  ...
  var_0 += anglesToForward(var_2) * 3;
  level.apt_grenade = magicgrenade("frag", var_0, var_1.origin, 4, 1);
...
function civilian_stairwell_blocker_handler() {
  ...
  thread scripts\sp\maps\stpetersburg\stpetersburg_utility::scared_civs_player_looking(var_0);
  thread scripts\sp\maps\stpetersburg\stpetersburg_utility::scared_civs_trigger_grenade(var_0);
}
...
function civilian_stairs_shock_handler() {
  ...
  var_1.civ_ff_idle = 1;
  var_1 thread scripts\sp\maps\stpetersburg\stpetersburg_vo::vo_apartment_civ_shocked();
...
function civilian_stairs_death_handler() {
  ...
  var_1 endon("entitydeleted");
  var_1 endon("death");
  scripts\engine\utility::delaythread(1, &stairs_blindfire_vignette, var_1);
  var_1 thread scripts\sp\maps\stpetersburg\stpetersburg_vo::vo_apartment_civ_stairs();
  ...
  var_1 scripts\sp\maps\stpetersburg\stpetersburg_utility::dialogue_stop();
...
function civilians_hallway_flee_handler() {
  ...
  setcharmodels(var_1, "body_civ_stpeterburg_female_3_1", "head_sc_f_eghbali_hair", undefined);
  var_2 = scripts\engine\sp\utility::spawn_targetname("apt_hallway_flee_child", 1);
  setcharmodels(var_2, "body_civ_western_girl_4_1", "head_sc_f_chivikina_child", undefined);
  var_3 = [var_1, var_2];
  ...
  thread civilians_hallway_flee_single(var_1);
  thread civilians_hallway_flee_single(var_2);
...
function walla_mom_child_hallway(var_0, var_1) {
  wait 0.1;
...
function civilians_hallway_flee_single(var_0) {
...
function alive_monitor(var_0, var_1) {
  self waittill("death");
...
function apartment_dead_bodies(var_0, var_1) {
  level.enforcer endon("death");
  scripts\sp\maps\stpetersburg\stpetersburg_utility::setup_dead_bodies(var_0, var_1);
  scripts\engine\utility::flag_wait("flag_apartment_vignette_peek_2");
