...
function gauntlet_shootout_combat_handler() {
  ...
  thread originlink(var_1.link_org);
...
function gauntlet_van_hit_vignette() {
  ...
  var_18 = getanimlength(level.nikolai scripts\engine\utility::getanim("stp_street_car_hit")) - 2;
...
function gauntlet_actor_animate_single_then_loop(var_0, var_1, var_2, var_3, var_4, var_5) {
  self endon("death");
  level.enforcer endon("death");
  level.player endon("death");
  level endon("missionfailed");
...
function gauntlet_aq_spawn_handler() {
  ...
  thread gauntlet_aq_vehicle_movement_handler(var_0);
  thread gauntlet_car_death_monitor(var_0);
  ...
  thread gauntlet_aq_vehicle_movement_handler(var_1);
  thread gauntlet_car_death_monitor(var_1);
  wait 5;
  ...
  thread gauntlet_aq_vehicle_movement_handler(var_2);
  var_2.health = int(var_2.health * 1.2);
  thread gauntlet_car_death_monitor(var_2);
...
function gauntlet_van_takeoff(var_0, var_1) {
...
function get_random_array_element_no_repeat(var_0, var_1, var_2) {
  if(!isDefined(var_2)) {
    var_2 = 2;
  }
...
function gauntlet_car_death_monitor(var_0) {
  self endon("entitydeleted");
...
function gauntlet_aq_on_foot_spawner(var_0) {
...
function gauntlet_police_vehicle_lights(var_0) {
  if(!isDefined(var_0)) {
    var_0 = 0;
  }
  ...
  if(var_0) {
    ...
    var_3 = (0, 0, 0);
    var_2 = scripts\engine\utility::spawn_tag_origin(self.origin, self.angles);
    var_2 linkTo(self, "tag_origin", (0, 0, 32.25), var_3);
    var_2 scripts\engine\sp\utility::fx_playontag_safe("vfx_stpburg_police_lights", "tag_origin");
  }
  ...
  if(isDefined(var_3)) {
    var_3 scripts\engine\sp\utility::fx_stopontag_safe("vfx_stpburg_police_lights", "tag_origin");
    var_3 delete();
    return;
  }
}
...
function gauntlet_van_damage_impact(var_0) {
  switch (var_0) {
    case 0:
...
function audio_play_bullet_impacts_around_player(var_0) {
  var_1 = randomfloatrange(-120, 120);
  var_2 = randomfloatrange(-120, 120);
...
function gauntlet_van_create_bullethole(var_0) {
...
function gauntlet_van_create_random_bullethole() {
  ...
  var_1 += (randomintrange(-15, 15), 0, randomintrange(-15, 15));
...
function gauntlet_set_ai_in_range_to_pacifist(var_0) {
  var_1 = scripts\common\utility::getdifficulty();
  var_2 = squared(400);
  var_3 = randomfloatrange(6, 9);

  if(var_1 == "easy") {
    var_2 = squared(450);
    var_3 = randomfloatrange(8, 12);
  } else if(var_1 == "fu") {
    var_2 = squared(350);
    var_3 = randomfloatrange(4, 6);
  }
  ...
  foreach(var_8 in var_6) {
    ...
    if(var_9 <= var_4) {
      var_8 thread scripts\anim\combat_utility::flashbangstart(var_5);
    }
...
function gauntlet_aq_vehicle_movement_handler(var_0) {
  self endon("entitydeleted");
  self endon("death");
  var_1 = undefined;
...
function gauntlet_car_fx_handler(var_0) {
  self.fx_tags = [];
  ...
  foreach(var_2 in self.fx_tags) {
    thread gauntlet_car_wheel_fx_handler(var_2, var_0, var_3);
  }
}

function gauntlet_car_wheel_fx_handler(var_0, var_1, var_2) {
  self endon("entitydeleted");
  var_3 = var_0 + var_1;
...
function gauntlet_aq_vehicle_driver_death_handler(var_0, var_1) {
  self endon("entitydeleted");
  self endon("death");
  level endon(var_1);
...
function gauntlet_aq_vehicle_cleanup(var_0) {
...
function gauntlet_shootout_police_arrive() {
  ...
  thread gauntlet_police_vehicle_lights(var_5);
  thread gauntlet_police_car_array_setup(var_5);
  ...
  thread gauntlet_police_vehicle_lights(var_6);
  ...
  thread gauntlet_police_vehicle_lights(var_7);
  ...
  thread gauntlet_police_vehicle_lights(var_8);
  thread gauntlet_police_car_array_setup(var_8);
  scripts\engine\utility::flag_wait("flag_gauntlet_van_moving");
  ...
  thread gauntlet_police_vehicle_lights(var_9);
  thread gauntlet_police_car_array_setup(var_9);
}

function gauntlet_police_car_array_setup(var_0) {
  self endon("death");
  self endon("entitydeleted");
...
function spawnlootitemsuspended(var_0, var_1, var_2, var_3, var_4) {
...
function gauntlet_hack_bench_badplace() {
  ...
  foreach(var_3 in var_0) {
    var_1 = createnavbadplacebybounds(var_3.origin, (4, 18, 64), var_3.angles);
  }
