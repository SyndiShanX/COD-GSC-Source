 ...
 * Script: scripts\sp\maps\stpetersburg\stpetersburg_vignette_alleys_anim.gsc
******************************************************************************/
...
function civ_stairs_blood_splatter() {
  ...
  for(;;) {
    if(scripts\engine\sp\utility::players_within_distance(250, self getEye())) {
      ...
      level.player thread scripts\sp\player::damagebloodoverlaydirectional(self getEye(), "MOD_RIFLE_BULLET", 8);
      break;
    }
