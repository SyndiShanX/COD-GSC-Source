 ...
 * Script: scripts\sp\maps\stpetersburg\stpetersburg.gsc
*********************************************************/

function main() {
  scripts\sp\maps\stpetersburg\gen\stpetersburg_art::main();
  scripts\sp\maps\stpetersburg\stpetersburg_fx::main();
  ...
  thread kilo121_hack();
  scripts\sp\maps\stpetersburg\stpetersburg_gameplay_club::bar_init();
  scripts\sp\maps\stpetersburg\stpetersburg_gameplay_apartment::apartment_init();
  scripts\sp\maps\stpetersburg\stpetersburg_gameplay_canal::canal_init();
  scripts\sp\maps\stpetersburg\stpetersburg_gameplay_acquire::acquire_init();
  scripts\sp\maps\stpetersburg\stpetersburg_gameplay_escort::escort_phase_init();
  scripts\sp\maps\stpetersburg\stpetersburg_gameplay_gauntlet::gauntlet_init();
  scripts\sp\maps\stpetersburg\stpetersburg_interrogation::interrogation_init();
  scripts\sp\maps\stpetersburg\stpetersburg_vignette_alleys::alleys_vig_init();
  scripts\sp\maps\stpetersburg\stpetersburg_vig_script_street_intro::vig_street_intro_init();
  scripts\sp\maps\stpetersburg\stpetersburg_vig_script_canal::canal_vig_init();
  scripts\sp\maps\stpetersburg\stpetersburg_vig_script_gauntlet::gauntlet_vig_init();
  scripts\sp\maps\stpetersburg\stpetersburg_containment::containment_init();
  scripts\sp\maps\stpetersburg\stpetersburg_utility::init_dialog_structs();
  init_hints();
  init_dvars();
  ...
  thread scripts\sp\maps\stpetersburg\stpetersburg_utility::display_ai_count();
  thread scripts\sp\maps\stpetersburg\stpetersburg_containment::containment_start();
...
function stpetersburg_starts() {
  ...
  scripts\engine\sp\utility::add_start("interrogation_intro", &interrogation_intro_start, "", &interrogation_stp_main, "00000001100_001", &scripts\sp\maps\stpetersburg\stpetersburg_interrogation::interrogation_intro_catchup);
...
function stpetersburg_transients() {
...
function track_player_achievements() {
...
function stpetersburg_ai_spawn_function_setup() {
...
function stpetersburg_friendly_fire_think() {
...
function init_hints() {
  scripts\engine\sp\utility::add_hint_string("holster_weapon", &"STPETERSBURG/HOLSTER_WEAPON", &scripts\sp\maps\stpetersburg\stpetersburg_utility::player_weapon_holstered);
  scripts\engine\sp\utility::add_hint_string("draw_weapon", &"STPETERSBURG/DRAW_WEAPON", &scripts\sp\maps\stpetersburg\stpetersburg_utility::player_holdingpistolweapon);
  scripts\engine\sp\utility::add_hint_string("draw_weapon_alt", &"STPETERSBURG/DRAW_WEAPON_ALT", &scripts\sp\maps\stpetersburg\stpetersburg_utility::player_holdingpistolweapon);
  scripts\engine\sp\utility::add_hint_string("wait_for_signal", &"STPETERSBURG/WAIT_FOR_SIGNAL", &scripts\sp\maps\stpetersburg\stpetersburg_utility::player_holdingpistolweapon);
...
function stpetersburg_objectives() {
  ...
  if(!scripts\sp\starts::is_after_start("bar_shootout")) {
    ...
    waitframe();
    scripts\sp\maps\stpetersburg\stpetersburg_utility::objective_enforcer_los("chase_butcher", "obj_chase_enforcer_1", "obj_chase_enforcer_1_complete");
    scripts\sp\maps\stpetersburg\stpetersburg_utility::objective_enforcer_los("chase_butcher", "obj_chase_enforcer_2", "obj_chase_enforcer_2_complete");
    scripts\sp\maps\stpetersburg\stpetersburg_utility::objective_enforcer_los("chase_butcher", "obj_chase_enforcer_3", "obj_chase_enforcer_3_complete");
    scripts\sp\maps\stpetersburg\stpetersburg_utility::objective_enforcer_los("chase_butcher", "obj_chase_enforcer_4", "obj_chase_enforcer_4_complete");
  ...
  if(!scripts\sp\starts::is_after_start("apartment")) {
    ...
    waitframe();
    scripts\sp\maps\stpetersburg\stpetersburg_utility::objective_enforcer_los("chase_butcher", "fallback_apartment_entrance", "fallback_end_apartment_entrance");
    scripts\sp\maps\stpetersburg\stpetersburg_utility::objective_enforcer_los("chase_butcher", "fallback_apartment_door", "fallback_end_apartment_door");
    scripts\sp\maps\stpetersburg\stpetersburg_utility::objective_enforcer_los("chase_butcher", "fallback_apartment_exit", "fallback_end_apartment_exit");
  }
  ...
  if(!scripts\sp\starts::is_after_start("canal")) {
    ...
    waitframe();
    scripts\sp\maps\stpetersburg\stpetersburg_utility::objective_enforcer_los("chase_butcher", "fallback_canal_bridge", "fallback_canal_bridge_end");
    scripts\sp\maps\stpetersburg\stpetersburg_utility::objective_enforcer_los("chase_butcher", "fallback_canal_street", "fallback_canal_street_end");
    scripts\sp\maps\stpetersburg\stpetersburg_utility::objective_enforcer_los("chase_butcher", "fallback_canal_gate", "fallback_canal_gate_end");
  }
  ...
  if(!scripts\sp\starts::is_after_start("acquire")) {
    ...
    waitframe();
    scripts\sp\maps\stpetersburg\stpetersburg_utility::objective_enforcer_los("chase_butcher", "fallback_acquire_corner", "fallback_acquire_corner_end");
    scripts\sp\maps\stpetersburg\stpetersburg_utility::objective_enforcer_los("chase_butcher", "fallback_acquire_exit", "fallback_acquire_exit_end");
  ...
  if(!scripts\sp\starts::is_after_start("evade")) {
    ...
    waitframe();
    scripts\sp\maps\stpetersburg\stpetersburg_utility::objective_enforcer_los("chase_butcher", "obj_recover_enforcer_1", "obj_recover_enforcer_1_complete");
    scripts\sp\maps\stpetersburg\stpetersburg_utility::objective_enforcer_los("chase_butcher", "obj_recover_enforcer_2", "obj_recover_enforcer_2_complete");
  }
...
function stakeout_intro_start() {
  setDvar("stp_intro_cinematic", 1);
}

function audio_stp_intro_amb() {
...
function stakeout_stp_main() {
  ...
  thread scripts\sp\maps\stpetersburg\stpetersburg_gameplay_club::intro_stakeout_main();
...
function audio_music_start_st_pete() {
  wait 0.5;
...
function alley_stealth_start() {
  ...
  level.price = scripts\sp\maps\stpetersburg\stpetersburg_utility::setup_named_ai("price", "Captain Price", "start_alley_stealth_price", "price_start_alley_stealth_colors", "cqb");
  setup_player_silenced_pistol();
  thread alley_stealth_start_delayed();
  thread scripts\sp\maps\stpetersburg\stpetersburg_gameplay_club::alley_stealth_start_function();
...
function alley_stealth_start_delayed() {
...
function alley_stealth_stp_main() {
  thread scripts\sp\maps\stpetersburg\stpetersburg_gameplay_club::alley_stealth_main();
  setup_price_silenced_pistol();
...
function alley_stealth_catchup() {
  scripts\engine\utility::flag_set("flag_backroom_player_downstairs");
}

function bar_backroom_start() {
  set_player_health_semifragile();
  scripts\engine\sp\utility::set_start_location("stpetersburg_bar_backroom", [level.player]);
  level.price = scripts\sp\maps\stpetersburg\stpetersburg_utility::setup_named_ai("price", "Captain Price", "start_bar_backroom_price", "price_checkpoint_bar_backroom_colors", "cqb");
  setup_player_silenced_pistol();
  waitframe();
...
function bar_backroom_stp_main() {
  ...
  thread scripts\sp\maps\stpetersburg\stpetersburg_gameplay_club::bar_shootout_door_handler();
  scripts\sp\maps\stpetersburg\stpetersburg_gameplay_club::bar_backroom_main();
...
function bar_shootout_stp_main() {
  setup_price_smg();
  thread scripts\sp\maps\stpetersburg\stpetersburg_utility::enforcer_reset_fake_health();
  scripts\sp\maps\stpetersburg\stpetersburg_utility::trigger_safe_function("bar_street_triggers", "script_noteworthy", "enable");
  scripts\engine\utility::flag_wait("flag_player_exit_club");
}

function bar_shootout_catchup() {
  scripts\sp\maps\stpetersburg\stpetersburg_utility::trigger_safe_function("bar_street_triggers", "script_noteworthy", "enable");
  thread reduce_friendlyfire_penalties();
}

function bar_street_start() {
  set_player_health_semifragile();
  scripts\engine\sp\utility::set_start_location("stpetersburg_bar_street", [level.player]);
  level.price = scripts\sp\maps\stpetersburg\stpetersburg_utility::setup_named_ai("price", "Captain Price", "start_bar_street_price", "price_checkpoint_bar_street_alt_colors");
  scripts\sp\maps\stpetersburg\stpetersburg_utility::spawn_enforcer("node_enforcer_alley");
  scripts\sp\maps\stpetersburg\stpetersburg_gameplay_club::bar_street_enforcer_spawn();
  setup_player_ar();
  thread scripts\sp\maps\stpetersburg\stpetersburg_vignette_alleys::spawn_traffic();
  thread scripts\sp\maps\stpetersburg\stpetersburg_gameplay_club::bar_street_main();
  waitframe();
...
function apartment_start() {
  set_player_health_semifragile();
  scripts\engine\sp\utility::set_start_location("start_stpetersburg_apartment_player", [level.player]);
  level.price = scripts\sp\maps\stpetersburg\stpetersburg_utility::setup_named_ai("price", "Captain Price", "start_stpetersburg_apartment_price");
  scripts\sp\maps\stpetersburg\stpetersburg_utility::spawn_enforcer("start_petersburg_apartment_enforcer");
...
function apartment_stp_main() {
  setup_price_smg();
  thread scripts\sp\maps\stpetersburg\stpetersburg_utility::enforcer_reset_fake_health();
  scripts\engine\sp\utility::autosave_or_timeout("apartment_start", 3);
  scripts\engine\utility::flag_set("lighting_alley_to_apartments");
  scripts\sp\maps\stpetersburg\stpetersburg_gameplay_apartment::apartment_main();
}
...
function canal_start() {
  scripts\sp\maps\stpetersburg\stpetersburg_utility::spawn_enforcer("start_petersburg_canal_enforcer");
  ...
  level.price = scripts\sp\maps\stpetersburg\stpetersburg_utility::setup_named_ai("price", "Captain Price", "start_stpetersburg_canal_price");
  setup_player_ar();
...
function canal_stp_main() {
  ...
  scripts\sp\maps\stpetersburg\stpetersburg_gameplay_canal::canal_main();
}
...
function acquire_start() {
  ...
  level.price = scripts\sp\maps\stpetersburg\stpetersburg_utility::setup_named_ai("price", "Captain Price", "start_stpetersburg_acquire_price");
  set_player_health_semifragile();
  setup_player_ar();
  scripts\engine\utility::flag_set("flag_canal_enforcer_in_alley");
}

function acquire_stp_main() {
  ...
  scripts\sp\maps\stpetersburg\stpetersburg_gameplay_acquire::acquire_main();
}

function acquire_catchup() {}

function evade_start() {
  setDvar("stp_interrogation_escort", 0);
  set_player_health_semifragile();
...
function evade_stp_main() {
  ...
  scripts\sp\maps\stpetersburg\stpetersburg_gameplay_escort::evade_main();
}
...
function gauntlet_start() {
  ...
  level.price = scripts\sp\maps\stpetersburg\stpetersburg_utility::setup_named_ai("price", "Captain Price", "start_stpetersburg_gauntlet_price", "gauntlet_price_colors_1");
  setup_price_smg();
...
function gauntlet_stp_main() {
  level.autosave_threat_check_enabled = 1;
  scripts\engine\sp\utility::autosave_or_timeout("gauntlet_start", 6);
  scripts\engine\utility::flag_set("flag_start_escort_containment");
  thread reset_friendlyfire_penalties();
  scripts\sp\maps\stpetersburg\stpetersburg_gameplay_gauntlet::gauntlet_main();
}
...
function gauntlet_shootout_start() {
  level.price = scripts\sp\maps\stpetersburg\stpetersburg_utility::setup_named_ai("price", "Captain Price", "start_stpetersburg_gauntlet_price");
  setup_price_smg();
  scripts\sp\maps\stpetersburg\stpetersburg_gameplay_gauntlet::gauntlet_shootout_setup_van();
  waitframe();
...
function gauntlet_shootout_stp_main() {
  level.autosave_threat_check_enabled = 1;
  scripts\engine\sp\utility::autosave_or_timeout("gauntlet_shootout_start", 3);
  set_player_health_standard();
  scripts\sp\maps\stpetersburg\stpetersburg_gameplay_gauntlet::gauntlet_shootout_main();
  setDvar("stp_interrogation_phase", 0);
}

function gauntlet_shootout_catchup() {
  level.autosave_threat_check_enabled = 1;
}

function interrogation_cine_start() {
  setDvar("stp_interrogation_phase", 0);
}

function interrogation_intro_start() {
  setDvar("stp_interrogation_phase", 1);
}

function interrogation_room_start() {
  setDvar("stp_interrogation_phase", 2);
  level.player allowmelee(0);
}

function interrogation_revolver_start() {
  setDvar("stp_interrogation_phase", 3);
}

function interrogation_stp_main() {
  thread scripts\sp\maps\stpetersburg\stpetersburg_vo::mus_intro_torture();
...
function interrogation_actor_setup() {
  if(isDefined(level.enforcer)) {
    level.enforcer delete();
  }

  scripts\sp\maps\stpetersburg\stpetersburg_utility::spawn_enforcer();

  if(!isDefined(level.price)) {
    level.price = scripts\sp\maps\stpetersburg\stpetersburg_utility::setup_named_ai("price", "Captain Price", undefined, undefined, "casual_gun");
  }
...
function reduce_friendlyfire_penalties() {
...
function reset_friendlyfire_penalties() {
...
function set_player_health_fragile() {
...
function set_player_health_semifragile() {
...
function set_player_health_standard() {
