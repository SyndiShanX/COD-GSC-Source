...
function trigger_array_wait_then_delete_cafe(var_0, var_1) {
...
function trigger_array_delete_cafe(var_0, var_1) {
...
function evade_window_shoot_at() {
  ...
  scripts\engine\sp\utility::set_ignoreme(1);
  self waittill("goal");
  var_2 moveTo(var_1.origin, 3, 0.05, 0.05);
...
function evade_police_runby_retreat() {
  ...
  scripts\sp\maps\stpetersburg\stpetersburg_utility::waittill_alive_count(var_0, 1);
...
function runby_manager(var_0) {
  var_1 = 1;
  var_2 = getEnt("evade_police_cafe_windows", "targetname");

  foreach(var_4 in var_0) {
    thread go_to_targetname(var_4, "runby_struct_" + var_1);
    var_1++;
  }
}

function go_to_targetname(var_0, var_1) {
...
function evade_police_assault_extra() {
  ...
  if(isalive(var_1)) {
    var_1 scripts\engine\sp\utility::set_attackeraccuracy(1);
    return;
  }
}
...
function evade_animate_door(var_0, var_1, var_2, var_3, var_4) {
  if(!isDefined(var_3)) {
    var_3 = 0;
  }
...
function evade_molotov_throw(var_0, var_1) {
  var_2 = scripts\engine\utility::getStruct(var_0, "targetname");
...
function magic_molotov_fake_think(var_0) {
  var_0 endon("entitydeleted");
  var_1 = getmissileowner(var_0);
  var_0 waittill("missile_stuck", var_2, var_3, var_4, var_5, var_6, var_7);
  thread fake_molotov_explode(var_0, var_6, var_7, var_5, var_2);
  scripts\engine\utility::exploder("mtov_fx");
  playrumbleonposition("grenade_rumble", var_6);
  earthquake(0.3, 1, var_6, 400);
  var_0 delete();
}

function fake_molotov_explode(var_0, var_1, var_2, var_3, var_4) {
