...
function intro_scene_butcher_aq() {
  ...
  var_5 scripts\sp\maps\stpetersburg\stpetersburg_utility::disable_breath_fx();
  var_1 scripts\sp\maps\stpetersburg\stpetersburg_utility::disable_breath_fx();
  var_2 scripts\sp\maps\stpetersburg\stpetersburg_utility::disable_breath_fx();
...
function intro_stakeout_window_monitor(var_0) {
  level endon("missionfailed");
  level.player endon("death");
...
function intro_stakeout_door_clip(var_0) {
...
function waittill_lookat_price_or_door_or_delay(var_0, var_1) {
  level endon(var_0);
  level endon("missionfailed");
...
function bar_rotate_door(var_0, var_1, var_2) {
  if(!isDefined(var_2)) {
    var_2 = 0;
  }
  ...
  var_4 linkTo(var_3);
  var_3 rotateYaw(var_1, 1, 0.05, 0.05);
  wait 1;
...
function bar_animate_door(var_0, var_1, var_2, var_3, var_4, var_5) {
  if(!isDefined(var_3)) {
    var_3 = 0;
  }
  ...
  if(var_4 == 1) {
    ...
    var_7 setanimrate(var_7 scripts\engine\utility::getanim(var_2), 2);
    wait var_9 * 0.5;
  } else {
...
function alley_stealth_aq_setup() {
  ...
  var_10 = randomfloatrange(1, 3);

  if(var_0 == "price_ambush" && var_9 == "easy") {
    var_10 = randomfloatrange(5, 8);
  } else if(var_0 == "price_ambush" && var_9 == "medium") {
    var_10 = randomfloatrange(3, 5);
  }
...
function alley_stealth_enemies() {
  ...
  thread scripts\sp\maps\stpetersburg\stpetersburg_utility::price_clean_up_last_enemy(var_0, randomfloatrange(4, 6));
...
function alley_stealth_check_if_player_unholsters() {
  ...
  for(;;) {
    foreach(var_2 in var_0) {
      if(level.player istouching(var_2) && scripts\sp\maps\stpetersburg\stpetersburg_utility::player_weapon_holstered() == 0) {
        level notify("alley_alert");
        return;
      }
    }
...
function get_aq_for_shootout_anim(var_0) {
...
function kill_aq_for_shootout_anim() {
  ...
  scripts\sp\maps\stpetersburg\stpetersburg_utility::waittill_alive_count(var_0, 0);
...
function alley_stealth_price_combat() {
  ...
  if(var_0 == "flag_alley_stealth_cover_blown") {
    ...
    level.price scripts\anim\shared::forceuseweapon(var_1, "sidearm");
...
function alley_stealth_price_clean_house() {
  ...
  while(!scripts\engine\utility::flag("flag_alley_stealth_aq_dead")) {
    ...
    var_3 = scripts\sp\maps\stpetersburg\stpetersburg_utility::price_get_los_enemy(var_2);
...
function trigger_array_wait_then_delete(var_0, var_1) {
...
function bomb_room_enemies_handler() {
  ...
  thread scripts\sp\maps\stpetersburg\stpetersburg_utility::price_clean_up_last_enemy(var_1, randomfloatrange(4, 6));
  ...
  scripts\engine\utility::array_thread(var_1, &scripts\sp\maps\stpetersburg\stpetersburg_utility::set_attackeraccuracy_handler, 0.5, 1, "flag_bomb_room_enforcer_clear", 1);
...
function bomb_room_enemy_anim_new(var_0) {
  self endon("death");
  self endon("entitydeleted");
  self.animname = var_0;
...
function bomb_room_price_advance(var_0) {
  level.price scripts\engine\sp\utility::set_ignoreall(1);
  scripts\engine\utility::flag_wait_any("flag_player_blew_backroom_stealth", "flag_player_shoots_in_backroom", "flag_backroom_butcher_convo_over", "flag_backroom_player_seen_standing", "flag_player_jumps_in_backroom");
  scripts\sp\player::player_movement_state("default");
  level.price scripts\engine\sp\utility::set_ignoreall(0);
  ...
  for(;;) {
    ...
    if(bar_shootout_player_hiding()) {
      for(var_6 = 0; var_6 < var_5; var_6++) {
        ...
        wait var_4 * randomfloatrange(1, 3);
      }
...
function bar_shootout_retreat_enemy_handler() {
  ...
  foreach(var_2 in var_0) {
    thread bar_shootout_send_retreater_to_goal(var_2);
  }
...
function bar_shootout_send_retreater_to_goal(var_0) {
  self endon("death");
  self endon("entitydeleted");
...
function street_civs_flee(var_0, var_1, var_2, var_3, var_4) {
  wait var_4;
...
function bar_street_combat_handler() {
  ...
  thread scripts\sp\maps\stpetersburg\stpetersburg_utility::price_clean_up_last_enemy(var_0, randomfloatrange(10, 15));
...
function bar_street_aq_handler(var_0) {
  var_0 = scripts\engine\utility::array_removedead_or_dying(var_0);
...
function bar_street_aq_death_check(var_0) {
  scripts\sp\maps\stpetersburg\stpetersburg_utility::waittill_alive_count(var_0, 2);
  scripts\engine\utility::flag_set("flag_bar_street_aq_some_dead");
}

function bar_street_aq_door(var_0) {
...
function bar_street_enforcer_flee() {
  ...
  level.enforcer scripts\anim\shared::forceuseweapon(var_0, "primary");
...
function intro_scene_end(var_0) {
