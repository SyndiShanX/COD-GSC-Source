 ...
 * Script: scripts\sp\maps\estate\estate_anim.gsc
**************************************************/
...
function humans() {
  ...
  level.scr_goaltime["alq1"]["search_cabinet_loop"] = 0;
...
function script_models() {
  ...
  scripts\common\anim::addnotetrack_customfunction("fusebox", "handle_down", &scripts\sp\maps\estate\estate_util::fusebox_handle_down, "fusebox_interact");
