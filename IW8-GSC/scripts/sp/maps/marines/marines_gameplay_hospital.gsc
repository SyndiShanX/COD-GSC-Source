...
function groundfloor_extra_marines_handler() {
  ...
  if(var_1.size > 2) {
    for(var_2 = 2; var_2 < var_1.size; var_2++) {
      var_1[var_2] scripts\sp\maps\marines\marines_utility::switch_marine_color("g", "c");
      var_0 = scripts\engine\utility::array_add(var_0, var_1[var_2]);
    }
  }

  var_3 = scripts\sp\maps\marines\marines_utility::get_array_of_living_allies_by_color("b");

  if(var_3.size > 2) {
    for(var_2 = 2; var_2 < var_3.size; var_2++) {
      var_3[var_2] scripts\sp\maps\marines\marines_utility::switch_marine_color("b", "c");
...
function marine_groundfloor_room_clearing_manager() {
  ...
  thread scripts\sp\maps\marines\marines_utility::marine_room_clear_node("flag_groundfloor_room_1_cleared", var_0, var_1);
  thread scripts\sp\maps\marines\marines_utility::marine_room_clear_node("flag_groundfloor_room_2_cleared", var_2, var_3);
}
...
function groundfloor_tripwire_defuse_monitor() {
  ...
  thread scripts\sp\maps\marines\marines_utility::marines_tripwire_monitor(var_0, undefined, var_3, undefined, var_2, undefined, "flag_groundfloor_tripwire_defused");
}
...
function groundfloor_color_advance_manager() {
  ...
  thread groundfloor_color_handler(var_0);
  thread groundfloor_color_handler(var_1);
  thread groundfloor_color_handler(var_2);
  thread groundfloor_color_handler(var_3);
  thread groundfloor_color_handler(var_4);
  thread groundfloor_color_handler(var_5);
}

function groundfloor_color_handler(var_0) {
  self endon("deleted");
...
function groundfloor_civ_manager() {
  ...
  scripts\sp\maps\marines\marines_gameplay_civ_ambush::bed_civ_init(var_0, var_3, 0, 0, 0, 0, "body_civ_syrkistan_male_2_1", "head_sc_m_arakelyan_civ");
  scripts\sp\maps\marines\marines_gameplay_civ_ambush::bed_civ_init(var_1, var_4, 0, 1, 0, 1);
  var_7 = scripts\sp\maps\marines\marines_gameplay_civ_ambush::bed_civ_init(var_2, var_5, 0, 0, 0, 1);
...
function groundfloor_last_stand_handler(var_0, var_1) {
  self endon("death");
  self endon("entitydeleted");
  self.health = 50;
...
function groundfloor_last_stand_ignoreme_monitor(var_0) {
  self endon("death");
  self endon("entitydeleted");
...
function hall_rush_crutch_civs_handler() {
  ...
  anim_then_last_frame_and_kill(var_0, var_4, "crutch_runaway");
}
...
function anim_then_last_frame_and_kill(var_0, var_1) {
...
function hall_rush_civ_behavior(var_0, var_1) {
  self endon("death");
  ...
  if(var_1 == 0) {
    ...
    if(isDefined(var_2.target)) {
      ...
      scripts\sp\maps\marines\marines_utility::color_node_arrive(var_2);
...
function hall_rush_gunner_target_handler() {
  ...
  var_3 scripts\engine\sp\utility::set_allowdeath(1);
  var_3.ignoreme = 1;
  var_1 scripts\common\anim::anim_single_solo(var_3, "hallway_ambush", undefined, 3);
...
function lobby_start() {
  ...
  thread scripts\sp\maps\marines\marines_utility::marines_checkpoint_forcespawn_allies(var_2);
