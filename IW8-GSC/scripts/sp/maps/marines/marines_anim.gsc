 ...
 * Script: scripts\sp\maps\marines\marines_anim.gsc
****************************************************/
...
function player_anims() {
  ...
  scripts\common\anim::addnotetrack_customfunction("player_rig", "air_vehicles_distant", &scripts\sp\maps\marines\marines_background::air_vehicles_distant, "introSequence");
}

function fake_actor_anims() {
...
function vehicles() {
  ...
  level.scr_goaltime["retreat_tank"]["retreat_assault_vehicle_destroyed"] = 0;
}
