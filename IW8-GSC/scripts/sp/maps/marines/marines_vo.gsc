 ...
 * Script: scripts\sp\maps\marines\marines_vo.gsc
**************************************************/

function vo_intro_marine_oorah_dialogue() {
...
function vo_intro_nag_manager_1() {
  scripts\engine\utility::flag_wait("intro_cinematic_complete");
  wait 4;
  ...
  while(!scripts\engine\utility::flag("door_kick_vignette_flag")) {
    ...
    if(!scripts\engine\utility::flag("door_kick_vignette_flag")) {
      ...
      scripts\sp\maps\marines\marines_utility::marines_intro_glanceback(0.3);
    }
  }
...
function vo_intro_nag_manager_2() {
...
function vo_intro_nag_manager_3() {
...
function vo_convoy_griggs_move_out_dialogue() {
  ...
  wait 1;
  level.griggs scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_igc_intro_200", undefined, undefined, undefined, undefined, level.player);

  if(!scripts\engine\utility::flag("vo_flag_convoy_rush")) {
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_intro_street_10", undefined, undefined, undefined, undefined, level.player);
    level.vo_convoy_griggs_move_out_dialogue_done = 1;
    return;
  }
}

function vo_convoy_viper_arriving_dialogue() {
  ...
  if(!scripts\engine\utility::flag("vo_flag_convoy_rush")) {
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_convoy_apc("dx_vom_usd1_intro_street_20", undefined, undefined, undefined, 1);
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_intro_street_30");
  }

  scripts\sp\maps\marines\marines_utility::add_dialogue_line_convoy_apc("dx_vom_usd1_intro_street_40", undefined, undefined, undefined, 1);
  ...
  if(!scripts\engine\utility::flag("vo_flag_tripwire_approach")) {
    if(!scripts\engine\utility::flag("vo_flag_tripwire_approach")) {
      scripts\sp\maps\marines\marines_utility::add_dialogue_line_convoy_apc("dx_vom_usd1_intro_street_60", undefined, undefined, undefined, 1);
...
function vo_convoy_sledgehammer_dialogue() {
  if(isDefined(level.introdoorbreachmarines[1]) && isalive(level.introdoorbreachmarines[1])) {
    level.introdoorbreachmarines[1] scripts\sp\maps\marines\marines_utility::add_dialogue_line_marine("dx_vom_us1_intro_clearance_10");
  }

  if(isDefined(level.introdoorbreachmarines[2]) && isalive(level.introdoorbreachmarines[2])) {
    level.introdoorbreachmarines[2] scripts\sp\maps\marines\marines_utility::add_dialogue_line_marine("dx_vom_us2_intro_clearance_20");
  }

  if(isDefined(level.introdoorbreachmarines[3]) && isalive(level.introdoorbreachmarines[3])) {
    level.introdoorbreachmarines[3] scripts\sp\maps\marines\marines_utility::add_dialogue_line_marine("dx_vom_us4_intro_clearance_270");
  }

  scripts\engine\utility::flag_wait("play_sledge_dialogue");

  if(isDefined(level.introdoorbreachmarines[1]) && isalive(level.introdoorbreachmarines[1])) {
    level.introdoorbreachmarines[1] scripts\sp\maps\marines\marines_utility::add_dialogue_line_marine("dx_vom_us4_intro_clearance_270");
  }

  if(isDefined(level.introdoorbreachmarines[2]) && isalive(level.introdoorbreachmarines[2])) {
    level.introdoorbreachmarines[2] scripts\sp\maps\marines\marines_utility::add_dialogue_line_marine("dx_vom_us1_intro_clearance_60");
    return;
  }
}
...
function vo_convoy_alex_tripwire_callout_dialogue() {
  ...
  if(!scripts\engine\utility::flag("tripwire_cleared_flag")) {
    ...
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_groundfloor_combat_60");
    thread convoy_tripwire_nag_handler();
    return;
  }
}

function vo_convoy_griggs_tripwire_callout_dialogue() {
  ...
  if(!scripts\engine\utility::flag("tripwire_cleared_flag")) {
    ...
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_intro_tripwires_20", undefined, undefined, undefined, undefined, undefined, undefined, undefined, "dx_vom_grg_intro_tripwires_21");
    thread convoy_tripwire_nag_handler();
  }
  ...
  if(!scripts\engine\utility::flag("tripwire_cleared_flag")) {
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_intro_tripwires_80");
    return;
  }
}

function convoy_tripwire_nag_handler() {
  wait 7;
...
function vo_convoy_tutorial_tripwire_disabled_dialogue() {
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_intro_tripwires_90");
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_intro_tripwires_110");
}
...
function vo_convoy_griggs_ahead_nag_dialogue() {
  if(scripts\engine\utility::cointoss()) {
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_intro_street_80", undefined, undefined, undefined, undefined, undefined, undefined, undefined, "dx_vom_grg_intro_street_81");
    return;
  }

  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_intro_street_100", undefined, undefined, undefined, undefined, undefined, undefined, undefined, "dx_vom_grg_intro_street_101");
}

function vo_murderhole_griggs_ied_dialogue() {
...
function vo_murderhole_alex_throws_smokes_dialogue() {
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_murderhole_smoke_130");
}

function vo_murderhole_griggs_smoke_advance_dialogue() {
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_murderhole_smoke_140");
}

function vo_murderhole_griggs_alley_dialogue() {
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_civ_ambush_corridor_110");
}

function vo_alley_griggs_mg_warning() {
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_mg_hall_assault_112", undefined, undefined, undefined, undefined, undefined, undefined, undefined, "dx_vom_grg_mg_hall_assault_113");
}
...
function vo_alley_mg_initial_callout_dialogue() {
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_alley_approach_30", undefined, undefined, undefined, undefined, undefined, undefined, undefined, "dx_vom_grg_murderhole_breach_door_51");
}
...
function vo_alley_scripted_push_up_dialogue() {
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_murderhole_smoke_50", undefined, undefined, undefined, undefined, undefined, undefined, undefined, "dx_vom_grg_murderhole_smoke_51");
}
...
function vo_mhbreach_griggs_breach_dialogue() {
  ...
  if(!scripts\engine\utility::flag("ready_to_breach_MH")) {
    if(scripts\engine\utility::cointoss()) {
      scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_murderhole_breach_door_50", undefined, undefined, undefined, undefined, undefined, undefined, undefined, "dx_vom_grg_murderhole_breach_door_51");
    } else {
      scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_murderhole_breach_door_60", undefined, undefined, undefined, undefined, undefined, undefined, undefined, "dx_vom_grg_murderhole_breach_door_61");
    }

    wait 2;

    if(!scripts\engine\utility::flag("kitchen_trigger")) {
      scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_alley_approach_120");
    }
...
function vo_mhbreach_alex_kitchen_clear_dialogue() {
  wait 1;
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_murderhole_breach_firstfloor_10");
}

function vo_mhbreach_alex_stairs_climbing_dialogue() {
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_murderhole_breach_firstfloor_20");
  wait 1;
...
function vo_mhbreach_alex_tripwire_dialogue() {
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_murderhole_breach_tripwires_30");
}
...
function vo_mhbreach_alex_bedroom_clear_dialogue() {
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_retreat_rally_10");
}
...
function vo_mhbreach_alex_staircase_dialogue() {
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_murderhole_breach_thirdfloor_10");
  wait 0.5;
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_murderhole_breach_thirdfloor_20");

  if(!scripts\engine\utility::flag("player_entered_mg_room") && !scripts\engine\utility::flag("mg_team_alerted")) {
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_murderhole_breach_thirdfloor_30");
    return;
  }
}
...
function vo_retreat_alex_mh_clear_dialogue() {
  ...
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_retreat_rally_10");
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_retreat_rally_30");

  if(!scripts\engine\utility::flag("flag_vo_retreat_griggs_heli_fast")) {
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_retreat_helos_10");
    level.griggs_retreat_line_done = 1;

    if(!scripts\engine\utility::flag("flag_retreat_exiting_mg_house")) {
      scripts\sp\maps\marines\marines_utility::add_dialogue_line_heli_pilot("dx_vom_usgp_retreat_helos_20", undefined, undefined, undefined, 1);
    }
  ...
  if(!scripts\engine\utility::flag("flag_retreat_exiting_mg_house_vehicle_move")) {
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_retreat_helos_11");
    level.griggs_retreat_line_done = 1;
...
function vo_retreat_exit_sprint_monitor() {
...
function vo_retreat_alex_nags() {
  ...
  while(!scripts\engine\utility::flag("flag_retreat_exiting_mg_house")) {
    if(!scripts\engine\utility::flag("flag_retreat_player_response")) {
      if(!scripts\engine\utility::flag("flag_retreat_exiting_mg_house")) {
        scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_retreat_rally_60");
      }
    }
    ...
    if(!scripts\engine\utility::flag("flag_retreat_player_response")) {
      if(!scripts\engine\utility::flag("flag_retreat_exiting_mg_house")) {
        scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_murderhole_smoke_150");
      }
    }
...
function vo_retreat_helo_air_support_intro_dialogue() {
  level.griggs thread scripts\sp\maps\marines\marines_utility::dialogue_stop();
  waitframe();
  thread scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_retreat_helos_40");
  wait 3;
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_heli_pilot("dx_vom_usgp_retreat_helos_50", undefined, undefined, undefined, 1);
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_retreat_helos_60");
}
...
function vo_retreat_marine_advance_reactions_dialogue() {
  scripts\engine\utility::flag_wait("flag_retreat_advance_2");
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_retreat_hospital_90", undefined, undefined, undefined, undefined, undefined, undefined, undefined, "dx_vom_grg_retreat_hospital_91");
  wait 3;
...
function vo_retreat_griggs_advance_nags() {
  level endon("missionfailed");
  level.player endon("death");
  ...
  while(!scripts\engine\utility::flag("murderhole_shadow_adjustment_end")) {
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_murderhole_smoke_150", undefined, undefined, undefined, undefined, undefined, undefined, undefined, "dx_vom_grg_murderhole_smoke_151");
    wait randomfloatrange(10, 15);
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_murderhole_smoke_160", undefined, undefined, undefined, undefined, undefined, undefined, undefined, "dx_vom_grg_murderhole_smoke_161");
    wait randomfloatrange(10, 15);
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_murderhole_smoke_170", undefined, undefined, undefined, undefined, undefined, undefined, undefined, "dx_vom_grg_murderhole_smoke_171");
    wait randomfloatrange(15, 20);
  }
}
...
function vo_retreat_marine_advance_ambush_initial_dialogue() {
  ...
  if(!scripts\engine\utility::flag("flag_retreat_rpg_killed")) {
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_alley_combat_50");
    return;
  }
}
...
function vo_retreat_griggs_advance_dialogue() {
  ...
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_lobby_entrance_100", undefined, undefined, undefined, undefined, undefined, undefined, undefined, "dx_vom_grg_lobby_entrance_101");
}

function vo_lobby_griggs_secure_lobby_dialogue() {
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_murderhole_smoke_140");
}
...
function vo_lobby_marines_secured_dialogue() {
  level.griggs_lobby_cleared_vo_done = 0;
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_groundfloor_door_10", undefined, undefined, undefined, undefined, undefined, undefined, undefined, "dx_vom_grg_groundfloor_door_11");
  ...
  if(!scripts\engine\utility::flag("flag_groundfloor_hallway_ambush_start") && distance2d(level.player.origin, level.griggs.origin) < 750) {
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_groundfloor_door_20");
    wait 0.5;
    ...
    if(!scripts\engine\utility::flag("flag_groundfloor_hallway_ambush_start")) {
      ...
      if(!scripts\engine\utility::flag("flag_groundfloor_hallway_ambush_start") && distance2d(level.player.origin, level.griggs.origin) < 750) {
        scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_groundfloor_door_40");
        return;
      }
...
function vo_groundfloor_alex_tripwire_defused_dialogue() {
...
function vo_groundfloor_alex_corner_dialogue() {
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_groundfloor_combat_120");
}

function vo_civambush_griggs_stairwell_advance_dialogue() {
  ...
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_civ_ambush_stairs_10");
  level.griggs_vo_civambush_speaking = 0;
  wait 1;
  thread vo_civambush_group_progress_dialogue();
}

function vo_civambush_group_progress_dialogue() {
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_civ_ambush_stairs_60");
  ...
  if(isDefined(level.alex_speaking_stairwell_secure_speaking) && level.alex_speaking_stairwell_secure_speaking == 0 && !scripts\engine\utility::flag("flag_civ_ambush_griggs_react_vo")) {
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_civ_ambush_stairs_70");
    wait 0.5;
    level.griggs_vo_civambush_speaking = 1;
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_civ_ambush_stairs_80");
    level.griggs_vo_civambush_speaking = 0;
    return;
  }

  if(!scripts\engine\utility::flag("flag_civ_ambush_griggs_react_vo")) {
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_civ_ambush_stairs_70");
    wait 0.5;
    level.griggs_vo_civambush_speaking = 1;
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_civ_ambush_stairs_80");
...
function vo_civambush_marine_intro_dialogue() {
  ...
  level.griggs_vo_civambush_speaking = 1;
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_civ_ambush_triage_20");
  level.griggs_vo_civambush_speaking = 0;
  wait 0.5;
...
function vo_civambush_alex_take_point() {
  ...
  for(;;) {
    if(level.griggs_vo_civambush_speaking == 1) {
      ...
      if(!scripts\engine\utility::flag("flag_ambusher_killed_clear_vo")) {
        scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_civ_ambush_triage_60", undefined, undefined, undefined, undefined, level.player);
      }
...
function vo_civ_ambush_friendly_hands_up_dialogue() {
...
function vo_civ_ambush_alex_dialogue() {
  scripts\engine\utility::flag_wait("flag_alex_vo_corridor");
  level.griggs_vo_civambush_speaking = 1;
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_civ_ambush_corridor_60", undefined, undefined, undefined, undefined, undefined, undefined, undefined, "dx_vom_grg_civ_ambush_corridor_61");
  wait 0.25;
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_radio("dx_vom_us3_civ_ambush_corridor_10", undefined, undefined, undefined, 1);
  level.griggs_vo_civambush_speaking = 0;
...
function vo_civ_ambush_ambusher_killed_dialogue() {
  if(isalive(level.player)) {
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_civ_ambush_gun_100");
...
function vo_mghall_marines_intro_dialogue() {
  ...
  wait 3;
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_mg_hall_assault_40");
  wait 2;
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_mg_hall_assault_50", undefined, undefined, undefined, undefined, undefined, undefined, undefined, "dx_vom_grg_mg_hall_assault_51");
  wait 4;
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_mg_hall_assault_120");
}

function vo_mghall_griggs_shoot_nag_1_dialogue() {
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_mg_hall_assault_130", undefined, undefined, undefined, undefined, undefined, undefined, undefined, "dx_vom_grg_mg_hall_assault_131");
}

function vo_mghall_griggs_shoot_nag_2_dialogue() {
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_mg_hall_assault_140", undefined, undefined, undefined, undefined, undefined, undefined, undefined, "dx_vom_grg_mg_hall_assault_141");
}
...
function vo_mghall_smoked_dialogue_handler() {
...
function vo_mghall_griggs_smoked_dialogue() {
  level.mg_hall_griggs_smoke_vo_done = 0;
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_civ_ambush_corridor_110");
  level.mg_hall_griggs_smoke_vo_done = 1;
}

function vo_mghall_alex_tripwire_l_defused_dialogue() {
...
function vo_mghall_alex_tripwire_r_defused_dialogue() {
...
function vo_mghall_griggs_gunner_dead_alex_dialogue() {
  ...
  if(!scripts\engine\utility::flag("flag_snakecam_tripwire_cleared")) {
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_mg_hall_assault_150");

    if(distance2d(level.player.origin, level.griggs.origin) < 1000) {
      scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_mg_hall_assault_160");
    }
...
function vo_mghall_marine_clear_dialogue() {
  level.mg_hall_cleared_vo_done = 0;
  wait 1;
  scripts\engine\utility::flag_wait("flag_mg_hall_cleared");
...
function vo_snakecam_griggs_tripwire_start_dialogue() {
  scripts\engine\utility::flag_wait("flag_mg_hall_cleared");
...
function vo_snakecam_griggs_snakecam_start_dialogue() {
  if(!scripts\engine\utility::flag("snakecam_enable_flag")) {
    if(isDefined(level.snakecam_marine) && isalive(level.snakecam_marine)) {
      ...
      level.snakecam_marine scripts\sp\maps\marines\marines_utility::add_dialogue_line_marine("dx_vom_us3_snakecam_wolfdoor_30");
    }
  }
  ...
  if(isDefined(level.snakecam_marine) && isalive(level.snakecam_marine)) {
    level.snakecam_marine scripts\sp\maps\marines\marines_utility::add_dialogue_line_marine("dx_vom_us3_snakecam_wolfdoor_40");
    return;
  }
}

function vo_snakecam_griggs_snakecam_ready_dialogue() {
  wait 3;

  if(!scripts\engine\utility::flag("flag_wolf_snakecam_starting")) {
    level.snakecam_griggs_setup_vo_done = 0;
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_snakecam_wolfdoor_50", undefined, undefined, undefined, undefined, level.player, undefined, undefined, "dx_vom_grg_snakecam_wolfdoor_51");
  ...
  if(!scripts\engine\utility::flag("flag_wolf_snakecam_starting")) {
    level.snakecam_griggs_setup_vo_done = 0;
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_snakecam_wolfdoor_60", undefined, undefined, undefined, undefined, level.player, undefined, undefined, "dx_vom_grg_snakecam_wolfdoor_61");
    level.snakecam_griggs_setup_vo_done = 1;
  }
  ...
  if(!scripts\engine\utility::flag("flag_wolf_snakecam_starting")) {
    level.snakecam_griggs_setup_vo_done = 0;
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_snakecam_wolfdoor_70", undefined, undefined, undefined, undefined, level.player, undefined, undefined, "dx_vom_grg_snakecam_wolfdoor_71");
    level.snakecam_griggs_setup_vo_done = 1;
  }
  ...
  if(!scripts\engine\utility::flag("flag_wolf_snakecam_starting")) {
    level.snakecam_griggs_setup_vo_done = 0;
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_mg_hall_tripwires_240", undefined, undefined, undefined, undefined, level.player, undefined, undefined, "dx_vom_grg_mg_hall_tripwires_241");
    level.snakecam_griggs_setup_vo_done = 1;
    return;
  }
}

function vo_snakecam_wolf_speech_dialogue() {
  ...
  if(!scripts\engine\utility::flag("flag_wolf_snakecam_complete")) {
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_snakecam_hostage_20");
  }
...
function vo_snakecam_wolf_dialogue() {
  if(!scripts\engine\utility::flag("flag_wolf_snakecam_complete")) {
    scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_snakecam_hostage_30");
  }
  ...
  if(!scripts\engine\utility::flag("flag_wolf_snakecam_complete")) {
    thread scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_snakecam_hostage_40");
  }
...
function vo_snakecam_hostage_dialogue() {
  scripts\engine\utility::flag_wait("flag_snakecam_hostage_kicked");
}

function vo_wolf_alex_start_dialogue() {
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_wolf_capture_10");
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_wolf_capture_20", undefined, undefined, undefined, undefined, level.player);
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_wolf_capture_41", undefined, undefined, undefined, undefined, level.player);
...
function vo_wolf_alex_tripwire_approach_dialogue() {
  level.wolf_tripwire_set_vo_done = 0;
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_hospital_wolf_room_10");
  level.wolf_tripwire_set_vo_done = 1;
}

function vo_wolf_alex_tripwire_encountered_dialogue() {
  while(level.wolf_tripwire_set_vo_done == 0) {
    waitframe();
  }

  if(isalive(level.player)) {
    thread scripts\sp\maps\marines\marines_utility::add_dialogue_line_alex("dx_vom_alx_hospital_wolf_room_30");
    return;
  }
}
...
function vo_wolf_alex_tripwire_cleared_dialogue() {
  scripts\engine\utility::flag_wait("flag_wolf_breach_gundown");
  scripts\sp\maps\marines\marines_utility::add_dialogue_line_griggs("dx_vom_grg_wolf_capture_50");
}
