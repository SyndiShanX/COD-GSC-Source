...
function heli_sound_handler(var_0, var_1) {
  waitframe();
  ...
  if(isDefined(var_0) && var_0 == "heli_mosoleum_flyby") {
  ...
  if(isDefined(var_0) && var_0 == "helis_convoy_overhead") {
    if(isDefined(var_1) && var_1 == 1) {
  ...
  if(isDefined(var_0) && var_0 == "helis_convoy_overhead_detonated") {
    if(isDefined(var_1) && var_1 == 1) {
  ...
  if(isDefined(var_0) && var_0 == "helis_surround_hospital") {
    if(isDefined(var_1) && var_1 == 1) {
  ...
  if(isDefined(var_0) && var_0 == "streets_loop_helis") {
    thread streets_loop_helis_1();
    return;
  }

  if(isDefined(var_0) && var_0 == "flank_alley_helis") {
    if(isDefined(var_1) && var_1 == 1) {
  ...
  if(isDefined(var_0) && var_0 == "window_passby_helis") {
    if(isDefined(var_1) && var_1 == 1) {
  ...
  if(isDefined(var_0) && var_0 == "helis_house_stairs_window") {
    thread helis_house_stairs_window_1();
    return;
  }

  if(isDefined(var_0) && var_0 == "helis_if_you_look_backwards") {
    thread helis_if_you_look_backwards_1();
    return;
  }

  if(isDefined(var_0) && var_0 == "retreat_heli_right") {
    thread retreat_heli_right_1();
    return;
  }

  if(isDefined(var_0) && var_0 == "retreat_heli_left") {
    thread retreat_heli_left_1();
    return;
  }

  if(isDefined(var_0) && var_0 == "heli_stairwell") {
    if(isDefined(var_1) && var_1 == 1) {
  ...
  if(isDefined(var_0) && var_0 == "heli_civ_ambush") {
    self vehicle_turnengineoff();
    thread heli_civ_ambush_1();
    return;
  }

  if(isDefined(var_0) && var_0 == "wolf_room_heli") {
    self vehicle_turnengineoff();
...
function air_vehicles_distant(var_0) {
...
function hospital_ground_vehicle_movement_sound(var_0, var_1) {
  self endon("death");
  var_2 = 1;
  var_3 = 0.05;
  var_4 = 0.2;
  ...
  jumpiffalse(isDefined(var_1)) LOC_00000067;
...
function bg_aa_fire_tracer_fx(var_0) {
  var_0 endon("death");
...
function wolf_balcony_apc_handler() {
  var_0 = scripts\sp\maps\marines\marines_utility::setup_named_vehicle("wolf_background_apc_1", "Stormin Norman", "wolf_background_apc_1_start", 0, 0);
  var_1 = scripts\sp\maps\marines\marines_utility::setup_named_vehicle("wolf_background_apc_2", "Sticky Treads", "wolf_background_apc_2_start", 0, 0);
  var_2 = scripts\sp\maps\marines\marines_utility::setup_named_vehicle("wolf_background_apc_3", "Hollywood", "wolf_background_apc_3_start", 0, 0);
  var_3 = scripts\sp\maps\marines\marines_utility::setup_named_vehicle("wolf_background_apc_4", "Beagle", "wolf_background_apc_4_start", 0, 0);
