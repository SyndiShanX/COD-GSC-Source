...
function retreat_main() {
  ...
  var_4 = scripts\sp\maps\marines\marines_utility::get_array_of_living_allies_by_color("g");
  ...
  var_8 = scripts\sp\maps\marines\marines_utility::get_array_of_living_allies_by_color("b");
  ...
  thread apc_turret_behavior(level.retreat_assault_vehicle, var_16);
  wait 2;
...
function advance_tank_bullet_pings() {
  ...
  while(!scripts\engine\utility::flag("flag_retreat_trigger_counterattack")) {
    ...
    retreat_building_magic_bullets_fire_bradley_ping(var_3, level.retreat_assault_vehicle, randomintrange(2, 5));
...
function retreat_aq_counterattack_rooftop_handler() {
  ...
  foreach(var_5 in var_3) {
    if(isDefined(var_5)) {
      thread rpg_guy_force_kill(var_5);
    }
...
function rpg_guy_force_kill(var_0) {
...
function retreat_rpg_detonation_manager() {
  ...
  while(!scripts\engine\utility::flag("flag_groundfloor_hallway_ambush_start")) {
    ...
    thread retreat_rpg_detonation_monitor(var_1, var_0);
    waitframe();
  }
}

function retreat_rpg_detonation_monitor(var_0, var_1) {
  ...
  foreach(var_11 in var_9) {
    if(isDefined(var_11) && isalive(var_11) && var_7 < 4) {
      if(var_7 == 0 && !scripts\engine\utility::flag("flag_retreat_player_on_stairs")) {
        ...
        thread player_using_staircase_monitor(var_11, var_0);
      ...
      if(var_7 == 1 && !scripts\engine\utility::flag("flag_retreat_player_on_stairs")) {
        ...
        thread player_using_staircase_monitor(var_11, var_2);
...
function player_using_staircase_monitor(var_0, var_1) {
  self endon("death");
...
function marine_retreat_advance() {
  ...
  level.retreat_assault_vehicle.script_badplace = 1;
  var_13 = scripts\sp\maps\marines\marines_utility::get_array_of_living_allies_by_color("b");
  var_14 = scripts\sp\maps\marines\marines_utility::get_array_of_living_allies_by_color("g");
...
function marine_advance_with_util(var_0, var_1, var_2, var_3) {
  var_4 = 1;
  var_5 = 0;
    ...
    if(isDefined(var_8) && isalive(var_8)) {
      if(var_3 <= var_2.size) {
        if(var_5 < var_4) {
          ...
          thread marine_advance_faketarget_shoot_handler(var_8);
          var_5++;
          var_8.poi_enabled = 0;
        }
        ...
        if(isDefined(var_8.goalnode)) {
          if(isDefined(var_8.goalnode.target)) {
            ...
            var_8 thread scripts\sp\maps\marines\marines_utility::marine_path_util(var_11, undefined, undefined, undefined, undefined, 0);
          ...
          var_8 thread scripts\sp\maps\marines\marines_utility::marine_path_util(var_2[var_3], undefined, undefined, undefined, undefined, 0);
...
function marine_advance_faketarget_shoot_handler(var_0) {
  self endon("death");
  self endon("entitydeleted");
  ...
  while(var_14.size > var_12) {
    ...
    if(isDefined(var_5.node)) {
      switch (var_5.node.type) {
        case "Cover Stand":
          if(var_17 == 1) {
            var_5 scripts\sp\maps\marines\marines_utility::force_long_death(7);
          } else {
            var_5 kill();
          }
        ...
        case "Cover Left":
          if(var_18 == 1) {
            var_5 scripts\sp\maps\marines\marines_utility::force_long_death(9);
          } else {
            var_5 kill();
          }
        ...
        case "Cover Right":
          if(var_19 == 1) {
            var_5 scripts\sp\maps\marines\marines_utility::force_long_death(13);
          } else {
            var_5 kill();
          }
  ...
  foreach(var_4 in var_1) {
    if(isDefined(var_4) && isalive(var_4)) {
      if(var_0.size > 0) {
        ...
        var_4 scripts\sp\maps\marines\marines_utility::add_dialogue_line_aq(scripts\engine\utility::random(var_2));
        var_4 cleargoalvolume();
        var_4 setgoalvolumeauto(var_5);
        var_0 = scripts\engine\utility::array_remove(var_0, var_5);
      } else {
        var_1 = getEntArray("bombardment_initial_cover_volume", "targetname");
        waitframe();
        var_5 = scripts\engine\utility::getclosest(var_6.origin, var_1);
        var_6 cleargoalvolume();
        var_6 setgoalvolumeauto(var_5);
...
function bombardment_aq_window_target_player_manager() {
  ...
  while(!scripts\engine\utility::flag("flag_retreat_exiting_mg_house")) {
    ...
    if(!scripts\engine\utility::flag("flag_retreat_exiting_mg_house")) {
      ...
      thread retreat_building_magic_bullets(var_0, undefined, undefined, undefined, 1, 1, 1);
      level.bombardment_window_kills = 0;
      wait randomfloatrange(5, 7.5);
      var_0 notify("disable_magic_bullets");
      thread retreat_building_magic_bullets(var_0, level.bombardment_window_ground_bullet_targets, undefined, undefined, 0, 0, 1);
    }
  }
...
function enable_tank_stackup(var_0, var_1, var_2) {
  waitframe();
  var_0 moveTo(var_1.origin, 0.1);
  wait 1;
  var_0 disconnectPaths();
...
function clear_tank_stackup(var_0, var_1, var_2) {
  waitframe();
  var_0 moveTo(var_2.origin, 0.1);
  wait 1;
  var_0 connectpaths();
...
function retreat_gate_breach_marines() {
  ...
  if(var_8 == 0) {
    ...
    var_7[0] scripts\anim\shared::forceuseweapon(var_12, "primary");
  }
...
function apc_turret_behavior(var_0, var_1) {
...
function apc_fire_main_cannon(var_0, var_1) {
...
function apc_turret_scanning_behavior(var_0) {
  self endon("death");
  self endon("entitydeleted");
  var_1 = undefined;
  var_2 = undefined;
...
function retreat_building_magic_bullets(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
...
function retreat_building_magic_bullets_fire(var_0, var_1, var_2, var_3) {
  self endon("disable_magic_bullets");
  var_4 = var_0.origin;
  var_5 = undefined;
...
function retreat_building_magic_bullets_fire_bradley_ping(var_0, var_1) {
...
function retreat_heli_left_deploy() {
  ...
  thread heli_strafing_run(level.retreat_heli_left, 0, 50, 10, 5, 500, 0, 1, undefined, "flag_retreat_bombardment_heli_left_complete", var_0);
}
...
function retreat_heli_right_deploy() {
  ...
  thread heli_strafing_run(level.retreat_heli_right, 1, 100, 15, 10, 500, 1, 1, "flag_retreat_bombardment_heli_left_complete", "flag_retreat_bombardment_heli_right_complete", var_0);
}

function heli_strafing_run(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10) {
...
function heli_fire_rocket_at_building(var_0, var_1, var_2, var_3) {
  var_4 = self.origin;
  var_5 = self.angles;
...
function heli_idle_movement(var_0) {
  var_1 = undefined;
...
function heli_rocket_fire(var_0) {
...
function gate_collapse_rumble_handler(var_0) {
...
function delete_alley_trucks_monitor() {
  scripts\engine\utility::flag_wait("flag_retreat_trigger_counterattack");
  var_0 = scripts\sp\maps\marines\marines_utility::get_all_script_models_with_modelname("veh8_civ_lnd_techo_static_dst_black");

  foreach(var_2 in var_0) {
    var_2 thread scripts\sp\maps\marines\marines_utility::delete_when_offscreen(1500);
  }
}
...
function retreat_marine_bombardment_reaction_dialogue() {
  ...
  var_0 scripts\sp\maps\marines\marines_vo::vo_retreat_marine_bombardment_reaction_dialogue();
  wait 4;
