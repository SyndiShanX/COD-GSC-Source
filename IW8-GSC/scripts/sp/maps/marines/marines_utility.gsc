...
function setup_named_ai(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
...
function setup_named_ai_after_spawn(var_0, var_1, var_2, var_3, var_4, var_5) {
  if(!isDefined(var_1)) {
    var_1 = var_0;
  }
...
function switch_marines_from_color_to_color(var_0, var_1) {
  var_2 = get_array_of_living_allies_by_color(var_0);

  if(var_2.size > 0) {
    foreach(var_4 in var_2) {
      if(isalive(var_4)) {
        switch_marine_color(var_4, var_0, var_1);
      }
    }
...
function switch_marine_color(var_0, var_1) {
  if(!isDefined(var_0)) {
...
function display_ai_count(var_0) {
...
function setup_marine_allies(var_0, var_1, var_2, var_3) {
  ...
  foreach(var_11 in level.colorspawners) {
...
function marine_callsign_picker(var_0) {
...
function add_spawner_to_color_spawner_array(var_0, var_1) {
...
function flood_spawn_allies(var_0) {
...
function get_array_of_living_allies_by_color(var_0) {
  level.allymarines[var_0] = scripts\engine\utility::array_removedead_or_dying(level.allymarines[var_0]);
  level.allymarines["all"] = scripts\engine\utility::array_removedead_or_dying(level.allymarines["all"]);
  return level.allymarines[var_0];
}

function setup_named_vehicle(var_0, var_1, var_2, var_3, var_4, var_5) {
  if(!isDefined(var_3)) {
    var_3 = 0;
  }
  ...
  if(var_7.classname == "script_vehicle_iw8_apc_stango") {
    ...
    vehicle_turret_init(var_7);
  }

  return var_7;
}

function vehicle_nav_repulsor(var_0) {
...
function delete_barricaded_door_boards(var_0) {
...
function check_los_and_proximity(var_0) {
  var_1 = sighttracepassed(self getEye(), var_0 getEye(), 0, var_0);
  var_2 = distance(self.origin, var_0.origin) <= 400;
  return var_1 && var_2;
}

function marine_airstrike_group(var_0, var_1, var_2, var_3, var_4) {
  if(!isDefined(var_1)) {
    var_1 = 0;
  }
...
function marine_airstrike_single(var_0, var_1, var_2, var_3) {
  var_4 = scripts\engine\sp\utility::spawn_anim_model("a10", self.origin, self.angles);
  thread a10_play_contrail();

  if(var_0 == 1) {
    thread marine_airstrike_bombing_run(var_4, var_1);
  }
...
function a10_airstrike_fx(var_0) {
...
function marine_airstrike_bombing_run(var_0, var_1) {
  self endon("death");
  self endon("entitydeleted");
  wait var_0;
...
function add_dialogue_line_alex(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  if(isDefined(level.player) && isalive(level.player)) {
    level.player.name = "Alex";
    level.player.team = "allies";
    dialogue(level.player, var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7);
    return;
  }
}

function add_dialogue_line_heli_pilot(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  dialogue(level.pilot_dialog_struct, var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7);
}

function add_dialogue_line_convoy_apc(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  dialogue(level.convoy_apc_dialog_struct, var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7);
}

function add_dialogue_line_radio(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  dialogue(level.radio_dialog_struct, var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7);
}

function add_dialogue_line_griggs(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8) {
  if(isDefined(level.griggs)) {
    level.griggs.name = "Sgt. Griggs";
    level.griggs.team = "allies";
    dialogue(level.griggs, var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8);
    return;
  }

  if(!soundexists(var_0)) {
    dialogue(level.griggs_dialog_struct, var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8);
    return;
  }
}

function add_dialogue_line_civ_ambusher(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  if(isDefined(level.civ_ambusher)) {
    level.civ_ambusher.name = "Disguised AQ";
    thread dialogue(level.civ_ambusher, var_0, var_1, var_2, var_3, var_4, var_5, var_6);
  } else if(!soundexists(var_0)) {
    thread dialogue(level.civilian_ambusher_dialog_struct, var_0, var_1, var_2, var_3, var_4, var_5, var_6);
  }

  level.civ_ambusher scripts\engine\sp\utility::name_hide();
}

function add_dialogue_line_wolf(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  if(isDefined(level.wolf)) {
    level.wolf.name = "^1Wolf";
    level.wolf.callsign = "^1Omar Sulaman";
    level.wolf.team = "axis";
    dialogue(level.wolf, var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7);
    return;
  }

  if(!soundexists(var_0)) {
    dialogue(level.wolf_dialog_struct, var_0, var_1, var_2, var_3, var_4);
    return;
  }
}

function add_dialogue_line_marine(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8) {
  ...
  if(!soundexists(var_0)) {
    dialogue(level.marine_dialog_struct, var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8);
    return;
  }
}

function add_dialogue_line_aq(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  if(isDefined(self) && isalive(self) && isai(self)) {
  ...
  if(!soundexists(var_0)) {
    dialogue(level.aq_soldier_dialog_struct, var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7);
    return;
  }
}

function add_dialogue_line_civilian(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  ...
  if(!soundexists(var_0)) {
    dialogue(level.civilian_dialog_struct, var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7);
    return;
  }
}

function add_dialogue_line_hms(var_0, var_1, var_2, var_3) {
  dialogue(var_0, var_1);
}
    ...
    if(var_0.size > 0) {
      ...
      if(var_1.size > 1) {
        for(var_2 = 1; var_2 < var_1.size; var_2++) {
          if(1.1 * distance(level.player.origin, var_1[var_2].origin) < distance(level.player.origin, var_1.origin) && sighttracepassed(level.player getEye(), var_1[var_2].origin + (0, 0, 42), 0, level.player)) {
            var_1 = var_1[var_2];
          }
        }
      }
...
function marines_autosave(var_0) {
  if(!isDefined(var_0)) {
    var_0 = [];
  }
...
function marines_autosave_thread(var_0) {
...
function dialogue(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8) {
  self endon("death");
...
function dialogue_play_sound(var_0, var_1) {
  if(isPlayer(self)) {
...
function marines_checkpoint_forcespawn_allies(var_0) {
  foreach(var_2 in var_0) {
    if(isDefined(var_2)) {
...
function marine_path_util(var_0, var_1, var_2, var_3, var_4, var_5) {
  self endon("death");
  self endon("entitydeleted");
  self.disablebulletwhizbyreaction = 1;
...
function get_closest_marine(var_0) {
  var_1 = [level.griggs];
...
function get_closest_marine_no_vo(var_0, var_1) {
  var_2 = [level.griggs];
...
function get_closest_civ(var_0) {
  var_1 = [];
...
function vo_get_closest_available_marine(var_0, var_1) {
  var_2 = [level.griggs];
...
function objective_wolf_los(var_0, var_1, var_2, var_3) {
  ...
  var_4 = "";
  jumpiffalse(isDefined(var_3) && var_3 == 1) LOC_0000005f;
...
function marines_lookatentity(var_0, var_1) {
...
function mg_gunner(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11) {
...
function mg_damage_nag_manager() {
  ...
  for(;;) {
    ...
    if(var_1 == level.mg_damage_owner) {
      level.player.mg_damage_nag_total += var_0;
...
function mg_shoot_behavior(var_0, var_1) {
  level endon("mg_ceasefire");
...
function suppression_monitor(var_0) {
  self.suppressed = 0;
...
function mg_target_ent_manager(var_0) {
  level endon("mg_ceasefire");
...
function mg_target_other() {
  ...
  for(;;) {
    ...
    for(var_5 = 0; var_5 < var_0.size; var_5++) {
      var_1 = mg_get_los_score(var_0[var_5], 60);
    }
...
function mg_get_los_score(var_0, var_1) {
...
function mg_switch_targets(var_0, var_1, var_2) {
  level endon("mg_ceasefire");
...
function mg_lerp(var_0, var_1, var_2) {
  level endon("mg_ceasefire");
...
function mg_tracer(var_0) {
  ...
  waitframe();
  var_1.origin -= var_1.origin - var_0;
  waitframe();
  var_1 delete();
}

function force_long_death(var_0) {
...
function marines_tripwire_monitor(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  var_8 = 999999;
  var_9 = undefined;
  ...
  thread marines_tripwire_defused_tracker(var_9);
  thread marines_tripwire_detonation_tracker(var_9);
...
function marines_tripwire_defused_tracker(var_0) {
...
function marines_tripwire_detonation_tracker(var_0) {
...
function spawn_corpses(var_0, var_1, var_2) {
...
function spawn_corpse(var_0, var_1, var_2) {
  if(!isspawner(var_0)) {
...
function corpse_anim_hack(var_0) {
...
function get_all_script_models_with_modelname(var_0) {
...
function delete_when_offscreen(var_0) {
  if(!isDefined(var_0)) {
    var_0 = 0;
  }
...
function delete_all_script_models_with_modelname(var_0) {
  var_1 = getEntArray("script_model", "classname");
...
function delete_all_script_models_with_modelname_async(var_0) {
  var_1 = getEntArray("script_model", "classname");
...
function disable_weapon_swap(var_0) {
  self allowads(0);
...
function delay_poi_enable(var_0, var_1, var_2) {
  wait var_0;
...
function marine_room_clear_node(var_0, var_1, var_2) {
  if(isDefined(var_2)) {
...
function marines_intro_glanceback(var_0, var_1) {
  if(isDefined(var_1)) {
