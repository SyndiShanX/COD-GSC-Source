...
function mg_hall_main() {
  ...
  thread scripts\sp\maps\marines\marines_utility::marines_tripwire_monitor(var_1, "flag_snakecam_tripwire_cleared", var_2, var_4, var_3, 1, "flag_snakecam_tripwire_defused");
...
function mg_hall_shouter_handler() {
  ...
  if(isDefined(var_1) && isalive(var_1)) {
    thread scripts\sp\maps\marines\marines_vo::vo_mghall_enemy_trap_shout(var_1);
  }
...
function mg_hall_tripwire_handler() {
  ...
  thread scripts\sp\maps\marines\marines_utility::marines_tripwire_monitor(var_0, undefined, var_1, undefined, var_2, undefined, "flag_mghall_tripwire_l_defused");
  thread scripts\sp\maps\marines\marines_utility::marines_tripwire_monitor(var_3, undefined, var_4, undefined, var_5, undefined, "flag_mghall_tripwire_r_defused");
}
...
function snakecam_main() {
  ...
  setsaveddvar("cursorHintControlLockExitTimeout", 0.1);
  ...
  var_7 = scripts\sp\maps\marines\marines_utility::get_array_of_living_allies_by_color("g");
  ...
  setsaveddvar("cursorHintControlLockExitTimeout", 1);
...
function snakecam_to_wolf() {
  ...
  while(var_14 == 0) {
    var_13 = scripts\sp\maps\marines\marines_utility::get_array_of_living_allies_by_color("r");
  ...
  var_19 = scripts\sp\maps\marines\marines_utility::get_array_of_living_allies_by_color("b");
...
function wolf_main() {
  ...
  var_15 = scripts\sp\maps\marines\marines_utility::get_array_of_living_allies_by_color("b");
  ...
  var_21 = scripts\sp\maps\marines\marines_utility::get_array_of_living_allies_by_color("g");
...
function rally_to_snakecam_door_monitor() {
  ...
  if(isDefined(self) && isalive(self)) {
    for(var_1 = distance2d(self.origin, var_0.origin); var_1 > 500; var_1 = distance2d(self.origin, var_0.origin)) {
      wait 1;
...
function wolf_tripwire_handler() {
  ...
  thread scripts\sp\maps\marines\marines_utility::marines_tripwire_monitor(var_0, "flag_wolf_tripwire_cleared");
...
function anim_hold_last_frame_solo(var_0, var_1) {
  var_0 endon("death");
...
function wolf_takedown_hint_check(var_0, var_1) {
  var_2 = 0;
...
function takedown_guards() {
  ...
  for(var_2 = 0; var_2 < var_0.size; var_2++) {
    thread guard_takedown_anim(var_1[var_2], var_0[var_2]);
  }
...
function guard_takedown_anim(var_0, var_1) {
...
function takedown_hostages() {
  ...
  thread singleanimtohold(var_1[0], var_0[0]);
  thread singleanimtohold(var_1[1], var_0[1]);
}

function singleanimtohold(var_0, var_1) {
...
function wolf_takedown() {
  ...
  scripts\sp\maps\marines\marines_utility::put_player_into_rig(level.player.rig, var_5, 30, 30, 0, 0);
...
function wolf_cameraman_handler() {
  ...
  level.wolf_cameraman scripts\anim\shared::forceuseweapon(var_1, "primary");
...
function guard_damage(var_0, var_1) {
  level endon("wolfTakedown");
...
function wolf_guard_behavior_setup(var_0, var_1) {
  level endon("wolfTakedown");
  self.dontmelee = 1;
  self.ignoreme = 0;
  self.ignoreall = 0;
...
function wolf_guards_breach_reaction_flag(var_0) {
...
function wolf_guards_breach_reaction_notify(var_0) {
  level waittill("wolfguard_alerted");
...
function hostage_death(var_0, var_1) {
  scripts\common\anim::anim_single_solo(var_0, var_1);
  scripts\common\anim::anim_last_frame_solo(var_0, var_1);
}
...
function upperfloor_murderhole_handler() {
  ...
  var_6 scripts\anim\shared::forceuseweapon(var_7, "primary");
  waitframe();
  level.mg_damage_owner = var_6;
  level.target_player_volumes = getEntArray("mg_hall_target_player", "targetname");
  thread mg_rotation(var_1);
  thread ally_move_with_purpose();
  var_8 = scripts\engine\utility::getStructArray("mg_dummy_target_mghall", "targetname");
  var_1 scripts\sp\maps\marines\marines_utility::mg_gunner("iw8_ar_akilo47_marines_mghall", var_8, &scripts\sp\maps\marines\marines_utility::mg_damage_smoke_nag_mghall, &scripts\sp\maps\marines\marines_utility::mg_intro_sequence_mg_hall, "upperfloor_murderhole_intro_complete", var_4, ["flag_upperfloor_murderhole_flank_left", "flag_upperfloor_murderhole_flank_right", "mg_hall_gunner_dead", "flag_upperfloor_murderhole_abandon"], 120, undefined, 1, -1, 1);
  level notify("mg_ceasefire");

  if(isalive(var_6)) {
    thread mg_hall_gunner_alert_monitor();
    var_1 scripts\sp\maps\marines\marines_utility::mg_gunner("iw8_ar_akilo47_marines_mghall", var_8, &scripts\sp\maps\marines\marines_utility::mg_damage_smoke_nag_mghall, undefined, "upperfloor_murderhole_intro_complete", var_4, ["flag_mg_gunner_react", "mg_hall_gunner_dead"], 120, undefined, 1, -1, 1);
    level notify("mg_ceasefire");
  }
...
function marines_breach() {
  ...
  var_0 = scripts\sp\maps\marines\marines_utility::get_array_of_living_allies_by_color("b");
...
function play_and_hold_anim(var_0, var_1) {
  scripts\common\anim::anim_single_solo(var_0, var_1);
  scripts\common\anim::anim_last_frame_solo(var_0, var_1);
}
...
function snakecam_marine_spawn_monitor(var_0, var_1) {
...
function snakecam_marine_forcespawn(var_0, var_1) {
...
function wolf_room_pre_breach_door() {
  ...
  var_7 = scripts\sp\maps\marines\marines_utility::get_array_of_living_allies_by_color("b");
  var_8 = scripts\sp\maps\marines\marines_utility::get_array_of_living_allies_by_color("g");
  var_9 = [];
...
function snakecam_marine_moveto_node(var_0) {
...
function snakecam_marine_timer() {
  ...
  while(level.snakecam_marine_reached_node == 0 && var_1 < var_2) {
    wait 0.1;
    var_1 += 0.1;
  }
...
function snakecam_make_yellow_marine() {
  ...
  var_2[0] scripts\sp\maps\marines\marines_utility::switch_marine_color("g", "y");
  scripts\engine\utility::flag_wait("exit_snakecam_immediately");
  ...
  if(isDefined(var_2[0]) && isalive(var_2[0])) {
    var_2[0] scripts\sp\maps\marines\marines_utility::switch_marine_color("y", "g");
...
function wolf_proxy_cameraman_handler() {
  ...
  level.wolf_proxy_cameraman scripts\anim\shared::forceuseweapon(var_8, "primary");
  var_1 linkTo(var_0);
  waitframe();
...
function snakecam_enter_fadein(var_0) {
  var_0 = scripts\sp\hud_util::create_client_overlay("black", 0);
...
function snakecam_movement_monitor() {
  ...
  while(!scripts\engine\utility::flag("flag_wolf_snakecam_moved")) {
    [var_2, var_1] = level.player getnormalizedcameramovement();
...
function rally_to_snakecam_door() {
  var_0 = getEnt("wolf_door_faketarget", "targetname");
  var_1 = scripts\sp\maps\marines\marines_utility::get_array_of_living_allies_by_color("b");
...
function shelfexit(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  ...
  waitframe();
  thread front_mantle_handler_right(var_6, var_2, 14.9, "twoMarinesWindowExit", var_10, 8);
  thread front_mantle_handler_left(var_7, var_1, 11.16, "twoMarinesWindowExit", var_11, 10.5);
  ...
  if(isDefined(var_6) && isalive(var_6)) {
    thread scripts\sp\maps\marines\marines_vo::vo_wolf_marine_balcony_advance_dialogue(var_6);
  }
  ...
  if(isDefined(var_5) && isalive(var_5)) {
    ...
    thread rear_mantle_handler(var_5, var_0, 3.2);
...
function front_mantle_handler_left(var_0, var_1, var_2, var_3, var_4, var_5) {
  self endon("death");
  self endon("entitydeleted");
  ...
  for(var_9 = 0; var_8 < var_7; var_9 = 1) {
    wait 0.1;
...
function front_mantle_handler_right(var_0, var_1, var_2, var_3, var_4, var_5) {
  self endon("death");
  self endon("entitydeleted");
...
function rear_mantle_handler(var_0, var_1, var_2, var_3, var_4, var_5) {
  self endon("death");
  self endon("entitydeleted");
  var_0 thread scripts\common\anim::anim_single_solo(self, var_2);
  waitframe();
  ...
  for(var_8 = 0; var_7 < var_6; var_8 = 1) {
    wait 0.1;
...
function barricade_player_crushed_monitor(var_0) {
...
function balcony_marine_advancing(var_0) {
  self endon("death");
  self endon("entitydeleted");
  var_1 = 20;
  var_2 = self.origin;
...
function wolf_clear_window_barricade() {
  ...
  if(isDefined(level.wolf_barricade_clip)) {
    level.wolf_barricade_clip moveTo(var_0.origin, 4);
  }
...
function wolf_fail_timer_logic(var_0, var_1, var_2, var_3) {
  level endon(var_0);
  wait var_1 * var_2;
