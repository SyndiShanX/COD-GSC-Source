...
function wait_weapon_fire_cooldown(var_0, var_1, var_2) {
...
function setup_player(var_0, var_1) {
...
function player_say_clear(var_0, var_1) {
  if(isDefined(var_0)) {
...
function postspawn_friendlies(var_0) {
...
function postpawn_friendly_weapon(var_0) {
  if(self == level.price) {
    return;
  }
  ...
  var_4 = "laserir";
  var_5 = scripts\sp\utility::make_weapon(var_2, [var_3, var_4, "rec_kilo433|1", "back_kilo433|1", "barsil_kilo433", "mag_kilo433|1"]);
  scripts\anim\shared::forceuseweapon(var_5, "primary");
}
...
function colornode_assign_price(var_0) {
...
function spawn_weapon_model(var_0) {
...
function colornode_assign_bravo2_2(var_0) {
  if(isDefined(var_0.script_noteworthy)) {
    if(var_0.script_noteworthy == "freeze_townhouse") {
      thread scripts\sp\maps\townhoused\townhoused_inner::backyard_freeze_townhouse(var_0);
      return;
    }
...
function postspawn_bravo3() {
  ...
  anim_then_loop_solo(var_0, self, "side_alley_move");
...
function nvg_eyelights_thread() {
  ...
  for(var_1 = 0;; var_1 = self.visor_down) {
    waitframe();
...
function footstep_sound(var_0, var_1, var_2) {
  var_3 = undefined;
...
function golden_path_fail(var_0) {
...
function ally_shoot_enemy(var_0, var_1, var_2) {
  if(!isDefined(var_1)) {
    var_1 = 0;
  }
  ...
  var_4 = var_1 gettagorigin(var_3);
  var_5 = get_shoot_start(var_4);
  var_1.scriptedattacker = self;
  magicbullet(self.weapon, var_5, var_4, self, self);

  if(var_2) {
    var_1 scripts\sp\utility::do_damage(var_1.health + 10000, var_5, self, undefined, "MOD_RIFLE_BULLET", self.weapon);
  }

  return true;
}

function get_shoot_start(var_0, var_1) {
...
function ally_burstshoot_enemy(var_0, var_1, var_2, var_3) {
...
function ally_shoot_pos(var_0) {
  var_1 = get_shoot_start(var_0);
  magicbullet(self.weapon, var_1, var_0, self);
}

function ally_burstshoot_pos(var_0, var_1, var_2) {
  var_3 = var_0;
...
function get_closest_living_ai(var_0, var_1) {
...
function get_closest_squad_guy(var_0, var_1) {
...
function get_farthest_living_ai(var_0, var_1) {
  var_2 = scripts\engine\sp\utility::get_living_ai_array(var_0, var_1);
  var_3 = sortbydistance(var_2, level.player.origin);
...
function lookat_random_animloop_ender(var_0, var_1, var_2) {
  if(isDefined(var_1)) {
    self endon(var_1);
  }

  lookat_random(var_0, var_2);
}
...
function do_sound_on_death(var_0) {
...
function flash_react_thread(var_0) {
  self endon("death");
...
function flag_react_sound_array(var_0) {
  if(!isarray(var_0)) {
    var_0 = [var_0];
  }
...
function play_generic_react(var_0) {
  self endon("death");
  var_1 = undefined;
  var_2 = undefined;
...
function player_grenade_fire_thread() {
  for(;;) {
    ...
    if(var_1.basename == "flash") {
      thread friendly_projectile_nearby(level, var_0, var_3);
      continue;
    }
...
function friendly_projectile_nearby(var_0, var_1, var_2) {
  if(var_1 > 1.25) {
    wait var_1 - 1.25;
  }
  ...
  if(isDefined(var_4)) {
    thread play_projectile_nearby_dialog(var_4);
    return;
  }
}

function play_projectile_nearby_dialog(var_0) {
...
function play_grenade_reaction_dialog() {
  ...
  if(!isDefined(level.grenadedamagedialogdeck)) {
    var_0 = [];
    GscBinSkip0(0x2e, var_0.size, "dx_vom_pri_react_frag_10");
  }
...
function isscriptedalive(var_0) {
  if(!isalive(var_0)) {
    return false;
  }
...
function assign_scripted_movement(var_0, var_1) {
...
function movement_dialog(var_0) {
  if(!isDefined(var_0.script_sound)) {
    return;
  }
...
function is_demo_python_anime(var_0) {
  if(!istrue(level.demo)) {
    return false;
  }
...
function anim_long_death(var_0, var_1, var_2, var_3) {
  var_0 endon("death");
  ...
  if(!is_demo_python_anime(var_1) && (var_0.damagelocation == "head" || var_0.damagelocation == "helmet")) {
    var_4 = use_long_death_for_death(var_0, var_1 + "_long_death");
  ...
  if(var_5 == "_long_death") {
    ...
    if(var_0 scripts\engine\utility::hasanim(var_6)) {
      ...
      if(isDefined(var_8)) {
        thread delay_allowdeath(var_0);
        var_0 scripts\engine\sp\utility::set_deathanim(var_7);
      } else {
        enable_death_clearscriptedanim(var_0);
        thread delay_allowdeath(var_0, 0.3);
      }
    } else {
      var_5 = "_death";
    }
...
function anim_long_death_relative(var_0, var_1, var_2, var_3) {
  var_0 endon("death");
  ...
  if(isDefined(self.target)) {
    ...
    if(var_8 > var_5) {
      var_4 += vectorNormalize(var_7) * var_5;
    } else {
      var_4 = var_0.origin;
    }
  }
  ...
  if(!is_near_long_death_pos(var_9, var_0, var_1, var_2)) {
    return;
  }
...
function is_near_long_death_pos(var_0, var_1, var_2) {
  if(!isDefined(var_2)) {
    var_2 = 10;
  }
...
function delay_allowdeath(var_0, var_1) {
  self endon("death");
  wait var_0;
  self.allowdeath = 1;
...
function use_long_death_for_death(var_0) {
  var_1 = scripts\engine\utility::getanim(var_0);

  if(animhasnotetrack(var_1, "headshot_death")) {
    scripts\common\anim::addnotetrack_customfunction(self.animname, "headshot_death", &scripts\sp\maps\townhoused\townhoused_anim::kill_me_ragdoll, var_0);
    return true;
  }
...
function doors_waittill_any_open(var_0) {
  var_1 = spawnStruct();

  foreach(var_3 in var_0) {
    thread doors_waittill_open_internal(var_1);
  }
...
function doors_waittill_open_internal(var_0) {
  var_0 endon("entitydeleted");
  self endon("stop_doors_waittill_open");
  var_1 = door_waittill_open(var_0);
  self notify("door_opened", var_0, var_1);
}

function door_waittill_open(var_0) {
  self endon("entitydeleted");
...
function door_angle_check(var_0, var_1) {
  return abs(angleclamp180(self.angles[1]) - var_0) > var_1;
}

function doors_waittill_any_snakecam(var_0) {
  var_1 = spawnStruct();

  foreach(var_3 in var_0) {
    thread doors_waittill_snakecam(var_1);
  }
...
function doors_waittill_snakecam(var_0) {
  var_0 endon("entitydeleted");
  self endon("stop_doors_waittill_snake");
  door_waittill_snakecam(var_0);
...
function force_open_door_targetname(var_0) {
  var_1 = scripts\sp\door::get_interactive_door(var_0);
  force_open_door(var_1);
}

function force_open_door(var_0, var_1) {
...
function force_close_door(var_0) {
  var_1 = scripts\sp\door::get_interactive_door(var_0);
...
function ai_try_open_door(var_0) {
...
function temp_scriptablerotateTo(var_0, var_1, var_2, var_3, var_4) {
  if(!isDefined(var_4)) {
    var_4 = (0, 0, 0);
  }
...
function stairtrain1_animcustom() {
  ...
  var_0.fnadditive_twitch_get = &scripts\sp\maps\townhoused\townhoused_anim::stairtrain_twitch_get;
...
function stairtrain1_nag() {
  var_0 = [];
  GscBinSkip0(0x2e, var_0.size, "dx_vom_pri_stairtrain1_rally_40");
}
...
function train_go(var_0, var_1) {
  ...
  for(var_13 = 0; var_13 < var_9; var_13++) {
    ...
    var_12 = var_15;
    thread train_move(var_15, var_5.origin + var_11);
  }

  thread train_thread(level, var_12);
}

function get_closer_track(var_0) {
  var_1 = var_0[0];
...
function spawn_train_end(var_0, var_1) {
  var_2 = spawn("script_model", var_0);
  var_2.angles = var_1;
...
function train_move(var_0, var_1) {
...
function train_attach_light(var_0) {
...
function train_thread(var_0, var_1) {
...
function train_light_flicker(var_0, var_1) {
  while(gettime() < 1000) {
    waitframe();
  }
...
function train_sounds(var_0, var_1, var_2) {
  if(isDefined(var_2)) {
...
function train_rumble(var_0) {
  ...
  while(scripts\engine\utility::flag("train_passing")) {
    if(scripts\engine\utility::flag("train_player_nearby")) {
      if(!var_2) {
        var_1 thread scripts\engine\sp\utility::rumble_ramp_to(0.1, 3);
        var_2 = 1;
      }
...
function train_check_if_player_nearby(var_0) {
  var_1 = 1048576;
...
function train_check_if_player_nearby_proc(var_0) {
  var_1 = 1048576;
...
function get_next_struct(var_0) {
...
function objective_quick_add(var_0, var_1, var_2, var_3) {
  if(isDefined(var_1)) {
...
function objective_add_structpos(var_0) {
...
function objective_clear_structpos(var_0) {
...
function get_longest_anim_ent(var_0, var_1) {
  var_2 = var_0[0];
...
function smart_dialogue_or_radio(var_0) {
  GscBinSkip1(0x45, "dx_vom_b27_branch2_dining_20", 1);
}

function get_radio_alias(var_0) {
  var_1 = "";
  ...
  var_1 += "r_" + var_2[var_2.size - 1];
  return var_1;
}

function set_start_location_by_animname(var_0, var_1) {
  var_2 = [];
  ...
  foreach(var_4 in var_1) {
    ...
    foreach(var_7 in var_2) {
      ...
      if(isDefined(var_4.animname) && var_8 == var_4.animname) {
        var_5 = var_7;
        break;
      }
    }
...
function get_object(var_0, var_1) {
...
function get_object_array(var_0, var_1) {
  var_2 = [];
...
function teleport_to_targetname(var_0) {
...
function anim_single_then_loop_solo(var_0, var_1, var_2, var_3) {
  if(!isDefined(var_2)) {
    var_2 = var_1 + "_idle";
...
function waittill_any_damage(var_0) {
  var_1 = spawnStruct();

  foreach(var_3 in var_0) {
    thread waittill_damage_thread(var_1);
  }

  var_1 waittill("damage_was_done");
}

function waittill_damage_thread(var_0) {
  var_0 scripts\engine\utility::waittill_any("death", "damage");
  self notify("damage_was_done");
}

function anim_then_loop(var_0, var_1, var_2, var_3) {
...
function get_door_targetname(var_0) {
...
function anim_door(var_0, var_1, var_2, var_3) {
...
function anim_loop_door(var_0, var_1) {
...
function anim_loop_door_stop(var_0) {
  self waittill("stop_door_loop");
  var_0 delete();
}

function anim_door_then_loop(var_0, var_1, var_2) {
...
function anim_door_then_loop_stopper(var_0) {
  self waittill(var_0);
  self.loopendernotified = 1;
}

function scripted_deathanim(var_0, var_1, var_2, var_3) {
  if(!isDefined(var_1)) {
    var_1 = self;
  }
...
function scripted_deathanim_loop(var_0, var_1) {
  self endon("death");
...
function nag(var_0, var_1, var_2, var_3, var_4, var_5) {
  nag_internal(var_0, var_1, var_2, var_3, var_4, 0, var_5);
}

function radio_nag(var_0, var_1, var_2, var_3, var_4, var_5) {
  nag_internal(var_0, var_1, var_2, var_3, var_4, 1, var_5);
}

function nag_internal(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  self endon("death");
  self endon("stop_nag");
  ...
  var_7 = scripts\engine\sp\utility::create_deck(var_1);

  for(;;) {
    wait randomfloatrange(var_3, var_4);
    var_8 = var_7 scripts\engine\sp\utility::deck_draw();
    nag_say(var_8, var_6, var_7);
    var_3 = min(var_3 + var_5, 18);
    var_4 = min(var_4 + var_5, 24);
...
function nag_say(var_0, var_1, var_2, var_3) {
  if(isDefined(var_3)) {
    wait var_3;
  }
...
function nag_anim(var_0, var_1, var_2, var_3, var_4) {
  var_5 = nag_group_getalias(var_2);
  GscBinSkip4(0x6e, var_0, var_5, var_3, undefined, var_4);
}

function nag_group_create(var_0, var_1) {
...
function nag_group_getalias(var_0, var_1) {
...
function is_flash_weapon(var_0) {
  if(isDefined(var_0)) {
...
function try_smart_radio_dialogue(var_0) {
  var_1 = 0;
...
function quick_spawn_model(var_0, var_1) {
  if(!isDefined(var_1)) {
    var_1 = (0, 0, 0);
  }
...
function is_explosivedamage(var_0, var_1) {
  if(isDefined(var_1)) {
    if(var_1.basename == "flash") {
      return false;
    }
...
function clear_floor(var_0, var_1, var_2) {
...
function sound_mover_playsoundatpos(var_0, var_1) {
...
function temp_draw_multipoints(var_0) {
...
function screensaver_play() {
  ...
  while(var_6 < level.screensaverpath.size) {
    ...
    if(var_12) {
      var_13 = var_11 / 0.3;
      var_13 *= getdvarfloat("scr_screensaver_playspeedscale");
      ...
      var_17 = var_11 + var_15 * 1000;
      var_18 = vectorNormalize(var_8.origin - var_9);
    } else {
      var_14 = 0;
      var_18 = undefined;
      var_16 = undefined;
    ...
    while(gettime() < var_17) {
      waitframe();

      if(var_13) {
        var_19 = (gettime() - var_11) * 0.001;
        var_20 = var_9 + var_18 * (var_5 * var_19 + 0.5 * var_16 * squared(var_19));
        var_4.origin = var_20;
      }

      var_22 = (gettime() - var_11) / (var_17 - var_11);
      var_15 = clamp_angles(clamp_angles(var_21) - clamp_angles(var_10));
      var_4.angles = clamp_angles(var_10 + var_15 * var_22);
    }

    if(isDefined(var_8.actions)) {
      foreach(var_24 in var_8.actions) {
        if(var_24 == "nvg_on") {
  ...
  foreach(var_27 in var_1) {
    level.player giveweapon(var_27);
  }
}

function donightvision(var_0) {}

function clamp_angles(var_0) {
...
function screensaver_record() {
  ...
  while(getdvarint("scr_screensaver_rec") > 0) {
    wait 0.3;
    level.screensaverpath[level.screensaverpath.size] = screensaver_point_create(var_0);
  }
}

function screensaver_point_create(var_0) {
  var_1 = spawnStruct();
