...
function kitchen_open_door(var_0) {
...
function kitchen_use_deathanim_hold(var_0) {
...
function kitchen_use_deathanim_tie(var_0) {
  var_0.deathanim = undefined;
...
function kitchen_use_deathanim_laying(var_0) {
  var_0.skipdeathanim = undefined;
  var_0.noragdoll = 1;
  var_0 scripts\engine\sp\utility::set_deathanim("kitchen_takedown_death_laying");
}

function kitchen_no_react(var_0) {
  var_0.no_react = 1;
}

function kitchen_use_deathanim_laying_bravo(var_0) {
  ...
  var_1.no_react = undefined;
  var_1.kitchen_react = "kitchen_takedown_death_laying";
}

function kitchen_use_deathanim(var_0) {
  var_0.noragdoll = 1;
...
function dining_room_chest_fx(var_0) {
...
function set_nvg_bool(var_0) {
  var_0.visor_down = 1;
}

function use_death_long_end(var_0) {
  var_0.allowdeath = 1;
  var_0.skipdeathanim = undefined;
  var_0 scripts\engine\sp\utility::set_deathanim("dining_long_death_end");
}

function use_death_long_end2(var_0) {
  var_0.allowdeath = 1;
  var_0.skipdeathanim = undefined;
  var_0 scripts\engine\sp\utility::set_deathanim("dining_late_long_death_end2");
}

function use_late_long_death(var_0) {
  var_0 thread scripts\sp\maps\townhoused\townhoused_inner::dining_room_late_long_death();
}

function stop_late_long_death(var_0) {
  var_0 notify("stop_dining_room_late_long_death");
}

function attach_sidearm(var_0) {
  var_0 scripts\anim\shared::forceuseweapon(var_0.sidearm, "sidearm");
}

function pickup_gun(var_0) {
  var_0 scripts\sp\anim_notetrack::gun_pickup_right();
}

function remove_dining_deathanim(var_0) {
  var_0.allowdeath = 1;
  var_0 scripts\engine\sp\utility::clear_deathanim();
  var_0 notify("stop_death_react_thread");
}

function remove_dining_deathanim_ragonly(var_0) {
  var_0 notify("stop_death_react_thread");
  var_0 scripts\engine\sp\utility::clear_deathanim();
...
function stairtrain_twitch_get() {
  var_0 = [];
  GscBinSkip0(0x2e, var_0.size, %thd_stair_train_twitch_01);
}

function stairtrain1_try_vo(var_0) {
...
function stairtrain2_remove_clip(var_0) {
...
function set_skipdeathanim(var_0) {
  var_0.skipdeathanim = 1;
}

function second_floor_bedroom_fire(var_0) {
...
function second_floor_bedroom_reveal_fire(var_0) {
  var_1 = "tag_flash";
  ...
  foreach(var_7 in var_5) {
    thread second_floor_follow_tag_flash(var_0);
...
function second_floor_follow_tag_flash(var_0) {
...
function second_floor_bedroom_door2(var_0) {
  ...
  var_1 thread scripts\sp\maps\townhoused\townhoused_code::anim_door(var_2, "2ndfloor_bedroom_enter2");
}

function second_floor_bedroom_check_stop(var_0) {
...
function hostage_hit_wall(var_0) {}

function hostage_elbow_hit_wall(var_0) {}

function hostage_enemy_fx(var_0) {
...
function hostage_allow_long_death(var_0) {
  var_0.allowdeath = 0;
  var_0.health = 180;
  var_0.skipdeathanim = 1;
  var_0.deathfunction = &scripts\sp\maps\townhoused\townhoused_inner::hostage_death_with_gun;
  ...
  var_1 = scripts\engine\utility::getStruct("hostage_animnode", "targetname");
  var_1 thread scripts\sp\maps\townhoused\townhoused_code::anim_long_death_relative(var_0, "hostage_live_long_death", 10, &scripts\sp\maps\townhoused\townhoused_inner::hostage_death_counter);
}

function hostage_ondeath_remove_linkedents(var_0) {
...
function hostage_turn_to_enemy(var_0) {
  var_0.team = "axis";
  var_0 thread scripts\sp\maps\townhoused\townhoused_code::golden_enemydamage();
  var_0 thread scripts\sp\maps\townhoused\townhoused_code::golden_enemydeath();
}
...
function bathroom_stop_deathanim(var_0) {
  remove_deathanim(var_0);
  var_0.deathfunction = undefined;
}

function direct_shoot(var_0) {
...
function bravo4_4_open_baby_door(var_0) {
  var_1 = scripts\sp\door::get_interactive_door("baby_room_door");
  var_0 scripts\sp\maps\townhoused\townhoused_code::ai_try_open_door(var_1);
}
...
function baby_mom_anim_get(var_0) {
  var_1 = undefined;
  var_1 = spawnStruct();
...
function baby_mom_use_move_death(var_0) {
  var_0.skipdeathanim = undefined;
}

function baby_mom_remove_death(var_0) {
  var_0 scripts\engine\sp\utility::clear_deathanim();
}

function bravo4_4_try_early_mom_death(var_0) {
  ...
  var_1 thread scripts\sp\maps\townhoused\townhoused_code::anim_then_loop_solo(var_0, "grab_baby_mom_early_death");
}

function bravo4_4_use_stand_death_react(var_0) {
  var_0.momdeathreact_anime = "grab_baby_stand_death";
}

function bravo4_4_use_death_react(var_0) {
  var_0.momdeathreact_anime = "grab_baby_death";
}

function baby_mom_stand_death(var_0) {
...
function baby_mom_normal_death(var_0) {
  var_0.deathanime = "grab_baby_death";
}

function baby_pickup_by_allyanim(var_0, var_1) {
...
function baby_pickup_early_time_adjust(var_0, var_1) {
  self setanimtime(scripts\engine\utility::getanim(var_0), var_1);
}

function baby_room_unlink_baby(var_0) {
  var_1 = getEnt("baby", "targetname");
  var_1 unlink();
}

function set_team_axis(var_0) {
  var_0.team = "axis";
  var_0.skipdeathanim = 1;
  var_0.a.nodeath = 1;
}

function set_team_allies(var_0) {
  var_0.team = "allies";
}

function set_as_innocent(var_0) {
  var_0.team = "allies";
...
function bed_guy_dropgun(var_0) {
  var_0.nodrop = 0;
  var_0 waittill("death");
  var_1 = var_0.weapon;
  var_0 scripts\anim\shared::detachallweaponmodels();
...
function bed_guy_deathanim(var_0) {
  var_0.allowdeath = 1;
...
function buddy_down_dropgun(var_0) {
  ...
  var_0 scripts\anim\shared::forceuseweapon(var_2, "primary");
  var_0 scripts\anim\notetracks_sp::notetrackgundrop();
}

function buddy_down_remove_playerclip(var_0) {
...
function try_attic_dialogue_shoot_her(var_0) {
...
function attic_detach_laptop(var_0) {
  level.price.laptop unlink();
}

function attic_attach_clacker(var_0) {
  var_0 attach(level.clacker.model, "tag_accessory_right");
  level.clacker delete();
}

function attic_player_can_shoot(var_0) {
  var_0 notify("stop_early_death");
  var_0.playerbullets--;
}

function attic_use_ragdoll(var_0) {
  var_0.health = 5;
  var_0.allowdeath = 1;
  var_0.skipdeathanim = 1;
}

function attic_use_final_deathanim(var_0) {
  var_0.health = 5;
  var_0.allowdeath = 1;
  var_0.skipdeathanim = 1;
...
function attic_final_player_deathanim() {
  ...
  self.disabledeathorient = 1;
  scripts\sp\maps\townhoused\townhoused_code::scripted_deathanim("attic_enemy_death", var_0);
}

function attic_use_deathanim(var_0) {
  var_0.allowdeath = 1;
  var_0.skipdeathanim = undefined;
  var_0 scripts\engine\sp\utility::set_deathanim("attic_enemy_early_long_death_end");
}

function attic_price_shoot(var_0) {
...
function attic_enemy_death(var_0) {
  var_0.a.nodeath = 1;
  var_0 kill();
}
...
function mantle_give_viewlook(var_0) {}

function backyard_cut_gate(var_0) {
  level.gatelock setModel(scripts\engine\sp\utility::getmodel("gate_lock_cut"));
}

function hide_fakeplayer_head(var_0) {
...
function attic_swap_door(var_0) {
...
function customnotetrackhandler(var_0) {
  var_1 = getsubstr(var_0, 0, 3);

  if(var_1 == "dr_") {
    var_2 = getsubstr(var_0, 3);
    thread scripts\sp\maps\townhoused\townhoused_code::smart_dialogue_or_radio(var_2);
    return;
  }
}

function apc_lerp_fov(var_0) {}
...
function kill_me_ragdoll_nosound(var_0) {
  var_0.diequietly = 1;
  kill_me_ragdoll(var_0);
}

function allowdeath_just_ragdoll(var_0) {
  var_0.allowdeath = 1;
  var_0.skipdeathanim = 1;
}

function remove_deathfunc(var_0) {
  var_0.deathfunction = undefined;
}

function remove_skipdeathanim(var_0) {
  var_0.skipdeathanim = undefined;
}

function remove_deathanim(var_0) {
  var_0.deathanime = undefined;
  var_0 scripts\engine\sp\utility::clear_deathanim();
}

function remove_scripted_deaths(var_0) {
  remove_deathanim(var_0);
  remove_deathfunc(var_0);
}

function no_allowdeath(var_0) {
  var_0.allowdeath = 0;
}

function enable_allowdeath(var_0) {
  var_0.allowdeath = 1;
}

function remove_death_react(var_0) {
  var_0 notify("stop_reaction_death");
  var_0 scripts\engine\sp\utility::clear_deathanim();
}

function enable_magic_bullet_shield(var_0) {
  var_0 scripts\common\ai::magic_bullet_shield();
}

function disable_magic_bullet_shield(var_0) {
  var_0 scripts\common\ai::stop_magic_bullet_shield();
}

function sfx_townhouse_door_audio_backyard_gate(var_0) {
  thread threaded_sfx_townhouse_door_audio(level);
}

function sfx_townhouse_door_audio_basement_prep(var_0) {
  thread threaded_sfx_townhouse_door_audio(level);
}

function sfx_townhouse_door_audio_basement_enter(var_0) {
  thread threaded_sfx_townhouse_door_audio(level);
}

function sfx_townhouse_door_audio_kitchen_girl_pre(var_0) {
  thread threaded_sfx_townhouse_door_audio(level);
}

function sfx_townhouse_door_audio_kitchen_girl(var_0) {
  thread threaded_sfx_townhouse_door_audio(level);
}

function sfx_townhouse_door_audio_front_open(var_0) {
  thread threaded_sfx_townhouse_door_audio(level);
}

function sfx_townhouse_door_audio_2nd_floor_bathroom(var_0) {
  thread threaded_sfx_townhouse_door_audio(level);
}

function sfx_townhouse_door_audio_2nd_floor_bedroom(var_0) {
  thread threaded_sfx_townhouse_door_audio(level);
}

function sfx_townhouse_door_audio_2nd_floor_bedroom_bash(var_0) {
  thread threaded_sfx_townhouse_door_audio(level);
}

function sfx_townhouse_door_audio_3rd_floor_price(var_0) {
  thread threaded_sfx_townhouse_door_audio(level);
}

function sfx_townhouse_door_audio_3rd_floor_python_pre(var_0) {
  thread threaded_sfx_townhouse_door_audio(level);
}

function sfx_townhouse_door_audio_3rd_floor_python_enter(var_0) {
  thread threaded_sfx_townhouse_door_audio(level);
}

function sfx_townhouse_audio_3rd_floor_sound_look_at(var_0) {
  thread threaded_sfx_townhouse_door_audio(level);
}

function sfx_townhouse_audio_3rd_floor_buddy_down_look_at(var_0) {
  thread threaded_sfx_townhouse_door_audio(level);
}

function sfx_townhouse_door_audio_4th_floor_bathroom(var_0) {
  thread threaded_sfx_townhouse_door_audio(level);
}

function sfx_townhouse_door_audio_attic_prep(var_0) {
  thread threaded_sfx_townhouse_door_audio(level);
}

function sfx_townhouse_door_audio_attic_open(var_0) {
  thread threaded_sfx_townhouse_door_audio(level);
}

function threaded_sfx_townhouse_door_audio(var_0) {
  switch (var_0) {
