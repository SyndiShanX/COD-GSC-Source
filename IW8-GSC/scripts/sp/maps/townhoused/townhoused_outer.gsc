...
function apc_exit_sequence(var_0, var_1, var_2) {
...
function apc_exit_thread(var_0) {
  ...
  if(!scripts\engine\utility::flag("player_passed_barrier")) {
    if(self == level.price) {
      ...
      thread scripts\sp\maps\townhoused\townhoused_code::nag(var_1, "player_passed_barrier");
    }
  ...
  var_0 scripts\sp\maps\townhoused\townhoused_code::anim_then_loop_solo(self, "street_movement", "gate_approach_pre_idle", "stop_loop_gate_approach");
}
...
function apc_exit_cops_sequence(var_0, var_1, var_2) {
  ...
  var_7 = scripts\sp\maps\townhoused\townhoused_code::get_longest_anim_ent(var_1, "open_barrier");
  ...
  foreach(var_7 in var_1) {
    ...
    var_0 thread scripts\sp\maps\townhoused\townhoused_code::anim_then_loop_solo(var_7, "close_barrier", "close_barrier_loop", "stop_barrier_cop_idle");
  }
...
function extra_street_alles_movement() {
  ...
  for(var_3 = 0; var_3 < var_0.size; var_3++) {
    ...
    thread extra_street_alles_movement_internal(var_0[var_3]);
  }
}

function extra_street_alles_movement_internal(var_0) {
  var_1 = "approach_alley";
  var_0 scripts\sp\anim::anim_reach_solo(self, var_1);
  var_0 scripts\sp\maps\townhoused\townhoused_code::anim_then_loop_solo(self, var_1, undefined, "stop_approach_alley_loop");
}
...
function bravo_gate_vo_open(var_0) {
...
function street_jogger() {
  ...
  var_6 thread scripts\sp\maps\townhoused\townhoused_code::anim_then_loop(var_0, "jog");
}

function street_jogger_vo(var_0, var_1) {
  wait 5.5;
...
function street_knocknock_vo(var_0, var_1) {
  wait 15;
...
function woman_onlooker_vo(var_0, var_1) {
...
function woman_onlook_vo2(var_0, var_1) {
...
function woman_onlook_vo2_thread(var_0, var_1) {
...
function onlooker_vo_thread(var_0) {
...
function alley_gate_open(var_0) {
...
function alley_price_anim(var_0) {
...
function alley_ctbuddy_anim(var_0) {
...
function alley_approach_garage(var_0) {
...
function kill_cellphone_guy(var_0) {
  var_0 endon("death");
  ...
  wait 2;
  level.price thread scripts\sp\maps\townhoused\townhoused_code::ally_shoot_enemy(var_0, undefined, "tag_eye");
}

function cellphone_guy_ondeath(var_0) {
  var_0 waittill("death");
  scripts\engine\utility::flag_set("cellphone_guy_executed");
}

function cellphone_use_deathanim(var_0) {
...
function garage_knock() {
  ...
  var_0 thread scripts\sp\maps\townhoused\townhoused_code::anim_door(var_3, "garage_knock");
...
function garage_entry_dialog(var_0) {
...
function garage_ambush_thread(var_0) {
  self endon("death");
...
function garage2_carjack(var_0) {
...
function garage_explosive_thread() {
  for(;;) {
    ...
    if(scripts\sp\maps\townhoused\townhoused_code::is_explosivedamage(var_4, var_9)) {
      break;
    }
  }
  ...
  for(var_12 = 0; var_12 < var_11.size; var_12++) {
    thread garage_explosive_explode(var_11[var_12]);
  }
}

function garage_explosive_explode(var_0) {
  if(var_0 > 0) {
    wait var_0;
  }
...
function tripwire_trigger_thread(var_0) {
  self endon("death");
...
function tripwire_delete_cleanup(var_0) {
...
function switch_to_ground_player_disable(var_0) {
  if(var_0) {
...
function cam_fly_path(var_0, var_1) {
...
function get_flight_path_up() {
  ...
  var_7 = max(var_7, 30);
  var_2 = create_path_data(var_6, (7, 90, 0), var_7);
  var_8 = (var_3[0], var_1.origin[1], var_3[2]);
  var_6 = var_8;
  var_2 = create_path_data(var_6, (7, 90, 0), 30);
  var_6 = var_8 + (0, 0, 300);
  var_2 = create_path_data(var_6, (90, 90, 0), 300);
  var_6 = var_8 + (0, -300, 2500);
  var_2 = create_path_data(var_6, (75, 90, 0), 3000);
  return var_2;
}
...
function get_flight_path_down() {
  ...
  var_8 = create_path_data(var_12, var_13, 3000);
  var_9 = 400;
  var_11 = anglesToForward((var_10, var_2.angles[1], 0)) * var_9 * -1;
  var_12 = var_2.origin + var_11;
  var_13 = (var_10, var_2.angles[1], 0);
  var_8 = create_path_data(var_12, var_13, 1000);
  var_9 = 60;
  var_11 = anglesToForward((var_10, var_2.angles[1], 0)) * var_9 * -1;
  var_12 = var_2.origin + (0, 0, 60);
  var_13 = (0, var_2.angles[1], 0);
  var_8 = create_path_data(var_12, var_13, 1);
  return var_8;
}
...
function get_flight_path(var_0) {
  ...
  var_9 = [];
  var_10 = [];
  var_9 = create_path_data(var_3 + (0, 0, 200), (90, 0, 0), 400);
  var_9 = create_path_data(var_3 + (0, 0, 1000), (90, 0, 0), 600);
  var_9 = create_path_data(var_3 + (0, 0, 1200), (90, 0, 0), 100);
  var_11 = var_3 + (var_4 - var_3) / 2;
  var_9 = create_path_data(var_11 + (0, 0, 1200), (90, 0, 0), 600);
  var_9 = create_path_data(var_4 + (0, 0, 1200), (90, 0, 0), 100);
  var_9 = create_path_data(var_4 + (0, 0, 1000), (90, 0, 0), 600);
  var_9 = create_path_data(var_4 + (0, 0, 100), (90, 0, 0), 600);
  var_9 = create_path_data(var_4, var_7, 1);
  return var_9;
}

function create_path_data(var_0, var_1, var_2) {
  var_3 = spawnStruct();
  var_3.origin = var_0;
  var_3.angles = var_1;
  var_3.speed = var_2;
...
function anglesclamp180_lerp(var_0, var_1, var_2) {
