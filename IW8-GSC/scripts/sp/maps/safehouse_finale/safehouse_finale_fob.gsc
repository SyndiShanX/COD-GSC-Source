...
function chu_bad_places_armory() {
  ...
  foreach(var_3 in var_0) {
    var_1 = createnavbadplacebyent(var_3, "axis", "allies");
  }
...
function bink_start() {
  level.bink_start = 1;
  var_0 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnfarah();
  var_0 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnhadir();
...
function bink_technical() {
  ...
  foreach(var_5 in var_2) {
    if(scripts\engine\utility::is_equal(var_5.script_noteworthy, "left")) {
      ...
      var_5.origin += anglesToForward(var_5.angles) * var_3;
...
function safehouse_interior_main() {
  ...
  var_2 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnfarah();
  var_3 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnhadir();
...
function wait_fly_drone() {
  ...
  wait 10;
  var_0 = [];
  GscBinSkip0(0x2e, var_0.size, [level.farah, "dx_vom_far_safehouse_interior_planestart_60"]);
}
...
function intro_actors_to_idle(var_0, var_1) {
  self endon("death");
...
function hadir_stair_idle_nag(var_0) {
...
function hadir_tablet_idle_nag(var_0, var_1) {
...
function intro_scene_player(var_0) {
...
function rooftops_main() {
  ...
  var_5 = scripts\sp\maps\safehouse_finale\safehouse_finale::board_getallydronestartnodes();

  foreach(var_7 in var_5) {
    var_8 = scripts\sp\maps\safehouse_finale\safehouse_finale_utility::level_dronespawnVehicle(var_7.origin, var_7.angles);
    thread scripts\sp\maps\safehouse_finale\safehouse_finale::fly_allydronepathlogic(var_8, var_7, 0);
  }
  ...
  var_11 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnfarah();
  var_12 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnhadir();
  var_13 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnarmen();
  level.player takeweapon("ks_remote_device");
  level.player switchtoweapon(level.player.playeroriginalweapon);
  var_11 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_getfarah();
  var_12 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_gethadir();
  var_11.allowdeath = 1;
  var_12.allowdeath = 1;
  ...
  var_15 = scripts\sp\maps\safehouse_finale\safehouse_finale_utility::ai_getaliveaiarray("axis");
...
function hc_workers_scene() {
  ...
  foreach(var_3 in var_0) {
    var_1 = createnavbadplacebyent(var_3, "allies");
  }
...
function bad_place_remover(var_0) {
...
function ally_town_movement_bink() {
  var_0 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_getfarah();
  var_1 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_gethadir();
  level.allies = getaiarray("allies");
...
function scene_pep_talk(var_0) {
  ...
  foreach(var_2 in level.wall_actors) {
    var_2 clearpath();
  ...
  level.farah scripts\sp\maps\safehouse_finale\safehouse_finale_utility::nagtill_delayed(8, "pep_talk_trigger", var_7);
...
function anim_reach_failsafe_go(var_0, var_1, var_2) {
...
function pre_charge_start() {
  ...
  scripts\sp\maps\safehouse_finale\safehouse_finale::player_givemolotovweapon();
  var_0 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnfarah();
  var_1 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnhadir();
  var_2 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnarmen();
  scripts\engine\sp\utility::set_start_location("start_river", [level.player, var_0, var_1]);
  var_3 = scripts\sp\maps\safehouse_finale\safehouse_finale::spawnallies();
...
function pre_charge_main() {
  ...
  for(var_3 = 0; var_3 < 2; var_3++) {
    thread pre_charge_wall_anims(var_2[var_3]);
  }
...
function pre_charge_wall_anims(var_0) {
  level endon("early_charge");
  self endon("death");
...
function hellcannon_first_strike(var_0) {
  var_1 = spawnStruct();
  var_1.origin = (-35920, 32944, -552);
  var_2 = scripts\sp\maps\safehouse_finale\safehouse_finale::explosion_gethellcannonstructs();
  level notify("hell_cannon_fire_move_tank");
  scripts\sp\maps\safehouse_finale\safehouse_finale::level_hellcannonfire(var_2[0], var_1, 3.5);
...
function charge_main() {
  ...
  var_1 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_getfarah();
  scripts\sp\maps\safehouse_finale\safehouse_finale::rocket_setnotsolidtargets();
  var_1 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_getfarah();
  var_2 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_gethadir();
  ...
  var_3 = scripts\sp\maps\safehouse_finale\safehouse_finale_utility::array_removedeaddyingorundefined(var_3);
  ...
  level notify("hell_cannon_fire_move_tank");
  var_19 = scripts\sp\maps\safehouse_finale\safehouse_finale::explosion_gethellcannonstructs();
  scripts\sp\maps\safehouse_finale\safehouse_finale::level_hellcannonfire(var_19[0], var_18, 4);
...
function run_dialogue() {
  ...
  var_0 thread scripts\sp\maps\safehouse_finale\safehouse_finale_utility::say_as_chatter("dx_vom_rcom_pre_charge_setup_50");
  var_0 scripts\sp\maps\safehouse_finale\safehouse_finale_utility::say_as_chatter("dx_vom_rcom_pre_charge_setup_60");
  ...
  var_0 scripts\sp\maps\safehouse_finale\safehouse_finale_utility::say_as_chatter("dx_vom_rcom_pre_charge_setup_70");
  var_0 delete();
}
...
function hell_cannon_reactions(var_0) {
...
function rpg_guy_logic() {
  ...
  var_0 scripts\anim\shared::forceuseweapon("iw8_la_rpapa7_straight", "primary");
...
function check_stay_in_river(var_0) {
...
function charge_allypathlogic(var_0, var_1, var_2, var_3) {
  if(isDefined(var_3)) {
    wait var_3;
  }
  ...
  scripts\sp\maps\safehouse_finale\safehouse_finale_utility::ai_movealongpath(var_0, var_1);
...
function charge_setalliestoredshirts() {
  var_0 = scripts\sp\maps\safehouse_finale\safehouse_finale::getallies();
...
function bunkers_start() {
  ...
  var_1 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnhadir();
  var_2 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnarmen();
  var_3 = scripts\sp\maps\safehouse_finale\safehouse_finale::spawnallies(10);
  var_4 = charge_setalliestoredshirts();
...
function anim_gate_truck_lights() {
  ...
  foreach(var_3 in var_0) {
    if(scripts\engine\utility::is_equal(var_3.script_noteworthy, "left")) {
      ...
      var_3.origin += anglestoright(var_3.angles) * var_1;
...
function hangar_hatch() {
  ...
  thread hadir_pick_up_loop(var_0);
...
function hadir_pick_up_loop(var_0) {
  var_1 = self;
...
function hadir_boost_nag(var_0) {}
...
function gunner_bravo_spawn() {
  ...
  var_0 thread scripts\sp\maps\safehouse_finale\safehouse_finale_utility::track_fob_helo_spawn();
}
...
function transport_bravo_spawn() {
  ...
  level notify("chopper_spawned");
  var_1 thread scripts\sp\maps\safehouse_finale\safehouse_finale_utility::track_fob_helo_spawn();
}
...
function ally_fob_movement(var_0) {
  scripts\engine\utility::flag_wait("bunkers_breached");
  scripts\engine\sp\utility::activate_trigger_with_targetname("bunkers_color_trigger");
  level.allies = getaiarray("allies");
...
function ally_movement_containers(var_0) {
  scripts\engine\utility::flag_wait("fob_cleared");
  ...
  foreach(var_5 in level.allies) {
    ...
    if(isalive(var_5) && isDefined(var_5)) {
      ...
      if(var_5 == var_2) {
        ...
        thread hadir_truck_entrance(var_5);
        continue;
      }
...
function hadir_truck_entrance(var_0) {
  if(isDefined(var_0)) {
    waitframe();
  }
...
function enemies_cleared_move_forward(var_0) {
...
function fob_center_start() {
  ...
  var_1 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnhadir();
  var_2 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnarmen();
  var_3 = scripts\sp\maps\safehouse_finale\safehouse_finale::spawnallies(7);
  var_4 = charge_setalliestoredshirts();
  var_5 = bunker_getallycovernodes();
  level.allies = scripts\engine\sp\utility::array_merge(var_4, [var_0, var_1, var_2]);
...
function fob_center_main() {
  ...
  var_3 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_getfarah();
  var_4 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_gethadir();
...
function vo_fob_center_snipers() {
  var_0 = [];
  GscBinSkip0(0x2e, var_0.size, "dx_vom_far_tarmac_snipers_10");
}

function fob_center_autosave(var_0) {
...
function favela_door_guy_anims(var_0, var_1) {
  self endon("death");
...
function door_ent_movement(var_0) {
  var_1 = 3;
  var_0 endon("death");
...
function door_gag_magic_bullet(var_0) {
...
function get_enemy_info_all(var_0) {
  self endon("death");
...
function fob_spawn_manager() {
  ...
  var_8 = [];
  GscBinSkip0(0x2e, var_8.size, tower_spawner_logic("tower_guy_fob"), level);
}

function tower_guy_cleanup() {}

function rooftop_directoring(var_0) {
  if(var_0.size < 1) {
    return;
  }
...
function tower_spawner_logic(var_0, var_1) {
  if(isDefined(var_1)) {
    wait var_1;
  }
...
function ally_drone_attack(var_0) {
  self endon("death");
  level endon("fob_cleared");
  ...
  var_3 = 0.9998;
  jumpiffalse(isDefined(var_0)) LOC_00000056;
  ...
  var_6 = scripts\sp\maps\safehouse_finale\safehouse_finale_utility::level_dronespawnVehicle(var_5.origin, var_5.angles);
  var_6.maxhealth = 30000;
  thread scripts\sp\maps\safehouse_finale\safehouse_finale::fly_allydronepathlogic(var_6, var_5);
}
...
function goal_ent_player(var_0, var_1) {
  var_2 = getaiarray("axis");
...
function goal_ent_position(var_0, var_1, var_2, var_3) {
...
function armory_01_start() {
  ...
  var_1 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnhadir();
  var_2 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnarmen();
  var_3 = scripts\sp\maps\safehouse_finale\safehouse_finale::spawnallies(4);
  var_4 = charge_setalliestoredshirts();
...
function containers_gate_start() {
  ...
  var_3 = scripts\sp\maps\safehouse_finale\safehouse_finale::spawnallies(5);
  var_4 = charge_setalliestoredshirts();
  var_5 = fobchu_getallycovernodes();
...
function containers_gate_main() {
  ...
  var_0 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_gethadir();
...
function containers_truck_main() {
  ...
  var_0 = scripts\sp\maps\safehouse_finale\safehouse_finale_utility::ai_getaliveaiarray("axis");
...
function player_clear_truck_nag(var_0) {
  var_1 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_gethadir();
  ...
  for(;;) {
    ...
    if(level.player istouching(var_0)) {
      var_1 thread scripts\sp\maps\safehouse_finale\safehouse_finale_utility::dialogue("Alex, I'm going to hit the gate with the truck.");
    }
...
function player_clear_armory_nag(var_0) {
  var_1 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_gethadir();
  level endon("hadir_gate_smash");

  for(;;) {
    if(level.player istouching(var_0)) {
      var_1 thread scripts\sp\maps\safehouse_finale\safehouse_finale_utility::dialogue("Get what you need and get back out here, Alex.");
    }
...
function close_airport_gate(var_0) {
...
function airport_gate_trigger(var_0) {
  if(isDefined(var_0)) {
    return;
  }
...
function tarmac_start() {
  ...
  var_0 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnfarah();
  var_1 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnhadir();
  var_2 = scripts\sp\maps\safehouse_finale\safehouse_finale::spawnallies(5);
...
function ally_rpg_guy() {
  ...
  var_3 scripts\anim\shared::forceuseweapon(var_6, "primary");
  wait 1;
  var_3.ignoreall = 0;
}
...
function hangar_drag_scene() {
  ...
  var_1.health = 100;
  thread budy_death_watcher(var_1);
  thread budy_death_watcher(var_2);
...
function budy_death_watcher(var_0) {
...
function tarmac_push_player(var_0) {
  while(var_0.size) {
    var_0 = scripts\engine\utility::array_removedead_or_dying(var_0);
    var_0 = sortbydistance(var_0, level.player.origin);
...
function hangar_defend_start() {
  ...
  var_2 = scripts\sp\maps\safehouse_finale\safehouse_finale::spawnallies(1);
  var_3 = charge_setalliestoredshirts();
  var_4 = towerstairs_getallycovernodes();
...
function pallet_light_lerps() {
  ...
  thread scripts\sp\maps\safehouse_finale\safehouse_finale_lighting::lerp_value_charge_explosion(var_0, var_0 * 0.15, 0.5);
  wait 4;
  thread scripts\sp\maps\safehouse_finale\safehouse_finale_lighting::lerp_value_charge_explosion(var_0 * 0.15, var_0, 3);
}
...
function killstreak_chopper_main() {
  ...
  while(gettime() <= var_26 && !level.player scripts\sp\maps\safehouse_finale\safehouse_finale::stick_forward()) {
    waitframe();
  }
...
function apache_start_moving_nags() {
  ...
  level thread scripts\sp\maps\safehouse_finale\safehouse_finale_utility::nagtill_delayed(15, "apache_start_moving_nags", var_0, 12, 1.2);
...
function apache_fire_vo() {
  ...
  while(level.player attackButtonPressed() && !var_1 scripts\engine\sp\utility::deck_is_empty()) {
    level scripts\sp\maps\safehouse_finale\safehouse_finale_utility::say_as_chatter(var_1 scripts\engine\sp\utility::deck_draw(), 0, 0.5);
    wait 0.1;
  }
}
...
function apache_killconfirm_vo() {
  var_0 = [];
  GscBinSkip0(0x2e, var_0.size, "dx_vom_apap_killstreak_chopper_reactions_100");
}
...
function apache_reloading_vo() {
  ...
  for(;;) {
    ...
    level thread scripts\sp\maps\safehouse_finale\safehouse_finale_utility::say_as_chatter(var_3, 0, 3);
    wait 4.5;
    var_3 = var_2 scripts\engine\sp\utility::deck_draw();
    level thread scripts\sp\maps\safehouse_finale\safehouse_finale_utility::say_as_chatter(var_3, 0);
  }
}
...
function run_to_position(var_0, var_1, var_2) {
  self endon("death");
...
function ending_scene_start() {
  ...
  var_2 = scripts\sp\maps\safehouse_finale\safehouse_finale::spawnallies(2);
  var_3 = scripts\sp\maps\safehouse_finale\safehouse_finale::trench_spawnallies();
  var_4 = charge_setalliestoredshirts();
...
function ending_scene_main() {
  ...
  var_2.origin += anglesToForward(var_2.angles) * 10000;
  ...
  var_3 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_getfarah();
  var_4 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_spawnhadir();
  ...
  var_5 scripts\anim\shared::forceuseweapon(level.player.fake_weapon, "primary");
  ...
  level.blackoverlay.alpha = 0;
  thread ending_scene_anims(var_7, var_3, var_5);
...
function ending_scene_anims(var_0, var_1, var_2) {
  var_3 = [var_0, var_1, var_2];
  thread scripts\common\anim::anim_single(var_3, "outro_scene");
  thread scene_mayhem(var_1, %shf_050_3p_outro_alex_face);
  thread scene_mayhem(var_0, %shf_050_3p_outro_farah_face);
  thread scene_mayhem(var_2, %shf_050_3p_outro_hadir_face);
}

function scene_mayhem(var_0, var_1, var_2) {
...
function play_mayhem_animation(var_0, var_1) {
  ...
  if(isDefined(var_1)) {
    level waittill(var_1);
    self setanim(var_0, 0, 0, 0);
    self attach(self.headmodel);
    return;
  }
}

function ending_scene_ent_cleanup(var_0) {
  if(isDefined(var_0)) {
    wait var_0;
  }
  ...
  var_5 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_getfarah();
...
function tarmac_umike_01(var_0) {
  var_1 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_gethadir();
...
function tarmac_vindia_02(var_0, var_1) {
  if(isDefined(var_0)) {
    var_2 = var_0;
  } else {
    var_2 = 0;
  ...
  wait var_2;
  var_3 = scripts\sp\maps\safehouse_finale\safehouse_finale::level_gethadir();
...
function vindia_spotlight() {
  ...
  foreach(var_3 in var_0) {
    ...
    var_3.origin += anglesToForward(var_3.angles) * var_1;
...
function tarmac_vindia_03() {
  ...
  tank_aim_at(var_1, var_3);

  while(var_1.veh_speed > 0) {
    wait 0.1;
  }

  tank_fire_enable(var_1);
  var_4 = scripts\engine\utility::spawn_tag_origin(var_1.origin, var_1.angles);
  var_1 linkTo(var_4);
...
function tank_aim_at(var_0, var_1) {
  if(!isDefined(var_1)) {
    var_1 = (0, 0, 0);
  }
...
function gunner_death_watcher(var_0) {
  self endon("death");
  var_0 waittill("death");
  self kill();
}
...
function radiant_cockpit_light(var_0) {
...
function chopper_crew_behavior() {
  ...
  foreach(var_2 in var_0) {
    if(scripts\engine\utility::is_equal(var_2.script_noteworthy, "gunner")) {
      ...
      thread crew_chopper_death_watcher_behavior(var_2);
...
function pilot_death_watcher(var_0) {
  self endon("death");
...
function chopper_nags() {
  ...
  for(;;) {
    var_0 thread scripts\sp\maps\safehouse_finale\safehouse_finale_utility::dialogue("Hit that chopper with an RC plane!");
    wait 18;
  }
}
...
function boss_chopper_rockets() {
  ...
  while(!scripts\engine\utility::flag("boss_chopper_dead")) {
    ...
    if(!scripts\engine\utility::flag("chopper_wounded")) {
      var_7 += anglesToForward(level.player.angles) * var_3;
      var_8 += anglesToForward(level.player.angles) * var_3;
    }
...
function fob_ks_chopper_behavior(var_0) {
  self endon("death");
  self endon("kill_chopper_logic");
  self endon("chopper_gunners_dead");
  var_1 = 0;
...
function lb_mg_50cal(var_0, var_1) {
  var_2 = 1.1;
...
function crew_chopper_death_watcher_behavior(var_0) {
...
function crew_chopper_transport_behavior(var_0) {
  self endon("death");
  var_0 waittill("goal");
...
function spawn_check_func(var_0, var_1, var_2) {
  if(scripts\engine\utility::flag("ai_spawner_busy")) {
  ...
  for(var_7 = 0; var_7 < var_4; var_7++) {
    ...
    var_6 = var_5[var_7] scripts\engine\sp\utility::spawn_ai(1);
    var_5[var_7].count = 1;
  }
...
function cull_redshirts_for_startpoint(var_0, var_1) {
  var_2 = [];

  if(var_0.size > var_1) {
    GscBinSkip0(0x2e, var_2.size, scripts\engine\utility::array_remove(var_0, var_0[var_0.size - 1]));
  }
...
function town_technical_01() {
  ...
  foreach(var_4 in var_1) {
    if(scripts\engine\utility::is_equal(var_4.script_noteworthy, "left")) {
      ...
      var_4.origin += anglesToForward(var_4.angles) * var_2;
...
function location_objective_remover(var_0) {
  level endon("killstreak_complete");
  var_1 = self.objindex;
  self waittill("death");
...
function dialoge_fly_off_course() {
  ...
  for(;;) {
    ...
    level scripts\sp\maps\safehouse_finale\safehouse_finale_utility::say_as_chatter(var_1 scripts\engine\sp\utility::deck_draw());
...
function dialogue_rooftops() {
  ...
  level.farah scripts\sp\maps\safehouse_finale\safehouse_finale_utility::nagtill_delayed(8, "reached_hc_meeting", var_1, 10);
...
function dialogue_pre_charge_pep() {
  ...
  var_0 = sortbydistance(var_0, level.player.origin);
  var_0[1] thread scripts\sp\maps\safehouse_finale\safehouse_finale_utility::say("dx_vom_lf4_pre_charge_setup_180");
  wait 0.6;
}
...
function say_on_closest_enemy(var_0, var_1, var_2) {
  var_3 = getaiarray("axis");
  var_3 = scripts\engine\utility::array_removedead_or_dying(var_3);
  ...
  var_4 scripts\sp\maps\safehouse_finale\safehouse_finale_utility::say_as_chatter(var_0, var_1, var_2);
}

function wait_lookat_armory(var_0) {
  level endon("hadir_sees_armory");
  level endon("looked_at_armory");
  scripts\sp\maps\safehouse_finale\safehouse_finale_utility::wait_lookat(var_0, 100);
...
function wait_hadir_sees_armory(var_0) {
  level endon("hadir_sees_armory");
  level endon("looked_at_armory");
...
function dialogue_armory_02() {
  ...
  level.farah thread scripts\sp\maps\safehouse_finale\safehouse_finale_utility::nagtill("hangar_defend_start", var_0, 12);
}

function wait_guys_all_reach_node(var_0, var_1) {
  var_1 = squared(var_1);
...
function wait_guys_any_reach_node(var_0, var_1) {
  var_1 = squared(var_1);
...
function dialogue_check_lock_and_nag_boost() {
  ...
  level.hadir scripts\sp\maps\safehouse_finale\safehouse_finale_utility::nagtill(undefined, var_0, 8);
}
...
function dialogue_nag_open_armory_02() {
  ...
  wait 4;
  var_0 = [];
  GscBinSkip0(0x2e, var_0.size, [level.farah, "dx_vom_far_armory_02_breach_40"]);
}
...
function armory_01_nag() {
  ...
  level.farah childthread scripts\sp\maps\safehouse_finale\safehouse_finale_utility::nagtill("armory_01_trigger", var_0, 10, 2, 35);

  for(;;) {
    level waittill("started_nag", var_1, var_2);
    var_3 = lookupsoundlength(var_2) / 1000;
    childthread scripts\sp\maps\safehouse_finale\safehouse_finale_utility::focus_reminder("armory_01_trigger", var_3 + 20);
    wait var_3 + 20;
  }
}
...
function dialogue_containers_gate() {
  ...
  level.farah thread scripts\sp\maps\safehouse_finale\safehouse_finale_utility::nagtill_delayed(1, "farah_gate_lookat", var_1, 10);
  ...
  level.hadir scripts\sp\maps\safehouse_finale\safehouse_finale_utility::nagtill_open("player_in_truck_path", var_1, 6);
  scripts\engine\utility::flag_set("hadir_ramming_dialogue_complete");
}
...
function player_in_area_check(var_0, var_1, var_2, var_3) {
  var_4 = gettime();
  ...
  var_3 = scripts\sp\maps\safehouse_finale\safehouse_finale_utility::default_if_undefined(var_3, 1200);
  var_1 = scripts\sp\maps\safehouse_finale\safehouse_finale_utility::default_if_undefined(var_1, 0.9848);
  var_5 = 600;
...
function dialogue_killstreak_waiting() {
  ...
  level scripts\sp\maps\safehouse_finale\safehouse_finale_utility::nagtill("air_support_inbound", var_0, 12, 1.2);
}
...
function take_out_armor_nags() {
  ...
  while(level.ks_vehicles.size > 0) {
    level.incomingapache scripts\sp\maps\safehouse_finale\safehouse_finale_utility::say_as_chatter(var_1 scripts\engine\sp\utility::deck_draw());
