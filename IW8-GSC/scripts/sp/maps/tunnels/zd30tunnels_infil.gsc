...
function objective_control(var_0) {
  switch (var_0) {
    case "intro":
...
function resume_idle_or_anim(var_0) {
...
function temp_scriptablerotateTo(var_0, var_1, var_2, var_3) {
...
function heli_spawn_alpha(var_0) {
  ...
  var_8 = link_player_to_rig_free_look(var_0, "heli_intro", undefined, undefined, undefined, 0, 20, 25, 30, 22);
  level.player freezelookcontrols(1);
  level.player disableoffhandweapons();
  var_8.animweapon = thread anim_weapon_for_player();
  ...
  thread play_then_delete(level.kyle, var_0);
  thread play_single_anim_player(var_8);
...
function sort_allies(var_0, var_1, var_2) {
  if(isDefined(var_2)) {
...
function audio_zd30_intro_lbird_plr_heli() {
  ...
  var_0 scripts\engine\utility::delaycall(4.5, &scalevolume, 1, 2.5);
...
function audio_zd30_intro_lbird_plr_heli_kill_entities(var_0, var_1) {
  wait 24;
...
function rand_num(var_0, var_1) {
  var_2 = randomfloatrange(var_0 - var_1, var_0 + var_1);
  return var_2;
}

function heli_spawn_bravo(var_0) {
...
function heli_spawn_charlie(var_0) {
...
function heli_intro_anim_unlink_player(var_0) {
...
function nag_enter_b1_internal(var_0) {
  level endon("start_sledge");
  ...
  for(;;) {
    wait 12;
    level.price scripts\sp\maps\tunnels\zd30tunnels_utility::nagtill("player_inside_b1", var_0, 15);
...
function setup_alpha_breach_jumpto() {
  ...
  foreach(var_3 in var_0) {
    ...
    thread breach_anims_jumpto(var_3);
  }

  thread setup_alpha_breach_team(var_1);
}

function setup_alpha_breach_team(var_0) {
...
function breach_anims_jumpto(var_0) {
  var_0 thread scripts\common\anim::anim_loop_solo(self, "breach_idle", "stop_breach_loop");
...
function breach_gate_nag(var_0) {
  level endon(var_0);
  ...
  thread nag_system(level.alpha4, var_0, var_1, 13);
}
...
function dog_kill_and_main_house_vo(var_0) {
...
function laser_discipline_kill(var_0) {
...
function b1_girl_action() {
  ...
  scripts\engine\sp\utility::anim_stopanimScripted();
  GscBinSkip4(0x35, "building1_mom_dead", var_0);
}
...
function b1_girl_damage_watcher(var_0) {
...
function b1_girl_ads_watcher(var_0) {
  level endon("b1_girl_dead");
...
function alpha5_b1_girl_secure(var_0) {
  level endon("b1_girl_dead");
...
function b1_mom_child_nag(var_0) {
  level endon(var_0);
...
function b1_mom_damage_tracker(var_0, var_1) {
  for(;;) {
...
function animation_single_then_loop(var_0) {
  var_0 scripts\common\anim::anim_single_solo(self, "protect_death");
  var_0 thread scripts\common\anim::anim_loop_solo(self, "protect_death_idle", "b1_child_stop_loop");
}

function b1_mom_action(var_0) {
...
function b1_child_action(var_0) {
  if(scripts\engine\utility::flag("mom_isflashed")) {
    scripts\engine\sp\utility::anim_stopanimScripted();
    var_0 notify("b1_child_stop_loop");
    var_0 scripts\common\anim::anim_single_solo(self, "protect_react");
...
function b1_back_room_vo(var_0) {
  b1_back_room_approach_vo(var_0);
  b1_child_reaction_vo();
}

function b1_back_room_approach_vo(var_0) {
...
function runner_temp_death(var_0, var_1) {
  self.allowdeath = 0;
...
function setup_1f_main_door_arrival() {
  ...
  foreach(var_3 in var_0) {
    thread approach_fd_and_idle(var_3);
    var_3.a.laseron = 1;
    var_3 scripts\anim\shared::updatelaserstatus();
  }

  thread setup_1f_main_door(var_1);
}

function approach_fd_and_idle(var_0) {
...
function setup_1f_main_door(var_0) {
  ...
  thread anim_scriptable(var_0, level.maindoor[0]);

  foreach(var_3 in var_1) {
    thread door_react_anim(var_3);
  }
  ...
  thread allies_nvg_on(var_1);
  bravo5_anim_check(level.bravo5, var_0);
...
function play_light_fx_on_door(var_0) {
...
function bravo5_anim_check(var_0) {
  var_0 notify("stop_door_arrival_idle_" + self.animname);
}

function door_react_anim(var_0) {
...
function alpha_moveup_post_breach() {
  ...
  foreach(var_1 in level.alpha_trailers) {
    ...
    set_goal_node_and_poi(var_1, var_1.nodeend, var_5);
  }
}
...
function moveto_compound(var_0, var_1) {
...
function hallway_1f_nag(var_0) {
  ...
  thread nag_system(level.bravo4, var_0, var_1, 8, 10);
}
...
function moveto_intro_anim(var_0) {
  var_0 notify("stop_first_frame");
...
function open_1f_runner_door() {
  ...
  door_waittill_open(var_0[0], 25, "1f_runner_start");
  door_waittill_open(var_0[0], 30, "1f_civ_reaction");
}
...
function setup_1f_side_door_arrival() {
  ...
  foreach(var_3 in var_0) {
    thread setup_1f_side_door_anim(var_3);
  }
}

function setup_1f_side_door_anim(var_0) {
...
function setup_1f_side_door(var_0) {
  scripts\engine\utility::flag_wait("compound_side_door_breach");
...
function side_window_target(var_0, var_1, var_2) {
...
function waittill_player_looks_at_hallway(var_0) {
...
function bravo5_in_door(var_0) {
  ...
  for(;;) {
    ...
    if(var_3 < 60 && scripts\engine\utility::within_fov(level.player getEye(), level.player.angles, self gettagorigin("j_head"), var_2)) {
      scripts\common\utility::lookatentity(level.player);
      wait 2;
      scripts\common\utility::lookatentity();
      break;
...
function price_move_midway(var_0) {
  scripts\engine\sp\utility::anim_stopanimScripted();
...
function civ01_deathwatch(var_0) {
  self endon("death");
  level endon("3f_cleared");
...
function civ02_deathwatch(var_0) {
  self endon("death");
...
function civ03_deathwatch(var_0) {
  self endon("death");
  level endon("3f_cleared");
...
function moveup_1f_hallway(var_0) {
  wait 1.2;
...
function moveto_unbreachable_door(var_0) {
  scripts\common\ai::reset_gunpose();
  self.inanim = 1;
...
function open_1f_hallway_door(var_0) {
...
function power_handle_down(var_0) {
...
function setup_2f_stairs_vo() {
  ...
  wait_near(level.player, var_0, 40);
...
function setup_1f_kitchen_scene() {
  ...
  foreach(var_4 in var_2) {
    thread kitchen_scene_speedup(var_4);
  }
...
function kitchen_scene_speedup(var_0) {
...
function bed_enemy_2f_action(var_0) {
...
function bed_civ_2f_action(var_0) {
  level.bedciv = self;
...
function balcony_enemy_2f_action(var_0) {
...
function temp_bed_enemy_shooting(var_0) {
  ...
  for(var_10 = 0; isalive(var_0); var_10 = gettime() + 1500) {
    waitframe();
...
function price_dataciv_is_dead(var_0) {
...
function play_2f_data_anim(var_0) {
  var_0 scripts\common\anim::anim_single_solo(self, "2f_data_scene");
...
function setup_2f_bedroom() {
  ...
  var_0 scripts\engine\utility::array_thread(var_0, &scripts\game\sp\door::remove_door_snake_cam_ability);
  thread interactive_door_lock_one_side(var_0[0]);
  ...
  if(isalive(level.balcony_enemy)) {
    ...
    failsafe_2f_balcony_setup(level.balcony_enemy, var_0, var_1);
    return;
  }
}
...
function failsafe_2f_balcony_setup(var_0, var_1) {
  scripts\engine\utility::flag_clear("start_shadow");
  thread door_waittill_open(var_0[0], 30);
  ...
  for(;;) {
    ...
    if(scripts\engine\utility::within_fov(level.player getEye(), level.player getplayerangles(), level.bravo4 gettagorigin("j_head"), var_2) && scripts\engine\trace::ray_trace_passed(level.player getEye(), level.bravo4 gettagorigin("j_head"), [level.bravo4, level.player])) {
      break;
    }
  ...
  if(scripts\engine\utility::flag("start_shadow")) {
    ...
    var_5 = "2f_balcony_deathA";
    var_5 = scripts\engine\utility::getStruct(var_5 + "_struct", "targetname");
    var_5 scripts\common\anim::anim_first_frame_solo(self, var_5);
  }

  wait 0.5;
  level.bravo4 shoot(1, self);
  thread failsafe_2f_balcony_death(var_5, var_5);
  wait 0.15;
  level.bravo4 shoot(1, self);
  wait 0.8;
}
...
function failsafe_2f_balcony_death(var_0, var_1) {
  self.diequietly = 1;
  self.skipdeathanim = 1;
  self.noragdoll = 1;
  var_0 notify("stop_first_frame");
...
function scriptable_watcher(var_0, var_1, var_2) {
  level endon("tunnels_transition");
  scripts\engine\utility::flag_wait("scriptables_ready");
...
function interactive_door_lock_one_side(var_0) {
...
function setup_3f_bravo1(var_0) {
...
function spawn_3f_stairs_enemy(var_0) {
...
function stairs_3f_enemy(var_0) {
  self waittill("stairtrain_end");
...
function balcony_3f_door() {
  ...
  var_0 scripts\engine\utility::array_thread(var_0, &scripts\game\sp\door::remove_door_snake_cam_ability);
  thread door_waittill_open(var_0[0], 25);
  return var_0[0];
}
...
function setup_3f_scene(var_0) {
  ...
  thread enemy_3f_death(var_2, var_0, var_3, var_6);
  ...
  if(scripts\engine\utility::flag("player_is_breaching_hallway")) {
    ...
    if(!scripts\engine\utility::flag("3f_favela_guy_dead")) {
      thread anim_door(var_0, var_6);
      thread anim_door(var_0, var_5);
  ...
  var_0 notify("stop_favella_loop");
  thread anim_door(var_0, var_7);
  thread anim_door(var_0, var_8);
...
function setup_gear_alex() {
  ...
  level.alex scripts\anim\shared::forceuseweapon(var_0, "primary");
}
...
function bravo1_enters_3f_room(var_0) {
...
function bravo1_3f_ending(var_0) {
  self endon("death");
...
function enemy_3f_death(var_0, var_1, var_2, var_3) {
...
function enemy_3f_damage(var_0) {
  level endon("3f_favela_guy_dead");
  ...
  for(;;) {
    ...
    self.fakehealth -= var_1;
  }
}

function enemy_3f_weap_clip(var_0) {
  level endon("3f_favela_guy_dead");
  var_0 setCanDamage(1);
  ...
  for(;;) {
    ...
    if(isDefined(var_5) && var_5 != "MOD_MELEE") {
      ...
      self.fakehealth -= var_11;
    }
  }
}

function death_scene_3f(var_0, var_1, var_2, var_3) {
  var_0 notify("stop_favella_loop");
  var_0 notify("stop_first_frame");
  thread anim_door(var_0, var_2);
  thread anim_door(var_0, var_3);

  if(isalive(var_1)) {
    thread death_scene_enemy(var_1);
  }
  ...
  for(;;) {
    ...
    if(isalive(var_1) && distancesquared(level.player.origin, var_1.origin) <= var_5) {
      break;
    }
    ...
    if(scripts\engine\utility::within_fov(level.player getEye(), level.player getplayerangles(), self.origin, var_4)) {
      break;
    }
...
function death_scene_enemy(var_0) {
...
function smart_dialogue_tracked(var_0) {
...
function track_dialogue(var_0, var_1) {
  self.speaking = 1;
...
function fail_for_wild_firing_charlie() {
  ...
  for(;;) {
    ...
    foreach(var_3 in level.charlie) {
      if(isDefined(var_3) && in_player_fov(var_3, var_0)) {
        var_1 = 1;
      }
    }
...
function fail_for_wild_firing(var_0) {
  level endon("tunnels_transition");
  ...
  for(;;) {
    ...
    foreach(var_6 in var_2) {
      if(isDefined(var_6) && in_player_fov(var_6, var_3)) {
        var_4 = 1;
      }
    }
...
function cleanup_2f(var_0) {
  thread animate_2f_extras(var_0);

  foreach(var_2 in self) {
    thread flash_allies(var_2);
    var_2 scripts\common\ai::reset_gunpose();
    thread cleanup_2f_anim(var_2);
  }
}

function flash_allies(var_0) {
...
function cleanup_2f_anim(var_0) {
  level endon("tunnels_transition");
...
function spawn_2f_bodies(var_0) {
  var_0 notify("stop_last_frame");
...
function spawn_2f_extras(var_0) {
  level.sse_bags = [];
  level.sse_items = [];
  var_1 = 42;
...
function animate_2f_extras(var_0) {
  var_0 notify("stop_first_frame");
...
function teahouse_walk_vo() {
  ...
  var_0 = [];
  GscBinSkip0(0x2e, var_0.size, [level.price, "dx_vom_pri_downstairs_teahouse_130"]);
}
...
function skippable_tunnels_transition(var_0) {
  var_1 = scripts\sp\utility::userskip_wait();
...
function tunnels_door_anim(var_0) {
...
function trap_door_plywood(var_0) {
...
function setup_fake_bomber(var_0) {
...
function setup_kyledrone(var_0) {
...
function walkto_1f_price_anims(var_0) {
  scripts\engine\utility::flag_wait("downstairs_2f");
  wait 0.7;
...
function walkto_1f_anims(var_0) {
...
function walkto_door_anims(var_0) {
  level endon("tunnels_transition");
...
function walkto_tunnels_anim(var_0) {
...
function unarmed_enemy_check() {
  ...
  level.player scripts\sp\maps\tunnels\zd30tunnels_utility::say_as_chatter(var_2, 0, 0.2);
}
...
function get_unarmed_response() {
  ...
  var_0 = [];
  GscBinSkip0(0x2e, var_0.size, "dx_vom_kyle_civkill_reactions_10");
}

function link_player_to_rig_free_look(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10) {
...
function unlink_player_from_rig_free_look(var_0, var_1) {
...
function allies_nvg_on(var_0) {
  jumpiffalse(var_0) LOC_00000047;
...
function ai_nvg_up(var_0, var_1) {
...
function ai_nvg_down(var_0, var_1) {
...
function spawn_glowstick_on_struct(var_0) {
...
function lookat_random_lite(var_0) {
  level endon(var_0);
  var_1 = 0.1;
  var_2 = 0.5;
  var_3 = 3;
...
function play_single_anim_player(var_0) {
...
function play_single_anim(var_0) {
  self.plays_single_anim = 1;
  level endon("heli_intro_skipped");
  var_0 scripts\common\anim::anim_single_solo(self, "heli_pre_intro");
...
function play_multi_anim(var_0, var_1) {
...
function anim_gun_react(var_0, var_1, var_2, var_3, var_4) {
  level endon(var_4);
  self endon("death");
  var_5 = 0;
  var_6 = cos(var_3);
...
function anim_gun_react_and_idle(var_0, var_1, var_2, var_3, var_4) {
  level endon(var_4);
  self endon("death");
  var_5 = 0;
  self.iamflashed = 0;
...
function get_is_looking_at(var_0, var_1, var_2, var_3) {
  ...
  if(!isDefined(var_4) || var_4) {
    jumpiffalse(isent(var_2)) LOC_0000007d;
    var_6 = [self, var_2];
    goto LOC_00000084;
  } else {
    var_7 = 1;
...
function set_goal_node_and_poi(var_0, var_1) {
  scripts\common\ai::poi_enable(1, var_1);
  self setgoalnode(var_0);
  wait 3;
  scripts\common\ai::poi_enable(0);
...
function compound_door_setup(var_0) {
  var_1 = getEnt(var_0, "targetname");
...
function compound_lights_on(var_0) {
  var_1 = [];
  var_2 = [];
  waitframe();
...
function compound_lights_off(var_0) {
  var_1 = [];
  var_2 = [];
  waitframe();
...
function turn_lights_onoff(var_0, var_1) {
...
function anim_door(var_0, var_1, var_2) {
...
function anim_scriptable(var_0, var_1) {
...
function open_main_door() {
  ...
  var_1 = scripts\engine\utility::getStruct("1f_animnode", "targetname");
  anim_scriptable(var_1, var_0[0], "main_door_open");
}

function interactive_double_door_force_open(var_0) {
  if(!scripts\engine\utility::flag("scriptables_ready")) {
    scripts\engine\utility::flag_wait("scriptables_ready");
  }
  ...
  thread interactive_door_force_open(var_2);
  thread interactive_door_force_open(var_3);
}

function interactive_door_force_open(var_0) {
  if(!scripts\engine\utility::flag("scriptables_ready")) {
    scripts\engine\utility::flag_wait("scriptables_ready");
  }
...
function door_waittill_open(var_0, var_1) {
  self endon("entitydeleted");
...
function force_open_doors(var_0, var_1, var_2, var_3) {
  scripts\engine\utility::flag_wait("interactive_doors_ready");

  if(isDefined(var_0)) {
    interactive_double_door_force_open(level.player, var_0);
  }

  if(isDefined(var_1)) {
    interactive_double_door_force_open(level.player, var_1);
  }

  if(isDefined(var_2)) {
    interactive_double_door_force_open(level.player, var_2);
    return;
  }
}

function waittill_struct_within_fov(var_0, var_1) {
...
function waittill_struct_or_self_within_fov(var_0, var_1) {
  var_2 = scripts\engine\utility::getStruct(var_0, "targetname");
  var_3 = getEnt(var_1, "targetname");
  var_4 = cos(35);
...
function tea_room_change(var_0, var_1) {
...
function nag_system(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  level endon(var_0);
  wait var_2;
...
function stairtrain_1f_animcustom() {
  ...
  var_0.fnadditive_twitch_get = &scripts\sp\maps\tunnels\zd30tunnels_anim::stairtrain_twitch_get;
...
function power_interact_anim(var_0) {
