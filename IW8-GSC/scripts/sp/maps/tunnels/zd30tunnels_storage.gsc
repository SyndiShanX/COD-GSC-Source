...
function storage_surprise() {
  ...
  storage_surprise_wait(var_1, var_0);
  ...
  thread storage_surprise_shoot_on_notetrack(var_1);
  wait 1.6 / var_2;
  ...
  var_1.ignoreall = 0;
  var_1.ignoreme = 0;
  GscBinSkip4(0x6e, var_1, "chased", var_2);
}

function skip_ambush_if_ambusher_died(var_0) {
  level endon("storage_ambush");
  var_0 waittill("death");
  scripts\engine\utility::flag_set("storage_ambush");
}

function respond_if_player_chases(var_0) {
  var_1 = 160;
...
function storage_surprise_shoot_on_notetrack(var_0) {
...
function waittill_propanes_exploded(var_0) {
  wait 3.5;
}
...
function storage_surprise_wait(var_0) {
  var_1 = scripts\engine\utility::getStruct(var_0.target, "targetname");
...
function storage_tripwire_chain_defuse_single(var_0) {
  var_0 endon("trigger");
...
function storage_first_room_enemy_whisper() {
  ...
  var_0 waittill("trigger");
  var_1 scripts\sp\maps\tunnels\zd30tunnels_utility::say_as_chatter("dx_vom_aq1_tunnels_hunt_02");
  var_1 scripts\sp\maps\tunnels\zd30tunnels_utility::say_as_chatter("dx_vom_aq2_tunnels_hunt_04");
  wait 0.5;
...
function storage_oil() {
  ...
  if(!istrue(level.storage_do_not_spawn_runner)) {
    var_6 = scripts\engine\sp\utility::spawn_targetname("storage_retreater", 1);
    var_6 = scripts\engine\sp\utility::spawn_targetname("storage_retreater_2", 1);
  }
  ...
  foreach(var_9 in var_6) {
    ...
    if(isalive(var_9)) {
      thread storage_redirect_enemies(var_9, var_3, var_4);
    }
  }
...
function start_mg_nags() {
  ...
  for(;;) {
    ...
    level.farah scripts\sp\maps\tunnels\zd30tunnels_utility::say_as_chatter(var_10);
...
function storage_oil_final_room_nags() {
  ...
  for(;;) {
    ...
    level.farah scripts\sp\maps\tunnels\zd30tunnels_utility::say_as_chatter(var_1 scripts\engine\sp\utility::deck_draw());
...
function monitor_player_deaths(var_0, var_1, var_2, var_3) {
  ...
  if(var_4) {
    scripts\sp\maps\tunnels\zd30tunnels_utility::register_player_deaths(var_0);
    return;
  }
}
...
function storage_death_hint_think() {
  ...
  var_1 = scripts\sp\maps\tunnels\zd30tunnels_utility::get_player_deaths("storage_MG");
  var_2 = 71;
...
function magic_flash_enemy_vo(var_0) {
  scripts\engine\utility::flag_wait("enemy_magic_flash_vo");
  var_1 = scripts\sp\maps\tunnels\zd30tunnels_ai::get_alive_enemies();
...
function nag_while_near(var_0, var_1) {}

function storage_mg_putout_fire(var_0) {
  if(isDefined(level.storage_oil_fire) && istrue(level.storage_oil_fire.fire_exploder_on)) {
...
function nag_storage_mg_nest_vo() {
  ...
  var_0 = [];
  var_0 = "dx_vom_far_storage_oil_mgnest_130";
  var_0 = "dx_vom_far_storage_oil_mgnest_150";
  var_0 = "dx_vom_far_storage_oil_mgnest_190";
  var_0 = "dx_vom_far_storage_oil_mgnest_200";
  var_0 = "dx_vom_far_storage_oil_mgnest_210";
...
function say_offhand_nag(var_0, var_1) {
...
function storage_redirect_enemies(var_0, var_1, var_2) {
  self endon("death");
...
function storage_enemy_waittill_seen_or_hurt(var_0, var_1) {
  self endon("death");
...
function storage_enemy_temp_ignore(var_0) {
  self endon("death");
  self endon("beenshot");
  level.player endon("death");
  GscBinSkip4(0x35);
...
function storage_3rd_room_spawn(var_0) {
  var_1 = 4;
  var_2 = getEnt("storage_3rd_room_spawn_trig", "targetname");
  var_2 waittill("trigger");
  level notify("spawned_storage_3rd_room");
  var_3 = scripts\sp\maps\tunnels\zd30tunnels_ai::get_alive_enemies();
  var_4 = 0;
...
function storage_mg_guy_molotov_crawl(var_0, var_1) {
  level endon("player_entered_molotov_crawl_trigs");
  var_2 = scripts\engine\utility::getStruct(var_0, "targetname");
  var_3 = getEnt(var_2.target, "targetname");
  var_2.angles += (0, 180, 0);
  var_3 waittill("trigger");
  scripts\sp\maps\tunnels\zd30tunnels_utility::cleanup_corpses_in_radius(var_2.origin, 128);
...
function storage_mg_guy_molotov_crawl_anim(var_0, var_1) {
...
function storage_mg_coward() {
  ...
  if(var_0 == "storage_mg_crawl") {
    ...
    var_1 scripts\engine\utility::delaythread(0.75, &scripts\sp\maps\tunnels\zd30tunnels_utility::ai_playsound, "dx_vom_aq2_tunnels_ambusher_10");
  ...
  var_1 thread scripts\sp\maps\tunnels\zd30tunnels_ai::zdt_rush_guy();
}
...
function turret_operator() {
  ...
  GscBinSkip4(0x6e, var_0, self, var_2);
}
...
function storage_mg_tracer_remove_on_death(var_0) {
  self waittill("death");
...
function storage_mg_player_lag(var_0) {
  level.player endon("death");
...
function get_storage_mg_target(var_0) {
  var_1 = undefined;
  var_2 = 3;
  ...
  if(int(getDvar("zd30_debug")) >= 1 && isDefined(var_0) && isai(var_0)) {
    if(!isDefined(var_1)) {
      var_9 = "Target: NONE";
    } else if(var_2 == level.farah) {
      var_9 = "Target: Farah";
    } else if(var_9 == level.player) {
      var_9 = "Target: Player";
    } else {
      var_9 = "Target: Idle";
    }
...
function shouldshootplayer(var_0) {
...
function storage_split_scene_farah(var_0, var_1, var_2) {
  if(var_2 || scripts\engine\utility::flag("storage_split_player_jumped")) {
    ...
    var_1 scripts\sp\anim::anim_reach_solo(level.farah, var_2 + "_enter");
    level.farah thread scripts\sp\maps\tunnels\zd30tunnels_utility::say_as_chatter("dx_vom_far_storage_split_fall_50");
    var_1 scripts\common\anim::anim_single_solo(level.farah, var_2 + "_enter");
    level.farah setanimrate(level.farah scripts\engine\utility::getanim(var_2 + "_enter"), 1.5);
    var_1 thread scripts\common\anim::anim_loop_solo(level.farah, var_2 + "_enter_idle");
    ...
    if(scripts\engine\utility::flag("storage_split_player_legs_hide")) {
      thread storage_split_scene_farah(var_1, var_2, 1);
      waitframe();
      return;
    }

    var_1 thread scripts\common\anim::anim_single_solo(level.farah, var_2 + "_intro");
    ...
    scripts\engine\sp\utility::do_wait_any();
    level notify(var_4);
    thread storage_split_scene_farah_vo(var_1, var_2);
  }

  scripts\engine\utility::flag_wait("storage_split_player_jumped");
  level.farah notify("stop_nag");
  thread storage_split_scene_farah_jump(var_1, var_2, var_3);
}

function storage_split_scene_farah_vo(var_0, var_1) {
  var_2 = ["dx_vom_far_storage_split_fall_20", "dx_vom_far_storage_split_fall_30", "dx_vom_far_storage_split_fall_40"];
  nag_interval(level.farah, var_0, var_1 + "_intro", 2, 3, var_2, undefined, 25);
...
function nag_interval(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  self endon("death");
  self endon("entitydeleted");
  self endon("stop_nag");
...
function storage_split_skip_to_jump_monitor(var_0) {
  level endon(var_0);
  var_1 = 0;
...
function storage_split_scene_farah_jump(var_0, var_1, var_2) {
  level.farah scripts\engine\sp\utility::anim_stopanimScripted();
...
function storage_split_scene_player(var_0, var_1) {
  ...
  var_12 = 20;
  var_5 scripts\sp\player_rig::link_player_to_rig(var_7, "crouch", undefined, undefined, undefined, var_12, var_12, var_12, var_12, 1);
  waitframe();
  ...
  thread scripts\sp\maps\tunnels\zd30tunnels_utility::fake_player_damage(var_10, 2);
  ...
  var_5 scripts\common\anim::anim_single_solo(level.player_rig, var_7);
  var_5 thread scripts\common\anim::anim_loop_solo(level.player_rig, var_6 + "_jump_idle", "time_to_getup");
  thread hint_to_move();
  var_13 = 18;
  var_14 = 0;
  ...
  var_5 notify("time_to_getup");
  var_5 scripts\common\anim::anim_single_solo(level.player_rig, var_6 + "_getup");
