 ...
 * Script: scripts\sp\maps\tunnels\zd30tunnels_anim.gsc
********************************************************/
...
function turn_off_power_vo(var0) {
  ...
  if(!scripts\engine\utility::flag("power_is_off")) {
    scripts\sp\maps\tunnels\zd30tunnels_infil::objective_control("power");
  }
...
function script_models() {
  ...
  scripts\common\anim::addnotetrack_customfunction("power", "handle_down", &scripts\sp\maps\tunnels\zd30tunnels_infil::power_handle_down, "power_interact");
