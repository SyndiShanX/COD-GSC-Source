 ...
 * Script: scripts\sp\maps\embassy\embassy_anim.gsc
****************************************************/
...
function player() {
  ...
  level.scr_goaltime["player_rig"]["infil_crash_fall_relative"] = 0;
  level.scr_anim["player_rig"]["infil_crash_fall"] = % emb_infil_010_crash_fall_plr;
  level.scr_goaltime["player_rig"]["infil_crash_fall"] = 0;
  ...
  level.scr_goaltime["player_rig"]["bpg_scene_door_enter"] = 0;
  ...
  level.scr_goaltime["player_rig"]["bpg_scene_door_success"] = 1;
  ...
  level.scr_goaltime["player_rig"]["bpg_scene_door_success_branch"] = 1;
...
function humans() {
  ...
  level.scr_goaltime["price"]["infil_crash_fall"] = 0;
  ...
  level.scr_goaltime["pilot"]["infil_crash_fall"] = 1;
  ...
  level.scr_goaltime["aq_entourage_1"]["bpg_md_first_wave"] = 1;
  ...
  level.scr_goaltime["aq_entourage_2"]["bpg_md_first_wave"] = 1;
  ...
  level.scr_goaltime["aq_entourage_3"]["bpg_md_first_wave"] = 1;
  ...
  level.scr_goaltime["aq_entourage_4"]["bpg_md_first_wave"] = 1;
  ...
  level.scr_goaltime["aq_entourage_5"]["bpg_md_first_wave"] = 1;
  ...
  level.scr_goaltime["aq_entourage_6"]["bpg_md_first_wave"] = 1;
  ...
  level.scr_goaltime["aq_entourage_7"]["bpg_md_first_wave"] = 1;
  ...
  level.scr_goaltime["aq_entourage_8"]["bpg_md_first_wave"] = 1;
  ...
  level.scr_goaltime["aq_enforcer"]["bpg_scene_door_success_branch"] = 1;
  ...
  level.scr_goaltime["price"]["halligan_breakout_a"] = 1;
  level.scr_anim["price"]["halligan_breakout_b"] = % emb_oc_030_basement_door_price_breakout_b;
  level.scr_goaltime["price"]["halligan_breakout_b"] = 1;
  ...
  level.scr_goaltime["enemy"]["halligan_breakout_a"] = 1;
  level.scr_anim["enemy"]["halligan_breakout_b"] = % emb_oc_030_basement_door_enemy01_breakout_b;
  level.scr_goaltime["enemy"]["halligan_breakout_b"] = 1;
...
function md_vo(var_0) {
  ...
  level.price scripts\sp\maps\embassy\embassy_util::say_as_chatter("dx_vom_pri_entrance_overrun_60");
  level.price scripts\sp\maps\embassy\embassy_util::say_as_chatter("dx_vom_pri_entrance_overrun_130");
  wait 1;
  level.player scripts\sp\maps\embassy\embassy_util::say_as_chatter("dx_vom_kyle_entrance_overrun_135");
  wait 0.5;
...
function script_models() {
  ...
  level.scr_animtree["infil_fast_rope"] = $;
  ...
  level.scr_goaltime["bpg_scene_door_latch"]["bpg_scene_door_enter"] = 0;
  ...
  level.scr_goaltime["bpg_scene_door_latch"]["bpg_scene_door_success"] = 1;
  ...
  level.scr_goaltime["safety_door_1"]["bpg_scene_door_success"] = 1;
  level.scr_anim["safety_door_2"]["bpg_scene_door_success"] = % emb_bpg_020_hostage_door_success_door02;
  level.scr_goaltime["safety_door_2"]["bpg_scene_door_success"] = 1;
