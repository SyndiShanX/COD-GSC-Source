...
function residence_arrival_vo() {
  ...
  level.price scripts\sp\maps\embassy\embassy_util::nagtill_delayed(8, "res_inside_armory", var_0, 12, 1.2);
  wait 2;
  ...
  level.price scripts\sp\maps\embassy\embassy_util::nagtill("reached_approach", var_0, 15);
}
...
function residence_arrival_marines_look_at(var_0) {
  for(;;) {
    var_1 = scripts\sp\maps\embassy\embassy_util::within_distance(level.player.origin, self.origin, var_0);
...
function residence_arrival_door_setup(var_0, var_1) {
...
function residence_arrival_door_open(var_0, var_1) {
  thread audio_residence_door_open();
  var_0.clip connectpaths();
  var_0 moveTo(var_0.end, 4, 0.25, 0.25);
  wait 4;
  ...
  thread residence_arrival_door_pauser(var_0);
...
function residence_arrival_door_pauser(var_0) {
  self endon("closed");
  self endon("entitydeleted");
  ...
  for(;;) {
    ...
    self moveTo(self.end, var_1 * 10, 0.25 * var_1, 0.25 * var_1);
  }
}

function residence_arrival_side_door(var_0) {
...
function back_on_roof_nag() {
  ...
  for(;;) {
    ...
    level.price scripts\sp\maps\embassy\embassy_util::nagtill(["player_on_south_building", "player_on_north_building"], var_1);
  }
}
...
function wrong_rooftop_nag() {
  ...
  var_0 = [];
  GscBinSkip0(0x2e, var_0.size, [level.alex, "dx_vom_alx_defend_intro_100"]);
}
...
function civ_life_car_00() {
  ...
  thread vehicle_death_watcher(var_0);
  thread vehicle_whizby_watcher(var_0, var_1);
...
function civ_life_car_01(var_0) {
  ...
  thread vehicle_death_watcher(var_1);
  thread vehicle_whizby_watcher(var_1, var_2);
...
function civ_table_animations(var_0) {
  level endon("firing_down_field");
  self endon("death");
...
function civs_table_breakout(var_0) {
  level endon("spawning_unknowns");
  self endon("death");
  self endon("entitydeleted");
...
function civs_bike_breakout(var_0) {
  self endon("death");
  level endon("spawning_unknowns");
  level waittill("firing_down_field");
...
function civs_garage_door_guy() {
  ...
  thread civs_garage_door_guy_breakout(var_1);
  scripts\engine\utility::flag_wait("table_civs_spooked");
  wait 2;
  var_2 notify("stop_loop");
...
function civs_garage_door_guy_breakout(var_0) {
  level endon("spawning_unknowns");
...
function distant_guy_spawner_watcher(var_0, var_1) {
  level endon("spawning_unknowns");
...
function friendlies_defend_using_volume(var_0, var_1, var_2) {
  ...
  foreach(var_5 in var_0) {
    thread waittill_return_to_colornode(var_3);
  }
...
function waittill_return_to_colornode(var_0) {
  wait 0.1;
...
function price_mortar_run_triggers_on(var_0) {
  ...
  jumpiffalse(var_0 == 0) LOC_0000008a;
...
function price_compound_run_triggers_on(var_0) {
  ...
  jumpiffalse(var_0 == 0) LOC_00000066;
...
function init_front_wall(var_0) {
  level waittill("mortar_impact");
  var_0 = getEntArray("building_a_roof_front_destructible", "script_noteworthy");
  var_1 = [];
...
function init_b_side_wall(var_0) {
  wait 1;
...
function destructible_perimeter(var_0) {
  var_1 = undefined;
  var_2 = undefined;
  var_3 = 1;
...
function roof_b_wall_init(var_0) {
...
function roof_b_wall_02_init(var_0) {
  foreach(var_2 in self) {
    if(isDefined(var_2.script_noteworthy) && var_2.script_noteworthy == "broken_wall") {
      var_2 hide();
    }
...
function roof_b_corner_wall_init(var_0) {
  foreach(var_2 in self) {
    if(isDefined(var_2.script_noteworthy) && var_2.script_noteworthy == "broken_wall") {
      var_2 hide();
    }
...
function destructible_wall_mortar_end(var_0, var_1) {
...
function scene_mortars_ai_to_anim(var_0) {
...
function marine_rooftop_reach_and_idle(var_0) {
...
function scene_intro_to_ai(var_0) {
  self waittillmatch("single anim", "end");
...
function scene_intro_to_roof_to_idle(var_0) {
...
function ally_anim_reach_after_delay(var_0) {
...
function scene_triage() {
  ...
  var_4.counter = 0;
  scripts\sp\maps\embassy\embassy_util::remove_corpses_near_pos(var_5.origin, var_5.radius);
  thread anim_reach_failsafe_go(level.price, 10, var_4);
...
function price_to_idle_to_climb(var_0) {
...
function spawn_triage_props() {
  ...
  foreach(var_3 in var_0) {
    var_1 = scripts\engine\sp\utility::spawn_anim_model(var_3);
  }
...
function triage_reach_and_idle(var_0) {
...
function scene_triage_to_idle(var_0) {
  self endon("death");
  var_1 = "stop_loop";
  wait 1;
  self waittillmatch("single anim", "end");
...
function scene_triage_to_exit(var_0) {
...
function scene_sniper_roof() {
  ...
  thread anim_reach_failsafe_go(level.greeter_marine, 10, var_0);
  thread anim_reach_failsafe_go(level.fsa_02, 10, var_0);
...
function enemies_flood_interior(var_0, var_1) {
  self endon("death");
...
function embassy_palm_trees(var_0) {
...
function scaffolding_combat() {
  ...
  var_9 = scripts\sp\maps\embassy\embassy_util::array_removedeaddyingorundefined(var_9);
...
function scaffolding_mayhem(var_0, var_1, var_2, var_3) {
...
function building_rails_destroy(var_0) {
...
function embassy_technicals(var_0) {
...
function enemies_alive_watcher(var_0, var_1) {
  while(var_0.size > 0) {
    var_0 = scripts\sp\maps\embassy\embassy_util::array_removedeaddyingorundefined(var_0);
    wait 0.1;
  }
...
function civ_car() {
  ...
  thread vehicle_whizby_watcher(level.civ_car, var_4);
...
function sfx_technical_drive_in(var_0, var_1) {
  var_0 vehicle_turnengineoff();
...
function vehicle_whizby_watcher(var_0, var_1) {
...
function vehicle_death_watcher(var_0) {
  level endon("civ_car_gone");
  self waittill("death");
  level.civ_car_death_spot = self.origin;
...
function truck_street_death_watcher(var_0) {
  level endon("wave_4_end");
  self waittill("death");
...
function enemy_move_to_exposed(var_0) {
  var_0 endon("death");
...
function defend_mortar_house_favela() {
  ...
  var_0.origin += anglestoright(var_0.angles) * 2;
...
function favela_door_open(var_0, var_1) {
  var_1 endon("death");
  ...
  thread favela_door_guy_anims(var_1, var_0, var_3);
  ...
  thread magic_grenade_toss(var_1, 1, var_6, var_7, 3);
  thread favela_door_distance_check();
  thread favela_door_fastopen(var_0, var_3);
  wait var_3;
...
function favela_door_fastopen(var_0, var_1) {
  var_2 = self;
...
function magic_grenade_toss(var_0, var_1, var_2, var_3, var_4) {
  self endon("death");
  ...
  if(isDefined(var_3)) {
    thread beacon_fuse(var_5);
    return;
  }
}

function beacon_fuse(var_0) {
  waitframe();
...
function favela_door_guy_anims(var_0, var_1, var_2) {
  self endon("death");
  var_0 scripts\common\anim::anim_single_solo(self, var_2);
}

function field_ent_cleanup(var_0) {
...
function field_ent_cleanup_logic(var_0) {
...
function mortar_house_boost_vo() {
  ...
  var_1.autoshuffle = 1;
  level.hadir scripts\sp\maps\embassy\embassy_util::nagtill("house_gate_interacted", var_1, 8);
  ...
  var_1 = scripts\engine\sp\utility::create_deck(var_0, 0);
  var_1.autoshuffle = 1;
  level.hadir scripts\sp\maps\embassy\embassy_util::nagtill("boost_started", var_1, 6);
  wait 9;
  ...
  var_1 = scripts\engine\sp\utility::create_deck(var_0, 0);
  var_1.autoshuffle = 1;
  level.hadir scripts\sp\maps\embassy\embassy_util::nagtill("mortar_house_enter_save", var_1);
}
...
function mortar_door_magic_bullet(var_0) {
  wait 7;
...
function mortar_building_doors(var_0, var_1) {
  var_0 = getEntArray("mortar_door_left", "targetname");
  var_2 = undefined;
...
function mortar_house_vo() {
  ...
  level.hadir thread scripts\sp\maps\embassy\embassy_util::nagtill("player_at_stairs", var_2, 12);
...
function wait_floor_clear(var_0, var_1) {
  if(!isDefined(var_0)) {
    var_0 = getaiarray("axis");
  }

  var_1 = scripts\sp\maps\embassy\embassy_util::default_if_undefined(var_1, 0);
  var_2 = 0;
...
function sfx_car_bomb_expl(var_0) {
...
function defend_wolf_hostage() {
  ...
  thread hostage_loop_watcher(var_1);
  thread flashbang_watcher();
  thread flashbang_watcher();
  thread hostage_loop_watcher(var_1);
  thread wolf_damage_watcher(level.stacy);
  thread stacy_killer_succeeds(var_0);
  thread stacy_killer_dies(var_0);
  thread stacy_dies(var_0);
  thread stacy_killed_by_player(var_0);
  var_0 endon("death");
...
function stacy_killer_succeeds(var_0) {
  self endon("death");
...
function stacy_killer_dies(var_0) {
  level.stacy endon("damage");
  level.stacy endon("bullethit");
  level.stacy endon("death");
  level.stacy endon("killer_succeeds");
...
function stacy_killed_by_player(var_0) {
  self endon("death");
  level.stacy endon("freed");
  level.stacy endon("death");
...
function stacy_dies_after_freedom(var_0) {
...
function wolf_damage_watcher(var_0) {
  level endon("hostage_free");
  level.stacy scripts\engine\utility::waittill_any("damage", "bullethit");
}

function hostage_loop_watcher(var_0) {
...
function wolf_actors_idle(var_0) {
  self waittillmatch("single anim", "end");
...
function molotov_throwers() {
  ...
  while(var_9 < 4) {
    var_10 = getaiarray("axis");
    var_10 = scripts\sp\maps\embassy\embassy_util::array_removedeaddyingorundefined(var_10);
    ...
    thread anim_reach_watcher(var_11);
...
function anim_reach_watcher(var_0) {
  self endon("death");
...
function enemies_skip_front_2(var_0) {
  self allowedstances("stand", "crouch", "prone");
  scripts\common\utility::demeanor_override("combat");
...
function wave_1_enemy_battle_line_update(var_0, var_1) {
...
function friendly_flare_sender(var_0, var_1, var_2) {
  var_3 = 0;
...
function friendly_flare_sender_loop(var_0, var_1) {
  level endon("wave_2_end");
  ...
  while(scripts\engine\utility::flag("flare_loop_on")) {
    ...
    level.support_mortar_tube showpart(level.support_mortar_tube.shell, "misc_wm_mortar");
    level.alex scripts\engine\utility::delaythread(1, &scripts\sp\maps\embassy\embassy_util::say_as_chatter, var_4 scripts\engine\sp\utility::deck_draw(), 0, 1);
...
function wave_1_technical_01() {
  ...
  level.technical_01_gunner scripts\anim\shared::forceuseweapon(var_1, "primary");
...
function gunner_ignore_delay(var_0) {
  self endon("death");
  wait var_0;
  self.ignoreme = 0;
  self.ignoreall = 0;
...
function wave_6_technical_05() {
  ...
  thread gunner_death_watcher(var_0);
...
function wave_6_technical_08_gunner_behavior(var_0) {
  level waittill("stop_ignoring_player");
...
function shoot_out_field_lights(var_0) {
  wait 0.3;
  ...
  foreach(var_9 in var_8) {
    ...
    var_12 = var_9 scripts\engine\sp\utility::get_linked_struct();
    thread shoot_out_lights_thread(var_9, var_7[var_10].origin, var_12.origin);
...
function shoot_out_perimeter_lights(var_0) {
  ...
  foreach(var_4 in var_4) {
    ...
    thread shoot_out_lights_thread(var_4, var_5[var_6].origin);
    wait randomfloatrange(1, 2);
    var_6++;
  }
}

function shoot_out_lights_thread(var_0, var_1, var_2) {
  ...
  for(var_6 = 0; var_6 < var_3; var_6++) {
    ...
    var_9 += randomfloatrange(0.2, 0.4);
...
function perimeter_light_ondeath(var_0, var_1) {
  var_0 waittill("death");
  var_0.isdead = 1;
...
function dialogue_rooftops_wave_0_cafe() {
  ...
  if(scripts\sp\maps\embassy\embassy_util::wait_lookat_ads_or_timeout(var_0, 200, 4)) {
    wait 0.3;
  ...
  if(scripts\sp\maps\embassy\embassy_util::wait_lookat_ads_or_timeout(var_0, 200, 2)) {
  ...
  if(scripts\sp\maps\embassy\embassy_util::wait_lookat_ads_or_timeout(var_0, 200, 1)) {
...
function wait_shot_warning(var_0) {
  if(!istrue(var_0)) {
    wait 2;
  }
...
function dialogue_rooftops_wave_1() {
  ...
  wait 1;
  var_0 = [];
  GscBinSkip0(0x2e, var_0.size, [level.price, "dx_vom_pri_defend_flarestart_40"]);
}
...
function flarenag() {
  ...
  if(!isDefined(level.flarenags)) {
    var_0 = [];
    GscBinSkip0(0x2e, var_0.size, [level.farah, "dx_vom_far_defend_grounds_101"]);
  }
...
function dialogue_rooftops_wave_2_mortars() {
  ...
  level.price scripts\sp\maps\embassy\embassy_util::say_as_chatter("dx_vom_pri_defend_mortars_70", 1, var_0 - 0.3);
...
function nag_near_wall() {
  ...
  for(;;) {
    ...
    level.price childthread scripts\sp\maps\embassy\embassy_util::nagtill("away_from_wall", var_2, 5, 1.6, 20);
...
function off_the_roof_nags() {
  ...
  init_building_flags();
  wait 5;
  level.alex scripts\sp\maps\embassy\embassy_util::nagtill_open("player_on_south_building", var_1, 6.5, 1.2, 20, 1.5);
}
...
function dialogue_rooftops_wave_3() {
  ...
  level.price scripts\sp\maps\embassy\embassy_util::nagtill("green_beam_acquired", var_0, "price_triage_nag");
  wait 1;
  scripts\engine\utility::flag_wait("wave_3_inside");
...
function resupply_nag() {
  ...
  level.price scripts\sp\maps\embassy\embassy_util::nagtill("triage_scene_started", var_0, 5);
}

function get_on_north_roof_nag(var_0) {
  init_building_flags();
  ...
  level endon("wave_3_end");
  var_1 = [];
  GscBinSkip0(0x2e, var_1.size, [level.price, "dx_vom_pri_defend_building_fight_10"]);
}
...
function vo_beam_confirms() {
  var_0 = [];
  GscBinSkip0(0x2e, var_0.size, "dx_vom_kyle_defend_greenbeam1_110");
}

function vo_beam_hit() {
  var_0 = [];
  GscBinSkip0(0x2e, var_0.size, "dx_vom_uavoperator_defend_greenbeam1_190");
}
...
function vo_beam_ally_close() {
  ...
  for(;;) {
    ...
    if(level.player.greenbeamerror == "allies_too_close") {
      level scripts\sp\maps\embassy\embassy_util::say_as_chatter(var_1 scripts\engine\sp\utility::deck_draw(), 0, 1);
    }
  }
}
...
function vo_beam_negative() {
  var_0 = [];
  GscBinSkip0(0x2e, var_0.size, "dx_vom_uavoperator_defend_greenbeam1_280");
}

function vo_beam_cooldown() {
  var_0 = [];
  GscBinSkip0(0x2e, var_0.size, "dx_vom_uavoperator_uav_reload_10");
}

function drone_nags_enable(var_0) {
...
function vo_use_beam_nags(var_0) {
...
function check_init_beam_nags() {
  if(!isDefined(level.beam_nags)) {
    var_0 = [];
    GscBinSkip0(0x2e, var_0.size, [level.price, "dx_vom_pri_defend_greenbeam1_40"]);
  }
...
function check_add_beam_nags() {
  if(scripts\engine\utility::flag("hellfire_launched") && !istrue(level.beam_nags.added_lines)) {
    var_0 = [];
    GscBinSkip0(0x2e, var_0.size, [level.farah, "dx_vom_far_defend_greenbeam1_310"]);
  }
}
...
function nag_say_with_hadir() {
  ...
  var_0 = [];
  GscBinSkip0(0x2e, var_0.size, [level.alex, "dx_vom_alx_defend_mortar_building_110"]);
}
...
function dialogue_rooftops_wave_6() {
  ...
  level.hadir scripts\sp\maps\embassy\embassy_util::nagtill("player_leaving_mortar_house", var_0);
  wait 0.8;
  ...
  wait 6;
  var_1 = [];
  GscBinSkip0(0x2e, var_1.size, "dx_vom_pri_wolf_escapes_combat_131");
}

function wait_hadir_goal_or_flag(var_0) {
...
function enemy_mortar_house_mortar_guy(var_0, var_1, var_2) {
  if(!isDefined(var_1)) {
  ...
  enemy_mortar_animations(var_1, var_0);
  scripts\engine\utility::flag_clear("enemy_mortar_manned");
}

function enemy_mortar_animations(var_0) {
  self endon("death");
...
function mortar_guy_mortar_death(var_0) {
  self endon("death");
  self endon("mortar_guy_breakout");
  self.allowdeath = 1;
...
function mortar_guy_breakout(var_0) {
  self endon("death");
  scripts\engine\utility::flag_wait("mortar_guy_breakout_watcher");
...
function mortar_tube_collapse(var_0) {
  scripts\engine\utility::flag_wait("mortar_guy_breakout_watcher");
...
function dx_mortar_launch_callout(var_0) {
  var_1 = undefined;
  var_2 = undefined;
...
function enemy_mortar_launch(var_0) {
...
function illumination_mortars_friendly_init() {
  ...
  foreach(var_2 in var_0) {
    if(var_2.script_noteworthy == "north") {
      ...
      illumination_mortar_friendly(var_2);
    }
  }
}
...
function illumination_flare(var_0) {
  ...
  thread flare_mover(var_5);
  thread flare_ai_ent_flag_setting();
  var_5 scripts\engine\utility::delaythread(level.flare_lifetime - 2, &scripts\engine\utility::playsoundontag, "weap_mortar_flare_phosphorus_end", "tag_origin");
...
function show_scaffolding_mayhem(var_0) {
  showmayhem(var_0);
