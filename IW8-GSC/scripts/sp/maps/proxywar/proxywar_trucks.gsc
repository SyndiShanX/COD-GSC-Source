 ...
 * Script: scripts\sp\maps\proxywar\proxywar_trucks.gsc
********************************************************/

function proxywar_trucks_precache() {
...
function proxywar_trucks_flags() {
...
function proxywar_trucks_hints() {}

function proxywar_trucks_objectives() {}

function proxywar_trucks_spawnfuncs() {}

function proxywar_trucks_init() {
  ...
  thread scripts\sp\maps\proxywar\proxywar_lighting::lights_off("suv_a_tail_lights");
  ...
  thread scripts\sp\maps\proxywar\proxywar_lighting::lights_off("truck_head_lights");
  thread scripts\sp\maps\proxywar\proxywar_lighting::lights_off("truck_tail_lights");
...
function trucks_convoy_start() {
  ...
  thread alpha1_wait_for_player();
}

function trucks_convoy_main() {
  ...
  level.player clearsoundsubmix("sp_npc_steps_down", 10);
...
function alpha1_wait_for_player() {
  ...
  for(;;) {
    level.pullinref notify("end_pre_idle");
    level thread scripts\sp\maps\proxywar\proxywar_vo::vo_wdg_nag_exit();
...
function turn_trucks_on() {
  wait 1;
  thread scripts\sp\maps\proxywar\proxywar_lighting::lights_on("suv_b_head_lights");
  thread scripts\sp\maps\proxywar\proxywar_lighting::lights_on("suv_b_tail_lights");
  wait 0.5;
  thread scripts\sp\maps\proxywar\proxywar_lighting::lights_on("suv_a_head_lights");
  thread scripts\sp\maps\proxywar\proxywar_lighting::lights_on("suv_a_tail_lights");
  wait 3.5;
  thread scripts\sp\maps\proxywar\proxywar_lighting::lights_on("truck_dome_light");
  wait 5;
  thread scripts\sp\maps\proxywar\proxywar_lighting::lights_off("truck_dome_light");
  thread audio_big_truck_turn_on_idle();
  wait 3;
  thread scripts\sp\maps\proxywar\proxywar_lighting::lights_on("truck_head_lights");
  thread scripts\sp\maps\proxywar\proxywar_lighting::lights_on("truck_tail_lights");
...
function audio_big_truck_turn_on_idle() {
  ...
  wait 0.35;
  level.truck3_idle thread scripts\engine\sp\utility::sound_fade_in("scn_proxy_truck3_idle", 1, 1, 1);
  scripts\engine\utility::flag_wait("player_entered_truck");
  level.truck3_idle scripts\engine\sp\utility::sound_fade_and_delete(5, 1);
}
...
function bravo2_truck_convoy() {
  ...
  scripts\engine\utility::delaythread(7, &audio_jeep1_idle);
  scripts\engine\utility::delaythread(7, &audio_jeep2_idle);
  ...
  while(!scripts\engine\utility::flag("player_entered_truck")) {
    if(level.truck2 scripts\engine\math::is_point_on_right(level.player.origin)) {
      ...
      if(!scripts\engine\utility::flag("done_call_shotgun")) {
        ...
        level thread scripts\sp\maps\proxywar\proxywar_vo::vo_ts_call_shotgun();
      }
...
function audio_jeep1_idle() {
  level.bravo1_idle = spawn("script_origin", level.bravo1.origin);
  level.bravo1_idle thread scripts\engine\sp\utility::sound_fade_in("scn_proxy_jeep1_idle", 1, 1, 1);
  scripts\engine\utility::flag_wait("player_entered_truck");
  level.bravo1_idle scripts\engine\sp\utility::sound_fade_and_delete(5, 1);
}

function audio_jeep2_idle() {
  level.bravo2_idle = spawn("script_origin", level.bravo2.origin);
  level.bravo2_idle thread scripts\engine\sp\utility::sound_fade_in("scn_proxy_jeep2_idle", 1, 1, 1);
  scripts\engine\utility::flag_wait("player_entered_truck");
  level.bravo2_idle scripts\engine\sp\utility::sound_fade_and_delete(5, 1);
}
...
function open_facility_exit() {
  ...
  level.leftexitgate1 thread scripts\sp\maps\proxywar\proxywar_util::move_to_point_with_angles(3.5, scripts\engine\utility::getStruct("left_exit_gate_open_1", "targetname").origin, scripts\engine\utility::getStruct("left_exit_gate_open_1", "targetname").angles, undefined, 2, 1);
  level.leftexitgate2 thread scripts\sp\maps\proxywar\proxywar_util::move_to_point_with_angles(3.5, scripts\engine\utility::getStruct("left_exit_gate_open_1", "targetname").origin, scripts\engine\utility::getStruct("left_exit_gate_open_2", "targetname").angles, undefined, 2, 1);
  level.rightexitgate1 thread scripts\sp\maps\proxywar\proxywar_util::move_to_point_with_angles(3.25, scripts\engine\utility::getStruct("right_exit_gate_open_1", "targetname").origin, scripts\engine\utility::getStruct("right_exit_gate_open_1", "targetname").angles, undefined, 2, 1);
  level.rightexitgate2 thread scripts\sp\maps\proxywar\proxywar_util::move_to_point_with_angles(3.25, scripts\engine\utility::getStruct("right_exit_gate_open_2", "targetname").origin, scripts\engine\utility::getStruct("right_exit_gate_open_2", "targetname").angles, undefined, 2, 1);
}
...
function trucks_stolen_main() {
  ...
  thread scripts\sp\maps\proxywar\proxywar_lighting::end_sequence_dof();
  ...
  thread trucks_retreat_setup_actor(level.hadir, 0);
...
function audio_truck3_wake_up_and_away() {
  ...
  wait 2;
  level.truck3_idle scripts\engine\sp\utility::sound_fade_in("scn_proxy_truck3_idle_wake_up_lp", 1, 3, 1);
...
function wait_show_cinematic_bars() {
  level waittill("show_cinematic_bars");
  level.player scripts\engine\utility::delaycall(18, &setclienttriggeraudiozone, "fade_to_black_minus_scripted5_music_and_dx", 10);
  hidecinematicletterboxing(3, 0);
...
function audio_fade_out_over_bink() {
  level.player setclienttriggeraudiozone("fade_to_black", 0.3);
}

function trucks_stolen_catchup() {}