 ...
 * Script: scripts\sp\maps\proxywar\proxywar_warehouse.gsc
***********************************************************/

function proxywar_warehouse_precache() {
...
function proxywar_warehouse_flags() {
...
function proxywar_warehouse_hints() {
...
function warehouse_enter_start() {
...
function warehouse_enter_main() {
  ...
  thread alpha1_move_into_warehouse();
  thread bravo1_move_into_warehouse();
  ...
  thread gate_team_approach_and_mask_up(level.alpha1);
  thread gate_team_approach_and_mask_up(level.bravo1);
  thread gate_team_approach_and_mask_up(level.bravo2);
  thread bravo3_approach_and_mask_up();
  scripts\engine\utility::flag_wait("allies_ready_at_gate");
  thread check_nag_to_warehouse_door();
  ...
  scripts\sp\maps\proxywar\proxywar_vo::vo_we_open_door();
  thread wait_turn_off_lights();
  ...
  level thread scripts\sp\maps\proxywar\proxywar_vo::vo_wc_entered_main_warehouse();
  ...
  level thread scripts\sp\maps\proxywar\proxywar_vo::vo_wc_hear_enemies();
  ...
  scripts\sp\maps\proxywar\proxywar_util::disable_allies_firing();
  level thread scripts\sp\maps\proxywar\proxywar_vo::vo_wc_all_dead();
}

function warehouse_enter_catchup() {
  scripts\engine\utility::exploder("warehouse_camcentr");
  scripts\engine\utility::stop_exploder("factory_ext_camcentr");
  scripts\engine\sp\objectives::objective_set_position("objective", scripts\engine\utility::getStruct("obj_clear_warehouse", "targetname").origin);
...
function check_nag_to_warehouse_door() {
  level endon("near_warehouse_door");
  level endon("reached_warehouse_interior");
  level thread scripts\sp\maps\proxywar\proxywar_vo::vo_we_nag_enter_warehouse();
  wait 10;
...
function alpha1_move_into_warehouse() {
  scripts\common\ai::set_gunpose("disable", 1);
  scripts\sp\maps\proxywar\proxywar_util::set_ally_movement_courtyard();
  thread scripts\sp\maps\proxywar\proxywar_util::teleport_if_clear(getnode("warehouse_foyer_corridor_right", "targetname"), "a1_safe_teleport", "a1_reached_node", (0, 0, 60));
  scripts\sp\maps\proxywar\proxywar_util::go_to_node_targetname("warehouse_foyer_corridor_right");
  level notify("a1_reached_node");
  scripts\engine\utility::set_movement_speed(randomintrange(80, 110));
  level thread scripts\sp\maps\proxywar\proxywar_vo::vo_we_alpha1_enter_warehouse();
  thread entered_foyer_timer();
  door_team_member_arrived();
}

function entered_foyer_timer() {
  wait 3;
  scripts\engine\utility::flag_set("reached_warehouse_foyer");
}

function bravo1_move_into_warehouse() {
  scripts\common\ai::set_gunpose("disable", 1);
  scripts\sp\maps\proxywar\proxywar_util::set_ally_movement_courtyard();
  thread scripts\sp\maps\proxywar\proxywar_util::teleport_if_clear(getnode("warehouse_foyer_corridor_rear", "targetname"), "b1_safe_teleport", "b1_reached_node", (0, 0, 60));
  scripts\sp\maps\proxywar\proxywar_util::go_to_node_targetname("warehouse_foyer_corridor_rear");
  level notify("b1_reached_node");
  scripts\engine\utility::set_movement_speed(randomintrange(80, 110));
  door_team_member_arrived();
}

function bravo2_move_into_warehouse() {
  scripts\common\ai::set_gunpose("disable", 1);
  scripts\sp\maps\proxywar\proxywar_util::set_ally_movement_courtyard();
  thread scripts\sp\maps\proxywar\proxywar_util::teleport_if_clear(getnode("warehouse_foyer_enter_left", "targetname"), "b2_safe_teleport", "b2_reached_node", (0, 0, 60));
  scripts\sp\maps\proxywar\proxywar_util::go_to_node_targetname("warehouse_foyer_enter_left");
  level notify("b2_reached_node");
  scripts\engine\utility::set_movement_speed(randomintrange(80, 110));
  level thread scripts\sp\maps\proxywar\proxywar_vo::vo_we_bravo2_enter_warehouse();
  scripts\engine\utility::flag_wait("reached_warehouse_foyer");
  door_team_member_arrived();
}

function bravo3_move_into_warehouse() {
  scripts\common\ai::set_gunpose("ready");
  scripts\sp\maps\proxywar\proxywar_util::set_ally_movement_courtyard();
  thread scripts\sp\maps\proxywar\proxywar_util::teleport_if_clear(getnode("warehouse_foyer_enter_right", "targetname"), "b3_safe_teleport", "b3_reached_node", (0, 0, 60));
  scripts\sp\maps\proxywar\proxywar_util::go_to_node_targetname("warehouse_foyer_enter_right");
  level notify("b3_reached_node");
  scripts\engine\utility::set_movement_speed(randomintrange(80, 110));
  level thread scripts\sp\maps\proxywar\proxywar_vo::vo_we_bravo3_enter_warehouse();
  scripts\asm\shared\utility::toggle_poiauto(0);
  wait 3;
  scripts\common\ai::set_gunpose("disable", 1);
}

function door_team_member_arrived() {
...
function bravo3_approach_and_mask_up() {
  scripts\sp\maps\proxywar\proxywar_util::go_to_node_targetname("warehouse_foyer_gate_right");
}

function gate_team_open_and_enter() {
  scripts\asm\shared\utility::toggle_poiauto(0);
...
function door_team_member_at_gate() {
  level.doorgatecount++;
...
function wait_turn_off_lights() {
  level waittill("turn_off_lights");
  scripts\engine\utility::flag_set("lights_out");
  thread scripts\sp\maps\proxywar\proxywar_vo::mus_lightsout();
  turn_off_lights();
  level thread scripts\sp\maps\proxywar\proxywar_vo::vo_we_power_off();
  wait 1;
  ...
  thread flashlight_tutorial();
}

function warehouse_laststand_spawn_func() {
  self endon("death");
...
function enable_firing() {
  self.ignoreme = 0;
  self.ignoreall = 0;
  self.dontevershoot = 0;
}

function disable_firing() {
  self.ignoreme = 1;
  self.ignoreall = 1;
  self.dontevershoot = 1;
}

function runner1_behavior() {
  self endon("death");
...
function runner2_behavior() {
  self endon("death");
  self.deathfunction = &runner2_deathfunc;
  level thread scripts\sp\maps\proxywar\proxywar_vo::vo_wc_shelf_runner_killed(self);
...
function check_defender_damaged() {
  self waittill("damage");
  enable_firing();
  scripts\common\utility::clear_demeanor_override();
}

function catwalk_defender_behavior() {
  self endon("death");
...
function final_defender_behavior() {
  self endon("death");
  ...
  thread flashbang_tutorial();
  self.sweepfiretarget = scripts\engine\utility::spawn_script_origin();
  thread scripts\sp\maps\proxywar\proxywar_vo::vo_wc_laststand();
  enable_firing();
  ...
  level thread scripts\sp\maps\proxywar\proxywar_vo::vo_wc_shelf_runner();
...
function final_defender_check_damage() {
...
function final_defender_death_anim() {
  self.ignoreme = 1;
  ...
  thread play_defender_death(level.dummydefender);
  self delete();
}
...
function flashlight_equip_hint_check() {
  if(level.player.flashlighton) {
    return true;
  }
...
function objective_tutorial_hint_check() {
...
function tutorial_timeout_check() {
  wait 10;
...
function warehouse_discover_gas_start() {
  scripts\sp\maps\proxywar\proxywar_util::spawn_ally_teams(0);
...
function warehouse_discover_gas_main() {
  ...
  scripts\engine\utility::flag_set("threw_flashbang");
  level notify("clear_flashbang_tutorial");
  thread alpha1_gas_search();
  thread bravo1_gas_search();
  thread bravo2_gas_search();
  thread bravo3_gas_search();
  ...
  thread check_door_button_interact();
  thread check_objective_button_pressed();
  ...
  thread scripts\sp\maps\proxywar\proxywar_vo::vo_wdg_found_button();
  ...
  thread alpha1_move_to_chem_truck();
...
function check_facing_russian_scene() {
...
function inspect_dead_russians() {
...
function check_door_button_interact() {
  level endon("warehouse_power_on");
...
function warehouse_discover_gas_ally_cleanup() {
  scripts\engine\utility::flag_wait("warehouse_power_on");
  self.ignoreall = 1;
  scripts\engine\sp\utility::enable_ai_color();
}

function alpha1_move_to_chem_truck() {
...
function warehouse_audio_rolling_door_open() {
  wait 7.25;
