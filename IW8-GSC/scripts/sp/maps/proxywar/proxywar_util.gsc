...
function waittill_func(var_0, var_1, var_2, var_3, var_4, var_5) {
...
function waittill_func_or_timeout(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
...
function call_func_with_params(var_0, var_1, var_2, var_3, var_4) {
  if(isDefined(var_4)) {
...
function setup_ally_team(var_0, var_1) {
  foreach(var_3 in var_0) {
    ...
    var_3 scripts\anim\shared::forceuseweapon(var_1[0], "primary");
...
function spawn_alpha_team(var_0) {
  if(!isDefined(var_0)) {
    var_0 = 1;
  }
...
function spawn_ally_teams(var_0) {
  if(!isDefined(var_0)) {
    var_0 = 1;
  }
...
function ally_track_and_kill(var_0, var_1) {
...
function ally_track_and_kill_noteworthy(var_0, var_1) {
...
function within_distance2d(var_0, var_1, var_2) {
  return distance2dsquared(var_0, var_1) < squared(var_2);
}

function notify_within_distance(var_0, var_1, var_2, var_3, var_4) {
  level endon(var_4);
...
function within_player_fov(var_0, var_1) {
  if(isDefined(var_1)) {
    var_2 = var_1;
  } else {
...
function within_player_fov_2d(var_0, var_1) {
  if(isDefined(var_1)) {
    var_2 = var_1;
  } else {
    var_2 = cos(getdvarfloat("cg_targetBaseFov"));
...
function get_closest_in_front(var_0, var_1) {
  var_2 = undefined;
...
function setup_scripted_door(var_0) {
...
function open_scripted_door(var_0, var_1, var_2, var_3, var_4) {
  var_5 = self.open;
...
function close_scripted_door(var_0, var_1, var_2, var_3) {
  internal_move_scripted_door(self.closed.origin, self.closed.angles, var_0, var_1, var_2, var_3);
}

function internal_move_scripted_door(var_0, var_1, var_2, var_3, var_4, var_5) {
...
function move_to_point_with_angles(var_0, var_1, var_2, var_3, var_4, var_5) {
  if(isDefined(var_3)) {
    wait var_3;
  }
...
function stub_move(var_0, var_1, var_2, var_3) {
  ...
  move_to_point_with_angles(var_4, var_0, var_1, var_2, var_3);
  self unlink();
...
function stub_move_to_struct(var_0, var_1, var_2, var_3) {
  if(!isDefined(var_2)) {
    var_2 = "targetname";
  }
...
function stub_path_simple(var_0, var_1, var_2) {
  ...
  foreach(var_12 in var_5) {
    move_to_point_with_angles(var_3, var_10, var_12.origin, var_12.angles, 1);
  }
...
function stub_path_array(var_0, var_1) {
  foreach(var_3 in var_0) {
...
function lerp_player_speed_scale(var_0, var_1) {
...
function can_flashlight_ai_see_player(var_0) {
  ...
  var_3 &= scripts\engine\utility::within_fov(self.origin, self.angles, level.player.origin, cos(60));
  var_3 &= scripts\engine\trace::ray_trace_passed(self gettagorigin("tag_flash"), level.player getEye(), [self, level.player], scripts\engine\trace::create_ainosight_contents());
  return var_3 || var_3;
}

function player_shining_light_at(var_0, var_1) {
  if(!isalive(var_0)) {
    return 0;
  }
  ...
  var_2 &= within_player_fov(var_0 getEye());
  var_2 &= within_distance(level.player.origin, var_0.origin, var_1);
  return var_2;
}

function proxywar_timeout(var_0, var_1) {
  if(!isDefined(var_1)) {
    var_1 = "timeout";
  }
...
function enable_allies_firing() {
  foreach(var_1 in level.alpha_and_bravo_team) {
    enable_ally_vision(var_1);
    enable_ally_firing(var_1);
  }
}
...
function disable_allies_firing() {
  foreach(var_1 in level.alpha_and_bravo_team) {
    disable_ally_vision(var_1);
    disable_ally_firing(var_1);
  }
}
...
function flag_wait_either_or_timeout(var_0, var_1, var_2) {
  var_3 = var_2 * 1000;
  var_4 = gettime();
...
function wait_for_either_flag_or_time_elapses(var_0, var_1, var_2) {
  level endon(var_0);
  level endon(var_1);
  wait var_2;
}
...
function dialogue(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  if(istrue(var_13)) {
    var_14 = var_13 + var_13 + " Over Radio" + ": " + "^7" + var_4;
  } else {
    var_14 = var_14 + var_13 + ": " + "^7" + var_5;
  }
...
function move_to_arrive_then_idle(var_0, var_1, var_2, var_3) {
...
function play_group_single_anim_into_idle_anim(var_0, var_1, var_2, var_3, var_4) {
  level endon("kill_all_anim_instructions");
  ...
  foreach(var_6 in self) {
    thread play_single_anim_into_idle_anim(var_6, var_0, var_1, var_2, var_3);
  }
}

function play_single_anim_into_idle_anim(var_0, var_1, var_2, var_3, var_4) {
  level endon("kill_all_anim_instructions");
...
function get_struct_with_sight_to_player(var_0) {
...
function hint_alt_fire_swap(var_0) {
...
function set_flag_on_death_or_damage(var_0) {
  if(isalive(self)) {
...
function ally_go_to_and_wait(var_0, var_1, var_2) {
...
function anim_last_frame_door(var_0, var_1) {
  var_2 = scripts\engine\utility::spawn_tag_origin(self.origin, self.angles);
  var_2 scripts\engine\sp\utility::assign_animtree("door");
  var_2 scripts\common\anim::anim_first_frame_solo(var_2, var_1);
  var_0.temp_animator = var_2;
...
function change_scene_speed_while_offscreen(var_0, var_1, var_2, var_3) {
  ...
  for(;;) {
    ...
    if(var_4 && !var_5) {
      foreach(var_7 in var_0) {
        var_7 setanimrate(var_7 scripts\engine\utility::getanim(var_2), 1);
      }
    } else if(!var_4 && var_5) {
      foreach(var_7 in var_0) {
...
function lerp_fov_over_distance_trigger() {
  ...
  foreach(var_3 in var_0) {
    var_1 = scripts\engine\utility::getStruct(var_3, "targetname");
  }
...
function change_ai_speed_while_offscreen(var_0, var_1) {
...
function notify_if_teleport_clear(var_0, var_1, var_2, var_3, var_4) {
  level endon(var_3);
...
function teleport_if_clear(var_0, var_1, var_2, var_3) {
  level endon(var_2);
  ...
  while(!var_5) {
    if(!within_distance2d(level.player.origin, self.origin, 200) && !within_distance2d(level.player.origin, var_0.origin + var_3, 200) && !within_player_fov_2d(level.player, self getEye(), var_4) && !within_player_fov_2d(level.player, var_0.origin + var_3, var_4) && scripts\engine\math::within_fov_2d(var_0.origin, var_0.angles, level.player.origin, 0)) {
      var_5 = 1;
    }
...
function nightvision_override(var_0, var_1, var_2) {
...
function nightvision_override_callback(var_0, var_1) {
  self endon("death");
...
function within_bounds(var_0, var_1, var_2, var_3, var_4) {
  var_5 = var_2 - var_0;
...
function magic_gun_create_weapon(var_0, var_1, var_2, var_3, var_4, var_5) {
...
function magic_gun_set_target(var_0, var_1) {
  self endon("kill_magic_gun");
...
function magic_gun_set_tracking_speed(var_0) {
  self.tracking_speed = var_0;
}

function magic_gun_fire(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  ...
  var_16 = 0;
  var_17 = randomfloatrange(var_4, var_5);

  while(var_16 < var_17) {
    var_18 = randomfloatrange(var_13, var_12) * var_10;
    var_19 = randomfloatrange(var_15, var_14) * var_11;
    ...
    var_16++;
    var_12 = clamp(var_12 - var_14, 1, var_12);
    var_13 = clamp(var_13 - var_14, 0, var_12);
    var_14 = clamp(var_14 - var_15, 1, var_14);
    var_15 = clamp(var_15 - var_15, 0, var_14);
...
function internal_mg_forward(var_0) {
  return var_0.origin - self.origin;
}

function internal_mg_left_vector(var_0) {
  return vectorNormalize(vectorcross((0, 0, 1), var_0));
}

function magic_gun_search_around_ent(var_0, var_1) {
  self endon("kill_magic_gun");
  ...
  for(;;) {
    var_3 = internal_mg_forward(var_1);
    var_4 = internal_mg_left_vector(var_3) * var_2 * var_2;
    var_2 *= -1;
...
function magic_gun_track_ent(var_0, var_1, var_2) {
  self endon("kill_magic_gun");
  ...
  jumpiftrue(isDefined(var_1)) LOC_0000002e;
  var_1 = "tag_origin";
...
function set_ignoreme_after_time(var_0, var_1) {
  self endon("death");
  wait var_1;
  self.ignoreme = var_0;
}

function increase_attacker_accuracy(var_0) {
  self endon("death");
  var_1 = 1 - self.attackeraccuracy;
  var_2 = var_1 / var_0;

  while(self.attackeraccuracy < 1) {
    self.attackeraccuracy += var_2 * 0.05;
    waitframe();
  }
...
function delete_on_ent_notify(var_0, var_1) {
...
function set_ally_movement_pre_breach(var_0) {
