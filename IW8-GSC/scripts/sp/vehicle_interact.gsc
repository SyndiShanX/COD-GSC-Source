...
function main_vehicle_interact(var_0) {
  ...
  foreach(var_2 in var_0) {
    ...
    foreach(var_8 in var_6) {
      ...
      thread interact_door_setup(var_2);
    }
...
function interact_door_setup(var_0) {
  self endon("death");
  ...
  if(isDefined(self.hint_bones[var_0.script_namenumber])) {
    ...
    var_7 = var_4 scripts\engine\utility::spawn_tag_origin();
  }

  var_7.door_name = var_4.script_namenumber;
  self.getin_hints[var_7].hint_ent = var_7;
  var_7 endon("death");
  ...
  switch (var_7.door_name) {
    ...
    case "outside_sunroof":
      var_8 = scripts\engine\utility::getStruct(var_4.target, "targetname");
      thread interact_vehicle_animate_door("rr");
      break;
  }
...
function interact_interior_door_open(var_0) {
  var_1 = undefined;
...
function interact_interior_door_open_remove(var_0) {
  level.player endon("death");
  var_0 endon("death");
...
function interact_vehicle_inside(var_0) {
...
function block_for_mantle(var_0) {
...
function wait_for_mantle_inside(var_0) {
...
function block_for_push(var_0, var_1) {
  self endon("death");
...
function get_prev_struct(var_0) {
...
function get_opposite_door(var_0) {
  var_1 = undefined;
...
function interact_vehicle_movement(var_0, var_1, var_2, var_3) {
  self endon("death");
  var_4 = 100;
...
function get_end_door_state(var_0) {
...
function set_moverate_along_dir() {
  ...
  self.velocity *= var_8 + self.velocity_bump;
}

function get_scoot_velocity(var_0) {
  var_1 = 3.14159;
...
function get_scoot_velocity_bump(var_0) {
  var_1 = 0.2;
  var_1 += (var_1 - 0) * var_0 * 2;
...
function qlerp(var_0, var_1, var_2) {
...
function set_viewangles() {
  ...
  var_11 = (var_2, var_3, var_4) * self.moveviewmult;
  var_11 += var_7 + var_5;
  ...
  var_1.angles = anglelerpquatfrac(var_1.angles, var_12, 0.5);
}

function is_pos_in_front(var_0, var_1, var_2) {
...
function interact_give_control_back(var_0, var_1) {
  wait var_0;
  level.player playerlinktodelta(var_1, "tag_player", 0, 110, 110, 20, 30);
}

function hide_interact_vehicle(var_0) {
  var_1 = getscriptablearray(var_0, "script_noteworthy")[0];
  var_1 hide();
  return var_1;
}

function show_interact_vehicle(var_0) {
  var_1 = getscriptablearray(var_0, "script_noteworthy")[0];
  var_1 show();
  return var_1;
}

function get_interact_vehicle(var_0) {
...
function get_interact_vehicle_array(var_0) {
  var_1 = [];
...
function interact_vehicle_doors_state(var_0, var_1) {
  self endon("death");
...
function interact_vehicle_doors_inactive(var_0) {
  self endon("death");
...
function interact_interior_door_hack(var_0) {
  var_1 = undefined;
...
function interact_getanim(var_0) {
...
function interact_vehicle_animate_door(var_0) {
  self.door_open[var_0] = 1;
  var_1 = interact_getanim(self.vehicle, var_0 + "_open");
...
function interact_vehicle_spawn_cover_node(var_0, var_1, var_2, var_3) {
  var_4 = undefined;
...
function update_color_nodes(var_0) {
  if(isDefined(var_0.script_color_allies)) {
    add_node_to_global_arrays(var_0, var_0.script_color_allies, "allies");
  }

  if(isDefined(var_0.script_color_axis)) {
    add_node_to_global_arrays(var_0, var_0.script_color_axis, "axis");
    return;
  }
}
