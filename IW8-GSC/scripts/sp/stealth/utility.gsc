...
function try_announce_sound(var_0, var_1, var_2) {
...
function should_sound_take_priority(var_0) {
...
function get_snd_priority(var_0) {
  switch (var_0) {
...
function can_announce_sound(var_0) {
  if(!isalive(self)) {
    return false;
  }
...
function add_announce_debounce(var_0, var_1) {
  self endon("death");
...
function play_stealth_vo(var_0, var_1, var_2) {
  var_3 = 0;
  var_4 = undefined;
  ...
  switch (var_0) {
    ...
    case "lost_sight":
      ...
      if(scripts\engine\utility::cointoss()) {
        var_1 = "_losloss_" + var_6 + "_" + randomintrange(1, 4);
      } else {
        var_1 = "_enemylost_" + randomintrange(1, 7) + "_" + var_6;
      }

      break;
    case "drone_spotted":
      var_1 = "_dronefound_" + randomintrange(1, 4);
      break;
    case "warning1":
      var_1 = "_enemyalerted";
      break;
    ...
    case "backup_call":
      ...
      break;
    case "hunting":
      var_1 = "_hunting_" + randomintrange(1, 5);
      break;
    case "acknowledgement":
      if(self.stealth.voiceid == "sf1") {
        var_1 = "_reinforcements_" + randomintrange(1, 7);

        if(isDefined(var_3) && isDefined(var_3.entity) && isai(var_3.entity) && isalive(var_3.entity) && distance2d(self.origin, var_3.entity.origin) >= 350) {
          var_5 = var_3.entity;
        }
      } else {
        var_1 = "_reinforcements";
      }
    ...
    case "gunshot":
    case "ally_damaged":
      if(scripts\engine\utility::cointoss() && isDefined(var_3.origin)) {
        var_1 = try_cardinal_gunshot(var_3);
      } else {
        var_1 = scripts\engine\utility::random(["_gunshot_4", "_gunshot_7", "_gunshot_9", "_gunshot_10"]);
      }
    ...
    case "gunshot_teammate":
      if(scripts\engine\utility::cointoss() && isDefined(var_3.origin)) {
        ...
        var_1 = scripts\engine\utility::random(["_gunshot_1", "_gunshot_2", "_gunshot_3", "_gunshot_5", "_gunshot_6", "_gunshot_8"]);
      }

      break;
    case "patrol_update_low":
      var_1 = try_cardinal_patrol_update("low");

      if(!isDefined(var_1)) {
        var_1 = scripts\engine\utility::random(["_areasecure_n_1_low", "_areasecure_s_1_low", "_areasecure_e_1_low", "_areasecure_w_1_low"]);
      }
      ...
      break;
    case "patrol_update_high":
      var_1 = try_cardinal_patrol_update("high");

      if(!isDefined(var_1)) {
        var_1 = scripts\engine\utility::random(["_areasecure_n_1_high", "_areasecure_s_1_high", "_areasecure_e_1_high", "_areasecure_w_1_high"]);
      }

      break;
    case "inquiry":
      if(isDefined(var_3) && isDefined(var_3.typeorig) && var_3.typeorig == "unresponsive_teammate" && isDefined(var_3.origin)) {
        var_1 = "_searchreport_" + randomintrange(1, 7);
        var_5 = var_3.origin;
      } else {
        var_1 = "_searchreport";
      }
  ...
  var_12 = var_6 + self.stealth.voiceid + var_1;
  var_4 = play_stealth_vo_alias(var_12, var_5);
  return var_4;
}
...
function try_cardinal_patrol_update(var_0) {
  var_1 = scripts\anim\battlechatter::getdirectioncompass(self.origin, (0, 0, 0));
  ...
  switch (var_1) {
    ...
    case "northwest":
      if(scripts\engine\utility::cointoss()) {
        var_3 = "_areasecure_n_" + var_3 + var_1;
      } else {
        var_3 = "_areasecure_w_" + var_3 + var_2;
      }

      break;
    case "northeast":
      if(scripts\engine\utility::cointoss()) {
        var_3 = "_areasecure_n_" + var_3 + var_3;
      } else {
        var_3 = "_areasecure_e_" + var_3 + var_3;
      }

      break;
    case "south":
      var_3 = "_areasecure_s_" + var_3 + var_3;
      break;
    case "southwest":
      if(scripts\engine\utility::cointoss()) {
        var_3 = "_areasecure_s_" + var_3 + var_3;
      } else {
        var_3 = "_areasecure_w_" + var_3 + var_3;
      }
...
function play_stealth_vo_alias(var_0, var_1) {
  var_2 = 0;
  self.stealth.current_requested_snd = undefined;
...
function should_try_generic_radio_confirmation(var_0) {
  if(randomint(100) > 60) {
    return 0;
  }
...
function announce_spotted_acknowledge(var_0) {
  var_1 = var_0.origin;
  var_2 = get_country_prefix(var_0);
  wait 1.5;
  ...
  var_4 = var_3 + var_3 + "_stealth_alert_r";
}

function try_cardinal_gunshot(var_0) {
  var_1 = scripts\anim\battlechatter::getdirectioncompass(self.origin, var_0.origin);
  ...
  switch (var_1) {
    ...
    case "northwest":
      if(scripts\engine\utility::cointoss()) {
        var_3 = "_gunshot_n_" + var_3;
      } else {
        var_3 = "_gunshot_w_" + var_3;
      }
    ...
    case "northeast":
      if(scripts\engine\utility::cointoss()) {
        ...
        var_3 = "_gunshot_e_" + var_3;
      }

      break;
    case "south":
      var_3 = "_gunshot_s_" + var_3;
      break;
    case "southwest":
      if(scripts\engine\utility::cointoss()) {
        var_3 = "_gunshot_s_" + var_3;
...
function playradiotransmission(var_0, var_1) {
  if(isai(var_1)) {
    if(!isalive(var_1)) {
      return;
    }
...
function stealth_music_transition_sp(var_0) {
  ...
  var_3 = var_0;
  jumpiffalse(isDefined(var_3) && !isDefined(self.stealth.music_ent[var_3])) LOC_000000da;
  self.stealth.music_ent[var_3] = spawn("script_model", self.origin);
  self.stealth.music_ent[var_3] linkTo(self);
  self.stealth.music_ent[var_3].cur_vol = 0;
  self.stealth.music_ent[var_3] scalevolume(0);
  ...
  for(;;) {
    ...
    foreach(var_3, var_6 in self.stealth.music_ent) {
      ...
      if(isDefined(var_0) && var_3 == var_0) {
        var_6.cur_vol = min(1, var_6.cur_vol + var_2 / var_1);
        var_7 = 1;
      } else {
        var_6.cur_vol = max(0, var_6.cur_vol - var_2 / var_1);
        var_7 = 0;
      }
