...
function last_phone_check_fail() {
  ...
  foreach(var_2 in self.parenttripwires) {
    thread triggerfunctripwire(var_2, undefined, 1);
    var_0 = 0;
  }
}
...
function triggerfuncfrag(var_0) {
  ...
  if(scripts\cp_mp\utility\script_utility::issharedfuncdefined("tripwire", "damageFunc")) {
    var_3 = scripts\cp_mp\utility\script_utility::getsharedfunc("tripwire", "damageFunc");
    level thread[[var_3]](self, var_1);
  } else {
...
function damagetrapfuncthink(var_0, var_1) {
  ...
  for(;;) {
    ...
    if(scripts\cp_mp\utility\script_utility::issharedfuncdefined("tripwire", "blowTripWire")) {
      self thread[[scripts\cp_mp\utility\script_utility::getsharedfunc("tripwire", "blowTripWire")]](var_3, var_6);
    }

    if(scripts\cp_mp\utility\script_utility::issharedfuncdefined("tripwire", "canTripTrap")) {
      var_16 = scripts\cp_mp\utility\script_utility::getsharedfunc("tripwire", "canTripTrap");

      if(self[[var_16]](var_3, var_11, var_6, var_2, var_5)) {
        break;
      }
    } else if(cantriptrap(var_2, var_5, var_1)) {
      break;
    }
  ...
  foreach(var_20 in self.parenttripwires) {
    var_20 notify("trigger", var_2, var_17, var_18);
  }

  self notify("trigger", var_2, 1);
}

function cantriptrap(var_0, var_1, var_2) {
  if(!isDefined(var_0)) {
    return false;
  }
...
function disarmfuncthink(var_0, var_1) {
  ...
  if(scripts\cp_mp\utility\script_utility::issharedfuncdefined("tripwire", "createHintObject")) {
    var_4 = scripts\cp_mp\utility\script_utility::getsharedfunc("tripwire", "createHintObject");
    self.defusehintstruct = [[var_4]](var_2.origin, undefined, undefined, undefined, undefined, "duration_medium", "hide", 128, 35, 84, 35);
  } else {
    self.defusehintstruct = var_2 scripts\engine\utility::spawn_script_origin();
  }

  self.deletefunc = &last_phone_check_fail;
  self.defusehintstruct waittill("trigger", var_5);
  ...
  foreach(var_9 in self.parenttripwires) {
    var_9 notify("trigger", var_5, var_6, var_7);
  }
...
function disarmgiveweapon(var_0, var_1) {
  if(scripts\cp_mp\utility\script_utility::issharedfuncdefined("tripwire", "disarmGiveWeapon")) {
    var_2 = scripts\cp_mp\utility\script_utility::getsharedfunc("tripwire", "disarmGiveWeapon");
    GscBinSkip1(0x74, var_2, var_0, var_1, self);
  }
}