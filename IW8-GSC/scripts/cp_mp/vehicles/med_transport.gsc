...
function med_transport_create(var_0, var_1) {
...
function med_transport_explode(var_0, var_1) {
  if(!isDefined(var_0)) {
    var_0 = spawnStruct();
...
function med_transport_deathcallback(var_0) {
  thread med_transport_explode(var_0);
  return true;
}

function med_transport_enterend(var_0, var_1, var_2, var_3, var_4) {
...
function med_transport_enterendinternal(var_0, var_1, var_2, var_3, var_4) {
  if(var_1 == "driver") {
...
function med_transport_exitend(var_0, var_1, var_2, var_3, var_4) {
  if(istrue(var_4.success)) {
...
function med_transport_exitendinternal(var_0, var_1, var_2, var_3, var_4) {
  if(var_1 == "driver") {
