...
func_9375() {
  ...
  if(self.shouldsplash) {
    level thread scripts\mp\utility\game::teamplayercardsplash(level.var_9385[self.var_9386].var_10A38, var_0);
    self.shouldsplash = 0;
  }
...
func_6D2C(var_0, var_1) {
  ...
  for(var_8 = 0; var_8 < var_7.size; var_8++) {
    if(isDefined(var_5)) {
      scripts\mp\utility\game::_magicbullet(var_4, var_2.origin, var_7[var_8], var_5);
      continue;
    }

    scripts\mp\utility\game::_magicbullet(var_4, var_2.origin, var_7[var_8]);
  }
