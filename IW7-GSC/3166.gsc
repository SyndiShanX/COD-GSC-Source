...
func_3F06(var_0, var_1, var_2) {
  ...
  var_10 = spawnStruct();
  if(abs(var_8) > 135) {
    var_10.var_1299D = scripts\asm\asm::asm_lookupanimfromalias(var_1, "2");
  } else if(var_8 < 0) {
    var_10.var_1299D = scripts\asm\asm::asm_lookupanimfromalias(var_1, "6");
  } else {
    var_10.var_1299D = scripts\asm\asm::asm_lookupanimfromalias(var_1, "4");
  }

  var_10.var_D81F = var_7;
  return var_10;
}
...
func_D55A(var_0, var_1, var_2, var_3) {
  ...
  var_11 = 0;
  while(var_11 < var_9) {
    self func_80F1(self.origin, self.angles + (0, var_10, 0));
    var_11++;
    wait(0.05);
  }
}
...
func_D558(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(var_7)) {
    ...
    var_10 = angleclamp180(var_8 - var_7.var_3E);
  ...
  lib_0A1E::func_2369(var_3, var_4, var_10);
...
func_FFCA(var_0, var_1, var_2, var_3) {
  ...
  var_11 = self._blackboard.shufflenode.origin - self._blackboard.var_1016B.origin;
