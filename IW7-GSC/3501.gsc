...
func_12889(var_0) {
  ...
  if(scripts\mp\killstreaks\utility::func_A69F(var_0, "passive_armor_duration")) {
    var_6 = var_6 - 5;
  }

  if(scripts\mp\killstreaks\utility::func_A69F(var_0, "passive_twin_dragons")) {
  ...
  var_10.var_13CC3 = [];
  var_10.var_13CC3["hover"] = "minijackal_assault_mp";
  var_10.var_13CC3["fly"] = var_7;
  var_10.var_13CC3["land"] = var_10.var_13CC3["hover"];
  var_10 func_84BE("minijackal_mp");
  var_10 func_849E(var_10.var_13CC3["fly"]);
  ...
  var_10.var_10E4C = func_495B();
  var_10.var_EDD7 = 2250;
  ...
  self setclientomnvar("ui_killstreak_health", var_10.var_EDD7 / var_10.max_health);
...
func_B97F(var_0) {
  ...
  for(;;) {
    ...
    if(scripts\mp\utility\game::istrue(self.var_DF58)) {
      continue;
    }
    var_3 = self.var_B8B0;
    ...
    for(var_4 = 0; var_4 < var_3; var_4++) {
      ...
      var_7 = scripts\mp\utility\game::_magicbullet("shockproj_mp", var_5, var_6, var_0);
...
trackmissiletargetinview(var_0, var_1) {
  var_2 = scripts\mp\killstreaks\utility::func_7E92(var_1.owner);
  var_3 = undefined;
  var_4 = 999999999;
  var_5 = var_0;
  ...
  foreach(var_10 in var_2) {
    ...
    if(scripts\engine\trace::ray_trace_passed(var_5, var_11, var_7, var_8) && vectordot(var_6, var_12) > 0.75 && var_13 <= var_4) {
      var_4 = var_13;
      var_3 = var_10;
    }
  }
...
func_B95F(var_0) {
  ...
  for(;;) {
    ...
    if(isDefined(var_13)) {
      var_4 = scripts\mp\killstreaks\utility::getmodifiedantikillstreakdamage(var_5, var_13, var_8, var_4, self.max_health, var_1, var_2, var_3, 1);
    ...
    if(isplayer(var_5)) {
      ...
      if(self.var_EDD7 <= 0) {
        ...
        scripts\mp\damage::onkillstreakkilled("minijackal", var_5, var_13, var_8, var_4, "destroyed_" + self.streakname, self.streakname + "_destroy", var_18, 1);
      }
    }
...
func_B961(var_0) {
  ...
  scripts\mp\utility\game::printgameaction("killstreak ended - minijackal", var_0);
  self delete();
...
func_B95E(var_0) {
  ...
  for(;;) {
    ...
    if(var_9 > 0) {
      ...
      if(self.var_EDD7 - var_10 < 150) {
        var_10 = self.var_EDD7 - 150;
      }
    }
  }
}
...
func_B9A9(var_0) {
  ...
  self endon("minijackal_end");
  thread scripts\mp\killstreaks\utility::watchhostmigrationlifetime("minijackal_end", var_0, ::func_B9A9);
...
func_B969(var_0) {
  ...
  for(;;) {
    ...
    scripts\mp\killstreaks\utility::dodamagetokillstreak(100, var_1, var_1, self.team, var_3, var_5, var_4);
...
func_C77B(var_0) {
  ...
  var_1 = scripts\mp\utility\game::outlineenableforplayer(var_0, "cyan", var_0, 0, 0, "killstreak");
...
func_B7AC(var_0) {
  scripts\mp\utility\game::setusingremote(var_0);
}
