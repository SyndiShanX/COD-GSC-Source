...
update_personality_camper() {
  if(should_select_new_ambush_point() && !scripts\mp\bots\bots_util::bot_is_defending() && !scripts\mp\bots\bots_util::bot_is_remote_or_linked()) {
    ...
    if(isDefined(var_1) && var_1) {
      ...
      if(isDefined(var_4)) {
        var_5 = gettime();
        scripts\mp\bots\bots_strategy::bot_set_ambush_trap(var_4, self.ambush_entrances, self.node_ambushing_from, self.ambush_aw);
        var_5 = gettime() - var_5;
  ...
  if(!scripts\mp\bots\bots_strategy::bot_has_tactical_goal() && !scripts\mp\bots\bots_util::bot_is_remote_or_linked()) {
    ...
    if(!var_1 || var_2 < var_3 * var_3) {
      ...
      if(var_6 && randomfloat(100) < 25) {
        var_7 = scripts\mp\bots\bots_strategy::bot_get_ambush_trap_item("trap_directional", "trap");
        ...
        if(isDefined(var_7)) {
          ...
          if(isDefined(var_8)) {
            ...
            if(isDefined(var_9)) {
              var_10 = scripts\mp\bots\bots_util::bot_queued_process("bot_find_ambush_entrances", ::bot_find_ambush_entrances, var_9, 0);
              var_11 = scripts\mp\bots\bots_strategy::bot_set_ambush_trap(var_7, var_10, var_9);
