...
main() {
  ...
  self attach("head_bg_var_head_bg_male_07_head_male_bc_06", "", 1);
  self.headmodel = "head_bg_var_head_bg_male_07_head_male_bc_06";
...
precache() {
  ...
  precachemodel("head_bg_var_head_bg_male_07_head_male_bc_06");
