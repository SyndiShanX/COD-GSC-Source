...
init() {
  ...
  level.var_C321["odin_support"].timeout = 60.0;
  ...
  level.var_C321["odin_assault"].timeout = 60.0;
...
func_128F1(var_0, var_1) {
  ...
  if(scripts\mp\utility\game::currentactivevehiclecount() >= scripts\mp\utility\game::maxvehiclesallowed() || level.fauxvehiclecount + var_3 >= scripts\mp\utility\game::maxvehiclesallowed()) {
...
watchhostmigrationfinishedinit(var_0) {
  ...
  for(;;) {
    ...
    self.targeting_marker giveperkequipment(var_0);
  }
}
...
func_10DD2(var_0) {
  ...
  level thread scripts\mp\utility\game::teamplayercardsplash(level.var_C321[var_0.odintype].teamsplash, self);
...
func_C320(var_0) {
  ...
  var_6 = scripts\engine\utility::array_add(scripts\mp\utility\game::get_players_watching(), self);
  ...
  if(isDefined(var_0)) {
    ...
    foreach(var_2 in level.var_C321[var_0.odintype].weapon) {
      if(isDefined(var_2.var_D5E4)) {
        self stopolcalsound(var_2.var_D5E4);
      }

      if(isDefined(var_2.var_D5DD)) {
        self stopolcalsound(var_2.var_D5DD);
      }
    }
...
func_1399C() {
  ...
  for(;;) {
    ...
    if(gettime() >= self.odin_airdropusetime) {
      if(level.teambased) {
        scripts\mp\utility\game::leaderdialog(var_1.var_13521, self.team);
      } else {
        var_0 scripts\mp\utility\game::leaderdialogonplayer(var_1.var_13521);
      }
...
func_13B49() {
  ...
  for(;;) {
    ...
    if(gettime() >= self.odin_smokeusetime) {
      if(level.teambased) {
        scripts\mp\utility\game::leaderdialog(var_1.var_13551, self.team);
      } else {
        var_0 scripts\mp\utility\game::leaderdialogonplayer(var_1.var_13551);
      }
...
func_1369E(var_0) {
  ...
  wait 3.0;
  var_3 = scripts\mp\agents\agents::add_humanoid_agent("odin_juggernaut", var_1.team, "class1", var_0.origin, vectortoangles(var_2 - var_0.origin), var_1, 0, 0, "veteran");

  if(isDefined(var_3)) {
    var_4 = level.var_C321[self.odintype].weapon["juggernaut"];
    var_3 thread scripts\mp\killstreaks\juggernaut::givejuggernaut(var_4.var_A4AF);
...
func_13B21(var_0) {
  ...
  if(isDefined(var_4)) {
    var_1 scripts\mp\utility\game::func_13A7(var_4);
  }
...
func_58EE(var_0) {
  ...
  foreach(var_9 in level.participants) {
    ...
    if(!func_6565(var_9)) {
      if(level.teambased) {
        var_18 = scripts\mp\utility\game::outlineenableforteam(var_9, "orange", self.team, 0, 0, "killstreak");
      } else {
        var_18 = scripts\mp\utility\game::outlineenableforplayer(var_9, "orange", self.owner, 0, 0, "killstreak");
      }
  ...
  var_20 = level.var_C321[self.odintype].weapon["marking"];

  if(var_7 == 1) {
    if(level.teambased) {
      scripts\mp\utility\game::leaderdialog(var_20.var_1354B, self.team);
    } else {
      var_1 scripts\mp\utility\game::leaderdialogonplayer(var_20.var_1354B);
    }
  } else if(var_7 > 1) {
    if(level.teambased) {
      scripts\mp\utility\game::leaderdialog(var_20.var_1354A, self.team);
    } else {
      var_1 scripts\mp\utility\game::leaderdialogonplayer(var_20.var_1354A);
    }
  }
...
func_20D2(var_0) {
  ...
  var_1 = scripts\mp\utility\game::outlineenableforplayer(var_0, "orange", self.owner, 1, 0, "killstreak");
