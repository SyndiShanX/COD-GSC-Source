...
main() {
  ...
  var_0._id_EBEA[75] = [%shipcrib_stand_idle02_letsgo_left_01];
  var_0._id_EBEA[195] = [%shipcrib_stand_idle02_letsgo_left_03];
  var_0._id_EBEA[325] = [%shipcrib_stand_idle02_letsgo_left_01];
  var_0._id_EBEA["lastanim"] = [%shipcrib_stand_idle02_letsgo_left_03];
  var_0._id_EBEA["trigger_radius"] = 164;
  scripts\sp\interaction::register_interaction("stand_idle_2_left_reaction_xo", var_0);
}