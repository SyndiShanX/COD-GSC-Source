...
_id_475F(var_0) {
  ...
  if(isDefined(level._id_93A9) && level.player._id_4759.active.size > 3) {
    var_3 = level.player._id_4759.active.size - 3;

    for(var_4 = 0; var_4 < var_3; var_4++) {
      level.player._id_4759.active[var_4] notify("expired");
    }
  }
...
_id_DFDF(var_0) {
  ...
  if(isDefined(self.grenade)) {
    ...
    level.player._id_4759._id_A8C6 = self.grenade.origin;
    self.grenade delete();
  }
...
_id_4763(var_0, var_1, var_2, var_3) {
  ...
  var_4 _id_4765();
  level.player._id_4759.active[level.player._id_4759.active.size] = var_4;
}
...
draw_cool_circle_til_notify() {
  ...
  for(;;) {
    ...
    scripts\sp\debug::_id_5B5D(var_0, var_1, (0, 1, 0), 1, 0);
    wait 0.05;
  }
}
...
_id_10696(var_0) {
  ...
  for(var_9 = 1; var_9 < 5; var_9++) {
    ...
    if(var_0 _id_3913(var_16, var_12)) {
      var_0._id_473D[var_7 + "_" + var_8] = spawncovernode(var_16, var_12, "cover stand", 512, var_14);
    } else {
      var_13 = var_2;
    }
...
_id_E0E1(var_0) {
  foreach(var_4, var_2 in self._id_473D) {
    if(var_0 == self._id_473D[var_4]) {
      ...
      self._id_473D = scripts\sp\utility::_id_22B2(self._id_473D, var_4);
      return;
    }
  }
}
...
_id_5B54(var_0, var_1, var_2) {
  ...
  for(;;) {
    scripts\sp\debug::_id_5B54(var_0, var_1, var_2, 32, 1);
    wait 0.05;
  }
}

_id_475E(var_0) {
  self._id_BE07 thread scripts\sp\utility::_id_C12D("expired", var_0);
  var_1 = self._id_BE07 scripts\engine\utility::waittill_any_return("expired", "death");
  var_2 = var_1 == "death";
  ...
  if(isDefined(self._id_BE07._id_BE64)) {
    destroynavobstacle(self._id_BE07._id_BE64);
  }
  ...
  var_4._id_4759.active = scripts\engine\utility::array_remove(var_4._id_4759.active, self._id_BE07);
  scripts\engine\utility::flag_wait_or_timeout("coverwall_force_delete", 1.5);

  if(!var_4._id_4759.active.size) {
...
_id_2BCE() {
  foreach(var_1 in self._id_4759.active) {
    _id_475C(var_1);
  ...
  for(;;) {
    ...
    foreach(var_2 in var_0) {
      if(isDefined(var_2._id_BE64)) {
        destroynavobstacle(var_2._id_BE64);
      }
