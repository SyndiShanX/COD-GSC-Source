...
_id_23CB() {
  ...
  for(;;) {
    ...
    foreach(var_2 in level.players) {
      if(!scripts\engine\utility::is_true(var_2._id_23DE)) {
        var_2._id_23DE = 1;
        ...
        if(scripts\cp\utility::isplayingsolo() || level.only_one_player) {
          ...
          var_2 thread scripts\cp\zombies\zombie_doors::_id_59FA();
        }
      }
    }
...
_id_12E34(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(var_3) && interaction_is_sliding_door(var_3) && scripts\engine\utility::is_true(var_3.player_opened)) {
    var_1 = 0;
  }
...
reset_interaction() {
  if(isDefined(self.interaction_trigger.name)) {
    scripts\cp\zombies\zombie_analytics::_id_AF74(self.interaction_trigger.name, 0);
  }
...
disable_linked_interactions(var_0) {
  ...
  foreach(var_3 in var_1) {
    if(var_3.target == var_0.target) {
      scripts\cp\zombies\zombie_analytics::_id_AF74(var_3.name, 0);
...
enable_linked_interactions(var_0) {
  ...
  foreach(var_3 in var_1) {
    if(var_3.target == var_0.target) {
      scripts\cp\zombies\zombie_analytics::_id_AF74(var_3.name, 1);
...
_id_55A2() {
  ...
  foreach(var_2 in var_0) {
    if(interaction_is_weapon_buy(var_2) || interaction_is_grenade_wall_buy(var_2) || interaction_is_ticket_buy(var_2) || isDefined(var_2.script_parameters) && var_2.script_parameters == "tickets") {
      var_2.disabled = 1;
      scripts\cp\zombies\zombie_analytics::_id_AF74(var_2.name, 0);
      continue;
    }
  }
}
