...
func_3E9A(var_0, var_1, var_2) {
  ...
  if(self.asm.shootparams.var_FF0B == 1) {
    ...
    var_4 = var_3 + self.asm.shootparams.var_FF0B;
  }
...
getnodeyawoffset(var_0, var_1) {
  ...
  if(getdvarint("ai_iw7", 0) == 1) {
    ...
    if(self.asm.var_7360 && isDefined(anim.var_7365) && isDefined(anim.var_7365[self.asmname])) {
      var_2 = getnodeyawfromoffsettable(anim.var_7365[self.asmname], var_0, var_1);
      ...
      return 0;
    } else if(isDefined(anim.var_C05A) && isDefined(anim.var_C05A[self.asmname])) {
      var_2 = getnodeyawfromoffsettable(anim.var_C05A[self.asmname], var_0, var_1);
...
getnodeforwardangles(var_0, var_1) {
  var_2 = getnodeyawoffset(var_0, var_1);
  return _combineangles(var_0.angles, (0, var_2, 0));
}
...
func_7FF1(var_0, var_1, var_2) {
  ...
  if(var_2 == "exposed") {
    var_3 = anim.var_C046[var_0];
  } else if(var_2 == "lean" || var_2 == "leanover") {
    var_3 = anim.var_C04D[var_0];
  }
