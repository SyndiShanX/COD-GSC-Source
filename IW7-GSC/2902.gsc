...
func_196B(var_0, var_1, var_2, var_3) {
  self endon("death");
  var_2 = squared(var_2);
  var_1 = func_0EFB::func_7D7A(var_1);
  var_3 = func_0EFB::func_7D7A(var_3).origin;
...
func_194A(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  ...
  if(isDefined(var_1)) {
    wait(var_3);
    var_2 = func_0EFB::func_7D7A(var_2);
...
func_195C(var_0, var_1, var_2, var_3, var_4) {
  ...
  var_0 = func_0EFB::func_7D7A(var_0);
  thread func_0C4C::func_1955(var_0, var_1, var_2);
  wait(var_4);
  func_0C4C::func_1964(var_3);
}
