 ...
 * Script: aitype\enemy_sdf_rpg.gsc
**************************************/
...
main() {
  ...
  self.weapon = "iw7_lockon_ai+lockonscope";
  var_0 = undefined;
  var_1 = ["character_sdf_army_light_1", "character_sdf_army_heavy_4"];
...
precache() {
  ...
  _id_03AE::_id_DEE8();
  _id_0C69::_id_2371();
  precacheitem("iw7_lockon_ai+lockonscope");
}