...
setup_individual_exploder(var_0) {
  ...
  if(exploder_model_is_damaged_model(var_0)) {
    var_0 hide();
    var_0 notsolid();
    if(isDefined(var_0.spawnimpulsefield) && var_0.spawnimpulsefield & 1) {
...
setupexploders() {
  ...
  for(var_2 = 0; var_2 < var_6.size; var_2++) {
    ...
    } else if(var_9.var_9F == "script_brushmodel" || isDefined(var_9.model)) {
      var_4.model = var_9;
      var_4.model.disconnect_paths = var_9.script_disconnectpaths;
    }

    if(isDefined(var_9.var_336) && isDefined(var_8[var_9.var_336])) {
      var_4.v["exploder_type"] = var_9.var_336;
    } else {
    ...
    if(isDefined(var_9.masked_exploder)) {
      ...
      var_4.v["masked_exploder_spawnflags"] = var_9.spawnimpulsefield;
...
exploder_model_is_damaged_model(var_0) {
  return isDefined(var_0.var_336) && var_0.var_336 == "exploder";
}

exploder_model_starts_hidden(var_0) {
  return var_0.model == "fx" && !isDefined(var_0.var_336) || var_0.var_336 != "exploderchunk";
}

exploder_model_is_chunk(var_0) {
  return isDefined(var_0.var_336) && var_0.var_336 == "exploderchunk";
}
...
show_exploder_models_proc(var_0) {
  ...
  var_5 = 0;
  while(var_3 < level.createfxent.size) {
    var_5 = level.createfxent[var_3];
    if(!isDefined(var_5)) {
      continue;
    }
    ...
    if(var_5.v["exploder"] + "" != var_2) {
      continue;
    }

    if(isDefined(var_5.model)) {
      if(!exploder_model_starts_hidden(var_5.model) && !exploder_model_is_damaged_model(var_5.model) && !exploder_model_is_chunk(var_5.model)) {
        var_5.model show();
      }

      if(isDefined(var_5.brush_shown)) {
        var_5.model show();
      }
    }
...
stop_exploder_proc(var_0) {
  ...
  while(var_3 < level.createfxent.size) {
    ...
    if(isDefined(var_5.loopsound_ent)) {
      var_5.loopsound_ent stoploopsound();
      var_5.loopsound_ent delete();
    }
...
brush_throw() {
  ...
  if(var_4) {
    ...
    if(isDefined(var_5)) {
      ...
      var_7 = vectornormalize(var_4 - self.model.origin);
    }
...
brush_show() {
  ...
  if(!isDefined(self.model.script_modelname)) {
    ...
    if(isDefined(self.model.destroynavobstacle)) {
      var_0.destroynavobstacle = self.model.destroynavobstacle;
    }
