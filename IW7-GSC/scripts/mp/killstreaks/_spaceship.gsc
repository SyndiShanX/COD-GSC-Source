...
func_105A9(var_0, var_1, var_2, var_3, var_4) {
  var_5 = self;
  if(scripts\mp\utility::isstrstart(var_1, "spaceship")) {
...
func_105A5(var_0, var_1) {
  ...
  if(isDefined(var_1.var_10574) && var_1.var_10574 == var_0) {
    ...
    level.var_1676 = scripts\engine\utility::array_remove(level.var_1676, var_0);
    var_0 dodamage(var_0.health + 1, var_0.origin, var_1, undefined, "MOD_EXPLOSIVE");
...
func_10587(var_0) {
  ...
  wait(5);
  var_1 = 18.75;
  while(var_0.var_E1 > 0) {
    var_2 = 1500 - var_0.var_E1;
    var_0.var_E1 = var_0.var_E1 - var_1;
    if(var_0.var_E1 < 0) {
      var_0.var_E1 = 0;
    }

    var_3 = 1500 - var_0.var_E1;
...
func_105C4(var_0) {
  ...
  var_1 = scripts\engine\utility::array_combine(var_1, level.var_FE33[scripts\mp\utility::getotherteam(var_0)]);
  var_2 = undefined;
  var_3 = 0;
...
func_10593(var_0) {
  ...
  var_4 = physics_spherecast(var_1, var_3, 15, scripts\common\trace::create_vehicle_contents(), undefined, "physicsquery_closest");
  if(var_4.size == 0) {
    return undefined;
  }
...
func_1057A(var_0) {
  ...
  if(level.var_A407.allowhide) {
    ...
    foreach(var_4 in level.var_105ED) {
      if(func_105DD(var_4, var_2)) {
        return 1;
      }
    }
  }

  var_2 iprintlnbold(&"MP_JACKAL_CANT_SUMMON");
  return 0;
}
...
func_105BA(var_0, var_1) {
  ...
  for(;;) {
    ...
    if(var_3 < 100) {
      ...
      thread func_105B9(var_0, var_1, "space_particles", var_4 * 300, 3);
      wait(0.75);
      continue;
    }
