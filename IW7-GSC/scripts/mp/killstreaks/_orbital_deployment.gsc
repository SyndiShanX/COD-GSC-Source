...
func_B9F2(var_0) {
  ...
  for(;;) {
    ...
    var_3 = var_0 scripts\mp\utility::get_players_watching();
  ...
  if(isDefined(var_0)) {
    ...
    foreach(var_3 in level.var_C6D7["orbital_deployment"].weapon) {
      ...
      if(isDefined(var_3.var_D5DD)) {
        self stoplocalsound(var_3.var_D5DD);
      }
    }
...
func_1285(var_0, var_1, var_2, var_3) {
  ...
  var_8 = scripts\mp\utility::_magicbullet("drone_hive_projectile_mp", var_6 - (0, 0, 5000), var_5, var_2);
...
func_C6D6(var_0, var_1) {
  ...
  var_0 thread scripts\mp\utility::set_visionset_for_watching_players("default", 0, undefined, 1);
...
func_13AA4(var_0) {
  ...
  for(;;) {
    ...
    if(isDefined(self)) {
      ...
      var_0 scripts\mp\utility::set_visionset_for_watching_players("default", 0, undefined, 1);
