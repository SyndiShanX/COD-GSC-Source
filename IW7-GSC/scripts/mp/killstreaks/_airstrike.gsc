...
func_57DD(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  ...
  var_10 = spawnStruct();
  var_10.origin = var_9;
  var_10.missionfailed = anglesToForward((0, var_2, 0));
...
losradiusdamage(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  ...
  for(var_8 = 0; var_8 < var_7.size; var_8++) {
    ...
    if(var_7[var_8].isplayer || isDefined(var_7[var_8].issentry) && var_7[var_8].issentry) {
      var_10 = !bullettracepassed(var_7[var_8].issplitscreen.origin, var_7[var_8].issplitscreen.origin + (0, 0, 130), 0, undefined);
      if(var_10) {
        var_10 = !bullettracepassed(var_7[var_8].issplitscreen.origin + (0, 0, 130), var_0 + (0, 0, 114), 0, undefined);
        if(var_10) {
          var_9 = var_9 * 4;
          if(var_9 > var_1) {
            continue;
...
func_5A60(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11) {
  ...
  var_11 = scripts\mp\killstreak_loot::getrarityforlootitem(var_11.variantid);
  if(var_11 != "") {
    var_10 = var_10 + "_" + var_11;
  }

  var_12 = spawn("script_model", var_14);
  ...
  if(var_9 == "precision_airstrike") {
    ...
    if(scripts\mp\killstreaks\_utility::func_A69F(var_11, "passive_speed_cost")) {
      var_7 = var_7 - 1;
    }
    ...
    var_12.var_A87B.streakinfo = var_11;
    var_12.turret settargetentity(var_12.turrettarget);
  }

  var_12 moveto(var_15, var_7, 0, 0);
  if(var_9 == "precision_airstrike") {
    var_12 setscriptablepartstate("thrusters", "idle", 0);
    thread func_3788(var_12, var_15, var_7, var_6 - 1.5, var_1);
    wait(var_6 + 1);
  } else {
    var_12 setscriptablepartstate("thrusters", "idle", 0);
    thread callstrike_bombeffect(var_12, var_15, var_7, var_6 - 1, var_1, var_2, var_9, var_10);
    wait(var_6 - 0.75);
  }
...
callstrike_bombeffect(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  ...
  var_10 thread deleteaftertime(15);
  var_10.angles = var_8;
  ...
  var_15 = 5;
  var_10 = 55;
  var_11 = var_10 - var_15 / var_14;
  var_12 = (0, 0, 0);
  for(var_13 = 0; var_13 < var_14; var_13++) {
    var_14 = anglesToForward(var_13 + (var_10 - var_11 * var_13, randomint(10) - 5, 0));
    var_15 = var_12 + var_14 * 10000;
    var_16 = bulletTrace(var_12, var_15, 0, undefined);
  ...
  var_12 = var_12 / var_14 + (0, 0, 128);
  var_10 moveto(var_9.killcament.origin * 0.35 + var_12 * 0.65, 1.5, 0, 0.5);
  wait(5);
  var_11 delete();
  var_9 delete();
}
...
callstrike(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  ...
  if(var_4 == "jackal") {
    ...
    var_1 scripts\mp\killstreaks\_jackal::func_2A6B(var_0, var_14["startPoint"], var_2, var_6);
    return;
  }

  if(var_5 == "precision_airstrike") {
    var_14 = getflightpath(var_3, var_10, var_11, var_8, var_13, var_12, var_9, var_5);
...
selectairstrikelocation(var_0, var_1, var_2) {
  ...
  if(var_1 == "precision_airstrike") {
    ...
    var_4 = scripts\mp\killstreaks\_mapselect::func_8112(var_1, var_12, 1);
  ...
  thread scripts\mp\utility::teamplayercardsplash(var_10, self);
