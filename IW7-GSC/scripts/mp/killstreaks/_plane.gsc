...
selectairstrikelocation(var_0, var_1, var_2) {
  ...
  scripts\mp\utility::_beginlocationselection(var_1, "map_artillery_selector", var_4.choosedirection, var_3);
...
setobjectiveicons(var_0, var_1) {
  ...
  if(level.teambased) {
    ...
    if(var_3 != -1) {
      scripts\mp\objidpoolmanager::minimap_objective_team(var_3, scripts\mp\utility::getotherteam(self.team));
      return;
    }
