...
markeractivate(var_0, var_1, var_2) {
  ...
  var_5 thread[[var_2]]();
  self delete();
  if(isDefined(var_5) && var_5 scripts\mp\utility::touchingbadtrigger()) {
    var_5 notify("death");
  }
}
...
box_seticon(var_0, var_1, var_2) {
  scripts\mp\entityheadicons::setheadicon(var_0, scripts\mp\utility::getkillstreakoverheadicon(var_1), (0, 0, var_2), 14, 14, undefined, undefined, undefined, undefined, undefined, 0);
}
...
boxcapturethink(var_0) {
  ...
  while(isDefined(self)) {
    ...
    if(isDefined(level.boxsettings[self.boxtype].nousekillstreak) && level.boxsettings[self.boxtype].nousekillstreak && scripts\mp\utility::iskillstreakweapon(var_0 getcurrentweapon())) {
      continue;
    }
