...
tryuseescortairdrop(var_0, var_1) {
  ...
  if(scripts\mp\utility::currentactivevehiclecount() >= scripts\mp\utility::maxvehiclesallowed() || level.fauxvehiclecount + var_2 >= scripts\mp\utility::maxvehiclesallowed()) {
...
func_4983(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  level.chopper = var_6;
  var_6 scripts\mp\killstreaks\_helicopter::func_184E();
  var_6 thread scripts\mp\killstreaks\_flares::flares_monitor(2);
  var_6 thread scripts\mp\killstreaks\_helicopter::heli_leave_on_disconnect(var_0);
  var_6 thread scripts\mp\killstreaks\_helicopter::heli_leave_on_changeteams(var_0);
  var_6 thread scripts\mp\killstreaks\_helicopter::heli_leave_on_gameended(var_0);
  var_7 = level.var_C73F[var_5].timeout;
  var_6 thread scripts\mp\killstreaks\_helicopter::heli_leave_on_timeout(var_7);
  var_6 thread scripts\mp\killstreaks\_helicopter::heli_damage_monitor(var_5, 0);
  var_6 thread scripts\mp\killstreaks\_helicopter::heli_health();
  var_6 thread scripts\mp\killstreaks\_helicopter::func_8D49();
...
func_1011E(var_0) {
  ...
  self.var_6741 settext(level.var_C73F[var_0.var_C740].var_DA71);
  wait(6);
...
func_1AE6(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  scripts\mp\killstreaks\_helicopter::heli_fly_simple_path(var_1);
  self.var_C96C = var_2;
  var_6 = self.angles;
...
func_A663(var_0) {
  ...
  for(;;) {
    foreach(var_3 in level.players) {
      ...
      if(var_3 scripts\mp\utility::_hasperk("specialty_blindeye")) {
        continue;
      }
...
func_1B01(var_0, var_1) {
  ...
  for(;;) {
    ...
    if(var_2 <= 0) {
      var_3--;
      var_2 = 6;
      if(distancesquared(var_0.origin, var_1) > 500000 || var_3 <= 0 || !scripts\mp\utility::isreallyalive(var_0)) {
...
func_C73E(var_0, var_1, var_2) {
  ...
  var_3[0] = thread scripts\mp\killstreaks\_airdrop::dropthecrate(undefined, self.droptype, undefined, 0, undefined, self.origin, (randomint(10), randomint(10), randomint(10)), undefined, var_1);
  wait(0.05);
  self notify("drop_crate");
  wait(var_0);
  var_3[1] = thread scripts\mp\killstreaks\_airdrop::dropthecrate(undefined, self.droptype, undefined, 0, undefined, self.origin, (randomint(100), randomint(100), randomint(100)), var_3, var_1);
  wait(0.05);
  self notify("drop_crate");
  wait(var_0);
  var_3[2] = thread scripts\mp\killstreaks\_airdrop::dropthecrate(undefined, self.droptype, undefined, 0, undefined, self.origin, (randomint(50), randomint(50), randomint(50)), var_3, var_1);
  wait(0.05);
  self notify("drop_crate");
  wait(var_0);
  var_3[3] = thread scripts\mp\killstreaks\_airdrop::dropthecrate(undefined, self.droptype, undefined, 0, undefined, self.origin, (randomintrange(-100, 0), randomintrange(-100, 0), randomintrange(-100, 0)), var_3, var_1);
  wait(0.05);
  self notify("drop_crate");
  wait(var_0);
  thread scripts\mp\killstreaks\_airdrop::dropthecrate(undefined, self.droptype, undefined, 0, undefined, self.origin, (randomintrange(-50, 0), randomintrange(-50, 0), randomintrange(-50, 0)), var_3, var_1);
  wait(0.05);
  self notify("drop_crate");
  wait(1);
  thread func_1AEC();
