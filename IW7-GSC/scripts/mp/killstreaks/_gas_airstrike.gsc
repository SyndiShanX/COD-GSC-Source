...
init() {
  ...
  var_0.getclosestpointonnavmesh3d = 5000;
...
onuse(var_0, var_1) {
  ...
  var_3 = scripts\mp\killstreaks\_plane::selectairstrikelocation(var_0, "gas_airstrike", ::dostrike);
...
dostrike(var_0, var_1, var_2, var_3) {
  level.var_C22F = 0;
  wait(1);
  var_4 = scripts\mp\killstreaks\_plane::_meth_806A();
...
dooneflyby(var_0, var_1, var_2, var_3, var_4) {
  ...
  var_6 = scripts\mp\killstreaks\_plane::getflightpath(var_2, var_3, var_5.halfdistance, 1, var_4, var_5.getclosestpointonnavmesh3d, 0, var_0);
...
dropbombs(var_0, var_1, var_2, var_3, var_4) {
  ...
  var_7 = var_5.var_5703 / var_5.getclosestpointonnavmesh3d;
  while(var_6 > 0) {
...
func_5D35(var_0, var_1) {
  ...
  var_5 movegravity(var_4 * var_3.getclosestpointonnavmesh3d / 1.5, 3);
