...
init() {
  ...
  if(level.multiteambased) {
    for(var_3 = 0; var_3 < level.teamnamelist.size; var_3++) {
      level.createprintchannel[level.teamnamelist[var_3]] = "normal_radar";
...
onplayerconnect() {
  ...
  for(;;) {
    ...
    level.createprintchannel[var_1.guid] = "normal_radar";
    var_1.drawsoundshape = var_0;
...
launchuav(var_0, var_1, var_2) {
  ...
  var_0A = scripts\mp\killstreak_loot::getrarityforlootitem(var_2.variantid);
  if(var_0A != "") {
    var_6 = var_6 + "_" + var_0A;
    var_9 = var_9 + "_" + var_0A;
  }

  level thread scripts\mp\utility::teamplayercardsplash(var_9, var_0);
  if(var_1 == "uav") {
    if(scripts\mp\killstreaks\_utility::func_A69F(var_2, "passive_duration_health")) {
      var_7 = var_7 + 5;
      var_8 = var_8 - 200;
    }

    if(scripts\mp\killstreaks\_utility::func_A69F(var_2, "passive_armor_speed")) {
      var_7 = var_7 - 5;
    }
    ...
    if(scripts\mp\killstreaks\_utility::func_A69F(var_2, "passive_disable_hud")) {
      var_7 = var_7 - 10;
    }
  } else {
    if(scripts\mp\killstreaks\_utility::func_A69F(var_2, "passive_duration_health")) {
    ...
    if(scripts\mp\killstreaks\_utility::func_A69F(var_2, "passive_vision_sweep")) {
      var_7 = var_7 - 5;
    }
  }
  ...
  var_5 _meth_8549();
  var_5 _meth_8594();
  var_5 scripts\mp\killstreaks\_utility::func_1843(var_1, "Killstreak_Air", var_0);
  ...
  if(scripts\mp\killstreaks\_utility::func_A69F(var_2, "passive_stealth_vehicle")) {
  ...
  if(isDefined(level.activeuavs[var_3])) {
    foreach(var_1A in level.uavmodels[var_3]) {
      if(var_1A == var_5) {
        continue;
      }
  ...
  if(scripts\mp\killstreaks\_utility::func_A69F(var_2, "passive_emp_blast")) {
  ...
  scripts\mp\utility::printgameaction("killstreak ended - " + var_1, var_0);
  level notify("uav_update");
}
...
damagetracker() {
  ...
  for(;;) {
    ...
    if(isDefined(var_9)) {
      if(scripts\mp\killstreaks\_utility::func_A69F(self.streakinfo, "passive_armor_speed")) {
        if(scripts\mp\killstreaks\_utility::isexplosiveantikillstreakweapon(var_9)) {
          var_1 scripts\mp\damagefeedback::updatedamagefeedback("hitblastshield");
        }
      }

      var_0E = scripts\mp\killstreaks\_utility::getmodifiedantikillstreakdamage(var_1, var_9, var_4, var_0E, self.maxhealth, var_0F, var_10, var_11);
    ...
    if(self.var_E1 >= self.maxhealth) {
      if(isplayer(var_1) && !isDefined(self.triggerportableradarping) || var_1 != self.triggerportableradarping) {
        ...
        scripts\mp\damage::onkillstreakkilled(self.uavtype, var_1, var_9, var_4, var_0, "destroyed_" + self.uavtype, self.uavtype + "_destroyed", var_13);
...
handlewiretap() {
  foreach(var_1 in level.players) {
    ...
    if(!var_1 scripts\mp\utility::_hasperk("specialty_expanded_minimap")) {
      continue;
    }
...
_getradarstrength(var_0) {
  ...
  if(var_3) {
    var_1 = var_0F - getuavstrengthlevelneutral();
  }
  ...
  if(var_2 > 0) {
    ...
    var_10 = int(clamp(var_2 + getuavstrengthlevelneutral(), getuavstrengthlevelneutral(), getuavstrengthlevelshowenemyfastsweep()));
  }
...
func_12F3F(var_0, var_1) {
  ...
  foreach(var_0A in level.players) {
    var_0B = var_7;
    if(var_0A.team != var_0) {
      continue;
    }

    if(var_0A scripts\mp\utility::_hasperk("specialty_empimmune") && var_7 <= var_5) {
      if(scripts\mp\utility::istrue(var_0A.cylinder)) {
        var_0B = var_3;
      }

      if(var_0B != var_3) {
        var_0B = int(clamp(var_8 + var_5, var_5, var_6));
      }
    }

    if(var_0B <= var_2) {
      var_0B = var_2;
    } else if(var_0B >= var_3) {
      var_0B = var_3;
    }
    ...
    var_0A setradarmode(var_0B, var_6, var_4);
    var_0A.cylinder = var_0B >= var_4;
...
func_12EF2() {
  ...
  foreach(var_5 in level.players) {
    ...
    if(var_6 <= getuavstrengthlevelneutral()) {
      var_5.playcinematicforall = 0;
      var_5.cylinder = 0;
      if(isDefined(var_5.createprintchannel) && var_5.createprintchannel == "constant_radar") {
        var_5.createprintchannel = "normal_radar";
      }
    ...
    var_5.cylinder = var_6 >= var_2;
    var_5.playcinematicforall = 1;
  ...
  if(var_0 >= var_2) {
    ...
    foreach(var_5 in var_3) {
      if(isDefined(var_5) && var_5.uavtype == "directional_uav") {
        if(!level.teambased) {
          if(var_5.triggerportableradarping != self) {
            continue;
          }
        }

        if(scripts\mp\killstreaks\_utility::func_A69F(var_5.streakinfo, "passive_vision_sweep")) {
...
func_12F40(var_0) {
  ...
  foreach(var_3 in level.players) {
    ...
    var_3.createprintchannel = level.createprintchannel[var_3.team];
    if(var_3.team == var_0) {
      var_3.cylinder = var_1;
    }
  }
}
...
func_13920(var_0, var_1) {
  ...
  for(;;) {
    ...
    foreach(var_5 in level.participants) {
      ...
      if(var_5 scripts\mp\utility::_hasperk("specialty_noplayertarget")) {
        continue;
      }
      ...
      foreach(var_7 in level.participants) {
        ...
        if(scripts\mp\utility::isenemy(var_7)) {
          continue;
        }
...
_meth_81E8(var_0, var_1) {
  ...
  switch (var_0) {
    ...
    case "directional_uav":
      ...
      if(scripts\mp\killstreaks\_utility::func_A69F(var_1, "passive_stealth_vehicle")) {
...
func_CA50() {
  ...
  self.var_6569 = scripts\mp\killstreaks\_airdrop::createobjective_engineer(var_0, 1, 1);
  for(;;) {
    foreach(var_2 in level.players) {
      ...
      if(self.var_6569 != -1) {
        if(var_2 scripts\mp\utility::_hasperk("specialty_engineer") && scripts\mp\utility::istrue(scripts\mp\utility::playersareenemies(var_2, self.triggerportableradarping))) {
...
startsystemshutdown() {
  ...
  foreach(var_1 in level.players) {
    ...
    if(!scripts\mp\utility::playersareenemies(self.triggerportableradarping, var_1)) {
      continue;
    }

    if(!var_1 scripts\mp\utility::_hasperk("specialty_empimmune")) {
...
applyshutdownonspawn() {
  ...
  for(;;) {
    ...
    if(!scripts\mp\utility::playersareenemies(var_0, var_2)) {
      continue;
    }
...
startemppulse() {
  ...
  foreach(var_1 in level.players) {
    ...
    if(scripts\mp\equipment\phase_shift::isentityphaseshifted(var_1)) {
      var_3 = 0;
    } else if(scripts\mp\utility::istrue(var_1.visionpulsevisionsetactive)) {
      var_3 = 0;
    }
...
func_52C5(var_0, var_1) {
  ...
  var_4 = scripts\mp\perks\_perkfunctions::func_7D96();
  var_5 = undefined;
  ...
  if(isDefined(var_5)) {
    foreach(var_7 in var_5) {
      if(isDefined(var_7)) {
        var_7 scripts\mp\killstreaks\_utility::dodamagetokillstreak(10000, var_1, var_1, var_0, var_7.origin, "MOD_EXPLOSIVE", var_2);
      }
    }
  }
}