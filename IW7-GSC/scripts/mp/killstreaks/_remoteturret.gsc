...
func_13A1D() {
  ...
  for(;;) {
    ...
    var_2 = 0;
    while(var_0 usebuttonpressed() && !var_0 fragbuttonpressed() && !var_0 scripts\mp\utility::func_85C7() && !var_0 secondaryoffhandbuttonpressed() && !var_0 isusingturret() && var_0 isonground() && !var_0 istouching(self.ownertrigger) && !isDefined(var_0.empgrenaded) || !var_0.empgrenaded) {
