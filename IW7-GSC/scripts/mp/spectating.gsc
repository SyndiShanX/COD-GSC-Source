...
autoattachtoplayer() {
  ...
  for(;;) {
    ...
    if(level.players.size > 1) {
      var_1 = scripts\mp\utility::getteamarray("allies", 0);
      if(var_1.size > 0) {
        var_0 = scripts\mp\utility::getlowestclientnum(var_1, 1);
      }

      if(!isDefined(var_0)) {
        var_1 = scripts\mp\utility::getteamarray("axis", 0);
        if(var_1.size > 0) {
          var_0 = scripts\mp\utility::getlowestclientnum(var_1, 1);
        }
      }
...
setspectatepermissions() {
  ...
  if(isDefined(var_2) && var_2 == "axis" || var_2 == "allies") {
    ...
    if(isDefined(level.spectateoverride[var_2].allowenemyspectate)) {
      self allowspectateteam(scripts\mp\utility::getotherteam(var_2), 1);
    }
  }
}
...
func_F87A(var_0) {
  ...
  if(isDefined(var_0) && var_0 == "allies" || var_0 == "axis" && !level.multiteambased) {
    self allowspectateteam(var_0, 1);
    self allowspectateteam(scripts\mp\utility::getotherteam(var_0), 0);
    self allowspectateteam("freelook", 0);
    self allowspectateteam("none", 0);
    return;
  }

  if(isDefined(var_0) && issubstr(var_0, "team_") && level.multiteambased) {
