...
func_4ADA(var_0) {
  ...
  var_0 endon("death");
  scripts\mp\utility::printgameaction("cryo mine spawn", var_0.triggerportableradarping);
  ...
  var_0 scripts\mp\sentientpoolmanager::registersentient("Tactical_Static", var_0.triggerportableradarping);
...
func_4AD8(var_0, var_1) {
  ...
  scripts\engine\utility::waittill_any_timeout_1(var_1, "chillEnd");
