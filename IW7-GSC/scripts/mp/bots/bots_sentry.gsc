...
bot_sentry_choose_target(var_0) {
  var_1 = scripts\mp\bots\_bots_util::defend_valid_center();
  if(isDefined(var_1)) {
    return var_1;
  }
...
bot_sentry_choose_placement(var_0, var_1, var_2, var_3) {
  ...
  } else if(var_3 == "hide_nonlethal") {
    var_7 = self botnodepick(var_6, var_7, "node_hide");
  } else {
    var_7 = self botnodepick(var_6, var_7, "node_sentry", var_2);
  }
