...
intelattachmentcount0kills(var_0) {
  while(!scripts\mp\intel::func_9E94()) {
    self waittill("kill_event_buffered", var_1, var_2);
    if(isDefined(var_2)) {
      if(!scripts\mp\utility::iscacprimaryweapon(var_2) && !scripts\mp\utility::iscacsecondaryweapon(var_2)) {
        continue;
      }
    ...
    if(!scripts\mp\intel::func_9E94()) {
      switch (self.var_9978.ref) {
        ...
        case "ch_intel_ace":
          var_5 = 0;
          if(level.teambased) {
            var_5 = scripts\mp\utility::getteamarray(scripts\mp\utility::getotherteam(self.team)).size;
          } else {
        ...
        case "ch_intel_ss_drone_kills":
          ...
          var_11 = scripts\mp\missions::func_7F48(var_2);
          switch (var_11) {
        ...
        case "ch_intel_close_range_kills":
          if(var_1 == self) {
            var_15 = distancesquared(self.origin, var_0.origin);
            if(var_3 == "MOD_MELEE" || var_15 < 24336) {
              updatecurrentobjective();
            }
          }
          break;
...
func_9969(var_0) {
  self waittill("kill_event_buffered", var_1, var_2);
  if(!scripts\mp\utility::iskillstreakweapon(var_2) && scripts\mp\utility::func_9D48(var_0)) {
    updatecurrentobjective();
  }
}
...
func_996A(var_0) {
  self waittill("super_kill_buffered");
  if(scripts\mp\utility::func_9D48(var_0)) {
    updatecurrentobjective();
  }
}
...
intelattachmentcountchallenge(var_0, var_1, var_2) {
  ...
  foreach(var_6 in getweaponattachments(var_0)) {
    var_7 = scripts\mp\utility::attachmentmap_tobase(var_6);
...
combinealtweaponarray(var_0) {
  ...
  foreach(var_5, var_3 in var_0) {
    var_4 = var_5;
    if(scripts\mp\utility::isstrstart(var_5, "alt_")) {
