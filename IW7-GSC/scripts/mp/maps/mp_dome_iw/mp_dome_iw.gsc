...
patchablecollision() {
  ...
  var_10 = spawn("script_model", (-200, -1992, 480));
  var_10.angles = (0, 117, 90);
  var_10 clonebrushmodeltoscriptmodel(var_7);
  var_11 = getent("player512x512x8", "targetname");
  var_12 = spawn("script_model", (-200, -1992, 992));
  var_12.angles = (0, 117, 90);
  var_12 clonebrushmodeltoscriptmodel(var_11);
  var_13 = spawn("script_model", (275, -2448, 992));
  var_13.angles = (0, -117, 90);
  var_13 clonebrushmodeltoscriptmodel(var_11);
  var_14 = spawn("script_model", (32, -2448, 992));
  var_14.angles = (0, 117, 90);
  var_14 clonebrushmodeltoscriptmodel(var_11);
  var_15 = spawn("script_model", (-320, -1752, 992));
  var_15.angles = (0, 117, 90);
  var_15 clonebrushmodeltoscriptmodel(var_11);
