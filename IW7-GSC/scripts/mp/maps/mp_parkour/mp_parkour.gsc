...
fix_collision() {
  ...
  var_10 = spawn("script_model", (-225, -3316, 197));
  var_10.angles = (0, 165, -90);
  var_10 setModel("panel_metal_02_16x176_mp_parkour_patch");
  var_11 = spawn("script_model", (-56, -3361, 197));
  var_11.angles = (0, 165, -90);
  var_11 setModel("panel_metal_02_16x176_mp_parkour_patch");
  var_12 = spawn("script_model", (-177.5, -3137, 197));
  var_12.angles = (0, 165, -90);
  var_12 setModel("panel_metal_02_16x176_mp_parkour_patch");
  var_13 = spawn("script_model", (-8.5, -3182, 197));
  var_13.angles = (0, 165, -90);
  var_13 setModel("panel_metal_02_16x176_mp_parkour_patch");
  var_14 = spawn("script_model", (-378, -3277.5, 197));
  var_14.angles = (0, 75, -90);
  var_14 setModel("panel_metal_02_16x176_mp_parkour_patch");
  var_15 = spawn("script_model", (-68, -3357.5, 197));
  var_15.angles = (0, 75, -90);
  var_15 setModel("panel_metal_02_16x176_mp_parkour_patch");
