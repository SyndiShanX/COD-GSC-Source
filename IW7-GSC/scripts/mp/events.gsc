...
damagedplayer(var_0, var_1, var_2) {
  if(var_1 < 50 && var_1 > 10) {
    thread scripts\mp\utility::giveunifiedpoints("damage", var_2);
    level thread scripts\mp\battlechatter_mp::saytoself(self, "plr_damaged_light", undefined, 0.1);
    return;
  }

  thread scripts\mp\utility::giveunifiedpoints("heavy_damage", var_2);
...
func_A651(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  self.var_A9A4 = var_1;
  if(self.var_E9 > 0) {
    var_9 = self.setculldist / self.var_E9;
    if(var_9 > 3) {
  ...
  if(!scripts\mp\utility::iskillstreakweapon(var_2) && !scripts\mp\utility::isjuggernaut() && !scripts\mp\utility::_hasperk("specialty_explosivebullets")) {
    ...
    if(var_12) {
      if(func_9F03(self, var_2, var_3, var_11, var_1)) {
        thread func_D63F(var_0, var_2, var_3, var_1);
      } else if(func_9E84(self, var_2, var_3, var_11, var_1)) {
    ...
    if(level.teambased) {
      ...
      if(var_1B) {
        ...
        if(isDefined(var_1F[0]) && var_1 == var_1F[0]) {
    ...
    if(isDefined(var_5) && scripts\mp\utility::istrue(var_5.var_9F07) && var_3 == "MOD_IMPACT" && !scripts\mp\weapons::func_9FA9(var_2)) {
...
func_3E24(var_0, var_1) {
  var_2 = scripts\mp\utility::iskillstreakweapon(var_0);
  if(var_2) {
    ...
    switch (var_3) {
      ...
      default:
        thread scripts\mp\utility::giveunifiedpoints("killstreak_full_score", var_0);
        break;
    }
...
func_3E50(var_0, var_1, var_2, var_3) {
  ...
  var_7 = scripts\mp\utility::issuperweapon(var_2);
  var_8 = undefined;
  if(!isDefined(var_5)) {
    return;
  }
  ...
  if(var_7 && var_2 != "iw7_reaperblade_mp") {
    ...
    if(isDefined(var_8)) {
      thread scripts\mp\utility::giveunifiedpoints(var_8);
    }
  }
...
givekillreward(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  thread scripts\mp\utility::giveunifiedpoints(var_0, var_2);
}
