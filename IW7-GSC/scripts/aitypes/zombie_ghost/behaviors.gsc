 ...
 * Script: scripts\aitypes\zombie_ghost\behaviors.gsc
******************************************************/
...
ghostattack(var_0) {
  ...
  var_1 updateghostanimplaybackrate(1.0);
}
...
entangleghost(var_0, var_1) {
  ...
  var_0 updateghostanimplaybackrate(1.0);
...
isentangled(var_0) {
  return scripts\engine\utility::is_true(var_0.is_entangled);
}
