...
func_12E90(var_0) {
  ...
  scripts\asm\asm_bb::bb_setisincombat(func_8BEC(undefined) == anim.success);
...
func_43EB(var_0) {
  ...
  if(isDefined(self.enemy) && isDefined(self.var_101B4) && !scripts\engine\utility::is_true(self.var_C009)) {
    var_1 = 409;
...
func_DF53(var_0) {
  ...
  self.bt.instancedata[var_0].var_2AB1 = isDefined(self.pathgoalpos);
...
chooseshootstyle(var_0) {
  ...
  if(weaponburstcount(self.weapon) > 0) {
    return func_F840(var_0, "burst", 0);
  }

  var_8 = distancesquared(self getshootatpos(), var_0.pos);

  if(var_8 < var_1) {
    if(isDefined(var_0.ent) && isDefined(var_0.ent.var_B14F)) {
      return func_F840(var_0, "single", 0);
    } else {
      return func_F840(var_0, "full", 0);
    }
  } else if(var_8 < var_2 || func_FFC6()) {
    if(weaponissemiauto(self.weapon) || func_FFF6()) {
      return func_F840(var_0, "semi", 1);
    } else {
      return func_F840(var_0, "burst", 1);
    }
...
choosenumshotsandbursts(var_0) {
  ...
  } else if(var_0.var_1119D == "burst" || var_0.var_1119D == "semi") {
    var_0.var_FF0B = func_4F65(var_0);
  } else if(var_0.var_1119D == "single") {
    var_0.var_FF0B = 1;
  } else if(var_0.var_1119D == "mg") {
...
func_4F65(var_0) {
  ...
  if(var_2) {
    ...
    var_1 = anim.var_F217[randomint(anim.var_F217.size)];
  } else if(var_0.var_6B92) {
    var_1 = anim.var_6B93[randomint(anim.var_6B93.size)];
  } else {
    var_1 = anim.var_32BF[randomint(anim.var_32BF.size)];
  }
...
func_FECB(var_0) {
  if(!scripts\anim\utility_common::shouldshootenemyent()) {
    if(!isDefined(self.enemy)) {
      ...
      if((self.providecoveringfire || randomint(5) > 0) && func_100A4()) {
...
func_1384E(var_0) {
  ...
  if(var_1 > self._blackboard.var_2754 + 100 && !isDefined(self.pathgoalpos)) {
    return anim.failure;
  }
...
func_E84E(var_0) {
  func_FE6E(var_0);
  self.var_C3BB = self.favoriteenemy;
  self.var_C3B6 = self.combatmode;
  self.favoriteenemy = self.var_F126;
  self.looktarget = self.var_F126;
...
func_E84D(var_0) {
  ...
  if(!isDefined(self.favoriteenemy) || !isalive(self.favoriteenemy) || self.favoriteenemy != self.var_F126) {
    return anim.success;
  }
...
func_E84F(var_0) {
  self func_8484();
  self.favoriteenemy = self.var_C3BB;
  self.var_C3BB = undefined;
  self.combatmode = self.var_C3B6;
