...
update_challenge(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9) {
  ...
  var_0A thread[[var_0A.var_12E9C]](var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9);
}
  ...
  if(var_0[[var_0.var_9F82]]()) {
    ...
    if(func_9F17(var_0)) {
      ...
      if(var_0.ref == "no_laststand" || var_0.ref == "no_bleedout" || var_0.ref == "protect_player") {
        ...
        scripts\cp\zombies\zombie_analytics::func_AF64(var_0.ref, level.wave_num, var_0.current_progress / var_0.objective_icon * 100, level.var_3C2B[var_0.ref]);
      }
...
activate_new_challenge(var_0) {
  ...
  if(var_1[[var_1.var_386E]]()) {
    ...
    if(isDefined(var_2)) {
      level.challenge_data[var_0].objective_icon = var_2;
...
update_death_challenges(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8) {
  ...
  if(isDefined(level.custom_death_challenge_func)) {
    var_0A = self[[level.custom_death_challenge_func]](var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8);
