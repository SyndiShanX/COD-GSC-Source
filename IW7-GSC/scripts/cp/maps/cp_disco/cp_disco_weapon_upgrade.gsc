...
weapon_upgrade(var_0, var_1) {
  ...
  var_0A = undefined;
  var_0B = 0;
  if(!can_use_pap_machine(var_5, var_3)) {
    return;
  }
  ...
  if(var_3 can_upgrade(var_4)) {
    ...
    var_14 makeunusable();
    var_3 thread disco_playpapgesture(var_3, var_3.pap_gesture, var_7, var_4, var_0E);
    ...
    if(var_3 scripts\cp\utility::is_valid_player()) {
      ...
      var_3 scripts\cp\cp_merits::processmerit("mt_dlc2_upgrade_weapons");
    }
...
wait_for_player_to_take_weapon(var_0, var_1, var_2) {
  ...
  for(;;) {
    ...
    if(scripts\engine\utility::istrue(var_3.kung_fu_mode)) {
      wait(0.1);
      continue;
    }
