  ...
  if(scripts\engine\utility::istrue(var_7)) {
    ...
    foreach(var_13 in var_11) {
      ...
      if((isDefined(var_15) && var_8.vo_prefix == var_15) || var_14 || getdvarint("scr_solo_dialogue", 0) == 1) {
        ...
        var_14 = scripts\cp\cp_vo::create_vo_data(var_10, var_3, var_5, var_6, var_13);
        ...
        var_8 scripts\cp\cp_vo::set_vo_currently_playing(var_14);
        var_8 scripts\cp\cp_vo::play_vo(var_14);
    ...
    foreach(var_13, var_12 in var_10) {
      ...
      foreach(var_10 in level.players) {
        if((isDefined(var_14) && var_10.vo_prefix == var_14) || var_13 || getdvarint("scr_solo_dialogue", 0) == 1) {
          var_11 = scripts\cp\cp_vo::create_vo_data(var_15, var_3, var_5, var_6, var_12);
    ...
    if(scripts\engine\utility::istrue(level.announcer_vo_playing) || scripts\engine\utility::istrue(level.pam_playing)) {
      if(isDefined(level.jukebox_playing) && level.jukebox_playing.size > 0) {
        foreach(var_2, var_1 in level.jukebox_playing) {
          if(scripts\engine\utility::istrue(level.jukebox_playing[var_2])) {
            if(isDefined(level.jukebox_org_struct)) {
              level.jukebox_org_struct stoploopsound();
            }
          }
  ...
  foreach(var_8 in level.players) {
    if(isDefined(var_8) && isalive(var_8)) {
      if(var_8.vo_prefix == "p5_") {
        var_8 thread scripts\cp\cp_vo::try_to_play_vo("powerup_collect", "rave_comment_vo");
        continue;
      }
