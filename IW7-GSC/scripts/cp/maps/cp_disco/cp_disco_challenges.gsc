...
activate_challenge(var_0) {
  ...
  var_0 scripts\cp\zombies\solo_challenges::update_challenge_progress(var_0.current_challenge.current_progress, var_0.current_challenge.goal);
}
...
challenge_success(var_0) {
  ...
  if(scripts\engine\utility::is_true(var_0.chi_master_tiger) && scripts\engine\utility::is_true(var_0.chi_master_dragon) && scripts\engine\utility::is_true(var_0.chi_master_snake) && scripts\engine\utility::is_true(var_0.chi_master_crane)) {
