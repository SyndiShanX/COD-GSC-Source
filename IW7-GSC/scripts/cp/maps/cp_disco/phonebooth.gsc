...
skullbuster() {
  if(scripts\engine\utility::is_true(level.skullbuster_service_available)) {
    thread playlocalsound_phone("ring_usa");
    wait(randomfloatrange(2.2, 5.5));
    stoplocalsound_phone("ring_usa");
...
use_phonebooth(var_0, var_1) {
  ...
  if(var_5) {
    ...
    var_0.keypad_frame showtoplayer(var_1);
    var_1 clear_phone_omnvars_for_player();
    var_1 setclientomnvar("zm_ui_dialpad_ent", var_0.keypad_frame);

    foreach(var_11, var_9 in var_0.keypad_buttons) {
      if(!isDefined(var_9.model)) {
        var_10 = spawn("script_model", var_9.keypos);
        var_10 setModel(var_9.modelname);
        var_10.origin = var_9.keypos;
        var_10.angles = var_9.keyang;
        var_9.model = var_10;
        var_9.model showtoplayer(var_1);
      }
    }

    var_12 = use_phone_keypad(var_0, var_1, var_6);

    if(isDefined(var_1)) {
      var_1 thread snd_phone_outro(var_12);
    ...
    if(isDefined(var_1)) {
      ...
      var_1 unlink();
      var_0.keypad_frame hidefromplayer(var_1);
    }
    ...
    if(isDefined(var_1)) {
      ...
      if(!isDefined(var_12) || var_12 == "invalid_number") {
...
snd_phone_outro(var_0) {
  ...
  if(!scripts\engine\utility::is_true(self._phone_exit_move) && !scripts\engine\utility::is_true(self._phone_exit_damage)) {
    if(!isDefined(var_0)) {
