...
super_slasher_fight() {
  ...
  level.superslasher.damageshield = 1;
...
get_trap_trigger() {
  ...
  foreach(var_3 in var_0) {
    if(scripts\engine\utility::is_true(var_3.completed)) {
      continue;
    }
...
soul_key_pick_up_monitor(var_0, var_1) {
  ...
  clear_existing_enemies();
  scripts\cp\utility::play_bink_video("zombies_cp_rave_outro", 32);
