...
weapon_upgrade(var_0, var_1) {
  ...
  if(var_3 can_upgrade(var_4)) {
    ...
    var_14 makeunusable();
    var_3 thread rave_playpapgesture(var_3, var_3.pap_gesture, var_7, var_4, var_14);
...
update_level_pap_machines(var_0, var_1, var_2, var_3, var_4) {
  ...
  foreach(var_7 in level.player_pap_machines) {
    ...
    if((scripts\engine\utility::istrue(var_7.owner.has_zis_soul_key) && var_5) || scripts\engine\utility::istrue(level.placed_alien_fuses) && var_5) {
