...
createmazeonmodel(var_0, var_1, var_2) {
  ...
  foreach(var_13, var_15 in level.maze_attributes) {
    if(var_13 == var_0.mod_name) {
      ...
      level thread store_wall_directions(var_15, level.random_maze_roll[var_13]);
    }
  }
...
input_cursor(var_0, var_1) {
  ...
  for(;;) {
    ...
    if(!scripts\engine\utility::is_true(level.masterpcinteraction.triggeredsuser)) {
      scripts\engine\utility::waitframe();
      continue;
    }

    if(isDefined(level.maze_completed)) {
      if(scripts\engine\utility::is_true(level.maze_completed[var_0.mod_name])) {
        scripts\engine\utility::waitframe();
        continue;
      }
    }

    if(scripts\engine\utility::is_true(level.failed_puzzle)) {
      scripts\engine\utility::waitframe();
      continue;
    }
...
timer_progress(var_0, var_1, var_2, var_3) {
  ...
  while(gettime() <= var_0 + var_4) {
    if(!scripts\engine\utility::flag("completepuzzles_step4")) {
      ...
      if(!scripts\engine\utility::is_true(var_1.stop_triggering_zombies)) {
        break;
      }

      if(isDefined(level.maze_completed)) {
        if(scripts\engine\utility::is_true(level.maze_completed["maze1"]) && scripts\engine\utility::is_true(level.maze_completed["maze2"])) {
          break;
        }
      }
    }
  ...
  if(isDefined(level.trapped_zombie) && level.trapped_zombie scripts\cp\utility::is_zombie_agent()) {
    level.trapped_zombie.ignoreall = 0;
...
update_player_monitor_wires(var_0) {
  ...
  for(;;) {
    ...
    if(!scripts\engine\utility::is_true(level.electric_phantom_completed)) {
      continue;
    }
...
watch_for_input_entered_on_button(var_0) {
  ...
  for(;;) {
    ...
    if(scripts\engine\utility::is_true(level.wire_struct_disabled)) {
...
init_venomx_models_interactions() {
  ...
  level.mission_intel_array = ["i,n,t,e,l,o,n,e.z,o,n,e,o,f,a,c,t,i,o,n.p,o,r,t,a,l.", "i,n,t,e,l,t,w,o.o,n,e,j,o,e.a,t,f,r,o,n,t,l,i,n,e."];
  ...
  level.hidden_figures[0].targetname = "interaction";
  ...
  level.hidden_figures[1].targetname = "interaction";
  ...
  level.hidden_figures[2].targetname = "interaction";
  ...
  level.hidden_figures[3].targetname = "interaction";
...
watch_for_containment_trigger() {
  for(;;) {
    ...
    if(scripts\engine\utility::is_true(self.stop_triggering_zombies)) {
      scripts\engine\utility::waitframe();
      continue;
    }
...
timeperiodinteractionusefunc(var_0, var_1) {
  ...
  if(var_2 == 1950) {
    if(scripts\engine\utility::is_true(var_1.canattempthiddenfigureschallenge)) {
      scripts\cp\cp_interaction::remove_from_current_interaction_list(var_0);
...
dotinteractionusefunc(var_0, var_1) {
  ...
  if(!scripts\engine\utility::is_true(level.completedpap2morsecode)) {
    if(!scripts\engine\utility::is_true(var_0.entered_key)) {
    ...
    var_1 thread clearinputafterwaveend();
  }
}

clearinputafterwaveend() {
  self notify("one_thread_for_" + self.name);
  self endon("one_thread_for_" + self.name);
  level waittill("spawn_wave_done");
  level.inputkeyword = "";
...
venomx_weapon_logic_start(var_0) {
  ...
  } else if(issubstr(var_0.weapon_name, "pap2")) {
...
deal_venomx_projectile_damage(var_0, var_1) {
  ...
  var_2 = scripts\common\trace::create_contents(0, 1, 1, 1, 1, 0, 1);
  var_3 = var_0.angles;
  var_4 = var_0.origin;
  var_5 = 200;
  ...
  var_7 = gettime();
  var_8 = spawn("trigger_radius", var_6, 0, var_5, 64);
  self.basetriggercount++;
  var_8.name = "venomx_triggered_afterT" + self.basetriggercount;
  var_8 thread deal_venomx_damage_to_enemies(self, var_7);
  var_8 thread delete_venomx_trigger_after_time(self, var_7);
}
  ...
  for(;;) {
    foreach(var_3 in level.players) {
      if(var_3 istouching(self)) {
        if(!scripts\engine\utility::is_true(var_3.inside_slow_sphere)) {}
    ...
    foreach(var_7 in level.zombie_list) {
      ...
      if(!scripts\engine\utility::is_true(var_7.entered_playspace)) {
        scripts\engine\utility::waitframe();
        continue;
      }

      if(scripts\engine\utility::is_true(var_7.dot_triggerd)) {
        scripts\engine\utility::waitframe();
        continue;
      }
...
spawn_egg_interaction_for_players(var_0) {
  ...
  var_1.cost = 0;
  var_1.model = spawn("script_model", var_1.origin + (0, 0, 3.5));
  ...
  if(is_this_position_safe(var_0, var_1, var_2, var_3, var_4)) {
    ...
    if(var_1 == level.maze_attributes[var_4.mod_name].endpoint_x && var_2 == level.maze_attributes[var_4.mod_name].endpoint_y) {
      ...
      if(level.puzzles_solved >= 4) {
        ...
        var_4.xcoord = var_1;
        var_4.ycoord = var_2;
        var_7 = return_position_x_y(var_1, var_2, var_4);
        var_4 moveTo(var_7, 0.1);
      ...
      } else if(!scripts\engine\utility::is_true(level.maze_completed[var_4.mod_name])) {
...
solvecipher(var_0, var_1, var_2) {
  ...
  var_1 convertwordintomorse(level.ciphered_word, 0, level.morsecodecomponent);
...
activatefiguredamage(var_0, var_1, var_2) {
  ...
  for(;;) {
    ...
    if(scripts\engine\utility::is_true(var_2.got_hit_by_player)) {
...
showhiddenfigurestoplayer(var_0, var_1, var_2, var_3) {
  ...
  if(!scripts\engine\utility::is_true(var_3.triggeredtimequest)) {
    return;
  }
  var_4 = 2;
  var_5 = 100000;
