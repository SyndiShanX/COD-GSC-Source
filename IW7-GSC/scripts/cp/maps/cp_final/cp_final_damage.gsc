...
cp_final_onzombiedamaged(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_0A, var_0B) {
  ...
  if(var_29 && !var_1D) {
    ...
    if(var_2B) {
      var_2 = var_2 * min(2 + var_0E * 0.5, 10);
    }
...
cp_final_initial_weapon_scale(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_0A, var_0B) {
  if(!scripts\cp\agents\gametype_zombie::can_scale_weapon(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_0A, var_0B)) {
    return var_2;
  }
...
moveghosttowardsplayer(var_0, var_1) {
  ...
  var_0A = scripts\cp\crafted_entangler::getcapsulefrommodel(var_6);
  ...
  for(var_0B = 0; var_1 getcurrentweapon() == "iw7_entangler2_zm"; var_0B++) {
    var_0C = gettime();
    if(var_6.lasteffecttime + 250 <= var_0C) {
      var_6.lasteffecttime = var_0C;
    }

    var_4 = 96;
    var_0D = var_1 getvelocity();
    var_0E = vectordot(var_0D, var_1.angles);
    if(var_0E >= 1) {
    ...
    if(var_10) {
      ...
      var_21 = scripts\common\trace::capsule_trace(var_20, var_1B, var_0A[0], var_0A[1], undefined, var_11, var_8, 1);
    ...
    if(scripts\engine\utility::istrue(var_1.is_off_grid) || scripts\engine\utility::istrue(var_1.isfasttravelling)) {
      ...
      var_1 scripts\engine\utility::waittill_any_timeout_1(var_3, "update_ghost_pos");
    }
...
launchfakeghost(var_0, var_1, var_2, var_3, var_4) {
  ...
  var_0A = rotatepointaroundvector(anglestoup(var_8), anglesToForward(var_8), var_9);
  var_0B = scripts\common\trace::create_contents(1, 1, 1, 1, 0, 0, 0);
  var_0C = scripts\common\trace::capsule_trace(var_5, var_6 + var_0A, 16, 32, undefined, [var_3, var_4], var_0B, 24);
  var_0D = var_0C["shape_position"];
  var_0E = magicbullet("ghost_grenade_launcher", var_4.origin, var_0D, var_3);
  var_4 linkto(var_0E, "tag_origin");
  var_0E.triggerportableradarping = var_3;
  var_0E.team = var_3.team;
  var_0E setscriptablepartstate("animation", "on");
  thread delaykillghost(var_4, var_0E);
}
...
callback_finalzombieplayerdamage(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_0A, var_0B) {
  var_0C = self;
...
slasher_processdamagefeedback(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_0A) {
