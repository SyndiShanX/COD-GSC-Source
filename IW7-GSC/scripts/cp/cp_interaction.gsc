...
func_23CB() {
  ...
  for(;;) {
    ...
    foreach(var_2 in level.players) {
      if(!scripts\engine\utility::istrue(var_2.var_23DE)) {
        var_2.var_23DE = 1;
...
func_BC88(var_0) {
  ...
  var_5 = squared(75);
  for(;;) {
    if(scripts\engine\utility::istrue(var_0.inlaststand) || scripts\engine\utility::istrue(var_0.siege_activated) || scripts\engine\utility::istrue(var_0.flung)) {
      var_1 = undefined;
      ...
      if(scripts\engine\utility::istrue(var_0.resetguidedinteraction)) {
        var_1 = undefined;
        func_12E34(var_0, -1, undefined, undefined);
...
func_9C64(var_0, var_1, var_2) {
  ...
  if(scripts\engine\utility::istrue(var_1.out_of_order) || isDefined(var_1.cooling_down)) {
    return 0;
  }
  ...
  if(scripts\engine\utility::istrue(var_1.requires_power) && !scripts\engine\utility::istrue(var_1.powered_on)) {
    return 0;
  }
...
func_12E34(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(var_3) && interaction_is_sliding_door(var_3) && scripts\engine\utility::istrue(var_3.player_opened)) {
    var_1 = 0;
  }
...
can_use_interaction(var_0) {
  ...
  if(scripts\engine\utility::istrue(var_0.disabled) || !scripts\cp\utility::areinteractionsenabled() || self isinphase()) {
    return 0;
  }
  ...
  if(var_0.script_noteworthy == "ritual_stone" && scripts\engine\utility::istrue(self.rave_mode)) {
    return 0;
  }
  ...
  if(var_1.script_noteworthy == "weapon_purchase" && isDefined(self.weapon_purchase_looking_at)) {
    ...
    if(isDefined(var_2) && !isstring(var_2) && var_2 == &"COOP_INTERACTIONS_PURCHASE_AMMO") {
      ...
      if(var_5 > 1) {
        ...
        self.interaction_trigger sethintstringparams(int(0.5 * level.interactions[var_1.script_noteworthy].cost), var_3);
      }
    }
  } else if(interactionislostandfound(var_1) && scripts\engine\utility::istrue(self.have_things_in_lost_and_found)) {
  ...
  for(;;) {
    ...
    if(scripts\cp\utility::map_check(4)) {
      if(issubstr(var_1.script_noteworthy, "_trap")) {
        var_0 thread scripts\cp\cp_vo::try_to_play_vo("trap_not_avail", "zmb_comment_vo");
      } else {
...
func_4616() {
  ...
  for(;;) {
    ...
    if(scripts\cp\utility::map_check(4)) {
      if(issubstr(var_1.script_noteworthy, "_trap")) {
        var_0 thread scripts\cp\cp_vo::try_to_play_vo("trap_cooldown", "zmb_comment_vo");
      } else {
...
can_purchase_interaction(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(var_1)) {
    var_4 = var_1;
  } else if(interaction_is_sliding_door(var_1)) {
    var_4 = 0;
  } else {
...
player_has_souvenir(var_0, var_1) {
  if(isDefined(var_1.current_crafted_inventory)) {
    return var_1.current_crafted_inventory.randomintrange == var_0.script_noteworthy;
  }
...
interaction_is_valid(var_0, var_1) {
  ...
  if(scripts\engine\utility::istrue(var_0.in_use)) {
    return 0;
  }
...
func_9A3A(var_0) {
  return scripts\engine\utility::istrue(var_0.requires_power) && isDefined(var_0.power_area);
}
