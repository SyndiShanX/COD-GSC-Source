...
func_E4BA() {
  ...
  while(self.var_130D2 > 0) {
    ...
    foreach(var_4 in var_2) {
      ...
      if(var_4.agent_type == "superslasher" || var_4.agent_type == "slasher" || var_4.agent_type == "zombie_sasquatch" || var_4.agent_type == "lumberjack" || scripts\engine\utility::istrue(var_4.is_skeleton)) {
        continue;
      }

      if(!isDefined(var_4) || !isalive(var_4) || !var_4.entered_playspace || scripts\engine\utility::istrue(var_4.marked_for_death) || var_4.agent_type == "zombie_brute" || var_4.agent_type == "zombie_grey" || var_4.agent_type == "zombie_ghost" || var_4.team == "allies") {
        continue;
      }
...
turn_zombie(var_0) {
  ...
  var_1.allowpain = 0;
  var_1 notify("turned");
  if(scripts\engine\utility::istrue(var_1.about_to_dance)) {
