...
func_7859(var_0) {
  var_1 = strtok(var_0.destroynavobstacle, "_");
  if(var_1.size < 2) {
    var_2 = var_1[0];
    ...
    var_2 = var_1.destroynavobstacle;
  }
...
func_79EA() {
  ...
  foreach(var_2 in level.rotateyaw) {
    if(scripts\engine\utility::istrue(var_2.var_19)) {
      var_0[var_0.size] = var_2;
    }
  }
...
func_106D8() {
  ...
  foreach(var_2 in var_0) {
    var_3 = spawn("trigger_radius", var_2.origin, 0, var_2.fgetarg, 96);
    var_3.var_336 = var_2.var_336;
...
func_10927() {
  ...
  while(level.current_enemy_deaths < level.desired_enemy_deaths_this_wave) {
    ...
    if((var_2 && var_5 < 1) || scripts\engine\utility::flag("force_spawn_boss")) {
      ...
      var_0A = get_spawner_and_spawn_goons(var_9);
...
should_spawn_clown() {
  if(isDefined(level.should_spawn_special_zombie_func)) {
    ...
    return scripts\engine\utility::istrue(var_0);
  }
...
spawn_wave_enemy(var_0, var_1, var_2, var_3) {
  ...
  } else if(level.agent_definition[var_1]["species"] == "c6") {
    var_6 = func_33B1(var_1, var_5, var_6, "axis", self);
  } else if(var_1 == "zombie_brute") {
    var_6 = func_13F13("zombie_brute", "axis", var_5, var_6);
    if(isDefined(var_6)) {
      level thread scripts\cp\zombies\zombies_vo::play_zombie_vo(var_6, "spawn", 1);
    }
  } else {
    var_6 = func_13F53(var_1, var_5, var_6, "axis", self);
  }
...
get_spawn_volumes_players_are_in(var_0, var_1) {
  ...
  foreach(var_5 in var_3) {
    ...
    foreach(var_8 in level.players) {
      ...
      if(scripts\engine\utility::istrue(var_0) && var_8 func_9C0F(var_5)) {
        var_6 = 1;
      }
    }
...
get_spawn_volumes_player_is_in(var_0, var_1, var_2) {
  ...
  foreach(var_6 in var_4) {
    ...
    if(var_2 istouching(var_6)) {
      var_7 = 1;
    } else if(scripts\engine\utility::istrue(var_0) && var_2 func_9C0F(var_6)) {
      var_7 = 1;
    }
...
update_volume_adjacency_by_name(var_0, var_1) {
  if(!isDefined(level.var_186E[var_0])) {
    level.var_186E[var_0] = [];
  }

  if(scripts\engine\utility::array_contains(level.var_186E[var_0], var_1)) {
    return;
  }

  level.var_186E[var_0][level.var_186E[var_0].size] = var_1;
  func_12E46(var_0, var_1);
}
        ...
        if(distance2dsquared(var_5.origin, self.origin) < var_1) {
          ...
          if(var_5.last_attack_time + 1000 < var_6) {
            if(isDefined(var_5.var_A9B8)) {
              ...
              if(!scripts\engine\utility::istrue(var_5.bneedtoenterplayspace)) {
                if(!func_CFB2(var_5)) {
                  continue;
                }
...
wave_complete_dialogues(var_0) {
  ...
  if(var_0 >= 6 && var_0 <= 8 && !isDefined(level.completed_dialogues["round_end_6thru8_1"])) {
    if(randomint(100) > 50) {
  ...
  if(var_0 >= 9 && var_0 <= 12 && !isDefined(level.completed_dialogues["round_end_9thru12_1"])) {
    if(randomint(100) > 50) {
  ...
  if(var_0 >= 13 && var_0 <= 16 && !isDefined(level.completed_dialogues["round_end_13thru16_1"])) {
    if(randomint(100) > 50) {
...
func_5773(var_0) {
  ...
  if(!var_2 || !var_4) {
    ...
    if(isDefined(var_0)) {
      var_0B = var_0;
    } else if(isDefined(var_7) && func_CF4C(var_7)) {
      var_0B = 189225;
    } else {
      var_0B = 1000000;
    }
...
animmode(var_0, var_1) {
  ...
  if(scripts\engine\utility::istrue(var_0) && var_6 == 0 && isDefined(var_2.var_186E)) {
...
func_F5EC() {
  ...
  foreach(var_2 in var_0) {
    level.var_B789[var_2.var_336] = var_2;
  }
  ...
  foreach(var_6 in level.spawn_volume_array) {
    ...
    while(isDefined(level.var_B789[var_7])) {
      ...
      if(isDefined(level.var_B789[var_7].target)) {
        var_0A = level.var_B789[var_7].target;
        level.var_B789[var_7].var_186E[var_0A] = level.var_B789[var_0A];
        level.var_B789[var_0A].var_186E[var_7] = level.var_B789[var_7];
      }
...
func_C1EB(var_0, var_1) {
  ...
  if(isDefined(var_3)) {
    ...
    if(scripts\engine\utility::istrue(var_1) && var_5 == 0 && isDefined(var_3.var_186E)) {
...
func_FF55(var_0) {
  ...
  var_1 = isDefined(self.isnodeoccupied) && isDefined(self.isnodeoccupied.is_fast_traveling);
...
add_idle_spot(var_0) {
  var_1 = spawnStruct();
  var_1.origin = var_0;
  var_1.var_336 = "zombie_idle_spot";
  level.var_13F33 = scripts\engine\utility::array_add_safe(level.var_13F33, var_1);
}
...
func_7C18(var_0) {
  ...
  foreach(var_2 in var_1) {
    if(ispointinvolume(self.origin, var_2.volume)) {
      if(isDefined(self.var_92E8) && var_2 == self.var_92E8) {
        continue;
      }
  ...
  foreach(var_2 in var_0) {
    if(isDefined(self.spawner.volume) && self.spawner.volume == var_2.volume) {
      if(isDefined(self.var_92E8) && var_2 == self.var_92E8) {
        continue;
      }
