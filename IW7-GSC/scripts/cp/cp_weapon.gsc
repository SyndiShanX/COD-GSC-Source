...
ben_franklin_harpoon_activate(var_0, var_1, var_2) {
  ...
  playsoundatpos(var_0, "harpoon2_impact");
...
play_stun_fx(var_0, var_1, var_2, var_3, var_4) {
  var_5 = "reload_zap_m";
  playsoundatpos(var_4, "perk_blue_bolts_sparks");
...
zap_over_time(var_0, var_1) {
  ...
  while(var_0 > 0) {
    ...
    wait(0.1);
    self dodamage(1, self.origin, var_1, var_1, "MOD_GRENADE_SPLASH", "iw7_harpoon2_zm_stun");
    var_0 = var_0 - 1;
    wait(1.5);
  }
  ...
  if(isDefined(var_0.origin)) {
    ...
    foreach(var_5 in var_2) {
      ...
      if(distancesquared(var_5.origin, var_1) < var_3) {
        ...
        var_5.full_gib = 1;
        if(isDefined(var_5.agent_type) && var_5.agent_type == "slasher" || var_5.agent_type == "superslasher") {
          var_5 dodamage(var_5.health, var_5.origin, self, self, "MOD_UNKNOWN", "iw7_harpoon4_zm");
        } else {
          var_5 dodamage(var_5.health + 1000, var_5.origin, self, self, "MOD_UNKNOWN", "iw7_harpoon4_zm");
        }
      }
    }
  }
...
fling_zombie_thundergun_harpoon(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(var_2)) {
    ...
    var_1.nocorpse = 1;
    var_1.full_gib = 1;
    self dodamage(self.health + 1000, var_1.origin, var_2, var_2, "MOD_UNKNOWN", "iw7_harpoon4_zm");
    return;
  }

  self.nocorpse = 1;
  self.full_gib = 1;
  self dodamage(self.health + 1000, var_1.origin, var_1, var_1, "MOD_UNKNOWN", "iw7_harpoon4_zm");
}
      ...
      if(isDefined(var_1)) {
        if(distance2dsquared(var_1.origin, var_9.origin) < 16384) {
          if(isDefined(var_9.agent_type) && var_9.agent_type == "slasher" || var_9.agent_type == "superslasher") {
            var_9 dodamage(var_9.health, var_9.origin, self, self, "MOD_UNKNOWN", "iw7_harpoon4_zm");
          } else {
...
alt_acid_rain_dud_explode(var_0) {
  self endon("disconnect");
  self endon("death");
  var_1 = scripts\common\trace::create_contents(0, 1, 1, 1, 1, 0, 1);
  var_2 = var_0.angles;
  var_3 = var_0.origin;
  var_0 waittill("death");
  if(!isDefined(var_0.origin)) {
  ...
  while(gettime() <= var_1 + 3400) {
    ...
    if(isDefined(var_0)) {
      if(var_2.agent_type == "slasher" || var_2.agent_type == "superslasher") {
        var_2 dodamage(0.1 * var_2.maxhealth, var_2.origin, var_0, var_0, "MOD_RIFLE_BULLET", "iw7_harpoon1_zm");
      } else {
        playFX(level._effect["acid_rain"], var_2.origin);
        var_2 dodamage(var_2.maxhealth, var_2.origin, var_0, var_0, "MOD_RIFLE_BULLET", "iw7_harpoon1_zm");
      }

      continue;
    }

    var_2 dodamage(var_2.maxhealth, var_2.origin, undefined, undefined, "MOD_RIFLE_BULLET", "iw7_harpoon1_zm");
  }
}
...
runharpoontraplogic(var_0, var_1) {
  ...
  playsoundatpos(var_0.origin, "weap_harpoon3_impact");
  wait(0.5);
...
clean_up_trap_ent(var_0, var_1) {
  ...
  triggerfx(var_2);
  playsoundatpos(var_1, "weap_harpoon3_trap_off");
...
connect_to_nearby_harpoon_projectiles(var_0, var_1) {
  var_0 endon("death");
  var_2 = scripts\common\trace::create_world_contents();
  for(;;) {
    var_3 = [];
    ...
    foreach(var_6 in var_4) {
      ...
      var_7 = scripts\common\trace::ray_trace(var_0 gettagorigin("TAG_FX"), var_6 gettagorigin("TAG_FX"), var_0, var_2);
...
play_sfx_on_harpoon_trap(var_0, var_1, var_2) {
  ...
  playsoundatpos(var_7, "weap_harpoon3_trap_on");
...
damage_enemies_in_trigger(var_0, var_1, var_2, var_3) {
  ...
  for(;;) {
    ...
    if(var_4.agent_type == "slasher" || var_4.agent_type == "superslasher") {
      if(scripts\engine\utility::istrue(var_4.got_hit_once)) {
        continue;
      } else {
...
run_harpoon_laser_death(var_0, var_1) {
  ...
  if(isDefined(var_1)) {
    var_0 dodamage(var_0.health, var_0.origin, var_1, var_1, "MOD_UNKNOWN", "iw7_harpoon3_zm");
    return;
  }

  var_0 dodamage(var_0.health, var_0.origin, undefined, undefined, "MOD_UNKNOWN", "iw7_harpoon3_zm");
}
...
clean_up_links(var_0, var_1) {
  ...
  foreach(var_3 in var_0.linked_to_targets) {
    if(isDefined(var_0.linked_fx[var_3.var_64])) {
      var_0.linked_fx[var_3.var_64] = undefined;
    }
...
monitorlauncherspawnedgrenades() {
  ...
  for(;;) {
    ...
    if(isDefined(var_0.weapon_name)) {
      ...
      if(issubstr(var_0.weapon_name, "iw7_venomx_zm")) {
...
begingrenadetracking() {
  ...
  switch (var_1.weapon_name) {
    ...
    case "splash_grenade_mp":
      var_1 thread grenade_earthquake();
      thread scripts\cp\cp_spawn_plasma_projectile::splashgrenadeused(var_1);
      break;
...
isinvalidzone(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  if(isDefined(var_5)) {
    ...
    if(isDefined(var_5.var_336) && var_5.var_336 == "beginning_area_balloons") {
      return 0;
    }
  }
  ...
  if(scripts\engine\utility::istrue(var_4) && !ispointonnavmesh(var_0)) {
    return 0;
  }
...
deal_damage(var_0, var_1) {
  ...
  playsoundatpos(var_2, "gib_fullbody");
  var_1 earthquakeforplayer(0.5, 1.5, var_2, 120);
  scripts\engine\utility::waitframe();
  if(isDefined(var_0)) {
    var_0 dodamage(var_0.health + 100000, var_0.origin, var_1, var_1, "MOD_EXPLOSIVE", "heart_cp");
  }
}
...
watchsmokeexplode() {
  ...
  var_4.var_33F = 10000;
  var_4 give_zombies_perk("players");
...
waitsmoketime(var_0, var_1, var_2, var_3) {
  ...
  foreach(var_5 in level.players) {
    if(isDefined(var_5)) {
      ...
      var_5 give_zombies_perk("players");
    }
  }
        ...
        foreach(var_2 in var_3) {
          if(issubstr(var_2, var_5)) {
            if(scripts\cp\utility::isaltmodeweapon(var_2)) {
              ...
              if(isDefined(level.mode_weapons_allowed) && scripts\engine\utility::array_contains(level.mode_weapons_allowed, var_9)) {
                var_5 = "alt_" + var_5;
                break;
              }
            }
...
getarkattachmentlist() {
  var_0 = [];
  var_1 = 0;
  var_2 = tablelookup("cp\zombies\zombie_attachmenttable.csv", 0, var_1, 5);
  while(var_2 != "") {
...
buildattachmentmaps() {
  ...
  foreach(var_24, var_3 in var_0) {
    ...
    foreach(var_0B in var_1) {
      ...
      foreach(var_19 in var_4) {
        var_1A = tablelookup(var_3, 4, var_19, 12);
        if(var_1A == "") {
          continue;
        }
...
return_weapon_name_with_like_attachments(var_0, var_1, var_2, var_3, var_4) {
  ...
  var_19 = [];
  var_1A = 15;
  var_1B = scripts\cp\utility::coop_getweaponclass(var_6);
  if(scripts\cp\utility::weaponhasattachment(var_5, "xmags")) {
    var_9 = 1;
  }

  var_1C = get_possible_attachments_by_weaponclass(var_1B, var_6, var_1);
  if(!var_1C && isDefined(var_1)) {
    if(!scripts\engine\utility::istrue(var_3)) {
  ...
  if(scripts\cp\utility::has_zombie_perk("perk_machine_rat_a_tat")) {
    if(get_possible_attachments_by_weaponclass(var_1B, var_6, "doubletap")) {
  ...
  if(isDefined(var_1)) {
    if(weaponclass(var_0) == "spread") {
      if(issubstr(var_1, "arkyellow")) {
        foreach(var_1E in var_2) {
          if(issubstr(var_1E, "smart")) {
            var_2 = scripts\engine\utility::array_remove(var_2, var_1E);
          }
        }
      }
    }
  ...
  if(var_2.size > 0 && var_2.size <= var_1A) {
    foreach(var_21 in var_2) {
      ...
      if(is_default_attachment(var_21, scripts\cp\utility::getweaponrootname(var_6))) {
  ...
  if(isDefined(var_1)) {
    var_23 = scripts\cp\utility::attachmentmap_tobase(var_1);
    ...
    var_26 = scripts\cp\utility::getattachmenttype(var_1);
...
can_upgrade(var_0, var_1) {
  ...
  if(var_2 == "dischord" || var_2 == "facemelter" || var_2 == "headcutter" || var_2 == "shredder") {
    if(scripts\cp\zombies\directors_cut::directors_cut_is_activated()) {
      if(isDefined(self.pap[var_2]) && self.pap[var_2].lvl == 2) {
        return 0;
      } else {
        return 1;
      }
...
watchweaponfired() {
  ...
  for(;;) {
    ...
    if(scripts\cp\utility::is_melee_weapon(var_0) || issubstr(var_0, "fists") || issubstr(var_0, "heart") || issubstr(var_0, "dagger")) {
      continue;
    }
