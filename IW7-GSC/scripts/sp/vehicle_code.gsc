...
func_1323A() {
  ...
  for(;;) {
    ...
    var_0.spawner = self;
    var_0 thread lib_0B77::func_E81A();
  }
}
...
func_1063F(var_0) {
  ...
  foreach(var_4 in var_0) {
    ...
    if(isDefined(var_4.var_ED6E)) {
      ...
      var_7 scripts\sp\drone_base::func_5C21();
    ...
    } else if(isDefined(var_4.var_9F) && var_4.var_9F == "script_vehicle") {
      var_6 = 1;
...
func_131F6(var_0) {
  ...
  if(var_0.var_380 == "empty" || var_0.var_380 == "empty_heli") {
  ...
  var_0 func_13203();
  var_0 func_1322F();
  if(!isDefined(level.var_13261[var_0.var_380][var_0.classname])) {}

  var_0 thread[[level.var_13261[var_0.var_380][var_0.classname]]]();
  ...
  if(isDefined(var_0.var_ED48)) {
    var_0 thread lib_0B77::func_131C1();
  }
  ...
  if(var_0 _meth_83E2()) {
    var_0.var_378 = "constrained";
    if(isDefined(var_0.var_EE7C)) {
      var_0.var_378 = var_0.var_EE7C;
    }
  }
...
func_A5CB(var_0) {
  ...
  if(isDefined(self.var_4E38)) {
    ...
    var_1 = level.vehicle.var_116CE.var_4E1C[var_1].var_B48B;
  }

  if(isDefined(self.var_4E39)) {
    var_2 = self.var_4E39;
  } else {
    var_2 = level.vehicle.var_116CE.var_4E1C[var_1].var_B758;
  }
...
func_131FA() {
  ...
  for(;;) {
    ...
    if(isDefined(level.vehicle.var_116CE.var_4E02[self.classname])) {
      earthquake(level.vehicle.var_116CE.var_4E02[self.classname].var_EB9C, level.vehicle.var_116CE.var_4E02[self.classname].var_5F36, var_9, level.vehicle.var_116CE.var_4E02[self.classname].fgetarg);
    }
...
func_13200(var_0, var_1) {
  ...
  foreach(var_4 in var_2) {
    self give_attacker_kill_rewards(var_4.setglaregrimematerial, 1, 0.2, 1);
  }
  ...
  foreach(var_4 in var_2) {
    self clearanim(var_4.setglaregrimematerial, 0);
...
func_A5E1(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(var_1.effect)) {
    if(var_1.var_2A4E && !isDefined(self.delete_on_death)) {
      if(isDefined(var_1.physics_setgravitydynentscalar)) {
        if(isDefined(var_1.var_10E6A) && var_1.var_10E6A == 1) {
          thread func_B03F(var_1.effect, var_1.delay, var_1.physics_setgravitydynentscalar);
        } else {
          thread func_D4C4(var_1.effect, var_1.delay, var_1.physics_setgravitydynentscalar);
        }
      } else {
        var_4 = self.origin + (0, 0, 100) - self.origin;
        playFX(var_1.effect, self.origin, var_4);
      }
    } else if(isDefined(var_1.physics_setgravitydynentscalar)) {
      var_4 = func_12FC(var_3, var_1.var_24DF);
      if(isDefined(var_4)) {
        var_5 = func_4E49();
        playFX(var_1.effect, var_5 gettagorigin(var_1.physics_setgravitydynentscalar), var_4);
        if(isDefined(var_1.var_DFEC)) {
          var_5 scripts\engine\utility::delaycall(var_1.var_DFEC, ::delete);
        }
      } else {
        playFXOnTag(var_1.effect, func_4E49(), var_1.physics_setgravitydynentscalar);
        if(isDefined(var_1.var_DFEC)) {
          func_4E49() scripts\engine\utility::delaycall(var_1.var_DFEC, ::delete);
        }
      }
    } else {
      var_4 = func_12FC(var_4, var_2.var_24DF);
      if(isDefined(var_4)) {
        playFX(var_1.effect, self.origin, var_4);
      } else {
        var_4 = self.origin + (0, 0, 100) - self.origin;
...
func_A5BF(var_0) {
  ...
  badplace_cylinder("vehicle_kill_badplace", var_1.var_5F36, self.origin, var_1.fgetarg, var_1.height, var_1.var_115A4, var_1.var_115A5);
}
...
func_12B8(var_0, var_1) {
  ...
  foreach(var_6 in var_4) {
    if(var_3 && var_6.var_9F != "script_vehicle") {
      continue;
    }
...
func_B6B7() {
  ...
  foreach(var_8, var_6 in var_2) {
    ...
    if(isDefined(var_6.setthreatbiasagainstall)) {
      var_7.setthreatbiasagainstall = var_6.setthreatbiasagainstall;
    }
...
func_13203() {
  ...
  if(level.vehicle.var_116CE.var_AC4A[var_0] == -1) {
    return;
  }

  if(isDefined(level.vehicle.var_116CE.var_AC4D[var_0]) && isDefined(level.vehicle.var_116CE.var_AC4C[var_0])) {
...
func_7B21(var_0) {
  ...
  return self getscoreinfocategory(var_0) / getanimlength(var_0);
}
...
func_1322A() {
  ...
  for(;;) {
    ...
    if(isDefined(self.var_380)) {
      var_5 = self.var_380 + "_rumble_sfx";
...
func_24DE(var_0) {
  ...
  if(isai(var_0) && var_0.team == self.script_team) {
    return 1;
  }
...
func_7D47() {
  ...
  if(isDefined(self.target)) {
    ...
    foreach(var_3 in var_1) {
      if(!issubstr(var_3.var_9F, "actor") && !issubstr(var_3.var_9F, "vehicle")) {
        continue;
      }

      if(issubstr(var_3.var_9F, "actor")) {
        if(!isspawner(var_3)) {
          continue;
        } else if(issubstr(var_3.var_9F, "vehicle")) {
          if(!var_3.spawnimpulsefield & 2) {
            continue;
          }
        }
      }
...
func_D808() {
  ...
  foreach(var_4 in var_1) {
    var_4.var_380 = tolower(var_4.var_380);
    if(var_4.var_380 == "empty" || var_4.var_380 == "empty_heli") {
      continue;
    }
    ...
    if(!isDefined(level.var_13261[var_4.var_380])) {
      level.var_13261[var_4.var_380] = [];
    }
...
func_D812(var_0, var_1) {
  if(isDefined(level.var_13261[var_1.var_380][var_1.classname])) {
    return;
  }
...
func_10810(var_0) {
  ...
  foreach(var_5 in var_2) {
    if(!isDefined(var_5.var_9F) || var_5.var_9F != "script_vehicle") {
      continue;
    }
...
func_A5CC(var_0) {
  ...
  if(isarray(level.vehicle.var_116CE.var_4DF9[var_0])) {
    if(isDefined(self.var_D832)) {
      ...
      var_1 = scripts\engine\utility::random(level.vehicle.var_116CE.var_4DF9[var_1]);
    }

    return func_A5CD(var_1);
  }

  return func_A5CD(level.vehicle.var_116CE.var_4DF9[var_1]);
}
