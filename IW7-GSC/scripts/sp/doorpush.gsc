...
func_5A38() {
  ...
  foreach(var_2 in var_0) {
    ...
    if(isDefined(var_2.var_5A50)) {
      var_2.var_ECCE = lib_0EFB::func_7994("shipcrib_door_screen", "script_noteworthy", var_2.var_5A50);
    }
...
func_48C7() {
  ...
  self.var_5A40 lib_0E46::func_48C4(undefined, undefined, undefined, var_0, var_2, 50, var_1, undefined, undefined, undefined, undefined, undefined, undefined, 1);
  self.var_5A3F lib_0E46::func_48C4(undefined, undefined, undefined, var_0, var_2, 50, var_1, undefined, undefined, undefined, undefined, undefined, undefined, 1);
...
func_11EB(var_0, var_1, var_2, var_3, var_4) {
  ...
  level.player playerlinktoblend(var_5, "tag_player", var_1, 0.2, 0.2);
  if(isDefined(var_2)) {
    self thread[[var_2]]();
  }
