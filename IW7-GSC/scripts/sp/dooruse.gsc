...
func_95B6() {
  ...
  foreach(var_2 in var_0) {
    if(isDefined(var_2.var_336) && isDefined(level.doors[var_2.var_336])) {
    ...
    if(isDefined(var_2.var_336)) {
      level.doors[var_2.var_336] = var_2;
      var_4 = getEntArray(var_2.var_336, "targetname");
...
func_1AD9() {
  ...
  foreach(var_2 in var_0) {
    ...
    var_2.var_ECCE["back"] = [];
    var_3 = getscriptablearray(var_2.var_336, "targetname");
    ...
    if(isDefined(var_2.var_336)) {
      level.var_1AE3[var_2.var_336] = var_2;
    }
  }
...
func_1AA9(var_0, var_1, var_2, var_3, var_4) {
  ...
  foreach(var_14 in var_12) {
    if(var_14 == var_11) {
      foreach(var_16 in var_5.var_ECCE[var_14]) {
...
func_A855() {
  ...
  var_0["player"] lib_0E46::func_48C4("override_box_jt", undefined, undefined, undefined, 5000, undefined, 0);
...
buddy_down_trigger_damage_onflashbang() {
  ...
  lib_0E46::func_48C4(var_0, var_1, undefined, undefined, undefined, undefined, var_2);
  self setusefov(180);
  lib_0E46::func_9016();
...
buddyplayerid() {
  ...
  var_1 = lib_0A1E::func_2356("Knobs", "body");
...
func_21E0() {
  ...
  if(isDefined(var_0)) {
    foreach(var_2 in var_0) {
      if(isDefined(var_2.var_336) && var_2.var_336 == "loot_hint_struct") {
        self.var_9026 = var_2;
      }
    }
  }
...
func_21E9(var_0) {
  ...
  scripts\sp\armoury::func_489F(var_0);
  if(!lib_0A2F::func_D9ED(var_0)) {
    lib_0A2F::func_DA49(var_0, 1);
...
func_9530(var_0) {
  ...
  if(var_1.size > 0) {
    foreach(var_3 in var_1) {
      if(var_3.var_336 == var_0) {
        var_3 thread func_13684(var_3.var_336);
      }
    }
  }
}
...
func_13684(var_0) {
  ...
  var_1 thread scripts\sp\armoury::func_489F(0);
}
...
func_FA17(var_0) {
  ...
  var_4 = 0.4;
  level.player playerlinktoblend(var_1, "tag_player", var_4, 0.15, 0.15);
  wait(var_4);
  var_1 show();
  return var_1;
}
