...
func_734F(var_0) {
  ...
  level.newteamhudelem.var_B37A[level.newteamhudelem.var_B37A.size] = var_1;
  var_1 linkto(var_0, "tag_fx", (0, 0, 0), (0, 0, 0));
  var_2 = func_734E();
  var_0 func_13771(var_1);
  var_3 = isDefined(var_1.isteamradarblocked);
  var_4 = var_1.origin;
  var_1 func_E011();
  if(!var_3) {
    return;
...
func_DFBF() {
  ...
  foreach(var_1 in level.newteamhudelem.var_B37A) {
    var_1 func_E012();
  }
...
getdamageableents(var_0, var_1, var_2, var_3) {
  ...
  for(var_5 = 0; var_5 < level.players.size; var_5++) {
    ...
    if(var_7 < var_1 && !var_2 || func_13C7E(var_0, var_6, var_3, undefined)) {
      ...
      var_8.isplayer = 1;
      var_8.var_9D26 = 0;
      var_8.issplitscreen = level.players[var_5];
...
damageent(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  ...
  self.issplitscreen notify("damage", var_2, var_1);
}
