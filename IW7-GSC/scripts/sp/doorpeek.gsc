...
func_118F() {
  ...
  foreach(var_2 in var_0) {
    if(isDefined(var_2.spawnimpulsefield) && var_2.spawnimpulsefield & 1) {
      ...
      if(var_2.spawnimpulsefield & 4) {
        thread func_59BE(var_2.var_336, 1);
      }
    ...
    if(var_7 == "airlock" || var_7 == "airlockcombat") {
      var_6 scripts\sp\dooruse::func_1AB5(0);
    }
  }
}
...
func_1211(var_0, var_1, var_2, var_3) {
  ...
  if(!var_1) {
    ...
    if(isDefined(var_5.var_EE0E)) {
      var_9 = var_5.var_EE0E * -1;
    }

    level.var_5A23[var_0].var_74C0 = var_9;
  } else {
    var_6 = -1;
    var_7 = func_12A6(var_6, "door_peek_animstruct_b");
    level.var_5A23[var_1].var_5A26 = var_6 scripts\engine\utility::spawn_tag_origin();
    level.var_5A23[var_1].var_5A26.angles = level.var_5A23[var_1].var_5A26.angles + (0, 180, 0);
    level.var_5A23[var_1].var_5A00 = var_9 scripts\engine\utility::spawn_tag_origin();
    level.var_5A23[var_1].var_5A00 linkto(level.var_5A23[var_1].var_5978);
    level.var_5A23[var_1].var_5A58 = distance2d(level.var_5A23[var_1].var_5A26.origin, level.var_5A23[var_1].var_5A00.origin);
    var_0A = func_12A6(var_5, "door_kick_animstruct_b");
    level.var_5A23[var_0].var_A5AA = var_0A scripts\engine\utility::spawn_tag_origin();
  ...
  if(!var_1) {
    var_0B = func_12A6(var_4, "door_kick_interact");
    level.var_5A23[var_0].var_4C26 = spawn("script_origin", var_0B.origin);
    level.var_5A23[var_0].var_4C26.origin = var_0B.origin;
    level.var_5A23[var_0].var_4C26.angles = var_0B.angles;
    level.var_5A23[var_0].var_4C26 linkto(level.var_5A23[var_0].var_5978);
  } else {
    var_0B = func_12A6(var_5, "door_kick_interact_b");
    level.var_5A23[var_0].var_4C27 = spawn("script_origin", var_0B.origin);
    level.var_5A23[var_0].var_4C27.origin = var_0B.origin;
    level.var_5A23[var_0].var_4C27.angles = var_0B.angles;
  ...
  if(var_1) {
    ...
    var_0C = level.var_5A23[var_0].var_C9FF.var_11782;
    level.var_5A23[var_0].var_5A2A.origin = level.var_5A23[var_0].var_5A2A.origin + var_0C * anglesToForward(level.var_5A23[var_0].var_5A26.angles);
    level.var_5A23[var_0].var_5978 linkto(level.var_5A23[var_0].var_5A2A);
  }
...
func_11F8(var_0, var_1) {
  ...
  if(!var_1) {
    ...
    var_2 = level.var_5A23[var_1].var_4C27;
  }

  var_2.ogorigin = var_2.origin;
  var_2 lib_0E46::func_48C4(undefined, (0, 0, 0), &"SCRIPT_DOORPEEK_OPEN", undefined, 512);
...
func_1202(var_0, var_1) {
  if(!var_1) {
    ...
    var_2 = level.var_5A23[var_4].var_C9FF;
    var_3 = "ges_doorpeek_" + func_1297(level.var_5A23[var_3].var_5A57) + "_r";
    var_4 = level.var_5A23[var_2].var_5A00;
    var_5 = "doorpeek_" + func_1297(level.var_5A23[var_1].var_5A57) + "_r_in";
  }
  ...
  if(!scripts\engine\utility::flag(var_0 + "door_peek_handle_down")) {
    ...
    var_0B = var_4.origin - var_9;
    var_0C = level.player.origin - var_9;
    var_0D = var_0A - var_4.angles + (0, 180, 0);
    var_0E = var_4.origin;
    var_0F = var_4.angles;
    var_4 unlink();
    var_4.origin = var_4.origin + var_0C;
    var_10 = vectornormalize(var_4.origin - level.player.origin);
    var_11 = distance(var_4.origin, level.player.origin);
    var_10 = rotatevector(var_10, var_0D);
    var_4.origin = level.player.origin + var_10 * var_11;
    var_4.angles = var_4.angles + var_0D;
    var_12 = 0.6 - var_7;
    var_13 = distance(level.player.origin, var_9);
    var_14 = 20;
    var_15 = 40;
    var_16 = 0;
    if(var_13 > var_14) {
    ...
    level.player playerlinktoblend(level.var_5A23[var_0].var_C9FD, "tag_player", 0.2, 0, 0);
    wait(0.05);
    level.var_5A23[var_0].var_C9FD linkto(var_4);
    var_4 moveto(var_0E, var_1C);
    var_4 rotateto(var_0F, var_1C);
    level thread scripts\sp\utility::func_C12D(var_0 + "door_peek_blend_complete", var_1C + 0.1);
    level thread scripts\sp\utility::func_C12D("door_peek_blend_complete", var_1C + 0.1);
    var_4 scripts\engine\utility::delaycall(var_1C + 0.05, ::linkto, level.var_5A23[var_0].var_5978);
    if(var_1B > 0) {
      wait(var_1B);
    }
  ...
  if(!var_1) {
    level.player playerlinktodelta(level.var_5A23[var_0].var_C9FD, "tag_player", 1, var_2.setdevdvarifuninitialized, var_2.var_B7C1, 80, 20, 0);
  } else {
    level.player playerlinktodelta(level.var_5A23[var_0].var_C9FD, "tag_player", 1, var_2.var_B7C9, var_2.setmatchdataid, 80, 20, 0);
  }

  if((!isDefined(level.var_5A23[var_0].var_A5AB) || level.var_5A23[var_0].var_A5AB == 0) && level.var_5A23[var_0].var_1B12 == 0) {
...
func_1203(var_0, var_1) {
  if(!var_1) {
    ...
    var_2 = level.var_5A23[var_1].var_C9FF;
  }

  level.var_5A23[var_0].var_5A2A ghost_killed_update_func((0, 0 - var_2.var_47A3, 0), var_2.var_47A4, 0, var_2.var_47A4 / 2);
...
func_11F5(var_0, var_1, var_2) {
  ...
  if(!var_1) {
    ...
    var_3 = -1;
    var_4 = level.var_5A23[var_2].var_C9FF;
    var_5 = level.var_5A23[var_1].var_5A26;
  }
  ...
  var_8 = 0;
  var_9 = 1;
  var_0A = level.var_5A23[var_0].var_5A2A.angles;
  var_0B = 0;
  var_0C = 0;
  var_0D = 0;
  var_0E = 80;
  ...
  for(;;) {
    if(!var_1 && level.var_5A23[var_0].var_5A21 >= var_0E && !level.var_5A23[var_0].var_C9D4) {
      break;
    } else if(var_1 && level.var_5A23[var_0].var_5A21 <= 0 - var_0E && !level.var_5A23[var_0].var_C9D4) {
      break;
    }

    var_0C = 0;
    var_0F = func_1296(var_0, var_1);
    if(isDefined(level.var_5A23[var_0].var_72C6) && level.var_5A23[var_0].var_72C6 == 1) {
      var_0F = 1;
    }

    var_10 = var_0F * 1.2 * var_3;
    if(var_8 == 1 && var_0F == 1) {
      var_10 = var_10 * 1.01 * scripts\sp\utility::func_E753(var_9, 0, 1);
      var_9 = var_9 + 0.5;
    } else {
      var_9 = 1;
    }

    var_10 = clamp(var_10, 0 - var_4.var_B4B9, var_4.var_B4B9);
    if(!level.var_5A23[var_0].var_C9D4) {
      var_11 = 0;
      if(isDefined(level.var_5A23[var_0].var_B7C6)) {
        var_11 = level.var_5A23[var_0].var_B7C6 - var_6;
      }

      if(!var_1) {
        level.var_5A23[var_0].var_5A21 = max(level.var_5A23[var_0].var_5A21 + var_10, var_11);
      } else {
        level.var_5A23[var_0].var_5A21 = min(level.var_5A23[var_0].var_5A21 + var_10, 0 - var_11);
      }

      level.var_5A23[var_0].var_5A21 = scripts\sp\utility::func_E753(level.var_5A23[var_0].var_5A21, 1);
      if(isDefined(var_2)) {
        level.var_5A23[var_0].var_5A21 = min(level.var_5A23[var_0].var_5A21 + var_10, var_2);
      }
    }
    ...
    if(level.var_5A23[var_0].var_5A21 != var_7) {
      ...
      level.var_5A23[var_0].var_5A2A rotateto(var_0A + (0, 0 - level.var_5A23[var_0].var_5A21, 0), 0.1, 0, 0);
      if(!var_1) {
        var_12 = clamp(level.var_5A23[var_0].var_5A21 / var_4.var_B481, 0, 1) * var_4.var_B4AA - var_4.var_B7C1 + var_4.var_B7C1;
        level.player playerlinktodelta(level.var_5A23[var_0].var_C9FD, "tag_player", 1, var_4.setdevdvarifuninitialized, var_12, 80, 20, 0);
      } else {
        var_13 = clamp(-1 * level.var_5A23[var_0].var_5A21 / var_4.var_B481, 0, 1) * var_4.var_B4C1 - var_4.var_B7C9 + var_4.var_B7C9;
        level.player playerlinktodelta(level.var_5A23[var_0].var_C9FD, "tag_player", 1, var_13, var_4.setmatchdataid, 80, 20, 0);
      }
      ...
      if(level.var_5A23[var_0].var_5A57 == "airlock" && var_0D == 0 && level.var_5A23[var_0].var_5A21 >= 64) {
        var_0D = 1;
...
func_1210(var_0, var_1) {
  ...
  if(!var_1) {
    ...
    var_2 = level.var_5A23[var_1].var_74C1;
  }

  var_3 = 0.15;
  level.var_5A23[var_0].var_5A2A rotateto(level.var_5A23[var_0].var_5A24 + (0, var_2, 0), var_3, 0, 0);
...
func_11F7(var_0, var_1, var_2, var_3) {
  level.player endon("death");
  level endon(var_0.var_336 + "door_peek_start");
  if(!isDefined(var_3)) {
    var_3 = 0;
  }

  if(!var_1) {
    var_4 = level.var_5A23[var_0.var_336].var_5A25;
  } else {
    var_4 = level.var_5A23[var_1.var_336].var_5A26;
  }
  ...
  var_9 = self.ogorigin + var_7 * level.var_5A23[var_0.var_336].var_5A58 * 0.5;
  self unlink();
  for(;;) {
    wait(0.05);
    var_0A = distance2d(level.player.origin, var_9);
    ...
    if(var_0B > 0) {
      ...
      if(vectordot(var_0E, var_6) < 0) {
        continue;
      }

      var_0F = scripts\sp\math::func_ACE9(var_0C, var_0C + var_0E * 64, self.ogorigin, var_6);
      ...
      var_11 = vectorcross(var_6, var_10);
      var_12 = 0;
      if(!var_1 && vectordot(var_11, var_8) > 0 && !var_3) {
        var_12 = 1;
      } else if(var_1 && vectordot(var_11, var_8) < 0 && !var_3) {
        var_12 = 1;
      }

      if(var_12) {
        var_13 = vectordot(var_10, var_8);
        var_14 = distance(var_0F, self.ogorigin) * var_13;
        var_0F = self.ogorigin + var_8 * var_14;
      }
...
func_C9E8(var_0, var_1, var_2) {
  ...
  if(!var_1) {
    ...
    var_3 = level.var_5A23[var_2].var_5A00;
    var_4 = "doorpeek_" + func_1297(level.var_5A23[var_1].var_5A57) + "_r_backon";
  }
...
func_120B(var_0, var_1, var_2) {
  ...
  for(;;) {
    ...
    if(!var_7 && isDefined(var_6)) {
      var_8 = 1;
      if(!var_1 && var_6 && !isDefined(level.var_5A23[var_0.var_336].var_C9FF)) {
        wait(0.05);
        continue;
      }
      ...
      if(!var_6) {
        var_10 = anglesToForward(level.var_5A23[var_0.var_336].var_5A25.angles);
        if(acos(clamp(vectordot(var_10, var_0F), -1, 1)) > var_9) {
          var_8 = 0;
        }
      } else {
        var_10 = anglesToForward(level.var_5A23[var_1.var_336].var_5A25.angles + (0, 180, 0));
        if(acos(clamp(vectordot(var_10, var_0F), -1, 1)) > var_9) {
          var_8 = 0;
        }
      }
    ...
    if(var_7 || var_8) {
      ...
      var_11 = 360;
      if(!var_6) {
        var_12 = level.var_5A23[var_0.var_336].var_74C0;
      } else {
        var_12 = level.var_5A23[var_0.var_336].var_74C1;
      }

      var_13 = anglesToForward(level.var_5A23[var_0.var_336].var_5A2A.angles);
      var_14 = anglesToForward(level.var_5A23[var_0.var_336].var_5A24 + (0, var_12, 0));
      var_2 connectpaths();
      var_15 = "ges_doorpeek_bash";
      var_16 = func_12AB(var_0.var_336, var_6);
      if(isDefined(var_16)) {
        var_15 = var_16;
      }
      ...
      level notify(var_0.var_336 + "door_peek_bash_open");
      level notify("door_peek_bash_open");
      if(var_1 != var_6) {
        var_17 = anglesToForward(level.var_5A23[var_0.var_336].var_5A24);
        ...
        level.var_5A23[var_0.var_336].var_5A2A rotateto(level.var_5A23[var_0.var_336].var_5A24, var_1A, 0, 0);
        wait(var_1A);
        level.var_5A23[var_0.var_336].var_5A2A rotateto(level.var_5A23[var_0.var_336].var_5A24 + (0, var_12, 0), var_1B, 0, 0);
        wait(var_1B);
      } else {
        var_1C = acos(clamp(vectordot(var_13, var_14), -1, 1));
        var_1D = var_1C / var_11;
        level.var_5A23[var_0.var_336].var_5A2A rotateto(level.var_5A23[var_0.var_336].var_5A24 + (0, var_12, 0), var_1D, 0, 0);
        wait(var_1D);
      }

      wait(0.05);
      var_2 disconnectpaths();
      level.var_5A23[var_0.var_336].var_5A2A delete();
      level notify(var_0.var_336 + "door_peek_finished");
...
func_11FC(var_0) {
  var_1 = level.var_5A23[var_0.var_336].var_5A25;
  var_2 = anglesToForward(level.var_5A23[var_0.var_336].var_5A2A.angles);
  var_3 = -1 * anglestoright(level.var_5A23[var_0.var_336].var_5A2A.angles);
  var_4 = level.player.origin - var_1.origin;
  var_5 = vectornormalize(var_4);
  var_6 = level.var_5A23[var_0.var_336].var_5A58 + 8;
  var_7 = 48;
  ...
  if(!var_8) {
    ...
    var_0A = abs(length(var_4) * var_9);
    if(var_0A > var_6) {
      return undefined;
    }

    var_0B = -1 * var_2;
    var_9 = vectordot(var_5, var_0B);
    var_0A = abs(length(var_4) * var_9);
    if(var_0A > var_7) {
      return undefined;
    }
    ...
    var_0A = abs(length(var_5) * var_0A);
    if(var_0A > var_6) {
      return undefined;
    }
...
func_12F4(var_0) {
  ...
  foreach(var_9 in var_2) {
    ...
    var_0A = distance(level.player.origin, level.var_5A23[var_9].var_5A25.origin);
    if(!isDefined(var_6) || var_0A < var_6) {
      var_6 = var_0A;
      var_7 = var_9;
    }
  }
...
func_11FD(var_0) {
  ...
  var_7 = anglesToForward(level.var_5A23[var_0.var_336].var_5A25.angles);
  var_8 = -1 * anglestoright(level.var_5A23[var_0.var_336].var_5A25.angles);
  var_9 = level.var_5A23[var_0.var_336].var_5A25.origin + var_7 * var_6.var_11782 * -0.5;
  var_0A = level.player.origin - var_9;
  var_0B = vectornormalize(var_0A);
  var_0C = level.var_5A23[var_5].var_5A58 + 8;
  var_0D = 48;
  if(distance(level.player.origin, var_9) > var_0C + var_0D) {
    return undefined;
  }

  if(vectordot(var_0A, var_7) < 0) {
    var_0E = 0;
  } else {
    var_0E = 1;
  }
...
func_11F9(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  if(!var_3) {
    ...
    level.player playerlinktodelta(var_8, "tag_origin", 1, 90, 90, 90, 90, 0);
  }
  ...
  if(!var_3) {
    if(scripts\engine\utility::flag("doorpeek_hand_on_door")) {
      ...
      if(!var_2) {
        ...
        var_0C thread scripts\sp\anim::func_1F35(var_0C, "doorpeek_" + func_1297(var_6) + "_r_out");
      }

      var_0C scripts\engine\utility::delaycall(0.2, ::delete);
    }

    var_10 = func_12A1(var_0, var_2);
    var_11 = 0.2;
    var_8 moveto(var_10, var_11, var_11 / 2, 0);
...
func_12A1(var_0, var_1) {
  ...
  if(!var_1) {
    ...
    var_6 = anglesToForward(level.var_5A23[var_0].var_59FF.angles) * -1;
    ...
    var_0A = level.var_5A23[var_0].var_5A25.origin + var_9;
    var_0B = anglestoright(level.var_5A23[var_0].var_5A25.angles);
    var_0C = anglestoright(level.var_5A23[var_0].var_59FF.angles) * -1;
  } else {
    var_0D = -1;
    var_5 = anglesToForward(level.var_5A23[var_0].var_5A26.angles);
    var_6 = anglesToForward(level.var_5A23[var_0].var_5A00.angles) * -1;
    var_7 = func_794C(var_0) * -1;
    var_8 = level.var_5A23[var_0].var_5A00.origin - level.var_5A23[var_0].var_5A26.origin;
    var_9 = rotatevector(var_8, (0, var_7, 0));
    var_0A = level.var_5A23[var_0].var_5A26.origin + var_9;
    var_0B = anglestoright(level.var_5A23[var_0].var_5A26.angles) * -1;
    var_0C = anglestoright(level.var_5A23[var_0].var_5A00.angles) * -1;
  }

  var_0E = 0.2;
  var_0F = level.player.origin + var_6 * var_3 * -1;
  ...
  var_16 = max(level.var_5A23[var_0].var_5A25.origin[2], var_15["position"][2]);
...
func_1209(var_0, var_1, var_2, var_3) {
  ...
  level waittill(var_0 + "door_peek_start_peek_control");
  for(;;) {
    if(!var_2 && level.var_5A23[var_0].var_5A21 >= 28) {
      break;
    } else if(var_2 && level.var_5A23[var_0].var_5A21 <= -28) {
      break;
    }
  ...
  for(;;) {
    ...
    var_0F = anglesToForward(var_0E);
    if(!var_2) {
      var_10 = anglesToForward(level.var_5A23[var_0].var_59FF.angles + (0, 180, 0));
    } else {
      var_10 = anglesToForward(level.var_5A23[var_0].var_5A00.angles + (0, 180, 0));
    }
...
func_1296(var_0, var_1) {
  ...
  if(!var_1) {
    ...
    var_5 = anglesToForward(level.var_5A23[var_0].var_59FF.angles) * -1;
  } else {
    var_4 = anglesToForward(level.var_5A23[var_2].var_5A26.angles);
    var_5 = anglesToForward(level.var_5A23[var_1].var_5A00.angles) * -1;
  }
  ...
  var_0A = combineangles(var_9, var_8);
  ...
  var_0F = min(1, sqrt(squared(var_2[0]) + squared(var_2[1])));
  if(var_0F <= 0.1) {
    return 0;
  }
  ...
  var_10 = acos(clamp(vectordot(var_0B, var_4), -1, 1));
  var_11 = acos(clamp(vectordot(var_0B, var_0D), -1, 1));
  var_12 = acos(clamp(vectordot(var_0B, var_5), -1, 1));
  var_13 = func_54E3(var_0B, var_5, var_0D);
  var_14 = 0.25;
  var_15 = 20;
  var_16 = 90;
...
func_59BE(var_0, var_1, var_2, var_3) {
  ...
  if(var_6 == "airlock" || var_6 == "airlockcombat") {
    var_5 scripts\sp\dooruse::func_1AB6("unlocked");
  }
...
func_1414(var_0) {
  level scripts\engine\utility::waittill_any_3(var_0 + "door_peek_start_detach", var_0 + "remove_hint_text");
...
func_11EC(var_0) {
  ...
  var_0A = 90;
  var_0B = level.var_5A23[var_0].var_C9FE;
  var_0C = 120;
  var_0D = level.var_5A23[var_0].var_5A24 + (0, 0 - var_0B.var_47A3, 0);
  ...
  var_14 = level.var_5A23[var_0].var_5A21;
  var_15 = var_14 + var_11;
  var_15 = clamp(var_15, 0, var_12);
  var_16 = var_0D + (0, 0 - var_15, 0);
  level.var_5A23[var_0].var_5A2A rotateto(var_16, var_0F, 0, 0.2);
  ...
  var_18 rotateto((var_18.angles[0], var_5.angles[1], var_18.angles[2]), 0.5, 0, 0.2);
  wait(var_13);
  func_11EE();
...
func_11ED(var_0) {
  ...
  level.var_5A23[var_0].var_5A2A rotateto(var_1A, var_18, var_18 * 0.4, 0);
  ...
  wait(var_18);
  level.var_5A23[var_0].var_5A21 = var_16;
  level.var_5A23[var_0].var_C9D4 = 0;
  level notify(var_0 + "door_kick_finished");
...
func_1351(var_0) {
  ...
  for(;;) {
    ...
    var_5 = clamp(var_4 / var_1.var_B481, 0, 1) * var_1.var_B4AA - var_1.var_B7C1 + var_1.var_B7C1;
    level.player lerpviewangleclamp(0, 0, 0, var_1.setdevdvarifuninitialized, var_5, 20, 20);
    if(var_4 >= var_3) {
      var_6 = 1;
      level notify(var_0 + "door_peek_airlock_ally_move");
      level notify("door_peek_airlock_ally_move");
...
func_11F0(var_0, var_1, var_2) {
  ...
  if(!var_1) {
    ...
    var_7 = level.var_5A23[var_1].var_A5AA;
  }
  ...
  level.player.dontmelee = 1;
  if(!var_1) {
    var_8 = level.var_5A23[var_4.var_336].var_74C0;
  } else {
    var_8 = level.var_5A23[var_5.var_336].var_74C1;
  }
  ...
  var_0F = level.var_5A23[var_0].var_5A21;
  var_10 = var_0F - abs(var_8) * -1 / var_8;
  var_11 = clamp(var_10 * var_0A, var_0D, var_0A);
  var_12 = var_11 / var_0A;
  var_13 = var_0B * var_12;
  var_14 = var_0C * var_12;
  level.var_5A23[var_0].var_5A2A scripts\engine\utility::delaycall(var_9, ::rotateto, level.var_5A23[var_0].var_5A24 + (0, var_8, 0), var_11, var_13, var_14);
  level.var_5A23[var_0].var_5A2A scripts\engine\utility::delaycall(var_9 + var_11 + 0.05, ::delete);
  ...
  var_7 thread scripts\sp\anim::func_1EC3(level.var_5A23[var_4.var_336].var_A5AE, var_15);
  var_1A = level.var_5A23[var_4.var_336].var_A5AE gettagorigin("tag_player");
  var_1B = var_7.origin - var_1A;
  var_1C = level.player.origin - var_1A;
  var_1D = var_18 - var_7.angles;
  var_1E = var_7.origin;
  var_1F = var_7.angles;
  var_7 unlink();
  var_7.origin = var_7.origin + var_1C;
  var_20 = vectornormalize(var_7.origin - level.player.origin);
  var_21 = distance(var_7.origin, level.player.origin);
  var_20 = rotatevector(var_20, var_1D);
  var_7.origin = level.player.origin + var_20 * var_21;
  var_7.angles = var_7.angles + var_1D;
  level.player playgestureviewmodel(var_16, undefined, 1, 0.2);
  var_7 thread scripts\sp\anim::func_1F35(level.var_5A23[var_4.var_336].var_A5AE, var_15);
  var_22 = getanimlength(level.var_5A23[var_4.var_336].var_A5AE scripts\sp\utility::func_7DC1(var_15));
  var_23 = 0.4;
  var_24 = 1.1;
  var_25 = 0.3;
  var_26 = 0.35;
  ...
  level.player playerlinktoblend(level.var_5A23[var_4.var_336].var_A5AE, "tag_player", var_25, 0, 0);
  level.player scripts\engine\utility::delaycall(var_25, ::playerlinktodelta, level.var_5A23[var_4.var_336].var_A5AE, "tag_player", 1, 0, 0, 0, 0, 0);
  level.player scripts\engine\utility::delaycall(var_26, ::lerpviewangleclamp, var_27, 0, 0, 40, 40, 60, 10);
  wait(0.05);
  level.var_5A23[var_4.var_336].var_A5AE linkto(var_7);
  var_7 moveto(var_1E, var_23);
  var_7 rotateto(var_1F, var_23);
  wait(var_23);
  level.player scripts\sp\utility::func_2B76(0.2, 0.05);
  if(isDefined(var_2)) {
    var_29 = 0.7;
    wait(var_24 - var_23 - var_29);
    var_2A = var_7 func_12A0(-60, 0, 0);
    var_7 moveto(var_2A, var_29, 0.2, 0.1);
    wait(var_29);
  ...
  level.player unlink();
  var_7 delete();
  level.var_5A23[var_4.var_336].var_A5AE delete();
  level.var_5A23[var_4.var_336].var_59FF delete();
...
func_59CF(var_0, var_1) {
  ...
  if(!isDefined(var_1) || var_1 == 0) {
    level scripts\engine\utility::waittill_any_3(var_0 + "door_peek_kick", var_0 + "door_peek_back_off", var_0 + "door_peek_sprint");
  } else {
    level scripts\engine\utility::waittill_any_3(var_0 + "door_peek_back_off", var_0 + "door_peek_sprint");
  }
...
func_1465(var_0) {
  level.player endon("death");
  level scripts\engine\utility::waittill_any_3(var_0 + "door_peek_kick", var_0 + "door_peek_detach");
  if(level.var_5A23[var_0].var_13C81) {
    level.player scripts\engine\utility::allow_weapon_switch(1);
  }
}
...
func_1298(var_0, var_1) {
  ...
  if(var_0 == "bulkhead" && !var_1) {
    ...
    var_2.var_B7C1 = 0;
    var_2.var_B4AA = 70;
    var_2.setdevdvarifuninitialized = 8;
    var_2.var_B481 = 30;
    var_2.var_B4B9 = 4;
    var_2.var_11782 = 16;
  ...
  if((var_0 == "airlockcombat" || var_0 == "airlockcombatsdf") && !var_1) {
    ...
    var_2.var_B7C1 = 0;
    var_2.var_B4AA = 140;
    var_2.setdevdvarifuninitialized = 13;
    var_2.var_B481 = 80;
    var_2.var_B4B9 = 4;
    var_2.var_11782 = 10;
    ...
    var_2.var_B7C1 = 9.5;
    var_2.var_B4AA = 70;
    var_2.setdevdvarifuninitialized = 5;
    var_2.var_B481 = 29;
    var_2.var_B4B9 = 4;
    var_2.var_11782 = 3;
  } else if(var_0 == "civlever" && var_1) {
...
func_1299(var_0) {
  ...
  if(var_0 == "airlock" || var_0 == "airlocksdf" || var_0 == "airlockcombat" || var_0 == "airlockcombatsdf") {
    return "airlock";
  }

  if(var_0 == "armory" || var_0 == "armoryajar") {
    return "armory";
  }
...
func_1297(var_0) {
  ...
  if(var_0 == "civlever" || var_0 == "civchurch1") {
    return "civlever";
  }
}
...
func_59D9(var_0, var_1) {
  level.var_5A23[var_0].var_5A2A rotateto(level.var_5A23[var_0].var_5A24 + (0, -140, 0), var_1, 0, 0);
