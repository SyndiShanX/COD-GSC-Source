...
func_F4B2(var_0) {
  self.triggeroneoffradarsweep = var_0;
}
...
func_13754(var_0, var_1, var_2) {
  ...
  foreach(var_5 in var_0) {
    if(isalive(var_5) && !var_5.precachemodel) {
  ...
  var_7.var_C1 = var_0.size;
  if(isDefined(var_1) && var_1 < var_7.var_C1) {
    var_7.var_C1 = var_1;
  }
...
waittill_nonai_isnt_blocking_tank(var_0) {
  self endon("damage");
  self endon("death");
  self waittillmatch(var_0, "single anim");
}
...
func_7A9E(var_0, var_1) {
  ...
  foreach(var_5 in var_2) {
    ...
    switch (var_1) {
      case "targetname":
        if(isDefined(var_5.var_336) && var_5.var_336 == var_0) {
          var_3[var_3.size] = var_5;
        }
        break;
...
func_7D43(var_0, var_1) {
  ...
  foreach(var_6 in var_2) {
    if(var_6.var_9F != "script_vehicle") {
      continue;
    }
...
func_7AA0(var_0, var_1, var_2) {
  ...
  for(var_5 = 0; var_5 < var_3.size; var_5++) {
    switch (var_1) {
      case "targetname":
        if(isDefined(var_3[var_5].var_336) && var_3[var_5].var_336 == var_0) {
...
func_7F79(var_0, var_1) {
  ...
  for(var_3 = 0; var_3 < var_0.size; var_3++) {
    var_4 = var_0[var_3];
    var_5 = var_4.destroynavobstacle;
    if(!isDefined(var_5)) {
      continue;
    }
...
func_28D7(var_0) {
  ...
  if(isDefined(var_0)) {
    ...
    foreach(var_0 in level.var_115E7) {
      func_F2DC(var_0, 0);
    }
  ...
  var_6 = gettime() - level.var_AA27["allies"];
  if(var_6 < 1500) {
    wait(var_6 / 1000);
  }
...
func_F5C2(var_0, var_1) {
  ...
  var_2 = getarraykeys(level.var_46BD);
...
func_F292(var_0) {
  ...
  var_1 = getarraykeys(level.var_46BD);
...
func_F5C3(var_0, var_1) {
  var_2 = getaiarray(var_0);
  for(var_3 = 0; var_3 < var_2.size; var_3++) {
    var_2[var_3].triggeroneoffradarsweep = var_1;
  }
}
...
func_5CC9(var_0) {
  var_1 = lib_0B77::func_1085E(var_0);
  return var_1;
}
...
func_6B47(var_0) {
  ...
  var_1 thread lib_0B77::func_E81A();
  var_1.spawner = var_0;
  var_1.var_ED8A = 1;
...
func_F417(var_0) {
  self.precacherumble = var_0;
}

func_F3E0(var_0) {
  self.objective_playermask_showto = var_0;
}
...
func_F582(var_0, var_1) {
  ...
  func_559A();
  self.var_E80C = level.var_EC85[self.var_1FBB][var_1];
...
func_C81A(var_0) {
  var_1 = lib_0A1E::func_2357(self.asm.archetype, "move_walk_loop", "casual_purpose");
...
func_13035(var_0, var_1, var_2) {
  ...
  var_4 = (-16, 0, 0);
  var_5 = var_0 gettweakablevalue(var_4);
...
func_7C84(var_0, var_1) {
  ...
  if(var_1 == "code_classname") {
    foreach(var_5 in var_2) {
      if(isDefined(var_5.var_9F) && var_5.var_9F == var_0) {
        var_3[var_3.size] = var_5;
      }
    }
    ...
    foreach(var_5 in var_2) {
      if(isDefined(var_5.destroynavobstacle) && var_5.destroynavobstacle == var_0) {
        var_3[var_3.size] = var_5;
      }
    }
...
func_22CD(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(level.var_107A7)) {
    ...
    var_6 = lib_0B77::func_7BC6(var_5);
...
func_BDD5(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(level.var_1188.var_A90A)) {
    musicstop(var_1, level.var_1188.var_A90A, var_3);
  }
...
func_7965(var_0) {
  ...
  foreach(var_4 in var_1) {
    ...
    if(isDefined(var_4.var_336) && var_4.var_336 == var_0) {
      var_2[var_2.size] = var_4;
    }
  }
...
func_7226(var_0, var_1, var_2, var_3) {
  ...
  var_5 = self.var_EDB0;
  self.var_EDB0 = 1;
  lib_0B77::worldpointinreticle_circle(var_0, var_4, var_2, var_1, var_3);
  self.var_EDB0 = var_5;
...
func_13817(var_0, var_1) {
  self endon("death");
  if(!isDefined(var_1)) {
    var_1 = self.objective_playermask_showto;
  }
...
func_6389() {
  ...
  var_0 scripts\engine\utility::delaycall(0.2, ::func_84FD);
...
func_7B93() {
  return int(self func_8155("gameskill"));
}
...
func_D0F4() {
  ...
  return isDefined(var_0.isent) && var_0.isent.var_6F43;
}
...
func_848C(var_0, var_1, var_2, var_3, var_4) {
  var_5 = var_4 - var_2;
  var_6 = var_3 - var_1;
  var_7 = var_5 / var_6;
  var_0 = var_0 - var_3;
...
func_BCA1(var_0, var_1, var_2) {
  ...
  self.var_381 = var_5 * var_3 / var_4;
}
...
func_51D4(var_0) {
  ...
  var_1 = var_0.destroynavobstacle;
...
func_7227(var_0, var_1) {
  ...
  while(isDefined(var_2)) {
    self.var_4B76 = var_2;
    if(isDefined(var_2.setnojiptime)) {
      break;
    }

    if(isDefined(level.struct_class_names["targetname"][var_2.var_336])) {
      var_4 = ::func_722A;
    ...
    if(isDefined(var_2.fgetarg) && var_2.fgetarg != 0) {
      self.objective_playermask_showto = var_2.fgetarg;
    }
    ...
    if(isDefined(var_2.height) && var_2.height != 0) {
      self.objective_playermask_hidefrom = var_2.height;
    }

    var_5 = self.objective_playermask_showto;
    ...
    if(!isDefined(var_2.var_EE95) && var_1 > 0 && self.team == "allies") {
      while(isalive(level.player)) {
        ...
        if(isDefined(var_2.animation)) {
          self.objective_playermask_showto = var_5;
          self give_mp_super_weapon(self.origin);
        }
...
func_61F0(var_0) {
  scripts\sp\dynamic_move::func_5F84(var_0);
}
...
func_D090(var_0, var_1) {
  ...
  if(var_2) {
    thread lib_0E49::func_D092(var_0, 1, 1, 0, 1, 1, 1, 1, 1, 1, 1, 1);
  }
...
func_EBA6(var_0, var_1) {
  func_960B();
  if(isDefined(var_0)) {
    setsaveddvar("bg_gravity", level.isinphase * var_0);
  }
...
func_77B9(var_0) {
  if(isDefined(self.unittype) && self.unittype == "c6") {
    thread lib_0C4C::func_1965(var_0);
  } else {
    thread lib_0C4C::func_194F(var_0 * 0.1);
    thread lib_0C4C::func_1964(var_0);
  }
...
func_77BD(var_0) {
  thread lib_0C4C::func_1967(var_0);
}

func_7793(var_0) {
  thread lib_0C4C::func_194F(var_0);
}
...
func_779A(var_0, var_1, var_2, var_3) {
  thread lib_0C4C::func_1956(var_0, var_1, var_2, var_3);
}

func_7798(var_0, var_1, var_2) {
  thread lib_0C4C::func_194E(var_0, var_1, var_2);
}

func_779C(var_0, var_1) {
  thread lib_0C4C::func_1959(var_0, var_1);
}

func_779B(var_0, var_1) {
  lib_0C4C::func_196A(var_0, var_1);
}

func_7797(var_0, var_1) {
  lib_0C4C::func_1969(var_0, var_1);
}

func_77A9(var_0) {
  lib_0C4C::func_195D(var_0);
}

func_77B7(var_0) {
  lib_0C4C::func_1960(var_0);
}

func_7791(var_0, var_1, var_2) {
  lib_0C4C::func_194C(var_0, var_1, var_2);
}

func_7790(var_0, var_1) {
  lib_0C4C::func_192F(var_0, var_1);
}
...
func_77B8(var_0, var_1, var_2, var_3) {
  ...
  for(;;) {
    if(var_5 < var_4 && scripts\sp\interaction_manager::func_3838(var_1 * 3)) {
      break;
    }
...
func_799D(var_0) {
  return lib_0B29::func_129C(var_0);
}

func_78E4() {
  if(getdvarint("ai_corpseSynch")) {
    return self func_82CC();
  }
...
func_9DB4(var_0) {
  if(isDefined(self.var_E2) && self.var_E2 != "alt_none" && self.var_E2 != "none" && getweaponbasename(self.var_E2) == var_0) {
    return 1;
  }
...
func_E820(var_0, var_1, var_2, var_3, var_4) {
  ...
  if(isDefined(level.func_8134)) {
    var_6 = [[level.func_8134]](var_0);
...
func_7B27(var_0) {
  ...
  if(scripts\engine\utility::issp()) {
    var_1 = [[level.getnodefunction]](var_0, "script_noteworthy");
    if(isDefined(var_1)) {
      return var_1;
    }
  }
...
func_9C39(var_0) {
  ...
  return var_1.var_C1 > var_1.max_count;
}
