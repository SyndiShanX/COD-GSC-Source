...
func_8739(var_0, var_1) {
  ...
  if(isDefined(var_0.var_4E2A) && !isDefined(var_0.var_B14F) && vehicle_allows_driver_death()) {
    if(var_0.var_1321D != 0 || vehicle_all_stop_func()) {
      var_0.var_30 = !isDefined(var_0.var_ECED) || var_0.var_ECED;
  ...
  if(var_0.classname == "script_model") {
    if(isDefined(var_5.var_E6) && var_0.var_30 && !isDefined(var_0.var_ECED) || var_0.var_ECED) {
  ...
  if(var_4 == 0 && isDefined(var_3[0].var_E6)) {
...
func_8732(var_0, var_1) {
  var_2 = gettime() + getanimlength(var_1.var_E6) * 1000;
  var_3 = var_0.angles;
  var_4 = var_0.origin;
  ...
  var_0 linkto(self);
  var_0 notsolid();
  var_0 give_attacker_kill_rewards(var_1.var_E6);
  if(isai(var_0)) {
...
func_13211(var_0) {
  if(isDefined(var_0.var_380) && isDefined(var_0.var_13212)) {
  ...
  if(!var_0.var_E880.size && var_0.var_E4FB.size) {
...
func_8752(var_0, var_1, var_2, var_3) {
  ...
  var_0.objective_playermask_showto = 16;
...
func_872C(var_0, var_1) {
  ...
  var_0 = lib_0B77::func_10869(var_0);
  var_2 = self.classname;
...
func_CDAA(var_0, var_1) {
  ...
  if(isDefined(var_1.var_D3E2) && isDefined(var_2.var_D0E8)) {
    func_1FC2(var_1, var_2.var_10220, var_2.var_D0E8);
    return;
  }

  if(isDefined(var_2.var_131F2)) {
    thread func_F642(var_2.var_131F2);
  }

  func_1FC2(var_1, var_2.var_10220, var_1.var_131F2);
}
...
botgetfovdot(var_0, var_1, var_2) {
  ...
  var_6 = var_0 gettagorigin(level.vehicle.var_116CE.var_247D[var_3][var_4.var_6B9D].physics_setgravitydynentscalar);
  var_7 = var_0 gettagangles(level.vehicle.var_116CE.var_247D[var_3][var_4.var_6B9D].physics_setgravitydynentscalar);
  ...
  var_8 linkto(var_0, level.vehicle.var_116CE.var_247D[var_3][var_4.var_6B9D].physics_setgravitydynentscalar, (0, 0, 0), (0, 0, 0));
  thread botgetscriptgoalnode(var_4, var_8, level.vehicle.var_116CE.var_247D[var_3][var_4.var_6B9D].physics_setgravitydynentscalar, level.vehicle.var_116CE.var_247D[var_3][var_4.var_6B9D].var_5D1B, var_2);
  return var_8;
}
...
func_8766(var_0, var_1) {
  ...
  if(isDefined(var_3.var_131E6)) {
    ...
    if(isDefined(var_3.var_131E8) && !var_8) {
      playworldsound(var_3.var_131E8, var_9);
    }
  ...
  if(isalive(var_0) || var_2) {
    if(isai(var_0)) {
      var_0.a.disablelongdeath = !var_0 gettargetchargepos();
    }
    ...
    if(isai(var_0)) {
      ...
      if(isDefined(var_0.var_1356F.target)) {
        ...
        var_11 = var_0.var_1356F scripts\sp\utility::func_10808();
      }
...
func_8767(var_0, var_1, var_2, var_3, var_4) {
  ...
  if(isai(var_0)) {
    var_0 lib_0A1E::func_2307(::func_873D, ::func_873E);
  } else {
...
func_1FC2(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  if(!isDefined(var_1)) {
    ...
    var_7 = var_8 gettagorigin(var_3);
    var_8 = var_7 gettagangles(var_2);
  }
...
func_1FC4(var_0, var_1, var_2) {
  ...
  if(isDefined(var_0.var_DC17)) {
    ...
    if(abs(var_3[2] + 16) <= abs(var_5)) {
      ...
      var_0 waittillmatch("start_ragdoll", "fastrope_fall");
    }
  }
...
func_1F9D(var_0, var_1, var_2, var_3) {
  ...
  var_0 waittillmatch("end", "movetospot");
}
...
func_45EE(var_0, var_1) {
  ...
  var_3 = var_0 getscoreremaining();
  for(var_4 = 0; var_4 < var_3; var_4++) {
    var_2 attach(var_0 getscoreperminute(var_4), var_0 getattachtagname(var_4));
  }
...
func_538C(var_0, var_1) {
  var_2 = var_0 getscoreremaining();
  var_3 = [];
  var_4 = [];
  var_5 = 0;
  for(var_6 = 0; var_6 < var_2; var_6++) {
    var_7 = var_0 getscoreperminute(var_6);
