...
func_9021(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  ...
  if(!scripts\engine\utility::istrue(var_8.var_6AB8)) {
...
func_68CD(var_0) {
  if(var_0.var_C8FD.size == 0) {
    ...
    [[var_0.func]](var_0.var_C8FD[0]);
  } else if(var_0.var_C8FD.size == 2) {
    [[var_0.func]](var_0.var_C8FD[0], var_0.var_C8FD[1]);
  } else if(var_0.var_C8FD.size == 3) {
    [[var_0.func]](var_0.var_C8FD[0], var_0.var_C8FD[1], var_0.var_C8FD[2]);
  }

  if(var_0.var_C8FD.size == 4) {
    [[var_0.func]](var_0.var_C8FD[0], var_0.var_C8FD[1], var_0.var_C8FD[2], var_0.var_C8FD[3]);
  }

  if(var_0.var_C8FD.size == 5) {
    [[var_0.func]](var_0.var_C8FD[0], var_0.var_C8FD[1], var_0.var_C8FD[2], var_0.var_C8FD[3], var_0.var_C8FD[4]);
  }
}
...
func_12688(var_0) {
  if(isDefined(self.missionfailed)) {
    ...
    var_0.origin = var_0.origin + var_1 * self.missionfailed;
  }

  if(isDefined(self.setdebugorigin)) {
    var_2 = anglestoright(var_0.angles);
    var_0.origin = var_0.origin + var_2 * self.setdebugorigin;
  }

  if(isDefined(self.var_367)) {
    var_3 = anglestoup(var_0.angles);
    var_0.origin = var_0.origin + var_3 * self.var_367;
  }
  ...
  if(isDefined(self.var_CBE9)) {
    var_0 getnodeyawtoenemy(self.var_CBE9);
  }

  if(isDefined(self.var_E67D)) {
    var_0 getnodeyawtoorigin(self.var_E67D);
  }
}
...
func_5F8E(var_0, var_1, var_2, var_3, var_4) {
  ...
  for(;;) {
    ...
    var_11 = var_10;
    if(isDefined(var_4)) {
      var_12 = scripts\engine\utility::getclosest(var_9.origin, var_4);
      var_11 = distancesquared(var_12.origin, var_9.origin);
    }
...
dyndof_set(var_0) {
  ...
  scripts\sp\art::func_583F(var_3, var_4, level.dyndof.nearblur, var_5, var_6, level.dyndof.farblur, level.dyndof.focusspeed);
}
