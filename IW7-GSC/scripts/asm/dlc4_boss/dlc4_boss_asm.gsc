...
meph_victory() {
  ...
  foreach(var_1 in level.players) {
    var_1 thread scripts\cp\utility::player_black_screen(0.25, 1, 0.25, 0, 1);
    var_1 scripts\cp\cp_merits::processmerit("mt_dlc4_troll2");
    var_1 setplayerdata("cp", "meritState", "mt_dc_camo", 1);
  }
