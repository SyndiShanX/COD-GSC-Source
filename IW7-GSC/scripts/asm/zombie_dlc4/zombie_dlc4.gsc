...
dotraverseanim_dlc(var_0, var_1, var_2, var_3) {
  ...
  var_14 = "flex_height_up_start_fix";
  ...
  if(isDefined(opcode::OP_CallBuiltin4) && isDefined(var_1E.target)) {
    ...
    if(var_13.size > 0) {
      ...
      if(var_15[0] - var_11[0] >= 0.05 / opcode::OP_ScriptFarMethodThreadCall) {
        self scragentsetanimscale(1, 1);
        scripts\mp\agents\_scriptedagents::func_CED2(var_6, var_7, 1, "traverse", var_14, ::zombietraversenotetrackhandler_dlc);
      }
    ...
    childthread traverse_lerp_z_over_time_dlc(var_4.origin[2], var_5[2], opcode::OP_CastBool - opcode::OP_SetLevelFieldVariableField / self.traverseratescale);
    ...
    if(opcode::OP_CallBuiltin1[2] > 0) {
      if(var_12) {
        ...
        if(var_11.size > 0) {
          scripts\mp\agents\_scriptedagents::func_CED3(var_6, var_7, opcode::OP_ScriptFarFunctionCall2 * self.traverseratescale, "traverse", var_10);
...
shoulddosharpturn_dlc(var_0, var_1, var_2, var_3) {
  return lib_0F3B::func_FFF8(var_0, var_1, var_2, var_3);
}
...
shootburst_dlc(var_0, var_1, var_2) {
  ...
  thread lib_0F3E::func_FE84(var_3, var_4, var_2);
  self endon(var_3);
  ...
  while(var_5 < var_6 && var_6 > 0) {
    ...
    var_10 = lib_0F3C::func_811C();
    var_11 = lib_0F3C::func_811E(var_10);
    self shoot(1, var_11, 1, 0, 1);
    ...
    var_5++;
    if(var_9) {
      childthread lib_0F3E::func_FE7D(var_0);
    }
