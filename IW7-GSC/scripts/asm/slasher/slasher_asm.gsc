...
grenadethrownotehandler(var_0, var_1, var_2, var_3) {
  switch (var_0) {
    ...
    case "grenade_left":
      break;
    case "grenade_throw":
      if(scripts\engine\utility::is_true(self.grenade_thrown)) {
        return;
      }
...
fireblades(var_0) {
  ...
  for(;;) {
    ...
    if(isDefined(var_2) && isDefined(self.lookposition)) {
      var_3 = self gettagorigin("j_wrist_ri");
      var_4 = self.lookposition;
...
doramattackdamage(var_0) {
  ...
  if(scripts\engine\utility::is_true(self.bramattackdamageoccured)) {
    return;
  }
