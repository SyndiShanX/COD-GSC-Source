...
playtraverseziplinedrop(var_0, var_1, var_2, var_3) {
  ...
  scripts\mp\agents\_scriptedagents::func_CED2(var_1, var_4, 2, var_1, "flex_height_down_start", undefined);
  ...
  scripts\mp\agents\_scriptedagents::func_CED2(var_1, var_4, 1.5, var_1, "end", undefined);
