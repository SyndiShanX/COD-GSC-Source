...
shouldplayentranceanim(var_0, var_1, var_2, var_3) {
  return !scripts\engine\utility::is_true(self.shouldabortentranceanim);
}
...
crabbossnotehandler(var_0, var_1, var_2, var_3) {
  switch (var_0) {
    ...
    case "footstep_right_large":
      thread dorightfootstep();
      break;
    case "footstep_left_large":
      thread doleftfootstep();
      break;
    case "debris_vfx_1":
...
dorightfootstep() {
  ...
  var_0 = self gettagorigin("j_ball_ri");
  var_0 = bulletTrace(var_0 + (0, 0, 1000), var_0, 0, self)["position"];
  playFX(level._effect["leg_splashes_heavy"], var_0);
}
...
beam_notehandler(var_0, var_1, var_2, var_3) {
  switch (var_0) {
    ...
    case "interruptable_end":
      ...
      break;
    case "start_beam_fx":
      if(!scripts\engine\utility::is_true(self.bbeamfxstarted)) {
...
hideweakspot() {
  if(scripts\engine\utility::is_true(self.reveal_weak_spot)) {
    return;
  }
  if(isDefined(self.crab_boss_weak_spot)) {
...
_id_3EE4(var_0, var_1, var_2) {
  ...
  return scripts\asm\asm::asm_lookupanimfromalias(var_1, self.painalias);
}
...
stopsonicbeam() {
  scripts\cp\maps\cp_town\cp_town_crab_boss_sonic_ring::terminate_sonic_ring();
}