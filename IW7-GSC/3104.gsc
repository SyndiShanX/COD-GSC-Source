...
_id_2399() {
  ...
  scripts\sp\utility::_id_75C4(self.script_team + "_vtolThrustSide", "tag_vtol_right", 0, "notify_change_fx_state");
  _id_13913();
  self.fx._id_552E = ::_id_2398;
}
...
_id_2398() {
  ...
  scripts\sp\utility::_id_75F8(self.script_team + "_vtolThrustSide", "tag_vtol_right");
  _id_13912();
}
...
_id_13913() {
  thread scripts\sp\vehicle_code::_id_1A93();
}
