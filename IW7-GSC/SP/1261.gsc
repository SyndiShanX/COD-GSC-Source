...
main() {
  ...
  self attach("head_bg_var_head_sc_male_24_head_sc_male_25", "", 1);
  self.headmodel = "head_bg_var_head_sc_male_24_head_sc_male_25";
...
precache() {
  ...
  precachemodel("head_bg_var_head_sc_male_24_head_sc_male_25");
