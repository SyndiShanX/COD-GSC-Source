...
_id_9766() {
  ...
  scripts\sp\utility::_id_1749("no_game", ::_id_10CBC);
  _id_171D();
}
...
_id_171D() {
  ...
  foreach(var_2 in var_0) {
    ...
    scripts\sp\utility::_id_1749("no_game_" + var_2.script_startname, ::_id_10CBC);
  }
}
...
_id_57A2() {
  ...
  if(level._id_10CDA == "no_game") {
    level.player scripts\sp\utility::_id_11633(var_0[0]);
    return;
  }

  var_1 = getsubstr(level._id_10CDA, 8);
  var_2 = 0;
...
_id_56CC() {
  ...
  var_1 = _id_10C9D();
  var_2 = _id_4959("Selected Start:", -1);
  var_2.color = (1, 1, 1);
  var_3 = [];
  ...
  for(var_4 = 0; var_4 < var_0.size; var_4++) {
    ...
    if(var_5 != "cancel" && var_5 != "default") {
      if(isDefined(level._id_10BA8[var_5]["start_loc_string"])) {
        var_6 = var_6 + " -> ";
        var_6 = var_6 + level._id_10BA8[var_5]["start_loc_string"];
      }
    }
  ...
  for(var_10 = 0; var_7 > 0; var_7--) {
    if(var_0[var_7] == level._id_10CDA) {
      var_10 = 1;
      break;
    }
  }
...
_id_10C9F() {
  ...
  if(isloadingsavegame()) {
    ...
    if(isDefined(level._id_D9E5["loaded_weapons"])) {
      foreach(var_7 in level._id_D9E5["loaded_weapons"]) {
        if(_id_0A2F::_id_9B49(var_7)) {
...
_id_8960() {
  ...
  for(var_3 = 0; var_3 < var_1.size; var_3++) {
    if(var_0 == var_1[var_3]) {
      var_2 = var_3;
      level._id_10CDA = var_1[var_3];
      break;
    }
  }

  if(isDefined(level._id_501A) && !isDefined(level._id_10CDA)) {
      ...
      if(isDefined(var_4) && var_5.size > 0) {
        if(var_5[0] == "sa" || var_5[0] == "ja") {
          foreach(var_8, var_7 in var_1) {
            if(level._id_501A == var_7) {
              var_2 = var_8;
              level._id_10CDA = var_7;
              break;
            }
          }
        }
  ...
  if(isDefined(level._id_5019) && !isDefined(level._id_10CDA)) {
    foreach(var_8, var_7 in var_1) {
      if(level._id_5019 == var_7) {
        var_2 = var_8;
        level._id_10CDA = var_7;
        break;
      }
  ...
  if(!scripts\sp\utility::_id_9BB5() && level._id_10CDA != "no_game") {
    var_13 = gettime();

    for(var_3 = 0; var_3 < level._id_10C58.size; var_3++) {
      var_10 = level._id_10C58[var_3];

      if(var_10["name"] == level._id_10CDA) {
        break;
      }
  ...
  for(var_3 = var_2; var_3 < level._id_10C58.size; var_3++) {
    var_10 = level._id_10C58[var_3];
...
_id_48E4(var_0) {
  ...
  level._id_6BC2 = var_1[getdvarint("feedback_index")];
}

_id_48E1(var_0, var_1) {
  if(!getdvarint("feedback")) {
    return;
  }
  var_0 = tolower(var_0);
...
_id_48E2(var_0, var_1, var_2) {
  if(!getdvarint("feedback")) {
    return;
  }
  var_0 = tolower(var_0);
  scripts\engine\utility::flag_init(var_0 + "_endFunc");
  thread _id_48E3(var_0, var_1, var_2);
}
...
_id_56B5(var_0) {
  ...
  if(!isDefined(level._id_6BC0[var_0])) {
    return;
  }
...
_id_6BBF(var_0, var_1) {
  if(!isDefined(level._id_6BC3)) {
    return;
  }
  var_2 = var_0["name"];
  var_3 = getdvarint("feedback_index");
  thread _id_6BBE(var_2, var_3);
  _id_6BBD(var_2, var_3);
  _id_56B5(var_2);
}

_id_6BBE(var_0, var_1) {
  if(!isDefined(level._id_6BC3[var_1])) {
    return;
  }
  if(!scripts\engine\utility::flag_exist(level._id_6BC3[var_1] + "_endFunc")) {
    return;
  }
  scripts\engine\utility::flag_set("feedback_waiting_on_endFunc");
  scripts\engine\utility::flag_wait(level._id_6BC3[var_1] + "_endFunc");
  scripts\engine\utility::flag_clear("feedback_waiting_on_endFunc");
  _id_6BBD(var_0, var_1 + 1);
}

_id_6BBD(var_0, var_1) {
  ...
  if(level._id_6BC3[var_1] != var_0) {
    setDvar("start", level._id_6BC3[var_1]);
...
_id_174B(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  var_7 = [];
  var_7["name"] = var_0;
