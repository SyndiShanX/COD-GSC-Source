...
_id_12867() {
  level.player scripts\sp\loadout_code::_id_F6B5();

  if(!isDefined(level._id_37E7))
    level._id_37E7 = "american";

  if(!_id_0A2F::_id_9CBB(level.template_script) && !_id_0A2F::is_jackal_arena_level(level.template_script)) {
    _id_F3BA(level.template_script);

    if(!_id_82FA()) {
      var_0 = 0;
      var_1 = _id_0A2F::_id_7AF1();

      if(level.template_script == "europa" || !scripts\engine\utility::array_contains(var_1, level.template_script))
        var_0 = 1;

      _id_F56D(level.template_script, 1, 0, var_0);
  ...
  scripts\sp\loadout_code::_id_AE27();
}
...
_id_F56D(var_0, var_1, var_2, var_3) {
  var_0 = _id_7AA7(var_0);
  ...
  var_10 = tablelookup("sp/recommended_loadouts.csv", 0, var_0, 8);

  if(scripts\sp\utility::_id_93A6() && !scripts\sp\specialist_MAYBE::_id_2C91()) {
    var_6[1] = var_6[0];
    var_7[1] = var_7[0];
    var_6[0] = "helmet";
    var_7[0] = "nanoshot";
  ...
  if(isDefined(var_3) && var_3)
    _id_8305(var_4, var_5, var_6[0], var_7[0], var_6[1], var_7[1]);
  else {
    if(var_0 == "default") {
      _id_8305(var_4);
      return;
    ...
    if(var_1) {
      var_4 = _id_79B0(var_4);
      var_5 = _id_79B0(var_5);
    }

    _id_F467(var_2, var_4, var_5, var_7[0], var_6[0], var_7[1], var_6[1], var_8, var_9, var_10);
    var_11 = int(tablelookup("sp/recommended_loadouts.csv", 0, var_0, 9));
...
_id_F3BA(var_0) {
  ...
  if(var_1 != "")
    level._id_72A6 = var_1;
}

_id_31CE(var_0, var_1) {
  ...
  return _id_31CD(var_2, var_3);
}

_id_31CD(var_0, var_1, var_2) {
  if(!isDefined(var_0) || var_0 == "none" || var_0 == "")
    return "none";

  if(isDefined(level._id_72A6)) {
    if(!scripts\engine\utility::array_contains(var_1, level._id_72A6))
      var_1 = scripts\engine\utility::array_add(var_1, level._id_72A6);
  }

  var_3 = _id_7874(var_0, var_1);

  if(isDefined(var_3)) {
    var_1 = scripts\engine\utility::array_add(var_1, level._id_2C81);
    level._id_7655 = var_1;
  }

  var_4 = _id_0A2F::build_attach_models(var_0, "array", undefined, 0, 0, 3, 0, var_1);
...
_id_AE39() {
  ...
  setDvar("loadout_start_point", level._id_10CDA);
  scripts\engine\utility::waitframe();
  map_restart();
  wait 3;
}
...
_id_82FA() {
  ...
  if(isDefined(level.script))
    var_1 = scripts\sp\endmission::_id_7F6B(level.script);
  else
    var_1 = undefined;
  ...
  var_10 = _id_31CD(var_2, var_3);
  var_11 = _id_31CD(var_4, var_5);
  _id_8305(var_10, var_11, var_6, var_7, var_8, var_9);
  var_12 = level.player _meth_84C6("currentLoadout", "weaponClipAmmo", 0);
  var_13 = level.player _meth_84C6("currentLoadout", "weaponStockAmmo", 0);
  var_14 = level.player _meth_84C6("currentLoadout", "weaponClipAmmo", 1);
  var_15 = level.player _meth_84C6("currentLoadout", "weaponStockAmmo", 1);
  level.player setweaponammostock(var_10, var_13);
  level.player setweaponammostock(var_11, var_15);
  level.player setweaponammoclip(var_10, var_12);
  level.player setweaponammoclip(var_11, var_14);
  var_16 = level.player _meth_84C6("currentLoadout", "offhandEquipmentAmmo", 0);
  var_17 = level.player _meth_84C6("currentLoadout", "equipmentAmmo", 0);
  var_18 = level.player _meth_84C6("currentLoadout", "offhandEquipmentAmmo", 1);
  var_19 = level.player _meth_84C6("currentLoadout", "equipmentAmmo", 1);
  level.player setweaponammoclip(var_6, var_17);
  level.player setweaponammoclip(var_8, var_19);
  level.player setweaponammoclip(var_7, var_16);
  level.player setweaponammoclip(var_9, var_18);
  return 1;
}

_id_7C27(var_0, var_1) {
  if(!isDefined(var_0))
    return undefined;
...
_id_EB5B() {
  var_0 = scripts\sp\endmission::_id_7F6B(level.script);
  ...
  if(level.script == "europa" || level.script == "marscrash" || level.script == "shipcrib_epilogue") {
    ...
    if(!isDefined(var_2) || !scripts\engine\utility::array_contains(_id_0A2F::_id_DA17(), var_2))
      var_2 = "none";
    ...
    foreach(var_4 in var_1) {
      ...
      var_8 = _id_7D6A(var_4);
      var_9 = var_8[0];
      var_10[0] = var_8[1];
      var_10[1] = var_8[2];
      var_10[2] = var_8[3];

      if(!scripts\engine\utility::array_contains(_id_0A2F::_id_DA17(), var_9)) {
        continue;
      }
      ...
      level.player _meth_84C7("currentLoadout", "weaponSetups", var_11, "weapon", var_9);
      level.player _meth_84C7("currentLoadout", "weaponClipAmmo", var_11, var_7);
      level.player _meth_84C7("currentLoadout", "weaponStockAmmo", var_11, var_6);

      foreach(var_14, var_13 in var_10)
      level.player _meth_84C7("currentLoadout", "weaponSetups", var_11, "attachment", var_14, var_10[var_14]);
    }

    var_16 = scripts\sp\utility::_id_7BD6();
    var_16 = _id_7C27(var_16);

    if(isDefined(var_16)) {
      level.player _meth_84C7("currentLoadout", "offhandEquipment", 0, var_16);
      level.player _meth_84C7("currentLoadout", "offhandEquipmentAmmo", 0, scripts\sp\utility::_id_7BD7());
    } else {
    ...
    var_16 = scripts\sp\utility::_id_7CAF();
    var_16 = _id_7C27(var_16);

    if(isDefined(var_16)) {
      level.player _meth_84C7("currentLoadout", "offhandEquipment", 1, var_16);
      level.player _meth_84C7("currentLoadout", "offhandEquipmentAmmo", 1, scripts\sp\utility::_id_7CB0());
    } else {
    ...
    var_16 = scripts\sp\utility::_id_7C3D();
    var_16 = _id_7C27(var_16);

    if(isDefined(var_16)) {
      level.player _meth_84C7("currentLoadout", "equipment", 0, var_16);
      level.player _meth_84C7("currentLoadout", "equipmentAmmo", 0, scripts\sp\utility::_id_7C3E());
    } else {
      level.player _meth_84C7("currentLoadout", "equipment", 0, "none");
      level.player _meth_84C7("currentLoadout", "equipmentAmmo", 0, 0);
    }

    var_16 = scripts\sp\utility::_id_7CB1();
    var_16 = _id_7C27(var_16);

    if(isDefined(var_16)) {
      level.player _meth_84C7("currentLoadout", "equipment", 1, var_16);
      level.player _meth_84C7("currentLoadout", "equipmentAmmo", 1, scripts\sp\utility::_id_7CB2());
      return;
    }
...
_id_82FB() {
  ...
  var_3 = _id_31CE(0, var_0);
  var_4 = _id_31CE(1, var_0);
  ...
  _id_8305(var_3, var_4, var_5, var_6, var_7, var_8);
}

_id_8305(var_0, var_1, var_2, var_3, var_4, var_5) {
...
_id_783F(var_0) {
  if(!isDefined(level._id_D9E5) || isDefined(level._id_D9E5) && !isDefined(level._id_D9E5["attachments"]))
    var_1 = _id_0A2F::_id_DA52();
  else
    var_1 = level._id_D9E5["attachments"];

  foreach(var_3 in var_1) {
    foreach(var_5 in var_3) {
      foreach(var_7 in var_5) {
        foreach(var_9 in var_7) {
          if(var_9._id_24A2 == var_0)
            return var_9;
        }
      }
    }
...
_id_7D6A(var_0) {
  ...
  if(isDefined(var_4) && isDefined(var_5)) {
    ...
    foreach(var_8 in var_5) {
      ...
      var_9 = _id_783F(var_8);

      if(!isDefined(var_9)) {
        continue;
      }
      if(var_4 == "iw7_gambit" && isDefined(level._id_7655) && level._id_7655 == var_8) {
        continue;
      }
      if(var_9._id_13CDE == "default" || var_9.baseangles == "zerog")
        continue;
      else {
  ...
  if(var_6.size > 2) {
    if(isDefined(level._id_72A6))
      var_6 = scripts\engine\utility::array_remove(var_6, level._id_72A6);
  }
...
_id_F33B(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8) {
  _id_F467(0, var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8);
}

_id_F467(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9) {
  var_10 = _id_10A4F(var_1);
  var_1 = var_10[0];
  var_11 = var_10[1];
  var_12 = var_10[2];
  var_13 = var_10[3];
  var_10 = _id_10A4F(var_2);
  var_2 = var_10[0];
  var_14 = var_10[1];
  var_15 = var_10[2];
  var_16 = var_10[3];
  ...
  if(isDefined(var_1) && var_1 != "" && isDefined(var_11))
    level.player _meth_84C7("loadouts", var_0, "weaponSetups", 0, "attachment", 0, var_11);
  else
    level.player _meth_84C7("loadouts", var_0, "weaponSetups", 0, "attachment", 0, "none");

  if(isDefined(var_1) && var_1 != "" && isDefined(var_12))
    level.player _meth_84C7("loadouts", var_0, "weaponSetups", 0, "attachment", 1, var_12);
  else
    level.player _meth_84C7("loadouts", var_0, "weaponSetups", 0, "attachment", 1, "none");

  if(isDefined(var_1) && var_1 != "" && isDefined(var_13))
    level.player _meth_84C7("loadouts", var_0, "weaponSetups", 0, "attachment", 2, var_13);
  else
  ...
  if(isDefined(var_2) && var_2 != "" && isDefined(var_14))
    level.player _meth_84C7("loadouts", var_0, "weaponSetups", 1, "attachment", 0, var_14);
  else
    level.player _meth_84C7("loadouts", var_0, "weaponSetups", 1, "attachment", 0, "none");

  if(isDefined(var_2) && var_2 != "" && isDefined(var_15))
    level.player _meth_84C7("loadouts", var_0, "weaponSetups", 1, "attachment", 1, var_15);
  else
    level.player _meth_84C7("loadouts", var_0, "weaponSetups", 1, "attachment", 1, "none");

  if(isDefined(var_2) && var_2 != "" && isDefined(var_16))
    level.player _meth_84C7("loadouts", var_0, "weaponSetups", 1, "attachment", 2, var_16);
  else
  ...
  var_17 = level.player _meth_84C6("loadouts", var_0, "jackalSetup", "jackalDecal");

  if(!isDefined(var_17) || var_17 == "" || var_17 == "none") {
