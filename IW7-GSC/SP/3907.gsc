...
_id_116F5(var_0, var_1, var_2) {}

_id_D46C(var_0, var_1, var_2, var_3) {
...
_id_CECB(var_0, var_1, var_2, var_3) {
  ...
  self _meth_82E4(var_1, var_5, _id_0A1E::asm_getbodyknob(), 1, var_2, scripts\anim\combat_utility::_id_6B9A());
...
_id_D56D(var_0, var_1) {
  ...
  while(var_5 > 0) {
    ...
    self._id_10F8C = angleclamp180(self.angles[1] + var_7);
    var_8 = self islegacyagent(var_0);
    var_9 = getangledelta(var_0, var_8, 1.0);
...
_id_D56B(var_0, var_1, var_2) {
  self.useanimgoalweight = 0;
  self._id_10F8C = undefined;
}

_id_9EB9(var_0, var_1, var_2, var_3) {
...
_id_1007F(var_0, var_1, var_2, var_3) {
  var_4 = self.node;
  var_5 = angleclamp180(scripts\asm\shared\utility::_id_812D(var_4) - self.angles[1]);
