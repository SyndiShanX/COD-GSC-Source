...
_id_F8F9() {
  ...
  self._id_4D1E.fx = spawnStruct();
  self._id_4D1E.fx._id_BDFF = "capital_un_turret_sml_cheap";
  self._id_4D1E.fx._id_1037F = "capital_turret_smolder_lg";
  self._id_4D1E.fx._id_4CD9 = "capital_turret_damage1_lg";
  self._id_4D1E.fx._id_4CDA = "capital_turret_damage2_lg";
  self._id_4D1E.fx.death = "capital_turret_death_lg";
  self._id_4D1E.fx._id_A865 = "capital_turret_laser_lg";
  self._id_4D1E.fx._id_6D02 = "capital_turret_fire_laser_lg";
...
_id_F8F8() {
  ...
  self._id_4D1E._id_1060D = 50;
  self._id_4D1E.fx = spawnStruct();
  self._id_4D1E.fx._id_BDFF = "capital_turret_muzzle_lg";
  self._id_4D1E.fx._id_1037F = "capital_turret_smolder_lg";
  self._id_4D1E.fx._id_4CD9 = "capital_turret_damage1_lg";
  self._id_4D1E.fx._id_4CDA = "capital_turret_damage2_lg";
  self._id_4D1E.fx.death = "capital_turret_death_lg";
...
_id_F8F7(var_0, var_1, var_2) {
  ...
  self._id_4D1E.fx = spawnStruct();
  self._id_4D1E.fx._id_BDFF = "capital_turret_muzzle_lg";
  self._id_4D1E.fx._id_11A7B = "capital_turret_trace_lg";
  self._id_4D1E.fx._id_1037F = "capital_turret_smolder_lg";
  self._id_4D1E.fx._id_4CD9 = "capital_turret_damage1_lg";
  self._id_4D1E.fx._id_4CDA = "capital_turret_damage2_lg";
  self._id_4D1E.fx.death = "capital_turret_death_lg";
...
_id_F8FE(var_0, var_1, var_2, var_3) {
  ...
  self._id_4D1E.fx = spawnStruct();
  self._id_4D1E.fx._id_BDFF = "capital_turret_sml_cheap";
  self._id_4D1E.fx._id_11A7B = "capital_turret_sml_cheap";
  self._id_4D1E.fx._id_1037F = "capital_turret_smolder_sm";
  self._id_4D1E.fx._id_4CD9 = "capital_turret_damage1_sm";
  self._id_4D1E.fx._id_4CDA = "capital_turret_damage2_sm";
  self._id_4D1E.fx.death = "capital_turret_death_sm";
  ...
  if(isDefined(var_3) && var_3.classname == "script_vehicle_capitalship_missileboat_ca") {
    ...
    self._id_4D1E.fx._id_1037F = "capital_turret_smolder_sm_mb";
    self._id_4D1E.fx.death = "capital_turret_death_sm_mb";
...
_id_F8FF(var_0, var_1, var_2, var_3) {
  _id_F8FE(var_0, var_1, var_2, var_3);
  self._id_4D1E.fx._id_BDFF = "capital_turret_sml_mons_cheap";
  self._id_10241._id_6CF8 = _id_0BB6::_id_6D4D;
...
_id_F8F6(var_0, var_1, var_2) {
  ...
  self._id_4D1E.fx = spawnStruct();
  self._id_4D1E.fx._id_BDFF = "capital_turret_flak_cheap";
  self._id_4D1E.fx._id_11A7B = "capital_turret_flak_cheap";
  self._id_4D1E.fx._id_1037F = "capital_turret_smolder_md";
  self._id_4D1E.fx._id_4CD9 = "capital_turret_damage1_md";
  self._id_4D1E.fx._id_4CDA = "capital_turret_damage2_md";
  self._id_4D1E.fx.death = "capital_turret_death_md";
  self._id_4D1E.fx._id_69DA = "capital_turret_explosion_md";
  self._id_934D = "turret";
  self._id_10241 = spawnStruct();
  self._id_10241._id_6D20 = 3;
...
_id_F8FD(var_0, var_1, var_2) {
  ...
  self._id_4D1E._id_32B2 = self._id_4D1E._id_B428;
  self._id_4D1E.fx = spawnStruct();
  self._id_4D1E.fx._id_BDFF = "capital_turret_muzzle_md";
  self._id_4D1E.fx._id_11A7B = "capital_turret_trace_md";
  self._id_4D1E.fx._id_1037F = "capital_turret_smolder_md";
  self._id_4D1E.fx._id_4CD9 = "capital_turret_damage1_md";
  self._id_4D1E.fx._id_4CDA = "capital_turret_damage2_md";
  self._id_4D1E.fx.death = "capital_turret_death_md";
...
_id_F8FA(var_0, var_1, var_2) {
  ...
  self._id_4D1E._id_1060D = 500;
  self._id_4D1E.fx = spawnStruct();
  self._id_4D1E.fx._id_BDFF = "capital_turret_muzzle_smt";
  self._id_4D1E.fx._id_BE00 = 256;
  self._id_4D1E.fx._id_1037F = "capital_turret_smolder_smt";
  self._id_4D1E.fx._id_4CD9 = "capital_turret_damage1_smt";
  self._id_4D1E.fx._id_4CDA = "capital_turret_damage2_smt";
  self._id_4D1E.fx.death = "capital_turret_death_smt";
  self._id_4D1E.fx._id_B036 = "capital_missile_flare_smt";
  self._id_4D1E.fx._id_69DA = "capital_missile_imp_airburst_smt";
...
_id_F8FB(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(var_3) && var_3.classname == "script_vehicle_capitalship_missileboat_ca") {
    ...
    self._id_4D1E.fx._id_1037F = "capital_turret_smolder_smt_mb";
    self._id_4D1E.fx.death = "capital_turret_death_smt_mb";
  }
...
_id_F9DB(var_0, var_1) {
  ...
  self._id_4D1E._id_1060D = 1;
  self._id_4D1E.fx = spawnStruct();
  self._id_4D1E.fx._id_BDFF = "capital_turret_muzzle_sm";
  self._id_4D1E.fx._id_BE00 = 60;
  self._id_4D1E.fx._id_11A7B = "capital_turret_trace_sm";
  self._id_4D1E.fx._id_1037F = "capital_turret_smolder_sm";
  self._id_4D1E.fx._id_4CD9 = "capital_turret_damage1_sm";
  self._id_4D1E.fx._id_4CDA = "capital_turret_damage2_sm";
  self._id_4D1E.fx.death = "capital_turret_death_sm";
...
_id_B878(var_0, var_1, var_2) {
  ...
  var_0._id_BEED = scripts\engine\utility::spawn_tag_origin();
  ...
  var_0._id_4D1E.fx = spawnStruct();
  var_0._id_4D1E.fx._id_BDFF = "capital_turret_muzzle_sm";
  var_0._id_4D1E.fx._id_BE00 = 60;
  var_0._id_4D1E.fx._id_11A7B = "capital_turret_trace_sm";
  var_0._id_4D1E.fx._id_1037F = "capital_turret_smoke_trail";
  var_0._id_4D1E.fx._id_4CD9 = "capital_turret_damage1_sm";
  var_0._id_4D1E.fx._id_4CDA = "capital_turret_damage2_sm";
  var_0._id_4D1E.fx.death = "capital_turret_death_md";
  var_0._id_4D1E.fx._id_B036 = "capital_missile_flare_smt";
  var_0._id_4D1E.fx._id_69DA = "capital_missile_imp_airburst_smt";
