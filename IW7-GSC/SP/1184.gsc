...
main() {
  ...
  self attach("head_bg_var_head_sc_male_11_head_bg_male_09", "", 1);
  self.headmodel = "head_bg_var_head_sc_male_11_head_bg_male_09";
...
precache() {
  ...
  precachemodel("head_bg_var_head_sc_male_11_head_bg_male_09");
