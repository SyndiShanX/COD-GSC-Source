...
main(var_0, var_1, var_2) {
  ...
  scripts\sp\vehicle_build::_id_3186(var_0, var_0);
  ...
  scripts\sp\vehicle_build::_id_3184("vfx/iw7/core/vehicle/dropship/vfx_dropship_hit_damage.vfx", "tag_back_thruster_1_ri", "dropship_helicopter_hit", undefined, undefined, undefined, undefined, undefined, undefined, 10, 5);
  scripts\sp\vehicle_build::_id_3184("vfx/iw7/core/vehicle/dropship/vfx_dropship_hit_damage.vfx", "tag_frontsidethrsuter_ri", "dropship_helicopter_secondary_exp", undefined, undefined, undefined, 0.45, undefined, undefined, 10, 5);
  scripts\sp\vehicle_build::_id_3184("vfx/iw7/core/vehicle/dropship/vfx_dropship_hit_damage.vfx", "j_frontlandinggear", "dropship_helicopter_secondary_exp", undefined, undefined, undefined, 1.5, undefined, undefined, 10, 5);
  scripts\sp\vehicle_build::_id_3184("vfx/iw7/core/vehicle/dropship/vfx_dropship_hit_damage.vfx", "tag_back_thruster_1_le", "dropship_helicopter_secondary_exp", undefined, undefined, undefined, 3, undefined, undefined, 10, 5);
  scripts\sp\vehicle_build::_id_3184("vfx/iw7/core/vehicle/dropship/vfx_dropship_hit_damage.vfx", "tag_frontsidethruster_le", "dropship_helicopter_secondary_exp", undefined, undefined, undefined, 5, undefined, undefined, 10, 5);
  ...
  scripts\sp\vehicle_build::_id_31A2(::_id_F77B);
...
init_location() {
  ...
  scripts\sp\utility::_id_65E0("side_thrusters_out");
  self._id_12BBF = 150;
  ...
  if(issubstr(self.classname, "player")) {
    ...
    self._id_4D94._id_EF3C = [];
    self._id_4D94._id_EF3C["cabin_lights"] = [];
    ...
    foreach(var_6 in var_4) {
      var_7 = scripts\sp\anim::_id_1EE5("veh_mil_air_un_dropship_hero_interior_light", var_6);
      var_7.targetname = "dropship_cabin_lights_" + self._id_6A0B;
      self._id_4D94._id_EF3C["cabin_lights"][self._id_4D94._id_EF3C["cabin_lights"].size] = var_7;
    }
    ...
    foreach(var_6 in ["TAG_CARABINER_HANDLE_LE_1", "TAG_CARABINER_HANDLE_LE_2", "TAG_CARABINER_HANDLE_RI_1", "TAG_CARABINER_HANDLE_RI_2"]) {
      ...
      var_11._id_1FBD = var_11 scripts\engine\utility::spawn_tag_origin();
      var_11.tag = var_6;
      self._id_4D94.parts["straps"][self._id_4D94.parts["straps"].size] = var_11;
      var_11._id_1FBD linkTo(self, var_6, (0, 0, 0), (0, 0, 0));
      var_11 linkTo(var_11._id_1FBD, "tag_origin", (0, 0, 0), (0, 0, 0));
    }
  } else
    self attach("veh_mil_air_un_dropship_periph_interior");

  scripts\sp\utility::_id_65E0("left_door_open");
  scripts\sp\utility::_id_65E0("right_door_open");
  scripts\sp\utility::_id_65E0("back_door_open");
  scripts\sp\utility::_id_65E0("left_door_animating");
  scripts\sp\utility::_id_65E0("right_door_animating");
  scripts\sp\utility::_id_65E0("back_door_animating");
  self._id_4D94._id_5A13 = spawnStruct();
  self._id_4D94._id_5A13.tag = "TAG_DOOR_LEFT";
  self._id_4D94._id_5A13._id_4284 = 1;
  self._id_4D94.doors["left"] = self._id_4D94._id_5A13;
  self._id_4D94._id_5A27 = spawnStruct();
  self._id_4D94._id_5A27.tag = "TAG_DOOR_RIGHT";
  self._id_4D94._id_5A27._id_4284 = 1;
  self._id_4D94.doors["right"] = self._id_4D94._id_5A27;
  self._id_4D94._id_5A01 = spawnStruct();
  self._id_4D94._id_5A01.tag = "J_LowerBackDoor1";
  self._id_4D94._id_5A01._id_4284 = 1;
  self._id_4D94.doors["back"] = self._id_4D94._id_5A01;
}

_id_12B58(var_0) {
  if(self._id_101B2 && var_0 > 50) {
    scripts\sp\utility::_id_65DD("side_thrusters_out");
    self _meth_82A2(%vh_dropship_front_thrusters_in);
  ...
  scripts\engine\utility::delaythread(1.5, scripts\sp\utility::_id_65E1, "side_thrusters_out");
  self _meth_82A2(%vh_dropship_front_thrusters_out);
  ...
  for(;;) {
    ...
    if(var_5 < var_2) {
      if(!isDefined(self._id_5ECA)) {
        self._id_5ECA = spawn("script_origin", var_4);
        wait 0.05;
        self._id_5ECA scripts\sp\utility::_id_10461("dropship_lz_debris_lp", var_0, 1, 1);
        wait 1;
      }
      ...
      if(isDefined(self._id_5ECA)) {
        self._id_5ECA _meth_8278(0, 2);
        wait 2;
        self._id_5ECA delete();
      }
    }
...
_id_5DC2() {
  scripts\sp\utility::_id_65DD("dynamicThrusters");
...
_id_F8A1() {
  ...
  var_0[0]._id_92CC = % vh_org_dropship_idle_pilot;
  var_0[1]._id_92CC = % vh_org_dropship_idle_copilot;
  var_0[2]._id_92CC = % vh_org_dropship_unload_guy1_idle;
  var_0[3]._id_92CC = % vh_org_dropship_unload_guy2_idle;
  var_0[4]._id_92CC = % vh_org_dropship_unload_guy3_idle;
  var_0[5]._id_92CC = % vh_org_dropship_unload_guy4_idle;
  var_0[6]._id_92CC = % vh_org_dropship_unload_guy5_idle;
  var_0[7]._id_92CC = % vh_org_dropship_unload_guy6_idle;
  var_0[8]._id_92CC = % vh_org_dropship_unload_guy7_idle;
  var_0[9]._id_92CC = % vh_org_dropship_unload_guy8_idle;
  var_0[2]._id_8028 = % vh_org_dropship_unload_jump_guy1;
  var_0[3]._id_8028 = % vh_org_dropship_unload_jump_guy2;
  var_0[4]._id_8028 = % vh_org_dropship_unload_jump_guy3;
  var_0[5]._id_8028 = % vh_org_dropship_unload_jump_guy4;
  var_0[6]._id_8028 = % vh_org_dropship_unload_jump_guy5;
  var_0[7]._id_8028 = % vh_org_dropship_unload_jump_guy6;
  var_0[8]._id_8028 = % vh_org_dropship_unload_jump_guy7;
  var_0[9]._id_8028 = % vh_org_dropship_unload_jump_guy8;
  var_0[2]._id_802D = % vh_org_dropship_unload_jump_loop_guy1;
  var_0[3]._id_802D = % vh_org_dropship_unload_jump_loop_guy2;
  var_0[4]._id_802D = % vh_org_dropship_unload_jump_loop_guy3;
  var_0[5]._id_802D = % vh_org_dropship_unload_jump_loop_guy4;
  var_0[6]._id_802D = % vh_org_dropship_unload_jump_loop_guy5;
  var_0[7]._id_802D = % vh_org_dropship_unload_jump_loop_guy6;
  var_0[8]._id_802D = % vh_org_dropship_unload_jump_loop_guy7;
  var_0[9]._id_802D = % vh_org_dropship_unload_jump_loop_guy8;
  var_0[2]._id_802C = % vh_org_dropship_unload_land_guy1;
  var_0[3]._id_802C = % vh_org_dropship_unload_land_guy2;
  var_0[4]._id_802C = % vh_org_dropship_unload_land_guy3;
  var_0[5]._id_802C = % vh_org_dropship_unload_land_guy4;
  var_0[6]._id_802C = % vh_org_dropship_unload_land_guy5;
  var_0[7]._id_802C = % vh_org_dropship_unload_land_guy6;
  var_0[8]._id_802C = % vh_org_dropship_unload_land_guy7;
  var_0[9]._id_802C = % vh_org_dropship_unload_land_guy8;
  var_0[2]._id_802E = % vh_org_dropship_unload_guy1;
  var_0[3]._id_802E = % vh_org_dropship_unload_guy2;
  var_0[4]._id_802E = % vh_org_dropship_unload_guy3;
  var_0[5]._id_802E = % vh_org_dropship_unload_guy4;
  var_0[6]._id_802E = % vh_org_dropship_unload_guy5;
  var_0[7]._id_802E = % vh_org_dropship_unload_guy6;
  var_0[8]._id_802E = % vh_org_dropship_unload_guy7;
  var_0[9]._id_802E = % vh_org_dropship_unload_guy8;
  var_0 = _id_FB0C(var_0);
  return var_0;
}
...
_id_F5FC(var_0) {
  var_0[2]._id_131E6 = % vh_dropship_front_door_left_open;
  var_0[2]._id_131E7 = 0;
  var_0[6]._id_131E6 = % vh_dropship_front_door_right_open;
  var_0[6]._id_131E7 = 0;
  return var_0;
}
...
_id_FB0C(var_0) {
  var_0[10]._id_9FEF = 1;
  var_0[10]._id_10220 = "tag_origin";
  var_0[10]._id_92CC = % jsp_dropship_jumpout_apc_idle;
  var_0[10]._id_8028 = % jsp_dropship_jumpout_apc_unload;
  var_0[11]._id_9FEF = 1;
  var_0[11]._id_10220 = "tag_detach";
  var_0[11]._id_92CC = % jsp_dropship_apc_unload_idle;
  var_0[11]._id_8028 = % jsp_dropship_apc_unload;
  return var_0;
}
...
_id_C5F1(var_0, var_1, var_2, var_3) {
  ...
  foreach(var_6 in var_0) {
    var_4 = scripts\engine\utility::array_add(var_4, self._id_4D94.doors[var_6]);
...
_id_1236(var_0, var_1, var_2, var_3) {
  ...
  switch (var_0) {
    case "left":
      if(!isDefined(self._id_4D94._id_5A13)) {
        return;
      }
      if(scripts\sp\utility::_id_65DB("left_door_open") || scripts\sp\utility::_id_65DB("left_door_animating")) {
        return;
      }
      ...
      break;
    case "right":
      if(!isDefined(self._id_4D94._id_5A27)) {
        return;
      }
      if(scripts\sp\utility::_id_65DB("right_door_open") || scripts\sp\utility::_id_65DB("right_door_animating")) {
        return;
      }
      scripts\sp\utility::_id_65E1(var_0 + "_door_animating");
      ...
      break;
    case "back":
      if(!isDefined(self._id_4D94._id_5A01)) {
        return;
      }
      if(scripts\sp\utility::_id_65DB("back_door_open") || scripts\sp\utility::_id_65DB("back_door_animating")) {
        return;
      }
      scripts\sp\utility::_id_65E1(var_0 + "_door_animating");
  ...
  scripts\sp\utility::_id_65DD(var_0 + "_door_animating");
  scripts\sp\utility::_id_65E1(var_0 + "_door_open");
}
...
_id_F365(var_0, var_1) {
  ...
  foreach(var_3 in var_0) {
    switch (var_3) {
      case "left":
        self._id_4D94._id_5A13._id_1EF5 = var_1;
        break;
      case "right":
        self._id_4D94._id_5A27._id_1EF5 = var_1;
        break;
      case "back":
        self._id_4D94._id_5A01._id_1EF5 = var_1;
        break;
      default:
    }
  }
...
_id_F362(var_0, var_1) {
  ...
  foreach(var_3 in var_0) {
    switch (var_3) {
      case "left":
        self._id_4D94._id_5A13._id_1EA9 = var_1;
        break;
      case "right":
        self._id_4D94._id_5A27._id_1EA9 = var_1;
        break;
      case "back":
        self._id_4D94._id_5A01._id_1EA9 = var_1;
        break;
      default:
    }
  }
...
_id_4265(var_0, var_1) {
  ...
  foreach(var_4 in var_0) {
    var_2 = scripts\engine\utility::array_add(var_2, self._id_4D94.doors[var_4]);
...
_id_1221(var_0, var_1) {
  ...
  switch (var_0) {
    case "left":
      ...
      if(!scripts\sp\utility::_id_65DB("left_door_open")) {
        break;
      }
    ...
    case "right":
      ...
      if(!scripts\sp\utility::_id_65DB("right_door_open")) {
        break;
      }
    ...
    case "back":
      ...
      if(!scripts\sp\utility::_id_65DB("back_door_open")) {
        break;
      }
