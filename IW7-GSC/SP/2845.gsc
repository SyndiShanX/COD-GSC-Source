...
init() {
  ...
  level.player scripts\sp\utility::_id_65E0("no_grenade_block_gesture");
  scripts\engine\utility::array_thread(level.players, ::watchgrenadeusage);
  scripts\engine\utility::array_thread(level.players, ::_id_13B17);
...
_id_10408() {
  scripts\sp\utility::_id_9196(1, 1, 1, "sonic");
  wait 0.15;
  scripts\sp\utility::_id_9193("sonic");
}

_id_13995() {
  self endon("death");
  scripts\sp\utility::_id_9187("sonic", 190, ::_id_10409);
  ...
  for(;;) {
    ...
    if(getweaponbasename(var_0) == "iw7_kbs" && scripts\sp\utility::_id_9FFE(var_0)) {
  ...
  for(;;) {
    ...
    switch (var_1) {
      ...
      case "emp":
        ...
        break;
      case "coverwall":
        thread scripts\sp\coverwall::_id_475F(var_0);
        break;
      case "frag_up1":
      case "frag":
...
_id_DBDB(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  ...
  var_13 = scripts\sp\math::_id_C097(var_8, var_10, var_12);
  var_14 = scripts\sp\math::_id_6A8E(var_1, var_11, var_13);
  ...
  wait(var_5);
  thread scripts\sp\utility::_id_AB9A("r_mbradialoverridestrength", var_9["r_mbradialoverridestrength"], var_6);
  thread scripts\sp\utility::_id_AB9A("r_mbradialoverrideradius", var_9["r_mbradialoverrideradius"], var_6);
  scripts\engine\utility::flag_wait_or_timeout("frag_force_delete", var_6);
  setsaveddvar("r_mbenable", var_9["r_mbenable"]);
  setsaveddvar("r_mbRadialOverridePosition", var_9["r_mbRadialOverridePosition"]);
  setsaveddvar("r_mbRadialOverridePositionActive", var_9["r_mbRadialOverridePositionActive"]);
...
_id_734F(var_0) {
  ...
  thread scripts\sp\utility::_id_54EF(var_4);
...
_id_7352(var_0, var_1) {
  ...
  foreach(var_4 in getaiarray("axis")) {
    if(distance(var_4.origin, var_0) <= 256) {
      if(scripts\common\trace::ray_trace_passed(var_4 gettagorigin("j_SpineUpper"), var_0, var_4, scripts\common\trace::create_solid_ai_contents(1))) {
...
_id_7353() {
  scripts\sp\utility::_id_9196(0, 0, 0);
...
_id_1339D(var_0) {
  ...
  var_4 = 40;
  var_5 = 5;
  var_6 = scripts\sp\math::_id_C097(0, var_2, var_1);
  var_7 = scripts\sp\math::_id_6A8E(var_5, var_4, var_6);
