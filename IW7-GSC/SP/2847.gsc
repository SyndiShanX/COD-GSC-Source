...
_id_95B6() {
  ...
  foreach(var_2 in var_0) {
    ...
    var_2._id_5A18 = var_2.targetname;
    var_2._id_5A57 = var_2.script_parameters;
    var_2._id_1FBB = "door";
    var_2 _meth_83D0(#animtree);
    var_2 scripts\sp\utility::_id_65E0("player_used_door");
    var_2 scripts\sp\utility::_id_65E0("player_at_door");
    var_2 scripts\sp\utility::_id_65E0("actor_at_door");
    var_2 scripts\sp\utility::_id_65E0("begin_opening");
    var_2 scripts\sp\utility::_id_65E0("door_opened");
    var_2 scripts\sp\utility::_id_65E0("door_sequence_complete");
    var_2 scripts\sp\utility::_id_65E0("no_anim_reach");
    var_2 scripts\sp\utility::_id_65E0("skip_reach_on_use");

    if(isDefined(var_2._id_EDA0))
      var_2 scripts\sp\utility::_id_65E0(var_2._id_EDA0);

    var_2 scripts\sp\utility::_id_65E0("locked");
...
door_think() {
  if(self._id_5A57 == "airlock" && self.model == "sdf_door_airlock_01")
    scripts\sp\anim::_id_1EC3(self, "airlock_open_player");

  if(isDefined(self._id_EDA0))
    scripts\sp\utility::_id_65E3(self._id_EDA0);
...
_id_1AB0() {
  ...
  scripts\sp\utility::_id_65E1("player_at_door");
  ...
  scripts\sp\anim::_id_1F2C(var_6, "airlock_open_player");

  if(scripts\engine\utility::is_true(self._id_DF3A)) {
...
_id_1AD9() {
  ...
  foreach(var_2 in var_0) {
    ...
    var_2._id_ECCE["back"] = [];
    var_3 = getscriptablearray(var_2.targetname, "targetname");
    ...
    foreach(var_5 in var_3) {
      ...
      var_2._id_ECCE[var_6] = scripts\engine\utility::array_add(var_2._id_ECCE[var_6], var_5);
    ...
    var_2 _id_1AAE();
    var_2 scripts\sp\utility::_id_65E0("cycling");
    var_2 scripts\sp\utility::_id_65E0("cycling_complete");
    thread scripts\engine\utility::play_loopsound_in_space("airlock_light_hum", var_2.origin);

    if(isDefined(var_2.targetname))
      level._id_1AE3[var_2.targetname] = var_2;
  }
...
_id_1AAE() {
  ...
  foreach(var_8 in var_6) {
    foreach(var_4 in var_2[var_8]) {
      ...
      self._id_4CD3[var_8] = scripts\engine\utility::array_add(self._id_4CD3[var_8], var_14);
    }
  }
}
...
_id_1AA9(var_0, var_1, var_2, var_3, var_4) {
  ...
  var_5 scripts\sp\utility::_id_65DD("cycling_complete");
  var_5 scripts\sp\utility::_id_65E1("cycling");
  var_6 = [];
  ...
  scripts\engine\utility::array_thread(var_6, ::_id_1AB1, var_5, "cycling");
  ...
  var_5 scripts\sp\utility::_id_65E1("cycling_complete");
  var_5 scripts\sp\utility::_id_65DD("cycling");
}

_id_1AAB(var_0, var_1, var_2, var_3) {
  var_4 = level._id_1AE3[var_0];
  var_4 scripts\sp\utility::_id_65DD("cycling_complete");
  var_4 scripts\sp\utility::_id_65E1("cycling");
  var_5 = [];
  ...
  var_4._id_4CD5 = 1;
  scripts\engine\utility::array_thread(var_5, ::_id_1AB1, var_4, "cycling");
  scripts\engine\utility::play_sound_in_space("airlock_ext", var_4.origin);
  wait 8.408;
  var_4._id_4CD5 = 0;
  _id_1AD8(var_0, 0, var_2, var_3);
  var_4 scripts\sp\utility::_id_65E1("cycling_complete");
  var_4 scripts\sp\utility::_id_65DD("cycling");
}

_id_1374E(var_0) {
  scripts\engine\utility::flag_wait("airlocks_setup");
  var_1 = level._id_1AE3[var_0];
  var_1 scripts\sp\utility::_id_65E3("cycling_complete");
}
...
_id_1AAD(var_0) {
  ...
  foreach(var_3 in self._id_4CD3[var_1]) {
    ...
    var_8 = combineangles(var_3.angles, self.angles);
    var_9 = spawnStruct();
    var_9.origin = var_6;
    var_9.angles = var_8;
  ...
  if(self.model != "sdf_door_airlock_01") {
    if(isDefined(self.currentstate)) {
      foreach(var_2 in self._id_ACD5) {
        var_3 = _id_1AB4(self.currentstate);

        if(isDefined(var_3))
          killfxontag(scripts\engine\utility::getfx(var_3), var_2, "tag_origin");
      }
    }
...
_id_A852() {
  var_0 = undefined;
  var_1 = [];
  var_2 = scripts\sp\utility::_id_7A8F();
...
_id_A855() {
  ...
  var_0["player"] scripts\sp\anim::_id_1F2C(var_3, "large_door_open_arrive");
  scripts\sp\utility::_id_65E1("player_at_door");
  var_0["player"] thread scripts\sp\anim::_id_1EE7(var_3, "large_door_open_idle");
  scripts\sp\utility::_id_65E3("begin_opening");
  var_0["player"] notify("stop_loop");
  var_0["player"] scripts\sp\anim::_id_1F2C(var_3, "large_door_open");
  var_1 _id_5990();
  var_1 unlink();
  var_2 delete();
}
...
_id_A854(var_0, var_1) {
  ...
  foreach(var_6, var_4 in var_2) {
    ...
    var_4._id_1FBB = "main";
    var_4 scripts\sp\utility::_id_178D(scripts\sp\utility::_id_137AA, "actor_at_door");
    thread _id_A853(var_4, var_5);
  }

  if(isDefined(self._id_454F["player"]))
    scripts\sp\utility::_id_178D(scripts\sp\utility::_id_65E3, "player_at_door");

  scripts\sp\utility::_id_57D5();
  scripts\sp\utility::_id_65E1("actor_at_door");

  if(isDefined(self._id_D45A))
    scripts\sp\utility::_id_65E3("player_at_door");

  scripts\sp\utility::_id_65E1("begin_opening");
  wait(getanimlength(var_0 scripts\sp\utility::_id_7DC1("large_door_open")));
...
_id_A853(var_0, var_1) {
  var_2 = [var_0, var_1];
  var_1 scripts\sp\anim::_id_1F17(var_0, "large_door_open_arrive");
  var_1 scripts\sp\anim::_id_1F2C(var_2, "large_door_open_arrive");
  var_1 thread scripts\sp\anim::_id_1EE7(var_2, "large_door_open_idle");
  var_0 notify("actor_at_door");
  scripts\sp\utility::_id_65E3("begin_opening");
  var_1 notify("stop_loop");
  var_0 _id_0A1E::_id_2386();
  var_1 thread scripts\sp\anim::_id_1F2C(var_2, "large_door_open");
}

buddy_down_skip_post_clear() {
  scripts\sp\utility::_id_65E0("secondary_actors_going_through");
  scripts\sp\utility::_id_65E0("player_prying_open_door");
...
buddy_down_trigger_damage_onflashbang() {
  ...
  self setusefov(180);
  _id_0E46::_id_9016();
  scripts\sp\utility::_id_65E1("player_used_door");
  var_3 = _id_D0A6(_id_5997("intro"));

  if(isDefined(self._id_9AEF))
    level.player thread scripts\sp\utility::play_sound_on_entity(self._id_9AEF);
  ...
  scripts\sp\utility::_id_65E1("player_at_door");
  scripts\sp\utility::_id_65E3("actor_at_door");
  scripts\sp\utility::_id_65E1("begin_opening");
  var_4 = [self, var_3];
  ...
  scripts\sp\utility::_id_65E1("door_opened");
  level notify("buddydoor_player_outro");
  self notify("buddydoor_outro");

  if(isDefined(self._id_427C))
    level.player thread scripts\sp\utility::play_sound_on_entity(self._id_427C);
...
buddy_down_two_enemy_dead_thread(var_0) {
  ...
  var_1 = getanimlength(var_0[0] scripts\sp\utility::_id_7DC1(_id_5997("pull")));
  ...
  for(;;) {
    ...
    scripts\sp\utility::_id_65E1("player_prying_open_door");
    ...
    scripts\engine\utility::array_thread(var_0, ::_id_59F3, self);

    foreach(var_5 in var_0)
    var_5 _meth_83A1();

    scripts\sp\anim::_id_1EC1(var_0, _id_5997("pull"));

    foreach(var_5 in var_0) {
      if(isai(var_5)) {
        var_5 _id_0A1E::_id_2307(::buddyplayerid, _id_0A1E::_id_2385);
        continue;
      }

      var_8 = var_5 scripts\sp\utility::_id_7DC1(_id_5997("pull"));
    ...
    if(isDefined(self._id_C62B))
      level.player thread scripts\sp\utility::play_sound_on_entity(self._id_C62B);

    var_10 = 5;
    var_11 = var_0[0] islegacyagent(var_0[0] scripts\sp\utility::_id_7DC1(_id_5997("pull")));
    var_12 = var_1 * var_11;
    var_12 = var_12 / var_10;

    foreach(var_5 in var_0)
    var_5 _meth_82B1(var_5 scripts\sp\utility::_id_7DC1(_id_5997("pull")), var_10 * -1);

    wait(var_12);
    level.player playRumbleOnEntity("damage_heavy");
    self notify("stop_pry_anim");
    scripts\sp\utility::_id_65DD("player_prying_open_door");
    level.player._id_2704 = 0;
    thread _id_59DE(var_0, _id_5997("idle"), 1);
  }

  if(isDefined(self._id_C62F))
    scripts\engine\utility::stop_loop_sound_on_entity(self._id_C62F);

  if(isDefined(self._id_C634))
    thread scripts\sp\utility::play_sound_on_entity(self._id_C634);
}

_id_2643() {
  while(!scripts\sp\utility::_id_65DB("door_opened")) {
...
buddyplayerid() {
  ...
  var_0 = scripts\sp\utility::_id_7DC1(self._id_130FF _id_5997("pull"));
...
buddyspawn() {
  ...
  if(isDefined(self._id_C62F))
    thread scripts\engine\utility::play_loop_sound_on_entity(self._id_C62F);

  self waittill("buddydoor_pull_failed");

  if(isDefined(self._id_C62F))
    thread scripts\engine\utility::stop_loop_sound_on_entity(self._id_C62F);
...
buddy_down_gunner_damage_thread(var_0) {
  foreach(var_2 in var_0) {
    ...
    scripts\sp\utility::_id_65E0(var_4);
    scripts\sp\utility::_id_65E0(var_3);
  }

  scripts\engine\utility::array_thread(var_0, ::_id_598C);
  var_6 = [];
...
buddy_down_gunner_death(var_0, var_1) {
  ...
  if(var_0 scripts\sp\utility::_id_65DB("skip_reach_on_use"))
    _id_E9FF(var_0);
  else if(!var_0 scripts\sp\utility::_id_65DB("no_anim_reach"))
    var_0 scripts\sp\anim::_id_1F17(self, var_0 _id_5997("intro"));
  ...
  self._id_2412 = 1;
  var_0 scripts\sp\utility::_id_65E1(self._id_1FBB + "_at_door");
  ...
  var_0 scripts\sp\utility::_id_65E1("actor_at_door");
}
...
_id_21E0() {
  ...
  self.collision = scripts\sp\utility::_id_7A8E();
...
_id_21E9(var_0) {
  ...
  if(!_id_0A2F::_id_D9ED(var_0)) {
    ...
    scripts\sp\utility::_id_9145("fluff_messages_loot_room");
  }
}
...
_id_21E5() {
  ...
  if(isDefined(self._id_4386))
    self.collision linkTo(self, self._id_4386);
  else
    self.collision linkTo(self, "j_handle");

  if(scripts\engine\utility::is_true(self._id_72D1)) {
    self notify("stop_door");
    _id_0E46::_id_DFE3();
    self notify("stop_loop");
    var_0 scripts\sp\anim::_id_1EE0(var_0, "open_loot_door");
    ...
    var_0 thread scripts\sp\anim::_id_1F35(var_1, "open_loot_door", "tag_origin");
    var_0 scripts\sp\anim::_id_1F35(var_0, "open_loot_door", "tag_origin");
    self.collision connectpaths();
    var_1 delete();
    level.player _id_5990();
    level.player unlink();
  ...
  if(var_1.size > 0) {
    foreach(var_3 in var_1) {
      if(var_3.targetname == var_0)
        var_3 thread _id_13684(var_3.targetname);
    }
  }
}
...
_id_FA17(var_0) {
  if(isDefined(level._id_E982) && level._id_E982 == 1)
    var_1 = scripts\sp\utility::_id_10639("player_rig_disguise");
  else {
  ...
  var_3 = [var_1, self];
  thread scripts\sp\anim::_id_1EC3(var_1, var_0);
  var_4 = 0.4;
...
_id_3232() {
  ...
  var_5 scripts\sp\anim::_id_1F2C(var_7, "bulkhead_open");
  var_5 thread scripts\sp\anim::_id_1F35(self, "bulkhead_open");
  var_5 scripts\sp\anim::_id_1F2A([self], "bulkhead_open", 0.99);
  var_5 scripts\sp\anim::_id_1F27([self], "bulkhead_open", 0);
  level.player _id_5990();
  level.player unlink();
  var_6 delete();
  scripts\sp\utility::_id_65E1("door_sequence_complete");
...
_id_D0A6(var_0) {
  var_1 = scripts\sp\utility::_id_10639("door_player_rig");
  ...
  foreach(var_5 in var_3) {
    ...
    thread scripts\sp\anim::_id_1EC3(var_5, var_0);
  }
  ...
  level.player setviewangleresistance(30, 30, 30, 30);
  var_1 show();
  var_7 delete();
  return var_1;
}
...
_id_59DE(var_0, var_1, var_2) {
  ...
  foreach(var_5 in var_0) {
    ...
    if(isDefined(var_2))
      thread scripts\sp\anim::_id_1EEA(var_5, var_1, "stop_loop_" + var_5._id_1FBB);
    else
  ...
  if(!isDefined(var_2) && var_3.size > 0) {
    foreach(var_5 in var_3)
    var_5 scripts\sp\utility::_id_178D(scripts\sp\utility::_id_137AA, var_1);
