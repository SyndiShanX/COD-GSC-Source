...
_id_360D(var_0, var_1, var_2, var_3) {
  if(isarray(var_1))
    self._id_EF6D[var_0] = var_1;
  else
    self._id_EF6D[var_0] = [var_1];

  self._id_EF70[var_0] = var_2;

  if(!isDefined(var_3))
    var_3 = 1;

  self._id_EF6E[var_0] = var_3;
}
...
_id_352D(var_0) {
  ...
  self._id_EF6D[var_0] = undefined;
  self._id_EF70[var_0] = undefined;
  self._id_EF6E[var_0] = undefined;

  if(self._id_EF6D.size == 0) {
    self._id_EF6D = undefined;
    self._id_EF70 = undefined;
    self._id_EF6E = undefined;
  }
}
...
_id_3555(var_0, var_1) {
  if(!isDefined(var_1))
    var_1 = 1;

  self._id_13C83[var_0] = var_1;
}
...
_id_1375A(var_0) {
  ...
  if(level.player _meth_84C6("c12AchievementRodeoLeft") && level.player _meth_84C6("c12AchievementRodeoRight") && level.player _meth_84C6("c12AchievementSelfdestruct"))
    scripts\sp\utility::_id_834F("KILL_C12S");
}

_id_35A8(var_0, var_1, var_2, var_3, var_4) {
  if(!isDefined(var_4))
    var_4 = 0;

  scripts\engine\utility::array_thread(var_0, ::_id_3638, var_1, var_2, var_3, var_4);
}

_id_3638(var_0, var_1, var_2, var_3) {
  level.player endon("death");
  var_4 = scripts\engine\utility::spawn_tag_origin(self.origin + (0, 0, 25));
  var_4._id_E297 = 0;
  var_4 endon("death");
  var_4 thread _id_3639(var_0);
  thread _id_363A(var_4, var_3);
  ...
  for(;;) {
    ...
    if(_id_35DB(var_3) && !var_4._id_E297) {
      var_4 _id_0E46::_id_48C4("tag_origin", undefined, undefined, undefined, 5000, 0, 1, 0, 0, var_1, 0, 0);
...
_id_3639(var_0) {
  while(!isDefined(var_0._id_3508))
    wait 0.05;

  var_0._id_3508 scripts\engine\utility::waittill_any("death", "begin_rodeo", "self_destruct");
  self delete();
}
