...
main(var_0) {
  ...
  switch (var_0) {
    ...
    case "script_vehicle_m1a1_abrams_minigun":
      _id_F63D(var_0, "vfx/core/tread/tread_dust_hamburg_cheap.vfx");
      _id_FB0B(var_0, "water");
      _id_FB0B(var_0, "paintedmetal");
      _id_FB0B(var_0, "riotshield");
      break;
    ...
    case "script_vehicle_uk_utility_truck":
      _id_F63D(var_0, "vfx/core/tread/tread_dust_default.vfx");
      _id_FB0B(var_0, "water");
      _id_FB0B(var_0, "rock", undefined);
      _id_FB0B(var_0, "metal", undefined);
      _id_FB0B(var_0, "brick", undefined);
      _id_FB0B(var_0, "plaster", undefined);
      _id_FB0B(var_0, "asphalt", "vfx/core/tread/tread_asphalt_default.vfx");
      _id_FB0B(var_0, "paintedmetal", undefined);
      _id_FB0B(var_0, "riotshield", undefined);
      _id_FB0B(var_0, "snow", "vfx/core/tread/tread_snow_default.vfx");
      _id_FB0B(var_0, "slush", "vfx/core/tread/tread_snow_default.vfx");
      _id_FB0B(var_0, "ice", "vfx/core/tread/tread_ice_default.vfx");
      break;
    ...
    case "script_vehicle_ny_blackhawk":
      _id_F63D(var_0, "vfx/code/tread/heli_dust_default.vfx");
      _id_FB0B(var_0, "water", "vfx/code/tread/heli_water.vfx");
      _id_FB0B(var_0, "snow", "vfx/core/tread/heli_snow_default.vfx");
      _id_FB0B(var_0, "slush", "vfx/core/tread/heli_snow_default.vfx");
      _id_FB0B(var_0, "ice", "vfx/core/tread/heli_snow_default.vfx");
      break;
    ...
    default:
      _id_F63D(var_0, "vfx/core/tread/tread_dust_default.vfx");
      _id_FB0B(var_0, "water");
      _id_FB0B(var_0, "concrete");
      _id_FB0B(var_0, "rock");
      _id_FB0B(var_0, "metal");
      _id_FB0B(var_0, "brick");
      _id_FB0B(var_0, "plaster");
      _id_FB0B(var_0, "asphalt", "vfx/core/tread/tread_asphalt_default.vfx");
      _id_FB0B(var_0, "paintedmetal");
      _id_FB0B(var_0, "riotshield");
      _id_FB0B(var_0, "snow", "vfx/core/tread/tread_snow_default.vfx");
...
_id_FB0B(var_0, var_1, var_2) {
  scripts\sp\vehicle_build::_id_F5FB(var_0, var_1, var_2);
}

_id_F63D(var_0, var_1) {
  var_2 = _id_7D14();
  _id_FB0B(var_0, "none");
