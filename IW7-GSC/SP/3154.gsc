...
_id_F127(var_0, var_1, var_2, var_3) {
  ...
  [self.melee._id_00F2, self.melee.offset] = _id_F14B(self, self.melee.target);
  var_4.melee._id_00F2 = self.melee._id_00F2;
  var_6 = _id_3EB4(var_0, var_2, self.melee._id_00F2);
  var_7 = vectortoyaw(self.origin - self.melee.target.origin);
  var_8 = (0, self.melee.offset + var_7, 0);
  self.melee._id_10D6D = self.angles;
  var_4.melee._id_10D6D = var_8;
  var_4.ignoreme = 1;
  self.ignoreme = 1;
...
_id_D4CE(var_0, var_1, var_2, var_3) {
  self endon(var_1 + "_finished");
  self.melee._id_312F = 1;
  var_4 = self.melee.target;
  var_5 = _id_3EB4(var_0, var_1, self.melee._id_00F2);
  scripts\asm\asm::asm_fireephemeralevent("melee_attack", "begin");
  _id_0F42::_id_B5CB(var_1, 1);

  if(!isDefined(var_4._id_F184)) {
    var_4._id_F184 = 1;

    if(isDefined(var_4._id_46BC) && isDefined(var_4.npcid) && (var_4._id_46BC == "UN" || var_4._id_46BC == "SD")) {
      if(_id_13132(var_4.npcid) && !isDefined(level._id_93A9)) {
        var_6 = var_4._id_46BC + "_" + var_4.npcid + "_reaction_seeker_attack";
  ...
  createnavrepulsor("ent_" + self getentitynumber() + "_seeker_repulsor", -1, self, 250, 1, self.bt._id_652A);
  self animmode("zonly_physics");
  self _meth_81E1(self.melee.target, "tag_sync", 0, 0);
  self clearanim(_id_0A1E::asm_getbodyknob(), 0);
  self _meth_82EA(var_1, var_5, 1, 0, 1);
  scripts\engine\utility::delaythread(0.25, ::_id_F836);
  var_8 = _id_0A1E::_id_231F(var_0, var_1, _id_0C64::_id_B590);
  var_9 = _id_3EB5(var_0, var_1, self.melee._id_00F2);
  self clearanim(_id_0A1E::asm_getbodyknob(), var_2);
  self _meth_82EA(var_1, var_9, 1, var_2, 1);
  childthread _id_F172();
  ...
  self._id_9BB9 = 1;
  thread _id_0E26::_id_F11E();
}

_id_D4CF(var_0, var_1, var_2) {
  destroynavrepulsor("ent_" + self getentitynumber() + "_seeker_repulsor");
...
_id_F148(var_0, var_1, var_2, var_3) {
  level.player.damageshield = 1;
  self._id_55B1 = 1;
  self.ignoreme = 1;
  scripts\sp\utility::_id_9193("default_seeker");
  _id_0F3D::_id_B60F();
  scripts\asm\asm::asm_fireephemeralevent("melee_attack", "begin");
  thread _id_F153();
  _id_0A1E::_id_2364(var_0, var_1, 0.0);
}
...
_id_F142(var_0, var_1) {
  ...
  _id_0E46::_id_48C4("j_body", undefined, undefined, undefined, 1000, 1000, 1, 1);
  var_2 = _id_F13F(var_1);

  if(!isDefined(level.player) || !isDefined(level.player.melee)) {
    return;
  }
  level.player.melee._id_46B6 = var_2;
  _id_0E46::_id_DFE3();
}
...
_id_F143() {
  ...
  var_0 _id_0E46::_id_48C4(undefined, undefined, "", undefined, undefined, undefined, 1, 1);
...
_id_F141(var_0) {
  ...
  self.melee._id_B5FE settext(&"SCRIPT_PLATFORM_HINT_MELEE_TAP");
  ...
  self.melee._id_B5FE fadeovertime(var_1);
  self.melee._id_B5FE changefontscaleovertime(var_1);
...
_id_F149(var_0, var_1, var_2, var_3) {
  var_4 = _id_F130();
  var_5 = var_4["seekerMeleeGrab_win"];
  var_6 = level.player.melee._id_E505;
  thread _id_0F3D::_id_50E8(0.2);
  thread _id_0F3D::_id_510F(0.2, 65, 0.4);
  var_6 _meth_82E4("meleeCounter", var_5, var_6._id_E6E5, 1, 0.2, 1);
  var_6 thread scripts\sp\anim::_id_10CBF(var_6, "meleeCounter");
  var_6 thread scripts\anim\shared::donotetracks("meleeCounter", ::_id_F145);
  var_7 = _id_0A1E::asm_getallanimsforstate(var_0, var_1);
  self clearanim(_id_0A1E::asm_getbodyknob(), var_2);
  playworldsound("seeker_expl_beep", self.origin);
  thread _id_F116();
  self _meth_82E7(var_1, var_7, 1.0, var_2, 1.0);
...
_id_F13E(var_0) {
  if(isDefined(self._id_9BB9) && self._id_9BB9) {
    return;
  }
  level.player viewkick(50, self.origin);
  level.player _meth_80D1();
  self._id_9BB9 = 1;
  thread _id_0E26::_id_F11E(1, var_0);
  wait 0.1;
...
_id_F116() {
  ...
  for(;;) {
    ...
    if(var_2["hittype"] != "hittype_none") {
      _id_F13E(var_2["position"]);
      return;
    }
  }
}

_id_F147(var_0, var_1, var_2, var_3) {
