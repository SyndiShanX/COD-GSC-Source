...
_id_39E8(var_0) {
  ...
  if(!scripts\sp\utility::_id_65DF("hold_fire"))
...
_id_39E0(var_0) {
  ...
  switch (var_2) {
    ...
    case "cannon_small_ca":
      var_5 _id_0BB7::_id_F8FE(self.script_team, var_3, var_4, self);
      break;
    case "cannon_small_ca_mons":
      var_5 _id_0BB7::_id_F8FF(self.script_team, var_3, var_4, self);
      break;
    case "cannon_small_un":
      var_5 _id_0BB7::_id_F8FE(self.script_team, var_3, var_4, self);
      break;
    case "cannon_flak_ca":
      var_5 _id_0BB7::_id_F8F6(self.script_team, var_3, var_4);
      break;
    case "cannon_missile_ca":
      var_5 _id_0BB7::_id_F8FA(self.script_team, var_3, var_4);
      break;
    case "cannon_missile_long_ca":
      var_5 _id_0BB7::_id_F8FC(self.script_team, var_3, var_4);
      break;
    case "missile_cluster_turret_un":
      var_5 _id_0BB7::_id_F9D6(self.script_team, var_3, var_4);
      break;
    case "cannon_missile_ca_hardpoint":
      var_5 _id_0BB7::_id_F8FB(self.script_team, var_3, var_4, self);
      break;
    case "cannon_large_lock_ca":
      var_5 _id_0BB7::_id_F8F7(self.script_team, var_3, var_4);
      break;
    case "cannon_phalanx":
      var_5 _id_0BB7::_id_F8FD(self.script_team, var_3, var_4);
      break;
  ...
  foreach(var_3 in var_0) {
    ...
    if(isDefined(var_4[3])) {
      for(var_7 = 3; isDefined(var_4[var_7]); var_7++) {
        ...
        if(self._id_12A09 == 0 && scripts\sp\utility::hastag(self.model, var_9))
      ...
      for(;;) {
        ...
        if(scripts\sp\utility::hastag(self.model, var_9)) {
          if(isDefined(var_6._id_8B3B) && var_6._id_8B3B)
            ...
            else if(var_5 == "cannon_missile_ca" && scripts\engine\utility::mod(var_7, level._id_C214) == 1)
...
_id_39E7(var_0) {
  _id_13819(var_0, 1);
  scripts\engine\utility::array_thread(var_0, ::_id_129E0);
}
...
_id_107FC(var_0, var_1, var_2, var_3, var_4) {
  ...
  var_6 setleftarc(var_6._id_2103);
  var_6 setrightarc(var_6._id_2107);
  var_6 settoparc(var_6._id_2109);
  var_6 setbottomarc(var_6._id_2100);
...
_id_39ED(var_0, var_1) {
  ...
  if(isDefined(var_0._id_24C4) && var_0.classname != "script_vehicle_corpse") {
    var_3 = scripts\engine\utility::random(var_0._id_24C4);
...
_id_6D4D(var_0, var_1, var_2, var_3) {
  ...
  var_5 = var_4._id_4D1E.fx;

  if(scripts\sp\utility::hastag(self.model, "tag_flash_1") && scripts\sp\utility::hastag(self.model, "tag_flash_2")) {
    var_2 = "tag_flash_1";

    if(scripts\engine\utility::is_true(self._id_6D40)) {
      var_2 = "tag_flash_2";
      self._id_6D40 = 0;
    } else
      self._id_6D40 = 1;

    playFXOnTag(scripts\engine\utility::getfx(var_5._id_BDFF), self, var_2);
  } else if(scripts\sp\utility::hastag(self.model, "TAG_FLASH"))
    playFXOnTag(scripts\engine\utility::getfx(var_5._id_BDFF), self, "TAG_FLASH");
  else
    playFX(scripts\engine\utility::getfx(var_5._id_BDFF), var_0, var_1);
...
_id_399E(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(var_2) && var_2)
    var_4 = scripts\sp\math::_id_C097(level._id_A48E._id_3A04, level._id_A48E._id_3A03, level._id_A056._id_67D9);
  else
    var_4 = scripts\sp\math::_id_C097(level._id_A48E._id_3A06, level._id_A48E._id_3A05, level._id_A056._id_67D9);
  ...
  var_9 = scripts\sp\math::_id_6A8E(350, 900, var_4);
  var_7 = scripts\sp\math::_id_6A8E(800, var_7, var_4);
  var_8 = scripts\sp\math::_id_6A8E(1500, var_8, var_4);
  ...
  var_17 = self.origin;
  var_18 = scripts\sp\math::_id_C097(4000, 30000, var_6);
  var_19 = scripts\sp\math::_id_6A8E(7, 20, var_18);
  var_20 = level._id_D127.spaceship_vel * var_19;
  ...
  var_24 = scripts\sp\math::_id_C097(1000, 35000, var_6);
  var_24 = scripts\sp\math::_id_6A8E(0.1, 0.75, var_24);
  ...
  var_26 = scripts\sp\math::_id_C097(500, 8000, var_6);
  var_27 = scripts\sp\math::_id_6A8E(0.2, 0, var_26);

  if(var_27 > 0.01)
    earthquake(var_27, 0.5, level._id_D127.origin, 20000);

  var_26 = scripts\sp\math::_id_C097(200, 2000, var_6);
  var_28 = scripts\sp\math::_id_6A8E(100, 0, var_26);
  ...
  level._id_D127 dodamage(var_28, var_17, var_25, var_25, "MOD_EXPLOSIVE_BULLET", "spaceship_scripted_miniflak");
}
...
_id_398A(var_0) {
  if(var_0)
    thread scripts\sp\utility::_id_75C4("flak_omni_space", "TAG_ORIGIN");
  else
    thread scripts\sp\utility::_id_75F8("flak_omni_space", "TAG_ORIGIN");
}
...
_id_3966(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  ...
  if(var_1 == 1) {
    self._id_1DF8 = scripts\engine\utility::random(var_8);
...
_id_39E5(var_0, var_1, var_2) {
  ...
  foreach(var_8 in self.turrets) {
    foreach(var_10 in var_8) {
      ...
      var_10._id_1D65 = 1;
      var_10._id_1DF8 = scripts\engine\utility::random(var_4);
...
_id_6D0C(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  if(1) {
    ...
    foreach(var_14 in var_1) {
      ...
      if(isDefined(var_7._id_24C4)) {
        var_15 = scripts\engine\utility::random(var_7._id_24C4);
...
_id_39F0(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(self._id_8B4F["cap_hardpoint_missile_barrage"])) {
    self._id_8B4F["cap_hardpoint_missile_barrage"] = scripts\engine\utility::array_removeundefined(self._id_8B4F["cap_hardpoint_missile_barrage"]);
...
_id_39B5(var_0, var_1, var_2) {
  ...
  for(;;) {
    if(self._id_5099.turrets < var_0) {
      self._id_5099._id_B738 = 0;
...
_id_12A37(var_0, var_1) {
  ...
  if(isDefined(self._id_4D1E) && isDefined(self._id_4D1E.fx._id_BE00)) {
    ...
    var_6 = var_3 * (self._id_4D1E.fx._id_BE00 * var_5);
    var_2 = var_2 + var_6;
  }
...
_id_12A32(var_0) {
  foreach(var_2 in var_0) {
    ...
    var_5 = scripts\common\trace::ray_trace(var_4, var_4 + anglesToForward(var_3) * 7000, undefined, 1);
...
_id_39E3(var_0, var_1) {
  ...
  for(;;) {
    if(self._id_C841 scripts\sp\utility::_id_65DF("player_inside_ship") && self._id_C841 scripts\sp\utility::_id_65DB("player_inside_ship")) {
      wait 1;
      continue;
    }
    ...
    if(isDefined(var_1)) {
      ...
      playFXOnTag(scripts\engine\utility::getfx(self._id_4D1E.fx._id_BDFF), self, var_10);
    }

    while(var_3 > 0) {
      if(_id_12A3B(var_6, self._id_114FB) || scripts\engine\utility::is_true(self._id_C841._id_1D62) || isDefined(self._id_102A6)) {
        self._id_114FB = self;
        _id_B2CA(var_6, 1);
      }
      ...
      if(scripts\sp\utility::_id_D123() && self._id_114FB == level._id_D127) {
        if(isDefined(self._id_10241._id_6D35)) {
          ...
          thread scripts\engine\utility::play_sound_in_space(self._id_10241._id_6D33, self.origin);
      }

      foreach(var_10 in var_2) {
        if(!_id_12A32([var_10])) {
          if(!scripts\engine\utility::is_true(self._id_AF58) && !isDefined(self._id_C841._id_12FBA)) {
            if(isDefined(var_5._id_10943))
    ...
    if(isDefined(var_1)) {
      foreach(var_10 in var_2)
      stopFXOnTag(scripts\engine\utility::getfx(self._id_4D1E.fx._id_BDFF), self, var_10);
    }
...
_id_12A3E(var_0) {
  if(isDefined(self._id_AD42) && isDefined(self._id_C841) && isDefined(self.class_progression_init)) {
...
_id_B2CA(var_0, var_1) {
  ...
  if(isDefined(var_1) && self.classname == "misc_turret") {
    if(self._id_114FB == self || scripts\engine\utility::is_true(self._id_10241._id_102A6) || !self _meth_8540(self._id_114FB.origin))
      _id_11547();
    else
      self settargetentity(self._id_114FB, (0, 0, 0));
  }
...
_id_12A46(var_0) {
  ...
  for(;;) {
    ...
    if(isDefined(self._id_C841))
      var_2 = self._id_C841 vehicle_getvelocity();

    var_3 = (0, 0, 0);

    if(isDefined(level._id_D127) && var_0 == level._id_D127 && scripts\sp\utility::_id_D123())
    ...
    var_5 = projectileintercept(var_4, var_2, 20000, var_0.origin, var_3);
...
_id_11547() {
  if(isDefined(self._id_C841._id_102A9) && !isDefined(self._id_102A8)) {
    ...
    while(var_0 < 10) {
      var_1 = scripts\engine\utility::random(self._id_C841._id_102A9);
...
_id_B2CB(var_0, var_1, var_2) {
  ...
  foreach(var_4 in var_0) {
    ...
    if(var_4.team != self.team && !scripts\engine\utility::is_true(var_4._id_12A88)) {
...
_id_6D4F(var_0, var_1, var_2, var_3) {
  ...
  var_5 = self._id_4D1E.fx._id_11A7B;
...
_id_6D4E(var_0, var_1, var_2, var_3) {
  var_4 = self._id_4D1E.fx._id_A865;
  var_5 = self._id_4D1E.fx._id_6D02;
  var_6 = self._id_4D1E.fx._id_11A7B;
  var_7 = var_0 + self._id_4D1E._id_DCCA * anglesToForward(var_1);
  var_8 = vectortoangles(vectorNormalize(var_7 - var_0));
  _id_129CA(var_0, var_7, var_8, 1500, self._id_4D1E.fx._id_BDFF, var_2, undefined, "capital_ship_turret_fire");
}
...
_id_6D4C(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  var_11 = self._id_4D1E.fx._id_11A7B;
  thread _id_129CB(var_0, var_8, var_9, 730, self._id_4D1E.fx._id_BDFF, var_2, var_6, undefined, "capital_ship_turret_fire", "flak_explo_space", self._id_4D1E.fx._id_69DA);
}
...
_id_1A8A(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  ...
  var_9 = 0.2;
  var_10 = scripts\sp\math::_id_C097(400, 10000, sqrt(var_8));
  var_11 = scripts\sp\math::_id_6A8E(0.01, var_9, var_10);
...
_id_88BC(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  ...
  var_18 = scripts\sp\math::_id_C097(0, var_13, var_10);
  var_19 = scripts\sp\math::_id_6A8E(var_4._id_B428, var_4._id_B73D, var_18);
  var_20 = scripts\sp\math::_id_6A8E(var_4._id_B465, var_4._id_B753, var_18);
...
_id_54DF(var_0, var_1, var_2) {
  ...
  var_3 dodamage(var_0, var_1, var_2, var_2, "MOD_EXPLOSIVE");
}
...
_id_39B7(var_0, var_1, var_2) {
  ...
  self endon("entitydeleted");
  self.team = self.script_team;
  var_3 = _id_39DC(self.turrets[var_0][0].model);
  var_4 = 0;
  var_5 = 0;
  var_6 = undefined;

  if(isDefined(self.turrets[var_0][0]._id_10241))
    var_6 = self.turrets[var_0][0]._id_10241;
  else if(isDefined(level._id_39DD[self.turrets[var_0][0].class]._id_10241))
    var_6 = level._id_39DD[self.turrets[var_0][0].class]._id_10241;

  if(isDefined(self.turrets[var_0][0]._id_4D1E) && isDefined(self.turrets[var_0][0]._id_4D1E._id_DCCA))
    var_7 = self.turrets[var_0][0]._id_4D1E._id_DCCA;
  else
    var_7 = 5000;
  ...
  for(;;) {
    if(scripts\sp\utility::_id_65DF("player_inside_ship") && scripts\sp\utility::_id_65DB("player_inside_ship")) {
      wait 1;
      continue;
    }
    ...
    while(var_4 > 0) {
      ...
      self.turrets[var_0] = _id_0BA9::_id_DFE9(self.turrets[var_0]);

      if(isDefined(self.turrets[var_0]) && self.turrets[var_0].size == 0) {
        return;
      }
      if(_id_12A3B(var_7, self._id_114FB) || scripts\engine\utility::is_true(self._id_1D62))
        _id_B2CA(var_7);
        ...
        foreach(var_15 in self.turrets[var_0]) {
          if(isDefined(var_15)) {
            foreach(var_11 in var_3) {
              ...
              if(scripts\engine\utility::mod(var_13, level._id_C214) == var_9) {
                var_19 = [];
                var_19[0] = var_11;
...
_id_39B8(var_0, var_1, var_2, var_3, var_4) {
  ...
  self endon("entitydeleted");
  self.team = self.script_team;
  self._id_8B4F[var_0] = scripts\engine\utility::array_removeundefined(self._id_8B4F[var_0]);

  if(self._id_8B4F[var_0].size == 0) {
    return;
  }
  var_5 = _id_39DC(self._id_8B4F[var_0][0].model);
  var_6 = 0;
  var_7 = 0;
  var_8 = undefined;
  ...
  for(;;) {
    ...
    while(var_6 > 0) {
      ...
      else if(_id_12A3B(var_9, self._id_114FB) || scripts\engine\utility::is_true(self._id_1D62))
        _id_B2CA(var_9);
        ...
        foreach(var_17 in self._id_8B4F[var_0]) {
          if(isDefined(var_17)) {
            ...
            foreach(var_13 in var_5) {
              ...
              if(level._id_C214 == -1 || scripts\engine\utility::mod(var_15, level._id_C214) == var_11) {
                var_22 = [];
                var_22[0] = var_13;
...
_id_399B(var_0, var_1) {
  ...
  scripts\engine\utility::array_thread(self._id_12A69[var_2], ::_id_6D52, self, var_0, var_1);
}
...
_id_6D51(var_0, var_1, var_2, var_3) {
  ...
  if(scripts\engine\utility::is_true(var_3)) {
    ...
    if(isDefined(var_6) && isvalidmissile(var_6) && isDefined(var_4) && isDefined(var_4._id_114FB)) {
      var_6 missile_settargetEnt(var_4._id_114FB);
      return;
    }
  } else {
    ...
    if(isDefined(self._id_4D1E) && isDefined(self._id_4D1E.fx) && isDefined(self._id_4D1E.fx._id_BDFF))
      playFX(scripts\engine\utility::getfx(self._id_4D1E.fx._id_BDFF), var_0, anglesToForward(var_1), anglestoup(var_1));
    else
    ...
    if(isDefined(self._id_4D1E)) {
      ...
      var_6 _id_0B76::_id_A332(var_11, var_12, self, self._id_4D1E.fx._id_B036, undefined, (0, 0, 500), var_10, [self._id_4D1E.fx._id_69DA, "capitalship_cannon_impact", 5], undefined, undefined, undefined, 1);
    } else
    ...
    level.missiles--;
    level._id_B8AD = scripts\engine\utility::array_removeundefined(level._id_B8AD);
  }
}
...
_id_B887(var_0) {
  ...
  if(isDefined(self._id_4D1E) && isDefined(self._id_4D1E.fx) && isDefined(self._id_4D1E.fx._id_B036))
    var_1 = self._id_4D1E.fx._id_B036;
  else
    var_1 = "capital_missile_flare_smt";

  var_2 = "jackal_missile_lp_space";

  if(isDefined(self._id_4D1E) && isDefined(self._id_4D1E.fx) && isDefined(self._id_4D1E.fx._id_69DA))
    var_3 = [self._id_4D1E.fx._id_69DA, "capitalship_missile_impact", 5];
  else
    ...
    if(isDefined(var_6) && isDefined(var_6.team) && isDefined(var_0.owner.team) && var_6.team != var_0.owner.team) {
      ...
      if(isDefined(var_0)) {
        if(isDefined(var_0.owner)) {
          ...
          var_10 = scripts\common\trace::ray_trace(var_0.owner.origin, var_8, [var_0.owner, var_6], undefined, 1);
...
_id_51BB(var_0) {
  ...
  if(isDefined(self) && isDefined(var_0)) {
    ...
    var_7 = scripts\common\trace::ray_trace(var_0.origin, self.origin, [var_0, var_4], undefined, 1);
...
_id_129DF(var_0) {
  ...
  var_1._id_10381 = scripts\engine\utility::array_add(var_1._id_10381, var_2);
  self delete();

  if(isDefined(self._id_4D1E)) {
    playFXOnTag(scripts\engine\utility::getfx(self._id_4D1E.fx.death), var_2, "tag_origin");

    if(isDefined(self._id_4D1E.fx._id_1037F)) {
      playFXOnTag(scripts\engine\utility::getfx(self._id_4D1E.fx._id_1037F), var_2, "tag_origin");
      var_2._id_10380 = self._id_4D1E.fx._id_1037F;
    }
  }
...
_id_12A06() {
  ...
  self._id_B8A4 = scripts\engine\utility::array_removeundefined(self._id_B8A4);
...
_id_1150D(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  ...
  target_drawsquare(var_0);
  target_drawsingle(var_0);
  target_drawcornersonly(var_0, 1);

  if(isDefined(var_2))
    target_setcolor(var_0, var_2);

  target_setmaxsize(var_0, var_6);
  target_setminsize(var_0, var_5, 0);
  ...
  foreach(var_3 in self.turrets) {
    foreach(var_5 in var_3) {
      if(ispointinvolume(var_5.origin, var_1)) {
        var_5 scripts\sp\utility::_id_F40A("enemy", 0, 0);
...
_id_8933(var_0) {
  ...
  level._id_FD6C._id_4C11 = level.player scripts\sp\hud_util::_id_4999("default", 2);
  level._id_FD6C._id_4C11.hidewheninmenu = 1;
  level._id_FD6C._id_4C11.hidewhendead = 1;
  level._id_FD6C._id_4C11.alignx = "left";
  level._id_FD6C._id_4C11.aligny = "top";
  level._id_FD6C._id_4C11.horzalign = "left";
  level._id_FD6C._id_4C11.vertalign = "top";
  level._id_FD6C._id_4C11.alpha = 1;
  level._id_FD6C._id_4C11.font = "default";
  level._id_FD6C._id_4C11.color = (1, 1, 1);
  ...
  level._id_FD6C._id_4C11 settext(scripts\sp\utility::string(level._id_12A91) + " / " + scripts\sp\utility::string(level._id_B4D0) + " Turrets");
}
...
_id_409E() {
  ...
  if(isDefined(level._id_FD6C) && isDefined(level._id_FD6C._id_4C11)) {
    level._id_FD6C._id_4C11 settext("Turrets Destroyed");
...
_id_B7EA() {
  ...
  self._id_912F = [];
  self._id_912F["lock_on"] = scripts\sp\hud_util::_id_499B("hud_iw7_warning", 256, 64);
  self._id_912F["lock_on"].alignx = "center";
  self._id_912F["lock_on"].aligny = "top";
  self._id_912F["lock_on"].horzalign = "center";
  self._id_912F["lock_on"].vertalign = "top";
  self._id_912F["lock_on"].y = 50;
  self._id_912F["lock_on"].foreground = 0;
  self._id_912F["lock_on"].alpha = 0;
  self._id_912F["lock_on"].sort = -99;
  var_0 = 22;
  var_1 = 16;
  var_2 = 0.25;
...
_id_11AA8(var_0) {
  ...
  var_0._id_928C.color = (1, 0, 0);
  var_0._id_928C.alpha = 0.5;
  var_0._id_928C setwaypoint(0, 1, 1);
  var_0._id_928C settargetEnt(var_0);
  var_0._id_928C thread _id_9141(0.1, 0.1, 0.9, "death");
  self._id_AEEF = scripts\engine\utility::array_add(self._id_AEEF, var_0);
...
_id_88FE() {
  ...
  self._id_912F["lock_on"] scripts\engine\utility::waittill_any_timeout(2, "stop_locking");
  thread _id_88FC();
...
_id_4098() {
  for(;;) {
    if(scripts\engine\utility::is_true(level.player._id_912F["lock_on"]._id_AF21))
...
_id_4335(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(var_1.script_linkto))
    var_5 = var_1 scripts\sp\utility::_id_7A97();
...
_id_433B(var_0) {
  thread _id_4337();
  self endon("death");
  self missile_settargetEnt(level._id_D127, scripts\engine\utility::randomvectorrange(200, 400));
...
_id_4339() {
  ...
  target_setshader(self, "apache_target_lock");
  target_setminsize(self, 15, 0);
  target_setmaxsize(self, 20, 0);
}
