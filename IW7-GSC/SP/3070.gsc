...
_id_EF2B(var_0) {
  ...
  _id_EF2C(var_0.partname, var_1);
}

_id_EF2C(var_0, var_1) {
  ...
  thread _id_0A0B::_id_F592(var_0, "dismember", 0.05);

  if(isDefined(self._id_2023) && self._id_2023 != "get_up" && self._id_2023 != "fall") {
    return;
  }
...
_id_5675() {
  ...
  if(_id_0A0B::_id_2040())
    ...
    _id_E1B1(3000);
    self.bt._id_5661 = 0;
  } else if(var_0 || _id_0A0B::_id_AB53()) {
...
_id_566B() {
  ...
  if(isDefined(self._id_2A8F)) {
    ...
    if(var_6) {
      self _meth_8321();
      scripts\anim\shared::_id_5D19();
      scripts\asm\asm_bb::_id_2977(1);
      self.bt._id_5661 = 6;
      return;
    }

    self.bt._id_FEDB = "full";
    self.bt._id_FED8 = 1;
    self.bt._id_5661 = 5;
  }
}
...
_id_11A13() {
  if(isDefined(self.bt._id_11A14)) {
    return;
  }
  if(isDefined(self.bt._id_5615)) {
    return;
  }
  if(!isDefined(self._blackboard.scriptableparts)) {
    return;
  }
  if(randomint(100) > anim._id_33BB) {
    return;
  }
...
_id_F1FC(var_0) {
  ...
  self.bt.instancedata[var_0] = var_1 + self.bt._id_F1FE;
}

_id_F1FB(var_0) {
  var_1 = gettime();

  if(isDefined(self.bt._id_3127)) {
    self.bt._id_3127 = undefined;
    return anim.failure;
  }
...
_id_E1B2(var_0) {
  ...
  self.bt._id_3128 = 1;
  self.bt._id_F210 = var_0;
}

_id_41DB() {
  self.bt._id_3128 = undefined;
  self.bt._id_F210 = undefined;
}
...
_id_F20F(var_0) {
  var_1 = gettime();
  self.bt.instancedata[var_0] = var_1 + self.bt._id_F210;
}
...
_id_F201(var_0) {
  ...
  self.bt.instancedata[var_0]._id_BFB5 = var_1;
  self.bt.instancedata[var_0]._id_BFA1 = var_1 + 1000;
  self.noturnanims = 1;
  self.ignoreall = 1;
  _id_E1B1(randomintrange(4000, 7000));
}
...
_id_F202(var_0) {
  ...
  if(var_1 >= self.bt.instancedata[var_0]._id_BFB5) {
    var_2 = 1000000;
    var_3 = 100;
    self.bt.instancedata[var_0]._id_BFA1 = var_1 + 500;
    self.bt.instancedata[var_0]._id_BFB5 = var_1 + randomintrange(1000, 4000);
    var_4 = undefined;
...
_id_F209(var_0) {
  ...
  if(var_1 >= self.bt.instancedata[var_0]._id_BFB5) {
    ...
    if(isDefined(var_2)) {
      self.bt.instancedata[var_0]._id_BFA1 = var_1 + 1000;
      self.bt.instancedata[var_0]._id_BFB5 = var_1 + 3000;
      self.goalradius = 80;
      self.bt._id_F1EE = var_2;
...
_id_F205(var_0) {
  ...
  thread _id_F1F5(var_4);
  var_5 = gettime();
  self.bt.instancedata[var_0] = spawnStruct();
  self.bt.instancedata[var_0]._id_10D7A = var_5 + 500;
  self.bt.instancedata[var_0]._id_11064 = var_5 + 500 + var_4 * 1000;
}
...
_id_8C53(var_0) {
  _id_E1B1(randomintrange(5000, 10000));
  self.bt.instancedata[var_0] = gettime();
  self _meth_82B1(_id_0A1E::_id_2342(), 1.5);
  self.goalradius = 1000;
  self.team = "team3";
  self.ignoreall = 0;
  self _meth_8481(self.origin);
  self.btgoalradius = 500;
  self.ignoreme = 1;
  self._id_2894 = 2;
  thread _id_8C93();
}
...
_id_12F13(var_0) {
  ...
  if(isalive(self.enemy))
    ...
    foreach(var_7 in var_4) {
      ...
      if(isDefined(var_7.a) && isDefined(var_7.a._id_58DA)) {
        continue;
      }
      if(var_7.ignoreme) {
        continue;
...
_id_F1F8() {
  ...
  if(isDefined(self.bt._id_F1EE)) {
    var_0 = 1;
    var_1 = 180;
    var_2 = distance(self.origin, self.bt._id_F1EE.origin);
    var_3 = var_2 / var_1 + var_0;
    thread _id_F1F5(var_3);
    wait 0.5;
    var_4 = squared(96);
    ...
    for(;;) {
      ...
      if(distancesquared(self.origin, self.bt._id_F1EE.origin) <= var_4) {
        break;
      }
...
_id_F1F5(var_0) {
  ...
  self.bt._id_F1F7 thread _id_F1F6(self, var_0);
}

_id_F1F6(var_0, var_1) {
  self endon("death");
...
_id_F1F1(var_0, var_1, var_2, var_3) {
...
_id_F20D(var_0, var_1) {
  var_2 = gettime();

  if(!isDefined(self.bt._id_F20D)) {
    var_3 = randomintrange(var_0, var_1);
    self.bt._id_F20D = var_2 + var_3;
  } else if(var_2 >= self.bt._id_F20D) {
    self _meth_81D0();
    return 1;
  }
...
_id_3EDD() {
  ...
  if(!isDefined(self.bt._id_8C94)) {
    if(isDefined(self.damagemod) && self.damagemod == "MOD_MELEE") {
      ...
      var_5 = _id_7D77(var_1);
      self.bt._id_8C94 = var_0[var_5];
...
_id_F1F9(var_0, var_1) {
  ...
  if(!isDefined(self.bt._id_F1F9)) {
    var_3 = randomintrange(var_0, var_1);
    self.bt._id_F1F9 = var_2 + var_3;
    thread _id_F1F5(var_3 * 0.001);
  } else if(var_2 >= self.bt._id_F1F9) {
    self.btgoalradius = 64;
    self _meth_8481(self.origin);
    anim thread[[self.bt._id_71CC]](self);
    return 1;
...
_id_DCAA(var_0, var_1) {
  if(!isDefined(self.bt._id_DCAB)) {
    self.bt._id_DCAB = gettime() + randomintrange(var_0, var_1);
    return;
  }

  if(gettime() < self.bt._id_DCAB) {
    return;
  }
  self.bt._id_DCAB = gettime() + randomintrange(var_0, var_1);
...
_id_4D64(var_0, var_1) {
  ...
  while(var_4 < var_2.size - 1) {
    var_5 = _id_0A0B::_id_7C35(var_2[var_4]);
    var_4++;
