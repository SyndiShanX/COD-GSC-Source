...
_id_96D9() {
  ...
  level.player.death._id_12AEA = ["stand", "running", "crouch", "prone", "explo", "wallrun", "boosting", "zerog", "jackal"];
  level.player.death.deaths = [];
  level.player.death.anims = [];

  foreach(var_1 in level.player.death._id_12AEA)
  level.player.death.anims[var_1] = [];

  _id_DEA9();
  setDvar("player_death_animated", 1);
  level.player scripts\sp\utility::_id_65E0("finished_death_anim");
  var_3 = scripts\engine\utility::random(level.player.death.anims["stand"]);
  setdvarifuninitialized("player_death_last_anim", var_3);
}

_id_DEA9() {
  _id_DED1("fall_left", "ges_player_death_drop1", ["player_death_fall_left", "plr_death_flop"]);
  _id_DED1("fall_back", "ges_player_death_01", ["player_death_fall_back", "plr_death_flop"], ::_id_6B5B);
  _id_DED1("stand_left_hand_grasping", "ges_player_death_02", ["player_death_stand_left", "plr_death_flop"]);
  _id_DED1("explosive_up", "ges_player_death_frag_1", ["player_death_explosive_up", "plr_death_explosion"], ::_id_69FD);
  _id_DED1("crouch_fall_left", "ges_player_death_crouch_drop1", ["player_death_crouch_fall_left", "plr_death_flop"], ::_id_69FD);
  _id_DED1("zerog_back", "ges_player_death_zerog_01", ["player_death_zerog_back", "plr_death_generic"], undefined, 1);
...
_id_DED1(var_0, var_1, var_2, var_3, var_4) {
  var_5 = spawnStruct();
  var_5.name = var_0;
  var_5._id_7789 = var_1;
  var_5._id_10475 = var_2;
  var_5.type = _id_792C(var_0);

  if(isDefined(var_4))
    var_5._id_1C4B = var_4;
  else
    var_5._id_1C4B = 0;

  if(isDefined(var_3))
    var_5._id_74D6 = var_3;

  level.player.death.deaths = scripts\engine\utility::add_to_array(level.player.death.deaths, var_5);
  level.player.death.anims[var_5.type] = scripts\engine\utility::add_to_array(level.player.death.anims[var_5.type], var_5._id_7789);
  return var_5;
}

_id_F55B(var_0) {
  level.player.death._id_D838 = var_0;
}

main() {
  setdvarifuninitialized("player_did_helmet_death", 0);
  level.player thread _id_D2FB();
  ...
  if(scripts\sp\utility::_id_93A6() && scripts\sp\specialist_MAYBE::_id_2C8D()) {
    scripts\sp\analytics::_id_D37D();
    finishplayerdeath(scripts\sp\utility::_id_93AB());
    return;
  }
  ...
  if(level.player scripts\sp\utility::_id_7B93() < 2)
    thread scripts\sp\gameskill::_id_4766(5, 1);

  level.player scripts\sp\utility::_id_1C49(0);
  var_5 = level.player getstance();
  var_6 = undefined;
  var_7 = undefined;
  var_8 = level.player scripts\sp\utility::_id_65DF("zero_gravity") && level.player scripts\sp\utility::_id_65DB("zero_gravity");
  ...
  var_9 = _id_12849(var_5, var_6, var_1, var_3, var_7, var_8);

  if(!var_9) {
    level.player thread _id_ECC6();
    level.player takeallweapons();
  }

  if(!var_9 && isDefined(var_3) && (!isDefined(level.player._id_5818) || !level.player._id_5818)) {
  ...
  if(!scripts\sp\utility::_id_93A6())
    scripts\engine\utility::delaythread(0.05, ::_id_F32D, undefined, var_0, var_1, var_2, var_4);
  else {
    setomnvar("ui_death_hint", 0);
...
_id_12849(var_0, var_1, var_2, var_3, var_4, var_5) {
  if(!_id_CFF2())
    return 0;

  if(isDefined(level.player.death._id_D838)) {
    if(isstring(level.player.death._id_D838))
      var_6 = _id_792B(level.player.death._id_D838);
    else
      var_6 = level.player.death._id_D838;
  } else
    var_6 = _id_CB1D(var_0, var_1, var_2, var_4, var_5);

  if(!isDefined(var_6))
    return 0;
  else {
    setDvar("player_death_last_anim", var_6._id_7789);
    var_8 = _id_96DE(var_0, var_4, var_6._id_1C4B);

    if(var_8) {
      thread _id_77B0(var_6, var_3);
...
_id_CB1D(var_0, var_1, var_2, var_3, var_4) {
  var_5 = undefined;
  ...
  if(var_4) {
    var_5 = _id_12854(level.player.death.anims["zerog"], var_0, var_1);

    if(isDefined(var_5))
      return var_5;
  }

  if(isDefined(var_2) && _id_4D03(var_2) && var_0 == "stand") {
    var_5 = _id_12854(level.player.death.anims["explo"], var_0, var_1);
  ...
  if(isDefined(var_1) && var_0 == "stand") {
    var_5 = _id_12854(level.player.death.anims["running"], var_0, var_1);
  ...
  if(var_0 == "stand") {
    var_5 = _id_12854(level.player.death.anims["stand"], var_0, var_1);
  ...
  if(var_0 == "crouch") {
    var_5 = _id_12854(level.player.death.anims["crouch"], var_0, var_1);
  ...
  if(var_0 == "prone") {
    var_5 = _id_12854(level.player.death.anims["prone"], var_0, var_1);
...
_id_12854(var_0, var_1, var_2, var_3) {
  var_0 = scripts\engine\utility::array_randomize(var_0);

  foreach(var_7, var_5 in var_0) {
    if(_id_9B66(var_5, var_1, var_2)) {
      var_6 = _id_792A(var_5);
      return var_6;
    }
  }
...
_id_9B66(var_0, var_1, var_2) {
  return 1;
}

_id_CCD7(var_0) {
  level.player.ignoreme = 1;
  var_1 = level.player getgestureanimlength(var_0._id_7789);

  if(isDefined(var_0._id_74D6))
    level thread[[var_0._id_74D6]]();

  if(!scripts\sp\utility::_id_93A6()) {
    if(isarray(var_0._id_10475)) {
      foreach(var_3 in var_0._id_10475)
      level.player playSound(var_3);
    } else
      level.player playSound(var_0._id_10475);
  }

  var_5 = level.player forceplaygestureviewmodel(var_0._id_7789, undefined, 0.15, undefined, 1, 1);

  if(var_5)
    level.player thread _id_F32B(var_0);

  level.player scripts\engine\utility::waittill_notify_or_timeout("gesture_stopped", 3);
  level.player scripts\sp\utility::_id_65E1("finished_death_anim");
}

_id_F32B(var_0) {
  while(!isDefined(var_0._id_7789) || !isDefined(var_0.anchor))
    wait 0.05;

  var_1 = var_0._id_7789;
  var_2 = var_0.anchor;
  var_3 = undefined;
  ...
  var_4 = _id_79F3(anglesToForward(self.angles));
  var_5 = _id_79F3(anglestoright(self.angles));
  ...
  if(var_8["hittype"] == "hittype_none") {
    self _meth_823B(var_2, "tag_origin");
    ...
    if(var_2 islinked()) {
      ...
      var_2 _meth_826F(var_6, 1, 0.5, 0.5);
      return;
    }

    var_2 rotateTo(var_6, 1, 0.5, 0.5);
  }
}
...
_id_77B0(var_0, var_1) {
  if(isDefined(level.player._id_9DD2) && level.player._id_9DD2) {
    level.player _id_0E25::_id_D293(0);
    level.player _id_0E49::_id_D093();
  }

  if(isDefined(var_0._id_5965)) {
    return;
  }
  var_2 = 1.5;
...
_id_AB8E(var_0) {
  ...
  for(var_6 = 0; var_6 < var_1; var_6++) {
    ...
    level.player _meth_80D8(var_5, var_5);
    var_4 = var_5;
    wait 0.05;
  }

  level.player _meth_80D8(0, 0);
}

_id_96DE(var_0, var_1, var_2) {
  if(!var_2 && !level.player isonground()) {
    thread _id_BB02();
    level.player thread scripts\sp\utility::_id_C12D("falling_timeout", 1);
  ...
  level._id_7684 = ::empty_breathing_func;
...
_id_ECC6() {
  if(isDefined(level.player.death._id_1025C)) {
    return;
  }
  if(scripts\sp\utility::_id_93A6())
    return 0;
...
_id_2BC7() {
  ...
  level.player.death._id_91AF = [];
  var_0 = ["blood_splat1", "blood_splat2", "blood_drip", "blood_splat_large", "death_overlay"];

  foreach(var_2 in var_0)
  level.player.death._id_91AF[var_2] = _id_48C9();

  level.player.death._id_91AF["death_overlay"] thread _id_4E19();
  level.player.death._id_91AF["blood_drip"] thread _id_2BBF();
  level.player.death._id_91AF["blood_splat_large"] thread _id_A851();
  thread _id_1033D();
}
...
_id_FF31() {
  ...
  if(isDefined(level._id_BFF4))
    return 0;

  if(!isDefined(level.player.helmet) || scripts\sp\utility::_id_93A6() && !scripts\sp\specialist_MAYBE::_id_2C95)
    return 0;

  if(isDefined(level.player.helmet) && isDefined(level.player.helmet._id_13487) && level.player.helmet._id_13487 == "up")
    return 0;
...
_id_CFAE() {
  ...
  foreach(var_2 in var_0) {
    ...
    if(_id_0B1D::_id_385C(level.player getEye(), var_2))
      return 1;
  }
...
_id_1033D() {
  ...
  level.player.death._id_91AF["blood_splat1"].x = var_6;
  level.player.death._id_91AF["blood_splat1"].y = var_7;
  ...
  wait 0.7;
  level.player.death._id_91AF["blood_splat1"] setshader("vfx_ui_player_blood_splat1", var_14, var_15);
  level.player.death._id_91AF["blood_splat1"].alpha = randomfloatrange(var_12, var_13);
  level.player.death._id_91AF["blood_splat2"].x = var_2[0];
  level.player.death._id_91AF["blood_splat2"].y = var_5[0];
  wait 0.5;
  var_14 = randomintrange(var_8, var_9);
  var_15 = randomintrange(var_10, var_11);
  level.player.death._id_91AF["blood_splat2"] setshader("vfx_ui_player_blood_splat2", var_14, var_15);
  level.player.death._id_91AF["blood_splat2"].alpha = randomfloatrange(var_12, var_13);
}
...
_id_11493() {
  ...
  if(weaponinventorytype(var_1) == "altmode")
    var_0[var_0.size] = _id_8005(var_1);
  else {
...
_id_131B8(var_0) {
  ...
  if(!isDefined(var_0._id_00ED) || var_0._id_00ED != "vehicle")
    return 0;
...
_id_5346(var_0) {
  ...
  if(issubstr(var_0._id_00ED, "vehicle"))
    setomnvar("ui_death_hint", 3);
  else
...
_id_F322(var_0) {
  level._id_4C48 = var_0;
}

_id_F32E() {
  if(isDefined(level._id_4C48)) {
    var_0 = level._id_4C48;
...
_id_F32F() {
  ...
  for(var_2 = int(tablelookup("sp/death_hints.csv", 0, var_0, 0)); isDefined(var_2) && var_2 > 0; var_0++) {
    var_1 = var_2;
...
_id_F32D(var_0, var_1, var_2, var_3, var_4) {
  if(level._id_B8D0) {
    return;
  }
  setomnvar("ui_death_hint", 0);
  ...
  if(isDefined(var_0)) {
    ...
    _id_F32F();
    return;
  } else if(var_2 == "MOD_GRENADE" || var_2 == "MOD_GRENADE_SPLASH" || var_2 == "MOD_SUICIDE" || var_2 == "MOD_EXPLOSIVE") {
    if(level._id_7683 >= 2) {
      if(!scripts\sp\gameskill::_id_B327()) {
        _id_F32F();
        return;
      }
    }
    ...
    switch (var_2) {
      case "MOD_SUICIDE":
        if(level.player._id_A994 - gettime() > 3500.0) {
          return;
        }
        setomnvar("ui_death_hint", 2);
        break;
      case "MOD_EXPLOSIVE":
        if(level.player _id_5346(var_1)) {
          return;
        }
        if(level.player _id_131B8(var_4)) {
          return;
        }
        if(level.player _id_69BB(var_4, var_3)) {
          return;
        }
        _id_F32F();
        break;
...
_id_F330(var_0, var_1, var_2, var_3) {
  if(!isDefined(var_3))
    var_3 = 1.5;
...
_id_792C(var_0) {
  ...
  foreach(var_3 in level.player.death._id_12AEA) {
...
_id_792B(var_0) {
  foreach(var_2 in level.player.death.deaths) {
    if(var_2.name == var_0)
      return var_2;
  }
