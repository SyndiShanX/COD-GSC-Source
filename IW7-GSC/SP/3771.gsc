...
main() {
  ...
  var_0._id_EBEA[180] = [%shipcrib_stand_idle02_letsgo_right_02];
  var_0._id_EBEA[270] = [%shipcrib_stand_idle02_letsgo_left_02];
  var_0._id_EBEA["lastanim"] = [%shipcrib_stand_idle02_letsgo_right_02];
  var_0._id_EBEA["trigger_radius"] = 164;
  scripts\sp\interaction::register_interaction("stand_idle_2_back_reaction", var_0);
}