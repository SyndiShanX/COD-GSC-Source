...
main() {
  ...
  self attach("head_bg_var_head_bg_engineering_mate_head_male_bc_02", "", 1);
  self.headmodel = "head_bg_var_head_bg_engineering_mate_head_male_bc_02";
...
precache() {
  ...
  precachemodel("head_bg_var_head_bg_engineering_mate_head_male_bc_02");
