...
_id_4D8A() {
  ...
  while(_id_0E4F::_id_9C7B()) {
    ...
    thread scripts\sp\utility::_id_D2CD(50, 0.1);
    ...
    if(var_8 == 1) {
      ...
      if(var_2["fraction"] > 0.3) {
        ...
        var_15 = self.angles - vectortoangles(var_1);
        var_7 = anglesToForward(var_15) * var_4 * min(1, length(var_1));
    ...
    wait(var_9);
    var_16 = self getlinkedparent();

    if(isDefined(var_16) && var_16 == var_3) {
    ...
    if(_id_9C57()) {
      ...
      scripts\engine\utility::delaythread(var_13, ::_id_AB9C, "player_SwimWaterCurrent", (0, 0, 0), 0.5);
...
_id_9C57() {
  return !isDefined(self.space) || !self.space._id_6F43;
}