...
main() {
  self setModel("body_sdf_army_light_1_scorched_1");
  scripts\code\character::attachhead("alias_heads_sdf_army", _id_09C1::main());
  self.hatmodel = "helmet_sdf_army_light_2_scorched_1";
...
precache() {
  precachemodel("body_sdf_army_light_1_scorched_1");
  scripts\code\character::precachemodelarray(_id_09C1::main());
  precachemodel("helmet_sdf_army_light_2_scorched_1");
