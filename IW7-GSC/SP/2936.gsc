...
unlockspecialist() {
  ...
  if(level.script == "europa") {
    ...
    if(gettime() >= var_0) {
      ...
      scripts\sp\endmission::_id_725B(1);
...
init() {
  ...
  scripts\sp\utility::_id_16EB("helmet_tutorial_hint", &"SPECIALIST_MODE_TUTORIAL_HELMET");
  scripts\sp\utility::_id_16EB("nanoshot_tutorial_hint", &"SPECIALIST_MODE_TUTORIAL_NANOSHOT");
  scripts\sp\utility::_id_16EB("suffocate_tutorial_hint", &"SPECIALIST_MODE_TUTORIAL_SUFFOCATE");
  scripts\sp\utility::_id_16EB("left_arm_tutorial_hint_equipment", &"SPECIALIST_MODE_TUTORIAL_LEFT_ARM_EQUIPMENT");
  scripts\sp\utility::_id_16EB("left_arm_tutorial_hint_melee", &"SPECIALIST_MODE_TUTORIAL_LEFT_ARM_MELEE");
  scripts\sp\utility::_id_16EB("helmet_already_on_tutorial_hint", &"SPECIALIST_MODE_TUTORIAL_HELMET_ALREADY_ON");
  scripts\sp\utility::_id_16EB("nanoshot_tutorial_hint_at_max_health", &"SPECIALIST_MODE_TUTORIAL_NANOSHOT_MAX_HEALTH");
  scripts\sp\utility::_id_16EB("helmet_find", &"SPECIALIST_MODE_TUTORIAL_HELMET_FIND");
  scripts\sp\utility::_id_16EB("helmet_equip", &"SPECIALIST_MODE_TUTORIAL_HELMET_EQUIP");
  scripts\sp\utility::_id_16EB("press_use_pc", &"SPECIALIST_MODE_USE_PC", ::_id_86C8);
  scripts\sp\utility::_id_16EB("press_use_console", &"SPECIALIST_MODE_USE_CONSOLE", ::_id_86C8);
  scripts\sp\utility::_id_16EB("specialist_loadout", &"SPECIALIST_MODE_LOADOUT");
  level._id_10DB5 = 5;
  ...
  level._id_10964 = spawnStruct();
  level._id_10964.allowhints = 1;
  level._id_10964._id_98EC = 0;
  level._id_10964.ignorehelmetfuncs = 1;
  _id_F2D2(0);
  ...
  level._id_10964._id_2610 = spawn("script_origin", level.player.origin);
  level._id_10964._id_2610 linkTo(level.player);
}
...
main() {
  ...
  foreach(var_2 in var_0) {
    self._id_2C19[var_2] = spawnStruct();
    self._id_2C19[var_2].name = var_2;
    self._id_2C19[var_2].maxhealth = 60;
    self._id_2C19[var_2].health = 60;
  }
...
_id_4D05() {
  ...
  for(;;) {
    ...
    if(vectortoangles(var_2) == (90, 0, 0)) {
      thread _id_4D16(scripts\engine\utility::random(["left", "right"]), var_0);
      continue;
    }
    ...
    if(var_8 > 0.79) {
      ...
      thread _id_4D14(var_0, var_4, var_9, var_6);
    } else if(var_8 > 0.61)
      thread _id_4D18(_id_4CFA(var_3, 1), var_0);
    else
      thread _id_4D16(_id_4CFA(var_3, 0), var_0);

    _id_F531(0.55);
    _id_F49E(1);
    thread _id_F49E(0, 1.83);
  }
}

_id_4CFA(var_0, var_1) {
  var_2 = var_0 - level.player.origin;
  var_3 = scripts\sp\math::_id_EB9B(anglestoleft(level.player.angles), var_2);
  var_4 = scripts\sp\math::_id_EB9B(anglestoright(level.player.angles), var_2);
...
_id_4D14(var_0, var_1, var_2, var_3) {
  if(var_1 == "MOD_MELEE")
    var_4 = 0;
  else
    var_4 = 0.422618;
  ...
  if(!scripts\engine\utility::within_fov(level.player.origin, level.player.angles, var_2, var_4)) {
    ...
    thread _id_4D18(scripts\engine\utility::random(var_5), var_0);
  } else {
    if(_id_2C95() && self._id_8E1B < 4) {
      if(isDefined(var_3) && weaponclass(var_3) == "sniper" && self._id_8E1B < 3) {
        self._id_8E1B = 3;
        var_0 = var_0 * 0.75;
      } else
        self._id_8E1B++;

      _id_F52C(level.player.health + var_0);
      ...
      thread _id_25E9("injury", "helmet");

      if(level._id_10964._id_8E1B == 3)
        thread _id_9147(1);
      else if(var_1 == "MOD_MELEE")
        _id_4CFB(0, 1, var_2);
      else
        _id_4CFB(1, 1, var_2);
...
_id_4D16(var_0, var_1) {
  level.player endon("death");

  if(level.player getstance() == "prone")
    thread _id_4D18(var_0, var_1);
  else {
    screenshake(level.player.origin, 10, 20, 5, 0.75);
    var_2 = "leg_" + var_0;
    var_3 = _id_2C94(var_2);
    _id_4CE0(var_2, var_1);

    if(var_3) {
      return;
    }
    if(!_id_2C94(var_2)) {
      thread _id_25E9("injury", "leg", "generic");
      return;
    }

    thread _id_4D12();
    var_4 = _id_2C94("leg_right") && _id_2C94("leg_left");

    if(var_4) {
      thread _id_25E9("injury", "legs", "critical");
      return;
    }

    thread _id_4D39();
    thread _id_25E9("injury", "leg", "critical");
  }
}
...
_id_4D39() {
  ...
  for(;;) {
    ...
    if(scripts\sp\utility::_id_93AC() || _id_2C97()) {
      scripts\sp\utility::_id_AB9A("bg_viewBobMax", 0, 0.5);
      level.player _meth_82B5(0);
    } else if(level.player isonground()) {
      level.player _meth_82B5(var_0);
      scripts\sp\utility::_id_AB9A("bg_viewBobMax", var_1, var_2);
    } else {
      level.player _meth_82B5(1);
      scripts\sp\utility::_id_AB9A("bg_viewBobMax", 7, 0.5);
    }
...
_id_4D12() {
  ...
  if(scripts\sp\utility::_id_93AC()) {
    return;
  }
...
_id_4D18(var_0, var_1) {
  ...
  if(var_0 == "chest")
    thread _id_4D11(var_1);
  else {
    var_2 = "arm_" + var_0;

    if(_id_2C8A() && var_2 == "arm_right") {
      self._id_BF7E = gettime() + 120000 + randomint(120000);
      thread _id_4D1D();
      _id_F52C(level.player.health + var_1);
      return;
    }
    ...
    if(!_id_2C94(var_2)) {
      thread _id_25E9("injury", "arm", "generic");
      return;
    }
    ...
    if(var_2 == "arm_left") {
      ...
      if(_id_2C94("arm_right"))
        thread _id_4D31();
    } else if(var_2 == "arm_right") {
      if(_id_2C94("arm_left"))
        thread _id_4D31();
      else
        thread _id_4D3E();
    }

    var_4 = _id_2C94("arm_right") && _id_2C94("arm_left");

    if(var_4) {
      thread _id_25E9("injury", "arms", "critical");
      return;
    }

    thread _id_25E9("injury", "arm", "critical");
  }
}

_id_4D11(var_0) {
  var_1 = _id_2C94("chest");
  screenshake(level.player.origin, 20, 30, 10, 0.75);
  _id_4CE0("chest", var_0);
  ...
  thread _id_25E9("injury", "chest", "critical");
}
...
_id_4D36() {
  ...
  if(scripts\sp\utility::_id_D0BD("grapplingdevice", 1)) {
...
_id_86CB(var_0) {
  ...
  if(!var_0)
    var_4 thread _id_86CC(var_1, var_2);
  else {
    level.player takeweapon(var_1);
    var_4 _meth_8226(var_4.origin, var_4.origin + anglesToForward(level.player.angles) * 30);
  }
}

_id_86CC(var_0, var_1) {
  var_2 = level.player getcurrentweaponclipammo();
  var_3 = level.player getweaponammostock(var_0);
  ...
  level.player _meth_80D8(0.05, 0.05);
  _id_0B0B::_id_F5A0();
  ...
  thread scripts\sp\utility::_id_C12D("weapon_pickup_failed", 0.5);
  level.player scripts\engine\utility::delaycall(0.5, ::_meth_80DB);
  thread _id_86C9();
  thread _id_86CF(var_0);
  level scripts\engine\utility::waittill_any("weapon_pickup_failed", "player_grabbed_weapon");
  setslowmotion(0.25, 1, 0.4);
  level.player _meth_80D8(1, 1);
  level.player allowmovement(1);
  level.player specialist_allow_invulnerability(0);
  _id_0B0B::_id_F59F();
  thread _id_86CD(var_0, var_2, var_3);
}

_id_86CD(var_0, var_1, var_2) {
  for(;;) {
    ...
    if(scripts\sp\utility::_id_D0CA("iw7_fists_specialist_mode"))
...
_id_86CE(var_0) {
  ...
  while(gettime() < var_2) {
    ...
    var_14 = scripts\sp\math::_id_C097(0, var_4, var_12);
...
gun_drop_while_wallrunning() {
  ...
  self _meth_8226(self.origin, var_1 * 1700);
  wait 0.5;
  level notify("weapon_pickup_failed");
}
...
_id_86C9() {
  if(level.console || level.player usinggamepad())
    scripts\sp\utility::_id_56BE("press_use_console", 0.5);
  else
    scripts\sp\utility::_id_56BE("press_use_pc", 0.5);
}
...
_id_BE54() {
  ...
  foreach(var_2 in var_0)
  thread _id_BE52(var_2);

  _id_F52C(level.player.maxhealth);
}

announce_healed() {
  var_0 = 0;
  var_1 = 0;
  var_2 = _id_2C94("leg_left") || _id_2C94("leg_right");

  if(var_2)
    var_0 = _id_2C94("leg_left") && _id_2C94("leg_right");

  var_3 = _id_2C94("arm_left") || _id_2C94("arm_right");

  if(var_3)
    var_1 = _id_2C94("arm_left") && _id_2C94("arm_right");

  if(!var_2 && var_3) {
    if(var_1) {
      if(scripts\engine\utility::cointoss())
        thread _id_25E9("repair", "arms");
      else
        thread _id_25E9("repair", "status");
    } else
      thread _id_25E9("repair", "arm");
  } else if(var_2 && !var_3) {
    if(var_0) {
      if(scripts\engine\utility::cointoss())
        thread _id_25E9("repair", "legs");
      else
        thread _id_25E9("repair", "status");
    } else
      thread _id_25E9("repair", "leg");
  } else
    thread _id_25E9("repair", "status");
}
...
_id_BE53() {
  ...
  if(var_0) {
    var_1 = 0.25;
    thread scripts\sp\utility::_id_AB9A("bg_viewBobMax", 7, var_1);
    level.player _meth_82B5(0);
...
_id_BE51() {
  if(_id_2C94("arm_left")) {
    ...
    if(scripts\sp\utility::_id_D0BD("grapplingdevice", 1))
      level.player _meth_8503("ges_grapple", "ges_grav_jump_combat_fail", level._id_10533, level._id_10532);
  }
}
...
_id_8DE3() {
  ...
  for(;;) {
    ...
    level._id_10964.togglinghelmet = 1;
    ...
    _id_8E05();
    level._id_10964.togglinghelmet = undefined;
  }
}
...
_id_8DE1() {
  ...
  for(;;) {
    var_0 = level.player._id_4B21;
    level.player waittill("secondary_equipment_change", var_1);

    if(var_1 == "helmet") {
      if(scripts\sp\utility::_id_D0BD("grapplingdevice", 1) && !_id_2C94("arm_left"))
        level.player _meth_8507();
    ...
    if(var_0 == "helmet") {
      if(scripts\sp\utility::_id_D0BD("grapplingdevice", 0) && !_id_2C94("arm_left"))
        level.player _meth_8503("ges_grapple", "ges_grav_jump_combat_fail", level._id_10533, level._id_10532);
...
_id_8E01() {
  level._id_10964._id_BB4A = 1;
  _id_F3FF(0);
}

_id_4CE0(var_0, var_1) {
  var_2 = level._id_10964._id_2C19[var_0];
  var_3 = var_2.health - var_1 <= 30.0;

  if(self._id_BFAA && !var_3) {
    var_4 = var_2.health - var_1 - 30.0;
    var_1 = var_1 + var_4;
    _id_F52C(level.player.health - var_4);
  }
  ...
  if(_id_2C95())
    level._id_10964 thread _id_9151();

  var_5 = var_2.health / var_2.maxhealth;
  self._id_98F1[var_0] notify("hud_flicker_stop");
  self._id_98F1[var_0].alpha_req = 1 - var_5;
}

_id_BE52(var_0) {
  self._id_98F1[var_0.name] notify("hud_flicker_stop");
  self._id_98F1[var_0.name].alpha_req = 0;
  var_0.health = var_0.maxhealth;
}

_id_4CFB(var_0, var_1, var_2) {
  ...
  var_4 = level.player scripts\sp\math::_id_9C86(var_2);
  ...
  if(isDefined(level._id_10964._id_A99C)) {
    var_7 = (var_6[1] - var_6[0]) * 0.5;

    if(level._id_10964._id_A99C > var_7)
  ...
  level._id_10964._id_A99C = var_9;
  thread _id_914F(var_8, var_9, var_0, !var_4);
}

_id_914F(var_0, var_1, var_2, var_3) {
  var_4 = [];
  ...
  level._id_10964.helmetimpacts[level._id_10964.helmetimpacts.size] = var_4;

  if(var_2) {
    var_4["burn"].alpha = 0.7;
    var_10 = 3;
    var_4["burn"] scripts\engine\utility::delaythread(0.5, scripts\sp\hud_util::_id_6AAB, 0, var_10 - 0.5);
    var_4["burn"] thread _id_9175(var_10);
  }

  _id_137D1();

  if(isDefined(level._id_10964._id_BB4A) && level._id_10964._id_BB4A)
    level._id_10964 _id_915F(var_4);

  if(scripts\engine\utility::is_true(level._id_10964.jackalhelmetcrackfade)) {
    level._id_10964 hud_fade_cracks(var_4, var_5, 4);
    level._id_10964.jackalhelmetcrackfade = undefined;
  }
  ...
  scripts\engine\utility::array_removeundefined(level._id_10964.helmetimpacts);
}
...
_id_9147(var_0) {
  ...
  level._id_10964.helmetimpacts[level._id_10964.helmetimpacts.size]["crack"] = var_1;
  _id_137D1();
  var_1 destroy();
}
...
_id_4CE1() {
  ...
  if(isDefined(level._id_10964.helmet))
    level._id_10964.helmet hide();
  ...
  for(;;) {
    ...
    while(gettime() < var_0) {
      ...
      if(_id_2C95()) {
        ...
        scripts\engine\utility::delaythread(2, ::_id_25E9, "repair", "oxygen");
...
hide_helmet_impacts() {
  if(!isDefined(level._id_10964.helmetimpacts)) {
    return;
  }
  foreach(var_1 in level._id_10964.helmetimpacts) {
...
_id_8E05() {
  ...
  if(!isDefined(level._id_10964.helmet)) {
    level._id_10964.helmet = spawn("script_model", level.player.origin);
    level._id_10964.helmet setModel("vm_hero_protagonist_helmet");
    level._id_10964.helmet _meth_81E2(level.player, "tag_playerhelmet", (0, 0, 0), (0, 0, 0), 1, "view_jostle");
    level._id_10964.helmet notsolid();
  }

  level.player blendlinktoplayerviewmotion(0.25, 0);
  level._id_10964.helmet show();
  level._id_10964.helmet _meth_83D0(#animtree);
  level._id_10964.helmet clearanim(%vm_gesture_visor_up_visor, 0);
  level._id_10964.helmet _meth_82A2(%vm_gesture_visor_down_visor);
  thread _id_0E4B::_id_8DE2();
...
_id_4E1A(var_0) {
  ...
  if(scripts\sp\utility::_id_93AB()) {
    ...
    updategamerprofile();
    scripts\sp\endmission::_id_41ED();
  }
  ...
  level.player playRumbleOnEntity("grenade_rumble");
  playFX(level._id_7649["human_gib_head"], level.player getEye(), anglesToForward(level.player.angles), anglestoleft(level.player.angles));
  playFX(level._id_7649["human_gib_fullbody"], level.player getEye() + (0, 0, 5));
  playworldsound("bullet_large_flesh_head_npc", level.player getEye());
  playworldsound("bullet_impact_headshot", level.player getEye());
  self._id_98F1["pristine"].foreground = 1;
  self._id_98F1["pristine"].alpha_req = 0.5;
  self._id_98F1["skull"].alpha_req = 0.5;
  ...
  level.player _meth_823B(var_2, "tag_origin");
  _id_F52C(1);
  level.player specialist_allow_invulnerability(1);
  level.player _meth_84FE();
  level.player.ignoreme = 1;
  var_2 thread _id_4E10();
}
...
_id_4E10() {
  ...
  if(var_1 == "prone" || !var_0 || scripts\sp\utility::_id_93AC()) {
    wait 4;
    level.player _meth_80A1();
    level.player _meth_81D0();
    scripts\sp\utility::_id_B8D1();
...
_id_4E0F() {
  for(var_0 = 0; var_0 < 4; var_0++) {
    ...
    playFX(level._id_7649["human_gib_head"], level.player getEye() + (0, 0, 5));
  }
}
...
_id_4E1B() {
  ...
  if(scripts\sp\utility::_id_93AB())
    ...
    if(_id_2C96("nanoshot", 0, 1))
      var_1 = 200;

    if(randomint(100) < 40) {
      if(var_0 == "headshot_death" && !_id_2C96("helmet", 0, 1))
        var_1 = 203;
    ...
    if(level._id_10964._id_D430) {
      if(_id_2C96("helmet", 0, 1))
        var_1 = 202;
      else
        var_1 = 208;
    }
...
_id_12AAC() {
  ...
  for(;;) {
    ...
    if(!isDefined(level.player._id_1586) && var_1 == "actionslot_weapon_pressed") {
      continue;
    }
    if(_id_2C97()) {
      continue;
    ...
    var_2 = scripts\sp\utility::_id_7BD6();

    if(isDefined(var_2) && var_2 == "nanoshot" && var_1 == "frag_pressed") {
      continue;
    }
    level._id_10964._id_58DE = 1;
    thread scripts\sp\utility::_id_56BE("left_arm_tutorial_hint_equipment", var_0);
    wait(var_0);
    level._id_10964._id_58DE = 0;
    level._id_10964 notify("tutorial_over");
  }
}
...
_id_12AAD() {
  ...
  for(;;) {
    ...
    level._id_10964._id_58DE = 1;
    thread scripts\sp\utility::_id_56BE("left_arm_tutorial_hint_melee", var_0);
    wait(var_0);
    level._id_10964._id_58DE = 0;
    level._id_10964 notify("tutorial_over");
  }
...
_id_12AAB() {
  ...
  for(;;) {
    ...
    var_1 = scripts\sp\utility::_id_7C3D();
    ...
    if(level._id_10964._id_8E1B > 0) {
      continue;
    }
    level._id_10964._id_58DE = 1;
    thread scripts\sp\utility::_id_56BE("helmet_already_on_tutorial_hint", var_0);
    wait(var_0);
    level._id_10964._id_58DE = 0;
    level._id_10964 notify("tutorial_over");
  }
...
_id_12AB2() {
  ...
  for(;;) {
    ...
    var_1 = scripts\sp\utility::_id_7BD6();
    ...
    level._id_10964._id_58DE = 1;
    thread scripts\sp\utility::_id_56BE("nanoshot_tutorial_hint_at_max_health", var_0);
    wait(var_0);
    level._id_10964._id_58DE = 0;
    level._id_10964 notify("tutorial_over");
  }
...
_id_12AB1() {
  ...
  for(;;) {
    ...
    if(!_id_2C96("nanoshot", 0, 0)) {
      continue;
    }
    if(_id_2C96("nanoshot", 0, 1) && !scripts\sp\utility::_id_D0BD("nanoshot", 0))
      level.player _id_0B2A::_id_1418();
    ...
    var_0 = 1.5;
    level._id_10964._id_58DE = 1;
    thread scripts\sp\utility::_id_56BE("nanoshot_tutorial_hint", var_0);
...
_id_12AAA() {
  ...
  for(;;) {
    ...
    if(!isDefined(level._id_10964.allowhints)) {
      continue;
    }
    if(_id_2C97()) {
      continue;
    ...
    if(isDefined(level._id_10964.togglinghelmet) && level._id_10964.togglinghelmet) {
      continue;
    }
    if(_id_2C94("arm_left")) {
      continue;
    ...
    if(_id_2C96("helmet", 1, 1))
      var_1 = "helmet_tutorial_hint";
    else if(_id_2C96("helmet", 0, 1))
      var_1 = "helmet_equip";
    else
      var_1 = "helmet_find";
    ...
    if(_id_2C91() && _id_2C96("helmet", 0, 1) && !var_0) {
      if(!scripts\sp\utility::_id_D0BD("helmet", 0))
        level.player _id_0B2A::_id_1419();
    ...
    level._id_10964._id_58DE = 1;
    thread scripts\sp\utility::_id_56BE(var_1, var_3);
...
tutorial_loadout() {
  ...
  var_0 = 1.2;
  scripts\sp\utility::_id_56BE("specialist_loadout", var_0);
  wait(var_0);
  setslowmotion(0.2, 1, 2);
  level.player scripts\engine\utility::allow_usability(1);
}

_id_25E9(var_0, var_1, var_2) {
  level._id_10964._id_2610 scripts\sp\utility::_id_74D7(::audio_request_suit_vo_internal, var_0, var_1, var_2);
}

audio_request_suit_vo_internal(var_0, var_1, var_2) {
  if(isDefined(var_0) && var_0 == "nag") {
    if(isDefined(var_1) && var_1 == "helmet") {
      if(!level._id_10964._id_8E1B) {
        return;
      }
      if(isDefined(level._id_10964.togglinghelmet))
        return;
    }
  ...
  if(isDefined(var_0) && var_0 == "injury") {
    if(isDefined(var_1)) {
      if(!level._id_10964 ispartinjured(var_1))
        return;
    }
    ...
    if(isDefined(var_1) && var_1 == "status") {
      ...
      foreach(var_5 in var_3) {
        if(level._id_10964 ispartinjured(var_5))
          return;
      }
    }
  }

  if(level._id_10964._id_10B3B > 1) {
    return;
  }
  level._id_10964._id_10B3B++;

  while(level._id_10964._id_111BE)
    wait 0.05;

  level._id_10964._id_111BE = 1;

  if(isDefined(var_2))
    level._id_10964._id_2610 playSound("specialist_mode_" + var_0 + "_" + var_1 + "_" + var_2, "vo_over");
  else
    level._id_10964._id_2610 playSound("specialist_mode_" + var_0 + "_" + var_1, "vo_over");

  level._id_10964._id_2610 waittill("vo_over");
  level._id_10964._id_111BE = 0;
  level._id_10964._id_10B3B--;
}
...
ispartinjured(var_0) {
  switch (var_0) {
    case "legs":
    case "leg":
      return self._id_2C19["leg_left"].health != self._id_2C19["leg_left"].maxhealth || self._id_2C19["leg_right"].health != self._id_2C19["leg_right"].maxhealth;
    case "arms":
    case "arm":
      return self._id_2C19["arm_left"].health != self._id_2C19["arm_left"].maxhealth || self._id_2C19["arm_right"].health != self._id_2C19["arm_right"].maxhealth;
    case "chest":
      return self._id_2C19["chest"].health != self._id_2C19["chest"].maxhealth;
    case "oxygen":
      return scripts\engine\utility::is_true(self._id_D430);
    case "helmet":
      return scripts\engine\utility::is_true(level._id_10964._id_8E1B);
    default:
      return 0;
  }
}
...
_id_25FD() {
  ...
  for(;;) {
    ...
    if(_id_2C98())
      level._id_10964._id_2610 _id_25E1(var_0);
  }
}
  ...
  for(;;) {
    ...
    if(!_id_2C95()) {
      if(level._id_10964._id_D430)
        ...
        thread _id_25E9("nag", "helmet");

        if(!_id_2C96("helmet", 0, 0))
          wait 13;
      }
    ...
    if(_id_2C98()) {
      if(_id_2C96("nanoshot", 0, 1))
        thread _id_25E9("nag", "nano");
      else {
        thread _id_25E9("nag", "status");
        wait 13;
      }
...
_id_25E1(var_0) {
  var_1 = _id_25E2(var_0);
  var_2 = _id_25FE(var_1);
  var_3 = randomint(100);

  if(var_1 == "sprint" || var_3 > 75)
    var_4 = "breathing_limp";
  else if(var_1 == "run" || var_3 > 50)
    var_4 = "breathing_limp_better";
  else if(var_1 == "walk" || var_3 > 25)
...
_id_9150(var_0) {
  ...
  foreach(var_2 in var_0) {
    ...
    level._id_10964._id_98F1[var_2] = var_3;
  }
...
hudcanshow() {
  ...
  if(scripts\sp\utility::_id_7B8C() == "safe")
    return 0;
...
usingspecialequipment() {
  if(level._id_10964.hidehelmetimpacts)
    return 1;

  var_0 = ["transitiontorobot", "controllingrobot", "selfdestruct"];
  var_1 = _id_0E29::_id_87A7();
...
hud_thread() {
  ...
  for(;;) {
    ...
    if(hudcanshow() && !var_0) {
      foreach(var_2 in level._id_10964._id_98F1) {
    ...
    if(!var_0) {
      foreach(var_7 in level._id_10964.helmetimpacts) {
...
_id_9160(var_0, var_1) {
  if(!isDefined(level._id_10964._id_98F1)) {
    return;
  }
  if(isDefined(var_1))
    wait(var_1);

  foreach(var_3 in level._id_10964._id_98F1) {
    if(var_0) {
      var_3.x = 15;
      continue;
    }
...
_id_9151() {
  ...
  if(isDefined(self._id_914B))
    self._id_914B destroy();

  var_0 = scripts\sp\hud_util::createicon("hud_injury_scanner", 70, 20);
  var_0.x = 15;
  var_0.y = self._id_98F1["pristine"].y - self._id_98F1["pristine"].height + var_0.height;
  var_0.alignx = "left";
  var_0.aligny = "bottom";
  ...
  var_0.alpha_req = 0;
  self._id_914B = var_0;
  self._id_914B thread scripts\sp\hud_util::_id_6AAB(0.7, 0.25);

  while(self._id_914B.y < self._id_98F1["pristine"].y - 10) {
    wait 0.05;
    self._id_914B.y = self._id_914B.y + 7;
  }

  self._id_914B thread scripts\sp\hud_util::_id_6AAB(0, 0.25);
}
...
_id_9146() {
  ...
  foreach(var_1 in self._id_98F1)
  var_1 thread _id_9144(3);
...
_id_2296(var_0) {
  ...
  foreach(var_3 in level._id_10964._id_2C19) {
    if(var_0) {
      if(_id_2C94(var_3.name))
...
_id_2683() {
  scripts\sp\utility::_id_266B("specialist_mode", undefined, undefined, scripts\sp\utility::_id_93AB());
}

_id_2C87() {
  if(!_id_2C96("nanoshot", 1, 1))
    return 0;
...
_id_2C8B() {
  ...
  if(_id_2C95() && !bool_player_helmet_damaged_enough())
    return 0;
...
_id_2C8D() {
  return level._id_10964._id_1BFC;
}

_id_2C8E() {
  return level._id_10964._id_8E1F;
}
...
_id_2C90() {
  return _id_2C94("leg_left") || _id_2C94("leg_right");
}

_id_2C92() {
  return issubstr(level.script, "sa_") && isDefined(level._id_10533) && isDefined(level._id_10532);
}
...
_id_2C93() {
  if(_id_2C8F() || level.script == "heist" || level.script == "sa_wounded" || level.script == "sa_empambush")
    return 1;
...
_id_2C94(var_0) {
  return _id_993F(var_0) <= 30.0;
}

_id_2C95() {
  return level._id_10964._id_8E16;
}
...
_id_2C96(var_0, var_1, var_2) {
  if(!scripts\sp\utility::_id_D0BD(var_0, 1))
    return 0;

  if(var_1 && !scripts\sp\utility::_id_D0BD(var_0, 0))
    return 0;

  if(var_2 && !scripts\sp\utility::_id_799C(var_0))
    return 0;
...
_id_2C97() {
  return level._id_10964._id_98EC;
}

halt_specialist_hints() {
  if(isDefined(level._id_10964))
    level._id_10964.allowhints = undefined;
}
...
_id_2C99() {
  var_0 = level.player scripts\sp\utility::_id_7BD6();
  ...
  if(scripts\engine\utility::is_true(level.player.disable_nanoshot_hint))
    return 0;
...
_id_993F(var_0) {
  return level._id_10964._id_2C19[var_0].health;
}

_id_F2A6(var_0) {
  level._id_10964._id_1BFC = var_0;
}

_id_F2D2(var_0) {
  level._id_10964._id_2687 = var_0;
}

_id_F3FF(var_0) {
  level._id_10964._id_8E16 = var_0;

  if(var_0) {
    level._id_10964 notify("helmet_on");
    setomnvar("ui_helmet_state", 1);
  } else {
    level._id_10964 notify("helmet_off");
...
_id_F400(var_0) {
  level._id_10964._id_8E1F = var_0;
}
...
_id_F49E(var_0, var_1) {
  ...
  level._id_10964._id_BFAA = var_0;
}

_id_F52C(var_0) {
  var_0 = clamp(var_0, 1, level.player.maxhealth);
  level.player _meth_8319(var_0 / level.player.maxhealth);
}
...
_id_F530(var_0) {
  level._id_10964._id_98EC = var_0;
  _id_F53C(var_0);
  level._id_10964.jackalhelmetcrackfade = var_0;
  _id_F3FF(!var_0);

  if(var_0)
    level._id_10964 notify("in_jackal");
  else
    level._id_10964 notify("out_of_jackal");
}
...
specialist_allow_invulnerability(var_0) {
  if(!isDefined(level._id_10964.allowinvulnerability))
    level._id_10964.allowinvulnerability = 0;

  if(var_0) {
    level._id_10964.allowinvulnerability++;
    self _meth_80D1();
  } else {
    level._id_10964.allowinvulnerability--;

    if(level._id_10964.allowinvulnerability == 0)
      self _meth_80A1();
  }
}

_id_F53C(var_0) {
  level.player._id_8C0F = var_0;
}

_id_1381A() {
  if(!level._id_10964._id_58DE) {
    return;
  }
  level._id_10964 waittill("tutorial_over");
}
...
_id_137D1() {
  ...
  level._id_10964 waittill("helmet_off");
}
...
_id_137D2() {
  ...
  level._id_10964 waittill("helmet_on");
}
...
_id_137D3() {
  ...
  level._id_10964 waittill("in_jackal");
}
...
_id_137E4() {
  ...
  level._id_10964 waittill("out_of_jackal");
}
...
spawn_nanoshot() {
  ...
  var_4 scripts\sp\utility::_id_9196(3, 1, 1, "new_weapon");
  var_4 thread nanoshot_pickup();
  var_4 thread _id_0B77::add_to_grenade_cache("axis");
  var_4 _meth_8226(var_4.origin, var_2 * randomintrange(100, 200));
  return 1;
}
...
nanoshot_pickup() {
  ...
  var_0 linkTo(self);
  self._id_9027 = var_0;
  var_0 _id_0E46::_id_48C4(undefined, undefined, &"EQUIPMENT_PICKUP_NANOSHOT", 40, 300, undefined, undefined, undefined, 0, &"hud_interaction_prompt_center_equipment");
  var_0 makeunusable();

  if(!scripts\sp\utility::_id_D0BD("nanoshot", 1))
    var_0 makeusable();
  ...
  var_2 = scripts\sp\loadout::_id_7C27(scripts\sp\utility::_id_7BD6());
  var_3 = scripts\sp\utility::_id_7BD7();
...
drop_equipment_crate(var_0, var_1) {
  ...
  var_2 thread _id_0B04::_id_4842("equipment");
  var_2 thread _id_0B77::add_to_grenade_cache("axis");
  var_2 scripts\engine\utility::delaycall(0.05, ::physicslaunchserver, var_2.origin, anglesToForward(level.player.angles) * 250);
  var_2._id_99F7 linkTo(var_2);
  var_3 = var_2._id_99F7;
...
nanoshot_pickup_watcher() {
  if(!isDefined(level._id_8580) || !isDefined(level._id_8580["axis"])) {
    level._id_8581["axis"] = 0;
    level._id_8580["axis"] = [];
  }

  for(;;) {
    while(scripts\sp\utility::_id_D0BD("nanoshot", 1)) {
      nanoshot_near_pickup_check();
      wait 0.15;
    }

    foreach(var_1 in level._id_8580["axis"]) {
      if(isDefined(var_1) && var_1.classname == "weapon_nanoshot")
        var_1._id_9027 makeusable();
    }
...
nanoshot_near_pickup_check() {
  ...
  foreach(var_2 in level._id_8580["axis"]) {
    ...
    if(scripts\sp\utility::_id_7CB0() >= var_3) {
      continue;
    }
...
spawn_specialist_crates() {
  ...
  switch (var_0) {
    case "europa":
      _id_0B04::spawn_equipment_crate("helmet", (34469.1, -12214.8, -455.859), (0, 132, 0), 1);
      _id_0B04::spawn_equipment_crate("nanoshot", (34440, -12225, -455.859), (0, -64, 0), 3);
      break;
    case "phstreets":
      _id_0B04::spawn_equipment_crate("helmet", (50434.4, 29394.1, -34280.9), (0, 132, 0));
      _id_0B04::spawn_equipment_crate("nanoshot", (68113, 40290, -34416), (0, 274, 0), 2);
      break;
    case "titan":
      _id_0B04::spawn_equipment_crate("nanoshot", (-59090.7, -34205, -64624.4), (0, 132, 0), 3);
      _id_0B04::spawn_equipment_crate("nanoshot", (-47402.7, -39197.5, -64154.3), (0, 132, 0), 2);
      _id_0B04::spawn_equipment_crate("nanoshot", (-47482.1, -41287.1, -64375.9), (0, 132, 0), 3);
      _id_0B04::spawn_equipment_crate("helmet", (-47487.9, -41254.2, -64375.9), (0, 120, 0), 1);
      _id_0B04::spawn_equipment_crate("nanoshot", (-35701.4, -41712, -64787.9), (0, 132, 0), 2);
      _id_0B04::spawn_equipment_crate("nanoshot", (-34911.9, -42124.9, -64955.9), (0, -15, 0), 1);
      _id_0B04::spawn_equipment_crate("helmet", (-30218.4, -41231.9, -64988.4), (0, -15, 0), 1);
      _id_0B04::spawn_equipment_crate("nanoshot", (-29564.7, -42645, -64988.9), (0, 132, 0), 2);
      break;
    case "titanjackal":
      _id_0B04::spawn_equipment_crate("helmet", (41986.3, 75867.2, -64930.4), (0, 132, 0), 1);
      _id_0B04::spawn_equipment_crate("nanoshot", (41940.8, 74503.1, -64930.4), (0, 132, 0), 2);
      break;
    case "prisoner":
      _id_0B04::spawn_equipment_crate("helmet", (-4685, -14638, 585), (0, 0, 0), 1);
      _id_0B04::spawn_equipment_crate("helmet", (912.4, -9570.7, -1774.7), (7.38483, 270.432, -1.433), 1);
      break;
    case "heist":
      _id_0B04::spawn_equipment_crate("nanoshot", (-11407, 16389, -85536), (0, 270, 0), 2);
      break;
    case "yard":
      _id_0B04::spawn_equipment_crate("helmet", (385, 25919, 1856.14), (0, 0, 0), 1);
      _id_0B04::spawn_equipment_crate("nanoshot", (463, 25005, 2000.12), (0, 65, 0), 2);
      break;
    case "sa_assassination":
      _id_0B04::spawn_equipment_crate("helmet", (-160, -1326, -51 + var_1), (0, 59.9999, 0));
      break;
    case "sa_empambush":
      break;
    case "sa_moon":
      _id_0B04::spawn_equipment_crate("helmet", (1449.3, 628.471, 64.0938), (0, 345, 0));
      break;
    case "sa_vips":
      _id_0B04::spawn_equipment_crate("helmet", (-142, -1322, -79), (0, 183, 0));
      _id_0B04::spawn_equipment_crate("nanoshot", (-146, -1280, -79), (0, 194, 0));
      _id_0B04::spawn_equipment_crate("helmet", (4438, -907, 192), (0, 263, 0));
      _id_0B04::spawn_equipment_crate("helmet", (422, -423, -54), (0, 167, 0));
      _id_0B04::spawn_equipment_crate("helmet", (816, -1477.6, -142.906), (0, 183, 0));
      break;
    case "sa_wounded":
      _id_0B04::spawn_equipment_crate("nanoshot", (157, -177, -171), (0, 76, 0));
      _id_0B04::spawn_equipment_crate("helmet", (129, -175, -171), (0, 91, 0));
      break;
  }
}
...
specialist_crate_move(var_0, var_1, var_2, var_3, var_4) {
  ...
  if(!isDefined(var_4) && isDefined(var_7._id_EDE7))
    var_4 = var_7._id_EDE7;
  ...
  if(isDefined(var_7._id_99F7._id_6698)) {
    foreach(var_16 in var_7._id_99F7._id_6698) {
      if(isDefined(var_16))
        var_16 delete();
    }
  }

  var_7._id_99F7 notify("remove_pickup_cache");
  var_7._id_99F7 delete();
  var_11 delete();
  var_10 delete();
  var_7 = undefined;
  thread _id_0B04::spawn_equipment_crate(var_0, var_2, var_3, var_4);
}
...
specialist_crate_delete(var_0) {
  ...
  if(isDefined(var_3._id_99F7._id_6698)) {
    foreach(var_12 in var_3._id_99F7._id_6698) {
      if(isDefined(var_12))
        var_12 delete();
    }
  }

  var_3._id_99F7 notify("remove_pickup_cache");
  var_3._id_99F7 delete();
  var_7 delete();
  var_6 delete();
  var_3 = undefined;
}