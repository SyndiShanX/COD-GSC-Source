...
_id_CBB5(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  level._id_CB9C.enableshadows = 1;
  level._id_CB9C.rendertotexture = 1;
  level._id_CB9C.clipdistance = 5000;
  level._id_CB9C.nearz = 2;
  level._id_CB9C.aspectratio = 1;
  level._id_CB9C.origin_offset = (0, 0, 0);
  level._id_CB9C.angles_offset = (0, 0, 0);
...
_id_CBC3(var_0) {
  level._id_CB9C.activevisionset = "naked";
  level._id_CB9C.activevisionsetduration = 0.5;
  level._id_CB9C.visionsetnaked = var_0;
}
...
_id_CBA3() {
  ...
  setomnvar("ui_show_pip", 0);
  setomnvar("ui_jackal_hide_follow_pip", 1);
  level._id_CB9C.enable = 0;
  level notify("pip_closed");
}

_id_CBAC() {
  return isDefined(level._id_CB9C) && isDefined(level._id_CB9C.enable) && level._id_CB9C.enable;
}
