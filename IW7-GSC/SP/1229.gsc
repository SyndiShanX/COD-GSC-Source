...
main() {
  ...
  self attach("head_bg_var_head_sc_male_17_head_sc_kloos", "", 1);
  self.headmodel = "head_bg_var_head_sc_male_17_head_sc_kloos";
  scripts\code\character::attachhat("alias_hats_sdf_crew_ship_male_17_kloos", _id_09B9::main());
...
precache() {
  ...
  precachemodel("head_bg_var_head_sc_male_17_head_sc_kloos");
  scripts\code\character::precachemodelarray(_id_09B9::main());
