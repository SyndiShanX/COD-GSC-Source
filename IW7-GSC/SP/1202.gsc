...
main() {
  ...
  if(issentient(self)) {
    ...
    var_0["head"].partnerheli["head"]._id_4D6F = "J_Neck";
    self _meth_849B("head", 0, "head", 5000, "head", "J_Neck");
    var_0["right_arm"] = spawnStruct();
    var_0["right_arm"]._id_B4B8 = 2000;
    ...
    var_0["right_arm"].partnerheli["lower"]._id_4D6F = "J_Clavicle_X_RI";
    ...
    var_0["right_arm"].partnerheli["upper"]._id_4D6F = "J_Clavicle_X_RI";
    ...
    var_0["left_arm"].partnerheli["lower"]._id_4D6F = "J_Clavicle_X_LE";
    ...
    var_0["left_arm"].partnerheli["upper"]._id_4D6F = "J_Clavicle_X_LE";
    ...
    var_0["right_leg"].partnerheli["upper"]._id_4D6F = "J_HipInner_RI";
    ...
    var_0["right_leg"].partnerheli["lower"]._id_4D6F = "J_HipInner_RI";
    ...
    var_0["left_leg"].partnerheli["upper"]._id_4D6F = "J_HipInner_LE";
    ...
    var_0["left_leg"].partnerheli["lower"]._id_4D6F = "J_HipInner_LE";
    ...
    var_0["hip_pack_right"]._id_B4B8 = 0;
    ...
    var_0["hip_pack_left"].partnerheli["hip_pack_left"]._id_4D6F = "J_SpineLowerBottom_LE";
    ...
    var_0["torso"].partnerheli["lower"]._id_4D6F = "j_mainroot";
