...
_id_3D54() {
  ...
  for(;;) {
    if(getdvarint("scr_savetest") > 0) {
      ...
      scripts\sp\utility::_id_2669("cheat_save");
      wait 1;
    }
...
immediatelevelstartsave() {
  var_0 = scripts\sp\utility::_id_7F6E(level.script);

  if(!isDefined(var_0))
    var_0 = 0;

  var_0 = var_0 * 0.05;
  var_1 = scripts\sp\utility::_id_7E2C(level.script);
...
_id_268B(var_0) {
  ...
  scripts\sp\utility::_id_2669(var_1);
}
...
_id_268C(var_0, var_1) {
  ...
  if(!self islinked() && !scripts\engine\utility::player_is_in_jackal() && !scripts\sp\utility::_id_93AC() && !self isonground()) {
...
_id_2689(var_0) {
  ...
  var_1 = scripts\sp\utility::_id_7B9D();
  ...
  if(scripts\sp\utility::_id_A1A8("enemy_lockon"))
    return 0;
...
_id_268F(var_0, var_1) {
  ...
  foreach(var_4 in var_2) {
    ...
    if(var_4.a._id_A9ED > gettime() - 500) {
    ...
    if(isDefined(var_4.asm._id_11AC7) && var_4 scripts\asm\asm::_id_231B(var_4.asm._id_11AC7, "aim") && var_6)
      return 0;
  }

  if(scripts\sp\utility::_id_D121())
    return 0;
...
specialistsavecheck() {
  ...
  if(_id_0A2F::_id_9CBB(level.template_script))
    return 1;
