...
main() {
  ...
  self attach("head_bg_female_04_blast_damage_dustable", "", 1);
  self.headmodel = "head_bg_female_04_blast_damage_dustable";
...
precache() {
  ...
  precachemodel("head_bg_female_04_blast_damage_dustable");
