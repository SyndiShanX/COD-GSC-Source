...
main() {
  self setModel("body_sdf_army_armored_1");
  self attach("head_bg_var_head_sc_male_25_head_sc_male_24", "", 1);
  self.headmodel = "head_bg_var_head_sc_male_25_head_sc_male_24";
  scripts\code\character::attachhat("alias_hats_sdf_crew_ship_male_25_male_24", _id_09BB::main());
...
precache() {
  precachemodel("body_sdf_army_armored_1");
  precachemodel("head_bg_var_head_sc_male_25_head_sc_male_24");
  scripts\code\character::precachemodelarray(_id_09BB::main());
