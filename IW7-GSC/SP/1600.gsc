...
main() {
  ...
  self attach("head_bg_var_head_male_bc_02_head_sc_engineering_mate", "", 1);
  self.headmodel = "head_bg_var_head_male_bc_02_head_sc_engineering_mate";
...
precache() {
  ...
  precachemodel("head_bg_var_head_male_bc_02_head_sc_engineering_mate");
