...
main() {
  ...
  self attach("head_bg_var_head_female_bc_02_head_hero_xo", "", 1);
  self.headmodel = "head_bg_var_head_female_bc_02_head_hero_xo";
...
precache() {
  ...
  precachemodel("head_bg_var_head_female_bc_02_head_hero_xo");
