...
main() {
  ...
  self attach("head_bg_var_head_sc_female_13_blast_damage_dusty", "", 1);
  self.headmodel = "head_bg_var_head_sc_female_13_blast_damage_dusty";
...
precache() {
  ...
  precachemodel("head_bg_var_head_sc_female_13_blast_damage_dusty");
