...
_id_FE76(var_0, var_1, var_2, var_3) {
  thread _id_8981(var_1);

  if(scripts\asm\asm_bb::bb_moverequested()) {
    return;
  }
  _id_0A1E::_id_2361(var_0, var_1, var_2, var_3);
}
...
_id_FE58(var_0, var_1, var_2, var_3) {
  thread _id_8981(var_1);
}

_id_FECE(var_0, var_1, var_2, var_3) {
...
_id_C185(var_0, var_1, var_2, var_3) {
  return !_id_10078(var_0, var_1, var_2, var_3);
}

_id_10078(var_0, var_1, var_2, var_3) {
  return scripts\anim\utility_common::usingmg() || isDefined(self _meth_8164());
}

_id_FEDA(var_0, var_1, var_2, var_3) {
  return self._blackboard.shootparams._id_1119D == "mg";
}
...
_id_5AAC(var_0) {
  ...
  var_2 = self.asm.shootparams._id_FF0B;
...
_id_5AAB(var_0, var_1, var_2, var_3) {
  var_4 = self.asm.shootparams._id_FF0B;
...
_id_FE70(var_0, var_1, var_2, var_3) {
...
_id_FE5C(var_0, var_1, var_2, var_3) {
  ...
  childthread _id_FE84(var_4, var_5, var_3);
  self endon(var_4);
  ...
  var_11 = var_10 == 1 || self.asm.shootparams._id_1119D == "semi";
  var_12 = isPlayer(self.enemy) && self.enemy scripts\sp\utility::_id_65DB("player_is_invulnerable");
...
_id_FE89(var_0, var_1, var_2, var_3) {
  var_4 = self._blackboard.shootparams;

  if(!isDefined(self.asm.shootparams)) {
    self.asm.shootparams = spawnStruct();
    self.asm.shootparams._id_C21C = var_4._id_32BD;
  }

  self.asm.shootparams._id_1119D = var_4._id_1119D;
  self.asm.shootparams._id_6B92 = var_4._id_6B92;
  self.asm.shootparams._id_FF0B = var_4._id_FF0B;
  self.asm.shootparams.pos = var_4.pos;
  self.asm.shootparams.ent = var_4.ent;

  switch (var_4._id_1119D) {
    case "semi":
    case "burst":
      self.asm.shootparams._id_FF0B = scripts\aitypes\combat::_id_4F65(var_4);
      break;
    case "full":
      self.asm.shootparams._id_FF0B = scripts\aitypes\combat::_id_4F66();
      break;
    case "mg":
      self.asm.shootparams._id_FF0B = scripts\aitypes\combat::_id_4F68();
  }
