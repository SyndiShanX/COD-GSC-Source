...
main() {
  ...
  self attach("head_bg_var_head_bg_female_03_head_female_bc_02", "", 1);
  self.headmodel = "head_bg_var_head_bg_female_03_head_female_bc_02";
...
precache() {
  ...
  precachemodel("head_bg_var_head_bg_female_03_head_female_bc_02");
