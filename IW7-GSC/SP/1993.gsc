...
main() {
  ...
  self attach("head_bg_var_head_sc_engineering_mate_head_sc_male_15", "", 1);
  self.headmodel = "head_bg_var_head_sc_engineering_mate_head_sc_male_15";
...
precache() {
  ...
  precachemodel("head_bg_var_head_sc_engineering_mate_head_sc_male_15");
