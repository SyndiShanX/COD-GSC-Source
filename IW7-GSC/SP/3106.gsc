...
bt_initroot() {
  ...
  var_0._id_C21E = 8;
  var_0._id_273F = 0;
  self.bt._id_E6E5 = var_0;
  self.bt._id_BE5D = self _meth_84B1("jackal/jackal_native_api");
}
...
_id_0070() {
  ...
  var_1 = _id_0C1D::bt_registerprefabtaskids(var_0, 57, 89);
  var_1 = _id_0C1D::bt_registerprefabtaskids(var_0, 86, var_1);
  var_1 = _id_0C1D::bt_registerprefabtaskids(var_0, 88, var_1);
...
_id_70D2(var_0, var_1, var_2, var_3) {
  while(var_2._id_4B1B < var_2._id_C21E) {
    ...
    if(var_3 != anim.success) {
      scripts\aitypes\bt_util::bt_terminateprevrunningaction(var_1, ::_id_7147, var_2.id, var_2._id_4B1B);
      return var_3;
    }
...
_id_7094(var_0, var_1, var_2, var_3) {
  while(var_2._id_4B1B < var_2._id_C21E) {
    ...
    if(var_3 != anim.success) {
      scripts\aitypes\bt_util::bt_terminateprevrunningaction(var_1, ::_id_711A, var_2.id, var_2._id_4B1B);
      return var_3;
    }
...
_id_7087(var_0, var_1, var_2, var_3) {
  while(var_2._id_4B1B < var_2._id_C21E) {
    ...
    if(var_3 != anim.failure) {
      scripts\aitypes\bt_util::bt_terminateprevrunningaction(var_1, ::_id_7111, var_2.id, var_2._id_4B1B);
      return var_3;
    }
...
_id_704F(var_0, var_1, var_2, var_3) {
  while(var_2._id_4B1B < var_2._id_C21E) {
    ...
    if(var_3 != anim.success) {
      scripts\aitypes\bt_util::bt_terminateprevrunningaction(var_1, ::_id_70E3, var_2.id, var_2._id_4B1B);
      return var_3;
    }
