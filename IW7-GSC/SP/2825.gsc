...
_id_CF73() {
  for(;;) {
    ...
    setsaveddvar("player_itemUseRadius", level._id_A03B);
    setsaveddvar("player_itemUseFOV", level._id_A03A);
  }
}
    ...
    if(var_0._id_F1B8 != "none" && _id_0A2F::_id_9B49(var_0._id_F1B8)) {
      ...
      if(getdvarint("progression_on") == 1) {
        ...
        if(scripts\engine\utility::array_contains(var_2, var_5)) {
          var_4 scripts\sp\utility::_id_9196(4, 1, 0, "new_weapon");
...
_id_3E94(var_0, var_1) {
  ...
  if(var_0._id_BF1B > 0 && scripts\engine\utility::get_template_script_MAYBE() != "rogue" && scripts\engine\utility::get_template_script_MAYBE() != "moon_port") {
  ...
  var_0._id_3850 = scripts\engine\utility::array_randomize(var_0._id_3850);
  var_2 = undefined;
  var_3 = undefined;
...
_id_13C06(var_0, var_1) {
  ...
  if(isDefined(var_5) && var_5 == "extra_large") {
    foreach(var_11 in var_1) {
      var_12 = var_11 scripts\sp\utility::_id_7A97();

      if(var_12.size > 0) {
        foreach(var_14 in var_12) {
          if(isDefined(var_14.script_noteworthy)) {
            var_15 = var_14 scripts\sp\utility::_id_7A97();
...
_id_116DD(var_0, var_1, var_2) {
  ...
  var_4 scripts\sp\anim::_id_1F35(var_6, "hack_terminal");
...
_id_116DC(var_0, var_1, var_2) {
  ...
  _id_0A2F::_id_3D6E();
  var_16 = "armory" + var_2;
  scripts\sp\utility::_id_266A(var_16);
}
