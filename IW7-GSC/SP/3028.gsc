...
_id_10496() {
  level.player scripts\sp\utility::_id_65E0("flag_player_landing_enabled");
  level.player scripts\sp\utility::_id_65E0("flag_player_has_jackal");
  level.player scripts\sp\utility::_id_65E0("flag_player_is_flying");
  level.player scripts\sp\utility::_id_65E0("flag_takeoff_cooldown");
  level.player scripts\sp\utility::_id_65E0("flag_player_is_landing");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_missiles");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_mode_switch");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_emp");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_juke");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_flares");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_dogfight");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_guns");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_weapon_switch");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_ads");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_roll");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_quickturn");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_HUD_horizon");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_lockon");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_pilot_assist");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_overheat");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_targetAid");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_targetAid_update");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_map_boundary_autoturn");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_map_boundary_warning");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_map_boundary_push");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_cockpit_VO");
  level.player scripts\sp\utility::_id_65E0("disable_jackal_damage_vision_distortion");
  level.player scripts\sp\utility::_id_65E0("jackal_cockpit_VO");
  level.player scripts\sp\utility::_id_65E0("jackal_force_mode");
  level.player scripts\sp\utility::_id_65E0("jackal_autoboost");
  level.player scripts\sp\utility::_id_65E0("flag_player_dismounting");
  level.player scripts\sp\utility::_id_65E0("jackal_hud_on");
  level.player scripts\sp\utility::_id_65E0("jackal_enemy_homing_missile_allowed");
  level.player scripts\sp\utility::_id_65E0("jackal_enemy_homing_missile_allowed_hyperaggressive");
...
_id_10498() {
  scripts\sp\utility::_id_16EB("jackal_mount_hint", &"JACKAL_MOUNT", ::_id_A217);
  scripts\sp\utility::_id_16EB("jackal_supply_drop", &"JACKAL_MARK_DROPZONE", ::_id_A220);
  scripts\sp\utility::_id_16EB("jackal_takeoff", &"JACKAL_TAKEOFF", ::_id_A221);
  scripts\sp\utility::_id_16EB("jackal_launch_rev", &"JACKAL_LAUNCH_REV", ::_id_A21D);
  scripts\sp\utility::_id_16EB("jackal_launch_rev_pc", &"JACKAL_LAUNCH_REV_PC", ::_id_A21D);
  scripts\sp\utility::_id_16EB("jackal_launch_start", &"JACKAL_LAUNCH_START", ::_id_A222);
  scripts\sp\utility::_id_16EB("jackal_ads", &"JACKAL_ADS", ::_id_A209);
  scripts\sp\utility::_id_16EB("jackal_lockon", &"JACKAL_LOCKON", ::_id_A213);
  scripts\sp\utility::_id_16EB("jackal_brake", &"JACKAL_BRAKE", ::_id_A20C);
  scripts\sp\utility::_id_16EB("jackal_boost", &"JACKAL_BOOST", ::_id_A20B);
  scripts\sp\utility::_id_16EB("jackal_land", &"JACKAL_LAND", ::_id_A211);
  scripts\sp\utility::_id_16EB("jackal_landing_scan", &"JACKAL_LANDING_SCAN", ::_id_A212);
  scripts\sp\utility::_id_16EB("jackal_strike", &"JACKAL_STRIKE", ::_id_A21F);
  scripts\sp\utility::_id_16EB("jackal_assault", &"JACKAL_ASSAULT", ::_id_A20A);
  scripts\sp\utility::_id_16EB("jackal_weapon_switch", &"JACKAL_WEAP_SWITCH", ::_id_A223);
  scripts\sp\utility::_id_16EB("jackal_missile", &"JACKAL_MISSILE", ::_id_A215);
  scripts\sp\utility::_id_16EB("jackal_missile_lock", &"JACKAL_MISSILE_LOCK", ::_id_A216);
  scripts\sp\utility::_id_16EB("jackal_find_lockon", &"JACKAL_FIND_LOCKON", ::_id_A20E);
  scripts\sp\utility::_id_16EB("jackal_lose_lock", &"JACKAL_LOSE_LOCK", ::_id_A214);
  scripts\sp\utility::_id_16EB("jackal_juke_hint", &"JACKAL_JUKE_HINT", ::_id_A210);
  scripts\sp\utility::_id_16EB("jackal_flare_hint", &"JACKAL_FLARE_HINT", ::_id_A20F);
  scripts\sp\utility::_id_16EB("jackal_runway_hint", &"JACKAL_LAND_RUNWAY", ::_id_A21E);
  scripts\sp\utility::_id_16EB("jackal_runway_hint_inverted", &"JACKAL_LAND_RUNWAY_INVERTED", ::_id_A21E);
  scripts\sp\utility::_id_16EB("jackal_return_to_battle", &"JACKAL_RETURN_TO_BATTLE", ::_id_A21C);
  scripts\sp\utility::_id_16EB("jackal_launch_retribution", &"JACKAL_RET_LAUNCH", ::_id_A219);
  scripts\sp\utility::_id_16EB("jackal_return_to_ret", &"JACKAL_HINT_RETURN", ::_id_A21B);
  scripts\sp\utility::_id_16EB("jackal_hint_ret_reapproach", &"JACKAL_HINT_REAAPROACH", ::_id_A21A);
  scripts\sp\utility::_id_16EB("jackal_hint_ret_approach", &"JACKAL_HINT_APPROACH", ::_id_A218);
  scripts\sp\utility::_id_16EB("jackal_dogfight_hint", &"JACKAL_DOGFIGHT", ::_id_A20D);
}
...
_id_104A7() {
  ...
  foreach(var_2 in var_0) {
    ...
    level._id_A056._id_A82D = scripts\engine\utility::array_add(level._id_A056._id_A82D, var_4);
    var_4.lights = [];
...
_id_A220() {
  return !scripts\engine\utility::flag("jackal_supply_drop_hint") || isDefined(level._id_10260);
}

_id_A217() {
  return !scripts\engine\utility::flag("flag_mount_jackal") || level.player._id_C53F;
}
