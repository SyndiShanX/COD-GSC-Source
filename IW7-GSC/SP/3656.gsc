...
_id_5AD1(var_0) {
  ...
  for(;;) {
    ...
    if(var_2 || isDefined(self._id_4D93) || !scripts\engine\utility::flag("allow_double_jump")) {
      wait 0.25;
      continue;
    }
    ...
    if(isDefined(self._id_AD32) && self._id_AD32 == var_4) {
    ...
    var_11 = 0.5;
    thread scripts\sp\utility::_id_D2CD(100, var_11);
    thread _id_C144();
