...
main() {
  ...
  self attach("head_bg_var_head_bg_female_03_head_sc_owens_blast_damage_dustable", "", 1);
  self.headmodel = "head_bg_var_head_bg_female_03_head_sc_owens_blast_damage_dustable";
...
precache() {
  ...
  precachemodel("head_bg_var_head_bg_female_03_head_sc_owens_blast_damage_dustable");
