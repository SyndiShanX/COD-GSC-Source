...
registernotetracks() {
  ...
  anim.notetracks["c12_death_dying"] = ::_id_3538;
  anim.notetracks["c12_death_bodyfall"] = ::_id_3537;
...
notetrackpistolpickup(var_0, var_1) {
  scripts\anim\shared::placeweaponon(self._id_101B4, "right");
  self.bulletsinclip = weaponclipsize(self.weapon);
  self notify("weapon_switch_done");
}
...
notetrackfingerposeoffleft(var_0, var_1) {
  _id_0A1E::_id_2319("left");
}

notetrackfingerposeonleft(var_0, var_1) {
  _id_0A1E::_id_234C("left");
}
...
notetrackfingerposeonright(var_0, var_1) {
  _id_0A1E::_id_234C("right");
}

notetrackfacialidle(var_0, var_1) {
  _id_0A1E::_id_236A("facial_idle");
}

notetrackfacialrun(var_0, var_1) {
  _id_0A1E::_id_236A("facial_run");
}

notetrackfacialpain(var_0, var_1) {
  _id_0A1E::_id_236A("facial_pain");
}

notetrackfacialdeath(var_0, var_1) {
  _id_0A1E::_id_236A("facial_death");
}

notetrackfacialtalk(var_0, var_1) {
  _id_0A1E::_id_236A("facial_talk");
}

notetrackfacialcheer(var_0, var_1) {
  _id_0A1E::_id_236A("facial_cheer");
}

notetrackfacialhappy(var_0, var_1) {
  _id_0A1E::_id_236A("facial_happy");
}

notetrackfacialscared(var_0, var_1) {
  _id_0A1E::_id_236A("facial_scared");
}

notetrackfacialangry(var_0, var_1) {
  _id_0A1E::_id_236A("facial_angry");
}
...
notetrackland(var_0, var_1) {
  ...
  self _meth_8583("land", self.weapon);
}
...
handlenotetrack(var_0, var_1, var_2, var_3) {
  ...
  switch (var_0) {
    ...
    case "detach clip left":
      ...
      break;
    case "jetpack_boost":
      thread _id_CCAB("boost_on_up", "large");
      break;
    case "boost_on_right":
    case "boost_on_left":
    case "boost_on_down":
    ...
    if(soundexists(var_6)) {
      if(self.unittype == "c8") {
        if(!isDefined(self._id_6BC7)) {
          self._id_6BC7 = spawn("script_origin", self.origin);
          self._id_6BC7 linkTo(self);
        }

        self._id_6BC7 _meth_824E(var_6, var_2);
      } else
        thread scripts\sp\utility::_id_CE48(var_6, var_2, var_3);
    }
...
_id_D492(var_0, var_1) {
  if(!isai(self)) {
    self _meth_824E("c6_handstep", "default");
    return;
  }
...
_id_CD6B(var_0) {
  return _id_CE37("jetpack_thruster_large", "jetpack_thruster_large_allies", var_0);
}

_id_CE13(var_0) {
  return _id_CE37("jetpack_thruster_small", "jetpack_thruster_small_allies", var_0);
}
