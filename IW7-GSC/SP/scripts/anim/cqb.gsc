...
_id_BCB1() {
  ...
  _id_478E(var_1);
  scripts\anim\run::_id_F7A9(scripts\anim\utility::_id_B027("cqb", "move_b"), scripts\anim\utility::_id_B027("cqb", "move_l"), scripts\anim\utility::_id_B027("cqb", "move_r"));
...
_id_53C3() {
  ...
  if(var_1 == 0) {
    var_2 = scripts\anim\utility::_id_80BD(self.a._id_E860, var_0.size);
    return var_0[var_2];
  }
...
_id_FA9F() {
  ...
  foreach(var_3 in var_1) {
    level._id_479A[level._id_479A.size] = var_3.origin;
    var_3 delete();
  }

  thread _id_FAA0(var_0);
}
...
_id_6CB4() {
  if(isDefined(anim._id_6CB8)) {
    return;
  }
  anim._id_6CB8 = 1;
  waittillframeend;

  if(!level._id_479A.size) {
    return;
  }
  for(;;) {
    var_0 = getaiarray();
    ...
    foreach(var_3 in var_0) {
      if(isalive(var_3) && var_3 scripts\anim\utility::_id_9D9B() && !isDefined(var_3._id_5512)) {
        ...
        for(var_11 = 0; var_11 < level._id_479A.size; var_11++) {
          var_12 = level._id_479A[var_11];
