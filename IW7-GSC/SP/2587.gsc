...
_id_2980(var_0, var_1) {
  self._blackboard._id_1FC7[var_0] = var_1;
}
...
_id_2931() {
  return self._blackboard._id_1182F;
}
...
_id_291A() {
  return isDefined(self._blackboard._id_2996) && self._blackboard._id_2996;
}
...
_id_2964(var_0) {
  self._blackboard._id_2AB0 = var_0;
}

_id_293D(var_0, var_1, var_2, var_3) {
  return isDefined(self._blackboard._id_2AB0) && self._blackboard._id_2AB0;
}

_id_2963(var_0) {
  self._blackboard._id_2AAF = var_0;
}

_id_293C() {
  return isDefined(self._blackboard._id_2AAF) && self._blackboard._id_2AAF;
}
...
bb_clearrodeorequest(var_0) {
  self._blackboard._id_E600 = undefined;
}
...
_id_297B(var_0) {
  self._blackboard._id_8C52 = var_0;
}

_id_293E() {
  return isDefined(self._blackboard._id_8C52);
}

_id_2922() {
  return self._blackboard._id_8C52;
}
