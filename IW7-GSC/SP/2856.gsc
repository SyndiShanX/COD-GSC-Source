...
_id_1355(var_0) {
  ...
  if(scripts\sp\utility::_id_9BB7()) {
    ...
    scripts\sp\gameskill::_id_262C("aa_main_" + level.script);
    ...
    if(_id_7F6A(var_1)) {
      ...
      if(var_3 >= 4) {
        if(_id_3DEA(var_1, 4, 1)) {
          scripts\sp\utility::_id_834F("VETERAN");
    ...
    if(isDefined(_id_7EB2(var_1))) {
      changelevel(_id_7F6D(var_6), _id_7F31(var_1), _id_7EB2(var_1));
      return;
    }

    changelevel(_id_7F6D(var_6), _id_7F31(var_1));
  }
}
...
_id_1463(var_0, var_1) {
  ...
  var_18 = _id_0A2F::_id_7F7B(level.template_script);
...
_id_1464() {
  ...
  scripts\sp\utility::_id_12651(var_1);
}
...
_id_8171() {
  var_0 = _id_0A2F::_id_DA17();
  var_0 = scripts\engine\utility::array_remove_array(var_0, _id_0A2F::_id_DA0A());
  var_0 = scripts\engine\utility::array_remove_array(var_0, _id_0A2F::_id_DA10());
  var_1 = var_0.size;
  var_2 = 0;
