...
main() {
  ...
  self attach("head_sc_male_21", "", 1);
  self.headmodel = "head_sc_male_21";
  self.hatmodel = "head_sc_male_21_hat_sdf_capital_ship";
...
precache() {
  ...
  precachemodel("head_sc_male_21");
  precachemodel("head_sc_male_21_hat_sdf_capital_ship");
