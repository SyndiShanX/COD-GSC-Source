...
main() {
  scripts\code\character::setmodelfromarray(_id_093F::main());
  scripts\code\character::attachhead("heads_un_marines_male", _id_09F6::main());
...
precache() {
  scripts\code\character::precachemodelarray(_id_093F::main());
  scripts\code\character::precachemodelarray(_id_09F6::main());
