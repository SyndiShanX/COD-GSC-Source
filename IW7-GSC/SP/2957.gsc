...
_id_10FA2() {
  ...
  for(;;) {
    ...
    self._id_10F9D._id_10FAA = var_2.ent;
...
stinger_get_closest_to_player_view(var_0, var_1, var_2, var_3) {
  ...
  foreach(var_10 in var_0) {
    ...
    var_15 = 1 - scripts\sp\math::_id_C097(squared(250), squared(5000), var_14);
...
_id_1833(var_0) {
  var_1 = spawnStruct();
  var_1.ent = var_0;
  var_1.id = self._id_10F9D._id_11565[0];
  ...
  if(isDefined(var_0._id_3508)) {
    ...
    setomnvar("ui_lockon_target_health_" + var_1.id, var_1.ent._id_8CB0);
  }

  self._id_10F9D._id_11565 = scripts\engine\utility::array_remove(self._id_10F9D._id_11565, var_1.id);
...
_id_41E3(var_0) {
  ...
  self._id_10F9D._id_11565[self._id_10F9D._id_11565.size] = var_0.id;
...
_id_9922(var_0) {
  return level.player worldpointinreticle_circle(_id_7E9A(var_0), 65, 45);
}

_id_9920(var_0) {
  return level.player worldpointinreticle_circle(_id_7E9A(var_0), 65, 75);
}

_id_9921(var_0) {
  return level.player worldpointinreticle_circle(_id_7E9A(var_0), 65, 35);
}
