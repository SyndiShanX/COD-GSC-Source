...
func_114D9() {
  ...
  for(;;) {
    ...
    if(isDefined(var_6.classname) && var_6.classname == "script_vehicle") {
      ...
      if(var_6 scripts\mp\utility\game::_hasperk("specialty_armorpiercing")) {
...
func_FAD8() {
  ...
  foreach(var_4 in var_0) {
    ...
    foreach(var_17 in var_2) {
      ...
      var_17 thread func_8982(var_4, "forward");
      var_17.var_BF2E = getvehiclenode(var_4.targetname, "targetname");
      var_17.var_AB5D = distance(var_17.origin, var_4.origin);

      if(!isDefined(var_4.var_2F45)) {
        var_4.var_2F45 = [];
      }

      var_4.var_2F45[var_4.var_2F45.size] = var_17;
      var_15 = 1;
    }
...
func_897F(var_0) {
  ...
  for(;;) {
    ...
    if(isDefined(var_1.endnode) && var_1.endnode != var_3) {
      var_4 = func_7FE9(var_1.endnode, var_1.veh_pathdir);

      if(!isDefined(var_4)) {
        var_1 thread func_F6C4(level.var_C74A[var_1.veh_pathdir]);
      }
    }

    if(!isDefined(var_4) || var_4 == var_3) {
      var_4 = var_3 dontinterpolate(var_1.veh_pathdir);
    }
...
func_98A6(var_0) {
  ...
  foreach(var_3 in var_0) {
    ...
    var_1[var_7] func_17EC(var_1[var_8._meth_848D], var_9, "forward", var_10);
    var_8 = var_3.var_D886;
    var_9 = distance(var_3.origin, var_8.origin);

    for(var_10 = var_8; !isDefined(var_8._meth_848D); var_8 = var_8.var_D886) {
      var_9 = var_9 + distance(var_8.origin, var_8.var_D886.origin);
    }

    var_1[var_7] func_17EC(var_1[var_8._meth_848D], var_9, "reverse", var_10);
...
func_7732(var_0, var_1, var_2, var_3) {
  ...
  for(;;) {
    foreach(var_9, var_8 in var_6.var_AD40) {
  ...
  for(var_6 = var_0; var_6 != var_1; var_6 = var_6.var_C8F6) {
