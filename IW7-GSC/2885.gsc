...
func_9AF3(var_0, var_1) {
  ...
  if(isDefined(var_1)) {
    ...
    scripts\sp\hud_util::func_10CCC();
    level.player getroundswon(1);
    level.player scripts\engine\utility::delaycall(var_1, ::getroundswon, 0);
...
func_22FD(var_0) {
  ...
  for(;;) {
    ...
    foreach(var_4 in level.var_3F69.var_22FD) {
      ...
      var_4 give_zap_perk(var_1[var_7]);
...
func_765E(var_0) {
  ...
  if(!level.var_7661.active) {
    level thread func_7662();
  }
}

func_7664() {
  level.var_7661.active = 1;
...
func_7662() {
  ...
  for(var_1 = 0; level.var_7661.var_11760.size; level.var_7661.var_11760 = scripts\sp\utility::array_remove_index(level.var_7661.var_11760, 0)) {
...
func_5F33(var_0, var_1) {
  ...
  for(var_3 = 0; var_3 < var_1; var_3++) {
    ...
    var_4 give_zap_perk(var_0.text);
