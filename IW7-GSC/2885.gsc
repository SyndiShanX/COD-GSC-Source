...
_id_B23E() {
  ...
  if(!isDefined(level._id_9AF3) || !scripts\sp\utility::_id_9BB5() || var_0) {
...
_id_9AF9(var_0, var_1, var_2, var_3) {
  ...
  if(!isDefined(var_3)) {
    ...
    scripts\sp\hud_util::_id_6AA3(var_3);
  }

  wait(var_1);
  scripts\sp\hud_util::_id_6A99(var_2);
  wait(var_2);
...
_id_9AF3(var_0, var_1) {
  ...
  if(isDefined(var_1)) {
    ...
    scripts\engine\utility::delaythread(var_1, scripts\sp\hud_util::_id_6A99, 2);
  }
  ...
  if(!var_0) {
    ...
    thread scripts\sp\hud_util::_id_6A99(2);
    level.player freezecontrols(0);
  }
...
_id_119A5(var_0, var_1) {
  ...
  var_2.glowcolor = (0.425, 0.465, 0.46) * _id_83E5();
  var_5 = 0.3;
...
_id_111A1(var_0, var_1, var_2, var_3, var_4) {
  ...
  var_5.glowcolor = (0.425, 0.465, 0.46) * _id_83E5();
...
_id_5F31(var_0, var_1) {
  ...
  for(var_3 = 0; var_3 < var_1; var_3++) {
    var_2[var_2.size] = _id_48B3(var_0.text);
  }
...
_id_765E(var_0) {
  ...
  if(!level._id_7661.active) {
    level thread _id_7662();
  }
}

_id_7664() {
  level._id_7661.active = 1;
...
_id_7662() {
  ...
  for(var_1 = 0; level._id_7661._id_11760.size; level._id_7661._id_11760 = scripts\sp\utility::array_remove_index(level._id_7661._id_11760, 0)) {
...
_id_1119F(var_0, var_1, var_2, var_3) {
  ...
  wait 0.1;
  scripts\engine\utility::array_thread(var_0, ::_id_913E, 0.1);
  var_6 = 0.15;
  var_4 fadeovertime(0.25);
  var_4.alpha = 0.2;
  var_4.color = (1, 1, 1);
