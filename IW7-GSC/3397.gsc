...
log_purchasingaweapon(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8) {
  ...
  if(var_3 == "none") {
    ...
    var_11 = var_1.wavesheldwithweapon[getweaponbasename(var_3)];
    var_6 = var_4 - var_11;
    var_1.wavesheldwithweapon[getweaponbasename(var_2)] = var_4;
...
log_1984_kills(var_0) {
  scripts\cp\cp_analytics::func_AF6A("1984_kills", undefined, [var_0], undefined);
}
...
log_card_data(var_0, var_1) {
  ...
  foreach(var_5, var_3 in var_1.consumables) {
    ...
    var_1 setrankedplayerdata("cp", "cards_used", var_5, var_4 + var_3.times_used);
  }
}
...
func_AF91(var_0, var_1) {
  ...
  foreach(var_8, var_6 in var_1.aggregateweaponkills) {
    ...
    var_7 = var_1 getrankedplayerdata("cp", "killsPerWeapon", scripts\cp\utility::getbaseweaponname(var_8));
    var_1 setrankedplayerdata("cp", "killsPerWeapon", scripts\cp\utility::getbaseweaponname(var_8), var_7 + var_6);
  ...
  if(var_7 < var_3) {
    ...
    if(!isDefined(var_1.aggregateweaponkills[var_9])) {
      ...
      var_1 setrankedplayerdata("cp", "DeadliestWeaponKills", var_9, var_1.aggregateweaponkills[var_9] + var_11);
    }
