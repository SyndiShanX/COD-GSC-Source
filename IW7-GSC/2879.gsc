...
setpointbar(var_0, var_1, var_2, var_3) {
  ...
  if(self.alignx == "left") {
    self.bar.x = self.x + self._id_13E1E;
  } else if(self.alignx == "right") {
    self.bar.x = self.x - (self.width - self._id_13E1E);
  } else {
    self.bar.x = self.x - int((self.width - self._id_13E1E * 2) / 2);
  }
...
updatebar(var_0) {
  var_1 = int((self.width - self._id_13E1E * 2) * var_0);
  ...
  self.bar.frac = var_0;
  self.bar setshader(self.bar.shader, var_1, self.height - self._id_13E5D * 2);
}

_id_8EB9(var_0) {
  var_0 = scripts\engine\utility::ter_op(isDefined(var_0), var_0, 1);

  if(var_0 || !isDefined(self._id_C708) || !isDefined(self.bar._id_C708)) {
    self._id_C708 = self.alpha;
    self.bar._id_C708 = self.bar.alpha;
  }

  self.alpha = scripts\engine\utility::ter_op(var_0, 0, self._id_C708);
  self.bar.alpha = scripts\engine\utility::ter_op(var_0, 0, self.bar._id_C708);
}
...
_id_10B56(var_0) {
  ...
  level._id_10B54.alignx = "right";
  level._id_10B54.aligny = "bottom";
  level._id_10B54.horzalign = "right";
  level._id_10B54.vertalign = "bottom";
  level._id_10B54.foreground = 1;
...
_id_491A() {
  if(level.console) {
    ...
    var_0 settext(level._id_1114E["mantle"]);
...
_id_48B8(var_0, var_1, var_2, var_3, var_4) {
  var_5 = scripts\sp\utility::_id_7B92();
...
_id_7B5D(var_0) {
  ...
  var_1._id_C7FD[var_0].sort = 0;
  var_1._id_C7FD[var_0].foreground = 1;
