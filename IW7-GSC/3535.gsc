...
runequipmentping(var_0, var_1) {
  ...
  if(var_2 scripts\mp\utility\game::_hasperk("specialty_equipment_ping")) {
    for(;;) {
      var_4 = 0;
      ...
      if(gettime() >= self.equipping_lastpingtime + 3000) {
        foreach(var_6 in level.players) {
          ...
          if(var_6 scripts\mp\utility\game::_hasperk("specialty_engineer")) {
            continue;
          }
          ...
          if(distance2d(var_6.origin, self.origin) < 300 && scripts\engine\trace::ray_trace_passed(var_8, var_6 gettagorigin("j_head"), var_7)) {
            if(!var_6 scripts\mp\utility\game::_hasperk("specialty_gpsjammer")) {
