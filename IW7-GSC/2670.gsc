...
init() {
  ...
  level.medusa_check_func = ::_id_65F5;
  level.medusa_killed_func = ::_id_A630;
  level._id_B549 = [];
...
_id_49E8(var_0) {
  ...
  var_1.carriedmedusa setModel(level._id_B549["crafted_medusa"].modelbase);
...
_id_B543(var_0, var_1) {
  self setModel(level._id_B549["crafted_medusa"].modelplacement);
...
_id_B541(var_0, var_1) {
  ...
  thread scripts\cp\utility::item_timeout(var_0, level._id_B549["crafted_medusa"].timeout);
  thread _id_B53D();
  thread _id_B547();
  self._id_3CC3 = 0;
