...
_id_77FF(var_0, var_1, var_2, var_3) {
  ...
  foreach(var_6 in var_1) {
    if(!isalive(var_6) || !isDefined(var_6) || !var_3 && isDefined(var_6.a._id_58DA)) {
      continue;
    }
...
_id_65E6(var_0, var_1) {
  ...
  while(isDefined(self)) {
    ...
    scripts\sp\utility_code::_id_65FA(var_0, var_1);
  }
}
...
_id_6E49(var_0, var_1, var_2) {
  ...
  var_1 thread scripts\sp\utility_code::_id_1287(var_0, var_2);
  return var_1;
}
...
_id_6E4A(var_0, var_1, var_2) {
  ...
  for(var_3 = 0; var_3 < var_1.size; var_3++) {
    var_1[var_3] thread scripts\sp\utility_code::_id_1287(var_0, 0);
  }
...
_id_2679() {
  scripts\sp\utility_code::_id_2680();
  thread scripts\sp\utility_code::_id_267F();
}
...
_id_266B(var_0, var_1, var_2, var_3) {
  ...
  var_5 = level scripts\sp\autosave::_id_12891(level._id_4B18, "autosave", var_4, var_1, var_2, var_3);
...
_id_7E33(var_0, var_1, var_2) {
  return scripts\sp\utility_code::_id_4461(var_0, var_1, var_2, ::_id_4295);
}
...
_id_1101B() {
  ...
  if(isai(self)) {
    if(isDefined(self._id_C3B0)) {
      self.attackeraccuracy = self._id_C3B0;
...
_id_B14F(var_0) {
  ...
  if(isai(self)) {
    self._id_C3B0 = self.attackeraccuracy;
...
_id_C812() {
  if(isDefined(self.a._id_4C42)) {
    self.a._id_2274["crawl"] = self.a._id_4C42["crawl"];
    self.a._id_2274["death"] = self.a._id_4C42["death"];
    self.a._id_486A = self.a._id_4C42["blood_fx_rate"];

    if(isDefined(self.a._id_4C42["blood_fx"])) {
      self.a._id_4869 = self.a._id_4C42["blood_fx"];
    }
  }

  self.a._id_2274["stand_2_crawl"] = [];

  if(isDefined(self._id_C05D)) {
    self.a.pose = "prone";
  }

  self orientmode("face angle", self.a._id_7266);
  self.a._id_7266 = undefined;
}

_id_7268(var_0, var_1, var_2, var_3) {
  self._id_72CC = 1;
  self.a._id_7280 = var_1;
  self.noragdoll = 1;
  self._id_C05D = var_3;
  self.a._id_4C42 = var_2;
  ...
  if(!isDefined(var_3) || var_3 == 0) {
    self.a._id_7266 = var_0 + 181.02;
  } else {
    self.a._id_7266 = var_0;
...
play_sound_on_tag(var_0, var_1, var_2, var_3, var_4) {
  ...
  var_5 endon("death");
  thread scripts\sp\utility_code::_id_517B(var_5, "sounddone");
  ...
  if(isDefined(var_2)) {
    if(!isDefined(scripts\sp\utility_code::_id_1362A(var_5))) {
      var_5 stopsounds();
    }
...
_id_CE48(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  thread scripts\sp\utility_code::_id_517B(var_6, "sounddone");
  ...
  if(isDefined(var_3)) {
    if(!isDefined(scripts\sp\utility_code::_id_1362A(var_6))) {
      var_6 stopsounds();
    }
...
_id_F3A5(var_0, var_1, var_2, var_3) {
  ...
  scripts\engine\utility::array_thread(var_0, ::_id_F3A8, var_4, var_3);
...
_id_13754(var_0, var_1, var_2) {
  ...
  if(isDefined(var_2)) {
    ...
    var_7 thread scripts\sp\utility_code::_id_13758(var_2);
  }
  ...
  scripts\engine\utility::array_thread(var_0, scripts\sp\utility_code::_id_13756, var_7);
...
_id_28D7(var_0) {
  ...
  for(var_4 = 0; var_4 < var_1.size; var_4++) {
    ...
    var_5 scripts\sp\utility_code::_id_1368E();
    anim._id_29B7 = 0;
  }
...
_id_28D8(var_0) {
  thread scripts\sp\utility_code::_id_28D9(var_0);
}
...
_id_F2DA(var_0) {
  ...
  if(var_0) {
    if(isDefined(self._id_ED17) && !self._id_ED17 || isDefined(self.unittype) && self.unittype == "c8" || isDefined(self.unittype) && self.unittype == "c12" || isDefined(self.asmname) && self.asmname == "seeker") {
      self._id_28CF = 0;
    } else {
      self._id_28CF = 1;
    }
...
_id_F3B0(var_0, var_1, var_2) {
  ...
  scripts\engine\utility::array_thread(var_3, ::_id_F3AF, var_0);
}
...
_id_F3BC() {
  ...
  self._id_C3EC = self.pathenemyfightdist;
  self._id_C3F4 = self.pathenemylookahead;
  self._id_C3F5 = self.maxsightdistsqrd;
...
_id_12BFA() {
  ...
  self.pathenemyfightdist = self._id_C3EC;
  self.pathenemylookahead = self._id_C3F4;
  self.maxsightdistsqrd = self._id_C3F5;
...
_id_11161(var_0, var_1) {
  var_0._id_2274[var_0.lastindex] = var_1;
  var_1._id_11159 = var_0.lastindex;
  var_0.lastindex++;
}

_id_11162(var_0, var_1) {
  _id_11167(var_0, var_1);
  var_0._id_2274[var_0.lastindex - 1] = undefined;
  var_0.lastindex--;
}

_id_11163(var_0, var_1) {
  if(isDefined(var_0._id_2274[var_0.lastindex - 1])) {
    var_0._id_2274[var_1] = var_0._id_2274[var_0.lastindex - 1];
    var_0._id_2274[var_1]._id_11159 = var_1;
    var_0._id_2274[var_0.lastindex - 1] = undefined;
    var_0.lastindex = var_0._id_2274.size;
  } else {
...
_id_11167(var_0, var_1) {
  var_0 scripts\sp\utility_code::_id_11166(var_0._id_2274[var_0.lastindex - 1], var_1);
}

_id_11165(var_0, var_1) {
  for(var_2 = 0; var_2 < var_1; var_2++) {
    var_0 scripts\sp\utility_code::_id_11166(var_0._id_2274[var_2], var_0._id_2274[randomint(var_0.lastindex)]);
  }
}
...
_id_54F7() {
  ...
  level._id_22E0[scripts\sp\colors::_id_7CE4()][self._id_EDAD] = ::scripts\engine\utility::array_remove(level._id_22E0[scripts\sp\colors::_id_7CE4()][self._id_EDAD], self);
  scripts\sp\colors::_id_AB3A();
...
_id_F3B5(var_0) {
  ...
  self._id_C3BE = undefined;
  var_2 = scripts\sp\colors::_id_7CE4();
  ...
  level._id_22E0[var_2][self._id_EDAD] = ::scripts\engine\utility::array_add(level._id_22E0[var_2][self._id_EDAD], self);
  thread scripts\sp\utility_code::_id_BF01(var_1);
}
...
_id_131CC() {
  scripts\sp\vehicle_code::_id_13219();
}

_id_13221() {
  thread scripts\sp\vehicle_paths::_id_13222();
}

_id_131FF(var_0) {
  scripts\sp\vehicle_code::_id_13201(var_0);
}

_id_13206(var_0) {
  scripts\sp\vehicle_code::_id_13207(var_0);
}

_id_131D5(var_0, var_1) {
  scripts\sp\vehicle::_id_1321A(var_0, var_1);
}
...
_id_8201(var_0, var_1) {
  return scripts\sp\vehicle_code::_id_12B8(var_0, var_1);
}

_id_1749(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  scripts\sp\starts::_id_174A();
  var_0 = tolower(var_0);
  var_7 = scripts\sp\starts::_id_174B(var_0, var_1, var_2, var_3, var_4, var_5, var_6);
...
_id_5480(var_0) {
  _id_29C0();
  scripts\sp\anim::_id_1F32(self, var_0);
}

_id_7749(var_0, var_1) {
  _id_29C0();
  scripts\sp\anim::_id_1ECD(self, var_0, undefined, undefined, var_1);
}
...
_id_DBEF(var_0, var_1) {
  ...
  if(!isDefined(var_1)) {
    var_3 = level._id_D24D _id_74D7(::play_sound_on_tag, level._id_EC91[var_0], undefined, 1);
  } else {
    var_3 = level._id_D24D _id_74DD(var_1, ::play_sound_on_tag, level._id_EC91[var_0], undefined, 1);
  }
...
_id_DBF2(var_0) {
  level._id_D24D play_sound_on_tag(level._id_EC91[var_0], undefined, 1);
}
...
_id_10350(var_0, var_1) {
  scripts\sp\utility_code::_id_1778(var_0);
  _id_DBEF(var_0, var_1);
}
...
_id_1369(var_0, var_1, var_2, var_3, var_4) {
  ...
  if(!isDefined(scripts\sp\utility_code::_id_1362A(var_5, level.player))) {
    var_5 stopsounds();
  }
...
_id_1034D(var_0, var_1) {
  scripts\sp\utility_code::_id_1773(var_0);
  _id_D01B(var_0, var_1);
}
...
_id_10346(var_0) {
  scripts\sp\utility_code::_id_175F(var_0);
  _id_5480(var_0);
}

_id_10347(var_0) {
  scripts\sp\utility_code::_id_1760(var_0);
  _id_7749(var_0);
}
...
_id_F294() {
  ...
  self.unique_id = "ai" + level._id_19C9;
  level._id_19C9++;
}
...
_id_E198() {
  scripts\sp\colors::_id_43AA();
}

_id_107B3(var_0, var_1) {
  scripts\sp\colors::_id_43AC(var_0, var_1);
}
...
_id_13624(var_0) {
  scripts\sp\utility_code::_id_13634(var_0, "script_noteworthy");
}

_id_13630(var_0) {
  scripts\sp\utility_code::_id_13634(var_0, "targetname");
}
...
_id_135CA(var_0, var_1) {
  ...
  for(var_4 = 0; var_4 < var_3.size; var_4++) {
    var_2 thread scripts\sp\utility_code::_id_65FB(var_3[var_4]);
  }
...
_id_6B47(var_0) {
  ...
  if(isDefined(var_0._id_EE5F)) {
    var_1.noragdoll = var_0._id_EE5F;
  }
...
_id_9591() {
  if(!isDefined(self.script_animation)) {
    ...
    if(isai(self)) {
      ...
      _id_F333(self.script_animation);
      self _meth_81D0();
      return;
    }

    self animScripted("corpse_anim", self.origin, self.angles, _id_7DC1(self.script_animation), "deathplant", undefined, 0);

    if(self.script_noteworthy != "corpse_noragdoll") {
      var_3 = getanimlength(_id_7DC1(self.script_animation));
...
_id_6DDE(var_0) {
  ...
  if(isDefined(self._id_11A3F[var_0.unique_id])) {
    return 0;
  }

  self._id_11A3F[var_0.unique_id] = 1;
  return 1;
}
...
_id_F48E(var_0, var_1) {
  scripts\asm\asm::asm_setdemeanoranimoverride(var_0, "move", level._id_EC85[self._id_1FBB][var_1]);
}
...
_id_F40E(var_0, var_1) {
  scripts\asm\asm::asm_setdemeanoranimoverride(var_0, "idle", level._id_EC85[self._id_1FBB][var_1]);
}
...
_id_C81A(var_0) {
  var_1 = _id_0A1E::_id_2357(self.asm.archetype, "move_walk_loop", "casual_purpose");
...
_id_416A() {
  thread _id_4169(scripts\asm\asm::asm_getdemeanor());
  thread _id_412D();
}
...
_id_13035(var_0, var_1, var_2) {
  ...
  var_6 = physicstrace(var_5, var_5 + (0, 0, -72));
...
_id_15F1(var_0, var_1, var_2) {
  if(!isDefined(var_0)) {
    ...
    scripts\engine\utility::array_thread(var_3, ::_id_15F2, var_2);
  }
}
...
_id_15F2(var_0) {
  if(isDefined(self._id_ED33)) {
    ...
    scripts\sp\colors::_id_159B("allies");
  }

  if(isDefined(self._id_ED34)) {
    self.activated_color_trigger = 1;
    scripts\sp\colors::_id_159B("axis");
  }
...
_id_8B6C() {
  if(scripts\sp\colors::_id_7CE4() == "axis") {
...
_id_13763(var_0, var_1, var_2, var_3) {
  var_4 = spawnStruct();
  thread scripts\sp\utility_code::_id_13764(var_4, var_0, var_1);
  thread scripts\sp\utility_code::_id_13764(var_4, var_2, var_3);
  var_4 waittill("done");
}
...
_id_56BA(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(level._id_1274F[var_0])) {
    ...
    var_4 thread scripts\sp\utility_code::_id_9021(level._id_12750[var_0], level._id_1274F[var_0], var_1, var_2, var_3);
  } else
    var_4 thread scripts\sp\utility_code::_id_9021(level._id_12750[var_0]);
}
...
_id_56BE(var_0, var_1, var_2, var_3, var_4) {
  ...
  var_5 thread scripts\sp\utility_code::_id_9021(level._id_12750[var_0], level._id_1274F[var_0], var_2, var_3, var_4, var_1);
}
...
_id_56BF(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  var_1 = scripts\engine\utility::ter_op(isDefined(var_1), var_1, 6);
  var_6 thread scripts\sp\utility_code::_id_9021(level._id_12750[var_0], level._id_1274F[var_0], var_3, var_4, var_5, var_1, var_2);
}
...
_id_56BB(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9) {
  ...
  var_10 = scripts\sp\utility_code::_id_900D(var_0, var_1, var_2, var_3, var_4, var_5, var_6);
  _id_56BA(var_10, var_7, var_8, var_9);
  thread scripts\sp\utility_code::_id_900E(var_0, var_1, var_2, var_3, var_4, var_5, var_6);
}
...
_id_56BC(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10) {
  ...
  var_11 = scripts\sp\utility_code::_id_900D(var_0, var_2, var_3, var_4, var_5, var_6, var_7);
  thread _id_56BE(var_11, var_1, var_8, var_9, var_10);
  thread scripts\sp\utility_code::_id_900E(var_0, var_2, var_3, var_4, var_5, var_6, var_7);
}
...
_id_56BD(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11) {
  ...
  var_12 = scripts\sp\utility_code::_id_900D(var_0, var_3, var_4, var_5, var_6, var_7, var_8);
  thread _id_56BF(var_12, var_1, var_2, var_9, var_10, var_11);
  thread scripts\sp\utility_code::_id_900E(var_0, var_3, var_4, var_5, var_6, var_7, var_8);
}
...
_id_10619(var_0, var_1) {
  ...
  var_2 = undefined;
  var_3 = isDefined(self._id_EED1) && scripts\engine\utility::flag("stealth_enabled") && !scripts\engine\utility::flag("stealth_spotted");
...
_id_74D7(var_0, var_1, var_2, var_3, var_4, var_5) {
  var_6 = spawnStruct();
  var_6 thread scripts\sp\utility_code::_id_74DB(self, var_0, var_1, var_2, var_3, var_4, var_5);
  return scripts\sp\utility_code::_id_74DF(var_6);
}

_id_74DD(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  var_7 = spawnStruct();
  var_7 thread scripts\sp\utility_code::_id_74DB(self, var_1, var_2, var_3, var_4, var_5, var_6);

  if(isDefined(var_7._id_74DA) || var_7 scripts\engine\utility::waittill_any_timeout(var_0, "function_stack_func_begun") != "timeout") {
    return scripts\sp\utility_code::_id_74DF(var_7);
  } else {
    var_7 notify("death");
    return 0;
  }
...
_id_22C6(var_0, var_1, var_2) {
  ...
  foreach(var_5 in var_0) {
    ...
    if(getsubstr(var_5.classname, 7, 10) == "veh") {
      ...
      if(isDefined(var_6.target) && !isDefined(var_6._id_EE2B)) {
        var_6 thread scripts\sp\vehicle_paths::_id_845A();
      }
...
_id_16C5(var_0, var_1, var_2) {
  ...
  if(level._id_545A.size == 5) {
    ...
    level._id_545A = array_remove_index(level._id_545A, 0);
    _id_12DB1();
...
_id_12DB1() {
  level._id_545A = scripts\engine\utility::array_removeundefined(level._id_545A);
...
_id_266F(var_0) {
  return scripts\sp\autosave::_id_1190(var_0);
}

_id_2670() {
  return scripts\sp\autosave::_id_1190(1);
}
...
_id_200D(var_0, var_1) {
  if(var_1) {
    if(!isDefined(level._id_2006._id_5602) || level._id_2006._id_5602.size == 0 || var_0 == "all") {
      ...
      level._id_2006._id_5602 = scripts\engine\utility::array_combine_unique(level._id_2006._id_5602, [var_0]);
  } else {
    ...
    if(var_0 == "all") {
      ...
      level._id_2006._id_5602 = scripts\engine\utility::array_remove_array(level._id_2006._id_5602, [var_0]);
      return;
    }
  }
}
...
_id_22D8(var_0, var_1, var_2) {
  ...
  for(var_5 = 0; var_5 < var_3.size; var_5++) {
    ...
    var_4[var_6] thread scripts\sp\utility_code::_id_22D9(var_0[var_6], var_1, var_2);
  }
...
_id_57D5(var_0) {
  ...
  var_1 scripts\engine\utility::array_levelthread(var_2, scripts\sp\utility_code::_id_13774, var_3);
  var_1 thread scripts\sp\utility_code::_id_5767(var_7);
  ...
  scripts\engine\utility::array_levelthread(var_4, scripts\sp\utility_code::_id_68CE, []);
  scripts\engine\utility::array_levelthread(var_5, scripts\sp\utility_code::_id_68CC);
  scripts\engine\utility::array_levelthread(var_6, scripts\sp\utility_code::_id_68CD);
}
...
_id_578A() {
  ...
  foreach(var_3 in var_1) {
    level scripts\sp\utility_code::_id_68CE(var_3, []);
  }
...
_id_BF95(var_0) {
  scripts\sp\endmission::_id_1355(var_0);
}
...
_id_BF97(var_0, var_1, var_2) {
  ...
  scripts\sp\endmission::_id_1356(var_0, var_1, var_2);
  scripts\engine\utility::flag_set("nextmission_preload_complete");
}

_id_BF98() {
  scripts\sp\endmission::_id_1357();
}

_id_CE6D(var_0) {}

_id_7F6E(var_0) {
  return scripts\sp\endmission::_id_12B0(var_0);
}

_id_7E2C(var_0) {
  return scripts\sp\endmission::_id_12AF(var_0);
}

_id_7F70(var_0) {
  return scripts\sp\endmission::_id_12B1(var_0);
}
...
_id_13705(var_0) {
  ...
  scripts\sp\endmission::_id_1455(var_0);
}

_id_13C3C(var_0) {
  scripts\sp\endmission::_id_1463(var_0);
}

_id_13C60() {
  scripts\sp\endmission::_id_1464();
}
...
_id_BDDF(var_0, var_1, var_2, var_3, var_4) {
  thread scripts\sp\utility_code::_id_BDE1(var_0, var_1, var_2, var_3, var_4);
}

_id_BDE3(var_0, var_1, var_2, var_3, var_4) {
  thread scripts\sp\utility_code::_id_BDE1(var_0, var_1, var_2, var_3, var_4, 1);
}

_id_BDE5(var_0, var_1, var_2, var_3) {
  if(isDefined(var_1) && var_1 > 0) {
    thread scripts\sp\utility_code::_id_BDE6(var_0, var_1, var_2, var_3);
    return;
  }
...
_id_BDD5(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(level._id_1188._id_A90A)) {
    musicstop(var_1, level._id_1188._id_A90A, var_3);
  } else {}
...
_id_12687() {
  ...
  scripts\engine\utility::array_levelthread(var_0, scripts\sp\utility_code::_id_12688);
}
...
_id_61F1(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  self._id_5953 = var_5;
  thread scripts\sp\utility_code::_id_5F8E(var_0, var_1, var_2, var_3, var_4);
}
...
_id_D2D1(var_0, var_1) {
  ...
  var_3 = scripts\sp\utility_code::_id_764E;
  var_4 = scripts\sp\utility_code::_id_764F;
  level.player thread _id_D2CE(var_0, var_1, var_3, var_4, "player_speed_set");
}

_id_CF97(var_0, var_1) {
  var_2 = scripts\sp\utility_code::_id_7647;
  var_3 = scripts\sp\utility_code::_id_7648;
...
_id_2B76(var_0, var_1) {
  ...
  var_3 = scripts\sp\utility_code::_id_BCF0;
  var_4 = scripts\sp\utility_code::_id_BCF3;
...
_id_2A75(var_0, var_1, var_2) {
  ...
  var_3 _meth_84FE();
  var_3 forceplaygestureviewmodel("ges_slide", var_5._id_77BA, 0.2);

  if(isDefined(level._effect["vfx_slide_dirt"])) {
    var_16 = scripts\engine\utility::getfx("vfx_slide_dirt");
    playFXOnTag(scripts\engine\utility::getfx("vfx_slide_dirt"), var_3._id_7601, "tag_origin");
    var_3._id_7601 show();
  }
  ...
  var_3 thread scripts\sp\utility_code::_id_5AAD(var_5, var_1, var_2);
...
_id_6389() {
  ...
  if(level.player islinked()) {
    var_0 unlink();
    var_0 setvelocity(var_0._id_102EB.slidevelocity);
  }
  ...
  if(isDefined(var_0._id_7601)) {
    if(isDefined(level._effect["vfx_slide_dirt"])) {
      ...
      if(isDefined(var_1)) {
        stopFXOnTag(scripts\engine\utility::getfx("vfx_slide_dirt"), var_0._id_7601, "tag_origin");
      }
    }
...
_id_10808() {
  return scripts\sp\vehicle::_id_13237(self);
}

_id_7E9C(var_0) {
  var_1 = scripts\sp\trigger::_id_7AA4();
  var_2 = [];
  ...
  var_7 = scripts\sp\trigger::_id_7AA5();
...
_id_58DA() {
  return isDefined(self.a._id_58DA);
}
...
_id_7C23(var_0) {
  ...
  var_2._id_99E5 = 1;
  var_2 thread scripts\sp\utility_code::_id_12E1F(var_1, var_0);
  return var_2;
}
...
_id_61FF(var_0) {
  ...
  self.custommoveanimset["run"] = ::scripts\anim\utility::_id_B028("heat_run");
}
...
_id_8FE1(var_0, var_1, var_2) {
  ...
  if(isDefined(level._id_9019)) {
    level._id_9019 scripts\sp\hud_util::destroyelem();
  }

  level._id_9019 = scripts\sp\hud_util::createfontstring("default", 1.5);
  level._id_9019 scripts\sp\hud_util::setpoint("MIDDLE", undefined, 0, 30 + var_2);
  level._id_9019.color = (1, 1, 1);
  level._id_9019 settext(var_0);
...
_id_A5CE(var_0, var_1) {
  ...
  foreach(var_3 in level._id_4E3F[var_0]) {
    foreach(var_5 in var_3) {
      if(isalive(var_5)) {
        var_5 thread scripts\sp\utility_code::_id_A5CF(var_1);
        continue;
      }
...
_id_48AA(var_0, var_1, var_2, var_3) {
  var_4 = spawnStruct();
  var_4 childthread scripts\sp\utility_code::_id_D961(var_0, self, var_1, var_2, var_3);
  return var_4;
}
...
_id_D0F4() {
  ...
  return isDefined(var_0.space) && var_0.space._id_6F43;
}

_id_CFAA() {
  level.player _id_65DD("player_zero_attacker_accuracy");
  level.player.ignorerandombulletdamage = 0;
  level.player scripts\sp\gameskill::_id_12E0B();
}
...
_id_F520(var_0) {
  var_1 = _id_7B92();
  var_1.gs._id_CF81 = var_0;
  var_1 scripts\sp\gameskill::_id_12E0B();
}
...
_id_78D5() {
  var_0 = scripts\sp\utility_code::_id_78D1();
  var_1 = var_0["team"];
...
dirteffect(var_0, var_1) {
  ...
  foreach(var_5, var_4 in var_2) {
    thread scripts\sp\gameskill::_id_8587(var_5);
  }
}
...
_id_2BC6(var_0) {
  ...
  var_1 = _id_ECC4(self.damageattacker.origin);

  foreach(var_4, var_3 in var_1) {
    thread scripts\sp\gameskill::_id_2BC1(var_4);
  }
}
...
_id_C971(var_0) {
  if(!isDefined(self._id_C3D0)) {
    self._id_C3D0 = self.pathrandompercent;
  }
...
_id_C970() {
  self.pathrandompercent = self._id_C3D0;
...
_id_13876() {
  ...
  self._id_C3E2 = self.walkdist;
  self._id_C3E3 = self.walkdistfacingmotion;
  self.walkdist = 0;
  self.walkdistfacingmotion = 0;
}

_id_13875() {
  self.walkdist = self._id_C3E2;
  self.walkdistfacingmotion = self._id_C3E3;
...
_id_8E9A() {
  if(!isDefined(self._id_C3E9)) {
    self._id_C3E9 = self setcontents(0);
  }
...
_id_100FC() {
  ...
  if(isDefined(self._id_C3E9)) {
    self setcontents(self._id_C3E9);
  }
...
_id_50E4(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  childthread scripts\sp\utility_code::_id_50E5(var_1, var_0, var_2, var_3, var_4, var_5, var_6, var_7);
}
...
_id_6E7C(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  ...
  thread scripts\sp\utility_code::_id_6E7D(var_1, var_0, var_2, var_3, var_4, var_5, var_6);
}
...
_id_13843(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  ...
  thread scripts\sp\utility_code::_id_13844(var_1, var_0, var_2, var_3, var_4, var_5, var_6);
}
...
_id_F323(var_0) {
  ...
  thread scripts\sp\gameskill::_id_E26C();
}
...
_id_F2DC(var_0, var_1) {
  ...
  scripts\sp\utility_code::_id_12D95();
}
...
_id_7617(var_0, var_1) {
  ...
  wait 0.05;
  scripts\sp\utility_code::_id_7615(var_2, var_1);
}
...
_id_7618(var_0) {
  scripts\engine\utility::array_thread(var_0.fx, ::_id_E2B0);
}
...
_id_178A(var_0) {
  if(!isDefined(self._id_1274A)) {
    thread scripts\sp\utility_code::_id_1789();
  }
...
_id_10461(var_0, var_1, var_2, var_3) {
  ...
  wait 0.05;
  scripts\engine\utility::delaycall(0.05, ::_meth_8278, var_1, var_2);
}
...
_id_9ACE(var_0, var_1, var_2, var_3, var_4) {
  ...
  scripts\engine\utility::noself_array_call(level._id_9AF3._id_ACF2, ::precachestring);
}
...
_id_7229(var_0) {
  ...
  if(isDefined(var_0.animation)) {
    var_0 scripts\sp\anim::_id_1ECE(self, var_0.animation);
    self notify("starting_anim", var_0.animation);

    if(isDefined(var_0.script_parameters) && issubstr(var_0.script_parameters, "gravity")) {
      var_0 scripts\sp\anim::_id_1ECB(self, var_0.animation);
    } else {
      var_0 scripts\sp\anim::_id_1ED1(self, var_0.animation);
    }
...
_id_D6D9(var_0) {
  ...
  level._id_D6D8 = scripts\engine\utility::array_add(level._id_D6D8, var_0);
}
...
_id_1119E(var_0, var_1, var_2, var_3) {
  ...
  foreach(var_10, var_8 in var_0) {
    var_9 = scripts\sp\introscreen::_id_111A0(var_8, var_1, var_4, var_5 + var_10 * 20, "center", var_2, var_3);
    var_6 = scripts\engine\utility::array_combine(var_9, var_6);
  }

  wait(var_1);
  scripts\sp\introscreen::_id_1119F(var_6, var_4, var_5, var_0.size);
}

_id_97A2() {
  if(!scripts\engine\utility::add_init_script("waits", ::_id_97A2)) {
    return;
  }
...
_id_77DD(var_0) {
  level._id_1162[var_0]._id_1912 = array_removedeadvehicles(level._id_1162[var_0]._id_1912);
  level._id_1162[var_0]._id_1912 = scripts\engine\utility::array_removeundefined(level._id_1162[var_0]._id_1912);
...
_id_77DF(var_0) {
  return level._id_1162[var_0].spawners;
}
...
_id_75CD() {
  ...
  self endon("entitydeleted");
  var_0 = _id_79E1();
  self._id_760A = scripts\engine\utility::array_add(self._id_760A, var_0);
...
_id_EBA6(var_0, var_1) {
  ...
  if(isDefined(var_0)) {
    setsaveddvar("bg_gravity", level._id_84D9 * var_0);
  }

  if(isDefined(var_1)) {
    physics_setgravity((0, 0, level._id_8519 * var_1));
  }
}
...
_id_E1F0() {
  setsaveddvar("bg_gravity", level._id_84D9);
  physics_setgravity((0, 0, level._id_8519));
}
...
_id_77B8(var_0, var_1, var_2, var_3) {
  ...
  for(;;) {
    if(var_5 < var_4 && scripts\sp\interaction_manager::_id_3838(var_1 * 3.0)) {
      break;
    }
...
_id_7B9D() {
  return level._id_D127._id_B154 / scripts\sp\gameskill::_id_7A59();
}
...
_id_1C34(var_0) {
  if(var_0) {
    ...
    if(!self._id_55BD) {
      if(isDefined(self._id_1586)) {
        self setactionslot(1, "weapon", self._id_1586);
      }
    }
  } else {
    if(!isDefined(self._id_55BD)) {
...
_id_7BD7() {
  if(level.player.curobjid == "") {
    return 0;
  } else if(_id_799D(level.player.curobjid) == "drain") {
    return 1;
  } else {
...
_id_9187(var_0, var_1, var_2) {
  scripts\sp\outline::_id_9188(var_0, var_1, var_2);
}

_id_9189(var_0, var_1, var_2) {
  scripts\sp\outline::_id_918A(var_0, var_1, var_2);
}

_id_9199(var_0, var_1) {
  scripts\sp\outline::_id_919A(var_0, var_1);
}

_id_9196(var_0, var_1, var_2, var_3) {
  scripts\sp\outline::_id_9197(var_3, var_0, var_1, var_2, 0);
}

_id_9198(var_0, var_1, var_2, var_3) {
  scripts\sp\outline::_id_9197(var_3, var_0, var_1, var_2, 1);
}

_id_9193(var_0) {
  scripts\sp\outline::_id_9194(var_0);
}

_id_918D(var_0, var_1) {
  scripts\sp\outline::_id_CC8D(var_0, var_1);
  level notify("hudoutline_anim_complete");
  level notify("hudoutline_anim_complete" + var_0);
}

_id_918E(var_0, var_1) {
  thread scripts\sp\outline::_id_CC8E(var_0, var_1);
}
...
_id_91A9(var_0) {
  ...
  setsaveddvar("r_hudoutlineFillColor0", var_1);
  setsaveddvar("r_hudoutlineFillColor1", var_2);
...
_id_918B(var_0, var_1, var_2) {
  ...
  wait 0.05;
  setsaveddvar("r_hudoutlineEnable", 1);
  level.player._id_20F8 = scripts\engine\utility::spawn_tag_origin();
...
_id_9674() {
  ...
  scripts\engine\utility::array_thread(var_0, ::_id_B2FC);
}

_id_B2FC() {
  if(isDefined(self._id_EDA0)) {
    scripts\engine\utility::flag_init(self._id_EDA0);
  }

  if(isDefined(self._id_ED48)) {
    scripts\engine\utility::flag_init(self._id_ED48);
  }
    ...
    for(var_0 = 0; var_0 < 3; var_0++) {
      if(self.script_rotation_max[var_0] != 0) {
        if(self.script_rotation_speed[var_0] > 0) {
          self._id_E746[var_0] = ::scripts\sp\math::_id_10AB0(self.script_rotation_speed[var_0] * 10, 0, self._id_10BA1[var_0] + self.script_rotation_max[var_0], 0);
          continue;
        }
      }
    }
    ...
    for(var_0 = 0; var_0 < 3; var_0++) {
      if(self._id_EEE9[var_0] != 0) {
        if(self._id_EEEA[var_0] > 0) {
          self._id_12689[var_0] = ::scripts\sp\math::_id_10AB0(self._id_EEEA[var_0] * 10, 0, self._id_10CCA[var_0] + self._id_EEE9[var_0], 0);
          continue;
        }
      }
    }
...
_id_12686() {
  ...
  for(;;) {
    ...
    for(var_1 = 0; var_1 < 3; var_1++) {
      ...
      if(self._id_EEEA[var_1] > 0 && self._id_EEE9[var_1] != 0) {
        var_0[var_1] = ::scripts\sp\math::_id_10AB4(self._id_12689[var_1], self._id_10CCA[var_1]);
      }
    }
...
_id_E702() {
  ...
  for(;;) {
    ...
    for(var_1 = 0; var_1 < 3; var_1++) {
      ...
      if(self.script_rotation_speed[var_1] > 0 && self.script_rotation_max[var_1] != 0) {
        var_0[var_1] = ::scripts\sp\math::_id_10AB4(self._id_E746[var_1], self._id_10BA1[var_1]);
      }
    }
...
_id_B2FA() {
  ...
  if(isDefined(self._id_E746)) {
    foreach(var_1 in self._id_E746) {
      scripts\sp\math::_id_10AAA(var_1);
    }
  }
...
_id_4125(var_0, var_1, var_2) {
  ...
  if(isDefined(var_2)) {
    if(isDefined(self._id_13C4D) && self._id_13C4D.model == getweaponmodel(var_2)) {
...
_id_CE10(var_0, var_1, var_2) {
  ...
  setsaveddvar("bg_cinematicCanPause", "1");
  cinematicingame(var_0);
  thread scripts\sp\gameskill::_id_E080();
  _id_E006();
  ...
  if(isDefined(var_2)) {
    ...
    level.player thread scripts\sp\gameskill::_id_8CBA();
