...
setpoint(var_0, var_1, var_2, var_3, var_4) {
  ...
  if(scripts\mp\utility\game::strip_suffix(var_6, "_adjustable") == var_5.alignx) {
    var_8 = 0;
    var_9 = 0;
  ...
  if(scripts\mp\utility\game::strip_suffix(var_7, "_adjustable") == var_5.aligny) {
    var_10 = 0;
    var_11 = 0;
...
func_4A16(var_0, var_1, var_2, var_3) {
  if(isDefined(var_3)) {
...
func_4A14(var_0, var_1, var_2, var_3, var_4, var_5) {
  if(isDefined(var_4)) {
...
func_4A24(var_0) {
  var_1 = func_4A14((1, 0, 0), level.var_115E3, level.var_115E1, undefined, var_0);
  var_1 setpoint("TOP", undefined, 0, level.var_115E4);
  return var_1;
}

func_4A25(var_0) {
  var_1 = func_4A15("default", level.var_115E0, var_0);
  var_1 setpoint("TOP", undefined, 0, level.var_115E2);
  return var_1;
}
