...
func_1288B(var_0) {
  ...
  if(scripts\mp\killstreaks\utility::func_A69F(var_0, "passive_increased_frost")) {
    var_4 = var_4 - 10;
  }

  if(scripts\mp\killstreaks\utility::func_A69F(var_0, "passive_speed_heavy")) {
    var_6 = "veh_venom_mp_fast";
  }

  if(scripts\mp\killstreaks\utility::func_A69F(var_0, "passive_stealth_speed")) {
  ...
  level thread scripts\mp\utility\game::teamplayercardsplash(var_7, self);
  return 1;
}
  ...
  for(;;) {
    ...
    if(isplayer(var_2)) {
      ...
      if(self.var_EDD7 <= 0) {
        ...
        scripts\mp\damage::onkillstreakkilled(self.streakname, var_2, var_10, var_5, var_1, "destroyed_" + self.streakname, "venom_destroyed", var_16, 1);
        self notify("venom_end", self.origin);
      }
...
func_1327A() {
  ...
  scripts\mp\utility\game::printgameaction("killstreak ended - venom", var_0);
...
func_13281(var_0) {
  ...
  level endon("game_ended");
  thread scripts\mp\killstreaks\utility::watchhostmigrationlifetime("venom_end", var_0, ::func_13281);
  scripts\mp\hostmigration::waitlongdurationwithhostmigrationpause(var_0);
  var_1 scripts\mp\utility\game::playkillstreakdialogonplayer("venom_timeout", undefined, undefined, var_1.origin);
  self notify("venom_end", self.origin);
}
...
func_13275() {
  ...
  foreach(var_2 in level.players) {
    ...
    scripts\mp\killstreaks\utility::func_20CF(var_2, "venom_end");
  }
}
...
func_13276(var_0) {
  ...
  for(;;) {
    ...
    scripts\mp\killstreaks\utility::func_20CF(var_0, "venom_end");
  }
}
...
venommodifieddamage(var_0, var_1, var_2, var_3, var_4) {
  if(isDefined(var_0) && isDefined(var_3) && isDefined(var_1)) {
    if(var_3 isvenom() && scripts\mp\killstreaks\utility::func_A69F(var_3.streakinfo, "passive_decreased_damage")) {
