...
use_basketball_game(var_0, var_1) {
  ...
  var_0.basketball_game_music scripts\engine\utility::delaycall(2.0, ::playloopsound, "mus_arcade_basketball_game_lp");
  var_2 = undefined;
...
_id_28BA(var_0, var_1, var_2) {
  ...
  var_1.basketball_game_music scripts\engine\utility::delaycall(1.0, ::playsound, "mus_arcade_basketball_game_end");
