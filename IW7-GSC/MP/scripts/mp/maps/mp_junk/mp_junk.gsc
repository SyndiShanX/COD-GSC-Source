...
fix_collision() {
  ...
  var_6 = spawn("script_model", (700, 1368, -80));
  var_6.angles = (0, 270, 90);
  var_6 setModel("mp_rivet_missile_patch_01");
}
...
magwatch(var_0) {
  ...
  for(;;) {
    ...
    if(!isDefined(var_0._id_127BE[var_2])) {
      var_0._id_127BE[var_2] = var_1;
...
magupvector(var_0, var_1, var_2) {
  ...
  wait 2;
  var_0._id_127BE[var_1] = undefined;
}
