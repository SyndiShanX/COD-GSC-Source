 ...
 * Script: scripts\mp\maps\mp_carnage2\mp_carnage2.gsc
*******************************************************/

main() {
  scripts\mp\maps\mp_carnage2\mp_carnage2_precache::main();
  ...
  for(;;) {
    ...
    if(isDefined(var_5)) {
      if(isDefined(var_5.streakname) && var_5.streakname == "remote_c8") {
        var_5 scripts\mp\killstreaks\utility::dodamagetokillstreak(100000, var_5.owner, var_4, var_5.owner.team, var_4.origin, "MOD_MELEE", "bombproj_mp");
        continue;
      }
...
barreldroppersetup(var_0, var_1, var_2, var_3) {
  ...
  var_5 scripts\engine\utility::trigger_off(var_5.targetname, "targetname");
...
barreldropperloop(var_0, var_1, var_2, var_3) {
  ...
  for(;;) {
    ...
    var_1 moveTo(var_1.activepos, 1.0, 0.5, 0.5);
    var_2 moveTo(var_2.activepos, 1.0, 0.5, 0.5);
    playsoundatpos((-803, -1234, 526), "barrel_tumble");
    wait 1.0;
    var_1 moveTo(var_1.initialpos, 1.0, 0.5, 0.5);
    ...
    foreach(var_10 in var_6) {
      if(!var_10 isinphase() && !(isDefined(var_10.isrewinding) && var_10.isrewinding == 1)) {
        ...
        if(var_10 istouching(var_3)) {
          if(isDefined(var_4)) {
            var_10 dodamage(1000, var_3.explosionloc, var_4);
            continue;
          }
      ...
      foreach(var_13 in var_7) {
        if(var_13 istouching(var_3)) {
          if(var_13.streakname == "minijackal") {
            var_13 scripts\mp\killstreaks\utility::dodamagetokillstreak(100000, var_4, var_3, var_13.team, var_3.origin, "MOD_EXPLOSIVE", "bombproj_mp");
            continue;
          }
          ...
          if(var_13.streakname == "sentry_shock") {
            var_13 scripts\mp\killstreaks\utility::dodamagetokillstreak(100000, var_4, var_3, var_13.team, var_3.origin, "MOD_MELEE", "bombproj_mp");
    ...
    scripts\engine\utility::waitframe();
    var_19 = 1;
    thread lingeringgascloudwatch(var_19, var_3, var_4, var_5);
    wait 10;
    var_19 = 0;
    var_3 scripts\engine\utility::trigger_off(var_3.targetname, "targetname");
    var_0 makeusable();
  }
}
