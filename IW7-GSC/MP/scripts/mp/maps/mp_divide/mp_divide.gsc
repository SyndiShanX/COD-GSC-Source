...
fix_collision() {
  ...
  var_11 = spawn("script_model", (1346, 822, 1120));
  var_11.angles = (0, 15, 0);
  var_11 clonebrushmodeltoscriptmodel(var_10);
  var_12 = spawn("script_model", (-384, -576, 704));
  var_12.angles = (0, 0, 0);
  var_12 setModel("mp_divide_nosight_drill_02");
  var_13 = getEnt("player32x32x128", "targetname");
  var_14 = spawn("script_model", (-2672, 704, 800));
  var_14.angles = (0, 0, 0);
...
_id_1F87() {
  ...
  for(;;) {
    _id_E268(var_0);
    wait 0.1;
    thread _id_1F6C(var_0, var_8);
    thread _id_1F76(var_3, var_8);
    wait(var_8 - 7);
    thread _id_1F71(var_1);
    wait 7;
    thread _id_1F6D(var_0, var_9);
    wait(var_9 - 24);
    thread _id_1F72(var_2);
    thread _id_1F73(var_4, var_9);
    wait 24;
    _id_1F6B(var_4);
    wait 3.5;
  }
