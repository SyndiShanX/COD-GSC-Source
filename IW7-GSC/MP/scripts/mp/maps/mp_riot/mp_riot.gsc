...
fix_collision() {
  ...
  var_17 = spawn("script_model", (-1572, 2506, 630));
  var_17.angles = (0, 0, 0);
  var_17 clonebrushmodeltoscriptmodel(var_16);
  var_18 = getEnt("player256x256x8", "targetname");
  var_19 = spawn("script_model", (614, 2176, 424));
  var_19.angles = (272, 0, 0);
