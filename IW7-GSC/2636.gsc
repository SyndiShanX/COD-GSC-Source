...
missilespawned(var_0, var_1) {
  ...
  if(var_12 < 90) {
    ...
    var_15 thread monitorprojectilearrive(var_14, self, var_16, var_2);
...
makeblackholeimpulsefield(var_0) {
  var_1 = _spawnimpulsefield(self.owner, "bhgunfield_mp", self.origin);
  var_1 linkto(self);
  return var_1;
}
...
trydodamage(var_0, var_1, var_2, var_3) {
  ...
  if(var_5) {
    var_0 getrandomarmkillstreak(var_2, self.origin, self.owner, self, "MOD_EXPLOSIVE", "iw7_blackholegun_mp");
  }
}
...
watchforincidentalplayerdamage(var_0) {
  ...
  var_1 = scripts\engine\trace::create_contents(0, 1, 1, 0, 1, 0);
  var_2 = 5898.24;
...
watchfordirectplayerdamage(var_0, var_1) {
  ...
  for(;;) {
    ...
    var_3 getrandomarmkillstreak(var_3.maxhealth, self.origin, self.owner, self, "MOD_EXPLOSIVE", "iw7_blackholegun_mp");
...
spawnblackholephysicsvolume(var_0) {
  var_1 = _physics_volumecreate(self.origin, 384.0);
