...
main(var_0, var_1, var_2) {
  ...
  scripts\sp\vehicle_build::func_31C6(var_2, "default", "vfx\iw7\core\tread\tread_airship_retr_titan.vfx", 0);
...
init_location() {
  if(issubstr(self.classname, "_damaged")) {
    self.var_B210 = "veh_mil_air_un_retribution_repair";
  } else if(issubstr(self.classname, "_repaired")) {
    self.var_B210 = "veh_mil_air_un_retribution_repair";
  }

  self.var_24C4 = ["tag_origin", "amb_turret_sml_t_l_4", "tag_engine_bottom_rear_a", "amb_missile_l_2", "tag_engine_bottom_midlf_a", "mdl_ftl_a_al", "amb_turret_sml_t_l_2", "mdl_ftl_b_el", "mdl_ftl_b_bl", "amb_turret_sml_t_r_1", "mdl_ftl_b_gr", "mdl_ftl_a_ar", "tag_lockon", "amb_missile_r_3", "amb_turret_sml_t_r_4"];
  thread func_0BA9::func_396E("un");
  scripts\sp\vehicle::playgestureviewmodel();
  func_0BB8::func_7561("thrust_vert", "tag_engine_bottom_front_a", "retribution_thrust_vert_large", self.var_5020);
  func_0BB8::func_7561("thrust_vert", "tag_engine_bottom_front_b", "retribution_thrust_vert_large", self.var_5020);
  func_0BB8::func_7561("thrust_vert", "tag_engine_bottom_mid_a", "retribution_thrust_vert_large", self.var_5020);
  func_0BB8::func_7561("thrust_vert", "tag_engine_bottom_mid_b", "retribution_thrust_vert_large", self.var_5020);
  func_0BB8::func_7561("thrust_vert", "tag_engine_bottom_midlr_a", "retribution_thrust_vert_large", self.var_5020);
  func_0BB8::func_7561("thrust_vert", "tag_engine_bottom_midlf_a", "retribution_thrust_vert_large", self.var_5020);
  func_0BB8::func_7561("thrust_vert", "tag_engine_bottom_rear_a", "retribution_thrust_vert_large", self.var_5020);
  func_0BB8::func_7562("thrust_rear", "tag_engine_rear_l_out_00", "retribution_thrust_rear", self.var_501F);
  func_0BB8::func_7562("thrust_rear", "tag_engine_rear_l_in_00", "retribution_thrust_rear", self.var_501F);
  func_0BB8::func_7562("thrust_rear", "tag_engine_rear_r_in_00", "retribution_thrust_rear", self.var_501F);
  func_0BB8::func_7562("thrust_rear", "tag_engine_rear_r_out_00", "retribution_thrust_rear", self.var_501F);
  self.var_539B = ["veh_mil_air_un_retribution_engines", "veh_mil_air_un_retribution_details"];
  self.var_539A = "veh_mil_air_un_retribution_interior_01";

  if(issubstr(self.classname, "periph")) {
    self.var_B210 = "veh_mil_air_un_retribution_periph";
    return;
  }
  ...
  thread func_1EDC();
  self.var_7482 = "retribution_un_warp";
  self.var_748F = "vfx_ftl_ca_destroyer";
  self.var_7475 = 0.5;
  self.var_7499 = "retribution_un_warp_in";
  self.var_749A = 0.195;
}
