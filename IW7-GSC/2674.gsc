...
_id_126AA(var_0, var_1) {
  ...
  var_2 solid();
  var_2 setModel(level._id_47B3["crafted_electric_trap"].modelbase);
...
_id_126A8(var_0, var_1) {
  ...
  var_0.iscarrying = 1;
  var_0 thread scripts\cp\utility::update_trap_placement_internal(self, self.carried_trap, level._id_47B3["crafted_electric_trap"]);
...
_id_126A6(var_0) {
  ...
  self setHintString(level._id_47B3["crafted_electric_trap"].hintstring);
  self makeusable();
  ...
  thread scripts\cp\utility::item_timeout(var_0, level._id_47B3["crafted_electric_trap"].timeout);
  thread _id_126A1();
  thread _id_126AF();
