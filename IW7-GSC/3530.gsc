...
func_4A30(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  var_6 thread scripts\mp\killstreaks\helicopter::func_E111();
...
func_1317A(var_0) {
  ...
  for(;;) {
    if(var_0 scripts\mp\utility\game::touchingbadtrigger("gryphon")) {
...
vanguard_firemissile(var_0, var_1) {
  ...
  var_3 = scripts\mp\utility\game::_magicbullet("remote_tank_projectile_mp", var_2, var_1, self);
