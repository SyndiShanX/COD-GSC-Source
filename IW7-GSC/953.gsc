...
main() {
  ...
  if(issentient(self)) {
    ...
    var_0["left_arm"].partnerheli["upper"].var_4D6F = "j_shoulder_le";
    ...
    var_0["right_arm"].partnerheli["upper"].var_4D6F = "j_shoulder_ri";
    ...
    var_0["left_leg"].partnerheli["upper"].var_4D6F = "j_hip_le";
    ...
    var_0["right_leg"].partnerheli["upper"].var_4D6F = "j_hip_ri";
