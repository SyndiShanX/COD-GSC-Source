...
bot_defend_get_precalc_entrances_for_current_area(var_0) {
  if(isDefined(self.defend_entrance_index)) {
    return scripts\mp\bots\bots_util::bot_get_entrances_for_stance_and_index(var_0, self.defend_entrance_index);
  }
...
bot_defend_think(var_0, var_1, var_2, var_3) {
  ...
  if(scripts\mp\utility\game::isgameparticipant(var_0)) {
  ...
  var_17 = level.bot_find_defend_node_func[var_2];
  ...
  for(;;) {
    ...
    var_20 = scripts\mp\bots\bots_util::bot_goal_can_override(var_4, var_19);
    ...
    if(isDefined(self.cur_defend_node) || isDefined(self.cur_defend_point_override)) {
      if(var_23 && scripts\mp\bots\bots_util::bot_is_protecting() && !isPlayer(var_0) && isDefined(self.defend_entrance_index)) {
...
defense_cautious_approach() {
  ...
  while(var_2) {
    ...
    if(!scripts\mp\bots\bots_util::bot_vectors_are_equal(var_0, var_4)) {
      return;
    }
    var_3 = var_3 + 0.25;
  ...
  var_12 = self botnodepickmultiple(var_9, 15, var_11, "node_protect", scripts\mp\bots\bots_util::defend_valid_center(), "ignore_occupancy");
  ...
  foreach(var_17 in var_15) {
    if(distancesquared(var_17, self.bot_defending_center) < var_7) {
      ...
      if(var_30 == "goal") {
        for(var_13 = 0; var_13 < var_29.size; var_13++) {
          for(var_31 = 0; var_29[var_13].frames_visible < 18 && var_31 < 3.6; var_31 = var_31 + 0.25) {
            self botlookatpoint(var_29[var_13].origin + (0, 0, self func_8157()), 0.25, "script_search");
            wait 0.25;
          }
        }
      }
...
bot_get_teammates_in_radius(var_0, var_1) {
  ...
  for(var_4 = 0; var_4 < level.participants.size; var_4++) {
    ...
    if(var_5 != self && isDefined(var_5.team) && var_5.team == self.team && scripts\mp\utility\game::isteamparticipant(var_5)) {
...
defend_get_ally_bots_at_zone_for_stance(var_0) {
  ...
  foreach(var_3 in level.participants) {
    ...
    if(var_3.team == self.team && var_3 != self && isai(var_3) && var_3 scripts\mp\bots\bots_util::bot_is_defending() && var_3.cur_defend_stance == var_0) {
...
find_defend_node_patrol() {
  ...
  var_2 = getnodesinradius(scripts\mp\bots\bots_util::defend_valid_center(), self.bot_defending_radius, 0, 520, "path", var_1);
