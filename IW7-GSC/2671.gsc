...
func_89B3(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  if(!isDefined(var_1.var_903C)) {
    var_1.var_903C = [];
  } else if(func_903B(var_1, var_2.birthtime)) {
    return;
  }
  var_1 thread func_E252();
  var_1.var_903C[var_1.var_903C.size] = var_2.birthtime;
...
func_11AF4(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  if(var_1.var_C944 >= 150 && var_1.var_A9CA + 3 <= level.wave_num) {
    var_1.var_C944 = 0;
    level scripts\cp\loot::drop_loot(var_1.origin, var_1, "kill_50", 1);
  }
}
...
set_player_stealthed(var_0, var_1) {
  ...
  var_0.stealth_used = scripts\engine\utility::add_to_array(var_0.stealth_used, var_1);
...
func_89B8(var_0, var_1) {
  ...
  if(var_2 > 0) {
    var_0 getrandomarmkillstreak(var_2, var_0 gettagorigin("j_wrist_ri"), var_0, undefined, "MOD_RIFLE_BULLET", "iw7_pickup_zm");
  }
...
scrambler_stun_damage(var_0, var_1) {
  ...
  var_0 getrandomarmkillstreak(1, var_0.origin, var_1, var_1, "MOD_UNKNOWN", "iw7_scrambler_zm");
...
handleberserk(var_0, var_1, var_2, var_3, var_4, var_5) {
  if(!scripts\engine\utility::is_true(var_1.berserk)) {
    ...
    var_1 getweaponrankinfomaxxp(int(var_6));
  }
...
handlemeleeconeexplode(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  foreach(var_14 in var_12) {
    ...
    wait 0.05;
    var_14 getrandomarmkillstreak(var_15, var_6, var_1, var_1, "MOD_EXPLOSIVE", var_0);
  }
}
...
func_12EDF(var_0, var_1, var_2, var_3, var_4) {
  ...
  foreach(var_8 in var_6) {
    if(scripts\engine\utility::is_true(var_1.var_C54A[var_8])) {
...
func_12EE1(var_0, var_1) {
  ...
  foreach(var_5 in var_3) {
    if(scripts\engine\utility::is_true(var_0.var_C5C9[var_5])) {
...
func_12EDD(var_0, var_1, var_2) {
  ...
  foreach(var_6 in var_4) {
    if(scripts\engine\utility::is_true(var_0.var_C4E6[var_6])) {
