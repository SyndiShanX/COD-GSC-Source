...
_id_59CB() {
  ...
  _id_120C();
  level._id_5A23 = [];
  scripts\sp\utility::_id_D6D9(::_id_59CC);
  ...
  scripts\sp\utility::_id_16EB("peek_hint", &"SCRIPT_DOORPEEK_HINT", ::_id_C9F7);
  scripts\sp\utility::_id_16EB("peek_hint_pc", &"SCRIPT_DOORPEEK_HINT_PC", ::_id_C9F7);
  scripts\sp\utility::_id_16EB("peek_hint_shove", &"SCRIPT_DOORPEEK_HINT_SHOVE", ::_id_C9F7);
  scripts\sp\utility::_id_16EB("peek_hint_shove_pc", &"SCRIPT_DOORPEEK_HINT_SHOVE_PC", ::_id_C9F7);
  scripts\sp\utility::_id_16EB("peek_only_hint", &"SCRIPT_DOORPEEK_HINT_PEEK_ONLY", ::_id_C9F7);
  scripts\sp\utility::_id_16EB("peek_only_hint_pc", &"SCRIPT_DOORPEEK_HINT_PEEK_ONLY_PC", ::_id_C9F7);
}
...
_id_1211(var_0, var_1, var_2, var_3) {
  ...
  level._id_5A23[var_0]._id_5978 scripts\sp\utility::_id_23B7("doorpeek_door");
  var_5 = _id_12A6(var_4, "door_peek_struct");

  if(!var_1) {
    var_6 = 1.0;
    var_7 = _id_12A6(var_4, "door_peek_animstruct");
    level._id_5A23[var_0]._id_5A25 = var_5 scripts\engine\utility::spawn_tag_origin();
    level._id_5A23[var_0]._id_59FF = var_7 scripts\engine\utility::spawn_tag_origin();
    ...
    level._id_5A23[var_0]._id_A5A9 = var_8 scripts\engine\utility::spawn_tag_origin();
    ...
    level._id_5A23[var_0]._id_5A26 = var_5 scripts\engine\utility::spawn_tag_origin();
    level._id_5A23[var_0]._id_5A26.angles = level._id_5A23[var_0]._id_5A26.angles + (0, 180, 0);
    level._id_5A23[var_0]._id_5A00 = var_7 scripts\engine\utility::spawn_tag_origin();
    ...
    level._id_5A23[var_0]._id_A5AA = var_10 scripts\engine\utility::spawn_tag_origin();
  ...
  level._id_5A23[var_0]._id_5A2A = var_5 scripts\engine\utility::spawn_tag_origin();
  ...
  thread scripts\engine\utility::flag_set_delayed(var_0 + "door_peek_can_kick", level._id_5A23[var_0]._id_C9FE._id_119D5);
...
_id_1202(var_0, var_1) {
  ...
  if(!scripts\engine\utility::flag(var_0 + "door_peek_handle_down")) {
    ...
    level thread scripts\sp\utility::_id_C12D(var_0 + "door_peek_blend_complete", var_28 + 0.1);
...
_id_11F5(var_0, var_1, var_2) {
  ...
  for(;;) {
    ...
    if(var_8 == 1.0 && var_15 == 1.0) {
      var_16 = var_16 * 1.01 * scripts\sp\utility::_id_E753(var_9, 0, 1);
      var_9 = var_9 + 0.5;
    } else
      var_9 = 1;
    ...
    if(level._id_5A23[var_0]._id_5A21 != var_7) {
      ...
      if(!var_1) {
        ...
        level.player playerlinktodelta(level._id_5A23[var_0]._id_C9FD, "tag_player", 1, var_4.rightarc, var_18, 80, 20, 0);
      } else {
        var_19 = clamp(-1.0 * level._id_5A23[var_0]._id_5A21 / var_4._id_B481, 0.0, 1.0) * (var_4._id_B4C1 - var_4._id_B7C9) + var_4._id_B7C9;
        level.player playerlinktodelta(level._id_5A23[var_0]._id_C9FD, "tag_player", 1, var_19, var_4._id_01B8, 80, 20, 0);
      }
...
_id_1210(var_0, var_1) {
  ...
  level._id_5A23[var_0]._id_5A2A scripts\engine\utility::delaycall(var_3 + 0.05, ::delete);
  level._id_5A23[var_0]._id_5A03 connectpaths();
  level._id_5A23[var_0]._id_5A03 scripts\engine\utility::delaycall(var_3 + 0.05, ::disconnectpaths);
  level._id_5A23[var_0]._id_5978 playSound("doorpeek_" + _id_1299(level._id_5A23[var_0]._id_5A57) + "_swing_open");
  level._id_5A23[var_0]._id_5978 scripts\engine\utility::delaycall(var_3, ::playsound, "doorpeek_" + _id_1299(level._id_5A23[var_0]._id_5A57) + "_hit_wall");
  level thread scripts\sp\utility::_id_C12D(var_0 + "door_peek_finished", var_3 + 0.05);
  level thread scripts\sp\utility::_id_C12D("door_peek_finished", var_3 + 0.05);
...
_id_11F7(var_0, var_1, var_2, var_3) {
  ...
  var_9 = self.ogorigin + var_7 * level._id_5A23[var_0.targetname]._id_5A58 * 0.5;
  self unlink();
  ...
  for(;;) {
    ...
    if(var_11 > 0.0) {
      ...
      var_15 = scripts\sp\math::_id_ACE9(var_12, var_12 + var_14 * 64, self.ogorigin, var_6);
...
_id_120A(var_0, var_1) {
  ...
  for(;;) {
    if(level.player isreloading() && !var_2 && !level.player isdualwielding()) {
      _id_116C(var_0, var_1, 0);
      var_2 = 1;
    } else if(!level.player isreloading() && var_2) {
      _id_116C(var_0, var_1, 1);
      var_2 = 0;
    }
...
_id_136C(var_0, var_1, var_2) {
  ...
  var_0 scripts\sp\anim::_id_1F35(level._id_5A23[var_1]._id_C9FD, var_2);
}
...
_id_120B(var_0, var_1, var_2) {
  ...
  for(;;) {
    ...
    if(!var_7 && isDefined(var_6)) {
      ...
      if(!var_1 && var_6 && !isDefined(level._id_5A23[var_0.targetname]._id_C9FF)) {
        wait 0.05;
        continue;
      }
    ...
    if(var_7 || var_8) {
      ...
      if(var_1 != var_6) {
        var_23 = anglesToForward(level._id_5A23[var_0.targetname]._id_5A24);
        ...
        level._id_5A23[var_0.targetname]._id_5A2A rotateTo(level._id_5A23[var_0.targetname]._id_5A24, var_26, 0.0, 0.0);
        wait(var_26);
        level._id_5A23[var_0.targetname]._id_5A2A rotateTo(level._id_5A23[var_0.targetname]._id_5A24 + (0, var_18, 0), var_27, 0.0, 0.0);
        wait(var_27);
      } else {
        var_28 = acos(clamp(vectordot(var_19, var_20), -1, 1));
        var_29 = var_28 / var_17;
        level._id_5A23[var_0.targetname]._id_5A2A rotateTo(level._id_5A23[var_0.targetname]._id_5A24 + (0, var_18, 0), var_29, 0.0, 0.0);
        wait(var_29);
      }

      wait 0.05;
      var_2 disconnectPaths();
      level._id_5A23[var_0.targetname]._id_5A2A delete();
...
_id_11FC(var_0) {
  var_1 = level._id_5A23[var_0.targetname]._id_5A25;
  var_2 = anglesToForward(level._id_5A23[var_0.targetname]._id_5A2A.angles);
  var_3 = -1 * anglestoright(level._id_5A23[var_0.targetname]._id_5A2A.angles);
...
_id_11FD(var_0) {
  ...
  var_7 = anglesToForward(level._id_5A23[var_0.targetname]._id_5A25.angles);
  var_8 = -1 * anglestoright(level._id_5A23[var_0.targetname]._id_5A25.angles);
  var_9 = level._id_5A23[var_0.targetname]._id_5A25.origin + var_7 * var_6._id_11782 * -0.5;
...
_id_11F9(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  if(!var_3) {
    ...
    if(var_1._id_EE52 == "airlock") {
      level.player scripts\sp\utility::_id_2B76(0.25, 0.5);
      level.player scripts\engine\utility::delaythread(0.5, scripts\sp\utility::_id_2B76, 1, 0.7);
    }
...
_id_12A1(var_0, var_1) {
  ...
  var_21 = scripts\common\trace::ray_trace(var_15 + (0, 0, 32), var_15 + (0, 0, -100), undefined, scripts\common\trace::create_solid_ai_contents(1));
...
_id_11EC(var_0) {
  ...
  _id_11EF();
  level._id_5A23[var_0]._id_59FF thread scripts\sp\anim::_id_1F35(level._id_5A23[var_0]._id_C9FD, "doorpeek_airlock_bash");
  var_14 = 0.2;
  var_15 = 2.4;
  var_16 = 1.1;
  var_17 = 140.0;
  ...
  var_2 thread scripts\engine\utility::play_sound_in_space("doorpeek_" + _id_1299(var_4) + "_kick", var_2.origin);
  thread _id_1351(var_0);
  wait(var_16);
  level thread scripts\sp\utility::_id_C12D(var_0 + "door_kick_multi_kick_ready", 0.5);
  ...
  level.player playerlinktodelta(var_24, "tag_origin", 1, 10, 10, 10, 10, 0);
...
_id_11F0(var_0, var_1, var_2) {
  ...
  level._id_5A23[var_0]._id_5A2A scripts\engine\utility::delaycall(var_9, ::rotateto, level._id_5A23[var_0]._id_5A24 + (0, var_8, 0), var_17, var_19, var_20);
  level._id_5A23[var_0]._id_5A2A scripts\engine\utility::delaycall(var_9 + var_17 + 0.05, ::delete);
  ...
  var_4 scripts\engine\utility::delaythread(var_9, scripts\engine\utility::play_sound_in_space, "doorpeek_" + _id_1299(var_6) + "_kick", var_4.origin);
  level thread scripts\sp\utility::_id_C12D(var_0 + "door_kick_open", var_9);
  level thread scripts\sp\utility::_id_C12D("door_kick_open", var_9);
  ...
  var_7 thread scripts\sp\anim::_id_1F35(level._id_5A23[var_4.targetname]._id_A5AE, var_21);
  var_34 = getanimlength(level._id_5A23[var_4.targetname]._id_A5AE scripts\sp\utility::_id_7DC1(var_21));
  var_35 = 0.4;
  var_36 = 1.1;
  var_37 = 0.3;
  var_38 = 0.35;
  ...
  level.player _meth_823C(level._id_5A23[var_4.targetname]._id_A5AE, "tag_player", var_37, 0.0, 0.0);
  level.player scripts\engine\utility::delaycall(var_37, ::playerlinktodelta, level._id_5A23[var_4.targetname]._id_A5AE, "tag_player", 1, 0, 0, 0, 0, 0);
  level.player scripts\engine\utility::delaycall(var_38, ::lerpviewangleclamp, var_39, 0, 0, 40, 40, 60, 10);
  wait 0.05;
  level._id_5A23[var_4.targetname]._id_A5AE linkTo(var_7);
  var_7 moveTo(var_30, var_35);
  var_7 rotateTo(var_31, var_35);
  wait(var_35);
  level.player scripts\sp\utility::_id_2B76(0.2, 0.05);
  ...
  level.player unlink();
  var_7 delete();
  level._id_5A23[var_4.targetname]._id_A5AE delete();
  level._id_5A23[var_4.targetname]._id_59FF delete();
  level.player scripts\sp\utility::_id_2B76(1.0, var_40);
  _id_1200();
  level.player.dontmelee = undefined;
  level notify(var_0 + "door_kick_newdoor_think");
...
_id_1206() {
  ...
  scripts\sp\anim::_id_17F6("player_rig", "doorpeek_handle", ::_id_5A1B, "doorpeek_civlever_in");
  ...
  scripts\sp\anim::_id_17F6("player_rig", "doorpeek_handle", ::_id_5A1B, "doorpeek_civlever_r_in");
  ...
  scripts\sp\anim::_id_17F6("player_rig", "doorpeek_handle", ::_id_5A1B, "doorpeek_bulkhead_in");
  ...
  scripts\sp\anim::_id_17F6("player_rig", "doorpeek_handle", ::_id_5A1B, "doorpeek_airlock_in");
  ...
  scripts\sp\anim::_id_17F6("player_rig", "doorpeek_handle", ::_id_5A1B, "doorpeek_armory_in");
...
_id_59D9(var_0, var_1) {
  ...
  level._id_5A23[var_0]._id_5A2A scripts\engine\utility::delaycall(var_1 + 0.05, ::delete);
  level._id_5A23[var_0]._id_5A03 connectpaths();
  level._id_5A23[var_0]._id_5A03 scripts\engine\utility::delaycall(var_1 + 0.05, ::disconnectpaths);
  level._id_5A23[var_0]._id_5978 playSound("doorpeek_" + _id_1299(level._id_5A23[var_0]._id_5A57) + "_swing_open");
  level._id_5A23[var_0]._id_5978 scripts\engine\utility::delaycall(var_1, ::playsound, "doorpeek_" + _id_1299(level._id_5A23[var_0]._id_5A57) + "_hit_wall");
  level._id_5A23[var_0]._id_5A56 hide();
  _id_551D(var_0);
}