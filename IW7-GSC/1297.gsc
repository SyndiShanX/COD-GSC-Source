...
main() {
  self setModel("body_sdf_army_light_2");
  scripts\code\character::attachhead("alias_heads_sdf_army", _id_09C1::main());
  self.hatmodel = "helmet_sdf_army_light_2";
  ...
  if(issentient(self)) {
    ...
    var_0["helmet"].partnerheli["helmet"].maxhealth = 150;
    var_0["helmet"].partnerheli["helmet"].hitloc = "helmet";
    var_0["helmet"].partnerheli["helmet"]._id_4D6F = "j_helmet";
    self _meth_849B("helmet", 9999, "helmet", 150, "helmet", "j_helmet");
    self._id_4D5D = var_0;
  }
...
precache() {
  precachemodel("body_sdf_army_light_2");
  scripts\code\character::precachemodelarray(_id_09C1::main());
  precachemodel("helmet_sdf_army_light_2");
