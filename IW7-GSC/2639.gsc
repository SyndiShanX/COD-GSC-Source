...
func_1118C(var_0, var_1, var_2) {
  ...
  if(isDefined(var_3)) {
    ...
    if(isDefined(self)) {
      ...
      if(isDefined(var_5)) {
        var_5 getrandomarmkillstreak(var_4, self.origin, var_0, var_0.stun_struct.attack_bolt, var_2);
      }
    }
  }
...
check_for_special_damage(var_0, var_1, var_2) {
  ...
  if(!isDefined(var_0.is_burning) && isalive(var_0)) {
    ...
    } else if((scripts\engine\utility::is_true(self.var_8B86) || scripts\engine\utility::is_true(self.var_8BAC)) && var_2 != "MOD_UNKNOWN") {
      var_0 thread catch_alien_on_fire(self, undefined, undefined, 1);
    }
...
damage_alien_over_time(var_0, var_1, var_2, var_3) {
  ...
  for(var_9 = 0; var_9 < var_6; var_9++) {
    ...
    if(isalive(self)) {
      self getrandomarmkillstreak(var_8, self.origin, var_0, var_0, "MOD_UNKNOWN");
    }
  }
}
...
func_20BA() {
  ...
  self endon("death");
  self.var_1BD8++;
  self.var_1BD9 = _pow(0.68, (self.var_1BD8 + 1) * 0.35);
