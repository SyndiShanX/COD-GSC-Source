...
main(var_0, var_1, var_2) {
  ...
  scripts\sp\vehicle_build::func_31C6(var_2, "default", "vfx\iw7\core\tread\tread_airship_mons_titan.vfx", 0);
...
init_location() {
  if(issubstr(self.classname, "_damaged")) {
    self.var_B210 = "veh_mil_air_ca_olympus_mons_dmg";
  }

  if(issubstr(self.classname, "_heistspace_end")) {
    self.var_B210 = "veh_mil_air_ca_olympus_mons_heist_space";
  }

  self.var_24C4 = ["tag_origin", "amb_turret_r_6", "amb_turret_sml_r_1", "amb_turret_l_5", "amb_turret_sml_r_6", "amb_turret_l_1", "amb_turret_sml_r_16", "amb_turret_sml_l_14", "fx_light_main_a_1", "fx_light_running_lrg_b3_4", "fx_light_running_lrg_b3_2", "amb_missile_l_4", "amb_missile_r_16", "amb_missile_r_25", "fx_entryburn_1"];
  thread func_0BA9::func_396E("ca");
  thread func_1EDC();
  scripts\sp\vehicle::playgestureviewmodel();
  self.var_129F5 = [];
  self.var_129F5["front_left"] = ["amb_turret_sml_l_11", "amb_turret_sml_l_12", "amb_turret_sml_l_13", "amb_turret_sml_l_14", "amb_turret_sml_l_15", "amb_turret_sml_l_16", "amb_turret_sml_l_17", "amb_turret_sml_l_18", "amb_turret_l_1", "amb_turret_l_2"];
  self.var_129F5["front_right"] = ["amb_turret_sml_r_11", "amb_turret_sml_r_12", "amb_turret_sml_r_13", "amb_turret_sml_r_14", "amb_turret_sml_r_15", "amb_turret_sml_r_16", "amb_turret_sml_r_17", "amb_turret_sml_r_18", "amb_turret_r_1", "amb_turret_r_2"];
  self.var_129F5["back_left"] = ["amb_turret_sml_l_1", "amb_turret_sml_l_2", "amb_turret_sml_l_3", "amb_turret_sml_l_4", "amb_turret_sml_l_5", "amb_turret_sml_l_6", "amb_turret_sml_l_7", "amb_turret_sml_l_8", "amb_turret_sml_l_9", "amb_turret_sml_l_10", "amb_turret_l_3", "amb_turret_l_4", "amb_turret_l_5", "amb_turret_l_6"];
  self.var_129F5["back_right"] = ["amb_turret_sml_r_1", "amb_turret_sml_r_2", "amb_turret_sml_r_3", "amb_turret_sml_r_4", "amb_turret_sml_r_5", "amb_turret_sml_r_6", "amb_turret_sml_r_7", "amb_turret_sml_r_8", "amb_turret_sml_r_9", "amb_turret_sml_r_10", "amb_turret_r_3", "amb_turret_r_4", "amb_turret_r_5", "amb_turret_r_6"];
  self.var_129F5["new"] = ["amb_turret_l_7", "amb_turret_l_8", "amb_turret_l_9", "amb_turret_l_10", "amb_turret_l_11", "amb_turret_l_12", "amb_turret_l_13", "amb_turret_r_7", "amb_turret_r_8", "amb_turret_r_9", "amb_turret_r_10", "amb_turret_r_11", "amb_turret_r_12", "amb_turret_r_13", "amb_turret_r_14", "amb_turret_r_15"];
  self.var_8B46 = [];
  self.var_8B46["left_1"] = ["amb_missile_l_18", "amb_missile_l_19", "amb_missile_l_20", "amb_missile_l_21", "amb_missile_l_22", "amb_missile_l_23"];
  self.var_8B46["right_1"] = ["amb_missile_r_18", "amb_missile_r_19", "amb_missile_r_20", "amb_missile_r_21", "amb_missile_r_22", "amb_missile_r_23"];
  self.var_8B46["left_2"] = ["amb_missile_l_1", "amb_missile_l_2", "amb_missile_l_3", "amb_missile_l_4", "amb_missile_l_5", "amb_missile_l_6", "amb_missile_l_7", "amb_missile_l_8", "amb_missile_l_9", "amb_missile_l_10"];
  self.var_8B46["right_2"] = ["amb_missile_r_1", "amb_missile_r_2", "amb_missile_r_3", "amb_missile_r_4", "amb_missile_r_5", "amb_missile_r_6", "amb_missile_r_7", "amb_missile_r_8", "amb_missile_r_9", "amb_missile_r_10"];
  self.var_8B46["left_3"] = ["amb_missile_l_11", "amb_missile_l_12", "amb_missile_l_13", "amb_missile_l_14", "amb_missile_l_15", "amb_missile_l_16", "amb_missile_l_17"];
  self.var_8B46["right_3"] = ["amb_missile_r_11", "amb_missile_r_12", "amb_missile_r_13", "amb_missile_r_14", "amb_missile_r_15", "amb_missile_r_16", "amb_missile_r_17"];
  self.var_8B46["left_4"] = ["amb_missile_l_26", "amb_missile_l_27", "amb_missile_l_28", "amb_missile_l_29", "amb_missile_l_30", "amb_missile_l_31", "amb_missile_l_32"];
  self.var_8B46["right_4"] = ["amb_missile_r_26", "amb_missile_r_27", "amb_missile_r_28", "amb_missile_r_29", "amb_missile_r_30", "amb_missile_r_31", "amb_missile_r_32"];
  self.var_8B46["center"] = ["amb_missile_l_24", "amb_missile_l_25", "amb_missile_r_24", "amb_missile_r_25"];
  func_0BB8::func_7561("thrust_vert", "tag_engine_bottom_front", "mons_thrust_bottom_front", self.var_5020);
  func_0BB8::func_7561("thrust_vert", "tag_engine_bottom_middle", "mons_thrust_bottom_middle", self.var_5020);
  func_0BB8::func_7561("thrust_vert", "tag_engine_bottom_rear", "mons_thrust_bottom_rear", self.var_5020);
  func_0BB8::func_7561("thrust_rear", "tag_engine_rear", "mons_thrust_rear", self.var_501F);

  if(self.classname != "script_vehicle_capitalship_mons_heistspace") {
    self.var_539B = ["veh_mil_air_ca_olympus_mons_engines", "veh_mil_air_ca_olympus_mons_details", "veh_mil_air_ca_olympus_mons_details_scr"];
    self.var_539A = "veh_mil_air_ca_olympus_mons_interior_01";
  }
  ...
  self.var_7482 = "mons_ca_warp";
  self.var_748F = "vfx_ftl_mons";
  self.var_7475 = 0.35;
  self.var_7499 = "mons_ca_warp_in";
  self.var_749A = 0.195;
...
func_1EDC() {
  ...
  level.var_EC8C["ftl_model"] = "vfx_ftl_mons";
  level.var_EC85["ftl_model"]["ftl_in"] = % vfx_ftl_mons_in;
  level.var_EC85["ftl_model"]["ftl_out"] = % vfx_ftl_mons_out;
}
...
func_BA69(var_0, var_1) {
  var_2 = spawn("script_origin", var_0);
  func_BA68(var_2, var_1);
  thread func_409A(var_2);
}
...
func_BA6A(var_0, var_1, var_2) {
  ...
  if(var_0 > 0) {
    ...
    playFXOnTag(level._effect["vfx_heist_mons_steeldragon_chargeup"], self.cannon, var_3);
    ...
    stopFXOnTag(level._effect["vfx_heist_mons_steeldragon_chargeup"], self.cannon, var_3);
  }

  playFXOnTag(level._effect["vfx_heist_mons_steeldragon_loop"], self.cannon, var_3);
  var_4 = gettime();
  ...
  stopFXOnTag(level._effect["vfx_heist_mons_steeldragon_loop"], self.cannon, var_3);
...
func_B2DF() {
  ...
  self stopsounds();
  thread scripts\engine\utility::play_sound_in_space("heistspace_fspar_powerdown", var_0);
}
