...
init() {
  ...
  level.var_12A8D["mg_turret"].timeout = 60.0;
...
func_1146D(var_0) {
  scripts\mp\utility\game::_takeweapon(level.var_12A8D[var_0].var_A84D);
  scripts\mp\utility\game::_takeweapon(level.var_12A8D[var_0].remotedetonatethink);
}
...
func_F68B(var_0, var_1) {
  ...
  for(;;) {
    ...
    if(var_2 == "cancel_turret" || var_2 == "force_cancel_placement") {
      ...
      if(level.console) {
        var_3 = scripts\mp\utility\game::getkillstreakweapon(level.var_12A8D[var_0.var_12A9A].streakname);
...
func_12A2A() {
  ...
  if(isalive(var_0)) {
    var_0 scripts\mp\utility\game::setlowermessage("pickup_remote_turret", level.var_12A8D[self.var_12A9A].var_901F, undefined, undefined, undefined, undefined, undefined, undefined, 1);
  }
...
func_10E08() {
  var_0 = self.owner;
  var_0 scripts\mp\utility\game::setusingremote(self.var_12A9A);
  ...
  var_0 scripts\mp\utility\game::_giveweapon(level.var_12A8D[self.var_12A9A].remotedetonatethink);
  var_0 scripts\mp\utility\game::_switchtoweaponimmediate(level.var_12A8D[self.var_12A9A].remotedetonatethink);
  ...
  if(isDefined(level.var_9181["thermal_mode"])) {
    level.var_9181["thermal_mode"] give_zap_perk("");
  }
  ...
  var_0 scripts\mp\utility\game::setlowermessage("early_exit", level.var_12A8D[self.var_12A9A].var_901B, undefined, undefined, undefined, undefined, undefined, undefined, 1);
}
...
func_1109C() {
  ...
  if(var_0 scripts\mp\utility\game::isusingremote()) {
    ...
    var_1 = scripts\mp\utility\game::getkillstreakweapon(level.var_12A8D[self.var_12A9A].streakname);
  ...
  var_0 scripts\mp\utility\game::clearlowermessage("early_exit");

  if(!isDefined(var_0.var_13108) || !var_0.var_13108) {
    var_0 scripts\mp\utility\game::setlowermessage("enter_remote_turret", level.var_12A8D[self.var_12A9A].var_901A, undefined, undefined, undefined, 1, 0.25, 1.5, 1);
  }
...
func_13AE5(var_0) {
  ...
  for(;;) {
    ...
    if(!self.var_13108) {
      scripts\mp\utility\game::setlowermessage("enter_remote_turret", level.var_12A8D[var_0.var_12A9A].var_901A, undefined, undefined, undefined, 1, 0.25, 1.5, 1);
      continue;
    }
...
func_13A1D() {
  ...
  for(;;) {
    ...
    if(scripts\mp\utility\game::iskillstreakweapon(var_1) && var_1 != level.var_12A8D[self.var_12A9A].weaponinfo && var_1 != level.var_12A8D[self.var_12A9A].var_A84D && var_1 != level.var_12A8D[self.var_12A9A].remotedetonatethink && var_1 != "none" && (!var_0 scripts\mp\utility\game::isjuggernaut() || var_0 scripts\mp\utility\game::isusingremote())) {
    ...
    if(var_0 getteamflagcount() && !var_0.using_remote_turret) {
      if(!isDefined(var_0.var_6617) || !var_0.var_6617) {
        var_0.var_6617 = 1;
        var_0 scripts\mp\utility\game::clearlowermessage("enter_remote_turret");
      }
    ...
    while(var_0 usebuttonpressed() && !var_0 fragbuttonpressed() && !var_0 scripts\mp\utility\game::func_85C7() && !var_0 secondaryoffhandbuttonpressed() && !var_0 isusingturret() && var_0 isonground() && !var_0 istouching(self.ownertrigger) && (!isDefined(var_0.empgrenaded) || !var_0.empgrenaded)) {
      ...
      if(!var_0.using_remote_turret && var_0 scripts\mp\utility\game::isusingremote()) {
        break;
      }
      if(var_0 getteamflagcount() && !var_0.using_remote_turret) {
        break;
      ...
      if(var_2 > 0.75) {
        ...
        if(var_0.using_remote_turret) {
          ...
          var_0 scripts\mp\utility\game::_giveweapon(level.var_12A8D[self.var_12A9A].var_A84D);
          var_0 scripts\mp\utility\game::_switchtoweaponimmediate(level.var_12A8D[self.var_12A9A].var_A84D);
          func_10E08();
...
turret_handlepickup(var_0) {
  ...
  for(;;) {
    ...
    if(scripts\mp\utility\game::iskillstreakweapon(var_2) && var_2 != "killstreak_remote_turret_mp" && var_2 != level.var_12A8D[var_0.var_12A9A].weaponinfo && var_2 != level.var_12A8D[var_0.var_12A9A].var_A84D && var_2 != level.var_12A8D[var_0.var_12A9A].remotedetonatethink && var_2 != "none" && (!scripts\mp\utility\game::isjuggernaut() || scripts\mp\utility\game::isusingremote())) {
    ...
    if(scripts\mp\utility\game::isreallyalive(self) && self istouching(var_0.ownertrigger) && !isDefined(var_0.carriedby) && self isonground()) {
      if(isDefined(self.var_CB39) && self.var_CB39 && var_2 != "none") {
        scripts\mp\utility\game::setlowermessage("pickup_remote_turret", level.var_12A8D[var_0.var_12A9A].var_901F, undefined, undefined, undefined, undefined, undefined, undefined, 1);
        self.var_CB39 = 0;
      }
...
func_129FB() {
  ...
  if(isDefined(var_1)) {
    ...
    var_1 scripts\mp\utility\game::clearlowermessage("enter_remote_turret");
    var_1 scripts\mp\utility\game::clearlowermessage("early_exit");
    var_1 scripts\mp\utility\game::clearlowermessage("pickup_remote_turret");
    var_1 restoreperks();
    var_1 restoreweapons();

    if(var_1 getcurrentweapon() == "none") {
      var_1 scripts\mp\utility\game::_switchtoweapon(var_1 scripts\engine\utility::getlastweapon());
    }
  ...
  for(;;) {
    ...
    if(self.damagetaken >= self.maxhealth) {
      if(isPlayer(var_1) && (!isDefined(self.owner) || var_1 != self.owner)) {
        var_1 thread scripts\mp\utility\game::giveunifiedpoints("kill", var_9, 100);
        var_1 notify("destroyed_killstreak");
      }

      if(isDefined(self.owner)) {
        self.owner thread scripts\mp\utility\game::leaderdialogonplayer(level.var_12A8D[self.var_12A9A].vodestroyed, undefined, undefined, self.origin);
      }
