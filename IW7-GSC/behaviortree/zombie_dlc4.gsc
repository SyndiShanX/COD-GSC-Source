...
func_2AD0() {
  ...
  var_0.var_1581[1] = ::scripts\aitypes\zombie_dlc4\behaviors::checkscripteddlc;
  ...
  var_0.var_1581[6] = ::zombie_dlc4fn0;
  ...
  var_0.var_1581[12] = ::scripts\aitypes\zombie_dlc4\behaviors::seekenemydlc;
  var_0.var_1581[13] = ::lib_0C2B::notargetfound;
  level.var_119E["zombie_dlc4"] = var_0;
}
