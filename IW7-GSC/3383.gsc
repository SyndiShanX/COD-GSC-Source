...
func_13643() {
  ...
  for(;;) {
    ...
    var_1 = scripts\engine\utility::is_true(self.has_fnf_weapon);
...
func_12FFA(var_0, var_1, var_2) {
  ...
  var_1.var_10A03 ghost_nav_mode(var_1.var_E74A, 5, 1, 4);
...
func_1010C(var_0, var_1) {
  ...
  if(level.currentweaponlist.size > 0) {
    ...
    var_5 = getrotationlist(var_0.var_13C25);
  }
  ...
  var_0.weapon thread wait_for_player_to_take_weapon(var_0);
  var_0.weapon scripts\engine\utility::waittill_any_timeout(12, "weapon_taken");
  var_0.weapon delete();
  var_0.var_13C25 = scripts\engine\utility::array_remove(var_0.var_13C25, "iw7_nunchucks_zm");
  var_0.var_13C25 = scripts\engine\utility::array_remove(var_0.var_13C25, "iw7_nunchucks_zm_pap2");
  var_0 setscriptablepartstate("spin_light", "off");
  var_0.var_13C25 = func_7ABF();
  var_0.var_E74A = func_7C20();
  var_1.var_13103 = undefined;
  var_0 notify("ready");
}
...
wait_for_player_to_take_weapon(var_0) {
  ...
  if(isDefined(self.scriptmodelplayanim) && getsubstr(self.scriptmodelplayanim, 0, 5) == "power") {
    ...
    switch (var_3) {
      ...
      case "sdflmg":
      case "lmg03":
        var_1 thread scripts\cp\cp_vo::try_to_play_vo("purchase_weapon", "zmb_comment_vo", "low", 10, 0, 1, 0, 25);
        break;
      case "katana":
...
func_B16A(var_0, var_1) {
  ...
  if(scripts\cp\zombies\zombies_weapons::should_take_players_current_weapon(var_0)) {
    ...
    var_0 giveuponsuppressiontime(var_3);
...
get_camo_for_upgraded_weapon(var_0, var_1) {
  ...
  if(isDefined(level.no_pap_camos) && scripts\engine\utility::array_contains(level.no_pap_camos, var_0)) {
    var_2 = undefined;
  } else if(scripts\engine\utility::is_true(level.magic_wheel_upgraded) && var_1 scripts\cp\utility::is_consumable_active("magic_wheel_upgrade") && isDefined(level.pap_2_camo)) {
...
func_4DB4(var_0, var_1, var_2) {
  ...
  if(var_3 != "activated" + var_0) {
    ...
    while(var_10) {
      ...
      foreach(var_8 in level.players) {
        if(scripts\engine\utility::is_true(var_8.var_13103)) {
          wait 0.25;
          var_11 = 1;
          continue;
        }
