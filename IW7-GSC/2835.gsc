...
func_957E() {
  ...
  foreach(var_17 in var_15) {
    level.var_11AE[var_17.classname] = var_17;
  }
}
...
func_F3D2(var_0) {
  ...
  } else if(isDefined(level.var_6E02)) {
    self.fixednodesaferadius = level.var_6E02;
  } else {
...
func_78D4(var_0) {
  if(isDefined(var_0)) {
    if(!isDefined(level.var_11AE[var_0])) {
      var_1 = _getspawnerteamarray("allies");
