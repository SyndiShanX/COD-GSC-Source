...
_id_23DA() {
  ...
  foreach(var_7 in var_5) {
    if(isDefined(var_7.name) && var_7.name == "wall_buy") {
      ...
      if(isDefined(var_7.target)) {
        if(scripts\engine\utility::is_true(var_7.already_used)) {
          continue;
        }
  ...
  foreach(var_24, var_15 in var_13) {
    ...
    if(!scripts\engine\utility::is_true(var_15.already_used)) {
...
_id_834A(var_0) {
  ...
  if(!scripts\cp\cp_weapon::has_weapon_variation(var_0.script_noteworthy)) {
    ...
    if(scripts\cp\utility::is_consumable_active("wall_power")) {
      ...
      var_18 = scripts\cp\utility::getrawbaseweaponname(var_17);
      ...
      var_17 = scripts\cp\cp_weapon::return_weapon_name_with_like_attachments(var_4, undefined, var_16);
      var_17 = scripts\cp\utility::_giveweapon(var_17, undefined, undefined, 1);
      self.itempicked = var_17;
    ...
    foreach(var_25 in var_20) {
      var_10 = scripts\cp\utility::getrawbaseweaponname(var_25);
