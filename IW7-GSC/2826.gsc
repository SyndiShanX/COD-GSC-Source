...
func_5838(var_0) {
  if(level.var_5832[var_0]["timeRemaining"] <= 0.0) {
    return;
  }
  var_1 = min(1.0, 0.05 / level.var_5832[var_0]["timeRemaining"]);
  level.var_5832[var_0]["timeRemaining"] = level.var_5832[var_0]["timeRemaining"] - 0.05;

  if(level.var_5832[var_0]["timeRemaining"] <= 0.0) {
    level.var_5832[var_0]["timeRemaining"] = 0.0;
...
func_583A(var_0, var_1) {
  ...
  var_6 = 500;
  var_7 = 0.05;
  func_5849(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, 1.0);
}
...
func_5843() {
  ...
  level.var_5832["base"]["timeRemaining"] = 0.0;
  ...
  level.var_5832["script"]["timeRemaining"] = 0.0;
...
func_5848(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  func_5849("base", "goal", var_0, var_1, var_2, var_3, var_4, var_5, 1.0);
  level.var_5832["base"]["timeRemaining"] = var_6;

  if(var_6 <= 0.0) {
    func_5849("base", "current", var_0, var_1, var_2, var_3, var_4, var_5, 1.0);
  }
}

func_583F(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  func_5849("script", "goal", var_0, var_1, var_2, var_3, var_4, var_5, 1.0);
  level.var_5832["script"]["timeRemaining"] = var_6;

  if(var_6 <= 0.0) {
    func_5849("script", "current", var_0, var_1, var_2, var_3, var_4, var_5, 1.0);
  } else if(level.var_5832["script"]["current"]["weight"] <= 0.0) {
    func_5849("script", "current", var_0, var_1, var_2, var_3, var_4, var_5, 0.0);
  }
}

func_583D(var_0) {
  level.var_5832["script"]["goal"]["weight"] = 0.0;
  level.var_5832["script"]["timeRemaining"] = var_0;

  if(var_0 <= 0.0) {
    level.var_5832["script"]["current"]["weight"] = 0.0;
  }
}
...
func_583E(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  ...
  if(level.var_5832["ads"]["current"]["weight"] <= 0.0) {
    func_5849("ads", "current", var_0, var_1, var_2, var_3, var_4, var_5, 0.0);
  }
}
...
func_5835() {
  ...
  level.var_5832["ads"]["current"]["weight"] = 1.0;
}

func_583C() {
  level.var_5832["ads"]["goal"]["weight"] = 0.0;
  level.var_5832["ads"]["current"]["weight"] = 0.0;
}
...
func_5845() {
  ...
  if(isDefined(self.var_5847)) {
    var_12 = _combineangles(self.var_5847.angles, var_11);
  } else {
    var_12 = var_11;
  }
  ...
  if(isDefined(level.var_1094B[var_16])) {
    [[level.var_1094B[var_16]]](var_14, var_15, var_10, var_13, var_0);
    return;
  }
  ...
  var_28 = var_17 * var_4;
  var_29 = var_18 * var_7;
  func_583E(var_28, var_17, var_8, var_18, var_29, var_9, var_0);
}
...
func_11715() {
  ...
  level.var_11714.var_4CA5 = getdvarfloat("r_tessellationCutoffDistanceBase", 960.0);
  level.var_11714.var_4CA6 = level.var_11714.var_4CA5;
  level.var_11714.var_4CA7 = getdvarfloat("r_tessellationCutoffFalloffBase", 320.0);
  level.var_11714.var_4CA8 = level.var_11714.var_4CA7;
  level.var_11714.time_remaining = 0.0;
  _setsaveddvar("r_tessellationCutoffDistance", level.var_11714.var_4CA5);
  _setsaveddvar("r_tessellationCutoffFalloff", level.var_11714.var_4CA7);
...
func_11717() {
  for(;;) {
    ...
    if(level.var_11714.time_remaining > 0.0) {
...
func_1121E(var_0, var_1) {
  ...
  var_2 = gettime();
  var_3 = var_1 * 1000;
  var_4 = _getdvarvector("r_sunflare_position", (0, 0, 0));
  var_5 = gettime() - var_2;
  var_6 = level.var_11220[var_0].position;

  for(level.var_4BC4 = var_0; var_5 < var_3; var_5 = gettime() - var_2) {
    var_6 = level.var_11220[var_0].position;
