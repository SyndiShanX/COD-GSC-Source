...
_id_FAB0() {
  ...
  level.brute_damage_adjustment_func = ::_id_3110;
...
_id_3116() {
  ...
  for(;;) {
    if(scripts\engine\utility::is_true(self._id_3117)) {
      var_0 = 0;
      wait 1;
      continue;
    }
...
_id_1164D() {
  ...
  scripts\cp\zombies\zombies_spawning::_id_3115(var_0);
  self.ignoreall = 1;
  ...
  wait 3;
  var_2 = _id_6CA4();
  scripts\cp\zombies\zombies_spawning::_id_3115(var_2);
