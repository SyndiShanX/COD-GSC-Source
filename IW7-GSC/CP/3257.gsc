...
onzombiedamaged(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11) {
  ...
  var_16 = scripts\engine\utility::isbulletdamage(var_4);
  var_17 = isDefined(var_1) && isPlayer(var_1);
  var_18 = scripts\cp\utility::isheadshot(var_5, var_8, var_4, var_1);
  var_19 = (var_1 scripts\cp\cp_weapon::has_attachment(var_5, "overclock") || var_1 scripts\cp\cp_weapon::has_attachment(var_5, "overclockcp")) && var_16;
  var_20 = scripts\engine\utility::is_true(self.battleslid);
  var_21 = scripts\engine\utility::is_true(level.insta_kill);
  var_22 = var_18 && var_16 && var_1 scripts\cp\utility::is_consumable_active("headshot_explosion");
  ...
  if(!var_14 && var_17 && !isDefined(var_1.linked_to_coaster) && var_1 scripts\cp\utility::is_consumable_active("sniper_soft_upgrade"))
    var_25 = var_1 scripts\cp\utility::coop_getweaponclass(var_5) == "weapon_sniper";

  var_26 = scripts\engine\utility::is_true(level.explosive_touch) && isDefined(var_4) && var_4 == "MOD_UNKNOWN";
  ...
  if(scripts\cp\powers\coop_armageddon::isfirstarmageddonmeteorhit(var_5)) {
    ...
    return;
  } else if(isDefined(var_5) && scripts\cp\cp_weapon::isforgefreezeweapon(var_5) && !var_14) {
    if(!var_28) {
      self.isfrozen = 1;
    ...
    var_30 = is_grenade(var_5, var_4);
    var_31 = scripts\engine\utility::is_true(self.is_burning) && !var_16;
    var_32 = var_14 && var_1 scripts\cp\utility::is_consumable_active("shock_melee_upgrade");
    var_33 = var_18 && var_1 scripts\cp\utility::is_consumable_active("sharp_shooter_upgrade");
    var_34 = var_16 && var_1 scripts\cp\utility::is_consumable_active("bonus_damage_on_last_bullets");
    var_35 = var_16 && var_1 scripts\cp\utility::is_consumable_active("damage_booster_upgrade");
    var_36 = var_16 && isDefined(var_1.special_ammo_type) && (var_1.special_ammo_type == "stun_ammo" || var_1.special_ammo_type == "combined_ammo");
    var_37 = var_17 && var_1 scripts\cp\utility::has_zombie_perk("perk_machine_boom");
    var_38 = var_17 && var_1 scripts\cp\utility::has_zombie_perk("perk_machine_smack");
    var_39 = is_axe_weapon(var_5);

    if(isDefined(var_2) && isDefined(var_8) && !var_21 && var_16) {
      var_40 = scripts\cp\zombies\zombie_armor::process_damage_to_armor(var_12, var_1, var_2, var_8, var_7);
    ...
    shotgun_scaling(var_1, var_12, var_5);
    ...
    if(var_17) {
      if(var_14) {
        ...
        if(var_39) {
          if(var_2 >= self.health) {
            ...
            self setvelocity(vectorNormalize(self.origin - (var_1.origin + var_42)) * 400 + (0, 0, 10));
      ...
      if(var_32 && weapontype(var_5) != "riotshield")
        var_1 thread scripts\cp\zombies\zombie_damage::stun_zap(self.origin, self, var_2, "MOD_UNKNOWN", undefined, var_32);
    ...
    if(scripts\engine\utility::is_true(var_1.reload_damage_increase))
      var_2 = var_2 * 5;
...
process_kill_rewards(var_0, var_1, var_2, var_3, var_4) {
  ...
  if(isDefined(var_6)) {
    ...
    if(scripts\cp\utility::coop_mode_has("pillage") && scripts\engine\utility::is_true([[level.pillage_item_drop_func]](var_5, self.origin, var_0))) {
      level.last_drop_time = gettime();
      return;
    } else if(scripts\cp\utility::coop_mode_has("loot") && isDefined(level.loot_func))
...
shotgun_scaling(var_0, var_1, var_2) {
  if(isDefined(var_0) && isDefined(var_1) && isDefined(var_2) && weaponclass(var_2) == "spread") {
    ...
    else if(var_0.pelletdmg[var_3][var_1.guid] + 1 > 2)
      return;
    else
...
initial_weapon_scale(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11) {
  ...
  var_2 = scale_ww_damage(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11);
...
eligible_for_reward(var_0, var_1, var_2, var_3) {
  ...
  switch (var_1) {
    ...
    case "MOD_MELEE":
      ...
      return 1;
    case "MOD_UNKNOWN":
      if(scripts\engine\utility::is_true(var_3.is_burning) && isDefined(var_3.flame_damage_time)) {
        if(gettime() > var_3.flame_damage_time)
          return 1;
      }
  ...
  if(!scripts\engine\utility::is_true(var_3.is_burning))
    return 1;

  if(!scripts\engine\utility::is_true(var_3.marked_for_death))
    return 1;
...
onzombiedamagefinished(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12) {
  ...
  if(isDefined(var_1)) {
    if(isDefined(var_1.perk_data) && var_1.perk_data["damagemod"].bullet_damage_scalar == 2.0)
      var_14 = var_14 * 2;
  ...
  if(isDefined(var_8) && scripts\cp\utility::isheadshot(var_5, var_8, var_4, var_1)) {
    if(var_1 scripts\cp\utility::is_consumable_active("armor_after_headshot")) {
      ...
      if(isDefined(var_1.bodyarmorhp))
        var_15 = int(var_1.bodyarmorhp + 25);
...
zombieenterplayspace() {
  ...
  if(!scripts\engine\utility::is_true(self.reached_entrance_goal)) {
    ...
    self scragentsetgoalpos(self.attack_spot.origin);
...
run_if_last_zombie(var_0) {
  var_1 = scripts\mp\agents\zombie\zombie_agent::calulatezombiemovemode(var_0);
