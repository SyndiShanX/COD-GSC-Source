...
_id_E4B9(var_0, var_1) {
  ...
  var_2 solid();
  var_2 setModel(level._id_47B1["crafted_revocator"].placedmodel);
...
_id_E4B7(var_0, var_1) {
  self setModel(level._id_47B1["crafted_revocator"].modelplacement);
  self hide();
  self setsentrycarrier(var_0);
  self setCanDamage(0);
  self.carriedby = var_0;
  var_0.iscarrying = 1;
  var_0 thread scripts\cp\utility::update_trap_placement_internal(self, self.carriedrevocator, level._id_47B1["crafted_revocator"]);
...
_id_E4B5(var_0) {
  ...
  thread scripts\cp\utility::item_timeout(var_0, level._id_47B1["crafted_revocator"].timeout);
  thread _id_E4B2();
  thread _id_E4BA();
