...
drop_loot(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  if(!is_in_active_volume(var_0) && loot_fly_to_player_enabled()) {
    var_0 = moveeffecttoclosestplayer(var_7);
...
process_loot_content(var_0, var_1, var_2, var_3) {
  var_4 = var_1;
  ...
  switch (var_5) {
    ...
    case "instakill":
      ...
      level thread activate_instakill(var_0, var_4, int(var_6), var_7);
      break;
    case "ammo":
    ...
    case "board":
      if(isDefined(level.rebuild_all_windows_func)) {
        ...
        level thread[[level.rebuild_all_windows_func]](var_0);
      }
...
choose_powerup(var_0, var_1, var_2) {
  ...
  for(var_5 = 0; var_5 < var_4; var_5++) {
    ...
    switch (var_8) {
      case "fire":
        if((scripts\engine\utility::is_true(level.power_up_drop_override) || scripts\engine\utility::flag("canFiresale") && var_1 - var_7 >= 180000) && var_3 >= 5) {
          level.allowed_powerups[level.allowed_powerups.size] = var_5;
          break;
        } else
          break;
      case "explosive":
        if((scripts\engine\utility::is_true(level.power_up_drop_override) || var_1 - var_7 >= 300000) && var_3 >= 8) {
          level.allowed_powerups[level.allowed_powerups.size] = var_5;
          break;
        } else
          break;
      case "infinite":
        if((scripts\engine\utility::is_true(level.power_up_drop_override) || var_1 - var_7 >= 180000) && var_3 >= 5) {
          level.allowed_powerups[level.allowed_powerups.size] = var_5;
          break;
        } else
          break;
      case "ammo":
        if((scripts\engine\utility::is_true(level.power_up_drop_override) || var_1 - var_7 >= 180000) && var_3 >= 2) {
          level.allowed_powerups[level.allowed_powerups.size] = var_5;
          break;
        } else
          break;
      case "grenade":
        if((scripts\engine\utility::is_true(level.power_up_drop_override) || var_1 - var_7 >= 60000) && var_3 >= 1) {
          level.allowed_powerups[level.allowed_powerups.size] = var_5;
          break;
        } else
          break;
      case "upgrade":
        if((scripts\engine\utility::is_true(level.power_up_drop_override) || var_1 - var_7 >= 600000) && var_3 >= 15) {
          ...
          break;
      case "kill":
        if((scripts\engine\utility::is_true(level.power_up_drop_override) || var_1 - var_7 >= 180000) && var_3 >= 1) {
          level.allowed_powerups[level.allowed_powerups.size] = var_5;
          break;
        } else
          break;
      case "cash":
        if((scripts\engine\utility::is_true(level.power_up_drop_override) || var_1 - var_7 >= 90000) && var_3 >= 1) {
          level.allowed_powerups[level.allowed_powerups.size] = var_5;
          break;
        } else
          break;
      case "instakill":
        if((scripts\engine\utility::is_true(level.power_up_drop_override) || var_1 - var_7 >= 90000) && var_3 >= 1) {
          ...
          break;
      case "board":
        if((scripts\engine\utility::is_true(level.power_up_drop_override) || var_1 - var_7 >= 45000) && var_3 >= 1) {
          level.allowed_powerups[level.allowed_powerups.size] = var_5;
          break;
        } else
          break;
...
update_enemy_killed_event(var_0, var_1, var_2) {
  ...
  var_4 = scripts\engine\utility::is_true(level.power_up_drop_override);
...
kill_selected_enemy(var_0) {
  ...
  var_1 = scripts\engine\utility::is_true(self.is_suicide_bomber);
