...
update_challenges_status(var_0, var_1) {
  if(level._id_13F0B.challenge_results.size > 25) {
    return;
  }
  var_2 = spawnStruct();
  var_2.challenge_name = var_0;
  var_2.result = var_1;
  level._id_13F0B.challenge_results[level._id_13F0B.challenge_results.size] = var_2;
}
...
inc_laststand_record(var_0) {
  if(!isDefined(self._id_13F0B.laststand_record[var_0][level.wave_num]))
    self._id_13F0B.laststand_record[var_0][level.wave_num] = 0;

  self._id_13F0B.laststand_record[var_0][level.wave_num]++;
}

update_spending_type(var_0, var_1) {
  switch (var_1) {
    case "weapon":
      self._id_13F0B.single_value_stats["cashSpentOnWeapon"].value = self._id_13F0B.single_value_stats["cashSpentOnWeapon"].value + var_0;
      break;
    case "ability":
      self._id_13F0B.single_value_stats["cashSpentOnAbility"].value = self._id_13F0B.single_value_stats["cashSpentOnAbility"].value + var_0;
      break;
    case "trap":
      self._id_13F0B.single_value_stats["cashSpentOnTrap"].value = self._id_13F0B.single_value_stats["cashSpentOnTrap"].value + var_0;
      break;
    default:
      break;
  }
