...
_id_DDAE(var_0, var_1) {
  ...
  while(!level.gameended && isDefined(var_1) && scripts\cp\utility::isreallyalive(var_1) && (var_1 useButtonPressed() && (!isDefined(var_1.laststand) || !var_1.laststand))) {
    ...
    var_7 = 10;
    var_8 = var_7;
    var_9 = var_3.barrier._id_C1DE < 6;
    ...
    if(var_1 scripts\cp\utility::is_consumable_active("faster_window_reboard")) {
      ...
      scripts\cp\zombies\zombie_entrances::_id_F2E3(var_3, var_10 - 1, "repairing");
      _id_DDB6(var_3, var_10, var_6, var_0, var_1);
      level notify("reboard", 1, var_1);
      var_1 scripts\cp\cp_merits::processmerit("mt_rebuild_barriers");
      var_1 notify("window_reboard_notify");
      scripts\cp\zombies\zombie_entrances::_id_F2E3(var_3, var_10 - 1, "boarded");
    }

    var_1.reboarding_points = var_1.reboarding_points + var_8;

    if(isDefined(var_1.reboarding_points) && var_1.reboarding_points <= level._id_B41F && var_9) {
...
_id_DDB8(var_0) {
  ...
  while(!scripts\cp\utility::entrance_is_fully_repaired(var_0)) {
    ...
    var_5 = scripts\cp\zombies\zombie_entrances::_id_7B13(var_0);
...
_id_DDB7(var_0, var_1, var_2, var_3) {
  scripts\cp\zombies\zombie_entrances::_id_F2E3(var_0, var_1 - 1, "boarded");
  var_0.barrier scripts\cp\zombies\zombie_entrances::_id_F2D7("board_" + var_1, "instant_repair");
  wait 0.25;
...
_id_DDB6(var_0, var_1, var_2, var_3, var_4) {
  if(var_4 scripts\cp\utility::has_zombie_perk("perk_machine_flash")) {
    var_5 = 0.5;
    var_0.barrier scripts\cp\zombies\zombie_entrances::_id_F2D7("board_" + var_1, "fast_repair");
  } else {
    var_5 = 1;
    var_0.barrier scripts\cp\zombies\zombie_entrances::_id_F2D7("board_" + var_1, "repair");
  }
