...
_id_3721(var_0, var_1, var_2, var_3) {
  ...
  if(var_2 == "Custom") {
    var_14 = _id_8174(self.asm._id_4C86._id_22F1, undefined, self.asm._id_4C86._id_22F6);
    var_13 = self.asm._id_4C86._id_22F1;
  } else
...
_id_8177() {
  ...
  if(isDefined(var_1) && var_1.type != "Path") {
    ...
    var_0._id_0130 = (0, scripts\asm\shared\utility::getnodeforwardyaw(var_1), 0);
  } else {
