...
eog_player_tracking_init() {
  ...
  foreach(var_8 in level.players) {
    ...
    self setplayerdata("cp", "EoGPlayer", var_0, "drillplants", var_16);
    self setplayerdata("cp", "EoGPlayer", var_0, "downs", var_17);
    self setplayerdata("cp", "EoGPlayer", var_0, "deaths", var_18);
    self setplayerdata("cp", "EoGPlayer", var_0, "hivesdestroyed", var_19);
    self setplayerdata("cp", "EoGPlayer", var_0, "currency", var_20);
    self setplayerdata("cp", "EoGPlayer", var_0, "currencyspent", var_21);
    self setplayerdata("cp", "EoGPlayer", var_0, "currencytotal", var_22);
    self setplayerdata("cp", "EoGPlayer", var_0, "tickets", var_23);
    self setplayerdata("cp", "EoGPlayer", var_0, "ticketsspent", var_24);
    self setplayerdata("cp", "EoGPlayer", var_0, "tickettotal", var_25);
    self setplayerdata("cp", "EoGPlayer", var_0, "traps", var_26);
    self setplayerdata("cp", "EoGPlayer", var_0, "deployables", var_27);
    self setplayerdata("cp", "EoGPlayer", var_0, "deployablesused", var_28);
    self setplayerdata("cp", "EoGPlayer", var_0, "consumablesearned", var_29);
    self setplayerdata("cp", "EoGPlayer", var_0, "headShots", var_30);
    self setplayerdata("cp", "EoGPlayer", var_0, "connected", var_31);
  }
