...
_id_A86F(var_0, var_1, var_2) {
  ...
  var_3._id_A86A = scripts\engine\utility::play_loopsound_in_space("trap_laser_lp", var_1.origin);
  ...
  for(;;) {
    ...
    if(isalive(var_5) && !scripts\engine\utility::is_true(var_5.marked_for_death)) {
