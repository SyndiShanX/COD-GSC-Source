...
_id_E5D9() {
  ...
  var_7 = undefined;
  var_8 = scripts\engine\utility::is_true(self.requires_power) && isDefined(self.power_area);
  var_9 = "power_on";
...
use_rocket_trap(var_0, var_1) {
  ...
  if(!isDefined(level._id_E5D5)) {
    ...
    level._id_E5D8 = spawn("script_origin", var_0.rocket.origin);
  }
  ...
  earthquake(0.3, 25, var_0.rocket.origin, 850);
...
_id_E5D3() {
  ...
  playsoundatpos(level._id_E5D5.origin, "trap_rocket_alarm");
  wait 1;
  playsoundatpos(level._id_E5D5.origin, "trap_rocket_alarm");
  wait 1;
}
