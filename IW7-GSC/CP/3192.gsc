...
_id_13F91(var_0, var_1, var_2, var_3) {
  return scripts\engine\utility::is_true(self.is_regening_health);
}

_id_13F93(var_0, var_1, var_2, var_3) {
  return scripts\engine\utility::is_true(self.should_shock_wave);
}

_id_13F92(var_0, var_1, var_2, var_3) {
  return scripts\engine\utility::is_true(self.should_regen_summon);
}
...
zombiegreyshouldteleportattack(var_0, var_1, var_2, var_3) {
  return scripts\engine\utility::is_true(self.doing_teleport_attack);
}

zombiegreyshouldteleportsummon(var_0, var_1, var_2, var_3) {
  return scripts\engine\utility::is_true(self.doing_teleport_summon);
}

zombiegreyshouldteleportdash(var_0, var_1, var_2, var_3) {
  return scripts\engine\utility::is_true(self.doing_teleport_dash);
}

_id_13F8C(var_0, var_1, var_2, var_3) {
  return scripts\engine\utility::is_true(self._id_9B78);
}

_id_13F8E(var_0, var_1, var_2, var_3) {
  return scripts\engine\utility::is_true(self.doing_duplicating_attack);
}
...
_id_F3E8(var_0, var_1) {
  var_0._id_D8A3 = var_0.meleerangesq;
  var_0.meleerangesq = var_1;
}

_id_E2FA(var_0) {
  var_0.meleerangesq = var_0._id_D8A3;
}
...
try_kill_off_zombies(var_0) {
  ...
  if(var_2 < var_0) {
    var_3 = var_0 - var_2;
    scripts\cp\zombies\zombies_spawning::_id_A5FA(var_3);
  }
}
...
_id_FE53(var_0) {
  foreach(var_2 in level.players) {
    ...
    scripts\mp\agents\zombie_grey\zombie_grey_agent::_id_85F8(var_0, var_2);
  }
}
...
_id_11642(var_0, var_1, var_2, var_3) {
  if(var_0 == "start_summon_zombies") {
    if(isDefined(self._id_11643) && !scripts\engine\utility::is_true(self._id_11643.in_afterlife_arcade)) {
      try_kill_off_zombies(6);
...
_id_7CEF(var_0, var_1) {
  var_2 = scripts\engine\utility::get_array_of_closest(var_1.origin, level._id_85F2, undefined, level._id_85F2.size, 1400, 200);
  var_3 = undefined;

  for(var_4 = 0; var_4 < var_2.size; var_4++) {
    var_5 = var_2[var_4];

    if(scripts\engine\utility::is_true(var_5._id_9B8C)) {
      continue;
    }
    ...
    var_3 = var_5;
    var_0._id_DDC6 = scripts\engine\utility::array_add(var_0._id_DDC6, var_3);
    break;
  }
...
_id_8601(var_0, var_1, var_2, var_3) {
  return scripts\engine\utility::is_true(self.should_stop_intro_anim);
}
