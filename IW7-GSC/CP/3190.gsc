...
_id_8485(var_0, var_1, var_2, var_3) {
  if(var_0 == "hit") {
    if(isDefined(self.zombietograb) && !isDefined(self.zombiepiece) && isalive(self.zombietograb)) {
      ...
      self.zombietograb dodamage(self.zombietograb.health + 50000, self.origin);
      var_4 = self gettagorigin("J_Wrist_ri");
...
_id_895D(var_0) {
  ...
  if(scripts\engine\utility::is_true(self.bblockedbyfrozenzombies)) {
    ...
    foreach(var_7 in var_5) {
      ...
      if(!scripts\engine\utility::is_true(var_7.isfrozen)) {
        continue;
      }
...
_id_9E70(var_0, var_1, var_2, var_3) {
  return !scripts\engine\utility::is_true(self.blaserattack);
}
...
_id_8979(var_0) {
  ...
  for(var_4 = 0; var_4 < var_3; var_4++) {
    ...
    self shoot(1, self.lookposition, 1, 1);
    _id_FF5C();
    wait 0.05;
  }
