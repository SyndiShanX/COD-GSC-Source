...
givepower(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  ...
  var_13.weaponuse = var_20;
  self giveweapon(var_20, 0);
  self setweaponammoclip(var_20, var_13.charges);

  if(var_13.slot == "primary") {
    self assignweaponoffhandprimary(var_20);
    self.powerprimarygrenade = var_20;
  } else if(var_13.slot == "secondary") {
    self assignweaponoffhandsecondary(var_20);
...
_id_12D07() {
  scripts\cp\powers\coop_phaseshift::_id_E154();
}

usephaseshift() {
  scripts\cp\powers\coop_phaseshift::_id_E88D();
}
...
_id_F776(var_0) {
  level.powers[var_0]._id_5FF3 = 3.0;
}

unsetkillstreaktoscorestreak() {}

_id_1309C() {
  scripts\cp\powers\coop_kinetic_pulse::_id_E85E();
}
...
_id_F658(var_0) {
  level.powers[var_0]._id_5FF3 = 30.0;
}
...
power_adjustcharges(var_0, var_1, var_2) {
  ...
  foreach(var_6 in var_3) {
    ...
    if(self.powers[var_6].slot == var_1 || var_1 == "all") {
      ...
      scripts\cp_mp\powershud::powershud_updatepowercharges(self.powers[var_6].slot, self.powers[var_6].charges);
    }
  }
}
...
_id_D76C(var_0) {
  ...
  for(;;) {
    ...
    scripts\cp_mp\powershud::powershud_updatepowercharges(var_2, var_3);
  }
}
...
power_watch_hint(var_0) {
  ...
  var_0 = scripts\engine\utility::is_true(var_0);
