...
init() {
  ...
  level._id_47AF["crafted_gascan"].timeout = 180;
  level._id_47AF["crafted_gascan"].modelbase = "zmb_candybox_crafted_lod0";
  level._id_47AF["crafted_gascan"].modelplacement = "zmb_candybox_crafted_lod0";
  level._id_47AF["crafted_gascan"].modelplacementfailed = "zmb_candybox_crafted_lod0";
  level._id_47AF["crafted_gascan"].placedmodel = "zmb_candybox_crafted_lod0";
}
...
_id_76C8(var_0, var_1) {
  ...
  var_3 setModel(level._id_47AF["crafted_gascan"].placedmodel);
...
_id_135B5(var_0) {
  thread _id_92DF();
  thread _id_76C2();
  thread _id_76C3(level._id_47AF["crafted_gascan"].timeout);
...
_id_76C0(var_0, var_1) {
  ...
  self._id_4D27.targetname = "kindlepops_trig";
...
_id_76CA(var_0, var_1) {
  ...
  self setModel(level._id_47AF["crafted_gascan"].modelplacement);
  self hide();
...
_id_12EA0(var_0, var_1) {
  ...
  for(;;) {
    var_0.canbeplaced = _id_3831(var_0);

    if(var_0.canbeplaced != var_2 || var_0._id_BE9C) {
      var_0._id_BE9C = 0;
