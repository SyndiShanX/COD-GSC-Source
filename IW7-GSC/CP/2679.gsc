...
entrance_is_fully_repaired(var_0) {
  ...
  var_1 = scripts\cp\zombies\zombie_entrances::_id_7B13(var_0);
...
is_trap(var_0, var_1, var_2) {
  ...
  if(isDefined(var_2) && scripts\engine\utility::is_true(var_2.fridge_trap_marked))
    return 1;
