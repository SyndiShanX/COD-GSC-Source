...
teleport_begin(var_0) {
  scripts\aitypes\dlc4\behavior_utils::facepoint(self._id_AAFD);
  self._blackboard.jumpdestinationpos = self._id_AAFD;
  self._blackboard.jumpdestinationangles = vectortoangles(self._id_AAFD - self.origin * (1, 1, 0));
