...
_id_126AA(var_0, var_1) {
  ...
  var_2 setModel(level._id_47B3["crafted_trap_balloon"].modelbase);
  var_2 notsolid();
  var_3 = (0, 0, 60);
  var_4 = (0, 0, 350) - var_3;
  var_5 = var_2.origin;
...
_id_126A8(var_0, var_1, var_2) {
  ...
  var_0.iscarrying = 1;
  var_0 thread scripts\cp\utility::update_trap_placement_internal(self, self.carried_trap, level._id_47B3["crafted_trap_balloon"]);
...
_id_126A6(var_0) {
  ...
  thread scripts\cp\utility::item_timeout(var_0, level._id_47B3["crafted_trap_balloon"].timeout);
  thread _id_126A1();
...
balloon_death(var_0) {
  ...
  self._id_55CF = 1;
  scripts\anim\notetracks_mp::setstatelocked(1, "balloon_trap");
