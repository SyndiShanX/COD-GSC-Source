...
watch_dpad() {
  ...
  for(;;) {
    ...
    if(scripts\engine\utility::is_true(self.attemptingpuzzle)) {
      continue;
    }
    ...
    if(scripts\engine\utility::is_true(self.carriedsentry)) {
      self playlocalsound("perk_machine_deny");
      continue;
    }
...
moveitemtowardsplayer(var_0, var_1, var_2) {
  ...
  while(isDefined(var_0) && var_0 getcurrentweapon() == "iw7_entangler2_zm") {
    ...
    var_20 = var_12 >= 20;
    var_13 = var_14 >= 5;
    var_21 = scripts\engine\utility::array_combine(level.players, [var_7]);
    var_22 = var_0 getEye();
    ...
    var_32 = var_31[2];
    var_33 = scripts\engine\utility::drop_to_ground(var_22, 12, -100)[2] + 16;
    ...
    if(var_8) {
      if(scripts\engine\utility::is_true(var_0.is_off_grid) || scripts\engine\utility::is_true(var_0.isfasttravelling)) {
        ...
        if(var_13) {
          ...
          var_38 = scripts\common\trace::capsule_trace(var_37, var_31, var_11[0], var_11[1], undefined, var_21, var_9, 1);
        ...
        if([[var_1.entanglemovetofunc]](var_1, var_31, var_7, var_0)) {
          ...
          var_21 = scripts\engine\utility::array_combine(level.players, [var_7]);
          var_38 = scripts\common\trace::capsule_trace(var_1.origin, var_0.origin, var_11[0], var_11[1], undefined, var_21, var_9, 24);
      ...
      if(var_19) {
        ...
        var_21 = scripts\engine\utility::array_combine(level.players, [var_7]);
        var_40 = scripts\common\trace::ray_trace(var_22, var_37 + (0, 0, 16), var_21, var_10);
...
launchitem(var_0, var_1, var_2) {
  ...
  if(scripts\engine\utility::is_true(var_1.forcerelease)) {
    ...
    var_16 = -150;
    var_14 = trajectorycalculateinitialvelocity(var_15 + (0, 0, 20), var_15 + (0, 0, 20) + (randomintrange(-10, 10), randomintrange(-10, 10), 0), (0, 0, var_16), 2);
