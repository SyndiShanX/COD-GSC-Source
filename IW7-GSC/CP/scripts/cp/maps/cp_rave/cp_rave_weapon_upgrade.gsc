...
update_level_pap_machines(var_0, var_1, var_2, var_3, var_4) {
  ...
  foreach(var_7 in level.player_pap_machines) {
    ...
    if(scripts\engine\utility::is_true(var_7.owner.has_zis_soul_key) && var_5 || scripts\engine\utility::is_true(level.placed_alien_fuses) && var_5) {
...
get_pap_offhand_weapon(var_0, var_1) {
  ...
  foreach(var_4 in var_2) {
    if(!issubstr(var_1, var_4) && (!scripts\cp\utility::isstrstart(var_4, "alt_") && !issubstr(var_4, "knife"))) {
      return var_4;
    }
  }
...
process_pap_stat_logging(var_0, var_1) {
  ...
  var_1 scripts\cp\zombies\achievement::update_achievement("PUMP_IT_UP", 1);
}
