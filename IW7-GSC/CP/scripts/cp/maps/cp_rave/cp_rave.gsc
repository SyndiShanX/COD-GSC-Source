...
main() {
  ...
  scripts\cp\cp_weapon_medusa::init();
  scripts\cp\crafted_trap_electric::init();
  scripts\cp\crafted_trap_mower::init();
  scripts\cp\crafted_trap_balloons::init();
  scripts\cp\crafted_trap_boombox::init();
  scripts\cp\crafted_trap_revocator::init();
  ...
  level.additional_laststand_weapon_exclusion = ["iw7_cpbasketball_mp", "iw7_cpskeeball_mp", "iw7_cpclowntoothball_mp", "iw7_horseracepistol_zm_blue", "iw7_horseracepistol_zm_yellow", "iw7_horseracepistol_zm_red", "iw7_horseracepistol_zm_green", "iw7_shootgallery_zm", "iw7_blackholegun_mp", "iw7_penetrationrail_mp", "iw7_atomizer_mp", "iw7_glr_mp", "iw7_claw_mp", "iw7_shootgallery_zm_blue", "iw7_shootgallery_zm_yellow", "iw7_shootgallery_zm_red", "iw7_lawnmower_zm", "iw7_shootgallery_zm_green"];
...
fix_map_exploits() {
  ...
  add_invalid_place((-1869, -4367.5, 393.5), (250, 0, 0), 48);
  ...
  level thread scripts\engine\utility::draw_entity_bounds(var_1, 40);
}

add_invalid_place(var_0, var_1, var_2, var_3, var_4) {
  var_5 = spawnStruct();
  var_5.origin = var_0;
  var_5.velocity = var_1;
    ...
    foreach(var_1 in level.invalid_orgs) {
      foreach(var_3 in level.players) {
        if(distancesquared(var_3.origin, var_1.origin) <= var_1.distcheck) {
          ...
          var_3 setvelocity(var_1.velocity);
        }
      }
...
setup_pap_camos() {
  ...
  level.no_pap_camos = ["harpoon", "harpoon1", "harpoon2", "harpoon3", "harpoon4", "slasher", "axe", "two", "golf", "machete", "spiked"];
}
...
spawn_water_trigger(var_0) {
  ...
  var_1.targetname = "water_trigger";
}
...
wait_for_player_approach(var_0) {
  ...
  if(isDefined(var_0.target)) {
    ...
    foreach(var_6 in level.players) {
      if(!scripts\engine\utility::is_true(var_6.rave_mode))
...
wave_complete_dialogues(var_0) {
  ...
  if(var_0 >= 3 && var_0 <= 5) {
    ...
    if(scripts\engine\utility::is_true(level.met_kev)) {
...
toy_charging_use_func(var_0, var_1) {
  ...
  for(var_3 = 0; var_3 < var_2.size; var_3++) {
    ...
    if(isDefined(var_0.current_statue) && (scripts\engine\utility::flag(var_2[var_3] + "_toy_charged") && scripts\engine\utility::flag(var_2[var_3] + "_toy_placed"))) {
      ...
      if(scripts\engine\utility::is_true(var_0.has_statue_equipped))
...
toy_statue_end_pos_hint_func(var_0, var_1) {
  ...
  if(!scripts\engine\utility::flag(var_0.name + "_toy_placed"))
    return &"CP_RAVE_PLACE_ITEM";
  else if(scripts\engine\utility::flag(var_0.name + "_quest_completed"))
    return &"CP_RAVE_PICKUP_ITEM";
  else
    return "";
}
...
setup_b_bman_quest(var_0) {
  ...
  if(!isDefined(level.head.kills[var_0.current_statue]))
    level.head.kills[var_0.current_statue] = 0;
}
...
watch_zombie_health() {
  ...
  for(;;) {
    ...
    foreach(var_7 in var_4) {
      ...
      if(!scripts\engine\utility::is_true(var_7.is_skeleton))
...
get_valid_statue_enemy(var_0, var_1, var_2, var_3) {
  ...
  foreach(var_11 in var_9) {
    if(scripts\engine\utility::is_true(var_11.died_poorly)) {
      continue;
    }
    var_12 = 0;
...
toy_animal_statue_end_pos(var_0, var_1) {
  ...
  if(scripts\engine\utility::flag(var_0.name + "_quest_completed")) {
    ...
    scripts\cp\cp_interaction::add_to_current_interaction_list(var_0);
    return;
  } else if(!scripts\engine\utility::flag(var_0.name + "_toy_placed")) {
...
rave_processenemykilledfunc(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9) {
  if(isPlayer(var_1) && !scripts\engine\utility::is_true(var_1.has_rave_dust) && !isDefined(var_1.rave_dust_pouch)) {
    if(isDefined(var_1.kills) && var_1.kills % 20 == 0 || scripts\engine\utility::is_true(var_1.should_drop_pouch)) {
...
slasher_gesture(var_0) {
  ...
  while(var_0 adsButtonPressed(1) && (var_0 isgestureplaying("ges_slasher_charge") || var_0 isgestureplaying("ges_slasher_charge_hit"))) {
    ...
    if(scripts\engine\utility::is_true(var_0.should_lunge)) {
...
run_slasher_saw_logic(var_0) {
  ...
  for(var_2 = 0; var_0 adsButtonPressed(1); var_2 = 0) {
    ...
    foreach(var_5 in var_3) {
      ...
      if(!scripts\engine\utility::is_true(var_0.slasher_screen_blood))
...
setup_slide() {
  ...
  for(;;) {
    ...
    if(scripts\engine\utility::is_true(var_1.onslide)) {
      continue;
    }
...
cp_rave_onplayerspawned() {
  ...
  if(scripts\engine\utility::is_true(level.forceravemode)) {
...
run_pap_machine_logic(var_0) {
  ...
  if(scripts\engine\utility::is_true(var_0.has_zis_soul_key) || scripts\engine\utility::is_true(level.placed_alien_fuses)) {
...
moveraveentstostructs(var_0) {
  ...
  var_3 = scripts\engine\utility::is_true(var_0.rave_mode);
  ...
  for(;;) {
    ...
    if(scripts\engine\utility::is_true(var_0.rave_mode) != var_3) {
      var_3 = scripts\engine\utility::is_true(var_0.rave_mode);
      var_5 = 1;
    }
    ...
    foreach(var_8 in var_6) {
      ...
      if(var_8 hasplayerentattached(var_0, var_8)) {
        ...
        if(isDefined(var_10)) {
          if(var_5) {
            if(scripts\engine\utility::is_true(var_0.rave_mode)) {
...
memory_start_struct_mode(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(var_4)) {
    ...
    var_5 = get_memory_attributes(var_4, undefined, !scripts\engine\utility::is_true(var_3.rave_mode), 1, var_1);
    var_6 = set_memory_model(var_4, undefined, !scripts\engine\utility::is_true(var_3.rave_mode), var_0, 1, var_1);
...
memory_struct_rave_mode(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(var_4)) {
    ...
    var_5 = scripts\engine\utility::is_true(var_1.activated);
...
set_memory_model(var_0, var_1, var_2, var_3, var_4, var_5) {
  var_1 = scripts\engine\utility::is_true(var_1);
  var_2 = scripts\engine\utility::is_true(var_2);
  var_6 = scripts\engine\utility::is_true(var_4);
...
get_memory_attributes(var_0, var_1, var_2, var_3, var_4) {
  var_1 = scripts\engine\utility::is_true(var_1);
  var_2 = scripts\engine\utility::is_true(var_2);
  var_5 = scripts\engine\utility::is_true(var_3);
  var_6 = scripts\engine\utility::is_true(var_4.ravetriggered);
  var_7 = [];
...
removeinvalidstructs(var_0, var_1) {
  ...
  foreach(var_4 in var_0) {
    if(!scripts\engine\utility::is_true(var_1.rave_mode) && scripts\engine\utility::is_true(var_4.only_rave_mode)) {
      continue;
    }
...
spawn_ground_pound_flowers(var_0) {
  ...
  foreach(var_18 in var_10) {
    var_13 = scripts\common\trace::ray_trace(var_18 + (0, 0, 32), var_18, var_0, var_8);
...
play_slasher_vo() {
  foreach(var_1 in level.players) {
    if(var_1.vo_prefix == "p5_") {
      ...
      } else if(!scripts\engine\utility::is_true(level.slasher_first_spawn)) {
      ...
      } else if(scripts\engine\utility::is_true(var_1.rave_mode)) {
    ...
    if(!scripts\engine\utility::is_true(level.slasher_first_spawn)) {
      level.slasher_first_spawn = 1;
...
exit_rave_mode(var_0) {
  ...
  var_0 clearclienttriggeraudiozone(1.0);
...
create_rave_fx_walls_after_time() {
  ...
  while(scripts\engine\utility::is_true(level.someones_in_rave)) {
...
create_fire_damage_trigger(var_0, var_1, var_2) {
  ...
  for(;;) {
    ...
    if(!scripts\engine\utility::is_true(var_4.rave_mode)) {
      continue;
    }
    if(scripts\cp\utility::is_valid_player(var_4)) {
      continue;
    }
    if(scripts\engine\utility::is_true(var_4.padding_damage)) {
      continue;
    }
...
knockback_nearby_rave_players(var_0, var_1) {
  ...
  for(;;) {
    ...
    foreach(var_6 in var_4) {
      if(scripts\engine\utility::is_true(var_6.rave_knockback)) {
        continue;
      }
...
update_rave_effect_visibility(var_0) {
  ...
  for(;;) {
    foreach(var_2 in level.players) {
      if(scripts\engine\utility::is_true(var_2.rave_mode)) {
...
getbestraveeffectstruct(var_0, var_1) {
  ...
  foreach(var_5 in var_1) {
    ...
    if(scripts\engine\utility::is_true(var_5.claimed)) {
      continue;
    }
...
show_rave_objects(var_0) {
  ...
  foreach(var_9 in level.wall_buy_interactions) {
    if(scripts\engine\utility::is_true(var_9.should_be_hidden)) {
      continue;
    }
    if(isDefined(var_9.trigger))
...
monitor_player_in_water(var_0) {
  ...
  if(scripts\engine\utility::is_true(self.noslowmovement)) {
    self.in_water = undefined;
    self.waterspeedscalar = 1;
    cp_rave_updatemovespeedscale();
    return;
...
reset_move_speed(var_0) {
  ...
  if(!scripts\engine\utility::is_true(self.in_water)) {
    if(scripts\engine\utility::is_true(self.disabledcrouch))
      scripts\engine\utility::allow_crouch(1);
  ...
  while(!scripts\engine\utility::is_true(self.in_water)) {
...
cp_rave_kill_reward(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  if(isDefined(var_4)) {
    if(isDefined(level.melee_weapons) && scripts\engine\utility::array_contains(level.melee_weapons, getweaponbasename(var_4)))
      return 60;
    else if(isDefined(var_1) && isPlayer(var_1) && scripts\engine\utility::is_true(var_1.rave_mode))
      return var_6 * 2;
    else
      return var_6;
...
rave_add_attachment_to_weapon(var_0, var_1) {
  ...
  if(issubstr(var_2, "+camo"))
    ...
    var_9 = var_1 scripts\cp\utility::getweaponcamo(var_4);
  ...
  foreach(var_16 in var_1 getweaponslistall()) {
...
glyph_watch_for_player_interaction(var_0, var_1, var_2) {
  ...
  while(!scripts\engine\utility::is_true(var_0.found)) {
    ...
    foreach(var_4 in level.players) {
      ...
      if(scripts\engine\utility::is_true(var_4.ee_song_tracking)) {
        continue;
      }
...
give_harpoon_weapon(var_0, var_1) {
  ...
  if(!scripts\cp\cp_weapon::has_weapon_variation(var_0.script_noteworthy)) {
    ...
    var_16 = scripts\cp\cp_weapon::return_weapon_name_with_like_attachments(var_3, undefined, var_15);
    var_16 = scripts\cp\utility::_giveweapon(var_16, undefined, undefined, var_9);
    self.itempicked = var_16;
    ...
    var_8 = undefined;
    var_18 = self getweaponslistall();
    var_19 = self getcurrentweapon();
    var_20 = scripts\cp\utility::getrawbaseweaponname(var_0.script_noteworthy);
    var_21 = undefined;

    foreach(var_23 in var_18) {
      var_8 = scripts\cp\utility::getrawbaseweaponname(var_23);
    ...
    var_26 = scripts\cp\perks\prestige::prestige_getminammo();
  ...
  if(!scripts\cp\cp_weapon::has_weapon_variation(var_0.script_noteworthy)) {
    ...
    if(scripts\cp\maps\cp_rave\cp_rave_weapon_upgrade::can_upgrade(var_3) && scripts\cp\utility::is_consumable_active("wall_power")) {
      ...
      if(isDefined(var_15) && var_15 != "replace_me")
        var_16 = scripts\engine\utility::array_combine(getweaponattachments(var_3), ["pap1"]);
      else
        var_16 = getweaponattachments(var_3);

      var_17 = scripts\cp\utility::getrawbaseweaponname(var_3);
      var_18 = spawnStruct();
      var_18.lvl = 1;
      self.pap[var_17] = var_18;
      var_19 = scripts\cp\cp_weapon::return_weapon_name_with_like_attachments(var_3, undefined, var_16, undefined, var_4);
      var_19 = scripts\cp\utility::_giveweapon(var_19, undefined, undefined, var_9);
      self.pap[var_17].lvl++;
      ...
      self notify("weapon_purchased");
      var_16 = getweaponattachments(var_3);
      var_19 = scripts\cp\cp_weapon::return_weapon_name_with_like_attachments(var_3, undefined, var_16);
      var_19 = scripts\cp\utility::_giveweapon(var_19, undefined, undefined, var_9);
      self.itempicked = var_19;
      level.transactionid = randomint(100);
      scripts\cp\zombies\zombie_analytics::log_purchasingaweapon(1, self, self.itempicked, self.curr_weap, level.wave_num, var_0.name, self.wavesheldwithweapon, self.killsperweaponlog, self.downsperweaponlog);
      removefistsweapons(var_5);
      var_18 = spawnStruct();
      var_18.lvl = 1;
      self.pap[var_8] = var_18;
    }
    ...
    self.purchasing_ammo = 1;
    var_8 = undefined;
    var_20 = self getweaponslistall();
    var_21 = self getcurrentweapon();
    var_22 = scripts\cp\utility::getrawbaseweaponname(var_0.script_noteworthy);
    var_23 = undefined;

    foreach(var_25 in var_20) {
      var_8 = scripts\cp\utility::getrawbaseweaponname(var_25);
    ...
    var_28 = scripts\cp\perks\prestige::prestige_getminammo();
...
wait_for_player_death(var_0, var_1) {
  ...
  for(;;) {
    ...
    var_2 = 0;
    var_4 = var_1 scripts\engine\utility::waittill_any_return_no_endon_death("player_entered_ala", "revive", "death");
...
register_waves_movement() {
  scripts\cp\maps\cp_zmb\cp_zmb_ghost_wave::register_moving_target_wave(1, 1.0, 2.0, 0.3);
  scripts\cp\maps\cp_zmb\cp_zmb_ghost_wave::register_moving_target_wave(2, 1.0, 1.8, 0.3);
  scripts\cp\maps\cp_zmb\cp_zmb_ghost_wave::register_moving_target_wave(3, 1.0, 1.6, 0.3);
