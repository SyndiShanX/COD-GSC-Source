...
init_crab_boss_quest() {
  ...
  scripts\engine\utility::flag_init("boss_fight_begin");
...
move_to_taunt_loc(var_0) {
  ...
  for(;;) {
    ...
    if(scripts\engine\utility::is_true(level.crab_boss_swim_to_combat_position)) {
      return;
    }
  }
}
...
crab_boss_gets_to_combat_pos() {
  var_0 = 10;
  level.crab_boss_swim_to_combat_position = 1;
...
init_escort_bomb() {
  ...
  scripts\engine\utility::flag_set("boss_fight_begin");
}
