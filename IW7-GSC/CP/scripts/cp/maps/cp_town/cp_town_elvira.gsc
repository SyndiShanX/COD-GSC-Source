...
init_elvira_beach() {
  var_0 = scripts\engine\utility::getStruct("elvira_beach", "script_noteworthy");
  scripts\cp\cp_interaction::remove_from_current_interaction_list(var_0);
  scripts\engine\utility::flag_wait("boss_fight_begin");
  ...
  if(isDefined(level.elvira_available_again) && gettime() < level.elvira_available_again)
    ...
    if(!scripts\engine\utility::flag("spellbook_found")) {
      ...
      if(!scripts\engine\utility::is_true(level.pause_nag_vo) && !scripts\engine\utility::is_true(level.vo_system_busy)) {
        ...
        var_2 = ["el_pap_nag_spellbook_prior", "el_pap_nag_spellbook_prior_2", "el_pap_nag_spellbook_prior_3", "el_pap_nag_spellbook_prior_4"];
        var_3 = scripts\engine\utility::random(var_2);
        var_1 thread scripts\cp\cp_vo::try_to_play_vo(var_3, "elvira_player_dialogue_vo", "highest", 70, 0, 0, 1);
        var_4 = scripts\cp\cp_vo::get_sound_length(var_3);
        var_0 thread elvira_talks(var_4);

        for(;;) {
          level waittill("dialogue_done", var_5);

          if(var_5 != "elvira_player_dialogue_vo") {
            continue;
          }
          break;
        }
    ...
    if(scripts\engine\utility::flag("spellbook_placed") && !scripts\engine\utility::flag("vial_filled")) {
      ...
      if(!scripts\engine\utility::is_true(level.pause_nag_vo) && !scripts\engine\utility::is_true(level.vo_system_busy)) {
        ...
        var_3 = scripts\engine\utility::random(var_6);
        scripts\engine\utility::play_sound_in_space(var_3, level.elvira.origin, 0, level.elvira);
        var_4 = scripts\cp\cp_vo::get_sound_length(var_3);
        var_0 thread elvira_talks(var_4);
        wait(var_4 + 1);
        scripts\cp\cp_vo::set_vo_system_busy(0);
    ...
    if(scripts\engine\utility::flag("vial_filled")) {
      ...
      if(!scripts\engine\utility::is_true(level.pause_nag_vo) && !scripts\engine\utility::is_true(level.vo_system_busy)) {
        ...
        var_4 = scripts\cp\cp_vo::get_sound_length("el_pap_returned_vial");
        var_0 thread elvira_talks(var_4);
        wait(var_4);
        scripts\cp\cp_vo::set_vo_system_busy(0);
      }
...
spawn_elvira() {
  ...
  for(;;) {
    level.elvira_ai = scripts\cp\zombies\zombies_spawning::_id_33B1("elvira", var_0.origin, var_0.angles, "allies", undefined, "iw7_erad_zm");
