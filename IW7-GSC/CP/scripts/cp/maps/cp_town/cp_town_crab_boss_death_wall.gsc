...
try_wait_for_players_activate_teleporter() {
  if(!scripts\engine\utility::is_true(level.player_activated_teleporter)) {
...
escort_teleporter_manager() {
  ...
  if(scripts\engine\utility::is_true(level.escort_teleporter_manager)) {
    return;
  }
...
adjust_zombie_spawn(var_0) {
  switch (var_0) {
    case 1:
      level.crab_boss_max_zombie_spawn = 15;
      level.crab_boss_zombie_spawn_delay = 4.5;
      level.max_wave_spawn_num = 20;
      level.wait_time_between_wave = 15;
      break;
    case 2:
      level.crab_boss_max_zombie_spawn = 15;
      level.crab_boss_zombie_spawn_delay = 3.5;
      level.max_wave_spawn_num = 20;
      level.wait_time_between_wave = 15;
      break;
    case 3:
      level.crab_boss_max_zombie_spawn = 15;
      level.crab_boss_zombie_spawn_delay = 2.5;
      level.max_wave_spawn_num = 20;
      level.wait_time_between_wave = 15;
      break;
  }
...
deactivate_toxic_patch_and_trigger(var_0) {
  ...
  if(scripts\engine\utility::is_true(var_1.activated)) {
    var_1 dontinterpolate();
...
activate_final_sequence_blocker() {
  if(scripts\engine\utility::is_true(level.final_sequence_blocker_activated)) {
    return;
  }
...
wail_all_player_trigger_teleporter(var_0, var_1) {
  ...
  for(;;) {
    ...
    foreach(var_5 in level.players) {
      ...
      if(scripts\engine\utility::is_true(var_5.iscarrying)) {
        var_3 = 0;
        break;
      }

      if(distancesquared(var_5.origin, (3016, 2838, -158)) > var_2) {
        var_3 = 0;
        break;
      }
