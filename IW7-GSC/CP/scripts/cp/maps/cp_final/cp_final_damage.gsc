...
cp_final_onzombiedamaged(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11) {
  ...
  var_15 = scripts\engine\utility::is_true(var_12.hit_by_dodging_player);
  var_16 = var_4 == "MOD_MELEE";
  var_17 = scripts\engine\utility::is_true(var_1.inlaststand);
  var_18 = scripts\engine\utility::is_true(var_12.is_suicide_bomber);
  var_3 = var_3 | 4;
  var_19 = isDefined(var_1) && isPlayer(var_1);
  var_20 = scripts\engine\utility::isbulletdamage(var_4) || var_4 == "MOD_EXPLOSIVE_BULLET" && var_8 != "none";
  var_21 = var_20 && scripts\cp\utility::isheadshot(var_5, var_8, var_4, var_1);
  var_22 = scripts\engine\utility::is_true(self.battleslid);
  var_23 = scripts\engine\utility::is_true(level.insta_kill) && !scripts\cp\utility::agentisinstakillimmune();
  ...
  var_25 = !var_17 && var_21 && var_20 && var_1 scripts\cp\utility::is_consumable_active("headshot_explosion");
  var_26 = var_16 && var_1 scripts\cp\utility::is_consumable_active("increased_melee_damage");
  var_27 = var_16 && var_1 scripts\cp\utility::is_consumable_active("shock_melee_upgrade");
  var_28 = scripts\cp\utility::isaltmodeweapon(var_5);
  var_29 = scripts\cp\utility::agentisfnfimmune();
  var_30 = scripts\cp\utility::agentisinstakillimmune();
  var_31 = var_19 && var_1 scripts\cp\utility::has_zombie_perk("perk_machine_change");
  var_32 = scripts\cp\utility::agentisspecialzombie();
        ...
        if(var_35 == var_1) {
          if(distance2dsquared(var_35.origin, self.origin) <= 10000) {
            ...
            if(var_2 >= self.health) {
              if(scripts\engine\utility::is_true(var_35.inlaststand)) {
                scripts\cp\zombies\zombies_consumables::revive_downed_entities(var_35);
              }
            }
  ...
  if(!var_16 && scripts\cp\agents\gametype_zombie::checkaltmodestatus(var_5) && var_19 && !isDefined(var_1.linked_to_coaster) && var_1 scripts\cp\utility::is_consumable_active("sniper_soft_upgrade")) {
    var_37 = var_1 scripts\cp\utility::coop_getweaponclass(var_5) == "weapon_sniper";
  }

  var_38 = !var_29 && scripts\engine\utility::is_true(level.explosive_touch) && isDefined(var_4) && var_4 == "MOD_UNKNOWN";
  var_39 = isDefined(var_5) && var_5 == "iw7_entangler2_zm";
  var_40 = !var_30 && (var_22 || var_23 || var_27 || var_38 || var_25 || var_26 || var_37);
  var_41 = scripts\engine\utility::is_true(self.isfrozen);
  ...
  if(var_40 && !var_29) {
    ...
    if(var_27) {
      ...
      var_1 thread scripts\cp\zombies\zombie_damage::stun_zap(self getEye(), self, self.maxhealth, "MOD_UNKNOWN", undefined, var_27);
    }
    ...
    var_42 = scripts\cp\agents\gametype_zombie::is_grenade(var_5, var_4);
    var_43 = scripts\engine\utility::is_true(self.is_burning) && !var_20;
    var_44 = var_21 && var_1 scripts\cp\utility::is_consumable_active("sharp_shooter_upgrade");
    var_45 = var_20 && var_1 scripts\cp\utility::is_consumable_active("bonus_damage_on_last_bullets");
    var_46 = var_20 && var_1 scripts\cp\utility::is_consumable_active("damage_booster_upgrade");
    var_47 = var_20 && isDefined(var_1.special_ammo_weapon) && var_1.special_ammo_weapon == var_5;
    var_48 = var_19 && var_1 scripts\cp\utility::has_zombie_perk("perk_machine_boom");
    var_49 = var_19 && var_1 scripts\cp\utility::has_zombie_perk("perk_machine_smack");
    var_50 = scripts\engine\utility::array_contains(level.melee_weapons, var_5);
    var_51 = weaponclass(var_5) == "spread" && var_1 scripts\cp\cp_weapon::has_attachment(var_5, "smart");
    var_52 = weaponclass(var_5) == "spread" && !var_51 && (var_1 scripts\cp\cp_weapon::has_attachment(var_5, "arkpink") || scripts\cp\cp_weapon::has_attachment(var_5, "arkyellow"));
    var_53 = var_21 && var_20 && var_1 scripts\cp\cp_weapon::has_attachment(var_5, "highcal");
    ...
    if(issubstr(var_5, "cutie") && var_19) {
      ...
      if(lengthsquared(var_7) < 1) {
        var_55 = self.origin - var_1.origin;
        var_55 = vectorNormalize((var_55[0], var_55[1], var_55[2]));
        self.ragdollimpactvector = var_55 * var_54;
      } else
        self.ragdollimpactvector = var_7 * var_54;
    }
    ...
    if(var_45) {
      var_57 = int(var_1 getweaponammoclip(var_1 getcurrentweapon()) + 1);
      var_58 = weaponclipsize(var_1 getcurrentweapon());
    ...
    if(var_20 && scripts\engine\utility::is_true(var_1.reload_damage_increase) && !var_33) {
      var_2 = var_2 * 2;
    }
  ...
  var_59 = isDefined(var_5) && var_5 == "ghost_grenade_launcher";

  if(isDefined(var_1.perk_data) && var_1.perk_data["damagemod"].bullet_damage_scalar == 2.0 && var_20) {
    var_2 = var_2 * 1.33;
  }
  ...
  if(var_39) {
    ...
    if(isDefined(level.wave_num_override)) {
      var_60 = level.wave_num_override;
    } else {
      var_60 = var_14;
    }

    var_61 = int(clamp(var_60 / 5, 1, 4));

    if(var_32) {
      var_2 = 1;
    } else {
      if(var_61 > 1) {
        var_2 = self.maxhealth * (0.1 / var_61);
      } else {
  ...
  if(self.health > 0 && self.health - var_2 <= 0) {
    ...
    if(var_39 && scripts\engine\utility::is_true(self.entangled)) {
      self.nocorpse = 1;
    }
...
finalfateandfortuneweaponscale(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  ...
  if(isDefined(var_7)) {
    switch (var_7) {
      ...
      case "iw7_claw_mp":
        if(var_5) {
          var_2 = min(max(var_0.maxhealth * 0.34, 100), 150);
...
cp_final_initial_weapon_scale(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11) {
  ...
  if(isDefined(var_5)) {
    if(isDefined(var_4) && var_4 == "MOD_MELEE") {
      ...
      if(scripts\engine\utility::is_true(self.is_mammoth)) {
...
moveghosttowardsplayer(var_0, var_1) {
  ...
  for(var_11 = 0; var_1 getcurrentweapon() == "iw7_entangler2_zm"; var_11++) {
    ...
    var_28 = var_27[2];
    var_29 = scripts\engine\utility::drop_to_ground(var_18, 12, -100)[2];
    ...
    if(var_16) {
      ...
      var_33 = scripts\common\trace::capsule_trace(var_32, var_27, var_10[0], var_10[1], undefined, var_17, var_8, 1);
    ...
    if(scripts\engine\utility::is_true(var_1.is_off_grid) || scripts\engine\utility::is_true(var_1.isfasttravelling)) {
    ...
    if(var_16) {
      ...
      var_17 = scripts\engine\utility::array_combine(level.players, [var_6]);
      var_35 = scripts\common\trace::ray_trace(var_18, var_32 + (0, 0, 16), var_17, var_9);
...
cp_final_onzombiekilled(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8) {
  ...
  if(isDefined(var_1) && isPlayer(var_1) && scripts\engine\utility::is_true(self.entangled) && !scripts\engine\utility::is_true(var_1.hasghostentangled)) {
  ...
  if(isPlayer(var_1)) {
    ...
    if(isDefined(self.soldier)) {
      ...
      var_18 = self launchgrenade("frag_grenade_zm", var_16, var_17, var_15);
    }
  }
  ...
  var_20 = 0;
  var_21 = 0;
  var_22 = scripts\engine\utility::is_true(self.is_suicide_bomber);

  if(isDefined(level.updaterecentkills_func) && isPlayer(var_1)) {
    var_1 thread[[level.updaterecentkills_func]](self, var_4);
  }

  if(getweaponbasename(var_4) == "iw7_cutie_zm" && scripts\engine\utility::is_true(self.affectedbyfovdamage)) {
  ...
  if(scripts\engine\utility::isbulletdamage(var_3) && (getweaponbasename(var_4) == "iw7_atomizer_mp" || scripts\engine\utility::is_true(self.atomize_me)) || var_3 == "MOD_UNKNOWN" && getweaponbasename(var_4) == "iw7_harpoon3_zm" || var_3 == "MOD_UNKNOWN" && getweaponbasename(var_4) == "iw7_lasertrap_zm") {
    if(!var_22 && !var_19 && !var_20 && !var_21 && !scripts\cp\utility::agentisfnfimmune()) {
      self playSound("bullet_atomizer_impact_npc");
  ...
  if(isDefined(self.near_crystal) && !var_22) {
    if(isDefined(level.closest_crystal_func)) {
      var_23 = level[[level.closest_crystal_func]](self);
    } else {
      var_23 = undefined;
    }
    ...
    if(isDefined(var_23)) {
      if(isDefined(level.crystal_killed_notify)) {
        thread scripts\cp\agents\gametype_zombie::delayminiufocollection(self.origin, var_4, var_23);
      }
    }
  }
  ...
  if(self.agent_type == "alien_goon" || self.agent_type == "alien_phantom" || self.agent_type == "alien_rhino") {
    if(getDvar("scr_easy_egg_drop", "") != "") {
      ...
      if(isPlayer(var_1)) {
        var_25 = var_1 getweaponslistall();
      ...
      if(scripts\engine\utility::flag("completepuzzles_step4") && scripts\engine\utility::is_true(var_24)) {
        level thread scripts\cp\maps\cp_final\cp_final_venomx_quest::spawn_egg_interaction_for_players(self.origin);
      }
    }
  }
...
callback_finalzombieplayerdamage(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11) {
  ...
  var_18 = scripts\cp\utility::has_zombie_perk("perk_machine_change");
  ...
  if(var_19) {
    if(var_1 == self) {
      if(var_13) {
        ...
        if(var_17) {
          var_2 = 0;
        } else if(isDefined(self.has_fortified_passive) && self.has_fortified_passive && (self issprintsliding() || (var_23 == "crouch" || var_23 == "prone") && self isonground())) {
          var_2 = 0;
        } else {
      ...
      if(!isDefined(self.last_zombie_hit_time) || var_24 - self.last_zombie_hit_time > 20) {
        self.last_zombie_hit_time = var_24;
      } else {
        return;
      }

      if(scripts\engine\utility::is_true(self.back_shield)) {
        var_25 = (0, 0, 0);
      ...
      if(isDefined(var_1.last_damage_time_on_player[self.vo_prefix])) {
        var_29 = var_1.last_damage_time_on_player[self.vo_prefix];
    ...
    if(isDefined(self.has_fortified_passive) && self.has_fortified_passive && (self issprintsliding() || (var_23 == "crouch" || var_23 == "prone") && self isonground())) {
      if(var_5 == "frag_grenade_zm" || var_5 == "cluster_grenade_zm") {
        var_2 = 0;
      }
    }
  ...
  if(!var_15 || var_16) {
    scripts\cp\zombies\zombie_damage::finishplayerdamagewrapper(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_30, var_10, var_11);
...
damage_from_escort_vehicle(var_0, var_1) {
  if(isDefined(var_0) && isDefined(var_0.targetname) && var_0.targetname == "bomb_vehicle" && isDefined(var_1) && var_1 == "MOD_CRUSH") {
    return 1;
  }
...
slasher_processdamagefeedback(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10) {
  ...
  if(scripts\engine\utility::is_true(var_10.armor_hit)) {
  ...
  if(scripts\engine\utility::is_true(self.armor_hit)) {
    self.armor_hit = 0;
  }
}
...
change_chews_fire_damage(var_0, var_1) {
  ...
  if(isalive(self) && !scripts\engine\utility::is_true(self.marked_for_death)) {
