...
updateneilheadangles(var_0, var_1, var_2) {
  ...
  if(isDefined(var_2.pathtogoal)) {
    if(scripts\engine\utility::is_true(var_0.isfasttravelling)) {
      ...
      if(isDefined(var_10)) {
        if(scripts\engine\utility::is_true(var_10._id_4284)) {
          var_11 = anglesToForward(var_0.angles);
          var_12 = 0;

          foreach(var_14 in var_8) {
            if(distance2dsquared(var_14, var_10.origin) <= 9216) {
              var_12 = 1;

              if(scripts\engine\utility::is_true(var_10._id_4284)) {
                var_15 = scripts\engine\utility::getStructArray(var_10.script_noteworthy, "script_noteworthy");

                foreach(var_17 in var_15) {
                  if(var_17.target == var_17.target) {
                    var_17.nointeraction = undefined;
                  }
                }
...
checkfornearbydisk(var_0) {
  ...
  for(;;) {
    if(isDefined(level.undergratepuzzlepiece)) {
      ...
      if(scripts\engine\utility::is_true(level.undergratepuzzlepiece.hasbeenthrown) && var_1 <= 96) {
...
setneilstatepent(var_0, var_1, var_2, var_3) {
  ...
  switch (level.currentneilstate) {
    ...
    case "straight":
      ...
      var_4 = var_0 playLoopSound("neil_alarm", 1);
...
useentanglerweapon(var_0, var_1) {
  if(!scripts\engine\utility::is_true(var_1.hascollectedentangler)) {
...
disableslidingdoorinteractions(var_0) {
  foreach(var_2 in level.allslidingdoors) {
    if(scripts\engine\utility::is_true(var_0) && !scripts\engine\utility::is_true(var_2.player_opened)) {
      continue;
    }
...
resetslidingdoorstonormalstate() {
  foreach(var_1 in level.allslidingdoors) {
    ...
    if(scripts\engine\utility::is_true(var_1._id_4284)) {
...
watchforitementangled(var_0, var_1) {
  ...
  if(scripts\engine\utility::is_true(var_1.entangled)) {
...
neilheadlaunchfunc(var_0, var_1, var_2) {
  ...
  if(scripts\engine\utility::is_true(var_1.sendbacktospawn)) {
...
solvetogglepuzzle() {
  ...
  foreach(var_3 in var_1) {
    var_3._id_32D9.color = "horizontal";
...
assignbuttonindex(var_0, var_1) {
  ...
  foreach(var_29 in var_0) {
    ...
    if(isDefined(var_29.script_noteworthy)) {
      var_29.id = int(var_29.script_noteworthy);
    }
...
setnextneilvotime(var_0) {
  level.neilvotime = level.neilvotime + (gettime() + var_0);
}
...
initbridgepieces() {
  ...
  foreach(var_2 in var_0) {
    ...
    var_3.angles = var_2.angles;
    var_3.targetname = "pap_bridge_model";
  }
...
spawnastronauts() {
  ...
  foreach(var_4, var_2 in var_0) {
    ...
    if(isDefined(var_2.targetname)) {
      var_3.targetname = var_2.targetname + "_model";
    }
...
watchfornearbyzombies(var_0) {
  ...
  for(;;) {
    ...
    if(var_1.size > 0 && distance(var_1[0].origin, var_0.origin) <= 72) {
      if(scripts\engine\utility::is_true(var_0._id_4284)) {
...
openalldoors() {
  foreach(var_1 in level.allslidingdoors) {
    if(scripts\engine\utility::is_true(var_1.player_opened) && scripts\engine\utility::is_true(var_1._id_4284)) {
...
closealldoors(var_0) {
  foreach(var_2 in level.allslidingdoors) {
    if(scripts\engine\utility::is_true(var_2.player_opened) && scripts\engine\utility::is_true(var_2.opened)) {
      if(scripts\engine\utility::is_true(var_0)) {
