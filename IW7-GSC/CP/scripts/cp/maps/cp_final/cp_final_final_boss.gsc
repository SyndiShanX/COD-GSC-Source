...
bossfight_loadout() {
  ...
  var_8 solid();
  var_9 = scripts\engine\utility::getStructArray("afterlife_arcade", "targetname");
  var_9 = scripts\engine\utility::array_randomize(var_9);

  foreach(var_11, var_1 in level.players) {
    var_1.ability_invulnerable = 1;
    var_1 setOrigin(var_9[var_11].origin);
    var_1 setplayerangles(var_9[var_11].angles);
  }
...
boss_fight_intro_clear_audio_zone() {
  wait 10;
  self clearclienttriggeraudiozone(10.0);
}
...
spawn_meph() {
  ...
  if(isDefined(level.dlc4_boss) && isalive(level.dlc4_boss)) {
    ...
    var_3 = scripts\cp\zombies\zombies_spawning::_id_13F53("dlc4_boss", (-13314, -337, -109), var_5, var_4);
      ...
      if(var_2.state == "CHARGING") {
        foreach(var_4 in level.players) {
          if(canchargecircle(var_4, var_2)) {
            ...
            var_5 = var_1._id_3CCC * level.players.size * pow(0.9, level.players.size);
            var_6 = 1.0 / var_5;
            var_7 = var_6 * 50;
            var_2._id_3CB7 = min(var_2._id_3CB7 + var_7, 1);
            var_2.buffer = var_1.buffer_time;
...
manageactivecircle() {
  ...
  for(;;) {
    var_6 = gettime();
    var_0.activecircle._id_3CB7 = 1 - (var_6 - var_2) / var_1.active_time;
...
setupweakspot(var_0) {
  ...
  var_5 linkTo(var_1.boss, var_3._id_0332, var_3.modeloffset, var_3.angleoffset);
  var_5 enableaimassist();
...
gointolaststand() {
  ...
  self._blackboard.painnotifytime = 100.0;
}
