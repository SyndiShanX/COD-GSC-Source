...
register_environment_interactions() {
  ...
  disco_register_interaction(0, "atm_deposit", "atm", undefined, undefined, ::atm_deposit, 1000, 1, undefined);
...
register_weapon_interactions() {
  ...
  disco_register_interaction(1, "iw7_katana_zm", "wall_buy", undefined, scripts\cp\maps\cp_disco\rat_king_fight::katanahintfunc, scripts\cp\maps\cp_disco\rat_king_fight::katanausefunc, 0);
  var_0 = 500;
...
watch_for_rewind_triggered_on_completion() {
  ...
  for(;;) {
    if(!scripts\engine\utility::is_true(self.isrewinding) || !isDefined(self.rewindmover)) {
      ...
      if(scripts\engine\utility::is_true(self.isrewinding)) {
        self.isrewinding = 0;
      }
...
watch_for_final_quest_end() {
  ...
  for(;;) {
    if(self.clocks_destroyed == 3) {
      if(isDefined(self.rewindmover) || scripts\engine\utility::is_true(self.isrewinding)) {
...
watch_for_damage_on_clock(var_0) {
  ...
  for(;;) {
    ...
    if(scripts\engine\utility::is_true(var_0.already_attacked_by_player)) {
      var_0.health = var_0.maxhealth;
      continue;
    }

    if(scripts\engine\utility::is_true(var_2.finished_backstory)) {
      continue;
    }
    if(var_2 != self) {
      continue;
    }
    if(scripts\engine\utility::is_true(var_2.kung_fu_mode)) {
      continue;
    }
...
watch_for_quest_progress(var_0) {
  ...
  if(scripts\engine\utility::is_true(self.finished_final_part)) {
    return;
  }
  for(;;) {
    if(scripts\engine\utility::is_true(self.finished_final_part)) {
...
use_memory_tv_object(var_0, var_1) {
  ...
  if(var_1.vo_prefix == "p5_") {
    ...
    if(scripts\engine\utility::is_true(var_1.isrewinding)) {
      return;
    }
    var_2 = 666;
    var_3 = " ";
    ...
    if(scripts\engine\utility::is_true(var_1.finished_part_one) && scripts\engine\utility::is_true(var_1.finished_part_two) && scripts\engine\utility::is_true(var_1.finished_part_three) || getDvar("scr_tv_quest") != "") {
      if(!isDefined(var_1.vo_prefix)) {
        return;
      }
      if(scripts\engine\utility::is_true(var_1.finished_backstory)) {
        return;
      }
      if(scripts\engine\utility::is_true(var_1.interacted_with_set)) {
        return;
      }
...
skeleton_death_watcher(var_0) {
  ...
  self waittill("death");
  var_0.skeletons_alive--;

  if(var_0.skeletons_alive <= 0) {
    var_0.finished_final_part = 1;
  }
}
...
init_nunchucks() {
  ...
  foreach(var_2, var_1 in scripts\engine\utility::getStructArray("clock", "script_noteworthy")) {
    level.clock[0] = var_1;
  }
...
use_nunchucks_object(var_0, var_1) {
  ...
  if(scripts\engine\utility::is_true(var_1.finished_part_one) && getDvar("scr_nunchucks") == "") {
    return;
  }
  ...
  level thread clock_watcher(var_0, var_5, var_1, 1);
  var_1 runrewind(1);
...
clock_watcher(var_0, var_1, var_2, var_3) {
  ...
  if(var_3 == 2) {
    var_0.clock_owner_q2 = undefined;
  }

  if(var_3 == 3) {
    var_0.clock_owner_q3 = undefined;
  }
...
reset_rewind_mover(var_0) {
  if(scripts\engine\utility::is_true(self.finished_part_one) || scripts\engine\utility::is_true(self.finished_part_two) || scripts\engine\utility::is_true(self.finished_part_three)) {
    if(isDefined(self.rewindmover)) {
      var_0 = int(var_0);
...
watch_for_damage_on_struct(var_0) {
  ...
  for(;;) {
    ...
    if(self.object_num == 2 && var_2.objects_array_sequence["part1"].size == 0) {
      continue;
    } else if(!scripts\engine\utility::is_true(var_2.attacked_first_object) && self.object_num == 1 && var_2.objects_array_sequence["part1"].size == 0) {
    ...
    if(self.object_num == 2 && scripts\engine\utility::is_true(var_2.attacked_first_object)) {
      var_2.objects_array_sequence["part1"][self.object_num - 1] = self;
      self.model.damage_done = self.model.damage_done + var_1;
      var_2.attacked_first_object = 1;
      self.model hidefromplayer(var_2);
...
activatememquestmodel(var_0, var_1, var_2) {
  ...
  for(;;) {
    ...
    if(var_3 == "quest_2" && !scripts\engine\utility::is_true(var_1.quest_active_q2)) {
      continue;
    }
    if(var_3 == "quest_3" && !scripts\engine\utility::is_true(var_1.quest_active_q3)) {
      continue;
    }
    ...
    if(var_0.object_num == 2 && var_5.objects_array_sequence[var_3].size == 0) {
      ...
      if(var_3 == "quest_2" && !scripts\engine\utility::is_true(var_5.attacked_first_object_q2)) {
      ...
      } else if(var_3 == "quest_3" && !scripts\engine\utility::is_true(var_5.attacked_first_object_q3)) {
        var_5.objects_array_sequence[var_3][0] = var_0;
        var_0.model.damage_done = var_0.model.damage_done + var_4;
    ...
    if(var_0.object_num == 2) {
      if(var_3 == "quest_2" && scripts\engine\utility::is_true(var_5.attacked_first_object_q2) || var_3 == "quest_3" && scripts\engine\utility::is_true(var_5.attacked_first_object_q3)) {
  ...
  switch (var_1.script_noteworthy) {
    case "memory_object_three":
      if(var_3.vo_prefix == "p1_") {
        ...
        if(scripts\engine\utility::is_true(var_3.quest_active_q2)) {
    ...
    case "memory_object_five":
      if(var_3.vo_prefix == "p1_") {
        if(scripts\engine\utility::is_true(var_3.quest_active_q3)) {
...
init_nunchucks_2() {
  ...
  foreach(var_2, var_1 in scripts\engine\utility::getStructArray("clock_2", "script_noteworthy")) {
    level.clock[1] = var_1;
  }
...
use_nunchucks_object_2(var_0, var_1) {
  ...
  if(scripts\engine\utility::is_true(var_1.finished_part_two) && getDvar("scr_nunchucks") == "") {
    return;
  }
  if(!isDefined(var_1.objects_array_sequence)) {
    var_1.objects_array_sequence = [];
  ...
  level thread clock_watcher(var_0, var_5, var_1, 2);
  var_1 runrewind(2);
  level thread delay_enable_linked_interaction(var_0, 30, var_1);
}
...
watch_for_damage_on_struct_q2(var_0) {
  ...
  for(;;) {
    ...
    if(!scripts\engine\utility::is_true(var_2.quest_active)) {
      continue;
    }
    if(isDefined(var_5) && var_5 != "MOD_MELEE") {
      continue;
    ...
    if(self.object_num == 2 && var_2.objects_array_sequence["quest_2"].size == 0) {
      continue;
    } else if(!scripts\engine\utility::is_true(var_2.attacked_first_object_q2) && self.object_num == 1 && var_2.objects_array_sequence["part2"].size == 0) {
    ...
    if(self.object_num == 2 && scripts\engine\utility::is_true(var_2.attacked_first_object_q2)) {
      var_2.objects_array_sequence["quest_2"][self.object_num - 1] = self;
      self.model.damage_done = self.model.damage_done + var_1;
      scripts\cp\cp_interaction::remove_from_current_interaction_list_for_player(self, var_2);
      var_2 thread scripts\cp\maps\cp_disco\cp_disco::update_special_mode_for_player(var_2);
...
init_nunchucks_3() {
  ...
  foreach(var_2, var_1 in scripts\engine\utility::getStructArray("clock_3", "script_noteworthy")) {
    level.clock[2] = var_1;
  }
...
use_nunchucks_object_3(var_0, var_1) {
  ...
  if(scripts\engine\utility::is_true(var_1.finished_part_three) && getDvar("scr_nunchucks") == "") {
    return;
  }
  if(!isDefined(var_1.objects_array_sequence)) {
    var_1.objects_array_sequence = [];
  ...
  level thread clock_watcher(var_0, var_5, var_1, 3);
  var_1 runrewind(3);
  level thread delay_enable_linked_interaction(var_0, 30, var_1);
}
...
watch_for_damage_on_struct_q3(var_0) {
  ...
  for(;;) {
    ...
    if(self.object_num == 2 && var_2.objects_array_sequence["quest_3"].size == 0) {
      continue;
    } else if(!scripts\engine\utility::is_true(var_2.attacked_first_object_q3) && self.object_num == 1 && var_2.objects_array_sequence["part3"].size == 0) {
    ...
    if(self.object_num == 2 && scripts\engine\utility::is_true(var_2.attacked_first_object_q3)) {
      var_2.objects_array_sequence["quest_3"][self.object_num - 1] = self;
      self.model.damage_done = self.model.damage_done + var_1;
      var_2.attacked_first_object_q3 = 1;
      scripts\cp\cp_interaction::remove_from_current_interaction_list_for_player(self, var_2);
...
disco_wait_for_interaction_triggered(var_0) {
  ...
  for(;;) {
    ...
    if(isDefined(level.interactions[var_0.script_noteworthy].can_use_override_func)) {
      ...
      if(!scripts\engine\utility::is_true(self.have_things_in_lost_and_found)) {
        wait 0.1;
        continue;
      }
      ...
      } else if(scripts\engine\utility::is_true(level.has_picked_up_fuses) && !isDefined(level.placed_alien_fuses))
        var_2 = 0;
...
disco_player_interaction_monitor() {
  ...
  for(;;) {
    ...
    if(scripts\engine\utility::is_true(self.delay_hint)) {
      wait 0.1;
      continue;
    }
...
runrewind(var_0) {
  ...
  scripts\cp\utility::adddamagemodifier("rewind_invulnerability", 0.0, 0);
  ...
  self playerlinkTo(self.rewindmover, "tag_origin", 0.0, 10, 10, 10, 10, 0);
  self playerhide();
...
restrictfunctionality() {
  if(scripts\engine\utility::is_true(self.rewindrestrictedfunctionality)) {
    return;
  }
...
init_electric_trap() {
  ...
  for(;;) {
    if(scripts\engine\utility::is_true(level.spawn_volume_array["punk_street"].active) && scripts\engine\utility::is_true(level.spawn_volume_array["rooftops_1"].active)) {
      break;
    }
...
electric_trap_damage(var_0, var_1) {
  ...
  for(;;) {
    ...
    if(scripts\engine\utility::is_true(var_4.is_turned) || !scripts\cp\utility::should_be_affected_by_trap(var_4, 0, 1)) {
      continue;
    }
...
use_fan_trap(var_0, var_1) {
  ...
  if(scripts\engine\utility::flag("rk_fight_started")) {
    ...
    scripts\cp\cp_interaction::interaction_cooldown(var_0, 60);
  }
