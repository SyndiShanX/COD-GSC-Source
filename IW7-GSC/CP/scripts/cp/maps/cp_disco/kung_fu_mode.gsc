...
watchforrightdpad(var_0, var_1) {
  ...
  if(!scripts\engine\utility::is_true(var_0.first_kung_fu)) {
...
run_wipe_away_effects(var_0, var_1) {
  ...
  if(scripts\engine\utility::is_true(self.crane_super)) {
    return;
  }
...
freeze_zombie(var_0) {
  ...
  if(scripts\engine\utility::is_true(var_0.crane_chi_kill)) {
...
get_enemies_within_reticle(var_0, var_1) {
  ...
  foreach(var_9 in var_4) {
    if(scripts\engine\utility::is_true(var_9.pinched)) {
      continue;
    }
    var_10 = 0;
    var_11 = var_9.origin;
...
run_neck_slice_logic() {
  ...
  if(scripts\engine\utility::is_true(self.dragon_super)) {
    return;
  }
  var_0 = 250;
...
getenemiesleftofcenter(var_0, var_1, var_2) {
  ...
  for(var_10 = 1; var_10 <= var_0; var_10++) {
    ...
    foreach(var_13 in var_5) {
      ...
      var_17 = scripts\engine\utility::anglebetweenvectorssigned(var_6, var_16, var_9);
...
talk_to_trainer(var_0, var_1) {
  if(level.wave_num < 5) {
    if(isDefined(level.spoke_to_pam_first) && level.spoke_to_pam_first == var_1) {
      ...
      switch (var_1.vo_prefix) {
        case "p1_":
          var_1 thread scripts\cp\cp_vo::try_to_play_vo("sally_pam_first_1", "pam_dialogue_vo", "highest", 20, 1);
          break;
        case "p2_":
          var_1 thread scripts\cp\cp_vo::try_to_play_vo("pdex_pam_first_1", "pam_dialogue_vo", "highest", 20, 1);
          break;
        case "p3_":
          var_1 thread scripts\cp\cp_vo::try_to_play_vo("andre_pam_first_1", "pam_dialogue_vo", "highest", 20, 1);
          break;
        case "p4_":
          var_1 thread scripts\cp\cp_vo::try_to_play_vo("aj_pam_first_1", "pam_dialogue_vo", "highest", 20, 1);
          break;
        case "p5_":
          var_1 thread scripts\cp\cp_vo::try_to_play_vo("pam_generic_response", "pam_dialogue_vo", "highest", 20, 1);
          break;
        default:
      }
    }
  ...
  if(scripts\engine\utility::flag_exist("heart_picked") && scripts\engine\utility::flag("heart_picked") && !scripts\engine\utility::is_true(var_1.played_heart_vo)) {
    if(var_1.vo_prefix == "p5_") {
      var_1 thread scripts\cp\cp_vo::try_to_play_vo("pam_return_rat_heart", "disco_comment_vo");
      var_1.played_heart_vo = 1;
    }
  } else if(scripts\engine\utility::flag_exist("brain_picked") && scripts\engine\utility::flag("brain_picked") && !scripts\engine\utility::is_true(var_1.played_brain_vo)) {
    if(var_1.vo_prefix == "p5_") {
      var_1 thread scripts\cp\cp_vo::try_to_play_vo("pam_return_rat_brain", "disco_comment_vo");
...
activate_level_3_power(var_0, var_1) {
  ...
  if(scripts\engine\utility::is_true(var_0.kung_fu_exit_delay)) {
    return;
  }
...
unset_kung_fu_mode(var_0, var_1) {
  ...
  if(scripts\engine\utility::is_true(var_0.refill_powers_after_kungfu)) {
...
playerhasusedstyle(var_0) {
  return isDefined(getactivekungfustyle(var_0)) && scripts\engine\utility::is_true(var_0.kung_fu_progression.has_used[getactivekungfustyle(var_0)]);
}
