  ...
  if(scripts\engine\utility::is_true(var_1.kung_fu_mode)) {
    ...
    switch (var_0.script_noteworthy) {
      ...
      case "purchase_boombox":
        var_1 thread scripts\cp\cp_vo::try_to_play_vo("collect_craft_misc", "disco_comment_vo");
        scripts\cp\crafted_trap_boombox::give_crafted_boombox(var_0, var_1);
...
show_next_piece(var_0) {
  foreach(var_2 in var_0.targets) {
    if(scripts\engine\utility::is_true(var_2.ispuzzlepiece) && scripts\engine\utility::is_true(var_2.hidden)) {
...
repopulate_puzzle_piece() {
  self.puzzle_interaction.item show();
  self.puzzle_interaction.item.hidden = undefined;
...
pickup_puzzle(var_0, var_1) {
  if(isDefined(var_1.puzzle_piece) || scripts\engine\utility::is_true(var_1.kung_fu_mode)) {
    var_1 playlocalsound("perk_machine_deny");
    return;
  }
  ...
  switch (var_0.name) {
    case "craft_boombox":
      var_2 = 1;
      playFX(level._effect["boombox_tile_pup"], var_0.item.origin + (0, 0, 5));
      break;
    case "craft_zombgone":
      var_2 = 2;
      playFX(level._effect["zbc_tile_pup"], var_0.item.origin + (0, 0, 5));
      break;
    case "craft_turret":
      var_2 = 3;
      playFX(level._effect["turret_tile_pup"], var_0.item.origin + (0, 0, 5));
      break;
    case "craft_lavalamp":
      var_2 = 4;
      playFX(level._effect["lavalamp_tile_pup"], var_0.item.origin + (0, 0, 5));
      break;
    case "craft_robot":
      var_2 = 5;
      playFX(level._effect["robot_tile_pup"], var_0.item.origin + (0, 0, 5));
      break;
  }
