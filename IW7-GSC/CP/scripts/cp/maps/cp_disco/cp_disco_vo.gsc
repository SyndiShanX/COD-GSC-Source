...
one_to_one_dialogue_vo_handler(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  ...
  if(var_9) {
    if(isDefined(level.vo_alias_data[var_0].chance_to_play))
      var_10 = level.vo_alias_data[var_0].chance_to_play;
  }
  ...
  var_11 = scripts\cp\cp_music_and_dialog::getarrayofdialoguealiases(var_0, var_9);
  level.dialogue_arr = var_11;

  while(scripts\cp\cp_music_and_dialog::vo_is_playing()) {
    if(scripts\engine\utility::is_true(level.pam_playing)) {
      break;
    }
  ...
  if(scripts\engine\utility::is_true(var_7)) {
    ...
    foreach(var_13 in var_11) {
      ...
      if(var_9 && isDefined(level.vo_alias_data[var_13].dialogueprefix)) {
        var_15 = level.vo_alias_data[var_13].dialogueprefix;
      ...
      if(isDefined(var_15) && var_8.vo_prefix == var_15 || var_14 || getdvarint("scr_solo_dialogue", 0) == 1) {
        ...
        var_17 = scripts\cp\cp_vo::create_vo_data(var_16, var_3, var_5, var_6, var_13);

        if(isDefined(self.current_vo_queue))
          self.current_vo_queue = scripts\engine\utility::array_add(self.current_vo_queue, var_16);

        var_8 scripts\cp\cp_vo::set_vo_system_playing(1);
        var_8 scripts\cp\cp_vo::set_vo_currently_playing(var_17);
        var_8 scripts\cp\cp_vo::play_vo(var_17);
    ...
    foreach(var_12 in var_9) {
      ...
      foreach(var_10 in level.players) {
        if(isDefined(var_14) && var_10.vo_prefix == var_14 || var_13 || getdvarint("scr_solo_dialogue", 0) == 1) {
          var_17 = scripts\cp\cp_vo::create_vo_data(var_15, var_3, var_5, var_6, var_12);

          if(isDefined(var_10.current_vo_queue))
            var_10.current_vo_queue = scripts\engine\utility::array_add(var_10.current_vo_queue, var_15);

          var_10 scripts\cp\cp_vo::set_vo_system_playing(1);
          var_10 scripts\cp\cp_vo::set_vo_currently_playing(var_17);
          var_10 scripts\cp\cp_vo::play_vo(var_17);
          var_10 scripts\cp\cp_vo::pause_between_vo(var_17);
  ...
  while(var_6 < var_0.size) {
    ...
    if(var_1 && isDefined(level.vo_alias_data[var_0[var_6]].dialogueprefix)) {
      ...
      if(isDefined(level.trainer)) {
        scripts\engine\utility::play_sound_in_space(var_7, level.trainer.origin, 0, level.trainer);
...
ww_vo(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  ...
  if(isPlayer(self)) {
    ...
    thread scripts\cp\cp_vo::play_vo_system(var_8, var_7);
    wait(scripts\cp\cp_vo::get_sound_length(var_0));
    ...
    foreach(var_10 in level.players) {
      ...
      var_8 = scripts\cp\cp_vo::create_vo_data(var_0, var_3, var_5, var_6);
      var_10 thread scripts\cp\cp_vo::play_vo_system(var_8, var_7);
    }
...
minigame_vo(var_0, var_1) {
  ...
  if(self == var_0) {
    ...
    if(scripts\engine\utility::is_true(var_0.recent_vo[var_1])) {
      return;
    }
    var_0 add_to_recent_player_vo(var_1);
    play_minigame_vo(var_0, var_1);
  } else {
    if(scripts\engine\utility::is_true(level.recent_vo[var_1])) {
      return;
    }
...
play_announcer_vo(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  ...
  if(isPlayer(self)) {
    ...
    var_8 = scripts\cp\cp_vo::create_vo_data(var_0, var_3, var_5, var_6);
    thread scripts\cp\cp_vo::play_vo_system(var_8);
  } else {
    foreach(var_10 in level.players) {
      if(!isDefined(var_10)) {
        continue;
      ...
      if(isDefined(var_7) && var_10.vo_prefix == var_7) {
        ...
        var_8 = scripts\cp\cp_vo::create_vo_data(var_0, var_3, var_5, var_6);
        var_10 thread scripts\cp\cp_vo::play_vo_system(var_8);
      }
    }
  }
...
play_vo_for_powerup(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  wait 0.5;
  announcer_vo("ww_" + var_0, "rave_announcer_vo", "highest", 60, 0, 0, 1);
...
willard_intro_vo() {
  ...
  if(level.players.size > 1) {
    if(randomint(100) > 50) {
      ...
      var_1 thread scripts\cp\cp_vo::try_to_play_vo("ww_intro", "rave_ww_vo", "highest", 30, 0, 0, 1, 100, 1);
    } else
...
power_nag() {
  ...
  for(;;) {
    ...
    if(level.wave_num > 0 && level.wave_num % 7 == 0) {
      foreach(var_1 in level.players)
      var_1 scripts\cp\cp_vo::add_to_nag_vo("nag_activate_power", "disco_comment_vo", 600, 120, 3, 1);
    }
  }
}
...
purchase_area_vo(var_0, var_1, var_2) {
  ...
  if(scripts\engine\utility::is_true(var_2)) {
    ...
    var_1 thread scripts\cp\cp_vo::try_to_play_vo(scripts\engine\utility::random(var_3), "disco_comment_vo");
  } else {
    switch (var_0) {
      case "front_gate":
      ...
      default:
        if(level.players.size > 1) {
          if(soundexists(var_1.vo_prefix + "purchase_area"))
            var_1 thread scripts\cp\cp_vo::try_to_play_vo("purchase_area", "rave_comment_vo", "low", 10, 0, 2, 1, 40);
          else if(soundexists(var_1.vo_prefix + "purchase_area_misc"))
          ...
          if(soundexists(level.players[0].vo_prefix + var_4))
            level.players[0] thread scripts\cp\cp_vo::try_to_play_vo(var_4, "rave_comment_vo", "low", 10, 0, 2, 1, 40);
          else
...
multiple_pam_intro_vo(var_0) {
  switch (level.special_character_count) {
    case 1:
      var_0 thread scripts\cp\cp_vo::try_to_play_vo("spawn_team_first", "disco_comment_vo");
      break;
    case 2:
      var_0 thread scripts\cp\cp_vo::try_to_play_vo("pam_players", "disco_comment_vo");
      break;
    case 3:
      var_0 thread scripts\cp\cp_vo::try_to_play_vo("pam_players_3", "disco_comment_vo");
      break;
    case 4:
      var_0 thread scripts\cp\cp_vo::try_to_play_vo("pam_players_4", "disco_comment_vo");
      break;
    default:
      break;
  }
