...
onratkingdamaged(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11) {
  ...
  if(scripts\engine\utility::is_true(level.rat_king.disabledamage)) {
...
rkprocessdamagefeedback(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10) {
  if(scripts\engine\utility::is_true(var_10.outofplayspace)) {
    return;
  }
  if(scripts\engine\utility::is_true(var_10.disabledamage)) {
...
adjustrkcooldowns() {
  ...
  if(scripts\engine\utility::is_true(scripts\aitypes\ratking\behaviors::rk_shouldbeonplatform()))
    scripts\cp\maps\cp_disco\rat_king_fight::forcerkteleport();
}
...
weapondamageadjustments(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11) {
  ...
  if(isPlayer(var_1)) {
    ...
    var_16 = var_14 && scripts\cp\utility::isheadshot(var_5, var_8, var_4, var_1);
    var_17 = isexplosivedamage(var_4, var_8);
    var_18 = !scripts\cp\agents\gametype_zombie::checkaltmodestatus(var_5) && var_1 scripts\cp\utility::coop_getweaponclass(var_5) == "weapon_sniper";
    var_19 = var_1 scripts\cp\cp_weapon::get_weapon_level(var_5);
    var_2 = var_2 * var_19;
