...
init() {
  ...
  level.powers["power_holyWater"]._id_AD4E = [];
}
...
holywater_projectile_instance() {
  self endon("death");
  level.powers["power_holyWater"]._id_AD4E = scripts\engine\utility::array_add(level.powers["power_holyWater"]._id_AD4E, self);
  var_0 = gettime();
  level.zbg_active = 1;
