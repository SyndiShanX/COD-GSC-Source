...
fish_trap_damage(var_0, var_1) {
  ...
  for(;;) {
    ...
    if(!isPlayer(var_2) && !isDefined(var_2.marked_for_death) && isagent(var_2) && isalive(var_2) && scripts\engine\utility::is_true(var_2.isactive)) {
...
fish_kill_zombie(var_0, var_1) {
  ...
  if(var_1 scripts\cp\utility::is_valid_player()) {
    ...
    var_0 dodamage(var_0.health + 100, var_0.origin, var_1, var_1, "MOD_UNKNOWN", "zmb_imsprojectile_mp");
  } else
    var_0 dodamage(var_0.health + 100, var_0.origin, undefined, undefined, "MOD_UNKNOWN", "zmb_imsprojectile_mp");
}
