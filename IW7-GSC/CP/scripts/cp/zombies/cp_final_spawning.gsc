...
_id_1071B(var_0) {
  ...
  while(level.current_enemy_deaths < level.desired_enemy_deaths_this_wave) {
    ...
    if(var_3 > 0) {
      wait(_id_8454(var_1, level.desired_enemy_deaths_this_wave));
      continue;
    }
...
choose_agent_type_and_spawn(var_0, var_1) {
  ...
  if(scripts\engine\utility::flag("power_on")) {
    if(!scripts\engine\utility::is_true(level.used_portal)) {
      var_2 = "alien_goon";
    } else {
...
spawn_goons_from_eggs(var_0, var_1) {
  ...
  if(var_0 > 0) {
    ...
    for(var_4 = 0; var_4 < var_0; var_6.in_use = 0) {
...
_id_10719(var_0, var_1) {
  ...
  if(isDefined(var_5)) {
    var_5 thread scripts\cp\zombies\zombies_spawning::_id_64E7(var_4);
...
_id_380D(var_0) {
  ...
  if(scripts\engine\utility::is_true(var_0.sent_to_portal)) {
    return 0;
  }
      ...
      if(isDefined(var_1.vo_prefix)) {
        switch (var_1.vo_prefix) {
          ...
          case "p3_":
            ...
            break;
          case "p4_":
            if(!isDefined(level.completed_dialogues["conv_crypitd_aj_1_1"])) {
              level thread scripts\cp\cp_vo::try_to_play_vo("conv_crypitd_aj_1_1", "rave_dialogue_vo", "highest", 666, 0, 0, 0, 100);
              level.completed_dialogues["conv_crypitd_aj_1_1"] = 1;
            }
