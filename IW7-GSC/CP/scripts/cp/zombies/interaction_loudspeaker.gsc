...
speaker_delayed_death(var_0) {
  ...
  if(isDefined(var_0) && isalive(var_0)) {
    ...
    self dodamage(self.health + 1000, level.rave_dance_attract_sorter.origin, var_0, var_0, "MOD_EXPLOSIVE", "zmb_imsprojectile_mp");
  } else
    self dodamage(self.health + 1000, level.rave_dance_attract_sorter.origin, undefined, undefined, "MOD_EXPLOSIVE", "zmb_imsprojectile_mp");
}
