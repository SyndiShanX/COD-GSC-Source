...
_id_FAB0() {
  ...
  level.agent_definition["alien_phantom"]["setup_model_func"] = ::_id_FACE;
  ...
  level.agent_funcs["alien_phantom"]["on_damaged_finished"] = ::scripts\mp\agents\zombie\zombie_agent::onzombiedamagefinished;
