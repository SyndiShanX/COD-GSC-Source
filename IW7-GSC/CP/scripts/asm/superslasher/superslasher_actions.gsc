    ...
    foreach(var_13 in level.players) {
      if(isalive(var_13) && var_13 getstance() != "prone") {
        ...
        if(abs(var_15) < var_6) {
          ...
          var_13 dodamage(0.75 * var_13.maxhealth, var_16, self, self, "MOD_IMPACT");
        }
      }
    }
...
superslasher_dosawfan() {
  ...
  for(var_3 = 0; var_3 < var_0; var_3++) {
    ...
    var_5 = spawnStruct();
    var_5.startpos = self.origin + var_4 * 40 + (0, 0, 48);
    var_5._id_6378 = var_5.startpos + var_4 * var_2;
...
superslasher_dosawblade(var_0) {
  magicbullet("zmb_superslasher_sawblade", var_0.startpos, var_0._id_6378, self);
}
