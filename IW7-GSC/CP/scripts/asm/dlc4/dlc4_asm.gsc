...
alienmeleenotehandler(var_0, var_1, var_2, var_3) {
  if(var_0 == "hit") {
    ...
    if(shouldmeleeattackhit(self.curmeleetarget, var_4.moving_melee_attack_damage_radius_sq, var_4.melee_dot)) {
      scripts\asm\zombie\melee::_id_1106E();
      scripts\asm\zombie\melee::domeleedamage(self.curmeleetarget, self._id_B601, "MOD_IMPACT");
    }
  }

  if(var_0 == "start_melee") {
    var_4 = gettunedata();
    thread domeleedamageoncontact(var_1, self.curmeleetarget, self._id_B601, var_4.moving_melee_attack_damage_radius_sq, var_4.melee_dot);
