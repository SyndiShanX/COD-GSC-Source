...
use_bfp_game(var_0, var_1) {
  ...
  var_1 thread scripts\cp\zombies\arcade_game_utility::arcade_game_player_disconnect_or_death(var_1, var_0, "iw7_cpskeeball_mp", ::_id_10228);
  var_1 thread scripts\cp\zombies\arcade_game_utility::arcade_game_player_gets_too_far_away(var_1, var_0, "iw7_cpskeeball_mp", ::_id_10228, "mus_arcade_skeeball_game_end", 4096);
}
...
_id_11805(var_0, var_1, var_2, var_3, var_4, var_5) {
  ...
  var_5 = scripts\engine\utility::getclosest(var_4["position"], var_0._id_11806, 64);
