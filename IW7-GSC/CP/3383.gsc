...
_id_94EF() {
  ...
  level._id_B162 = 0;
  level._id_B160 = [];
  level.fire_sale_func = ::_id_10C4D;
...
_id_BC3F() {
  for(;;) {
    var_0 = scripts\engine\utility::random(level._id_B160);
...
_id_12FFA(var_0, var_1, var_2) {
  ...
  scripts\cp\zombies\zombie_analytics::_id_AF79(level.wave_num);
  ...
  var_1._id_10A03 rotatepitch(var_1._id_E74A, 5, 1, 4);
...
_id_1010C(var_0, var_1) {
    ...
    if(randomint(100) > 95) {
      if(!has_venomx_in_loadout(var_1) && (scripts\cp\zombies\directors_cut::directors_cut_is_activated() || can_have_venomx(var_1))) {
        ...
        if(var_3 != "") {
          ...
          var_0._id_13C25 = scripts\engine\utility::array_add(var_0._id_13C25, "iw7_venomx_zm");
  ...
  var_14 = scripts\cp\zombies\interaction_weapon_upgrade::getoffsetfrombaseweaponname(var_0._id_13C25[var_4]);
...
wait_for_player_to_take_weapon(var_0) {
  ...
  for(;;) {
    ...
    if(var_1 ismeleeing() || var_1 meleeButtonPressed() || scripts\engine\utility::is_true(var_1.isusingsupercard)) {
      continue;
    }
...
_id_10C4D(var_0, var_1, var_2) {
  ...
  foreach(var_5 in level._id_B163) {
    ...
    if(var_5.area_name == level._id_A8E2) {
...
_id_4DB4(var_0, var_1, var_2) {
  ...
  if(var_3 != "activated" + var_0) {
    ...
    while(var_10) {
      ...
      foreach(var_8 in level.players) {
        if(scripts\engine\utility::is_true(var_8._id_13103)) {
          wait 0.25;
          var_11 = 1;
          continue;
        }
