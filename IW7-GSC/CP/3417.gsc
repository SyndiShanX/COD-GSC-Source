...
watch_for_super_button(var_0) {
  ...
  for(;;) {
    ...
    if(var_1 == var_0) {
      if(scripts\engine\utility::is_true(self.inlaststand)) {
...
dpad_drain_triggerpassive(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7) {
  ...
  for(;;) {
    ...
    if(!scripts\engine\utility::is_true(self.spectating) && !scripts\engine\utility::is_true(self.inlaststand) || var_0 == "coagulant") {
      var_10 = var_10 - var_8;
...
meter_fill_up() {
  ...
  while(self.consumable_meter < self.consumable_meter_max) {
    ...
    if(scripts\engine\utility::is_true(self.disable_consumables)) {
      continue;
    }
...
fnf_upgrade_weapon(var_0, var_1, var_2, var_3) {
  ...
  var_19 = var_0 scripts\cp\cp_weapon::return_weapon_name_with_like_attachments(var_3, var_5, var_6, undefined, var_4);

  if(isDefined(var_19)) {
    var_0.pap[var_2].lvl++;
    var_0 notify("weapon_level_changed");
    var_0.ephemeralweapon = getweaponbasename(var_19);
    var_0 thread downgradeweaponaftertimeout(var_1, var_0, var_19, var_7);
    var_0 endon("last_stand");
    wait(getcharactercardgesturelength());
    var_19 = var_0 scripts\cp\utility::_giveweapon(var_19, undefined, undefined, 1);
...
downgradeweaponaftertimeout(var_0, var_1, var_2, var_3) {
  ...
  if(isDefined(var_1.copy_fullweaponlist)) {
    var_16 = var_1.copy_fullweaponlist;

    foreach(var_18 in var_16) {
      var_14 = getweaponbasename(var_18);

      if(var_14 == var_4) {
        var_19 = var_1.copy_weapon_ammo_clip[var_18];
        var_20 = var_1.copy_weapon_ammo_stock[var_18];
        var_1.copy_fullweaponlist = scripts\engine\utility::array_remove(var_1.copy_fullweaponlist, var_18);
        ...
        var_1.copy_weapon_ammo_clip[var_2] = var_19;
        var_1.copy_weapon_ammo_stock[var_2] = var_20;
        break;
      }
    }
  }
  ...
  if(isDefined(var_1.lost_and_found_ent)) {
    var_16 = var_1.lost_and_found_ent.copy_fullweaponlist;
    ...
    foreach(var_18 in var_16) {
      ...
      if(var_14 == var_4) {
        var_19 = var_1.copy_weapon_ammo_clip[var_18];
        var_20 = var_1.copy_weapon_ammo_stock[var_18];
        var_1.lost_and_found_ent.copy_fullweaponlist = scripts\engine\utility::array_remove(var_1.lost_and_found_ent.copy_fullweaponlist, var_18);
...
unlimited_ammo(var_0, var_1) {
  ...
  while(scripts\engine\utility::is_true(self.has_fnf_weapon)) {
    var_3 = 0;
...
use_explosive_touch(var_0) {
  ...
  for(;;) {
    if(!scripts\engine\utility::is_true(self.has_explosive_touch)) {
...
watch_for_zombie_touch(var_0) {
  ...
  while(scripts\engine\utility::is_true(self.has_explosive_touch)) {
    var_1 = scripts\cp\cp_agent_utils::get_alive_enemies();
...
outline_enemeies(var_0) {
  ...
  for(;;) {
    foreach(var_2 in self.marked_ents) {
      ...
      if(scripts\engine\utility::is_true(var_2.marked_shared_fate_fnf)) {
...
linktoplayer_fire_chains(var_0, var_1, var_2) {
  ...
  while(scripts\engine\utility::is_true(var_0.linked_to_player)) {
...
deal_damage_to_zombies_entering_the_link(var_0, var_1) {
  ...
  foreach(var_5 in var_1) {
    ...
    if(isDefined(var_6["entity"])) {
      ...
      var_7 = scripts\engine\utility::is_true(var_6["entity"].is_skeleton);
  ...
  for(;;) {
    ...
    if(var_3.size <= 0) {
      ...
      foreach(var_5 in var_3) {
        ...
        if(scripts\engine\utility::is_true(var_5.entered_playspace)) {
...
watchforzombiecollisions(var_0) {
  ...
  while(scripts\engine\utility::is_true(self.dodging)) {
    var_1 = scripts\cp\cp_agent_utils::get_alive_enemies();
...
remove_stimulus(var_0) {
  ...
  if(scripts\engine\utility::is_true(self.stimulus_active)) {
...
wait_for_player_activation(var_0) {
  ...
  for(;;) {
    ...
    foreach(var_8 in level.players) {
      if(scripts\engine\utility::is_true(var_8.inlaststand)) {
        var_6 = 0;
        break;
      }

      if(scripts\engine\utility::is_true(var_8.iscarrying)) {
        var_6 = 0;
        break;
      }

      if(scripts\engine\utility::is_true(var_8.isusingsupercard)) {
        var_6 = 0;
        break;
      }
      ...
      if(!scripts\engine\utility::is_true(var_0.activate_gns_machine)) {
        var_6 = 0;
        break;
      }
    }
    ...
    if(var_6) {
      ...
      foreach(var_8 in level.players) {
        ...
        if(level.script == "cp_disco") {
          ...
          if(scripts\engine\utility::is_true(var_8.start_breaking_clock)) {
            var_6 = 0;
          }

          if(scripts\engine\utility::is_true(var_8.is_using_gourd)) {
            var_6 = 0;
          }

          if(scripts\engine\utility::is_true(var_8.kung_fu_mode)) {
            var_6 = 0;
          }
        }
      }
  ...
  if(!var_0 scripts\cp\cp_weapon::has_weapon_variation(var_3)) {
    ...
    if(isDefined(var_14)) {
      ...
      foreach(var_17 in var_9) {
        if(scripts\cp\utility::isstrstart(var_17, "alt_")) {
          var_11++;
        }
      }
    ...
    if(isDefined(var_2)) {
      ...
      var_19 = var_0 scripts\cp\cp_weapon::get_weapon_level(var_3);
    }
    ...
    if(isDefined(var_2)) {
      if(isDefined(var_0.pap[var_2])) {
        var_21 = "pap" + var_0.pap[var_2].lvl;
      } else {
        var_21 = "pap1";
      }
    }
    ...
    var_12 = undefined;
    var_24 = var_0 getweaponslistall();
    var_25 = var_0 getcurrentweapon();
    var_26 = scripts\cp\utility::getrawbaseweaponname(var_3);
    var_27 = undefined;
    ...
    var_31 = var_0 scripts\cp\perks\prestige::prestige_getminammo();
...
can_upgrade_via_pap2fnfcard(var_0, var_1) {
  ...
  if(scripts\engine\utility::is_true(var_1) && isDefined(self.pap[var_5]) && self.pap[var_5].lvl <= min(level.pap_max + 1, 2)) {
    return 1;
  }
