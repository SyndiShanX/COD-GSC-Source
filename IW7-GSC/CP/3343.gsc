...
init() {
  ...
  level.sentrysettings["sentry_microturret"].timeout = 90.0;
  level.sentrysettings["sentry_microturret"].spinuptime = 0.2;
  level.sentrysettings["sentry_microturret"].overheattime = 8.0;
  ...
  level.sentrysettings["sentry_microturret"].headicon = 1;
