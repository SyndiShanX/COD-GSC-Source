...
_id_2A37(var_0, var_1, var_2) {
  ...
  for(;;) {
    ...
    if(scripts\cp\utility::should_be_affected_by_trap(var_3, undefined, 1) && !scripts\engine\utility::is_true(var_3.dismember_crawl)) {
...
_id_3286(var_0) {
  ...
  if(isDefined(var_0)) {
    ...
    self dodamage(self.health + 50000, self.origin, var_0, var_0, "MOD_UNKNOWN", "iw7_beamtrap_zm");
  } else
    self dodamage(self.health + 50000, self.origin, undefined, undefined, "MOD_UNKNOWN", "iw7_beamtrap_zm");
}