...
_id_D66E() {
  ...
  scripts\sp\mg_penetration::_id_8715(var_1.turret);
}

_id_B6AB() {
  self waittill("trigger");
  level notify(self.targetname);
  level._id_B6AB[self.targetname] = 1;
  self delete();
}
...
_id_12A30() {
  ...
  var_3 = var_2 / 300;
  wait(var_3);
  playworldsound(self._id_FC65, var_1);
  wait 1;
  self._id_FC66 = 1;
}
...
_id_DC9D(var_0) {
  ...
  for(;;) {
    if(isPlayer(var_0)) {
      var_0.origin = self._id_B319 getorigin();
    } else {
...
_id_140E() {
  ...
  for(;;) {
    if(var_1) {
      ...
      if(isDefined(var_0.targetname) || self._id_6E66) {
    ...
    if(var_2.size) {
      var_3 = scripts\sp\utility::_id_78AB(var_0.origin, undefined, var_2);
    } else {
      var_3 = scripts\sp\utility::_id_78AA(var_0.origin, undefined);
    }
...
_id_B6AA() {
  ...
  if(isDefined(var_1.target)) {
    if(!isDefined(level._id_B6AB) || !isDefined(level._id_B6AB[var_1.target])) {
      level._id_B6AB[var_1.target] = 0;
      getEnt(var_1.target, "targetname") thread _id_B6AB();
    }
...
_id_B6A4(var_0, var_1) {
  ...
  self endon("auto_ai");
  self.pacifist = 1;
  self setgoalpos(var_0._id_C6EA);
  self.goalradius = level._id_B153;
  self waittill("goal");

  if(var_1) {
    if(!level._id_B6AB[var_0.target]) {
  ...
  if(var_5.size > 0) {
    ...
    for(;;) {
      for(var_13 = 0; var_13 < 1; var_13 = var_13 + var_10) {
        var_2.origin = var_7 * (1.0 - var_13) + (level.player getorigin() + _id_10B5A()) * var_13;
      ...
      if(_id_D279()) {
        ...
        while(_id_D279() && isDefined(level._id_CFE7.target) && gettime() < var_11) {
          var_16 = getEntArray(level._id_CFE7.target, "targetname");
...
_id_129EA(var_0, var_1) {
  ...
  for(var_3 = 0; var_3 < var_2.size; var_3++) {
    if(var_2[var_3] _meth_81A5(var_0.origin) && var_2[var_3] canuseturret(var_1)) {
...
_id_B6A7(var_0, var_1) {
  var_0.contextleanenabled = level._id_B6C2[var_1]["convergenceTime"];
  var_0.suppressiontime = level._id_B6C2[var_1]["suppressionTime"];
  var_0.accuracy = level._id_B6C2[var_1]["accuracy"];
...
_id_B6A9(var_0, var_1, var_2) {
  ...
  var_3 = scripts\sp\utility::_id_7E72();
  ...
  for(;;) {
    ...
    if(!isDefined(self._id_C3EA)) {
      self._id_C3EA = self.contextleanenabled;
    }
    ...
    while(level._id_5CC3[var_6].lastindex) {
      scripts\engine\utility::lock("mg42_drones");

      if(!level._id_5CC3[var_6].lastindex) {
    ...
    self.contextleanenabled = self._id_C3EA;
...
_id_5C88(var_0, var_1, var_2) {
  ...
  while(var_3 > gettime() || var_4) {
    ...
    scripts\sp\utility::_id_12BDD("mg42_drones_target_trace");
  }

  self _meth_83A3();
  scripts\sp\utility::_id_11165(level._id_5CC3[var_0.team], 1);
}

_id_7868(var_0, var_1) {
  if(level._id_5CC3[var_0].lastindex < 1) {
    return;
  }
  var_2 = undefined;
  var_3 = anglesToForward(self.angles);

  for(var_4 = 0; var_4 < level._id_5CC3[var_0].lastindex; var_4++) {
...
_id_EB7D() {
  ...
  foreach(var_7 in var_1) {
    foreach(var_9 in getnodesinradius(var_7.origin, 50, 0)) {
      ...
      var_9._id_12A72.node = var_9;
      var_9._id_12A72._id_01B8 = 45;
      var_9._id_12A72.rightarc = 45;
      ...
      if(isDefined(var_7.rightarc)) {
        var_9._id_12A72.rightarc = min(var_7.rightarc, 45);
      }
...
_id_5EF0() {
  ...
  self detach(self._id_12A78, level._id_D66F);
...
_id_E2DB() {
  ...
  scripts\sp\utility::_id_F2A4(scripts\anim\init::empty);
}
...
_id_1A30(var_0, var_1) {
  if(!isalive(self._id_4B6D) && self cansee(self._id_4B6D)) {
...
_id_E826(var_0) {
  ...
  wait 0.05;
  scripts\sp\utility::_id_F2A4(scripts\anim\combat::_id_68C7);
  scripts\engine\utility::clear_exception("move");
  scripts\sp\utility::_id_F398("cover_crouch", ::_id_906E);
...
_id_12A4E() {
  ...
  scripts\sp\mg_penetration::_id_8715(var_2.turret);
}
...
_id_13030(var_0) {
  ...
  if(var_1) {
    scripts\sp\utility::_id_F398("move", ::_id_12A4E);
    self.turret = var_0;
...
find_connected_turrets(var_0) {
  ...
  for(var_5 = 0; var_5 < var_3.size; var_5++) {
    ...
    var_7 = getarraykeys(self.turret._id_FC5E[var_0]);
