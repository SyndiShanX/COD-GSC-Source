...
func_1843(var_0, var_1, var_2, var_3, var_4) {
  ...
  if(isDefined(var_0)) {
    if(scripts\mp\utility\game::func_9FBA(var_0)) {
      func_1863(var_5);
      thread func_E121(var_5);
    } else if(scripts\mp\utility\game::func_9D35(var_0)) {
      func_1844(var_5);
      thread func_E0FE(var_5);
    } else if(scripts\mp\utility\game::func_9E7F(var_0)) {
      addtolittlebirdlist(var_5);
      thread func_E111(var_5);
    } else if(scripts\mp\utility\game::func_9E2D(var_0)) {
      func_184E(var_5);
      thread func_E10A(var_5);
    } else if(scripts\mp\utility\game::func_9F67(var_0)) {
      func_185A(var_5);
      thread func_E118(var_5);
    } else if(scripts\mp\utility\game::func_9D61(var_0)) {
      func_1847(var_5);
      thread func_E102(var_5);
    } else if(scripts\mp\utility\game::func_9FB7(var_0)) {
      func_1862(var_5);
      thread func_E120(var_5);
    } else if(scripts\mp\utility\game::func_9D82(var_0)) {
      func_184A(var_5);
      thread func_E105(var_5);
    } else if(scripts\mp\utility\game::func_9F0F(var_0)) {
      func_1857(var_5);
    ...
    if(scripts\mp\utility\game::func_9E64(var_0)) {
      self.var_18DD = 1;
    }

    if(scripts\mp\utility\game::func_9E6A(var_0)) {
      self.var_18DE = 1;
    }
  }
  ...
  if(scripts\mp\utility\game::istrue(var_3)) {
    ...
    if(level.teambased) {
      if(scripts\mp\utility\game::func_9F2C(var_0)) {
        foreach(var_9 in level.players) {
          if(var_9.team == self.team && var_9 != self.owner) {
            var_6 = scripts\mp\utility\game::outlineenableforplayer(self, "cyan", var_9, 0, 0, "lowest");
          }
...
func_20CF(var_0, var_1) {
  ...
  if(isDefined(var_4)) {
    if(scripts\mp\utility\game::istrue(var_5)) {
      if(var_0 scripts\mp\utility\game::_hasperk("specialty_noplayertarget")) {
        return;
      }
    }

    var_6 = scripts\mp\utility\game::outlineenableforplayer(var_0, var_4, self.owner, 1, 1, "killstreak");
...
getmodifiedantikillstreakdamage(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8) {
  ...
  if(scripts\mp\utility\game::istrue(var_9)) {
    var_11 = scripts\mp\utility\game::getweaponattachmentsbasenames(var_1);
  ...
  var_15 = undefined;
  var_16 = scripts\mp\utility\game::getweaponbasedsmokegrenadecount(var_1);
...
isexplosiveantikillstreakweapon(var_0) {
  ...
  if(scripts\mp\utility\game::istrue(var_2)) {
    var_4 = scripts\mp\utility\game::getweaponattachmentsbasenames(var_0);
  ...
  var_8 = scripts\mp\utility\game::getweaponbasedsmokegrenadecount(var_0);
...
dodamagetokillstreak(var_0, var_1, var_2, var_3, var_4, var_5, var_6) {
  ...
  if(isagent(self)) {
    self getrandomarmkillstreak(var_0, var_4, var_1, var_2, var_5, var_6);
  } else {
...
func_139B5(var_0, var_1, var_2) {
  ...
  for(;;) {
    ...
    if(scripts\mp\utility\game::func_9FAE(var_5)) {
      continue;
    }
...
func_13B84(var_0, var_1, var_2) {
  ...
  for(var_8 = self.lastboundstimelimit; self istouching(var_0); var_8 = var_8 - 0.05) {
    if(var_8 <= 0) {
      var_7 = 1;
      break;
    }
...
manualmissilecantracktarget(var_0) {
  ...
  if(var_0 isinphase() || scripts\mp\utility\game::istrue(var_0.var_9D8B) || var_0 scripts\mp\utility\game::_hasperk("specialty_noscopeoutline")) {
    var_1 = 0;
  }
