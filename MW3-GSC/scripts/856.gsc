...
main() {
  ...
  level._effect["leaves_fall_gentlewind_deltacamp"] = loadfx("misc/leaves_fall_gentlewind_deltacamp");
  ...
  level._effect["flood_light_smoke_deltacamp"] = loadfx("smoke/flood_light_smoke_deltacamp");
  level._effect["battlefield_smokebank_s_cheap"] = loadfx("smoke/battlefield_smokebank_s_cheap");
