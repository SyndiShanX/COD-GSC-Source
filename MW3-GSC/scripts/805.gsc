...
main() {
  ...
  level._effect["payback_window_glow_light"] = loadfx("maps/payback/payback_window_glow_light");
  ...
  level._effect["payback_int_amb_dustmotes"] = loadfx("maps/payback/payback_int_amb_dustmotes");
